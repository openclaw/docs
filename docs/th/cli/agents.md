---
read_when:
    - คุณต้องการเอเจนต์ที่แยกจากกันหลายตัว (เวิร์กสเปซ + การกำหนดเส้นทาง + การยืนยันตัวตน)
...
- ในโหมดโต้ตอบ การเติมข้อมูลการยืนยันตัวตนจะคัดลอกเฉพาะโปรไฟล์แบบสแตติกที่พกพาได้
  (`api_key` และ `token` แบบสแตติกโดยค่าเริ่มต้น). โปรไฟล์ OAuth refresh-token จะยังคง
  ใช้ได้ผ่านการสืบทอดแบบอ่านทะลุจากที่เก็บเอเจนต์ `main` จริงเท่านั้น.
