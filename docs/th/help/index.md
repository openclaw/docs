---
read_when:
    - คุณเป็นผู้ใช้ใหม่และต้องการคู่มือแบบ "ต้องคลิก/เรียกใช้อะไร"
    - มีบางอย่างขัดข้อง และคุณต้องการวิธีแก้ไขที่เร็วที่สุด
summary: 'ศูนย์ช่วยเหลือ: วิธีแก้ไขปัญหาทั่วไป, การตรวจสอบความถูกต้องของการติดตั้ง, และตำแหน่งที่ควรดูเมื่อเกิดปัญหา'
title: ความช่วยเหลือ
x-i18n:
