---
summary: คะแนนความพร้อมสำหรับการเผยแพร่ของ OpenClaw สำหรับพื้นที่ผลิตภัณฑ์ การผสานการทำงาน และเวิร์กโฟลว์ที่รองรับ
title: ตารางคะแนนวุฒิภาวะ
x-i18n:
    generated_at: "2026-07-02T08:58:36Z"
    model: gpt-5.5
...
# ตารางคะแนนความพร้อมสมบูรณ์

<div className="maturity-hero">
  <p className="maturity-kicker">ความพร้อมสำหรับรีลีส - สร้างจากอนุกรมวิธาน + หลักฐาน QA</p>
  <p className="maturity-hero-title">มุมมองเชิงปฏิบัติว่าอะไรพร้อมแล้ว อะไรมีหลักฐานยืนยันแล้ว และอะไรยังต้องปรับปรุง</p>
  <p>50 พื้นผิว - 281 พื้นที่ความสามารถ - ความครอบคลุมแบบกำหนดผลได้แน่นอน รวมกับคุณภาพและความครบถ้วนที่ผ่านการตรวจทานโดยมนุษย์</p>
...
ใช้หน้านี้เพื่อตอบคำถามเดียว: พื้นผิวใดของ OpenClaw เป็นตัวเลือกที่น่าเชื่อถือสำหรับรีลีส และมีหลักฐานใดรองรับการตัดสินนั้น ความครอบคลุมมาจากหลักฐาน QA แบบกำหนดผลได้แน่นอน ส่วนคุณภาพและความครบถ้วนจะถูกรักษาไว้เป็นคะแนนความพร้อมสมบูรณ์ที่ผ่านการตรวจทานแล้ว
...
<div className="maturity-summary-grid">
  <div className="maturity-summary-item maturity-score-alpha">
    <div className="maturity-summary-heading">
      ...
      <span>คะแนนความพร้อมสมบูรณ์</span>
    </div>
    ...
    <div className="maturity-summary-meta">
      ...
      <span>คุณภาพ + ความครบถ้วน</span>
      <span>ความครอบคลุม ทดลอง - 4%</span>
      <span>คุณภาพ อัลฟา - 64%</span>
      <span>ความครบถ้วน เบต้า - 71%</span>
    </div>
  </div>
</div>

ความครอบคลุมตั้งใจให้ขับเคลื่อนด้วยหลักฐาน: พื้นที่หนึ่งจะไม่กลายเป็น "พร้อม" เพียงเพราะมีการติดตั้งใช้งานอยู่แล้ว สิ่งนี้ไม่ใช่อินพุตของคะแนนความพร้อมสมบูรณ์ แต่ OpenClaw ตั้งเป้าที่จะรักษาความครอบคลุมแบบครบวงจรให้สูงกว่า 90% สำหรับฟีเจอร์ที่โตเต็มที่ในระดับเสถียรหรือดีกว่าเมื่อเวลาผ่านไป
...
พื้นผิวถูกจัดเรียงตามระดับความพร้อมสมบูรณ์ ความครบถ้วน และคุณภาพ การรองรับ LTS จะแสดงควบคู่ไปกับแต่ละแถว เพื่อให้เปรียบเทียบตัวเลือกที่พร้อมสำหรับรีลีสได้ง่าย
  ...
  <Tab title="พื้นผิวทั้งหมด">
    <div className="maturity-surface-table">
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/th/maturity/taxonomy#cli"><span className="maturity-surface-title">CLI</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-stable"><span className="maturity-level-code">M4</span><span>เสถียร</span></span><span>7 ขอบเขต</span></span></a>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/th/maturity/taxonomy#gateway-runtime"><span className="maturity-surface-title">รันไทม์ Gateway</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-stable"><span className="maturity-level-code">M4</span><span>เสถียร</span></span><span>13 ขอบเขต</span></span></a>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/th/maturity/taxonomy#linux-gateway-host"><span className="maturity-surface-title">โฮสต์ Linux Gateway</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-stable"><span className="maturity-level-code">M4</span><span>เสถียร</span></span><span>5 ขอบเขต</span></span></a>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/th/maturity/taxonomy#macos-gateway-host"><span className="maturity-surface-title">โฮสต์ macOS Gateway</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-stable"><span className="maturity-level-code">M4</span><span>เสถียร</span></span><span>7 ขอบเขต</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">ความครอบคลุม</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">ทดลอง</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/th/maturity/taxonomy#discord"><span className="maturity-surface-title">Discord</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-stable"><span className="maturity-level-code">M4</span><span>เสถียร</span></span><span>6 ขอบเขต</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">ความครอบคลุม</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">ทดลอง</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/th/maturity/taxonomy#android-app"><span className="maturity-surface-title">แอป Android</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-stable"><span className="maturity-level-code">M4</span><span>เสถียร</span></span><span>7 ขอบเขต</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">ความครอบคลุม</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">ทดลอง</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/th/maturity/taxonomy#ios-app"><span className="maturity-surface-title">แอป iOS</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-stable"><span className="maturity-level-code">M4</span><span>เสถียร</span></span><span>8 ขอบเขต</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">ความครอบคลุม</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">ทดลอง</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">คุณภาพ</span><span className="maturity-score maturity-score-stable"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-stable">เสถียร</span><span>80%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "80%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">ความสมบูรณ์</span><span className="maturity-score maturity-score-stable"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-stable">เสถียร</span><span>80%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "80%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">ไม่มี</span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/th/maturity/taxonomy#agent-runtime"><span className="maturity-surface-title">รันไทม์ของเอเจนต์</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>เบต้า</span></span><span>9 ด้าน</span></span></a>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/th/maturity/taxonomy#browser-automation-exec-and-sandbox-tools"><span className="maturity-surface-title">เครื่องมือสำหรับการทำงานอัตโนมัติของเบราว์เซอร์, exec และ sandbox</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>เบต้า</span></span><span>3 ด้าน</span></span></a>
      ...
      <div className="maturity-surface-row">
        ...
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">ความครอบคลุม</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">ทดลอง</span><span>12%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "12%" }} /></span></span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/th/maturity/taxonomy#security-auth-pairing-and-secrets"><span className="maturity-surface-title">ความปลอดภัย การตรวจสอบสิทธิ์ การจับคู่ และความลับ</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>เบต้า</span></span><span>6 ด้าน</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">ความครอบคลุม</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">ทดลอง</span><span>16%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "16%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">คุณภาพ</span><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">เบต้า</span><span>72%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "72%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">ความครบถ้วน</span><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">เบต้า</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-partial">บางส่วน - 5</span></div>
      </div>
      <div className="maturity-surface-row">
        ...
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">ความครอบคลุม</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">ทดลอง</span><span>2%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "2%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">คุณภาพ</span><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">เบต้า</span><span>72%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "72%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">ความครบถ้วน</span><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">เบต้า</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">ไม่มี</span></div>
      </div>
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/th/maturity/taxonomy#docker-and-podman-hosting"><span className="maturity-surface-title">การโฮสต์ด้วย Docker และ Podman</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>เบต้า</span></span><span>4 ด้าน</span></span></a>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/th/maturity/taxonomy#slack"><span className="maturity-surface-title">Slack</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>เบต้า</span></span><span>5 ด้าน</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">ความครอบคลุม</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">ทดลอง</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/th/maturity/taxonomy#imessage-and-bluebubbles"><span className="maturity-surface-title">iMessage และ BlueBubbles</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>Beta</span></span><span>5 ด้าน</span></span></a>
        ...
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">คุณภาพ</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>66%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "66%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">ความสมบูรณ์</span><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>78%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "78%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">ไม่มี</span></div>
      </div>
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/th/maturity/taxonomy#macos-companion-app"><span className="maturity-surface-title">แอปคู่ขนาน macOS</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>Beta</span></span><span>8 ด้าน</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">ความครอบคลุม</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">เชิงทดลอง</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">คุณภาพ</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>66%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "66%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">ความสมบูรณ์</span><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>78%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "78%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">ไม่มี</span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/th/maturity/taxonomy#openrouter-provider-path"><span className="maturity-surface-title">เส้นทางผู้ให้บริการ OpenRouter</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>Beta</span></span><span>4 ด้าน</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">ความครอบคลุม</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">เชิงทดลอง</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">คุณภาพ</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>66%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "66%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">ความสมบูรณ์</span><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>78%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "78%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">ไม่มี</span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/th/maturity/taxonomy#whatsapp"><span className="maturity-surface-title">WhatsApp</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>Beta</span></span><span>5 ด้าน</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">ความครอบคลุม</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">เชิงทดลอง</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">คุณภาพ</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>66%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "66%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">ความสมบูรณ์</span><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>78%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "78%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">ไม่มี</span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/th/maturity/taxonomy#media-understanding-and-media-generation"><span className="maturity-surface-title">ความเข้าใจสื่อและการสร้างสื่อ</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>Alpha</span></span><span>6 ด้าน</span></span></a>
        ...
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">คุณภาพ</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>64%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "64%" }} /></span></span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/th/maturity/taxonomy#image-video-and-music-generation-tools"><span className="maturity-surface-title">เครื่องมือสร้างภาพ วิดีโอ และดนตรี</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>Alpha</span></span><span>5 ด้าน</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">ความครอบคลุม</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">เชิงทดลอง</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/th/maturity/taxonomy#local-model-providers-ollama-vllm-sglang-lm-studio"><span className="maturity-surface-title">ผู้ให้บริการโมเดลภายในเครื่อง: Ollama, vLLM, SGLang, LM Studio</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>Alpha</span></span><span>5 ด้าน</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">ความครอบคลุม</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">ทดลอง</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/th/maturity/taxonomy#kubernetes-hosting"><span className="maturity-surface-title">การโฮสต์ Kubernetes</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>อัลฟา</span></span><span>4 ด้าน</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">ความครอบคลุม</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">ทดลอง</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
      ...
      <div className="maturity-surface-row">
        ...
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">ความครอบคลุม</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">เชิงทดลอง</span><span>3%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "3%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">คุณภาพ</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">อัลฟา</span><span>54%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "54%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">ความครบถ้วน</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">อัลฟา</span><span>53%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "53%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">ไม่มี</span></div>
      </div>
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/th/maturity/taxonomy#nix-install-path"><span className="maturity-surface-title">เส้นทางการติดตั้ง Nix</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-experimental"><span className="maturity-level-code">M1</span><span>เชิงทดลอง</span></span><span>5 ด้าน</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">ความครอบคลุม</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">เชิงทดลอง</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">คุณภาพ</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">เชิงทดลอง</span><span>41%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "41%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">ความครบถ้วน</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">เชิงทดลอง</span><span>44%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "44%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">ไม่มี</span></div>
      </div>
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/th/maturity/taxonomy#voice-call-channel"><span className="maturity-surface-title">ช่องทางการโทรด้วยเสียง</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-experimental"><span className="maturity-level-code">M1</span><span>เชิงทดลอง</span></span><span>5 ด้าน</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">ความครอบคลุม</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">เชิงทดลอง</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">คุณภาพ</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">เชิงทดลอง</span><span>41%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "41%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">ความครบถ้วน</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">เชิงทดลอง</span><span>44%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "44%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">ไม่มี</span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/th/maturity/taxonomy#watchos-companion-surfaces"><span className="maturity-surface-title">พื้นผิวคู่หูของ watchOS</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-experimental"><span className="maturity-level-code">M1</span><span>เชิงทดลอง</span></span><span>5 ด้าน</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">ความครอบคลุม</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">เชิงทดลอง</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">คุณภาพ</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">เชิงทดลอง</span><span>41%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "41%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">ความครบถ้วน</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">เชิงทดลอง</span><span>44%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "44%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">ไม่มี</span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/th/maturity/taxonomy#linux-companion-app"><span className="maturity-surface-title">แอปคู่หู Linux</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-experimental"><span className="maturity-level-code">M0</span><span>วางแผนไว้</span></span><span>5 ด้าน</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">ความครอบคลุม</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">เชิงทดลอง</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">คุณภาพ</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">เชิงทดลอง</span><span>19%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "19%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">ความครบถ้วน</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">เชิงทดลอง</span><span>21%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "21%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">ไม่มี</span></div>
      </div>
      <div className="maturity-surface-row">
  ...
  <Tab title="แกนหลัก">
    <div className="maturity-surface-table">
      <div className="maturity-surface-row maturity-surface-row-header"><span>พื้นผิว</span><span>ความครอบคลุม</span><span>คุณภาพ</span><span>ความครบถ้วน</span><span>การสนับสนุน</span></div>
      <div className="maturity-surface-row">
        ...
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">ความครอบคลุม</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">ทดลอง</span><span>4%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "4%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">คุณภาพ</span><span className="maturity-score maturity-score-stable"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-stable">เสถียร</span><span>83%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "83%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">ความครบถ้วน</span><span className="maturity-score maturity-score-stable"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-stable">เสถียร</span><span>90%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "90%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-partial">บางส่วน - 6</span></div>
      </div>
      <div className="maturity-surface-row">
        ...
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">ความครอบคลุม</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">ทดลอง</span><span>6%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "6%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">คุณภาพ</span><span className="maturity-score maturity-score-stable"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-stable">เสถียร</span><span>81%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "81%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">ความครบถ้วน</span><span className="maturity-score maturity-score-stable"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-stable">เสถียร</span><span>89%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "89%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-partial">บางส่วน - 12</span></div>
      </div>
      <div className="maturity-surface-row">
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/th/maturity/taxonomy#session-memory-and-context-engine"><span className="maturity-surface-title">เครื่องมือเซสชัน หน่วยความจำ และบริบท</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>เบต้า</span></span><span>9 ด้าน</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">ความครอบคลุม</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">ทดลอง</span><span>30%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "30%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">คุณภาพ</span><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">เบต้า</span><span>77%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "77%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">ความครบถ้วน</span><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">เบต้า</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-partial">บางส่วน - 6</span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/th/maturity/taxonomy#gateway-web-app"><span className="maturity-surface-title">Gateway เว็บแอป</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>เบต้า</span></span><span>6 ด้าน</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">ความครอบคลุม</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">ทดลอง</span><span>4%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "4%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">คุณภาพ</span><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">เบต้า</span><span>74%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "74%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">ความสมบูรณ์</span><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">เบต้า</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">ไม่มี</span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/th/maturity/taxonomy#clawhub"><span className="maturity-surface-title">ClawHub</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>อัลฟา</span></span><span>4 พื้นที่</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">ความครอบคลุม</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">ทดลอง</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">คุณภาพ</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">อัลฟา</span><span>58%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "58%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">ความสมบูรณ์</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">อัลฟา</span><span>62%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "62%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">ไม่มี</span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/th/maturity/taxonomy#openclaw-app-sdk"><span className="maturity-surface-title">OpenClaw App SDK</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>อัลฟา</span></span><span>6 พื้นที่</span></span></a>
  ...
  <Tab title="แพลตฟอร์ม">
    <div className="maturity-surface-table">
      <div className="maturity-surface-row maturity-surface-row-header"><span>พื้นผิว</span><span>ความครอบคลุม</span><span>คุณภาพ</span><span>ความสมบูรณ์</span><span>การสนับสนุน</span></div>
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/th/maturity/taxonomy#linux-gateway-host"><span className="maturity-surface-title">โฮสต์ Gateway บน Linux</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-stable"><span className="maturity-level-code">M4</span><span>เสถียร</span></span><span>5 พื้นที่</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">ความครอบคลุม</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">ทดลอง</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">คุณภาพ</span><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">เบต้า</span><span>75%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "75%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">ความสมบูรณ์</span><span className="maturity-score maturity-score-stable"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-stable">เสถียร</span><span>89%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "89%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-partial">บางส่วน - 4</span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/th/maturity/taxonomy#macos-gateway-host"><span className="maturity-surface-title">โฮสต์ Gateway บน macOS</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-stable"><span className="maturity-level-code">M4</span><span>เสถียร</span></span><span>7 พื้นที่</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">ความครอบคลุม</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">ทดลอง</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">คุณภาพ</span><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">เบต้า</span><span>74%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "74%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">ความสมบูรณ์</span><span className="maturity-score maturity-score-stable"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-stable">เสถียร</span><span>88%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "88%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">ไม่มี</span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/th/maturity/taxonomy#android-app"><span className="maturity-surface-title">แอป Android</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-stable"><span className="maturity-level-code">M4</span><span>เสถียร</span></span><span>7 พื้นที่</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">ความครอบคลุม</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">ทดลอง</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">คุณภาพ</span><span className="maturity-score maturity-score-stable"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-stable">เสถียร</span><span>80%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "80%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">ความสมบูรณ์</span><span className="maturity-score maturity-score-stable"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-stable">เสถียร</span><span>80%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "80%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">ไม่มี</span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/th/maturity/taxonomy#ios-app"><span className="maturity-surface-title">แอป iOS</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-stable"><span className="maturity-level-code">M4</span><span>เสถียร</span></span><span>8 พื้นที่</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">ความครอบคลุม</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">ทดลอง</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">คุณภาพ</span><span className="maturity-score maturity-score-stable"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-stable">เสถียร</span><span>80%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "80%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">ความสมบูรณ์</span><span className="maturity-score maturity-score-stable"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-stable">เสถียร</span><span>80%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "80%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">ไม่มี</span></div>
      ...
      <div className="maturity-surface-row">
        ...
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">ความสมบูรณ์</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">แอลฟา</span><span>61%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "61%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">ไม่มี</span></div>
      </div>
      <div className="maturity-surface-row">
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/th/maturity/taxonomy#watchos-companion-surfaces"><span className="maturity-surface-title">พื้นผิวคู่ขนานของ watchOS</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-experimental"><span className="maturity-level-code">M1</span><span>ทดลอง</span></span><span>5 ด้าน</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">ความครอบคลุม</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">ทดลอง</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">คุณภาพ</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">ทดลอง</span><span>41%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "41%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">ความสมบูรณ์</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">ทดลอง</span><span>44%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "44%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">ไม่มี</span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/th/maturity/taxonomy#linux-companion-app"><span className="maturity-surface-title">แอปคู่ขนานสำหรับ Linux</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-experimental"><span className="maturity-level-code">M0</span><span>วางแผนแล้ว</span></span><span>5 ด้าน</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">ความครอบคลุม</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">ทดลอง</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/th/maturity/taxonomy#native-windows-companion-app"><span className="maturity-surface-title">แอปคู่ขนานแบบเนทีฟสำหรับ Windows</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-experimental"><span className="maturity-level-code">M0</span><span>วางแผนแล้ว</span></span><span>5 ด้าน</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">ความครอบคลุม</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">ทดลอง</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">คุณภาพ</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">ทดลอง</span><span>19%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "19%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">ความสมบูรณ์</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">ทดลอง</span><span>21%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "21%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">ไม่มี</span></div>
  ...
  <Tab title="ช่องทาง">
    <div className="maturity-surface-table">
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/th/maturity/taxonomy#telegram"><span className="maturity-surface-title">Telegram</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>เบต้า</span></span><span>5 ด้าน</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">ความครอบคลุม</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">ทดลอง</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">คุณภาพ</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">แอลฟา</span><span>68%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "68%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">ความสมบูรณ์</span><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">เบต้า</span><span>78%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "78%" }} /></span></span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/th/maturity/taxonomy#imessage-and-bluebubbles"><span className="maturity-surface-title">iMessage และ BlueBubbles</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>เบต้า</span></span><span>5 ด้าน</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">ความครอบคลุม</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">เชิงทดลอง</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">คุณภาพ</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">อัลฟา</span><span>66%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "66%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">ความสมบูรณ์</span><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">เบต้า</span><span>78%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "78%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">ไม่มี</span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/th/maturity/taxonomy#feishu-qq-bot-wechat-yuanbao-zalo-zalo-personal-regional-channels"><span className="maturity-surface-title">Feishu, QQ Bot, WeChat, Yuanbao, Zalo, Zalo Personal, ช่องทางระดับภูมิภาค</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>แอลฟา</span></span><span>4 ด้าน</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">ความครอบคลุม</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">ทดลอง</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        ...
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">ความสมบูรณ์</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">แอลฟา</span><span>58%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "58%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">ไม่มี</span></div>
      </div>
      <div className="maturity-surface-row">
        ...
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">ความสมบูรณ์</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">แอลฟา</span><span>54%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "54%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">ไม่มี</span></div>
      </div>
      <div className="maturity-surface-row">
  ...
  <Tab title="ผู้ให้บริการและเครื่องมือ">
    <div className="maturity-surface-table">
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/th/maturity/taxonomy#browser-automation-exec-and-sandbox-tools"><span className="maturity-surface-title">การทำงานอัตโนมัติของเบราว์เซอร์, exec, และเครื่องมือแซนด์บ็อกซ์</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>เบตา</span></span><span>3 ด้าน</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">ความครอบคลุม</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">ทดลอง</span><span>21%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "21%" }} /></span></span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/th/maturity/taxonomy#local-model-providers-ollama-vllm-sglang-lm-studio"><span className="maturity-surface-title">ผู้ให้บริการโมเดลในเครื่อง: Ollama, vLLM, SGLang, LM Studio</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>อัลฟา</span></span><span>5 ด้าน</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">ความครอบคลุม</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">ทดลอง</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">คุณภาพ</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">อัลฟา</span><span>61%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "61%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">ความสมบูรณ์</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">อัลฟา</span><span>68%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "68%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">ไม่มี</span></div>
...
การตรวจสอบด้านล่างแสดงว่าพื้นที่ใดใน scorecard ได้รับการทดสอบด้วยหลักฐานจากโปรไฟล์ QA

<div className="maturity-evidence-grid">
  <div className="maturity-evidence-card">
    <span className="maturity-evidence-title">การตรวจสอบ taxonomy แบบครบถ้วน</span>
    <span>2026-06-23T07:24:36.128Z</span>
    <span>ตรวจสอบ 96 รายการ - ผ่าน 94 รายการ, ถูกบล็อก 2 รายการ</span>
    <span>0 จาก 281 (0%) พื้นที่ - 20 จาก 1675 (1.2%) ฟีเจอร์ - 77 จาก 1665 (4.6%) coverage ID</span>
  </div>
</div>

### ความพร้อมตามพื้นที่

เปิดพื้นผิวเพื่อตรวจสอบสถานะหลักฐานของแต่ละหมวดหมู่ รายการจะยังคงยุบไว้เพื่อให้หน้าเว็บยังคงดูภาพรวมได้ง่าย

<AccordionGroup>
  <Accordion title="รันไทม์ของเอเจนต์ - 9 พื้นที่">
    <p className="maturity-readiness-summary">ตรวจทานบางส่วน 8 รายการ / ต้องตรวจทาน 1 รายการ</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>พื้นที่</span><span>ฟีเจอร์ / coverage ID</span><span>การติดตามผล</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">การดำเนินการเทิร์นของเอเจนต์</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">ตรวจทานบางส่วน - การตรวจสอบ taxonomy แบบครบถ้วน</span>
        </div>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">รันไทม์ภายนอกและซับเอเจนต์</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">ตรวจทานบางส่วน - การตรวจสอบ taxonomy แบบครบถ้วน</span>
        </div>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">ผู้ให้บริการภายในเครื่องและแบบโฮสต์เอง</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">ต้องตรวจทาน - การตรวจสอบ taxonomy แบบครบถ้วน</span>
        </div>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">การยืนยันตัวตนของผู้ให้บริการ</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">ตรวจทานบางส่วน - การตรวจสอบ taxonomy แบบครบถ้วน</span>
        </div>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">การควบคุมการดำเนินการเครื่องมือ</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">ตรวจทานบางส่วน - การตรวจสอบ taxonomy แบบครบถ้วน</span>
        </div>
  ...
  <Accordion title="แอป Android - 7 พื้นที่">
    <p className="maturity-readiness-summary">ต้องตรวจทาน 7 รายการ</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>พื้นที่</span><span>ฟีเจอร์ / coverage ID</span><span>การติดตามผล</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
  ...
  <Accordion title="เส้นทางผู้ให้บริการ Anthropic - 5 พื้นที่">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">การยืนยันตัวตนและการกู้คืนของผู้ให้บริการ</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">ต้องตรวจทาน - การตรวจสอบ taxonomy แบบครบถ้วน</span>
        </div>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">การส่งคำขอและความหมายของเทิร์น</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">ต้องตรวจทาน - การตรวจสอบ taxonomy แบบครบถ้วน</span>
        </div>
  ...
  <Accordion title="ระบบอัตโนมัติ: Cron, ฮุก, งาน, การโพล - 6 ด้าน">
    <p className="maturity-readiness-summary">5 ต้องตรวจทาน / 1 ตรวจทานบางส่วนแล้ว</p>
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">ฮุกระบบอัตโนมัติ</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">การรับเหตุการณ์เข้า</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">ต้องตรวจทาน - การตรวจสอบอนุกรมวิธานแบบเต็ม</span>
        </div>
        <span>0 จาก 15 (0%) / 0 จาก 15 (0%)</span>
        <span>ช่องว่างด้านความสามารถ 15 รายการ</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          ...
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">ตรวจทานบางส่วนแล้ว - การตรวจสอบอนุกรมวิธานแบบเต็ม</span>
        </div>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">การควบคุมการโพล</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">ต้องตรวจทาน - การตรวจสอบอนุกรมวิธานแบบเต็ม</span>
        </div>
        <span>0 จาก 10 (0%) / 0 จาก 10 (0%)</span>
        <span>ช่องว่างด้านความสามารถ 10 รายการ</span>
  ...
  <Accordion title="ระบบอัตโนมัติของเบราว์เซอร์, exec และเครื่องมือ sandbox - 3 ด้าน">
    <p className="maturity-readiness-summary">2 ตรวจทานบางส่วนแล้ว / 1 ต้องตรวจทาน</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>ด้าน</span><span>ฟีเจอร์ / ID ความครอบคลุม</span><span>การติดตามผล</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">นโยบาย sandbox และเครื่องมือ</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">ต้องตรวจทาน - การตรวจสอบอนุกรมวิธานแบบเต็ม</span>
        </div>
  ...
  <Accordion title="Gateway เว็บแอป - 6 ด้าน">
    <p className="maturity-readiness-summary">3 ต้องตรวจทาน / 3 ตรวจทานบางส่วนแล้ว</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>ด้าน</span><span>ฟีเจอร์ / ID ความครอบคลุม</span><span>การติดตามผล</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">การเข้าถึงและความน่าเชื่อถือของเบราว์เซอร์</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">ต้องตรวจทาน - การตรวจสอบอนุกรมวิธานแบบเต็ม</span>
        </div>
        <span>0 จาก 5 (0%) / 0 จาก 5 (0%)</span>
        <span>ช่องว่างด้านความสามารถ 5 รายการ</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">คอนโซลผู้ปฏิบัติการ</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">ตรวจทานบางส่วนแล้ว - การตรวจสอบอนุกรมวิธานแบบเต็ม</span>
        </div>
        <span>0 จาก 10 (0%) / 1 จาก 12 (8.3%)</span>
        <span>ช่องว่างด้านความสามารถ 11 รายการ</span>
  ...
  <Accordion title="เฟรมเวิร์กช่องทาง - 8 ด้าน">
    <p className="maturity-readiness-summary">4 ต้องตรวจทาน / 4 ตรวจทานบางส่วนแล้ว</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>ด้าน</span><span>ฟีเจอร์ / ID ความครอบคลุม</span><span>การติดตามผล</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">การดำเนินการ คำสั่ง และการอนุมัติของช่องทาง</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">ต้องตรวจทาน - การตรวจสอบอนุกรมวิธานแบบเต็ม</span>
        </div>
        <span>0 จาก 5 (0%) / 0 จาก 5 (0%)</span>
        <span>ช่องว่างด้านความสามารถ 5 รายการ</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">การเข้าถึงขาเข้าและด่านข้อมูลประจำตัว</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">ต้องตรวจทาน - การตรวจสอบอนุกรมวิธานแบบเต็ม</span>
        </div>
        <span>0 จาก 5 (0%) / 0 จาก 5 (0%)</span>
        <span>ช่องว่างด้านความสามารถ 5 รายการ</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">การส่งมอบขาออกและไปป์ไลน์การตอบกลับ</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">ตรวจทานบางส่วนแล้ว - การตรวจสอบอนุกรมวิธานแบบเต็ม</span>
        </div>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">สถานะ ความสมบูรณ์ และการควบคุมของผู้ปฏิบัติการ</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">ต้องตรวจทาน - การตรวจสอบอนุกรมวิธานแบบเต็ม</span>
        </div>
  ...
  <Accordion title="CLI - 7 ด้าน">
    <p className="maturity-readiness-summary">ต้องตรวจทาน 5 รายการ / ตรวจทานแล้วบางส่วน 2 รายการ</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>ด้าน</span><span>ฟีเจอร์ / ID ความครอบคลุม</span><span>การติดตามผล</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          ...
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">ตรวจทานแล้วบางส่วน - การตรวจสอบความถูกต้องของอนุกรมวิธานทั้งหมด</span>
        </div>
  ...
  <Accordion title="การโฮสต์ด้วย Docker และ Podman - 4 ด้าน">
    <p className="maturity-readiness-summary">ต้องตรวจทาน 3 รายการ / ตรวจทานแล้วบางส่วน 1 รายการ</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>ด้าน</span><span>ฟีเจอร์ / ID ความครอบคลุม</span><span>การติดตามผล</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">แซนด์บ็อกซ์และเครื่องมือของเอเจนต์</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">ต้องตรวจทาน - การตรวจสอบความถูกต้องของอนุกรมวิธานทั้งหมด</span>
        </div>
        <span>0 จาก 3 (0%) / 0 จาก 3 (0%)</span>
        <span>ช่องว่างด้านความสามารถ 3 รายการ</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">การเผยแพร่และการตรวจสอบความถูกต้องของอิมเมจ</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">ตรวจทานแล้วบางส่วน - การตรวจสอบความถูกต้องของอนุกรมวิธานทั้งหมด</span>
        </div>
  ...
  <Accordion title="Feishu, QQ Bot, WeChat, Yuanbao, Zalo, Zalo Personal, ช่องทางภูมิภาค - 4 ด้าน">
    ...
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>ด้าน</span><span>คุณสมบัติ / ID ความครอบคลุม</span><span>การติดตามผล</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">การเข้าถึงและตัวตน</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">ต้องตรวจสอบ - การตรวจสอบอนุกรมวิธานเต็มรูปแบบ</span>
        </div>
        <span>0 จาก 1 (0%) / 0 จาก 1 (0%)</span>
        <span>ช่องว่างด้านความสามารถ 1 รายการ</span>
      </div>
  ...
  <Accordion title="รันไทม์ Gateway - 13 ด้าน">
    <p className="maturity-readiness-summary">ต้องตรวจสอบ 9 รายการ / ตรวจสอบแล้วบางส่วน 4 รายการ</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>ด้าน</span><span>คุณสมบัติ / ID ความครอบคลุม</span><span>การติดตามผล</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          ...
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">ตรวจสอบแล้วบางส่วน - การตรวจสอบอนุกรมวิธานเต็มรูปแบบ</span>
        </div>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">API และเหตุการณ์ RPC ของ Gateway</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">ตรวจสอบแล้วบางส่วน - การตรวจสอบอนุกรมวิธานเต็มรูปแบบ</span>
        </div>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">สุขภาพ การวินิจฉัย และการซ่อมแซม</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">ต้องตรวจสอบ - การตรวจสอบอนุกรมวิธานเต็มรูปแบบ</span>
        </div>
        <span>0 จาก 7 (0%) / 0 จาก 7 (0%)</span>
        <span>ช่องว่างด้านความสามารถ 7 รายการ</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">API ของ HTTP</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">ตรวจสอบแล้วบางส่วน - การตรวจสอบอนุกรมวิธานเต็มรูปแบบ</span>
        </div>
  ...
  <Accordion title="เส้นทางผู้ให้บริการ Google - 5 พื้นที่">
    <p className="maturity-readiness-summary">5 รายการต้องตรวจทาน</p>
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">การแคชพรอมป์</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">ต้องตรวจทาน - การตรวจสอบอนุกรมวิธานแบบเต็ม</span>
        </div>
        <span>0 จาก 5 (0%) / 0 จาก 5 (0%)</span>
        <span>ช่องว่างด้านความสามารถ 5 รายการ</span>
  ...
  <Accordion title="เครื่องมือสร้างภาพ วิดีโอ และเพลง - 5 พื้นที่">
    <p className="maturity-readiness-summary">5 รายการต้องตรวจทาน</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>พื้นที่</span><span>ฟีเจอร์ / ID ความครอบคลุม</span><span>การติดตามผล</span></div>
      <div className="maturity-readiness-row">
  ...
  <Accordion title="iMessage และ BlueBubbles - 5 พื้นที่">
    <p className="maturity-readiness-summary">5 รายการต้องตรวจทาน</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>พื้นที่</span><span>ฟีเจอร์ / ID ความครอบคลุม</span><span>การติดตามผล</span></div>
      <div className="maturity-readiness-row">
  ...
  <Accordion title="แอป iOS - 8 พื้นที่">
    <p className="maturity-readiness-summary">8 รายการต้องตรวจทาน</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>พื้นที่</span><span>ฟีเจอร์ / ID ความครอบคลุม</span><span>การติดตามผล</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">การจัดจำหน่าย</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">ต้องตรวจทาน - การตรวจสอบอนุกรมวิธานแบบเต็ม</span>
        </div>
        <span>0 จาก 1 (0%) / 0 จาก 1 (0%)</span>
        <span>ช่องว่างด้านความสามารถ 1 รายการ</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">การแจ้งเตือนและเบื้องหลัง</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">ต้องตรวจทาน - การตรวจสอบอนุกรมวิธานแบบเต็ม</span>
        </div>
        <span>0 จาก 1 (0%) / 0 จาก 1 (0%)</span>
        <span>ช่องว่างด้านความสามารถ 1 รายการ</span>
  ...
  <Accordion title="การโฮสต์ Kubernetes - 4 ด้าน">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">การกำหนดค่าและความลับ</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">ต้องตรวจสอบ - การตรวจสอบอนุกรมวิธานทั้งหมด</span>
        </div>
        <span>0 จาก 5 (0%) / 0 จาก 5 (0%)</span>
        <span>ช่องว่างด้านความสามารถ 5 รายการ</span>
  ...
  <Accordion title="แอปคู่หูบน Linux - 5 ด้าน">
    <p className="maturity-readiness-summary">ต้องตรวจสอบ 5 รายการ</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>ด้าน</span><span>ฟีเจอร์ / ID ความครอบคลุม</span><span>การติดตามผล</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">การจัดจำหน่ายแอป</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">ต้องตรวจสอบ - การตรวจสอบอนุกรมวิธานทั้งหมด</span>
        </div>
        <span>0 จาก 3 (0%) / 0 จาก 3 (0%)</span>
        <span>ช่องว่างด้านความสามารถ 3 รายการ</span>
  ...
  <Accordion title="ผู้ให้บริการโมเดลภายในเครื่อง: Ollama, vLLM, SGLang, LM Studio - 5 ด้าน">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">หน่วยความจำและ Embeddings ภายในเครื่อง</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">ต้องตรวจสอบ - การตรวจสอบอนุกรมวิธานทั้งหมด</span>
        </div>
        <span>0 จาก 5 (0%) / 0 จาก 5 (0%)</span>
        <span>ช่องว่างด้านความสามารถ 5 รายการ</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">ความปลอดภัยของเครือข่ายและการควบคุมพรอมป์ต์</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">ต้องตรวจสอบ - การตรวจสอบอนุกรมวิธานทั้งหมด</span>
        </div>
        <span>0 จาก 2 (0%) / 0 จาก 2 (0%)</span>
        <span>ช่องว่างด้านความสามารถ 2 รายการ</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">ความเข้ากันได้ของรันไทม์ที่เข้ากันได้กับ OpenAI</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">ต้องตรวจสอบ - การตรวจสอบอนุกรมวิธานทั้งหมด</span>
        </div>
        <span>0 จาก 8 (0%) / 0 จาก 8 (0%)</span>
        <span>ช่องว่างด้านความสามารถ 8 รายการ</span>
  ...
  <Accordion title="ผู้ให้บริการแบบโฮสต์กลุ่ม Long-tail - 3 ด้าน">
  ...
  <Accordion title="แอปคู่หู macOS - 8 ด้าน">
    <p className="maturity-readiness-summary">ต้องตรวจทาน 8 รายการ</p>
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          ...
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">ต้องตรวจทาน - การตรวจสอบอนุกรมวิธานแบบครบถ้วน</span>
        </div>
        <span>0 จาก 4 (0%) / 0 จาก 4 (0%)</span>
        <span>ช่องว่างด้านความสามารถ 4 รายการ</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">การตั้งค่าภายในเครื่อง</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">ต้องตรวจทาน - การตรวจสอบอนุกรมวิธานแบบครบถ้วน</span>
        </div>
        <span>0 จาก 7 (0%) / 0 จาก 7 (0%)</span>
        <span>ช่องว่างด้านความสามารถ 7 รายการ</span>
  ...
  <Accordion title="โฮสต์ macOS Gateway - 7 ด้าน">
    <p className="maturity-readiness-summary">ต้องตรวจทาน 7 รายการ</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>ด้าน</span><span>ฟีเจอร์ / รหัสความครอบคลุม</span><span>การติดตามผล</span></div>
      <div className="maturity-readiness-row">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">การวินิจฉัยและความสามารถในการสังเกต</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">ต้องตรวจทาน - การตรวจสอบอนุกรมวิธานแบบครบถ้วน</span>
        </div>
        <span>0 จาก 4 (0%) / 0 จาก 4 (0%)</span>
        <span>ช่องว่างด้านความสามารถ 4 รายการ</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">การผสานรวม Gateway ภายในเครื่อง</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">ต้องตรวจทาน - การตรวจสอบอนุกรมวิธานแบบครบถ้วน</span>
        </div>
        <span>0 จาก 9 (0%) / 0 จาก 9 (0%)</span>
        <span>ช่องว่างด้านความสามารถ 9 รายการ</span>
  ...
  <Accordion title="Mattermost, LINE, IRC, Nextcloud Talk, Nostr, Twitch, Tlon, Synology Chat - 4 ด้าน">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">การเข้าถึงและตัวตน</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">ต้องตรวจทาน - การตรวจสอบความถูกต้องของอนุกรมวิธานเต็มรูปแบบ</span>
        </div>
        <span>0 จาก 1 (0%) / 0 จาก 1 (0%)</span>
        <span>1 ช่องว่างความสามารถ</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">การตั้งค่าและการดำเนินงานของช่องทาง</span>
  ...
  <Accordion title="การทำความเข้าใจสื่อและการสร้างสื่อ - 6 ด้าน">
    <p className="maturity-readiness-summary">4 ต้องตรวจทาน / 2 ตรวจทานบางส่วนแล้ว</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>ด้าน</span><span>ฟีเจอร์ / ID ความครอบคลุม</span><span>การติดตามผล</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
        ...
        <span>0 จาก 5 (0%) / 0 จาก 5 (0%)</span>
        <span>5 ช่องว่างความสามารถ</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          ...
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">ตรวจทานบางส่วนแล้ว - การตรวจสอบความถูกต้องของอนุกรมวิธานเต็มรูปแบบ</span>
        </div>
        <span>1 จาก 17 (5.9%) / 1 จาก 19 (5.3%)</span>
        <span>18 ช่องว่างความสามารถ</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
        ...
        <span>0 จาก 8 (0%) / 0 จาก 8 (0%)</span>
        <span>8 ช่องว่างความสามารถ</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
        ...
        <span>13 ช่องว่างความสามารถ</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">การส่งเสียงพูดจากข้อความ</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">ต้องตรวจทาน - การตรวจสอบความถูกต้องของอนุกรมวิธานเต็มรูปแบบ</span>
        </div>
        <span>0 จาก 2 (0%) / 0 จาก 2 (0%)</span>
        <span>2 ช่องว่างความสามารถ</span>
      </div>
    </div>
  </Accordion>
  ...
  <Accordion title="Microsoft Teams - 5 ด้าน">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        ...
        <span>0 จาก 9 (0%) / 0 จาก 9 (0%)</span>
        <span>9 ช่องว่างความสามารถ</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">การตั้งค่าและการดำเนินงานของช่องทาง</span>
  ...
  <Accordion title="Windows แบบเนทีฟ - 4 ด้าน">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        ...
        <span>0 จาก 11 (0%) / 0 จาก 11 (0%)</span>
        <span>11 ช่องว่างความสามารถ</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
        ...
        <span>0 จาก 4 (0%) / 0 จาก 4 (0%)</span>
        <span>4 ช่องว่างความสามารถ</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
  ...
  <Accordion title="แอปคู่หู Windows แบบเนทีฟ - 5 ด้าน">
    <p className="maturity-readiness-summary">5 ต้องตรวจทาน</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>ด้าน</span><span>ฟีเจอร์ / รหัสความครอบคลุม</span><span>การติดตามผล</span></div>
      <div className="maturity-readiness-row">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">เครื่องมือเดสก์ท็อปและสิทธิ์อนุญาต</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">ต้องตรวจทาน - การตรวจสอบอนุกรมวิธานแบบเต็ม</span>
        </div>
        <span>0 จาก 10 (0%) / 0 จาก 10 (0%)</span>
        <span>ช่องว่างด้านความสามารถ 10 รายการ</span>
  ...
  <Accordion title="เส้นทางการติดตั้ง Nix - 5 ด้าน">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">รันไทม์บริการและการป้องกัน</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">ต้องตรวจทาน - การตรวจสอบอนุกรมวิธานแบบเต็ม</span>
        </div>
        <span>0 จาก 8 (0%) / 0 จาก 8 (0%)</span>
        <span>ช่องว่างด้านความสามารถ 8 รายการ</span>
  ...
  <Accordion title="เส้นทางผู้ให้บริการ OpenAI และ Codex - 5 ด้าน">
    <p className="maturity-readiness-summary">2 ต้องตรวจทาน / 3 ตรวจทานบางส่วนแล้ว</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>ด้าน</span><span>ฟีเจอร์ / รหัสความครอบคลุม</span><span>การติดตามผล</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">ชุดทดสอบ Codex แบบเนทีฟ</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">ตรวจทานบางส่วนแล้ว - การตรวจสอบอนุกรมวิธานแบบเต็ม</span>
        </div>
  ...
  <Accordion title="เส้นทางผู้ให้บริการ OpenRouter - 4 ด้าน">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">รันไทม์แชตและการทำให้เป็นมาตรฐาน</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">ต้องตรวจทาน - การตรวจสอบอนุกรมวิธานแบบเต็ม</span>
        </div>
        <span>0 จาก 15 (0%) / 0 จาก 15 (0%)</span>
      ...
      <div className="maturity-readiness-row">
        ...
        <span>14 ช่องว่างด้านความสามารถ</span>
      </div>
    </div>
  </Accordion>

  <Accordion title="Plugin - 9 ด้าน">
    <p className="maturity-readiness-summary">6 ต้องตรวจทาน / 3 ตรวจทานบางส่วนแล้ว</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>ด้าน</span><span>ฟีเจอร์ / ID ความครอบคลุม</span><span>การติดตามผล</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">การเขียนและการจัดแพ็กเกจ Plugin</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">ต้องตรวจทาน - การตรวจสอบอนุกรมวิธานแบบเต็ม</span>
        </div>
        <span>0 จาก 8 (0%) / 0 จาก 8 (0%)</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Plugin ที่มาพร้อมชุด</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">ต้องตรวจทาน - การตรวจสอบอนุกรมวิธานแบบเต็ม</span>
        </div>
        <span>0 จาก 5 (0%) / 0 จาก 5 (0%)</span>
        <span>5 ช่องว่างด้านความสามารถ</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">การติดตั้งและการรัน Plugin</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">ตรวจทานบางส่วนแล้ว - การตรวจสอบอนุกรมวิธานแบบเต็ม</span>
        </div>
      ...
      <div className="maturity-readiness-row">
        ...
        <span>12 ช่องว่างด้านความสามารถ</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
  ...
  <Accordion title="Raspberry Pi และอุปกรณ์ Linux ขนาดเล็ก - 4 ด้าน">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        ...
        <span>0 จาก 9 (0%) / 0 จาก 9 (0%)</span>
        <span>9 ช่องว่างด้านความสามารถ</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
  ...
  <Accordion title="ความปลอดภัย การยืนยันตัวตน การจับคู่ และความลับ - 6 ด้าน">
    <p className="maturity-readiness-summary">2 ตรวจทานบางส่วนแล้ว / 4 ต้องตรวจทาน</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>ด้าน</span><span>ฟีเจอร์ / ID ความครอบคลุม</span><span>การติดตามผล</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">นโยบายการอนุมัติและการป้องกันเครื่องมือ</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">ตรวจทานบางส่วนแล้ว - การตรวจสอบอนุกรมวิธานแบบเต็ม</span>
        </div>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">สุขอนามัยของข้อมูลรับรองและความลับ</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">ตรวจทานบางส่วนแล้ว - การตรวจสอบอนุกรมวิธานแบบเต็ม</span>
        </div>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">การยืนยันตัวตน Gateway และการเข้าถึงระยะไกล</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">ต้องตรวจทาน - การตรวจสอบอนุกรมวิธานแบบเต็ม</span>
        </div>
        <span>0 จาก 9 (0%) / 0 จาก 9 (0%)</span>
        <span>9 ช่องว่างด้านความสามารถ</span>
  ...
  <Accordion title="เซสชัน ความจำ และเอนจินบริบท - 9 ด้าน">
    <p className="maturity-readiness-summary">2 ต้องตรวจทาน / 7 ตรวจทานบางส่วนแล้ว</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>ด้าน</span><span>ฟีเจอร์ / ID ความครอบคลุม</span><span>การติดตามผล</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">การจัดการเซสชัน CLI และบันทึกถอดความ</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">ต้องตรวจทาน - การตรวจสอบอนุกรมวิธานฉบับเต็ม</span>
        </div>
        <span>0 จาก 2 (0%) / 0 จาก 2 (0%)</span>
        <span>2 ช่องว่างด้านความสามารถ</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          ...
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">ตรวจทานบางส่วนแล้ว - การตรวจสอบอนุกรมวิธานฉบับเต็ม</span>
        </div>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">ความจำ</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">ตรวจทานบางส่วนแล้ว - การตรวจสอบอนุกรมวิธานฉบับเต็ม</span>
        </div>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">การคงอยู่ของบันทึกถอดความ</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">ต้องตรวจทาน - การตรวจสอบอนุกรมวิธานฉบับเต็ม</span>
        </div>
        <span>0 จาก 2 (0%) / 0 จาก 2 (0%)</span>
        <span>2 ช่องว่างด้านความสามารถ</span>
  ...
  <Accordion title="Signal - 5 ด้าน">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        ...
        <span>0 จาก 1 (0%) / 0 จาก 1 (0%)</span>
        <span>1 ช่องว่างด้านความสามารถ</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
  ...
  <Accordion title="ความสามารถในการสังเกตการณ์ - 5 ด้าน">
    <p className="maturity-readiness-summary">ตรวจทานบางส่วนแล้ว 3 รายการ / ต้องตรวจทาน 2 รายการ</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>ด้าน</span><span>ฟีเจอร์ / ID ความครอบคลุม</span><span>การติดตามผล</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">สถานภาพและการซ่อมแซม</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">ตรวจทานบางส่วนแล้ว - การตรวจสอบความถูกต้องของอนุกรมวิธานทั้งหมด</span>
        </div>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">การส่งออกเทเลเมทรี</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">ตรวจทานบางส่วนแล้ว - การตรวจสอบความถูกต้องของอนุกรมวิธานทั้งหมด</span>
        </div>
  ...
  <Accordion title="TUI - 5 ด้าน">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">การป้อนข้อมูลและคำสั่ง</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">ต้องตรวจทาน - การตรวจสอบความถูกต้องของอนุกรมวิธานทั้งหมด</span>
        </div>
        <span>0 จาก 8 (0%) / 0 จาก 8 (0%)</span>
        <span>ช่องว่างด้านความสามารถ 8 รายการ</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">การเรนเดอร์และความปลอดภัยของเอาต์พุต</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">ต้องตรวจทาน - การตรวจสอบความถูกต้องของอนุกรมวิธานทั้งหมด</span>
        </div>
        <span>0 จาก 4 (0%) / 0 จาก 4 (0%)</span>
        <span>ช่องว่างด้านความสามารถ 4 รายการ</span>
  ...
  <Accordion title="เสียงและการสนทนาแบบเรียลไทม์ - 6 ด้าน">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">การสนทนาในแอปเนทีฟ</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">ต้องตรวจทาน - การตรวจสอบความถูกต้องของอนุกรมวิธานทั้งหมด</span>
        </div>
        <span>0 จาก 4 (0%) / 0 จาก 4 (0%)</span>
        <span>ช่องว่างด้านความสามารถ 4 รายการ</span>
  ...
  <Accordion title="ช่องทาง Voice Call - 5 ด้าน">
    <p className="maturity-readiness-summary">ต้องตรวจทาน 5 รายการ</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>ด้าน</span><span>ฟีเจอร์ / ID ความครอบคลุม</span><span>การติดตามผล</span></div>
      <div className="maturity-readiness-row">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">เสียงแบบเรียลไทม์และการโทร</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">ต้องตรวจทาน - การตรวจสอบความถูกต้องของอนุกรมวิธานทั้งหมด</span>
        </div>
        <span>0 จาก 2 (0%) / 0 จาก 2 (0%)</span>
        <span>ช่องว่างด้านความสามารถ 2 รายการ</span>
  ...
  <Accordion title="พื้นผิวคู่หูของ watchOS - 5 ด้าน">
    <p className="maturity-readiness-summary">5 รายการต้องตรวจทาน</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>ด้าน</span><span>ฟีเจอร์ / ID ความครอบคลุม</span><span>การติดตามผล</span></div>
      <div className="maturity-readiness-row">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">การแจกจ่ายและการสนับสนุน</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">ต้องตรวจทาน - การตรวจสอบอนุกรมวิธานแบบครบถ้วน</span>
        </div>
        <span>0 จาก 6 (0%) / 0 จาก 6 (0%)</span>
        <span>ช่องว่างด้านความสามารถ 6 รายการ</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">UI ของแอปนาฬิกา</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">ต้องตรวจทาน - การตรวจสอบอนุกรมวิธานแบบครบถ้วน</span>
        </div>
        <span>0 จาก 3 (0%) / 0 จาก 3 (0%)</span>
        <span>ช่องว่างด้านความสามารถ 3 รายการ</span>
  ...
  <Accordion title="เครื่องมือค้นหาเว็บ - 4 ด้าน">
    <p className="maturity-readiness-summary">2 รายการต้องตรวจทาน / 2 รายการตรวจทานบางส่วนแล้ว</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>ด้าน</span><span>ฟีเจอร์ / ID ความครอบคลุม</span><span>การติดตามผล</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          ...
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">ตรวจทานบางส่วนแล้ว - การตรวจสอบอนุกรมวิธานแบบครบถ้วน</span>
        </div>
  ...
  <Accordion title="Windows ผ่าน WSL2 - 6 ด้าน">
    <p className="maturity-readiness-summary">5 รายการต้องตรวจทาน / 1 รายการตรวจทานบางส่วนแล้ว</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>ด้าน</span><span>ฟีเจอร์ / ID ความครอบคลุม</span><span>การติดตามผล</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
