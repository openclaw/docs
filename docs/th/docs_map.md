...
title: แผนผังเอกสาร
x-i18n:
    generated_at: "2026-06-30T22:40:23Z"
    model: gpt-5.5
...
- หัวข้อ:
  ...
  - H2: ข้อมูลรับรองโทเคน
  - H3: กฎคุณสมบัติ
  - H3: กฎการแปลงค่า
  - H2: ความสามารถในการพกพาสำเนาเอเจนต์
  - H2: เส้นทางการยืนยันตัวตนเฉพาะคอนฟิก
  - H2: การกรองลำดับการยืนยันตัวตนแบบระบุชัดเจน
  - H2: การแปลงค่าเป้าหมายโพรบ
...
- หัวข้อ:
  ...
  - H3: การตั้งค่าครั้งเดียวด้วยตนเอง
...
- หัวข้อ:
  ...
  - H3: คอนฟิก bootstrap-extra-files
...
- หัวข้อ:
  ...
  - H3: โหมดจัดการ
  - H3: โหมดมิเรอร์
  - H2: สถานะคงทนและการติดตามรีวิชัน
...
- หัวข้อ:
  ...
  - H2: เมื่อใดที่การย้ายระบบนี้เหมาะสม
  - H2: imsg ทำอะไร
  - H2: ก่อนเริ่มต้น
  - H2: การแปลคอนฟิก
...
- หัวข้อ:
  ...
  - H2: การเขียนคอนฟิก
  - H2: การรวม DM แบบส่งแยก (คำสั่ง + URL ในการเขียนเดียว)
  - H3: สถานการณ์และสิ่งที่เอเจนต์เห็น
  - H2: การกู้คืนขาเข้าหลังจากบริดจ์หรือ Gateway รีสตาร์ท
...
- หัวข้อ:
  ...
  - H2: ข้อความทั่วไปและความหมายของข้อความเหล่านั้น
...
- หัวข้อ:
  ...
  - H3: กฎ push แบบโฮสต์เองสำหรับตัวอย่างสุดท้ายที่เงียบ
  - H2: ห้องบอตต่อบอต
...
- หัวข้อ:
  ...
  - H3: ขั้นตอนที่ 5: สร้าง Manifest ของ Teams App
  ...
  - H2: ตัวอย่าง manifest ของ Teams (ปกปิดข้อมูลแล้ว)
  ...
  - H2: ID ทีมและช่องทาง (จุดที่มักพลาด)
  - H2: ช่องทางส่วนตัว
  - H2: การแก้ไขปัญหา
  - H3: ปัญหาทั่วไป
...
- หัวข้อ:
  - H2: Plugin ที่รวมมาให้
  - H3: การติดตั้งรุ่นเก่าหรือแบบกำหนดเอง
...
- หัวข้อ:
  ...
  - H3: การอนุมัติอัตโนมัติสำหรับ Node ตาม trusted-CIDR แบบไม่บังคับ
...
- หัวข้อ:
  ...
  - H2: อีเวนต์และพฤติกรรมการปฏิบัติการ
  - H2: อ้างอิงการกำหนดค่า
  - H2: การแก้ไขปัญหา
...
- หัวข้อ:
  ...
  - H3: การทดสอบแบบ end-to-end จาก macOS iMessage/SMS
  - H2: ความปลอดภัยของ Webhook
  - H2: ค่ากำหนดหลายบัญชี
  - H2: การแก้ไขปัญหา
  - H3: Twilio ส่งกลับ 403 หรือ OpenClaw ปฏิเสธ Webhook
...
- หัวข้อ:
  ...
  - H2: โมเดลรันไทม์
  - H2: พรอมต์การอนุมัติ
  - H2: Hook ของ Plugin และความเป็นส่วนตัว
  - H2: การควบคุมการเข้าถึงและการเปิดใช้งาน
...
- หัวข้อ:
  ...
  - H3: 2) กำหนดค่าโทเค็น (env หรือการกำหนดค่า)
  - H2: วิธีการทำงาน (พฤติกรรม)
  - H2: ขีดจำกัด
  - H2: การควบคุมการเข้าถึง (DM)
  - H3: การเข้าถึง DM
...
- หัวข้อ:
  ...
  - H3: 1. ติดตั้ง Plugin
  - H3: 2. เปิดใช้ Plugin ในการกำหนดค่า
...
- หัวข้อ:
  ...
  - H2: การเรียกใช้งานด้วยตนเอง
  - H2: Runner
  - H2: งบประมาณการลงทะเบียน Runner
  - H2: สิ่งที่เทียบเท่าในเครื่อง
  - H2: ประสิทธิภาพของ OpenClaw
  - H2: การตรวจสอบ Release แบบเต็ม
  - H2: Shard แบบ Live และ E2E
  - H2: การยอมรับแพ็กเกจ
  - H3: งาน
  - H3: แหล่งที่มาของ Candidate
  - H3: โปรไฟล์ Suite
  - H3: หน้าต่างความเข้ากันได้กับรุ่นเก่า
  - H3: ตัวอย่าง
  - H2: Smoke การติดตั้ง
  - H2: Docker E2E ในเครื่อง
  - H3: ค่าที่ปรับได้
  - H3: เวิร์กโฟลว์ Live/E2E ที่ใช้ซ้ำได้
  - H3: ชิ้นส่วนเส้นทาง Release
  - H2: Prerelease ของ Plugin
  - H2: QA Lab
  - H2: CodeQL
  - H3: หมวดหมู่ความปลอดภัย
  - H3: Shard ความปลอดภัยเฉพาะแพลตฟอร์ม
  - H3: หมวดหมู่คุณภาพสำคัญ
  - H2: เวิร์กโฟลว์การบำรุงรักษา
  - H3: เอเจนต์เอกสาร
  - H3: เอเจนต์ประสิทธิภาพการทดสอบ
  - H3: PR ซ้ำหลัง Merge
  - H2: Gate การตรวจสอบในเครื่องและการกำหนดเส้นทางตามการเปลี่ยนแปลง
  - H2: การตรวจสอบด้วย Testbox
  - H2: ที่เกี่ยวข้อง
...
- หัวข้อ:
  ...
  - H2: การแก้ไขปัญหาแบบรวดเร็ว
  - H2: วงจรชีวิต
  - H2: หากไม่มีคำสั่ง
  - H2: โปรไฟล์
  - H2: แท็บ
  - H2: Snapshot / ภาพหน้าจอ / การทำงาน
...
- หัวข้อ:
  ...
  - H2: คำสั่งทั่วไป
  - H2: สถานะ / ความสามารถ / แก้ชื่อ / บันทึก
  - H2: เพิ่ม / ลบบัญชี
...
- หัวข้อ:
  ...
  - H2: Query Gateway ที่กำลังรันอยู่
  - H3: gateway health
...
- หัวข้อ:
  ...
  - H3: สถานะสำหรับคลังเก็บเท่านั้น
  - H3: หลังจากนำไปใช้
  - H2: สัญญา Plugin
...
- หัวข้อ:
  ...
  - H3: สถานะโมเดล
  - H2: นามแฝง + fallback
  - H2: โปรไฟล์การรับรองความถูกต้อง
  - H2: ที่เกี่ยวข้อง
...
- หัวข้อ:
  ...
  - H2: รัน (foreground)
  - H2: การรับรองความถูกต้อง Gateway สำหรับโฮสต์ node
...
- หัวข้อ:
  ...
  - H4: ความลับ
  - H4: การอนุมัติ exec
  - H4: โปรไฟล์การรับรองความถูกต้อง
...
- หัวข้อ:
  ...
  - H3: หลังจากเปลี่ยนเป้าหมาย SSH หรือวัสดุรับรองความถูกต้อง SSH
  - H3: หลังจากเปลี่ยนแหล่งที่มา นโยบาย หรือโหมดของ OpenShell
...
- หัวข้อ:
  ...
  - H3: wiki obsidian ...
  - H2: คำแนะนำการใช้งานเชิงปฏิบัติ
  - H2: จุดเชื่อมโยงการกำหนดค่า
  - H2: ที่เกี่ยวข้อง
...
- หัวข้อ:
  ...
  - H2: show
  - H2: dispatch
  - H2: ความเท่าเทียมกับ Slash Command
  - H2: สิทธิ์
  - H2: การแก้ไขปัญหา
  - H3: ไม่มีการ์ดปรากฏ
...
- หัวข้อ:
  ...
  - H2: ไฟล์บูตสแตรป (ฉีดเข้าไป)
  - H2: เครื่องมือในตัว
  - H2: Skills
  - H2: ขอบเขตรันไทม์
  - H2: เซสชัน
  - H2: การควบคุมขณะสตรีม
  - H2: การอ้างอิงโมเดล
...
- หัวข้อ:
  ...
  - H3: โหนด (macOS / iOS / Android / แบบไม่มีหน้าจอ)
  - H3: WebChat
...
- หัวข้อ:
  - H2: เริ่มต้นอย่างรวดเร็ว
  - H2: วิธีการทำงาน
  - H3: วงจรชีวิตซับเอเจนต์ (ไม่บังคับ)
...
- หัวข้อ:
  ...
  - H2: ไฟล์พื้นที่ทำงานที่ฉีดเข้าไป (บริบทโปรเจกต์)
  - H2: Skills: ฉีดเข้าไปเทียบกับโหลดเมื่อจำเป็น
...
- หัวข้อ:
  ...
  - H2: ความครอบคลุมของรายงานการทดลองเงา QA
  - H2: การจัดตารางเวลา
  - H2: เริ่มต้นอย่างรวดเร็ว
  - H2: คำสั่งสแลช
  - H2: เวิร์กโฟลว์ CLI
...
- หัวข้อ:
  ...
  - H2: โหมดเบาสำหรับโมเดลในเครื่อง
  - H3: ทำไมจึงเป็นเครื่องมือสามอย่างนี้
...
- หัวข้อ:
  ...
  - H2: Dreaming
  - H2: การเติมย้อนหลังแบบมีหลักฐานและการโปรโมตแบบสด
  - H2: CLI
  - H2: อ่านเพิ่มเติม
  - H2: ที่เกี่ยวข้อง
...
- หัวข้อ:
  ...
  - H3: เฟส 8: ลบความเข้ากันได้ที่ตั้งชื่อตามเทิร์น
  - H2: แผนการทดสอบ
  - H2: คำถามที่เปิดอยู่
  - H2: เกณฑ์การยอมรับ
  - H2: ที่เกี่ยวข้อง
...
- หัวข้อ:
  ...
  - H2: การตัดรายการซ้ำขาเข้า
  - H2: การหน่วงขาเข้า
  - H2: เซสชันและอุปกรณ์
  - H2: เมตาดาตาผลลัพธ์เครื่องมือ
  - H2: เนื้อหาขาเข้าและบริบทประวัติ
  - H2: การเข้าคิวและการติดตามผล
  - H2: ความเป็นเจ้าของการรันช่องทาง
  - H2: การสตรีม การแบ่งชิ้น และการแบตช์
  - H2: การมองเห็นการให้เหตุผลและโทเคน
...
- หัวข้อ:
  ...
  - H2: ประกาศ fallback ที่ผู้ใช้เห็นได้
  - H2: การจัดเก็บการยืนยันตัวตน (คีย์ + OAuth)
  - H2: ID โปรไฟล์
  - H2: ลำดับการหมุนเวียน
  - H3: ความเหนียวของเซสชัน (เป็นมิตรต่อแคช)
  - H3: การสมัครสมาชิก OpenAI Codex พร้อมคีย์ API สำรอง
  - H2: ช่วงพัก
  - H2: การปิดใช้งานจากการเรียกเก็บเงิน
  - H2: fallback ของโมเดล
  - H3: กฎห่วงโซ่ตัวเลือก
...
- หัวข้อ:
  ...
  - H3: OpenCode
  - H3: Google Gemini (คีย์ API)
  - H3: Google Vertex และ Gemini CLI
  - H3: Z.AI (GLM)
  - H3: Vercel AI Gateway
  - H3: Plugin ผู้ให้บริการแบบบันเดิลอื่น ๆ
  - H4: เกร็ดที่ควรรู้
...
- หัวข้อ:
  ...
  - H2: รูปแบบที่พบบ่อย
  - H2: แซนด์บ็อกซ์และการกำหนดค่าเครื่องมือต่อเอเจนต์
  - H2: ที่เกี่ยวข้อง
...
- หัวข้อ:
  - H2: ปลายทางรับโทเคน (เหตุผลที่มีอยู่)
  - H2: การจัดเก็บ (โทเคนอยู่ที่ไหน)
...
- หัวข้อ:
  - H2: ฟิลด์สถานะออนไลน์ (สิ่งที่แสดง)
  - H2: ผู้ผลิตข้อมูล (สถานะออนไลน์มาจากที่ใด)
...
- หัวข้อ:
  - H2: การสตรีมแบบบล็อก (ข้อความช่อง)
  - H3: การส่งสื่อด้วยการสตรีมแบบบล็อก
  - H2: อัลกอริทึมการแบ่งชิ้น (ขอบเขตต่ำ/สูง)
  - H2: การรวมกัน (ผสานบล็อกที่สตรีม)
  - H2: จังหวะแบบมนุษย์ระหว่างบล็อก
  - H2: "สตรีมเป็นชิ้นหรือทั้งหมด"
  - H2: โหมดสตรีมตัวอย่างก่อนดู
  - H3: การแมปช่อง
  - H3: พฤติกรรมรันไทม์
  - H3: การอัปเดตตัวอย่างก่อนดูความคืบหน้าของเครื่องมือ
  - H2: ที่เกี่ยวข้อง
...
- หัวข้อ:
  ...
  - H2: ตำแหน่งที่สคีมาอยู่
  - H2: ไปป์ไลน์ปัจจุบัน
  - H2: วิธีใช้สคีมาในรันไทม์
  - H2: เฟรมตัวอย่าง
  - H2: ไคลเอนต์ขั้นต่ำ (Node.js)
  - H2: ตัวอย่างที่ทำจริง: เพิ่มเมธอดตั้งแต่ต้นจนจบ
...
- หัวข้อ:
  ...
  - H2: เพย์โหลดเครื่องมือ + คอนเน็กเตอร์ (เวลาผู้ให้บริการดิบ + ฟิลด์ที่ทำให้เป็นมาตรฐาน)
  - H2: เอกสารที่เกี่ยวข้อง
...
- หัวข้อ:
  - H2: วิธีทำงาน
  - H2: เปิดใช้ผ่านการกำหนดค่า
  - H2: เขียนทับผ่าน env (ครั้งเดียว)
  - H2: แฟล็กการทำโปรไฟล์
  - H2: อาร์ติแฟกต์ไทม์ไลน์
  - H2: ตำแหน่งที่ล็อกไปอยู่
  - H2: แยกล็อกออกมา
  - H2: หมายเหตุ
  - H2: ที่เกี่ยวข้อง
...
- หัวข้อ:
  ...
  - H3: OpenAI และ id แบบเดิมของ openai-codex
  - H3: ระหว่างเข้าสู่ระบบ (CLI)
  - H3: ต่อเซสชัน (คำสั่งแชต)
  - H3: ต่อเอเจนต์ (การเขียนทับผ่าน CLI)
  - H2: การแก้ไขปัญหา
  - H3: "ไม่พบข้อมูลรับรอง"
  - H3: โทเค็นกำลังจะหมดอายุ/หมดอายุแล้ว
  - H2: ที่เกี่ยวข้อง
...
- หัวข้อ:
  ...
  - H3: การตั้งค่าเซิร์ฟเวอร์ DNS แบบครั้งเดียว (โฮสต์ Gateway)
...
- หัวข้อ:
  ...
  - H2: วิธีทำงาน
  - H2: เซสชัน
  - H2: พรีลูด fallback จากเซสชัน claude-cli
  - H2: รูปภาพ (ส่งผ่าน)
  - H2: อินพุต / เอาต์พุต
...
- หัวข้อ:
  ...
  - H3: การเขียนทับโปรไฟล์บูตสแตรปต่อเอเจนต์
...
- หัวข้อ:
  ...
  - H3: การเขียนทับโมเดลของช่อง
  - H3: ค่าเริ่มต้นของช่องและ Heartbeat
  - H3: WhatsApp
  - H3: Telegram
  - H3: Discord
  - H3: Google Chat
...
- หัวข้อ:
  ...
  - H3: กลุ่มเครื่องมือ
  - H3: MCP และเครื่องมือ Plugin ภายในนโยบายเครื่องมือ sandbox
  - H3: tools.codeMode
...
- หัวข้อ:
  ...
  - H3: repo Skills ข้างเคียงที่เชื่อมด้วย symlink
  - H2: รูปแบบทั่วไป
  ...
  - H3: โหมด DM แบบปลอดภัย (กล่องข้อความร่วม / DM หลายผู้ใช้)
  - H3: คีย์ API ของ Anthropic + MiniMax fallback
  - H3: บอททำงาน (การเข้าถึงแบบจำกัด)
...
- หัวข้อ:
  ...
  - H2: งานทั่วไป
  - H2: การ reload การกำหนดค่าแบบ hot
  - H3: โหมด reload
  - H3: สิ่งที่ใช้แบบ hot ได้เทียบกับสิ่งที่ต้อง restart
  - H3: การวางแผน reload
  - H2: RPC การกำหนดค่า (การอัปเดตผ่านโปรแกรม)
  - H2: ตัวแปรสภาพแวดล้อม
...
- หัวข้อ:
  ...
  - H2: อินพุตการค้นพบ (วิธีที่ไคลเอนต์รู้ว่า Gateway อยู่ที่ใด)
  ...
  - H2: การจับคู่ + auth (transport แบบ direct)
...
- หัวข้อ:
  ...
  - H2: สิ่งที่ทำ (สรุป)
  - H2: การ backfill และ reset UI Dreams
...
- หัวข้อ:
  ...
  - H2: ค่าเริ่มต้น
  - H2: พรอมป์ Heartbeat ใช้เพื่ออะไร
  - H2: สัญญาการตอบกลับ
  - H2: การกำหนดค่า
  - H3: ขอบเขตและลำดับความสำคัญ
  - H3: Heartbeat รายเอเจนต์
...
- หัวข้อ:
  ...
  - H2: เอกสารอ้างอิงด่วนของโปรโตคอล (มุมมองผู้ปฏิบัติการ)
...
- หัวข้อ:
  ...
  - H3: การกำหนดค่าแบบไฮบริด: hosted เป็นหลัก, local เป็น fallback
  - H3: local-first พร้อม hosted safety net
...
- หัวข้อ:
  ...
  - H3: ลูป follow-up ของเครื่องมือ
...
- หัวข้อ:
  ...
  - H3: OpenShell รายเอเจนต์พร้อม Gateway แบบกำหนดเอง
  - H2: การจัดการวงจรชีวิต
  - H3: เมื่อใดควรสร้างใหม่
  - H2: การ hardening ความปลอดภัย
  - H2: ข้อจำกัดปัจจุบัน
  - H2: วิธีการทำงาน
  - H2: ที่เกี่ยวข้อง
...
- หัวข้อ:
  - H2: วิธีที่ส่วนต่างๆ ทำงานร่วมกัน
  - H2: เริ่มต้นอย่างรวดเร็ว
  - H2: สัญญาณที่ export
  - H2: เอกสารอ้างอิงการกำหนดค่า
  - H3: ตัวแปรสภาพแวดล้อม
  ...
  - H3: Exec
  - H3: ภายในระบบวินิจฉัย (หน่วยความจำและลูปเครื่องมือ)
  - H2: spans ที่ export
  - H2: catalog เหตุการณ์วินิจฉัย
...
- หัวข้อ:
  - H2: บทบาท
  - H2: ระดับขอบเขต
  - H2: ขอบเขตเมธอดเป็นเพียงด่านแรกเท่านั้น
...
- หัวข้อ:
  ...
  - H2: การ gate คำสั่ง Node (2026.3.31+)
...
- หัวข้อ:
  ...
  - H2: นโยบาย label
  - H2: สูตร PromQL
  - H2: การเลือกระหว่าง Prometheus กับการ export OpenTelemetry
  - H2: การแก้ไขปัญหา
  - H2: ที่เกี่ยวข้อง
...
- หัวข้อ:
  ...
  - H3: เมธอดช่วยเหลือ Node
  - H3: RPC บัญชีรายการงาน
  - H3: เมธอดช่วยเหลือผู้ปฏิบัติการ
...
- หัวข้อ:
  - H1: การรัน OpenClaw.app ด้วย Remote Gateway
  - H2: ภาพรวม
  - H2: การตั้งค่าอย่างรวดเร็ว
  - H3: ขั้นตอนที่ 1: เพิ่มการกำหนดค่า SSH
  - H3: ขั้นตอนที่ 2: คัดลอกคีย์ SSH
  - H3: ขั้นตอนที่ 3: กำหนดค่า Auth ของ Remote Gateway
...
- หัวข้อ:
  ...
  - H3: macOS: อุโมงค์ SSH แบบถาวรผ่าน LaunchAgent
...
- หัวข้อ:
  ...
  - H2: ยกระดับ: `exec` เท่านั้น "รันบนโฮสต์"
  - H2: วิธีแก้ปัญหา "คุก sandbox" ที่พบบ่อย
  - H3: "เครื่องมือ X ถูกบล็อกโดยนโยบายเครื่องมือ sandbox"
...
- หัวข้อ:
  ...
  - H2: setupCommand (การตั้งค่า container ครั้งเดียว)
...
- หัวข้อ:
  ...
  - H2: พฤติกรรมการยินยอมของ exec provider
...
- หัวข้อ:
  ...
  - H2: การ preflight อ้างอิงการ onboarding
  - H2: สัญญา SecretRef
  - H2: การกำหนดค่า provider
  - H2: API keys ที่มีไฟล์เป็น backend
  - H2: ตัวอย่างการผสานรวม exec
  - H2: ตัวแปรสภาพแวดล้อมของ MCP server
...
- หัวข้อ:
  ...
  - H3: การล็อก dependency ของ package ที่เผยแพร่
  ...
  - H2: baseline แบบ hardened ใน 60 วินาที
  ...
  - H2: glossary การ audit ความปลอดภัย
  - H2: Control UI ผ่าน HTTP
  - H2: สรุป flags ที่ไม่ปลอดภัยหรืออันตราย
  - H2: การกำหนดค่า reverse proxy
  - H2: หมายเหตุ HSTS และ origin
  - H2: บันทึก session ภายในเครื่องอยู่บนดิสก์
  - H2: การรัน Node (`system.run`)
  - H2: Skills แบบ dynamic (watcher / nodes ระยะไกล)
  - H2: โมเดลภัยคุกคาม
  - H2: แนวคิดหลัก: การควบคุมการเข้าถึงมาก่อน intelligence
  ...
  - H2: การ sanitize special-token ของเนื้อหาภายนอก
  - H2: flags สำหรับ bypass เนื้อหาภายนอกที่ไม่ปลอดภัย
  - H3: Prompt injection ไม่จำเป็นต้องมี DM สาธารณะ
  - H3: Backend LLM แบบ self-hosted
  - H3: ความแข็งแรงของโมเดล (หมายเหตุด้านความปลอดภัย)
  - H2: Reasoning และ output แบบละเอียดในกลุ่ม
  - H2: ตัวอย่างการ hardening การกำหนดค่า
  - H3: สิทธิ์ไฟล์
  - H3: การเปิดเผยเครือข่าย (bind, port, firewall)
  - H3: การ publish port ของ Docker ด้วย UFW
  - H3: การค้นพบ mDNS/Bonjour
  - H3: ล็อก Gateway WebSocket (auth ภายในเครื่อง)
  - H3: headers ระบุตัวตนของ Tailscale Serve
  - H3: การควบคุม browser ผ่าน node host (แนะนำ)
  - H3: Secrets บนดิสก์
  - H3: ไฟล์ .env ของ workspace
  - H3: Logs และ transcripts (การ redaction และ retention)
  - H3: DM: pairing เป็นค่าเริ่มต้น
  ...
  - H2: ความเสี่ยงของการควบคุม browser
  ...
  - H3: ตัวอย่าง: ไม่มีการเข้าถึง filesystem/shell (อนุญาตการส่งข้อความของ provider)
  - H2: การตอบสนองต่อเหตุการณ์
  - H3: ควบคุมให้อยู่ในวงจำกัด
  - H3: หมุนเวียน (ถือว่าถูก compromise หาก secrets รั่ว)
  - H3: Audit
...
- หัวข้อ:
  ...
  - H2: ตัวอย่าง CLI
  - H2: หมายเหตุ
  - H2: การควบคุม browser (Gateway ระยะไกล + browser ภายในเครื่อง)
...
- หัวข้อ:
  ...
  - H2: node paired แล้ว แต่เครื่องมือล้มเหลว
...
- หัวข้อ:
  ...
  - H2: วิธีทำงาน
  - H2: พฤติกรรม pairing ของ Control UI
  - H2: การกำหนดค่า
...
- หัวข้อ:
  ...
  - H2: ข้อมูลรับรอง provider และ workspace .env
  ...
  - H2: Logging
  - H3: OPENCLAWHOME
  - H2: ผู้ใช้ nvm: webfetch TLS failures
...
- หัวข้อ:
  - H2: Quick start และการตั้งค่า first-run
  - H2: ที่เกี่ยวข้อง
...
- หัวข้อ:
  ...
  - H2: สิ่งต่าง ๆ อยู่บนดิสก์ที่ไหน
  - H2: พื้นฐาน config
  - H2: Gateways และ nodes ระยะไกล
  - H2: Env vars และการโหลด .env
  - H2: Sessions และ chats หลายรายการ
  ...
  - H2: คำสั่ง chat การยกเลิก tasks และ "มันไม่หยุด"
  - H2: เบ็ดเตล็ด
  - H2: ที่เกี่ยวข้อง
...
- หัวข้อ:
  - H2: ข้อตกลง
  - H2: scripts สำหรับ monitoring auth
  - H2: helper อ่าน GitHub
  - H2: เมื่อเพิ่ม scripts
  - H2: ที่เกี่ยวข้อง
...
- หัวข้อ:
  ...
  - H3: วิสัยทัศน์: การส่งรูปภาพ (ไฟล์แนบ → ข้อความหลายรูปแบบ)
  - H3: ตัวรวบรวม / Gateway ทางเลือก
  - H2: ข้อมูลประจำตัว (ห้าม commit เด็ดขาด)
  - H2: Deepgram สด (การถอดเสียงจากเสียง)
...
- หัวข้อ:
  ...
  - H2: ตัวรัน Docker (การตรวจสอบ "ทำงานบน Linux" แบบไม่บังคับ)
  - H2: ความสมเหตุสมผลของเอกสาร
...
- หัวข้อ:
  - H2: 60 วินาทีแรก
  - H2: ผู้ช่วยรู้สึกจำกัดหรือไม่มีเครื่องมือ
...
- หัวข้อ:
  ...
  - H2: แนวทางปฏิบัติที่ดีที่สุดสำหรับการแท็ก
...
- หัวข้อ:
  ...
  - H3: ตัวติดตั้งแบบคำนำหน้าภายในเครื่อง (install-cli.sh)
...
- หัวข้อ:
  ...
  - H2: อัปเกรด Plugin ภายในที่เดิม
  - H2: ที่เกี่ยวข้อง
...
- หัวข้อ:
  ...
  - H2: สลับระหว่างการติดตั้งแบบ npm และ git
...
- หัวข้อ:
  ...
  - H3: ระดับบันทึก
  - H3: การวินิจฉัยการส่งผ่านของโมเดลแบบเจาะจง
...
- หัวข้อ:
  ...
  - H2: ตัวอย่างการกำหนดค่า
  - H3: Provider + fallback ของ CLI (OpenAI + Whisper CLI)
  - H3: เฉพาะ Provider พร้อมการจำกัดตามขอบเขต
  - H3: เฉพาะ Provider (Deepgram)
  - H3: เฉพาะ Provider (Mistral Voxtral)
  - H3: เฉพาะ Provider (SenseAudio)
  - H3: ส่ง transcript กลับไปที่แชต (เลือกเปิดใช้)
...
- หัวข้อ:
  ...
  - H3: Codex app-server ยังคงเป็นแหล่งมาตรฐานสำหรับสถานะเธรดแบบ native
  ...
  - H3: 6. เชื่อม post-turn หลังการทำมิเรอร์ transcript
  - H3: 7. ทำให้ usage และ context รันไทม์ของ prompt-cache เป็นมาตรฐาน
  - H3: 8. นโยบาย Compaction
  - H4: /compact และ Compaction ของ OpenClaw แบบชัดเจน
  - H4: เหตุการณ์ contextCompaction แบบ native ของ Codex ภายในเทิร์น
...
- หัวข้อ:
  ...
  - H3: บีคอนแสดงการมีอยู่ที่ยังทำงาน
...
- หัวข้อ:
  ...
  - H2: push ที่ใช้รีเลย์สำหรับบิลด์ทางการ
  - H2: บีคอน alive เบื้องหลัง
...
- หัวข้อ:
  ...
  - H2: แรงกดดันหน่วยความจำและการ kill จาก OOM
  - H2: ที่เกี่ยวข้อง
...
- หัวข้อ:
  - H1: การลงนาม mac (debug builds)
  - H2: การใช้งาน
  - H3: หมายเหตุการลงนามแบบ Ad-hoc
  - H2: เมตาดาต้าการสร้างสำหรับ About
  - H2: เหตุผล
  - H2: ที่เกี่ยวข้อง
...
- หัวข้อ:
  ...
  - H2: เป้าหมาย
  - H2: วิธีการทำงาน
  - H3: Gateway + การรับส่ง Node
  - H3: บริการ Node + IPC ของแอป
  - H3: PeekabooBridge (ระบบอัตโนมัติ UI)
  - H2: โฟลว์การปฏิบัติงาน
  - H2: หมายเหตุการเสริมความปลอดภัย
  - H2: ที่เกี่ยวข้อง
...
- หัวข้อ:
  - H2: เมื่อใดควรสร้างความสามารถ
  - H2: ลำดับมาตรฐาน
  - H2: อะไรอยู่ที่ไหน
  - H2: รอยต่อของผู้ให้บริการและ harness
  - H2: เช็กลิสต์ไฟล์
...
- หัวข้อ:
  - H2: ไปป์ไลน์การโหลด
  - H3: พฤติกรรมที่ให้ความสำคัญกับ manifest ก่อน
  - H3: ขอบเขตแคช Plugin
  - H2: โมเดล registry
  - H2: callback การผูก conversation
  - H2: hook รันไทม์ของผู้ให้บริการ
  - H3: ลำดับและการใช้งาน hook
  - H3: ตัวอย่างผู้ให้บริการ
  - H3: ตัวอย่างในตัว
  - H2: helper รันไทม์
  - H3: api.runtime.imageGeneration
  - H2: เส้นทาง HTTP ของ Gateway
  - H2: เส้นทาง import ของ Plugin SDK
  - H2: schema เครื่องมือข้อความ
  - H2: การระบุเป้าหมาย channel
  - H2: ไดเรกทอรีที่อิง config
  - H2: แค็ตตาล็อกผู้ให้บริการ
  - H2: การตรวจสอบ channel แบบอ่านอย่างเดียว
  - H2: แพ็ก package
  - H3: เมตาดาต้าแค็ตตาล็อก channel
  - H2: Plugin ของ context engine
  - H2: การเพิ่มความสามารถใหม่
  - H3: เช็กลิสต์ความสามารถ
  - H3: เทมเพลตความสามารถ
  - H2: ที่เกี่ยวข้อง
...
- หัวข้อ:
  - H2: โมเดลความสามารถสาธารณะ
  - H3: จุดยืนด้านความเข้ากันได้ภายนอก
  - H3: รูปแบบ Plugin
  - H3: hook เดิม
  - H3: สัญญาณความเข้ากันได้
  - H2: ภาพรวมสถาปัตยกรรม
  - H3: snapshot เมตาดาต้า Plugin และตาราง lookup
  - H3: การวางแผนการเปิดใช้งาน
  - H3: Plugin ช่องทางและเครื่องมือข้อความที่ใช้ร่วมกัน
  - H2: โมเดลการเป็นเจ้าของความสามารถ
  - H3: การจัดเลเยอร์ความสามารถ
  - H3: ตัวอย่าง Plugin บริษัทแบบหลายความสามารถ
  - H3: ตัวอย่างความสามารถ: การเข้าใจวิดีโอ
...
- หัวข้อ:
  ...
  - H2: Plugin แบ็กเอนด์ขั้นต่ำ
  - H2: รูปแบบ config
  - H2: hook แบ็กเอนด์ขั้นสูง
...
- หัวข้อ:
  ...
  - H2: การรับส่ง app-server
  - H2: โหมด approval และ sandbox
  - H2: การประมวลผลแบบเนทีฟใน sandbox
...
- หัวข้อ:
  ...
  - H2: ขอบเขต hook
  - H2: สัญญาการรองรับ V1
  - H2: สิทธิ์เนทีฟและ MCP elicitations
  - H2: การบังคับทิศทาง queue
...
- หัวข้อ:
  ...
  - H3: การ deployment ผู้ให้บริการแบบผสม
...
- หัวข้อ:
  ...
  - H2: วิธีการทำงานของการตั้งค่า plugin แบบเนทีฟ
  - H2: ขอบเขตการรองรับ V1
  - H2: inventory แอปและการเป็นเจ้าของ
...
- หัวข้อ:
  ...
  - H3: lane การยอมรับของผู้ดูแล
  - H2: นโยบายการเลิกใช้งาน
  - H2: พื้นที่ความเข้ากันได้ปัจจุบัน
  - H3: alias แบบแบนของ WhatsApp Inbound Callback
  - H3: ฟิลด์ WhatsApp Inbound Admission
  - H2: บันทึกประจำรุ่น
...
- หัวข้อ:
  ...
  - H2: รายการตรวจสอบการทดสอบแบบไลฟ์
  - H2: การแก้ไขปัญหา
  - H3: เอเจนต์มองไม่เห็นเครื่องมือ Google Meet
  - H3: ไม่มีโหนดที่เชื่อมต่ออยู่ซึ่งรองรับ Google Meet
  ...
  - H3: สาย Twilio เริ่มแล้วแต่ไม่เข้าการประชุม
  - H2: หมายเหตุ
  - H2: ที่เกี่ยวข้อง
...
- หัวข้อ:
  ...
  - H2: Prompt และ model hook
  - H3: ส่วนขยายเซสชันและการฉีดในเทิร์นถัดไป
  - H2: Message hook
  - H2: Install hook
...
- หัวข้อ:
  - H2: การติดตั้ง
  - H2: เริ่มต้นอย่างรวดเร็ว
  - H2: Embedding ที่หนุนด้วยผู้ให้บริการ
  - H2: Ollama embedding
...
- หัวข้อ:
  ...
  - H2: claim แบบมีโครงสร้างและหลักฐาน
  - H2: metadata ของ entity สำหรับเอเจนต์
  - H2: ไปป์ไลน์ compile
...
- หัวข้อ:
  ...
  - H3: โหมด harness ของ Codex แบบเนทีฟ
  - H2: ความเข้มงวดของรันไทม์
  - H2: เซสชันเนทีฟและสำเนาทรานสคริปต์
...
- หัวข้อ:
  ...
  - H2: แผนการย้ายระบบสำหรับการพูดคุยและเสียงเรียลไทม์
...
- หัวข้อ:
  ...
  - H3: สล็อตเฉพาะ
  - H3: อะแดปเตอร์ฝังความจำที่เลิกใช้แล้ว
...
- หัวข้อ:
  ...
  - H3: subpath ตัวช่วยของ Plugin ที่ bundled และสงวนไว้
  - H2: ที่เกี่ยวข้อง
...
- หัวข้อ:
  ...
  - H2: เผยแพร่
  - H2: การแก้ไขปัญหา
  - H3: ไม่พบจุดเข้า Plugin: ./dist/index.js
  - H3: จุดเข้า Plugin ไม่เปิดเผยเมทาดาทา defineToolPlugin
...
- หัวข้อ:
  ...
  - H3: สายเริ่มได้แต่ Webhook ของผู้ให้บริการไม่มาถึง
...
- หัวข้อ:
  ...
  - H3: พรอมต์และวงจรชีวิตของ worker
  - H3: จุดเข้า dispatch
...
- หัวข้อ:
  - H2: เริ่มต้นใช้งาน
  - H2: ตัวเลือกการกำหนดค่า
  - H2: การสตรีม STT สำหรับการโทรด้วยเสียง
  - H2: หมายเหตุ
  - H2: ที่เกี่ยวข้อง
...
- หัวข้อ:
  ...
  - H2: ส่วนติดต่อ OpenClaw ที่รองรับ
...
- หัวข้อ:
  ...
  - H2: การฝังสำหรับค้นหาหน่วยความจำ
  - H3: การกำหนดค่า
  - H3: วิธีทำงาน
  - H2: ที่เกี่ยวข้อง
...
- หัวข้อ:
  ...
  - H2: แคตตาล็อกในตัว (รวม 41 รายการ)
  - H2: การค้นพบโมเดล
...
- หัวข้อ:
  ...
  - H3: ระยะที่ 2: ทำความสะอาดโดยยึดสัญญาเช่าก่อน
  - H3: ระยะที่ 3: เก็บกวาดตอนเริ่มต้นโดยยึดสัญญาเช่าก่อน
...
- หัวข้อ:
  - H1: การปรับโครงสร้างสถานะโดยยึดฐานข้อมูลก่อน
  - H2: การตัดสินใจ
  - H2: สัญญาแบบเข้มงวด
...
- หัวข้อ:
  ...
  - H2: เช็กลิสต์ผู้ปฏิบัติการปล่อยรุ่น
...
- หัวข้อ:
  ...
  - H2: ระยะที่ 3: การกระชับสถาปัตยกรรมส่วนหน้า
  - H2: ระยะที่ 4: ประสิทธิภาพและความน่าเชื่อถือ
  - H2: ระยะที่ 5: การเสริมความแข็งแรงให้ Type, สัญญา และการทดสอบ
  - H2: ส่วนแรกที่แนะนำ
  - H2: การอัปเดตทักษะส่วนหน้า
...
- หัวข้อ:
  ...
  - H2: ส่วนย่อยเส้นทางการปล่อย Docker
  - H2: โปรไฟล์การปล่อยรุ่น
  - H2: ส่วนเพิ่มสำหรับเต็มรูปแบบเท่านั้น
...
- หัวข้อ:
  ...
  - H2: หน่วยความจำแบบหลายโมดัล (Gemini)
  - H2: แคช embedding
...
- หัวข้อ:
  ...
  - H3: ตัวสลับ Env (การดีบักเฉพาะครั้ง)
  - H3: สิ่งที่ควรตรวจสอบ
...
- หัวข้อ:
  - H2: [embed ...]
  - H2: รูปทรงการเรนเดอร์ที่จัดเก็บไว้
  - H2: ที่เกี่ยวข้อง
...
- หัวข้อ:
  - H2: รูปแบบ A: ดีมอน HTTP (signal-cli)
...
- หัวข้อ:
  - H1: TOOLS.md - บันทึกภายในเครื่อง
...
- หัวข้อ:
  ...
  - H2: ผลกระทบของ TTL แคชและการตัดทอน
  ...
  - H2: เคล็ดลับในการลดแรงกดดันจากโทเค็น
  - H2: ที่เกี่ยวข้อง
...
- หัวข้อ:
  ...
  - H2: กฎสากล: เทิร์นที่มีเฉพาะการให้เหตุผลและไม่สมบูรณ์
...
- หัวข้อ:
  ...
  - H4: T-RECON-002: การตรวจสอบการเชื่อมต่อช่องทาง
  ...
  - H3: 3.7 การรวบรวมและการรั่วไหลของข้อมูล (AML.TA0009, AML.TA0010)
  ...
  - H2: 4. การวิเคราะห์ห่วงโซ่อุปทานของ ClawHub
...
- หัวข้อ:
  ...
  - H3: การกั้นขาเข้า (การกล่าวถึง + การเลี่ยงคำสั่งควบคุม)
  ...
  - H3: ความสัมพันธ์ trace ขาเข้า / idempotency
...
- หัวข้อ:
  ...
  - H2: การเริ่มใช้งานกำหนดค่าอะไร
  - H2: การเริ่มใช้งาน CLI
  - H2: การเริ่มใช้งานแอป macOS
...
- หัวข้อ:
  ...
  - H2: กลยุทธ์การปรับแต่ง (เพื่อให้การอัปเดตไม่สร้างปัญหา)
  - H2: รัน Gateway จาก repo นี้
  - H2: เวิร์กโฟลว์เสถียร (แอป macOS ก่อน)
  - H2: เวิร์กโฟลว์แนวหน้า (Gateway ในเทอร์มินัล)
...
- หัวข้อ:
  ...
  - H3: การกำหนดค่า timeout ของการทำงานรันไทม์
  - H3: การกำหนดค่าเอเจนต์ตรวจสุขภาพ
...
- หัวข้อ:
  - H2: ฉันต้องการหน้าใด?
  - H2: ใช้งานได้ทันทีโดยไม่ต้องตั้งค่าเพิ่มหรือไม่?
...
- หัวข้อ:
  ...
  - H2: วิธีทำงาน (ภายใน)
  - H2: คู่มืออ้างอิง CLI แบบเร็ว
  - H2: snapshot และ refs
...
- หัวข้อ:
  ...
  - H3: ตัวเลือก 1: remote CDP ดิบจาก WSL2 ไปยัง Windows
  - H3: ตัวเลือก 2: Chrome MCP บนโฮสต์ภายใน
  ...
  - H3: ชั้น 3: กำหนดค่า browser profile ที่ถูกต้อง
...
- หัวข้อ:
  ...
  - H2: พร็อกซีเบราว์เซอร์ Node (ค่าเริ่มต้นแบบไม่ต้องตั้งค่า)
  ...
  - H2: API ควบคุม (ไม่บังคับ)
  - H2: การแก้ไขปัญหา
  - H3: การเริ่ม CDP ล้มเหลวเทียบกับบล็อก SSRF ระหว่างนำทาง
...
- หัวข้อ:
  ...
  - H3: config URL ผู้ดูแบบถาวร
  - H2: config ความปลอดภัย
  - H2: วงจรชีวิตและการจัดเก็บ artifact
  - H2: URL ผู้ดูและพฤติกรรมเครือข่าย
  - H2: โมเดลความปลอดภัย
...
- หัวข้อ:
  ...
  - H2: โมเดลการอนุญาต
  - H2: การอนุมัติ exec (companion app / node host)
...
- หัวข้อ:
  ...
  - H2: กำหนดค่า Firecrawl webfetch fallback
...
- หัวข้อ:
  - H2: การเริ่มใช้งานและ configure
...
- หัวข้อ:
  - H2: Hook
  - H2: เหตุผล
  - H2: เหตุใดจึงใช้ DSL แทนโปรแกรมธรรมดา?
  - H2: วิธีทำงาน
...
- หัวข้อ:
  ...
  - H2: Async เทียบกับ synchronous
  - H2: Speech-to-text และ Voice Call
  - H2: การแมปผู้ให้บริการ (ผู้ขายแบ่งตาม surface อย่างไร)
  - H2: ที่เกี่ยวข้อง
...
- หัวข้อ:
  ...
  - H3: โหมดทางเลือกสำรองด้วยการดึงข้อมูล
  - H2: การกำหนดค่า
...
- หัวข้อ:
  ...
  - H2: บุคลิก
  - H3: บุคลิกขั้นต่ำ
  - H3: บุคลิกแบบเต็ม (พรอมป์ที่ไม่ขึ้นกับผู้ให้บริการ)
  - H3: การแก้ไขบุคลิก
  - H3: วิธีที่ผู้ให้บริการใช้พรอมป์บุคลิก
  - H3: นโยบายทางเลือกสำรอง
...
- หัวข้อ:
  ...
  - H3: การควบคุมสไตล์
  - H3: ขั้นสูง
  - H4: ทางเลือกสำรองและตัวเลือกแบบมีชนิด
  - H2: การดำเนินการ
  - H2: การเลือกโมเดล
  - H2: หมายเหตุสำหรับผู้ให้บริการ
  - H2: โหมดความสามารถของผู้ให้บริการ
...
- หัวข้อ:
  ...
  - H2: การรองรับภาษา
  - H2: ธีมลักษณะหน้าตา
  - H2: สิ่งที่ทำได้ (ตอนนี้)
  - H2: หน้า MCP
  - H2: แท็บกิจกรรม
  - H2: พฤติกรรมแชต
  - H2: การติดตั้ง PWA และเว็บพุช
  - H2: การฝังแบบโฮสต์
  - H2: ความกว้างข้อความแชต
  - H2: การเข้าถึง Tailnet (แนะนำ)
  - H2: HTTP ที่ไม่ปลอดภัย
  - H2: นโยบายความปลอดภัยของเนื้อหา
  - H2: การตรวจสอบสิทธิ์เส้นทางอวาตาร์
  - H2: การตรวจสอบสิทธิ์เส้นทางสื่อของผู้ช่วย
  - H2: การสร้าง UI
...
- หัวข้อ:
  ...
  - H2: พื้นฐานการตรวจสอบสิทธิ์ (ในเครื่องเทียบกับระยะไกล)
