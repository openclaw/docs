...
title: แผนผังเอกสาร
x-i18n:
    generated_at: "2026-07-04T04:11:05Z"
    model: gpt-5.5
...
- หัวข้อ:
  ...
  - H2: เส้นทางการยืนยันตัวตนแบบกำหนดค่าล้วน
...
- หัวข้อ:
  ...
  - H3: เพย์โหลดคำสั่ง
  - H3: ตัวเลือกเพย์โหลดสำหรับงานที่แยกเดี่ยว
...
- หัวข้อ:
  ...
  - H3: ตัวอย่าง 3: การติดตามและการแจ้งเตือน (ต่อเนื่อง)
...
- หัวข้อ:
  ...
  - H3: โหมดมิเรอร์
  - H2: สถานะที่คงทนและการติดตามรีวิชัน
  - H2: พฤติกรรมการยกเลิก
  - H2: คำสั่ง CLI
  - H2: โฟลว์เกี่ยวข้องกับงานอย่างไร
  - H2: ที่เกี่ยวข้อง
...
- หัวข้อ:
  ...
  - H2: อ้างอิงกลุ่มจากรายการอนุญาต
...
- หัวข้อ:
  ...
  - H3: ตัวอย่างแบบครบถ้วน
  - H2: วิธีการทำงาน
  - H3: โฟลว์ข้อความ
  - H3: การแยกเซสชัน
  - H3: ตัวอย่าง: เซสชันที่แยกเดี่ยว
  - H2: แนวทางปฏิบัติที่ดี
  - H2: ความเข้ากันได้
  - H3: ผู้ให้บริการ
  - H3: การกำหนดเส้นทาง
...
- หัวข้อ:
  - H2: การตั้งค่าอย่างรวดเร็ว
  - H2: แนะนำ: ตั้งค่าพื้นที่ทำงานกิลด์
  - H2: โมเดลรันไทม์
  - H2: ช่องฟอรัม
  - H2: คอมโพเนนต์เชิงโต้ตอบ
  - H2: การควบคุมการเข้าถึงและการกำหนดเส้นทาง
  - H3: การกำหนดเส้นทางเอเจนต์ตามบทบาท
  - H2: คำสั่งเนทีฟและการยืนยันสิทธิ์คำสั่ง
...
- หัวข้อ:
  ...
  - H3: การตั้งค่าด้วย QR ไม่ตอบสนองในแอป Feishu บนมือถือ
  ...
  - H3: ขอบเขตเซสชัน
  - H3: การติดตั้งใช้งานหลายผู้ใช้ทั่วไป
  - H3: การตรวจสอบยืนยัน
  - H3: หมายเหตุ
  - H2: ข้อมูลอ้างอิงการกำหนดค่า
...
- หัวข้อ:
  ...
  - H2: ป้ายชื่อที่แสดง
  - H2: นโยบายกลุ่ม
  - H2: เกตการกล่าวถึง (ค่าเริ่มต้น)
  - H2: กำหนดขอบเขตรูปแบบการกล่าวถึงที่ตั้งค่าไว้
  - H2: ข้อจำกัดเครื่องมือของกลุ่ม/ช่องทาง (ไม่บังคับ)
  - H2: รายการอนุญาตกลุ่ม
...
- หัวข้อ:
  ...
  - H3: การตั้งค่า
  - H3: เมื่อคุณไม่สามารถปิดใช้งาน SIP ได้
  - H2: การควบคุมการเข้าถึงและการกำหนดเส้นทาง
  - H2: การผูกบทสนทนา ACP
  - H2: รูปแบบการติดตั้งใช้งาน
  - H2: สื่อ การแบ่งชิ้น และเป้าหมายการส่งมอบ
  - H2: การดำเนินการ API ส่วนตัว
  - H2: การเขียนการกำหนดค่า
  - H2: การรวม DM ที่ส่งแบบแยกส่วน (คำสั่ง + URL ในองค์ประกอบเดียว)
  - H3: สถานการณ์และสิ่งที่เอเจนต์เห็น
  - H2: การกู้คืนขาเข้าหลังบริดจ์หรือ Gateway รีสตาร์ต
  - H3: สัญญาณที่โอเปอเรเตอร์มองเห็น
  - H3: การย้ายระบบ
  - H2: การแก้ไขปัญหา
  - H2: ตัวชี้ไปยังข้อมูลอ้างอิงการกำหนดค่า
  - H2: ที่เกี่ยวข้อง
...
- หัวข้อ:
  ...
  - H2: การควบคุมการเข้าถึง
  - H3: ข้อพลาดที่พบบ่อย: allowFrom ใช้กับ DM ไม่ใช่ช่องทาง
  ...
  - H3: เครื่องมือแตกต่างกันตามผู้ส่ง (เจ้าของมีอำนาจมากกว่า)
  - H2: NickServ
...
- หัวข้อ:
  ...
  - H2: ขั้นตอนอัปเกรดที่แนะนำ
  - H2: การย้ายข้อมูลที่เข้ารหัสทำงานอย่างไร
...
- หัวข้อ:
  ...
  - H3: กฎ push แบบ self-hosted สำหรับตัวอย่างที่สรุปแล้วแบบเงียบ
  - H2: ห้องบอตต่อบอต
  - H2: การเข้ารหัสและการยืนยัน
  - H3: เปิดใช้งานการเข้ารหัส
  - H3: สัญญาณสถานะและความเชื่อถือ
...
- หัวข้อ:
  ...
  - H2: เส้นทางตั้งค่า A: ลิงก์บัญชี Signal ที่มีอยู่ (QR)
  - H2: เส้นทางตั้งค่า B: ลงทะเบียนหมายเลขบอตเฉพาะ (SMS, Linux)
...
- หัวข้อ:
  - H2: การเลือก Socket Mode หรือ URL คำขอ HTTP
  - H3: โหมดรีเลย์
  - H2: ติดตั้ง
  - H2: ตั้งค่าอย่างรวดเร็ว
  ...
  - H2: การสตรีมข้อความ
  - H2: ทางสำรองของรีแอ็กชันการพิมพ์
...
- หัวข้อ:
  ...
  - H2: พฤติกรรมรันไทม์
  - H2: อ้างอิงฟีเจอร์
  - H2: ตัวควบคุมการตอบกลับเมื่อเกิดข้อผิดพลาด
  - H2: การแก้ไขปัญหา
  - H2: อ้างอิงการกำหนดค่า
  - H2: ที่เกี่ยวข้อง
...
- หัวข้อ:
  ...
  - H3: ปรับแต่งกลยุทธ์ merge-text
  - H2: คำสั่งทั่วไป
  - H2: การแก้ไขปัญหา
  - H3: บอตไม่ตอบสนองในแชตกลุ่ม
  - H3: บอตไม่ได้รับข้อความ
  - H3: บอตส่งคำตอบว่างหรือคำตอบ fallback
  - H3: App Secret รั่วไหล
  - H2: ค่ากำหนดขั้นสูง
  - H3: หลายบัญชี
  - H3: ขีดจำกัดข้อความ
...
- หัวข้อ:
  ...
  - H2: หลายบัญชี
  - H2: ตัวแปรสภาพแวดล้อม
  - H2: การพิมพ์ รีแอ็กชัน และการตอบรับการส่ง
  - H2: การแก้ไขปัญหา
  - H2: ที่เกี่ยวข้อง
...
- หัวข้อ:
  ...
  - H2: การตรวจสอบ Release เต็มรูปแบบ
  - H2: Live และ E2E shards
  - H2: การยอมรับแพ็กเกจ
  - H3: งาน
...
- หัวข้อ:
  ...
  - H3: โหมดเร็ว
  - H3: การลองซ้ำการสลับโมเดลสด
  - H2: เอาต์พุตการรันและการปฏิเสธ
  - H3: การระงับการตอบรับที่ล้าสมัย
...
- หัวข้อ:
  ...
  - H2: ดูข้อมูล Hook
  - H2: ตรวจสอบคุณสมบัติการใช้งาน Hook
  - H2: เปิดใช้งาน Hook
  - H2: ปิดใช้งาน Hook
  - H2: หมายเหตุ
  - H2: ติดตั้งแพ็ก Hook
...
- หัวข้อ:
  ...
  - H3: สิ่งที่ serve เปิดให้ใช้งาน
  - H3: การใช้งาน
  - H3: เครื่องมือบริดจ์
  - H3: โมเดลเหตุการณ์
...
- หัวข้อ:
  - H2: คำสั่ง
  - H3: ผู้เขียน
  - H3: สร้างโครง Provider
  - H3: ติดตั้ง
  - H4: ชื่อย่อ Marketplace
  - H3: แสดงรายการ
  - H3: ดัชนี Plugin
  - H3: ถอนการติดตั้ง
  - H3: อัปเดต
...
- หัวข้อ:
  ...
  - H2: เริ่มต้นอย่างรวดเร็ว
  - H3: อ้างอิงกฎนโยบาย
  - H4: โอเวอร์เลย์แบบกำหนดขอบเขต
  - H4: ช่องทาง
  - H4: เซิร์ฟเวอร์ MCP
  - H4: ผู้ให้บริการโมเดล
  - H4: เครือข่าย
  - H4: ทางเข้าและการเข้าถึงช่องทาง
  - H4: Gateway
...
- หัวข้อ:
  ...
  - H2: คำสั่ง
  - H2: ตรวจสอบความถูกต้อง
  - H2: ค่าที่ตั้งไว้ล่วงหน้าของคิวรี
  - H2: หมายเหตุ
  - H2: ที่เกี่ยวข้อง
...
- หัวข้อ:
  ...
  - H3: Lossless Claw
  - H2: ช่องทางขั้นสูงสำหรับหลีกเลี่ยงข้อจำกัด
...
- หัวข้อ:
  ...
  - H2: จุด Hook (ตำแหน่งที่คุณสามารถแทรกกลางได้)
...
- หัวข้อ:
  ...
  - H2: ไฟล์บูตสแตรป (ถูกแทรก)
  - H2: เครื่องมือในตัว
  - H2: Skills
  - H2: ขอบเขตรันไทม์
  - H2: เซสชัน
  - H2: การกำกับระหว่างสตรีม
  - H2: การอ้างอิงโมเดล
...
- หัวข้อ:
  ...
  - H3: Node (macOS / iOS / Android / ไม่มีส่วนติดต่อ)
  - H3: WebChat
...
- หัวข้อ:
  ...
  - H3: การใช้โมเดลอื่น
  - H3: การคงตัวระบุ
  - H3: ตัวป้องกันไบต์ทรานสคริปต์ที่ใช้งานอยู่
...
- หัวข้อ:
  ...
  - H2: ไฟล์พื้นที่ทำงานที่ถูกแทรก (บริบทโปรเจกต์)
  - H2: Skills: แบบถูกแทรกเทียบกับแบบโหลดตามต้องการ
  - H2: เครื่องมือ: มีต้นทุนสองอย่าง
  - H2: คำสั่ง, directive, และ "ทางลัดอินไลน์"
...
- หัวข้อ:
  ...
  - H2: ความครอบคลุมรายงานการทดลองเงา QA
  - H2: การจัดตารางเวลา
  - H2: เริ่มต้นอย่างรวดเร็ว
  - H2: คำสั่ง slash
  - H2: เวิร์กโฟลว์ CLI
...
- หัวข้อ:
  ...
  - H3: ควรเปิดเมื่อใด
  - H3: ควรปล่อยให้ปิดเมื่อใด
  - H3: เปิดใช้
  - H2: ทดลองไม่ได้หมายความว่าถูกซ่อน
  - H2: ที่เกี่ยวข้อง
...
- หัวข้อ:
  ...
  - H2: เครื่อง
  - H2: ความลับ
  - H2: artifact ของ GitHub และความคิดเห็น PR
  - H2: หมายเหตุการปรับใช้ส่วนตัว
...
- หัวข้อ:
  ...
  - H2: Dreaming
  - H2: การ backfill ที่มีหลักฐานรองรับและการเลื่อนขั้นแบบสด
  - H2: CLI
  - H2: อ่านเพิ่มเติม
  - H2: ที่เกี่ยวข้อง
...
- หัวข้อ:
  ...
  - H2: เนื้อหา inbound และบริบทประวัติ
  - H2: การเข้าคิวและ followup
  - H2: ความเป็นเจ้าของการรันของช่องทาง
  - H2: การสตรีม, การแบ่งชังก์, และการทำแบตช์
  - H2: การมองเห็น reasoning และโทเค็น
  - H2: prefix, เธรด, และการตอบกลับ
...
- หัวข้อ:
  ...
  - H2: แหล่งการเลือกและพฤติกรรม fallback
  - H2: นโยบายโมเดลอย่างรวดเร็ว
  - H2: onboarding (แนะนำ)
...
- หัวข้อ:
  - H2: "เอเจนต์หนึ่งตัว" คืออะไร
  - H2: path (แผนที่อย่างรวดเร็ว)
  ...
  - H2: รูปแบบทั่วไป
  - H2: sandbox และการกำหนดค่าเครื่องมือรายเอเจนต์
  - H2: ที่เกี่ยวข้อง
...
- หัวข้อ:
  ...
  - H2: ที่จัดเก็บ (โทเค็นอยู่ที่ใด)
  - H2: ความเข้ากันได้กับโทเค็นแบบเดิมของ Anthropic
...
- หัวข้อ:
  - H2: ฟิลด์สถานะการปรากฏ (สิ่งที่แสดง)
  - H2: ผู้ผลิตข้อมูล (สถานะการปรากฏมาจากที่ใด)
  ...
  - H2: ข้อควรระวังสำหรับระยะไกล/อุโมงค์ (IP แบบ loopback)
  - H2: ผู้บริโภค
...
- หัวข้อ:
  ...
  - H2: ซีดที่รองรับด้วยรีโป
  - H2: เลนจำลองผู้ให้บริการ
...
- หัวข้อ:
  ...
  - H2: สคีมาอยู่ที่ใด
  - H2: ไปป์ไลน์ปัจจุบัน
  - H2: วิธีใช้สคีมาในรันไทม์
  - H2: ตัวอย่างเฟรม
  - H2: ไคลเอนต์ขั้นต่ำ (Node.js)
  - H2: ตัวอย่างใช้งานจริง: เพิ่มเมธอดตั้งแต่ต้นจนจบ
  - H2: พฤติกรรมการสร้างโค้ด Swift
  - H2: การกำหนดเวอร์ชัน + ความเข้ากันได้
  - H2: รูปแบบและแบบแผนของสคีมา
  - H2: JSON สคีมาแบบสด
...
- หัวข้อ:
  ...
  - H2: เพย์โหลดเครื่องมือ + ตัวเชื่อมต่อ (เวลาผู้ให้บริการดิบ + ฟิลด์ที่ปรับเป็นมาตรฐาน)
  - H2: เอกสารที่เกี่ยวข้อง
...
- หัวข้อ:
  ...
  - H2: ชื่ออินสแตนซ์ที่ถูก escape (\032)
...
- หัวข้อ:
  ...
  - H2: การใช้เป็นทางสำรอง
  - H2: ภาพรวมการกำหนดค่า
  - H3: ตัวอย่างการกำหนดค่า
  - H2: วิธีทำงาน
  - H2: เซสชัน
  - H2: บทนำทางสำรองจากเซสชัน claude-cli
  - H2: รูปภาพ (ส่งผ่าน)
  - H2: อินพุต / เอาต์พุต
...
- หัวข้อ:
  ...
  - H3: การแทนที่โปรไฟล์บูตสแตรปต่อเอเจนต์
  ...
  - H3: รีแอ็กชันรับทราบ
  - H3: Debounce ขาเข้า
  - H3: TTS (การแปลงข้อความเป็นเสียง)
  - H2: พูดคุย
  - H2: ที่เกี่ยวข้อง
...
- หัวข้อ:
  ...
  - H3: การควบคุมการกล่าวถึงในแชทกลุ่ม
  - H4: ขีดจำกัดประวัติ DM
  - H4: โหมดแชทกับตัวเอง
  - H3: คำสั่ง (การจัดการคำสั่งแชท)
  - H2: ที่เกี่ยวข้อง
...
- หัวข้อ:
  - H2: เริ่มต้นอย่างรวดเร็ว
  - H3: ขั้นต่ำสุด
  - H3: ชุดเริ่มต้นที่แนะนำ
  - H2: ตัวอย่างแบบขยาย (ตัวเลือกหลัก)
  - H3: รีโป skill ข้างเคียงแบบ symlink
  - H2: รูปแบบที่พบบ่อย
  - H3: เส้นฐาน skill ที่ใช้ร่วมกันพร้อมการแทนที่หนึ่งรายการ
  - H3: การตั้งค่าหลายแพลตฟอร์ม
  - H3: การอนุมัติอัตโนมัติสำหรับเครือข่าย Node ที่เชื่อถือ
  - H3: โหมด DM ปลอดภัย (กล่องขาเข้าที่ใช้ร่วมกัน / DM หลายผู้ใช้)
  - H3: คีย์ API ของ Anthropic + ตัวสำรอง MiniMax
...
- หัวข้อ:
  ...
  - H3: โหมดโหลดใหม่
  - H3: สิ่งที่มีผลแบบ hot-apply เทียบกับสิ่งที่ต้องรีสตาร์ต
...
- หัวข้อ:
  ...
  - H2: อินพุตการค้นพบ (ไคลเอนต์รู้ตำแหน่งของ Gateway ได้อย่างไร)
  ...
  - H2: การจับคู่ + auth (ทรานสปอร์ตโดยตรง)
...
- หัวข้อ:
  ...
  - H2: สิ่งที่ทำ (สรุป)
  - H2: การเติมข้อมูลย้อนหลังและการรีเซ็ต UI ของ Dreams
...
- หัวข้อ:
  ...
  - H2: การเข้าถึงระยะไกล
  - H2: การควบคุมดูแลและวงจรชีวิตบริการ
  - H2: เส้นทางด่วนของโปรไฟล์ dev
  - H2: อ้างอิงโปรโตคอลแบบเร็ว (มุมมองผู้ปฏิบัติการ)
...
- หัวข้อ:
  ...
  - H3: การกำหนดค่าแบบไฮบริด: โฮสต์เป็นตัวหลัก, ภายในเครื่องเป็นตัวสำรอง
  - H3: ให้ภายในเครื่องมาก่อนพร้อมตาข่ายนิรภัยที่โฮสต์
...
- หัวข้อ:
  ...
  - H2: เช็กลิสต์การแยก
  - H2: การแมปพอร์ต (ได้มาจากค่าอื่น)
...
- หัวข้อ:
  - H2: การตรวจสอบสิทธิ์, ความปลอดภัย และการกำหนดเส้นทาง
  - H2: พฤติกรรมเซสชัน
  - H2: รูปแบบคำขอ (รองรับ)
  - H2: รายการ (อินพุต)
  - H3: message
  - H3: functioncalloutput (เครื่องมือแบบอิงรอบ)
...
- หัวข้อ:
  - H2: บทบาท
  - H2: ระดับขอบเขต
  - H2: ขอบเขตของเมธอดเป็นเพียงด่านแรกเท่านั้น
...
- หัวข้อ:
  ...
  - H2: การอนุมัติอุปกรณ์อัตโนมัติตาม CIDR ที่เชื่อถือ
  - H2: การอนุมัติอัตโนมัติเมื่ออัปเกรดเมทาดาทา
  - H2: ตัวช่วยจับคู่ QR
  - H2: ความเป็นภายในและส่วนหัวที่ส่งต่อ
...
- หัวข้อ:
  ...
  - H2: การเข้าถึงระยะไกลของ Chat UI
...
- หัวข้อ:
  ...
  - H2: ยกระดับ: "รันบนโฮสต์" สำหรับ exec เท่านั้น
  - H2: วิธีแก้ไข "sandbox jail" ที่พบบ่อย
  - H3: "เครื่องมือ X ถูกบล็อกโดยนโยบายเครื่องมือของ sandbox"
  - H3: "ฉันนึกว่านี่คือ main ทำไมจึงอยู่ใน sandbox?"
  - H2: ที่เกี่ยวข้อง
...
- หัวข้อ:
  ...
  - H2: การเขียนทับสำหรับหลายเอเจนต์
...
- หัวข้อ:
  ...
  - H2: กฎการตรวจสอบความถูกต้องของพาธ
...
- หัวข้อ:
  ...
  - H2: การระบุเส้นทางคำสั่ง
  - H2: เวิร์กโฟลว์ตรวจสอบและกำหนดค่า
...
- หัวข้อ:
  ...
  - H2: การตรวจสอบอย่างรวดเร็ว: openclaw security audit
  ...
  - H2: สิ่งที่การตรวจสอบตรวจเช็ก (ระดับสูง)
  ...
  - H2: Sandboxing (แนะนำ)
  - H3: ขอบกั้นการมอบหมายงานให้ sub-agent
...
- หัวข้อ:
  - H2: ลำดับขั้นคำสั่ง
  - H2: หลังการอัปเดต
  - H2: การติดตั้งแบบ split brain และตัวป้องกัน config ที่ใหม่กว่า
  ...
  - H2: การตอบกลับถูกบล็อกด้วย upstream 403
  - H2: แบ็กเอนด์ที่เข้ากันได้กับ OpenAI ในเครื่องผ่านการ probe โดยตรง แต่การรันเอเจนต์ล้มเหลว
  - H2: ไม่มีการตอบกลับ
  - H2: การเชื่อมต่อของ Dashboard control UI
...
- หัวข้อ:
  - H2: การเขียนทับการดีบักรันไทม์
  - H2: เอาต์พุต trace ของเซสชัน
  - H2: trace วงจรชีวิตของ Plugin
  - H2: การโปรไฟล์การเริ่มต้น CLI และคำสั่ง
...
- หัวข้อ:
  - H2: เริ่มต้นอย่างรวดเร็วและการตั้งค่าในการรันครั้งแรก
  - H2: ที่เกี่ยวข้อง
...
- หัวข้อ:
  - H2: ข้อตกลง
  - H2: สคริปต์เฝ้าติดตามการยืนยันตัวตน
...
- หัวข้อ:
  ...
  - H3: ชั้นที่ 2: Gateway + smoke ของเอเจนต์ dev (สิ่งที่ "@openclaw" ทำจริง)
  - H2: Live: smoke ของแบ็กเอนด์ CLI (Claude, Gemini หรือ CLI ภายในเครื่องอื่นๆ)
  - H2: Live: ความสามารถในการเข้าถึงพร็อกซี APNs HTTP/2
  - H2: Live: smoke การ bind ของ ACP (/acp spawn ... --bind here)
  - H2: Live: smoke ของ harness แอปเซิร์ฟเวอร์ Codex
...
- หัวข้อ:
  ...
  - H2: runner Docker (การตรวจสอบ "ทำงานบน Linux" แบบเลือกได้)
  - H2: การตรวจ sanity ของเอกสาร
  - H2: regression แบบออฟไลน์ (ปลอดภัยสำหรับ CI)
  - H2: การประเมินความน่าเชื่อถือของเอเจนต์ (Skills)
  - H2: การทดสอบ contract (รูปทรง Plugin และช่องทาง)
  - H3: คำสั่ง
  - H3: contract ของช่องทาง
  - H3: contract สถานะของผู้ให้บริการ
  - H3: contract ของผู้ให้บริการ
  - H3: ควรรันเมื่อใด
...
- หัวข้อ:
  - H2: 60 วินาทีแรก
  - H2: ผู้ช่วยดูถูกจำกัดหรือขาดเครื่องมือ
  - H2: Anthropic long context 429
  - H2: แบ็กเอนด์ภายในเครื่องที่เข้ากันได้กับ OpenAI ใช้งานได้โดยตรงแต่ล้มเหลวใน OpenClaw
  - H2: การติดตั้ง Plugin ล้มเหลวเนื่องจากขาด openclaw extensions
...
- หัวข้อ:
  - H2: การสลับช่องทาง
  - H2: การกำหนดเป้าหมายเวอร์ชันหรือ tag แบบครั้งเดียว
  - H2: dry run
...
- หัวข้อ:
  - H2: ฝังไบนารีที่จำเป็นลงในอิมเมจ
...
- หัวข้อ:
  ...
  - H3: การเขียน config ผ่าน SSH
  - H3: state ไม่คงอยู่
  - H2: การอัปเดต
  - H3: คำสั่งอัปเดตเครื่อง
  - H2: การปรับใช้แบบส่วนตัว (เสริมความแข็งแกร่งแล้ว)
...
- เส้นทาง: /install/gcp
- หัวข้อ:
  - H2: เรากำลังทำอะไร (พูดง่ายๆ)?
  - H2: เส้นทางด่วน (ผู้ปฏิบัติงานที่มีประสบการณ์)
  - H2: สิ่งที่คุณต้องมี
  - H2: การแก้ไขปัญหา
  - H2: service accounts (แนวทางปฏิบัติที่ดีที่สุดด้านความปลอดภัย)
  - H2: ขั้นตอนถัดไป
  - H2: ที่เกี่ยวข้อง
...
- หัวข้อ:
  ...
  - H2: install.sh
  - H3: โฟลว์ (install.sh)
  - H3: การตรวจพบ checkout ของซอร์ส
...
- หัวข้อ:
  ...
  - H2: ติดตั้ง Node
  - H2: การแก้ไขปัญหา
  - H3: openclaw: ไม่พบคำสั่ง
  - H3: ข้อผิดพลาดสิทธิ์ในการ npm install -g (Linux)
  - H2: ที่เกี่ยวข้อง
...
- หัวข้อ:
  ...
  - H2: Systemd (Quadlet, แบบเลือกได้)
...
- หัวข้อ:
  ...
  - H3: ระดับบันทึก
  - H3: การวินิจฉัยการส่งข้อมูลโมเดลแบบเจาะจง
...
- หัวข้อ:
  ...
  - H3: ข้อกำหนดให้อยู่เบื้องหน้า
  - H3: ตัวช่วย CLI
  - H2: โหนด Android
  - H3: การตั้งค่าผู้ใช้ Android (เปิดเป็นค่าเริ่มต้น)
  - H3: สิทธิ์
  - H3: ข้อกำหนดให้อยู่เบื้องหน้าของ Android
...
- หัวข้อ:
  ...
  - H2: ตำแหน่งที่ตั้ง (โหนด)
  - H2: SMS (โหนด Android)
  - H2: อุปกรณ์ Android + คำสั่งข้อมูลส่วนบุคคล
...
- หัวข้อ:
  - H2: ลำดับขั้นคำสั่ง
  - H2: ข้อกำหนดให้อยู่เบื้องหน้า
  - H2: เมทริกซ์สิทธิ์
  - H2: การจับคู่เทียบกับการอนุมัติ
  - H2: รหัสข้อผิดพลาดของโหนดทั่วไป
...
- หัวข้อ:
  ...
  - H3: Codex app-server ยังคงเป็นแหล่งมาตรฐานสำหรับสถานะเธรดแบบเนทีฟ
  ...
  - H3: 3. ต่อสาย bootstrap ก่อนเริ่มเธรด Codex
  - H3: 4. ต่อสาย assemble ก่อน thread/start / thread/resume และ turn/start
  - H3: 5. รักษาการจัดรูปแบบที่เสถียรสำหรับ prompt-cache
  - H3: 6. ต่อสาย post-turn หลังจากมิเรอร์ทรานสคริปต์
  - H3: 7. ทำให้บริบท usage และ prompt-cache runtime เป็นมาตรฐาน
  - H3: 8. นโยบาย Compaction
  - H4: /compact และ OpenClaw compaction แบบชัดเจน
  - H4: อีเวนต์ contextCompaction แบบเนทีฟของ Codex ระหว่างเทิร์น
...
- หัวข้อ:
  ...
  - H3: 8) เสียง + พื้นผิวคำสั่ง Android ที่ขยายขึ้น
...
- หัวข้อ:
  ...
  - H2: การ push ที่รองรับด้วย relay สำหรับบิลด์ทางการ
...
- หัวข้อ:
  - H2: ติดตั้ง CLI (จำเป็นสำหรับโหมดในเครื่อง)
...
- หัวข้อ:
  ...
  - H2: ล็อกไฟล์การวินิจฉัยแบบหมุนเวียน (แผง Debug)
...
- หัวข้อ:
  ...
  - H2: ความสัมพันธ์กับการใช้คอมพิวเตอร์
  - H2: เปิดใช้ bridge
  - H2: ลำดับการค้นหาไคลเอนต์
  - H2: ความปลอดภัยและสิทธิ์
  - H2: พฤติกรรมสแนปช็อต (automation)
  - H2: การแก้ไขปัญหา
  - H2: ที่เกี่ยวข้อง
...
- หัวข้อ:
  ...
  - H2: รายการตรวจสอบการกู้คืนเมื่อพรอมป์หายไป
...
- หัวข้อ:
  ...
  - H2: การใช้งาน
  - H3: หมายเหตุเกี่ยวกับการลงนามแบบ Ad-hoc
  - H2: เมตาดาต้าบิลด์สำหรับ About
  - H2: เหตุผล
  - H2: ที่เกี่ยวข้อง
...
- หัวข้อ:
  - H1: การปลุกด้วยเสียง &amp; กดเพื่อพูด
  - H2: ข้อกำหนด
  - H2: โหมด
  - H2: พฤติกรรม runtime (wake-word)
  - H2: invariant ของวงจรชีวิต
  - H2: โหมดความล้มเหลวของโอเวอร์เลย์ค้าง (ก่อนหน้า)
  - H2: รายละเอียดเฉพาะของกดเพื่อพูด
  - H2: การตั้งค่าที่ผู้ใช้เห็น
  - H2: พฤติกรรมการส่งต่อ
  - H2: เพย์โหลดการส่งต่อ
  - H2: การตรวจสอบอย่างรวดเร็ว
  - H2: ที่เกี่ยวข้อง
...
- หัวข้อ:
  ...
  - H3: เว็บแชตติดต่อ Gateway ระยะไกลไม่ได้
...
- หัวข้อ:
  - H2: pipeline การโหลด
  - H3: พฤติกรรมที่ยึด manifest ก่อน
  ...
  - H2: ไดเรกทอรีที่รองรับด้วย config
  - H2: แคตตาล็อก provider
  - H2: การตรวจสอบ channel แบบอ่านอย่างเดียว
  - H2: แพ็กแพ็กเกจ
  - H3: เมตาดาต้าแคตตาล็อก channel
...
- หัวข้อ:
  ...
  - H3: สแนปช็อตเมตาดาต้า Plugin และตาราง lookup
  - H3: การวางแผนการเปิดใช้งาน
  - H3: Plugin ของ channel และเครื่องมือข้อความร่วม
  ...
  - H2: สัญญาและการบังคับใช้
  - H3: สิ่งที่ควรอยู่ในสัญญา
...
- หัวข้อ:
  ...
  - H2: Dependencies ของ runtime และการล้างข้อมูล
  - H2: ความปลอดภัย
  - H2: การแก้ไขปัญหา
  - H2: ที่เกี่ยวข้อง
...
- หัวข้อ:
  ...
  - H2: การดำเนินการเนทีฟใน sandbox
  - H2: การแยกการยืนยันตัวตนและสภาพแวดล้อม
  - H2: เครื่องมือแบบไดนามิก
  - H2: timeout
  - H2: การค้นหาโมเดล
  - H2: ไฟล์ bootstrap ของ workspace
  - H2: การแทนที่สภาพแวดล้อม
  - H2: ที่เกี่ยวข้อง
...
- หัวข้อ:
  ...
  - H2: ขอบเขต hook
  - H2: สัญญารองรับ V1
  - H2: สิทธิ์เนทีฟและ MCP elicitations
  - H2: การบังคับทิศทางคิว
  - H2: การอัปโหลดคำติชม Codex
...
- หัวข้อ:
  ...
  - H3: การ deployment แบบ provider ผสม
...
- หัวข้อ:
  ...
  - H2: ขอบเขตรองรับ V1
  - H2: สินค้าคงคลังแอปและความเป็นเจ้าของ
...
- หัวข้อ:
  ...
  - H2: คำถามข้างเคียง (/btw)
  - H2: Doctor
  - H2: ข้อจำกัด
  - H2: สิทธิ์และ askuser
  - H3: โทเค็น GitHub ระดับเซสชัน
  - H2: ที่เกี่ยวข้อง
...
- หัวข้อ:
  ...
  - H2: ข้อมูลอ้างอิงเมทาดาทาผู้ให้บริการการสร้าง
...
- หัวข้อ:
  - H2: การติดตั้ง
  - H2: เริ่มต้นอย่างรวดเร็ว
  - H2: เอ็มเบดดิงที่รองรับโดยผู้ให้บริการ
  - H2: เอ็มเบดดิง Ollama
  ...
  - H3: โมเดลเอ็มเบดดิงที่ไม่รองรับ
...
- หัวข้อ:
  ...
  - H2: การอ้างสิทธิ์และหลักฐานแบบมีโครงสร้าง
...
- หัวข้อ:
  ...
  - H2: แผนการย้ายข้อมูล talk และเสียงแบบเรียลไทม์
...
- หัวข้อ:
  ...
  - H3: slot แบบเอกสิทธิ์
  - H3: adapter embedding หน่วยความจำที่เลิกใช้แล้ว
  - H3: เหตุการณ์และ lifecycle
  - H3: ความหมายของการตัดสินใจของ hook
  - H3: ฟิลด์ object ของ API
  - H2: ข้อตกลงของ module ภายใน
  - H2: ที่เกี่ยวข้อง
...
- หัวข้อ:
  ...
  - H2: utility runtime ที่นำกลับมาใช้ได้
...
- หัวข้อ:
  ...
  - H2: entry การตั้งค่า
  - H3: import helper การตั้งค่าแบบแคบ
...
- หัวข้อ:
  ...
  - H3: subpath ของ helper สำหรับ Plugin ที่ bundle ไว้ซึ่งสงวนไว้
  - H2: ที่เกี่ยวข้อง
...
- หัวข้อ:
  - H2: utility สำหรับการทดสอบ
  - H3: export ที่พร้อมใช้งาน
  - H3: ชนิด
  - H2: การทดสอบการ resolve target
  - H2: รูปแบบการทดสอบ
  - H3: การทดสอบ contract การลงทะเบียน
  - H3: การทดสอบการเข้าถึง config runtime
  - H3: การทดสอบหน่วย Plugin channel
  - H3: การทดสอบหน่วย Plugin provider
  - H3: การ mock runtime ของ Plugin
  - H3: การทดสอบด้วย stub ราย instance
  - H2: การทดสอบ contract (Plugin ใน repo)
  - H3: การเรียกใช้การทดสอบตาม scope
...
- หัวข้อ:
  ...
  - H3: entry ของ plugin ไม่ได้เปิดเผย metadata defineToolPlugin
...
- หัวข้อ:
  - H2: เริ่มต้นอย่างรวดเร็ว
  - H2: การกำหนดค่า
  - H2: scope ของ session
  - H2: การสนทนาด้วยเสียงแบบเรียลไทม์
  - H3: นโยบายเครื่องมือ
  - H3: context เสียงของ agent
  ...
  - H3: ตัวอย่าง TTS
  - H2: สายเรียกเข้า
  - H3: การ routing ตามหมายเลข
  - H3: contract ของเอาต์พุตที่พูด
  - H3: พฤติกรรมการเริ่มต้นการสนทนา
  - H3: grace เมื่อ stream Twilio หลุด
  - H2: ตัวล้างสายที่ค้างอยู่
  - H2: ความปลอดภัยของ Webhook
  - H2: CLI
  - H2: เครื่องมือ agent
  - H2: RPC ของ Gateway
  ...
  - H3: การโทรเริ่มต้นได้แต่ webhook ของ provider ไม่มาถึง
  - H3: การตรวจสอบ signature ล้มเหลว
...
- หัวข้อ:
  ...
  - H2: การซิงค์ lifecycle ของ session
  - H2: workflow ของ dashboard
  - H2: สิทธิ์
  - H2: การกำหนดค่า
  - H2: การแก้ไขปัญหา
...
- หัวข้อ:
  ...
  - H3: ตัวเลือก B: ติดตั้งจากโฟลเดอร์ภายในเครื่อง (dev)
  - H2: config
  - H2: CLI
  - H2: เครื่องมือ agent
  - H2: ที่เกี่ยวข้อง
...
- หัวข้อ:
  ...
  - H2: การ mapping runtime ของ OpenClaw
  - H2: ตำแหน่งไฟล์
  - H2: backend ของสถานะ
  - H2: ความปลอดภัย
  - H2: ที่เกี่ยวข้อง
...
- หัวข้อ:
  ...
  - H2: เวกเตอร์ฝังสำหรับการค้นหาหน่วยความจำ
  - H3: การกำหนดค่า
  - H3: วิธีการทำงาน
  - H2: ที่เกี่ยวข้อง
...
- หัวข้อ:
  ...
  - H2: แค็ตตาล็อกแนะนำ
  - H2: Nemotron 3 Ultra
  - H2: แค็ตตาล็อกสำรองที่มาพร้อมระบบ
  - H2: การกำหนดค่าขั้นสูง
  - H2: ที่เกี่ยวข้อง
...
- หัวข้อ:
  ...
  - H2: เวกเตอร์ฝังหน่วยความจำ
  - H2: เริ่มต้นใช้งาน
  - H2: การตรวจสอบสิทธิ์ app-server ของ Codex แบบเนทีฟ
  - H2: การสร้างภาพ
  - H2: การสร้างวิดีโอ
  - H2: การมีส่วนร่วมพรอมป์ GPT-5
  - H2: เสียงและเสียงพูด
  - H2: ปลายทาง Azure OpenAI
  - H3: การกำหนดค่า
  - H3: เวอร์ชัน API
...
- หัวข้อ:
  ...
  - H2: แผนการย้ายข้อมูล
  - H3: ระยะที่ 1: เพิ่มอัตลักษณ์และการเช่า
  - H3: ระยะที่ 2: การล้างข้อมูลแบบเน้นการเช่าก่อน
  - H3: ระยะที่ 3: การเก็บกวาดเมื่อเริ่มต้นแบบเน้นการเช่าก่อน
...
- หัวข้อ:
  - H1: การรีแฟกเตอร์สถานะแบบฐานข้อมูลก่อน
  - H2: การตัดสินใจ
  - H2: สัญญาเข้มงวด
  ...
  - H2: รูปแบบการย้ายข้อมูลของ Doctor
  - H2: รายการสินทรัพย์การย้ายข้อมูล
  - H2: แผนการย้ายข้อมูล
  ...
  - H3: ระยะที่ 6: รันไทม์ของ Worker
  - H3: ระยะที่ 7: ลบโลกเก่า
  - H2: การสำรองข้อมูลและกู้คืน
...
- หัวข้อ:
  ...
  - H2: รอบการเผยแพร่
  - H2: รายการตรวจสอบผู้ดำเนินการเผยแพร่
  - H2: การปิดงาน main เสถียร
  - H2: การตรวจสอบล่วงหน้าก่อนเผยแพร่
...
- หัวข้อ:
  ...
  - H2: ระยะที่ 5: การเสริมความแข็งแรงของประเภท สัญญา และการทดสอบ
...
- หัวข้อ:
  ...
  - H2: ชิ้นงานเส้นทางการเผยแพร่ Docker
...
- หัวข้อ:
  ...
  - H3: ไทม์เอาต์เอ็มเบดดิ้งแบบอินไลน์
  - H2: การกำหนดค่าการค้นหาแบบไฮบริด
  - H3: ตัวอย่างแบบเต็ม
  - H2: เส้นทางหน่วยความจำเพิ่มเติม
  - H2: หน่วยความจำหลายโมดัล (Gemini)
  - H2: แคชเอ็มเบดดิ้ง
...
- หัวข้อ:
  - H1: แบบแผน placeholder สำหรับความลับ
  - H2: สไตล์ที่แนะนำ
...
- หัวข้อ:
  ...
  - H2: เมื่อเกิดการ Compaction อัตโนมัติ (รันไทม์ OpenClaw)
...
- หัวข้อ:
  - H1: BOOTSTRAP.md - สวัสดี ชาวโลก
  - H2: บทสนทนา
  - H2: หลังจากที่คุณรู้ว่าคุณคือใคร
...
- หัวข้อ:
  ...
  - H2: ทดสอบควันการนำเข้า QR (Docker)
  - H2: ที่เกี่ยวข้อง
...
- หัวข้อ:
  ...
  - H2: การประมาณต้นทุน (เมื่อแสดง)
  - H2: TTL ของแคชและผลกระทบจากการตัดแต่ง
...
- หัวข้อ:
  - H2: กฎส่วนกลาง: บริบทรันไทม์ไม่ใช่ทรานสคริปต์ของผู้ใช้
...
- หัวข้อ:
  ...
  - H3: ผลลัพธ์ระยะไกลและการส่งสื่อ
...
- หัวข้อ:
  ...
  - H3: การมีส่วนร่วมกับแบบจำลองภัยคุกคามนี้
  - H2: 1. บทนำ
  - H3: 1.1 จุดประสงค์
  - H3: 1.2 ขอบเขต
  - H3: 1.3 นอกขอบเขต
  ...
  - H4: T-PERSIST-002: การปนเปื้อนการอัปเดต Skill
  ...
  - H3: 3.7 การรวบรวม &amp; การส่งข้อมูลออก (AML.TA0009, AML.TA0010)
...
- หัวข้อ:
  ...
  - H2: ข้อควรระวังสำคัญ
  - H2: การทำซ้ำผลลัพธ์
  - H3: การเปิดเผย Gateway และการกำหนดค่า Gateway เปิดที่ผิดพลาด
  - H3: ไปป์ไลน์ exec ของ Node (ความสามารถที่มีความเสี่ยงสูงสุด)
  - H3: ที่เก็บการจับคู่ (การกั้น DM)
  - H3: การกั้นขาเข้า (การเมนชัน + การเลี่ยงคำสั่งควบคุม)
  ...
  - H3: ลำดับความสำคัญของ dmScope ในการกำหนดเส้นทาง + identityLinks
  - H2: ที่เกี่ยวข้อง
...
- หัวข้อ:
  - H2: สิ่งที่การบูตสแตรปทำ
  - H2: การข้ามการบูตสแตรป
  - H2: ตำแหน่งที่ทำงาน
  - H2: เอกสารที่เกี่ยวข้อง
...
- หัวข้อ:
  ...
  - H3: การทิ้งไดเรกทอรี (3 ธ.ค. 2025)
  - H3: การลอกคราบครั้งใหญ่ (27 ม.ค. 2026)
  - H3: รูปแบบสุดท้าย (30 มกราคม 2026)
  - H3: การช้อปปิงหุ่นยนต์ครั้งใหญ่ (3 ธ.ค. 2025)
...
- หัวข้อ:
  ...
  - H2: เรียกใช้ Gateway จากรีโปนี้
  - H2: เวิร์กโฟลว์เสถียร (เริ่มจากแอป macOS)
  - H2: เวิร์กโฟลว์รุ่นล้ำหน้า (Gateway ในเทอร์มินัล)
  - H3: 0) (ไม่บังคับ) เรียกใช้แอป macOS จากซอร์สด้วย
  - H3: 1) เริ่ม Gateway สำหรับพัฒนา
  - H3: 2) ชี้แอป macOS ไปยัง Gateway ที่กำลังทำงานของคุณ
  - H3: 3) ตรวจสอบ
  - H3: ข้อพลาดง่ายที่พบบ่อย
  - H2: แผนผังการจัดเก็บข้อมูลประจำตัว
...
- หัวข้อ:
  ...
  - H3: บริดจ์ MCP ของเครื่องมือ Plugin
  - H3: บริดจ์ MCP ของเครื่องมือ OpenClaw
  - H3: การกำหนดค่าการหมดเวลาของการทำงานขณะรันไทม์
...
- หัวข้อ:
  ...
  - H2: คู่มือปฏิบัติการสำหรับผู้ดูแล
...
- หัวข้อ:
  ...
  - H2: อ้างอิงด่วน CLI
  - H2: สแนปช็อตและ refs
  - H2: การเพิ่มความสามารถให้การรอ
  - H2: เวิร์กโฟลว์ดีบัก
  - H2: เอาต์พุต JSON
  - H2: ตัวปรับแต่งสถานะและสภาพแวดล้อม
...
- หัวข้อ:
  - H2: การเข้าสู่ระบบด้วยตนเอง (แนะนำ)
...
- หัวข้อ:
  ...
  - H3: ชั้น 3: กำหนดค่าโปรไฟล์เบราว์เซอร์ให้ถูกต้อง
  - H3: ชั้น 4: ตรวจสอบชั้น Control UI แยกต่างหาก
  - H3: ชั้น 5: ตรวจสอบการควบคุมเบราว์เซอร์ตั้งแต่ต้นจนจบ
...
- หัวข้อ:
  ...
  - H2: การควบคุมภายในเทียบกับระยะไกล
  ...
  - H3: การเรียกใช้งาน Chrome MCP แบบกำหนดเอง
...
- หัวข้อ:
  ...
  - H3: การเชน shell, wrappers และ multiplexers
  ...
  - H3: การอนุมัติในแชทเดียวกันบนช่องทางใดก็ได้
...
- หัวข้อ:
  ...
  - H3: การตั้งค่า "never prompt" แบบถาวรบนโฮสต์ Gateway
  - H3: ทางลัดภายใน
  - H3: โฮสต์ Node
...
- หัวข้อ:
  ...
  - H2: กำหนดค่า fallback ของ Firecrawl สำหรับ webfetch
  - H3: Firecrawl แบบ self-hosted
  - H2: เครื่องมือ Plugin ของ Firecrawl
  - H3: firecrawlsearch
  - H3: firecrawlscrape
  - H2: Stealth / การหลีกเลี่ยงบอต
...
- หัวข้อ:
  ...
  - H2: การแมปผู้ให้บริการ (วิธีที่ผู้ขายแบ่งข้ามพื้นผิวต่าง ๆ)
  - H2: ที่เกี่ยวข้อง
...
- หัวข้อ:
  ...
  - H2: รายการอนุญาต Skills ที่รวมมาให้
  - H2: รายการแยกตาม Skill (skills.entries)
  - H2: รายการอนุญาตของเอเจนต์ (agents)
  - H2: เวิร์กช็อป (skills.workshop)
  - H2: รูท Skill แบบ symlink
  - H2: Skills แบบ sandbox และตัวแปรสภาพแวดล้อม
...
- หัวข้อ:
  ...
  - H2: โหมดเร็ว (/fast)
  - H2: ไดเรกทีฟแบบละเอียด (/verbose หรือ /v)
  - H2: ไดเรกทีฟ trace ของ Plugin (/trace)
...
- หัวข้อ:
  ...
  - H3: นโยบายสำรอง
  - H2: ไดเรกทีฟที่ขับเคลื่อนด้วยโมเดล
  - H2: คำสั่ง Slash
...
- หัวข้อ:
  ...
  - H2: พารามิเตอร์ของเครื่องมือ
  - H2: วิธีการทำงาน
  - H2: อัปเดตความคืบหน้า
  - H2: การกำหนดค่า
  - H2: การสำรองด้วย Firecrawl
...
- หัวข้อ:
  ...
  - H2: การปรับแต่งการเริ่มทำงานสำหรับ VM ขนาดเล็กและโฮสต์ ARM
...
- หัวข้อ:
  ...
  - H2: ตัวตนส่วนบุคคล (เฉพาะเบราว์เซอร์ในเครื่อง)
...
- หัวข้อ:
  ...
  - H2: พื้นฐานการยืนยันตัวตน (ในเครื่องเทียบกับระยะไกล)
...
- หัวข้อ:
  ...
  - H3: โหมดในเครื่อง
  - H2: สิ่งที่คุณเห็น
  - H2: โมเดลเชิงแนวคิด: เอเจนต์ + เซสชัน
  - H2: การส่ง + การนำส่ง
...
- หัวข้อ:
  ...
  - H2: เริ่มต้นอย่างรวดเร็ว
  - H2: วิธีการทำงาน (พฤติกรรม)
  - H3: โมเดลทรานสคริปต์และการนำส่ง
