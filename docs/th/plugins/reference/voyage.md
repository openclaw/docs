---
read_when:
    - คุณกำลังติดตั้ง กำหนดค่า หรือตรวจสอบ Plugin voyage
summary: เพิ่มการรองรับผู้ให้บริการการฝังข้อมูลสำหรับหน่วยความจำ.
title: Plugin Voyage
x-i18n:
    generated_at: "2026-05-02T20:57:59Z"
    model: gpt-5.5
    provider: openai
...
เพิ่มการรองรับผู้ให้บริการ embedding หน่วยความจำ
