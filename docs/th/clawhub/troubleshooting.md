---
read_when:
    - คำสั่ง CLI ของ ClawHub หรือคำสั่งรีจิสทรีของ OpenClaw ล้มเหลว
...
x-i18n:
    generated_at: "2026-07-01T20:40:00Z"
    model: gpt-5.5
...
หากผู้ใช้จำนวนมากใช้ IP ขาออกเดียวกันร่วมกัน ขีดจำกัด IP แบบไม่ระบุตัวตนอาจถูกชนแม้ว่าแต่ละ
คนจะส่งคำขอเพียงไม่กี่รายการ เข้าสู่ระบบเมื่อทำได้และลองใหม่หลังจาก
...
## ทักษะไม่ปรากฏในการค้นหา

- ตรวจสอบ slug ที่แน่นอนหรือหน้าของเจ้าของหากคุณทราบ
- ยืนยันว่า release เป็นสาธารณะและไม่ได้ถูกกักไว้โดยการสแกนหรือการตรวจสอบเนื้อหา
- หากคุณเป็นเจ้าของทักษะ ให้เข้าสู่ระบบและตรวจสอบ:

```bash
clawhub inspect @openclaw/demo
```

การวินิจฉัยที่เจ้าของเห็นได้อาจอธิบายสถานะการสแกน, upload-gate หรือการตรวจสอบเนื้อหา

## การเผยแพร่ล้มเหลวเพราะ metadata ที่จำเป็นขาดหายไป

สำหรับทักษะ ให้ตรวจสอบ frontmatter ของ `SKILL.md` ควรประกาศตัวแปรสภาพแวดล้อมและ
...
หากการเผยแพร่ล้มเหลวเพราะ handle เจ้าของ, namespace ขององค์กร, scope ของแพ็กเกจ, slug ของทักษะ
...
หากคุณเชื่อว่าองค์กร โปรเจกต์ หรือแบรนด์ของคุณเป็นเจ้าของ namespace ที่ถูกต้องโดยชอบธรรม แต่
...
- ยืนยันว่าเวอร์ชัน OpenClaw ของคุณเป็นไปตามช่วงความเข้ากันได้ที่แพ็กเกจ
  ประกาศไว้
- หากแพ็กเกจถูกซ่อน ถูกกักไว้ หรือถูกบล็อก อาจไม่สามารถติดตั้งได้จนกว่า
  เจ้าของจะแก้ไขปัญหา
...
- อย่าทำ mirror เนื้อหาที่ซ่อน เป็นส่วนตัว ถูกกักไว้ หรือถูกบล็อกโดยการตรวจสอบเนื้อหานอก
  พื้นผิว Public API
