...
ClawHub ใช้ GitHub สำหรับการลงชื่อเข้าใช้เว็บ CLI ใช้โทเค็น API ของ ClawHub ที่สร้าง
...
บัญชีที่ถูกลบ ถูกแบน หรือถูกปิดใช้งานจะไม่สามารถลงชื่อเข้าใช้ ClawHub ตามปกติให้เสร็จสมบูรณ์ได้
...
กฎพร็อกซี ให้ใช้โฟลว์โทเค็นแบบไม่ใช้เบราว์เซอร์

## การเข้าสู่ระบบแบบไม่ใช้เบราว์เซอร์
...
โทเค็นที่ถูกเพิกถอน ไม่ถูกต้อง หรือหายไปจะส่งกลับ `401 Unauthorized` ลงชื่อเข้าใช้อีกครั้ง
