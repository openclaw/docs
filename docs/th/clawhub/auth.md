...
read_when:
    ...
    - การใช้ ClawHub CLI
    - การดีบัก 401s
summary: การเข้าสู่ระบบ ClawHub, โทเค็น API, การเข้าสู่ระบบ CLI, การจัดเก็บโทเค็น และการเพิกถอน
x-i18n:
    generated_at: "2026-07-02T17:48:34Z"
    model: gpt-5.5
...
หากการลงชื่อเข้าใช้นำคุณกลับไปยังสถานะที่ออกจากระบบอยู่ บัญชีของคุณอาจไม่ได้อยู่ในสถานะดี
...
หากเบราว์เซอร์ของคุณไม่สามารถเข้าถึง callback ภายในเครื่องได้เนื่องจากไฟร์วอลล์, VPN หรือ
กฎพร็อกซี ให้ใช้ขั้นตอนโทเค็นแบบไม่มีหน้าจอ
