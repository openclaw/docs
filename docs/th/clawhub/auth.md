...
หากการลงชื่อเข้าใช้พาคุณกลับไปยังสถานะที่ออกจากระบบแล้ว บัญชีของคุณอาจไม่ได้อยู่ใน
...
1. CLI เริ่มเซิร์ฟเวอร์รับ callback ชั่วคราวบน `127.0.0.1`
...
หากเบราว์เซอร์ของคุณเข้าถึง callback ภายในเครื่องไม่ได้เนื่องจากกฎไฟร์วอลล์, VPN หรือ
พร็อกซี ให้ใช้โฟลว์โทเค็นแบบไม่มีส่วนติดต่อ

## การเข้าสู่ระบบแบบไม่มีส่วนติดต่อ
...
CLI จะพิมพ์รหัสใช้ครั้งเดียวและรอขณะที่คุณอนุมัติที่
