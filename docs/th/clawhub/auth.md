...
x-i18n:
    generated_at: "2026-06-30T14:29:24Z"
    model: gpt-5.5
...
บัญชีที่ถูกลบ ถูกแบน หรือถูกปิดใช้งานไม่สามารถดำเนินการลงชื่อเข้าใช้ ClawHub ตามปกติได้
...
5. CLI เก็บโทเค็นไว้ในไฟล์การกำหนดค่า ClawHub ของคุณ
...
ใช้โฟลว์นี้สำหรับเซิร์ฟเวอร์ งาน CI หรือสภาพแวดล้อมที่ใช้ได้เฉพาะเทอร์มินัล
