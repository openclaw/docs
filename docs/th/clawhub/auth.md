...
x-i18n:
    generated_at: "2026-06-27T17:15:40Z"
    model: gpt-5.5
...
พร็อกซี ให้ใช้ขั้นตอนโทเค็นแบบไม่มีส่วนติดต่อผู้ใช้

## การเข้าสู่ระบบแบบไม่มีส่วนติดต่อผู้ใช้

สร้างโทเค็นในเว็บ UI ของ ClawHub แล้วส่งให้ CLI:
...
คุณสามารถเพิกถอนโทเค็น API ได้ในเว็บ UI ของ ClawHub

โทเค็นที่ถูกเพิกถอน ไม่ถูกต้อง หรือหายไปจะส่งคืน `401 Unauthorized` ให้ลงชื่อเข้าใช้อีกครั้ง
