...
x-i18n:
    generated_at: "2026-07-05T08:59:11Z"
    model: gpt-5.5
...
หากการลงชื่อเข้าใช้พาคุณกลับไปยังสถานะที่ออกจากระบบแล้ว บัญชีของคุณอาจไม่มี
สถานะที่ดี หากบัญชีของคุณถูกแบนหรือถูกปิดใช้งาน ให้ใช้
...
proxy ให้ใช้โฟลว์โทเค็นแบบไม่มีอินเทอร์เฟซ
