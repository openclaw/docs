...
หากเบราว์เซอร์ของคุณเข้าถึง callback ภายในเครื่องไม่ได้เนื่องจากไฟร์วอลล์ VPN หรือ
กฎพร็อกซี ให้ใช้โฟลว์โทเค็นแบบไม่มีส่วนติดต่อผู้ใช้
...
โทเค็นที่ถูกเพิกถอน ไม่ถูกต้อง หรือไม่มีอยู่ จะส่งคืน `401 Unauthorized` ลงชื่อเข้าใช้อีกครั้ง
