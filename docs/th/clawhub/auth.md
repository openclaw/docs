...
x-i18n:
    generated_at: "2026-07-02T08:59:09Z"
    model: gpt-5.5
...
ClawHub ใช้ GitHub สำหรับการลงชื่อเข้าใช้เว็บ CLI ใช้โทเค็น ClawHub API ที่สร้าง
...
ใช้ขั้นตอนนี้สำหรับเซิร์ฟเวอร์ งาน CI หรือสภาพแวดล้อมที่ใช้เฉพาะเทอร์มินัล
...
โทเค็นที่ถูกเพิกถอน ไม่ถูกต้อง หรือขาดหายไปจะส่งกลับ `401 Unauthorized` ลงชื่อเข้าใช้อีกครั้ง
ด้วย `clawhub login` หรือให้โทเค็นใหม่ด้วย `clawhub login --token`
