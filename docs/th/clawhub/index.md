...
title: ClawHub
x-i18n:
    generated_at: "2026-05-12T08:44:29Z"
    model: gpt-5.5
    provider: openai
...
ติดตั้ง ClawHub CLI เมื่อต้องการเวิร์กโฟลว์ที่ต้องยืนยันตัวตนกับรีจิสทรี เช่น
เผยแพร่ ซิงก์ หรือลบ/ยกเลิกการลบ:
...
| Plugin บันเดิล | บันเดิล Plugin แบบแพ็กเกจสำหรับการเผยแพร่ OpenClaw            | `clawhub package publish <source>`           |
| Souls          | บันเดิล `SOUL.md` ที่แสดงบน onlycrabs.ai                      | เวิร์กโฟลว์เผยแพร่ผ่านเว็บและ API                    |
...
เมตาดาต้าแหล่งที่มาไว้ เพื่อให้คำสั่งอัปเดตภายหลังยังคงใช้ ClawHub ได้

ใช้ `clawhub:<package>` เมื่อต้องการให้การติดตั้ง Plugin resolve ผ่าน ClawHub
สเปก Plugin แบบ npm-safe ที่ไม่ระบุแหล่งอาจ resolve ผ่าน npm ระหว่างช่วงเปลี่ยนผ่านการเปิดตัว และ
...
ที่ประกาศไว้ก่อนรันการติดตั้งจากอาร์ไคฟ์ เมื่อเวอร์ชันแพ็กเกจเผยแพร่อาร์ติแฟกต์
ClawPack OpenClaw จะเลือก `.tgz` จาก npm-pack ที่อัปโหลดไว้อย่างตรงเวอร์ชัน ตรวจสอบ
...
และดูเมตาดาต้าของ Skill ที่ [รูปแบบ Skill](/th/clawhub/skill-format)

## ความปลอดภัยและการดูแล

ClawHub เปิดเป็นค่าเริ่มต้น: ใครก็อัปโหลดได้ แต่การเผยแพร่ต้องใช้บัญชี GitHub
ที่มีอายุเก่าเพียงพอจะผ่านด่านอัปโหลด หน้ารายละเอียดสาธารณะสรุปสถานะการสแกนล่าสุด
ก่อนติดตั้งหรือดาวน์โหลด

ClawHub รันการตรวจสอบอัตโนมัติกับ Skills และรีลีส Plugin ที่เผยแพร่ รีลีสที่ถูกระงับจากการสแกน
หรือถูกบล็อกอาจหายไปจากแค็ตตาล็อกสาธารณะและพื้นผิวการติดตั้ง ในขณะที่ยังคง
...
เมื่อคุณรัน `clawhub sync` ขณะลงชื่อเข้าใช้ CLI จะส่งสแนปชอตแบบขั้นต่ำเพื่อให้
...
ดูเอกสารอ้างอิงเชิงลึกเพิ่มเติมที่ [Telemetry](/th/clawhub/telemetry), [HTTP API](/th/clawhub/http-api) และ
