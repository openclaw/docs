...
ใช้ `clawhub:<package>` เมื่อการติดตั้ง Plugin ควรแก้ไขผ่าน ClawHub
สเปก Plugin แบบ bare ที่ปลอดภัยสำหรับ npm อาจแก้ไขผ่าน npm ระหว่างช่วงเปลี่ยนผ่านการเปิดตัว และ
...
ที่ประกาศไว้ก่อนการติดตั้งจากอาร์ไคฟ์จะทำงาน เมื่อเวอร์ชันแพ็กเกจเผยแพร่
อาร์ติแฟกต์ ClawPack, OpenClaw จะเลือก npm-pack `.tgz` ที่อัปโหลดมาอย่างตรงรุ่น, ตรวจสอบ
ส่วนหัว digest ของ ClawHub และไบต์ที่ดาวน์โหลดมา และบันทึกเมทาดาทาอาร์ติแฟกต์ไว้สำหรับ
การอัปเดตในภายหลัง
...
ClawHub เรียกใช้การตรวจสอบอัตโนมัติกับ Skills และรุ่น Plugin ที่เผยแพร่ รุ่นที่ถูกพักเพราะการสแกน
...
เมื่อคุณเรียกใช้ `clawhub install` ขณะที่ลงชื่อเข้าใช้อยู่ CLI อาจส่งอีเวนต์การติดตั้ง
แบบพยายามอย่างดีที่สุด เพื่อให้ ClawHub คำนวณจำนวนการติดตั้งรวมได้ ปิดใช้งานสิ่งนี้ด้วย:
