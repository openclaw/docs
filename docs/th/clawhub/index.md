...
title: ClawHub
x-i18n:
    generated_at: "2026-07-01T13:25:38Z"
    model: gpt-5.5
...
| -------------- | ------------------------------------------------------------ | -------------------------------------------- |
| Skills         | บันเดิลข้อความแบบมีเวอร์ชันพร้อม `SKILL.md` และไฟล์ประกอบ | `openclaw skills install @openclaw/demo`     |
...
เมทาดาทาแหล่งที่มาไว้ เพื่อให้คำสั่งอัปเดตภายหลังยังคงอยู่บน ClawHub ได้

ใช้ `clawhub:<package>` เมื่อการติดตั้ง Plugin ควร resolve ผ่าน ClawHub
สเปก Plugin แบบ npm-safe ที่ไม่มีคำนำหน้าอาจ resolve ผ่าน npm ระหว่างช่วงเปลี่ยนผ่านตอนเปิดตัว และ
...
ที่ประกาศไว้ก่อนเริ่มติดตั้ง archive เมื่อเวอร์ชันของแพ็กเกจเผยแพร่
อาร์ทิแฟกต์ ClawPack แล้ว OpenClaw จะเลือก npm-pack `.tgz` ที่อัปโหลดไว้ตรงตัว ตรวจสอบ
ส่วนหัว digest ของ ClawHub และไบต์ที่ดาวน์โหลดมา และบันทึกเมทาดาทาอาร์ทิแฟกต์ไว้สำหรับ
การอัปเดตภายหลัง
...
ClawHub รันการตรวจสอบอัตโนมัติกับ Skills และรีลีส Plugin ที่เผยแพร่ รีลีสที่ถูกระงับโดยการสแกน
...
เมื่อคุณรัน `clawhub install` ขณะลงชื่อเข้าใช้อยู่ CLI อาจส่งเหตุการณ์การติดตั้งแบบ best-effort
