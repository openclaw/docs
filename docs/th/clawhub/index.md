...
| Bundle Plugin | บันเดิล Plugin แบบแพ็กเกจสำหรับการจัดจำหน่าย OpenClaw            | `clawhub package publish <source>`           |
...
เมทาดาทาแหล่งที่มาไว้ เพื่อให้คำสั่งอัปเดตภายหลังยังอยู่บน ClawHub ได้
...
ที่ประกาศไว้ก่อนการติดตั้งอาร์ไคฟ์จะทำงาน เมื่อเวอร์ชันแพ็กเกจเผยแพร่อาร์ติแฟกต์
ClawPack, OpenClaw จะเลือก `.tgz` จาก npm-pack ที่อัปโหลดไว้แบบตรงตัว ตรวจสอบ
...
ใช้ `--dry-run` เพื่อสร้างแผนการเผยแพร่แบบตรงตัวโดยไม่อัปโหลด และใช้ `--json`
...
ที่มีอายุเก่าพอจะผ่านเกตการอัปโหลด หน้ารายละเอียดสาธารณะสรุปสถานะการสแกนล่าสุด
ก่อนติดตั้งหรือดาวน์โหลด

ClawHub เรียกใช้การตรวจสอบอัตโนมัติกับ Skills และรุ่นเผยแพร่ Plugin ที่เผยแพร่แล้ว รุ่นเผยแพร่ที่ถูกพักไว้จากการสแกน
หรือถูกบล็อกอาจหายไปจากแค็ตตาล็อกสาธารณะและพื้นผิวการติดตั้ง ขณะยังคง
...
เมื่อคุณเรียกใช้ `clawhub install` ขณะลงชื่อเข้าใช้ CLI อาจส่งเหตุการณ์การติดตั้งแบบ best-effort
