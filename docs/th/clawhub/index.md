...
title: ClawHub
x-i18n:
    generated_at: "2026-07-03T17:47:30Z"
    model: gpt-5.5
...
| Plugin แบบบันเดิล | บันเดิล Plugin ที่แพ็กเกจแล้วสำหรับการแจกจ่าย OpenClaw            | `clawhub package publish <source>`           |
...
ที่ประกาศไว้ก่อนเริ่มการติดตั้งจากอาร์ไคฟ์ เมื่อเวอร์ชันของแพ็กเกจเผยแพร่อาร์ติแฟกต์
ClawPack แล้ว OpenClaw จะเลือก npm-pack `.tgz` ที่อัปโหลดไว้อย่างตรงรุ่น ตรวจสอบ
...
ใช้ `--dry-run` เพื่อสร้างแผนการเผยแพร่ที่ตรงทั้งหมดโดยไม่อัปโหลด และ `--json`
...
ClawHub รันการตรวจสอบอัตโนมัติกับ Skills และรุ่น Plugin ที่เผยแพร่แล้ว รุ่นที่ถูกพักไว้
เพราะการสแกนหรือถูกบล็อกอาจหายไปจากแค็ตตาล็อกสาธารณะและพื้นผิวการติดตั้ง ในขณะที่
...
เมื่อคุณรัน `clawhub install` ขณะลงชื่อเข้าใช้ CLI อาจส่งเหตุการณ์การติดตั้งแบบพยายามอย่างดีที่สุด
...
[การแก้ไขปัญหา](/th/clawhub/troubleshooting) สำหรับเอกสารอ้างอิงเชิงลึก
