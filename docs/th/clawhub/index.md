...
title: ClawHub
x-i18n:
    generated_at: "2026-07-04T04:10:38Z"
    model: gpt-5.5
...
สเปก Plugin แบบไม่ระบุแหล่งที่มาที่ปลอดภัยกับ npm อาจถูกแก้ไขผ่าน npm ระหว่างช่วงเปลี่ยนผ่านการเปิดตัว และ
...
ที่ประกาศไว้ก่อนเรียกใช้การติดตั้งจากอาร์ไคฟ์ เมื่อเวอร์ชันแพ็กเกจเผยแพร่อาร์ทิแฟกต์
ClawPack OpenClaw จะเลือก npm-pack `.tgz` ที่อัปโหลดมาอย่างตรงรุ่น ตรวจสอบ
ส่วนหัวไดเจสต์ของ ClawHub และไบต์ที่ดาวน์โหลด และบันทึกเมทาดาทาอาร์ทิแฟกต์สำหรับ
การอัปเดตภายหลัง
...
ClawHub เรียกใช้การตรวจสอบอัตโนมัติกับ Skills และรุ่นเผยแพร่ Plugin ที่เผยแพร่แล้ว รุ่นเผยแพร่
ที่ถูกพักไว้เพราะการสแกนหรือถูกบล็อกอาจหายไปจากแคตตาล็อกสาธารณะและพื้นผิวการติดตั้ง ในขณะที่
...
การติดตั้งแบบพยายามอย่างดีที่สุด เพื่อให้ ClawHub คำนวณจำนวนการติดตั้งรวมได้ ปิดใช้งานสิ่งนี้ด้วย:
