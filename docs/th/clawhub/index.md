...
เผยแพร่ ซิงก์ หรือลบ/กู้คืนการลบ:
...
| Plugin แบบบันเดิล | บันเดิล Plugin แบบแพ็กเกจสำหรับการแจกจ่าย OpenClaw            | `clawhub package publish <source>`           |
...
ที่ประกาศไว้ก่อนการติดตั้งจากอาร์ไคฟ์จะทำงาน เมื่อเวอร์ชันของแพ็กเกจเผยแพร่อาร์ติแฟกต์
ClawPack, OpenClaw จะเลือก `.tgz` แบบ npm-pack ที่อัปโหลดไว้ตรงเวอร์ชัน ตรวจสอบ
ส่วนหัวไดเจสต์ของ ClawHub และไบต์ที่ดาวน์โหลด และบันทึกเมทาดาทาอาร์ติแฟกต์ไว้สำหรับ
การอัปเดตภายหลัง
...
CLI ยังมีคำสั่งติดตั้ง/อัปเดต Skill สำหรับเวิร์กโฟลว์กับรีจิสทรีโดยตรง:
...
ที่มีอายุมากพอจะผ่านด่านอัปโหลด หน้ารายละเอียดสาธารณะสรุปสถานะการสแกนล่าสุด
ก่อนติดตั้งหรือดาวน์โหลด

ClawHub รันการตรวจสอบอัตโนมัติกับ Skills และรุ่น Plugin ที่เผยแพร่แล้ว รุ่นที่ถูกระงับ
จากการสแกนหรือถูกบล็อกอาจหายไปจากแคตตาล็อกสาธารณะและพื้นผิวการติดตั้ง
...
เมื่อคุณรัน `clawhub sync` ขณะลงชื่อเข้าใช้อยู่ CLI จะส่งสแนปช็อตขั้นต่ำเพื่อให้
...
| `CLAWHUB_CONFIG_PATH`         | Override ตำแหน่งที่ CLI จัดเก็บสถานะโทเคน/การกำหนดค่า |
