...
title: ClawHub
x-i18n:
    generated_at: "2026-07-01T20:39:11Z"
    model: gpt-5.5
...
| Plugin แบบบันเดิล | บันเดิล Plugin ที่จัดแพ็กเกจแล้วสำหรับการกระจาย OpenClaw            | `clawhub package publish <source>`           |
...
เมตาดาต้าแหล่งที่มาไว้ เพื่อให้คำสั่งอัปเดตในภายหลังยังคงอยู่บน ClawHub ได้

ใช้ `clawhub:<package>` เมื่อการติดตั้ง Plugin ควร resolve ผ่าน ClawHub
สเปก Plugin แบบ bare ที่ปลอดภัยกับ npm อาจ resolve ผ่าน npm ระหว่างช่วงเปลี่ยนผ่านการเปิดตัว และ
...
ที่ประกาศไว้ก่อนเริ่มติดตั้ง archive เมื่อเวอร์ชันแพ็กเกจเผยแพร่ artifact
ClawPack แล้ว OpenClaw จะเลือก `.tgz` จาก npm-pack ที่อัปโหลดไว้ตรงรุ่น ตรวจสอบ
ส่วนหัว digest ของ ClawHub และไบต์ที่ดาวน์โหลด แล้วบันทึกเมตาดาต้า artifact สำหรับ
การอัปเดตในภายหลัง
...
เมื่อคุณรัน `clawhub install` ขณะเข้าสู่ระบบอยู่ CLI อาจส่งอีเวนต์การติดตั้งแบบ best-effort
