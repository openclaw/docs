...
แก้ไขแหล่งอ้างอิงผ่าน ClawHub ได้ต่อไป
...
สำหรับรีโพสิทอรีที่มีหลาย Skills เวิร์กโฟลว์ GitHub ที่ใช้ซ้ำได้จะเรียก
`skill publish` สำหรับโฟลเดอร์ Skill ระดับถัดลงมาแต่ละโฟลเดอร์ใต้ `skills/`:
...
Plugin ประเภทโค้ดต้องมีเมทาดาทาความเข้ากันได้กับ OpenClaw ใน `package.json`
