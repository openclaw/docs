...
x-i18n:
    generated_at: "2026-07-19T07:05:19Z"
    model: gpt-5.6
...
ใช้ OpenClaw เมื่อติดตั้งสิ่งต่างๆ ลงใน OpenClaw ใช้ CLI `clawhub`
...
OpenClaw บันทึกว่า Skills มาจากที่ใด เพื่อให้การอัปเดตในภายหลังยังคง
ค้นหาและดึงผ่าน ClawHub ได้
...
Skills คือโฟลเดอร์ที่ต้องมีไฟล์ `SKILL.md` และอาจมีไฟล์สนับสนุน
เพิ่มเติม
...
คำสั่งจะข้ามเนื้อหาที่ไม่มีการเปลี่ยนแปลง Skills ใหม่จะเริ่มต้นที่ `1.0.0`; การเปลี่ยนแปลงในภายหลัง
...
Skills ต้องใช้อะไรก่อนติดตั้ง ดู[รูปแบบ Skills](/clawhub/skill-format)
...
เผยแพร่ Plugin จากโฟลเดอร์ภายในเครื่อง รีโพซิทอรี GitHub การอ้างอิง GitHub หรือ
...
ใช้ `--dry-run` ก่อนเพื่อดูตัวอย่างข้อมูลเมตาของแพ็กเกจที่ค้นหาได้ ฟิลด์
ความเข้ากันได้ การระบุแหล่งที่มา และแผนการอัปโหลดโดยไม่เผยแพร่

Plugin โค้ดต้องมีข้อมูลเมตาความเข้ากันได้กับ OpenClaw ใน `package.json`
