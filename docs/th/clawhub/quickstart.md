...
เมื่อคุณกำลังลงชื่อเข้าใช้ เผยแพร่ จัดการรายการของคุณเอง หรือใช้เวิร์กโฟลว์เฉพาะของ
registry
...
ClawHub แทนที่จะเป็น npm หรือแหล่งอื่น
...
ก่อนเผยแพร่ ให้ตรวจสอบ metadata ใน `SKILL.md` ประกาศตัวแปรสภาพแวดล้อม
...
สำหรับ repositories ที่มี skills หลายรายการ เวิร์กโฟลว์ GitHub ที่ใช้ซ้ำได้จะเรียก
`skill publish` สำหรับแต่ละโฟลเดอร์ skill ชั้นแรกใต้ `skills/`:
...
code plugins ต้องมี metadata ความเข้ากันได้ของ OpenClaw ใน `package.json`
