...
skill คือโฟลเดอร์ที่มีไฟล์ `SKILL.md` ที่จำเป็น และมีไฟล์สนับสนุนเพิ่มเติม
ได้
...
ก่อนเผยแพร่ ให้ตรวจสอบ metadata ใน `SKILL.md` ระบุตัวแปรสภาพแวดล้อม เครื่องมือ
และสิทธิ์ที่จำเป็น เพื่อให้ผู้ใช้เข้าใจว่า skill ต้องใช้อะไรก่อนติดตั้ง ดู
[รูปแบบ Skill](/th/clawhub/skill-format)

สำหรับ repository ที่มีหลาย Skills เวิร์กโฟลว์ GitHub ที่นำกลับมาใช้ได้จะเรียก
...
เผยแพร่ Plugin จากโฟลเดอร์ local, repo GitHub, ref ของ GitHub หรือ archive
ที่มีอยู่:
...
ใช้ `--dry-run` ก่อนเพื่อดูตัวอย่าง metadata ของ package ที่ resolve แล้ว ฟิลด์
compatibility การระบุแหล่งที่มา และแผนการอัปโหลดโดยไม่เผยแพร่
...
รายการสาธารณะจะแสดงสถานะการสแกนล่าสุด Releases ที่ถูกพักหรือถูกบล็อกโดย
