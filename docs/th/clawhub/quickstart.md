...
x-i18n:
    generated_at: "2026-07-04T18:24:50Z"
    model: gpt-5.5
...
แก้ไขที่มาผ่าน ClawHub ต่อไปได้
...
คำสั่งนี้จะข้ามเนื้อหาที่ไม่เปลี่ยนแปลง Skills ใหม่จะเริ่มที่ `1.0.0`; การเปลี่ยนแปลงภายหลัง
