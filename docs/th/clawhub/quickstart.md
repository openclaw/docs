...
x-i18n:
    generated_at: "2026-07-12T15:51:21Z"
    model: gpt-5.6
...
เมื่อลงชื่อเข้าใช้ เผยแพร่ จัดการรายการของคุณเอง หรือใช้
...
สภาพแวดล้อมที่ไม่มีส่วนติดต่อผู้ใช้สามารถใช้โทเค็น API จากเว็บ UI ของ ClawHub:
...
คำสั่งจะข้ามเนื้อหาที่ไม่มีการเปลี่ยนแปลง Skills ใหม่จะเริ่มต้นที่ `1.0.0` ส่วนการเปลี่ยนแปลง
ครั้งถัดไปจะเผยแพร่เป็นเวอร์ชันแพตช์ลำดับถัดไปโดยอัตโนมัติ ใช้ `--dry-run` เพื่อดูตัวอย่าง หรือ
...
Skill ต้องใช้อะไรบ้างก่อนติดตั้ง ดู [รูปแบบ Skill](/th/clawhub/skill-format)

สำหรับรีโพซิทอรีที่มีหลาย Skills เวิร์กโฟลว์ GitHub ที่นำกลับมาใช้ซ้ำได้จะเรียก
`skill publish` สำหรับแต่ละโฟลเดอร์ Skill ที่อยู่ภายใต้ `skills/` โดยตรง:
...
ใช้ `--dry-run` ก่อนเพื่อดูตัวอย่างเมทาดาทาของแพ็กเกจที่ได้จากการค้นหาและดึงข้อมูล ฟิลด์
ความเข้ากันได้ การระบุแหล่งที่มา และแผนการอัปโหลดโดยไม่เผยแพร่จริง

Plugin แบบโค้ดต้องมีเมทาดาทาความเข้ากันได้กับ OpenClaw ใน `package.json`
...
การกลั่นกรองอาจถูกซ่อนจากส่วนค้นหาและติดตั้งจนกว่าจะได้รับการแก้ไข
