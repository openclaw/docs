...
as `other`, the same as [`clawhub sync`](/clawhub/cli#sync); you can also set catalog
...
[workflow notes](/clawhub/cli#github-actions-1) for the full behavior.
...
`clear_topics: true` to clear them. See the [package CLI reference](/clawhub/cli#package-publish-%3Csource%3E)
...
[`POST /api/v1/publish/attempts/{id}/recover`](/clawhub/http-api#post-%2Fapi%2Fv1%2Fpublish%2Fattempts%2F%7Bid%7D%2Frecover).
...
[`package transfer`](/clawhub/cli#package-transfer-%3Cname%3E) for details.
