---
read_when:
    - أنت تثبّت Plugin الخاص بـ Matrix أو تهيئه أو تدقّق فيه
summary: Plugin قناة Matrix لـ OpenClaw للغرف والرسائل المباشرة.
title: Plugin ‏Matrix
x-i18n:
    generated_at: "2026-07-12T06:21:11Z"
    model: gpt-5.6
...
Plugin قناة Matrix في OpenClaw للغرف والرسائل المباشرة.
