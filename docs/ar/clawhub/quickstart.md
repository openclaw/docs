...
يتخطى الأمر المحتوى غير المتغير. تبدأ المهارات الجديدة عند `1.0.0`؛ وتنشر التغييرات اللاحقة
...
يجب أن تتضمن Plugins البرمجية بيانات تعريف توافق OpenClaw في `package.json`،
...
الإشراف من أسطح البحث والتثبيت إلى أن تُحل.
