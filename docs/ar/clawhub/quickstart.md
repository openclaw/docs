...
read_when:
    ...
    - النشر إلى ClawHub
summary: 'ابدأ باستخدام ClawHub: ابحث عن Skills أو الإضافات، وثبّتها وحدّثها وانشرها.'
x-i18n:
    generated_at: "2026-06-30T14:03:11Z"
    model: gpt-5.5
...
ClawHub هو سجل لمهارات OpenClaw وPluginsه.
...
استخدم السابقة `clawhub:` عندما تريد من OpenClaw حل الحزمة عبر
...
يتجاوز الأمر المحتوى غير المتغير. تبدأ المهارات الجديدة عند `1.0.0`؛ وتنشر التغييرات اللاحقة
...
وإسناد المصدر، وخطة الرفع دون النشر.
