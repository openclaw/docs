...
read_when:
    ...
    - النشر إلى ClawHub
summary: 'ابدأ باستخدام ClawHub: ابحث عن Skills أو المكوّنات الإضافية وثبّتها وحدّثها وانشرها.'
x-i18n:
    generated_at: "2026-06-28T06:03:10Z"
    model: gpt-5.5
...
ClawHub هو سجل لمهارات OpenClaw والـ plugins.
...
يتخطى الأمر المحتوى غير المتغير. تبدأ المهارات الجديدة عند `1.0.0`؛ وتنشر
...
بالنسبة إلى المستودعات التي تحتوي على مهارات متعددة، يستدعي تدفق عمل GitHub القابل لإعادة الاستخدام
...
استخدم `--dry-run` أولًا لمعاينة البيانات الوصفية للحزمة التي تم حلّها وحقول
...
خلال الإشراف عن أسطح البحث والتثبيت إلى أن تُحل.
