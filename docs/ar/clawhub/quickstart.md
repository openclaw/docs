...
x-i18n:
    generated_at: "2026-07-03T09:36:35Z"
    model: gpt-5.5
...
عندما تسجل الدخول، أو تنشر، أو تدير قوائمك الخاصة، أو تستخدم
سير عمل خاصة بالسجل.

## البحث عن Skills وتثبيتها
...
يسجل OpenClaw مصدر Skills بحيث يمكن للتحديثات اللاحقة أن تواصل
الحل عبر ClawHub.
...
Skills هي مجلد يحتوي على ملف `SKILL.md` مطلوب وملفات داعمة
اختيارية.
...
متغيرات البيئة والأدوات والأذونات المطلوبة لكي يتمكن المستخدمون من فهم ما
تحتاجه Skills قبل تثبيتها. راجع [تنسيق Skills](/ar/clawhub/skill-format).

بالنسبة للمستودعات التي تحتوي على Skills متعددة، يستدعي سير عمل GitHub القابل لإعادة الاستخدام
`skill publish` لكل مجلد Skills مباشر ضمن `skills/`:
