...
read_when:
    ...
    - النشر إلى ClawHub
summary: 'ابدأ باستخدام ClawHub: اعثر على Skills أو الإضافات وثبّتها وحدّثها وانشرها.'
x-i18n:
    generated_at: "2026-07-02T14:03:27Z"
    model: gpt-5.5
...
يسجّل OpenClaw مصدر المهارة حتى تتمكّن التحديثات اللاحقة من متابعة
الحل عبر ClawHub.
...
يتخطى الأمر المحتوى غير المتغيّر. تبدأ المهارات الجديدة عند `1.0.0`؛ وتنشر
...
يجب أن تتضمن مكونات الكود الإضافية بيانات وصفية لتوافق OpenClaw في `package.json`،
