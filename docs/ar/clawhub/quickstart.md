...
x-i18n:
    generated_at: "2026-07-04T15:20:14Z"
    model: gpt-5.5
...
ClawHub هو سجل لمهارات وPluginات OpenClaw.

استخدم OpenClaw عندما تثبّت أشياء داخل OpenClaw. واستخدم CLI `clawhub`
...
يسجّل OpenClaw المصدر الذي جاءت منه المهارة بحيث يمكن للتحديثات اللاحقة
متابعة الحل عبر ClawHub.
...
يتجاوز الأمر المحتوى غير المتغير. تبدأ المهارات الجديدة من `1.0.0`؛ وتنشر التغييرات اللاحقة
...
استخدم `--dry-run` أولًا لمعاينة بيانات الحزمة الوصفية التي تم حلها، وحقول التوافق،
وإسناد المصدر، وخطة الرفع دون نشر.

يجب أن تتضمن Pluginات الكود بيانات وصفية للتوافق مع OpenClaw في `package.json`،
...
الإشراف من أسطح البحث والتثبيت إلى أن تُحل المشكلة.
