...
x-i18n:
    generated_at: "2026-07-05T05:09:08Z"
    model: gpt-5.5
...
يسجّل OpenClaw المصدر الذي جاءت منه المهارة كي تتمكّن التحديثات اللاحقة من
...
يتجاوز الأمر المحتوى غير المتغيّر. تبدأ المهارات الجديدة عند `1.0.0`؛ وتنشر التغييرات
اللاحقة تلقائيًا إصدار التصحيح التالي. استخدم `--dry-run` للمعاينة أو
`--version` لاختيار إصدار صريح.

قبل النشر، تحقّق من البيانات الوصفية في `SKILL.md`. صرّح بمتغيرات
البيئة والأدوات والأذونات المطلوبة كي يتمكن المستخدمون من فهم ما
تحتاج إليه المهارة قبل تثبيتها. راجع [تنسيق المهارة](/ar/clawhub/skill-format).
...
استخدم `--dry-run` أولًا لمعاينة البيانات الوصفية للحزمة التي تم حلّها، وحقول التوافق،
