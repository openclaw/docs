...
x-i18n:
    generated_at: "2026-07-02T08:18:57Z"
    model: gpt-5.5
...
استخدم البادئة `clawhub:` عندما تريد أن يحلّل OpenClaw الحزمة عبر
...
يتجاوز الأمر المحتوى غير المتغيّر. تبدأ Skills الجديدة عند `1.0.0`؛ وتنشر التغييرات اللاحقة
...
متغيرات البيئة والأدوات والأذونات المطلوبة حتى يفهم المستخدمون ما
تحتاجه Skill قبل تثبيتها. راجع [تنسيق Skill](/ar/clawhub/skill-format).

للمستودعات التي تحتوي على عدة Skills، يستدعي سير عمل GitHub القابل لإعادة الاستخدام
...
استخدم `--dry-run` أولًا لمعاينة البيانات الوصفية للحزمة المحلّلة وحقول التوافق
وإسناد المصدر وخطة الرفع دون نشر.

يجب أن تتضمن إضافات الشيفرة بيانات وصفية للتوافق مع OpenClaw في `package.json`،
