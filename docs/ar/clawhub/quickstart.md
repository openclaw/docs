...
read_when:
    ...
    - النشر إلى ClawHub
summary: 'ابدأ استخدام ClawHub: اعثر على Skills أو المكونات الإضافية وثبّتها وحدّثها وانشرها.'
x-i18n:
...
ClawHub هو سجل لـ Skills وPlugins في OpenClaw.
...
ثبّت Plugin مستضافا على ClawHub مع مصدر ClawHub صريح:
...
إصدار التصحيح التالي تلقائيا. استخدم `--dry-run` للمعاينة أو
`--version` لاختيار إصدار صريح.

قبل النشر، تحقق من البيانات الوصفية في `SKILL.md`. صرّح عن
متغيرات البيئة والأدوات والأذونات المطلوبة كي يتمكن المستخدمون من فهم ما
...
استخدم `--dry-run` أولا لمعاينة البيانات الوصفية للحزمة المحلولة، وحقول التوافق،
...
المراجعة من واجهات البحث والتثبيت حتى يتم حلها.
