...
يسجل OpenClaw مصدر المهارة بحيث يمكن للتحديثات اللاحقة أن تواصل
الحل عبر ClawHub.
...
يمكن للبيئات غير التفاعلية استخدام رمز API من واجهة ClawHub على الويب:
...
التوافق، ونسبة المصدر، وخطة الرفع من دون نشر.
...
عندما تكون مسجل الدخول، قد يرسل `sync` أيضًا لقطة تثبيت مصغرة
لأعداد التثبيت الإجمالية. راجع [القياسات عن بُعد](/ar/clawhub/telemetry) لمعرفة ما يتم الإبلاغ عنه
وكيفية إلغاء الاشتراك.

## الفحص قبل التثبيت

قبل التثبيت، استخدم صفحة ClawHub على الويب أو أوامر التفاصيل في CLI لفحص
...
تعرض القوائم العامة أحدث حالة فحص. قد تُخفى الإصدارات المعلّقة أو المحظورة من
قبل الإشراف عن واجهات البحث والتثبيت إلى أن يتم حلها.
