...
x-i18n:
    generated_at: "2026-07-03T00:58:03Z"
    model: gpt-5.5
...
يسجل OpenClaw المصدر الذي جاءت منه المهارة حتى تتمكن التحديثات اللاحقة من
مواصلة الحل عبر ClawHub.
...
استخدم السابقة `clawhub:` عندما تريد أن يحل OpenClaw الحزمة عبر
...
يتخطى الأمر المحتوى غير المتغير. تبدأ المهارات الجديدة بالإصدار `1.0.0`؛ وتنشر
...
ونسبة المصدر وخطة الرفع من دون النشر.
