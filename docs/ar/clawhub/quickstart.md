...
يمكن للبيئات دون واجهة رسومية استخدام رمز API من واجهة ويب ClawHub:
...
تعرض القوائم العامة أحدث حالة فحص. قد تُخفى الإصدارات المعلقة أو المحظورة بواسطة
