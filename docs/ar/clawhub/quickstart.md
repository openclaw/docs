...
x-i18n:
    generated_at: "2026-07-01T13:00:36Z"
    model: gpt-5.5
...
ثبّت إضافة مستضافة على ClawHub باستخدام مصدر ClawHub صريح:
...
التغييرات اللاحقة تلقائياً إصدار التصحيح التالي. استخدم `--dry-run` للمعاينة أو
...
استخدم `--dry-run` أولاً لمعاينة البيانات الوصفية للحزمة التي تم حلها وحقول
التوافق ونسبة المصدر وخطة الرفع دون النشر.

يجب أن تتضمن إضافات الكود بيانات توافق OpenClaw الوصفية في `package.json`،
