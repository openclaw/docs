...
x-i18n:
    generated_at: "2026-07-02T00:57:06Z"
    model: gpt-5.5
...
إصدار التصحيح التالي تلقائياً. استخدم `--dry-run` للمعاينة أو
...
يجب أن تتضمن إضافات الشيفرة بيانات وصفية لتوافق OpenClaw في `package.json`،
