...
x-i18n:
    generated_at: "2026-05-12T00:57:32Z"
    model: gpt-5.5
    provider: openai
...
يسجّل OpenClaw مصدر Skill لكي تتمكّن التحديثات اللاحقة من الاستمرار في
الحل عبر ClawHub.
...
استخدم بادئة `clawhub:` عندما تريد من OpenClaw حلّ الحزمة عبر
...
البيئة والأدوات والأذونات المطلوبة لكي يتمكّن المستخدمون من فهم ما تحتاجه
...
يجب أن تتضمّن Plugin البرمجية بيانات توافق OpenClaw الوصفية في `package.json`،
بما في ذلك `openclaw.compat.pluginApi` و`openclaw.build.openclawVersion`.

## مزامنة Skills التي تصونها

يفحص `sync` مجلدات Skills وينشر Skills الجديدة أو التي تغيّرت وغير
المتزامنة مسبقًا.
...
بسبب الإشراف من واجهات البحث والتثبيت إلى أن يتم حلّها.
