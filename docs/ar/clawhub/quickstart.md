...
read_when:
    ...
    - النشر إلى ClawHub
summary: 'ابدأ باستخدام ClawHub: ابحث عن Skills أو المكونات الإضافية وثبّتها وحدّثها وانشرها.'
x-i18n:
    generated_at: "2026-06-28T20:42:25Z"
    model: gpt-5.5
...
ClawHub هو سجل لمهارات OpenClaw وPluginاته.

استخدم OpenClaw عندما تثبّت أشياء داخل OpenClaw. استخدم واجهة CLI الخاصة بـ `clawhub`
...
يمكن للبيئات دون واجهة استخدام رمز API من واجهة ويب ClawHub:
...
المهارة هي مجلد يحتوي على ملف `SKILL.md` مطلوب وملفات دعم
اختيارية.
...
يتخطى الأمر المحتوى غير المتغيّر. تبدأ المهارات الجديدة عند `1.0.0`؛ وتنشر التغييرات اللاحقة
...
بالنسبة إلى المستودعات التي تحتوي على عدة مهارات، يستدعي سير عمل GitHub القابل لإعادة الاستخدام
...
استخدم `--dry-run` أولًا لمعاينة بيانات وصف الحزمة المحلولة، وحقول التوافق،
ونسبة المصدر، وخطة الرفع دون نشر.

يجب أن تتضمن Plugins البرمجية بيانات وصف توافق OpenClaw في `package.json`،
