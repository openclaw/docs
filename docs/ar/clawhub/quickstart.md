...
read_when:
    ...
    - النشر إلى ClawHub
summary: 'ابدأ استخدام ClawHub: اعثر على Skills أو Plugin وثبّتها وحدّثها وانشرها.'
x-i18n:
    generated_at: "2026-07-02T17:38:40Z"
    model: gpt-5.5
...
يسجّل OpenClaw مصدر المهارة حتى تتمكن التحديثات اللاحقة من الاستمرار في
الحل عبر ClawHub.
...
يتخطى الأمر المحتوى غير المتغير. تبدأ المهارات الجديدة من `1.0.0`؛ وتنشر
...
والأدوات والأذونات المطلوبة حتى يتمكن المستخدمون من فهم ما تحتاجه المهارة قبل
تثبيتها. راجع [تنسيق المهارة](/ar/clawhub/skill-format).
...
يجب أن تتضمن Pluginات الكود بيانات وصفية لتوافق OpenClaw في `package.json`،
...
بسبب الإشراف من واجهات البحث والتثبيت حتى تُحل.
