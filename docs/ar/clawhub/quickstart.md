...
x-i18n:
    generated_at: "2026-07-03T17:25:51Z"
    model: gpt-5.5
...
يسجّل OpenClaw مصدر Skills حتى تتمكّن التحديثات اللاحقة من متابعة
الحل عبر ClawHub.
...
Skills هي مجلد يحتوي على ملف `SKILL.md` مطلوب وملفات داعمة اختيارية.
...
يتخطّى الأمر المحتوى غير المتغيّر. تبدأ Skills الجديدة عند `1.0.0`؛ وتنشر
