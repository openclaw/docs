...
title: ClawHub
x-i18n:
    generated_at: "2026-07-01T20:20:41Z"
    model: gpt-5.5
...
| ------------- | ------------------------------------------------------------ | -------------------------------------------- |
| Skills        | حِزم نصية ذات إصدارات تتضمن `SKILL.md` مع ملفات داعمة       | `openclaw skills install @openclaw/demo`     |
...
استخدم `clawhub:<package>` عندما يجب أن يمر تثبيت Plugin عبر ClawHub.
قد تُحل مواصفات Plugin الخالية من مشكلات npm عبر npm أثناء مراحل الانتقال عند الإطلاق، ويبقى
...
المعلن عنهما قبل تشغيل تثبيت الأرشيف. عندما تنشر نسخة حزمة قطعة ClawPack،
يفضّل OpenClaw ملف `.tgz` المطابق المرفوع بصيغة npm-pack، ويتحقق من
ترويسة الملخص في ClawHub والبايتات المنزّلة، ويسجل بيانات تعريف القطعة من أجل
التحديثات اللاحقة.
...
- `--slug <slug>`: اسم عنوان URL المنشور لـ Skill.
- `--name <name>`: اسم العرض.
...
يجب أن تتضمن Code plugins بيانات تعريف التوافق المطلوبة مع OpenClaw في
...
الإصدارات المحجوزة للفحص أو المحظورة من الكتالوج العام وأسطح التثبيت مع
