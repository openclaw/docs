...
read_when:
    ...
    - تصحيح أخطاء 401
summary: تسجيل الدخول إلى ClawHub، ورموز API، وتسجيل الدخول عبر CLI، وتخزين الرموز، وإلغاؤها.
x-i18n:
    generated_at: "2026-06-30T14:01:23Z"
    model: gpt-5.5
...
تطبع CLI رمزًا لمرة واحدة وتنتظر بينما تفوّضه في
...
لا يمكن للحسابات المحذوفة أو المحظورة أو المعطّلة مواصلة استخدام رموز API الموجودة.
