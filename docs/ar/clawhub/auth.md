...
x-i18n:
    generated_at: "2026-06-30T22:16:24Z"
    model: gpt-5.5
...
من خلال ذلك الحساب الذي سُجِّل الدخول إليه.
...
[نموذج الاستئناف لدى ClawHub](https://appeals.openclaw.ai/) إذا كنت تعتقد أن هذا
خطأ.
...
بالنسبة إلى الأصداف البعيدة التي يمكنك فيها فتح متصفح في مكان آخر، شغّل:

```bash
clawhub login --device
```

يطبع CLI رمزًا لمرة واحدة وينتظر بينما تفوضه في
