...
يستخدم ClawHub GitHub لتسجيل الدخول عبر الويب. وتستخدم CLI رموز API الخاصة بـ ClawHub التي تُنشأ
...
5. تخزن CLI الرمز في ملف إعدادات ClawHub لديك.
...
تطبع CLI رمزًا لمرة واحدة وتنتظر أثناء تفويضه في
