...
x-i18n:
    generated_at: "2026-07-04T03:47:50Z"
    model: gpt-5.5
...
[نموذج استئناف ClawHub](https://appeals.openclaw.ai/) إذا كنت تعتقد أن ذلك
خطأ.
...
الوكيل، فاستخدم مسار الرمز دون واجهة.
...
يطبع CLI رمزًا لمرة واحدة وينتظر بينما تفوّضه على
