...
الوكيل، فاستخدم تدفق الرمز بلا واجهة.
...
يطبع CLI رمزًا لمرة واحدة وينتظر بينما تمنحه التفويض على
...
لا يمكن للحسابات المحذوفة أو المحظورة أو المعطّلة مواصلة استخدام رموز API الحالية.
