...
x-i18n:
    generated_at: "2026-07-03T23:32:11Z"
    model: gpt-5.5
...
5. يخزّن CLI الرمز في ملف تهيئة ClawHub لديك.
...
لا يمكن للحسابات المحذوفة أو المحظورة أو المعطّلة الاستمرار في استخدام رموز API الموجودة.
