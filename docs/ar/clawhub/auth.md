...
x-i18n:
    generated_at: "2026-07-03T13:29:44Z"
    model: gpt-5.5
...
يمكنك إبطال رموز API في واجهة الويب الخاصة بـ ClawHub.

تُرجع الرموز المُبطلة أو غير الصالحة أو المفقودة `401 Unauthorized`. سجّل الدخول مرة أخرى
