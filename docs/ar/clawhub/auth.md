...
x-i18n:
    generated_at: "2026-06-27T17:17:11Z"
    model: gpt-5.5
...
يفتح مسار تسجيل الدخول الافتراضي عبر CLI متصفحك:
...
استخدم هذا المسار للخوادم أو مهام CI أو البيئات التي تعتمد على الطرفية فقط.
