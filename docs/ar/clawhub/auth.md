...
x-i18n:
    generated_at: "2026-07-04T10:40:15Z"
    model: gpt-5.5
...
إذا لم يتمكن متصفحك من الوصول إلى الاستدعاء المحلي بسبب قواعد جدار حماية أو VPN أو
وكيل، فاستخدم مسار الرمز بلا واجهة.
...
يطبع CLI رمزًا لمرة واحدة وينتظر بينما تفوّضه في
