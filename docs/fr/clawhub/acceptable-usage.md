...
x-i18n:
    generated_at: "2026-07-01T08:00:58Z"
    model: gpt-5.5
...
se présente et à la façon dont les éditeurs utilisent les surfaces de découverte, d’installation et de confiance de ClawHub. Pour les états de modération et la situation des comptes, consultez
...
| ----------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Accès non autorisé ou contournement de sécurité             | Contournement d’authentification, prise de contrôle de compte, abus de limites de débit, prise de contrôle d’un appel en direct ou d’un agent, vol de session réutilisable, ou approbation automatique de flux d’appairage pour des utilisateurs non approuvés.                                             |
| Abus de plateforme et contournement de bannissement         | Comptes furtifs après bannissement, préchauffage ou élevage de comptes, faux engagement, automatisation multicomptes, publication massive, bots de spam, ou automatisation conçue pour éviter la détection.                                                                                                  |
| Fraude, escroqueries et workflows financiers trompeurs      | Faux certificats ou factures, flux de paiement trompeurs, démarchage frauduleux, fausse preuve sociale, workflows d’identité synthétique pour la fraude, ou outils de dépense/facturation sans approbation humaine claire.                                                                                    |
| Enrichissement intrusif pour la vie privée ou surveillance  | Aspiration de contacts pour le spam, doxxing, harcèlement, extraction de prospects associée à un démarchage non sollicité, surveillance dissimulée, correspondance biométrique non consensuelle, ou utilisation de données divulguées ou de fuites issues de violations de données.                           |
...
| Contenu sexuel explicite ou génération pour adultes sans garde-fous | Génération d’images, de vidéos ou de contenu NSFW ; wrappers de contenu pour adultes autour d’API tierces ; ou fiches dont l’objectif principal est le contenu sexuel explicite.                                                                                                                              |
...
| Matériel portant atteinte au droit d’auteur ou violant des droits | Republier la skill, le plugin, les docs, les ressources de marque ou le code propriétaire d’une autre personne sans autorisation ; violer les conditions de licence ; ou usurper l’identité de l’auteur ou de l’éditeur d’origine.                                                                            |
...
- publier en masse un grand nombre de fiches peu travaillées, duplicatives, factices ou
  générées par machine qui ne semblent pas avoir de valeur réelle pour les utilisateurs
- saturer les surfaces de recherche ou de catégories avec des Skills ou des plugins presque identiques
...
- téléverser à plusieurs reprises du contenu qui a déjà été masqué, retiré ou bloqué
