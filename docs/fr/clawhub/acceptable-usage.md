...
x-i18n:
    generated_at: "2026-07-02T00:50:18Z"
    model: gpt-5.5
...
de confiance de ClawHub. Pour les états de modération et le statut de compte, consultez
...
consultez [Demandes relatives aux droits du contenu](/clawhub/content-rights).
...
| Sécurité défensive, modération et revue des abus | L’outil est présenté pour une revue autorisée, préserve les preuves et garde les limites d’approbation humaine claires.             |
...
| ----------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Accès non autorisé ou contournement de sécurité             | Contournement d’authentification, prise de contrôle de compte, abus de limites de débit, prise de contrôle d’appel en direct ou d’agent, vol réutilisable de session, ou approbation automatique de flux d’association pour des utilisateurs non approuvés.                                                   |
| Abus de plateforme et contournement d’interdiction          | Comptes furtifs après interdiction, préparation ou élevage de comptes, faux engagement, automatisation multi-comptes, publication massive, bots de spam, ou automatisation conçue pour éviter la détection.                                                                                                    |
...
| Enrichissement intrusif pour la vie privée ou surveillance  | Extraction de contacts pour le spam, doxxing, harcèlement, extraction de prospects associée à une prospection non sollicitée, surveillance clandestine, mise en correspondance biométrique non consentie, ou utilisation de données divulguées ou de dumps de violation.                                      |
...
| Exigences d’exécution cachées, dangereuses ou trompeuses    | Commandes d’installation obfusquées, installateurs pipe-to-shell tels que du contenu téléchargé exécuté avec `sh` ou `bash` sans possibilité claire de revue, exigences de secrets ou de clés privées non déclarées, exécution distante de `npx @latest` sans possibilité claire de revue, ou métadonnées qui cachent ce dont la fiche a réellement besoin pour s’exécuter. |
| Matériel enfreignant le droit d’auteur ou violant des droits | Republier la skill, le plugin, la documentation, les actifs de marque ou le code propriétaire de quelqu’un d’autre sans autorisation ; violer des conditions de licence ; ou usurper l’identité de l’auteur ou de l’éditeur d’origine.                                                                          |
...
- publier en masse de grands nombres de fiches à faible effort, duplicatives, provisoires ou
...
- gonfler artificiellement les installations, téléchargements, étoiles ou autres métriques
  d’engagement par automatisation, boucles d’auto-installation, faux comptes, activité coordonnée,
  engagement payé ou autre comportement non organique
- créer ou faire tourner des comptes pour échapper à la modération, aux interdictions, aux limites d’éditeur ou à
...
[Demandes relatives aux droits du contenu](/clawhub/content-rights). N’utilisez pas les rapports normaux de la place de marché
...
- masquer, mettre en attente, supprimer, supprimer de manière logique ou, lorsque le type de ressource le permet,
  supprimer définitivement les fiches en infraction
- bloquer les téléchargements ou installations de versions dangereuses
- révoquer des jetons d’API
- supprimer de manière logique le contenu associé
...
les fiches masquées, les bannissements et le statut de compte.
