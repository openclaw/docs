...
de confiance de ClawHub. Pour les états de modération et la situation du compte, consultez
...
| Workflows d’interface utilisateur, de données et d’automatisation | La portée est claire, les identifiants requis sont explicites, et les actions risquées incluent des parcours de revue, d’exécution à blanc, d’aperçu ou de confirmation. |
| Sécurité défensive, modération et revue des abus | L’outil est présenté pour une revue autorisée, préserve les preuves et maintient claires les limites d’approbation humaine.             |
...
| ------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Accès non autorisé ou contournement de sécurité              | Contournement d’authentification, prise de contrôle de compte, abus de limite de débit, prise de contrôle d’appel en direct ou d’agent, vol de session réutilisable, ou approbation automatique de flux d’association pour des utilisateurs non approuvés.                                                                                 |
| Abus de plateforme et contournement de bannissement          | Comptes furtifs après bannissement, préparation ou élevage de comptes, engagement factice, automatisation multi-comptes, publication de masse, bots de spam, ou automatisation conçue pour éviter la détection.                                                                                                                            |
| Fraude, arnaques et workflows financiers trompeurs           | Faux certificats ou factures, flux de paiement trompeurs, prospection liée à des arnaques, fausse preuve sociale, workflows d’identité synthétique à des fins de fraude, ou outils de dépense/facturation sans approbation humaine claire.                                                                                                |
...
| Exigences d’exécution cachées, dangereuses ou trompeuses     | Commandes d’installation obscurcies, installateurs pipe-to-shell tels que du contenu téléchargé exécuté avec `sh` ou `bash` sans possibilité claire de revue, exigences de secret ou de clé privée non déclarées, exécution distante de `npx @latest` sans possibilité claire de revue, ou métadonnées qui cachent ce dont la fiche a réellement besoin pour s’exécuter. |
| Matériel portant atteinte au droit d’auteur ou aux droits    | Republier le Skill, Plugin, la documentation, les ressources de marque ou le code propriétaire de quelqu’un d’autre sans autorisation ; violer les conditions de licence ; ou usurper l’identité de l’auteur ou de l’éditeur d’origine.                                                                                                   |
...
- publier en masse un grand nombre de fiches à faible effort, duplicatives, de remplacement ou
...
- créer ou faire tourner des comptes pour contourner la modération, les bannissements, les limites des éditeurs ou
  la revue de la marketplace
- induire les utilisateurs en erreur au sujet de la propriété, de la source, des capacités, de la posture de sécurité,
...
ne prouve pas à lui seul l’existence d’un abus ; il aide ClawHub à décider ce qui doit être examiné.

Nous pouvons :

- masquer, mettre en attente, supprimer, soft-delete ou, lorsque cela est pris en charge pour le type de ressource,
  hard-delete les fiches en infraction
- bloquer les téléchargements ou les installations pour les versions dangereuses
- révoquer les jetons d’API
- soft-delete le contenu associé
...
[Modération et sécurité du compte](/fr/clawhub/moderation) pour les signalements, les mises en attente de modération,
