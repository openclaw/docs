...
read_when:
    ...
    - Rédaction de documents de modération ou de guides d’exécution pour les relecteurs
    - Décider si une compétence doit être masquée ou un utilisateur banni
sidebarTitle: Acceptable Usage
summary: 'Politique de la marketplace : ce que ClawHub autorise et ce qu’il n’hébergera pas.'
title: Utilisation acceptable
x-i18n:
    generated_at: "2026-07-04T17:56:25Z"
    model: gpt-5.5
...
ClawHub héberge des Skills, Plugins, paquets et métadonnées de marketplace pour OpenClaw.
...
| Sécurité défensive, modération et examen des abus | L'outil est présenté pour une revue autorisée, préserve les preuves et maintient des limites claires pour l'approbation humaine.                          |
...
fondé sur le consentement, et inacceptable lorsqu'il est empaqueté comme un workflow abusif.
...
| ----------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Accès non autorisé ou contournement de sécurité                      | Contournement de l'authentification, prise de contrôle de compte, abus des limites de débit, prise de contrôle d'un appel actif ou d'un agent, vol de session réutilisable, ou approbation automatique de flux d'association pour des utilisateurs non approuvés.                                                                                                                                                   |
| Abus de plateforme et contournement de bannissement                              | Comptes furtifs après bannissement, préchauffage ou élevage de comptes, engagement factice, automatisation multi-comptes, publication massive, robots de spam, ou automatisation conçue pour éviter la détection.                                                                                                                                          |
| Fraude, escroqueries et workflows financiers trompeurs             | Faux certificats ou factures, flux de paiement trompeurs, prospection frauduleuse, preuve sociale factice, workflows d'identité synthétique pour fraude, ou outils de dépense/facturation sans approbation humaine claire.                                                                                                                    |
| Enrichissement ou surveillance portant atteinte à la vie privée                 | Extraction de contacts pour du spam, doxxing, harcèlement, extraction de prospects associée à une prospection non sollicitée, surveillance clandestine, correspondance biométrique sans consentement, ou utilisation de données divulguées ou de dumps issus de violations.                                                                                                                  |
| Usurpation d'identité ou manipulation d'identité sans consentement       | Échange de visage, jumeaux numériques, influenceurs clonés, faux personnages, ou autres outils utilisés pour usurper une identité ou induire en erreur.                                                                                                                                                                                                 |
...
| Exigences d'exécution cachées, dangereuses ou trompeuses        | Commandes d'installation obscurcies, installateurs pipe-to-shell tels que du contenu téléchargé exécuté avec `sh` ou `bash` sans capacité claire de revue, exigences non déclarées de secrets ou de clés privées, exécution distante de `npx @latest` sans capacité claire de revue, ou métadonnées qui dissimulent ce dont la fiche a réellement besoin pour s'exécuter. |
...
- saturer les surfaces de recherche ou de catégories avec des Skills ou Plugins presque identiques
...
La publication à haut volume n'est pas automatiquement un abus. Les grands catalogues sont acceptables
...
- masquer, retenir, retirer, supprimer de façon réversible ou, lorsque le type de ressource le prend en charge,
