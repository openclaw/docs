...
x-i18n:
    generated_at: "2026-07-01T12:56:58Z"
    model: gpt-5.5
...
[Modération et sécurité des comptes](/clawhub/moderation). Pour les réclamations liées aux droits d’auteur ou à d’autres droits,
...
ClawHub n’héberge pas de contenu dont l’objectif principal est l’abus, la tromperie, l’exécution non sûre
ou la violation de droits.

| Catégorie                                                    | Non autorisé                                                                                                                                                                                                                                                                                                   |
| ----------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Accès non autorisé ou contournement de sécurité                      | Contournement de l’authentification, prise de contrôle de compte, abus de limites de débit, prise de contrôle d’appels en direct ou d’agents, vol de session réutilisable, ou approbation automatique de flux d’appairage pour des utilisateurs non approuvés.                                                                                                                                                   |
| Abus de plateforme et contournement d’interdiction                              | Comptes furtifs après interdictions, préchauffage ou élevage de comptes, faux engagement, automatisation multi-comptes, publication massive, bots de spam, ou automatisation conçue pour éviter la détection.                                                                                                                                          |
...
| Enrichissement portant atteinte à la vie privée ou surveillance                 | Scraping de contacts pour du spam, doxxing, harcèlement, extraction de prospects associée à une prospection non sollicitée, surveillance dissimulée, correspondance biométrique non consentie, ou utilisation de données divulguées ou de dumps issus de violations.                                                                                                                  |
| Usurpation d’identité ou manipulation d’identité non consentie       | Échange de visages, jumeaux numériques, influenceurs clonés, faux personnages, ou autres outils utilisés pour usurper une identité ou induire en erreur.                                                                                                                                                                                                 |
...
| Matériel violant le droit d’auteur ou d’autres droits           | Republication du skill, du plugin, de la documentation, des ressources de marque ou du code propriétaire de quelqu’un d’autre sans autorisation ; violation des conditions de licence ; ou usurpation de l’auteur ou de l’éditeur original.                                                                                                                            |
...
- publier en masse de grandes quantités de fiches peu travaillées, dupliquées, provisoires ou
...
- gonfler artificiellement les installations, téléchargements, étoiles ou autres métriques
  ...
  coordonnée, engagement payé ou autre comportement non organique
...
le volume est associé à des fiches légères, dupliquées, trompeuses, non maintenues ou
promues artificiellement.

## Droits de contenu

Si vous pensez qu’un contenu sur ClawHub enfreint vos droits d’auteur ou d’autres droits, utilisez
...
une revue par le personnel pour identifier les contenus non sûrs ou les comportements de publication abusifs. Un signal
