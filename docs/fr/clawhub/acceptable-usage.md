...
read_when:
    ...
    - Rédiger des documents de modération ou des guides opérationnels pour les réviseurs
    - Décider si une skill doit être masquée ou si un utilisateur doit être banni
sidebarTitle: Acceptable Usage
summary: 'Politique de la marketplace : ce que ClawHub autorise et ce qu’elle n’hébergera pas.'
...
confiance de ClawHub. Pour les états de modération et la réputation de compte, consultez
...
non sécurisée ou l’atteinte aux droits.
...
| Fraude, arnaques et workflows financiers trompeurs             | Faux certificats ou factures, flux de paiement trompeurs, démarchage frauduleux, fausse preuve sociale, workflows d’identité synthétique pour fraude, ou outils de dépense/facturation sans approbation humaine claire.                                                                                                                    |
| Enrichissement intrusif pour la vie privée ou surveillance                 | Collecte de contacts pour spam, doxxing, harcèlement, extraction de prospects associée à une prise de contact non sollicitée, surveillance clandestine, rapprochement biométrique non consensuel, ou utilisation de données divulguées ou de dumps de fuite.                                                                                                                  |
...
| Exigences d’exécution cachées, non sécurisées ou trompeuses        | Commandes d’installation obfusquées, installateurs pipe-to-shell tels que du contenu téléchargé exécuté avec `sh` ou `bash` sans possibilité claire de revue, exigences non déclarées de secrets ou de clés privées, exécution distante de `npx @latest` sans possibilité claire de revue, ou métadonnées qui dissimulent ce dont la fiche a réellement besoin pour s’exécuter. |
| Matériel portant atteinte au droit d’auteur ou violant des droits           | Republier le skill, le plugin, les docs, les ressources de marque ou le code propriétaire de quelqu’un d’autre sans autorisation ; violer les conditions de licence ; ou usurper l’identité de l’auteur ou de l’éditeur original.                                                                                                                            |
...
- saturer les surfaces de recherche ou de catégories avec des Skills ou des plugins quasi identiques
...
- téléverser de façon répétée du contenu qui a déjà été masqué, supprimé ou bloqué
...
pour les réclamations de droit d’auteur ou de droits, sauf si la fiche est également non sécurisée,
...
une revue par l’équipe pour identifier les contenus non sécurisés ou les comportements de publication abusifs. Un signal
ne prouve pas un abus à lui seul ; il aide ClawHub à décider ce qui doit être examiné.

Nous pouvons :

- masquer, suspendre, retirer, supprimer de façon réversible ou, lorsque cela est pris en charge pour le type de ressource,
  supprimer définitivement les fiches en infraction
- bloquer les téléchargements ou les installations pour les versions non sécurisées
...
[Modération et sécurité des comptes](/fr/clawhub/moderation) pour les signalements, les suspensions de modération,
les fiches masquées, les bannissements et la réputation de compte.
