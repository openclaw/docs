...
summary: Comment demander un examen ClawHub pour les litiges de propriété concernant une organisation, une marque, un identifiant de propriétaire, une portée de paquet, un slug de Skill ou un espace de noms.
...
revendiqué, réservé, trompeur ou contesté sur ClawHub, demandez au personnel de l’examiner avec le
...
rapports intégrés au produit ni le formulaire de recours de compte pour les revendications d’espaces de noms.
...
ou être modifié autrement en raison d’une propriété réelle.
