...
Pour les packages Plugin, les noms scopés tels que `@example-org/example-plugin` doivent être
...
- l’historique d’une organisation GitHub, d’un dépôt, d’une release ou de mainteneurs
- des docs officielles du projet qui nomment l’espace de noms
- une preuve de domaine ou de domaine d’e-mail officiel
- le contrôle d’un scope de registre de packages npm, PyPI, crates.io ou autre
...
- des fichiers ou contrats juridiques privés
...
Le personnel évalue les preuves publiques, l’usage existant, le risque de sécurité et l’impact sur les utilisateurs.
