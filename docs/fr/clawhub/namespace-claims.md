---
read_when:
    - Revendiquer une organisation, une marque, un périmètre de package, un identifiant de propriétaire, un slug de compétence ou un espace de noms de package
...
summary: Comment demander une révision ClawHub pour des litiges de propriété concernant une organisation, une marque, un identifiant de propriétaire, un périmètre de package, un identifiant de skill ou un espace de noms.
title: Revendications d’organisation et d’espace de noms
x-i18n:
    generated_at: "2026-07-01T15:22:44Z"
    model: gpt-5.5
...
Utilisez cette voie pour les examens publics et non sensibles de propriété. N’utilisez pas les
...
- un scope de package tel que `@example-org/*` qui ne devrait publier que sous le
...
- une contestation concernant une marque, une marque déposée, un renommage de projet ou un historique de package
...
publiés comme le propriétaire `example-org` correspondant.
...
- contrôle de scope de registre de packages npm, PyPI, crates.io ou autre
- preuve de marque déposée, de marque ou de propriété de projet qui peut être discutée
