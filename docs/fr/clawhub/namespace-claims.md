---
read_when:
    - Revendiquer une organisation, une marque, un scope de package, un identifiant de propriétaire, un slug de skill ou un espace de noms de package
...
x-i18n:
    generated_at: "2026-07-03T00:55:05Z"
    model: gpt-5.5
...
ClawHub utilise les identifiants de propriétaire, les identifiants d’organisation, les slugs de compétence, les noms de packages de Plugin et les
...
ou modifié d’une autre façon en raison d’une propriété réelle.
...
- des liens vers le propriétaire, la compétence, le Plugin, le package ou l’issue ClawHub contesté
