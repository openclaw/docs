...
x-i18n:
    generated_at: "2026-07-04T10:38:10Z"
    model: gpt-5.5
...
# Demandes relatives aux organisations et aux espaces de noms

ClawHub utilise les identifiants de propriétaires, les identifiants d’organisations, les slugs de compétences, les noms de paquets Plugin et
...
avec le
[formulaire de ticket de demande d’organisation / d’espace de noms](https://github.com/openclaw/clawhub/issues/new?template=org-namespace-claim.yml).

Utilisez ce parcours pour les examens de propriété publics et non sensibles. N’utilisez pas les
signalements dans le produit ni le formulaire d’appel de compte pour les demandes relatives aux espaces de noms.

## Quand ouvrir une demande

Ouvrez une demande d’espace de noms lorsque vous estimez que l’équipe ClawHub doit examiner si un
...
- un slug de compétence ou un nom de paquet Plugin qui semble usurper l’identité d’un projet
...
suivez également les consignes de modération ou de sécurité pertinentes. Le formulaire de demande d’espace de noms
sert à l’examen de propriété, et non à la divulgation urgente de vulnérabilités.

## Avant de déposer une demande

Vérifiez d’abord que vous publiez avec le propriétaire qui correspond à l’espace de noms.
Pour les paquets Plugin, les noms à portée tels que `@example-org/example-plugin` doivent être
...
renommant, transférant, masquant ou supprimant la ressource concernée. Utilisez une demande
...
- l’historique d’une organisation GitHub, d’un dépôt, d’une version ou de responsables de maintenance
...
- des liens vers le propriétaire, la compétence, le Plugin, le paquet ou le ticket ClawHub contesté
...
Le formulaire de demande indique s’il faut un canal privé avec l’équipe pour les éléments sensibles.
