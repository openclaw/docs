...
x-i18n:
    generated_at: "2026-07-04T15:14:01Z"
    model: gpt-5.5
...
Ouvrez une demande relative à un espace de noms lorsque vous pensez que l’équipe ClawHub doit examiner si un
...
suivez également les consignes de modération ou de sécurité pertinentes. Le formulaire de demande relative à un espace de noms
...
- des liens vers le propriétaire, le skill, le Plugin, le package ou le ticket ClawHub contesté
...
Le formulaire de demande demande si des preuves sensibles nécessitent un canal privé avec l’équipe.
