...
x-i18n:
    generated_at: "2026-07-03T02:48:02Z"
    model: gpt-5.5
...
- Vous êtes connecté dans le CLI.
...
À chaque `clawhub install` signalé, le CLI envoie un événement d’installation au mieux.
...
- Aucun chemin de dossier ni identifiant dérivé de dossiers.
- Aucun contenu de fichier.
- Aucun journal par exécution, prompt ni autre sortie du CLI.
...
Une fois cette variable définie, le CLI n’enverra pas de télémétrie d’installation.
