...
x-i18n:
    generated_at: "2026-07-01T08:00:43Z"
    model: gpt-5.5
...
À chaque `clawhub install` signalé, la CLI envoie un événement d’installation dans la mesure du possible.
...
- `installsAllTime` : utilisateurs uniques ayant signalé au moins une installation CLI du skill.
