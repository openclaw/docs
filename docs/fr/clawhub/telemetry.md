...
x-i18n:
    generated_at: "2026-07-01T12:59:40Z"
    model: gpt-5.5
...
Pour chaque `clawhub install` signalé, la CLI envoie un événement d’installation au mieux.
...
- `installsAllTime` : utilisateurs uniques ayant signalé au moins une installation CLI pour le skill.
...
Une fois cette variable définie, la CLI n’enverra pas la télémétrie d’installation.
