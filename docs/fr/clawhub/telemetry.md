...
x-i18n:
    generated_at: "2026-06-27T17:16:49Z"
    model: gpt-5.5
...
À chaque `clawhub install` signalé, la CLI envoie un événement d’installation en mode meilleur effort.
...
### Ce que nous _ne_ collectons pas
