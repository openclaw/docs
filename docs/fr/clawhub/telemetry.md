...
summary: Installer la télémétrie collectée par la CLI ClawHub et savoir comment se désinscrire.
x-i18n:
    generated_at: "2026-07-01T18:10:25Z"
    model: gpt-5.5
...
- Aucun chemin de dossier ni identifiant dérivé de dossier.
- Aucun contenu de fichier.
- Aucun journal par exécution, prompt ou autre sortie CLI.

## Nombres d’installations

ClawHub maintient des compteurs agrégés par compétence :
...
Une fois cette variable définie, la CLI n’enverra pas de télémétrie d’installation.
