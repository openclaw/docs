...
summary: Télémétrie d’installation collectée par la CLI ClawHub et comment la désactiver.
x-i18n:
    generated_at: "2026-07-02T00:51:40Z"
    model: gpt-5.5
...
ClawHub utilise une télémétrie CLI minimale pour calculer des nombres agrégés d’installations.
...
- `slug` : le slug de la Skills installée.
...
ClawHub conserve des compteurs agrégés par Skills :

- `installsAllTime` : utilisateurs uniques ayant signalé au moins une installation CLI pour la Skills.
