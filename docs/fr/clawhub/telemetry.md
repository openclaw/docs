...
summary: Installer la télémétrie collectée par la CLI ClawHub et savoir comment la désactiver.
x-i18n:
    generated_at: "2026-07-04T03:44:50Z"
    model: gpt-5.5
...
- Aucun journal d’exécution, prompt ni autre sortie de la CLI.
