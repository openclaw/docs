...
x-i18n:
    generated_at: "2026-07-03T23:31:43Z"
    model: gpt-5.5
...
- Confirmez que la publication est publique et non retenue par l’analyse ou la modération.
...
Les diagnostics visibles par le propriétaire peuvent expliquer l’état d’analyse, de barrière de téléversement ou de modération.
...
les noms à portée comme `@example-org/example-plugin` doivent être publiés sous le
...
[Revendications d’organisation et d’espace de noms](/clawhub/namespace-claims) pour les recommandations sur les preuves et ce
