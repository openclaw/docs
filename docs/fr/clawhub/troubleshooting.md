---
read_when:
    - Échec des commandes CLI ClawHub ou de registre OpenClaw
...
x-i18n:
    generated_at: "2026-07-05T05:04:19Z"
    model: gpt-5.5
...
Si une publication échoue parce que l'identifiant du propriétaire, l'espace de noms de l'organisation, le scope du package, le
...
les noms scopés tels que `@example-org/example-plugin` doivent être publiés en tant que propriétaire
...
[Revendications d'organisations et d'espaces de noms](/clawhub/namespace-claims) pour obtenir des conseils sur les preuves et savoir ce
