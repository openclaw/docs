...
x-i18n:
    generated_at: "2026-07-03T00:55:54Z"
    model: gpt-5.5
...
les noms avec portée comme `@example-org/example-plugin` doivent être publiés par le
...
[Revendications d’organisation et d’espace de noms](/clawhub/namespace-claims) pour les recommandations sur les preuves et sur ce
...
- Publier votre copie modifiée sous un nouveau slug ou comme fork.
