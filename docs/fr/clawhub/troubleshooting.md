...
x-i18n:
    generated_at: "2026-07-01T20:19:47Z"
    model: gpt-5.5
...
Les diagnostics visibles par le propriétaire peuvent expliquer l'état de l'analyse, du verrou de téléversement ou de la modération.
...
ou le nom du paquet est déjà revendiqué ou réservé, vérifiez d'abord que vous publiez avec le
propriétaire qui correspond à l'espace de noms. Pour les paquets de plugin,
