...
x-i18n:
    generated_at: "2026-05-13T02:52:48Z"
    model: gpt-5.5
    provider: openai
...
Les diagnostics visibles par le propriétaire peuvent expliquer l’état de l’analyse, du blocage d’importation ou de la modération.
