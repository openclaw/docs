...
Les diagnostics visibles par le propriétaire peuvent expliquer l’état d’analyse, de blocage à l’importation ou de modération.
...
outils doivent être déclarés afin que les utilisateurs et les analyseurs puissent comprendre le package.
...
- Vérifiez la page de détails du package pour connaître l’état d’analyse et les métadonnées de compatibilité.
...
Consultez [API HTTP](/fr/clawhub/http-api) pour les détails des endpoints.
