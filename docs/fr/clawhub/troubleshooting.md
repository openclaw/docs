...
x-i18n:
    generated_at: "2026-07-01T08:01:44Z"
    model: gpt-5.5
...
- Vérifiez que la publication est publique et qu’elle n’est pas retenue par l’analyse ou la modération.
- Si la skill vous appartient, connectez-vous et inspectez-la :
...
Si une publication échoue parce que l’identifiant du propriétaire, l’espace de noms d’organisation, la portée du paquet, le slug de skill
...
les noms à portée tels que `@example-org/example-plugin` doivent être publiés sous le
