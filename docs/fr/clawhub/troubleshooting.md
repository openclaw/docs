...
x-i18n:
    generated_at: "2026-07-01T05:40:00Z"
    model: gpt-5.5
...
Pour les compétences, vérifiez le frontmatter de `SKILL.md`. Les variables d'environnement et
...
slug de compétence ou le nom du paquet est déjà revendiqué ou réservé, confirmez d'abord que vous
...
[Revendications d'organisation et d'espace de noms](/clawhub/namespace-claims) pour obtenir des conseils sur les preuves et sur ce
