...
x-i18n:
    generated_at: "2026-06-30T22:14:37Z"
    model: gpt-5.5
...
Les diagnostics visibles par le propriétaire peuvent expliquer l'état de l'analyse, de la barrière d'envoi ou de la modération.
...
[Revendications d'organisations et d'espaces de noms](/clawhub/namespace-claims) pour obtenir des conseils sur les preuves et savoir ce qu'il
faut exclure des issues publiques.
...
- Confirmez que votre version d'OpenClaw satisfait la plage de compatibilité
  annoncée du paquet.
- Si le paquet est masqué, retenu ou bloqué, il se peut qu'il ne soit pas installable tant que
