...
x-i18n:
    generated_at: "2026-07-02T22:29:32Z"
    model: gpt-5.5
...
personne n’envoie que quelques requêtes. Connectez-vous lorsque c’est possible, puis réessayez après le
délai indiqué.
...
## Une compétence n’apparaît pas dans la recherche
...
Les diagnostics visibles par le propriétaire peuvent expliquer l’état d’analyse, de blocage d’envoi ou de modération.
...
Si une publication échoue parce que l’identifiant du propriétaire, l’espace de noms d’organisation, la portée du paquet, le slug de compétence
...
les noms avec portée comme `@example-org/example-plugin` doivent être publiés sous le
...
[Revendications d’organisation et d’espace de noms](/clawhub/namespace-claims) pour obtenir des recommandations sur les preuves et savoir ce
...
## `update` refuse de continuer à cause de modifications locales
