...
x-i18n:
    generated_at: "2026-07-02T14:02:59Z"
    model: gpt-5.5
...
Les diagnostics visibles par le propriétaire peuvent expliquer l’état de l’analyse, de la porte de téléversement ou de la modération.

## La publication échoue parce que des métadonnées requises manquent
...
- Consultez la page de détail du paquet pour connaître l’état de l’analyse et les métadonnées de compatibilité.
