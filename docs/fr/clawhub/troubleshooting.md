...
x-i18n:
    generated_at: "2026-07-04T15:14:47Z"
    model: gpt-5.5
...
Si une publication échoue parce que l’identifiant du propriétaire, l’espace de noms d’organisation, le périmètre du paquet, le slug de compétence
...
les noms à périmètre tels que `@example-org/example-plugin` doivent être publiés avec le
