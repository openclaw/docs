...
x-i18n:
    generated_at: "2026-07-01T12:57:33Z"
    model: gpt-5.5
...
Si de nombreux utilisateurs partagent une même IP de sortie, les limites par IP anonyme peuvent être atteintes même si chaque
...
Si une publication échoue parce que l’identifiant du propriétaire, l’espace de noms d’organisation, la portée du package, le slug du Skill
...
- Si le package est masqué, retenu ou bloqué, il se peut qu’il ne soit pas installable tant que
