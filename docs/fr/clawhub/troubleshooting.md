...
x-i18n:
    generated_at: "2026-07-02T08:12:08Z"
    model: gpt-5.5
...
Si vous pensez que votre organisation, projet ou marque est le propriétaire légitime de l’espace de noms mais que
...
- Remplacez par la version publiée :

```bash
clawhub update @openclaw/demo --force
```

- Publiez votre copie modifiée sous forme de nouveau slug ou de fork.
...
- Consultez la page de détail du package pour connaître l’état de l’analyse et les métadonnées de compatibilité.
