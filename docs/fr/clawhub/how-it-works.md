...
x-i18n:
    generated_at: "2026-07-03T23:30:58Z"
    model: gpt-5.5
...
- des informations de changelog et de balises comme `latest`
...
Un Skill est un lot de texte versionné centré sur `SKILL.md`. Il peut inclure
