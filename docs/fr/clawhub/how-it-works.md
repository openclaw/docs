...
summary: Fonctionnement des fiches, versions, installations, publications, analyses et mises à jour ClawHub.
x-i18n:
...
- des informations de changelog et d’étiquette comme `latest`
- des signaux de téléchargement, d’installation et d’étoiles
- un état d’analyse de sécurité et de modération

La page de fiche est l’endroit canonique où les utilisateurs inspectent ce qu’une skill ou
...
package de registre ultérieurement. La CLI ClawHub prend également en charge les workflows d’installation et
de mise à jour directes de skills pour les utilisateurs qui veulent des dossiers de skills gérés par le registre en dehors d’un
...
ClawHub expose des API de lecture publiques pour la découverte, la recherche, les détails de package et
