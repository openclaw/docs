...
x-i18n:
    generated_at: "2026-07-03T09:31:56Z"
    model: gpt-5.5
...
donne à OpenClaw suffisamment de métadonnées pour installer et mettre à jour ces packages en toute sécurité.
...
la version minimale du Gateway, les cibles d’hôte, les exigences d’environnement et les condensés
d’artefacts.
...
package du registre ultérieurement. La CLI ClawHub prend aussi en charge les workflows directs d’installation et
...
à des contrôles automatisés, aux signalements des utilisateurs et aux actions de modération.
