...
x-i18n:
    generated_at: "2026-07-04T03:45:37Z"
    model: gpt-5.5
...
ClawHub est la couche de registre pour les compétences et Plugins OpenClaw. Elle offre aux utilisateurs un
emplacement pour découvrir des paquets, aux éditeurs un emplacement pour publier des versions, et
...
La page de fiche est l’emplacement canonique où les utilisateurs peuvent examiner ce qu’une compétence ou
un plugin prétend faire avant de l’installer.

## Skills

Une compétence est un paquet de texte versionné centré sur `SKILL.md`. Elle peut inclure
des fichiers d’accompagnement, des exemples, des modèles et des scripts.
...
métadonnées exactes sont importantes, car elles aident les utilisateurs à décider s’ils doivent installer la compétence et
...
paquet du registre ultérieurement. La CLI ClawHub prend également en charge les workflows d’installation et de
mise à jour directes de compétences pour les utilisateurs qui veulent des dossiers de compétences gérés par le registre en dehors d’un
...
des contrôles automatisés, des signalements d’utilisateurs et des actions de modération.
...
ClawHub expose des API de lecture publiques pour la découverte, la recherche, les détails de paquet et les
téléchargements. Les catalogues tiers peuvent utiliser ces API lorsqu’ils renvoient vers la fiche
ClawHub canonique, respectent les limites de débit et évitent de suggérer une approbation.
