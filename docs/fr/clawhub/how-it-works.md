...
summary: Fonctionnement des annonces ClawHub, des versions, des installations, de la publication, des analyses et des mises à jour.
x-i18n:
...
Les commandes d’installation d’OpenClaw utilisent ClawHub comme source de package :
...
package de registre plus tard. Le CLI ClawHub prend aussi en charge les workflows directs d’installation et
...
ClawHub expose des API publiques de lecture pour la découverte, la recherche, les détails de packages et
