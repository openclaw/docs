...
x-i18n:
    generated_at: "2026-07-02T08:14:08Z"
    model: gpt-5.5
...
paquet de registre ultérieurement. La CLI ClawHub prend également en charge les workflows directs d’installation et
...
ClawHub expose des API publiques en lecture pour la découverte, la recherche, les détails des paquets et les
