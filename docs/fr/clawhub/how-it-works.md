...
x-i18n:
    generated_at: "2026-05-13T04:17:39Z"
    model: gpt-5.5
    provider: openai
...
La page de fiche est l’endroit canonique où les utilisateurs peuvent examiner ce qu’une skill ou
...
la version minimale du Gateway, les cibles d’hôte, les exigences d’environnement et les condensats
d’artefacts.
...
le même package de registre. La CLI ClawHub prend également en charge les workflows directs d’installation et
...
ClawHub expose des API de lecture publiques pour la découverte, la recherche, les détails de packages et
les téléchargements. Les catalogues tiers peuvent utiliser ces API lorsqu’ils renvoient à la
fiche canonique ClawHub, respectent les limites de débit et évitent d’impliquer une approbation.
