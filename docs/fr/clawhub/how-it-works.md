...
x-i18n:
    generated_at: "2026-07-04T10:37:13Z"
    model: gpt-5.5
...
le même package de registre. Le CLI ClawHub prend aussi en charge les workflows directs d’installation et de
...
ClawHub est ouvert à la publication, mais les releases restent soumises à des barrières de téléversement,
...
ClawHub expose des API publiques de lecture pour la découverte, la recherche, les détails des packages et les
