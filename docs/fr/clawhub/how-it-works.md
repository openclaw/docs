...
x-i18n:
    generated_at: "2026-07-05T05:02:49Z"
    model: gpt-5.5
...
endroit où découvrir des paquets, aux éditeurs un endroit où publier des versions, et à
...
- des informations de changelog et d’étiquettes, comme `latest`
...
Un Skill est un ensemble de textes versionné centré sur `SKILL.md`. Il peut inclure
...
affichent ensuite les métadonnées publiées, les fichiers, l’attribution de la source et l’état des analyses.
...
paquet du registre ultérieurement. Le CLI ClawHub prend aussi en charge des workflows directs d’installation et
...
à des vérifications automatisées, aux signalements des utilisateurs et aux actions de modération.
...
ClawHub expose des API publiques en lecture pour la découverte, la recherche, les détails de paquets et les
