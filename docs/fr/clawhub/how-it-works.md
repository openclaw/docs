...
x-i18n:
    generated_at: "2026-07-02T22:29:47Z"
    model: gpt-5.5
...
- des métadonnées, un résumé, des fichiers et une attribution de la source
- des informations de changelog et de balises telles que `latest`
...
de mise à jour de skills pour les utilisateurs qui souhaitent des dossiers de skills gérés par le registre en dehors d’un
