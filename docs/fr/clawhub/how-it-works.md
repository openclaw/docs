---
read_when:
    - Comprendre les listings, les versions, les installations, la publication et la modération
...
x-i18n:
    generated_at: "2026-07-03T02:46:31Z"
    model: gpt-5.5
...
- des informations de journal des modifications et de tag telles que `latest`
...
Quand OpenClaw installe un plugin depuis ClawHub, il vérifie les métadonnées
de compatibilité annoncées avant l’installation. Les enregistrements de package peuvent inclure la compatibilité d’API,
...
ClawHub est ouvert à la publication, mais les releases restent soumises à des barrières d’envoi,
