...
x-i18n:
    generated_at: "2026-07-04T20:29:11Z"
    model: gpt-5.5
...
La page de fiche est l’endroit canonique où les utilisateurs peuvent examiner ce qu’une compétence ou
...
paquet de registre plus tard. La CLI ClawHub prend aussi en charge les workflows directs d’installation et
...
aux contrôles automatisés, aux signalements des utilisateurs et aux actions des modérateurs.
...
ClawHub expose des API publiques en lecture pour la découverte, la recherche, les détails de paquet et
les téléchargements. Les catalogues tiers peuvent utiliser ces API lorsqu’ils renvoient vers la
fiche ClawHub canonique, respectent les limites de débit et évitent de sous-entendre une approbation.
