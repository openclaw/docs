...
x-i18n:
    generated_at: "2026-07-04T06:29:10Z"
    model: gpt-5.5
...
package du registre ultérieurement. La CLI ClawHub prend également en charge les workflows d’installation et
...
des vérifications automatisées, des signalements utilisateurs et des actions de modération.
