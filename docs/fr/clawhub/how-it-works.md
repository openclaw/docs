...
x-i18n:
    generated_at: "2026-07-03T17:19:11Z"
    model: gpt-5.5
...
Les commandes d’installation d’OpenClaw utilisent ClawHub comme source de paquet :
...
OpenClaw enregistre les métadonnées de source d’installation afin que les mises à jour puissent résoudre ultérieurement le même
paquet de registre. La CLI ClawHub prend également en charge les workflows directs d’installation et
