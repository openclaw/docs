---
read_when:
    - Comprendre les annonces, les versions, les installations, la publication et la modération
...
- des informations de journal des modifications et d’étiquettes telles que `latest`
...
Une compétence est un lot de texte versionné centré sur `SKILL.md`. Elle peut inclure
...
métadonnées exactes sont importantes, car elles aident les utilisateurs à décider d’installer ou non la compétence et
...
paquet de registre plus tard. Le CLI ClawHub prend aussi en charge les flux de travail directs d’installation et
