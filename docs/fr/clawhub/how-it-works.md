...
x-i18n:
    generated_at: "2026-07-04T17:56:48Z"
    model: gpt-5.5
...
ClawHub est la couche de registre pour les compétences et plugins OpenClaw. Il fournit aux utilisateurs un
...
- des informations de journal des modifications et d’étiquette comme `latest`
- des signaux de téléchargement, d’installation et d’étoiles
- l’état de l’analyse de sécurité et de la modération

La page de fiche est l’endroit canonique où les utilisateurs peuvent examiner ce qu’une compétence ou un
plugin prétend faire avant de l’installer.

## Skills

Une compétence est un ensemble de texte versionné centré sur `SKILL.md`. Elle peut inclure
...
aident les analyses automatisées à détecter les écarts entre le comportement déclaré et observé.
...
package de registre plus tard. La CLI ClawHub prend aussi en charge les workflows directs d’installation et
de mise à jour de compétences pour les utilisateurs qui veulent des dossiers de compétences gérés par le registre en dehors d’un
...
téléchargements. Les catalogues tiers peuvent utiliser ces API lorsqu’ils renvoient à la
