...
x-i18n:
    generated_at: "2026-07-01T12:57:57Z"
    model: gpt-5.5
...
- des informations de journal des modifications et d’étiquette telles que `latest`
...
paquet du registre ultérieurement. La CLI ClawHub prend aussi en charge les workflows directs d’installation et de
...
ClawHub expose des API de lecture publiques pour la découverte, la recherche, les détails de paquets et les
