...
title: ClawHub
x-i18n:
    generated_at: "2026-07-03T02:46:51Z"
    model: gpt-5.5
...
- Utilisez la CLI `clawhub` séparée pour l’authentification au registre, la publication et les flux de suppression/restauration.
...
Installez la CLI ClawHub lorsque vous voulez utiliser des flux authentifiés auprès du registre, comme
...
ClawHub suit les versions semver, les étiquettes comme `latest`, les changelogs, les fichiers,
...
| `CLAWHUB_CONFIG_PATH`         | Remplace l’emplacement où la CLI stocke l’état de jeton/configuration. |
