...
Installez la CLI ClawHub lorsque vous voulez utiliser des workflows authentifiés auprès du registre, comme
...
et [Format des Skills](/fr/clawhub/skill-format) pour les métadonnées de Skills.

## Sécurité et modération

ClawHub est ouvert par défaut : tout le monde peut téléverser, mais la publication exige un compte GitHub
...
d’installation au mieux de ses possibilités afin que ClawHub puisse calculer des nombres agrégés d’installations. Désactivez cela avec :
