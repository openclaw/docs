...
title: ClawHub
x-i18n:
    generated_at: "2026-07-04T15:14:09Z"
    model: gpt-5.5
...
Installez la CLI ClawHub lorsque vous voulez des workflows authentifiés auprès du registre, comme la
publication ou la suppression/restauration :
...
| -------------- | ------------------------------------------------------------ | -------------------------------------------- |
| Skills         | Lots de texte versionnés avec `SKILL.md` et des fichiers de prise en charge | `openclaw skills install @openclaw/demo`     |
...
Utilisez `clawhub:<package>` lorsqu’une installation de plugin doit se résoudre via ClawHub.
Les spécifications de plugins nues compatibles npm peuvent se résoudre via npm pendant les bascules de lancement, et
...
ClawHub est ouvert par défaut : tout le monde peut téléverser, mais la publication nécessite un compte
GitHub suffisamment ancien pour passer la barrière de téléversement. Les pages de détail publiques résument
...
| Variable                      | Effet                                             |
| ----------------------------- | ------------------------------------------------- |
| `CLAWHUB_SITE`                | Remplace l’URL du site utilisée pour la connexion via navigateur. |
