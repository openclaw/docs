...
title: ClawHub
x-i18n:
    generated_at: "2026-07-04T06:30:13Z"
    model: gpt-5.5
...
Les spécifications de plugins compatibles npm sans préfixe peuvent être résolues via npm pendant les transitions de lancement, et
...
ClawPack, OpenClaw privilégie le `.tgz` npm-pack téléversé exact, vérifie
...
suffisamment ancien pour passer le contrôle de téléversement. Les pages de détail publiques résument le
dernier état d’analyse avant l’installation ou le téléchargement.

ClawHub exécute des contrôles automatisés sur les Skills publiées et les versions de plugins. Les versions retenues par l’analyse
...
d’installation au mieux de ses capacités afin que ClawHub puisse calculer des nombres d’installations agrégés. Désactivez cela avec :
