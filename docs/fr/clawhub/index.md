...
title: ClawHub
x-i18n:
    generated_at: "2026-06-30T22:14:07Z"
    model: gpt-5.5
...
| -------------- | ------------------------------------------------------------ | -------------------------------------------- |
| Skills         | Ensembles de texte versionnés avec `SKILL.md` et des fichiers de prise en charge | `openclaw skills install @openclaw/demo`     |
...
afin que ClawHub puisse calculer des nombres d’installations agrégés. Désactivez cela avec :
