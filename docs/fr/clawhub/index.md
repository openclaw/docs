...
title: ClawHub
x-i18n:
    generated_at: "2026-07-01T08:00:57Z"
    model: gpt-5.5
...
ClawHub suit les versions semver, les tags comme `latest`, les journaux des changements, les fichiers,
...
- `--changelog <text>` : texte du journal des changements.
...
ClawHub est ouvert par défaut : n’importe qui peut téléverser, mais la publication nécessite un compte GitHub
assez ancien pour passer la barrière de téléversement. Les pages publiques de détail résument
le dernier état d’analyse avant l’installation ou le téléchargement.

ClawHub exécute des vérifications automatisées sur les Skills publiées et les versions de Plugins. Les versions retenues par l’analyse
...
d’installation au mieux de ses capacités afin que ClawHub puisse calculer des totaux agrégés d’installation. Désactivez cela avec :
