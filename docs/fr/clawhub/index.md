...
title: ClawHub
x-i18n:
    generated_at: "2026-05-13T05:33:09Z"
    model: gpt-5.5
    provider: openai
...
Les commandes OpenClaw natives s’installent dans l’espace de travail OpenClaw actif et conservent
...
Les spécifications de plugins simples compatibles npm peuvent être résolues via npm pendant les bascules de lancement, et
...
avant l’exécution de l’installation de l’archive. Lorsqu’une version de package publie un artefact
...
ClawHub est ouvert par défaut : tout le monde peut téléverser du contenu, mais la publication nécessite un compte GitHub
...
ClawHub exécute des vérifications automatisées sur les Skills et les versions de plugins publiés. Les versions
