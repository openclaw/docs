...
La CLI propose également des commandes d’installation/mise à jour de Skills pour les workflows directs avec le registre :
...
ClawHub est ouvert par défaut : n’importe qui peut téléverser, mais la publication nécessite un compte
...
d’installation au mieux de ses possibilités afin que ClawHub puisse calculer des nombres d’installations agrégés. Désactivez cela avec :
