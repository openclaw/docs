...
title: ClawHub
x-i18n:
    generated_at: "2026-07-01T12:56:59Z"
    model: gpt-5.5
...
- Utilisez le CLI `clawhub` séparé pour les workflows d’authentification au registre, de publication et de suppression/restauration.
...
Installez le CLI ClawHub lorsque vous voulez des workflows authentifiés auprès du registre, comme
...
Les spécifications de plugin brutes compatibles npm peuvent être résolues via npm pendant les bascules de lancement, et
...
annoncée avant l’exécution de l’installation de l’archive. Lorsqu’une version de paquet publie un
...
Le CLI propose aussi des commandes d’installation/mise à jour de Skills pour les workflows directs avec le registre :
...
Lorsque vous exécutez `clawhub install` en étant connecté, le CLI peut envoyer un événement
...
| `CLAWHUB_CONFIG_PATH`         | Remplace l’emplacement où le CLI stocke l’état des jetons/config. |
