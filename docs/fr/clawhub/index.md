...
title: ClawHub
x-i18n:
    generated_at: "2026-05-12T15:42:46Z"
    model: gpt-5.5
    provider: openai
...
la publication, la synchronisation ou la suppression/restauration :
...
| Souls          | Lots `SOUL.md` affichés sur onlycrabs.ai                     | Workflows de publication Web et API         |
...
Les spécifications de plugins compatibles npm sans préfixe peuvent se résoudre via npm pendant les bascules de lancement, et
...
artefact ClawPack, OpenClaw privilégie le `.tgz` npm-pack exact téléversé, vérifie
...
La CLI dispose aussi de commandes d’installation et de mise à jour de Skills pour les workflows directs avec le registre :
...
ClawHub exécute des vérifications automatisées sur les Skills et versions de plugins publiés. Les versions
...
[Sécurité + modération](/fr/clawhub/security) pour les détails des règles et de l’application.
