...
title: ClawHub
x-i18n:
    generated_at: "2026-07-03T09:33:19Z"
    model: gpt-5.5
...
publier ou supprimer/restaurer :
...
| Surface        | Ce qui y est stocké                                         | Commande typique                             |
| -------------- | ---------------------------------------------------------- | -------------------------------------------- |
...
Les spécifications de plugin compatibles npm sans préfixe peuvent être résolues via npm pendant les bascules de lancement, et
...
ClawHub exécute des contrôles automatisés sur les Skills et les versions de plugins publiées. Les versions retenues par l’analyse
