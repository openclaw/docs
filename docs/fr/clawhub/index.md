...
title: ClawHub
x-i18n:
    generated_at: "2026-07-01T20:19:06Z"
    model: gpt-5.5
...
| -------------- | ------------------------------------------------------------ | -------------------------------------------- |
| Skills         | Ensembles de texte versionnés avec `SKILL.md` et fichiers de prise en charge | `openclaw skills install @openclaw/demo`     |
...
GitHub suffisamment ancien pour franchir la barrière de téléversement. Les pages de détail publiques résument
le dernier état d’analyse avant installation ou téléchargement.
