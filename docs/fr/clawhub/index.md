...
title: ClawHub
x-i18n:
    generated_at: "2026-07-02T17:36:37Z"
    model: gpt-5.5
...
Les spécifications de Plugins brutes compatibles npm peuvent être résolues via npm pendant les bascules de lancement, et
...
La CLI ClawHub sert aux tâches authentifiées auprès du registre :
...
l’état de la dernière analyse avant installation ou téléchargement.
...
| `CLAWHUB_CONFIG_PATH`         | Remplace l’emplacement où la CLI stocke l’état du jeton/de la config. |
