...
title: ClawHub
x-i18n:
    generated_at: "2026-07-03T17:19:15Z"
    model: gpt-5.5
...
| Surface        | Ce qu’il stocke                                                        | Commande habituelle                           |
| -------------- | ---------------------------------------------------------------------- | --------------------------------------------- |
| Skills         | Bundles de texte versionnés avec `SKILL.md` et fichiers de prise en charge | `openclaw skills install @openclaw/demo`      |
| Plugins de code | Paquets de plugins OpenClaw avec métadonnées de compatibilité          | `openclaw plugins install clawhub:<package>`  |
| Plugins en bundle | Bundles de plugins empaquetés pour la distribution OpenClaw         | `clawhub package publish <source>`            |
...
Les commandes OpenClaw natives installent dans l’espace de travail OpenClaw actif et persistent
...
Les spécifications de plugin npm-safe sans préfixe peuvent être résolues via npm pendant les bascules de lancement, et
...
annoncée avant l’installation de l’archive. Lorsqu’une version de paquet publie un
...
assez ancien pour passer le seuil de téléversement. Les pages de détail publiques résument le
...
d’installation au mieux afin que ClawHub puisse calculer les nombres d’installations agrégés. Désactivez cela avec :
