...
| -------------- | ------------------------------------------------------------ | -------------------------------------------- |
| Skills         | Bundles de texte versionnés avec `SKILL.md` et fichiers de prise en charge | `openclaw skills install <slug>`             |
...
Les spécifications de plugins nues compatibles npm peuvent être résolues via npm pendant les transitions de lancement, et
...
suffisamment ancien pour passer le contrôle de téléversement. Les pages de détail publiques résument
