...
title: ClawHub
x-i18n:
    generated_at: "2026-07-01T18:10:18Z"
    model: gpt-5.5
...
- Utilisez la CLI séparée `clawhub` pour les workflows d’authentification au registre, de publication et de suppression/restauration.
...
| -------------- | ------------------------------------------------------------------- | -------------------------------------------- |
| Skills         | Ensembles de texte versionnés avec `SKILL.md` et fichiers de support | `openclaw skills install @openclaw/demo`     |
...
les téléchargements, les étoiles et les résumés d’analyse de sécurité. Les pages publiques affichent l’état
actuel du registre afin que les utilisateurs puissent inspecter un Skill ou un plugin avant de l’installer.
...
Utilisez `--dry-run` pour générer le plan de publication exact sans téléverser, et `--json`
...
ClawHub exécute des contrôles automatisés sur les Skills publiés et les versions de plugins. Les versions
...
[Utilisation acceptable](/fr/clawhub/acceptable-usage) pour les détails des politiques et de leur application.
...
[Dépannage](/fr/clawhub/troubleshooting) pour des ressources de référence plus approfondies.
