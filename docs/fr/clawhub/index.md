...
title: ClawHub
x-i18n:
    generated_at: "2026-07-04T17:56:26Z"
    model: gpt-5.5
...
Installez la CLI ClawHub lorsque vous voulez utiliser des workflows authentifiés
auprès du registre, comme la publication ou la suppression/restauration :
...
Les spécifications de plugins compatibles npm sans préfixe peuvent être résolues via npm lors des bascules de lancement, et
...
l’en-tête de digest ClawHub et les octets téléchargés, puis enregistre les métadonnées d’artefact pour
...
et [Format des Skills](/clawhub/skill-format) pour les métadonnées de Skills.
