...
x-i18n:
    generated_at: "2026-06-30T13:57:39Z"
    model: gpt-5.5
...
Si la connexion vous ramène à un état déconnecté, il est possible que votre compte ne soit pas en
règle. Si votre compte a été banni ou désactivé, utilisez le
