...
x-i18n:
    generated_at: "2026-07-16T13:06:39Z"
    model: gpt-5.6
...
par l’intermédiaire de ce compte connecté.
...
du proxy, utilisez la procédure de jeton sans interface graphique.
...
Utilisez cette procédure pour les serveurs, les tâches CI ou les environnements limités au terminal.

Pour les shells distants permettant d’ouvrir un navigateur ailleurs, exécutez :
