...
x-i18n:
    generated_at: "2026-05-11T20:24:04Z"
    model: gpt-5.5
    provider: openai
...
ClawHub utilise GitHub pour la connexion web. La CLI utilise les jetons d’API ClawHub créés
...
La CLI affiche un code à usage unique et attend pendant que vous l’autorisez à l’adresse
