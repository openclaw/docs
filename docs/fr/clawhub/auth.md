...
summary: Connexion à ClawHub, jetons API, connexion CLI, stockage des jetons et révocation.
x-i18n:
...
Les comptes supprimés, bannis ou désactivés ne peuvent pas effectuer une connexion ClawHub normale.
...
Les comptes supprimés, bannis ou désactivés ne peuvent pas continuer à utiliser des jetons d’API existants.
Si votre compte a été banni ou désactivé, utilisez le
[formulaire d’appel ClawHub](https://appeals.openclaw.ai/) si vous pensez qu’il s’agit d’une
erreur.
