...
x-i18n:
    generated_at: "2026-07-02T14:01:56Z"
    model: gpt-5.5
...
Si la connexion vous renvoie à un état déconnecté, il est possible que votre compte ne soit pas en règle.
...
Les jetons révoqués, invalides ou manquants renvoient `401 Unauthorized`. Connectez-vous de nouveau
