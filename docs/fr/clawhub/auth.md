...
Les comptes supprimés, bannis ou désactivés ne peuvent pas terminer la connexion
ClawHub normale. Si la connexion vous ramène à un état déconnecté, votre compte
n’est peut-être pas en règle.
...
Si votre navigateur ne peut pas atteindre le rappel local en raison de règles de
pare-feu, de VPN ou de proxy, utilisez le flux de jeton sans interface graphique.
...
La CLI affiche un code à usage unique et attend que vous l’autorisiez à l’adresse
