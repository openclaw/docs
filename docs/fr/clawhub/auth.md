...
Si votre navigateur ne peut pas atteindre le rappel local à cause des règles du pare-feu, du VPN ou
du proxy, utilisez le flux de jeton sans interface graphique.
