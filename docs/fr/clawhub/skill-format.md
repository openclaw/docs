...
`SKILL.md` ou les anciens fichiers `skills.md` dans les dépôts publics non issus d’un fork appartenant au
...
- N’ajoutez pas de conditions de licence incompatibles dans `SKILL.md` ; ClawHub ne prend pas en charge les remplacements de licence par Skill.
