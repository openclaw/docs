...
x-i18n:
    generated_at: "2026-05-13T05:33:11Z"
    model: gpt-5.5
    provider: openai
...
- ClawHub ne prend pas en charge les Skills payants, la tarification par skill, les péages d’accès ni le partage des revenus.
