...
x-i18n:
    generated_at: "2026-07-03T23:31:31Z"
    model: gpt-5.5
...
`SKILL.md` ou l’ancien `skills.md` dans des dépôts publics, non forks, appartenant au
...
- Les portées de package doivent correspondre exactement au handle d’éditeur ClawHub. Les handles d’éditeur peuvent utiliser des lettres minuscules, des chiffres, des traits d’union, des points et des underscores ; ils doivent commencer et se terminer par une lettre minuscule ou un chiffre.
