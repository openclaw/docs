...
x-i18n:
    generated_at: "2026-07-05T05:51:53Z"
    model: gpt-5.5
...
| `emoji`            | `string`   | Émoji d’affichage pour le Skill.                                                                                                            |
...
- Les fichiers de script sont encore analysés après le téléversement ; les fichiers PowerShell `.ps1`, `.psm1` et `.psd1` sont acceptés comme texte.
...
- Les scopes de package doivent correspondre exactement à l’identifiant d’éditeur ClawHub. Les identifiants d’éditeur peuvent utiliser des lettres minuscules, des chiffres, des traits d’union, des points et des underscores ; ils doivent commencer et se terminer par une lettre minuscule ou un chiffre.
