...
x-i18n:
    generated_at: "2026-07-02T17:37:28Z"
    model: gpt-5.5
...
`SKILL.md` ou les anciens fichiers `skills.md` dans les dépôts publics, non forkés et appartenant
...
| `primaryEnv`       | `string`   | Variable d’environnement principale de l’identifiant d’accès pour votre Skill.                                                               |
...
- Les portées de package doivent correspondre exactement à l’identifiant du publieur ClawHub. Les identifiants de publieur peuvent utiliser des lettres minuscules, des chiffres, des traits d’union, des points et des underscores ; ils doivent commencer et se terminer par une lettre minuscule ou un chiffre.
...
- N’importe qui peut utiliser, modifier et redistribuer les Skills publiés, y compris commercialement.
...
- ClawHub ne prend pas en charge les Skills payants, la tarification par Skill, les péages d’accès ni le partage de revenus.
