...
summary: Format de dossier de Skill, fichiers requis, types de fichiers autorisés, limites.
x-i18n:
    generated_at: "2026-07-01T08:01:36Z"
    model: gpt-5.5
...
- Les portées de package doivent correspondre exactement au handle de l’éditeur ClawHub. Les handles d’éditeur peuvent utiliser des lettres minuscules, des chiffres, des traits d’union, des points et des underscores ; ils doivent commencer et se terminer par une lettre minuscule ou un chiffre.
