...
les fichiers `SKILL.md` ou l’ancien `skills.md` dans les dépôts publics, non forkés, appartenant au
...
- N’ajoutez pas de métadonnées de prix à `SKILL.md` ; elles ne font pas partie du format de skill et ne rendront pas un skill publié payant.
