...
`SKILL.md` ou les anciens fichiers `skills.md` dans des dépôts publics, non issus d’un fork, détenus par
...
- `description` est utilisée comme résumé du skill dans l’UI/la recherche.
