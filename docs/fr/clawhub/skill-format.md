...
x-i18n:
    generated_at: "2026-07-02T00:52:38Z"
    model: gpt-5.5
...
`SKILL.md` ou l’ancien `skills.md` dans des dépôts publics, non issus d’un fork, appartenant au compte GitHub connecté. Il n’importe pas les dépôts privés, les forks,
