...
x-i18n:
    generated_at: "2026-05-12T00:57:29Z"
    model: gpt-5.5
    provider: openai
...
| `primaryEnv`       | `string`   | La variable d’environnement principale des identifiants pour votre skill.                                                                                       |
...
Si votre skill nécessite des dépendances installées, déclarez-les dans le tableau `install` :
