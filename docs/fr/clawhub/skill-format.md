...
x-i18n:
    generated_at: "2026-05-13T02:52:14Z"
    model: gpt-5.5
    provider: openai
...
| `emoji`            | `string`   | Émoji d’affichage du skill.                                                                                                                      |
...
- Les balises sont des pointeurs texte vers une version ; `latest` est couramment utilisé.
