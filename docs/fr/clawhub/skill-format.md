...
- Les scopes de paquet doivent correspondre exactement au handle de l’éditeur ClawHub. Les handles d’éditeur peuvent utiliser des lettres minuscules, des chiffres, des traits d’union, des points et des underscores ; ils doivent commencer et se terminer par une lettre minuscule ou un chiffre.
