...
- Le texte utilisé pour l’intégration vectorielle inclut uniquement `SOUL.md`.
...
- Les balises sont des pointeurs sous forme de chaînes vers une version ; `latest` est couramment utilisée.
