...
read_when:
    ...
    - Décider s’il faut installer une Skills ou un Plugin
...
x-i18n:
    generated_at: "2026-07-02T08:15:55Z"
    model: gpt-5.5
...
sans risque. Faites toujours preuve de discernement avant d’accorder des accès sensibles.

Voir aussi [Sécurité](/clawhub/security), [Usage acceptable](/clawhub/acceptable-usage),
...
| `High`           | La version dispose d’une autorité à fort impact, de conclusions graves ou de signaux malveillants. |
...
signifie pas qu’elle est malveillante. Cela signifie que la skill semble alignée avec son objectif, mais peut
...
Les conclusions à faible confiance sont masquées du résumé public de l’audit afin que la page
...
Les pages d’artefact pointent vers l’audit complet à l’adresse :
...
les signaux de réputation qui complètent l’examen de ClawHub tenant compte des agents. Lorsque les décomptes
des moteurs de fournisseurs sont disponibles, l’audit les résume en langage clair, par exemple :
...
Lorsque ClawHub ne dispose d’aucune télémétrie de décompte des fournisseurs à résumer, l’audit indique :
...
l’exécution non sûre, l’empoisonnement de la mémoire ou du contexte, et l’agentivité excessive.

ClawScan ne considère pas une capacité à l’apparence inquiétante comme automatiquement malveillante.
Il demande si la capacité est divulguée, alignée avec l’objectif et prise en charge par
