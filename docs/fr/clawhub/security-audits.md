...
read_when:
    ...
    - Explication du statut d’audit, du niveau de risque ou des conclusions de ClawHub
...
x-i18n:
    generated_at: "2026-07-02T14:02:43Z"
    model: gpt-5.5
...
- le niveau de risque
- toutes les constatations répertoriées
...
Un `Pass` est rassurant, mais il ne remplace pas votre propre jugement. C’est
...
- le contenu de compétence ou de Plugin pertinent
- une recommandation
...
partenariat permet à ClawHub d’ajouter une intelligence de sécurité plus large à l’examen des compétences et Plugins.
