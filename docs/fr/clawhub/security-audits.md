...
read_when:
    ...
    - Expliquer le statut d’audit, le niveau de risque ou les constats de ClawHub
...
x-i18n:
    generated_at: "2026-07-04T10:38:46Z"
    model: gpt-5.5
...
- Le niveau de risque demande : « Quelle est l’ampleur du pouvoir ici ? »
...
Les constatations peuvent être étiquetées `Info`, `Low`, `Medium`, `High` ou `Critical`. Les constatations de gravité
...
comme angle d’analyse des risques tels que l’injection de prompt, le mauvais usage d’outils, l’exposition d’identifiants,
