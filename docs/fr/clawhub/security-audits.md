...
read_when:
    ...
    - Décider d’installer ou non un Skill ou un Plugin
    - Explication de l’état d’audit, du niveau de risque ou des constats de ClawHub
...
x-i18n:
    generated_at: "2026-06-27T17:16:55Z"
    model: gpt-5.5
...
si quelque chose mérite une attention particulière avant qu’elle puisse accéder à des fichiers, comptes,
...
et le contenu réel correspondent-ils à ce que les utilisateurs seraient raisonnablement en droit d’attendre ?
...
décomptes des moteurs de fournisseurs sont disponibles, l’audit les résume en langage clair, par exemple :
...
Lorsque ClawHub n’a aucune télémétrie de décompte de fournisseurs à résumer, l’audit indique :
...
conclusions de SkillSpector, télémétrie VirusTotal et contexte fourni par l’éditeur.
Les signaux d’analyse statique sont du contexte interne pour cet examen ; ils ne constituent pas une
...
comme grille de lecture pour les risques tels que l’injection de prompt, le mauvais usage d’outils, l’exposition d’identifiants,
l’exécution non sûre, l’empoisonnement de mémoire ou de contexte, et l’autonomie excessive.

ClawScan ne traite pas une capacité à l’apparence inquiétante comme automatiquement malveillante.
