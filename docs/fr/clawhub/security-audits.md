...
summary: Comment comprendre les résultats de l’audit de sécurité ClawHub avant d’installer une Skill ou un Plugin.
title: Audits de sécurité
x-i18n:
    generated_at: "2026-07-03T00:55:34Z"
    model: gpt-5.5
...
si certains éléments méritent une attention supplémentaire avant qu’elle puisse accéder aux fichiers, comptes,
...
| `Medium`         | La version dispose d’une autorité significative, comme un accès au compte ou des modifications de données. |
...
gravité supérieure contribuent plus fortement au niveau de risque et à l’état de l’audit.
...
des commandes locales, des API de fournisseurs ou des installations de packages. L’audit vérifie si ce
pouvoir est attendu, divulgué et proportionné.

Les pages d’artefact renvoient à l’audit complet à l’adresse :
...
les signaux de réputation qui complètent l’examen ClawHub sensible aux agents. Lorsque les décomptes des
...
VirusTotal reste une télémétrie. Il ne remplace pas la propre analyse des risques
de ClawHub, fondée sur les artefacts.
...
l’exécution non sûre, l’empoisonnement de la mémoire ou du contexte et une autonomie excessive.
