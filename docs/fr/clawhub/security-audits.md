...
read_when:
    ...
    - Explication de l’état d’audit de ClawHub, du niveau de risque ou des constats
sidebarTitle: Security Audits
summary: Comment interpréter les résultats d’audit de sécurité ClawHub avant d’installer une skill ou un Plugin.
title: Audits de sécurité
x-i18n:
    generated_at: "2026-07-04T20:28:51Z"
    model: gpt-5.5
...
exempte de risques. Faites toujours preuve de discernement avant d’accorder un accès sensible.
...
- le propriétaire, la source, la version, le journal des modifications, les téléchargements, les étoiles et autres signaux de confiance
...
| `High`           | La version dispose d’autorisations à fort impact, de constats graves ou de signaux malveillants. |
...
agir avec une autorisation de compte significative.
...
Les constats peuvent être étiquetés `Info`, `Low`, `Medium`, `High` ou `Critical`. Les constats de
gravité plus élevée contribuent plus fortement au niveau de risque et à l’état de l’audit.

Les constats à faible confiance sont masqués dans le récapitulatif d’audit public afin que la page
...
[Top 10 OWASP des Agentic Skills](https://owasp.org/www-project-agentic-skills-top-10/)
comme prisme pour les risques tels que l’injection de prompt, le mauvais usage d’outils, l’exposition d’identifiants,
l’exécution non sûre, l’empoisonnement de mémoire ou de contexte et l’agence excessive.
