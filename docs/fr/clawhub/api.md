...
x-i18n:
    generated_at: "2026-07-01T20:18:35Z"
    model: gpt-5.5
...
Vous pouvez créer un catalogue, un répertoire ou une interface de recherche tiers à partir des API publiques de lecture de ClawHub. Les métadonnées publiques des Skills et les fichiers de Skills sont publiés selon les règles de licence des Skills de ClawHub, tandis que l’API elle-même est soumise à des limites de débit et doit être consommée de manière responsable.
...
- Les erreurs v1 sont en texte brut (`text/plain; charset=utf-8`), y compris les réponses
  `400`, `401`, `403`, `404`, `429` et les téléchargements bloqués.
- Les paramètres de requête inconnus sont ignorés pour compatibilité.
- Les paramètres de requête connus ayant des valeurs invalides renvoient `400`.
