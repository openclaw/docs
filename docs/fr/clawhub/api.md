...
summary: 'API REST publique (v1) : présentation et conventions.'
x-i18n:
...
- En cas de jeton manquant/invalide, l’application des limites revient à l’adresse IP.
...
- `POST /api/v1/users/reserve` réserve des slugs racine et des espaces réservés de paquets privés sans version pour un identifiant de propriétaire.
