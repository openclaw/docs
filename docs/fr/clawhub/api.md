...
- Ajoutez un lien vers l’URL canonique du skill ClawHub lorsque vous affichez des listes, afin que les utilisateurs puissent inspecter l’enregistrement source du registre.
- Utilisez des URL de page canoniques sous la forme `https://clawhub.ai/<owner>/<slug>`.
- Ne laissez pas entendre que ClawHub approuve, vérifie ou exploite le site tiers.
- Ne dupliquez pas le contenu masqué, privé ou bloqué par la modération en contournant les filtres d’API publics ou les limites d’authentification.
