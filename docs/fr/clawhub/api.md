...
x-i18n:
    generated_at: "2026-07-02T17:36:05Z"
    model: gpt-5.5
...
Vous pouvez créer un catalogue, un annuaire ou une interface de recherche tiers par-dessus les API publiques de lecture de ClawHub. Les métadonnées publiques de Skills et les fichiers de Skills sont publiés selon les règles de licence des Skills de ClawHub, tandis que l’API elle-même est limitée en débit et doit être consommée de manière responsable.
