...
Vous pouvez créer un catalogue, un annuaire ou une interface de recherche tiers au-dessus des API publiques de lecture de ClawHub. Les métadonnées publiques des skills et les fichiers de skills sont publiés selon les règles de licence des skills de ClawHub, tandis que l’API elle-même est soumise à des limites de débit et doit être consommée de manière responsable.
...
- Un jeton manquant/invalide bascule vers l’application par IP.
