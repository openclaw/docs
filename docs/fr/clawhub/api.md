...
x-i18n:
    generated_at: "2026-07-04T10:37:16Z"
    model: gpt-5.5
...
Vous pouvez créer un catalogue, un répertoire ou une interface de recherche tierce par-dessus les API publiques de lecture de ClawHub. Les métadonnées publiques des Skills et les fichiers de Skills sont publiés selon les règles de licence des Skills de ClawHub, tandis que l’API elle-même est soumise à des limites de débit et doit être consommée de manière responsable.
...
- `Retry-After` : délai d’attente en secondes sur `429`
