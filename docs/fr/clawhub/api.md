...
x-i18n:
    generated_at: "2026-07-04T17:56:50Z"
    model: gpt-5.5
...
Vous pouvez créer un catalogue, un annuaire ou une surface de recherche tierce au-dessus des API publiques de lecture de ClawHub. Les métadonnées publiques des Skills et les fichiers de Skills sont publiés selon les règles de licence des Skills de ClawHub, tandis que l’API elle-même est soumise à des limites de débit et doit être consommée de manière responsable.
...
- Utilisez des URL de page canoniques de la forme `https://clawhub.ai/<owner>/skills/<slug>`.
