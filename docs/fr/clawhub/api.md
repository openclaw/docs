...
x-i18n:
    generated_at: "2026-05-11T22:19:21Z"
    model: gpt-5.5
    provider: openai
...
Vous pouvez créer un catalogue, un répertoire ou une surface de recherche tiers par-dessus les API de lecture publiques de ClawHub. Les métadonnées publiques des Skills et les fichiers de Skills sont publiés selon les règles de licence des Skills de ClawHub, tandis que l’API elle-même est soumise à des limites de débit et doit être consommée de manière responsable.
...
- Un jeton manquant/non valide revient à une application par IP.
