...
x-i18n:
    generated_at: "2026-07-03T17:19:36Z"
    model: gpt-5.5
...
OpenClaw enregistre d’où provient le skill afin que les mises à jour ultérieures puissent continuer à
...
Utilisez d’abord `--dry-run` pour prévisualiser les métadonnées du paquet résolues, les champs de
...
la modération peuvent être masquées dans la recherche et les surfaces d’installation jusqu’à résolution.
