...
x-i18n:
    generated_at: "2026-07-01T05:39:35Z"
    model: gpt-5.5
...
Un Skill est un dossier avec un fichier `SKILL.md` requis et des fichiers de support
facultatifs.
...
d’environnement, les outils et les permissions requis afin que les utilisateurs puissent comprendre ce dont le
...
Utilisez d’abord `--dry-run` pour prévisualiser les métadonnées du package résolues, les champs de compatibilité,
...
les métadonnées, les liens sources, les versions, les journaux de modifications et l’état d’analyse :
...
modération peuvent être masquées des surfaces de recherche et d’installation jusqu’à résolution.
