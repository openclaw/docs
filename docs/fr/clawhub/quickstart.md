...
Une Skill est un dossier contenant un fichier `SKILL.md` obligatoire et, éventuellement, des
...
variables d’environnement, outils et autorisations requis afin que les utilisateurs comprennent ce dont la
...
Utilisez d’abord `--dry-run` pour prévisualiser les métadonnées du paquet résolu, les champs de
