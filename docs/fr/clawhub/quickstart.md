...
x-i18n:
    generated_at: "2026-07-04T15:14:40Z"
    model: gpt-5.5
...
l’attribution de la source et le plan d’envoi sans publier.
...
les métadonnées, liens source, versions, journaux des modifications et l’état d’analyse :
