...
Les environnements sans interface peuvent utiliser un jeton API depuis l’interface web de ClawHub :
...
compétence a besoin avant de l’installer. Consultez [Format des compétences](/fr/clawhub/skill-format).
...
## Synchroniser les compétences que vous maintenez

`sync` analyse les dossiers de compétences et publie les compétences nouvelles ou modifiées qui ne sont pas
déjà synchronisées.
