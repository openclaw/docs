...
x-i18n:
    generated_at: "2026-07-02T14:02:09Z"
    model: gpt-5.5
...
Utilisez d’abord `--dry-run` pour prévisualiser les métadonnées du paquet résolues, les champs
...
les métadonnées, liens de source, versions, journaux des modifications et état d’analyse :
