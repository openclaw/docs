...
variables d’environnement, outils et autorisations requis afin que les utilisateurs puissent comprendre ce dont
la skill a besoin avant de l’installer. Consultez [Format des skills](/fr/clawhub/skill-format).
...
les nombres d’installations agrégés. Consultez [Télémétrie](/fr/clawhub/telemetry) pour savoir ce qui est signalé
