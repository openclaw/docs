...
Un Skill est un dossier avec un fichier `SKILL.md` requis et des fichiers de prise en charge
facultatifs.
...
les décomptes d'installation agrégés. Voir [Télémétrie](/fr/clawhub/telemetry) pour savoir ce qui est signalé
