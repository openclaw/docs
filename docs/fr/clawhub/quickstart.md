...
x-i18n:
    generated_at: "2026-06-30T13:58:54Z"
    model: gpt-5.5
...
Un Skill est un dossier contenant un fichier `SKILL.md` requis et des fichiers de support
facultatifs.
...
les métadonnées, les liens sources, les versions, les journaux des changements et l’état d’analyse :
...
Les listings publics affichent le dernier état d’analyse. Les versions retenues ou bloquées par la
modération peuvent être masquées dans les surfaces de recherche et d’installation jusqu’à résolution.
