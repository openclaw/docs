...
Utilisez d’abord `--dry-run` pour prévisualiser les métadonnées du package résolu, les champs de
...
les métadonnées, liens de source, versions, journaux de changements et état d’analyse :
