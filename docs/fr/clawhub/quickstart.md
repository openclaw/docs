...
read_when:
    ...
    - Installer une compétence ou un Plugin depuis le registre
...
x-i18n:
    generated_at: "2026-07-02T08:14:56Z"
    model: gpt-5.5
...
lorsque vous vous connectez, publiez, gérez vos propres listes ou utilisez des
...
Utilisez d’abord `--dry-run` pour prévisualiser les métadonnées résolues du package, les champs de compatibilité,
...
les métadonnées, les liens source, les versions, les changelogs et l’état de l’analyse :
