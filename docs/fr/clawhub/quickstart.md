...
x-i18n:
    generated_at: "2026-06-27T17:16:26Z"
    model: gpt-5.5
...
Utilisez d’abord `--dry-run` pour prévisualiser les métadonnées résolues du paquet, les champs
...
Les fiches publiques affichent le dernier état d’analyse. Les versions retenues ou bloquées par la
