...
summary: 'Commencez à utiliser ClawHub : rechercher, installer, mettre à jour et publier des Skills ou des plugins.'
x-i18n:
    generated_at: "2026-07-03T02:47:04Z"
    model: gpt-5.5
...
Un Skill est un dossier contenant un fichier `SKILL.md` obligatoire et, éventuellement,
...
compatibilité, l’attribution de source et le plan de téléversement sans publier.
...
les métadonnées, les liens vers la source, les versions, les journaux des modifications et l’état de l’analyse :
