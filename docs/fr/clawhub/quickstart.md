...
x-i18n:
    generated_at: "2026-07-05T05:51:54Z"
    model: gpt-5.5
...
Un Skill est un dossier contenant un fichier `SKILL.md` obligatoire et des fichiers de prise en charge
facultatifs.
...
d’environnement, outils et permissions requis afin que les utilisateurs comprennent ce dont le
...
de compatibilité, l’attribution de source et le plan de téléversement sans publier.
