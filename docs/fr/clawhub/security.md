...
title: Sécurité
x-i18n:
    generated_at: "2026-07-04T10:39:20Z"
    model: gpt-5.5
...
N’utilisez pas les avis ClawHub pour les vulnérabilités dans le code source propre à une skill tierce ou
au plugin. Signalez-les directement à l’éditeur ou au dépôt source
...
ou de secrets d’utilisateurs, du contenu malveillant atteignant les utilisateurs à cause d’une défaillance de la plateforme,
