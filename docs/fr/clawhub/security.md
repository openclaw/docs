...
title: Sécurité
x-i18n:
    generated_at: "2026-07-03T09:33:56Z"
    model: gpt-5.5
...
données ou de secrets utilisateur, du contenu malveillant atteignant les utilisateurs en raison d’une défaillance de la plateforme,
ou tout problème obligeant les utilisateurs à effectuer une rotation des identifiants, à mettre à jour un logiciel local ou
à prendre d’autres mesures de protection.

Les vulnérabilités dans les logiciels installés par les utilisateurs sont divulguées publiquement, comme
les packages CLI, binaires, bibliothèques ou autres artefacts de version ClawHub que les utilisateurs
doivent mettre à jour localement.

## Pages associées

Pour les libellés d’audit à l’installation, les niveaux de risque, les constats et l’interprétation, consultez
