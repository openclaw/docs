...
données utilisateur ou de secrets, du contenu malveillant atteignant les utilisateurs à cause d’une défaillance de plateforme,
...
Pour les étiquettes d’audit à l’installation, les niveaux de risque, les conclusions et leur interprétation, consultez
