...
read_when:
    ...
    - Distinguer les problèmes de la plateforme ClawHub des problèmes liés aux Skills ou plugins tiers
sidebarTitle: Security
summary: Comment signaler les problèmes de sécurité de ClawHub et quand les vulnérabilités sont rendues publiques.
title: Sécurité
x-i18n:
    generated_at: "2026-06-30T13:57:12Z"
    model: gpt-5.5
...
N’utilisez pas les avis ClawHub pour les vulnérabilités dans le code source propre à un skill ou
...
Les vulnérabilités dans les logiciels installés par l’utilisateur sont divulguées publiquement, comme les
packages CLI ClawHub, les binaires, les bibliothèques ou d’autres artefacts de version que les utilisateurs
doivent mettre à jour localement.

## Pages associées

Pour les libellés d’audit à l’installation, les niveaux de risque, les constats et leur interprétation, consultez
[Audits de sécurité](/clawhub/security-audits).

Pour les signalements de place de marché, les mises en attente de modération, les fiches masquées, les bannissements et l’état
