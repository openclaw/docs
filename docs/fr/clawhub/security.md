...
title: Sécurité
x-i18n:
    generated_at: "2026-07-02T00:52:41Z"
    model: gpt-5.5
...
N’utilisez pas les advisories ClawHub pour les vulnérabilités dans le code source propre d’une Skills ou d’un
...
prendre une autre mesure de protection.

Les vulnérabilités dans les logiciels installés par les utilisateurs sont divulguées publiquement, comme
les packages CLI ClawHub, les binaires, les bibliothèques ou d’autres artefacts de publication que les utilisateurs
...
Pour les signalements de marketplace, les mises en attente pour modération, les fiches masquées, les bannissements et l’état
