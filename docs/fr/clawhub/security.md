...
read_when:
    ...
    - Distinguer les problèmes de plateforme ClawHub des problèmes liés aux compétences ou aux plugins tiers
...
title: Sécurité
x-i18n:
    generated_at: "2026-07-05T05:58:30Z"
    model: gpt-5.5
...
N’utilisez pas les avis ClawHub pour les vulnérabilités dans le code source propre à une skill ou
...
Les vulnérabilités dans les logiciels installés par l’utilisateur sont divulguées publiquement, comme
les paquets CLI ClawHub, les binaires, les bibliothèques ou autres artefacts de publication que les utilisateurs
doivent mettre à jour localement.

## Pages connexes

Pour les étiquettes d’audit lors de l’installation, les niveaux de risque, les constats et leur interprétation, consultez
