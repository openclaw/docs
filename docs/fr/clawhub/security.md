...
title: Sécurité
x-i18n:
    generated_at: "2026-07-02T08:12:09Z"
    model: gpt-5.5
...
N’utilisez pas les avis ClawHub pour les vulnérabilités dans le code source propre d’un skill tiers ou
Plugin. Signalez-les directement à l’éditeur ou au dépôt source
...
utilisateur ou de secrets, du contenu malveillant atteignant les utilisateurs en raison d’une défaillance de la plateforme,
...
les packages CLI ClawHub, les binaires, les bibliothèques ou d’autres artefacts de version que les utilisateurs
...
Pour les signalements de la marketplace, les mises en attente de modération, les fiches masquées, les bannissements et la
réputation des comptes, consultez [Modération et sécurité des comptes](/clawhub/moderation).
