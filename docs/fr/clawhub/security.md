...
title: Sécurité
x-i18n:
    generated_at: "2026-07-02T17:36:49Z"
    model: gpt-5.5
...
Utilisez GitHub Security Advisories pour les vulnérabilités dans ClawHub lui-même. Un bon
rapport d’avis ClawHub inclut des bogues dans :
...
N’utilisez pas les avis ClawHub pour les vulnérabilités dans le code source propre d’un skill tiers ou d’un
...
packages CLI ClawHub, les binaires, les bibliothèques ou les autres artefacts de version que les utilisateurs
...
Pour les signalements de marketplace, les mises en attente de modération, les fiches masquées, les bannissements et l’état des comptes,
consultez [Modération et sécurité des comptes](/clawhub/moderation).
