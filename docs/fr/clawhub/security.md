...
title: Sécurité
x-i18n:
    generated_at: "2026-07-01T12:57:37Z"
    model: gpt-5.5
...
Les problèmes de sécurité de ClawHub peuvent être signalés via les alertes de sécurité GitHub pour
`openclaw/clawhub`.

Utilisez les alertes de sécurité GitHub pour les vulnérabilités dans ClawHub lui-même. Les bons
rapports d’alerte ClawHub incluent les bugs dans :
...
N’utilisez pas les alertes ClawHub pour les vulnérabilités dans le code source propre à une Skills ou
un Plugin tiers. Signalez-les directement à l’éditeur ou au dépôt source
...
les packages, binaires, bibliothèques ou autres artefacts de publication de la CLI ClawHub que les utilisateurs
