...
title: Sécurité
x-i18n:
    generated_at: "2026-07-01T08:01:34Z"
    model: gpt-5.5
...
N’utilisez pas les avis ClawHub pour les vulnérabilités dans le code source propre à un skill tiers ou
à un plugin. Signalez-les directement à l’éditeur ou au dépôt source
...
Parmi les exemples d’impact réel sur les utilisateurs figurent l’exploitation confirmée, l’exposition de
...
ou tout problème qui oblige les utilisateurs à renouveler leurs identifiants, mettre à jour un logiciel local ou
prendre d’autres mesures de protection.

Les vulnérabilités dans les logiciels installés par les utilisateurs sont rendues publiques, comme les
paquets CLI ClawHub, les binaires, les bibliothèques ou les autres artefacts de publication que les utilisateurs
doivent mettre à jour localement.

## Pages connexes

Pour les labels d’audit au moment de l’installation, les niveaux de risque, les constatations et leur interprétation, consultez
[Audits de sécurité](/clawhub/security-audits).

Pour les signalements de marketplace, les mises en attente de modération, les fiches masquées, les bannissements et l’état du compte, consultez [Modération et sécurité du compte](/clawhub/moderation).
