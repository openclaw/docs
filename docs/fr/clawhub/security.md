...
read_when:
    ...
    - Distinguer les problèmes de la plateforme ClawHub des problèmes de Skills ou de plugins tiers
...
title: Sécurité
x-i18n:
    generated_at: "2026-07-03T23:31:29Z"
    model: gpt-5.5
...
des preuves d’impact réel sur les utilisateurs ou lorsque les utilisateurs doivent agir.

Les exemples d’impact réel sur les utilisateurs comprennent l’exploitation confirmée, l’exposition de données utilisateur
ou de secrets, du contenu malveillant atteignant les utilisateurs en raison d’une défaillance de la plateforme,
ou tout problème qui oblige les utilisateurs à effectuer une rotation des identifiants, à mettre à jour un logiciel local ou à
prendre d’autres mesures de protection.

Les vulnérabilités dans les logiciels installés par les utilisateurs sont divulguées publiquement, comme les packages CLI ClawHub,
les binaires, les bibliothèques ou d’autres artefacts de version que les utilisateurs
