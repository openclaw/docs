...
title: Sécurité
x-i18n:
    generated_at: "2026-07-04T15:14:39Z"
    model: gpt-5.5
...
N’utilisez pas les avis ClawHub pour les vulnérabilités dans le code source propre à un skill ou à un
Plugin tiers. Signalez-les directement à l’éditeur ou au dépôt source lié depuis la fiche ClawHub.
...
Des exemples d’impact réel sur les utilisateurs incluent une exploitation confirmée, l’exposition de
...
Pour les libellés d’audit au moment de l’installation, les niveaux de risque, les constats et leur interprétation, consultez
[Audits de sécurité](/clawhub/security-audits).

Pour les signalements de la marketplace, les blocages de modération, les fiches masquées, les bannissements et le
statut du compte, consultez [Modération et sécurité des comptes](/clawhub/moderation).
