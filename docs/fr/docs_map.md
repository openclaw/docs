...
x-i18n:
    generated_at: "2026-07-04T03:45:05Z"
    model: gpt-5.5
...
- Titres :
  - H1: Suppression de BlueBubbles et chemin imsg iMessage
  - H2: Ce qui a changé
  - H2: Que faire
...
- Titres :
  ...
  - H3: Configuration avec assistant (recommandée)
...
- Titres :
  ...
  - H2: Consignes permanentes plus tâches cron
  - H2: Exemples
  ...
  - H2: Architecture multi-programmes
  - H2: Bonnes pratiques
  - H3: À faire
  - H3: À éviter
  - H2: Lié
...
- Titres :
  ...
  - H2: Intégration de statut (pression des tâches)
  - H2: Stockage et maintenance
  - H3: Où vivent les tâches
...
- Titres :
  ...
  - H3: Autoriser uniquement des groupes précis
...
- Titres :
  ...
  - H2: Coalescence des DM envoyés en plusieurs parties (commande + URL dans une seule composition)
  - H3: Scénarios et ce que voit l’agent
  - H2: Récupération entrante après un redémarrage du bridge ou du gateway
...
- Titres :
  ...
  - H2 : Politique des DM et des salons
...
- Titres :
  ...
  - H2 : Nouvelle tentative du canal DM
...
- Titres :
  ...
  - H3 : Points d’attention du manifeste (champs obligatoires)
...
- Titres :
  ...
  - H2 : 2) Appairage d’appareil Node (nœuds iOS/Android/macOS/sans interface)
...
- Titres :
  - H2 : Choisir le Socket Mode ou les URL de requêtes HTTP
  - H3 : Mode relais
  - H2 : Installer
  - H2 : Configuration rapide
  - H2 : Réglage du transport Socket Mode
  - H2 : Checklist du manifeste et des portées
  ...
  - H2 : Repli de réaction de saisie
  ...
  - H3 : Pipeline entrant
  - H3 : Héritage des pièces jointes de la racine de fil
...
- Titres :
  ...
  - H3 : Numéro privé limité à la liste d’autorisation
...
- Titres :
  ...
  - H3 : Restreindre les DM à des utilisateurs précis
...
- Itinéraire : /channels/zaloclawbot
- Titres :
  - H2 : Compatibilité
  - H2 : Prérequis
...
- Itinéraire : /channels/zalouser
- Titres :
  - H2 : plugin intégré
  - H2 : Configuration rapide (débutant)
  - H2 : Ce que c’est
  - H2 : Nommage
  - H2 : Trouver les ID (annuaire)
  - H2 : Limites
  - H2 : Contrôle d’accès (DM)
  - H2 : Accès de groupe (facultatif)
...
- Titres :
  ...
  - H3 : Profils de suite
  - H3 : Fenêtres de compatibilité legacy
  - H3 : Exemples
  - H2 : Smoke test d’installation
  - H2 : E2E Docker local
  - H3 : Paramètres ajustables
  - H3 : Workflow live/E2E réutilisable
  - H3 : Segments du chemin de release
  - H2 : Prérelease des plugins
  - H2 : Labo QA
  - H2 : CodeQL
...
- Itinéraire : /cli/attach
- Titres : aucun

## cli/backup.md

- Itinéraire : /cli/backup
- Titres :
  - H1 : openclaw backup
  - H2 : Notes
...
- Titres :
  ...
  - H2 : Options courantes
  - H2 : Notes
  - H2 : Liste de contrôle de récupération en cas de dérive du jeton
  - H2 : Associé

## cli/directory.md

- Itinéraire : /cli/directory
- Titres :
...
- Titres :
  ...
  - H2 : Découvrir des gateways (Bonjour)
  - H3 : gateway discover
  - H2 : Associé

## cli/health.md

- Itinéraire : /cli/health
- Titres :
  - H1 : openclaw health
  - H2 : Options
  - H2 : Associé
...
- Titres :
  - H1 : openclaw logs
  - H2 : Options
  - H2 : Options RPC du Gateway partagé
  - H2 : Exemples
  - H2 : Notes
  - H2 : Associé
...
- Titres :
  ...
  - H3 : État de l’archive et de la révision manuelle
  - H2 : Fournisseur Codex
  - H3 : Ce que Codex importe
  - H3 : État Codex de révision manuelle
...
- Titres :
  ...
  - H2 : Proxy de navigateur (configuration zéro)
...
- Titres :
  ...
  - H2 : Commandes courantes de suivi
...
- Titres :
  ...
  - H2 : Heartbeat système last|enable|disable
  - H2 : Présence système
  - H2 : Notes
  - H2 : Associé
...
- Titres :
  ...
  - H2 : Sous-commandes
  - H2 : Configuration des webhooks gmail
  - H3 : Obligatoire
  - H3 : Options Pub/Sub
  ...
  - H3 : Sortie
  - H2 : Exécuter les webhooks gmail
...
- Titres :
  ...
  - H3 : Ingestion du wiki &lt;path-or-url&gt;
  - H3 : Import OKF du wiki &lt;path&gt;
  - H3 : Compilation du wiki
  - H3 : Lint du wiki
  - H3 : Recherche dans le wiki &lt;query&gt;
  - H3 : Obtenir du wiki &lt;lookup&gt;
  - H3 : Appliquer au wiki
  - H3 : Import de pont du wiki
  - H3 : Import local non sécurisé du wiki
  - H3 : wiki obsidian ...
...
- Titres :
  ...
  - H2 : Persistance des transcripts
  - H2 : Configuration
  - H2 : Configuration recommandée
...
- Titres :
  ...
  - H3 : Gateway (daemon)
  - H3 : Clients (app Mac / CLI / administration web)
...
- Titres :
  ...
  - H3 : Garde sur les octets de transcription active
  - H3 : Transcriptions suivantes
...
- Titres :
  - H2 : Flux de messages (niveau général)
...
- Titres :
  ...
  - H2 : Cache d’ignorance des échecs d’authentification
  ...
  - H3 : Ignorer le délai de récupération ou comportement de sonde
...
- Titres :
  ...
  - H2 : Recherche dans la mémoire QMD inter-agents
...
- Titres :
  ...
  - H2 : Migration de l’CLI Claude d’Anthropic
  - H2 : Échange OAuth (fonctionnement de la connexion)
  - H3 : setup-token d’Anthropic
...
- Titres :
  ...
  - H2 : Producteurs (d’où provient la présence)
  - H3 : 1) Entrée automatique du Gateway
  ...
  - H2 : Règles de fusion + déduplication (pourquoi instanceId importe)
  - H2 : TTL et taille limitée
  - H2 : Mise en garde distant/tunnel (IP de local loopback)
  - H2 : Consommateurs
...
- Titres :
  ...
  - H2 : Assistants de statut et d’orchestration
...
- Titres :
  ...
  - H2 : « Diffuser les segments ou tout »
  - H2 : Modes de streaming d’aperçu
  - H3 : Mappage de canal
  - H3 : Comportement à l’exécution
  - H3 : Mises à jour d’aperçu de progression d’outil
...
- Route : /date-time
- Titres :
  - H2 : Enveloppes de messages (local par défaut)
  - H3 : Exemples
  - H2 : Prompt système : date et heure actuelles
  - H2 : Lignes d’événements système (local par défaut)
  - H3 : Configurer le fuseau horaire utilisateur + format
...
- Titres :
  ...
  - H2 : Anthropic : CLI Claude et compatibilité des jetons
  - H2 : Note Anthropic
  - H2 : Vérifier l’état d’authentification du modèle
  - H2 : Comportement de rotation des clés API (gateway)
  - H2 : Suppression de l’authentification fournisseur pendant l’exécution du gateway
  - H2 : Contrôler l’identifiant utilisé
  - H3 : OpenAI et identifiants hérités openai-codex
...
- Titres :
  - H2 : Démarrage rapide accessible aux débutants
  - H2 : L’utiliser comme solution de secours
  - H2 : Vue d’ensemble de la configuration
  - H3 : Exemple de configuration
  - H2 : Fonctionnement
  - H2 : Sessions
  - H2 : Prélude de solution de secours depuis les sessions claude-cli
...
- Titres :
  ...
  - H3 : Remplacements de modèles par canal
  ...
  - H4 : Mode de discussion avec soi-même
...
- Titres :
  ...
  - H3 : Approbation automatique d’un réseau de nœuds de confiance
...
- Titres :
  ...
  - H2 : Code d’application et code de Plugin
  - H2 : Connexe
...
- Titres :
  ...
  - H3 : Précédence du port et de l’adresse d’écoute
...
- Titres :
  ...
  - H3 : Configuration hybride : primaire hébergé, repli local
...
- Titres :
  ...
  - H2 : Notes sur navigateur/CDP (piège courant)
...
- Titres :
  ...
  - H2 : Contrat de modèle agent d’abord
...
- Titres :
  ...
  - H2 : La portée de méthode n’est que le premier filtre
...
- Titres :
  ...
  - H2 : Flux de travail CLI (compatible headless)
...
- Titres :
  ...
  - H2 : Délimitation des événements diffusés
...
- Titres :
  ...
  - H2 : Elevated : `exec` uniquement « exécuter sur l’hôte »
  - H2 : Correctifs courants de « prison sandbox »
  - H3 : « Outil X bloqué par la politique d’outils du sandbox »
  - H3 : « Je pensais que c’était le principal, pourquoi est-ce sandboxé ? »
  - H2 : Connexe
...
- Titres :
  ...
  - H2 : Exposition des DM et groupes
  - H2 : Vérifications du proxy inverse
  - H2 : Examen des outils et du sandbox
...
- Titres :
  ...
  - H2 : Assainissement des jetons spéciaux de contenu externe
  - H2 : Indicateurs de contournement non sécurisés pour contenu externe
...
- Titres :
  - H2 : Par défaut : aucun helper Python
  - H2 : Ce qui reste protégé sans Python
  - H2 : Ce que Python ajoute
  - H2 : Conseils pour les Plugins et le cœur
...
- Titres :
  ...
  - H2 : Prérequis Tailscale + limites
  - H2 : En savoir plus
  - H2 : Connexe
...
- Titres :
  ...
  - H2 : Le gateway macOS cesse silencieusement de répondre, puis reprend lorsque vous touchez le tableau de bord
  - H2 : Le Gateway se ferme lors d’une forte utilisation de mémoire
  ...
  - H2 : Si vous avez mis à niveau et que quelque chose s’est soudainement cassé
  - H2 : Connexe
...
- Titres :
  ...
  - H2 : Démarrage de la CLI et profilage des commandes
  - H2 : Mode watch du Gateway
  - H2 : Profil dev + gateway dev (`--dev`)
  - H2 : Journalisation du flux brut (OpenClaw)
  - H2 : Journalisation des chunks bruts compatibles OpenAI
  - H2 : Notes de sécurité
...
- Titres :
  ...
  - H2 : Identifiants des fournisseurs et `.env` d’espace de travail
  ...
  - H2 : Variables d’env de l’interface
  - H2 : Substitution de variables d’env dans la configuration
  - H2 : Réfs secrètes vs chaînes `${ENV}`
...
- Titres :
  ...
  - H3 : Jeu de smoke moderne (appel d’outils + image)
...
- Titres :
  ...
  - H2 : Contrôle de cohérence des docs
...
- Titres :
  ...
  - H2 : 5) Se connecter à la VM via SSH
  - H2 : 6) Installer OpenClaw
  - H2 : 7) Configurer les canaux
  - H2 : 8) Exécuter la VM sans affichage
...
- Titres :
  ...
  - H3 : Échecs des contrôles d’intégrité
  - H2 : Étapes suivantes
...
- Titres :
  ...
  - H3 : Journaux propres aux canaux
  ...
  - H3 : Taille et temps d’appel du modèle
...
- Titres :
  ...
  - H2 : Notes et limites
  - H3 : Prise en charge des environnements proxy
...
- Titres :
  ...
  - H3 : Prise en charge des environnements proxy (modèles fournisseur)
...
- Titres :
  ...
  - H3 : 6. Brancher l’après-tour après la mise en miroir de la transcription
...
- Titres :
  ...
  - H3 : 7) Canevas + caméra
  - H4 : Hôte de canevas Gateway (recommandé pour le contenu web)
...
- Titres :
  ...
  - H2 : Déclencher des exécutions d’agent depuis le canevas
  - H2 : Notes de sécurité
  - H2 : Connexe
...
- Itinéraire : /platforms/mac/dev-setup
- Titres :
  ...
  - H3: L’application plante lors de l’octroi d’une permission
  - H3: Gateway « Démarrage... » indéfiniment
  - H2: Associé

## platforms/mac/health.md

- Itinéraire : /platforms/mac/health
- Titres :
...
- Itinéraire : /platforms/mac/logging
- Titres :
  - H1: Journalisation (macOS)
  - H2: Journal de diagnostics tournant (panneau Débogage)
...
- Itinéraire : /platforms/mac/menu-bar
- Titres :
...
- Itinéraire : /platforms/mac/peekaboo
- Titres :
...
- Itinéraire : /platforms/mac/permissions
- Titres :
...
- Itinéraire : /platforms/mac/remote
- Titres :
  - H2: Modes
...
- Itinéraire : /platforms/mac/signing
- Titres :
...
- Itinéraire : /platforms/mac/skills
- Titres :
...
- Itinéraire : /platforms/mac/voice-overlay
- Titres :
...
- Itinéraire : /platforms/mac/voicewake
- Titres :
...
- Itinéraire : /platforms/mac/webchat
- Titres :
...
- Itinéraire : /platforms/macos
- Titres :
  - H2: Téléchargement
  - H2: Première exécution
  - H2: Choisir un mode Gateway
  - H2: Ce que l’application possède
  - H2: Pages de détails macOS
  - H2: Associé

## platforms/oracle.md

- Itinéraire : /platforms/oracle
- Titres :
  - H2: Associé

## platforms/raspberry-pi.md

- Itinéraire : /platforms/raspberry-pi
- Titres :
  - H2: Associé

## platforms/windows.md

- Itinéraire : /platforms/windows
- Titres :
  ...
  - H2: Dépannage
  - H3: L’icône de zone de notification n’apparaît pas
...
- Itinéraire : /plugins/adding-capabilities
- Titres :
  - H2: Quand créer une capacité
  - H2: La séquence standard
  - H2: Ce qui va où
  - H2: Points de jonction fournisseur et harnais
...
- Itinéraire : /plugins/admin-http-rpc
- Titres :
...
- Itinéraire : /plugins/agent-tools
- Titres :
  - H2: Associé

## plugins/architecture-internals.md

- Itinéraire : /plugins/architecture-internals
- Titres :
...
- Itinéraire : /plugins/architecture
- Titres :
...
- Itinéraire : /plugins/building-extensions
- Titres :
  - H2: Associé

## plugins/building-plugins.md

- Itinéraire : /plugins/building-plugins
- Titres :
  - H2: Exigences
...
- Itinéraire : /plugins/cli-backend-plugins
- Titres :
  - H2: Ce que le Plugin possède
  - H2: Plugin backend minimal
  - H2: Forme de configuration
  - H2: Hooks backend avancés
  - H3: ownsNativeCompaction: se soustraire à la Compaction d’OpenClaw
...
- Itinéraire : /plugins/codex-computer-use
- Titres :
...
- Itinéraire : /plugins/codex-harness-reference
- Titres :
...
- Itinéraire : /plugins/codex-harness
- Titres :
  - H2: Exigences
  - H2: Démarrage rapide
  - H2: Configuration
...
- Itinéraire : /plugins/compatibility
- Titres :
  ...
  - H3: Alias plats des callbacks entrants WhatsApp
  - H3: Champs d’admission entrants WhatsApp
  - H2: Notes de publication

## plugins/copilot.md

- Itinéraire : /plugins/copilot
- Titres :
  - H2: Exigences
...
- Itinéraire : /plugins/dependency-resolution
- Titres :
...
- Titres :
  ...
  - H2 : Hooks d’invite et de modèle
...
- Titres :
  ...
  - H2 : Outils d’agent
  - H2 : Comportement d’invite et de contexte
  - H2 : Configuration
...
- Titres :
  ...
  - H2 : Dépendances
  - H2 : Ce qu’il fournit
  - H2 : Relation avec d’autres plugins
  - H2 : Sécurité
  - H2 : Associé
...
- Titres :
  ...
  - H2 : Router les invites d’approbation
...
- Titres :
  - H2 : Entrée de Plugin
  - H3 : Helpers de compatibilité et de test dépréciés
...
- Titres :
  ...
  - H3 : Tester un Plugin de canal en unitaire
  - H3 : Tester un Plugin de fournisseur en unitaire
...
- Titres :
  ...
  - H2 : Mappage de l’exécution OpenClaw
...
- Titres :
  - H2 : Premiers pas
  - H2 : Configuration via l’environnement uniquement
  - H2 : Articles connexes
...
- Titres :
  ...
  - H2 : Catalogue des forfaits à jetons
  - H2 : Synthèse vocale
  - H2 : Exemple de configuration
  - H2 : Associé
...
- Titres :
  ...
  - H3 : Phase 3 : purge au démarrage priorisant les baux
...
- Titres :
  - H1 : Refactorisation de l’état axée d’abord sur la base de données
  - H2 : Décision
  - H2 : Contrat strict
...
- Titres :
  ...
  - H2 : Pré-vérification des solutions existantes
  - H2 : Début de session (requis)
  - H2 : Âme (requis)
  ...
  - H2 : Skills principaux (à activer dans Paramètres → Skills)
...
- Titres :
  ...
  - H2 : Pré-vérification de publication
...
- Titres :
  ...
  - H2 : Phase 2 : nettoyage du produit et de l’UX
  ...
  - H2 : Mise à jour du skill frontend
...
- Route : /reference/rpc
- Titres :
  - H2 : Modèle A : daemon HTTP (signal-cli)
...
- Titres :
  - H1 : Conventions pour les placeholders de secrets
  - H2 : Style recommandé
  - H2 : Éviter ces modèles dans les docs
  - H2 : Exemple
...
- Titres :
  ...
  - H2 : Frontières des morceaux de Compaction et appairage des outils
...
- Titres :
  ...
  - H2 : Impact du TTL de cache et de l’élagage
  - H3 : Exemple : garder un cache de 1 h chaud avec un heartbeat
...
- Titres :
  ...
  - H3 : Récupération après redémarrage et état de préparation
...
- Titres :
  ...
  - H3 : 5.2 Chaînes d’attaque critiques
...
- Titres :
  ...
  - H3 : Exposition du Gateway et mauvaise configuration de gateway ouvert
  - H3 : Pipeline exec Node (capacité à plus haut risque)
  - H3 : Store d’appairage (filtrage des DM)
  ...
  - H3 : Concurrence / idempotence du store d’appairage
  - H3 : Corrélation de traces d’entrée / idempotence
...
- Titres :
  ...
  - H3 : Le dump de répertoire (3 déc. 2025)
...
- Titres :
  ...
  - H2 : Workflow bleeding edge (Gateway dans un terminal)
...
- Titres :
  ...
  - H3 : Configuration de l’agent de sonde d’état
...
- Titres :
  ...
  - H3 : Paramètres par défaut d’exécution par agent
  - H3 : Exemple
  - H3 : Comportement
...
- Titres :
  - H2 : Connexion manuelle (recommandé)
...
- Titres :
  ...
  - H2 : Liste de vérification de triage rapide
...
- Titres :
  ...
  - H2 : API de contrôle (facultative)
  - H2 : Dépannage
  - H3 : Échec du démarrage CDP ou blocage SSRF de navigation
...
- Titres :
  ...
  - H2 : Paramètres par défaut du Plugin
  - H3 : Configuration persistante de l’URL du visualiseur
...
- Titres :
  - H2 : Binaries sûrs (stdin uniquement)
  ...
  - H3 : Binaries sûrs versus liste d’autorisation
...
- Titres :
  ...
  - H2 : Binaries sûrs et transfert des approbations
...
- Titres :
  ...
  - H2 : Liste d’autorisation + binaries sûrs
  - H2 : Exemples
  - H2 : applypatch
  - H2 : Associé
...
- Titres :
  ...
  - H3 : Limitation importante : Lobster intégré versus openclaw.invoke
...
- Itinéraire : /tools/media-overview
- Titres :
  - H2 : Capacités
...
- Itinéraire : /tools/minimax-search
- Titres :
...
- Itinéraire : /tools/multi-agent-sandbox-tools
- Titres :
  - H2 : Exemples de configuration
  ...
  - H2 : Piège courant : « non principal »
  - H2 : Tests
  - H2 : Dépannage
  - H2 : Connexe
...
- Itinéraire : /tools/music-generation
- Titres :
  - H2 : Démarrage rapide
  - H2 : Fournisseurs pris en charge
...
- Itinéraire : /tools/ollama-search
- Titres :
...
- Itinéraire : /tools/parallel-search
- Titres :
  - H2 : Installer le Plugin
...
- Itinéraire : /tools/permission-modes
- Titres :
...
- Itinéraire : /tools/perplexity-search
- Titres :
  - H2 : Installer le Plugin
...
- Itinéraire : /tools/searxng-search
- Titres :
  - H2 : Configuration initiale
  - H2 : Configuration
...
- Itinéraire : /tools/skill-workshop
- Titres :
  - H2 : Fonctionnement
  - H2 : Cycle de vie
  - H2 : Chat
...
- Itinéraire : /tools/skills-config
- Titres :
...
- Titres :
  ...
  - H2 : Contrôle d’accès
  - H3 : Spécifications de l’installateur
...
- Itinéraire : /tools/slash-commands
- Titres :
...
- Titres :
  ...
  - H3 : Comment les fournisseurs utilisent les invites de personnalité
...
- Itinéraire : /tools/video-generation
- Titres :
  - H2 : Démarrage rapide
...
- Titres :
  ...
  - H2 : Utilisation de nœuds avec un VPS
  - H2 : Ajustement du démarrage pour les petites VM et les hôtes ARM
  - H3 : Liste de vérification d’ajustement systemd (facultatif)
  - H2 : Connexe

## web/control-ui.md

- Itinéraire : /web/control-ui
- Titres :
...
- Itinéraire : /web/webchat
- Titres :
  - H2 : Ce que c’est
  - H2 : Démarrage rapide
  - H2 : Fonctionnement (comportement)
  - H3 : Transcription et modèle de livraison
  - H2 : Panneau des outils d’agents Control UI
