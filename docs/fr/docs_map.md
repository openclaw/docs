...
x-i18n:
    generated_at: "2026-07-02T22:29:27Z"
    model: gpt-5.5
...
- Titres :
  ...
  - H2: Garde de politique SecretRef OAuth
...
- Titres :
  ...
  - H3: Jour du mois et jour de la semaine utilisent une logique OU
...
- Titres :
  - H2: Pourquoi les consignes permanentes
  - H2: Fonctionnement
  - H2: Anatomie d’une consigne permanente
  - H2: Consignes permanentes et tâches cron
  - H2: Exemples
...
- Titres :
  ...
  - H2: Définir la portée des motifs de mention configurés
...
- Titres :
  ...
  - H2: Récupération entrante après le redémarrage d’un bridge ou d’un gateway
...
- Titres :
  ...
  - H2 : Politique des MP et des salons
...
- Titres :
  ...
  - H2 : Modes de chat
  - H2 : Fils et sessions
  - H2 : Contrôle d’accès (MP)
  - H2 : Canaux (groupes)
  - H2 : Cibles pour la livraison sortante
  - H2 : Nouvelle tentative de canal MP
...
- Titres :
  ...
  - H2 : Objectifs
  - H2 : Écritures de configuration
  - H2 : Contrôle d’accès (MP + groupes)
  - H3 : Fonctionnement
  ...
  - H2 : Capacités : RSC seul vs Graph
  - H3 : Avec Teams RSC seul (application installée, aucune autorisation Graph API)
  ...
  - H2 : Envoyer des fichiers dans les chats de groupe
...
- Titres :
  - H2 : 1) Appairage MP (accès au chat entrant)
  ...
  - H3 : Approbation automatique facultative de nœud trusted-CIDR
...
- Titres :
  ...
  - H3 : Taille, téléchargement et limites de modèle
  - H3 : Limites connues
  - H3 : Documentation liée
  - H2 : Articles liés
...
- Titres :
  ...
  - H2 : Configuration rapide
  - H2 : Variables d’environnement
  - H2 : Politique de MP et contrôle d’accès
...
- Titres :
  ...
  - H2: Comportement avec numéro personnel et conversation avec soi-même
  - H2: Normalisation des messages et contexte
  - H2: Livraison, découpage et médias
  - H2: Citation de réponses
...
- Chemin : /channels/zaloclawbot
- Titres :
  - H2: Compatibilité
  - H2: Prérequis
  - H2: Installer avec l’onboarding (recommandé)
...
- Chemin : /channels/zalouser
- Titres :
  - H2: Plugin groupé
  - H2: Configuration rapide (débutant)
  - H2: Ce que c’est
  - H2: Nommage
  - H2: Recherche d’identifiants (répertoire)
  - H2: Limites
  - H2: Contrôle d’accès (messages directs)
  - H2: Accès aux groupes (facultatif)
  - H3: Verrouillage des groupes par mention
...
- Titres :
  ...
  - H2: Portes de contrôle locales et routage des changements
...
- Titres :
  ...
  - H2: modes config set
  - H2: config patch
  - H2: Flags de constructeur de fournisseur
...
- Titres :
  ...
  - H2: Mode de sauvetage des messages
  - H2: Liens associés
...
- Titres :
  ...
  - H2: Approbation initiale Paperclip / openclawgateway
  - H3: openclaw devices reject
  - H3: openclaw devices rotate --device --role [--scope ]
  - H3: openclaw devices revoke --device --role
  - H2: Options courantes
  - H2: Notes
  - H2: Liste de contrôle de récupération en cas de dérive de jeton
  - H2: Liens associés

## cli/directory.md

- Chemin : /cli/directory
- Titres :
  - H1: openclaw directory
  - H2: Flags courants
  - H2: Notes
  - H2: Utiliser les résultats avec l’envoi de messages
  - H2: Formats d’identifiant (par canal)
  - H2: Soi-même ("me")
...
- Titres :
  ...
  - H2: Accepter l’état de stratégie
  - H2: Résultats
  - H2: Réparation
  - H2: Codes de sortie
  - H2: Associés
...
- Titres :
  ...
  - H3: Après la modification de la source, de la stratégie ou du mode OpenShell
...
- Titres :
  ...
  - H2: Ne pas committer de secrets
...
- Titres :
  ...
  - H3 : Garde sur les octets de la transcription active
...
- Titres :
  ...
  - H2 : Couverture du rapport d’essai parallèle QA
  - H2 : Planification
  - H2 : Démarrage rapide
  - H2 : Commande slash
...
- Titres :
  - H2 : Drapeaux actuellement documentés
...
- Titres :
  ...
  - H2 : Cycle de vie de l’exécution
  - H2 : MVP Discord
...
- Titres :
  ...
  - H3 : Règles de chaîne candidate
  - H3 : Quelles erreurs font avancer le fallback
  - H3 : Évitement par délai de récupération ou comportement de sonde
  - H2 : Remplacements de session et changement de modèle en direct
  - H2 : Observabilité et résumés des échecs
...
- Titres :
  ...
  - H2 : Compatibilité des jetons hérités Anthropic
...
- Titres :
  ...
  - H3 : Phase 1 : contrats de lanes + travaux lourds en arrière-plan
...
- Titres :
  ...
  - H2 : Mise en garde remote/tunnel (IP de bouclage)
  - H2 : Consommateurs
...
- Titres :
  ...
  - H2 : Seeds appuyés par le repo
  - H2 : Lanes de mock fournisseur
...
- Titres :
  ...
  - H2 : « Streamer les morceaux ou tout »
  ...
  - H3 : Lane de progression commentary
  - H2 : Lié
...
- Titres :
  ...
  - H2 : Injection du bootstrap de l’espace de travail
  - H2 : Gestion du temps
  - H2 : Skills
  - H2 : Documentation
  - H2 : Lié
...
- Titres :
  ...
  - H2 : Comportement du codegen Swift
  - H2 : Versionnage + compatibilité
  - H2 : Motifs et conventions de schéma
  - H2 : JSON de schéma live
  - H2 : Quand vous modifiez des schémas
  - H2 : Lié
...
- Titres :
  ...
  - H2 : Charges utiles d’outils + connecteurs (temps fournisseur brut + champs normalisés)
  - H2 : Docs liées
...
- Titres :
  ...
  - H2 : Repro minimale dans le repo
...
- Titres :
  ...
  - H2 : Supprimer l’authentification fournisseur pendant que le gateway s’exécute
...
- Titres :
  - H2 : Démarrage rapide pour débutants
...
- Titres :
  ...
  - H3 : Champs de correspondance de binding
...
- Titres :
  ...
  - H3 : Verrouillage des mentions en chat de groupe
  - H4 : Limites d’historique DM
...
- Titres :
  ...
  - H3 : Clé API Anthropic + solution de repli MiniMax
...
- Titres :
  ...
  - H3 : Configuration hybride : primaire hébergé, solution de repli locale
...
- Titres :
  ...
  - H2 : Liste de vérification d’isolation
...
- Titres :
  ...
  - H2 : Comportement de session
  - H2 : Forme de la requête (prise en charge)
  - H2 : Éléments (entrée)
  - H3 : message
...
- Titres :
  ...
  - H2 : Approbations d’appairage des appareils
  - H2 : Approbations d’appairage des nœuds
...
- Titres :
  ...
  - H2 : Flux de travail CLI (compatible sans interface)
  - H2 : Surface API (protocole Gateway)
  - H2 : Contrôle des commandes de nœud (2026.3.31+)
...
- Titres :
  ...
  - H2 : Présence
  - H3 : Événement de nœud actif en arrière-plan
  ...
  - H3 : RPC du registre de tâches
  - H3 : Méthodes d’assistance opérateur
  - H3 : Vues models.list
  - H2 : Approbations Exec
  - H2 : Solution de repli pour la livraison à l’agent
  - H2 : Versionnement
...
- Titres :
  ...
  - H3 : L’ordinateur de bureau personnel exécute le Gateway
...
- Titres :
  ...
  - H2 : Correctifs courants de « prison sandbox »
...
- Titres :
  ...
  - H2 : Exemple d’activation minimal
  - H2 : Connexe
...
- Titres :
  ...
  - H2 : Prévol de la référence d’intégration
  - H2 : Contrat SecretRef
  - H2 : Configuration du fournisseur
  - H2 : Clés API basées sur fichier
  ...
  - H2 : Comportement et priorité requis
  - H2 : Déclencheurs d’activation
  - H2 : Signaux dégradés et récupérés
...
- Titres :
  - H2 : Portée d’abord : modèle de sécurité de l’assistant personnel
  ...
  - H2 : Plugins
  - H2 : Modèle d’accès MP : appairage, liste d’autorisation, ouvert, désactivé
  - H2 : Isolation des sessions MP (mode multi-utilisateur)
  - H3 : Mode MP sécurisé (recommandé)
  - H2 : Listes d’autorisation pour MP et groupes
  - H2 : Injection de prompt (ce que c’est, pourquoi c’est important)
  - H2 : Nettoyage des jetons spéciaux du contenu externe
  - H2 : Indicateurs de contournement de contenu externe non sûr
...
- Titres :
  ...
  - H2 : Recommandations pour Plugin et cœur
...
- Titres :
  ...
  - H2 : Réponses bloquées par 403 en amont
  ...
  - H2 : Gateway se ferme pendant une forte utilisation mémoire
  ...
  - H2 : Node appairé, échec de l’outil
...
- Titres :
  - H2 : Priorité (du plus élevé au plus bas)
  - H2 : Identifiants fournisseur et .env de l’espace de travail
  ...
  - H2 : Références de secret contre chaînes ${ENV}
...
- Titres :
  ...
  - H2 : Commandes de chat, interruption de tâches et « ça ne s’arrêtera pas »
  - H2 : Divers
  - H2 : Connexe
...
- Titres :
  ...
  - H2 : Exécuteurs spécifiques à QA
  - H3 : Identifiants Telegram partagés via Convex (v1)
  - H3 : Ajouter un canal à QA
...
- Titres :
  - H2 : Intégrer les binaires requis à l’image
...
- Titres :
  ...
  - H3 : Les vérifications de santé échouent / connexion refusée
...
- Titres :
  ...
  - H3 : Programme d’installation à préfixe local (install-cli.sh)
  - H3 : npm, pnpm ou bun
  - H3 : Depuis la source
...
- Titres :
  ...
  - H2 : 8) Exécuter la VM sans interface
...
- Titres :
  ...
  - H3 : Erreurs d’autorisation avec npm install -g (Linux)
  - H2 : Connexe
...
- Titres :
  - H2 : Chemin simple (CLI toujours installé)
...
- Titres :
  - H1 : Fiche d’évaluation de maturité
...
- Titres :
  ...
  - H2 : Exemples de configuration
  - H3 : Fournisseur + fallback CLI (OpenAI + Whisper CLI)
  - H3 : Fournisseur uniquement avec filtrage par scope
...
- Titres :
  ...
  - H3 : A2UI (Canvas)
  - H2 : Photos + vidéos (caméra de Node)
  ...
  - H2 : Liaison de Node exec
  - H2 : Carte des autorisations
  - H2 : Hôte de Node sans interface (multiplateforme)
  - H2 : Mode Node Mac
...
- Titres :
  ...
  - H3 : La stabilité du cache de prompt compte
  - H3 : Les sémantiques de sélection du runtime ne changent pas
  ...
  - H3 : 7. Normaliser l’utilisation et le contexte runtime du cache de prompt
...
- Titres :
  ...
  - H2 : Balises de présence active en arrière-plan
...
- Titres :
  ...
  - H2 : Dépannage
  - H3 : Échec de construction : incompatibilité de chaîne d’outils ou de SDK
...
- Titres :
  ...
  - H2 : Étapes suivantes
  - H2 : Liste de contrôle de débogage
...
- Titres :
  ...
  - H2 : Exigences
  - H2 : Modes
  - H2 : Comportement du runtime (mot d’activation)
...
- Titres :
  ...
  - H3 : PeekabooBridge (automatisation d’interface utilisateur)
...
- Titres :
  ...
  - H2 : Ce que possède l’application
...
- Titres :
  ...
  - H3 : les commandes screen.snapshot, caméra ou audio échouent
...
- Titres :
  ...
  - H2 : Ce qui va où
  - H2 : Points d’intégration fournisseur et harnais
...
- Titres :
  ...
  - H2 : Chemins d’import du SDK de Plugin
  - H2 : Schémas d’outils de messagerie
  ...
  - H3 : Liste de contrôle de capacité
...
- Titres :
  ...
  - H3 : Stratification des capacités
...
- Titres :
  ...
  - H3 : ownsNativeCompaction : désactiver la compaction OpenClaw
...
- Titres :
  ...
  - H3 : Déploiement fournisseur mixte
  - H3 : Déploiement Codex en échec fermé
...
- Titres :
  ...
  - H3 : Émettre le jeton d’actualisation
...
- Titres :
  ...
  - H2 : Liste de contrôle pour auteur de Plugin
  - H2 : Docs associés
...
- Titres :
  - H2 : Choisir la bonne porte de validation
...
- Titres :
  ...
  - H2 : Appairage fournisseur et harness
...
- Titres :
  ...
  - H2 : Plan de migration pour la conversation et la voix en temps réel
...
- Titres :
  ...
  - H3 : Infrastructure
  - H3 : Hooks hôtes pour les Plugins de workflow
  - H3 : Enregistrement de la découverte Gateway
  ...
  - H3 : Sémantique des décisions de hooks
...
- Titres :
  ...
  - H2 : Stocker les références d’exécution
  - H2 : Autres champs api de niveau supérieur
  - H2 : Associé
...
- Titres :
  ...
  - H3 : Importations restreintes des assistants de configuration
  - H3 : Promotion d’un compte unique possédée par le canal
  - H2 : Schéma de configuration
  - H3 : Créer des schémas de configuration de canal
...
- Titres :
  - H2 : Entrée de Plugin
  - H3 : Compatibilité obsolète et assistants de test
  - H3 : Sous-chemins réservés d’assistants de Plugins intégrés
  - H2 : Associé
...
- Titres :
  ...
  - H3 : Les appels démarrent mais les Webhook du fournisseur n’arrivent pas
...
- Titres :
  ...
  - H2 : Correspondance avec l’exécution OpenClaw
...
- Chemin : /providers/claude-max-api-proxy
- Titres :
  - H2: Pourquoi l’utiliser ?
  - H2: Fonctionnement
  - H2: Premiers pas
...
- Chemin : /providers/cloudflare-ai-gateway
- Titres :
  - H2: Installer le Plugin
  - H2: Premiers pas
...
- Chemin : /providers/github-copilot
- Titres :
...
- Chemin : /providers/perplexity-provider
- Titres :
  - H2: Installer le Plugin
  - H2: Premiers pas
  - H2: Modes de recherche
  - H2: Filtrage par API native
  - H2: Configuration avancée
  - H2: Connexe

## providers/pixverse.md

- Chemin : /providers/pixverse
- Titres :
  - H2: Premiers pas
...
- Titres :
  ...
  - H2: Tarification
  - H3: Venice (anonymisé) ou API directe
...
- Chemin : /providers/vercel-ai-gateway
- Titres :
  - H2: Premiers pas
  - H2: Exemple non interactif
...
- Chemin : /providers/xiaomi
- Titres :
  - H2: Premiers pas
  - H2: Catalogue avec paiement à l’usage
  - H2: Catalogue de plans de jetons
  - H2: Synthèse vocale
  - H2: Exemple de configuration
  - H2: Connexe
...
- Chemin : /refactor/database-first
- Titres :
...
- Chemin : /reference/AGENTS.default
- Titres :
...
- Titres :
  ...
  - H3: QA Lab
  - H3: Package
  - H2: Automatisation de la publication
...
- Chemin : /reference/application-modernization-plan
- Titres :
  - H2: Objectif
  - H2: Principes
  ...
  - H2: Phase 5 : durcissement des types, des contrats et des tests
  - H2: Phase 6 : documentation et préparation à la publication
  - H2: Première tranche recommandée
  - H2: Mise à jour des Skills frontend

## reference/code-mode.md

- Chemin : /reference/code-mode
- Titres :
  ...
  - H2: Interaction de recherche d’outils
  ...
  - H2: Télémétrie
  - H2: Débogage
  - H2: Agencement de l’implémentation
...
- Chemin : /reference/device-models
- Titres :
  - H2: Source de données
...
- Chemin : /reference/full-release-validation
- Titres :
  ...
  - H2: Ajouts réservés au mode complet
...
- Chemin : /reference/memory-config
- Titres :
...
- Chemin : /reference/release-performance-sweep
- Titres :
  - H2: Instantané
  ...
  - H2: Résumé d’un tour d’agent Kova
  - H2: Sondes source
...
- Chemin : /reference/rich-output-protocol
- Titres :
  - H2: [embed ...]
...
- Chemin : /reference/secret-placeholder-conventions
- Titres :
  - H1: Conventions de placeholders secrets
  - H2: Style recommandé
...
- Chemin : /reference/secretref-credential-surface
- Titres :
...
- Chemin : /reference/session-management-compaction
- Titres :
  ...
  - H2: Frontières des segments de Compaction et appariement d’outils
...
- Chemin : /reference/templates/AGENTS.dev
- Titres :
...
- Chemin : /reference/templates/BOOT
- Titres :
  - H1: BOOT.md
  - H2: Connexe
...
- Chemin : /reference/templates/BOOTSTRAP
- Titres :
...
- Chemin : /reference/templates/HEARTBEAT
- Titres :
...
- Chemin : /reference/templates/IDENTITY.dev
- Titres :
...
- Chemin : /reference/templates/IDENTITY
- Titres :
...
- Titres :
  ...
  - H2 : Intégration de bout en bout (Docker)
  - H2 : Test rapide d’importation QR (Docker)
  - H2 : Associé
...
- Titres :
  ...
  - H3 : Exemple : maintenir un cache d’1 h chaud avec Heartbeat
...
- Titres :
  ...
  - H2 : Règle globale : tours incomplets avec raisonnement uniquement
...
- Titres :
  ...
  - H4 : T-EXEC-004 : Contournement d’approbation d’exécution
  ...
  - H4 : T-EVADE-001 : Contournement des schémas de modération
  ...
  - H3 : 4.2 Schémas d’indicateurs de modération
...
- Titres :
  ...
  - H3 : Pipeline d’exécution Node (capacité au risque le plus élevé)
  - H3 : Magasin d’appairage (filtrage des messages privés)
  - H3 : Filtrage entrant (mentions + contournement des commandes de contrôle)
  ...
  - H3 : Corrélation des traces entrantes / idempotence
...
- Titres :
  ...
  - H3 : 2) Faire pointer l’application macOS vers votre Gateway en cours d’exécution
  - H3 : 3) Vérifier
  - H3 : Pièges courants
  - H2 : Carte de stockage des identifiants
...
- Titres :
  ...
  - H2: Cela fonctionne-t-il sans configuration ?
...
- Titres :
  ...
  - H4: Installation Docker Playwright
  ...
  - H2: Flux de débogage
  - H2: Sortie JSON
  - H2: Boutons de réglage d’état et d’environnement
...
- Titres :
  ...
  - H3: Couche 5 : vérifier le contrôle de navigateur de bout en bout
...
- Titres :
  ...
  - H2: Profils : openclaw vs utilisateur
  - H2: Configuration
...
- Titres :
  ...
  - H3: Quand des approbations sont envoyées à une session, n’importe qui dans cette session peut-il les approuver ?
  - H2: Connexe
...
- Titres :
  ...
  - H2: Boutons de réglage de politique
  - H3: tools.exec.mode
  - H3: exec.security
  - H3: exec.ask
  - H3: askFallback
...
- Titres :
  ...
  - H2: Paramètres de l’outil
  - H2: Sortie
  - H2: Exemple : étape de flux Lobster
...
- Titres :
  - H2: Accroche
  - H2: Pourquoi
  - H2: Pourquoi un DSL plutôt que des programmes ordinaires ?
  - H2: Fonctionnement
  - H2: Motif : petite CLI + tubes JSON + approbations
  - H2: Étapes LLM JSON uniquement (llm-task)
  - H3: Limitation importante : Lobster intégré vs openclaw.invoke
  - H2: Fichiers de flux (.lobster)
  ...
  - H2: Dépannage
  - H2: En savoir plus
  - H2: Étude de cas : flux communautaires
  - H2: Connexe
...
- Titres :
  ...
  - H2 : Transcription vocale et Voice Call
...
- Titres :
  - H2 : Installer le Plugin
  - H2 : Clé d’API (fournisseur payant)
  - H2 : Configuration
  - H2 : Remplacement de l’URL de base
  - H2 : Paramètres de l’outil
  - H2 : Notes
...
- Titres :
  - H2 : Installer le Plugin
  - H2 : Obtenir une clé d’API Perplexity
