...
x-i18n:
    generated_at: "2026-07-04T10:37:49Z"
    model: gpt-5.5
...
Ce fichier est généré à partir des titres `docs/**/*.md` et `docs/**/*.mdx` pour aider les agents à parcourir l’arborescence de la documentation.
...
- Titres :
  ...
  - H2: Groupes de référence depuis des listes d’autorisation
...
- Titres :
  ...
  - H2: Formes de clé de session (exemples)
...
- Titres :
  ...
  - H2: Isolation des agents par utilisateur (création dynamique d’agent)
...
- Titres :
  ...
  - H3: État et signaux de confiance
  ...
  - H3: Configuration de liaison des fils
  - H2: Réactions
...
- Titres :
  ...
  - H2: Style de réponse : fils ou publications
  ...
  - H3: Erreurs d’importation du manifeste
...
- Titres :
  - H2: 1) Appairage DM (accès entrant à la discussion)
...
- Titres :
  ...
  - H2: Médias + limites
  - H2: Indicateur de saisie + accusés de lecture
...
- Titres :
  ...
  - H2: Liste de contrôle du manifeste et des scopes
  ...
  - H3: Soumissions de modales gérées par le Plugin
...
- Titres :
  ...
  - H2 : Distribution, segmentation et médias
  ...
  - H2 : Dépannage
  - H2 : Instructions système
  - H2 : Repères de référence de configuration
  - H2 : Connexe
...
- Titres :
  ...
  - H3 : Optimiser la distribution des messages sortants
...
- Titres :
  ...
  - H2 : Interrogation longue vs Webhook
  - H2 : Types de messages pris en charge
  - H2 : Capacités
...
- Titres :
  ...
  - H3 : Gating par mention de groupe
  - H2 : Comptes multiples
  - H2 : Variables d’environnement
  - H2 : Saisie, réactions et accusés de distribution
  - H2 : Dépannage
  - H2 : Connexe
...
- Titres :
  ...
  - H2 : Options courantes
  - H2 : Notes
  - H2 : Liste de contrôle de récupération après dérive de jeton
  - H2 : Connexe
...
- Titres :
  ...
  - H3 : gateway status
  - H3 : gateway probe
  - H4 : À distance via SSH (parité avec l’app Mac)
...
- Titres :
  ...
  - H3: Points d’accroche de Plugin (cycle de vie agent + Gateway)
  ...
  - H2: Où les choses peuvent se terminer plus tôt
  - H2: Associé
...
- Titres :
  ...
  - H2 : Dossiers de workspace supplémentaires
  - H2 : Carte des fichiers du workspace
  - H2 : Ce qui n’est PAS dans le workspace
  - H2 : Sauvegarde Git (recommandée, privée)
  - H2 : Ne commitez pas de secrets
  - H2 : Déplacer le workspace vers une nouvelle machine
  - H2 : Notes avancées
  - H2 : Associé
...
- Titres :
  ...
  - H2 : Fichiers de workspace injectés (contexte du projet)
...
- Titres :
  ...
  - H2 : Ingestion des transcripts de session
  - H2 : Journal de rêve
  - H2 : Signaux de classement profonds
  - H2 : Couverture du rapport d’essai shadow QA
  - H2 : Planification
  - H2 : Démarrage rapide
  - H2 : Commande slash
  - H2 : Workflow CLI
  ...
  - H2 : Dreaming ne s’exécute jamais : le statut indique bloqué
  - H2 : Associé
...
- Titres :
  ...
  - H2 : Performances et compatibilité de recherche
...
- Titres :
  ...
  - H2 : Relation avec l’entrée canal
  ...
  - H3 : Phase 3 : pont d’entrée canal
  - H3 : Phase 4 : pont du répartiteur préparé
  - H3 : Phase 5 : cycle de vie unifié en direct
...
- Titres :
  ...
  - H2 : Cache de saut des échecs d’authentification
  - H2 : Avis de fallback visibles par l’utilisateur
  - H2 : Stockage d’authentification (clés + OAuth)
  - H2 : ID de profils
  - H2 : Ordre de rotation
  - H3 : Adhérence de session (favorable au cache)
  - H3 : Abonnement OpenAI Codex avec sauvegarde par clé API
  ...
  - H3 : Saut par délai de récupération ou comportement de probe
  - H2 : Remplacements de session et changement de modèle en direct
  - H2 : Observabilité et résumés d’échec
...
- Titres :
  - H2 : Règles rapides
  - H2 : Comportement des fournisseurs appartenant aux Plugins
...
- Titres :
  ...
  - H3 : models list
  - H3 : models status
  - H2 : Scan (modèles OpenRouter gratuits)
...
- Titres :
  ...
  - H2 : Recherche mémoire QMD entre agents
...
- Titres :
  - H2 : Le puits de jetons (pourquoi il existe)
...
- Chemin : /concepts/parallel-specialist-lanes
- Titres :
...
- Chemin : /concepts/personal-agent-benchmark-pack
- Titres :
  - H2 : Scénarios
...
- Chemin : /concepts/progress-drafts
- Titres :
  - H2 : Démarrage rapide
...
- Chemin : /concepts/qa-e2e-automation
- Titres :
  - H2 : Surface de commande
  - H2 : Flux opérateur
...
- Chemin : /concepts/queue-steering
- Titres :
...
- Chemin : /concepts/session-pruning
- Titres :
...
- Titres :
  ...
  - H2 : « Diffuser les morceaux ou tout »
  - H2 : Modes de streaming d’aperçu
  - H3 : Correspondance des canaux
  - H3 : Comportement d’exécution
  - H3 : Mises à jour d’aperçu de la progression des outils
  - H3 : Voie de progression des commentaires
  - H2 : Connexe

## concepts/system-prompt.md

- Chemin : /concepts/system-prompt
- Titres :
  - H2 : Structure
  - H2 : Modes d’invite
  - H2 : Instantanés d’invite
...
- Chemin : /concepts/typing-indicators
- Titres :
  - H2 : Valeurs par défaut
  - H2 : Modes
  - H2 : Configuration
...
- Chemin : /concepts/usage-tracking
- Titres :
  - H2 : Ce que c’est
  - H2 : Où cela apparaît
...
- Titres :
  ...
  - H2 : Charges utiles d’outil + connecteurs (temps brut du fournisseur + champs normalisés)
  - H2 : Docs connexes

## debug/node-issue.md

- Chemin : /debug/node-issue
- Titres :
  - H1 : Plantage Node + tsx "\\name is not a function"
  - H2 : Résumé
  - H2 : Environnement
  - H2 : Reproduction (Node uniquement)
  - H2 : Reproduction minimale dans le dépôt
...
- Chemin : /gateway/authentication
- Titres :
  - H2 : Configuration recommandée (clé API, n’importe quel fournisseur)
  - H2 : Anthropic : compatibilité avec la CLI Claude et les jetons
  - H2 : Note Anthropic
  - H2 : Vérifier l’état d’authentification du modèle
  - H2 : Comportement de rotation des clés API (Gateway)
  - H2 : Supprimer l’authentification de fournisseur pendant que le Gateway s’exécute
...
- Chemin : /gateway/background-process
- Titres :
  - H2 : Outil exec
...
- Chemin : /gateway/bridge-protocol
- Titres :
...
- Chemin : /gateway/cli-backends
- Titres :
  - H2 : Démarrage rapide adapté aux débutants
  - H2 : L’utiliser comme solution de repli
  - H2 : Vue d’ensemble de la configuration
...
- Titres :
  ...
  - H3 : Dépôt de skill frère lié par symlink
  - H2 : Modèles courants
...
- Titres :
  ...
  - H2 : Liste de vérification de l’isolation
...
- Titres :
  ...
  - H2 : Contrat de modèle centré agent
  ...
  - H3 : Forme de réponse d’outil non streamée
  - H3 : Forme de réponse d’outil streamée
...
- Titres :
  ...
  - H3 : Télémétrie de disponibilité de session
...
- Titres :
  ...
  - H2 : La portée de méthode n’est que le premier garde-fou
...
- Titres :
  ...
  - H3 : Bind mounts (vérification rapide de sécurité)
...
- Titres :
  ...
  - H2 : Notes de compatibilité de l’authentification legacy
...
- Titres :
  ...
  - H2 : Résumé des flags non sécurisés ou dangereux
  - H2 : Configuration du proxy inverse
  - H2 : Notes HSTS et origine
  - H2 : Les journaux de session locaux vivent sur disque
  ...
  - H2 : Flags de contournement du contenu externe non sécurisé
  ...
  - H3 : Contrôle du navigateur via l’hôte de nœud (recommandé)
  - H3 : Secrets sur disque
  - H3 : Fichiers .env de l’espace de travail
  - H3 : Journaux et transcriptions (caviardage et rétention)
...
- Titres :
  ...
  - H3 : Tailnet uniquement (bind à l’IP Tailnet)
...
- Titres :
  ...
  - H2 : Symlink de Skill ignoré comme échappement de chemin
  - H2 : Anthropic 429 : utilisation supplémentaire requise pour un contexte long
  - H2 : Réponses upstream 403 bloquées
  ...
  - H2 : Service Gateway non exécuté
...
- Titres :
  ...
  - H3 : Recommandations de déploiement progressif
  - H2 : Exemples de configuration de proxy
  - H2 : Configuration de jetons mixte
...
- Titres :
  - H2 : Priorité (la plus haute → la plus basse)
  ...
  - H2 : Variables d’environnement legacy
  - H2 : Connexe
...
- Titres :
  ...
  - H2 : Où les éléments vivent sur disque
  ...
  - H2 : Commandes de chat, abandon de tâches et "ça ne s’arrêtera pas"
  - H2 : Divers
  - H2 : Connexe
...
- Titres :
  ...
  - H2 : Live du plan de codage BytePlus
  - H2 : Live des médias de workflow ComfyUI
  - H2 : Génération d’images live
  - H2 : Génération de musique live
  - H2 : Génération de vidéo live
  - H2 : Harnais live multimédia
  - H2 : Connexe
...
- Titres :
  ...
  - H3 : E2E (navigateur simulé de la Control UI)
...
- Titres :
  ...
  - H2 : Ciblage ponctuel d’une version ou d’une balise
  - H2 : Simulation
...
- Titres :
  ...
  - H3 : Échecs des vérifications d’état / connexion refusée
...
- Titres :
  ...
  - H3 : Exposer au-delà de port-forward
  - H2 : Redéployer
  - H2 : Démontage
...
- Titres:
  ...
  - H3: Détecter automatiquement la compréhension des médias (par défaut)
...
- Titres:
  ...
  - H3: La stabilité du cache de prompts compte
  ...
  - H3: 5. Préserver la mise en forme stable du cache de prompts
  - H3: 6. Câbler le post-tour après le miroir de transcription
...
- Titres:
  ...
  - H2: Beacons actifs en arrière-plan
  - H2: Authentification et flux de confiance
...
- Titres :
  ...
  - H2 : Octrois d’accessibilité pour les environnements d’exécution Node et CLI
  - H2 : Liste de vérification de récupération lorsque les invites disparaissent
  - H2 : Autorisations de fichiers et dossiers (Desktop/Documents/Downloads)
  - H2 : Connexe
...
- Titres :
  - H1 : Activation vocale et push-to-talk
  - H2 : Exigences
  - H2 : Modes
  - H2 : Comportement d’exécution (mot d’activation)
  - H2 : Invariants de cycle de vie
  - H2 : Mode de défaillance de superposition persistante (précédent)
  - H2 : Spécificités du push-to-talk
  - H2 : Réglages visibles par l’utilisateur
...
- Titres :
  ...
  - H2 : Ce que l’app prend en charge
...
- Titres :
  ...
  - H3 : Ce que comprend Windows Hub
  ...
  - H3 : L’app indique qu’un appairage est requis
...
- Titres :
  ...
  - H2 : Ce qui va où
  - H2 : Jonctions des fournisseurs et des harnais
...
- Titres :
  ...
  - H3 : Instantané de métadonnées de Plugin et table de recherche
  ...
  - H3 : Exemple de Plugin d’entreprise multi-capacité
...
- Titres :
  - H2 : Ce que le Plugin prend en charge
...
- Titres :
  - H2 : Exigences
  - H2 : Démarrage rapide
  - H2 : Partager des threads avec Codex Desktop et CLI
  - H2 : Configuration
  ...
  - H3 : Déploiement Codex en fail-closed
  - H2 : Politique de serveur d’app
...
- Titres :
  ...
  - H3 : Remplacer un plugin de canal
...
- Titres :
  ...
  - H3 : Visibilité de repli de la valeur de bouton
...
- Titres :
  ...
  - H2 : Extraction du code source uniquement
...
- Titres :
  ...
  - H2 : Plan de migration pour la parole et la voix en temps réel
...
- Titres :
  ...
  - H3 : Enregistrement de capacités
  - H3 : Outils et commandes
  - H3 : Infrastructure
  - H3 : Hooks hôte pour les Plugins de workflow
...
- Titres :
  ...
  - H3 : Importations ciblées des helpers de configuration
...
- Titres :
  ...
  - H3 : Sous-chemins réservés aux helpers de Plugins groupés
  - H2 : Associé
...
- Titres :
  ...
  - H3 : Tester l’accès à la configuration runtime
...
- Titres :
  ...
  - H2 : Démarrage rapide
  - H2 : Écrire un outil
  - H2 : Outils optionnels et outils factory
  ...
  - H2 : Publier
  - H2 : Dépannage
  - H3 : entrée Plugin introuvable : ./dist/index.js
  - H3 : l’entrée Plugin n’expose pas les métadonnées defineToolPlugin
...
- Itinéraire : /providers/clawrouter
- Titres :
  - H2 : Prise en main
  - H2 : Découverte des modèles
  - H2 : Protocoles et Plugins de fournisseurs
...
- Titres :
  ...
  - H2 : Prise en main
  - H2 : Authentification app-server native Codex
  - H2 : Génération d’images
  - H2 : Génération de vidéos
...
- Titres :
  - H2 : Configuration
  - H2 : Valeurs par défaut
  - H2 : Différences par rapport à Qwen
...
- Titres :
  ...
  - H3 : Alias de compatibilité héritée
  - H2 : Fonctionnalités
  - H2 : Tests en direct
  - H2 : Liens associés
...
- Titres :
  - H1 : Plan de suppression du noyau d’entrée
  - H2 : Budget
  - H2 : Diagnostic
  - H2 : Points sensibles
...
- Titres :
  ...
  - H3 : 8) Analyse / sonde des modèles
  - H3 : 9) Parler (voix)
...
- Titres :
  ...
  - H2 : Configuration spécifique au fournisseur
...
- Titres :
  ...
  - H3 : Pont de réveil d’agent externe Raft
...
- Titres :
  ...
  - H4 : T-EXEC-001 : Injection directe dans l’invite
  - H4 : T-EXEC-002 : Injection indirecte dans l’invite
  ...
  - H4 : T-EVADE-002 : Échappement du conteneur de contenu
  ...
  - H3 : 4.2 Motifs de drapeaux de modération
...
- Titres :
  ...
  - H3 : Pipeline exec Node (capacité la plus risquée)
  - H3 : Magasin d’appairage (filtrage DM)
...
- Titres :
  ...
  - H3 : La frénésie d’achats de robots (3 déc. 2025)
  - H2 : Textes sacrés
...
- Titres :
  ...
  - H2 : Guide d’exploitation pour opérateur
  ...
  - H2 : Modes de liaison de lancement et de fil
...
- Titres :
  ...
  - H2 : Capacités d’attente avancées
...
- Titres :
  ...
  - H3 : Cause racine
  - H3 : Solution 1 : installer Google Chrome (recommandée)
  - H3 : Solution 2 : utiliser Snap Chromium avec le mode attachement seul
...
- Titres :
  ...
  - H2 : Règle essentielle pour l’interface utilisateur de contrôle
...
- Titres :
  ...
  - H2 : Contrat de détails de sortie
...
- Titres :
  - H2 : Inspecter la stratégie effective
  ...
  - H3 : Configuration « ne jamais demander » persistante sur l’hôte Gateway
  - H3 : Raccourci local
  - H3 : Hôte Node
  ...
  - H2 : Modification dans l’interface utilisateur de contrôle
...
- Titres :
  ...
  - H2 : Explorations détaillées des fournisseurs
  - H2 : Exemples
  - H2 : Connexe
...
- Titres :
  ...
  - H3 : Limite importante : Lobster intégré ou openclaw.invoke
...
- Titres :
  ...
  - H2 : Correspondances des fournisseurs (répartition des fournisseurs entre les surfaces)
...
- Titres :
  ...
  - H2 : Personas
  - H3 : Persona minimal
  - H3 : Persona complet (invite indépendante du fournisseur)
...
- Titres :
  ...
  - H2 : Ce qu’il peut faire (aujourd’hui)
  - H2 : Page MCP
  - H2 : Onglet d’activité
  - H2 : Comportement du chat
  - H2 : Installation PWA et notifications Web push
...
- Titres :
  ...
  - H2 : Panneau des outils des agents Control UI
