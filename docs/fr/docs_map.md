...
x-i18n:
    generated_at: "2026-06-30T22:15:01Z"
    model: gpt-5.5
...
Ce fichier est généré à partir des titres de `docs/**/*.md` et `docs/**/*.mdx` pour aider les agents à naviguer dans l’arborescence de la documentation.
...
- Titres :
  ...
  - H3 : Le jour du mois et le jour de la semaine utilisent la logique OR
  ...
  - H3 : Configuration par assistant (recommandé)
...
- Titres :
  ...
  - H3 : Tâches planifiées (Cron) vs Heartbeat
...
- Titres :
  ...
  - H2 : Groupes de référence depuis les listes d’autorisation
...
- Titres :
  ...
  - H2 : Délimiter les modèles de mention configurés
...
- Titres :
  ...
  - H2 : Quand cette migration a du sens
  - H2 : Ce que fait imsg
...
- Titres :
  ...
  - H2 : Fusion des DM à envoi fractionné (commande + URL dans une seule composition)
  - H3 : Scénarios et ce que voit l’agent
  - H2 : Récupération entrante après un redémarrage du pont ou du Gateway
...
- Titres :
  ...
  - H3 : Outils différents par expéditeur (le propriétaire a plus de pouvoirs)
  - H2 : NickServ
...
- Titres :
  - H2 : Installation
  - H2 : Configuration initiale rapide
  ...
  - H2 : Nouvelle tentative de canal de message privé
  - H2 : Streaming des aperçus
  - H2 : Réactions (outil de message)
  - H2 : Boutons interactifs (outil de message)
  - H3 : Intégration directe d’API (scripts externes)
...
- Titres :
  ...
  - H2 : Objectifs
  - H2 : Écritures de configuration
  - H2 : Contrôle d’accès (messages privés + groupes)
  - H3 : Fonctionnement
  ...
  - H2 : Capacités : RSC seulement vs Graph
  - H3 : Avec Teams RSC seulement (application installée, aucune autorisation Graph API)
  ...
  - H3 : Erreurs d’envoi du manifeste
...
- Titres :
  - H2 : Plugin inclus
  - H2 : Configuration initiale rapide (débutant)
  - H2 : Notes
  - H2 : Contrôle d’accès (messages privés)
  - H2 : Salons (groupes)
  - H2 : Capacités
...
- Titres :
  ...
  - H2 : Contrôle d’accès
  - H3 : Politiques de messages privés
...
- Titres :
  - H2 : 1) Appairage par message privé (accès au chat entrant)
  - H3 : Approuver un expéditeur
  - H3 : Groupes d’expéditeurs réutilisables
  - H3 : Emplacement de l’état
  - H2 : 2) Appairage d’appareil Node (nœuds iOS/Android/macOS/sans affichage)
  - H3 : Appairer via Telegram (recommandé pour iOS)
  - H3 : Approuver un appareil Node
  - H3 : Approbation automatique facultative des nœuds CIDR de confiance
...
- Titres :
  ...
  - H2 : Sécurité des Webhook
  - H2 : Configuration multicomptes
  - H2 : Dépannage
...
- Titres :
  ...
  - H2 : Configuration initiale rapide
  - H2 : Variables d’environnement
  - H2 : Politique de messages privés et contrôle d’accès
...
- Titres :
  ...
  - H2 : Comportement du numéro personnel et de l’auto-conversation
...
- Titres :
  ...
  - H3 : Restreindre les messages directs à des utilisateurs spécifiques
  ...
  - H3 : Le bot ne reçoit pas de messages
...
- Titres :
  ...
  - H2 : Qu’est-ce que c’est
  - H2 : Nommage
  - H2 : Recherche des ID (annuaire)
  - H2 : Limites
  - H2 : Contrôle d’accès (messages directs)
  - H2 : Accès aux groupes (facultatif)
  - H3 : Filtrage par mention de groupe
...
- Titres :
  ...
  - H3 : Segments du chemin de version
...
- Titres :
  ...
  - H2 : Modes config set
  - H2 : config patch
  - H2 : Indicateurs de générateur de fournisseur
  - H2 : Essai à blanc
...
- Titres :
  ...
  - H2 : Options courantes
  - H2 : Notes
  - H2 : Liste de contrôle de récupération après dérive des jetons
  - H2 : Lié
...
- Titres :
  ...
  - H2 : Indicateurs courants
  - H2 : Notes
  - H2 : Utilisation des résultats avec l’envoi de messages
...
- Titres :
  ...
  - H3 : État Codex à revue manuelle
...
- Titres :
  - H1 : openclaw policy
  - H2 : Démarrage rapide
  - H3 : Référence des règles de policy
  - H4 : Superpositions limitées
  - H4 : Canaux
  - H4 : Serveurs MCP
...
- Titres :
  ...
  - H3 : Après la modification de la source, de la policy ou du mode OpenShell
...
- Titres :
  ...
  - H2 : Policy de fallback du modèle
...
- Titres :
  ...
  - H2 : Exécution d’agent GitHub Copilot
...
- Titres :
  ...
  - H2 : Ne commettez pas de secrets
...
- Titres :
  ...
  - H3: WebChat
  - H2: Cycle de vie de connexion (client unique)
...
- Titres :
  ...
  - H3: Niveau 2 : envoi pour le compte de
...
- Titres :
  ...
  - H2: Mode allégé de modèle local
...
- Titres :
  ...
  - H2: Machines
  - H2: Secrets
  - H2: Artéfacts GitHub et commentaires de PR
...
- Titres :
  ...
  - H2: Fonctionnement
  - H2: Mémoire Honcho et mémoire intégrée
  - H2: Commandes CLI
...
- Titres :
  - H2: Flux de messages (haut niveau)
...
- Titres :
  ...
  - H2: Avis de repli visibles par l’utilisateur
  - H2: Stockage de l’authentification (clés + OAuth)
  - H2: ID de profil
  - H2: Ordre de rotation
  - H3: Affinité de session (favorable au cache)
  - H3: Abonnement OpenAI Codex plus sauvegarde par clé API
  - H2: Délais de récupération
  - H2: Désactivations liées à la facturation
  - H2: Repli de modèle
  - H3: Règles de chaîne de candidats
  - H3: Quelles erreurs font avancer le repli
  - H3: Comportement d’évitement ou de sonde pendant le délai de récupération
  - H2: Remplacements de session et changement de modèle en direct
  - H2: Observabilité et résumés de défaillances
...
- Titres :
  - H2: Règles rapides
  - H2: Comportement de fournisseur possédé par le Plugin
...
- Titres :
  ...
  - H2: Source de sélection et comportement de repli
  - H2: Politique rapide de modèles
...
- Titres :
  ...
  - H2: Stockage (où résident les tokens)
  - H2: Compatibilité avec les tokens Anthropic hérités
  - H2: Migration vers Anthropic Claude CLI
...
- Titres :
  ...
  - H3 : Phase 1 : contrats de lane + travaux lourds en arrière-plan
...
- Titres :
  ...
  - H2 : Mise en garde remote/tunnel (IP loopback)
  - H2 : Consommateurs
...
- Titres :
  ...
  - H2 : Algorithme de découpage (bornes basses/hautes)
  - H2 : Coalescence (fusionner les blocs streamés)
  - H2 : Cadence humaine entre les blocs
...
- Titres :
  ...
  - H2 : Charges utiles d’outil + connecteurs (heure brute du provider + champs normalisés)
  - H2 : Docs associées
...
- Titres :
  ...
  - H2 : Remplacement env (ponctuel)
  - H2 : Indicateurs de profilage
  - H2 : Artéfacts de chronologie
...
- Titres :
  - H2 : Configuration recommandée (clé API, tout provider)
  ...
  - H2 : Supprimer l’authentification du provider pendant que le Gateway est en cours d’exécution
...
- Titres :
  ...
  - H2 : Usage historique de tailnet
  - H2 : Versionnement
  - H2 : Associé
...
- Titres :
  ...
  - H2 : Fonctionnement
  - H2 : Sessions
  - H2 : Prélude de fallback depuis les sessions claude-cli
  ...
  - H2 : Limite de réamorçage de l’historique
  - H2 : Limitations
  - H2 : Dépannage
  - H2 : Associé
...
- Titres :
  ...
  - H3 : Remplacements de profil de bootstrap par agent
...
- Titres :
  ...
  - H3 : Valeurs par défaut de canal et Heartbeat
  - H3 : WhatsApp
  - H3 : Telegram
  - H3 : Discord
  - H3 : Google Chat
  ...
  - H3 : Filtrage des mentions en discussion de groupe
...
- Titres :
  ...
  - H3 : Profils d’outils
  - H3 : Groupes d’outils
  - H3 : Outils MCP et Plugin dans la politique d’outils de sandbox
  - H3 : tools.codeMode
...
- Titres :
  ...
  - H2 : Modèles courants
  - H3 : Base de Skills partagée avec une seule surcharge
...
- Titres :
  ...
  - H2 : Variables de modèle multimédia
...
- Titres :
  ...
  - H4 : Détails du signal de service
...
- Titres :
  ...
  - H2 : Rattrapage et réinitialisation de l’interface Dreams
...
- Titres :
  ...
  - H2 : Code d’application ou code de plugin
  - H2 : Associé
...
- Titres :
  ...
  - H2 : Signatures de pannes courantes
...
- Titres :
  ...
  - H3 : Style de journalisation WS
  - H2 : Formatage de console (journalisation par sous-système)
  - H2 : Associé
...
- Titres :
  ...
  - H3 : Forme de réponse d’outil sans streaming
...
- Titres :
  - H2 : Comment les éléments s’articulent
  - H2 : Démarrage rapide
  - H2 : Signaux exportés
  - H2 : Référence de configuration
  - H3 : Variables d’environnement
...
- Titres :
  ...
  - H2 : Approbation automatique de la mise à niveau des métadonnées
...
- Titres :
  ...
  - H3 : Méthodes d’assistance du nœud
  - H3 : RPC du registre des tâches
  - H3 : Méthodes d’assistance opérateur
  - H3 : Vues models.list
  - H2 : Approbations Exec
  - H2 : Repli de livraison aux agents
...
- Titres :
  ...
  - H2 : Flux de commande (ce qui s’exécute où)
  ...
  - H2 : Mode distant de l’app macOS
...
- Titres :
  ...
  - H2 : Stratégie d’outils : quels outils existent/sont appelables
  - H3 : Groupes d’outils (raccourcis)
  - H2 : Élevé : « exécuter sur l’hôte » uniquement pour exec
  - H2 : Correctifs courants pour la « jail de sandbox »
  - H3 : « Outil X bloqué par la stratégie d’outils de sandbox »
  - H3 : « Je pensais que c’était principal, pourquoi est-ce sandboxé ? »
  - H2 : Associé
...
- Titres :
  ...
  - H2 : Stratégie d’outils et échappatoires
...
- Titres :
  ...
  - H2 : Matériel d’authentification SSH de sandbox
  ...
  - H2 : Stratégie de sécurité à sens unique
...
- Titres :
  ...
  - H2 : Concept de confiance Gateway et nœud
  ...
  - H2 : Nettoyage des jetons spéciaux dans le contenu externe
  - H2 : Indicateurs de contournement dangereux pour le contenu externe
  ...
  - H3 : Exposition réseau (bind, port, pare-feu)
  ...
  - H3 : Garde-fou de délégation à un sous-agent
  - H2 : Risques du contrôle du navigateur
  - H3 : Stratégie SSRF du navigateur (stricte par défaut)
  - H2 : Profils d’accès par agent (multi-agent)
  - H3 : Exemple : accès complet (pas de sandbox)
...
- Titres :
  ...
  - H2 : Comportement de stratégie + routage
  - H2 : Réponses
  - H2 : Exemple
  - H2 : Associé
...
- Titres :
  ...
  - H2 : Anthropic 429 : utilisation supplémentaire requise pour contexte long
  - H2 : Réponses bloquées en amont avec 403
  ...
  - H2 : Gateway se ferme lors d’une forte utilisation de mémoire
  - H2 : Gateway a rejeté une configuration invalide
  - H2 : Avertissements de sonde Gateway
  - H2 : Canal connecté, messages non transmis
  - H2 : Livraison Cron et Heartbeat
  - H2 : Nœud appairé, échec de l’outil
  - H2 : Échec de l’outil de navigateur
  - H2 : Si vous avez fait une mise à niveau et que quelque chose a soudainement cassé
  - H2 : Associé
...
- Titres :
  ...
  - H2 : Réfs de secrets vs chaînes ${ENV}
...
- Titres :
  - H2 : Modèles : valeurs par défaut, sélection, alias, bascule
...
- Titres :
  ...
  - H2 : Sessions et discussions multiples
  ...
  - H2 : Commandes de discussion, abandon des tâches et « ça ne s’arrête pas »
  - H2 : Divers
  - H2 : Associé
...
- Chemin : /help/testing-live
- Titres :
  - H2: En direct : commandes locales de test de fumée
  - H2: En direct : balayage des capacités du nœud Android
  - H2: En direct : test de fumée des modèles (clés de profil)
  - H3: Couche 1 : complétion directe du modèle (sans Gateway)
  - H3: Couche 2 : Gateway + test de fumée de l’agent de développement (ce que fait réellement "@openclaw")
  - H2: En direct : test de fumée du backend CLI (Claude, Gemini ou autres CLI locales)
  - H2: En direct : accessibilité du proxy HTTP/2 APNs
  - H2: En direct : test de fumée de liaison ACP (/acp spawn ... --bind here)
  - H2: En direct : test de fumée du harnais de serveur d’application Codex
  - H3: Recettes en direct recommandées
  - H2: En direct : matrice de modèles (ce que nous couvrons)
  - H3: Ensemble de tests de fumée moderne (appel d’outils + image)
  ...
  - H2: Identifiants (ne jamais commit)
  ...
  - H2: Harnais de médias en direct
  - H2: Connexe

## help/testing-updates-plugins.md

- Chemin : /help/testing-updates-plugins
- Titres :
...
- Titres :
  ...
  - H3: E2E (test de fumée du Gateway)
  - H3: E2E (navigateur simulé de l’interface de contrôle)
  - H3: E2E : test de fumée du backend OpenShell
  - H3: En direct (fournisseurs réels + modèles réels)
...
- Chemin : /install/development-channels
- Titres :
...
- Chemin : /install/docker-vm-runtime
- Titres :
...
- Titres :
  ...
  - H3: Assistants shell (facultatifs)
...
- Chemin : /install/migrating-claude
- Titres :
...
- Chemin : /install/migrating-hermes
- Titres :
  - H2: Deux façons d’importer
  - H2: Ce qui est importé
  - H2: Ce qui reste uniquement archivé
...
- Titres :
  ...
  - H2 : Installation normale ou extraction des sources
  - H3 : Installation normale (install.sh / npm / pnpm / bun)
  - H3 : Extraction des sources (git clone)
  - H2 : Connexe
...
- Titres :
  ...
  - H3 : Fournisseur uniquement avec contrôle par périmètre
...
- Titres :
  ...
  - H3 : Jumeler + nommer
  - H3 : Mettre les commandes sur liste d’autorisation
  - H3 : Pointer exec vers le nœud
  - H2 : Appel de commandes
...
- Titres :
  ...
  - H3 : 3. Brancher l’amorçage avant le démarrage du fil Codex
  - H3 : 4. Brancher assemble avant thread/start / thread/resume et turn/start
  - H3 : 5. Préserver la mise en forme stable du cache d’invite
  ...
  - H4 : Événements natifs Codex contextCompaction pendant le tour
...
- Titres :
  ...
  - H3 : 4) Approuver le jumelage (CLI)
...
- Titres :
  - H2 : Ce qu’il fait
  - H2 : Exigences
  - H2 : Démarrage rapide (jumeler + connecter)
  - H2 : Push appuyé par relais pour les builds officiels
...
- Titres :
  - H2 : Installer la CLI (requise pour le mode local)
...
- Titres :
  ...
  - H3 : Gateway bloqué indéfiniment sur « Starting... »
  - H2 : Associé
...
- Titres :
  ...
  - H2 : Autorisations de fichiers et dossiers (Bureau/Documents/Téléchargements)
  - H2 : Associé
...
- Titres :
  ...
  - H3 : Échec des commandes screen.snapshot, camera ou audio
...
- Titres :
  ...
  - H3 : Comportement manifeste d’abord
  ...
  - H2 : Helpers d’exécution
  - H3 : api.runtime.imageGeneration
  - H2 : Routes HTTP de Gateway
...
- Titres :
  ...
  - H3 : Exemple de Plugin d’entreprise multi-capacités
...
- Titres :
  ...
  - H4 : Contenu de Skill
  - H4 : Packs de hooks
  - H4 : MCP pour OpenClaw embarqué
  - H4 : Paramètres d’OpenClaw embarqué
  - H4 : LSP OpenClaw embarqué
...
- Titres :
  ...
  - H2 : Compaction et miroir de transcript
...
- Titres :
  ...
  - H3 : Déploiement Codex à fermeture stricte
...
- Titres :
  ...
  - H2 : Configuration de l’application du thread
...
- Titres :
  ...
  - H3 : Voie d’acceptation mainteneur
...
- Titres :
  ...
  - H2 : Compaction
  - H2 : Mise en miroir du transcript
...
- Chemin : /plugins/install-overrides
- Titres :
  - H2: Environnement
  - H2: Comportement
  - H2: E2E de package
...
- Titres :
  ...
  - H3: Champs package.json qui influencent la découverte
  - H2: Priorité de découverte (ids de Plugin en double)
...
- Titres :
  ...
  - H2: Affirmations structurées et preuves
...
- Chemin : /plugins/message-presentation
- Titres :
  - H2: Contrat
  ...
  - H2: Liste de vérification pour auteur de Plugin
  - H2: Docs connexes

## plugins/oc-path.md

- Chemin : /plugins/oc-path
- Titres :
...
- Chemin : /plugins/plugin-inventory
- Titres :
...
- Chemin : /plugins/plugin-permission-requests
- Titres :
  - H2: Choisir le bon garde-fou
  - H2: Demander l’approbation avant un appel d’outil
  - H2: Comportement de décision
  - H2: Router les prompts d’approbation
  - H2: Autorisations natives Codex
  - H2: Dépannage
  - H2: Connexe

## plugins/reference.md

- Chemin : /plugins/reference
- Titres :
  - H1: Référence des Plugins

## plugins/reference/acpx.md

- Chemin : /plugins/reference/acpx
- Titres :
  - H1: Plugin ACPx
  - H2: Distribution
  - H2: Surface
...
- Chemin : /plugins/reference/admin-http-rpc
- Titres :
...
- Chemin : /plugins/reference/alibaba
- Titres :
  - H1: Plugin Alibaba
  - H2: Distribution
  - H2: Surface
...
- Chemin : /plugins/reference/amazon-bedrock-mantle
- Titres :
...
- Chemin : /plugins/reference/amazon-bedrock
- Titres :
...
- Chemin : /plugins/reference/anthropic-vertex
- Titres :
...
- Chemin : /plugins/reference/anthropic
- Titres :
  - H1: Plugin Anthropic
  - H2: Distribution
  - H2: Surface
...
- Chemin : /plugins/reference/arcee
- Titres :
  - H1: Plugin Arcee
  - H2: Distribution
  - H2: Surface
...
- Chemin : /plugins/reference/azure-speech
- Titres :
...
- Chemin : /plugins/reference/bonjour
- Titres :
  - H1: Plugin Bonjour
  - H2: Distribution
  - H2: Surface
...
- Chemin : /plugins/reference/brave
- Titres :
  - H1: Plugin Brave
  - H2: Distribution
  - H2: Surface
...
- Chemin : /plugins/reference/browser
- Titres :
  - H1: Plugin Browser
  - H2: Distribution
  - H2: Surface
...
- Chemin : /plugins/reference/byteplus
- Titres :
  - H1: Plugin BytePlus
  - H2: Distribution
  - H2: Surface
...
- Chemin : /plugins/reference/canvas
- Titres :
  - H1: Plugin Canvas
  - H2: Distribution
  - H2: Surface
...
- Chemin : /plugins/reference/cerebras
- Titres :
  - H1: Plugin Cerebras
  - H2: Distribution
  - H2: Surface
...
- Chemin : /plugins/reference/chutes
- Titres :
  - H1: Plugin Chutes
  - H2: Distribution
  - H2: Surface
...
- Chemin : /plugins/reference/clickclack
- Titres :
...
- Chemin : /plugins/reference/cloudflare-ai-gateway
- Titres :
...
- Chemin : /plugins/reference/codex-supervisor
- Titres :
...
- Chemin : /plugins/reference/codex
- Titres :
  - H1: Plugin Codex
  - H2: Distribution
  - H2: Surface
...
- Chemin : /plugins/reference/cohere
- Titres :
  - H1: Plugin Cohere
  - H2: Distribution
  - H2: Surface
...
- Chemin : /plugins/reference/comfy
- Titres :
  - H1: Plugin ComfyUI
  - H2: Distribution
  - H2: Surface
...
- Chemin : /plugins/reference/copilot-proxy
- Titres :
...
- Chemin : /plugins/reference/copilot
- Titres :
  - H1: Plugin Copilot
  - H2: Distribution
  - H2: Surface
...
- Chemin : /plugins/reference/deepgram
- Titres :
  - H1: Plugin Deepgram
  - H2: Distribution
  - H2: Surface
...
- Chemin : /plugins/reference/deepinfra
- Titres :
  - H1: Plugin DeepInfra
  - H2: Distribution
  - H2: Surface
...
- Chemin : /plugins/reference/deepseek
- Titres :
  - H1: Plugin DeepSeek
  - H2: Distribution
  - H2: Surface
...
- Chemin : /plugins/reference/diagnostics-otel
- Titres :
...
- Chemin : /plugins/reference/diagnostics-prometheus
- Titres :
...
- Chemin : /plugins/reference/diffs-language-pack
- Titres :
...
- Chemin : /plugins/reference/diffs
- Titres :
  - H1: Plugin Diffs
  - H2: Distribution
  - H2: Surface
...
- Chemin : /plugins/reference/discord
- Titres :
  - H1: Plugin Discord
  - H2: Distribution
  - H2: Surface
...
- Chemin : /plugins/reference/document-extract
- Titres :
...
- Chemin : /plugins/reference/duckduckgo
- Titres :
...
- Chemin : /plugins/reference/elevenlabs
- Titres :
...
- Chemin : /plugins/reference/feishu
- Titres :
  - H1: Plugin Feishu
  - H2: Distribution
  - H2: Surface
...
- Chemin : /plugins/reference/file-transfer
- Titres :
...
- Chemin : /plugins/reference/firecrawl
- Titres :
  - H1: Plugin Firecrawl
  - H2: Distribution
  - H2: Surface
...
- Titres :
  ...
  - H2 : Ce que le cœur continue de posséder
  ...
  - H3 : Effets de bord de fin d’agent
...
- Titres :
  ...
  - H2 : Approbations et capacités des canaux
...
- Titres :
  ...
  - H2 : Plan de migration de la voix de conversation et en temps réel
...
- Titres :
  ...
  - H3 : Adaptateurs d’embeddings mémoire obsolètes
...
- Titres :
  ...
  - H3 : Importations étroites de helpers de configuration
...
- Titres :
  - H2 : Entrée de Plugin
  - H3 : Helpers de compatibilité et de test obsolètes
  - H3 : Sous-chemins d’helpers réservés aux plugins groupés
  - H2 : Connexe
...
- Titres :
  ...
  - H3 : Tests avec stubs par instance
  - H2 : Tests de contrat (plugins du dépôt)
  - H3 : Exécuter les tests limités au périmètre
...
- Titres :
  ...
  - H3 : Délai de grâce de déconnexion du stream Twilio
  ...
  - H2 : RPC Gateway
  - H2 : Dépannage
  - H3 : Échec de l’exposition Webhook lors de la configuration
  - H3 : Échec des identifiants fournisseur
  - H3 : Les appels démarrent, mais les Webhooks du fournisseur n’arrivent pas
  - H3 : Échec de la vérification de signature
  - H3 : Échec des jonctions Twilio à Google Meet
...
- Titres :
  - H2 : Bien démarrer
  - H2 : Configuration uniquement via l’environnement
  - H2 : Connexe
...
- Titres :
  ...
  - H2 : Pages de vue d’ensemble partagée
...
- Titres :
  ...
  - H2 : Nemotron 3 Ultra
  - H2 : Catalogue de fallback groupé
  - H2 : Configuration avancée
  - H2 : Connexe
...
- Titres :
  - H2 : Installer le Plugin
  - H2 : Bien démarrer
  - H2 : Types d’abonnements et points de terminaison
  - H2 : Catalogue intégré
...
- Titres :
  - H2 : Installer le Plugin
  - H2 : Vue d’ensemble de la région et du point de terminaison
  - H2 : Catalogue intégré
  - H2 : Bien démarrer
  - H2 : Configuration avancée
  - H2 : Connexe
...
- Titres :
  - H2 : Démarrage
  - H2 : Catalogue à la consommation
...
- Titres :
  ...
  - H3 : Phase 2 : nettoyage basé sur les baux
  - H3 : Phase 3 : élimination au démarrage basée sur les baux
...
- Titres :
  - H1 : Refactorisation de l’état centrée sur la base de données
  - H2 : Décision
  - H2 : Contrat strict
...
- Titres :
  - H1 : Plan de suppression du cœur Ingress
  - H2 : Budget
  - H2 : Diagnostic
  - H2 : Points sensibles
...
- Titres :
  - H2 : Première exécution (recommandée)
  ...
  - H2 : Skills principaux (activer dans Paramètres → Skills)
...
- Titres :
  ...
  - H3 : 6) Instantanés d’utilisation des fournisseurs (état/santé)
...
- Titres :
  ...
  - H2 : Phase 5 : renforcement des types, des contrats et des tests
...
- Titres :
  ...
  - H2 : Segments Docker du chemin de publication
...
- Titres :
  ...
  - H3 : Délai d’expiration des embeddings inline
...
- Titres :
  ...
  - H2 : Style recommandé
  - H2 : Éviter ces motifs dans la documentation
  - H2 : Exemple
...
- Titres :
  ...
  - H2 : Frontières des fragments de Compaction et appariement des outils
...
- Titres :
  ...
  - H2 : Première exécution (ponctuelle)
  - H2 : Conseil de sauvegarde (recommandé)
  - H2 : Paramètres de sécurité par défaut
  - H2 : Vérification préalable des solutions existantes
...
- Titres :
  - H1 : TOOLS.md - Notes utilisateur sur les outils (modifiable)
  - H2 : Exemples
  - H3 : imsg
  - H3 : sag
  - H2 : Lié
...
- Titres :
  ...
  - H3 : Exemple : garder un cache de 1 h chaud avec Heartbeat
  - H3 : Exemple : trafic mixte avec stratégie de cache par agent
  - H3 : Contexte Anthropic 1M
  - H2 : Conseils pour réduire la pression des tokens
  - H2 : Lié
...
- Titres :
  ...
  - H2 : Règle globale : appels d'outil mal formés
...
- Titres :
  ...
  - H3 : 4.2 Motifs de signalement de modération
...
- Titres :
  ...
  - H3 : Le dump du répertoire (3 déc. 2025)
...
- Titres :
  ...
  - H3 : Pièges courants
  - H2 : Carte de stockage des identifiants
  - H2 : Mettre à jour (sans casser votre configuration)
...
- Titres :
  ...
  - H2 : Est-ce que cela fonctionne immédiatement ?
  - H2 : Cibles de harness prises en charge
  ...
  - H2 : Modes de liaison spawn et de thread
  ...
  - H2 : Harness acpx, configuration de Plugin et autorisations
  - H2 : Dépannage
  - H2 : Connexe
...
- Titres :
  ...
  - H3 : Solution 2 : utiliser Snap Chromium avec le mode attachement uniquement
...
- Titres :
  ...
  - H2 : Bac à sable + accès au navigateur de l’hôte
  - H2 : Connexe
...
- Titres :
  ...
  - H3 : Configuration persistante « ne jamais demander » pour gateway-host
  - H3 : Raccourci local
  - H3 : Hôte Node
  ...
  - H2 : Édition dans l’interface de contrôle
...
- Titres :
  ...
  - H2 : Fonctionnement
  - H2 : Modèle : petite CLI + pipes JSON + approbations
...
- Titres :
  ...
  - H2 : Synthèse vocale et Voice Call
  - H2 : Mappages des fournisseurs (comment les fournisseurs se répartissent entre les surfaces)
  - H2 : Connexe
...
- Titres :
  ...
  - H2 : Racines de Skills liées par lien symbolique
...
- Titres :
  ...
  - H2 : Ajuster le délai d’expiration de vidage
...
- Titres :
  ...
  - H3 : Liste de vérification du réglage systemd (facultatif)
  - H2 : Articles connexes
...
- Titres :
  ...
  - H2 : Authentification de la route des médias d’assistant
