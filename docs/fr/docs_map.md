...
x-i18n:
    generated_at: "2026-07-01T12:57:54Z"
    model: gpt-5.5
...
- Titres :
  ...
  - H2: Messagerie compatible avec l’ancien système
  - H2: Associé
...
- Titres :
  - H2: Quand utiliser le flux de tâches
...
- Titres :
  ...
  - H2: Exemples de configuration de groupes
  - H3: Autoriser tous les groupes, sans @mention requise
  - H3: Autoriser tous les groupes, mais exiger toujours une @mention
...
- Titres :
  ...
  - H2: Modèles de mention configurés par portée
...
- Titres :
  ...
  - H2: Récupération entrante après redémarrage d’un pont ou du Gateway
...
- Titres :
  ...
  - H3: Mêmes outils pour tous dans le canal
...
- Titres :
  ...
  - H3: Normalisation des ID de compte
...
- Titres :
  ...
  - H2: Nouvelle tentative pour le canal de messages directs
...
- Titres :
  - H2: 1) Appairage de messages directs (accès au chat entrant)
  ...
  - H3: Approbation automatique facultative de Node CIDR de confiance
...
- Titres :
  ...
  - H2: Repli sur réaction de saisie
...
- Titres :
  ...
  - H2 : Comportement des numéros personnels et de l’auto-conversation
...
- Titres :
  ...
  - H3 : Limiter les DM à des utilisateurs spécifiques
...
- Titres :
  ...
  - H2 : Comportement avec une configuration invalide
...
- Titres :
  ...
  - H2 : Modes config set
  - H2 : config patch
  - H2 : Flags du constructeur de fournisseur
  - H2 : Dry run
...
- Titres :
  ...
  - H2 : Approbation au premier lancement de Paperclip / openclawgateway
...
- Titres :
  ...
  - H2 : Options
  - H2 : Mode lint
  - H2 : Vérifications d’intégrité structurées
...
- Titres :
  ...
  - H3 : gateway status
  - H3 : gateway probe
  - H4 : Distant via SSH (parité avec l’application Mac)
  - H3 : gateway call
...
- Titres :
  ...
  - H2 : Modes de requête
  - H2 : Styles de prompt
  - H2 : Politique de solution de repli du modèle
  ...
  - H2 : Configuration
  - H2 : Configuration recommandée
  - H3 : Période de grâce au démarrage à froid
  - H2 : Débogage
...
- Titres :
  ...
  - H3 : Hooks de Plugin (cycle de vie de l’agent + Gateway)
...
- Titres :
  ...
  - H2 : Exemple : assistant d’organisation
...
- Titres :
  ...
  - H3 : Quelles erreurs font progresser la bascule
  - H3 : Saut sur délai de récupération ou comportement de sondage
...
- Titres :
  ...
  - H3: Phase 1 : contrats de voie + travaux lourds en arrière-plan
...
- Titres :
  ...
  - H2: Avertissement distant/tunnel (IP de boucle locale)
  - H2: Consommateurs
...
- Titres :
  ...
  - H2: "Diffuser les fragments ou tout"
  ...
  - H3: Voie de progression de commentary
  - H2: Connexe
...
- Titres :
  ...
  - H2: Fonctionnement
  - H2: Sessions
  - H2: Préambule de repli depuis les sessions claude-cli
...
- Titres :
  ...
  - H3: Verrouillage par mention dans les discussions de groupe
...
- Titres :
  ...
  - H3 : Profils d’outils
  - H3 : Groupes d’outils
  - H3 : Outils MCP et Plugin dans la politique d’outils sandbox
  - H3 : tools.codeMode
...
- Titres :
  - H2 : Démarrage rapide
  - H3 : Minimum absolu
  - H3 : Point de départ recommandé
  - H2 : Exemple développé (options principales)
  - H3 : Dépôt de Skills frère lié par symlink
  - H2 : Modèles courants
  - H3 : Référence commune de Skills avec une substitution
...
- Titres :
  ...
  - H2 : Association + authentification (transport direct)
...
- Titres :
  ...
  - H2 : Valeurs par défaut
  - H2 : À quoi sert le prompt de heartbeat
...
- Titres :
  ...
  - H2 : Formatage de la console (journalisation par sous-système)
  - H2 : Connexe
...
- Titres :
  ...
  - H2 : Approbations d’association d’appareil
  - H2 : Approbations d’association de nœud
...
- Titres :
  - H2 : Concepts
  - H2 : Fonctionnement de l’association
  ...
  - H2 : Approbation automatique d’appareil par CIDR de confiance
  - H2 : Approbation automatique par mise à niveau des métadonnées
  - H2 : Assistants d’association QR
...
- Titres :
  ...
  - H2 : Repli de livraison à l’agent
  - H2 : Versionnage
  - H3 : Constantes client
  - H2 : Authentification
  - H2 : Identité de l’appareil + association
...
- Titres :
  ...
  - H3: « Je pensais que c’était le principal, pourquoi est-ce en bac à sable ? »
  - H2: Liens connexes
...
- Titres :
  ...
  - H2: Données d’authentification SSH du bac à sable
...
- Titres :
  ...
  - H2: Plugins
  - H2: Modèle d’accès DM : appairage, allowlist, ouvert, désactivé
...
- Titres :
  ...
  - H2: Backend local compatible OpenAI réussi aux sondes directes, mais échec des exécutions d’agent
  - H2: Aucune réponse
  ...
  - H2: Si vous avez mis à niveau et que quelque chose a soudainement cassé
  - H2: Liens connexes
...
- Titres :
  ...
  - H2: Identifiants (ne jamais commiter)
...
- Titres :
  ...
  - H2: Évaluations de fiabilité de l’agent (skills)
  - H2: Tests de contrat (forme des plugins et des canaux)
  - H3: Commandes
  - H3: Contrats de canal
  - H3: Contrats de statut des fournisseurs
...
- Titres :
  ...
  - H2: L’assistant semble limité ou il lui manque des outils
...
- Titres :
  ...
  - H2: Mises à jour
  - H3: Mettre à jour la commande de la machine
...
- Titres :
  ...
  - H2: Ce qui reste uniquement dans les archives
...
- Titres :
  ...
  - H3 : Échecs de vérification de l’état
  - H2 : Étapes suivantes
...
- Titres :
  ...
  - H2 : Exemples de configuration
  - H3 : Repli fournisseur + CLI (OpenAI + Whisper CLI)
...
- Titres :
  ...
  - H3 : Assistant CLI (appel de nœud)
...
- Titres :
  ...
  - H2 : Exécuter les tests du runtime Agent
  - H2 : Tests manuels
...
- Titres :
  ...
  - H3 : 7. Normaliser l’utilisation et le contexte de runtime du cache d’invite
...
- Titres :
  - H2 : Instantané de la prise en charge
  - H2 : Contrôle système
...
- Titres :
  ...
  - H2 : Liste de récupération quand les invites disparaissent
...
- Titres :
  ...
  - H2 : Spécificités d’appuyer-pour-parler
...
- Titres :
  ...
  - H2 : Exemple complet : génération d’images
...
- Titres :
  ...
  - H3 : ownsNativeCompaction : se soustraire à la compaction OpenClaw
...
- Titres :
  ...
  - H3 : Déploiement Codex à fermeture sûre
...
- Titres :
  ...
  - H2 : Liste de vérification de l’auteur du plugin
  - H2 : Docs associées
...
- Titres :
  ...
  - H3 : Middleware de résultats d’outil
...
- Titres :
  ...
  - H2 : Plan de migration talk et voix en temps réel
...
- Titres :
  ...
  - H2 : Entrée de setup
  - H3 : Importations étroites des helpers de setup
...
- Titres :
  ...
  - H3 : Simulation du runtime de Plugin
  - H3 : Test avec stubs par instance
...
- Titres :
  ...
  - H2 : Démarrage rapide
  - H2 : Écrire un outil
  - H2 : Outils optionnels et factory
...
- Titres :
  ...
  - H2 : RPC Gateway
  - H2 : Dépannage
  - H3 : Le setup échoue à exposer le Webhook
  - H3 : Les identifiants du fournisseur échouent
  - H3 : Les appels démarrent mais les Webhooks fournisseur n’arrivent pas
...
- Titres :
  ...
  - H2 : Exemple : recherche et synthèse en parallèle
...
- Titres :
  - H2 : Premiers pas
  - H2 : Configuration uniquement par environnement
  - H2 : Articles connexes
...
- Titres :
  - H2 : Pourquoi utiliser Venice dans OpenClaw
  - H2 : Modes de confidentialité
  - H2 : Fonctionnalités
  - H2 : Premiers pas
  - H2 : Sélection de modèle
  - H2 : Comportement de rejeu de DeepSeek V4
...
- Route : /providers/xai
- Titres :
  - H2 : Choisissez votre chemin de configuration
  - H2 : Dépannage OAuth
  - H2 : Catalogue intégré
  - H2 : Couverture des fonctionnalités OpenClaw
...
- Titres :
  ...
  - H3 : Phase 2 : Nettoyage donnant priorité aux baux
  - H3 : Phase 3 : Purge au démarrage donnant priorité aux baux
...
- Titres :
  ...
  - H2 : Plan de migration
  - H3 : Phase 0 : Geler la limite
  - H3 : Phase 1 : Finaliser le plan de contrôle global
  - H3 : Phase 2 : Introduire les bases de données par agent
  - H3 : Phase 3 : Remplacer les API de stockage de sessions
  - H3 : Phase 4 : Déplacer les transcriptions, flux ACP, trajectoires et VFS
  - H3 : Phase 5 : Sauvegarder, restaurer, nettoyer et vérifier
  - H3 : Phase 6 : Environnement d’exécution du worker
  - H3 : Phase 7 : Supprimer l’ancien monde
  - H2 : Sauvegarde et restauration
  - H2 : Plan de refactorisation de l’exécution
...
- Titres :
  ...
  - H3 : QA Lab
  - H3 : Paquet
  - H2 : Automatisation de publication de version
...
- Titres :
  ...
  - H2 : Maintenance du stockage et contrôles de disque
  - H2 : Sessions Cron et journaux d’exécution
  - H2 : Clés de session (sessionKey)
  - H2 : Identifiants de session (sessionId)
  - H2 : Schéma du stockage de sessions (sessions.json)
  - H2 : Structure de transcription (.jsonl)
  - H2 : Fenêtres de contexte vs jetons suivis
  - H2 : Compaction : ce que c’est
  - H2 : Limites de segments de Compaction et appariement des outils
  - H2 : Quand l’auto-Compaction se produit (exécution OpenClaw)
...
- Titres :
  ...
  - H3 : 4.2 Modèles de signalement de modération
...
- Titres :
  - H2 : Fraîchement venu de Discord
...
- Titres :
  - H2 : Prise en charge du harnais acpx (actuel)
  - H2 : Configuration requise
...
- Titres :
  ...
  - H3 : Solution 2 : utiliser Snap Chromium en mode connexion uniquement
...
- Titres :
  ...
  - H2 : Profils : openclaw par rapport à utilisateur
  - H2 : Configuration
  ...
  - H2 : Garanties d’isolement
  - H2 : Sélection du navigateur
  - H2 : API de contrôle (facultatif)
  - H2 : Dépannage
  - H3 : Échec du démarrage CDP par rapport au blocage SSRF de navigation
...
- Titres :
  ...
  - H3 : Configuration d’URL persistante de la visionneuse
...
- Titres :
  ...
  - H3 : Validation d’argv et flags refusés
...
- Titres :
  ...
  - H2 : Dépannage
  - H3 : Propriété du chemin de plugin bloquée
...
- Titres :
  ...
  - H2 : Liste d’autorisation des Skills incluses
...
- Titres :
  ...
  - H3 : Commandes des plugins inclus
...
- Titres :
  - H2 : Session actuelle
  - H2 : Orienter vs mettre en file d’attente
  - H2 : Sous-agents
  - H2 : Sessions ACP
  - H2 : Connexe
...
- Titres :
  ...
  - H2 : Directives de trace du plugin (/trace)
...
- Titres :
  ...
  - H2 : Construction de l’UI
  - H2 : Page UI de contrôle vide
...
- Titres :
  ...
  - H2 : Panneau d’outils des agents de l’UI de contrôle
