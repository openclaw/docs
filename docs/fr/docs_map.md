...
x-i18n:
    generated_at: "2026-06-30T14:01:02Z"
    model: gpt-5.5
...
- Titres :
  ...
  - H2 : Écriture de points d’accroche
  - H3 : Structure d’un point d’accroche
  - H3 : Format HOOK.md
  - H3 : Implémentation du gestionnaire
  - H3 : Points clés du contexte d’événement
  - H2 : Découverte des points d’accroche
  - H3 : Packs de points d’accroche
  - H2 : Points d’accroche inclus
  ...
  - H2 : Points d’accroche de Plugin
  - H2 : Configuration
  - H2 : Référence CLI
  - H2 : Bonnes pratiques
  - H2 : Dépannage
  - H3 : Point d’accroche non découvert
  - H3 : Point d’accroche non éligible
  - H3 : Point d’accroche non exécuté
  - H2 : Connexe
...
- Titres :
  ...
  - H2 : Motif exécuter-vérifier-rapporter
...
- Titres :
  ...
  - H2 : Motif de flux de travail planifié fiable
...
- Titres :
  ...
  - H2 : Outils et garde-fous d’action
...
- Titres :
  ...
  - H3 : Autoriser tous les groupes, exiger quand même une @mention
  ...
  - H2 : Isolation d’agent par utilisateur (création dynamique d’agents)
...
- Titres :
  ...
  - H2 : Clés de session
  - H2 : Motif : DM personnels + groupes publics (agent unique)
...
- Titres :
  ...
  - H3 : Outils différents par expéditeur (le propriétaire a plus de pouvoir)
  - H2 : NickServ
...
- Titres :
  ...
  - H3: Formats de cibles en liste d’autorisation
  ...
  - H3: Statut et signaux de confiance
  ...
  - H2: Politique de messages directs et de salons
  - H2: Réparation de salon direct
  - H2: Approbations d’exécution
  - H2: Commandes slash
  - H2: Multi-compte
  - H2: Homeservers privés/LAN
  - H2: Relayer le trafic Matrix via proxy
...
- Titres :
  ...
  - H2: Nouvelle tentative pour canal de message direct
...
- Titres :
  ...
  - H2: Objectifs
  - H2: Écritures de configuration
  - H2: Contrôle d’accès (messages directs + groupes)
  - H3: Fonctionnement
  ...
  - H3: Mises en garde sur le manifeste (champs indispensables)
  ...
  - H3: RSC vs Graph API
  - H2: Médias et historique activés par Graph (requis pour les canaux)
...
- Titres :
  ...
  - H2: Contrôle d’accès
  - H3: Politiques de messages directs
...
- Titres :
  - H2: 1) Appairage par message direct (accès au chat entrant)
  ...
  - H3: Approbation automatique facultative de Node par CIDR approuvé
...
- Titres :
  ...
  - H2: Parcours de configuration A : lier un compte Signal existant (QR)
...
- Titres :
  ...
  - H2: Configuration rapide
  - H2: Variables d’environnement
  - H2: Politique de messages directs et contrôle d’accès
...
- Titres :
  ...
  - H2 : Barrières de vérification locales et routage des changements
...
- Titres :
  ...
  - H2 : Connexion et déconnexion (interactive)
  - H2 : Dépannage
...
- Titres :
  ...
  - H2 : config patch
  - H2 : Flags du générateur de fournisseurs
  - H2 : Essai à blanc
...
- Titres :
  ...
  - H3 : Refus structurés
  - H2 : Rétention
  - H2 : Migration d’anciennes tâches
...
- Titres :
  ...
  - H2 : Approbation de première exécution de Paperclip / openclawgateway
  - H3 : openclaw devices reject
  - H3 : openclaw devices rotate --device --role [--scope ]
  - H3 : openclaw devices revoke --device --role
  - H2 : Options courantes
  - H2 : Notes
  - H2 : Liste de vérification de récupération après dérive des jetons
  - H2 : Associé
...
- Titres :
  ...
  - H3 : gateway status
  - H3 : gateway probe
  - H4 : À distance via SSH (parité de l’application Mac)
  - H3 : gateway call
...
- Titres :
  ...
  - H3 : Définitions de serveur MCP enregistrées
...
- Titres :
  ...
  - H3 : État de l’archive et de la revue manuelle
...
- Titres :
  ...
  - H2 : Auth Gateway pour l’hôte de nœud
...
- Titres :
  - H1 : openclaw secrets
  - H2 : Recharger l’instantané runtime
  - H2 : Audit
...
- Titres :
  ...
  - H2 : Commandes
  - H2 : Sortie
  - H2 : De nombreuses réunions par jour
...
- Titres :
  ...
  - H2 : Modes de requête
  - H2 : Styles de prompt
  - H2 : Stratégie de fallback de modèle
...
- Titres :
  ...
  - H2 : Ne pas commettre de secrets
...
- Titres :
  ...
  - H2 : Skills : injectées vs chargées à la demande
...
- Titres :
  ...
  - H2 : Performance et compatibilité de la recherche
...
- Titres :
  ...
  - H2 : Relation avec l’entrant du canal
  ...
  - H3 : Phase 3 : passerelle entrante de canal
  - H3 : Phase 4 : passerelle de dispatcher préparé
...
- Titres :
  ...
  - H3 : Persistance de session (compatible cache)
  ...
  - H3 : Comportement d’évitement sur délai de récupération vs sonde
...
- Titres :
  ...
  - H2 : Modèles courants
  - H2 : Sandbox par agent et configuration des outils
  - H2 : Connexe
...
- Titres :
  ...
  - H3 : Phase 1 : contrats de voies + travaux lourds en arrière-plan
...
- Titres :
  ...
  - H3 : Diffusion multimédia avec le streaming par blocs
...
- Titres :
  ...
  - H2 : Charges utiles d’outil + connecteurs (heure brute du fournisseur + champs normalisés)
  - H2 : Docs associées
...
- Titres :
  ...
  - H2 : Supprimer l’authentification fournisseur pendant l’exécution du Gateway
...
- Titres :
  ...
  - H2 : Limite de réensemencement d’historique
  - H2 : Limitations
  - H2 : Dépannage
  - H2 : Associé
...
- Titres :
  ...
  - H3 : Valeurs par défaut et Heartbeat du canal
  - H3 : WhatsApp
  - H3 : Telegram
  - H3 : Discord
  - H3 : Google Chat
  ...
  - H3 : Autres canaux Plugin
  - H3 : Gating de mention en discussion de groupe
...
- Titres :
  ...
  - H3 : Approbation automatique du réseau de nœuds approuvé
...
- Titres :
  ...
  - H2 : Débordement du contexte après le Heartbeat
  - H2 : Associé
...
- Titres :
  ...
  - H3 : Télémétrie de vitalité des sessions
...
- Titres :
  ...
  - H2 : Flux de travail CLI (adapté au sans-interface)
  - H2 : Surface d’API (protocole Gateway)
  - H2 : Garde des commandes de nœud (2026.3.31+)
...
- Titres :
  ...
  - H3 : Caps/commandes/permissions (nœud)
  - H2 : Présence
  - H3 : Événement de nœud actif en arrière-plan
  - H2 : Délimitation de portée des événements diffusés
  ...
  - H3 : Diagnostics de migration de l’authentification d’appareil
  - H2 : TLS + épinglage
  - H2 : Portée
  - H2 : Associé
...
- Titres :
  ...
  - H2 : Corrections courantes de « prison sandbox »
  - H3 : « Outil X bloqué par la politique d’outils de la sandbox »
  - H3 : « Je pensais que c’était le principal, pourquoi est-il en sandbox ? »
  - H2 : Connexe
...
- Titres :
  - H2 : Ce qui est placé en sandbox
  - H2 : Modes
  - H2 : Portée
  - H2 : Backend
...
- Titres :
  ...
  - H2 : Le Gateway quitte lors d’une forte utilisation mémoire
...
- Titres :
  - H2 : Priorité (du plus élevé au plus faible)
  ...
  - H2 : Journalisation
  - H3 : OPENCLAWHOME
  - H2 : Utilisateurs nvm : échecs TLS webfetch
...
- Titres :
  ...
  - H2 : Commandes de discussion, abandon de tâches et « cela ne s’arrête pas »
  - H2 : Divers
  - H2 : Connexe
...
- Titres :
  - H2 : Live : commandes de vérification locale rapide
  - H2 : Live : balayage des capacités du nœud Android
  - H2 : Live : vérification rapide du modèle (clés de profil)
  - H3 : Couche 1 : complétion directe du modèle (sans Gateway)
  - H3 : Couche 2 : Gateway + vérification rapide de l’agent de développement (ce que fait réellement « @openclaw »)
  - H2 : Live : vérification rapide du backend CLI (Claude, Gemini ou autres CLI locales)
  - H2 : Live : accessibilité du proxy APNs HTTP/2
  - H2 : Live : vérification rapide de liaison ACP (/acp spawn ... --bind here)
  - H2 : Live : vérification rapide du harnais de serveur d’application Codex
  - H3 : Recettes live recommandées
  - H2 : Live : matrice de modèles (ce que nous couvrons)
  - H3 : Ensemble de vérification rapide moderne (appel d’outils + image)
...
- Titres :
  ...
  - H3 : Problèmes de verrou Gateway
  ...
  - H3 : Avantages en matière de sécurité
  - H2 : Notes
  - H2 : Coût
  - H2 : Étapes suivantes
  - H2 : Connexe
...
- Titres :
  ...
  - H2 : Ce qui reste en archive seulement
...
- Titres :
  ...
  - H3 : Répercuter la transcription dans la discussion (opt-in)
  - H2 : Notes et limites
...
- Titres :
  ...
  - H3 : 3. Câbler le bootstrap avant le démarrage du fil de discussion Codex
  ...
  - H3 : 6. Câbler l’après-tour après la mise en miroir de la transcription
...
- Titres :
  ...
  - H4 : Découverte Tailnet (Vienne ⇄ Londres) via DNS-SD monodiffusion
...
- Titres :
  ...
  - H2 : Autorisations d’accessibilité pour les environnements Node et CLI
  - H2 : Liste de vérification de récupération lorsque les invites disparaissent
  - H2 : Autorisations fichiers et dossiers (Desktop/Documents/Downloads)
  - H2 : Connexe
...
- Titres :
  ...
  - H3 : PeekabooBridge (automatisation de l’UI)
...
- Titres :
  - H2 : Modèle de capacités publiques
...
- Titres :
  ...
  - H2 : Téléversement de commentaires Codex
...
- Titres :
  ...
  - H3 : Déploiement Codex en fermeture sécurisée
...
- Titres :
  ...
  - H2 : Configuration d’application du thread
...
- Titres :
  ...
  - H2 : Paquet d’inspection de Plugin
...
- Titres :
  ...
  - H3 : Chrome
  - H3 : Twilio
  - H2 : OAuth et contrôles préalables
  ...
  - H2 : Liste de contrôle du test live
  - H2 : Dépannage
...
- Titres :
  ...
  - H2 : Liste de contrôle pour auteurs de Plugin
  - H2 : Documentation associée
...
- Titres :
  - H2 : Choisir le bon point de contrôle
...
- Titres :
  ...
  - H2 : Politique des mentions entrantes
...
- Titres :
  ...
  - H2 : Plan de migration de la conversation et de la voix temps réel
...
- Titres :
  ...
  - H3 : Infrastructure
  - H3 : Hooks hôte pour Plugins de workflow
...
- Titres :
  ...
  - H3 : Importations étroites d’assistants de configuration
  - H3 : Promotion d’un compte unique détenue par le canal
...
- Titres :
  ...
  - H2 : Tests de contrat (Plugins internes au dépôt)
  - H3 : Exécuter des tests limités au périmètre
  - H2 : Application du lint (Plugins internes au dépôt)
...
- Titres :
  ...
  - H3 : Package 'typebox' introuvable
...
- Titres :
  ...
  - H3 : Points d’entrée du dispatch
...
- Titres :
  ...
  - H2 : Plongements de recherche mémoire
  - H3 : Configuration
  - H3 : Fonctionnement
  - H2 : Voir aussi
...
- Titres :
  ...
  - H3 : Phase 2 : nettoyage axé d’abord sur les baux
  - H3 : Phase 3 : récupération au démarrage axée d’abord sur les baux
...
- Titres :
  - H1 : Refactorisation de l’état avec priorité à la base de données
  - H2 : Décision
  - H2 : Contrat strict
...
- Titres :
  ...
  - H2 : Skills principales (activer dans Settings → Skills)
...
- Titres :
  ...
  - H3 : QA Lab
  - H3 : Package
  - H2 : Automatisation de publication de release
...
- Titres :
  ...
  - H3 : Base de référence axée sur le coût
...
- Titres :
  ...
  - H2 : Maintenance du stockage et contrôles du disque
  - H2 : Sessions Cron et journaux d’exécution
  - H2 : Clés de session (sessionKey)
  - H2 : Identifiants de session (sessionId)
  - H2 : Schéma du stockage de session (sessions.json)
  - H2 : Structure de transcription (.jsonl)
  - H2 : Fenêtres de contexte ou jetons suivis
  - H2 : Compaction : ce que c’est
  - H2 : Limites de morceaux de Compaction et appariement des outils
...
- Chemin : /reference/templates/SOUL.dev
- Titres :
...
- Chemin : /reference/templates/SOUL
- Titres :
...
- Chemin : /reference/templates/TOOLS.dev
- Titres :
...
- Chemin : /reference/templates/TOOLS
- Titres :
...
- Chemin : /reference/templates/USER.dev
- Titres :
...
- Chemin : /reference/templates/USER
- Titres :
...
- Chemin : /reference/test
- Titres :
  - H2: Garde locale de PR
  - H2: Banc d’essai de latence des modèles (clés locales)
  - H2: Banc d’essai du démarrage de la CLI
  - H2: Banc d’essai du démarrage du Gateway
  - H2: Banc d’essai du redémarrage du Gateway
...
- Titres :
  ...
  - H2: Incidence du TTL du cache et de l’élagage
...
- Chemin : /reference/transcript-hygiene
- Titres :
...
- Chemin : /security/CONTRIBUTING-THREAT-MODEL
- Titres :
...
- Chemin : /security/THREAT-MODEL-ATLAS
- Titres :
  - H2: Cadre MITRE ATLAS
  - H3: Attribution du cadre
  - H3: Contribution à ce modèle de menace
  - H2: 1. Introduction
  - H3: 1.1 Objectif
  - H3: 1.2 Portée
  - H3: 1.3 Hors portée
  ...
  - H4: T-RECON-001: Découverte de points de terminaison d’agent
  - H4: T-RECON-002: Sondage des intégrations de canal
  - H3: 3.2 Accès initial (AML.TA0004)
  - H4: T-ACCESS-001: Interception de code d’appairage
  - H4: T-ACCESS-002: Usurpation AllowFrom
  - H4: T-ACCESS-003: Vol de tokens
...
- Chemin : /security/formal-verification
- Titres :
  ...
  - H3: Filtrage en entrée (mentions + contournement des commandes de contrôle)
  ...
  - H3: Corrélation de traces en entrée / idempotence
  - H3: Priorité dmScope du routage + identityLinks
  - H2: Articles connexes

## security/incident-response.md

- Chemin : /security/incident-response
- Titres :
...
- Titres :
  ...
  - H3: La virée shopping robotique (3 déc. 2025)
  - H2: Textes sacrés
...
- Chemin : /start/onboarding-overview
- Titres :
...
- Chemin : /start/onboarding
- Titres :
  - H2: Articles connexes

## start/openclaw.md

- Chemin : /start/openclaw
- Titres :
...
- Titres :
  ...
  - H2: Stratégie d’adaptation (pour que les mises à jour ne causent pas de problème)
...
- Chemin : /start/showcase
- Titres :
  - H2: Fraîchement depuis Discord
...
- Chemin : /start/wizard-cli-automation
- Titres :
...
- Chemin : /start/wizard-cli-reference
- Titres :
...
- Titres :
  ...
  - H2 : Est-ce que cela fonctionne prêt à l’emploi ?
  - H2 : Cibles de harness prises en charge
  - H2 : Runbook opérateur
  - H2 : ACP contre sous-agents
  ...
  - H2 : Modes de liaison au spawn et de fil
  ...
  - H2 : Harness acpx, configuration du Plugin et permissions
  - H2 : Dépannage
  - H2 : Connexe
...
- Titres :
  ...
  - H3 : Config d’URL de visionneuse persistante
  - H2 : Config de sécurité
  - H2 : Cycle de vie et stockage des artefacts
  - H2 : URL de visionneuse et comportement réseau
  - H2 : Modèle de sécurité
  - H2 : Exigences de navigateur pour le mode fichier
  - H2 : Dépannage
...
- Titres :
  ...
  - H2 : Transfert d’approbation vers les canaux de chat
...
- Titres :
  ...
  - H2 : Résoudre les outils manquants
  - H2 : Connexe
...
- Titres :
  ...
  - H2 : Reconnaissance vocale et Voice Call
  - H2 : Mappages de fournisseurs (comment les fournisseurs se répartissent entre les surfaces)
  - H2 : Connexe
...
- Titres :
  ...
  - H2 : Comprendre les formats de Plugins
  - H2 : Hooks de Plugins
...
- Titres :
  ...
  - H3 : Chaîne d’annonce
  - H3 : Politique des outils par profondeur
...
- Titres :
  ...
  - H3 : Personnalité complète (prompt neutre vis-à-vis du fournisseur)
  - H3 : Résolution de personnalité
  - H3 : Comment les fournisseurs utilisent les prompts de personnalité
...
- Titres :
  ...
  - H2 : Compiler l’interface utilisateur
...
- Titres :
  ...
  - H2 : Panneau des outils d’agents de Control UI
