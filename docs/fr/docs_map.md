...
x-i18n:
    generated_at: "2026-07-04T15:14:41Z"
    model: gpt-5.5
...
- Titres :
  ...
  - H2: Messagerie compatible héritage
  - H2: Voir aussi
...
- Titres :
  ...
  - H2: Commandes CLI
  - H2: Relation entre les flows et les tâches
  - H2: Voir aussi
...
- Titres :
  ...
  - H2: Voix
  - H3: Canaux vocaux
  - H3: Suivre les utilisateurs dans la voix
  - H3: Messages vocaux
  - H2: Dépannage
...
- Titres :
  ...
  - H3: Autoriser tous les groupes, exiger tout de même une @mention
...
- Titres :
  ...
  - H2: Barrière par mention (par défaut)
...
- Titres :
  ...
  - H2: Médias, découpage en segments et cibles de livraison
  - H2: Actions de l’API privée
  - H2: Écritures de configuration
  - H2: Fusion des DM à envoi scindé (commande + URL dans une seule composition)
...
- Itinéraire : /channels/matrix-migration
- Titres :
...
- Itinéraire : /channels/matrix-presentation
- Titres :
...
- Itinéraire : /channels/matrix-push-rules
- Titres :
  - H2: Prérequis
  - H2: Étapes
  - H2: Notes sur les bots multiples
  - H2: Notes sur le serveur d’accueil
  - H2: Associé

## channels/matrix.md

- Itinéraire : /channels/matrix
- Titres :
  - H2: Installer
  - H2: Configuration
  - H3: Configuration interactive
  - H3: Configuration minimale
  - H3: Jointure automatique
  ...
  - H3: Règles push auto-hébergées pour des aperçus finalisés discrets
  - H2: Salons bot-à-bot
...
- Itinéraire : /channels/mattermost
- Titres :
  - H2: Installer
  - H2: Configuration rapide
...
- Titres :
  ...
  - H3: Mises en garde du manifeste (champs obligatoires)
  - H3: Mettre à jour une application existante
  - H2: Capacités : RSC seulement vs Graph
  - H3: Avec Teams RSC seulement (application installée, aucune autorisation d’API Graph)
  - H3: Avec Teams RSC + autorisations d’application Microsoft Graph
  - H3: RSC vs API Graph
  - H2: Médias et historique activés par Graph (obligatoire pour les canaux)
  - H2: Limites connues
  - H3: Délais d’expiration du Webhook
...
- Itinéraire : /channels/nextcloud-talk
- Titres :
  - H2: Plugin groupé
  - H2: Configuration rapide (débutant)
  - H2: Notes
...
- Titres :
  ...
  - H3: Approbation automatique facultative des nœuds trusted-CIDR
...
- Itinéraire : /channels/qa-channel
- Titres :
  - H2: Ce qu’il fait
  - H2: Configuration
  - H2: Exécuteurs
...
- Itinéraire : /channels/synology-chat
- Titres :
  - H2: Plugin groupé
  - H2: Configuration rapide
  - H2: Variables d’environnement
...
- Itinéraire : /channels/troubleshooting
- Titres :
  - H2: Échelle des commandes
...
- Titres :
  ...
  - H2 : Comportement des numéros personnels et des discussions avec soi-même
...
- Titres :
  ...
  - H2 : Long-polling contre webhook
  - H2 : Types de messages pris en charge
  - H2 : Capacités
  - H2 : Cibles de livraison (CLI/cron)
  - H2 : Dépannage
...
- Titres :
  ...
  - H2 : Validation complète de publication
...
- Titres :
  ...
  - H3 : Format --bind
  - H3 : Comportement de portée de liaison
...
- Titres :
  ...
  - H2 : Options courantes
  - H2 : Notes
  - H2 : Liste de vérification de récupération après dérive de jeton
  - H2 : Connexe
...
- Titres :
  ...
  - H2 : Pourquoi aucune sauvegarde de rollback
  - H2 : Exemple
  - H2 : Associé
...
- Titres :
  - H2 : Ce qu’il ajoute par rapport à l’intégrée
  - H2 : Premiers pas
  - H3 : Prérequis
  - H3 : Activer
...
- Titres :
  ...
  - H2 : Plugin compagnon Wiki de mémoire
...
- Titres :
  ...
  - H2 : Relation avec les entrées de canal
  ...
  - H3 : Phase 3 : passerelle d’entrée de canal
  - H3 : Phase 4 : passerelle de répartiteur préparé
...
- Titres :
  ...
  - H2 : Métadonnées de résultat d’outil
  - H2 : Corps entrants et contexte d’historique
  - H2 : Mise en file d’attente et suivis
  - H2 : Propriété de l’exécution de canal
  - H2 : Streaming, découpage et regroupement par lots
...
- Titres :
  ...
  - H3 : Évitement du délai de récupération ou comportement de sonde
  - H2 : Remplacements de session et changement de modèle en direct
  - H2 : Observabilité et résumés de défaillance
...
- Titres :
  - H2 : Règles rapides
  - H2 : Comportement des fournisseurs détenu par le Plugin
...
- Titres :
  - H2 : Qu’est-ce qu’un « agent unique » ?
  ...
  - H2 : Un numéro WhatsApp, plusieurs personnes (séparation des messages directs)
...
- Titres :
  - H2 : Le collecteur de jetons (pourquoi il existe)
  - H2 : Stockage (où vivent les jetons)
  - H2 : Compatibilité avec les jetons Anthropic hérités
...
- Titres :
  ...
  - H2 : Réserve distant/tunnel (IP de loopback)
  - H2 : Consommateurs
...
- Titres :
  ...
  - H2 : « Streamer des fragments ou tout »
...
- Route : /date-time
- Titres :
  - H2 : Enveloppes de message (local par défaut)
  - H3 : Exemples
  - H2 : Prompt système : date et heure actuelles
  - H2 : Lignes d’événement système (local par défaut)
...
- Titres :
  - H2 : Configuration recommandée (clé d’API, n’importe quel fournisseur)
...
- Titres :
  - H2 : Bonjour à grande échelle (DNS-SD unicast) via Tailscale
...
- Titres :
  ...
  - H3 : Contrôle des mentions en discussion de groupe
  - H4 : Limites de l’historique des MP
...
- Titres :
  ...
  - H3 : Détails du champ fournisseur
...
- Titres :
  ...
  - H3 : Approbation automatique d’un réseau de Node de confiance
  - H3 : Mode MP sécurisé (boîte de réception partagée / MP multi-utilisateurs)
  - H3 : Clé d’API Anthropic + secours MiniMax
...
- Titres :
  - H2 : Termes
  - H2 : Pourquoi nous gardons à la fois direct et SSH
...
- Titres :
  ...
  - H2 : Remplissage rétroactif et réinitialisation de l’interface Dreams
...
- Titres :
  ...
  - H3 : Configuration hybride : principal hébergé, secours local
...
- Titres :
  - H1 : Journalisation
  - H2 : Journaliseur basé sur les fichiers
...
- Titres :
  ...
  - H2 : Contrat de modèle axé agent
...
- Titres :
  ...
  - H2 : Approbations d’appairage de Node
...
- Titres :
  ...
  - H2 : Contrôle des commandes de Node (2026.3.31+)
  - H2 : Frontières de confiance des événements de Node (2026.3.31+)
...
- Titres :
  ...
  - H2 : Corrections courantes de « prison de bac à sable »
...
- Titres :
  ...
  - H2 : Upserts et suppressions du fournisseur
...
- Titres :
  ...
  - H2 : Pré-vérification de référence d’intégration
...
- Titres :
  ...
  - H2 : Concept de confiance entre Gateway et Node
  ...
  - H2 : Listes d’autorisation pour DM et groupes
  ...
  - H3 : Publication de port Docker avec UFW
  ...
  - H3 : Mode lecture seule (via le bac à sable et les outils)
  ...
  - H3 : Exemple : accès complet (pas de bac à sable)
  - H3 : Exemple : outils en lecture seule + espace de travail en lecture seule
  - H3 : Exemple : pas d’accès au système de fichiers/shell (messagerie fournisseur autorisée)
  ...
  - H2 : Signaler les problèmes de sécurité
...
- Titres :
  ...
  - H2 : Recommandations pour Plugin et noyau
...
- Titres :
  ...
  - H2 : Réponses bloquées 403 en amont
  ...
  - H2 : Le Gateway se ferme lors d’une forte utilisation de la mémoire
  - H2 : Le Gateway a rejeté une configuration invalide
  - H2 : Avertissements de sonde Gateway
  - H2 : Canal connecté, messages bloqués
...
- Titres :
  ...
  - H2 : Journalisation des blocs bruts compatibles OpenAI
  - H2 : Notes de sécurité
...
- Titres :
  ...
  - H2 : Basculement de modèles et « Tous les modèles ont échoué »
...
- Titres :
  ...
  - H2 : En direct : test de fumée du modèle (clés de profil)
...
- Titres :
  ...
  - H3 : E2E (navigateur simulé de l’interface Control UI)
...
- Titres :
  ...
  - H2 : Un backend local compatible OpenAI fonctionne directement mais échoue dans OpenClaw
...
- Titres :
  ...
  - H2 : Configuration de canal distant
  - H2 : Accès distant
  - H2 : Mise à jour
  - H2 : Connexe
...
- Titres :
  ...
  - H3 : Problèmes de verrou du Gateway
...
- Titres :
  ...
  - H2 : Mettre à niveau un plugin en place
  - H2 : Connexe
...
- Itinéraire : /install/raspberry-pi
- Titres :
...
- Titres :
  ...
  - H2: Installation normale ou copie de travail source
  - H3: Installation normale (install.sh / npm / pnpm / bun)
  - H3: Copie de travail source (git clone)
  - H2: Connexe

## install/updating.md

- Itinéraire : /install/updating
- Titres :
...
- Itinéraire : /maturity/scorecard
- Titres :
  - H1: Tableau de score de maturité
  - H2: Objet de cette page
  - H2: En un coup d’œil
  - H2: Plages de score
...
- Titres :
  ...
  - H2: Commandes Android d’appareil + données personnelles
...
- Itinéraire : /nodes/location-command
- Titres :
  - H2: TL;DR
...
- Itinéraire : /nodes/media-understanding
- Titres :
  - H2: Objectifs
...
- Itinéraire : /nodes/troubleshooting
- Titres :
  - H2: Échelle de commandes
...
- Itinéraire : /openclaw-agent-runtime
- Titres :
  - H2: Vérification de types et linting
  - H2: Exécuter les tests de l’Agent Runtime
  - H2: Tests manuels
...
- Itinéraire : /perplexity
- Titres :
  - H2: Connexe

## plan/codex-context-engine-harness.md

- Itinéraire : /plan/codex-context-engine-harness
- Titres :
  - H2: Statut
  - H2: Objectif
  - H2: Non-objectifs
  ...
  - H3: 5. Préserver un formatage stable pour le cache de prompt
  - H3: 6. Brancher le post-tour après le miroir de transcription
  - H3: 7. Normaliser l’utilisation et le contexte de runtime du cache de prompt
...
- Itinéraire : /platforms/digitalocean
- Titres :
  - H2: Connexe

## platforms/easyrunner.md

- Itinéraire : /platforms/easyrunner
- Titres :
  - H2: Avant de commencer
...
- Itinéraire : /platforms/ios
- Titres :
  - H2: Ce que cela fait
  - H2: Exigences
  - H2: Démarrage rapide (appairer + connecter)
  - H2: Push adossé au relais pour les builds officielles
  - H2: Balises vivantes en arrière-plan
  ...
  - H2: Voice wake + mode parole
  - H2: Erreurs courantes
  - H2: Docs connexes

## platforms/linux.md

- Itinéraire : /platforms/linux
- Titres :
...
- Itinéraire : /platforms/mac/bundled-gateway
- Titres :
...
- Itinéraire : /platforms/mac/canvas
- Titres :
...
- Itinéraire : /platforms/mac/child-process
- Titres :
...
- Titres :
  ...
  - H2 : Ce qui va où
  - H2 : Jonctions de fournisseur et de harnais
...
- Titres :
  ...
  - H2 : Hooks d’exécution de fournisseur
...
- Titres :
  ...
  - H3 : ownsNativeCompaction : se désengager de la Compaction OpenClaw
...
- Titres :
  ...
  - H2 : Téléversement de retours Codex
...
- Titres :
  - H2 : Exigences
  - H2 : Démarrage rapide
  - H2 : Partager les fils avec Codex Desktop et CLI
  - H2 : Configuration
...
- Titres :
  ...
  - H2 : Inventaire d’applications et propriété
...
- Titres :
  ...
  - H2: Liste de contrôle pour les auteurs de Plugin
  - H2: Docs associées
...
- Titres :
  ...
  - H3 : Intergiciel de résultat d’outil
  ...
  - H2 : Résultats d’outils et médias
...
- Titres :
  ...
  - H2 : Plan de migration des conversations et de la voix en temps réel
...
- Titres :
  ...
  - H2 : Espaces de noms du runtime
  - H2 : Stocker les références du runtime
...
- Titres :
  ...
  - H3 : Promotion monocCompte possédée par le canal
...
- Titres :
  - H2 : Entrée de Plugin
  - H3 : Compatibilité et helpers de test dépréciés
  - H3 : Sous-chemins réservés de helpers de Plugins intégrés
  - H2 : Associé
...
- Titres :
  ...
  - H3 : Exécuter des tests à portée limitée
...
- Titres :
  ...
  - H3 : Comportement au démarrage d’une conversation
  ...
  - H2 : RPC Gateway
  - H2 : Dépannage
  - H3 : La configuration échoue à l’exposition du Webhook
...
- Titres :
  - H2 : Premiers pas
  - H2 : Valeurs de pensée par défaut (Claude Fable 5, 4.8 et 4.6)
  - H2 : Fallback de refus de sécurité (Claude Fable 5)
...
- Titres :
  - H2 : Premiers pas
  - H2 : Découverte des modèles
  - H2 : Protocoles et plugins de fournisseur
...
- Titres :
  - H2 : Premiers pas
  - H2 : Options de configuration
  - H2 : STT en streaming pour Voice Call
  - H2 : Notes
  - H2 : Liés
...
- Titres :
  ...
  - H2 : Nemotron 3 Ultra
  - H2 : Catalogue de secours groupé
  - H2 : Configuration avancée
  - H2 : Liés
...
- Route : /providers/xai
- Titres :
  - H2 : Choisissez votre parcours de configuration
  - H2 : Dépannage OAuth
  - H2 : Catalogue intégré
...
- Titres :
  ...
  - H3 : Phase 3 : Récolte au démarrage avec priorité aux baux
...
- Titres :
  ...
  - H2 : Forme de migration du doctor
...
- Titres :
  - H2 : Premier lancement (recommandé)
...
- Titres :
  ...
  - H2 : Fonctionnalités qui peuvent dépenser des clés
  ...
  - H3 : 6) Instantanés d’utilisation du fournisseur (statut/santé)
  - H3 : 7) Résumé de protection de la Compaction
  - H3 : 8) Scan / sonde de modèle
  - H3 : 9) Talk (parole)
...
- Titres :
  ...
  - H2 : Style recommandé
  - H2 : Évitez ces motifs dans la documentation
  - H2 : Exemple
...
- Titres :
  ...
  - H2 : Limites de blocs de Compaction et appairage des outils
...
- Titres :
  ...
  - H2 : Premier lancement (une seule fois)
  - H2 : Conseil de sauvegarde (recommandé)
  - H2 : Paramètres de sécurité par défaut
  - H2 : Vérification préalable des solutions existantes
...
- Titres :
  ...
  - H2 : La conversation
  - H2 : Après avoir compris qui vous êtes
...
- Titres :
  - H2 : Point de contrôle local des PR
  - H2 : Banc d’essai de latence des modèles (clés locales)
...
- Titres :
  ...
  - H2 : Règle globale : provenance des entrées entre sessions
...
- Titres :
  ...
  - H4 : T-RECON-001 : Découverte des endpoints d’agent
  ...
  - H2 : 7. Annexes
  - H3 : 7.1 Cartographie des techniques ATLAS
...
- Titres :
  ...
  - H3 : Magasin d’appairage (filtrage des DM)
  - H3 : Filtrage de l’entrée (mentions + contournement des commandes de contrôle)
  ...
  - H3 : Précédence routing dmScope + identityLinks
  - H2 : Associé
...
- Titres :
  ...
  - H3 : 2) Faire pointer l’app macOS vers votre Gateway en cours d’exécution
  - H3 : 3) Vérifier
  - H3 : Pièges courants
...
- Titres :
  ...
  - H2 : Modes de liaison spawn et de fil
...
- Titres :
  ...
  - H2 : Mise en bac à sable + accès au navigateur hôte
  - H2 : Connexe
...
- Titres :
  ...
  - H2 : Outils de l’agent + fonctionnement du contrôle
  - H2 : Connexe
...
- Titres :
  - H2 : Démarrage rapide
  - H2 : Désactiver les conseils système intégrés
  - H2 : Workflow typique d’un agent
  ...
  - H3 : Configuration de l’URL persistante du visualiseur
...
- Titres :
  ...
  - H3 : Raccourci local
  - H3 : Hôte Node
  - H3 : Raccourci de session uniquement
  ...
  - H2 : Exécutables sûrs et transfert des approbations
...
- Titres :
  ...
  - H2 : Liste d’autorisation + exécutables sûrs
  - H2 : Exemples
  - H2 : applypatch
  - H2 : Connexe
...
- Titres :
  ...
  - H2 : Correspondances des fournisseurs (comment les fournisseurs répartissent les surfaces)
  - H2 : Associé
...
- Titres :
  ...
  - H3 : Politique d’installation opérateur
...
- Titres :
  ...
  - H2 : Politique d’installation opérateur (security.installPolicy)
...
- Titres :
  - H2 : Commande slash
  - H3 : Contrôles de liaison des threads
  ...
  - H2 : Outil : subagents
  - H2 : Sessions liées au thread
  - H3 : Canaux prenant en charge les threads
  - H3 : Flux rapide
  - H3 : Contrôles manuels
  - H3 : Interrupteurs de configuration
...
- Titres :
  ...
  - H2 : Endpoint de configuration d’exécution
