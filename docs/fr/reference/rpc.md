...
x-i18n:
    generated_at: "2026-07-12T03:04:48Z"
    model: gpt-5.6
...
- Les messages JSON-RPC sont délimités par des retours à la ligne sur stdin/stdout (un objet JSON par ligne).
...
- Le Gateway gère le processus (le démarrage et l’arrêt sont liés au cycle de vie du fournisseur).
- Veillez à la résilience des clients RPC : délais d’expiration et redémarrage à la fermeture.
