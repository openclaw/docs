...
read_when:
    ...
    - Vous souhaitez utiliser la transcription audio ElevenLabs Scribe pour les pièces jointes audio
...
title: ElevenLabs
x-i18n:
    generated_at: "2026-07-12T03:01:51Z"
    model: gpt-5.6
...
| Transcription vocale en continu        | Diffusion de Voice Call ou `realtime.transcriptionProvider` de Google Meet | `scribe_v2_realtime`    |
...
Le Plugin `elevenlabs` inclus enregistre Scribe v2 Realtime pour la transcription en continu
...
ElevenLabs utilise `ulaw_8000` par défaut, ce qui permet de transférer les trames téléphoniques sans
transcodage.
</Note>
