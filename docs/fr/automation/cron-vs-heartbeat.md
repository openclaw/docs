---
summary: Rediriger vers /automation
title: Cron ou Heartbeat
x-i18n:
...
Le guide de décision pour choisir entre Cron et Heartbeat se trouve dans [Automatisation](/fr/automation).
