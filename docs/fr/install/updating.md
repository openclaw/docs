...
title: Mise à jour
x-i18n:
    generated_at: "2026-05-11T20:42:44Z"
    model: gpt-5.5
    provider: openai
...
Le canal `dev` garantit un checkout git, le compile et installe le CLI global
...
Le Gateway consigne également une indication de mise à jour au démarrage (désactivez avec `update.checkOnStart: false`).
