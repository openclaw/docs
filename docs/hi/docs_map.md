...
summary: OpenClaw दस्तावेज़ पृष्ठों के लिए जनरेट किया गया heading map
title: दस्तावेज़ मानचित्र
x-i18n:
    generated_at: "2026-07-03T17:19:46Z"
    model: gpt-5.5
...
- शीर्षक:
  ...
  - H2: दिखने वाले उत्तर
  - H2: संदर्भ दृश्यता और अनुमति-सूचियाँ
  - H2: सत्र कुंजियाँ
...
- शीर्षक:
  ...
  - H2: निजी API एक्शन
  - H2: कॉन्फ़िग लेखन
  - H2: विभाजित-भेजे गए DM को कोएलैस करना (एक कंपोज़िशन में कमांड + URL)
...
- शीर्षक:
  ...
  - H2: सुरक्षा डिफ़ॉल्ट
  - H2: पहुँच नियंत्रण
  - H3: सामान्य गलती: allowFrom DM के लिए है, चैनलों के लिए नहीं
...
- शीर्षक:
  ...
  - H2: रिएक्शन
  - H2: इतिहास कॉन्टेक्स्ट
  - H2: कॉन्टेक्स्ट दृश्यता
  - H2: DM और रूम नीति
...
- शीर्षक:
  ...
  - H3: वैकल्पिक भरोसेमंद-CIDR नोड ऑटो-अप्रूव
...
- शीर्षक:
  ...
  - H3: कॉन्फ़िग फ़ाइल
  - H3: एनवायरनमेंट वैरिएबल
  - H3: SecretRef ऑथ टोकन
  - H3: अनुमति-सूची-केवल निजी नंबर
...
- शीर्षक:
  ...
  - H2: पूर्ण रिलीज़ वैलिडेशन
  - H2: लाइव और E2E शार्ड
  - H2: पैकेज स्वीकृति
  - H3: जॉब
  - H3: उम्मीदवार स्रोत
  - H3: सुइट प्रोफ़ाइल
  - H3: लीगेसी संगतता विंडो
  - H3: उदाहरण
  - H2: इंस्टॉल स्मोक
...
- शीर्षक:
  ...
  - H2: समस्या निवारण
  - H2: क्षमताओं की जांच
  - H2: नामों को IDs में रिज़ॉल्व करें
  - H2: संबंधित
...
- शीर्षक:
  ...
  - H2: Paperclip / openclawgateway फर्स्ट-रन अनुमोदन
...
- शीर्षक:
  ...
  - H3: gateway status
  - H3: gateway probe
  - H4: SSH पर रिमोट (Mac ऐप समकक्षता)
...
- शीर्षक:
  ...
  - H2: Runtime सीमाएँ
  - H2: सेशन
  - H2: streaming के दौरान नियंत्रण
  - H2: Model refs
...
- शीर्षक:
  ...
  - H2: घटक और प्रवाह
  - H3: Gateway (daemon)
  - H3: क्लाइंट (mac app / CLI / web admin)
...
- शीर्षक:
  - H2: त्वरित शुरुआत (context inspect करें)
  - H2: उदाहरण आउटपुट
  - H3: /context list
  - H3: /context detail
  - H3: /context map
  ...
  - H2: कमांड, directives, और "inline shortcuts"
...
- शीर्षक:
  ...
  - H2: models.providers के माध्यम से providers (custom/base URL)
  - H3: Moonshot AI (Kimi)
  - H3: Kimi coding
...
- शीर्षक:
  ...
  - H2: Agent helper
  - H2: त्वरित शुरुआत
  - H2: Multiple agents = कई लोग, कई व्यक्तित्व
...
- शीर्षक:
  ...
  - H2: स्थिति और orchestration helper
  - H2: sub-agents शुरू करना
  - H2: दृश्यता
  - H2: आगे पढ़ें
  - H2: संबंधित
...
- शीर्षक:
  ...
  - H2: chunking algorithm (निचली/ऊपरी सीमाएँ)
  - H2: coalescing (स्ट्रीम किए गए ब्लॉकों को मर्ज करना)
  - H2: ब्लॉकों के बीच मानव-जैसी pacing
  - H2: "chunks स्ट्रीम करें या सब कुछ"
  - H2: preview streaming modes
  - H3: चैनल मैपिंग
  - H3: रनटाइम व्यवहार
  - H3: टूल-प्रगति preview updates
...
- शीर्षक:
  ...
  - H2: काम किया हुआ उदाहरण: एक method end-to-end जोड़ें
...
- रूट: /date-time
- शीर्षक:
  - H2: Message envelopes (डिफ़ॉल्ट रूप से local)
  - H3: उदाहरण
  - H2: System prompt: वर्तमान तारीख और समय
  - H2: System event lines (डिफ़ॉल्ट रूप से local)
...
- शीर्षक:
  ...
  - H2: सक्षम करना / अक्षम करना / configuration
  - H2: संबंधित docs
...
- शीर्षक:
  ...
  - H3: सिमलिंक किया गया सिबलिंग skill रेपो
  - H2: सामान्य पैटर्न
...
- शीर्षक:
  ...
  - H2: कॉन्फ़िगरेशन include ($include)
  - H2: संबंधित
...
- शीर्षक:
  ...
  - H2: डिस्कवरी इनपुट (क्लाइंट कैसे जानें कि gateway कहां है)
  ...
  - H2: पेयरिंग + auth (direct ट्रांसपोर्ट)
...
- शीर्षक:
  ...
  - H2: रिमोट पहुंच
  - H2: सुपरविजन और सेवा जीवनचक्र
  - H2: Dev प्रोफ़ाइल त्वरित पथ
  - H2: प्रोटोकॉल त्वरित संदर्भ (ऑपरेटर दृश्य)
  - H2: संचालन जांच
  - H3: Liveness
  - H3: Readiness
  - H3: गैप रिकवरी
  - H2: सामान्य विफलता हस्ताक्षर
  - H2: सुरक्षा गारंटी
  - H2: संबंधित
...
- शीर्षक:
  ...
  - H3: होस्टेड सुरक्षा नेट के साथ स्थानीय-प्रथम
...
- शीर्षक:
  ...
  - H3: WS लॉग शैली
  - H2: कंसोल फ़ॉर्मैटिंग (subsystem लॉगिंग)
  - H2: संबंधित
...
- शीर्षक:
  ...
  - H2: फ़ाइल + छवि सीमाएं (कॉन्फ़िगरेशन)
  - H2: स्ट्रीमिंग (SSE)
  - H2: उपयोग
  - H2: त्रुटियां
  - H2: उदाहरण
...
- शीर्षक:
  ...
  - H3: टूल निष्पादन
  - H3: Exec
  - H3: डायग्नॉस्टिक्स internals (मेमोरी और टूल लूप)
  - H2: निर्यात किए गए spans
  - H2: डायग्नॉस्टिक event कैटलॉग
  - H2: exporter के बिना
  - H2: अक्षम करें
  - H2: संबंधित
...
- शीर्षक:
  - H2: भूमिकाएं
  - H2: स्कोप स्तर
  - H2: विधि स्कोप केवल पहला gate है
...
- शीर्षक:
  ...
  - H2: Metadata-upgrade स्वतः-अनुमोदन
...
- शीर्षक:
  ...
  - H3: डिवाइस auth migration diagnostics
  - H2: TLS + pinning
  - H2: स्कोप
  - H2: संबंधित
...
- शीर्षक:
  ...
  - H3: चरण 3: रिमोट Gateway प्रमाणीकरण कॉन्फिगर करें
...
- शीर्षक:
  ...
  - H2: एलिवेटेड: केवल exec वाला "होस्ट पर चलाएं"
  - H2: सामान्य "सैंडबॉक्स जेल" सुधार
  - H3: "टूल X सैंडबॉक्स टूल नीति द्वारा ब्लॉक किया गया"
  - H3: "मुझे लगा यह main था, फिर यह सैंडबॉक्स में क्यों है?"
  - H2: संबंधित
...
- शीर्षक:
  ...
  - H2: Runtime और ऑडिट दायरा नोट्स
  - H2: ऑपरेटर जांच
  - H2: संबंधित डॉक्स
...
- शीर्षक:
  ...
  - H2: सक्रियण ट्रिगर
  - H2: अवनत और पुनर्प्राप्त सिग्नल
  - H2: कमांड-पाथ रिज़ॉल्यूशन
  - H2: ऑडिट और कॉन्फिगर वर्कफ़्लो
  - H2: एक-तरफ़ा सुरक्षा नीति
  - H2: लेगसी प्रमाणीकरण संगतता नोट्स
  - H2: Web UI नोट
  - H2: संबंधित
...
- शीर्षक:
  ...
  - H2: बाहरी सामग्री स्पेशल-टोकन सैनिटाइज़ेशन
  ...
  - H2: कॉन्फिगरेशन सुदृढ़ीकरण उदाहरण
  - H3: फ़ाइल अनुमतियां
  ...
  - H3: लॉग और ट्रांसक्रिप्ट (रेडैक्शन और रिटेंशन)
  ...
  - H3: उदाहरण: फ़ाइलसिस्टम/शेल एक्सेस नहीं (प्रदाता मैसेजिंग अनुमत)
  - H2: घटना प्रतिक्रिया
  - H3: सीमित करें
  - H3: रोटेट करें (सीक्रेट्स लीक होने पर समझौता मानें)
  - H3: ऑडिट
  - H3: रिपोर्ट के लिए इकट्ठा करें
  - H2: सीक्रेट स्कैनिंग
...
- शीर्षक:
  - H2: कमांड सीढ़ी
  - H2: अपडेट के बाद
  - H2: स्प्लिट ब्रेन इंस्टॉल और नए कॉन्फिग गार्ड
  - H2: रोलबैक के बाद प्रोटोकॉल मिसमैच
  - H2: पाथ एस्केप के रूप में Skill symlink छोड़ा गया
  - H2: लंबे संदर्भ के लिए Anthropic 429 में अतिरिक्त उपयोग आवश्यक
  - H2: अपस्ट्रीम 403 ब्लॉक की गई प्रतिक्रियाएं
  - H2: स्थानीय OpenAI-संगत बैकएंड सीधे probes पास करता है लेकिन एजेंट रन विफल होते हैं
  - H2: कोई उत्तर नहीं
  - H2: डैशबोर्ड Control UI कनेक्टिविटी
  - H3: प्रमाणीकरण विवरण कोड त्वरित मैप
  ...
  - H2: चैनल कनेक्टेड, संदेश प्रवाहित नहीं हो रहे
  - H2: Cron और Heartbeat डिलीवरी
  - H2: Node paired, टूल विफल
  - H2: ब्राउज़र टूल विफल
  - H2: अगर आपने अपग्रेड किया और कुछ अचानक टूट गया
  - H2: संबंधित
...
- मार्ग: /help/faq
- शीर्षक:
  - H2: अगर कुछ टूटा है तो पहले 60 सेकंड
  - H2: त्वरित शुरुआत और पहली-रन सेटअप
  - H2: OpenClaw क्या है?
  ...
  - H2: चैट कमांड, कार्यों को रोकना, और "यह नहीं रुकेगा"
  - H2: विविध
  - H2: संबंधित
...
- शीर्षक:
  ...
  - H3: लेयर 1: प्रत्यक्ष मॉडल पूर्णता (कोई Gateway नहीं)
  - H3: लेयर 2: Gateway + देव एजेंट स्मोक ("@openclaw" वास्तव में क्या करता है)
  - H2: लाइव: CLI बैकएंड स्मोक (Claude, Gemini, या अन्य स्थानीय CLI)
  - H2: लाइव: APNs HTTP/2 प्रॉक्सी पहुंचयोग्यता
  ...
  - H3: बेसलाइन: टूल कॉलिंग (रीड + वैकल्पिक Exec)
...
- शीर्षक:
  - H2: चैनल बदलना
  - H2: एक-बारगी संस्करण या टैग लक्षित करना
  - H2: ड्राई रन
  - H2: Plugins और चैनल
  - H2: वर्तमान स्थिति जांचना
  - H2: टैगिंग सर्वोत्तम प्रथाएँ
...
- शीर्षक:
  ...
  - H3: स्थिति कायम नहीं रह रही
  - H2: अपडेट
  - H3: मशीन कमांड अपडेट करना
  - H2: निजी डिप्लॉयमेंट (हार्डेन्ड)
...
- शीर्षक:
  ...
  - H3: स्थानीय प्रिफ़िक्स इंस्टॉलर (install-cli.sh)
  - H3: npm, pnpm, या bun
  - H3: स्रोत से
...
- शीर्षक:
  ...
  - H3: कस्टम नेमस्पेस
  - H3: कस्टम इमेज
  - H3: पोर्ट-फॉरवर्ड से आगे एक्सपोज़ करें
...
- शीर्षक:
  ...
  - H2: 2) macOS VM बनाएँ
  - H2: 3) सेटअप असिस्टेंट पूरा करें
...
- शीर्षक:
  - H1: Render
  - H2: पूर्वापेक्षाएँ
  - H2: Render ब्लूप्रिंट से डिप्लॉय करें
  - H2: ब्लूप्रिंट को समझना
  - H2: प्लान चुनना
...
- शीर्षक:
  ...
  - H2: सामान्य इंस्टॉल बनाम स्रोत checkout
  - H3: सामान्य इंस्टॉल (install.sh / npm / pnpm / bun)
  - H3: स्रोत checkout (git clone)
  - H2: संबंधित
...
- शीर्षक:
  ...
  - H3: सत्यापित करें
  - H2: रोलबैक
  - H3: कोई संस्करण pin करें (npm)
  - H3: कोई commit pin करें (स्रोत)
...
- शीर्षक:
  ...
  - H3: लॉग स्तर
  - H3: लक्षित मॉडल transport निदान
...
- शीर्षक:
  ...
  - H3: केवल Provider, scope gating के साथ
  - H3: केवल Provider (Deepgram)
  - H3: केवल Provider (Mistral Voxtral)
  - H3: केवल Provider (SenseAudio)
  - H3: Transcript को chat में echo करें (opt-in)
  - H2: नोट्स और सीमाएँ
  - H3: Proxy पर्यावरण समर्थन
  - H2: Groups में mention detection
...
- शीर्षक:
  ...
  - H3: Media understanding ऑटो-डिटेक्ट करें (डिफ़ॉल्ट)
  - H3: Proxy पर्यावरण समर्थन (Provider models)
...
- शीर्षक:
  ...
  - H3: 1. पुन: उपयोग योग्य context-engine attempt helpers को export या relocate करें
...
- शीर्षक:
  ...
  - H3: Gateway "Starting..." पर अनिश्चितकाल तक अटका है
  - H2: संबंधित
...
- शीर्षक:
  ...
  - H2: जीवनचक्र अपरिवर्त्यताएँ
  - H2: चिपचिपा ओवरले विफलता मोड (पूर्व)
...
- शीर्षक:
  - H2: Plugin का स्वामित्व क्या है
...
- शीर्षक:
  ...
  - H2: बंडल किया हुआ macOS मार्केटप्लेस
...
- शीर्षक:
  ...
  - H2: दृश्य उत्तर और heartbeats
  - H2: हुक सीमाएँ
  - H2: V1 समर्थन अनुबंध
  - H2: नेटिव अनुमतियाँ और MCP elicitations
  - H2: कतार दिशा-निर्देशन
...
- शीर्षक:
  ...
  - H3: फेल-क्लोज़्ड Codex डिप्लॉयमेंट
  - H2: ऐप-सर्वर नीति
...
- शीर्षक:
  ...
  - H2: जनरेशन प्रोवाइडर मेटाडेटा संदर्भ
...
- शीर्षक:
  - H2: इंस्टॉलेशन
  - H2: त्वरित शुरुआत
  - H2: प्रोवाइडर-समर्थित एम्बेडिंग
  - H2: Ollama एम्बेडिंग
  - H2: OpenAI-संगत प्रोवाइडर
...
- शीर्षक:
  - H1: Plugin इन्वेंटरी
  - H2: परिभाषाएं
  - H2: एक plugin इंस्टॉल करें
  - H2: कोर npm पैकेज
  - H2: आधिकारिक बाहरी पैकेज
  - H2: केवल सोर्स चेकआउट
...
- शीर्षक:
  ...
  - H3: अप्रचलित मेमोरी एम्बेडिंग एडाप्टर
  - H3: इवेंट और लाइफ़साइकिल
...
- शीर्षक:
  ...
  - H2: पुन: प्रयोज्य रनटाइम उपयोगिताएँ
  - H2: रनटाइम नेमस्पेस
...
- शीर्षक:
  - H2: Plugin एंट्री
  - H3: अप्रचलित संगतता और परीक्षण हेल्पर
  - H3: आरक्षित बंडल किए गए Plugin हेल्पर सबपाथ
  - H2: संबंधित
...
- शीर्षक:
  ...
  - H2: अनुबंध परीक्षण (इन-रेपो Plugin)
...
- शीर्षक:
  ...
  - H3: पैकेज 'typebox' नहीं मिल सकता
...
- शीर्षक:
  ...
  - H3: रीयलटाइम कॉल में कोई वाणी नहीं है
  - H2: संबंधित
...
- शीर्षक:
  ...
  - H3: वर्कर प्रॉम्प्ट और लाइफ़साइकिल
  - H3: डिस्पैच एंट्री पॉइंट
  - H2: CLI और स्लैश कमांड
  - H2: सत्र लाइफ़साइकिल सिंक
...
- शीर्षक:
  - H2: शुरू करना
  - H2: थिंकिंग डिफ़ॉल्ट्स (Claude Fable 5, 4.8, और 4.6)
  - H2: प्रॉम्प्ट कैशिंग
  - H2: उन्नत कॉन्फ़िगरेशन
  - H2: समस्या निवारण
  - H2: संबंधित
...
- शीर्षक:
  ...
  - H2: शुरू करना
  - H2: क्लाउड मॉडल
  - H2: मॉडल डिस्कवरी (निहित प्रदाता)
...
- शीर्षक:
  ...
  - H3: चरण 5: पुराने ह्यूरिस्टिक्स हटाएँ
  - H2: परीक्षण
  - H2: संगतता नोट्स
  - H2: सफलता मानदंड
...
- शीर्षक:
  - H1: डेटाबेस-प्रथम स्टेट रिफ़ैक्टर
  - H2: निर्णय
  - H2: कठोर अनुबंध
  ...
  - H3: चरण 6: Worker रनटाइम
  - H3: चरण 7: पुरानी दुनिया हटाएँ
  - H2: बैकअप और रीस्टोर
  - H2: रनटाइम रिफ़ैक्टर योजना
  - H2: प्रदर्शन नियम
  - H2: स्थैतिक प्रतिबंध
  - H2: पूर्णता मानदंड
...
- शीर्षक:
  ...
  - H2: प्री-Compaction "Memory फ्लश" (लागू)
...
- शीर्षक:
  ...
  - H3: 3.7 संग्रह &amp; एक्सफिल्ट्रेशन (AML.TA0009, AML.TA0010)
  ...
  - H4: T-IMPACT-003: प्रतिष्ठा नुकसान
  ...
  - H3: 5.2 महत्वपूर्ण पथ हमला श्रृंखलाएं
...
- शीर्षक:
  ...
  - H3: इनग्रेस गेटिंग (मेंशन + नियंत्रण-कमांड बायपास)
  - H3: रूटिंग/सत्र-कुंजी आइसोलेशन
  - H2: v1++: अतिरिक्त सीमित मॉडल (समवर्तीता, रिट्राई, ट्रेस शुद्धता)
  - H3: पेयरिंग स्टोर समवर्तीता / idempotency
  - H3: इनग्रेस ट्रेस सहसंबंध / idempotency
  - H3: रूटिंग dmScope precedence + identityLinks
  - H2: संबंधित
...
- शीर्षक:
  ...
  - H2: आर्टिफैक्ट जीवनचक्र और स्टोरेज
...
- शीर्षक:
  ...
  - H2: सुरक्षित bin और अनुमोदन फ़ॉरवर्डिंग
...
- शीर्षक:
  ...
  - H2: बंडल की गई Skills अनुमति-सूची
  - H2: प्रति-Skills प्रविष्टियां (skills.entries)
...
- शीर्षक:
  ...
  - H2: /model — मॉडल चयन
  - H2: /config — ऑन-डिस्क कॉन्फ़िगरेशन लिखना
...
- शीर्षक:
  ...
  - H2: टूल नीति
  - H3: कॉन्फ़िगरेशन के जरिए ओवरराइड
  - H2: समवर्तीता
...
- शीर्षक:
  ...
  - H2: पहले एडमिन पहुंच को मजबूत करें
...
- शीर्षक:
  ...
  - H2: डिबगिंग/परीक्षण: डेव सर्वर + रिमोट Gateway
  - H2: संबंधित
