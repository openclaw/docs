...
- कोई भी सहायक _टेक्स्ट-आधारित_ फ़ाइलें (“स्वीकृत फ़ाइलें” देखें)
- `.clawhubignore` (प्रकाशन के लिए अनदेखा पैटर्न, लेगेसी `.clawdhubignore`)
- `.gitignore` (इसे भी माना जाता है)

## GitHub आयात

वेब GitHub आयातक स्थानीय publish/sync से अधिक सख्त है। यह केवल साइन-इन किए गए GitHub खाते के स्वामित्व वाली सार्वजनिक, नॉन-फ़ोर्क रिपॉज़िटरी में
`SKILL.md` या लेगेसी `skills.md` फ़ाइलें खोजता है। यह निजी रिपो, फ़ोर्क,
...
स्किल मेटाडेटा आपके `SKILL.md` के शीर्ष पर YAML frontmatter में घोषित किया जाता है। यह registry (और सुरक्षा विश्लेषण) को बताता है कि आपकी स्किल को चलने के लिए क्या चाहिए।
...
अपनी स्किल की runtime आवश्यकताएं `metadata.openclaw` के अंतर्गत घोषित करें (उपनाम: `metadata.clawdbot`, `metadata.clawdis`)।
...
ऐसे environment variables के लिए `requires.env` का उपयोग करें जो स्किल चलने से पहले मौजूद होने चाहिए। जब आपको प्रति-variable मेटाडेटा चाहिए, जिसमें `required: false` वाले वैकल्पिक variables भी शामिल हैं, तब `envVars` का उपयोग करें।
...
| `envVars`          | `array`    | `name`, वैकल्पिक `required`, और वैकल्पिक `description` के साथ environment variable घोषणाएं। वैकल्पिक env vars के लिए `required: false` सेट करें। |
| `always`           | `boolean`  | यदि `true` है, तो स्किल हमेशा सक्रिय रहती है (स्पष्ट इंस्टॉल आवश्यक नहीं)।                                                                              |
...
वैकल्पिक environment variables को `metadata.openclaw.envVars` के अंतर्गत घोषित करें और `required: false` सेट करें। वैकल्पिक प्रविष्टियां `requires.env` में न जोड़ें, क्योंकि `requires.env` का अर्थ है कि स्किल उनके बिना चल नहीं सकती।
...
ClawHub का सुरक्षा विश्लेषण जांचता है कि आपकी स्किल जो घोषित करती है, वह वास्तव में किए जाने वाले काम से मेल खाती है। यदि आपका कोड `TODOIST_API_KEY` का संदर्भ देता है, लेकिन आपका frontmatter उसे `requires.env`, `primaryEnv`, या `envVars` के अंतर्गत घोषित नहीं करता, तो विश्लेषण मेटाडेटा mismatch को flag करेगा। घोषणाओं को सटीक रखने से आपकी स्किल review पास करने में मदद मिलती है और उपयोगकर्ताओं को समझने में मदद मिलती है कि वे क्या इंस्टॉल कर रहे हैं।
...
- कोई भी प्रकाशित skills का उपयोग, संशोधन, और पुनर्वितरण कर सकता है, commercial रूप से भी।
- Attribution आवश्यक नहीं है।
- `SKILL.md` में विरोधी license terms न जोड़ें; ClawHub प्रति-skill license overrides का समर्थन नहीं करता।
...
- यदि आपकी स्किल किसी paid तृतीय-पक्ष service के साथ integrate करती है, तो external cost और required account को स्किल instructions और env declarations में स्पष्ट रूप से document करें (required variables के लिए `requires.env`, या optional variables के लिए `required: false` के साथ `envVars`)।
