...
- `SKILL.md` (या `skill.md`; लेगसी `skills.md` भी स्वीकार किया जाता है)

वैकल्पिक:

- कोई भी सहायक _text-based_ फ़ाइलें (“अनुमत फ़ाइलें” देखें)
- `.clawhubignore` (प्रकाशन के लिए पैटर्न अनदेखा करें, लेगसी `.clawdhubignore`)
- `.gitignore` (इसे भी माना जाता है)

## GitHub आयात

वेब GitHub आयातक स्थानीय publish/sync से अधिक सख्त है। यह केवल साइन-इन किए गए GitHub खाते के स्वामित्व वाली सार्वजनिक, गैर-फोर्क रिपॉज़िटरी में
`SKILL.md` या लेगसी `skills.md` फ़ाइलें खोजता है। यह निजी repos, forks,
archived/disabled repos, या तीसरे-पक्ष के सार्वजनिक repos आयात नहीं करता।

स्थानीय इंस्टॉल मेटाडेटा (CLI द्वारा लिखा गया):

- `<skill>/.clawhub/origin.json` (लेगसी `.clawdhub`)

Workdir इंस्टॉल स्थिति (CLI द्वारा लिखी गई):

- `<workdir>/.clawhub/lock.json` (लेगसी `.clawdhub`)
...
Skill चलने से पहले मौजूद होने वाले environment variables के लिए `requires.env` का उपयोग करें। जब आपको प्रति-variable मेटाडेटा चाहिए, जिसमें `required: false` वाले वैकल्पिक variables भी शामिल हैं, तब `envVars` का उपयोग करें।
...
| `requires.bins`    | `string[]` | CLI binaries जिन्हें सभी इंस्टॉल होना चाहिए।                                                                                                     |
...
ClawHub का सुरक्षा विश्लेषण जाँचता है कि आपका Skill जो घोषित करता है, वह वास्तव में उसके किए गए कार्यों से मेल खाता है। यदि आपका code `TODOIST_API_KEY` को reference करता है लेकिन आपका frontmatter इसे `requires.env`, `primaryEnv`, या `envVars` के अंतर्गत घोषित नहीं करता, तो विश्लेषण मेटाडेटा mismatch flag करेगा। घोषणाओं को सटीक रखना आपके Skill को review पास करने में मदद करता है और users को यह समझने में मदद करता है कि वे क्या install कर रहे हैं।
...
- `SKILL.md` में विरोधाभासी license terms न जोड़ें; ClawHub प्रति-Skill license overrides का समर्थन नहीं करता।

## सशुल्क Skills

- ClawHub सशुल्क Skills, प्रति-Skill pricing, paywalls, या revenue sharing का समर्थन नहीं करता।
- `SKILL.md` में pricing metadata न जोड़ें; यह Skill format का हिस्सा नहीं है और प्रकाशित Skill को paid नहीं बनाएगा।
- यदि आपका Skill किसी paid third-party service के साथ integrate करता है, तो external cost और आवश्यक account को Skill instructions और env declarations में स्पष्ट रूप से document करें (`requires.env` आवश्यक variables के लिए, या वैकल्पिक variables के लिए `required: false` के साथ `envVars`)।
