...
x-i18n:
    generated_at: "2026-07-05T06:15:31Z"
    model: gpt-5.5
...
- `SKILL.md` (या `skill.md`; लीगेसी `skills.md` भी स्वीकार है)
...
वेब GitHub आयातक स्थानीय प्रकाशन/सिंक की तुलना में अधिक सख्त है। यह केवल साइन-इन किए हुए GitHub खाते के स्वामित्व वाली सार्वजनिक, नॉन-फ़ोर्क रिपॉज़िटरी में
`SKILL.md` या लीगेसी `skills.md` फ़ाइलों को खोजता है। यह निजी रेपो, फ़ोर्क,
...
स्किल मेटाडेटा आपके `SKILL.md` के शीर्ष पर YAML frontmatter में घोषित किया जाता है। यह रजिस्ट्री (और सुरक्षा विश्लेषण) को बताता है कि आपके स्किल को चलने के लिए क्या चाहिए।
...
अपने स्किल की रनटाइम आवश्यकताओं को `metadata.openclaw` के अंतर्गत घोषित करें (उपनाम: `metadata.clawdbot`, `metadata.clawdis`)।
...
स्किल चलने से पहले मौजूद होने वाले environment variables के लिए `requires.env` का उपयोग करें। जब आपको प्रति-variable मेटाडेटा चाहिए, जिसमें `required: false` वाले वैकल्पिक variables शामिल हों, तो `envVars` का उपयोग करें।
...
| `always`           | `boolean`  | यदि `true` है, तो स्किल हमेशा सक्रिय रहता है (स्पष्ट इंस्टॉल आवश्यक नहीं)।                                                                              |
...
ClawHub का सुरक्षा विश्लेषण जाँचता है कि आपका स्किल जो घोषित करता है वह वास्तव में किए जाने वाले काम से मेल खाता है। यदि आपका code `TODOIST_API_KEY` को reference करता है लेकिन आपका frontmatter उसे `requires.env`, `primaryEnv`, या `envVars` के अंतर्गत घोषित नहीं करता, तो विश्लेषण मेटाडेटा mismatch को flag करेगा। घोषणाओं को सटीक रखना आपके स्किल को review पास करने में मदद करता है और users को यह समझने में मदद करता है कि वे क्या इंस्टॉल कर रहे हैं।
...
- Script फ़ाइलें upload के बाद भी scan की जाती हैं; PowerShell `.ps1`, `.psm1`, और `.psd1` फ़ाइलें text के रूप में स्वीकार हैं।
...
- `SKILL.md` में विरोधाभासी license terms न जोड़ें; ClawHub per-skill license overrides का समर्थन नहीं करता।
...
- यदि आपका स्किल किसी paid third-party service के साथ integrate करता है, तो external cost और required account को skill instructions और env declarations में स्पष्ट रूप से document करें (`requires.env` आवश्यक variables के लिए, या वैकल्पिक variables के लिए `required: false` के साथ `envVars`)।
