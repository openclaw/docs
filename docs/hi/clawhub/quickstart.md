...
x-i18n:
    generated_at: "2026-06-28T22:45:18Z"
    model: gpt-5.5
...
ClawHub OpenClaw कौशलों और Plugin की रजिस्ट्री है।
...
## कोई कौशल खोजें और इंस्टॉल करें
...
कोई कौशल इंस्टॉल करें:

```bash
openclaw skills install @openclaw/demo
```

इंस्टॉल किए गए कौशल अपडेट करें:

```bash
openclaw skills update --all
```

OpenClaw यह दर्ज करता है कि कौशल कहाँ से आया था, ताकि बाद के अपडेट ClawHub के ज़रिए समाधान जारी रख सकें।
...
जब आप चाहते हैं कि OpenClaw पैकेज को npm या किसी अन्य स्रोत के बजाय ClawHub के ज़रिए हल करे, तो `clawhub:` प्रीफ़िक्स का उपयोग करें।
...
कौशल एक फ़ोल्डर है जिसमें आवश्यक `SKILL.md` फ़ाइल और वैकल्पिक सहायक फ़ाइलें होती हैं।
...
कमांड अपरिवर्तित सामग्री को छोड़ देता है। नए कौशल `1.0.0` से शुरू होते हैं; बाद के बदलाव अपने-आप अगला पैच संस्करण प्रकाशित करते हैं। पूर्वावलोकन के लिए `--dry-run` या स्पष्ट संस्करण चुनने के लिए `--version` का उपयोग करें।

प्रकाशित करने से पहले, `SKILL.md` में मेटाडेटा जाँचें। आवश्यक वातावरण चर, टूल और अनुमतियाँ घोषित करें, ताकि उपयोगकर्ता इंस्टॉल करने से पहले समझ सकें कि कौशल को क्या चाहिए। [कौशल फ़ॉर्मैट](/hi/clawhub/skill-format) देखें।

कई कौशलों वाली रिपॉज़िटरी के लिए, पुन: उपयोग योग्य GitHub वर्कफ़्लो `skills/` के अंतर्गत प्रत्येक तत्काल कौशल फ़ोल्डर के लिए `skill publish` कॉल करता है:
