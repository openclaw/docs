...
read_when:
    ...
    - Registry से skill या plugin इंस्टॉल करना
...
x-i18n:
    generated_at: "2026-07-02T14:02:53Z"
    model: gpt-5.5
...
जब आप OpenClaw में चीजें इंस्टॉल कर रहे हों, तब OpenClaw का उपयोग करें। जब आप साइन इन कर रहे हों, प्रकाशित कर रहे हों, अपनी खुद की लिस्टिंग प्रबंधित कर रहे हों, या रजिस्ट्री-विशिष्ट workflows का उपयोग कर रहे हों, तब `clawhub` CLI का उपयोग करें।
...
जब आप चाहते हैं कि OpenClaw पैकेज को npm या किसी अन्य स्रोत के बजाय ClawHub के माध्यम से resolve करे, तब `clawhub:` prefix का उपयोग करें।
...
कमांड अपरिवर्तित content को छोड़ देता है। नई skills `1.0.0` से शुरू होती हैं; बाद के changes स्वचालित रूप से अगला patch version प्रकाशित करते हैं। preview करने के लिए `--dry-run` या स्पष्ट version चुनने के लिए `--version` का उपयोग करें।

प्रकाशित करने से पहले, `SKILL.md` में metadata जांचें। आवश्यक environment variables, tools, और permissions घोषित करें ताकि users यह समझ सकें कि skill को इंस्टॉल करने से पहले क्या चाहिए। [Skill format](/hi/clawhub/skill-format) देखें।
...
Public listings नवीनतम scan state दिखाती हैं। moderation द्वारा रोके गए या blocked releases खोज और install surfaces से तब तक छिपे रह सकते हैं जब तक उनका समाधान न हो जाए।
