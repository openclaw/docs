...
x-i18n:
    generated_at: "2026-07-04T10:39:47Z"
    model: gpt-5.5
...
जब आप OpenClaw में चीज़ें इंस्टॉल कर रहे हों, तो OpenClaw का उपयोग करें। जब आप साइन इन कर रहे हों, प्रकाशित कर रहे हों, अपनी listings प्रबंधित कर रहे हों, या registry-specific workflows का उपयोग कर रहे हों, तो `clawhub` CLI का उपयोग करें।
...
OpenClaw यह रिकॉर्ड करता है कि skill कहाँ से आई थी, ताकि बाद के अपडेट ClawHub के ज़रिए resolve करना जारी रख सकें।
...
Command unchanged content को छोड़ देता है। नई Skills `1.0.0` से शुरू होती हैं; बाद के changes अपने आप अगला patch version प्रकाशित करते हैं। Preview के लिए `--dry-run` या स्पष्ट version चुनने के लिए `--version` का उपयोग करें।

प्रकाशित करने से पहले, `SKILL.md` में metadata जाँचें। आवश्यक environment variables, tools, और permissions घोषित करें, ताकि users इंस्टॉल करने से पहले समझ सकें कि skill को क्या चाहिए। [Skill format](/hi/clawhub/skill-format) देखें।
...
Local folder, GitHub repo, GitHub ref, या existing archive से plugin प्रकाशित करें:
...
प्रकाशित किए बिना resolved package metadata, compatibility fields, source attribution, और upload plan preview करने के लिए पहले `--dry-run` का उपयोग करें।
...
Public listings latest scan state दिखाती हैं। Moderation द्वारा रोके गए या blocked releases search और install surfaces से तब तक छिपे रह सकते हैं जब तक वे resolved न हों।
