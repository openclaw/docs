...
x-i18n:
    generated_at: "2026-07-03T13:27:57Z"
    model: gpt-5.5
...
Command unchanged content को skip करता है। नई skills `1.0.0` से शुरू होती हैं; बाद के changes अपने-आप अगला patch version publish करते हैं। Preview के लिए `--dry-run` या explicit version चुनने के लिए `--version` का उपयोग करें।
