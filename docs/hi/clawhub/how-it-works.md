...
x-i18n:
    generated_at: "2026-07-03T13:26:55Z"
    model: gpt-5.5
...
हर public listing एक registry record होती है, जिसमें शामिल हैं:
...
Listing page, उपयोगकर्ताओं के लिए यह जांचने की canonical जगह है कि कोई skill या
plugin install करने से पहले क्या करने का दावा करता है।
...
समझने के लिए `SKILL.md` frontmatter पढ़ता है। सटीक metadata महत्वपूर्ण है क्योंकि
यह उपयोगकर्ताओं को यह तय करने में मदद करता है कि skill install करना है या नहीं, और
...
Upload से पहले resolved payload preview करने के लिए dry runs का उपयोग करें। फिर public pages
...
Third-party catalogs इन APIs का उपयोग कर सकते हैं, जब वे canonical ClawHub listing पर वापस link करें,
rate limits का सम्मान करें, और endorsement का संकेत देने से बचें।
