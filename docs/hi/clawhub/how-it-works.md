...
packages खोजने की जगह देता है, publishers को versions रिलीज़ करने की जगह देता है, और
OpenClaw को उन packages को सुरक्षित रूप से install और update करने के लिए पर्याप्त metadata
देता है।
...
ClawHub publishing के लिए open है, लेकिन releases अभी भी upload gates,
