...
x-i18n:
    generated_at: "2026-07-01T15:23:36Z"
    model: gpt-5.5
...
हर public listing एक registry record होती है, जिसमें ये होते हैं:
...
ClawHub, skill name,
description, requirements, environment variables, और metadata समझने के लिए `SKILL.md` frontmatter पढ़ता है। सटीक
...
ClawHub publishing के लिए open है, लेकिन releases अब भी upload gates,
...
canonical ClawHub listing पर link back करें, rate limits का सम्मान करें, और endorsement का संकेत देने से बचें।
