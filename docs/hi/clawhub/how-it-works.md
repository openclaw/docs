---
read_when:
    - लिस्टिंग, संस्करणों, इंस्टॉल, प्रकाशन और मॉडरेशन को समझना
summary: ClawHub लिस्टिंग, संस्करण, इंस्टॉल, प्रकाशन, स्कैन और अपडेट कैसे काम करते हैं।
x-i18n:
    generated_at: "2026-07-02T08:15:42Z"
    model: gpt-5.5
...
ClawHub, OpenClaw Skills और Plugins के लिए registry layer है। यह users को
...
listing page वह canonical जगह है जहाँ users install करने से पहले देख सकते हैं कि कोई skill या
...
metadata महत्वपूर्ण है क्योंकि यह users को यह तय करने में मदद करता है कि skill install करनी है या नहीं, और
automated scans को declared और observed behavior के बीच mismatches detect करने में मदद करता है।
...
जब OpenClaw, ClawHub से plugin install करता है, तो यह install करने से पहले advertised compatibility
...
Upload से पहले resolved payload preview करने के लिए dry runs का उपयोग करें। Public pages फिर
...
downloads के लिए public read APIs expose करता है। Third-party catalogs इन APIs का उपयोग कर सकते हैं, बशर्ते वे
