...
read_when:
    ...
    - रोककर रखी गई, छिपी हुई, या अवरुद्ध लिस्टिंग से पुनर्प्राप्ति
...
x-i18n:
    generated_at: "2026-07-04T06:31:36Z"
    model: gpt-5.5
...
guardrails चाहिए। रिपोर्ट, मॉडरेशन होल्ड, छिपी हुई लिस्टिंग, और खाता कार्रवाइयां
...
- प्रतिरूपण
- बदनीयती से किए गए पंजीकरण या ट्रेडमार्क का दुरुपयोग
...
ClawHub में ही कमजोरियों के लिए हैं। उदाहरणों में वेबसाइट, API, CLI, रजिस्ट्री, auth,
...
संगठन, ब्रांड, पैकेज-scope, owner-handle, या namespace स्वामित्व विवादों के लिए
[संगठन और Namespace दावे](/clawhub/namespace-claims) प्रक्रिया का उपयोग करना चाहिए, न कि
इन-प्रोडक्ट रिपोर्ट flow या खाता appeal form का।

इस प्रक्रिया का उपयोग तब करें जब आपको ClawHub staff से ऐसे गैर-संवेदनशील प्रमाण की समीक्षा करवानी हो कि कोई
namespace आरक्षित, हस्तांतरित, नाम बदला, छिपाया, quarantined, aliased,
...
moderation hold के अधीन रख सकते हैं। ऐसा होने पर, प्रभावित सामग्री सार्वजनिक
discovery से छिपाई जा सकती है या भविष्य के publishes issue की समीक्षा होने तक hidden शुरू हो सकते हैं।

Moderation holds का उद्देश्य users की सुरक्षा करना है, जबकि ClawHub high-risk
cases को हल करता है। false positive की पुष्टि होने पर इन्हें हटाया भी जा सकता है।
...
issue हल न कर दे या moderation उसे restore न कर दे।

Owners फिर भी अपनी held या hidden listings के लिए diagnostics देख सकते हैं। ये
diagnostics यह समझाने में मदद करते हैं कि क्या हुआ और listing के public surfaces पर लौटने से पहले
क्या बदलना आवश्यक है।

## प्रतिबंध और खाता स्थिति

ClawHub नीति का उल्लंघन करने वाले accounts publishing access खो सकते हैं। गंभीर abuse के परिणामस्वरूप
...
ClawHub के potential-ban threshold तक पहुंचते हैं, वे automatic warning trigger कर सकते हैं। यदि warning deadline के बाद अगला
...
state की समीक्षा करने के लिए web UI में sign in करें। यदि sign-in या सामान्य CLI access ban या disabled account से blocked है, तो
recovery review के लिए [ClawHub appeal form](https://appeals.openclaw.ai/) का उपयोग करें।
