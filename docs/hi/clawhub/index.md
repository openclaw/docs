...
title: ClawHub
x-i18n:
    generated_at: "2026-07-02T14:02:51Z"
    model: gpt-5.5
...
| Surface        | यह क्या संग्रहीत करता है                                    | सामान्य command                              |
| -------------- | ------------------------------------------------------------ | -------------------------------------------- |
...
state दिखाते हैं ताकि users install करने से पहले किसी skill या plugin की जांच कर सकें.
...
जब plugin install ClawHub के माध्यम से resolve होना चाहिए, तो `clawhub:<package>` का उपयोग करें.
...
ये commands current working directory के तहत `./skills` में Skills install करते हैं
...
`/dashboard` में उनके owner को visible रहते हैं.
