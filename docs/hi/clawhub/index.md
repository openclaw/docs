...
title: ClawHub
x-i18n:
    generated_at: "2026-07-03T13:30:14Z"
    model: gpt-5.5
...
- ClawHub से skills खोजने, install करने और update करने तथा plugins install करने के लिए मूल `openclaw` commands का उपयोग करें।
...
OpenClaw से plugins खोजें और install करें:
...
state दिखाते हैं, ताकि users install करने से पहले किसी skill या plugin का निरीक्षण कर सकें।
...
जब plugin install को ClawHub के माध्यम से resolve होना चाहिए, तब `clawhub:<package>` का उपयोग करें।
Bare npm-safe plugin specs launch cutovers के दौरान npm के माध्यम से resolve हो सकते हैं, और
जब source explicit होना चाहिए, तब `npm:<package>` केवल npm ही रहता है।
...
OpenClaw exact uploaded npm-pack `.tgz` को prefer करता है, ClawHub digest header और downloaded bytes
verify करता है, और बाद के updates के लिए artifact metadata record करता है।
...
- `--tags <tags>`: comma-separated tags, default `latest` होता है।
...
upload किए बिना exact publish plan build करने के लिए `--dry-run` का उपयोग करें, और
CI-friendly output के लिए `--json` का उपयोग करें।
...
account आवश्यक है जो upload gate पार करने के लिए पर्याप्त पुराना हो। सार्वजनिक detail pages install या download से पहले
...
| Variable                      | Effect                                             |
| ----------------------------- | -------------------------------------------------- |
| `CLAWHUB_SITE`                | browser login के लिए उपयोग की जाने वाली site URL override करें। |
| `CLAWHUB_REGISTRY`            | registry API URL override करें।                   |
| `CLAWHUB_CONFIG_PATH`         | CLI token/config state कहां store करता है, उसे override करें। |
