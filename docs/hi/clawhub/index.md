...
title: ClawHub
x-i18n:
    generated_at: "2026-07-03T00:56:46Z"
    model: gpt-5.5
...
- रजिस्ट्री प्रमाणीकरण, प्रकाशन, और हटाने/पुनर्स्थापित करने वाले वर्कफ़्लो के लिए अलग `clawhub` CLI का उपयोग करें।
...
| कोड Plugin     | संगतता मेटाडेटा वाले OpenClaw Plugin पैकेज                    | `openclaw plugins install clawhub:<package>` |
| बंडल Plugin    | OpenClaw वितरण के लिए पैकेज किए गए Plugin बंडल                 | `clawhub package publish <source>`           |

ClawHub semver संस्करणों, `latest` जैसे टैग, चेंजलॉग, फ़ाइलों,
...
जब किसी Plugin इंस्टॉल को ClawHub के ज़रिए हल करना हो, तो `clawhub:<package>` का उपयोग करें।
लॉन्च कटओवर के दौरान bare npm-safe Plugin specs npm के ज़रिए हल हो सकते हैं, और
जब स्रोत स्पष्ट होना ज़रूरी हो तो `npm:<package>` केवल npm ही रहता है।

Plugin इंस्टॉल archive install चलने से पहले विज्ञापित `pluginApi` और `minGatewayVersion`
संगतता को मान्य करते हैं। जब कोई पैकेज संस्करण ClawPack artifact प्रकाशित करता है,
OpenClaw सटीक अपलोड किए गए npm-pack `.tgz` को प्राथमिकता देता है, ClawHub digest header
और डाउनलोड किए गए bytes को सत्यापित करता है, और बाद के अपडेट के लिए artifact मेटाडेटा रिकॉर्ड करता है।
...
किसी स्थानीय फ़ोल्डर, `owner/repo`, `owner/repo@ref`, या GitHub
...
अपलोड किए बिना सटीक publish plan बनाने के लिए `--dry-run` का उपयोग करें, और CI-अनुकूल
...
`openclaw.build.openclawVersion` शामिल हैं। पूरे कमांड
...
खाता चाहिए जो upload gate पास करने के लिए पर्याप्त पुराना हो। सार्वजनिक detail pages इंस्टॉल या डाउनलोड से पहले
नवीनतम scan state का सारांश देते हैं।

ClawHub प्रकाशित Skills और Plugin releases पर स्वचालित जांच चलाता है। Scan-held
...
साइन-इन किए हुए उपयोगकर्ता Skills और packages की रिपोर्ट कर सकते हैं। मॉडरेटर रिपोर्ट की समीक्षा कर सकते हैं,
content को छिपा या restore कर सकते हैं, और abusive accounts को ban कर सकते हैं। नीति और enforcement details के लिए
...
install event भेज सकता है ताकि ClawHub aggregate install counts की गणना कर सके। इसे इसके साथ अक्षम करें:
...
| `CLAWHUB_CONFIG_PATH`         | CLI token/config state कहाँ stored करता है, इसे override करें। |
