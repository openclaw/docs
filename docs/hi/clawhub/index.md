...
title: ClawHub
x-i18n:
    generated_at: "2026-07-04T17:58:04Z"
    model: gpt-5.5
...
जब आपको publish या delete/undelete जैसे रजिस्ट्री-प्रमाणीकृत वर्कफ़्लो चाहिए हों,
...
डाउनलोड, सितारे, और सुरक्षा स्कैन सारांश ट्रैक करता है। सार्वजनिक पेज वर्तमान रजिस्ट्री
...
जब किसी plugin इंस्टॉल को ClawHub के माध्यम से resolve करना हो, तो `clawhub:<package>` का उपयोग करें।
नंगे npm-सुरक्षित plugin spec लॉन्च कटओवर के दौरान npm के माध्यम से resolve हो सकते हैं, और
जब स्रोत स्पष्ट होना आवश्यक हो, तो `npm:<package>` केवल npm पर रहता है।
...
और डाउनलोड किए गए bytes की पुष्टि करता है, और बाद के अपडेट के लिए artifact metadata रिकॉर्ड करता है।
...
- `--tags <tags>`: अल्पविराम से अलग किए गए टैग, डिफ़ॉल्ट `latest`।
...
खाता चाहिए जो upload gate पास करने के लिए पर्याप्त पुराना हो। सार्वजनिक विवरण पेज
install या download से पहले नवीनतम scan स्थिति का सारांश देते हैं।

ClawHub प्रकाशित Skills और Plugin रिलीज़ पर स्वचालित जांच चलाता है। Scan-held
या अवरुद्ध रिलीज़ सार्वजनिक catalog और install surfaces से गायब हो सकती हैं, जबकि
अपने owner को `/dashboard` में दिखाई देती रहती हैं।

साइन-इन किए हुए उपयोगकर्ता Skills और packages की रिपोर्ट कर सकते हैं। Moderators रिपोर्टों की समीक्षा कर सकते हैं,
सामग्री छिपा या पुनर्स्थापित कर सकते हैं, और दुरुपयोग करने वाले खातों को ban कर सकते हैं। नीति और enforcement विवरणों के लिए
...
जब आप logged in रहते हुए `clawhub install` चलाते हैं, तो CLI एक सर्वोत्तम-प्रयास
install घटना भेज सकता है ताकि ClawHub कुल install counts की गणना कर सके। इसे इससे अक्षम करें:
...
| `CLAWHUB_CONFIG_PATH`         | CLI token/config state कहाँ संग्रहीत करता है, उसे override करें। |
| `CLAWHUB_WORKDIR`             | default working directory override करें।        |
| `CLAWHUB_DISABLE_TELEMETRY=1` | install telemetry अक्षम करें।                  |

गहरे संदर्भ सामग्री के लिए [Telemetry](/clawhub/telemetry), [HTTP API](/clawhub/http-api), और
