...
जब Plugin install को ClawHub के माध्यम से resolve करना हो, तब `clawhub:<package>` का उपयोग करें।
...
OpenClaw exact uploaded npm-pack `.tgz` को प्राथमिकता देता है, ClawHub digest header
