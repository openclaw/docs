...
title: ClawHub
x-i18n:
    generated_at: "2026-07-05T06:15:23Z"
    model: gpt-5.5
...
- रजिस्ट्री प्रमाणीकरण, प्रकाशन, और डिलीट/अनडिलीट वर्कफ़्लो के लिए अलग `clawhub` CLI का उपयोग करें।
...
| बंडल Plugin    | OpenClaw वितरण के लिए पैक किए गए Plugin बंडल                 | `clawhub package publish <source>`           |

ClawHub semver संस्करणों, `latest` जैसे टैग, changelogs, फ़ाइलों,
डाउनलोड, स्टार, और सुरक्षा स्कैन सारांशों को ट्रैक करता है। सार्वजनिक पेज वर्तमान रजिस्ट्री
...
Bare npm-safe Plugin specs लॉन्च कटओवर के दौरान npm के माध्यम से रिज़ॉल्व हो सकते हैं, और
जब स्रोत को स्पष्ट होना ज़रूरी हो, तब `npm:<package>` केवल npm तक सीमित रहता है।
...
और डाउनलोड किए गए bytes को सत्यापित करता है, और बाद के अपडेट के लिए artifact metadata रिकॉर्ड करता है।
...
अपलोड किए बिना सटीक प्रकाशन योजना बनाने के लिए `--dry-run` का उपयोग करें, और CI-अनुकूल आउटपुट के लिए `--json`
का उपयोग करें।
...
संदर्भ के लिए [CLI](/hi/clawhub/cli) और Skill मेटाडेटा के लिए [Skill फ़ॉर्मैट](/clawhub/skill-format) देखें।

## सुरक्षा और मॉडरेशन

ClawHub डिफ़ॉल्ट रूप से खुला है: कोई भी अपलोड कर सकता है, लेकिन प्रकाशन के लिए ऐसा GitHub
खाता आवश्यक है जो upload gate पास करने के लिए पर्याप्त पुराना हो। सार्वजनिक विवरण पेज install या download से पहले
नवीनतम स्कैन स्थिति का सारांश देते हैं।

ClawHub प्रकाशित Skills और Plugin releases पर स्वचालित जाँच चलाता है। स्कैन के कारण रोकी गई
या अवरुद्ध releases सार्वजनिक catalog और install सतहों से गायब हो सकती हैं, जबकि
...
content को hide या restore कर सकते हैं, और abusive accounts को ban कर सकते हैं। नीति और enforcement विवरण के लिए
...
install event भेज सकता है ताकि ClawHub aggregate install counts की गणना कर सके। इसे इस तरह अक्षम करें:
...
गहन संदर्भ सामग्री के लिए [Telemetry](/hi/clawhub/telemetry), [HTTP API](/clawhub/http-api), और
