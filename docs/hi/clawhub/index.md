...
title: ClawHub
x-i18n:
    generated_at: "2026-07-02T00:55:07Z"
    model: gpt-5.5
...
- ClawHub से Skills खोजने, इंस्टॉल करने, अपडेट करने और Plugins इंस्टॉल करने के लिए मूल `openclaw` कमांड का उपयोग करें।
- रजिस्ट्री ऑथ, प्रकाशन, और हटाने/हटाना रद्द करने वाले वर्कफ़्लो के लिए अलग `clawhub` CLI का उपयोग करें।
...
जब आपको प्रकाशन या हटाने/हटाना रद्द करने जैसे रजिस्ट्री-प्रमाणीकृत वर्कफ़्लो चाहिए हों,
...
| -------------- | ------------------------------------------------------------ | -------------------------------------------- |
| Skills         | `SKILL.md` और सहायक फ़ाइलों वाले वर्शन किए गए टेक्स्ट बंडल | `openclaw skills install @openclaw/demo`     |
...
ClawHub semver वर्शन, `latest` जैसे टैग, चेंजलॉग, फ़ाइलें,
...
जब किसी Plugin इंस्टॉल को ClawHub के माध्यम से हल होना चाहिए, तो `clawhub:<package>` का उपयोग करें।
लॉन्च कटओवर के दौरान साधारण npm-सुरक्षित Plugin स्पेक npm के माध्यम से हल हो सकते हैं, और
जब स्रोत स्पष्ट होना जरूरी हो, तो `npm:<package>` केवल npm पर ही रहता है।

Plugin इंस्टॉल आर्काइव इंस्टॉल चलने से पहले विज्ञापित `pluginApi` और `minGatewayVersion`
संगतता की पुष्टि करते हैं। जब कोई पैकेज वर्शन ClawPack आर्टिफ़ैक्ट प्रकाशित करता है,
तो OpenClaw सटीक अपलोड किए गए npm-pack `.tgz` को प्राथमिकता देता है, ClawHub डाइजेस्ट
हेडर और डाउनलोड किए गए बाइट्स की पुष्टि करता है, और बाद के अपडेट के लिए आर्टिफ़ैक्ट मेटाडेटा रिकॉर्ड करता है।
...
CLI में प्रत्यक्ष रजिस्ट्री वर्कफ़्लो के लिए Skill इंस्टॉल/अपडेट कमांड भी हैं:
...
और इंस्टॉल किए गए वर्शन `.clawhub/lock.json` में रिकॉर्ड करते हैं।
...
- `--version <version>`: semver वर्शन।
- `--changelog <text>`: चेंजलॉग टेक्स्ट।
- `--tags <tags>`: कॉमा-सेपरेटेड टैग, डिफ़ॉल्ट रूप से `latest`।
...
रेफ़रेंस के लिए [CLI](/hi/clawhub/cli) और Skill मेटाडेटा के लिए [Skill फ़ॉर्मैट](/clawhub/skill-format) देखें।

## सुरक्षा और मॉडरेशन

ClawHub डिफ़ॉल्ट रूप से खुला है: कोई भी अपलोड कर सकता है, लेकिन प्रकाशन के लिए ऐसा GitHub
खाता चाहिए जो अपलोड गेट पास करने के लिए पर्याप्त पुराना हो। सार्वजनिक विवरण पेज इंस्टॉल या डाउनलोड से पहले
नवीनतम स्कैन स्थिति का सारांश देते हैं।

ClawHub प्रकाशित Skills और Plugin रिलीज़ पर स्वचालित जांच चलाता है। स्कैन-रोकी गई
या अवरुद्ध रिलीज़ सार्वजनिक कैटलॉग और इंस्टॉल सतहों से गायब हो सकती हैं, जबकि
अपने मालिक को `/dashboard` में दिखाई देती रहती हैं।

साइन-इन किए हुए उपयोगकर्ता Skills और पैकेज की रिपोर्ट कर सकते हैं। मॉडरेटर रिपोर्ट की समीक्षा कर सकते हैं,
सामग्री छिपा या पुनर्स्थापित कर सकते हैं, और दुरुपयोग करने वाले खातों पर प्रतिबंध लगा सकते हैं। नीति और प्रवर्तन विवरण के लिए
...
जब आप लॉग इन रहते हुए `clawhub install` चलाते हैं, तो CLI एक सर्वोत्तम-प्रयास
इंस्टॉल इवेंट भेज सकता है, ताकि ClawHub कुल इंस्टॉल गणना निकाल सके। इसे इससे अक्षम करें:
...
| `CLAWHUB_CONFIG_PATH`         | CLI टोकन/कॉन्फ़िग स्थिति कहाँ संग्रहीत करता है, इसे ओवरराइड करें। |
| `CLAWHUB_WORKDIR`             | डिफ़ॉल्ट कार्यशील डायरेक्टरी को ओवरराइड करें।           |
| `CLAWHUB_DISABLE_TELEMETRY=1` | इंस्टॉल टेलीमेट्री अक्षम करें।                        |

अधिक गहरे रेफ़रेंस सामग्री के लिए [टेलीमेट्री](/clawhub/telemetry), [HTTP API](/clawhub/http-api), और
