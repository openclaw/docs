...
summary: ClawHub साइन-इन, इंस्टॉलेशन, प्रकाशन, अपडेट और API संबंधी समस्याओं का समस्या निवारण।
x-i18n:
    generated_at: "2026-07-03T13:31:24Z"
    model: gpt-5.5
...
CLI ब्राउज़र लॉगिन के दौरान अल्पकालिक स्थानीय कॉलबैक सर्वर शुरू करता है।
...
व्यक्ति केवल कुछ अनुरोध भेजता है। जहां संभव हो साइन इन करें और रिपोर्ट की गई
...
- यदि आपको सटीक slug या owner पेज पता है, तो उसे जांचें।
...
Owner को दिखने वाले डायग्नॉस्टिक्स स्कैन, upload-gate, या मॉडरेशन स्थिति समझा सकते हैं।

## आवश्यक मेटाडेटा गायब होने के कारण प्रकाशित करना विफल होता है

Skills के लिए, `SKILL.md` frontmatter जांचें। आवश्यक environment variables और
tools घोषित होने चाहिए ताकि उपयोगकर्ता और स्कैनर पैकेज को समझ सकें।

plugins के लिए, `package.json` संगतता मेटाडेटा जांचें। Code-plugin प्रकाशित करने के लिए
...
## GitHub owner या स्रोत त्रुटि के कारण प्रकाशित करना विफल होता है

ClawHub पैकेजों को उनके प्रकाशकों से जोड़ने के लिए GitHub पहचान और स्रोत एट्रिब्यूशन का उपयोग करता है।

- सुनिश्चित करें कि आप उस GitHub खाते से साइन इन हैं जो पैकेज का owner है या उसे प्रकाशित कर सकता है।
...
## namespace दावा किया गया या आरक्षित होने के कारण प्रकाशित करना विफल होता है

यदि प्रकाशित करना इसलिए विफल होता है क्योंकि owner handle, org namespace, package scope, skill
slug, या package name पहले से दावा किया गया या आरक्षित है, तो पहले पुष्टि करें कि आप
namespace से मेल खाने वाले owner के साथ प्रकाशित कर रहे हैं। plugin पैकेजों के लिए,
`@example-org/example-plugin` जैसे scoped names को मेल खाने वाले
`example-org` owner के रूप में प्रकाशित किया जाना चाहिए।
...
- यदि पैकेज hidden, held, या blocked है, तो जब तक
  owner समस्या हल नहीं करता, वह install करने योग्य नहीं हो सकता।
