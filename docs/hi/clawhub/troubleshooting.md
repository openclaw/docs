...
x-i18n:
    generated_at: "2026-06-30T14:01:06Z"
    model: gpt-5.5
...
CLI ब्राउज़र लॉगिन के दौरान अल्प-कालिक स्थानीय कॉलबैक सर्वर शुरू करता है।
...
यदि कई उपयोगकर्ता एक ही इग्रेस IP साझा करते हैं, तो अनाम IP सीमाएं तब भी लग सकती हैं जब प्रत्येक
...
## खोज में कोई स्किल दिखाई नहीं देती
...
- यदि आप स्किल के मालिक हैं, तो साइन इन करें और उसका निरीक्षण करें:
...
## आवश्यक मेटाडेटा गायब होने के कारण प्रकाशन विफल होता है
...
Plugins के लिए, `package.json` संगतता मेटाडेटा जांचें। कोड-Plugin प्रकाशनों
...
यदि प्रकाशन इसलिए विफल होता है क्योंकि मालिक हैंडल, org नेमस्पेस, पैकेज स्कोप, स्किल
...
खोलें। प्रमाण संबंधी मार्गदर्शन और सार्वजनिक मुद्दों से क्या बाहर रखना है, इसके लिए
[Org और Namespace Claims](/clawhub/namespace-claims) देखें।

## `sync` कहता है कि कोई Skills नहीं मिलीं

`sync` `SKILL.md` या `skill.md` वाली फ़ोल्डरें खोजता है।
...
- यदि पैकेज छिपा हुआ, रोका गया, या अवरुद्ध है, तो मालिक द्वारा समस्या हल किए जाने तक
  उसे इंस्टॉल नहीं किया जा सकता।
