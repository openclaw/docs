...
x-i18n:
    generated_at: "2026-07-01T20:21:26Z"
    model: gpt-5.5
...
CLI ब्राउज़र login के दौरान एक अल्पकालिक स्थानीय callback server शुरू करता है।
...
- यदि आप custom config path का उपयोग करते हैं, तो पुष्टि करें कि `CLAWHUB_CONFIG_PATH` उस
  file की ओर इशारा करता है जिसमें आपका current token है।
...
- `RateLimit-Remaining`: header मौजूद होने पर आपका सटीक remaining budget। `429` पर, यह `0` होता है।
...
- पुष्टि करें कि release public है और scan या moderation द्वारा held नहीं है।
- यदि आप Skills के owner हैं, तो sign in करें और inspect करें:
...
## Required metadata missing होने के कारण publish fail होता है

Skills के लिए, `SKILL.md` frontmatter जांचें। Required environment variables और
tools declared होने चाहिए ताकि users और scanners package को समझ सकें।
...
## GitHub owner या source error के कारण publish fail होता है

ClawHub packages को उनके publishers से जोड़ने के लिए GitHub identity और source attribution का उपयोग करता है।

- सुनिश्चित करें कि आपने उस GitHub account से sign in किया है जो package का owner है या उसे publish कर सकता है।
...
## Namespace claimed या reserved होने के कारण publish fail होता है
...
आप current ClawHub owner को manage नहीं कर सकते, तो public, non-sensitive proof के साथ
...
## Local changes के कारण `update` मना करता है

Local files ClawHub द्वारा ज्ञात किसी भी version से match नहीं करतीं। एक चुनें:
...
- अपनी edited copy को new slug या fork के रूप में publish करें।
