...
x-i18n:
    generated_at: "2026-07-04T10:40:18Z"
    model: gpt-5.5
...
- यदि callback कभी नहीं पहुँचता है, तो स्थानीय firewall, VPN, और proxy नियम जाँचें।
- headless वातावरणों में, ClawHub web UI में API token बनाएँ और चलाएँ:
...
- `RateLimit-Remaining`: header मौजूद होने पर आपका ठीक-ठीक बचा हुआ budget। `429` पर, यह `0` होता है।
- `RateLimit-Reset` या `X-RateLimit-Reset`: reset timing।

यदि कई users एक egress IP साझा करते हैं, तो anonymous IP limits हिट हो सकती हैं, भले ही प्रत्येक
व्यक्ति केवल कुछ requests भेजे। जहाँ संभव हो sign in करें और रिपोर्ट की गई
...
plugins के लिए, `package.json` compatibility metadata जाँचें। Code-plugin publishes को
...
- GitHub sources के लिए, `owner/repo`, `owner/repo@ref`, या full GitHub URL उपयोग करें।
...
यदि आपको यकीन नहीं है कि क्या publish होगा, तो पहले preview करें:
...
local files ClawHub को ज्ञात किसी भी version से match नहीं करतीं। एक चुनें:
...
- यदि package hidden, held, या blocked है, तो जब तक owner issue resolve नहीं करता,
