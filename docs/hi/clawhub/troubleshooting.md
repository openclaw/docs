...
- headless परिवेशों में, ClawHub web UI में API token बनाएं और चलाएं:
...
- यदि आप custom config path का उपयोग करते हैं, तो पुष्टि करें कि `CLAWHUB_CONFIG_PATH` उस
  file की ओर इशारा करता है जिसमें आपका मौजूदा token है।
...
- यदि skill आपका है, तो sign in करें और उसका निरीक्षण करें:
...
## Publish इसलिए विफल होता है क्योंकि required metadata missing है
...
को OpenClaw compatibility fields जैसे `openclaw.compat.pluginApi` और
...
## Publish इसलिए विफल होता है क्योंकि namespace claim या reserve किया गया है
...
scoped names जैसे `@example-org/example-plugin` को मिलते-जुलते
...
आप वर्तमान ClawHub owner को manage नहीं कर सकते, तो public, non-sensitive proof के साथ एक
...
`sync` `SKILL.md` या `skill.md` वाले folders ढूंढता है।

उसे उन roots की ओर point करें जिन्हें आप scan करना चाहते हैं:
...
local files ClawHub को ज्ञात किसी भी version से मेल नहीं खाते। एक विकल्प चुनें:
