...
x-i18n:
    generated_at: "2026-07-04T06:31:29Z"
    model: gpt-5.5
...
आप ClawHub की सार्वजनिक रीड APIs के ऊपर एक तृतीय-पक्ष कैटलॉग, डायरेक्टरी, या खोज सतह बना सकते हैं। सार्वजनिक skill metadata और skill files ClawHub के skill license rules के अंतर्गत प्रकाशित किए जाते हैं, जबकि API स्वयं rate-limited है और इसका उपयोग जिम्मेदारी से किया जाना चाहिए।
...
- सूचियां दिखाते समय canonical ClawHub skill URL पर वापस link करें ताकि उपयोगकर्ता स्रोत registry record देख सकें।
...
- लिखना + account: `Authorization: Bearer clh_...`।
...
- `X-RateLimit-Remaining` / `RateLimit-Remaining`: मौजूद होने पर सटीक शेष budget; sharded सफल requests approximate global value लौटाने के बजाय इसे छोड़ देते हैं
