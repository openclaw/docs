...
आप ClawHub के सार्वजनिक रीड API के ऊपर तृतीय-पक्ष कैटलॉग, डायरेक्टरी, या खोज सतह बना सकते हैं। सार्वजनिक skill मेटाडेटा और skill फ़ाइलें ClawHub के skill लाइसेंस नियमों के तहत प्रकाशित की जाती हैं, जबकि API स्वयं दर-सीमित है और इसका उपयोग जिम्मेदारी से किया जाना चाहिए।
...
- आक्रामक polling करने के बजाय प्रतिक्रियाएँ cache करें और `429`, `Retry-After`, तथा rate-limit header का सम्मान करें।
- सूचियाँ दिखाते समय canonical ClawHub skill URL पर वापस link करें ताकि उपयोगकर्ता स्रोत registry record की जाँच कर सकें।
- `https://clawhub.ai/<owner>/skills/<slug>` के रूप में canonical page URL का उपयोग करें।
- यह संकेत न दें कि ClawHub तृतीय-पक्ष site का समर्थन, सत्यापन, या संचालन करता है।
- सार्वजनिक API filter या auth boundaries को bypass करके hidden, private, या moderation-blocked content को mirror न करें।
...
- `X-RateLimit-Remaining` / `RateLimit-Remaining`: उपस्थित होने पर सटीक remaining budget; sharded successful requests अनुमानित global value लौटाने के बजाय इसे छोड़ देते हैं
...
- compatibility के लिए unknown query parameters अनदेखे किए जाते हैं।
