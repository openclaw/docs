...
आप ClawHub के सार्वजनिक रीड API के ऊपर तृतीय-पक्ष कैटलॉग, निर्देशिका या खोज सतह बना सकते हैं। सार्वजनिक Skill मेटाडेटा और Skill फ़ाइलें ClawHub के Skill लाइसेंस नियमों के अंतर्गत प्रकाशित की जाती हैं, जबकि API स्वयं दर-सीमित है और इसका उपयोग जिम्मेदारी से किया जाना चाहिए।
...
- सूचियां दिखाते समय कैनॉनिकल ClawHub Skill URL से वापस लिंक करें ताकि उपयोगकर्ता स्रोत रजिस्ट्री रिकॉर्ड की जांच कर सकें।
...
- सार्वजनिक API फ़िल्टर या प्रमाणीकरण सीमाओं को बायपास करके छिपी, निजी या मॉडरेशन-अवरुद्ध सामग्री को मिरर न करें।
...
- प्रमाणीकृत अनुरोध (वैध Bearer टोकन): प्रति उपयोगकर्ता बकेट।
- अनुपस्थित/अमान्य टोकन IP प्रवर्तन पर वापस चला जाता है।

- रीड: 3000/मिनट प्रति IP, 12000/मिनट प्रति कुंजी
- लेखन: 300/मिनट प्रति IP, 3000/मिनट प्रति कुंजी
...
- v1 त्रुटियां सादा पाठ (`text/plain; charset=utf-8`) होती हैं, जिनमें `400`,
...
- `GET /api/v1/skills?limit=&cursor=&sort=`
  ...
  - `cursor` गैर-`trending` क्रमों पर लागू होता है
...
- `GET /api/v1/download?slug=&version=&tag=`
  - होस्टेड Skills निर्धारक ZIP बाइट लौटाते हैं।
...
- `GET /api/v1/skills/export?startDate=&endDate=&limit=&cursor=`
  - होस्टेड Skills संग्रहीत फ़ाइलों के रूप में निर्यात किए जाते हैं।
...
- `POST /api/v1/skills` (प्रकाशन, multipart वांछनीय)
...
- `POST /api/v1/users/reserve` किसी मालिक हैंडल के लिए रूट स्लग और निजी नो-रिलीज़ पैकेज प्लेसहोल्डर आरक्षित करता है।
