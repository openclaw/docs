...
आप ClawHub के सार्वजनिक रीड APIs के ऊपर तृतीय-पक्ष कैटलॉग, डायरेक्टरी, या खोज सतह बना सकते हैं। सार्वजनिक skill मेटाडेटा और skill फ़ाइलें ClawHub के skill लाइसेंस नियमों के अंतर्गत प्रकाशित की जाती हैं, जबकि API स्वयं दर-सीमित है और उसका जिम्मेदारी से उपयोग किया जाना चाहिए।
...
- responses को cache करें और आक्रामक polling के बजाय `429`, `Retry-After`, और rate-limit headers का सम्मान करें।
- सूचियाँ दिखाते समय canonical ClawHub skill URL पर वापस link करें, ताकि उपयोगकर्ता स्रोत registry record देख सकें।
...
- सार्वजनिक API filters या auth सीमाओं को bypass करके hidden, private, या moderation-blocked content को mirror न करें।
...
- `X-RateLimit-Remaining` / `RateLimit-Remaining`: उपस्थित होने पर exact remaining budget; sharded successful requests अनुमानित global value लौटाने के बजाय इसे omit करते हैं
