...
x-i18n:
    generated_at: "2026-07-02T00:54:21Z"
    model: gpt-5.5
...
आप ClawHub के सार्वजनिक रीड API के ऊपर तृतीय-पक्ष कैटलॉग, डायरेक्टरी, या खोज सतह बना सकते हैं। सार्वजनिक skill मेटाडेटा और skill फ़ाइलें ClawHub के skill लाइसेंस नियमों के तहत प्रकाशित की जाती हैं, जबकि API स्वयं rate-limited है और उसका उपयोग जिम्मेदारी से किया जाना चाहिए।
...
- responses को cache करें और आक्रामक polling करने के बजाय `429`, `Retry-After`, और rate-limit headers का सम्मान करें।
- listings दिखाते समय canonical ClawHub skill URL पर वापस link करें ताकि users source registry record की जाँच कर सकें।
- `https://clawhub.ai/<owner>/skills/<slug>` के रूप में canonical page URLs का उपयोग करें।
- यह न जताएँ कि ClawHub तृतीय-पक्ष site का endorsement, verification, या संचालन करता है।
...
- Unknown query parameters को compatibility के लिए ignore किया जाता है।
