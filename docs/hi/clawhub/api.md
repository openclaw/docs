...
x-i18n:
    generated_at: "2026-07-03T00:56:29Z"
    model: gpt-5.5
...
आप ClawHub के सार्वजनिक read APIs के ऊपर किसी तृतीय-पक्ष कैटलॉग, डायरेक्टरी, या खोज सतह बना सकते हैं। सार्वजनिक स्किल मेटाडेटा और स्किल फ़ाइलें ClawHub के स्किल लाइसेंस नियमों के तहत प्रकाशित की जाती हैं, जबकि API स्वयं rate-limited है और इसे जिम्मेदारी से उपयोग किया जाना चाहिए।
...
- प्रतिक्रियाओं को cache करें और आक्रामक रूप से polling करने के बजाय `429`, `Retry-After`, और rate-limit headers का सम्मान करें।
- सूचियां दिखाते समय canonical ClawHub स्किल URL पर वापस link करें ताकि उपयोगकर्ता स्रोत registry record की जांच कर सकें।
...
- सार्वजनिक API filters या auth boundaries को bypass करके hidden, private, या moderation-blocked सामग्री को mirror न करें।
...
- `X-RateLimit-Remaining` / `RateLimit-Remaining`: मौजूद होने पर सटीक remaining budget; sharded सफल requests अनुमानित global value लौटाने के बजाय इसे omit करते हैं
...
- `GET /api/v1/download?slug=&version=&tag=`
  ...
  - `clean` या `suspicious` scan वाली वर्तमान GitHub-backed skills ClawHub bytes के बजाय JSON `public-github` handoff descriptor लौटाती हैं।
- `GET /api/v1/skills/export?startDate=&endDate=&limit=&cursor=`
  - Hosted skills stored files के रूप में export की जाती हैं।
  - `clean` या `suspicious` scan वाली वर्तमान GitHub-backed skills `public-github` handoff descriptors के रूप में export की जाती हैं।
