...
x-i18n:
    generated_at: "2026-07-01T18:12:15Z"
    model: gpt-5.5
...
आप ClawHub के सार्वजनिक read API के ऊपर तृतीय-पक्ष कैटलॉग, डायरेक्टरी, या खोज सतह बना सकते हैं। सार्वजनिक skill मेटाडेटा और skill फ़ाइलें ClawHub के skill लाइसेंस नियमों के तहत प्रकाशित की जाती हैं, जबकि API स्वयं rate-limited है और इसे ज़िम्मेदारी से उपयोग किया जाना चाहिए।

दिशानिर्देश:

- कैटलॉग सूचीकरणों के लिए सार्वजनिक read endpoints जैसे `GET /api/v1/skills`, `GET /api/v1/search`, और `GET /api/v1/skills/{slug}` का उपयोग करें।
- प्रतिक्रियाओं को कैश करें और आक्रामक polling के बजाय `429`, `Retry-After`, और rate-limit headers का सम्मान करें।
- listings दिखाते समय canonical ClawHub skill URL पर वापस लिंक करें ताकि उपयोगकर्ता source registry record का निरीक्षण कर सकें।
- `https://clawhub.ai/<owner>/skills/<slug>` के रूप में canonical page URLs का उपयोग करें।
- यह न जताएं कि ClawHub तृतीय-पक्ष site का समर्थन, सत्यापन, या संचालन करता है।
- सार्वजनिक API filters या auth boundaries को bypass करके छिपी, निजी, या moderation-blocked content को mirror न करें।
...
- Unknown query parameters compatibility के लिए ignore किए जाते हैं।
