...
- सूचियां दिखाते समय कैननिकल ClawHub स्किल URL से वापस लिंक करें ताकि उपयोगकर्ता स्रोत रजिस्ट्री रिकॉर्ड देख सकें।
...
- लेखन: प्रति IP 300/मिनट, प्रति कुंजी 3000/मिनट
...
- v1 त्रुटियां सादा पाठ (`text/plain; charset=utf-8`) होती हैं, जिनमें `400`, `401`, `403`, `404`, `429`, और रोकी गई डाउनलोड प्रतिक्रियाएं शामिल हैं।
...
- `GET /api/v1/search?q=...`
  ...
  - लीगेसी उपनाम: `nonSuspicious=true`
- `GET /api/v1/skills?limit=&cursor=&sort=`
  - `sort`: `updated` (डिफ़ॉल्ट), `recommended` (`default`), `createdAt` (`newest`), `downloads`, `stars` (`rating`), लीगेसी इंस्टॉल उपनाम `installsCurrent`/`installs`/`installsAllTime` `downloads`, `trending` से मैप होते हैं
...
- `GET /api/v1/download?slug=&version=&tag=`
  - होस्टेड स्किल्स नियतात्मक ZIP बाइट्स लौटाती हैं।
  - `clean` या `suspicious` स्कैन वाली वर्तमान GitHub-समर्थित स्किल्स ClawHub बाइट्स के बजाय JSON `public-github` हैंडऑफ़ डिस्क्रिप्टर लौटाती हैं।
- `GET /api/v1/skills/export?startDate=&endDate=&limit=&cursor=`
  - होस्टेड स्किल्स संग्रहीत फ़ाइलों के रूप में निर्यात की जाती हैं।
  - `clean` या `suspicious` स्कैन वाली वर्तमान GitHub-समर्थित स्किल्स `public-github` हैंडऑफ़ डिस्क्रिप्टर के रूप में निर्यात की जाती हैं।
- `GET /api/v1/packages?limit=&cursor=&sort=`
  - `sort`: `updated` (डिफ़ॉल्ट), `recommended`, `downloads`, लीगेसी उपनाम `installs`
  - अमान्य `sort` मान `400` लौटाते हैं
- `GET /api/v1/plugins?limit=&cursor=&sort=`
  - `sort`: `recommended` (डिफ़ॉल्ट), `downloads`, `updated`, लीगेसी उपनाम `installs`
...
- `POST /api/v1/skills` (प्रकाशन, multipart वरीय)
...
लीगेसी `/api/*` और `/api/cli/*` अब भी उपलब्ध हैं। `DEPRECATIONS.md` देखें।
