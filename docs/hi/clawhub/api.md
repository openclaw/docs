...
x-i18n:
    generated_at: "2026-07-01T15:23:34Z"
    model: gpt-5.5
...
आप ClawHub के सार्वजनिक रीड API के ऊपर तृतीय-पक्ष कैटलॉग, निर्देशिका, या खोज सतह बना सकते हैं। सार्वजनिक skill मेटाडेटा और skill फ़ाइलें ClawHub के skill लाइसेंस नियमों के तहत प्रकाशित की जाती हैं, जबकि API स्वयं rate-limited है और इसका उपयोग जिम्मेदारी से किया जाना चाहिए।

दिशानिर्देश:

- कैटलॉग लिस्टिंग के लिए `GET /api/v1/skills`, `GET /api/v1/search`, और `GET /api/v1/skills/{slug}` जैसे सार्वजनिक रीड endpoint का उपयोग करें।
- प्रतिक्रियाओं को cache करें और आक्रामक polling के बजाय `429`, `Retry-After`, और rate-limit headers का सम्मान करें।
- लिस्टिंग दिखाते समय canonical ClawHub skill URL पर वापस link करें ताकि उपयोगकर्ता source registry record की जाँच कर सकें।
- `https://clawhub.ai/<owner>/skills/<slug>` रूप में canonical page URL का उपयोग करें।
...
- लेखन + account: `Authorization: Bearer clh_...`.
...
- Missing/invalid token IP enforcement पर वापस जाता है।
...
- `X-RateLimit-Remaining` / `RateLimit-Remaining`: मौजूद होने पर exact remaining budget; sharded successful requests अनुमानित global value लौटाने के बजाय इसे छोड़ देते हैं
...
- v1 errors plain text (`text/plain; charset=utf-8`) होते हैं, जिनमें `400`,
