...
आप ClawHub के सार्वजनिक रीड API के ऊपर कोई तृतीय-पक्ष कैटलॉग, निर्देशिका या खोज सतह बना सकते हैं। सार्वजनिक Skills मेटाडेटा और Skills फ़ाइलें ClawHub के Skills लाइसेंस नियमों के अंतर्गत प्रकाशित की जाती हैं, जबकि API स्वयं rate-limited है और इसका उपयोग जिम्मेदारी से किया जाना चाहिए।

दिशानिर्देश:

- कैटलॉग सूचियों के लिए `GET /api/v1/skills`, `GET /api/v1/search`, और `GET /api/v1/skills/{slug}` जैसे सार्वजनिक रीड endpoint का उपयोग करें।
- आक्रामक polling के बजाय responses को cache करें और `429`, `Retry-After`, तथा rate-limit headers का सम्मान करें।
- सूचियां दिखाते समय canonical ClawHub Skills URL पर वापस link करें ताकि उपयोगकर्ता स्रोत registry record की जांच कर सकें।
...
- Missing/invalid token IP प्रवर्तन पर fallback करता है।

- Read: प्रति IP 3000/min, प्रति key 12000/min
- Write: प्रति IP 300/min, प्रति key 3000/min
- Download: प्रति IP 1200/min, प्रति key 6000/min
...
- `X-RateLimit-Remaining` / `RateLimit-Remaining`: उपस्थित होने पर सटीक शेष budget; sharded successful requests अनुमानित global value लौटाने के बजाय इसे छोड़ देते हैं
...
Legacy `/api/*` और `/api/cli/*` अब भी उपलब्ध हैं। `DEPRECATIONS.md` देखें।
