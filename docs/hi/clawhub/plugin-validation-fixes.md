...
read_when:
    ...
    - Plugin पैकेज प्रकाशित करने पर ClawHub ने उसे अस्वीकार किया या चेतावनी दी
...
x-i18n:
    generated_at: "2026-07-05T05:05:18Z"
    model: gpt-5.5
...
ClawHub प्रकाशन से पहले Plugin पैकेजों को सत्यापित करता है और स्वचालित
पैकेज स्कैन से मिले निष्कर्ष भी दिखा सकता है। यह पेज लेखक-उन्मुख निष्कर्षों
को कवर करता है, यानी वे निष्कर्ष जिन्हें Plugin लेखक अपने पैकेज मेटाडेटा,
मेनिफेस्ट, SDK इम्पोर्ट, या प्रकाशित आर्टिफैक्ट में ठीक कर सकता है।

यह आंतरिक Plugin Inspector कवरेज निष्कर्षों को कवर नहीं करता। यदि किसी पूर्ण
रिपोर्ट में लेखक के लिए सुधार मार्गदर्शन के बिना स्कैनर रखरखाव कोड शामिल हैं,
तो वे Plugin लेखकों के बजाय OpenClaw अनुरक्षकों के लिए हैं।
...
| `package-manifest-version-drift`        | [पैकेज और मेनिफेस्ट संस्करण संरेखित करें](/hi/clawhub/plugin-validation-fixes#package-manifest-version-drift)                          |
...
| `manifest-name-missing`                 | [मेनिफेस्ट प्रदर्शन नाम जोड़ें](/hi/clawhub/plugin-validation-fixes#manifest-name-missing)                                           |
| `manifest-unknown-fields`               | [असमर्थित मेनिफेस्ट फ़ील्ड हटाएँ](/hi/clawhub/plugin-validation-fixes#manifest-unknown-fields)                                  |
...
| `sdk-session-store-write`               | [पूरे-सेशन-स्टोर लेखन को बदलें](/hi/clawhub/plugin-validation-fixes#sdk-session-store-write)                                  |
| `sdk-session-file-helper`               | [सेशन फ़ाइल-पाथ हेल्पर बदलें](/hi/clawhub/plugin-validation-fixes#sdk-session-file-helper)                                   |
| `sdk-session-transcript-file-target`    | [लीगेसी ट्रांसक्रिप्ट फ़ाइल टार्गेट बदलें](/hi/clawhub/plugin-validation-fixes#sdk-session-transcript-file-target)                   |
...
| `channel-env-vars`                      | [वर्तमान मेटाडेटा में चैनल env vars को मिरर करें](/hi/clawhub/plugin-validation-fixes#channel-env-vars)                                |
| `security-manifest-schema-unavailable`  | [अनुपलब्ध सुरक्षा मेनिफेस्ट स्कीमा संदर्भ हटाएँ](/hi/clawhub/plugin-validation-fixes#security-manifest-schema-unavailable) |
| `unrecognized-security-manifest`        | [असमर्थित सुरक्षा मेनिफेस्ट फ़ाइलें हटाएँ](/hi/clawhub/plugin-validation-fixes#unrecognized-security-manifest)                   |

## पैकेज मेटाडेटा

### package-json-missing

पैकेज रूट में `package.json` शामिल नहीं है, इसलिए ClawHub npm पैकेज, संस्करण,
एंट्रीपॉइंट, या OpenClaw मेटाडेटा की पहचान नहीं कर सकता।

- `name`, `version`, और `type` के साथ `package.json` जोड़ें।
- जब पैकेज OpenClaw Plugin शिप करता हो, तो `openclaw` ब्लॉक जोड़ें।
- न्यूनतम पैकेज उदाहरण के लिए [Plugins बनाना](/hi/plugins/building-plugins) और
  पैकेज बनाम मेनिफेस्ट विभाजन के लिए [Plugin मेनिफेस्ट](/hi/plugins/manifest#manifest-versus-packagejson)
  का उपयोग करें।
...
- `openclaw.extensions` या
  `openclaw.runtimeExtensions` जैसे एंट्रीपॉइंट मेटाडेटा शामिल करें।
...
- जब प्रकाशित पैकेज को निर्मित JavaScript लोड करनी हो, तो
...
- `openclaw.install` को समर्थित इंस्टॉल स्रोत से भरें, जैसे
  `clawhubSpec`, `npmSpec`, या `localPath`।
- जब एक से अधिक इंस्टॉल स्रोत उपलब्ध हों, तो `openclaw.install.defaultChoice`
  सेट करें।
...
पैकेज अपने समर्थित OpenClaw Plugin API रेंज को घोषित नहीं करता।
...
- न्यूनतम होस्ट संस्करण को उस होस्ट संस्करण रेंज के साथ संरेखित करें जिसका
  पैकेज वास्तव में समर्थन करता है।
- [डिस्कवरी को प्रभावित करने वाले package.json फ़ील्ड](/hi/plugins/manifest#packagejson-fields-that-affect-discovery) देखें।
- `clawhub package validate <path-to-plugin>` फिर से चलाएँ।

### package-manifest-version-drift

पैकेज संस्करण और Plugin मेनिफेस्ट संस्करण में असहमति है।

- पैकेज रिलीज़ संस्करण के रूप में `package.json#version` को प्राथमिकता दें।
- यदि `openclaw.plugin.json` में भी `version` है, तो उसे मिलाने के लिए अपडेट करें
  या जब पैकेज मेटाडेटा आधिकारिक हो, तो बासी मेनिफेस्ट संस्करण मेटाडेटा हटाएँ।
...
`package.json#openclaw` ब्लॉक में ऐसे फ़ील्ड हैं जो समर्थित OpenClaw पैकेज
मेटाडेटा नहीं हैं।
...
- अमान्य पैकेज मेटाडेटा, टूटे lifecycle scripts, या ऐसी files entries ठीक करें
  जिनसे पैकिंग विफल होती है।
...
पैक किए गए आर्टिफैक्ट में वह OpenClaw मेटाडेटा गायब है जो आपके स्रोत पैकेज में
मौजूद है।
...
- सुनिश्चित करें कि पैक किए गए आर्टिफैक्ट में `package.json` में `openclaw`
  ब्लॉक शामिल है।
- जब पैकेज नेटिव OpenClaw Plugin हो, तो सुनिश्चित करें कि
...
- चैनल एंट्री सहायक के लिए `openclaw/plugin-sdk/channel-core` का उपयोग करें।
...
Plugin ऐसा SDK पाथ आयात करता है जो बंडल किए गए Plugin या आंतरिक
संगतता के लिए आरक्षित है।

- आरक्षित OpenClaw आंतरिक SDK आयातों को दस्तावेज़ित सार्वजनिक
...
Plugin अभी भी अप्रचलित पूर्ण-सेशन-स्टोर सहायक
...
Plugin अभी भी अप्रचलित पूर्ण-सेशन-स्टोर लेखन सहायक जैसे
...
- पूरे सेशन स्टोर ऑब्जेक्ट को लोड करने, बदलने और सहेजने से बचें।
- पूर्ण-स्टोर लेखन सहायक को केवल तब तक रखें जब तक आपकी घोषित संगतता सीमा
...
Plugin अभी भी अप्रचलित सेशन फ़ाइल-पाथ सहायक जैसे
...
- सेशन मेटाडेटा स्थायी करने के लिए `patchSessionEntry(...)` या `upsertSessionEntry(...)` का उपयोग करें।
- जब कोड transcript ऑपरेशन तैयार कर रहा हो, तो transcript पहचान या लक्ष्य सहायक का उपयोग करें।
- पुराने transcript फ़ाइल पाथ पर निर्भर न रहें या उन्हें स्थायी न करें।
- [रनटाइम API](/hi/plugins/sdk-runtime#agent-session-state) और
  [Plugin SDK सबपाथ](/hi/plugins/sdk-subpaths) देखें।
- `clawhub package validate <path-to-plugin>` फिर से चलाएँ।
...
Plugin अभी भी अप्रचलित transcript फ़ाइल लक्ष्य सहायक
...
- जब कोड को संरचित transcript ऑपरेशन लक्ष्य चाहिए, तो `resolveSessionTranscriptTarget(...)` का उपयोग करें।
- पुराने transcript फ़ाइल लक्ष्यों को सीधे पढ़ने या बनाने से बचें।
...
Plugin अभी भी अप्रचलित निम्न-स्तरीय transcript सहायक जैसे
`appendSessionTranscriptMessage` या `emitSessionTranscriptUpdate` का उपयोग करता है।

- transcript जोड़ने के लिए `appendSessionTranscriptMessageByIdentity(...)` का उपयोग करें।
- transcript अपडेट सूचनाओं के लिए `publishSessionTranscriptUpdateByIdentity(...)` का उपयोग करें।
- संरचित transcript रनटाइम सतह को प्राथमिकता दें ताकि OpenClaw सही
  transaction सीमाएँ और पहचान हैंडलिंग लागू कर सके।
- निम्न-स्तरीय transcript सहायक को केवल तब तक रखें जब तक आपकी घोषित संगतता सीमा
  अभी भी उन पुराने OpenClaw संस्करणों का समर्थन करती है जिन्हें उनकी आवश्यकता है।
- [रनटाइम API](/hi/plugins/sdk-runtime#agent-session-state) और
  [Plugin SDK सबपाथ](/hi/plugins/sdk-subpaths) देखें।
- `clawhub package validate <path-to-plugin>` फिर से चलाएँ।
...
- मॉडल या provider override कार्य को `before_model_resolve` में ले जाएँ।
...
मैनिफेस्ट अभी भी पुराने `providerAuthEnvVars` provider auth मेटाडेटा का उपयोग करता है।

- provider env-var मेटाडेटा को `setup.providers[].envVars` में प्रतिबिंबित करें।
...
मैनिफेस्ट पुराने या पूर्ववर्ती चैनल env-var मेटाडेटा का उपयोग करता है, जिसमें वर्तमान
...
- env-चालित चैनल setup को आपके Plugin आकार द्वारा उपयोग किए जाने वाले वर्तमान setup,
  चैनल config, या पैकेज चैनल मेटाडेटा में प्रतिबिंबित करें।
...
पैकेज `openclaw.security.json` को ऐसे schema reference के साथ शिप करता है जिसे ClawHub
उपलब्ध के रूप में नहीं पहचानता।

- यदि schema URL केवल परामर्शात्मक है, तो उसे हटाएँ।
- OpenClaw द्वारा कोई दस्तावेज़ित versioned schema प्रकाशित करने के बाद ही उसका उपयोग करें।
- `clawhub package validate <path-to-plugin>` फिर से चलाएँ।
...
- जब तक OpenClaw कोई versioned सुरक्षा मैनिफेस्ट schema और ClawHub व्यवहार दस्तावेज़ित नहीं करता,
  `openclaw.security.json` हटाएँ।
- मैनिफेस्ट contract मौजूद होने तक सुरक्षा-संवेदनशील व्यवहार को अपने सार्वजनिक पैकेज docs या
