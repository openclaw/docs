...
x-i18n:
    generated_at: "2026-07-02T22:29:56Z"
    model: gpt-5.5
...
यदि फ़ायरवॉल, VPN, या प्रॉक्सी नियमों के कारण आपका ब्राउज़र स्थानीय कॉलबैक तक नहीं पहुँच सकता, तो हेडलेस टोकन प्रवाह का उपयोग करें।
...
CLI एक एक-बार उपयोग वाला कोड प्रिंट करता है और `https://clawhub.ai/cli/device` पर आपके द्वारा उसे अधिकृत करने तक प्रतीक्षा करता है।
...
निरस्त, अमान्य, या अनुपस्थित टोकन `401 अनधिकृत` लौटाते हैं। `clawhub login` के साथ फिर से साइन इन करें या `clawhub login --token` के साथ नया टोकन प्रदान करें।
