...
x-i18n:
    generated_at: "2026-07-01T18:11:42Z"
    model: gpt-5.5
...
यदि आपका ब्राउज़र फ़ायरवॉल, VPN या प्रॉक्सी नियमों के कारण स्थानीय कॉलबैक तक नहीं पहुंच
सकता, तो हेडलेस टोकन प्रवाह का उपयोग करें।
...
CLI एक एक-बार उपयोग वाला कोड प्रिंट करता है और आपके द्वारा इसे
`https://clawhub.ai/cli/device` पर अधिकृत करने तक प्रतीक्षा करता है।
...
निरस्त, अमान्य या अनुपस्थित टोकन `401 Unauthorized` लौटाते हैं। `clawhub login` के साथ
फिर से साइन इन करें या `clawhub login --token` के साथ नया टोकन दें।
