...
CLI एक एक-बार इस्तेमाल होने वाला कोड प्रिंट करता है और तब तक प्रतीक्षा करता है जब तक आप उसे `https://clawhub.ai/cli/device` पर अधिकृत नहीं कर देते।
