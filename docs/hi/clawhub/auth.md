...
x-i18n:
    generated_at: "2026-07-05T05:03:07Z"
    model: gpt-5.5
...
यदि साइन-इन आपको लॉग-आउट स्थिति में वापस ले आता है, तो हो सकता है कि आपका खाता अच्छी
...
यदि फ़ायरवॉल, VPN, या प्रॉक्सी नियमों के कारण आपका ब्राउज़र स्थानीय कॉलबैक तक नहीं पहुँच सकता,
...
इस फ़्लो का उपयोग सर्वरों, CI जॉब्स, या केवल-टर्मिनल परिवेशों के लिए करें।
...
CLI एक एक-बार उपयोग होने वाला कोड प्रिंट करता है और तब तक प्रतीक्षा करता है जब तक आप इसे
...
निरस्त, अमान्य, या अनुपस्थित टोकन `401 Unauthorized` लौटाते हैं। `clawhub login` से फिर से
साइन इन करें या `clawhub login --token` से नया टोकन प्रदान करें।
