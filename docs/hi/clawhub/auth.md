...
x-i18n:
    generated_at: "2026-07-03T23:31:44Z"
    model: gpt-5.5
...
CLI एक एक-बारगी कोड प्रिंट करता है और प्रतीक्षा करता है जब तक आप उसे `https://clawhub.ai/cli/device` पर अधिकृत करते हैं।
