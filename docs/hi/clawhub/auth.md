...
x-i18n:
    generated_at: "2026-07-01T12:58:59Z"
    model: gpt-5.5
...
सर्वर, CI जॉब, या केवल-टर्मिनल वातावरणों के लिए इस प्रवाह का उपयोग करें।

दूरस्थ शेल के लिए, जहाँ आप किसी अन्य जगह ब्राउज़र खोल सकते हैं, चलाएँ:

```bash
clawhub login --device
```

CLI एक एक-बार उपयोग वाला कोड प्रिंट करता है और तब तक प्रतीक्षा करता है जब तक आप उसे `https://clawhub.ai/cli/device` पर अधिकृत नहीं कर देते।
