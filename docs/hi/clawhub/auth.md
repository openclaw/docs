...
x-i18n:
    generated_at: "2026-07-04T20:31:17Z"
    model: gpt-5.5
...
उन रिमोट शेल के लिए जहां आप कहीं और ब्राउज़र खोल सकते हैं, चलाएं:

```bash
clawhub login --device
```

CLI एक एक-बार इस्तेमाल होने वाला कोड प्रिंट करता है और प्रतीक्षा करता है जब तक आप उसे `https://clawhub.ai/cli/device` पर अधिकृत करते हैं।
