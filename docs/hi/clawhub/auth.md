...
यदि साइन-इन आपको लॉग-आउट स्थिति में वापस भेज देता है, तो हो सकता है कि आपका खाता अच्छी
...
यदि आपका ब्राउज़र फ़ायरवॉल, VPN, या प्रॉक्सी नियमों के कारण स्थानीय कॉलबैक तक नहीं पहुँच
...
CLI एक एक-बार उपयोग वाला कोड प्रिंट करता है और तब तक प्रतीक्षा करता है जब तक आप उसे
...
फिर से साइन इन करें या `clawhub login --token` से नया टोकन दें।
