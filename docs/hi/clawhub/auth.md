...
x-i18n:
    generated_at: "2026-07-04T15:14:43Z"
    model: gpt-5.5
...
हटाए गए, प्रतिबंधित या अक्षम खाते सामान्य ClawHub साइन-इन पूरा नहीं कर सकते। यदि साइन-इन आपको लॉग-आउट स्थिति में वापस ले आता है, तो आपका खाता अच्छी स्थिति में नहीं हो सकता। यदि आपका खाता प्रतिबंधित या अक्षम किया गया था, और आपको लगता है कि यह गलती है, तो [ClawHub अपील फ़ॉर्म](https://appeals.openclaw.ai/) का उपयोग करें।
...
दूरस्थ शेल के लिए, जहाँ आप कहीं और ब्राउज़र खोल सकते हैं, चलाएँ:

```bash
clawhub login --device
```

CLI एक एक-बार उपयोग होने वाला कोड प्रिंट करता है और प्रतीक्षा करता है जब तक आप उसे `https://clawhub.ai/cli/device` पर अधिकृत नहीं कर देते।
