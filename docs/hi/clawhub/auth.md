...
यदि साइन-इन आपको लॉग-आउट स्थिति में वापस भेज देता है, तो हो सकता है आपका खाता अच्छी स्थिति में न हो। यदि आपका खाता प्रतिबंधित या अक्षम किया गया था, और आपको लगता है कि यह गलती है, तो
...
ऐसे रिमोट शेल के लिए जहां आप कहीं और ब्राउज़र खोल सकते हैं, चलाएं:

```bash
clawhub login --device
```

CLI एक एक-बार उपयोग होने वाला कोड प्रिंट करता है और प्रतीक्षा करता है जबकि आप इसे
