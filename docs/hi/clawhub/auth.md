...
x-i18n:
    generated_at: "2026-07-01T15:23:30Z"
    model: gpt-5.5
...
ClawHub वेब साइन-इन के लिए GitHub का उपयोग करता है। CLI उस साइन-इन किए गए खाते के
...
अगर साइन-इन आपको लॉग-आउट स्थिति में वापस भेजता है, तो आपका खाता अच्छी स्थिति में
नहीं हो सकता। अगर आपका खाता प्रतिबंधित या अक्षम किया गया था, और आपको लगता है कि यह
...
4. ब्राउज़र स्थानीय कॉलबैक पर वापस रीडायरेक्ट होता है।
5. CLI टोकन को आपकी ClawHub कॉन्फ़िग फ़ाइल में संग्रहीत करता है।

अगर आपका ब्राउज़र फ़ायरवॉल, VPN, या प्रॉक्सी नियमों के कारण स्थानीय कॉलबैक तक नहीं
पहुंच सकता, तो हेडलेस टोकन फ़्लो का उपयोग करें।
...
CLI एक एक-बार उपयोग होने वाला कोड प्रिंट करता है और तब तक प्रतीक्षा करता है जब तक
आप इसे `https://clawhub.ai/cli/device` पर अधिकृत नहीं कर देते।
...
निरस्त, अमान्य, या अनुपस्थित टोकन `401 Unauthorized` लौटाते हैं। `clawhub login` से
फिर से साइन इन करें या `clawhub login --token` से नया टोकन प्रदान करें।

हटाए गए, प्रतिबंधित, या अक्षम खाते मौजूदा API टोकन का उपयोग जारी नहीं रख सकते।
अगर आपका खाता प्रतिबंधित या अक्षम किया गया था, और आपको लगता है कि यह गलती है, तो
