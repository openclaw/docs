...
summary: 通过 LiteLLM Proxy 运行 OpenClaw，以统一访问模型并跟踪成本
title: LiteLLM
x-i18n:
    generated_at: "2026-04-27T19:38:37Z"
    model: gpt-5.4
    provider: openai
...
<Note>
有关通用 provider 配置和故障转移行为，请参阅 [Model Providers](/zh-CN/concepts/model-providers)。
</Note>
