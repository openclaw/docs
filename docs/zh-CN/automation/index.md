...
read_when:
    ...
    - 在 Heartbeat、cron、跟进承诺、钩子和长期指令之间进行选择
    - 寻找合适的自动化入口点
summary: 自动化机制概览：任务、cron、钩子、常设指令和任务流
title: 自动化和任务
x-i18n:
    generated_at: "2026-05-06T04:09:48Z"
    model: gpt-5.5
    provider: openai
...
参见[常驻指令](/zh-CN/automation/standing-orders)。
...
- [推断式跟进承诺](/zh-CN/concepts/commitments) — 类似记忆的跟进检查
- [后台任务](/zh-CN/automation/tasks) — 所有分离工作的任务台账
- [任务流](/zh-CN/automation/taskflow) — 持久多步流程编排
- [钩子](/zh-CN/automation/hooks) — 事件驱动的生命周期脚本
- [插件钩子](/zh-CN/plugins/hooks) — 进程内工具、提示词、消息和生命周期钩子
- [常驻指令](/zh-CN/automation/standing-orders) — 持久智能体指令
