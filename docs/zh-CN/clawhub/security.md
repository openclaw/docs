...
title: 安全
x-i18n:
    generated_at: "2026-07-01T07:51:11Z"
    model: gpt-5.5
...
ClawHub 本身的漏洞请使用 GitHub 安全公告报告。好的 ClawHub 安全公告报告包括以下方面的错误：
...
不要使用 ClawHub 安全公告报告第三方技能或插件自身源代码中的漏洞。请直接向 ClawHub 列表中链接的发布者或源仓库报告这些问题。
...
有关安装时审计标签、风险等级、发现和解读，请参阅[安全审计](/clawhub/security-audits)。

有关市场报告、审核搁置、隐藏列表、封禁和账号状态，请参阅[审核与账号安全](/clawhub/moderation)。
