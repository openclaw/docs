...
title: 安全
x-i18n:
    generated_at: "2026-07-01T15:19:23Z"
    model: gpt-5.5
...
对于 ClawHub 本身的漏洞，请使用 GitHub Security Advisories。好的 ClawHub 安全公告报告包括以下方面的 bug：
...
不要将 ClawHub 安全公告用于第三方 skill 或插件自身源代码中的漏洞。请直接向 ClawHub 列表中链接的发布者或源代码仓库报告这些问题。
