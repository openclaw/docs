...
title: 安全
x-i18n:
    generated_at: "2026-06-28T05:08:54Z"
    model: gpt-5.5
...
请使用 GitHub 安全公告报告 ClawHub 本身的漏洞。好的 ClawHub 安全公告报告包括以下方面的 bug：
...
真实用户影响的示例包括已确认的利用、用户数据或密钥暴露、因平台故障导致恶意内容触达用户，或任何要求用户轮换凭证、更新本地软件或采取其他防护行动的问题。
...
有关市场报告、审核保留、隐藏列表、封禁和账户状态，请参阅[审核和账户安全](/zh-CN/clawhub/moderation)。
