...
请使用 GitHub 安全公告报告 ClawHub 本身的漏洞。优秀的 ClawHub 安全公告报告包括以下方面的错误：
...
真实用户影响的示例包括已确认的利用、用户数据或密钥暴露、因平台故障导致恶意内容触达用户，或任何需要用户轮换凭据、更新本地软件或采取其他保护措施的问题。
...
有关市场报告、审核暂停、隐藏列表、封禁和账户状态，请参阅[审核和账户安全](/clawhub/moderation)。
