...
title: 安全
x-i18n:
    generated_at: "2026-06-27T01:34:18Z"
    model: gpt-5.5
...
由于 ClawHub 是托管的云应用，ClawHub 服务漏洞默认不会公开披露。只有在有真实用户影响的证据，或用户需要采取行动时，才会公开披露。
...
有关市场报告、审核暂停、隐藏列表、封禁和账户状态，请参阅[审核和账户安全](/zh-CN/clawhub/moderation)。
