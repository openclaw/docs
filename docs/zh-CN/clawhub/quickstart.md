...
x-i18n:
    generated_at: "2026-06-27T10:17:36Z"
    model: gpt-5.5
...
将内容安装到 OpenClaw 时，请使用 OpenClaw。在登录、发布、管理你自己的条目或使用注册表特定工作流时，请使用 `clawhub` CLI。
...
公开条目会显示最新的扫描状态。被审核暂缓或阻止的发布版本，在解决前可能会从搜索和安装界面中隐藏。
