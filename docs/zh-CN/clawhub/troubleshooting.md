...
x-i18n:
    generated_at: "2026-05-10T19:26:10Z"
    model: gpt-5.5
    provider: openai
...
- `RateLimit-Remaining` 和 `RateLimit-Limit`：你当前的额度。
...
ClawHub 使用 GitHub 身份和来源归属，将包连接到其发布者。
...
- 如果该包被隐藏、暂扣或阻止，它可能要等所有者解决问题后才能安装。
