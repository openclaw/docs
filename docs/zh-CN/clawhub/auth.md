...
x-i18n:
    generated_at: "2026-07-14T13:30:52Z"
    model: gpt-5.6
...
已删除、被封禁或已停用的账户无法完成正常的 ClawHub 登录。如果登录后返回未登录状态，你的账户可能状态异常。如果你的账户被封禁或停用，并且你认为这是误判，请使用 [ClawHub 申诉表单](https://appeals.openclaw.ai/)。
...
CLI 会输出一次性代码，并在你前往 `https://clawhub.ai/cli/device` 完成授权期间等待。
