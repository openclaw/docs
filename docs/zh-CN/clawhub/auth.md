...
已删除、被封禁或被禁用的账户无法完成正常的 ClawHub 登录。如果登录后又回到未登录状态，你的账户可能并非状态良好。如果你的账户被封禁或禁用，而你认为这是误判，请使用 [ClawHub 申诉表](https://appeals.openclaw.ai/)。
...
已删除、被封禁或被禁用的账户无法继续使用现有 API 令牌。如果你的账户被封禁或禁用，而你认为这是误判，请使用 [ClawHub 申诉表](https://appeals.openclaw.ai/)。
