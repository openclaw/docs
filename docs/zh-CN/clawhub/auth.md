...
已删除、被封禁或被停用的账户无法完成正常的 ClawHub 登录。如果登录后又回到未登录状态，你的账户状态可能不正常。如果你的账户被封禁或停用，并且你认为这是误判，请使用 [ClawHub appeal form](https://appeals.openclaw.ai/)。
...
已删除、被封禁或被停用的账户无法继续使用现有 API 令牌。如果你的账户被封禁或停用，并且你认为这是误判，请使用 [ClawHub appeal form](https://appeals.openclaw.ai/)。
