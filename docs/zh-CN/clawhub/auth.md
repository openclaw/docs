...
x-i18n:
    generated_at: "2026-07-01T20:10:59Z"
    model: gpt-5.5
...
已删除、被封禁或被禁用的账户无法完成正常的 ClawHub 登录。如果登录后又返回到已退出状态，你的账户可能状态异常。如果你的账户被封禁或禁用，并且你认为这是一个错误，请使用 [ClawHub 申诉表单](https://appeals.openclaw.ai/)。
...
已删除、被封禁或被禁用的账户无法继续使用现有 API 令牌。如果你的账户被封禁或禁用，并且你认为这是一个错误，请使用 [ClawHub 申诉表单](https://appeals.openclaw.ai/)。
