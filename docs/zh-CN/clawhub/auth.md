...
已删除、被封禁或被禁用的账户无法完成正常的 ClawHub 登录。如果登录后又返回到未登录状态，你的账户状态可能不正常。如果你的账户被封禁或禁用，并且你认为这是错误，请使用 [ClawHub 申诉表](https://appeals.openclaw.ai/)。
...
已删除、被封禁或被禁用的账户无法继续使用现有 API 令牌。如果你的账户被封禁或禁用，并且你认为这是错误，请使用 [ClawHub 申诉表](https://appeals.openclaw.ai/)。
