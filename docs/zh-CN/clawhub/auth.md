...
x-i18n:
    generated_at: "2026-07-04T06:21:25Z"
    model: gpt-5.5
...
已删除、被封禁或被禁用的账户无法完成正常的 ClawHub 登录。如果登录后又回到未登录状态，你的账户可能状态不正常。如果你的账户被封禁或禁用，并且你认为这是一个错误，请使用 [ClawHub appeal form](https://appeals.openclaw.ai/)。
...
在 ClawHub Web UI 中创建一个令牌，然后将它传给 CLI：
...
已删除、被封禁或被禁用的账户无法继续使用现有 API 令牌。如果你的账户被封禁或禁用，并且你认为这是一个错误，请使用 [ClawHub appeal form](https://appeals.openclaw.ai/)。
