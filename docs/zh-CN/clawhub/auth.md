...
x-i18n:
    generated_at: "2026-07-02T07:54:51Z"
    model: gpt-5.5
...
已删除、被封禁或被停用的账户无法完成正常的 ClawHub 登录。如果登录后返回到未登录状态，你的账户可能状态不佳。如果你的账户被封禁或停用，并且你认为这是错误，请使用 [ClawHub 申诉表单](https://appeals.openclaw.ai/)。
...
已删除、被封禁或被停用的账户无法继续使用现有 API 令牌。如果你的账户被封禁或停用，并且你认为这是错误，请使用 [ClawHub 申诉表单](https://appeals.openclaw.ai/)。
