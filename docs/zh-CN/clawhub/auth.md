...
x-i18n:
    generated_at: "2026-07-03T23:25:39Z"
    model: gpt-5.5
...
已删除、被封禁或被禁用的账户无法完成正常的 ClawHub 登录。如果登录后又回到已登出状态，你的账户可能状态异常。如果你的账户被封禁或禁用，并且你认为这是误判，请使用 [ClawHub appeal form](https://appeals.openclaw.ai/)。
...
已删除、被封禁或被禁用的账户无法继续使用现有 API 令牌。如果你的账户被封禁或禁用，并且你认为这是误判，请使用 [ClawHub appeal form](https://appeals.openclaw.ai/)。
