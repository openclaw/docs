...
x-i18n:
    generated_at: "2026-07-12T21:22:36Z"
    model: gpt-5.6
...
已删除、被封禁或被禁用的账号无法完成正常的 ClawHub 登录。如果登录后又回到未登录状态，你的账号可能状态异常。如果你的账号被封禁或禁用，并且你认为这是误判，请使用 [ClawHub 申诉表单](https://appeals.openclaw.ai/)。
...
CLI 会显示一次性代码并等待你在 `https://clawhub.ai/cli/device` 完成授权。
...
已删除、被封禁或被禁用的账号无法继续使用现有 API 令牌。如果你的账号被封禁或禁用，并且你认为这是误判，请使用 [ClawHub 申诉表单](https://appeals.openclaw.ai/)。
