...
已删除、被封禁或已停用的账户无法完成正常的 ClawHub 登录。如果登录后又回到未登录状态，你的账户可能状态不佳。如果你的账户被封禁或停用，而你认为这是错误，请使用 [ClawHub appeal form](https://appeals.openclaw.ai/)。
...
已删除、被封禁或已停用的账户无法继续使用现有 API 令牌。如果你的账户被封禁或停用，而你认为这是错误，请使用 [ClawHub appeal form](https://appeals.openclaw.ai/)。
