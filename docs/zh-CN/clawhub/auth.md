...
x-i18n:
    generated_at: "2026-06-30T22:05:11Z"
    model: gpt-5.5
...
已删除、被封禁或被停用的账户无法完成正常的 ClawHub 登录。如果登录后又回到未登录状态，你的账户可能不处于良好状态。如果你的账户被封禁或停用，并且你认为这是误判，请使用 [ClawHub 申诉表单](https://appeals.openclaw.ai/)。
...
在 ClawHub Web UI 中创建令牌，然后传给 CLI：
