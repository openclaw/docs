...
已删除、被封禁或被停用的账号无法完成正常的 ClawHub 登录。如果登录后你又回到未登录状态，你的账号状态可能不良好。如果你的账号被封禁或停用，并且你认为这是误判，请使用 [ClawHub 申诉表单](https://appeals.openclaw.ai/)。
...
如果因为防火墙、VPN 或代理规则导致你的浏览器无法访问本地回调，请使用无头令牌流程。
