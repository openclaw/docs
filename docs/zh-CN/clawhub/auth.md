...
x-i18n:
    generated_at: "2026-07-03T00:51:35Z"
    model: gpt-5.5
...
已删除、被封禁或被停用的账户无法完成正常的 ClawHub 登录。如果登录后又返回未登录状态，你的账户可能状态不正常。如果你的账户被封禁或停用，且你认为这是一个错误，请使用 [ClawHub 申诉表单](https://appeals.openclaw.ai/)。
...
如果你的浏览器由于防火墙、VPN 或代理规则无法访问本地回调，请使用无头令牌流程。
...
已删除、被封禁或被停用的账户无法继续使用现有 API 令牌。如果你的账户被封禁或停用，且你认为这是一个错误，请使用 [ClawHub 申诉表单](https://appeals.openclaw.ai/)。
