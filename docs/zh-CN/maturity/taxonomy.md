---
summary: OpenClaw 成熟度评分卡背后的产品领域和检查项的详细参考。
title: 成熟度分类法
x-i18n:
    generated_at: "2026-07-02T07:56:01Z"
    model: gpt-5.5
...
<div className="maturity-hero maturity-hero-compact">
  ...
  <p>50 个功能面分为 4 个系列，每个类别都回连到规范文档和 QA 覆盖 ID。</p>
  <p className="maturity-jump-links"><a href="#product-areas">浏览产品区域</a> / <a href="#taxonomy-details">打开详细分类法</a> / <a href="/zh-CN/maturity/scorecard">查看评分</a></p>
</div>

## 如何阅读此页面

功能面是一个产品区域，例如 Gateway 网关运行时、Discord 或 macOS 应用。每个功能面包含多个类别，每个类别包含 QA 场景覆盖的能力级检查。使用评分卡进行发布级判断；使用此页面检查其底层模型。

## 成熟度等级

<div className="maturity-level-list">
  <div className="maturity-level-row"><span className="maturity-level-title"><span className="maturity-level-pill maturity-level-experimental"><span className="maturity-level-code">M0</span><span>规划中</span></span></span><span>方向已知，但还没有受支持的用户路径。</span><span className="maturity-level-promotion">晋级：存在设计 issue、负责人和目标功能面。</span></div>
  <div className="maturity-level-row"><span className="maturity-level-title"><span className="maturity-level-pill maturity-level-experimental"><span className="maturity-level-code">M1</span><span>实验性</span></span></span><span>已实现，但受限于注意事项、标志、源码构建或仅限维护者的流程。</span><span className="maturity-level-promotion">晋级：维护者可以从当前 main 运行该场景。</span></div>
  <div className="maturity-level-row"><span className="maturity-level-title"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>Alpha 版</span></span></span><span>真实用户可以试用，但预期会有破坏性变更和不完整的用户体验。</span><span className="maturity-level-promotion">晋级：有文档化设置、基础测试、已知注意事项，以及至少一项真实环境证明。</span></div>
  <div className="maturity-level-row"><span className="maturity-level-title"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>Beta 版</span></span></span><span>存在公开路径，主工作流可用，且注意事项范围有限。</span><span className="maturity-level-promotion">晋级：有安装/更新文档、回归测试、支持运行手册，并在预期环境中成功完成场景证明。</span></div>
  <div className="maturity-level-row"><span className="maturity-level-title"><span className="maturity-level-pill maturity-level-stable"><span className="maturity-level-code">M4</span><span>稳定</span></span></span><span>普通用户的推荐路径。故障会被视为回归。</span><span className="maturity-level-promotion">晋级：有发布门禁、Doctor/故障排除路径、广泛文档，以及重复的真实世界证明。</span></div>
  <div className="maturity-level-row"><span className="maturity-level-title"><span className="maturity-level-pill maturity-level-clawesome"><span className="maturity-level-code">M5</span><span>卓越</span></span></span><span>精致、令人愉悦、检测充分，并能与最佳同类工作流竞争。</span><span className="maturity-level-promotion">晋级：稳定基础上，代表性用户通过用户评分卡。</span></div>
</div>
...
<Tabs>
  <Tab title="核心">
    ...
    <a className="maturity-surface-link" href="#cli">
      ...
      <span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-stable"><span className="maturity-level-code">M4</span><span>稳定</span></span><span>7 个区域 - 完成 90%</span></span>
    </a>

    <a className="maturity-surface-link" href="#gateway-runtime">
      <span className="maturity-surface-title">Gateway 网关运行时</span>
      <span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-stable"><span className="maturity-level-code">M4</span><span>稳定</span></span><span>13 个区域 - 完成 89%</span></span>
    </a>

    <a className="maturity-surface-link" href="#agent-runtime">
      <span className="maturity-surface-title">Agent 运行时</span>
      <span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>Beta 版</span></span><span>9 个区域 - 完成 79%</span></span>
    </a>
    ...
    <a className="maturity-surface-link" href="#channel-framework">
      ...
      <span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>Beta 版</span></span><span>8 个区域 - 完成 79%</span></span>
    </a>

    <a className="maturity-surface-link" href="#observability">
      <span className="maturity-surface-title">可观测性</span>
      <span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>Beta 版</span></span><span>5 个区域 - 完成 79%</span></span>
    </a>

    <a className="maturity-surface-link" href="#gateway-web-app">
      <span className="maturity-surface-title">Gateway 网关 Web 应用</span>
      <span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>测试版</span></span><span>6 个领域 - 完成 79%</span></span>
    </a>

    <a className="maturity-surface-link" href="#plugins">
      <span className="maturity-surface-title">插件</span>
      <span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>测试版</span></span><span>9 个领域 - 完成 79%</span></span>
    </a>
    ...
    <a className="maturity-surface-link" href="#media-understanding-and-media-generation">
      ...
      <span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>Alpha</span></span><span>6 个领域 - 完成 68%</span></span>
    </a>
    ...
    <a className="maturity-surface-link" href="#tui">
      ...
      <span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>Alpha</span></span><span>5 个领域 - 完成 66%</span></span>
    </a>

    <a className="maturity-surface-link" href="#clawhub">
      <span className="maturity-surface-title">ClawHub</span>
      <span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>Alpha</span></span><span>4 个领域 - 完成 62%</span></span>
    </a>

    <a className="maturity-surface-link" href="#openclaw-app-sdk">
      <span className="maturity-surface-title">OpenClaw App SDK</span>
      <span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>Alpha</span></span><span>6 个领域 - 完成 53%</span></span>
    </a>
  ...
  <Tab title="平台">
    ...
    <a className="maturity-surface-link" href="#linux-gateway-host">
      ...
      <span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-stable"><span className="maturity-level-code">M4</span><span>稳定版</span></span><span>5 个领域 - 完成 89%</span></span>
    </a>

    <a className="maturity-surface-link" href="#macos-gateway-host">
      <span className="maturity-surface-title">macOS Gateway 网关主机</span>
      <span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-stable"><span className="maturity-level-code">M4</span><span>稳定版</span></span><span>7 个领域 - 完成 88%</span></span>
    </a>
    <a className="maturity-surface-link" href="#android-app">
      <span className="maturity-surface-title">Android 应用</span>
      <span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-stable"><span className="maturity-level-code">M4</span><span>稳定版</span></span><span>7 个领域 - 完成 80%</span></span>
    </a>
    <a className="maturity-surface-link" href="#ios-app">
      <span className="maturity-surface-title">iOS 应用</span>
      <span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-stable"><span className="maturity-level-code">M4</span><span>稳定版</span></span><span>8 个领域 - 完成 80%</span></span>
    </a>
    ...
    <a className="maturity-surface-link" href="#docker-and-podman-hosting">
      ...
      <span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>测试版</span></span><span>4 个领域 - 完成 79%</span></span>
    </a>
    ...
    <a className="maturity-surface-link" href="#macos-companion-app">
      ...
      <span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>Beta</span></span><span>8 个方面 - 完成 78%</span></span>
    </a>
    ...
    <a className="maturity-surface-link" href="#linux-companion-app">
      ...
      <span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-experimental"><span className="maturity-level-code">M0</span><span>计划中</span></span><span>5 个方面 - 完成 21%</span></span>
    </a>
...
<AccordionGroup>
  <Accordion title="CLI - M4 稳定 - 7 个方面">
    ...
    正常设置和修复路径已在安装、CLI 和 Gateway 网关文档中说明。特定于平台的 Windows 路径在 Windows via WSL2 和原生 Windows 行中跟踪。

    <div className="maturity-surface-rollup"><span>覆盖率实验性 - 4%</span><span>质量稳定 - 83%</span><span>完整性稳定 - 90%</span><span><span className="maturity-lts maturity-lts-partial">部分 - 6</span></span></div>
    ...
    <div className="maturity-category-list">
      ...
      <div className="maturity-category-row">
        ...
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta 版</span><span>75%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "75%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-stable"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-stable">稳定</span><span>89%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "89%" }} /></span></span></div>
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">更新与升级</span>
          <span>5 项能力 / LTS 支持</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">实验性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta 版</span><span>75%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "75%" }} /></span></span></div>
  ...
  <Accordion title="Gateway 网关运行时 - M4 稳定 - 13 个领域">
    ...
    <div className="maturity-category-list">
      ...
      <div className="maturity-category-row">
        ...
        <div><span className="maturity-score maturity-score-stable"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-stable">稳定版</span><span>89%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "89%" }} /></span></span></div>
        <div className="maturity-category-docs">[协议](/zh-CN/gateway/protocol), [架构](/zh-CN/concepts/architecture), [Typebox](/zh-CN/concepts/typebox), [Bridge 协议](/zh-CN/gateway/bridge-protocol)</div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
  ...
  <Accordion title="Agent Runtime - M3 Beta - 9 个领域">
    ...
    主循环、模型、提供商路由和工具流式传输是一等能力，但提供商行为每周都会变化，并且每个版本都需要场景证明。
    ...
    <div className="maturity-category-list">
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">Agent 轮次执行</span>
  ...
  <Accordion title="会话、记忆和上下文引擎 - M3 Beta - 9 个领域">
    ...
    文档完善且实现活跃。成熟度取决于转录持久性、压缩质量以及跨客户端一致性。

    <div className="maturity-surface-rollup"><span>覆盖率 Experimental - 30%</span><span>质量 Beta - 77%</span><span>完整度 Beta - 79%</span><span><span className="maturity-lts maturity-lts-partial">部分 - 6</span></span></div>
    ...
    <div className="maturity-category-list">
      ...
      <div className="maturity-category-row">
        ...
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta 版</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta 版</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
        <div className="maturity-category-docs">[Web 聊天](/zh-CN/web/webchat), [Android](/zh-CN/platforms/android), [频道路由](/zh-CN/channels/channel-routing)</div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
      ...
      <div className="maturity-category-row">
        ...
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta 版</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta 版</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
        <div className="maturity-category-docs">[上下文](/zh-CN/concepts/context), [转录清理规范](/zh-CN/reference/transcript-hygiene), [Discord](/zh-CN/channels/discord)</div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
      ...
      <div className="maturity-category-row">
        ...
        <div className="maturity-category-docs">[会话管理压缩](/zh-CN/reference/session-management-compaction), [转录卫生](/zh-CN/reference/transcript-hygiene)</div>
      </div>
    </div>
  ...
  <Accordion title="渠道框架 - M3 Beta - 8 个领域">
    ...
    <div className="maturity-surface-rollup"><span>覆盖率实验性 - 13%</span><span>质量 Beta - 76%</span><span>完整性 Beta - 79%</span><span><span className="maturity-lts maturity-lts-partial">部分 - 5</span></span></div>
    ...
    <div className="maturity-category-list">
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">群组线程和常驻房间行为</span>
          <span>5 项能力</span>
        </div>
        ...
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta 版</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta 版</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
        <div className="maturity-category-docs">[群组](/zh-CN/channels/groups), [群组消息](/zh-CN/channels/group-messages), [常驻房间事件](/zh-CN/channels/ambient-room-events), [广播群组](/zh-CN/channels/broadcast-groups), [Discord](/zh-CN/channels/discord)</div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">入站访问和身份门禁</span>
          <span>5 项能力 / LTS 支持</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">实验性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha 版</span><span>68%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "68%" }} /></span></span></div>
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">媒体附件和富频道数据</span>
          <span>4 项能力</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">实验性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha 版</span><span>68%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "68%" }} /></span></span></div>
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">出站交付和回复流水线</span>
          <span>4 项能力 / LTS 支持</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">实验性</span><span>38%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "38%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta 版</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta 版</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
        <div className="maturity-category-docs">[群组](/zh-CN/channels/groups), [常驻房间事件](/zh-CN/channels/ambient-room-events), [Discord](/zh-CN/channels/discord), [Matrix](/zh-CN/channels/matrix), [配置频道](/zh-CN/gateway/config-channels)</div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">会话路由和交付</span>
          <span>10 项能力 / LTS 支持</span>
        </div>
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">状态、健康和操作员控制</span>
          <span>4 项能力 / LTS 支持</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">实验性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta 版</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
  ...
  <Accordion title="可观测性 - M3 Beta - 5 个领域">
    ...
    OTel、Prometheus、日志和诊断文档已存在。需要一次面向公众的成熟度梳理，说明“操作员应首先查看什么”。

    <div className="maturity-surface-rollup"><span>覆盖率实验性 - 18%</span><span>质量测试版 - 75%</span><span>完整性测试版 - 79%</span><span><span className="maturity-lts maturity-lts-partial">部分 - 3</span></span></div>

    <div className="maturity-category-list">
      <div className="maturity-category-row maturity-category-row-header"><span>领域</span><span>覆盖率</span><span>质量</span><span>完整性</span><span>文档</span></div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">健康和修复</span>
  ...
  <Accordion title="Gateway 网关 Web 应用 - M3 测试版 - 6 个领域">
    ...
    Web UI 已记录配对、聊天、PWA、Talk、推送和远程 Gateway 网关流程。完成跨浏览器和移动 PWA 评分卡后再提升等级。

    <div className="maturity-surface-rollup"><span>覆盖率实验性 - 4%</span><span>质量测试版 - 74%</span><span>完整性测试版 - 79%</span><span><span className="maturity-lts maturity-lts-none">无</span></span></div>
    ...
    <div className="maturity-category-list">
      ...
      <div className="maturity-category-row">
        ...
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha 版</span><span>68%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "68%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta 版</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
        <div className="maturity-category-docs">[Control UI](/zh-CN/web/control-ui), [协议](/zh-CN/gateway/protocol), [Talk](/zh-CN/nodes/talk)</div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
        ...
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha 版</span><span>68%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "68%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta 版</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
        <div className="maturity-category-docs">[Control UI](/zh-CN/web/control-ui), [仪表板](/zh-CN/web/dashboard), [Tailscale](/zh-CN/gateway/tailscale), [远程](/zh-CN/gateway/remote)</div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
      ...
      <div className="maturity-category-row">
        ...
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta 版</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta 版</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
        <div className="maturity-category-docs">[Control UI](/zh-CN/web/control-ui), [健康](/zh-CN/gateway/health), [协议](/zh-CN/gateway/protocol), [仪表板](/zh-CN/web/dashboard)</div>
      </div>
    </div>

  </Accordion>

  <Accordion title="插件 - M3 Beta 版 - 9 个领域">
    <a id="plugins" />

    在清单、设备发现、加载、提供商/工具架构和审批边界方面，已有广泛文档和强有力的内部运行时证据。在公开 SDK API/子路径和外部分发证据更充分之前，将该行保持在 Beta 版。

    <div className="maturity-surface-rollup"><span>覆盖率 实验性 - 12%</span><span>质量 Beta 版 - 72%</span><span>完整性 Beta 版 - 79%</span><span><span className="maturity-lts maturity-lts-partial">部分 - 7</span></span></div>
    ...
    <div className="maturity-category-list">
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">编写和打包插件</span>
          <span>8 项能力 / LTS 支持</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">实验性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha 版</span><span>68%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "68%" }} /></span></span></div>
  ...
  <Accordion title="安全、认证、配对和密钥 - M3 Beta - 6 个领域">
    <a id="security-auth-pairing-and-secrets" />

    已有良好的文档和加固表面。在常规升级和安全场景运行证明没有设置回归后再提升成熟度。

    <div className="maturity-surface-rollup"><span>覆盖范围 实验性 - 16%</span><span>质量 测试版 - 72%</span><span>完整性 测试版 - 79%</span><span><span className="maturity-lts maturity-lts-partial">部分 - 5</span></span></div>
    ...
    <div className="maturity-category-list">
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">Gateway 网关认证和远程访问</span>
          <span>9 项能力 / LTS 支持</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">实验性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>68%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "68%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">测试版</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
        <div className="maturity-category-docs">[索引](/zh-CN/gateway/security/index), [暴露运行手册](/zh-CN/gateway/security/exposure-runbook), [可信代理认证](/zh-CN/gateway/trusted-proxy-auth), [Tailscale](/zh-CN/gateway/tailscale), [远程](/zh-CN/gateway/remote), [配置参考](/zh-CN/gateway/configuration-reference), [Gateway 网关](/zh-CN/cli/gateway), [Doctor](/zh-CN/cli/doctor), [Control UI](/zh-CN/web/control-ui), [浏览器控制](/zh-CN/tools/browser-control), [审计检查](/zh-CN/gateway/security/audit-checks)</div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">凭证和密钥卫生</span>
          <span>5 项能力 / LTS 支持</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">实验性</span><span>46%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "46%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">测试版</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">测试版</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
        <div className="maturity-category-docs">[认证](/zh-CN/gateway/authentication), [Models](/zh-CN/cli/models), [OpenAI](/zh-CN/providers/openai), [OAuth](/zh-CN/concepts/oauth), [密钥](/zh-CN/gateway/secrets), [密钥](/zh-CN/cli/secrets), [Secretref 凭证表面](/zh-CN/reference/secretref-credential-surface), [审计检查](/zh-CN/gateway/security/audit-checks)</div>
      </div>
    </div>
  ...
  <Accordion title="自动化：cron、钩子、任务、轮询 - M3 Beta - 6 个领域">
    ...
    已有文档且可用，但场景证明应覆盖无人值守交付、重试和失败可见性。

    <div className="maturity-surface-rollup"><span>覆盖范围 实验性 - 2%</span><span>质量 测试版 - 72%</span><span>完整性 测试版 - 79%</span><span><span className="maturity-lts maturity-lts-none">无</span></span></div>

    <div className="maturity-category-list">
      <div className="maturity-category-row maturity-category-row-header"><span>领域</span><span>覆盖率</span><span>质量</span><span>完整性</span><span>文档</span></div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">Cron 作业</span>
          <span>15 项能力</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">实验性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
        <div className="maturity-category-docs">[Cron 作业](/zh-CN/automation/cron-jobs), [Cron](/zh-CN/cli/cron), [协议](/zh-CN/gateway/protocol), [任务](/zh-CN/automation/tasks), [Discord](/zh-CN/channels/discord)</div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
      ...
      <div className="maturity-category-row">
        ...
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>68%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "68%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
        <div className="maturity-category-docs">[钩子](/zh-CN/automation/hooks), [钩子](/zh-CN/cli/hooks), [插件钩子](/zh-CN/plugins/hooks), [插件权限请求](/zh-CN/plugins/plugin-permission-requests), [SDK 子路径](/zh-CN/plugins/sdk-subpaths)</div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
        ...
        <div className="maturity-category-docs">[任务](/zh-CN/automation/tasks), [索引](/zh-CN/automation/index), [任务](/zh-CN/cli/tasks), [任务流](/zh-CN/automation/taskflow), [SDK 运行时](/zh-CN/plugins/sdk-runtime)</div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
  ...
  <Accordion title="媒体理解和媒体生成 - M2 Alpha - 6 个领域">
    ...
    已有广泛的能力表面，但提供商差异、文件限制以及节点/应用一致性使其尚不稳定。
    ...
    <div className="maturity-category-list">
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">媒体摄取和访问</span>
          <span>8 项能力</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">实验性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
      ...
      <div className="maturity-category-row">
        ...
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>69%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "69%" }} /></span></span></div>
        <div className="maturity-category-docs">[音频](/zh-CN/nodes/audio), [媒体理解](/zh-CN/nodes/media-understanding), [媒体概览](/zh-CN/tools/media-overview), [Whatsapp](/zh-CN/channels/whatsapp), [图像](/zh-CN/nodes/images), [Infer](/zh-CN/cli/infer), [Pdf](/zh-CN/tools/pdf)</div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
  ...
  <Accordion title="语音和实时对话 - M2 Alpha - 6 个领域">
    <a id="voice-and-realtime-talk" />

    Control UI、应用和提供商中存在多种实现。Beta 前需要延迟、故障模式和设置评分卡。

    <div className="maturity-surface-rollup"><span>覆盖率实验性 - 0%</span><span>质量 Alpha - 61%</span><span>完整性 Alpha - 68%</span><span><span className="maturity-lts maturity-lts-none">无</span></span></div>
    ...
    <div className="maturity-category-list">
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">语音和转写</span>
          <span>5 项能力</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">实验性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha 阶段</span><span>61%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "61%" }} /></span></span></div>
      ...
      <div className="maturity-category-row">
        ...
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha 阶段</span><span>61%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "61%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha 阶段</span><span>68%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "68%" }} /></span></span></div>
        <div className="maturity-category-docs">[Talk](/zh-CN/nodes/talk), [Voicewake](/zh-CN/platforms/mac/voicewake)</div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
      ...
      <div className="maturity-category-row">
        ...
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha 阶段</span><span>61%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "61%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha 阶段</span><span>68%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "68%" }} /></span></span></div>
        <div className="maturity-category-docs">[Control UI](/zh-CN/web/control-ui), [语音叠加层](/zh-CN/platforms/mac/voice-overlay), [Talk](/zh-CN/nodes/talk)</div>
      </div>
    </div>

  </Accordion>

  <Accordion title="TUI - M2 Alpha 阶段 - 5 个领域">
    <a id="tui" />

    存在于文档和源代码中，但作为主要用户工作流的可见性较低。需要明确的场景定义。

    <div className="maturity-surface-rollup"><span>覆盖率 实验性 - 0%</span><span>质量 Alpha 阶段 - 59%</span><span>完整度 Alpha 阶段 - 66%</span><span><span className="maturity-lts maturity-lts-none">无</span></span></div>
    ...
    <div className="maturity-category-list">
      ...
      <div className="maturity-category-row">
        ...
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha 版</span><span>59%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "59%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha 版</span><span>66%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "66%" }} /></span></span></div>
        <div className="maturity-category-docs">[终端界面](/zh-CN/web/tui), [二维码](/zh-CN/cli/qr), [日志](/zh-CN/cli/logs), [补全](/zh-CN/cli/completion)</div>
      </div>
    </div>
  ...
  <Accordion title="ClawHub - M2 Alpha - 4 areas">
    ...
    公共文档和生态系统概念已存在。还需要安装、信任、更新、回滚和兼容性评分卡。

    <div className="maturity-surface-rollup"><span>覆盖率 实验性 - 0%</span><span>质量 Alpha 版 - 58%</span><span>完整性 Alpha 版 - 62%</span><span><span className="maturity-lts maturity-lts-none">无</span></span></div>
    ...
    <div className="maturity-category-list">
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">兼容性和信任</span>
          <span>12 项能力</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">实验性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha 版</span><span>55%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "55%" }} /></span></span></div>
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">插件生命周期和健康</span>
          <span>26 项能力</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">实验性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha 版</span><span>61%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "61%" }} /></span></span></div>
  ...
  <Accordion title="OpenClaw App SDK - M2 Alpha - 6 个领域">
    ...
    OpenClaw App SDK 是独立的外部应用契约，与 Gateway 网关运行时和插件 SDK 分开。当前评分显示存在真实的 `@openclaw/sdk` 路径，但在公开打包、自动发现、审批、辅助工具和兼容性方面仍有缺口。

    <div className="maturity-surface-rollup"><span>覆盖率实验性 - 3%</span><span>质量 Alpha 版 - 54%</span><span>完整度 Alpha 版 - 53%</span><span><span className="maturity-lts maturity-lts-none">无</span></span></div>
    ...
    <div className="maturity-category-list">
      ...
      <div className="maturity-category-row">
        ...
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">实验性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha 阶段</span><span>51%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "51%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha 阶段</span><span>50%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "50%" }} /></span></span></div>
      ...
      <div className="maturity-category-row">
        ...
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">实验性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha 阶段</span><span>53%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "53%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha 阶段</span><span>54%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "54%" }} /></span></span></div>
      ...
      <div className="maturity-category-row">
        ...
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">实验性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha 阶段</span><span>52%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "52%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha 阶段</span><span>52%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "52%" }} /></span></span></div>
      ...
      <div className="maturity-category-row">
        ...
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">实验性</span><span>17%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "17%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha 阶段</span><span>62%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "62%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha 阶段</span><span>53%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "53%" }} /></span></span></div>
        <div className="maturity-category-docs">[OpenClaw SDK](/zh-CN/gateway/external-apps), [OpenClaw SDK API 设计](/zh-CN/gateway/external-apps)</div>
      </div>
      <div className="maturity-category-row">
        ...
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">实验性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha 阶段</span><span>54%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "54%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha 阶段</span><span>55%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "55%" }} /></span></span></div>
...
<AccordionGroup>
  <Accordion title="Linux Gateway 网关主机 - M4 稳定 - 5 个领域">
    <a id="linux-gateway-host" />

    推荐使用 Node 运行时，已记录 systemd 用户服务，并提供广泛的 VPS/容器指导。

    <div className="maturity-surface-rollup"><span>覆盖率实验性 - 0%</span><span>质量 Beta 阶段 - 75%</span><span>完整性稳定 - 89%</span><span><span className="maturity-lts maturity-lts-partial">部分 - 4</span></span></div>
  ...
  <Accordion title="macOS Gateway 网关主机 - M4 稳定版 - 7 个领域">
    ...
    已记录 LaunchAgent 服务路径、本地/远程 Gateway 网关模式、CLI 安装和应用集成。

    <div className="maturity-surface-rollup"><span>覆盖率实验性 - 0%</span><span>质量 Beta - 74%</span><span>完整度稳定版 - 88%</span><span><span className="maturity-lts maturity-lts-none">无</span></span></div>
    ...
    <div className="maturity-category-list">
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">配置文件和隔离</span>
          <span>5 项能力</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">实验性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>74%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "74%" }} /></span></span></div>
  ...
  <Accordion title="Android 应用 - M4 稳定版 - 7 个领域">
    ...
    官方 Google Play 分发已存在，源代码构建/运行文档保持维护，并且 Android 应用已作为面向用户的常规配套节点记录在文档中。

    <div className="maturity-surface-rollup"><span>覆盖率 实验性 - 0%</span><span>质量 稳定版 - 80%</span><span>完整性 稳定版 - 80%</span><span><span className="maturity-lts maturity-lts-none">无</span></span></div>

    <div className="maturity-category-list">
      <div className="maturity-category-row maturity-category-row-header"><span>领域</span><span>覆盖率</span><span>质量</span><span>完整度</span><span>文档</span></div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">媒体捕获</span>
          <span>1 项能力</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">实验性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
  ...
  <Accordion title="iOS 应用 - M4 稳定 - 8 个领域">
    ...
    已提供官方 App Store 分发，已记录基于中继的推送，并且 iOS 应用被记录为面向用户的普通配套节点。

    <div className="maturity-surface-rollup"><span>覆盖率 实验性 - 0%</span><span>质量 稳定 - 80%</span><span>完整度 稳定 - 80%</span><span><span className="maturity-lts maturity-lts-none">无</span></span></div>

    <div className="maturity-category-list">
      <div className="maturity-category-row maturity-category-row-header"><span>领域</span><span>覆盖率</span><span>质量</span><span>完整性</span><span>文档</span></div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">媒体和分享</span>
          <span>1 项能力</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">实验性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-stable"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-stable">稳定</span><span>80%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "80%" }} /></span></span></div>
      ...
      <div className="maturity-category-row">
        ...
        <div><span className="maturity-score maturity-score-stable"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-stable">稳定</span><span>80%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "80%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-stable"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-stable">稳定</span><span>80%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "80%" }} /></span></span></div>
        <div className="maturity-category-docs">[Ios](/zh-CN/platforms/ios), [Canvas](/zh-CN/plugins/reference/canvas)</div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
        ...
        <div><span className="maturity-score maturity-score-stable"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-stable">稳定</span><span>80%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "80%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-stable"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-stable">稳定</span><span>80%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "80%" }} /></span></span></div>
        <div className="maturity-category-docs">[Ios](/zh-CN/platforms/ios), [Webchat](/zh-CN/web/webchat), [协议](/zh-CN/gateway/protocol)</div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
  ...
  <Accordion title="Docker 和 Podman 托管 - M3 Beta - 4 个领域">
    <a id="docker-and-podman-hosting" />

    安装文档已存在，并且是常见部署路径。等反复发布冒烟测试捕获升级和卷行为后再提升成熟度。

    <div className="maturity-surface-rollup"><span>覆盖率实验性 - 7%</span><span>质量 Beta - 71%</span><span>完整性 Beta - 79%</span><span><span className="maturity-lts maturity-lts-none">无</span></span></div>
    ...
    <div className="maturity-category-list">
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">智能体沙箱和工具链</span>
          <span>3 项能力</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">实验性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha 版</span><span>68%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "68%" }} /></span></span></div>
  ...
  <Accordion title="通过 WSL2 使用 Windows - M3 Beta - 6 个领域">
    ...
    推荐的 Windows 路径，包含 systemd/用户服务指导和启动链文档。待安装/更新评分卡反复验证后再提升等级。

    <div className="maturity-surface-rollup"><span>覆盖率实验性 - 6%</span><span>质量 Alpha 版 - 69%</span><span>完整度 Beta 版 - 79%</span><span><span className="maturity-lts maturity-lts-partial">部分 - 5</span></span></div>
    ...
    <div className="maturity-category-list">
      ...
      <div className="maturity-category-row">
        ...
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>67%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "67%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
        <div className="maturity-category-docs">[Windows](/zh-CN/platforms/windows), [入门指南](/zh-CN/start/getting-started), [更新](/zh-CN/install/updating), [Onboard](/zh-CN/cli/onboard), [Doctor](/zh-CN/cli/doctor), [状态](/zh-CN/cli/status), [日志](/zh-CN/cli/logs)</div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">Gateway 网关服务生命周期</span>
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">Gateway 网关访问与暴露</span>
          <span>11 项能力 / LTS 支持</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">实验性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>67%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "67%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
        <div className="maturity-category-docs">[身份验证](/zh-CN/gateway/authentication), [密钥](/zh-CN/gateway/secrets), [远程访问](/zh-CN/gateway/remote), [暴露运行手册](/zh-CN/gateway/security/exposure-runbook), [Windows](/zh-CN/platforms/windows)</div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">诊断与修复</span>
          <span>6 项能力 / LTS 支持</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">实验性</span><span>38%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "38%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
  ...
  <Accordion title="Raspberry Pi 和小型 Linux 设备 - M3 Beta - 4 个领域">
    ...
    平台文档已存在，Gateway 网关路径基于 Linux。需要面向硬件的发布烟测证明，才能提升成熟度。
    ...
    <div className="maturity-category-list">
      ...
      <div className="maturity-category-row">
        ...
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta 版</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
        <div className="maturity-category-docs">[Raspberry Pi](/zh-CN/install/raspberry-pi), [索引](/zh-CN/install/index), [首次运行常见问题](/zh-CN/help/faq-first-run), [常见问题](/zh-CN/help/faq), [Linux](/zh-CN/platforms/linux), [安装器](/zh-CN/install/installer)</div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
        ...
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha 版</span><span>67%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "67%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta 版</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
        <div className="maturity-category-docs">[Raspberry Pi](/zh-CN/install/raspberry-pi), [身份验证](/zh-CN/gateway/authentication), [密钥](/zh-CN/gateway/secrets), [配对](/zh-CN/gateway/pairing), [设备](/zh-CN/cli/devices), [远程](/zh-CN/gateway/remote), [Tailscale](/zh-CN/gateway/tailscale)</div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
  ...
  <Accordion title="macOS 配套应用 - M3 Beta 版 - 8 个领域">
    <a id="macos-companion-app" />

    功能丰富的菜单栏应用、权限、节点模式、Canvas、语音唤醒、WebChat 和远程模式均已具备。它仍在快速演进，因此尚未达到稳定版。

    <div className="maturity-surface-rollup"><span>覆盖率 实验性 - 0%</span><span>质量 Alpha 版 - 66%</span><span>完整度 Beta 版 - 78%</span><span><span className="maturity-lts maturity-lts-none">无</span></span></div>
    ...
    <div className="maturity-category-list">
      ...
      <div className="maturity-category-row">
        ...
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha 版</span><span>66%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "66%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta 版</span><span>78%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "78%" }} /></span></span></div>
        <div className="maturity-category-docs">[语音唤醒](/zh-CN/platforms/mac/voicewake), [语音浮层](/zh-CN/platforms/mac/voice-overlay), [Talk](/zh-CN/nodes/talk), [macOS](/zh-CN/platforms/macos)</div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
      ...
      <div className="maturity-category-row">
        ...
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha 版</span><span>66%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "66%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta 版</span><span>78%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "78%" }} /></span></span></div>
        <div className="maturity-category-docs">[网页聊天](/zh-CN/platforms/mac/webchat), [远程](/zh-CN/gateway/remote), [远程](/zh-CN/platforms/mac/remote)</div>
      </div>
    </div>
  ...
  <Accordion title="原生 Windows - M2 Alpha - 4 个领域">
    ...
    核心 CLI/Gateway 网关流程可用，但文档仍建议使用 WSL2 以获得完整体验，并列出原生环境的注意事项。

    <div className="maturity-surface-rollup"><span>覆盖率实验性 - 0%</span><span>质量 Alpha - 58%</span><span>完整性 Alpha - 66%</span><span><span className="maturity-lts maturity-lts-partial">部分 - 1</span></span></div>
  ...
  <Accordion title="Kubernetes 托管 - M2 Alpha - 4 个领域">
    ...
    Kubernetes 托管是一条独立的、基于 Kustomize 的集群部署路径。当前评分显示已有一条真正的最小部署路径，但在 Kubernetes 专用 CI、ingress/TLS/NetworkPolicy 打包、备份/恢复和生产暴露加固方面仍有缺口。

    <div className="maturity-surface-rollup"><span>覆盖率 实验性 - 0%</span><span>质量 Alpha - 55%</span><span>完整度 Alpha - 61%</span><span><span className="maturity-lts maturity-lts-none">无</span></span></div>
  ...
  <Accordion title="Nix 安装路径 - M1 实验性 - 5 个领域">
    ...
    可选安装流程。在提升为 alpha/beta 之前，需要更清晰的支持承诺。

    <div className="maturity-surface-rollup"><span>覆盖率 Experimental - 0%</span><span>质量 Experimental - 41%</span><span>完整度 Experimental - 44%</span><span><span className="maturity-lts maturity-lts-none">无</span></span></div>
    ...
    <div className="maturity-category-list">
      ...
      <div className="maturity-category-row">
        ...
        <div className="maturity-category-docs">[Nix](/zh-CN/install/nix), [Index](/zh-CN/install/index), [文档目录](/zh-CN/start/docs-directory)</div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
      ...
      <div className="maturity-category-row">
        ...
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Experimental</span><span>41%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "41%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Experimental</span><span>44%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "44%" }} /></span></span></div>
        <div className="maturity-category-docs">[Nix](/zh-CN/install/nix), [设置](/zh-CN/cli/setup), [Doctor](/zh-CN/cli/doctor), [Update](/zh-CN/cli/update)</div>
      </div>
    </div>

  </Accordion>

  <Accordion title="watchOS 配套应用表面 - M1 Experimental - 5 个领域">
    <a id="watchos-companion-surfaces" />

    源代码包含 Watch 应用/扩展表面；公开文档尚未将其作为用户功能呈现。
  ...
  <Accordion title="Linux 配套应用 - M0 计划中 - 5 个领域">
    ...
    文档说明原生 Linux 配套应用已在计划中；Gateway 网关是目前受支持的 Linux 路径。
...
<AccordionGroup>
  <Accordion title="Discord - M4 稳定 - 6 个领域">
    ...
    深入的文档和广泛的功能覆盖。语音/委托路径应继续作为 beta/alpha 单独评分。

    <div className="maturity-surface-rollup"><span>覆盖范围实验性 - 0%</span><span>质量 Beta - 73%</span><span>完整度稳定 - 87%</span><span><span className="maturity-lts maturity-lts-partial">部分 - 4</span></span></div>

    <div className="maturity-category-list">
      <div className="maturity-category-row maturity-category-row-header"><span>领域</span><span>覆盖率</span><span>质量</span><span>完整性</span><span>文档</span></div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">渠道设置和操作</span>
          <span>10 项能力 / LTS 支持</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">实验性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        ...
        <div className="maturity-category-docs">[Discord](/zh-CN/channels/discord), [Discord](/zh-CN/plugins/reference/discord), [Fly](/zh-CN/install/fly), [Slash Commands](/zh-CN/tools/slash-commands), [健康](/zh-CN/gateway/health), [渠道](/zh-CN/cli/channels), [配置渠道](/zh-CN/gateway/config-channels)</div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
      ...
      <div className="maturity-category-row">
        ...
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>73%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "73%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-stable"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-stable">稳定版</span><span>87%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "87%" }} /></span></span></div>
        <div className="maturity-category-docs">[Discord](/zh-CN/channels/discord), [Slash Commands](/zh-CN/tools/slash-commands)</div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
        ...
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>73%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "73%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-stable"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-stable">稳定版</span><span>87%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "87%" }} /></span></span></div>
        <div className="maturity-category-docs">[Discord](/zh-CN/channels/discord), [OpenAI](/zh-CN/providers/openai), [Elevenlabs](/zh-CN/providers/elevenlabs), [QA E2E 自动化](/zh-CN/concepts/qa-e2e-automation), [配置渠道](/zh-CN/gateway/config-channels)</div>
      </div>
    </div>
  ...
  <Accordion title="Telegram - M3 Beta - 5 个领域">
    ...
    核心渠道已经足够成熟，可用于常规使用，但高差异性的 UX 和媒体边缘情况需要持续的场景证明。

    <div className="maturity-surface-rollup"><span>覆盖率实验性 - 0%</span><span>质量 Alpha - 68%</span><span>完整性 Beta - 78%</span><span><span className="maturity-lts maturity-lts-full">完整 - 5</span></span></div>
    ...
    <div className="maturity-category-list">
      ...
      <div className="maturity-category-row">
        ...
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha 版</span><span>66%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "66%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta 版</span><span>78%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "78%" }} /></span></span></div>
        <div className="maturity-category-docs">[Telegram](/zh-CN/channels/telegram), [配置频道](/zh-CN/gateway/config-channels), [渠道](/zh-CN/cli/channels)</div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">访问和身份</span>
  ...
  <Accordion title="Slack - M3 Beta 版 - 5 个领域">
    <a id="slack" />

    一流的频道文档和路由界面。需要工作区安装 / 管理员场景评分卡。

    <div className="maturity-surface-rollup"><span>覆盖率 实验性 - 0%</span><span>质量 Alpha 版 - 66%</span><span>完整度 Beta 版 - 78%</span><span><span className="maturity-lts maturity-lts-full">完整 - 5</span></span></div>
  ...
  <Accordion title="iMessage 和 BlueBubbles - M3 Beta 版 - 5 个领域">
    ...
    受支持的 iMessage 通过已登录的 macOS Messages 主机上的 imsg 运行；旧版 BlueBubbles 配置需要迁移。保持 macOS 权限、SSH 包装器、SIP/private API 和迁移注意事项可见。

    <div className="maturity-surface-rollup"><span>覆盖率：实验性 - 0%</span><span>质量：Alpha 版 - 66%</span><span>完整性：Beta 版 - 78%</span><span><span className="maturity-lts maturity-lts-none">无</span></span></div>
    ...
    <div className="maturity-category-list">
      ...
      <div className="maturity-category-row">
        ...
        <div className="maturity-category-docs">[Bluebubbles Imessage](/zh-CN/announcements/bluebubbles-imessage), [Imessage From Bluebubbles](/zh-CN/channels/imessage-from-bluebubbles), [配置渠道](/zh-CN/gateway/config-channels), [Imessage](/zh-CN/channels/imessage)</div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">访问和身份</span>
        ...
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>66%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "66%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>78%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "78%" }} /></span></span></div>
        <div className="maturity-category-docs">[Imessage](/zh-CN/channels/imessage), [Imessage From Bluebubbles](/zh-CN/channels/imessage-from-bluebubbles), [配置渠道](/zh-CN/gateway/config-channels)</div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
  ...
  <Accordion title="WhatsApp - M3 Beta - 5 个领域">
    ...
    核心路径很重要且已有文档说明；上游 Baileys/会话波动性使其低于 Stable。
  ...
  <Accordion title="Matrix - M2 Alpha - 6 个区域">
    <a id="matrix" />

    通过内置插件支持。需要桥接、认证和房间生命周期评分卡。

    <div className="maturity-surface-rollup"><span>覆盖率实验性 - 0%</span><span>质量 Alpha 版 - 60%</span><span>完整性 Alpha 版 - 67%</span><span><span className="maturity-lts maturity-lts-none">无</span></span></div>
    ...
    <div className="maturity-category-list">
      ...
      <div className="maturity-category-row">
        ...
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>60%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "60%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>67%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "67%" }} /></span></span></div>
        <div className="maturity-category-docs">[Matrix](/zh-CN/channels/matrix), [群组](/zh-CN/channels/groups), [Bot 循环保护](/zh-CN/channels/bot-loop-protection)</div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">对话路由和投递</span>
  ...
  <Accordion title="Google Chat - M2 Alpha - 5 个领域">
    ...
    已有文档记录的频道，但企业/管理员设置会提高成熟度风险。

    <div className="maturity-surface-rollup"><span>覆盖率实验性 - 0%</span><span>质量 Alpha - 59%</span><span>完整度 Alpha - 66%</span><span><span className="maturity-lts maturity-lts-none">无</span></span></div>
    ...
    <div className="maturity-category-list">
      ...
      <div className="maturity-category-row">
        ...
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">实验性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha 阶段</span><span>59%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "59%" }} /></span></span></div>
  ...
  <Accordion title="Microsoft Teams - M2 Alpha - 5 areas">
    ...
    <div className="maturity-surface-rollup"><span>覆盖率 实验性 - 0%</span><span>质量 Alpha 阶段 - 59%</span><span>完整性 Alpha 阶段 - 66%</span><span><span className="maturity-lts maturity-lts-none">无</span></span></div>
    ...
    <div className="maturity-category-list">
      ...
      <div className="maturity-category-row">
        ...
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">实验性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">阿尔法</span><span>59%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "59%" }} /></span></span></div>
        ...
        <div className="maturity-category-docs">[Msteams](/zh-CN/channels/msteams), [Msteams](/zh-CN/plugins/reference/msteams), [配置频道](/zh-CN/gateway/config-channels), [健康](/zh-CN/gateway/health)</div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">访问和身份</span>
      ...
      <div className="maturity-category-row">
        ...
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">阿尔法</span><span>59%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "59%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">阿尔法</span><span>66%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "66%" }} /></span></span></div>
        <div className="maturity-category-docs">[Msteams](/zh-CN/channels/msteams), [高级 Exec 审批](/zh-CN/tools/exec-approvals-advanced)</div>
      </div>
    </div>

  </Accordion>

  <Accordion title="Signal - M2 阿尔法 - 5 个领域">
    <a id="signal" />

    已有受支持的渠道文档；需要更强的安装和重新连接证明。

    <div className="maturity-surface-rollup"><span>覆盖率 实验性 - 0%</span><span>质量 阿尔法 - 59%</span><span>完整度 阿尔法 - 66%</span><span><span className="maturity-lts maturity-lts-none">无</span></span></div>

    <div className="maturity-category-list">
      <div className="maturity-category-row maturity-category-row-header"><span>领域</span><span>覆盖率</span><span>质量</span><span>完整性</span><span>文档</span></div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">渠道设置和运营</span>
          <span>7 项能力</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">实验性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha 版</span><span>59%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "59%" }} /></span></span></div>
  ...
  <Accordion title="Feishu、QQ Bot、微信、腾讯元宝、Zalo、Zalo Personal、区域渠道 - M2 Alpha 版 - 4 个领域">
    <a id="feishu-qq-bot-wechat-yuanbao-zalo-zalo-personal-regional-channels" />

    重要的区域覆盖，但公开支持级别应按账户类型、上游审批和维护者证明进行校准。

    <div className="maturity-surface-rollup"><span>覆盖率实验性 - 0%</span><span>质量 Alpha 版 - 55%</span><span>完整性 Alpha 版 - 58%</span><span><span className="maturity-lts maturity-lts-none">无</span></span></div>
  ...
  <Accordion title="Mattermost、LINE、IRC、Nextcloud Talk、Nostr、Twitch、Tlon、Synology Chat - M2 Alpha - 4 个领域">
    ...
    已有受支持的表面，但成熟度可能因上游和维护者覆盖范围而异。稍后单独评分。

    <div className="maturity-surface-rollup"><span>覆盖率 实验性 - 0%</span><span>质量 Alpha - 53%</span><span>完整性 Alpha - 54%</span><span><span className="maturity-lts maturity-lts-none">无</span></span></div>
  ...
  <Accordion title="语音通话渠道 - M1 实验性 - 5 个领域">
    ...
    <div className="maturity-surface-rollup"><span>覆盖率：实验性 - 0%</span><span>质量：实验性 - 41%</span><span>完整度：实验性 - 44%</span><span><span className="maturity-lts maturity-lts-none">无</span></span></div>

    <div className="maturity-category-list">
      <div className="maturity-category-row maturity-category-row-header"><span>领域</span><span>覆盖率</span><span>质量</span><span>完整性</span><span>文档</span></div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">频道设置与运维</span>
          <span>2 项能力</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">实验性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">实验性</span><span>41%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "41%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">实验性</span><span>44%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "44%" }} /></span></span></div>
        <div className="maturity-category-docs">[语音通话](/zh-CN/cli/voicecall), [语音通话](/zh-CN/plugins/voice-call), [协议](/zh-CN/gateway/protocol)</div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">访问与身份</span>
        ...
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">实验性</span><span>41%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "41%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">实验性</span><span>44%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "44%" }} /></span></span></div>
        <div className="maturity-category-docs">[语音通话](/zh-CN/plugins/voice-call), [语音通话](/zh-CN/cli/voicecall)</div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">实时语音与通话</span>
          <span>2 项能力</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">实验性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">实验性</span><span>41%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "41%" }} /></span></span></div>
...
<AccordionGroup>
  <Accordion title="浏览器自动化、exec 和沙箱工具 - M3 Beta - 3 个领域">
    ...
    核心工具已有文档，但主机安全和权限用户体验应继续纳入活跃的评分卡审查。

    <div className="maturity-surface-rollup"><span>覆盖率 实验性 - 21%</span><span>质量 Beta - 75%</span><span>完整性 Beta - 79%</span><span><span className="maturity-lts maturity-lts-partial">部分 - 2</span></span></div>
  ...
  <Accordion title="OpenAI 和 Codex 提供商路径 - M3 Beta - 5 个领域">
    ...
    深入文档、OAuth/订阅路径、实时语音、图像和兼容性行为。提供商变动频繁，因此在没有发布评分卡证明的情况下无法达到稳定版。

    <div className="maturity-surface-rollup"><span>覆盖率实验性 - 26%</span><span>质量 Beta - 74%</span><span>完整性 Beta - 79%</span><span><span className="maturity-lts maturity-lts-partial">部分 - 3</span></span></div>
    ...
    <div className="maturity-category-list">
      ...
      <div className="maturity-category-row">
        ...
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
        <div className="maturity-category-docs">[OpenAI](/zh-CN/providers/openai), [OpenResponses HTTP API](/zh-CN/gateway/openresponses-http-api), [OpenAI HTTP API](/zh-CN/gateway/openai-http-api), [Codex 原生插件](/zh-CN/plugins/codex-native-plugins)</div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
        ...
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
        <div className="maturity-category-docs">[Codex harness](/zh-CN/plugins/codex-harness), [Codex harness runtime](/zh-CN/plugins/codex-harness-runtime), [Codex harness reference](/zh-CN/plugins/codex-harness-reference), [Codex 原生插件](/zh-CN/plugins/codex-native-plugins)</div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
  ...
  <Accordion title="Web 搜索工具 - M3 Beta - 4 个领域">
    ...
    <div className="maturity-surface-rollup"><span>覆盖率实验性 - 9%</span><span>质量 Beta - 74%</span><span>完整度 Beta - 79%</span><span><span className="maturity-lts maturity-lts-none">无</span></span></div>
    ...
    <div className="maturity-category-list">
      ...
      <div className="maturity-category-row">
        ...
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>68%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "68%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
        <div className="maturity-category-docs">[Web](/zh-CN/tools/web), [Web Fetch](/zh-CN/tools/web-fetch), [常见问题](/zh-CN/help/faq), [API 使用成本](/zh-CN/reference/api-usage-costs), [Brave Search](/zh-CN/tools/brave-search), [Perplexity Search](/zh-CN/tools/perplexity-search), [Tavily](/zh-CN/tools/tavily), [Firecrawl](/zh-CN/tools/firecrawl)</div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
        ...
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>68%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "68%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
        <div className="maturity-category-docs">[Web](/zh-CN/tools/web), [Web Fetch](/zh-CN/tools/web-fetch), [Firecrawl](/zh-CN/tools/firecrawl), [Searxng Search](/zh-CN/tools/searxng-search)</div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
        ...
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
        <div className="maturity-category-docs">[配置工具](/zh-CN/gateway/config-tools), [Web Fetch](/zh-CN/tools/web-fetch), [Web](/zh-CN/tools/web), [常见问题](/zh-CN/help/faq)</div>
      </div>
    </div>
  ...
  <Accordion title="Anthropic 提供商路径 - M3 Beta - 5 个领域">
    ...
    一流模型提供商。需要持续提供凭证、目录和工具调用场景证明。

    <div className="maturity-surface-rollup"><span>覆盖率实验性 - 0%</span><span>质量 Beta - 71%</span><span>完整性 Beta - 78%</span><span><span className="maturity-lts maturity-lts-none">无</span></span></div>

    <div className="maturity-category-list">
      <div className="maturity-category-row maturity-category-row-header"><span>领域</span><span>覆盖率</span><span>质量</span><span>完整度</span><span>文档</span></div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">提供商认证和恢复</span>
          <span>9 项能力</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">实验性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>66%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "66%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>78%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "78%" }} /></span></span></div>
        <div className="maturity-category-docs">[Anthropic](/zh-CN/providers/anthropic), [Doctor](/zh-CN/gateway/doctor), [配置示例](/zh-CN/gateway/configuration-examples), [故障排除](/zh-CN/gateway/troubleshooting), [提示词缓存](/zh-CN/reference/prompt-caching)</div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">模型和运行时选择</span>
      ...
      <div className="maturity-category-row">
        ...
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
        <div className="maturity-category-docs">[Anthropic](/zh-CN/providers/anthropic), [提示词缓存](/zh-CN/reference/prompt-caching), [故障排除](/zh-CN/gateway/troubleshooting), [CLI 后端](/zh-CN/gateway/cli-backends), [模型提供商](/zh-CN/concepts/model-providers)</div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
        ...
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>66%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "66%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>78%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "78%" }} /></span></span></div>
        <div className="maturity-category-docs">[Anthropic](/zh-CN/providers/anthropic), [提示词缓存](/zh-CN/reference/prompt-caching), [故障排除](/zh-CN/gateway/troubleshooting), [Heartbeat](/zh-CN/gateway/heartbeat)</div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
  ...
  <Accordion title="Google 提供商路径 - M3 Beta - 5 个领域">
    ...
    具备模型和实时表面的一等提供商。需要单独进行 Live/Talk 评分。

    <div className="maturity-surface-rollup"><span>覆盖率 实验性 - 0%</span><span>质量 Alpha - 66%</span><span>完整度 Beta - 78%</span><span><span className="maturity-lts maturity-lts-none">无</span></span></div>
    ...
    <div className="maturity-category-list">
      ...
      <div className="maturity-category-row">
        ...
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>66%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "66%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>78%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "78%" }} /></span></span></div>
        <div className="maturity-category-docs">[Google](/zh-CN/providers/google), [模型提供商](/zh-CN/concepts/model-providers), [Google](/zh-CN/plugins/reference/google), [Gemini Search](/zh-CN/tools/gemini-search)</div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
        ...
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>66%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "66%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>78%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "78%" }} /></span></span></div>
        <div className="maturity-category-docs">[Google](/zh-CN/providers/google), [模型提供商](/zh-CN/concepts/model-providers), [常见问题：模型](/zh-CN/help/faq-models), [实时测试](/zh-CN/help/testing-live)</div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
      ...
      <div className="maturity-category-row">
        ...
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>66%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "66%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>78%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "78%" }} /></span></span></div>
        <div className="maturity-category-docs">[提示词缓存](/zh-CN/reference/prompt-caching), [Google](/zh-CN/providers/google), [模型提供商](/zh-CN/concepts/model-providers), [Token 使用](/zh-CN/reference/token-use)</div>
      </div>
    </div>
  ...
  <Accordion title="OpenRouter 提供商路径 - M3 Beta - 4 个领域">
    ...
    统一的提供商路径已有文档说明且很有价值，但特定模型行为会有所不同。
  ...
  <Accordion title="图像、视频和音乐生成工具 - M2 Alpha - 5 个领域">
    ...
    能力已在多个提供商中存在，但如果没有按提供商提供证明，质量、延迟和参数兼容性的差异过大，尚不足以达到 Beta。
    ...
    <div className="maturity-category-list">
      ...
      <div className="maturity-category-row">
        ...
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>61%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "61%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>68%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "68%" }} /></span></span></div>
        <div className="maturity-category-docs">[配置 Agents](/zh-CN/gateway/config-agents), [图像生成](/zh-CN/tools/image-generation), [视频生成](/zh-CN/tools/video-generation), [音乐生成](/zh-CN/tools/music-generation)</div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
      ...
      <div className="maturity-category-row">
        ...
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>61%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "61%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>68%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "68%" }} /></span></span></div>
        <div className="maturity-category-docs">[图像生成](/zh-CN/tools/image-generation), [推断](/zh-CN/cli/infer), [媒体概览](/zh-CN/tools/media-overview)</div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
  ...
  <Accordion title="本地模型提供商：Ollama、vLLM、SGLang、LM Studio - M2 Alpha - 5 个领域">
    ...
    <div className="maturity-category-list">
      ...
      <div className="maturity-category-row">
        ...
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">实验性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha 版</span><span>61%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "61%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha 版</span><span>68%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "68%" }} /></span></span></div>
  ...
  <Accordion title="长尾托管提供商 - M2 Alpha 版 - 3 个领域">
    <a id="long-tail-hosted-providers" />

    存在许多文档/参考页面；评分应由提供商元数据加上实时冒烟覆盖率生成。

    <div className="maturity-surface-rollup"><span>覆盖率实验性 - 0%</span><span>质量内测 - 61%</span><span>完整度内测 - 68%</span><span><span className="maturity-lts maturity-lts-none">无</span></span></div>
    ...
    <div className="maturity-category-list">
      ...
      <div className="maturity-category-row">
        ...
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">实验性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">内测</span><span>61%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "61%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">内测</span><span>68%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "68%" }} /></span></span></div>
      ...
      <div className="maturity-category-row">
        ...
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">内测</span><span>61%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "61%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">内测</span><span>68%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "68%" }} /></span></span></div>
        <div className="maturity-category-docs">[索引](/zh-CN/providers/index), [模型提供商](/zh-CN/concepts/model-providers), [清单](/zh-CN/plugins/manifest), [实时测试](/zh-CN/help/testing-live), [模型](/zh-CN/cli/models)</div>
      </div>
    </div>
