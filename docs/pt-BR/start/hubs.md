...
title: Centrais de documentação
x-i18n:
    generated_at: "2026-07-12T00:24:27Z"
    model: gpt-5.6
...
Use estas páginas centrais para descobrir todas as páginas, incluindo análises aprofundadas e documentação de referência que não aparecem na navegação à esquerda.
...
- [Configuração inicial](/pt-BR/start/setup)
...
- [Demonstrações](/pt-BR/start/showcase)
...
- [Ciclo do agente](/pt-BR/concepts/agent-loop)
- [Transmissão e divisão em blocos](/pt-BR/concepts/streaming)
...
- [Alternância de modelo em caso de falha](/pt-BR/concepts/model-failover)
- [OAuth](/pt-BR/concepts/oauth)

## Provedores e entrada

- [Central de canais de conversa](/pt-BR/channels)
- [Central de provedores de modelos](/pt-BR/providers/models)
...
- [Isolamento](/pt-BR/gateway/sandboxing)
...
- [Conjunto de ferramentas](/pt-BR/tools)
...
- [Raciocínio e modo detalhado](/pt-BR/tools/thinking)
...
- [Central do Windows](/pt-BR/platforms/windows)
- [Linux](/pt-BR/platforms/linux)
- [Interfaces web](/pt-BR/web)

## Aplicativo complementar para macOS (avançado)

- [Configuração do ambiente de desenvolvimento no macOS](/pt-BR/platforms/mac/dev-setup)
...
- [Registro de logs no macOS](/pt-BR/platforms/mac/logging)
- [Permissões do macOS](/pt-BR/platforms/mac/permissions)
- [Acesso remoto no macOS](/pt-BR/platforms/mac/remote)
...
- [Pacotes de Plugins](/pt-BR/plugins/bundles)
- [ClawHub](/clawhub)
- [Receitas de recursos](/pt-BR/plugins/adding-capabilities)
...
- [Modelos: AGENTS](/pt-BR/reference/templates/AGENTS)
- [Modelos: BOOTSTRAP](/pt-BR/reference/templates/BOOTSTRAP)
- [Modelos: HEARTBEAT](/pt-BR/reference/templates/HEARTBEAT)
- [Modelos: IDENTITY](/pt-BR/reference/templates/IDENTITY)
- [Modelos: SOUL](/pt-BR/reference/templates/SOUL)
- [Modelos: TOOLS](/pt-BR/reference/templates/TOOLS)
- [Modelos: USER](/pt-BR/reference/templates/USER)
