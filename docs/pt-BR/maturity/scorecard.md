---
summary: Pontuações de prontidão para lançamento do OpenClaw em áreas do produto, integrações e fluxos de trabalho compatíveis.
title: Quadro de avaliação de maturidade
x-i18n:
    generated_at: "2026-07-12T00:03:40Z"
    model: gpt-5.6
...
<div className="maturity-hero">
  <p className="maturity-kicker">prontidão para lançamento - gerado a partir da taxonomia + evidências de QA</p>
  <p className="maturity-hero-title">Uma visão prática do que está pronto, do que foi comprovado e do que ainda precisa ser aprimorado.</p>
  <p>50 superfícies - 281 áreas de capacidade - cobertura determinística, além de qualidade e completude revisadas por pessoas.</p>
  <p className="maturity-jump-links"><a href="#surface-explorer">Explorar superfícies</a> / <a href="#qa-evidence-summary">Examinar evidências de QA</a> / <a href="/pt-BR/maturity/taxonomy">Ler a taxonomia</a></p>
</div>

## Para que serve esta página

Use esta página para responder a uma pergunta: quais superfícies do OpenClaw são opções confiáveis para um lançamento e quais evidências sustentam essa avaliação? A cobertura vem de evidências determinísticas de QA; a qualidade e a completude são mantidas como pontuações de maturidade revisadas.
...
A cobertura é deliberadamente orientada por evidências: uma área não se torna "pronta" apenas porque a implementação existe. Ela não é um componente da pontuação de maturidade, mas o OpenClaw busca manter, ao longo do tempo, a cobertura de ponta a ponta acima de 90% para funcionalidades maduras classificadas como estáveis ou superiores.
...
As superfícies são ordenadas por nível de maturidade, completude e qualidade. O suporte LTS é exibido ao lado de cada linha para facilitar a comparação entre as opções prontas para lançamento.
  ...
  <Tab title="Todas as superfícies">
    <div className="maturity-surface-table">
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/pt-BR/maturity/taxonomy#gateway-runtime"><span className="maturity-surface-title">Ambiente de execução do Gateway</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-stable"><span className="maturity-level-code">M4</span><span>Estável</span></span><span>13 áreas</span></span></a>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/pt-BR/maturity/taxonomy#android-app"><span className="maturity-surface-title">Aplicativo Android</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-stable"><span className="maturity-level-code">M4</span><span>Estável</span></span><span>7 áreas</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Cobertura</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Experimental</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/pt-BR/maturity/taxonomy#ios-app"><span className="maturity-surface-title">Aplicativo iOS</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-stable"><span className="maturity-level-code">M4</span><span>Estável</span></span><span>8 áreas</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Cobertura</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Experimental</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Qualidade</span><span className="maturity-score maturity-score-stable"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-stable">Estável</span><span>80%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "80%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Completude</span><span className="maturity-score maturity-score-stable"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-stable">Estável</span><span>80%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "80%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">Nenhum</span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/pt-BR/maturity/taxonomy#agent-runtime"><span className="maturity-surface-title">Ambiente de execução do agente</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>Beta</span></span><span>9 áreas</span></span></a>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/pt-BR/maturity/taxonomy#browser-automation-exec-and-sandbox-tools"><span className="maturity-surface-title">Ferramentas de automação de navegador, execução e sandbox</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>Beta</span></span><span>3 áreas</span></span></a>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/pt-BR/maturity/taxonomy#automation-cron-hooks-tasks-polling"><span className="maturity-surface-title">Automação: Cron, ganchos, tarefas e sondagem</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>Beta</span></span><span>6 áreas</span></span></a>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/pt-BR/maturity/taxonomy#raspberry-pi-and-small-linux-devices"><span className="maturity-surface-title">Raspberry Pi e dispositivos Linux de pequeno porte</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>Beta</span></span><span>4 áreas</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Cobertura</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Experimental</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/pt-BR/maturity/taxonomy#image-video-and-music-generation-tools"><span className="maturity-surface-title">Ferramentas de geração de imagens, vídeos e música</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>Alfa</span></span><span>5 áreas</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Cobertura</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Experimental</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/pt-BR/maturity/taxonomy#kubernetes-hosting"><span className="maturity-surface-title">Hospedagem no Kubernetes</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>Alfa</span></span><span>4 áreas</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Cobertura</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Experimental</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/pt-BR/maturity/taxonomy#openclaw-app-sdk"><span className="maturity-surface-title">SDK de aplicativos do OpenClaw</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>Alfa</span></span><span>6 áreas</span></span></a>
  ...
  <Tab title="Núcleo">
    <div className="maturity-surface-table">
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/pt-BR/maturity/taxonomy#openclaw-app-sdk"><span className="maturity-surface-title">SDK de aplicativos OpenClaw</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>Alfa</span></span><span>6 áreas</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Cobertura</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Experimental</span><span>3%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "3%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Qualidade</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alfa</span><span>54%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "54%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Completude</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alfa</span><span>53%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "53%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">Nenhum</span></div>
  ...
  <Tab title="Plataforma">
    <div className="maturity-surface-table">
      <div className="maturity-surface-row maturity-surface-row-header"><span>Superfície</span><span>Cobertura</span><span>Qualidade</span><span>Completude</span><span>Suporte</span></div>
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/pt-BR/maturity/taxonomy#linux-gateway-host"><span className="maturity-surface-title">Host do Gateway no Linux</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-stable"><span className="maturity-level-code">M4</span><span>Estável</span></span><span>5 áreas</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Cobertura</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Experimental</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Qualidade</span><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>75%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "75%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Completude</span><span className="maturity-score maturity-score-stable"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-stable">Estável</span><span>89%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "89%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-partial">Parcial - 4</span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/pt-BR/maturity/taxonomy#macos-gateway-host"><span className="maturity-surface-title">Host do Gateway no macOS</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-stable"><span className="maturity-level-code">M4</span><span>Estável</span></span><span>7 áreas</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Cobertura</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Experimental</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Qualidade</span><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>74%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "74%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Completude</span><span className="maturity-score maturity-score-stable"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-stable">Estável</span><span>88%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "88%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">Nenhum</span></div>
  ...
  <Tab title="Provedor e ferramenta">
    <div className="maturity-surface-table">
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/pt-BR/maturity/taxonomy#image-video-and-music-generation-tools"><span className="maturity-surface-title">Ferramentas de geração de imagens, vídeos e músicas</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>Alfa</span></span><span>5 áreas</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Cobertura</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Experimental</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Qualidade</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alfa</span><span>61%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "61%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Completude</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alfa</span><span>68%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "68%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">Nenhum</span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/pt-BR/maturity/taxonomy#long-tail-hosted-providers"><span className="maturity-surface-title">Provedores hospedados de nicho</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>Alfa</span></span><span>3 áreas</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Cobertura</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Experimental</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Qualidade</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alfa</span><span>61%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "61%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Completude</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alfa</span><span>68%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "68%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">Nenhum</span></div>
...
## Resumo das evidências de QA

As verificações abaixo mostram quais áreas do quadro de avaliação foram exercitadas pelas evidências do perfil de QA.
...
Abra uma superfície para inspecionar o estado das evidências de cada categoria. A lista permanece recolhida para que a página continue útil em uma rápida consulta.
...
<AccordionGroup>
  <Accordion title="Runtime do agente - 9 áreas">
    ...
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>Área</span><span>Funcionalidades / IDs de cobertura</span><span>Acompanhamento</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Execução do turno do agente</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Execução em provedores hospedados</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">Parcialmente revisada - Validação completa da taxonomia</span>
        </div>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Chamadas de ferramentas e processamento de respostas</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">Parcialmente revisada - Validação completa da taxonomia</span>
        </div>
  ...
  <Accordion title="Caminho do provedor Anthropic - 5 áreas">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Cache de prompts e contexto</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Precisa de revisão - Validação completa da taxonomia</span>
        </div>
        <span>0 de 5 (0%) / 0 de 5 (0%)</span>
        <span>5 lacunas de capacidade</span>
  ...
  <Accordion title="Automação: cron, hooks, tarefas, sondagem - 6 áreas">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Controles de sondagem</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Precisa de revisão - Validação completa da taxonomia</span>
        </div>
        <span>0 de 10 (0%) / 0 de 10 (0%)</span>
        <span>10 lacunas de capacidade</span>
  ...
  <Accordion title="Automação de navegador, execução e ferramentas de sandbox - 3 áreas">
    <p className="maturity-readiness-summary">2 parcialmente revisadas / 1 precisa de revisão</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>Área</span><span>Recursos / IDs de cobertura</span><span>Acompanhamento</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
  ...
  <Accordion title="Aplicativo web do Gateway - 6 áreas">
    <p className="maturity-readiness-summary">3 precisam de revisão / 3 parcialmente revisadas</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>Área</span><span>Recursos / IDs de cobertura</span><span>Acompanhamento</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Acesso e confiança no navegador</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Precisa de revisão - Validação completa da taxonomia</span>
        </div>
        <span>0 de 5 (0%) / 0 de 5 (0%)</span>
        <span>5 lacunas de capacidade</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Interface do navegador</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">Parcialmente revisada - Validação completa da taxonomia</span>
        </div>
  ...
  <Accordion title="Framework de canais - 8 áreas">
    <p className="maturity-readiness-summary">4 precisam de revisão / 4 parcialmente revisadas</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>Área</span><span>Recursos / IDs de cobertura</span><span>Acompanhamento</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Ações, comandos e aprovações de canais</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Precisa de revisão - Validação completa da taxonomia</span>
        </div>
        <span>0 de 5 (0%) / 0 de 5 (0%)</span>
        <span>5 lacunas de capacidade</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Comportamento de threads de grupo e salas ambientes</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">Parcialmente revisada - Validação completa da taxonomia</span>
        </div>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Controles de acesso e identidade de entrada</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Precisa de revisão - Validação completa da taxonomia</span>
        </div>
        <span>0 de 5 (0%) / 0 de 5 (0%)</span>
        <span>5 lacunas de capacidade</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Pipeline de entrega de saída e respostas</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">Parcialmente revisada - Validação completa da taxonomia</span>
        </div>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Integridade do status e controles do operador</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Precisa de revisão - Validação completa da taxonomia</span>
        </div>
  ...
  <Accordion title="ClawHub - 4 áreas">
    ...
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>Área</span><span>IDs de funcionalidades / cobertura</span><span>Acompanhamento</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Descoberta do catálogo</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Precisa de revisão - Validação completa da taxonomia</span>
        </div>
        <span>0 de 5 (0%) / 0 de 5 (0%)</span>
        <span>5 lacunas de recursos</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
        ...
        <span>12 lacunas de recursos</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
        ...
        <span>26 lacunas de recursos</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
        ...
        <span>7 lacunas de recursos</span>
      </div>
    </div>
  </Accordion>
  ...
  <Accordion title="CLI - 7 áreas">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        ...
        <span>0 de 10 (0%) / 0 de 10 (0%)</span>
        <span>10 lacunas de recursos</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Gerenciamento do serviço do Gateway</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">Parcialmente revisada - Validação completa da taxonomia</span>
        </div>
        <span>0 de 5 (0%) / 1 de 7 (14,3%)</span>
        <span>6 lacunas de recursos</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Integração inicial e configuração da autenticação</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Precisa de revisão - Validação completa da taxonomia</span>
        </div>
        <span>0 de 5 (0%) / 0 de 5 (0%)</span>
        <span>5 lacunas de recursos</span>
  ...
  <Accordion title="Hospedagem com Docker e Podman - 4 áreas">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        ...
        <span>0 de 3 (0%) / 0 de 3 (0%)</span>
        <span>3 lacunas de recursos</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Operações de contêineres</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Precisa de revisão - Validação completa da taxonomia</span>
        </div>
        <span>0 de 11 (0%) / 0 de 11 (0%)</span>
        <span>11 lacunas de recursos</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Configuração de contêineres</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Precisa de revisão - Validação completa da taxonomia</span>
        </div>
        <span>0 de 6 (0%) / 0 de 6 (0%)</span>
        <span>6 lacunas de recursos</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Lançamento e validação de imagens</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">Parcialmente revisada - Validação completa da taxonomia</span>
        </div>
  ...
  <Accordion title="Tempo de execução do Gateway — 13 áreas">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Integridade, diagnóstico e reparo</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Precisa de revisão — Validação completa da taxonomia</span>
        </div>
        <span>0 de 7 (0%) / 0 de 7 (0%)</span>
        <span>7 lacunas de capacidade</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Interface Web hospedada</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Precisa de revisão — Validação completa da taxonomia</span>
        </div>
        <span>0 de 4 (0%) / 0 de 4 (0%)</span>
        <span>4 lacunas de capacidade</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Nodes e recursos remotos</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Precisa de revisão — Validação completa da taxonomia</span>
        </div>
  ...
  <Accordion title="Ferramentas de geração de imagens, vídeos e músicas - 5 áreas">
    <p className="maturity-readiness-summary">5 precisam de revisão</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>Área</span><span>Recursos / IDs de cobertura</span><span>Acompanhamento</span></div>
      <div className="maturity-readiness-row">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Geração de músicas</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Precisa de revisão - Validação completa da taxonomia</span>
        </div>
        <span>0 de 6 (0%) / 0 de 6 (0%)</span>
        <span>6 lacunas de capacidade</span>
  ...
  <Accordion title="Aplicativo para iOS - 8 áreas">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Configuração e diagnóstico do Gateway</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Precisa de revisão - Validação completa da taxonomia</span>
        </div>
        <span>0 de 7 (0%) / 0 de 7 (0%)</span>
        <span>7 lacunas de capacidade</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Notificações e execução em segundo plano</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Precisa de revisão - Validação completa da taxonomia</span>
        </div>
        <span>0 de 1 (0%) / 0 de 1 (0%)</span>
        <span>1 lacuna de capacidade</span>
  ...
  <Accordion title="Hospedagem no Kubernetes - 4 áreas">
    <p className="maturity-readiness-summary">4 precisam de revisão</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>Área</span><span>Recursos / IDs de cobertura</span><span>Acompanhamento</span></div>
      <div className="maturity-readiness-row">
  ...
  <Accordion title="Aplicativo complementar para Linux - 5 áreas">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Recursos da área de trabalho</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Precisa de revisão - Validação completa da taxonomia</span>
        </div>
        <span>0 de 9 (0%) / 0 de 9 (0%)</span>
        <span>9 lacunas de recursos</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Conectividade com o Gateway</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Precisa de revisão - Validação completa da taxonomia</span>
        </div>
        <span>0 de 4 (0%) / 0 de 4 (0%)</span>
        <span>4 lacunas de recursos</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Status e diagnóstico</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Precisa de revisão - Validação completa da taxonomia</span>
        </div>
        <span>0 de 7 (0%) / 0 de 7 (0%)</span>
        <span>7 lacunas de recursos</span>
  ...
  <Accordion title="Host Linux do Gateway - 5 áreas">
    <p className="maturity-readiness-summary">5 precisam de revisão</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>Área</span><span>Recursos / IDs de cobertura</span><span>Acompanhamento</span></div>
      <div className="maturity-readiness-row">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Ambiente de execução e controle de serviço do Gateway</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Precisa de revisão - Validação completa da taxonomia</span>
        </div>
        <span>0 de 6 (0%) / 0 de 6 (0%)</span>
        <span>6 lacunas de recursos</span>
  ...
  <Accordion title="Provedores de modelos locais: Ollama, vLLM, SGLang, LM Studio - 5 áreas">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Plugins nativos de provedores</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Precisa de revisão - Validação completa da taxonomia</span>
        </div>
        <span>0 de 10 (0%) / 0 de 10 (0%)</span>
        <span>10 lacunas de recursos</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Segurança de rede e controles de prompts</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Precisa de revisão - Validação completa da taxonomia</span>
        </div>
        <span>0 de 2 (0%) / 0 de 2 (0%)</span>
        <span>2 lacunas de recursos</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Compatibilidade com ambientes de execução compatíveis com a OpenAI</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Precisa de revisão - Validação completa da taxonomia</span>
        </div>
        <span>0 de 8 (0%) / 0 de 8 (0%)</span>
        <span>8 lacunas de recursos</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Configuração, ciclo de vida e diagnóstico de provedores</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Precisa de revisão - Validação completa da taxonomia</span>
        </div>
        <span>0 de 12 (0%) / 0 de 12 (0%)</span>
        <span>12 lacunas de recursos</span>
  ...
  <Accordion title="Provedores hospedados de menor adoção - 3 áreas">
  ...
  <Accordion title="Aplicativo complementar para macOS - 8 áreas">
    <p className="maturity-readiness-summary">8 precisam de revisão</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>Área</span><span>Recursos / IDs de cobertura</span><span>Acompanhamento</span></div>
      <div className="maturity-readiness-row">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Recursos nativos</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Precisa de revisão - Validação completa da taxonomia</span>
        </div>
        <span>0 de 5 (0%) / 0 de 5 (0%)</span>
        <span>5 lacunas de capacidade</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Voz e conversação</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Precisa de revisão - Validação completa da taxonomia</span>
        </div>
        <span>0 de 3 (0%) / 0 de 3 (0%)</span>
        <span>3 lacunas de capacidade</span>
  ...
  <Accordion title="Host do Gateway no macOS - 7 áreas">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Integração com o Gateway local</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Precisa de revisão - Validação completa da taxonomia</span>
        </div>
        <span>0 de 9 (0%) / 0 de 9 (0%)</span>
        <span>9 lacunas de capacidade</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Permissões e recursos nativos</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Precisa de revisão - Validação completa da taxonomia</span>
        </div>
        <span>0 de 4 (0%) / 0 de 4 (0%)</span>
        <span>4 lacunas de capacidade</span>
  ...
  <Accordion title="Compreensão e geração de mídia - 6 áreas">
    <p className="maturity-readiness-summary">4 precisam de revisão / 2 parcialmente revisadas</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>Área</span><span>Recursos / IDs de cobertura</span><span>Acompanhamento</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Processamento de mídia do canal</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Precisa de revisão - Validação completa da taxonomia</span>
        </div>
        <span>0 de 5 (0%) / 0 de 5 (0%)</span>
        <span>5 lacunas de capacidade</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Recepção e acesso à mídia</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Precisa de revisão - Validação completa da taxonomia</span>
        </div>
        <span>0 de 8 (0%) / 0 de 8 (0%)</span>
        <span>8 lacunas de capacidade</span>
  ...
  <Accordion title="Aplicativo complementar nativo para Windows - 5 áreas">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Ferramentas e permissões da área de trabalho</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Precisa de revisão - Validação completa da taxonomia</span>
        </div>
        <span>0 de 10 (0%) / 0 de 10 (0%)</span>
        <span>10 lacunas de capacidade</span>
  ...
  <Accordion title="Caminho de instalação do Nix - 5 áreas">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Ativação e experiência do usuário no aplicativo</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Precisa de revisão - Validação completa da taxonomia</span>
        </div>
        <span>0 de 7 (0%) / 0 de 7 (0%)</span>
        <span>7 lacunas de capacidade</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Ambiente de execução e proteções do serviço</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Precisa de revisão - Validação completa da taxonomia</span>
        </div>
        <span>0 de 8 (0%) / 0 de 8 (0%)</span>
        <span>8 lacunas de capacidade</span>
  ...
  <Accordion title="Caminho dos provedores OpenAI e Codex - 5 áreas">
    <p className="maturity-readiness-summary">2 precisam de revisão / 3 parcialmente revisadas</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>Área</span><span>Recursos / IDs de cobertura</span><span>Acompanhamento</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Entrada de imagens e multimodal</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Precisa de revisão - Validação completa da taxonomia</span>
        </div>
        <span>0 de 2 (0%) / 0 de 2 (0%)</span>
        <span>2 lacunas de capacidade</span>
  ...
  <Accordion title="SDK de aplicativos OpenClaw - 6 áreas">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Conversas do agente</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Precisa de revisão - Validação completa da taxonomia</span>
        </div>
        <span>0 de 6 (0%) / 0 de 6 (0%)</span>
        <span>6 lacunas de capacidade</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">API do cliente</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Precisa de revisão - Validação completa da taxonomia</span>
        </div>
        <span>0 de 4 (0%) / 0 de 4 (0%)</span>
        <span>4 lacunas de capacidade</span>
  ...
  <Accordion title="Caminho do provedor OpenRouter - 4 áreas">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Runtime e normalização do chat</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Precisa de revisão - Validação completa da taxonomia</span>
        </div>
        <span>0 de 15 (0%) / 0 de 15 (0%)</span>
        <span>15 lacunas de capacidade</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Recuperação e diagnóstico do provedor</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Precisa de revisão - Validação completa da taxonomia</span>
        </div>
        <span>0 de 5 (0%) / 0 de 5 (0%)</span>
        <span>5 lacunas de capacidade</span>
  ...
  <Accordion title="Plugins - 9 áreas">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Aprovações de plugins</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Precisa de revisão - Validação completa da taxonomia</span>
        </div>
        <span>0 de 6 (0%) / 0 de 6 (0%)</span>
        <span>6 lacunas de capacidade</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Plugins de provedores e ferramentas</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">Parcialmente revisada - Validação completa da taxonomia</span>
        </div>
  ...
  <Accordion title="Raspberry Pi e dispositivos Linux pequenos - 4 áreas">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Desempenho e diagnóstico</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Precisa de revisão - Validação completa da taxonomia</span>
        </div>
        <span>0 de 5 (0%) / 0 de 5 (0%)</span>
        <span>5 lacunas de capacidade</span>
  ...
  <Accordion title="Segurança, autenticação, pareamento e segredos - 6 áreas">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Controle de acesso aos canais</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Precisa de revisão - Validação completa da taxonomia</span>
        </div>
        <span>0 de 3 (0%) / 0 de 3 (0%)</span>
        <span>3 lacunas de capacidade</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Pareamento de dispositivos e Nodes</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Precisa de revisão - Validação completa da taxonomia</span>
        </div>
        <span>0 de 11 (0%) / 0 de 11 (0%)</span>
        <span>11 lacunas de capacidade</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Confiança em Plugins</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Precisa de revisão - Validação completa da taxonomia</span>
        </div>
        <span>0 de 2 (0%) / 0 de 2 (0%)</span>
        <span>2 lacunas de capacidade</span>
  ...
  <Accordion title="Sessão, memória e mecanismo de contexto — 9 áreas">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Gerenciamento de sessões e transcrições da CLI</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Precisa de revisão — Validação completa da taxonomia</span>
        </div>
        <span>0 de 2 (0%) / 0 de 2 (0%)</span>
        <span>2 lacunas de capacidade</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          ...
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">Parcialmente revisados — Validação completa da taxonomia</span>
        </div>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Paridade de histórico e sessões entre clientes</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">Parcialmente revisada — Validação completa da taxonomia</span>
        </div>
  ...
  <Accordion title="TUI - 5 áreas">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Execução do shell local</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Precisa de revisão - Validação completa da taxonomia</span>
        </div>
        <span>0 de 4 (0%) / 0 de 4 (0%)</span>
        <span>4 lacunas de capacidade</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Modos de execução</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Precisa de revisão - Validação completa da taxonomia</span>
        </div>
        <span>0 de 14 (0%) / 0 de 14 (0%)</span>
        <span>14 lacunas de capacidade</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Gerenciamento de sessões</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Precisa de revisão - Validação completa da taxonomia</span>
        </div>
        <span>0 de 3 (0%) / 0 de 3 (0%)</span>
        <span>3 lacunas de capacidade</span>
  ...
  <Accordion title="Superfícies complementares do watchOS - 5 áreas">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Aprovações de execução</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Precisa de revisão - Validação completa da taxonomia</span>
        </div>
        <span>0 de 3 (0%) / 0 de 3 (0%)</span>
        <span>3 lacunas de capacidade</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Interface do aplicativo para relógio</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Precisa de revisão - Validação completa da taxonomia</span>
        </div>
        <span>0 de 3 (0%) / 0 de 3 (0%)</span>
        <span>3 lacunas de capacidade</span>
  ...
  <Accordion title="Ferramentas de pesquisa na web - 4 áreas">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Disponibilidade e busca das ferramentas</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">Parcialmente revisada - Validação completa da taxonomia</span>
        </div>
  ...
  <Accordion title="Windows via WSL2 - 6 áreas">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Navegador e interface de controle</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Precisa de revisão - Validação completa da taxonomia</span>
        </div>
        <span>0 de 6 (0%) / 0 de 6 (0%)</span>
        <span>6 lacunas de capacidade</span>
