...
x-i18n:
    generated_at: "2026-07-04T15:10:55Z"
    model: gpt-5.5
...
- Headings:
  - H1: Remoção do BlueBubbles e o caminho do imsg para iMessage
  - H2: O que mudou
  - H2: O que fazer
...
- Headings:
  - H2: Códigos estáveis de motivo de probe
  ...
  - H2: Resolução do destino do probe
  - H2: Descoberta de credenciais de CLI externo
  - H2: Guarda de política SecretRef do OAuth
...
- Headings:
  ...
  - H2: Comandos da CLI
  - H2: Como os fluxos se relacionam com tarefas
  - H2: Relacionado
...
- Headings:
  ...
  - H3: Permitir todos os grupos, ainda exigindo @mention
...
- Headings:
  ...
  - H3: Configuração
  - H3: Quando você não consegue desabilitar SIP
  - H2: Controle de acesso e roteamento
...
- Títulos:
  ...
  - H2: Tentativa novamente de canal de DM
...
- Títulos:
  ...
  - H3: Armazenamento de estado do pareamento Node
  - H3: Observações
...
- Títulos:
  ...
  - H2: Reações de status de ciclo de vida
  - H2: Reações (ferramenta de mensagem)
...
- Títulos:
  ...
  - H3: Teste de ponta a ponta do iMessage/SMS no macOS
...
- Títulos:
  ...
  - H2: Configuração rápida
  - H2: Chamar o solicitante atual com MeowCaller (experimental)
  - H2: Padrões de implantação
  - H2: Modelo de runtime
...
- Títulos:
  ...
  - H2: Exemplos de configuração
  - H3: Configuração básica com política aberta de MD
  - H3: Restringir MDs a usuários específicos
...
- Títulos:
  ...
  - H3: formato --bind
  - H3: Comportamento de escopo da vinculação
...
- Títulos:
  ...
  - H2: Modelos
  - H3: Precedência isolada do modelo cron
  - H3: Modo rápido
...
- Títulos:
  ...
  - H2: Flags comuns
  - H2: Observações
  - H2: Usando resultados com envio de mensagem
...
- Títulos:
  ...
  - H3: Notificações de canal do Claude
...
- Títulos:
  ...
  - H3: Memória LanceDB
  - H3: Lossless Claw
  - H2: Saídas avançadas de emergência
...
- Títulos:
  ...
  - H2: Diário de sonhos
  - H2: Sinais profundos de classificação
  - H2: Cobertura do relatório de avaliação paralela de QA
  - H2: Agendamento
  - H2: Início rápido
  - H2: Comando de barra
...
- Títulos:
  - H2: O que ele adiciona em relação ao integrado
  - H2: Primeiros passos
  - H3: Pré-requisitos
  - H3: Habilitar
...
- Títulos:
  ...
  - H2: Streaming, divisão em partes e agrupamento em lotes
  - H2: Visibilidade do raciocínio e tokens
  - H2: Prefixos, threads e respostas
...
- Títulos:
  - H2: Fluxo de runtime
  - H2: Política da fonte de seleção
...
- Títulos:
  ...
  - H3: Edições seguras na lista de permissões
...
- Títulos:
  ...
  - H2: Cobertura de transportes ao vivo
  ...
  - H2: Seeds com respaldo do repositório
  - H2: Lanes de mock de provedor
  - H2: Adaptadores de transporte
  - H3: Adicionar um canal
...
- Títulos:
  - H2: Ferramentas disponíveis
  - H2: Listar e ler sessões
  - H2: Enviar mensagens entre sessões
...
- Títulos:
  - H2: Streaming em bloco (mensagens do canal)
  - H3: Entrega de mídia com streaming em bloco
  - H2: Algoritmo de divisão em chunks (limites baixo/alto)
  - H2: Coalescência (mesclar blocos em streaming)
  - H2: Ritmo humano entre blocos
  - H2: "Transmitir chunks por streaming ou tudo"
...
- Títulos:
  ...
  - H2: Configurar o fuso horário do usuário
...
- Títulos:
  ...
  - H3: Configuração
  - H2: Rodapé personalizado completo de /usage
  - H3: Formato
...
- Títulos:
  ...
  - H2: Substituição por env (avulsa)
...
- Títulos:
  ...
  - H2: Anthropic: Claude CLI e compatibilidade de token
  - H2: Observação sobre Anthropic
  - H2: Verificar status de autenticação do modelo
  - H2: Comportamento de rotação de chave de API (gateway)
  - H2: Remover autenticação de provedor enquanto o gateway está em execução
  - H2: Controlar qual credencial é usada
...
- Títulos:
  ...
  - H2: Limite de repropagação do histórico
  - H2: Limitações
  - H2: Solução de problemas
  - H2: Relacionado
...
- Títulos:
  ...
  - H3: Bloqueio por menção em chats de grupo
...
- Títulos:
  ...
  - H3: Repositório de skill irmão vinculado por symlink
  - H2: Padrões comuns
...
- Títulos:
  ...
  - H3: Modos de recarga
  - H3: O que é aplicado a quente versus o que precisa de reinicialização
...
- Títulos:
  ...
  - H3: Estilo de log WS
  - H2: Formatação de console (logs de subsistema)
  - H2: Relacionado
...
- Títulos:
  - H2: Funções
  - H2: Níveis de escopo
  - H2: O escopo de método é apenas o primeiro bloqueio
...
- Títulos:
  ...
  - H2: Localidade e headers encaminhados
...
- Títulos:
  ...
  - H2: Chaves de API respaldadas por arquivo
...
- Títulos:
  ...
  - H2: Execução em Node (system.run)
  ...
  - H2: Plugins
  - H2: Modelo de acesso por DM: pareamento, allowlist, aberto, desativado
  ...
  - H2: Riscos de controle de navegador
...
- Títulos:
  ...
  - H3: Apenas tailnet (bind ao IP da tailnet)
...
- Títulos:
  ...
  - H2: Gateway no macOS para de responder silenciosamente e volta quando você toca no painel
  - H2: Gateway encerra durante uso alto de memória
...
- Títulos:
  ...
  - H2: Refs de segredo vs strings ${ENV}
...
- Títulos:
  - H2: Ao vivo: comandos de smoke locais
  ...
  - H2: Ao vivo: alcance do proxy HTTP/2 de APNs
  - H2: Ao vivo: smoke de bind ACP (/acp spawn ... --bind here)
  - H2: Ao vivo: smoke do harness de app-server Codex
...
- Títulos:
  ...
  - H2: Direcionamento para versão ou tag única
  - H2: Simulação
  - H2: Plugins e canais
  - H2: Verificando o status atual
  - H2: Práticas recomendadas de marcação
...
- Títulos:
  - H2: Incorpore os binários necessários na imagem
...
- Títulos:
  ...
  - H2: 4) Configurar nginx para proxyar o OpenClaw para a porta 8000
...
- Títulos:
  ...
  - H3: Permissões
  - H3: Requisito de primeiro plano Android
  ...
  - H2: Vídeo da tela no macOS (nível do SO)
  - H2: Relacionado
...
- Títulos:
  ...
  - H3: A estabilidade do prompt-cache é importante
  ...
  - H3: 5. Preservar formatação estável do prompt-cache
  - H3: 6. Conectar post-turn após o espelhamento da transcrição
  - H3: 7. Normalizar uso e contexto de runtime do prompt-cache
...
- Títulos:
  ...
  - H2: Pressão de memória e eliminações por OOM
  - H2: Relacionado
...
- Títulos:
  ...
  - H2: Dados privados do logging unificado no macOS
...
- Títulos:
  ...
  - H2: O que vai onde
  - H2: Seams de provedor e harness
...
- Cabeçalhos:
  ...
  - H3: Nenhum Node conectado compatível com Google Meet
...
- Cabeçalhos:
  ...
  - H2: Roteiar prompts de aprovação
...
- Títulos:
  ...
  - H3: Modo harness nativo do Codex
  - H2: Rigor de runtime
...
- Títulos:
  ...
  - H2: Armazenando referências de runtime
...
- Títulos:
  ...
  - H3: Auxiliares obsoletos de compatibilidade e teste
...
- Títulos:
  ...
  - H3: Executando testes escopados
...
- Títulos:
  ...
  - H3: Período de tolerância para desconexão do stream Twilio
...
- Títulos:
  ...
  - H2: Fallback de recusa de segurança (Claude Fable 5)
...
- Títulos:
  - H2: Primeiros passos
  - H2: Descoberta de modelos
  - H2: Protocolo e plugins de provedor
  - H2: Cotas e uso
  - H2: Solução de problemas
...
- Títulos:
  ...
  - H3: Host do LM Studio na LAN ou tailnet
  - H2: Relacionado
...
- Títulos:
  ...
  - H2: Preços
  - H3: Venice (anonimizada) vs API direta
  - H2: Exemplos de uso
  - H2: Solução de problemas
  - H2: Configuração avançada
  - H2: Relacionado
...
- Títulos:
  ...
  - H2: Forma do esquema de destino
  - H2: Forma de migração do Doctor
  ...
  - H3: Fase 3: Substituir APIs do repositório de sessões
  - H3: Fase 4: Mover transcrições, streams ACP, trajetórias e VFS
  - H3: Fase 5: Backup, restauração, limpeza e verificação
...
- Títulos:
  ...
  - H2: Lista de verificação do operador de lançamento
  - H2: Encerramento do main estável
...
- Títulos:
  ...
  - H2: Fase 6: Documentação e prontidão de lançamento
...
- Títulos:
  ...
  - H2: Interação de pesquisa de ferramentas
...
- Títulos:
  - H2: Snapshot
  - H2: Linha do tempo do espaço ocupado pela instalação
...
- Títulos:
  - H1: Convenções de placeholders de segredos
...
- Títulos:
  ...
  - H2: Locais no disco
  - H2: Manutenção do repositório e controles de disco
  - H2: Sessões Cron e logs de execução
  - H2: Chaves de sessão (sessionKey)
  - H2: IDs de sessão (sessionId)
  - H2: Esquema do repositório de sessões (sessions.json)
  ...
  - H2: "Liberação de memória" antes da Compaction (implementada)
...
- Títulos:
  - H1: AGENTS.md - Workspace do OpenClaw
...
- Títulos:
  ...
  - H2: Teste rápido de importação de QR (Docker)
  - H2: Relacionado
...
- Títulos:
  ...
  - H2: Regra global: procedência de entrada entre sessões
...
- Títulos:
  ...
  - H2: A primeira troca de casca (27 de janeiro de 2026)
  - H2: O nome
  ...
  - H3: A grande troca de casca (27 de janeiro de 2026)
...
- Títulos:
  ...
  - H3: 0) (Opcional) Rode também o aplicativo macOS a partir do código-fonte
  - H3: 1) Inicie o Gateway de desenvolvimento
  - H3: 2) Aponte o aplicativo macOS para seu Gateway em execução
  - H3: 3) Verifique
  - H3: Armadilhas comuns
  - H2: Mapa de armazenamento de credenciais
...
- Cabeçalhos:
  ...
  - H2: Modos de vinculação de spawn e de thread
...
- Cabeçalhos:
  ...
  - H2: Sandbox + acesso ao navegador do host
  - H2: Relacionados
...
- Cabeçalhos:
  ...
  - H2: Configuração
  - H3: Visão por captura de tela (suporte a modelos somente texto)
  ...
  - H2: API de controle (opcional)
  - H2: Solução de problemas
  - H3: Falha de inicialização do CDP vs bloqueio de SSRF de navegação
...
- Cabeçalhos:
  ...
  - H2: Permitir automaticamente CLIs de skill
...
- Cabeçalhos:
  ...
  - H2: Aprovações de exec (aplicativo companion / host Node)
...
- Cabeçalhos:
  ...
  - H2: Como webfetch usa o Firecrawl
  - H2: Relacionados
...
- Cabeçalhos:
  ...
  - H3: Edição de imagem
  - H2: Aprofundamentos de provedores
  - H2: Exemplos
  - H2: Relacionados
...
- Títulos:
  - H2: Instalar Plugin
  - H2: Obter uma chave de API do Perplexity
...
- Títulos:
  ...
  - H3: tavilysearch
  - H3: tavilyextract
  - H2: Escolher a ferramenta certa
  - H2: Configuração avançada
  - H2: Relacionados
...
- Títulos:
  ...
  - H2: Reforçar o acesso administrativo primeiro
...
- Títulos:
  ...
  - H2: Largura de mensagens de chat
  - H2: Acesso por tailnet (recomendado)
  - H2: HTTP inseguro
  - H2: Política de segurança de conteúdo
  - H2: Autenticação de rota de avatar
  - H2: Autenticação de rota de mídia do assistente
  - H2: Construir a UI
  - H2: Página em branco da Control UI
  - H2: Depuração/testes: servidor dev + Gateway remoto
  - H2: Relacionados
