...
summary: Mapa de cabeçalhos gerado para páginas da documentação do OpenClaw
title: Mapa da documentação
x-i18n:
    generated_at: "2026-07-04T10:31:33Z"
    model: gpt-5.5
...
- Títulos:
  - H1: Remoção do BlueBubbles e o caminho imsg do iMessage
  - H2: O que mudou
  - H2: O que fazer
...
- Títulos:
  ...
  - H2: Rotas de autenticação apenas por configuração
  - H2: Filtragem explícita da ordem de autenticação
  - H2: Resolução do alvo de sondagem
  - H2: Descoberta de credenciais da CLI externa
  - H2: Proteção de política OAuth SecretRef
...
- Títulos:
  - H2: Quando usar fluxo de tarefas
  - H2: Padrão confiável de workflow agendado
...
- Títulos:
  ...
  - H3: Permitir todos os grupos, sem exigir @mention
  - H3: Permitir todos os grupos, ainda exigir @mention
...
- Títulos:
  ...
  - H2: Escopar padrões de menção configurados
  - H2: Restrições de ferramentas de grupo/canal (opcional)
...
- Títulos:
  ...
  - H3: Configuração
  - H3: Quando você não consegue desativar o SIP
  - H2: Controle de acesso e roteamento
  ...
  - H2: Agrupamento de DMs enviadas separadamente (comando + URL em uma composição)
...
- Títulos:
  ...
  - H2: Controle de acesso
  - H3: Pegadinha comum: allowFrom é para DMs, não para canais
  ...
  - H3: Ferramentas diferentes por remetente (proprietário tem mais poder)
  - H2: NickServ
...
- Títulos:
  ...
  - H3: Etapa 4: Habilitar canal Teams
  ...
  - H2: Contexto de histórico
  - H2: Permissões atuais de RSC do Teams (manifesto)
  ...
  - H3: Com apenas RSC do Teams (app instalado, sem permissões de API do Graph)
...
- Títulos:
  ...
  - H3: Aprovar um dispositivo de nó
  - H3: Aprovação automática opcional de nó por trusted-CIDR
...
- Títulos:
  ...
  - H3: Envios de modal de propriedade do Plugin
...
- Títulos:
  ...
  - H3: Teste ponta a ponta a partir de macOS iMessage/SMS
...
- Títulos:
  ...
  - H2: Configuração rápida
  - H2: Ligar para o solicitante atual com MeowCaller (experimental)
  - H2: Padrões de implantação
  - H2: Modelo de runtime
...
- Títulos:
  ...
  - H3: Desabilitar exigência de @menção em grupos
...
- Títulos:
  ...
  - H2: Limites
  - H2: Controle de acesso (DMs)
  - H2: Acesso de grupo (opcional)
  - H3: Gating por menção de grupo
  - H2: Várias contas
  - H2: Variáveis de ambiente
...
- Títulos:
  ...
  - H3: Shards de segurança específicos por plataforma
...
- Títulos:
  ...
  - H3: formato --bind
  - H3: Comportamento de escopo de vinculação
...
- Títulos:
  ...
  - H3: Supressão de token silencioso
...
- Títulos:
  ...
  - H3: gateway status
  - H3: gateway probe
  - H4: Remoto por SSH (paridade com app Mac)
...
- Títulos:
  - H1: openclaw hooks
  - H2: Listar todos os ganchos
  - H2: Obter informações do gancho
  - H2: Verificar elegibilidade dos ganchos
  - H2: Habilitar um gancho
  - H2: Desabilitar um gancho
  - H2: Observações
  - H2: Instalar pacotes de ganchos
  - H2: Atualizar pacotes de ganchos
  - H2: Ganchos incluídos
  - H3: session-memory
...
- Títulos:
  ...
  - H3: Depois de alterar a configuração do sandbox
  - H3: Depois de alterar o destino SSH ou o material de autenticação SSH
  - H3: Depois de alterar a origem, política ou modo do OpenShell
...
- Títulos:
  ...
  - H2: show
  - H2: dispatch
  - H2: Paridade de comando de barra
  - H2: Permissões
  - H2: Solução de problemas
...
- Títulos:
  ...
  - H3: Memória LanceDB
  - H3: Lossless Claw
  - H2: Escapes avançados
  - H2: Persistência de transcrições
  - H2: Configuração
  - H2: Configuração recomendada
  - H3: Período de carência de cold-start
  - H2: Depuração
  - H2: Problemas comuns
...
- Títulos:
  ...
  - H2: Montagem do prompt + prompt de sistema
  - H2: Pontos de gancho (onde você pode interceptar)
  - H3: Ganchos internos (ganchos do Gateway)
  - H3: Ganchos de Plugin (ciclo de vida do agente + Gateway)
  - H2: Streaming + respostas parciais
  - H2: Execução de ferramentas + ferramentas de mensagens
  - H2: Formatação da resposta + supressão
  - H2: Compaction + tentativas
...
- Títulos:
  ...
  - H2: Backup do Git (recomendado, privado)
  - H2: Não faça commit de segredos
  - H2: Como mover o workspace para uma nova máquina
...
- Títulos:
  ...
  - H3: Guarda de bytes da transcrição ativa
...
- Títulos:
  ...
  - H3: Adição ao prompt de sistema
...
- Títulos:
  ...
  - H2: Como o OpenClaw monta o prompt de sistema
...
- Títulos:
  ...
  - H2: Camadas de capacidade
  - H3: Camada 1: Somente leitura + rascunho
  - H3: Camada 2: Enviar em nome de alguém
  - H3: Camada 3: Proativo
  - H2: Pré-requisitos: isolamento e endurecimento
...
- Títulos:
  ...
  - H2: Dreaming nunca roda: o status mostra bloqueado
  - H2: Relacionado
...
- Títulos:
  ...
  - H2: Máquinas
  - H2: Segredos
  - H2: Artefatos do GitHub e comentários em PR
  - H2: Observações de implantação privada
...
- Títulos:
  ...
  - H2: Dreaming
  - H2: Preenchimento retroativo fundamentado e promoção ao vivo
  - H2: CLI
  - H2: Leitura adicional
  - H2: Relacionado
...
- Títulos:
  ...
  - H2: Proteções de compatibilidade
  ...
  - H3: Fase 4: Ponte de dispatcher preparado
...
- Títulos:
  ...
  - H2: Streaming, divisão em blocos e agrupamento em lote
...
- Títulos:
  ...
  - H2: IDs de perfil
  - H2: Ordem de rotação
  - H3: Fixação de sessão (amigável a cache)
  - H3: Assinatura do OpenAI Codex mais backup por chave de API
  - H2: Cooldowns
...
- Títulos:
  ...
  - H2: Um número do WhatsApp, várias pessoas (divisão de DM)
...
- Títulos:
  ...
  - H2: Múltiplas contas (perfis) + roteamento
  - H3: 1) Preferido: agentes separados
  - H3: 2) Avançado: múltiplos perfis em um agente
  - H2: Relacionados
...
- Títulos:
  ...
  - H3: Fase 1: contratos de lane + trabalho pesado em segundo plano
...
- Títulos:
  ...
  - H2: Seeds com base no repositório
...
- Títulos:
  ...
  - H2: Exemplo prático: adicionar um método de ponta a ponta
...
- Títulos:
  ...
  - H2: Linhas de evento do sistema (local por padrão)
  - H3: Configurar fuso horário do usuário + formato
  - H2: Detecção de formato de hora (automática)
  - H2: Payloads de ferramentas + conectores (hora bruta do provedor + campos normalizados)
  - H2: Documentos relacionados
...
- Títulos:
  ...
  - H2: Verificação da versão do Node
...
- Títulos:
  ...
  - H2: Anthropic: Claude CLI e compatibilidade de tokens
  - H2: Observação sobre Anthropic
  - H2: Verificando status de autenticação do modelo
...
- Títulos:
  - H2: ferramenta exec
  - H2: Ponte para processos filhos
...
- Títulos:
  - H2: Bonjour de área ampla (Unicast DNS-SD) via Tailscale
  ...
  - H2: Depuração em logs do Gateway
...
- Títulos:
  ...
  - H2: Frames
  - H2: Eventos do ciclo de vida de exec
...
- Títulos:
  ...
  - H3: Campos de correspondência de binding
...
- Títulos:
  ...
  - H3: Microsoft Teams
  - H3: IRC
  - H3: Múltiplas contas (todos os canais)
  - H3: Outros canais de Plugin
  - H3: Controle de menções em chat em grupo
...
- Títulos:
  ...
  - H3: Chave de API Anthropic + fallback MiniMax
...
- Títulos:
  ...
  - H3: Isolamento de múltiplas instâncias
  - H3: gateway.tls
  - H3: gateway.reload
  - H2: Hooks
  ...
  - H2: Assistente
  - H2: Identidade
  - H2: Ponte (legado, removida)
  - H2: Cron
  - H3: cron.retry
  - H3: cron.failureAlert
  - H3: cron.failureDestination
  - H2: Variáveis de modelo para modelos de mídia
...
- Títulos:
  ...
  - H3: Modos de recarga
  - H3: O que é aplicado dinamicamente vs. o que precisa de reinicialização
...
- Títulos:
  ...
  - H2: Preenchimento retroativo e redefinição da UI de Dreams
...
- Títulos:
  ...
  - H2: Assinaturas de falha comuns
...
- Títulos:
  ...
  - H2: Redação
  - H2: Logs WebSocket do Gateway
  - H3: Estilo de log WS
  - H2: Formatação de console (logging de subsistema)
  - H2: Relacionado
...
- Títulos:
  ...
  - H2: Configuração geral com múltiplos gateways
...
- Títulos:
  ...
  - H3: Conversa
  - H3: Filas e sessões
  - H3: Telemetria de liveness da sessão
...
- Títulos:
  ...
  - H2: Presença
  - H3: Evento de Node em segundo plano ativo
...
- Títulos:
  ...
  - H3: Etapa 5: Reiniciar o OpenClaw.app
...
- Títulos:
  ...
  - H2: Correções comuns de "prisão de sandbox"
  - H3: "Ferramenta X bloqueada pela política de ferramentas do sandbox"
  - H3: "Achei que isto fosse main, por que está em sandbox?"
  - H2: Relacionados
...
- Títulos:
  ...
  - H2: Variáveis de ambiente de servidor MCP
  ...
  - H2: Resolução de caminhos de comando
...
- Títulos:
  ...
  - H2: Inventário de pré-voo
  - H2: Verificações de baseline
  - H2: Baseline mínimo seguro
  - H2: Exposição de DM e grupo
...
- Títulos:
  ...
  - H3: Confiança na implantação e no host
  ...
  - H2: Baseline reforçado em 60 segundos
  ...
  - H2: Glossário da auditoria de segurança
  ...
  - H2: Risco de ferramentas do plano de controle
  - H2: Plugins
  - H2: Modelo de acesso a DMs: pareamento, lista de permissões, aberto, desativado
  ...
  - H2: Flags inseguras para contornar conteúdo externo
  - H3: Injeção de prompt não exige DMs públicas
  - H3: Backends LLM auto-hospedados
  ...
  - H3: Baseline seguro (copiar/colar)
  - H2: Sandboxing (recomendado)
  - H3: Proteção para delegação de subagente
...
- Títulos:
  ...
  - H2: O que continua protegido sem Python
  - H2: O que o Python adiciona
  - H2: Orientação para Plugin e núcleo
...
- Títulos:
  ...
  - H2: Exemplos de CLI
  - H2: Observações
  - H2: Controle de navegador (Gateway remoto + navegador local)
...
- Títulos:
  - H2: Escada de comandos
  - H2: Após uma atualização
  - H2: Instalações com split brain e proteção de configuração mais recente
  ...
  - H3: Mapa rápido de códigos de detalhes de autenticação
  - H2: Serviço do Gateway não está em execução
  - H2: Gateway macOS para silenciosamente de responder e depois retoma quando você toca no painel
...
- Títulos:
  ...
  - H2: Cabeçalho de escopos de operador
...
- Títulos:
  ...
  - H2: Substituição de variável de ambiente na configuração
  - H2: Referências secretas vs strings ${ENV}
  - H2: Variáveis de ambiente relacionadas a caminho
  - H2: Registro
  - H3: OPENCLAWHOME
  - H2: Usuários de nvm: falhas TLS em webfetch
...
- Títulos:
  ...
  - H2: Comandos de chat, abortar tarefas e "não para"
  - H2: Diversos
  - H2: Relacionados
...
- Títulos:
  ...
  - H2: Live: varredura de capacidade de node Android
  ...
  - H2: Live: smoke do harness de app-server do Codex
...
- Títulos:
  ...
  - H2: Instalação de Plugin falha por falta de extensões openclaw
...
- Títulos:
  ...
  - H2: 8) Rodar a VM sem interface gráfica
...
- Títulos:
  ...
  - H3: Descoberta de PATH de serviço
  - H2: Relacionado
...
- Cabeçalhos:
  ...
  - H3: Inicializações frias lentas (camada gratuita)
...
- Cabeçalhos:
  ...
  - H2: Execute a integração inicial
  - H2: Inicie o Gateway
...
- Cabeçalhos:
  ...
  - H2: Exemplos de configuração
  - H3: Provedor + fallback de CLI (OpenAI + Whisper CLI)
...
- Cabeçalhos:
  ...
  - H3: Auxiliar de CLI
  - H2: Nó Android
  - H3: Configuração de usuário do Android (ativada por padrão)
  - H3: Permissões
  ...
  - H2: Vídeo da tela do macOS (nível do SO)
  - H2: Relacionado
...
- Cabeçalhos:
  ...
  - H2: Host de nó sem interface gráfica (multiplataforma)
  - H2: Modo de nó Mac
...
- Cabeçalhos:
  ...
  - H2: Protocolo
  - H3: Métodos
  - H3: Métodos de roteamento (gatilho → alvo)
  - H3: Eventos
...
- Cabeçalhos:
  ...
  - H3: O servidor de app do Codex permanece canônico para o estado de thread nativo
...
- Cabeçalhos:
  ...
  - H2: Pré-requisitos
  - H2: 1. Instale as dependências
  - H2: 2. Compile e empacote o app
  - H2: 3. Instale a CLI e o Gateway
  - H2: Solução de problemas
  - H3: A compilação falha: incompatibilidade de cadeia de ferramentas ou SDK
...
- Cabeçalhos:
  ...
  - H2: Relação com uso do computador
  - H2: Habilite a ponte
...
- Cabeçalhos:
  ...
  - H2: Modo de falha da sobreposição fixa (anterior)
...
- Cabeçalhos:
  ...
  - H2: O que vai onde
  - H2: Pontos de integração de provedor e harness
...
- Cabeçalhos:
  ...
  - H2: Hooks de runtime de provedor
  ...
  - H2: Resolução de alvo de canal
  - H2: Diretórios respaldados por configuração
  ...
  - H2: Adicionando uma nova capacidade
...
- Cabeçalhos:
  - H2: Modelo público de capacidade
  ...
  - H3: Plugins de canal e a ferramenta de mensagem compartilhada
  - H2: Modelo de propriedade de capacidade
...
- Cabeçalhos:
  ...
  - H3: ownsNativeCompaction: optando por não usar a compaction do OpenClaw
...
- Cabeçalhos:
  - H2: Requisitos
  - H2: Início rápido
  - H2: Compartilhar threads com Codex Desktop e CLI
  - H2: Configuração
...
- Cabeçalhos:
  - H2: Requisitos
  - H2: Início rápido
  - H2: Gerencie plugins pelo chat
  - H2: Como a configuração de plugins nativos funciona
  - H2: Limite de suporte V1
  - H2: Inventário e propriedade do app
  - H2: Configuração de app por thread
...
- Títulos:
  ...
  - H2: Configuração
  - H2: Ferramenta
  - H2: Modos de agente e bidirecionais
  - H2: Lista de verificação de teste ao vivo
  - H2: Solução de problemas
  - H3: O agente não consegue ver a ferramenta Google Meet
  - H3: Nenhum nó conectado compatível com Google Meet
  - H3: O navegador abre, mas o agente não consegue entrar
  - H3: A criação da reunião falha
...
- Títulos:
  ...
  - H2: Política de chamadas de ferramenta
  - H3: Hook de ambiente de execução
  - H3: Persistência de resultados de ferramenta
...
- Títulos:
  - H2: Instalação
  - H2: Início rápido
  - H2: Embeddings baseados em provedor
  ...
  - H2: Solução de problemas
  - H3: O comprimento de entrada excede o comprimento do contexto
...
- Títulos:
  ...
  - H2: Como ele se encaixa com a memória
...
- Títulos:
  ...
  - H3: Visibilidade de fallback do valor do botão
...
- Cabeçalhos:
  ...
  - H2: Pareamento de provedor com harness
  ...
  - H3: Modo de harness nativo Codex
  - H2: Rigor do runtime
...
- Cabeçalhos:
  - H2: Como Plugins de canal funcionam
...
- Cabeçalhos:
  ...
  - H3: Subcaminhos reservados de auxiliares de Plugin integrado
  - H2: Relacionado
...
- Cabeçalhos:
  ...
  - H3: Teste de unidade de um Plugin de canal
  - H3: Teste de unidade de um Plugin de provedor
...
- Cabeçalhos:
  ...
  - H3: Carência para desconexão de stream do Twilio
  ...
  - H3: Credenciais de provedor falham
  - H3: Chamadas iniciam, mas Webhooks de provedor não chegam
...
- Cabeçalhos:
  ...
  - H2: Configuração
  - H2: Solução de problemas
  - H3: A aba diz que Workboard não está disponível
...
- Títulos:
  - H2: Primeiros passos
  - H2: Opções de configuração
  - H2: STT de streaming para chamada de voz
  - H2: Observações
  - H2: Relacionados
...
- Títulos:
  ...
  - H2: Descoberta de modelos
  - H2: Streaming e suporte a ferramentas
  - H2: Preços
...
- Títulos:
  ...
  - H3: Fase 3: Coleta de inicialização priorizando concessões
...
- Títulos:
  - H1: Refatoração de estado com prioridade para banco de dados
  - H2: Decisão
  - H2: Contrato rígido
  ...
  - H2: Forma atual do código
  - H2: Forma do esquema-alvo
  - H2: Forma da migração do doctor
  ...
  - H2: Plano de refatoração de runtime
...
- Títulos:
  ...
  - H2: Padrões de segurança
  - H2: Preflight de soluções existentes
...
- Títulos:
  ...
  - H3: 6) Snapshots de uso de provedor (status/saúde)
...
- Títulos:
  ...
  - H2: Atualização da skill frontend
...
- Títulos:
  ...
  - H2: Partes do caminho de lançamento Docker
  - H2: Perfis de lançamento
  - H2: Adições exclusivas do completo
...
- Títulos:
  ...
  - H3: Linha de base priorizando custo
  ...
  - H3: Configuração diagnostics.cacheTrace
  - H3: Alternadores de env (depuração pontual)
...
- Títulos:
  - H2: [embed ...]
  - H2: Forma de renderização armazenada
  - H2: Relacionado
...
- Títulos:
  ...
  - H3: Alvos openclaw.json (secrets configure + secrets apply + secrets audit)
  - H3: Alvos auth-profiles.json (secrets configure + secrets apply + secrets audit)
...
- Títulos:
  ...
  - H3: Verdades essenciais (de Clawd)
  - H2: Relacionado
...
- Títulos:
  - H2: Gate local de PR
  - H2: Benchmark de latência do modelo (chaves locais)
...
- Títulos:
  ...
  - H4: T-EXFIL-002: Envio de mensagens não autorizado
  - H4: T-EXFIL-003: Coleta de credenciais
  - H3: 3.8 Impacto (AML.TA0011)
  - H4: T-IMPACT-001: Execução de comandos não autorizada
...
- Títulos:
  ...
  - H2: v1++: modelos limitados adicionais (concorrência, tentativas, correção de rastreamento)
...
- Títulos:
  ...
  - H2: Configuração
  - H3: Modo de local loopback do Gateway
  - H2: Requisitos de proxy
  - H2: Destinos bloqueados recomendados
  - H2: Validação
  - H2: Confiança da CA de proxy
  - H2: Limites
...
- Títulos:
  ...
  - H3: O despejo de diretório (3 de dez. de 2025)
...
- Títulos:
  ...
  - H2: Pré-requisitos
  - H2: A configuração de dois telefones (recomendada)
...
- Títulos:
  ...
  - H2: Estratégia de adaptação (para que atualizações não prejudiquem)
...
- Títulos:
  ...
  - H2: O que a integração configura
  - H2: Adicionar outro agente
  - H2: Referência completa
  - H2: Documentação relacionada
...
- Títulos:
  ...
  - H2: Configuração obrigatória
  - H2: Configuração de Plugin para backend acpx
...
- Títulos:
  ...
  - H3: Solução 2: Use Snap Chromium com o modo somente anexação
...
- Títulos:
  ...
  - H2: Regra crítica para a UI de controle
  ...
  - H3: Camada 4: Verifique a camada da UI de controle separadamente
...
- Títulos:
  ...
  - H2: API de controle (opcional)
  - H2: Solução de problemas
  - H3: Falha de inicialização do CDP vs bloqueio de SSRF na navegação
...
- Títulos:
  ...
  - H2: Modelo de entrega
  - H2: Comportamento de superfície
  - H3: TUI
  - H3: Canais externos
  - H3: UI de controle / web
  - H2: Quando usar BTW
...
- Títulos:
  ...
  - H3: Encaminhamento de aprovação do Plugin
...
- Títulos:
  ...
  - H3: Configuração persistente de "never prompt" do host Gateway
  - H3: Atalho local
  - H3: Host Node
...
- Títulos:
  ...
  - H3: Edição de imagem
  - H2: Análises detalhadas de provedores
  - H2: Exemplos
  - H2: Relacionado
...
- Títulos:
  ...
  - H2: Como funciona
  - H2: Padrão: CLI pequeno + pipes JSON + aprovações
...
- Títulos:
  - H2: Capacidades
  - H2: Matriz de capacidades por provedor
...
- Títulos:
  - H2: Obter uma credencial do plano Token
  - H2: Configuração
...
- Títulos:
  ...
  - H2: Skills por agente vs compartilhados
  - H2: Listas de permissões de agentes
  - H2: Plugins e Skills
  - H2: Skill Workshop
  - H2: Instalando pelo ClawHub
  - H2: Segurança
  - H2: Formato SKILL.md
  - H3: Chaves opcionais de frontmatter
  - H2: Controle de acesso
  - H3: Especificações de instalador
...
- Títulos:
  - H2: Como uma rodada é executada
  - H2: Modos
  - H2: Por que isso existe
  - H2: API
  - H2: Limite de runtime
...
- Títulos:
  ...
  - H2: Diretivas guiadas por modelo
  - H2: Comandos slash
...
- Títulos:
  ...
  - H2: Proteja primeiro o acesso administrativo
...
- Títulos:
  ...
  - H2: Instalação PWA e push da web
  - H2: Incorporações hospedadas
  - H2: Largura de mensagem de chat
  - H2: Acesso à Tailnet (recomendado)
  - H2: HTTP inseguro
...
- Títulos:
  ...
  - H2: Painel de ferramentas de agentes da Control UI
  - H2: Uso remoto
