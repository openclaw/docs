...
summary: Redirecionar para /network#core-model
title: Modelo de rede
x-i18n:
    generated_at: "2026-05-06T05:55:24Z"
    model: gpt-5.5
    provider: openai
...
Este conteúdo foi mesclado em [Rede — Modelo principal](/pt-BR/network#core-model).
