...
title: Uso aceitável
x-i18n:
    generated_at: "2026-07-02T00:46:09Z"
    model: gpt-5.5
...
se apresenta e como publicadores usam as superfícies de descoberta, instalação e
...
O ClawHub aceita conteúdo útil, compreensível e publicado de boa
fé.
...
| Enriquecimento ou vigilância invasivos à privacidade        | Raspagem de contatos para spam, doxxing, perseguição, extração de leads combinada com contato não solicitado, monitoramento encoberto, correspondência biométrica sem consentimento ou uso de dados vazados ou dumps de violações.                                                                            |
...
| Material que infringe direitos autorais ou viola direitos   | Republicar Skill, plugin, docs, ativos de marca ou código proprietário de outra pessoa sem permissão; violar termos de licença; ou personificar o autor ou publicador original.                                                                                                                              |

## Comportamento de marketplace não permitido

O ClawHub também analisa como publicadores usam o marketplace. Não use o ClawHub para
manipular descoberta, métricas, sinais de confiança, sistemas de moderação ou a
atenção dos usuários.

Comportamentos de marketplace não permitidos incluem:
...
Publicação de alto volume não é automaticamente abuso. Grandes catálogos são aceitáveis
...
o volume vem acompanhado de listagens rasas, duplicadas, enganosas, não mantidas ou
...
- bloquear downloads ou instalações de releases inseguras
