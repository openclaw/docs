...
Estas regras são intencionalmente práticas. O que mais nos importa são fluxos de abuso de ponta a ponta, não apenas palavras-chave isoladas. Se uma skill é criada para burlar defesas, abusar de plataformas, aplicar golpes, invadir privacidade ou permitir comportamento não consensual, ela não pertence ao ClawHub.
...
- Conversão de JavaScript para TypeScript em UI5 que preserva comentários, usa tipos concretos de UI5 e mantém interfaces de controles geradas revisáveis.
...
- Fluxos de burlar segurança ou acesso não autorizado.
  - Exemplos: burlar autenticação, invasão de conta, burlar CAPTCHA, evasão de Cloudflare ou anti-bot, burlar limites de taxa, scraping furtivo projetado para derrotar proteções, tomada de chamada ao vivo ou de agente, roubo reutilizável de sessão, aprovação automática de fluxos de pareamento para usuários não aprovados.
...
- “Coletar leads por scraping, enriquecer contatos e lançar abordagem fria em escala.”
- “Comprar, publicar ou baixar dados vazados ou dumps de violações.”
- “Criar contas de email ou redes sociais em massa com identidades sintéticas ou resolução de CAPTCHA.”

## Observações para revisores

- O contexto importa. O mesmo tópico pode ser legítimo em um cenário defensivo ou baseado em consentimento, e inaceitável quando empacotado como fluxo de abuso.
...
- Podemos ocultar, remover ou excluir definitivamente skills que violem estas regras.
- Podemos revogar tokens, excluir temporariamente conteúdo associado e banir infratores reincidentes ou graves.
- Não garantimos aplicação com aviso prévio para abusos evidentes.
