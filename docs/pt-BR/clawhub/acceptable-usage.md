...
read_when:
    ...
    - Escrita de documentação de moderação ou runbooks de revisores
...
O ClawHub aceita conteúdo que seja útil, compreensível e publicado de boa-fé.
...
| Enriquecimento invasivo de privacidade ou vigilância                 | Coleta de contatos para spam, doxxing, perseguição, extração de leads combinada com contato não solicitado, monitoramento encoberto, correspondência biométrica não consensual ou uso de dados vazados ou dumps de violações.                                                                                                                  |
...
- publicação em massa de grandes quantidades de listagens de baixo esforço, duplicadas, de espaço reservado ou
