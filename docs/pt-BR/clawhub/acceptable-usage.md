...
title: Uso aceitável
x-i18n:
    generated_at: "2026-07-03T02:44:25Z"
    model: gpt-5.5
...
| Enriquecimento ou vigilância invasivos à privacidade        | Coleta de contatos para spam, doxxing, perseguição, extração de leads combinada com abordagem não solicitada, monitoramento oculto, correspondência biométrica sem consentimento ou uso de dados vazados ou conjuntos de dados de violações.                                                                        |
| Representação não consentida ou manipulação de identidade   | Troca de rosto, gêmeos digitais, influenciadores clonados, personas falsas ou outras ferramentas usadas para se passar por alguém ou induzir ao erro.                                                                                                                                                              |
...
| Material que infringe direitos autorais ou viola direitos   | Republicar Skills, plugin, documentação, ativos de marca ou código proprietário de outra pessoa sem permissão; violar termos de licença; ou se passar pelo autor ou publicador original.                                                                                                                           |
