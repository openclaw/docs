---
read_when:
    - Analisando uploads quanto a abuso ou violações de política
    - Escrever documentação de moderação ou roteiros operacionais para revisores
    - Decidindo se uma skill deve ser oculta ou um usuário banido
...
ClawHub acolhe conteúdo que seja útil, compreensível e publicado de boa-fé.
...
ClawHub não hospeda conteúdo cujo principal objetivo seja abuso, fraude, execução
insegura ou violação de direitos.

| Categoria                                                   | Não permitido                                                                                                                                                                                                                                                                                                |
| ----------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Acesso não autorizado ou contorno de segurança              | Contorno de autenticação, tomada de conta, abuso de limite de taxa, tomada de chamada ao vivo ou agente, roubo de sessão reutilizável ou aprovação automática de fluxos de pareamento para usuários não aprovados.                                                                                           |
| Abuso de plataforma e evasão de banimento                   | Contas furtivas após banimentos, aquecimento ou criação em massa de contas, engajamento falso, automação multi-conta, postagem em massa, bots de spam ou automação criada para evitar detecção.                                                                                                             |
| Fraude, golpes e fluxos financeiros enganosos               | Certificados ou faturas falsos, fluxos de pagamento enganosos, contato para golpes, prova social falsa, fluxos de identidade sintética para fraude ou ferramentas de gasto/cobrança sem aprovação humana clara.                                                                                              |
| Enriquecimento ou vigilância invasivos à privacidade        | Coleta de contatos para spam, doxxing, perseguição, extração de leads combinada com contato não solicitado, monitoramento oculto, correspondência biométrica sem consentimento ou uso de dados vazados ou dumps de violações.                                                                               |
...
| Conteúdo sexual explícito ou geração adulta com segurança desativada | Geração de imagem, vídeo ou conteúdo NSFW; wrappers de conteúdo adulto em torno de APIs de terceiros; ou listagens cujo principal objetivo é conteúdo sexual explícito.                                                                                                                             |
...
| Material que viola direitos autorais ou outros direitos     | Republicar skill, plugin, documentação, ativos de marca ou código proprietário de outra pessoa sem permissão; violar termos de licença; ou personificar o autor ou publicador original.                                                                                                                     |
...
Comportamento de marketplace proibido inclui:
...
- ocultar, reter, remover, excluir de forma reversível ou, quando houver suporte para o tipo de recurso,
  excluir de forma permanente listagens violadoras
