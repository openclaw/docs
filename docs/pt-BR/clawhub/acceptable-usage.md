...
title: Uso aceitável
x-i18n:
    generated_at: "2026-07-02T17:32:52Z"
    model: gpt-5.5
...
| Fluxos de trabalho de UI, dados e automação      | O escopo é claro, as credenciais exigidas são explícitas e ações arriscadas incluem caminhos de revisão, execução simulada, prévia ou confirmação. |
...
| Representação falsa ou manipulação de identidade sem consentimento | Troca de rosto, gêmeos digitais, influenciadores clonados, personas falsas ou outras ferramentas usadas para se passar por alguém ou enganar.                                                                                                                                                                  |
...
- publicação em massa de grandes números de listagens de baixo esforço, duplicadas, provisórias ou
...
[Solicitações de Direitos de Conteúdo](/clawhub/content-rights). Não use denúncias normais de marketplace
