...
title: Uso Aceitável
x-i18n:
    generated_at: "2026-07-02T13:59:45Z"
    model: gpt-5.5
...
ClawHub hospeda Skills, Plugins, pacotes e metadados do mercado para OpenClaw.
...
ClawHub aceita conteúdo útil, compreensível e publicado de boa
fé.

| Categoria                                        | Permitido quando                                                                                                                        |
| ------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------- |
| Produtividade de desenvolvimento                 | A listagem ajuda usuários a criar, testar, migrar, depurar, documentar ou operar software.                                              |
...
O contexto importa. O mesmo tópico pode ser aceitável em um cenário defensivo estreito ou
...
| Enriquecimento ou vigilância invasivos à privacidade        | Raspagem de contatos para spam, doxxing, perseguição, extração de leads combinada com contato não solicitado, monitoramento oculto, correspondência biométrica sem consentimento ou uso de dados vazados ou dumps de violações.                                                                               |
| Impersonação ou manipulação de identidade sem consentimento | Troca de rosto, gêmeos digitais, influenciadores clonados, personas falsas ou outras ferramentas usadas para impersonar ou enganar.                                                                                                                                                                           |
...
| Material que infringe direitos autorais ou viola direitos   | Republicar Skill, Plugin, documentação, ativos de marca ou código proprietário de outra pessoa sem permissão; violar termos de licença; ou impersonar o autor ou publicador original.                                                                                                                        |

## Comportamento proibido no mercado

ClawHub também revisa como publicadores usam o mercado. Não use ClawHub para
manipular descoberta, métricas, sinais de confiança, sistemas de moderação ou
atenção dos usuários.

Comportamentos proibidos no mercado incluem:
