---
read_when:
    - Análise de envios quanto a abuso ou violações de política
...
title: Uso aceitável
x-i18n:
    generated_at: "2026-07-04T03:38:25Z"
    model: gpt-5.5
...
O ClawHub hospeda Skills, plugins, pacotes e metadados de mercado para o OpenClaw.
...
| Fluxos de trabalho de UI, dados e automação               | O escopo é claro, as credenciais necessárias são explícitas, e ações arriscadas incluem caminhos de revisão, dry-run, prévia ou confirmação. |
...
| ----------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Acesso não autorizado ou bypass de segurança                      | Bypass de autenticação, tomada de conta, abuso de limites de taxa, tomada de chamada ao vivo ou de agente, roubo de sessão reutilizável ou aprovação automática de fluxos de pareamento para usuários não aprovados.                                                                                                                                                   |
...
## Comportamento de mercado não permitido

O ClawHub também analisa como os publicadores usam o mercado. Não use o ClawHub para
manipular descoberta, métricas, sinais de confiança, sistemas de moderação ou a
atenção dos usuários.

Comportamentos de mercado não permitidos incluem:

- publicar em massa grandes quantidades de listagens de baixo esforço, duplicativas, de placeholder ou
...
[Solicitações de Direitos de Conteúdo](/pt-BR/clawhub/content-rights). Não use relatórios normais do mercado
...
Não garantimos aplicação com aviso prévio para abuso evidente. Consulte
