...
title: Uso aceitável
x-i18n:
    generated_at: "2026-07-04T20:27:26Z"
    model: gpt-5.5
...
O ClawHub não hospeda conteúdo cujo principal propósito seja abuso, engano, execução
insegura ou infração de direitos.
...
| Enriquecimento ou vigilância invasivos à privacidade                 | Raspagem de contatos para spam, doxxing, perseguição, extração de leads combinada com contato não solicitado, monitoramento encoberto, correspondência biométrica não consensual ou uso de dados vazados ou dumps de violações.                                                                                                                  |
| Representação não consensual ou manipulação de identidade       | Face swap, gêmeos digitais, influenciadores clonados, personas falsas ou outras ferramentas usadas para representar outra pessoa ou induzir ao erro.                                                                                                                                                                                                 |
...
| Requisitos de execução ocultos, inseguros ou enganosos        | Comandos de instalação ofuscados, instaladores pipe-to-shell, como conteúdo baixado executado com `sh` ou `bash` sem possibilidade clara de revisão, requisitos de segredo ou chave privada não declarados, execução remota de `npx @latest` sem possibilidade clara de revisão ou metadados que ocultam o que a listagem realmente precisa para executar. |
| Material que infringe direitos autorais ou viola direitos           | Republicar a skill, o plugin, a documentação, os ativos de marca ou código proprietário de outra pessoa sem permissão; violar termos de licença; ou se passar pelo autor ou publicador original.                                                                                                                            |
...
- publicação em massa de grandes números de listagens de baixo esforço, duplicativas, de placeholder ou
  geradas por máquina que não parecem ter valor real para o usuário
...
revisão por equipe para identificar conteúdo inseguro ou comportamento de publicação abusivo. Um sinal
