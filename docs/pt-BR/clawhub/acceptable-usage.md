...
read_when:
    ...
    - Decidindo se um skill deve ser ocultado ou se um usuário deve ser banido
...
[Moderação e Segurança da Conta](/pt-BR/clawhub/moderation). Para direitos autorais ou outras reivindicações
de direitos, consulte [Solicitações de Direitos de Conteúdo](/pt-BR/clawhub/content-rights).
...
| Fluxos de trabalho de UI, dados e automação      | O escopo é claro, as credenciais exigidas são explícitas, e ações arriscadas incluem caminhos de revisão, dry-run, prévia ou confirmação. |
...
| ----------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Acesso não autorizado ou bypass de segurança                | Bypass de autenticação, tomada de conta, abuso de limites de taxa, tomada de chamada ao vivo ou de agente, roubo reutilizável de sessão ou aprovação automática de fluxos de pareamento para usuários não aprovados.                                                                                         |
| Abuso de plataforma e evasão de banimentos                  | Contas furtivas após banimentos, aquecimento ou cultivo de contas, engajamento falso, automação de múltiplas contas, postagem em massa, bots de spam ou automação criada para evitar detecção.                                                                                                             |
...
- publicação em massa de grandes quantidades de listagens de baixo esforço, duplicadas, placeholder ou
...
[Moderação e Segurança da Conta](/pt-BR/clawhub/moderation) para relatórios, retenções de moderação,
