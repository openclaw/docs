...
title: Uso aceitável
x-i18n:
    generated_at: "2026-07-05T04:51:25Z"
    model: gpt-5.5
...
| ----------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Acesso não autorizado ou contorno de segurança              | Bypass de autenticação, tomada de conta, abuso de limite de taxa, tomada de chamada ou agente ao vivo, roubo reutilizável de sessão ou aprovação automática de fluxos de pareamento para usuários não aprovados.                                                                                           |
...
| Fraudes, golpes e fluxos financeiros enganosos              | Certificados ou faturas falsos, fluxos de pagamento enganosos, abordagem para golpes, prova social falsa, fluxos de identidade sintética para fraude ou ferramentas de gasto/cobrança sem aprovação humana clara.                                                                                          |
| Enriquecimento invasivo de privacidade ou vigilância        | Coleta de contatos para spam, doxxing, stalking, extração de leads combinada com abordagem não solicitada, monitoramento oculto, correspondência biométrica sem consentimento ou uso de dados vazados ou dumps de violações.                                                                                |
