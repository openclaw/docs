---
read_when:
    - Análise de uploads em busca de abuso ou violações de política
...
title: Uso aceitável
x-i18n:
    generated_at: "2026-07-03T13:20:43Z"
    model: gpt-5.5
...
- inflar artificialmente instalações, downloads, estrelas ou outras métricas de engajamento
  por automação, loops de auto-instalação, contas falsas, atividade coordenada,
...
- ocultar, reter, remover, excluir temporariamente ou, quando houver suporte para o tipo de recurso,
  excluir permanentemente listagens violadoras
- bloquear downloads ou instalações de versões inseguras
- revogar tokens de API
- excluir temporariamente conteúdo associado
