---
read_when:
    - Revisar uploads em busca de abuso ou violações de política
    - Escrever documentação de moderação ou runbooks de revisores
...
title: Uso aceitável
x-i18n:
    generated_at: "2026-07-03T09:26:25Z"
    model: gpt-5.5
...
| Fluxos de trabalho de UI, dados e automação               | O escopo é claro, as credenciais exigidas são explícitas e ações arriscadas incluem caminhos de revisão, execução simulada, pré-visualização ou confirmação. |
...
| ----------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Acesso não autorizado ou bypass de segurança                      | Bypass de autenticação, tomada de conta, abuso de limites de taxa, tomada de chamada ao vivo ou agente, roubo de sessão reutilizável ou aprovação automática de fluxos de pareamento para usuários não aprovados.                                                                                                                                                   |
...
| Enriquecimento invasivo de privacidade ou vigilância                 | Coleta de contatos para spam, doxxing, perseguição, extração de leads combinada com abordagem não solicitada, monitoramento oculto, correspondência biométrica sem consentimento ou uso de dados vazados ou dumps de violação.                                                                                                                  |
| Falsificação de identidade ou manipulação de identidade sem consentimento       | Troca de rosto, gêmeos digitais, influenciadores clonados, personas falsas ou outras ferramentas usadas para se passar por alguém ou enganar.                                                                                                                                                                                                 |
...
| Requisitos de execução ocultos, inseguros ou enganosos        | Comandos de instalação ofuscados, instaladores pipe-to-shell, como conteúdo baixado executado com `sh` ou `bash` sem revisabilidade clara, requisitos não declarados de segredo ou chave privada, execução remota de `npx @latest` sem revisabilidade clara ou metadados que ocultam o que a listagem realmente precisa para ser executada. |
| Material que infringe direitos autorais ou viola direitos           | Republicar Skill, plugin, docs, ativos de marca ou código proprietário de outra pessoa sem permissão; violar termos de licença; ou se passar pelo autor ou publicador original.                                                                                                                            |
...
manipular descoberta, métricas, sinais de confiança, sistemas de moderação ou atenção
dos usuários.

Comportamentos proibidos no marketplace incluem:

- publicar em massa grandes quantidades de listagens de baixo esforço, duplicadas, placeholder ou
...
- inflar artificialmente instalações, downloads, estrelas ou outras métricas de engajamento
  por meio de automação, loops de auto-instalação, contas falsas, atividade coordenada,
...
o volume vem acompanhado de listagens rasas, duplicadas, enganosas, sem manutenção ou
promovidas artificialmente.

## Direitos de conteúdo

Se você acredita que conteúdo no ClawHub viola seus direitos autorais ou outros direitos, use
...
- ocultar, reter, remover, excluir de forma reversível ou, quando houver suporte para o tipo de recurso,
  excluir permanentemente listagens infratoras
...
Não garantimos fiscalização com aviso prévio para abuso óbvio. Consulte
