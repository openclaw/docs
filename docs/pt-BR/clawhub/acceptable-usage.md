...
| Segurança defensiva, moderação e análise de abuso | A ferramenta é enquadrada para análise autorizada, preserva evidências e mantém claros os limites de aprovação humana.                          |
...
| Personificação sem consentimento ou manipulação de identidade       | Troca de rosto, gêmeos digitais, influenciadores clonados, personas falsas ou outras ferramentas usadas para personificar ou induzir ao erro.                                                                                                                                                                                                 |
...
| Material que infringe direitos autorais ou viola direitos           | Republicar a skill, o plugin, a documentação, os ativos de marca ou o código proprietário de outra pessoa sem permissão; violar termos de licença; ou personificar o autor ou publicador original.                                                                                                                            |
...
- inflar artificialmente instalações, downloads, estrelas ou outras métricas de engajamento
  por meio de automação, ciclos de auto-instalação, contas falsas, atividade coordenada,
...
A publicação em alto volume não é automaticamente abuso. Catálogos grandes são aceitáveis
...
- ocultar, reter, remover, excluir de forma reversível ou, quando compatível com o tipo de recurso,
  excluir permanentemente listagens que violem regras
