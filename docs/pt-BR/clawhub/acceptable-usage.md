---
read_when:
    - Análise de uploads por abuso ou violações de política
    - Escrever documentação de moderação ou runbooks de revisão
...
title: Uso aceitável
x-i18n:
    generated_at: "2026-06-30T22:08:37Z"
    model: gpt-5.5
...
Essas regras se aplicam ao que uma listagem faz, ao que ela pede que os usuários executem, a como ela
...
| Fluxos de trabalho de UI, dados e automação               | O escopo é claro, as credenciais necessárias são explícitas e ações arriscadas incluem caminhos de revisão, execução simulada, pré-visualização ou confirmação. |
...
ClawHub não hospeda conteúdo cujo principal propósito seja abuso, fraude, execução
insegura ou violação de direitos.

| Categoria                                                    | Não permitido                                                                                                                                                                                                                                                                                                   |
| ----------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Acesso não autorizado ou bypass de segurança                      | Bypass de autenticação, tomada de conta, abuso de limite de taxa, tomada de chamada ao vivo ou agente, roubo reutilizável de sessão ou aprovação automática de fluxos de pareamento para usuários não aprovados.                                                                                                                                                   |
...
| Fraude, golpes e fluxos financeiros enganosos             | Certificados ou faturas falsos, fluxos de pagamento enganosos, divulgação de golpes, prova social falsa, fluxos de trabalho de identidade sintética para fraude ou ferramentas de gasto/cobrança sem aprovação humana clara.                                                                                                                    |
| Enriquecimento invasivo de privacidade ou vigilância                 | Coleta de contatos para spam, doxxing, perseguição, extração de leads combinada com contato não solicitado, monitoramento oculto, correspondência biométrica sem consentimento ou uso de dados vazados ou despejos de violações.                                                                                                                  |
...
| Conteúdo sexual explícito ou geração adulta com segurança desativada | Geração de imagem, vídeo ou conteúdo NSFW; wrappers de conteúdo adulto em torno de APIs de terceiros; ou listagens cujo propósito principal seja conteúdo sexual explícito.                                                                                                                                                       |
| Requisitos de execução ocultos, inseguros ou enganosos        | Comandos de instalação ofuscados, instaladores pipe-to-shell, como conteúdo baixado executado com `sh` ou `bash` sem possibilidade clara de revisão, requisitos não declarados de segredo ou chave privada, execução remota de `npx @latest` sem possibilidade clara de revisão ou metadados que ocultam do que a listagem realmente precisa para ser executada. |
| Material que infringe direitos autorais ou viola direitos           | Republicar Skills, plugin, documentação, ativos de marca ou código proprietário de outra pessoa sem permissão; violar termos de licença; ou personificar o autor ou publicador original.                                                                                                                            |

## Comportamento proibido no marketplace

ClawHub também revisa como os publicadores usam o marketplace. Não use ClawHub para
...
o volume vem acompanhado de listagens superficiais, duplicativas, enganosas, não mantidas ou
...
[Solicitações de direitos de conteúdo](/clawhub/content-rights). Não use relatórios normais do marketplace
para reivindicações de direitos autorais ou direitos, a menos que a listagem também seja insegura,
maliciosa ou enganosa.

## Revisão e aplicação

ClawHub pode usar verificações automatizadas, sinais estatísticos de abuso, relatórios de usuários e
...
- ocultar, reter, remover, excluir de forma reversível ou, quando compatível com o tipo de recurso,
  excluir definitivamente listagens em violação
