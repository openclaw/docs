...
| Enriquecimento ou vigilância invasivos à privacidade                 | Coleta de contatos para spam, doxxing, stalking, extração de leads combinada com abordagem não solicitada, monitoramento dissimulado, correspondência biométrica sem consentimento ou uso de dados vazados ou despejos de violações.                                                                                                                  |
| Personificação não consensual ou manipulação de identidade       | Troca de rosto, gêmeos digitais, influenciadores clonados, personas falsas ou outras ferramentas usadas para personificar ou induzir ao erro.                                                                                                                                                                                                 |
...
- publicação em massa de grandes quantidades de listagens de baixo esforço, duplicativas, provisórias ou
  geradas por máquina que não aparentam ter valor real para o usuário
...
- ocultar, reter, remover, excluir de forma reversível ou, quando compatível com o tipo de recurso,
  excluir de forma permanente listagens que violem as regras
