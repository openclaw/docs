...
title: Uso aceitável
x-i18n:
    generated_at: "2026-06-27T17:14:30Z"
    model: gpt-5.5
...
[Moderação e Segurança da Conta](/pt-BR/clawhub/moderation). Para direitos autorais ou outras
reivindicações de direitos, consulte [Solicitações de Direitos de Conteúdo](/pt-BR/clawhub/content-rights).
...
| ----------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Acesso não autorizado ou contorno de segurança                      | Contorno de autenticação, tomada de conta, abuso de limites de taxa, tomada de chamada ou agente ao vivo, roubo de sessão reutilizável ou aprovação automática de fluxos de pareamento para usuários não aprovados.                                                                                                                                                   |
...
| Enriquecimento invasivo de privacidade ou vigilância                 | Coleta de contatos para spam, doxxing, perseguição, extração de leads combinada com abordagem não solicitada, monitoramento oculto, correspondência biométrica sem consentimento ou uso de dados vazados ou dumps de violações.                                                                                                                  |
| Falsificação de identidade sem consentimento ou manipulação de identidade       | Troca de rosto, gêmeos digitais, influenciadores clonados, personas falsas ou outras ferramentas usadas para se passar por alguém ou induzir ao erro.                                                                                                                                                                                                 |
| Conteúdo sexual explícito ou geração adulta com segurança desativada | Geração de imagens, vídeos ou conteúdo NSFW; wrappers de conteúdo adulto em torno de APIs de terceiros; ou listagens cujo principal propósito seja conteúdo sexual explícito.                                                                                                                                                       |
...
| Material que infringe direitos autorais ou viola direitos           | Republicar o Skill, Plugin, documentação, ativos de marca ou código proprietário de outra pessoa sem permissão; violar termos de licença; ou se passar pelo autor ou publicador original.                                                                                                                            |
...
- publicação em massa de grandes números de listagens de baixo esforço, duplicadas, de placeholder ou
...
Não garantimos aplicação precedida de aviso para abusos óbvios. Consulte
