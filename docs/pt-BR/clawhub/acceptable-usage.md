---
read_when:
    - Análise de uploads para abuso ou violações de política
...
title: Uso aceitável
x-i18n:
    generated_at: "2026-07-03T00:53:56Z"
    model: gpt-5.5
...
| Fluxos de trabalho de UI, dados e automação               | O escopo é claro, as credenciais necessárias são explícitas, e ações arriscadas incluem caminhos de revisão, execução simulada, prévia ou confirmação. |
...
| ----------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Acesso não autorizado ou bypass de segurança                      | Bypass de autenticação, tomada de conta, abuso de limite de taxa, tomada de chamada ativa ou agente, roubo de sessão reutilizável ou aprovação automática de fluxos de pareamento para usuários não aprovados.                                                                                                                                                   |
...
| Fraude, golpes e fluxos financeiros enganosos             | Certificados ou faturas falsas, fluxos de pagamento enganosos, contato para golpes, prova social falsa, fluxos de identidade sintética para fraude ou ferramentas de gasto/cobrança sem aprovação humana clara.                                                                                                                    |
| Enriquecimento ou vigilância invasivos à privacidade                 | Raspagem de contatos para spam, doxxing, perseguição, extração de leads combinada com contato não solicitado, monitoramento oculto, correspondência biométrica não consensual ou uso de dados vazados ou despejos de violações.                                                                                                                  |
...
| Material que infringe direitos autorais ou viola direitos           | Republicar Skills, Plugins, docs, ativos de marca ou código proprietário de outra pessoa sem permissão; violar termos de licença; ou se passar pelo autor ou publicador original.                                                                                                                            |
