...
- publicação no registry, downloads, instalações ou integridade de artefatos
...
evidência de impacto real aos usuários ou quando os usuários precisam tomar uma ação.
...
pacotes, binários, bibliotecas da CLI do ClawHub ou outros artefatos de versão que os usuários
