...
title: Segurança
x-i18n:
    generated_at: "2026-07-05T02:01:49Z"
    model: gpt-5.5
...
evidência de impacto real para usuários ou quando os usuários precisam tomar medidas.
...
pacotes, binários, bibliotecas da CLI do ClawHub ou outros artefatos de lançamento que os usuários
