...
title: Segurança
x-i18n:
    generated_at: "2026-07-03T00:54:31Z"
    model: gpt-5.5
...
Não use avisos do ClawHub para vulnerabilidades no código-fonte próprio de uma skill de terceiros ou
Plugin. Relate-as diretamente ao publicador ou ao repositório de origem
...
evidência de impacto real aos usuários ou quando os usuários precisam tomar medidas.
