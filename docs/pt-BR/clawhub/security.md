...
read_when:
    ...
    - Distinguindo problemas da plataforma ClawHub de problemas de skill ou Plugin de terceiros
sidebarTitle: Security
summary: Como relatar problemas de segurança do ClawHub e quando as vulnerabilidades são divulgadas publicamente.
title: Segurança
x-i18n:
    generated_at: "2026-07-01T05:32:38Z"
    model: gpt-5.5
...
Como o ClawHub é uma aplicação de nuvem hospedada, vulnerabilidades do serviço ClawHub
...
ou qualquer problema que exija que usuários façam rotação de credenciais, atualizem software local ou
...
Para rótulos de auditoria no momento da instalação, níveis de risco, findings e interpretação, consulte
