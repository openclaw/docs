...
title: Segurança
x-i18n:
    generated_at: "2026-07-04T03:39:01Z"
    model: gpt-5.5
...
Problemas de segurança do ClawHub podem ser relatados por meio de GitHub Security Advisories para
`openclaw/clawhub`.
...
Não use avisos do ClawHub para vulnerabilidades no código-fonte próprio de uma skill ou
...
evidência de impacto real para usuários ou quando os usuários precisam agir.
...
Para relatórios do marketplace, bloqueios de moderação, listagens ocultas, banimentos e situação da conta,
