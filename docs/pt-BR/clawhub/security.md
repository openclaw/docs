...
Não use advisories do ClawHub para vulnerabilidades no código-fonte próprio de um skill ou
Plugin de terceiros. Relate-as diretamente ao publisher ou ao repositório de origem
