...
read_when:
    ...
    - Diferenciar problemas da plataforma ClawHub de problemas de Skills ou Plugins de terceiros
...
Não use avisos do ClawHub para vulnerabilidades no código-fonte próprio de uma habilidade ou
