---
read_when:
    - Como relatar um problema de segurança do ClawHub
    - Entendendo a divulgação de vulnerabilidades do ClawHub
    - Como diferenciar problemas da plataforma ClawHub de problemas de Skills ou Plugin de terceiros
...
Problemas de segurança do ClawHub podem ser reportados por meio dos GitHub Security Advisories para
`openclaw/clawhub`.
...
Não use os advisories do ClawHub para vulnerabilidades no código-fonte próprio de uma skill ou
...
evidências de impacto real nos usuários ou quando os usuários precisam tomar uma ação.

Exemplos de impacto real nos usuários incluem exploração confirmada, exposição de dados
...
pacotes da CLI do ClawHub, binários, bibliotecas ou outros artefatos de release que os usuários
...
Para relatórios do marketplace, bloqueios de moderação, listagens ocultas, banimentos e situação da conta, consulte [Moderação e segurança da conta](/clawhub/moderation).
