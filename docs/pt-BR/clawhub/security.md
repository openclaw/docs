...
Não use advisories do ClawHub para vulnerabilidades no código-fonte próprio de uma skill de terceiros ou
de um plugin. Relate-as diretamente ao publicador ou ao repositório de origem
