...
read_when:
    ...
    - Escolhendo entre os fluxos da CLI openclaw e clawhub
...
downloads, estrelas e resumos de varredura de segurança. As páginas públicas mostram
o estado atual do registro para que os usuários possam inspecionar uma Skill ou plugin antes de instalá-lo.

## Fluxos nativos do OpenClaw

Os comandos nativos do OpenClaw instalam no workspace ativo do OpenClaw e persistem
...
antiga o suficiente para passar pelo bloqueio de upload. Páginas públicas de detalhes resumem o
...
retidos por varredura ou bloqueados podem desaparecer do catálogo público e das superfícies de instalação enquanto
