...
title: ClawHub
x-i18n:
    generated_at: "2026-07-03T09:27:38Z"
    model: gpt-5.5
...
pelo ClawHub. Especificações de plugin simples e seguras para npm podem ser
resolvidas pelo npm durante transições de lançamento, e `npm:<package>` continua
...
O ClawHub é aberto por padrão: qualquer pessoa pode enviar, mas a publicação exige
uma conta do GitHub antiga o suficiente para passar pelo gate de envio. Páginas
públicas de detalhes resumem o estado da varredura mais recente antes da
...
catálogo público e das superfícies de instalação, permanecendo visíveis para seu
