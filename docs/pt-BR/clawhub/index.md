...
Especificações de plugins npm-safe sem prefixo podem ser resolvidas pelo npm durante transições de lançamento, e
...
e [Formato de Skill](/pt-BR/clawhub/skill-format) para metadados de Skills.
