...
title: ClawHub
x-i18n:
    generated_at: "2026-06-27T17:16:16Z"
    model: gpt-5.5
...
Use `--dry-run` para criar o plano de publicação exato sem enviar nada, e `--json`
...
antiga o suficiente para passar pelo controle de upload. Páginas públicas de detalhes resumem o
