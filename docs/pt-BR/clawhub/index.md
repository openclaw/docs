...
title: ClawHub
x-i18n:
    generated_at: "2026-06-28T20:41:41Z"
    model: gpt-5.5
...
Instale a CLI do ClawHub quando quiser fluxos de trabalho autenticados no
registro, como publicar ou excluir/restaurar:
...
Especificações de plugin sem pacote npm explícito podem ser resolvidas pelo npm durante transições de lançamento, e
