...
title: ClawHub
x-i18n:
    generated_at: "2026-07-01T12:50:50Z"
    model: gpt-5.5
...
downloads, estrelas e resumos de verificações de segurança. Páginas públicas mostram o estado atual do registro
...
Especificações de plugin simples compatíveis com npm podem ser resolvidas via npm durante transições de lançamento, e
...
e [Formato de Skills](/clawhub/skill-format) para metadados de Skills.
...
estado mais recente da verificação antes da instalação ou download.
