...
| Souls           | Bundles `SOUL.md` exibidos em onlycrabs.ai                 | Fluxos de publicação via Web e API          |
...
A CLI também tem comandos de instalação/atualização de Skills para fluxos de trabalho diretos do registro:
...
e [Formato de Skills](/pt-BR/clawhub/skill-format) para metadados de Skills.
...
O ClawHub executa verificações automatizadas em Skills publicadas e versões de plugins. Versões
retidas pela varredura ou bloqueadas podem desaparecer do catálogo público e das superfícies de instalação enquanto
