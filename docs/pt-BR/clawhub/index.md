...
| --------------- | ----------------------------------------------------------- | -------------------------------------------- |
| Skills          | Bundles de texto versionados com `SKILL.md` e arquivos de suporte | `openclaw skills install @openclaw/demo`     |
...
ClawHub executa verificações automatizadas em Skills e releases de plugin publicados. Releases retidos por varredura
