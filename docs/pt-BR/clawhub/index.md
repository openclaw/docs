...
title: ClawHub
x-i18n:
    generated_at: "2026-06-30T13:51:05Z"
    model: gpt-5.5
...
| -------------- | ------------------------------------------------------------ | -------------------------------------------- |
| Skills         | Pacotes de texto versionados com `SKILL.md` mais arquivos de suporte | `openclaw skills install @openclaw/demo`     |
...
ClawPack, o OpenClaw prefere o `.tgz` exato empacotado pelo npm enviado, verifica
