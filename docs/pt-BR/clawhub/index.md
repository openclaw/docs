...
title: ClawHub
x-i18n:
    generated_at: "2026-07-03T00:53:58Z"
    model: gpt-5.5
...
Especificações de plugin seguras para npm sem prefixo podem ser resolvidas pelo npm durante transições de lançamento, e
...
A CLI ClawHub é para trabalho autenticado no registro:
...
Use `--dry-run` para criar o plano de publicação exato sem enviar arquivos, e `--json`
...
permanecem visíveis para o proprietário em `/dashboard`.
