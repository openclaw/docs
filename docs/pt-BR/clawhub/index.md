...
title: ClawHub
x-i18n:
    generated_at: "2026-07-03T13:20:41Z"
    model: gpt-5.5
...
artefato ClawPack, o OpenClaw prefere o `.tgz` exato enviado via npm-pack, verifica
...
em caráter de melhor esforço para que o ClawHub possa calcular contagens agregadas de instalações. Desative isso com:
