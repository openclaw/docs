...
title: ClawHub
x-i18n:
    generated_at: "2026-07-01T07:55:31Z"
    model: gpt-5.5
...
- Use comandos `openclaw` nativos para buscar, instalar e atualizar Skills e para instalar plugins do ClawHub.
...
Especificações de plugins simples e seguras para npm podem ser resolvidas pelo npm durante transições de lançamento, e
...
antiga o bastante para passar pelo controle de upload. Páginas públicas de detalhes resumem o
