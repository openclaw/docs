...
title: ClawHub
x-i18n:
    generated_at: "2026-07-04T10:31:22Z"
    model: gpt-5.5
...
ClawHub. Especificações de plugin compatíveis com npm sem prefixo podem ser
...
de pacote publica um artefato ClawPack, o OpenClaw prefere o `.tgz` exato de
npm-pack enviado, verifica o cabeçalho de digest do ClawHub e os bytes baixados,
e registra metadados do artefato para atualizações posteriores.
...
Use `--dry-run` para montar o plano exato de publicação sem enviar nada, e `--json`
para saída amigável para CI.
...
completa de comandos e [Formato de Skills](/clawhub/skill-format) para metadados
de Skills.
...
públicas de detalhes resumem o estado mais recente da varredura antes da instalação
ou do download.
...
[Moderação e segurança de contas](/clawhub/moderation) e
