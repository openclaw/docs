...
title: ClawHub
x-i18n:
    generated_at: "2026-07-04T15:10:40Z"
    model: gpt-5.5
...
O ClawHub executa verificações automatizadas em Skills e releases de plugins publicados. Releases
...
Quando você executa `clawhub install` estando conectado, a CLI pode enviar um evento de instalação
