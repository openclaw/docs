...
read_when:
    ...
    - Entendendo a moderação, os banimentos ou o status da conta no ClawHub
...
x-i18n:
    generated_at: "2026-07-03T13:20:11Z"
    model: gpt-5.5
...
Algumas constatações graves ou problemas de política podem colocar um publicador ou listagem sob um
...
Bloqueios de moderação servem para proteger usuários enquanto o ClawHub resolve casos de
alto risco. Eles também podem ser suspensos quando um falso positivo é confirmado.
...
o limite de possível banimento do ClawHub podem disparar um aviso automático. Se a próxima
...
Sinais de revisão com menor confiança e temporalmente delimitados ficam fora da aplicação
automática.
