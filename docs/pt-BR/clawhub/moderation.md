...
read_when:
    ...
    - Recuperando de uma listagem retida, oculta ou bloqueada
...
x-i18n:
    generated_at: "2026-07-02T13:59:38Z"
    model: gpt-5.5
...
O ClawHub está aberto para publicações, mas as superfícies públicas de descoberta e instalação ainda
...
Disputas sobre organização, marca, escopo de pacote, identificador de proprietário ou propriedade de namespace devem
...
diagnósticos ajudam a explicar o que aconteceu e o que precisa mudar para que a
...
limite de potencial banimento, o ClawHub pode aplicar a ação de conta automaticamente.
