---
read_when:
    - Como relatar uma skill, plugin ou pacote
...
summary: Como funcionam os relatórios do ClawHub, as retenções de moderação, listagens ocultas, banimentos e a situação da conta.
title: Moderação e Segurança da Conta
x-i18n:
    generated_at: "2026-07-03T00:54:11Z"
    model: gpt-5.5
...
[Uso aceitável](/clawhub/acceptable-usage). Para questões de copyright ou outros
...
começar a falhar após uma ação de conta, entre na UI da web para revisar o estado da conta.
