...
x-i18n:
    generated_at: "2026-06-30T13:51:42Z"
    model: gpt-5.5
...
ou passar por outra revisão. Não inclua segredos, documentos privados, arquivos legais privados,
...
As retenções de moderação têm o objetivo de proteger usuários enquanto o ClawHub resolve casos de alto risco.
Elas também podem ser suspensas quando um falso positivo é confirmado.

## Listagens ocultas ou bloqueadas

Uma listagem pode estar retida, oculta, em quarentena, revogada ou indisponível de outra forma nas
...
limite de banimento potencial, o ClawHub poderá aplicar a ação de conta automaticamente.
Sinais de revisão com menor confiança e temporalmente delimitados ficam fora da
...
estado da conta. Se o login ou o acesso normal à CLI estiver bloqueado por um banimento ou conta desabilitada,
