...
x-i18n:
    generated_at: "2026-07-04T17:52:40Z"
    model: gpt-5.5
...
[Uso aceitável](/clawhub/acceptable-usage). Para questões de copyright ou outros direitos de
conteúdo, use [Solicitações de direitos de conteúdo](/clawhub/content-rights).
...
vinculado na listagem. ClawHub não mantém nem corrige código de Skills ou plugins de
terceiros.
...
Boas denúncias são específicas e acionáveis. Abuso do recurso de denúncia também pode levar a
ação na conta.
...
limite de potencial banimento, ClawHub pode aplicar a ação de conta automaticamente.
...
use o [formulário de contestação do ClawHub](https://appeals.openclaw.ai/) para revisão de recuperação.
...
e faça upload da versão corrigida.
