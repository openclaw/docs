---
read_when:
    - Denunciar uma skill, plugin ou pacote
...
x-i18n:
    generated_at: "2026-07-04T20:27:45Z"
    model: gpt-5.5
...
O ClawHub está aberto para publicação, mas as superfícies públicas de descoberta e instalação ainda
...
Bons relatórios são específicos e acionáveis. O abuso de denúncias pode levar a
ações na conta.
