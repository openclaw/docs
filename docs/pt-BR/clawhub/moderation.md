---
read_when:
    - Como reportar uma Skill, um Plugin ou um pacote
...
x-i18n:
    generated_at: "2026-07-01T18:09:00Z"
    model: gpt-5.5
...
Boas denúncias são específicas e acionáveis. O abuso das denúncias pode, por si só, levar a
ação na conta.
...
Retenções de moderação têm o objetivo de proteger usuários enquanto o ClawHub resolve casos de
alto risco. Elas também podem ser removidas quando um falso positivo é confirmado.
...
Contas que violam a política do ClawHub podem perder o acesso de publicação. Abuso grave pode
