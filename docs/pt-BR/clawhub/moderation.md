...
x-i18n:
    generated_at: "2026-07-01T12:51:24Z"
    model: gpt-5.5
...
Plugin de terceiros. Denuncie-as diretamente ao publicador ou ao repositório de código-fonte
...
Algumas descobertas graves ou problemas de política podem colocar um publicador ou uma listagem sob uma
...
Retenções de moderação servem para proteger usuários enquanto ClawHub resolve casos de alto risco.
...
limite de possível banimento, ClawHub pode aplicar a ação de conta automaticamente.
