...
read_when:
    - Publicando almas
    - Depuração de falhas na publicação da alma
...
- `description` é usado como o resumo da alma na IU/busca.
...
- Devem estar em letras minúsculas e ser seguros para URLs: `^[a-z0-9][a-z0-9-]*$`.
