...
summary: Como as listagens, versões, instalações, publicações, varreduras e atualizações do ClawHub funcionam.
x-i18n:
    generated_at: "2026-07-04T20:27:35Z"
    model: gpt-5.5
...
Use execuções de teste para pré-visualizar a carga útil resolvida antes do envio. As páginas públicas então
...
ClawHub é aberto para publicação, mas os lançamentos ainda estão sujeitos a barreiras de envio,
verificações automatizadas, denúncias de usuários e ações de moderadores.

As páginas públicas mostram resumos de varredura quando disponíveis. Conteúdo que esteja retido, oculto
