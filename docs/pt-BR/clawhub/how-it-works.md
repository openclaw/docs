...
versão mínima do gateway, destinos de host, requisitos de ambiente e digests de artefatos.
...
O OpenClaw registra metadados de origem de instalação para que as atualizações possam resolver o mesmo
...
ClawHub é aberto à publicação, mas os lançamentos ainda estão sujeitos a barreiras de upload,
