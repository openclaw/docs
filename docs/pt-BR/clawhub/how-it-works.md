...
versão mínima do gateway, destinos de host, requisitos de ambiente e resumos de
artefatos.
...
Use execuções de teste para visualizar a carga útil resolvida antes do upload. As páginas públicas então
...
atualização de skill para usuários que querem pastas de skills gerenciadas pelo registro fora de um
workspace completo do OpenClaw.

## Estado de segurança

O ClawHub é aberto à publicação, mas lançamentos ainda estão sujeitos a gates de upload,
...
Veja [Segurança](/pt-BR/clawhub/security), [Auditorias de segurança](/pt-BR/clawhub/security-audits),
