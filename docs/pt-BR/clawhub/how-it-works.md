...
Use uma origem explícita de instalação do ClawHub quando quiser que o registro seja a
fonte da verdade:
...
atualização direta de Skills para usuários que querem pastas de Skills gerenciadas pelo registro fora de um
