...
x-i18n:
    generated_at: "2026-07-01T15:21:01Z"
    model: gpt-5.5
...
Use execuções simuladas para pré-visualizar a carga resolvida antes do envio. As páginas públicas então
exibem os metadados publicados, arquivos, atribuição de origem e status da verificação.
...
ou bloqueado pode desaparecer da busca pública e dos fluxos de instalação, embora permaneça
