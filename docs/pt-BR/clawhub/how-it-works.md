...
x-i18n:
    generated_at: "2026-07-04T15:10:26Z"
    model: gpt-5.5
...
Use simulações para pré-visualizar o payload resolvido antes do envio. As páginas públicas então
...
ClawHub é aberto à publicação, mas os lançamentos ainda estão sujeitos a gates de upload,
