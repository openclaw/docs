...
x-i18n:
    generated_at: "2026-07-03T09:25:52Z"
    model: gpt-5.5
...
Quando OpenClaw instala um Plugin a partir do ClawHub, ele verifica os metadados de
...
Use execuções de teste para visualizar a carga útil resolvida antes do upload. Páginas públicas então
exibem os metadados publicados, arquivos, atribuição de origem e status de varredura.

## Instalações e atualizações

Comandos de instalação do OpenClaw usam ClawHub como origem de pacote:
