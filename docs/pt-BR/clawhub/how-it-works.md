...
summary: Como funcionam as listagens, as versões, as instalações, a publicação, as verificações e as atualizações do ClawHub.
x-i18n:
...
- informações de changelog e tag, como `latest`
...
pacote do registro posteriormente. A CLI do ClawHub também oferece suporte a fluxos de trabalho diretos de
instalação e atualização de skills para usuários que desejam pastas de skills gerenciadas pelo registro fora de um
workspace completo do OpenClaw.

## Estado de segurança

O ClawHub está aberto à publicação, mas os lançamentos ainda estão sujeitos a barreiras de upload,
verificações automatizadas, relatórios de usuários e ações de moderadores.
