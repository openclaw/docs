...
x-i18n:
    generated_at: "2026-06-30T13:51:14Z"
    model: gpt-5.5
...
ajudam verificações automatizadas a detectar divergências entre o comportamento declarado e o observado.
...
Use execuções de teste para pré-visualizar a carga resolvida antes do upload. As páginas públicas então
...
O OpenClaw registra os metadados da origem de instalação para que atualizações possam resolver o mesmo
...
O ClawHub é aberto para publicação, mas os lançamentos ainda estão sujeitos a controles de upload,
...
downloads. Catálogos de terceiros podem usar essas APIs quando fizerem link para a
