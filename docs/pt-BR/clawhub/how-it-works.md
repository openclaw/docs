...
summary: Como listagens, versões, instalações, publicação, varreduras e atualizações do ClawHub funcionam.
x-i18n:
    generated_at: "2026-07-05T05:24:51Z"
    model: gpt-5.5
...
Veja [Formato de skill](/clawhub/skill-format).
...
Use execuções de teste para pré-visualizar o payload resolvido antes do upload. As páginas públicas então
exibem os metadados publicados, arquivos, atribuição da fonte e status de varredura.
...
O ClawHub é aberto para publicação, mas os lançamentos ainda estão sujeitos a portões de upload,
...
Veja [Segurança](/pt-BR/clawhub/security), [Auditorias de segurança](/clawhub/security-audits),
