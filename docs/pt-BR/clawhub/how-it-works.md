...
exibem os metadados publicados, arquivos, atribuição da origem e status da varredura.
...
O ClawHub é aberto à publicação, mas os lançamentos ainda estão sujeitos a portões de upload,
