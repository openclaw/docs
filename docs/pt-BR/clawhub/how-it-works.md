...
x-i18n:
    generated_at: "2026-07-02T22:24:24Z"
    model: gpt-5.5
...
A página da listagem é o local canônico para usuários inspecionarem o que uma skill ou
...
Use execuções de teste para visualizar a carga resolvida antes do envio. As páginas públicas então
