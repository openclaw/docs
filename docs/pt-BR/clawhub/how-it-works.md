...
ClawHub lê o frontmatter do `SKILL.md` para entender o nome da skill,
...
anunciados antes de instalar. Registros de pacotes podem incluir compatibilidade de API,
...
ClawHub é aberto à publicação, mas as versões ainda estão sujeitas a gates de upload,
...
downloads. Catálogos de terceiros podem usar essas APIs quando apontarem de volta para a
