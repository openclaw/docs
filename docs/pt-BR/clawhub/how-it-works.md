...
summary: Como funcionam listagens, versões, instalações, publicações, verificações e atualizações do ClawHub.
x-i18n:
    generated_at: "2026-07-01T07:55:02Z"
    model: gpt-5.5
...
lugar para descobrir pacotes, aos publicadores um lugar para lançar versões e ao
OpenClaw metadados suficientes para instalar e atualizar esses pacotes com segurança.
...
versão mínima do Gateway, destinos de host, requisitos de ambiente e hashes de
artefatos.
...
para fluxos autenticados do registro:
