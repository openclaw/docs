...
x-i18n:
    generated_at: "2026-06-30T22:08:32Z"
    model: gpt-5.5
...
- Vincule de volta à URL canônica da Skill do ClawHub ao exibir listagens para que os usuários possam inspecionar o registro de origem no registro.
