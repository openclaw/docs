...
x-i18n:
    generated_at: "2026-07-04T17:52:11Z"
    model: gpt-5.5
...
- Ao exibir listagens, crie um link de volta para a URL canônica de Skill do ClawHub para que os usuários possam inspecionar o registro de origem.
...
- `X-RateLimit-Reset`: segundos do Unix epoch (hora absoluta de redefinição)
...
- `POST /api/v1/users/reserve` reserva slugs raiz e placeholders privados de pacotes sem lançamento para um identificador de proprietário.
