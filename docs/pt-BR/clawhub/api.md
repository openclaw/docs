...
x-i18n:
    generated_at: "2026-07-04T03:38:36Z"
    model: gpt-5.5
...
- Inclua link de volta para a URL canônica da Skill no ClawHub ao exibir listagens, para que os usuários possam inspecionar o registro de origem no registro.
...
Aplicação consciente de autenticação:
...
- Erros v1 são texto simples (`text/plain; charset=utf-8`), incluindo respostas `400`,
...
- `GET /api/v1/download?slug=&version=&tag=`
  ...
  - Skills atuais apoiadas pelo GitHub com varredura `clean` ou `suspicious` retornam um
...
- `GET /api/v1/skills/export?startDate=&endDate=&limit=&cursor=`
  ...
  - Skills atuais apoiadas pelo GitHub com varredura `clean` ou `suspicious` são exportadas
