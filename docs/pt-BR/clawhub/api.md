...
- Armazene respostas em cache e respeite `429`, `Retry-After` e cabeçalhos de limite de taxa em vez de fazer consultas agressivamente.
- Crie links para a URL canônica de Skills do ClawHub ao exibir listagens para que os usuários possam inspecionar o registro de origem no registro.
...
- Solicitações autenticadas (token Bearer válido): por grupo de usuário.
