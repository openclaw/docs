...
x-i18n:
    generated_at: "2026-07-04T20:27:37Z"
    model: gpt-5.5
...
- Armazene respostas em cache e respeite `429`, `Retry-After` e os cabeçalhos de limite de taxa em vez de fazer polling agressivo.
- Vincule de volta à URL canônica da Skill no ClawHub ao exibir listagens, para que os usuários possam inspecionar o registro de origem no registro.
...
- `POST /api/v1/users/reserve` reserva slugs raiz e espaços reservados privados de pacote sem release para um identificador de proprietário.
