...
- Aponte para a URL canônica da Skill no ClawHub ao exibir listagens, para que os usuários possam inspecionar o registro de origem no registry.
...
- `POST /api/v1/users/reserve` reserva slugs raiz e placeholders de pacote privados sem release para um identificador de proprietário.
