...
- Inclua um link de volta para a URL canônica de skill do ClawHub ao exibir listagens, para que usuários possam inspecionar o registro de origem no registro.
