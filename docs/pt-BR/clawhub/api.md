...
x-i18n:
    generated_at: "2026-07-01T15:21:06Z"
    model: gpt-5.5
...
- `X-RateLimit-Reset`: segundos de época Unix (horário absoluto de reset)
- `RateLimit-Reset`: segundos de atraso até o reset
...
- Erros v1 são texto puro (`text/plain; charset=utf-8`), incluindo `400`,
...
- `POST /api/v1/users/reserve` reserva slugs raiz e placeholders de pacote privado sem release para um identificador de proprietário.
