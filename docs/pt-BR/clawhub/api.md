...
read_when:
    ...
    - Adicionando endpoints ou schemas
...
- Aponte de volta para a URL canônica da Skill no ClawHub ao exibir listagens, para que os usuários possam inspecionar o registro de origem no registry.
...
- `GET /api/v1/skills?limit=&cursor=&sort=`
  ...
  - `cursor` se aplica a ordenações diferentes de `trending`
