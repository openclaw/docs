...
- Ao exibir listagens, vincule de volta para a URL canônica da Skill no ClawHub para que os usuários possam inspecionar o registro de origem no registry.
...
Legados `/api/*` e `/api/cli/*` ainda disponíveis. Veja `DEPRECATIONS.md`.
