...
- Inclua link para a URL canônica da Skill no ClawHub ao exibir listagens, para que os usuários possam inspecionar o registro de origem no registry.
...
- `GET /api/v1/download?slug=&version=&tag=`
  ...
  - Skills atuais baseadas no GitHub com varredura `clean` ou `suspicious` retornam um
    descritor de handoff JSON `public-github` em vez de bytes do ClawHub.
