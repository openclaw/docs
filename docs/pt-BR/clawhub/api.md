...
x-i18n:
    generated_at: "2026-07-02T00:46:17Z"
    model: gpt-5.5
...
- Armazene respostas em cache e respeite `429`, `Retry-After` e cabeçalhos de limite de taxa em vez de fazer sondagens agressivas.
- Inclua um link para a URL canônica da Skill no ClawHub ao exibir listagens, para que os usuários possam inspecionar o registro de origem no registro.
...
- Leitura pública: nenhum token obrigatório.
