...
- Inclua link para a URL canônica de Skills do ClawHub ao exibir listagens, para que os usuários possam inspecionar o registro de origem no registry.
...
- Erros v1 são texto simples (`text/plain; charset=utf-8`), incluindo `400`,
...
- `GET /api/v1/download?slug=&version=&tag=`
  ...
  - Skills atuais com suporte do GitHub e scan `clean` ou `suspicious` retornam um
...
- `GET /api/v1/skills/export?startDate=&endDate=&limit=&cursor=`
  ...
  - Skills atuais com suporte do GitHub e scan `clean` ou `suspicious` são exportadas
...
- `POST /api/v1/users/reserve` reserva slugs raiz e placeholders privados de pacote sem lançamento para um identificador de proprietário.
