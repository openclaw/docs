...
Você pode criar um catálogo, diretório ou superfície de busca de terceiros sobre as APIs públicas de leitura do ClawHub. Metadados públicos de skills e arquivos de skills são publicados de acordo com as regras de licença de skills do ClawHub, enquanto a API em si tem limite de taxa e deve ser consumida com responsabilidade.
