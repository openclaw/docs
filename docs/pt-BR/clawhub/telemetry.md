...
Em cada `clawhub install` informado, a CLI envia um evento de instalação em modo melhor esforço.
...
- `installsAllTime`: usuários únicos que informaram pelo menos uma instalação pela CLI da skill.
