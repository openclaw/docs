...
x-i18n:
    generated_at: "2026-07-02T17:34:25Z"
    model: gpt-5.5
...
Em cada `clawhub install` informado, a CLI envia um evento de instalação de melhor esforço.
...
- `installsAllTime`: usuários únicos que informaram pelo menos uma instalação pela CLI para a skill.
- `installsCurrent`: usuários únicos que informaram uma instalação e não excluíram sua
  telemetria.
