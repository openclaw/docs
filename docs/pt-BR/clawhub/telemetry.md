...
summary: Instale a telemetria coletada pela CLI do ClawHub e saiba como cancelar a participação.
x-i18n:
    generated_at: "2026-07-04T17:53:27Z"
    model: gpt-5.5
...
Em cada `clawhub install` reportado, a CLI envia um evento de instalação em regime de melhor esforço.
...
- `installsAllTime`: usuários únicos que reportaram pelo menos uma instalação da CLI para a skill.
