...
Em cada `clawhub install` relatado, a CLI envia um evento de instalação por melhor esforço.
...
- `installsAllTime`: usuários únicos que relataram pelo menos uma instalação pela CLI para a skill.
