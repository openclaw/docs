...
Em cada `clawhub install` relatado, a CLI envia um evento de instalação em modo de melhor esforço.
...
- `installsAllTime`: usuários únicos que relataram pelo menos uma instalação da habilidade pela CLI.
