...
summary: Instale a telemetria coletada pela CLI do ClawHub e como desativá-la.
x-i18n:
    generated_at: "2026-07-04T20:27:51Z"
    model: gpt-5.5
...
- `installsAllTime`: usuários únicos que reportaram pelo menos uma instalação via CLI para a habilidade.
