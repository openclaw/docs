...
summary: Como solicitar revisão do ClawHub para disputas de propriedade de org, marca, identificador do proprietário, escopo de pacote, slug de skill ou namespace.
title: Declarações de organização e namespace
x-i18n:
    generated_at: "2026-07-02T22:24:21Z"
    model: gpt-5.5
...
escopos de pacotes como namespaces públicos. Se um namespace parece pertencer a um
...
Use este caminho para revisão de propriedade pública e não sensível. Não use relatórios
