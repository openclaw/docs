...
read_when:
    ...
    - Decidindo se usar uma denúncia, contestação ou reivindicação de namespace
sidebarTitle: Org and Namespace Claims
summary: Como solicitar revisão do ClawHub para disputas de propriedade de org, marca, owner-handle, package-scope, skill-slug ou namespace.
