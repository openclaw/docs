...
x-i18n:
    generated_at: "2026-07-03T09:27:09Z"
    model: gpt-5.5
...
O ClawHub usa identificadores de proprietários, identificadores de organizações, slugs de habilidades, nomes de pacotes de plugin e
...
- um slug de habilidade ou nome de pacote de plugin que pareça se passar por um projeto
- uma disputa de marca, marca registrada, renomeação de projeto ou histórico de pacote
- um proprietário excluído, inativo ou inacessível que bloqueia o legítimo proprietário do namespace
...
- links para o proprietário, habilidade, plugin, pacote ou issue do ClawHub em disputa
