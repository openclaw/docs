...
summary: Como solicitar uma revisão do ClawHub para disputas de propriedade de organização, marca, identificador de proprietário, escopo de pacote, slug de habilidade ou namespace.
title: Declarações de Organização e Namespace
x-i18n:
    generated_at: "2026-07-04T15:10:23Z"
    model: gpt-5.5
...
reivindicado, reservado, enganoso ou em disputa no ClawHub, peça que a equipe o analise
com o
...
Use este caminho para análise pública e não sensível de propriedade. Não use relatórios no produto
nem o formulário de recurso da conta para reivindicações de namespace.
...
Primeiro confirme se você está publicando com o proprietário que corresponde ao namespace.
...
transferir propriedade, renomear um recurso, ocultar ou colocar uma listagem existente em quarentena,
