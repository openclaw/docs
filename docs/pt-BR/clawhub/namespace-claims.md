...
read_when:
    ...
    - Resolvendo um espaço de nomes que já foi reivindicado ou reservado
...
x-i18n:
    generated_at: "2026-07-01T15:21:12Z"
    model: gpt-5.5
...
reivindicado, reservado, enganoso ou disputado no ClawHub, peça à equipe para analisá-lo
com o
[formulário de solicitação de reivindicação de organização / namespace](https://github.com/openclaw/clawhub/issues/new?template=org-namespace-claim.yml).
...
- evidência de marca registrada, marca ou propriedade de projeto que seja segura para discutir
  publicamente
- histórico do repositório-fonte, histórico do pacote ou avisos públicos de renomeação
- links para o proprietário, Skill, Plugin, pacote ou issue disputado no ClawHub
