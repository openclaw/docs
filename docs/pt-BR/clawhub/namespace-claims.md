...
x-i18n:
    generated_at: "2026-07-04T06:25:15Z"
    model: gpt-5.5
...
O ClawHub usa handles de proprietários, handles de organizações, slugs de Skills, nomes de pacotes de Plugin e
...
- um handle de organização que corresponde à sua organização, projeto, empresa ou comunidade no GitHub
...
também siga a orientação de moderação ou segurança relevante. O formulário de reivindicação de namespace
