...
x-i18n:
    generated_at: "2026-07-05T04:51:35Z"
    model: gpt-5.5
...
quando você não conseguir gerenciar o proprietário atual ou quando a equipe precisar resolver uma
disputa.
...
- evidências de marca registrada, marca ou propriedade do projeto que sejam seguras para discutir
  publicamente
...
A equipe considera evidências públicas, uso existente, risco de segurança e impacto ao usuário.
