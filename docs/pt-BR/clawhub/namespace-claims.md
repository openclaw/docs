...
summary: Como solicitar uma revisão do ClawHub para disputas de titularidade de organização, marca, `owner-handle`, `package-scope`, `skill-slug` ou namespace.
title: Reivindicações de organização e namespace
x-i18n:
    generated_at: "2026-06-28T05:30:16Z"
    model: gpt-5.5
...
ClawHub usa identificadores de proprietário, identificadores de organização, slugs de Skills, nomes de pacotes de Plugin e
...
reivindicado, reservado, for enganoso ou estiver em disputa no ClawHub, peça para a equipe revisá-lo
com o
...
é para revisão de propriedade, não para divulgação emergencial de vulnerabilidade.
...
- organização, repositório, versão ou histórico de mantenedores no GitHub
