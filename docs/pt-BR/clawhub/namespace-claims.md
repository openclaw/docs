...
x-i18n:
    generated_at: "2026-07-03T00:53:50Z"
    model: gpt-5.5
...
quando não conseguir gerenciar o proprietário atual ou quando a equipe precisar resolver uma
disputa.
...
A equipe pondera evidências públicas, uso existente, risco de segurança e impacto para o usuário.
