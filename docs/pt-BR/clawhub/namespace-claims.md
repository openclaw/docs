...
read_when:
    ...
    - Decidindo se deve usar uma denúncia, contestação ou reivindicação de namespace
...
x-i18n:
    generated_at: "2026-07-04T20:27:22Z"
    model: gpt-5.5
...
Use este caminho para revisões públicas e não confidenciais de propriedade. Não use relatórios
...
A equipe avalia evidências públicas, uso existente, risco de segurança e impacto aos usuários.
