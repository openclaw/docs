...
Se o login retornar você a um estado desconectado, sua conta pode não estar em situação
regular.
...
Se o seu navegador não conseguir acessar o retorno de chamada local por causa de regras de firewall, VPN ou
...
Use este fluxo para servidores, tarefas de CI ou ambientes somente terminal.

Para terminais remotos nos quais você pode abrir um navegador em outro lugar, execute:
