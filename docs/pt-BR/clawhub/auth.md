...
O ClawHub usa GitHub para login na web. A CLI usa tokens de API do ClawHub criados
...
Se seu navegador não conseguir alcançar o retorno de chamada local por causa de regras de firewall, VPN ou
