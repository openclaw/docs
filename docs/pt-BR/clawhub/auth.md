...
read_when:
    ...
    - Depurando 401s
summary: Login do ClawHub, tokens de API, login da CLI, armazenamento de tokens e revogação.
x-i18n:
    generated_at: "2026-07-04T20:27:19Z"
    model: gpt-5.5
...
ClawHub usa GitHub para login na web. A CLI usa tokens da API do ClawHub criados
