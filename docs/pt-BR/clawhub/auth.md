...
read_when:
    ...
    - Depuração de 401s
summary: Autenticação no ClawHub, tokens de API, autenticação pela CLI, armazenamento de tokens e revogação.
x-i18n:
    generated_at: "2026-06-30T13:50:59Z"
    model: gpt-5.5
...
Se o login retornar você para um estado desconectado, talvez sua conta não esteja em boas
...
Use este fluxo para servidores, jobs de CI ou ambientes somente terminal.
