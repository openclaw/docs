...
read_when:
    ...
    - Depuração de 401s
summary: Login do ClawHub, tokens de API, login na CLI, armazenamento de tokens e revogação.
x-i18n:
    generated_at: "2026-07-02T08:01:04Z"
    model: gpt-5.5
...
Se o login retornar você para um estado desconectado, talvez sua conta não esteja em boa
