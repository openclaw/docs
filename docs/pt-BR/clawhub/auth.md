...
x-i18n:
    generated_at: "2026-05-11T20:23:08Z"
    model: gpt-5.5
    provider: openai
...
Se o login devolver você a um estado desconectado, sua conta pode não estar em boas
condições.
...
Se seu navegador não conseguir alcançar o callback local por causa de regras de
