...
x-i18n:
    generated_at: "2026-07-04T06:24:53Z"
    model: gpt-5.5
...
proxy, use o fluxo de token sem interface.

## Login sem interface

Crie um token na UI web do ClawHub e depois passe-o para a CLI:

```bash
clawhub login --token clh_...
```

Use este fluxo para servidores, trabalhos de CI ou ambientes apenas com terminal.
