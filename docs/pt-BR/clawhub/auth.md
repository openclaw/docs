...
x-i18n:
    generated_at: "2026-07-03T02:44:15Z"
    model: gpt-5.5
...
Se o login levar você de volta para um estado desconectado, sua conta pode não estar em boa
...
O fluxo padrão de login da CLI abre o navegador:
