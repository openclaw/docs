...
[formulário de recurso do ClawHub](https://appeals.openclaw.ai/) se você acreditar que isso é um
erro.
...
Se o seu navegador não conseguir alcançar o callback local por causa de firewall, VPN ou
regras de proxy, use o fluxo de token headless.
