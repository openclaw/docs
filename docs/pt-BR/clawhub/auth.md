...
x-i18n:
    generated_at: "2026-07-04T15:10:17Z"
    model: gpt-5.5
...
Se o login levar você de volta para um estado desconectado, sua conta pode não estar em situação regular.
Se sua conta foi banida ou desativada, use o
[formulário de apelação do ClawHub](https://appeals.openclaw.ai/) se você acredita que isso foi um
engano.
...
Use este fluxo para servidores, jobs de CI ou ambientes apenas com terminal.
