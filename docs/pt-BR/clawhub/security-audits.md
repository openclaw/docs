...
x-i18n:
    generated_at: "2026-06-28T05:31:13Z"
    model: gpt-5.5
...
consciente de artefatos própria do ClawHub.
...
seção independente de auditoria pública nem um veredito de bloqueio de instalação.
...
caso de uso declarado do lançamento.
