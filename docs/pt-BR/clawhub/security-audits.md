...
x-i18n:
    generated_at: "2026-07-04T03:38:43Z"
    model: gpt-5.5
...
e o conteúdo real estão alinhados com o que os usuários esperariam razoavelmente?

Comportamento poderoso não é automaticamente ruim. Muitas ferramentas úteis precisam de credenciais,
comandos locais, APIs de provedor ou instalações de pacote. A auditoria verifica se esse
poder é esperado, divulgado e proporcional.

Páginas de artefatos apontam para a auditoria completa em:
...
sinais de reputação que complementam a revisão do ClawHub ciente de agentes. Quando
...
do próprio ClawHub com conhecimento de artefatos.
