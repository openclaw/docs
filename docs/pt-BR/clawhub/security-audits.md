...
x-i18n:
    generated_at: "2026-07-03T00:54:18Z"
    model: gpt-5.5
...
Auditorias são sinais fortes de segurança, mas não são garantia de que uma versão esteja
...
A pergunta principal é coerência: o nome, o resumo, os metadados, a autoridade solicitada
...
Páginas de artefatos incluem link para a auditoria completa em:
...
O VirusTotal é especialmente útil para artefatos maliciosos conhecidos, detecções por motores e
sinais de reputação que complementam a revisão do ClawHub ciente de agentes. Quando contagens de
motores de fornecedores estão disponíveis, a auditoria as resume em linguagem simples, como:
...
A análise de risco é impulsionada internamente pelo ClawScan, o próprio sistema de auditoria de segurança
...
seção pública autônoma de auditoria nem um veredito que bloqueia a instalação.
