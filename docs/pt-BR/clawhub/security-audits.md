...
do próprio ClawHub, ciente dos artefatos.

## Análise de risco

A análise de risco é alimentada internamente pelo ClawScan, o próprio sistema de auditoria de segurança
do ClawHub. Ela revisa cada versão como um artefato voltado para agentes: instruções,
...
seção pública independente de auditoria nem um veredito que bloqueia instalação.
