---
read_when:
    - Compreender os resultados da auditoria de segurança do ClawHub
...
x-i18n:
    generated_at: "2026-07-02T14:00:34Z"
    model: gpt-5.5
...
Um `Pass` é tranquilizador, mas não substitui seu próprio julgamento. Isso é mais importante
...
gravidade contribuem com mais força para o nível de risco e o status da auditoria.
...
A principal pergunta é coerência: o nome, resumo, metadados, autoridade solicitada
...
As páginas de artefato têm link para a auditoria completa em:
...
ciente de artefatos do ClawHub.
...
seção pública de auditoria independente nem um veredito que bloqueia a instalação.
