...
x-i18n:
    generated_at: "2026-07-05T05:27:28Z"
    model: gpt-5.5
...
As auditorias de segurança do ClawHub ajudam você a decidir se uma skill ou Plugin é segura o bastante
...
A pergunta principal é a coerência: o nome, o resumo, os metadados, a autoridade solicitada
e o conteúdo real estão alinhados com o que os usuários razoavelmente esperariam?
...
sinais de reputação que complementam a revisão do ClawHub sensível a agentes. Quando contagens de
...
do próprio ClawHub, ciente do artefato.
...
Ele pergunta se a capacidade é divulgada, alinhada ao propósito e apoiada
