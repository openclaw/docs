...
x-i18n:
    generated_at: "2026-07-01T18:09:20Z"
    model: gpt-5.5
...
As auditorias de segurança do ClawHub ajudam você a decidir se uma habilidade ou Plugin é seguro o suficiente para instalar. Elas mostram o que uma versão faz, que autoridade ela solicita e se algo merece atenção extra antes de poder acessar arquivos, contas, credenciais, código ou serviços externos.
...
O nível de risco descreve o raio de impacto: quanto poder a versão parece ter se você a usar como previsto.
...
Descobertas de baixa confiança são ocultadas do resumo público de auditoria para que a página
...
A pergunta principal é a coerência: o nome, o resumo, os metadados, a autoridade
solicitada e o conteúdo real estão alinhados com o que os usuários razoavelmente esperariam?
...
sinais de reputação que complementam a revisão do ClawHub com consciência de agentes. Quando as contagens
dos mecanismos dos fornecedores estão disponíveis, a auditoria as resume em linguagem simples, como:
...
própria do ClawHub, com consciência de artefatos.

## Análise de risco

A análise de risco é alimentada internamente pelo ClawScan, o sistema de auditoria de segurança
próprio do ClawHub. Ele revisa cada versão como um artefato voltado para agentes: instruções,
metadados, permissões declaradas, arquivos, sinais de capacidade, sinais de verificação estática,
descobertas do SkillSpector, telemetria do VirusTotal e contexto fornecido pelo publicador.
Sinais de verificação estática são contexto interno para esta revisão; eles não são uma
seção pública independente da auditoria nem um veredito que bloqueia instalação.

A análise de risco usa o
[OWASP Agentic Skills Top 10](https://owasp.org/www-project-agentic-skills-top-10/)
como uma lente para riscos como injeção de prompt, uso indevido de ferramentas, exposição de credenciais,
...
Ele pergunta se a capacidade é divulgada, alinhada ao propósito e sustentada
pelo caso de uso declarado da versão.
