...
x-i18n:
    generated_at: "2026-07-03T09:27:42Z"
    model: gpt-5.5
...
| `Medium`       | A versão tem autoridade significativa, como acesso a conta ou alterações de dados. |
...
atuar com autoridade significativa sobre a conta.

## Achados

Achados explicam por que um resultado de auditoria foi mostrado. Cada achado geralmente inclui:
...
A pergunta principal é a coerência: o nome, resumo, metadados, autoridade solicitada
...
O ClawHub usa VirusTotal como telemetria de malware na pilha de auditoria. O VirusTotal é um
...
A análise de risco é alimentada internamente pelo ClawScan, o sistema próprio de auditoria de segurança do ClawHub.
Ele revisa cada versão como um artefato voltado a agentes: instruções,
