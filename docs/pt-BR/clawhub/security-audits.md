...
read_when:
    ...
    - Explicação do status de auditoria, nível de risco ou achados do ClawHub
...
sinais de reputação que complementam a revisão do ClawHub ciente de agentes. Quando contagens de mecanismos de
fornecedores estão disponíveis, a auditoria as resume em linguagem simples, como:
