...
read_when:
    ...
    - Decidindo se deve instalar uma habilidade ou um Plugin
    - Explicando o status de auditoria do ClawHub, o nível de risco ou os achados
...
x-i18n:
    generated_at: "2026-07-05T04:52:11Z"
    model: gpt-5.5
...
Auditorias são fortes sinais de segurança, mas não são garantia de que uma versão seja
...
solicitada e o conteúdo real se alinham ao que os usuários esperariam razoavelmente?
...
sinais de reputação que complementam a análise do ClawHub ciente de agentes. Quando as
...
seção de auditoria pública independente nem um veredito que bloqueia instalação.
