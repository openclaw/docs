...
x-i18n:
    generated_at: "2026-07-04T10:32:12Z"
    model: gpt-5.5
...
As auditorias de segurança do ClawHub ajudam você a decidir se uma habilidade ou plugin é seguro o bastante
...
principalmente para ferramentas que podem publicar conteúdo, editar dados, executar comandos, ler arquivos ou
...
sinais de reputação que complementam a revisão do ClawHub com consciência de agentes. Quando as contagens de
