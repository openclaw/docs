...
- credenciais, permissões ou variáveis de ambiente obrigatórias
...
sinais de reputação que complementam a revisão ciente de agentes do ClawHub. Quando as
...
O VirusTotal continua sendo telemetria. Ele não substitui a própria análise de risco do ClawHub
ciente de artefatos.

## Análise de risco

A análise de risco é alimentada internamente pelo ClawScan, o próprio sistema de auditoria de segurança
do ClawHub. Ele analisa cada versão como um artefato voltado a agentes: instruções,
