...
x-i18n:
    generated_at: "2026-07-02T22:24:44Z"
    model: gpt-5.5
...
sinais de reputação que complementam a análise do ClawHub ciente de agentes. Quando contagens de
...
Sinais de varredura estática são contexto interno para esta análise; eles não são uma
