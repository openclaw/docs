...
read_when:
    ...
    - Explicação do status da auditoria do ClawHub, do nível de risco ou das constatações
...
x-i18n:
    generated_at: "2026-07-04T06:25:42Z"
    model: gpt-5.5
...
As auditorias de segurança do ClawHub ajudam você a decidir se uma habilidade ou Plugin é segura o bastante
...
- metadados de compatibilidade e capacidades
...
poder é esperado, declarado e proporcional.
...
sinais de reputação que complementam a revisão consciente de agentes do ClawHub. Quando as
...
O VirusTotal permanece como telemetria. Ele não substitui a análise de risco própria do ClawHub,
consciente dos artefatos.
...
metadados, permissões declaradas, arquivos, sinais de capacidades, sinais de varredura estática,
...
Ele pergunta se a capacidade é declarada, alinhada ao propósito e apoiada
