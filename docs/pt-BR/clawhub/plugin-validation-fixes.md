...
read_when:
    ...
    - ClawHub rejeitou ou emitiu um aviso sobre a publicação de um pacote de Plugin
...
x-i18n:
    generated_at: "2026-07-02T14:00:04Z"
    model: gpt-5.5
...
constatações que o autor do Plugin pode corrigir nos metadados do pacote, no manifesto, nas importações do SDK
...
| `package-npm-pack-entrypoint-missing`   | [Inclua pontos de entrada na saída do pacote npm](/pt-BR/clawhub/plugin-validation-fixes#package-npm-pack-entrypoint-missing)                  |
| `package-npm-pack-metadata-missing`     | [Inclua metadados na saída do pacote npm](/pt-BR/clawhub/plugin-validation-fixes#package-npm-pack-metadata-missing)                       |
...
| `legacy-root-sdk-import`                | [Substitua importações de SDK raiz](/pt-BR/clawhub/plugin-validation-fixes#legacy-root-sdk-import)                                             |
| `reserved-sdk-import`                   | [Remova importações de SDK reservadas](/pt-BR/clawhub/plugin-validation-fixes#reserved-sdk-import)                                             |
...
- Verifique qualquer metadado de compilação do OpenClaw no pacote, como a versão do OpenClaw
...
- Mantenha pontos de entrada de pacote, compatibilidade, instalação, configuração e metadados de catálogo
...
- Atualize `files`, `.npmignore` ou a saída de compilação para que os pontos de entrada declarados sejam
  incluídos.
- Consulte [Pontos de entrada de Plugin](/pt-BR/plugins/sdk-entrypoints).
- Execute novamente `clawhub package validate <path-to-plugin>`.
...
O artefato empacotado não tem metadados do OpenClaw que existem no seu pacote
de origem.
...
- Evite carregar, modificar e salvar o objeto inteiro de armazenamento de sessão.
- Mantenha auxiliares de gravação de armazenamento completo apenas enquanto o intervalo de compatibilidade declarado
