...
summary: Corrigir achados de validação do pacote do Plugin ClawHub antes de publicar
title: Correções de validação de Plugin
x-i18n:
    generated_at: "2026-07-03T13:20:53Z"
    model: gpt-5.5
...
| `package-npm-pack-entrypoint-missing`   | [Inclua pontos de entrada na saída de empacotamento do npm](/pt-BR/clawhub/plugin-validation-fixes#package-npm-pack-entrypoint-missing) |
| `package-npm-pack-metadata-missing`     | [Inclua metadados na saída de empacotamento do npm](/pt-BR/clawhub/plugin-validation-fixes#package-npm-pack-metadata-missing)    |
...
| `sdk-load-session-store`                | [Substitua acesso ao repositório de sessão inteiro](/pt-BR/clawhub/plugin-validation-fixes#sdk-load-session-store)               |
| `sdk-session-store-write`               | [Substitua gravações do repositório de sessão inteiro](/pt-BR/clawhub/plugin-validation-fixes#sdk-session-store-write)           |
...
- Adicione um bloco `openclaw` quando o pacote envia um Plugin do OpenClaw.
...
### campos-desconhecidos-no-manifesto
...
### contratos-desconhecidos-no-manifesto
...
### importacao-sdk-reservada

O Plugin importa um caminho de SDK reservado para Plugins incluídos ou compatibilidade
interna.
...
- Evite carregar, modificar e salvar o objeto completo de armazenamento de sessão.
- Mantenha auxiliares de escrita no armazenamento completo apenas enquanto seu intervalo de compatibilidade declarado
...
- Prefira a superfície estruturada de tempo de execução de transcrição para que o OpenClaw possa aplicar
