...
summary: Corrigir achados de validação do pacote de Plugin do ClawHub antes da publicação
...
verificações automatizadas de pacotes. Esta página aborda achados voltados ao autor, ou seja,
...
| `sdk-load-session-store`                | [Substituir acesso ao armazenamento de sessão inteira](/pt-BR/clawhub/plugin-validation-fixes#sdk-load-session-store)                                   |
