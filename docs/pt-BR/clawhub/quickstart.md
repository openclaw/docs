...
x-i18n:
    generated_at: "2026-05-12T08:44:31Z"
    model: gpt-5.5
    provider: openai
...
Skill precisa antes de instalá-la. Consulte [Formato da Skill](/pt-BR/clawhub/skill-format).
...
`sync` verifica pastas de Skills e publica Skills novas ou alteradas que ainda não estejam
sincronizadas.
...
Quando você estiver conectado, `sync` também poderá enviar um snapshot mínimo de instalação para
...
Listagens públicas mostram o estado mais recente da verificação. Lançamentos retidos ou bloqueados pela
