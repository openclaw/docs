...
ambiente, ferramentas e permissões obrigatórias para que os usuários possam entender o que a
Skill precisa antes de instalá-la. Veja [Formato de Skill](/pt-BR/clawhub/skill-format).
...
compatibilidade, a atribuição da origem e o plano de upload sem publicar.
...
metadados, links de origem, versões, changelogs e status da varredura:
