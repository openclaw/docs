...
x-i18n:
    generated_at: "2026-07-03T17:15:52Z"
    model: gpt-5.5
...
ser resolvidas por meio do ClawHub.
...
publicam automaticamente a próxima versão patch. Use `--dry-run` para pré-visualizar ou
...
compatibilidade, atribuição de origem e plano de envio sem publicar.
