...
x-i18n:
    generated_at: "2026-07-01T05:32:15Z"
    model: gpt-5.5
...
Publique um plugin de uma pasta local, de um repositório GitHub, de uma ref do GitHub ou de um
arquivo existente:
...
Listagens públicas mostram o estado mais recente da varredura. Versões retidas ou bloqueadas pela
