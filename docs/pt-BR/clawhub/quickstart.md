...
x-i18n:
    generated_at: "2026-07-01T12:51:25Z"
    model: gpt-5.5
...
compatibilidade, a atribuição da fonte e o plano de upload sem publicar.
...
metadados, links de fonte, versões, changelogs e status da verificação:
...
Listagens públicas mostram o estado mais recente da verificação. Releases retidas ou bloqueadas por
