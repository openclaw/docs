...
read_when:
    ...
    - Instalando um skill ou plugin a partir do registro
...
Publique um plugin de uma pasta local, um repositório GitHub, uma referência GitHub ou um
arquivo existente:
...
Listagens públicas mostram o estado da varredura mais recente. Lançamentos retidos ou bloqueados por
