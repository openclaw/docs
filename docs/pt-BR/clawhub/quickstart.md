...
compatibilidade, a atribuição de origem e o plano de envio sem publicar.
...
Listagens públicas mostram o estado de verificação mais recente. Releases retidas ou bloqueadas por
