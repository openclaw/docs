...
x-i18n:
    generated_at: "2026-07-02T17:33:22Z"
    model: gpt-5.5
...
a atribuição da origem e o plano de upload sem publicar.
...
Listagens públicas mostram o estado mais recente da varredura. Lançamentos que estão retidos ou bloqueados por
