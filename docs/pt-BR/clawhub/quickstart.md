...
x-i18n:
    generated_at: "2026-07-02T22:24:49Z"
    model: gpt-5.5
...
O comando ignora conteúdo sem alterações. Novas skills começam em `1.0.0`; alterações posteriores
...
Listagens públicas mostram o estado mais recente da varredura. Versões retidas ou bloqueadas por
