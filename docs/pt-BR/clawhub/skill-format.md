...
x-i18n:
    generated_at: "2026-06-30T13:52:35Z"
    model: gpt-5.5
...
- O texto para embedding inclui `SKILL.md` + até cerca de 40 arquivos não `.md` (limite de melhor esforço).

## Slugs

- Derivados do nome da pasta por padrão.
- Escopos de pacote devem corresponder exatamente ao identificador do publicador no ClawHub. Identificadores de publicador podem usar letras minúsculas, números, hifens, pontos e underscores; eles devem começar e terminar com uma letra minúscula ou número.
