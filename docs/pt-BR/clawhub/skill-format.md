...
x-i18n:
    generated_at: "2026-07-04T15:11:03Z"
    model: gpt-5.5
...
| `always`           | `boolean`  | Se `true`, a skill está sempre ativa (não é necessária instalação explícita).                                                                              |
...
- O texto de embedding inclui `SKILL.md` + até ~40 arquivos não `.md` (limite de melhor esforço).
