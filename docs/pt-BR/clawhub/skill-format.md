...
| `nix`              | `object`   | Especificação de plugin Nix (consulte o README).                                                                                             |
...
Tipos de instalação com suporte: `brew`, `node`, `go`, `uv`.
...
- Tipos de conteúdo começando com `text/` são tratados como texto; além de uma pequena allowlist (JSON/YAML/TOML/JS/TS/Markdown/SVG).
