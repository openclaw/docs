...
- `description` é usada como o resumo da Skill na interface/pesquisa.
...
- Escopos de pacote precisam corresponder exatamente ao handle do publicador no ClawHub. Handles de publicador podem usar letras minúsculas, números, hifens, pontos e underscores; eles precisam começar e terminar com uma letra minúscula ou número.
...
- O ClawHub não oferece suporte a Skills pagas, precificação por Skill, paywalls nem compartilhamento de receita.
