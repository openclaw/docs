...
x-i18n:
    generated_at: "2026-07-03T00:54:29Z"
    model: gpt-5.5
...
arquivos `SKILL.md` ou o legado `skills.md` em repositórios públicos, que não sejam forks, pertencentes
...
- Escopos de pacote precisam corresponder exatamente ao identificador de publicador do ClawHub. Identificadores de publicador podem usar letras minúsculas, números, hifens, pontos e sublinhados; eles precisam começar e terminar com uma letra minúscula ou número.
