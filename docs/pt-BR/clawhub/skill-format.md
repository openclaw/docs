...
x-i18n:
    generated_at: "2026-06-28T22:32:54Z"
    model: gpt-5.5
...
- Texto de embedding inclui `SKILL.md` + até ~40 arquivos que não sejam `.md` (limite de melhor esforço).
...
- Slugs de pacote devem estar em minúsculas e ser compatíveis com npm, por exemplo `@example.tools/demo-plugin` ou `demo-plugin`.
