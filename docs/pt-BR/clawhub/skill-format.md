...
x-i18n:
    generated_at: "2026-06-30T22:08:38Z"
    model: gpt-5.5
...
Os metadados da skill são declarados no frontmatter YAML no início do seu `SKILL.md`. Isso informa ao registro (e à análise de segurança) o que sua skill precisa para executar.
