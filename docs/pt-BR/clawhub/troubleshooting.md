...
A CLI respeita variáveis padrão de proxy:
...
Para plugins, verifique os metadados de compatibilidade em `package.json`. Publicações de
...
com provas públicas e não confidenciais. Consulte
...
Aponte para as raízes que você quer verificar:
...
- Verifique a página de detalhes do pacote para ver o status da varredura e os metadados de compatibilidade.
