...
Para Plugins, verifique os metadados de compatibilidade em `package.json`. Publicações de Plugin de código
...
- Confira se você está conectado com a conta do GitHub que possui ou pode publicar
  o pacote.
