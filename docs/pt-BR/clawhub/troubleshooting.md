...
x-i18n:
    generated_at: "2026-07-04T06:25:47Z"
    model: gpt-5.5
...
- Confirme que a release é pública e não está retida por varredura ou moderação.
...
[Reivindicações de organização e namespace](/clawhub/namespace-claims) para orientação sobre evidências e o que
