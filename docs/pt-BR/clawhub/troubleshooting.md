...
x-i18n:
    generated_at: "2026-07-01T18:09:18Z"
    model: gpt-5.5
...
- Confira se seu navegador consegue acessar `http://127.0.0.1:<port>/callback`.
...
Nomes aceitos incluem `HTTPS_PROXY`, `HTTP_PROXY`, `https_proxy` e
`http_proxy`.
...
- Confira se você entrou com a conta do GitHub que possui ou pode publicar
  o pacote.
...
Aponte para as raízes que você quer varrer:
