...
- Certifique-se de ter entrado com a conta do GitHub que possui ou pode publicar
  o pacote.
...
- Verifique a página de detalhes do pacote para o estado da varredura e metadados de compatibilidade.
