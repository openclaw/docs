...
summary: Solução de problemas de login, instalação, publicação, atualização e questões de API do ClawHub.
x-i18n:
    generated_at: "2026-07-04T10:31:51Z"
    model: gpt-5.5
...
A CLI inicia um servidor de retorno de chamada local de curta duração durante o login pelo navegador.
...
[Reivindicações de org e namespace](/clawhub/namespace-claims) para orientações de evidência e o que
deixar fora de issues públicas.
