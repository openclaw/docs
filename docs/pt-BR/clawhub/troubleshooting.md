...
x-i18n:
    generated_at: "2026-07-03T09:27:48Z"
    model: gpt-5.5
...
- Certifique-se de que seu navegador consegue acessar `http://127.0.0.1:<port>/callback`.
...
- Certifique-se de que você entrou com a conta do GitHub que possui ou pode publicar
  o pacote.
...
- Respeite os cabeçalhos de nova tentativa de `429` e armazene em cache respostas públicas de listagem/pesquisa.
- Encaminhe os usuários de volta à listagem canônica do ClawHub.
