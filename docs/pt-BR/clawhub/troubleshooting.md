...
x-i18n:
    generated_at: "2026-07-02T08:00:47Z"
    model: gpt-5.5
...
- Confirme que o release é público e não está retido por varredura ou moderação.
...
- Verifique a página de detalhes do pacote para o status da varredura e os metadados de compatibilidade.
