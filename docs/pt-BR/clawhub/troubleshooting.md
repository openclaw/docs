...
summary: Solução de problemas de início de sessão, instalação, publicação, atualização e API do ClawHub.
x-i18n:
    generated_at: "2026-07-01T05:32:52Z"
    model: gpt-5.5
...
- Respeite os cabeçalhos de nova tentativa `429` e coloque em cache respostas públicas de listagem/busca.
