...
- Se você for o proprietário da skill, entre e inspecione-a:
...
[Reivindicações de Organização e Namespace](/pt-BR/clawhub/namespace-claims) para orientações de evidências e o que
