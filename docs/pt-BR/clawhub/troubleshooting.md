...
x-i18n:
    generated_at: "2026-07-01T07:56:00Z"
    model: gpt-5.5
...
Se muitos usuários compartilharem um IP de saída, limites de IP anônimo podem ser atingidos mesmo quando cada
...
- Verifique o slug exato ou a página do proprietário, se souber.
...
Diagnósticos visíveis ao proprietário podem explicar o estado de varredura, barreira de upload ou moderação.
...
## A publicação falha com um erro de proprietário ou fonte do GitHub

O ClawHub usa identidade do GitHub e atribuição de fonte para conectar pacotes a seus
publicadores.
...
não consegue gerenciar o proprietário atual do ClawHub, abra um
...
- Use uma fonte ClawHub explícita:

```bash
openclaw plugins install clawhub:<package>
```

- Verifique a página de detalhes do pacote para o status da varredura e metadados de compatibilidade.
