...
- Verifique o firewall local, a VPN e as regras de proxy se o retorno de chamada nunca chegar.
...
Pré-visualize primeiro a carga de publicação:
...
- Certifique-se de que você está conectado com a conta do GitHub que possui ou pode publicar
  o pacote.
...
- Verifique a página de detalhes do pacote para o estado de verificação e metadados de compatibilidade.
