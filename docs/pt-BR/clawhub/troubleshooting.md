...
x-i18n:
    generated_at: "2026-07-05T02:02:05Z"
    model: gpt-5.5
...
Diagnósticos visíveis para o proprietário podem explicar o estado de varredura, bloqueio de upload ou moderação.
...
[Reivindicações de org e namespace](/clawhub/namespace-claims) para orientações de evidências e o que
...
- Verifique a página de detalhes do pacote para saber o status de varredura e os metadados de compatibilidade.
