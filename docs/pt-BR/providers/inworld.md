...
read_when:
    ...
    - Você precisa de saída de telefonia PCM ou de mensagem de voz OGG_OPUS do Inworld
...
Inworld é um provedor de conversão de texto em fala (TTS) por streaming. No OpenClaw, ele sintetiza o áudio das respostas de saída (MP3 por padrão, OGG_OPUS para mensagens de voz) e áudio PCM bruto para canais de telefonia, como Voice Call.
