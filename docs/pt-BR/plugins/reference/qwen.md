---
read_when:
    - Você está instalando, configurando ou auditando o plugin qwen
...
title: Plugin Qwen
x-i18n:
    generated_at: "2026-07-12T15:27:26Z"
    model: gpt-5.6
...
Adiciona ao OpenClaw suporte aos provedores de modelos Qwen, Qwen Cloud, Model Studio, DashScope, Qwen Oauth, Qwen Portal, Qwen CLI, Qwen Token Plan e Bailian Token Plan.
