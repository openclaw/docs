...
پشتیبانی از ارائه‌دهنده مدل Chutes را به OpenClaw اضافه می‌کند.

## توزیع

- بسته: `@openclaw/chutes-provider`
- مسیر نصب: npm؛ ClawHub: `clawhub:@openclaw/chutes-provider`

## سطح

ارائه‌دهندگان: `chutes`
