...
x-i18n:
    generated_at: "2026-07-04T06:41:02Z"
    model: gpt-5.5
...
هنگامی که چیزی را در OpenClaw نصب می‌کنید، از OpenClaw استفاده کنید. هنگامی که در حال ورود، انتشار، مدیریت فهرست‌های خود، یا استفاده از گردش‌کارهای ویژهٔ رجیستری هستید، از CLI `clawhub` استفاده کنید.
...
پیش از انتشار، فراداده را در `SKILL.md` بررسی کنید. متغیرهای محیطی، ابزارها، و مجوزهای لازم را اعلام کنید تا کاربران بتوانند پیش از نصب بفهمند مهارت به چه چیزهایی نیاز دارد. [قالب مهارت](/fa/clawhub/skill-format) را ببینید.
...
یک Plugin را از یک پوشهٔ محلی، مخزن GitHub، ارجاع GitHub، یا یک آرشیو موجود منتشر کنید:
...
ابتدا از `--dry-run` استفاده کنید تا فرادادهٔ حل‌شدهٔ بسته، فیلدهای سازگاری، انتساب منبع، و برنامهٔ بارگذاری را بدون انتشار پیش‌نمایش کنید.
...
فهرست‌های عمومی آخرین وضعیت اسکن را نشان می‌دهند. انتشارهایی که توسط مدیریت نگه داشته یا مسدود شده‌اند ممکن است تا زمان حل‌شدن، از سطوح جست‌وجو و نصب پنهان بمانند.
