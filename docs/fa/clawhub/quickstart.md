...
وقتی چیزی را در OpenClaw نصب می‌کنید، از OpenClaw استفاده کنید. وقتی در حال ورود به سیستم، انتشار، مدیریت فهرست‌های خودتان، یا استفاده از گردش‌کارهای ویژهٔ رجیستری هستید، از CLI `clawhub` استفاده کنید.
...
یک Plugin را از یک پوشهٔ محلی، مخزن GitHub، ref در GitHub، یا یک آرشیو موجود منتشر کنید:
...
ابتدا از `--dry-run` استفاده کنید تا پیش‌نمایشی از فرادادهٔ resolveشدهٔ بسته، فیلدهای سازگاری، انتساب منبع، و برنامهٔ بارگذاری، بدون انتشار، ببینید.
...
## همگام‌سازی Skills تحت نگه‌داری شما
...
وقتی وارد سیستم شده‌اید، `sync` ممکن است برای شمارش تجمیعی نصب‌ها، یک snapshot نصب حداقلی نیز ارسال کند. برای اینکه چه چیزی گزارش می‌شود و چگونه می‌توانید opt out کنید، [دورسنجی](/fa/clawhub/telemetry) را ببینید.
...
فهرست‌های عمومی تازه‌ترین وضعیت اسکن را نشان می‌دهند. انتشارهایی که به‌دلیل moderation نگه داشته یا مسدود شده‌اند، ممکن است تا زمان رفع شدن از سطوح جست‌وجو و نصب پنهان بمانند.
