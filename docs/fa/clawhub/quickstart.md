...
x-i18n:
    generated_at: "2026-07-02T17:43:14Z"
    model: gpt-5.5
...
فهرست‌های عمومی آخرین وضعیت اسکن را نشان می‌دهند. انتشارهایی که به‌دلیل moderation نگه داشته شده‌اند یا مسدود شده‌اند، ممکن است تا زمان حل شدن از سطوح جست‌وجو و نصب پنهان بمانند.
