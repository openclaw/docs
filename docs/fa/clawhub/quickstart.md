...
x-i18n:
    generated_at: "2026-07-02T08:35:36Z"
    model: gpt-5.5
...
برای مخازنی که چند مهارت دارند، گردش‌کار قابل‌استفادهٔ مجدد GitHub برای هر پوشهٔ مستقیم مهارت زیر `skills/` فرمان `skill publish` را فراخوانی می‌کند:
...
فهرست‌های عمومی آخرین وضعیت اسکن را نشان می‌دهند. انتشارهایی که به‌دلیل بررسی نگه داشته شده‌اند یا مسدود شده‌اند ممکن است تا زمان رفع مشکل از سطوح جست‌وجو و نصب پنهان شوند.
