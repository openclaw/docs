...
می‌توانید یک کاتالوگ، فهرست یا سطح جست‌وجوی شخص ثالث را بر پایهٔ APIهای خواندن عمومی ClawHub بسازید. فرادادهٔ عمومی Skills و فایل‌های Skills طبق قواعد مجوز Skills در ClawHub منتشر می‌شوند، درحالی‌که خود API محدودیت نرخ دارد و باید مسئولانه مصرف شود.
...
- `POST /api/v1/users/reserve` اسلاگ‌های ریشه و نگه‌دارنده‌های خصوصی بستهٔ بدون انتشار را برای یک شناسهٔ مالک رزرو می‌کند.
