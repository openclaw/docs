...
می‌توانید یک کاتالوگ، فهرست یا سطح جست‌وجوی شخص ثالث را بر پایهٔ APIهای خواندن عمومی ClawHub بسازید. فرادادهٔ عمومی Skills و فایل‌های Skills تحت قوانین مجوز Skills در ClawHub منتشر می‌شوند، در حالی که خود API دارای محدودیت نرخ است و باید مسئولانه مصرف شود.
...
- محتوای پنهان، خصوصی یا مسدودشده توسط مدیریت را با دور زدن فیلترهای API عمومی یا مرزهای احراز هویت آینه نکنید.
...
- توکن گم‌شده/نامعتبر به اعمال بر اساس IP بازمی‌گردد.
...
- `X-RateLimit-Reset`: ثانیه‌های دورهٔ یونیکس (زمان بازنشانی مطلق)
...
- `POST /api/v1/users/reserve` اسلاگ‌های ریشه و جای‌نگهدارهای بستهٔ خصوصی بدون انتشار را برای handle مالک رزرو می‌کند.
