...
summary: نمای کلی و قراردادهای رابط برنامه‌نویسی کاربردی REST عمومی (v1).
x-i18n:
...
می‌توانید یک کاتالوگ، فهرست، یا سطح جست‌وجوی شخص ثالث را بر پایهٔ APIهای خواندن عمومی ClawHub بسازید. فرادادهٔ عمومی مهارت‌ها و فایل‌های مهارت‌ها تحت قواعد مجوز مهارت ClawHub منتشر می‌شوند، در حالی که خود API دارای محدودیت نرخ است و باید مسئولانه مصرف شود.
...
- هنگام نمایش فهرست‌ها، به URL مهارت معتبر ClawHub پیوند دهید تا کاربران بتوانند رکورد رجیستری منبع را بررسی کنند.
- از URLهای صفحهٔ معتبر در قالب `https://clawhub.ai/<owner>/<slug>` استفاده کنید.
...
- توکنِ موجود نبودن/نامعتبر به اعمال بر اساس IP بازمی‌گردد.
...
- `X-RateLimit-Reset`: ثانیه‌های مبدأ یونیکس (زمان بازنشانی مطلق)
