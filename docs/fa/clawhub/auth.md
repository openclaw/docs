...
اگر پس از تلاش برای ورود دوباره به وضعیت خارج‌شده برگردانده می‌شوید، ممکن است حساب شما در وضعیت مناسبی
...
پروکسی نمی‌تواند به callback محلی دسترسی پیدا کند، از جریان توکن بدون رابط گرافیکی استفاده کنید.
...
توکن‌های لغوشده، نامعتبر یا ازدست‌رفته `401 Unauthorized` برمی‌گردانند. دوباره
