...
اگر پس از ورود دوباره به وضعیت خارج‌شده برگردید، ممکن است حساب شما در وضعیت مناسبی
نباشد. اگر حساب شما مسدود یا غیرفعال شده است و فکر می‌کنید این موضوع
...
پروکسی نتواند به callback محلی دسترسی پیدا کند، از جریان توکن headless استفاده کنید.
...
توکن‌های باطل‌شده، نامعتبر یا گمشده `401 Unauthorized` برمی‌گردانند. دوباره
...
اگر حساب شما مسدود یا غیرفعال شده است و فکر می‌کنید این موضوع
اشتباه است، از [فرم درخواست تجدیدنظر ClawHub](https://appeals.openclaw.ai/) استفاده کنید.
