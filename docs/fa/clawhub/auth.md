...
اگر ورود شما را به وضعیت خارج‌شده برمی‌گرداند، ممکن است حساب شما در وضعیت مناسبی نباشد.
...
اگر مرورگر شما به‌دلیل قوانین فایروال، VPN یا پراکسی نمی‌تواند به بازگشت محلی برسد،
...
توکن‌های ابطال‌شده، نامعتبر یا گم‌شده `401 Unauthorized` برمی‌گردانند. دوباره
