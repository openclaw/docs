...
اگر مرورگر شما به‌دلیل قوانین فایروال، VPN یا پروکسی نمی‌تواند به callback محلی دسترسی پیدا کند، از جریان توکن headless استفاده کنید.
...
برای shellهای راه دور که می‌توانید مرورگر را جای دیگری باز کنید، اجرا کنید:
...
حساب‌های حذف‌شده، مسدودشده یا غیرفعال‌شده نمی‌توانند استفاده از توکن‌های API موجود را ادامه دهند. اگر حساب شما مسدود یا غیرفعال شده است و فکر می‌کنید این اشتباه است، از [فرم درخواست تجدیدنظر ClawHub](https://appeals.openclaw.ai/) استفاده کنید.
