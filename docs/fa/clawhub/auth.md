...
x-i18n:
    generated_at: "2026-07-01T08:19:25Z"
    model: gpt-5.5
...
اگر فرایند ورود شما را به وضعیت خارج‌شده از حساب برگرداند، ممکن است حساب شما وضعیت
مناسبی نداشته باشد. اگر حساب شما مسدود یا غیرفعال شده است، اگر فکر می‌کنید این یک
