...
4. مرورگر به کال‌بک محلی بازهدایت می‌شود.
5. CLI توکن را در فایل پیکربندی ClawHub شما ذخیره می‌کند.

اگر مرورگر شما به‌دلیل قوانین فایروال، VPN یا
پراکسی نتواند به کال‌بک محلی دسترسی پیدا کند، از جریان توکن بدون رابط گرافیکی استفاده کنید.
...
توکن‌های باطل‌شده، نامعتبر یا مفقود، `401 Unauthorized` برمی‌گردانند. دوباره
