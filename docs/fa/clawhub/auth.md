...
ClawHub از GitHub برای ورود وب استفاده می‌کند. CLI از توکن‌های API ClawHub استفاده می‌کند که
...
حساب‌های حذف‌شده، مسدودشده یا غیرفعال نمی‌توانند ورود عادی ClawHub را تکمیل کنند.
اگر ورود شما را به حالت خارج‌شده بازگرداند، ممکن است حساب شما در وضعیت مناسبی
