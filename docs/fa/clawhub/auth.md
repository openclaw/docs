...
x-i18n:
    generated_at: "2026-05-10T19:27:17Z"
    model: gpt-5.5
    provider: openai
...
proxy نتواند به callback محلی دسترسی پیدا کند، از جریان توکن بدون واسط گرافیکی استفاده کنید.
...
از این جریان برای سرورها، کارهای CI یا محیط‌های فقط terminal استفاده کنید.
...
توکن‌های لغو اعتبارشده، نامعتبر یا ازدست‌رفته `401 Unauthorized` برمی‌گردانند. دوباره
