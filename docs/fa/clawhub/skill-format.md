...
x-i18n:
    generated_at: "2026-07-04T06:40:55Z"
    model: gpt-5.5
...
حساب GitHub واردشده است شناسایی می‌کند. مخزن‌های خصوصی، فورک‌ها،
...
- scopeهای بسته باید دقیقاً با شناسه ناشر ClawHub مطابقت داشته باشند. شناسه‌های ناشر می‌توانند از حروف کوچک، عددها، خط تیره، نقطه و زیرخط استفاده کنند؛ باید با حرف کوچک یا عدد شروع و تمام شوند.
...
- همه مهارت‌های منتشرشده در ClawHub تحت `MIT-0` مجوزدهی می‌شوند.
