...
x-i18n:
    generated_at: "2026-07-03T09:46:24Z"
    model: gpt-5.5
...
فراداده Skill در frontmatter از نوع YAML در ابتدای `SKILL.md` شما اعلام می‌شود. این به registry (و تحلیل امنیتی) می‌گوید Skill شما برای اجرا به چه چیزهایی نیاز دارد.
...
- slugهای بسته باید حروف کوچک و سازگار با npm باشند، برای مثال `@example.tools/demo-plugin` یا `demo-plugin`.
...
- ClawHub از Skills پولی، قیمت‌گذاری برای هر Skill، paywallها، یا اشتراک درآمد پشتیبانی نمی‌کند.
