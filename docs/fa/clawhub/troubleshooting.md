...
x-i18n:
    generated_at: "2026-07-02T08:36:06Z"
    model: gpt-5.5
...
CLI هنگام ورود با مرورگر، یک سرور بازگشت محلی کوتاه‌عمر راه‌اندازی می‌کند.
...
ابتدا بار داده انتشار را پیش‌نمایش کنید:
...
اگر انتشار به این دلیل شکست می‌خورد که شناسه مالک، namespace سازمان، scope بسته، slug مهارت
یا نام بسته قبلاً ادعا یا رزرو شده است، ابتدا مطمئن شوید که با مالکی منتشر می‌کنید
...
را از مسائل عمومی دور نگه دارید، [ادعاهای سازمان و Namespace](/clawhub/namespace-claims) را ببینید.
