...
## انتشار به‌دلیل نبود فراداده ضروری شکست می‌خورد

برای مهارت‌ها، frontmatter فایل `SKILL.md` را بررسی کنید. متغیرهای محیطی و
ابزارهای ضروری باید اعلام شوند تا کاربران و اسکنرها بتوانند بسته را بفهمند.
...
یا نام بسته قبلاً ادعا یا رزرو شده شکست می‌خورد، ابتدا تأیید کنید که با
...
با مدارک عمومی و غیرحساس باز کنید. برای راهنمای مدارک و اینکه چه چیزهایی
...
آن را به ریشه‌هایی اشاره دهید که می‌خواهید اسکن شوند:
...
- نسخه ویرایش‌شده خود را با slug یا fork جدید منتشر کنید.
