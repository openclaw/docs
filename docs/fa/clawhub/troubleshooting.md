...
summary: رفع اشکال مشکلات ورود، نصب، انتشار، به‌روزرسانی و API در ClawHub.
x-i18n:
    generated_at: "2026-07-04T03:57:51Z"
    model: gpt-5.5
...
درخواست می‌فرستد، ممکن است به محدودیت‌های IP ناشناس برسید. در صورت امکان وارد شوید و پس از
...
- تأیید کنید انتشار عمومی است و توسط اسکن یا moderation نگه داشته نشده است.
...
تشخیص‌های قابل مشاهده برای مالک ممکن است وضعیت اسکن، دروازه بارگذاری، یا moderation را توضیح دهند.

## انتشار شکست می‌خورد چون فراداده‌های ضروری وجود ندارد

برای مهارت‌ها، frontmatter در `SKILL.md` را بررسی کنید. متغیرهای محیطی و
ابزارهای ضروری باید اعلام شوند تا کاربران و اسکنرها بتوانند بسته را درک کنند.
...
آن را به ریشه‌هایی که می‌خواهید اسکن کند اشاره دهید:
...
- به headerهای تلاش دوباره `429` احترام بگذارید و پاسخ‌های فهرست/جست‌وجوی عمومی را cache کنید.
