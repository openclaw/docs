...
درخواست می‌فرستد، محدودیت‌های IP ناشناس ممکن است فعال شوند. در صورت امکان وارد شوید و پس از
...
ابزارهای الزامی باید اعلام شوند تا کاربران و scannerها بتوانند بسته را درک کنند.
...
## انتشار ناموفق می‌شود چون یک namespace ادعا یا رزرو شده است

اگر انتشار به این دلیل ناموفق می‌شود که handle مالک، namespace سازمان، scope بسته، slug مربوط به Skill
...
باید از issueهای عمومی بیرون نگه دارید، [ادعاهای سازمان و Namespace](/clawhub/namespace-claims) را ببینید.
