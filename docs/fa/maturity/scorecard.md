...
<div className="maturity-hero">
  ...
  <p className="maturity-hero-title">نمایی کاربردی از اینکه چه چیز آماده است، چه چیز اثبات شده است، و چه چیز هنوز به کار نیاز دارد.</p>
  <p>50 سطح - 281 حوزه قابلیت - پوشش قطعی به‌همراه کیفیت و کامل‌بودنِ بازبینی‌شده توسط انسان.</p>
  <p className="maturity-jump-links"><a href="#surface-explorer">مرور سطح‌ها</a> / <a href="#qa-evidence-summary">بررسی شواهد QA</a> / <a href="/fa/maturity/taxonomy">خواندن رده‌بندی</a></p>
</div>
...
<div className="maturity-summary-grid">
  <div className="maturity-summary-item maturity-score-alpha">
    ...
    <div className="maturity-summary-meta">
      ...
      <span>کیفیت آلفا - 63%</span>
      <span>کامل‌بودن بتا - 70%</span>
    </div>
  </div>
</div>
...
سطح‌ها بر اساس سطح بلوغ، کامل‌بودن، و کیفیت مرتب شده‌اند. پشتیبانی LTS در کنار هر ردیف نشان داده می‌شود تا مقایسه گزینه‌های آماده انتشار آسان باشد.
  ...
  <Tab title="همه سطح‌ها">
    <div className="maturity-surface-table">
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/fa/maturity/taxonomy#linux-gateway-host"><span className="maturity-surface-title">میزبان Gateway لینوکس</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-stable"><span className="maturity-level-code">M4</span><span>پایدار</span></span><span>۵ حوزه</span></span></a>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/fa/maturity/taxonomy#macos-gateway-host"><span className="maturity-surface-title">میزبان Gateway macOS</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-stable"><span className="maturity-level-code">M4</span><span>پایدار</span></span><span>۷ حوزه</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">پوشش</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">آزمایشی</span><span>۰٪</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        ...
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">کامل‌بودن</span><span className="maturity-score maturity-score-stable"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-stable">پایدار</span><span>۸۸٪</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "88%" }} /></span></span></div>
      ...
      <div className="maturity-surface-row">
        ...
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">پوشش</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">آزمایشی</span><span>۰٪</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">کیفیت</span><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">بتا</span><span>۷۳٪</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "73%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">کامل‌بودن</span><span className="maturity-score maturity-score-stable"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-stable">پایدار</span><span>۸۷٪</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "87%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-partial">جزئی - ۴</span></div>
      </div>
      <div className="maturity-surface-row">
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/fa/maturity/taxonomy#session-memory-and-context-engine"><span className="maturity-surface-title">نشست، حافظه، و موتور زمینه</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>Beta</span></span><span>۹ حوزه</span></span></a>
        ...
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">کیفیت</span><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>۷۷٪</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "77%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">کامل‌بودن</span><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>۷۹٪</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-partial">جزئی - ۶</span></div>
      </div>
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/fa/maturity/taxonomy#channel-framework"><span className="maturity-surface-title">چارچوب کانال</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>Beta</span></span><span>۸ حوزه</span></span></a>
        ...
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">کیفیت</span><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>۷۶٪</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "76%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">کامل‌بودن</span><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>۷۹٪</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-partial">جزئی - ۵</span></div>
      </div>
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/fa/maturity/taxonomy#browser-automation-exec-and-sandbox-tools"><span className="maturity-surface-title">ابزارهای خودکارسازی مرورگر، exec، و sandbox</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>Beta</span></span><span>۳ حوزه</span></span></a>
        ...
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">کیفیت</span><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>۷۵٪</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "75%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">کامل‌بودن</span><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>۷۹٪</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-partial">جزئی - ۲</span></div>
      </div>
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/fa/maturity/taxonomy#observability"><span className="maturity-surface-title">مشاهده‌پذیری</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>Beta</span></span><span>۵ حوزه</span></span></a>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/fa/maturity/taxonomy#openai-and-codex-provider-path"><span className="maturity-surface-title">مسیر ارائه‌دهنده OpenAI و Codex</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>Beta</span></span><span>۵ حوزه</span></span></a>
        ...
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">کیفیت</span><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>۷۴٪</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "74%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">کامل‌بودن</span><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>۷۹٪</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-partial">جزئی - ۳</span></div>
      </div>
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/fa/maturity/taxonomy#gateway-web-app"><span className="maturity-surface-title">برنامه وب Gateway</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>Beta</span></span><span>۶ حوزه</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">پوشش</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">آزمایشی</span><span>۴٪</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "4%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">کیفیت</span><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>۷۴٪</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "74%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">کامل‌بودن</span><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>۷۹٪</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/fa/maturity/taxonomy#web-search-tools"><span className="maturity-surface-title">ابزارهای جست‌وجوی وب</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>Beta</span></span><span>۴ حوزه</span></span></a>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/fa/maturity/taxonomy#automation-cron-hooks-tasks-polling"><span className="maturity-surface-title">اتوماسیون: Cron، قلاب‌ها، وظیفه‌ها، پایش دوره‌ای</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>بتا</span></span><span>6 حوزه</span></span></a>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/fa/maturity/taxonomy#media-understanding-and-media-generation"><span className="maturity-surface-title">درک رسانه و تولید رسانه</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>آلفا</span></span><span>6 حوزه</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">پوشش</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">آزمایشی</span><span>2%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "2%" }} /></span></span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/fa/maturity/taxonomy#image-video-and-music-generation-tools"><span className="maturity-surface-title">ابزارهای تولید تصویر، ویدیو و موسیقی</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>آلفا</span></span><span>5 حوزه</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">پوشش</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">آزمایشی</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/fa/maturity/taxonomy#long-tail-hosted-providers"><span className="maturity-surface-title">ارائه‌دهندگان میزبانی‌شده بلنددامنه</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>آلفا</span></span><span>3 حوزه</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">پوشش</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">آزمایشی</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">کیفیت</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">آلفا</span><span>61%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "61%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">کامل‌بودن</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">آلفا</span><span>68%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "68%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">هیچ‌کدام</span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/fa/maturity/taxonomy#android-app"><span className="maturity-surface-title">برنامه Android</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>آلفا</span></span><span>۷ حوزه</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">پوشش</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">آزمایشی</span><span>۰٪</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/fa/maturity/taxonomy#ios-app"><span className="maturity-surface-title">برنامه iOS</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-experimental"><span className="maturity-level-code">M1</span><span>آزمایشی</span></span><span>8 حوزه</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">پوشش</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">آزمایشی</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
  ...
  <Tab title="هسته">
    <div className="maturity-surface-table">
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/fa/maturity/taxonomy#session-memory-and-context-engine"><span className="maturity-surface-title">نشست، حافظه و موتور زمینه</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>بتا</span></span><span>9 حوزه</span></span></a>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/fa/maturity/taxonomy#automation-cron-hooks-tasks-polling"><span className="maturity-surface-title">اتوماسیون: cron، هوک‌ها، وظیفه‌ها، polling</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>بتا</span></span><span>6 حوزه</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">پوشش</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">آزمایشی</span><span>2%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "2%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">کیفیت</span><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">بتا</span><span>72%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "72%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">کامل‌بودن</span><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">بتا</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">هیچ‌کدام</span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/fa/maturity/taxonomy#openclaw-app-sdk"><span className="maturity-surface-title">OpenClaw App SDK</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>آلفا</span></span><span>۶ حوزه</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">پوشش</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">آزمایشی</span><span>3%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "3%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">کیفیت</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">آلفا</span><span>54%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "54%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">کامل بودن</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">آلفا</span><span>53%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "53%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">هیچ</span></div>
  ...
  <Tab title="پلتفرم">
    <div className="maturity-surface-table">
      <div className="maturity-surface-row maturity-surface-row-header"><span>سطح</span><span>پوشش</span><span>کیفیت</span><span>کامل بودن</span><span>پشتیبانی</span></div>
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/fa/maturity/taxonomy#linux-gateway-host"><span className="maturity-surface-title">میزبان Linux Gateway</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-stable"><span className="maturity-level-code">M4</span><span>پایدار</span></span><span>۵ حوزه</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">پوشش</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">آزمایشی</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">کیفیت</span><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">بتا</span><span>75%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "75%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">کامل بودن</span><span className="maturity-score maturity-score-stable"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-stable">پایدار</span><span>89%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "89%" }} /></span></span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/fa/maturity/taxonomy#macos-gateway-host"><span className="maturity-surface-title">میزبان macOS Gateway</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-stable"><span className="maturity-level-code">M4</span><span>پایدار</span></span><span>۷ حوزه</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">پوشش</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">آزمایشی</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">کیفیت</span><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">بتا</span><span>74%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "74%" }} /></span></span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/fa/maturity/taxonomy#android-app"><span className="maturity-surface-title">برنامه Android</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>آلفا</span></span><span>7 حوزه</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">پوشش</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">آزمایشی</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">کیفیت</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">آلفا</span><span>59%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "59%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">کامل بودن</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">آلفا</span><span>66%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "66%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">هیچ‌کدام</span></div>
  ...
  <Tab title="ارائه‌دهنده و ابزار">
    <div className="maturity-surface-table">
      <div className="maturity-surface-row maturity-surface-row-header"><span>سطح</span><span>پوشش</span><span>کیفیت</span><span>کامل‌بودن</span><span>پشتیبانی</span></div>
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/fa/maturity/taxonomy#browser-automation-exec-and-sandbox-tools"><span className="maturity-surface-title">خودکارسازی مرورگر، exec، و ابزارهای sandbox</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>بتا</span></span><span>3 حوزه</span></span></a>
...
<AccordionGroup>
  <Accordion title="زمان اجرای عامل - 9 حوزه">
    <p className="maturity-readiness-summary">8 تا حدی بازبینی‌شده / 1 نیازمند بازبینی</p>
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">زمان‌های اجرای خارجی و زیرعامل‌ها</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">تا حدی بازبینی‌شده - اعتبارسنجی کامل رده‌بندی</span>
        </div>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">پخش جریانی و پیشرفت</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">تا حدی بازبینی‌شده - اعتبارسنجی کامل رده‌بندی</span>
        </div>
  ...
  <Accordion title="برنامه Android - 7 حوزه">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">چت موبایل</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">نیازمند بازبینی - اعتبارسنجی کامل رده‌بندی</span>
        </div>
        <span>0 از 1 (0%) / 0 از 1 (0%)</span>
        <span>1 شکاف قابلیت</span>
  ...
  <Accordion title="اتوماسیون: Cron، قلاب‌ها، وظایف، پایش دوره‌ای - 6 حوزه">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">قلاب‌های اتوماسیون</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">نیازمند بازبینی - اعتبارسنجی کامل رده‌بندی</span>
        </div>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">کنترل‌های پایش دوره‌ای</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">نیازمند بازبینی - اعتبارسنجی کامل رده‌بندی</span>
        </div>
        <span>0 از 10 (0%) / 0 از 10 (0%)</span>
        <span>10 شکاف قابلیت</span>
  ...
  <Accordion title="اتوماسیون مرورگر، exec و ابزارهای سندباکس - 3 حوزه">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">خط‌مشی سندباکس و ابزار</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">نیازمند بازبینی - اعتبارسنجی کامل رده‌بندی</span>
        </div>
  ...
  <Accordion title="وب‌اپ Gateway - 6 حوزه">
  ...
  <Accordion title="چارچوب کانال - 8 حوزه">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">اقدام‌ها، فرمان‌ها و تأییدهای کانال</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">نیازمند بازبینی - اعتبارسنجی کامل رده‌بندی</span>
        </div>
        <span>0 از 5 (0%) / 0 از 5 (0%)</span>
        <span>5 شکاف قابلیت</span>
  ...
  <Accordion title="CLI - 7 areas">
    <p className="maturity-readiness-summary">۵ مورد نیازمند بازبینی / ۲ مورد تا حدی بازبینی‌شده</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>حوزه</span><span>ویژگی‌ها / شناسه‌های پوشش</span><span>پیگیری</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
  ...
  <Accordion title="Docker and Podman hosting - 4 areas">
    <p className="maturity-readiness-summary">۳ مورد نیازمند بازبینی / ۱ مورد تا حدی بازبینی‌شده</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>حوزه</span><span>ویژگی‌ها / شناسه‌های پوشش</span><span>پیگیری</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">سندباکس عامل و ابزارسازی</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">نیازمند بازبینی - اعتبارسنجی کامل رده‌بندی</span>
        </div>
        <span>0 از 3 (0%) / 0 از 3 (0%)</span>
  ...
  <Accordion title="Feishu, QQ Bot, WeChat, Yuanbao, Zalo, Zalo Personal, regional channels - 4 areas">
    <p className="maturity-readiness-summary">۴ مورد نیازمند بازبینی</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>ناحیه</span><span>ویژگی‌ها / شناسه‌های پوشش</span><span>پیگیری</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">دسترسی و هویت</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">نیازمند بازبینی - اعتبارسنجی کامل رده‌بندی</span>
  ...
  <Accordion title="Gateway runtime - 13 areas">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">دسترسی شبکه و کشف</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">نیازمند بازبینی - اعتبارسنجی کامل رده‌بندی</span>
        </div>
        <span>۰ از ۶ (۰٪) / ۰ از ۶ (۰٪)</span>
        <span>۶ شکاف قابلیت</span>
  ...
  <Accordion title="مسیر ارائه‌دهنده Google - 5 حوزه">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">رسانه، جست‌وجو، و بی‌درنگ</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">نیازمند بازبینی - اعتبارسنجی کامل رده‌بندی</span>
        </div>
        <span>0 از 10 (0%) / 0 از 10 (0%)</span>
        <span>10 شکاف قابلیت</span>
  ...
  <Accordion title="ابزارهای تولید تصویر، ویدئو، و موسیقی - 5 حوزه">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">چرخه عمر و تحویل کار</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">نیازمند بازبینی - اعتبارسنجی کامل رده‌بندی</span>
        </div>
        <span>0 از 12 (0%) / 0 از 12 (0%)</span>
        <span>12 شکاف قابلیت</span>
  ...
  <Accordion title="برنامه iOS - 8 حوزه">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Canvas و صفحه‌نمایش</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">نیازمند بازبینی - اعتبارسنجی کامل رده‌بندی</span>
        </div>
        <span>0 از 1 (0%) / 0 از 1 (0%)</span>
        <span>1 شکاف قابلیت</span>
  ...
  <Accordion title="برنامه همراه Linux - 5 حوزه">
  ...
  <Accordion title="میزبان Gateway روی Linux - 5 حوزه">
    <p className="maturity-readiness-summary">5 مورد نیازمند بازبینی</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>حوزه</span><span>ویژگی‌ها / شناسه‌های پوشش</span><span>پیگیری</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">هدف‌های استقرار</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">نیازمند بازبینی - اعتبارسنجی کامل رده‌بندی</span>
        </div>
        <span>0 از 3 (0%) / 0 از 3 (0%)</span>
        <span>3 شکاف قابلیت</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">راه‌اندازی و به‌روزرسانی‌های میزبان</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">نیازمند بازبینی - اعتبارسنجی کامل رده‌بندی</span>
        </div>
        <span>0 از 4 (0%) / 0 از 4 (0%)</span>
        <span>4 شکاف قابلیت</span>
  ...
  <Accordion title="ارائه‌دهندگان میزبانی‌شده کم‌کاربرد - 3 حوزه">
  ...
  <Accordion title="میزبان Gateway در macOS - ۷ حوزه">
    <p className="maturity-readiness-summary">۷ مورد نیازمند بازبینی</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>حوزه</span><span>ویژگی‌ها / شناسه‌های پوشش</span><span>پیگیری</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">پروفایل‌ها و ایزوله‌سازی</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">نیازمند بازبینی - اعتبارسنجی کامل رده‌بندی</span>
        </div>
        <span>۰ از ۵ (۰٪) / ۰ از ۵ (۰٪)</span>
        <span>۵ شکاف قابلیت</span>
  ...
  <Accordion title="درک رسانه و تولید رسانه - ۶ حوزه">
    <p className="maturity-readiness-summary">۴ مورد نیازمند بازبینی / ۲ مورد تا حدی بازبینی‌شده</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>حوزه</span><span>ویژگی‌ها / شناسه‌های پوشش</span><span>پیگیری</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
  ...
  <Accordion title="برنامه همراه بومی Windows - 5 حوزه">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">ابزارهای دسکتاپ و مجوزها</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">نیازمند بررسی - اعتبارسنجی کامل رده‌بندی</span>
        </div>
        <span>0 از 10 (0%) / 0 از 10 (0%)</span>
        <span>10 شکاف قابلیت</span>
  ...
  <Accordion title="مسیر ارائه‌دهنده OpenAI و Codex - 5 حوزه">
    <p className="maturity-readiness-summary">2 نیازمند بررسی / 3 تا حدی بررسی‌شده</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>حوزه</span><span>ویژگی‌ها / شناسه‌های پوشش</span><span>پیگیری</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">هارنس بومی Codex</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">تا حدی بررسی‌شده - اعتبارسنجی کامل رده‌بندی</span>
        </div>
  ...
  <Accordion title="SDK برنامه OpenClaw - 6 حوزه">
    <p className="maturity-readiness-summary">5 نیازمند بررسی / 1 تا حدی بررسی‌شده</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>حوزه</span><span>ویژگی‌ها / شناسه‌های پوشش</span><span>پیگیری</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">رویدادها و تأییدیه‌ها</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">نیازمند بررسی - اعتبارسنجی کامل رده‌بندی</span>
        </div>
        <span>0 از 5 (0%) / 0 از 5 (0%)</span>
        <span>5 شکاف قابلیت</span>
  ...
  <Accordion title="مسیر ارائه‌دهنده OpenRouter - 4 حوزه">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">راه‌اندازی ارائه‌دهنده و احراز هویت</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">نیازمند بازبینی - اعتبارسنجی کامل رده‌بندی</span>
        </div>
  ...
  <Accordion title="امنیت، احراز هویت، جفت‌سازی و رازها - 6 حوزه">
    <p className="maturity-readiness-summary">2 مورد تا حدی بازبینی‌شده / 4 مورد نیازمند بازبینی</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>حوزه</span><span>قابلیت‌ها / شناسه‌های پوشش</span><span>پیگیری</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">سیاست تأیید و محافظت‌های ابزار</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">تا حدی بازبینی‌شده - اعتبارسنجی کامل رده‌بندی</span>
        </div>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">بهداشت اعتبارنامه و راز</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">تا حدی بازبینی‌شده - اعتبارسنجی کامل رده‌بندی</span>
        </div>
  ...
  <Accordion title="نشست، حافظه، و موتور زمینه - 9 حوزه">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">تاریخچه بین‌کلاینتی و هم‌ارزی نشست</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">تا حدی بازبینی‌شده - اعتبارسنجی کامل رده‌بندی</span>
        </div>
  ...
  <Accordion title="مشاهده‌پذیری - ۵ حوزه">
    <p className="maturity-readiness-summary">۳ تا حدی بررسی‌شده / ۲ نیازمند بررسی</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>حوزه</span><span>ویژگی‌ها / شناسه‌های پوشش</span><span>پیگیری</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">گردآوری تشخیص</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">تا حدی بررسی‌شده - اعتبارسنجی کامل رده‌بندی</span>
        </div>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">ثبت لاگ</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">نیازمند بررسی - اعتبارسنجی کامل رده‌بندی</span>
        </div>
        <span>۰ از ۵ (۰٪) / ۰ از ۵ (۰٪)</span>
        <span>۵ شکاف قابلیت</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">تشخیص نشست</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">نیازمند بررسی - اعتبارسنجی کامل رده‌بندی</span>
        </div>
        <span>۰ از ۴ (۰٪) / ۰ از ۴ (۰٪)</span>
        <span>۴ شکاف قابلیت</span>
  ...
  <Accordion title="TUI - ۵ حوزه">
    <p className="maturity-readiness-summary">۵ نیازمند بررسی</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>حوزه</span><span>ویژگی‌ها / شناسه‌های پوشش</span><span>پیگیری</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
  ...
  <Accordion title="صدا و گفت‌وگوی بی‌درنگ - ۶ حوزه">
    <p className="maturity-readiness-summary">۶ نیازمند بررسی</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>حوزه</span><span>ویژگی‌ها / شناسه‌های پوشش</span><span>پیگیری</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">گفت‌وگو در اپ بومی</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">نیازمند بررسی - اعتبارسنجی کامل رده‌بندی</span>
        </div>
        <span>۰ از ۴ (۰٪) / ۰ از ۴ (۰٪)</span>
        <span>۴ شکاف قابلیت</span>
  ...
  <Accordion title="سطوح همراه watchOS - 5 حوزه">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">تأییدیه‌های اجرایی</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">نیازمند بازبینی - اعتبارسنجی کامل رده‌بندی</span>
        </div>
        <span>0 از 3 (0%) / 0 از 3 (0%)</span>
        <span>3 شکاف قابلیت</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">رابط کاربری اپلیکیشن ساعت</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">نیازمند بازبینی - اعتبارسنجی کامل رده‌بندی</span>
        </div>
        <span>0 از 3 (0%) / 0 از 3 (0%)</span>
        <span>3 شکاف قابلیت</span>
  ...
  <Accordion title="Windows از طریق WSL2 - 6 حوزه">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">دسترسی و نمایانی Gateway</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">نیازمند بازبینی - اعتبارسنجی کامل رده‌بندی</span>
        </div>
        <span>0 از 11 (0%) / 0 از 11 (0%)</span>
        <span>11 شکاف قابلیت</span>
