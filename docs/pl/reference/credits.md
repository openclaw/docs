---
read_when:
    - Chcesz poznać historię projektu lub podziękowania dla współtwórców
...
- **Peter Steinberger** ([@steipete](https://x.com/steipete)) - Twórca, zaklinacz homarów
- **Mario Zechner** ([@badlogicc](https://x.com/badlogicgames)) - Twórca Pi, tester penetracyjny bezpieczeństwa
- **Clawd** - Kosmiczny homar, który zażądał lepszej nazwy
