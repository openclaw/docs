...
summary: Rozwiązywanie problemów z logowaniem do ClawHub, instalacją, publikowaniem, aktualizacją oraz interfejsem API.
x-i18n:
    generated_at: "2026-07-05T08:47:59Z"
    model: gpt-5.5
...
- Jeśli używasz tokena API, potwierdź, że nie został odwołany w interfejsie webowym.
...
Jeśli publikacja nie powiodła się, ponieważ identyfikator właściciela, przestrzeń nazw organizacji, zakres pakietu, slug Skill
lub nazwa pakietu są już zajęte albo zarezerwowane, najpierw potwierdź, że publikujesz
jako właściciel odpowiadający przestrzeni nazw. W przypadku pakietów Plugin
...
[Roszczenia dotyczące organizacji i przestrzeni nazw](/clawhub/namespace-claims), aby uzyskać wskazówki dotyczące dowodów i informacje, czego
...
## Instalacja Pluginu nie powiodła się w OpenClaw
