...
summary: Rozwiązywanie problemów z logowaniem do ClawHub, instalacją, publikowaniem, aktualizacją oraz problemów z API.
x-i18n:
    generated_at: "2026-07-04T20:44:44Z"
    model: gpt-5.5
...
- Jeśli używasz tokenu API, upewnij się, że nie został cofnięty w interfejsie webowym.
...
Jeśli publikacja nie działa, ponieważ uchwyt właściciela, przestrzeń nazw organizacji, zakres pakietu, slug umiejętności
lub nazwa pakietu są już zajęte albo zarezerwowane, najpierw upewnij się, że
publikujesz jako właściciel zgodny z przestrzenią nazw. W przypadku pakietów pluginów
...
Najpierw podejrzyj, jeśli nie masz pewności, co zostanie opublikowane:
...
## Żądania publicznego API nie działają
...
- Nie odzwierciedlaj ukrytych, prywatnych, zatrzymanych ani zablokowanych przez moderację treści poza
