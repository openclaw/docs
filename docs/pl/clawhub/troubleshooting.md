...
x-i18n:
    generated_at: "2026-07-01T08:33:42Z"
    model: gpt-5.5
...
CLI uruchamia krótkotrwały lokalny serwer wywołań zwrotnych podczas logowania przez przeglądarkę.

- Upewnij się, że przeglądarka może dotrzeć do `http://127.0.0.1:<port>/callback`.
...
## Umiejętność nie pojawia się w wyszukiwarce
