...
x-i18n:
    generated_at: "2026-07-04T06:53:45Z"
    model: gpt-5.5
...
- W środowiskach headless utwórz token API w interfejsie webowym ClawHub i uruchom:
...
- Jeśli jesteś właścicielem Skill, zaloguj się i go sprawdź:
...
publikujesz jako właściciel odpowiadający tej przestrzeni nazw. W przypadku pakietów Plugin
...
[Roszczenia organizacji i przestrzeni nazw](/clawhub/namespace-claims), aby uzyskać wskazówki dotyczące dowodów i informacji,
