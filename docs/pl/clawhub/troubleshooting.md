...
x-i18n:
    generated_at: "2026-07-02T14:12:45Z"
    model: gpt-5.5
...
- Jeśli używasz tokenu API, potwierdź, że nie został unieważniony w webowym interfejsie.
...
- Dla źródeł GitHub użyj `owner/repo`, `owner/repo@ref` albo pełnego adresu URL GitHub.
...
publikujesz jako właściciel zgodny z przestrzenią nazw. W przypadku pakietów plugin,
nazwy z zakresem, takie jak `@example-org/example-plugin`, muszą być publikowane jako
odpowiadający im właściciel `example-org`.
