...
x-i18n:
    generated_at: "2026-07-04T15:37:59Z"
    model: gpt-5.5
...
## Skills nie pojawia się w wyszukiwarce

- Sprawdź dokładny identyfikator lub stronę właściciela, jeśli je znasz.
...
Jeśli publikowanie kończy się niepowodzeniem, ponieważ identyfikator właściciela, przestrzeń nazw organizacji, zakres pakietu, identyfikator Skills
...
[Roszczenia organizacji i przestrzeni nazw](/clawhub/namespace-claims), aby uzyskać wskazówki dotyczące dowodów i informacji, których
...
- Opublikuj edytowaną kopię jako nowy identyfikator lub fork.
