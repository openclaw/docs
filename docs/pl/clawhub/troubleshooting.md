...
x-i18n:
    generated_at: "2026-07-01T13:23:07Z"
    model: gpt-5.5
...
Dla Skills sprawdź frontmatter w `SKILL.md`. Wymagane zmienne środowiskowe i
narzędzia powinny być zadeklarowane, aby użytkownicy i skanery mogli zrozumieć pakiet.

Dla Plugins sprawdź metadane zgodności w `package.json`. Publikacje code-plugin
...
Jeśli publikacja kończy się niepowodzeniem, ponieważ uchwyt właściciela, przestrzeń nazw organizacji, zakres pakietu, slug Skills
lub nazwa pakietu są już zajęte albo zarezerwowane, najpierw upewnij się, że publikujesz jako właściciel pasujący do przestrzeni nazw. Dla pakietów Plugin
...
z publicznymi, niewrażliwymi dowodami. Zobacz
...
## Instalacja Plugin nie działa w OpenClaw
