...
x-i18n:
    generated_at: "2026-07-03T02:57:42Z"
    model: gpt-5.5
...
- Upewnij się, że Twoja przeglądarka może otworzyć `http://127.0.0.1:<port>/callback`.
...
osoba wysyła tylko kilka żądań. Zaloguj się, gdy to możliwe, i spróbuj ponownie po
...
- Potwierdź, że wydanie jest publiczne i nie zostało zatrzymane przez skanowanie lub moderację.
...
## Publikowanie nie udaje się, ponieważ przestrzeń nazw jest zajęta lub zarezerwowana

Jeśli publikowanie nie udaje się, ponieważ uchwyt właściciela, przestrzeń nazw organizacji, zakres pakietu, slug Skill
...
## Instalacja Pluginu nie udaje się w OpenClaw
...
- Nie mirroruj ukrytej, prywatnej, zatrzymanej ani zablokowanej przez moderację treści poza
