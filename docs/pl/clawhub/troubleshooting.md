---
read_when:
    - Polecenia ClawHub CLI lub polecenia rejestru OpenClaw kończą się niepowodzeniem
...
- Nie replikuj ukrytych, prywatnych, wstrzymanych ani zablokowanych przez moderację treści poza
