...
x-i18n:
    generated_at: "2026-07-01T15:33:00Z"
    model: gpt-5.5
...
- `Retry-After`: liczba sekund do odczekania przed ponowieniem.
...
Jeśli wielu użytkowników współdzieli jeden wychodzący adres IP, anonimowe limity IP mogą zostać osiągnięte, nawet gdy każda
...
[Roszczenia organizacji i przestrzeni nazw](/clawhub/namespace-claims), aby uzyskać wskazówki dotyczące dowodów oraz informacje, czego
