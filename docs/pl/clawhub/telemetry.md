...
summary: Telemetria instalacji zbierana przez ClawHub CLI oraz sposób rezygnacji z niej.
x-i18n:
    generated_at: "2026-07-03T23:43:41Z"
    model: gpt-5.5
...
- `installsAllTime`: unikalni użytkownicy, którzy zgłosili co najmniej jedną instalację CLI dla skill.
...
Usunięcie konta usuwa również dane telemetryczne.
