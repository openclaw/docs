...
x-i18n:
    generated_at: "2026-07-05T08:47:27Z"
    model: gpt-5.5
...
- `slug`: slug zainstalowanego Skills.
...
ClawHub utrzymuje zbiorcze liczniki dla każdego Skills:

- `installsAllTime`: unikalni użytkownicy, którzy zgłosili co najmniej jedną instalację Skills przez CLI.
