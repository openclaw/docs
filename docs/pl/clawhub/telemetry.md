...
summary: Telemetria instalacji zbierana przez ClawHub CLI i sposób rezygnacji z niej.
x-i18n:
    generated_at: "2026-07-04T18:24:22Z"
    model: gpt-5.5
...
- `installsAllTime`: unikatowi użytkownicy, którzy zgłosili co najmniej jedną instalację umiejętności przez CLI.
- `installsCurrent`: unikatowi użytkownicy, którzy zgłosili instalację i nie usunęli swoich
