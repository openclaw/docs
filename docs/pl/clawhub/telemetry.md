...
summary: Telemetria instalacji zbierana przez ClawHub CLI oraz sposób rezygnacji z jej przesyłania.
x-i18n:
...
Przy każdym zgłoszonym `clawhub install` CLI wysyła jedno zdarzenie instalacji w miarę możliwości.
...
Wszyscy widzą wyłącznie **zagregowane liczniki instalacji**.
