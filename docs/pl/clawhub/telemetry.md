...
summary: Telemetria instalacji zbierana przez CLI ClawHub oraz sposób rezygnacji.
x-i18n:
    generated_at: "2026-07-04T20:44:26Z"
    model: gpt-5.5
...
Przy każdym zgłoszonym `clawhub install` CLI wysyła jedno zdarzenie instalacji w trybie najlepszych starań.
...
- `installsAllTime`: unikalni użytkownicy, którzy zgłosili co najmniej jedną instalację CLI dla tej umiejętności.
