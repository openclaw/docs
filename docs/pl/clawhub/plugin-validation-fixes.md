...
summary: Napraw problemy wykryte przez walidację pakietu Plugin ClawHub przed publikacją
title: Poprawki walidacji Plugin
x-i18n:
    generated_at: "2026-07-01T15:32:46Z"
    model: gpt-5.5
...
| `package-npm-pack-entrypoint-missing`   | [Uwzględnij punkty wejścia w wyjściu npm pack](/pl/clawhub/plugin-validation-fixes#package-npm-pack-entrypoint-missing)                  |
| `package-npm-pack-metadata-missing`     | [Uwzględnij metadane w wyjściu npm pack](/pl/clawhub/plugin-validation-fixes#package-npm-pack-metadata-missing)                       |
...
- Użyj [Tworzenie Plugin](/pl/plugins/building-plugins), aby zobaczyć minimalny przykład pakietu,
...
Pakiet można spakować, ale spakowany artefakt nie zawiera plików punktów
...
- Zaktualizuj `files`, `.npmignore` lub wyjście kompilacji, aby zadeklarowane punkty wejścia
  były uwzględnione.
- Zobacz [Punkty wejścia Plugin](/pl/plugins/sdk-entrypoints).
- Uruchom ponownie `clawhub package validate <path-to-plugin>`.
...
Plugin importuje z przestarzałego głównego pliku zbiorczego SDK:
`openclaw/plugin-sdk`.

- Zastąp importy z głównego pliku zbiorczego ukierunkowanymi importami z publicznych ścieżek podrzędnych.
...
- Jeśli dane zachowanie nie ma publicznego SDK, utrzymaj helper w swoim pakiecie albo
...
- Utrzymuj zachowania wrażliwe pod względem bezpieczeństwa opisane w publicznej dokumentacji pakietu lub
