...
summary: Format folderu umiejętności, wymagane pliki, dozwolone typy plików, ograniczenia.
x-i18n:
    generated_at: "2026-05-13T02:51:41Z"
    model: gpt-5.5
    provider: openai
...
Tylko pliki „tekstowe” są akceptowane przez publikowanie.
...
- Wszystkie umiejętności publikowane w ClawHub są licencjonowane na zasadach `MIT-0`.
...
- ClawHub nie obsługuje płatnych umiejętności, cenników dla poszczególnych umiejętności, paywalli ani podziału przychodów.
