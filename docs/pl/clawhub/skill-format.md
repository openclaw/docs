...
x-i18n:
    generated_at: "2026-07-03T02:56:39Z"
    model: gpt-5.5
...
- Tekst do osadzenia obejmuje `SKILL.md` + maksymalnie około 40 plików innych niż `.md` (limit typu best-effort).
...
- ClawHub nie obsługuje płatnych umiejętności, cen dla pojedynczych umiejętności, paywalli ani dzielenia się przychodami.
