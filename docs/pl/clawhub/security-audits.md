...
x-i18n:
    generated_at: "2026-07-02T08:55:20Z"
    model: gpt-5.5
...
Audyty bezpieczeństwa ClawHub pomagają zdecydować, czy dana umiejętność lub plugin jest wystarczająco bezpieczny
...
| `Warn`      | Zachowaj dodatkową ostrożność. ClawHub znalazł obawę o dużym wpływie lub sygnał ostrzegawczy. |
...
Poziom ryzyka opisuje promień oddziaływania: jak dużą władzę wydanie wydaje się mieć, jeśli
...
koncentrowała się na użytecznych dowodach.
...
uprawnienia i rzeczywista zawartość zgadzają się z tym, czego użytkownicy mogliby rozsądnie oczekiwać?
...
liczby od silników dostawców, audyt podsumowuje je prostym językiem, takim jak:
