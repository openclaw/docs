...
x-i18n:
    generated_at: "2026-07-03T10:02:27Z"
    model: gpt-5.5
...
| `Warn`      | Zachowaj szczególną ostrożność. ClawHub znalazł obawę o dużym wpływie lub sygnał ostrzegawczy. |
...
Na przykład skill publikujący może pokazać `Review` z ryzykiem `Medium`. To
...
Potężne zachowanie nie jest automatycznie złe. Wiele użytecznych narzędzi wymaga poświadczeń,
...
partnerstwo pozwala ClawHub dodawać szersze informacje bezpieczeństwa do przeglądu skilli i Pluginów.
...
jako soczewki dla ryzyk takich jak wstrzykiwanie promptów, niewłaściwe użycie narzędzi, ujawnienie poświadczeń,
