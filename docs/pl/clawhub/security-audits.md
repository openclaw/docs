...
x-i18n:
    generated_at: "2026-07-02T22:50:34Z"
    model: gpt-5.5
...
`Pass` uspokaja, ale nie zastępuje własnego osądu. Ma to znaczenie
szczególnie w przypadku narzędzi, które mogą publikować treści, edytować dane, uruchamiać polecenia, czytać pliki lub
uzyskiwać dostęp do systemów produkcyjnych.

## Poziom ryzyka

Poziom ryzyka opisuje zasięg skutków: jaką moc wydaje się mieć wydanie, jeśli
...
ClawHub audytuje przesłane artefakty wydania, w tym:
...
Strony artefaktów odsyłają do pełnego audytu pod adresem:
