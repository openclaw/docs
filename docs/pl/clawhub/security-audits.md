...
x-i18n:
    generated_at: "2026-07-04T15:36:53Z"
    model: gpt-5.5
...
Poziom ryzyka opisuje zasięg wpływu: jak dużą władzę wydanie wydaje się mieć, jeśli
używasz go zgodnie z przeznaczeniem.

| Poziom ryzyka | Znaczenie                                                                   |
| ------------- | --------------------------------------------------------------------------- |
| `Low`         | Znaleziono niewielkie wrażliwe uprawnienia lub wpływ na użytkownika.        |
...
nie oznacza, że jest złośliwa. Oznacza, że umiejętność wydaje się zgodna z celem, ale może
...
pozostawała skupiona na przydatnych dowodach.
...
ClawHub używa VirusTotal jako telemetrii złośliwego oprogramowania w stosie audytowym. VirusTotal jest
...
ClawHub. Sprawdza każde wydanie jako artefakt skierowany do agentów: instrukcje,
