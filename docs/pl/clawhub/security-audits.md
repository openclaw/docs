...
x-i18n:
    generated_at: "2026-07-03T17:45:03Z"
    model: gpt-5.5
...
danych uwierzytelniających, kodu lub usług zewnętrznych.
...
| `Warn`      | Zachowaj dodatkową ostrożność. ClawHub wykrył problem o dużym wpływie lub sygnał ostrzegawczy. |
...
w przypadku narzędzi, które mogą publikować treści, edytować dane, uruchamiać polecenia, odczytywać pliki lub
...
| ---------- | ----------------------------------------------------------------------------- |
| `Low`      | Wykryto niewielkie wrażliwe uprawnienia lub niewielki wpływ na użytkownika.                          |
...
Na przykład umiejętność publikowania może pokazywać `Review` z ryzykiem `Medium`. Nie oznacza to,
że jest złośliwa. Oznacza to, że umiejętność wydaje się zgodna z deklarowanym celem, ale może
...
uprawnienia i rzeczywista zawartość są zgodne z tym, czego użytkownicy mogliby rozsądnie oczekiwać?

Silne możliwości nie są automatycznie czymś złym. Wiele użytecznych narzędzi potrzebuje danych uwierzytelniających,
lokalnych poleceń, API dostawców lub instalacji pakietów. Audyt sprawdza, czy ta
...
partnerstwo pozwala ClawHub dodawać szerszą inteligencję bezpieczeństwa do przeglądu umiejętności i pluginów.

VirusTotal jest szczególnie przydatny w przypadku znanych złośliwych artefaktów, trafień silników oraz
sygnałów reputacji, które uzupełniają przegląd ClawHub świadomy agentów. Gdy liczby wskazań
silników dostawców są dostępne, audyt podsumowuje je prostym językiem, na przykład:
...
Gdy ClawHub nie ma telemetrii liczby wskazań dostawców do podsumowania, audyt mówi:
...
bezpieczeństwa ClawHub. Przegląda każde wydanie jako artefakt przeznaczony dla agentów: instrukcje,
...
Sygnały skanowania statycznego są wewnętrznym kontekstem tego przeglądu; nie są
samodzielną publiczną sekcją audytu ani werdyktem blokującym instalację.

Analiza ryzyka używa
[OWASP Agentic Skills Top 10](https://owasp.org/www-project-agentic-skills-top-10/)
jako perspektywy dla ryzyk takich jak wstrzykiwanie promptów, nadużycie narzędzi, ujawnienie danych uwierzytelniających,
