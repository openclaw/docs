...
x-i18n:
    generated_at: "2026-07-03T02:58:11Z"
    model: gpt-5.5
...
nie oznacza, że jest złośliwa. Oznacza to, że umiejętność wydaje się zgodna z celem, ale może
...
- instrukcje umiejętności lub metadane wtyczek
...
Zaawansowane działanie nie jest automatycznie czymś złym. Wiele użytecznych narzędzi potrzebuje poświadczeń,
lokalnych poleceń, interfejsów API dostawców lub instalacji pakietów. Audyt sprawdza, czy taka
...
partnerstwo pozwala ClawHub dodawać szersze informacje bezpieczeństwa do przeglądu umiejętności i wtyczek.
