...
x-i18n:
    generated_at: "2026-07-04T06:53:06Z"
    model: gpt-5.5
...
do instalacji. Pokazują, co robi wydanie, o jakie uprawnienia prosi oraz
...
Zobacz także [Bezpieczeństwo](/clawhub/security), [Dopuszczalne użycie](/clawhub/acceptable-usage)
...
Poziom ryzyka opisuje zakres oddziaływania: jak dużą moc wydaje się mieć wydanie, jeśli
...
Na przykład skill publikujący może pokazywać `Review` z ryzykiem `Medium`. Nie oznacza to,
że jest złośliwy. Oznacza to, że skill wydaje się zgodny z celem, ale może
...
- odpowiednią zawartość skill lub plugin
- rekomendację
...
pozostała skupiona na przydatnych dowodach.

## Co sprawdza ClawHub

ClawHub audytuje przesłane artefakty wydań, w tym:

- instrukcje skill lub metadane plugin
...
Potężne zachowanie nie jest automatycznie złe. Wiele przydatnych narzędzi potrzebuje danych uwierzytelniających,
...
partnerstwo pozwala ClawHub dodawać szerszą analizę bezpieczeństwa do przeglądu skill i plugin.

VirusTotal jest szczególnie przydatny w przypadku znanych złośliwych artefaktów, trafień silników i
sygnałów reputacji, które uzupełniają świadomy agentów przegląd ClawHub. Gdy dostępne są
liczby silników dostawców, audyt podsumowuje je prostym językiem, takim jak:
...
ustalenia SkillSpector, telemetrię VirusTotal i kontekst podany przez wydawcę.
...
jako perspektywy dla ryzyk takich jak prompt injection, niewłaściwe użycie narzędzi, ujawnienie danych uwierzytelniających,
