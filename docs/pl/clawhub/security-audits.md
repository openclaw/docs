...
x-i18n:
    generated_at: "2026-06-30T14:30:24Z"
    model: gpt-5.5
...
Audyty bezpieczeństwa ClawHub pomagają zdecydować, czy Skills lub Plugin są wystarczająco bezpieczne
...
wolne od ryzyka. Zawsze zachowaj rozsądek przed przyznaniem wrażliwego dostępu.
...
Poziom ryzyka opisuje zasięg oddziaływania: jaką władzę wydanie wydaje się mieć, jeśli
...
Na przykład publikujące Skills mogą pokazywać `Review` z ryzykiem `Medium`. Nie
oznacza to, że są złośliwe. Oznacza to, że Skills wydają się zgodne z celem, ale mogą
...
Silne możliwości nie są automatycznie złe. Wiele użytecznych narzędzi potrzebuje poświadczeń,
...
ClawHub używa VirusTotal jako telemetrii złośliwego oprogramowania w stosie audytu. VirusTotal to
zaufany standard branżowy dotyczący reputacji plików i skanowania złośliwego oprogramowania, a nasze
partnerstwo pozwala ClawHub dodać szerszą inteligencję bezpieczeństwa do przeglądu Skills i Plugin.

VirusTotal jest szczególnie przydatny dla znanych złośliwych artefaktów, trafień silników oraz
sygnałów reputacji, które uzupełniają przegląd ClawHub świadomy agentów. Gdy dostępne są
...
Analiza ryzyka jest wewnętrznie zasilana przez ClawScan, własny system audytów bezpieczeństwa
ClawHub. Przegląda każde wydanie jako artefakt skierowany do agentów: instrukcje,
...
jako perspektywy dla ryzyk takich jak wstrzyknięcie promptu, niewłaściwe użycie narzędzi, ujawnienie poświadczeń,
