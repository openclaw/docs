...
read_when:
    - Publikowanie dusz
    - Debugowanie niepowodzeń publikacji duszy
...
- `description` jest używane jako podsumowanie duszy w UI/wyszukiwaniu.
...
- Tagi są wskaźnikami tekstowymi do wersji; `latest` jest często używany.
