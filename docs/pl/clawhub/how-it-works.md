...
- changelogiem i informacjami o tagach, takimi jak `latest`
...
metadane są ważne, ponieważ pomagają użytkownikom zdecydować, czy zainstalować umiejętność, i
...
Używaj próbnych uruchomień, aby podejrzeć rozwiązany ładunek przed przesłaniem. Strony publiczne następnie
pokazują opublikowane metadane, pliki, przypisanie źródła i stan skanowania.
...
pobierania. Katalogi firm trzecich mogą używać tych API, gdy linkują z powrotem do
