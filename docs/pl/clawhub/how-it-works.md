---
read_when:
    - Zrozumienie listingów, wersji, instalacji, publikowania i moderacji
...
plugin deklaruje, że robi, przed jego instalacją.

## Skills

Umiejętność to wersjonowany pakiet tekstowy skoncentrowany na `SKILL.md`. Może zawierać
...
Używaj próbnych uruchomień, aby podejrzeć rozwiązany ładunek przed przesłaniem. Publiczne strony następnie
...
aktualizacji umiejętności dla użytkowników, którzy chcą zarządzanych przez rejestr folderów umiejętności poza
