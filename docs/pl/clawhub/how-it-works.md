...
OpenClaw zapisuje metadane źródła instalacji, aby późniejsze aktualizacje mogły rozwiązać ten sam
...
pobrań. Katalogi innych firm mogą używać tych API, gdy linkują do
