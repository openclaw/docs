...
x-i18n:
    generated_at: "2026-07-03T09:59:40Z"
    model: gpt-5.5
...
- stan skanowania zabezpieczeń i moderacji

Strona pozycji jest kanonicznym miejscem, w którym użytkownicy mogą sprawdzić,
co Skills lub plugin deklaruje, że robi, przed jego instalacją.

## Skills

Skills to wersjonowany pakiet tekstowy skoncentrowany wokół `SKILL.md`. Może
...
ponieważ pomagają użytkownikom zdecydować, czy zainstalować Skills, oraz
...
zarządzać folderami Skills przez rejestr poza pełnym obszarem roboczym OpenClaw.
...
pakietów i pobierania. Katalogi stron trzecich mogą używać tych API, gdy linkują
z powrotem do kanonicznej pozycji ClawHub, przestrzegają limitów szybkości i
unikają sugerowania rekomendacji.
