...
summary: Jak działają wpisy w ClawHub, wersje, instalacje, publikowanie, skanowanie i aktualizacje.
x-i18n:
    generated_at: "2026-07-04T20:43:59Z"
    model: gpt-5.5
...
co dana umiejętność lub plugin deklaruje, że robi, przed jej instalacją.
...
pomagają automatycznym skanom wykrywać niezgodności między deklarowanym i zaobserwowanym zachowaniem.
...
Publikowanie tworzy nowy niemutowalny rekord wersji. Wydawcy używają `clawhub`
CLI do uwierzytelnionych przepływów pracy rejestru:
...
pakiet rejestru. ClawHub CLI obsługuje także bezpośrednie przepływy pracy instalowania i
aktualizowania umiejętności dla użytkowników, którzy chcą folderów umiejętności zarządzanych przez rejestr poza
...
widoczne dla właściciela w celach diagnostycznych.
