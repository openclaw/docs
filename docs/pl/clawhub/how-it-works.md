...
x-i18n:
    generated_at: "2026-07-04T06:51:24Z"
    model: gpt-5.5
...
co dana skill lub Plugin deklaruje, że robi, przed jej instalacją.
...
pobrań. Katalogi stron trzecich mogą używać tych API, gdy linkują z powrotem do
