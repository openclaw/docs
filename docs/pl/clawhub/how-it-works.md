...
ClawHub to warstwa rejestru dla Skills i Plugin OpenClaw. Daje użytkownikom
...
Plugin to spakowane rozszerzenia OpenClaw. ClawHub przechowuje metadane pakietów,
...
Strony publiczne pokazują następnie opublikowane metadane, pliki, atrybucję źródła
i status skanowania.
...
ClawHub udostępnia publiczne API odczytu do odkrywania, wyszukiwania, szczegółów pakietów
i pobrań. Katalogi innych firm mogą używać tych API, gdy linkują z powrotem do
