...
x-i18n:
    generated_at: "2026-07-01T13:22:37Z"
    model: gpt-5.5
...
OpenClaw wystarczająco metadanych, aby bezpiecznie instalować i aktualizować te pakiety.
...
co według deklaracji robi umiejętność lub plugin przed instalacją.
...
pomagają automatycznym skanom wykrywać niezgodności między zadeklarowanym a
...
prezentują opublikowane metadane, pliki, przypisanie źródła i stan skanowania.
...
kanonicznej pozycji ClawHub, respektują limity szybkości i nie sugerują poparcia.
