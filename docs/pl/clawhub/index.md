...
Same specyfikacje pluginów zgodne z npm mogą być rozwiązywane przez npm podczas przejściowych wdrożeń uruchomieniowych, a
...
instalacyjnych, pozostając widoczne dla właściciela w `/dashboard`.
