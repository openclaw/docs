...
title: ClawHub
x-i18n:
    generated_at: "2026-07-03T17:45:47Z"
    model: gpt-5.5
...
Zainstaluj CLI ClawHub, gdy potrzebujesz przepływów uwierzytelnianych przez rejestr, takich jak
...
Same specyfikacje pluginów bezpieczne dla npm mogą być rozwiązywane przez npm podczas przejściowych zmian startowych, a
...
CLI ClawHub służy do pracy uwierzytelnianej przez rejestr:
...
- `--slug <slug>`: nazwa opublikowanego URL skilla.
...
`openclaw.build.openclawVersion`. Zobacz [CLI](/pl/clawhub/cli), aby poznać pełną dokumentację poleceń,
oraz [Format Skills](/clawhub/skill-format), aby poznać metadane Skills.
