...
summary: Publiczny przegląd ClawHub dotyczący wyszukiwania, instalacji, publikowania, bezpieczeństwa oraz CLI clawhub.
title: ClawHub
x-i18n:
    generated_at: "2026-05-10T19:26:18Z"
    model: gpt-5.5
    provider: openai
...
publikowanie, synchronizacja, usuwanie/przywracanie lub ponowne skanowania wymagane przez właściciela:
...
| Dusze          | Pakiety `SOUL.md` pokazywane na onlycrabs.ai               | Przepływy publikowania przez Web i API       |
...
stan rejestru, aby użytkownicy mogli sprawdzić Skill lub Plugin przed jego instalacją.
...
Nieoznakowane specyfikacje Pluginów bezpieczne dla npm mogą być rozwiązywane przez npm podczas przejść startowych, a
...
Właściciele mogą prosić o ograniczone ponowne skanowania w celu odzyskania po wynikach fałszywie dodatnich. Moderatorzy
i administratorzy platformy mogą prosić o ponowne skanowania dowolnego Skill lub pakietu podczas obsługi
zgłoszeń wsparcia:
...
ukrywać lub przywracać treści, rozstrzygać odwołania i blokować konta nadużywające zasad. Zobacz
[Akceptowalne użytkowanie](/pl/clawhub/acceptable-usage) i
