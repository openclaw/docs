...
summary: Publiczne omówienie ClawHub dotyczące odkrywania, instalacji, publikowania, bezpieczeństwa i CLI `clawhub`.
title: ClawHub
x-i18n:
    generated_at: "2026-07-01T13:22:29Z"
    model: gpt-5.5
...
pobrania, gwiazdki i podsumowania skanów bezpieczeństwa. Publiczne strony pokazują bieżący
...
Instalacje pluginów walidują deklarowaną zgodność `pluginApi` i `minGatewayVersion`
...
CLI ma również polecenia instalacji/aktualizacji Skills dla bezpośrednich przepływów rejestrowych:
...
- `--slug <slug>`: nazwa URL opublikowanego skillu.
...
poleceń, oraz [Format skillu](/clawhub/skill-format), aby uzyskać metadane skillu.
...
ClawHub uruchamia zautomatyzowane kontrole opublikowanych Skills i wydań pluginów. Wydania
wstrzymane przez skanowanie lub zablokowane mogą zniknąć z publicznego katalogu i powierzchni instalacji,
...
w trybie najlepszych starań, aby ClawHub mógł obliczać zagregowane liczniki instalacji. Wyłącz to za pomocą:
