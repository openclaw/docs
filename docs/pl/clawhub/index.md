...
| Pluginy pakietowe | Spakowane pakiety pluginów dla dystrybucji OpenClaw              | `clawhub package publish <source>`           |
...
metadane źródła, dzięki czemu późniejsze polecenia aktualizacji mogą pozostać przy ClawHub.

Używaj `clawhub:<package>`, gdy instalacja pluginu ma być rozwiązywana przez ClawHub.
Gołe specyfikacje pluginów bezpieczne dla npm mogą być rozwiązywane przez npm podczas przełączeń wdrożeniowych, a
...
dokumentację poleceń, oraz [Format Skill](/clawhub/skill-format), aby poznać metadane Skills.
...
ClawHub uruchamia automatyczne kontrole opublikowanych Skills i wydań pluginów. Wydania wstrzymane
przez skanowanie lub zablokowane mogą zniknąć z publicznego katalogu i powierzchni instalacji,
...
w trybie najlepszych starań, aby ClawHub mógł obliczać zbiorcze liczby instalacji. Wyłącz to za pomocą:
