...
title: ClawHub
x-i18n:
    generated_at: "2026-07-03T23:43:10Z"
    model: gpt-5.5
...
pobrania, gwiazdki i podsumowania skanowania bezpieczeństwa. Publiczne strony pokazują bieżący stan rejestru,
...
Użyj `--dry-run`, aby zbudować dokładny plan publikowania bez przesyłania, oraz `--json`
...
oraz [Format Skill](/clawhub/skill-format), aby poznać metadane Skill.
...
zdarzenie instalacji, aby ClawHub mógł obliczać zbiorcze liczby instalacji. Wyłącz to za pomocą:
