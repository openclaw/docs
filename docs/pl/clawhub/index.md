...
title: ClawHub
x-i18n:
    generated_at: "2026-07-02T01:17:02Z"
    model: gpt-5.5
...
| Pluginy kodu      | Pakiety Plugin OpenClaw z metadanymi zgodności                   | `openclaw plugins install clawhub:<package>` |
...
Surowe specyfikacje pluginów zgodne z npm mogą być rozwiązywane przez npm podczas przełączeń uruchomieniowych, a
...
Zobacz [Telemetria](/clawhub/telemetry), [API HTTP](/clawhub/http-api) oraz
