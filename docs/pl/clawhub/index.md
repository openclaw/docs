...
read_when:
    ...
    - Wyszukiwanie, instalowanie lub aktualizowanie Skills albo Plugin
    - Publikowanie Skills lub Plugin w rejestrze
    - Wybór między przepływami CLI openclaw i clawhub
sidebarTitle: ClawHub
summary: Publiczne omówienie ClawHub dotyczące wyszukiwania, instalacji, publikowania, bezpieczeństwa i CLI clawhub.
title: ClawHub
x-i18n:
...
- Używaj oddzielnego CLI `clawhub` do uwierzytelniania w rejestrze, publikowania, usuwania/przywracania usuniętych elementów oraz przepływów synchronizacji.
...
- `--changelog <text>`: tekst changelogu.
...
pozostając jednocześnie widoczne dla właściciela w `/dashboard`.
