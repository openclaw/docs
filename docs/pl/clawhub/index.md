...
title: ClawHub
x-i18n:
    generated_at: "2026-07-05T08:45:26Z"
    model: gpt-5.5
...
Same specyfikacje pluginów zgodne z npm mogą być rozwiązywane przez npm podczas przełączeń uruchomieniowych, a
...
nagłówek skrótu ClawHub oraz pobrane bajty, a następnie zapisuje metadane artefaktu na potrzeby
...
- `--slug <slug>`: nazwa opublikowanego adresu URL Skill.
...
poleceń, oraz [Format Skills](/clawhub/skill-format), aby uzyskać metadane Skills.
...
wstrzymane przez skan lub zablokowane mogą zniknąć z publicznego katalogu i powierzchni instalacji, pozostając
...
ukrywać lub przywracać treści oraz banować konta naruszające zasady. Zobacz
...
Gdy uruchamiasz `clawhub install` po zalogowaniu, CLI może wysłać zdarzenie instalacji typu best-effort,
...
Zobacz [Telemetria](/pl/clawhub/telemetry), [HTTP API](/clawhub/http-api) oraz
[Rozwiązywanie problemów](/clawhub/troubleshooting), aby uzyskać głębsze materiały referencyjne.
