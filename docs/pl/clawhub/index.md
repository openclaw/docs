...
Gołe specyfikacje pluginów zgodne z npm mogą być rozwiązywane przez npm podczas przełączeń wdrożeniowych, a
...
[Dopuszczalne użycie](/clawhub/acceptable-usage), aby poznać szczegóły zasad i egzekwowania.
