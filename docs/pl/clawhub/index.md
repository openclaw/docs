...
title: ClawHub
x-i18n:
    generated_at: "2026-07-03T10:01:01Z"
    model: gpt-5.5
...
Proste specyfikacje pluginów zgodne z npm mogą być rozwiązywane przez npm podczas przejść
startowych, a `npm:<package>` pozostaje wyłącznie npm, gdy źródło musi być jawne.
...
nagłówek skrótu ClawHub oraz pobrane bajty, a także zapisuje metadane artefaktu na potrzeby
...
referencję poleceń, oraz [Format Skills](/clawhub/skill-format), aby poznać metadane Skills.
...
na zasadzie najlepszej próby, aby ClawHub mógł obliczać zagregowane liczby instalacji. Wyłącz to za pomocą:
