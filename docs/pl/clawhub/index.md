...
Użyj `clawhub:<package>`, gdy instalacja plugin powinna zostać rozwiązana przez ClawHub.
Gołe specyfikacje plugin bezpieczne dla npm mogą być rozwiązywane przez npm podczas przejść przy uruchomieniu, a
...
CLI ma także polecenia instalowania/aktualizowania Skills dla bezpośrednich przepływów rejestrowych:
...
Publikuj plugins z lokalnego folderu, `owner/repo`, `owner/repo@ref` lub adresu URL
GitHub:
...
[Zasady dopuszczalnego użytkowania](/pl/clawhub/acceptable-usage) oraz
