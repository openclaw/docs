...
title: ClawHub
x-i18n:
    generated_at: "2026-07-03T02:57:02Z"
    model: gpt-5.5
...
- Używaj osobnego CLI `clawhub` do uwierzytelniania w rejestrze, publikowania oraz przepływów usuwania/cofania usunięcia.
...
publikowanie lub usuwanie/cofanie usunięcia:
...
Gołe specyfikacje pluginów zgodne z npm mogą być rozwiązywane przez npm podczas przełączeń startowych, a
...
opis poleceń, oraz [Format Skill](/clawhub/skill-format), aby poznać metadane Skill.
