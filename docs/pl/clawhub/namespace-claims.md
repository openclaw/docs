...
read_when:
    ...
    - Podejmowanie decyzji, czy użyć zgłoszenia, odwołania czy roszczenia do namespace
sidebarTitle: Org and Namespace Claims
summary: Jak poprosić o przegląd ClawHub w sporach dotyczących własności organizacji, marki, uchwytu właściciela, zakresu pakietu, identyfikatora skill-slug lub przestrzeni nazw.
...
ClawHub używa uchwytów właścicieli, uchwytów organizacji, identyfikatorów slug Skills, nazw pakietów Plugin oraz
...
przestrzeń nazw powinna zostać zarezerwowana, przeniesiona, przemianowana, ukryta, objęta kwarantanną, otrzymać alias
...
- identyfikator slug Skills lub nazwa pakietu Plugin, które wydają się podszywać pod projekt
...
zmianę nazwy, przeniesienie, ukrycie albo usunięcie zasobu, którego dotyczy problem. Użyj roszczenia,
