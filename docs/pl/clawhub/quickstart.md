...
summary: 'Zacznij korzystać z ClawHub: znajdź, zainstaluj, aktualizuj i publikuj skills lub pluginy.'
x-i18n:
    generated_at: "2026-07-03T17:43:52Z"
    model: gpt-5.5
...
Środowiska bez interfejsu graficznego mogą użyć tokenu API z internetowego interfejsu ClawHub:
...
Polecenie pomija niezmienioną treść. Nowe umiejętności zaczynają od `1.0.0`; późniejsze zmiany
...
`skill publish` dla każdego bezpośredniego folderu umiejętności pod `skills/`:
...
moderację mogą być ukryte w wyszukiwarce i miejscach instalacji do czasu rozwiązania sprawy.
