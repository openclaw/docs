...
x-i18n:
    generated_at: "2026-07-02T01:17:09Z"
    model: gpt-5.5
...
Środowiska bez interfejsu graficznego mogą użyć tokena API z internetowego UI ClawHub:
...
Polecenie pomija niezmienioną zawartość. Nowe umiejętności zaczynają od `1.0.0`; późniejsze zmiany
...
W przypadku repozytoriów zawierających wiele umiejętności przepływ pracy wielokrotnego użytku GitHub wywołuje
...
Publiczne pozycje pokazują najnowszy stan skanowania. Wydania wstrzymane lub zablokowane przez
