...
summary: 'Zacznij używać ClawHub: znajduj, instaluj, aktualizuj i publikuj Skills lub pluginy.'
x-i18n:
...
Gdy jesteś zalogowany, `sync` może także wysłać minimalną migawkę instalacji do
zbiorczych liczników instalacji. Zobacz [Telemetria](/pl/clawhub/telemetry), aby
sprawdzić, co jest raportowane i jak zrezygnować.
...
zablokowane przez moderację mogą być ukryte w wyszukiwarce i miejscach instalacji
