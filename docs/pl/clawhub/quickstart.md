...
x-i18n:
    generated_at: "2026-07-02T22:51:35Z"
    model: gpt-5.5
...
ClawHub, a nie npm ani inne źródło.
...
Polecenie pomija niezmienioną zawartość. Nowe umiejętności zaczynają od wersji `1.0.0`; późniejsze zmiany
...
moderację mogą być ukryte w wyszukiwarce i na powierzchniach instalacji do czasu rozwiązania problemu.
