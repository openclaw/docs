...
x-i18n:
    generated_at: "2026-06-28T20:42:37Z"
    model: gpt-5.5
...
OpenClaw zapisuje, skąd pochodził skill, aby późniejsze aktualizacje mogły nadal
...
Środowiska bez interfejsu graficznego mogą użyć tokena API z webowego UI ClawHub:
