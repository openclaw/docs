...
x-i18n:
    generated_at: "2026-07-02T17:47:50Z"
    model: gpt-5.5
...
Środowiska bez interfejsu graficznego mogą używać tokena API z webowego UI ClawHub:
...
Najpierw użyj `--dry-run`, aby wyświetlić podgląd rozwiązanych metadanych pakietu, pól
zgodności, atrybucji źródła i planu przesłania bez publikowania.
...
metadane, linki do źródeł, wersje, dzienniki zmian i status skanowania:
