...
summary: 'Zacznij korzystać z ClawHub: znajduj, instaluj, aktualizuj i publikuj Skills lub wtyczki.'
x-i18n:
    generated_at: "2026-07-04T18:23:20Z"
    model: gpt-5.5
...
gdy się logujesz, publikujesz, zarządzasz własnymi wpisami albo korzystasz
...
`--dry-run`, aby wyświetlić podgląd, albo `--version`, aby wybrać jawną wersję.
...
Najpierw użyj `--dry-run`, aby wyświetlić podgląd rozpoznanych metadanych pakietu, pól
zgodności, atrybucji źródła i planu przesyłania bez publikowania.
