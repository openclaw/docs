...
x-i18n:
    generated_at: "2026-07-03T23:44:28Z"
    model: gpt-5.5
...
OpenClaw zapisuje, skąd pochodziła umiejętność, aby późniejsze aktualizacje mogły nadal
...
automatycznie publikują kolejną wersję poprawkową. Użyj `--dry-run`, aby zobaczyć podgląd, lub
