...
Możesz zbudować katalog, spis lub powierzchnię wyszukiwania innej firmy na publicznych API odczytu ClawHub. Publiczne metadane Skills i pliki Skills są publikowane zgodnie z regułami licencji Skills ClawHub, natomiast samo API ma limity szybkości i powinno być używane odpowiedzialnie.
...
- Linkuj z powrotem do kanonicznego adresu URL Skills ClawHub podczas wyświetlania list, aby użytkownicy mogli sprawdzić źródłowy rekord rejestru.
...
- Błędy v1 są zwykłym tekstem (`text/plain; charset=utf-8`), w tym `400`,
  `401`, `403`, `404`, `429` i odpowiedzi z zablokowanego pobierania.
