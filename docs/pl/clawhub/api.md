...
x-i18n:
    generated_at: "2026-07-01T13:22:41Z"
    model: gpt-5.5
...
Możesz zbudować katalog, spis lub powierzchnię wyszukiwania innej firmy na publicznych API odczytu ClawHub. Publiczne metadane Skills i pliki Skills są publikowane zgodnie z zasadami licencji Skills ClawHub, natomiast samo API ma limity szybkości i powinno być używane odpowiedzialnie.
...
- Nie sugeruj, że ClawHub zatwierdza, weryfikuje lub obsługuje witrynę innej firmy.
- Nie twórz kopii lustrzanych ukrytych, prywatnych ani zablokowanych moderacyjnie treści przez omijanie filtrów publicznego API lub granic uwierzytelniania.
