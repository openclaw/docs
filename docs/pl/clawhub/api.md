...
x-i18n:
    generated_at: "2026-07-02T01:16:30Z"
    model: gpt-5.5
...
Możesz zbudować zewnętrzny katalog, directory lub powierzchnię wyszukiwania na podstawie publicznych API odczytu ClawHub. Publiczne metadane Skills i pliki Skills są publikowane zgodnie z regułami licencji Skills ClawHub, natomiast samo API ma limity szybkości i powinno być używane odpowiedzialnie.
...
- Nie odzwierciedlaj ukrytych, prywatnych ani zablokowanych przez moderację treści przez omijanie publicznych filtrów API lub granic uwierzytelniania.
...
- Żądania uwierzytelnione (prawidłowy token Bearer): na koszyk użytkownika.
...
- Nieznane parametry zapytania są ignorowane w celu zgodności.
