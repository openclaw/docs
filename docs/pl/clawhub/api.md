...
Możesz zbudować katalog, spis lub powierzchnię wyszukiwania innej firmy na publicznych interfejsach API odczytu ClawHub. Publiczne metadane Skills i pliki Skills są publikowane zgodnie z zasadami licencji Skills w ClawHub, a sam API ma ograniczenia szybkości i powinien być używany odpowiedzialnie.
...
- Podczas wyświetlania list odsyłaj do kanonicznego adresu URL Skills w ClawHub, aby użytkownicy mogli sprawdzić źródłowy rekord rejestru.
...
- Nie twórz kopii ukrytych, prywatnych ani zablokowanych przez moderację treści przez omijanie filtrów publicznego API lub granic uwierzytelniania.
...
Egzekwowanie uwzględniające uwierzytelnienie:
