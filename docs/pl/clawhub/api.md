...
Możesz zbudować katalog, spis lub powierzchnię wyszukiwania innej firmy na publicznych interfejsach API odczytu ClawHub. Publiczne metadane Skills i pliki Skills są publikowane zgodnie z zasadami licencji Skills w ClawHub, natomiast sam interfejs API ma limity szybkości i powinien być używany odpowiedzialnie.
...
- Nie odzwierciedlaj ukrytych, prywatnych ani zablokowanych moderacją treści przez omijanie publicznych filtrów API lub granic uwierzytelniania.
...
- Brakujący/nieprawidłowy token przechodzi na egzekwowanie według IP.
