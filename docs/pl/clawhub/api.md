...
Możesz zbudować zewnętrzny katalog, spis lub interfejs wyszukiwania na podstawie publicznych interfejsów API ClawHub do odczytu. Publiczne metadane umiejętności i pliki umiejętności są publikowane zgodnie z regułami licencyjnymi umiejętności ClawHub, natomiast samo API ma limity szybkości i powinno być używane odpowiedzialnie.
...
- Podczas wyświetlania list linkuj z powrotem do kanonicznego adresu URL umiejętności w ClawHub, aby użytkownicy mogli sprawdzić źródłowy rekord rejestru.
...
- Nie kopiuj ukrytych, prywatnych ani zablokowanych moderacyjnie treści przez omijanie publicznych filtrów API lub granic uwierzytelniania.
