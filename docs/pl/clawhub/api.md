...
Możesz zbudować katalog, katalog tematyczny lub powierzchnię wyszukiwania innej firmy na bazie publicznych API odczytu ClawHub. Publiczne metadane Skills i pliki Skills są publikowane zgodnie z zasadami licencji Skills ClawHub, natomiast samo API ma limity szybkości i powinno być używane odpowiedzialnie.
...
- Używaj kanonicznych URL stron w formacie `https://clawhub.ai/<owner>/<slug>`.
- Nie sugeruj, że ClawHub rekomenduje, weryfikuje lub obsługuje witrynę innej firmy.
