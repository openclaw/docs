...
x-i18n:
    generated_at: "2026-07-04T06:51:26Z"
    model: gpt-5.5
...
Możesz zbudować katalog, spis lub powierzchnię wyszukiwania innej firmy na publicznych interfejsach API odczytu ClawHub. Publiczne metadane umiejętności i pliki umiejętności są publikowane zgodnie z zasadami licencji umiejętności ClawHub, natomiast samo API ma limity szybkości i powinno być używane odpowiedzialnie.
