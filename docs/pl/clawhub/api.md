...
x-i18n:
    generated_at: "2026-07-04T15:38:29Z"
    model: gpt-5.5
...
Możesz zbudować katalog, katalog stron lub powierzchnię wyszukiwania innej firmy na publicznych interfejsach API odczytu ClawHub. Publiczne metadane Skills i pliki Skills są publikowane zgodnie z zasadami licencji Skills w ClawHub, natomiast sam interfejs API ma ograniczenia szybkości i powinien być używany odpowiedzialnie.
