...
Konta usunięte, zbanowane lub wyłączone nie mogą ukończyć normalnego logowania w ClawHub.
...
CLI wyświetla kod jednorazowy i czeka, gdy autoryzujesz go pod adresem
