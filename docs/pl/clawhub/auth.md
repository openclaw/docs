...
x-i18n:
    generated_at: "2026-07-01T15:31:20Z"
    model: gpt-5.5
...
Konta usunięte, zablokowane lub wyłączone nie mogą ukończyć zwykłego logowania do ClawHub.
Jeśli po logowaniu wracasz do stanu wylogowania, Twoje konto może nie być w dobrej
kondycji. Jeśli Twoje konto zostało zablokowane lub wyłączone, użyj
...
reguł proxy, użyj przepływu tokena bez przeglądarki.
...
Konta usunięte, zablokowane lub wyłączone nie mogą dalej używać istniejących tokenów API.
