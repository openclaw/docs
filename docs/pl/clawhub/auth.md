...
x-i18n:
    generated_at: "2026-07-04T20:43:47Z"
    model: gpt-5.5
...
Jeśli przeglądarka nie może połączyć się z lokalnym callbackiem z powodu zapory, VPN lub
...
Używaj tego przepływu dla serwerów, zadań CI lub środowisk dostępnych tylko z terminala.
