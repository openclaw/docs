...
Usunięte, zbanowane lub wyłączone konta nie mogą ukończyć standardowego logowania ClawHub.
...
CLI wyświetli jednorazowy kod i będzie czekać, aż autoryzujesz go pod adresem
...
Możesz unieważniać tokeny API w interfejsie internetowym ClawHub.
