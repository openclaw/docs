...
ClawHub używa GitHub do logowania w webie. CLI używa tokenów API ClawHub utworzonych
...
Jeśli logowanie przywraca Cię do stanu wylogowania, Twoje konto może nie mieć
dobrej reputacji.
...
Możesz unieważnić tokeny API w webowym interfejsie użytkownika ClawHub.
