...
Jeśli logowanie przywraca stan wylogowania, Twoje konto może nie być w dobrej
...
4. Przeglądarka przekierowuje z powrotem do lokalnego adresu zwrotnego.
5. CLI zapisuje token w pliku konfiguracji ClawHub.

Jeśli przeglądarka nie może połączyć się z lokalnym adresem zwrotnym z powodu reguł zapory, VPN lub
proxy, użyj bezgłowego przepływu z tokenem.
...
Użyj tego przepływu na serwerach, w zadaniach CI lub w środowiskach wyłącznie terminalowych.
