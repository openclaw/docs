...
x-i18n:
    generated_at: "2026-07-04T04:08:36Z"
    model: gpt-5.5
...
Konta usunięte, zablokowane lub wyłączone nie mogą ukończyć normalnego logowania do ClawHub.
...
Jeśli przeglądarka nie może dotrzeć do lokalnego wywołania zwrotnego z powodu reguł
zapory, VPN lub proxy, użyj przepływu tokenu bez interfejsu graficznego.
