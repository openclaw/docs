...
x-i18n:
    generated_at: "2026-07-01T20:36:50Z"
    model: gpt-5.5
...
Usunięte, zbanowane lub wyłączone konta nie mogą ukończyć zwykłego logowania do ClawHub.
...
W przypadku powłok zdalnych, w których możesz otworzyć przeglądarkę gdzie indziej, uruchom:
