...
summary: Jak zgłaszać problemy bezpieczeństwa ClawHub i kiedy luki są ujawniane publicznie.
title: Bezpieczeństwo
x-i18n:
    generated_at: "2026-06-28T00:11:58Z"
    model: gpt-5.5
...
Nie używaj zgłoszeń doradczych ClawHub do luk w zabezpieczeniach w kodzie źródłowym
umiejętności lub pluginu innej firmy. Zgłaszaj je bezpośrednio wydawcy albo do repozytorium
źródłowego podanego w wpisie ClawHub.
...
Luki w zabezpieczeniach w oprogramowaniu instalowanym przez użytkowników są ujawniane publicznie, na przykład
...
Informacje o zgłoszeniach z marketplace, blokadach moderacyjnych, ukrytych wpisach, banach i statusie konta
