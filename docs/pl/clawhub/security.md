...
summary: Jak zgłaszać problemy bezpieczeństwa ClawHub i kiedy luki są publicznie ujawniane.
title: Bezpieczeństwo
x-i18n:
    generated_at: "2026-07-04T20:44:50Z"
    model: gpt-5.5
...
Użyj GitHub Security Advisories dla podatności w samym ClawHub. Dobre
...
Nie używaj zgłoszeń doradczych ClawHub dla podatności we własnym kodzie źródłowym Skills lub Pluginu innej firmy. Zgłaszaj je bezpośrednio do wydawcy lub repozytorium źródłowego powiązanego z wpisem w ClawHub.
...
Przykłady rzeczywistego wpływu na użytkowników obejmują potwierdzone wykorzystanie, ujawnienie danych użytkowników lub sekretów, złośliwe treści docierające do użytkowników z powodu awarii platformy albo każdy problem, który wymaga od użytkowników rotacji poświadczeń, aktualizacji lokalnego oprogramowania lub podjęcia innych działań ochronnych.
...
Informacje o zgłoszeniach marketplace, wstrzymaniach moderacyjnych, ukrytych wpisach, blokadach i statusie konta znajdziesz w [Moderacji i bezpieczeństwie konta](/clawhub/moderation).
