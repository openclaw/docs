---
read_when:
    - Zgłaszanie problemu z zabezpieczeniami ClawHub
...
x-i18n:
    generated_at: "2026-07-04T15:38:02Z"
    model: gpt-5.5
...
Nie używaj ClawHub advisories do zgłaszania podatności w kodzie źródłowym
umiejętności lub wtyczki strony trzeciej. Zgłaszaj je bezpośrednio wydawcy albo
do repozytorium źródłowego wskazanego w wpisie ClawHub.

## Ujawnianie podatności

Ponieważ ClawHub jest hostowaną aplikacją chmurową, podatności usługi ClawHub
domyślnie nie są publicznie ujawniane. Są ujawniane publicznie, gdy istnieją
...
ujawnienie danych użytkownika lub sekretów, dotarcie złośliwej treści do
użytkowników z powodu awarii platformy albo każdy problem wymagający od
...
publicznie, na przykład pakiety ClawHub CLI, pliki binarne, biblioteki lub inne
...
Informacje o zgłoszeniach marketplace, blokadach moderacyjnych, ukrytych wpisach,
banach i statusie konta znajdziesz w [Moderacji i bezpieczeństwie konta](/clawhub/moderation).
