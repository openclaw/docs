...
summary: Wygenerowana mapa nagłówków stron dokumentacji OpenClaw
title: Mapa dokumentacji
x-i18n:
    generated_at: "2026-07-04T06:52:02Z"
    model: gpt-5.5
...
- Nagłówki:
  ...
  - H3: Konfiguracja kreatora (zalecana)
...
- Nagłówki:
  ...
  - H2: Nadpisywanie dla kanału lub konta
  - H2: Obsługa kanałów
...
- Nagłówki:
  ...
  - H2: Zasady grupy
  - H2: Bramkowanie przez wzmiankę (domyślne)
...
- Nagłówki:
  ...
  - H3: Różne narzędzia dla nadawcy (właściciel dostaje większe uprawnienia)
  - H2: NickServ
...
- Nagłówki:
  ...
  - H3: Format docelowy listy dozwolonych
...
- Nagłówki:
  ...
  - H2: Identyfikatory zespołu i kanału (typowa pułapka)
  - H2: Kanały prywatne
  - H2: Rozwiązywanie problemów
  - H3: Typowe problemy
...
- Nagłówki:
  ...
  - H3: Wysyłki wychodzące nie powiodły się
...
- Nagłówki:
  ...
  - H2: Typowe polecenia
  - H2: Zastępowanie zatwierdzeń z pliku
  - H2: Przykład „Never prompt” / YOLO
  - H2: Helpery listy dozwolonych
  - H2: Typowe opcje
  - H2: Uwagi
  - H2: Powiązane
...
- Nagłówki:
  ...
  - H3: Pomijanie nieaktualnych potwierdzeń
  - H3: Ciche pomijanie tokenów
...
- Nagłówki:
  ...
  - H2: Typowe opcje
  - H2: Uwagi
  - H2: Lista kontrolna odzyskiwania po dryfie tokena
  - H2: Powiązane
...
- Nagłówki:
  ...
  - H3: Instalacja za pomocą wrappera
...
- Nagłówki:
  ...
  - H3: Typowe przepisy serwera
  - H3: Kształty wyjścia JSON
  - H3: Transport Stdio
  - H3: Transport SSE / HTTP
  - H3: Przepływ pracy OAuth
  - H3: Transport HTTP z przesyłaniem strumieniowym
  - H2: Control UI
...
- Nagłówki:
  ...
  - H3: Nieinteraktywne wybory punktów końcowych Z.AI
...
- Nagłówki:
  ...
  - H2: Utrzymanie przez czyszczenie
  - H2: Skompaktuj sesję
...
- Nagłówki:
  ...
  - H3: Gateway (daemon)
  - H3: Klienty (aplikacja na Maca / CLI / administracja webowa)
  - H3: Node'y (macOS / iOS / Android / bez interfejsu)
  - H3: WebChat
  - H2: Cykl życia połączenia (pojedynczy klient)
  - H2: Protokół transmisyjny (podsumowanie)
...
- Nagłówki:
  - H2: Jak to działa
  - H2: Automatyczne Compaction
  - H2: Ręczne Compaction
  - H2: Konfiguracja
  - H3: Używanie innego modelu
  - H3: Zachowywanie identyfikatorów
  - H3: Ochrona liczby bajtów aktywnego transkryptu
...
- Nagłówki:
  ...
  - H2: Model faz
  - H2: Pobieranie transkryptu sesji
  - H2: Dziennik snów
...
- Nagłówki:
  ...
  - H2: Tryb odchudzony modelu lokalnego
  - H3: Dlaczego te trzy narzędzia
  - H3: Kiedy to włączyć
  - H3: Kiedy zostawić to wyłączone
  - H3: Włącz
...
- Nagłówki:
  - H2: Co dodaje względem wbudowanej funkcji
  - H2: Pierwsze kroki
...
- Nagłówki:
  ...
  - H2: Dreaming
  - H2: Ugruntowane uzupełnianie i promowanie na żywo
  - H2: CLI
  - H2: Dalsza lektura
  - H2: Powiązane
...
- Nagłówki:
  ...
  - H4: Nietypowe zachowania, które warto znać
...
- Nagłówki:
  - H2: Miejsce przyjmowania tokenów (dlaczego istnieje)
...
- Nagłówki:
  ...
  - H3: Faza 2: priorytety i kontrola współbieżności
...
- Nagłówki:
  - H2: Pola obecności (co jest wyświetlane)
...
- Nagłówki:
  ...
  - H2: Izolacja wiadomości prywatnych
  - H3: Kanały połączone z dokiem
  - H2: Cykl życia sesji
...
- Nagłówki:
  ...
  - H3: Konfiguracja strefy czasowej użytkownika + formatu
...
- Nagłówki:
  ...
  - H3: Repozytorium Skills jako dowiązany symbolicznie katalog równoległy
  - H2: Typowe wzorce
  - H3: Wspólna baza Skills z jednym nadpisaniem
  - H3: Konfiguracja wieloplatformowa
  - H3: Automatyczne zatwierdzanie zaufanej sieci Node
...
- Nagłówki:
  ...
  - H2: Sekrety
  - H3: SecretRef
  - H3: Obsługiwany obszar poświadczeń
...
- Nagłówki:
  ...
  - H2: Dostarczanie reasoning (opcjonalnie)
...
- Nagłówki:
  ...
  - H2: Uwagi Browser/CDP (typowa pułapka)
...
- Nagłówki:
  ...
  - H2: Zachowanie sesji
  - H2: Dlaczego ten obszar ma znaczenie
...
- Nagłówki:
  ...
  - H2: Obszar API (protokół Gateway)
...
- Nagłówki:
  ...
  - H3: Stale działający Gateway w Twojej sieci tailnet
  - H3: Komputer domowy uruchamia Gateway
  - H3: Laptop uruchamia Gateway
  - H2: Przepływ poleceń (co jest uruchamiane gdzie)
...
- Nagłówki:
  ...
  - H3: „Myślałem, że to main, dlaczego działa w piaskownicy?”
  - H2: Powiązane
...
- Nagłówki:
  ...
  - H2: Sygnały degradacji i przywrócenia
...
- Nagłówki:
  ...
  - H2: Kontrole bazowe
  - H2: Minimalny bezpieczny poziom bazowy
  - H2: Ekspozycja DM i grup
  - H2: Kontrole odwrotnego proxy
...
- Nagłówki:
  ...
  - H2: Z założenia nie są podatnościami
  - H2: Utwardzony poziom bazowy w 60 sekund
  ...
  - H2: Konfiguracja odwrotnego proxy
  ...
  - H2: Prompt injection (co to jest, dlaczego ma znaczenie)
  - H2: Sanityzacja specjalnych tokenów w treściach zewnętrznych
  - H2: Flagi obejścia niezabezpieczonych treści zewnętrznych
  ...
  - H3: Bezpieczny poziom bazowy (kopiuj/wklej)
...
- Nagłówki:
  ...
  - H2: Wymagania wstępne i ograniczenia Tailscale
...
- Nagłówki:
  ...
  - H2: Brak odpowiedzi
  - H2: Łączność Dashboard Control UI
  - H3: Szybka mapa kodów szczegółów uwierzytelniania
  - H2: Usługa Gateway nie działa
  - H2: Gateway na macOS po cichu przestaje odpowiadać, a potem wznawia po dotknięciu dashboardu
  - H2: Gateway kończy działanie przy dużym zużyciu pamięci
...
- Nagłówki:
  ...
  - H2: Na żywo: przegląd możliwości Node Androida
  ...
  - H2: Na żywo: test dymny bindowania ACP (/acp spawn ... --bind here)
  ...
  - H3: Poziom bazowy: wywoływanie narzędzi (Read + opcjonalnie Exec)
...
- Nagłówki:
  ...
  - H2: Zestawy testów (co działa gdzie)
  ...
  - H2: Runnery Docker (opcjonalne sprawdzenia „działa na Linuksie”)
  - H2: Sanity check dokumentacji
...
- Nagłówki:
  ...
  - H2: Instalacja Pluginu kończy się niepowodzeniem z brakującymi rozszerzeniami openclaw
...
- Nagłówki:
  ...
  - H2: Konfiguracja zdalnego kanału
  - H2: Zdalny dostęp
  - H2: Aktualizowanie
  - H2: Powiązane
...
- Nagłówki:
  ...
  - H3: Webhooki przy wdrożeniu prywatnym
...
- Nagłówki:
  ...
  - H2: Ręczne usunięcie usługi (CLI nie jest zainstalowane)
  - H3: macOS (launchd)
...
- Nagłówki:
  ...
  - H3: Echo transkrypcji na czat (opcjonalnie)
...
- Nagłówki:
  ...
  - H3: Asemblacja silnika kontekstu musi być projektowana do wejść Codex
  - H3: Stabilność pamięci podręcznej promptów ma znaczenie
  - H3: Semantyka wyboru runtime się nie zmienia
  - H2: Plan implementacji
  - H3: 1. Wyeksportuj lub przenieś wielokrotnego użycia pomocniki prób silnika kontekstu
...
- Nagłówki:
  ...
  - H2: Push wspierany przez przekaźnik dla oficjalnych buildów
...
- Nagłówki:
  ...
  - H2: Presja pamięci i ubicia OOM
  - H2: Powiązane
...
- Nagłówki:
  ...
  - H2: Rozwiązywanie problemów
  - H3: Budowanie kończy się niepowodzeniem: niezgodność toolchaina lub SDK
  - H3: Aplikacja ulega awarii przy nadawaniu uprawnienia
...
- Nagłówki:
  ...
  - H2: Rotowany plik dziennika diagnostycznego (panel Debug)
  - H2: Prywatne dane ujednoliconego rejestrowania w macOS
...
- Nagłówki:
  ...
  - H2: Uprawnienia plików i folderów (Pulpit/Dokumenty/Pobrane)
  - H2: Powiązane
...
- Nagłówki:
  ...
  - H2: Uprawnienia
  - H2: Uwagi dotyczące bezpieczeństwa
  - H2: Przepływ logowania WhatsApp (zdalnie)
  - H2: Rozwiązywanie problemów
...
- Nagłówki:
  - H1: Wybudzanie głosem &amp; naciśnij i mów
  - H2: Wymagania
  - H2: Tryby
  - H2: Zachowanie w czasie wykonywania (słowo wybudzające)
  - H2: Niezmienniki cyklu życia
  - H2: Tryb awarii przyklejonej nakładki (poprzedni)
  - H2: Szczegóły trybu naciśnij i mów
...
- Nagłówki:
  ...
  - H2: Model rejestru
  - H2: Wywołania zwrotne powiązania konwersacji
...
- Nagłówki:
  ...
  - H3: Migawka metadanych Pluginów i tabela wyszukiwania
...
- Nagłówki:
  ...
  - H2: Testuj względem wersji beta
  - H2: Następne kroki
  - H2: Powiązane
...
- Nagłówki:
  ...
  - H3: Wdrożenie Codex zamykane przy błędzie
...
- Nagłówki:
  ...
  - H3: Płaskie aliasy przychodzących callbacków WhatsApp
...
- Nagłówki:
  ...
  - H3: Połączenie Twilio startuje, ale nigdy nie wchodzi na spotkanie
  - H2: Uwagi
  - H2: Powiązane
...
- Nagłówki:
  ...
  - H2: Referencja metadanych narzędzi
...
- Nagłówki:
  ...
  - H2: Limity przypominania i przechwytywania
  - H2: Polecenia
  - H2: Przechowywanie
...
- Nagłówki:
  ...
  - H2: Dashboardy i raporty kondycji
...
- Nagłówki:
  ...
  - H2: Przechowywanie odniesień środowiska uruchomieniowego
...
- Nagłówki:
  ...
  - H3: Promowanie jednego konta zarządzane przez kanał
...
- Nagłówki:
  ...
  - H2: Generowanie muzyki
  - H2: Tekst na mowę
  - H2: Mowa na tekst (przychodzące audio)
  - H2: Router fuzji
...
- Nagłówki:
  ...
  - H3: Faza 3: Zbieranie przy uruchomieniu najpierw według dzierżaw
...
- Nagłówki:
  ...
  - H3: 4) Osadzanie pamięci + wyszukiwanie semantyczne
...
- Nagłówki:
  - H2: Podstawowe pokrętła
  - H3: cacheRetention (domyślne globalne, modelu i na agenta)
  - H3: contextPruning.mode: "cache-ttl"
  - H3: Heartbeat utrzymujący ciepło
...
- Nagłówki:
  ...
  - H2: Wtyczkowi dostawcy Compaction
...
- Nagłówki:
  ...
  - H3: Przykład: utrzymanie ciepłej pamięci podręcznej 1h za pomocą heartbeat
...
- Nagłówki:
  ...
  - H3: Wyniki zdalne i dostarczanie multimediów
...
- Nagłówki:
  ...
  - H3: Potok exec Node (możliwość o najwyższym ryzyku)
  ...
  - H3: Korelacja / idempotencja śladu wejścia
...
- Nagłówki:
  ...
  - H2: Tryby powiązania spawnu i wątków
...
- Nagłówki:
  ...
  - H2: Pokrętła stanu i środowiska
...
- Nagłówki:
  ...
  - H3: Warstwa 5: sprawdź sterowanie przeglądarką end-to-end
  - H2: Częste mylące błędy
  - H2: Szybka lista kontrolna triage'u
...
- Nagłówki:
  ...
  - H2: Konfiguracja
  - H3: Wizja zrzutów ekranu (obsługa modelu tylko tekstowego)
...
- Nagłówki:
  ...
  - H3: Walidacja argv i odrzucane flagi
...
- Nagłówki:
  - H2: Dostępność
  - H2: Odniesienie wejściowe
  - H2: Obsługiwane odniesienia PDF
  - H2: Tryby wykonywania
  - H3: Natywny tryb dostawcy
...
- Nagłówki:
  ...
  - H2: Uprawnienia środowiska ACPX
  - H2: Wybór trybu
  - H2: Powiązane
...
- Nagłówki:
  ...
  - H2: Odniesienie konfiguracji Plugin
  - H2: Uwagi
  - H2: Powiązane
...
- Nagłówki:
  ...
  - H2: Lista dozwolonych wbudowanych Skills
...
- Nagłówki:
  ...
  - H2: Konfiguracja
  - H2: Lista poleceń
  - H3: Polecenia rdzeniowe
  - H3: Polecenia Dock
  - H3: Polecenia wbudowanych Plugins
  - H3: Polecenia Skills
  - H2: /tools — z czego agent może teraz korzystać
  - H2: /model — wybór modelu
  - H2: /config — zapisy konfiguracji na dysku
  - H2: /mcp — konfiguracja serwera MCP
  - H2: /debug — nadpisania wyłącznie w czasie działania
...
- Nagłówki:
  ...
  - H3: Limit spawnowania per agent
...
- Nagłówki:
  ...
  - H3: Kontrolki stylu
  - H3: Zaawansowane
  - H4: Tryb awaryjny i opcje typowane
  - H2: Akcje
  - H2: Wybór modelu
  - H2: Uwagi dotyczące dostawców
  - H2: Tryby możliwości dostawców
...
- Nagłówki:
  ...
  - H2: Użycie zdalne
  - H2: Odniesienie konfiguracji (WebChat)
  - H2: Powiązane
