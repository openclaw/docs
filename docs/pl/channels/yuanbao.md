...
summary: Omówienie, funkcje i konfiguracja bota Yuanbao
title: Yuanbao
x-i18n:
...
przez wiadomości bezpośrednie i czaty grupowe.
...
<Steps>
  <Step title="Dodaj kanał Yuanbao ze swoimi poświadczeniami">
  ```bash
