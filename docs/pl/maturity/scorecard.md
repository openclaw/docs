...
x-i18n:
    generated_at: "2026-06-27T17:44:37Z"
    model: gpt-5.5
...
<div className="maturity-hero">
  <p className="maturity-kicker">gotowość do wydania - wygenerowane z taksonomii + dowodów QA</p>
  <p className="maturity-hero-title">Praktyczny obraz tego, co jest gotowe, co zostało potwierdzone i co nadal wymaga pracy.</p>
  <p>50 powierzchni - 281 obszarów możliwości - deterministyczne pokrycie oraz jakość i kompletność zweryfikowane przez człowieka.</p>
...
Użyj tej strony, aby odpowiedzieć na jedno pytanie: które powierzchnie OpenClaw są wiarygodnymi kandydatami do wydania i jakie dowody wspierają tę ocenę? Pokrycie pochodzi z deterministycznych dowodów QA; jakość i kompletność są utrzymywane jako zweryfikowane wyniki dojrzałości.
...
<div className="maturity-summary-grid">
  <div className="maturity-summary-item maturity-score-alpha">
    ...
    <div className="maturity-summary-meta">
      ...
      <span>Jakość Alpha - 63%</span>
      <span>Kompletność Beta - 70%</span>
    </div>
  </div>
</div>

Pokrycie celowo opiera się na dowodach: obszar nie staje się „gotowy” tylko dlatego, że implementacja istnieje. Nie jest ono składnikiem wyniku dojrzałości, ale OpenClaw dąży do utrzymania pokrycia end-to-end powyżej 90% dla dojrzałych funkcji na poziomie Stable lub wyższym w miarę upływu czasu.

## Przedziały punktacji

<div className="maturity-band-list">
  <div className="maturity-band maturity-band-experimental"><span className="maturity-band-title"><span className="maturity-level-pill maturity-level-experimental">Eksperymentalne</span></span><span>0-50%</span></div>
...
Powierzchnie są uporządkowane według poziomu dojrzałości, kompletności i jakości. Obsługa LTS jest pokazana przy każdym wierszu, aby ułatwić porównywanie opcji gotowych do wydania.

  <Tabs>
  <Tab title="Wszystkie obszary">
    <div className="maturity-surface-table">
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/pl/maturity/taxonomy#channel-framework"><span className="maturity-surface-title">Szkielet kanałów</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>Beta</span></span><span>8 obszarów</span></span></a>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/pl/maturity/taxonomy#browser-automation-exec-and-sandbox-tools"><span className="maturity-surface-title">Narzędzia do automatyzacji przeglądarki, wykonywania poleceń i piaskownicy</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>Beta</span></span><span>3 obszary</span></span></a>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/pl/maturity/taxonomy#long-tail-hosted-providers"><span className="maturity-surface-title">Mniej popularni dostawcy hostowani</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>Alpha</span></span><span>3 obszary</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Pokrycie</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Eksperymentalny</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Jakość</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>61%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "61%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Kompletność</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>68%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "68%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">Brak</span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/pl/maturity/taxonomy#android-app"><span className="maturity-surface-title">Aplikacja Android</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>Alfa</span></span><span>7 obszarów</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Pokrycie</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Eksperymentalne</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
      ...
      <div className="maturity-surface-row">
        ...
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Kompletność</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>54%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "54%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">Brak</span></div>
      </div>
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/pl/maturity/taxonomy#openclaw-app-sdk"><span className="maturity-surface-title">OpenClaw App SDK</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>Alpha</span></span><span>6 obszarów</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Pokrycie</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Eksperymentalne</span><span>3%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "3%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Jakość</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>54%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "54%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Kompletność</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>53%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "53%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">Brak</span></div>
      </div>
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/pl/maturity/taxonomy#ios-app"><span className="maturity-surface-title">Aplikacja iOS</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-experimental"><span className="maturity-level-code">M1</span><span>Eksperymentalne</span></span><span>8 obszarów</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Pokrycie</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Eksperymentalne</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/pl/maturity/taxonomy#voice-call-channel"><span className="maturity-surface-title">Kanał połączeń głosowych</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-experimental"><span className="maturity-level-code">M1</span><span>Eksperymentalne</span></span><span>5 obszarów</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Pokrycie</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Eksperymentalne</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Jakość</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Eksperymentalne</span><span>41%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "41%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Kompletność</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Eksperymentalne</span><span>44%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "44%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">Brak</span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/pl/maturity/taxonomy#linux-companion-app"><span className="maturity-surface-title">Aplikacja towarzysząca Linux</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-experimental"><span className="maturity-level-code">M0</span><span>Planowane</span></span><span>5 obszarów</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Pokrycie</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Eksperymentalne</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/pl/maturity/taxonomy#native-windows-companion-app"><span className="maturity-surface-title">Natywna aplikacja towarzysząca Windows</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-experimental"><span className="maturity-level-code">M0</span><span>Planowane</span></span><span>5 obszarów</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Pokrycie</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Eksperymentalne</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Jakość</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Eksperymentalne</span><span>19%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "19%" }} /></span></span></div>
  ...
  <Tab title="Core">
    <div className="maturity-surface-table">
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/pl/maturity/taxonomy#media-understanding-and-media-generation"><span className="maturity-surface-title">Rozumienie multimediów i generowanie multimediów</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>Alpha</span></span><span>6 obszarów</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Pokrycie</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Eksperymentalne</span><span>2%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "2%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Jakość</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>64%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "64%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Kompletność</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>68%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "68%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">Brak</span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/pl/maturity/taxonomy#voice-and-realtime-talk"><span className="maturity-surface-title">Głos i rozmowa w czasie rzeczywistym</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>Alpha</span></span><span>6 obszarów</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Pokrycie</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Eksperymentalne</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Jakość</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>61%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "61%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Kompletność</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>68%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "68%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">Brak</span></div>
  ...
  <Tab title="Platforma">
    <div className="maturity-surface-table">
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/pl/maturity/taxonomy#raspberry-pi-and-small-linux-devices"><span className="maturity-surface-title">Raspberry Pi i małe urządzenia z Linux</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>Beta</span></span><span>4 obszary</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Pokrycie</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Eksperymentalne</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Jakość</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alfa</span><span>67%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "67%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Kompletność</span><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">Brak</span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/pl/maturity/taxonomy#android-app"><span className="maturity-surface-title">aplikacja na Androida</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>Alfa</span></span><span>7 obszarów</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Pokrycie</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Eksperymentalne</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Jakość</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alfa</span><span>59%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "59%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Kompletność</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alfa</span><span>66%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "66%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">Brak</span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/pl/maturity/taxonomy#ios-app"><span className="maturity-surface-title">aplikacja na iOS</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-experimental"><span className="maturity-level-code">M1</span><span>Eksperymentalne</span></span><span>8 obszarów</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Pokrycie</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Eksperymentalne</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Jakość</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Eksperymentalne</span><span>41%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "41%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Kompletność</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Eksperymentalne</span><span>44%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "44%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">Brak</span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/pl/maturity/taxonomy#nix-install-path"><span className="maturity-surface-title">Ścieżka instalacji Nix</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-experimental"><span className="maturity-level-code">M1</span><span>Eksperymentalne</span></span><span>5 obszarów</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Zakres</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Eksperymentalne</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Jakość</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Eksperymentalne</span><span>41%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "41%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Kompletność</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Eksperymentalne</span><span>44%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "44%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">Brak</span></div>
      </div>
  ...
  <Tab title="Kanał">
    <div className="maturity-surface-table">
      <div className="maturity-surface-row maturity-surface-row-header"><span>Powierzchnia</span><span>Zakres</span><span>Jakość</span><span>Kompletność</span><span>Wsparcie</span></div>
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/pl/maturity/taxonomy#discord"><span className="maturity-surface-title">Discord</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-stable"><span className="maturity-level-code">M4</span><span>Stabilne</span></span><span>6 obszarów</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Zakres</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Eksperymentalne</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Jakość</span><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>73%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "73%" }} /></span></span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/pl/maturity/taxonomy#signal"><span className="maturity-surface-title">Signal</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>Alpha</span></span><span>5 obszarów</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Pokrycie</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Eksperymentalny</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Jakość</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>59%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "59%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Kompletność</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>66%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "66%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">Brak</span></div>
  ...
  <Tab title="Dostawca i narzędzie">
    <div className="maturity-surface-table">
      <div className="maturity-surface-row maturity-surface-row-header"><span>Powierzchnia</span><span>Pokrycie</span><span>Jakość</span><span>Kompletność</span><span>Wsparcie</span></div>
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/pl/maturity/taxonomy#browser-automation-exec-and-sandbox-tools"><span className="maturity-surface-title">Automatyzacja przeglądarki, exec i narzędzia sandbox</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>Beta</span></span><span>3 obszary</span></span></a>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/pl/maturity/taxonomy#image-video-and-music-generation-tools"><span className="maturity-surface-title">Narzędzia do generowania obrazów, wideo i muzyki</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>Alfa</span></span><span>5 obszarów</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Pokrycie</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Eksperymentalne</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Jakość</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alfa</span><span>61%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "61%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Kompletność</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alfa</span><span>68%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "68%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">Brak</span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/pl/maturity/taxonomy#long-tail-hosted-providers"><span className="maturity-surface-title">Dostawcy hostowani z długiego ogona</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>Alfa</span></span><span>3 obszary</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Pokrycie</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Eksperymentalny</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Jakość</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alfa</span><span>61%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "61%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Kompletność</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alfa</span><span>68%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "68%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">Brak</span></div>
...
Poniższe kontrole pokazują, które obszary karty oceny zostały objęte dowodami z profilu QA.
...
Otwórz powierzchnię, aby sprawdzić stan dowodów dla każdej kategorii. Lista pozostaje zwinięta, dzięki czemu strona nadal jest użyteczna na pierwszy rzut oka.

<AccordionGroup>
  <Accordion title="Środowisko uruchomieniowe agenta - 9 obszarów">
    <p className="maturity-readiness-summary">8 częściowo przejrzanych / 1 wymaga przeglądu</p>
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Lokalni i samodzielnie hostowani dostawcy</span>
  ...
  <Accordion title="Automatyzacja: Cron, hooki, zadania, odpytywanie - 6 obszarów">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Przychodzące zdarzenia</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Wymaga przeglądu - pełna walidacja taksonomii</span>
        </div>
        <span>0 z 15 (0%) / 0 z 15 (0%)</span>
        <span>15 luk w możliwościach</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Kontrole odpytywania</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Wymaga przeglądu - pełna walidacja taksonomii</span>
        </div>
        <span>0 z 10 (0%) / 0 z 10 (0%)</span>
        <span>10 luk w możliwościach</span>
  ...
  <Accordion title="Automatyzacja przeglądarki, exec i narzędzia sandbox - 3 obszary">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Zasady sandbox i narzędzi</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Wymaga przeglądu - pełna walidacja taksonomii</span>
        </div>
  ...
  <Accordion title="Aplikacja webowa Gateway - 6 obszarów">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Interfejs przeglądarki</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">Częściowo przejrzany - pełna walidacja taksonomii</span>
        </div>
  ...
  <Accordion title="Framework kanałów - 8 obszarów">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Konfiguracja kanałów</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">Częściowo przejrzany - pełna walidacja taksonomii</span>
        </div>
        <span>0 z 5 (0%) / 1 z 7 (14.3%)</span>
        <span>6 luk w możliwościach</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Bramki dostępu przychodzącego i tożsamości</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Wymaga przeglądu - pełna walidacja taksonomii</span>
        </div>
        <span>0 z 5 (0%) / 0 z 5 (0%)</span>
        <span>5 luk w możliwościach</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Kondycja statusu i kontrole operatora</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Wymaga przeglądu - pełna walidacja taksonomii</span>
        </div>
  ...
  <Accordion title="CLI - 7 obszarów">
    <p className="maturity-readiness-summary">5 wymaga przeglądu / 2 częściowo sprawdzone</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>Obszar</span><span>Funkcje / identyfikatory pokrycia</span><span>Dalsze działania</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Konfiguracja Plugin i kanału</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Wymaga przeglądu - pełna walidacja taksonomii</span>
        </div>
        <span>0 z 5 (0%) / 0 z 5 (0%)</span>
        <span>5 luk w możliwościach</span>
  ...
  <Accordion title="Discord - 6 obszarów">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Natywne elementy sterowania i zatwierdzenia</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Wymaga przeglądu - pełna walidacja taksonomii</span>
        </div>
        <span>0 z 5 (0%) / 0 z 5 (0%)</span>
        <span>5 luk w możliwościach</span>
  ...
  <Accordion title="Hosting Docker i Podman - 4 obszary">
    <p className="maturity-readiness-summary">3 wymagają przeglądu / 1 częściowo sprawdzony</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>Obszar</span><span>Funkcje / identyfikatory pokrycia</span><span>Dalsze działania</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Operacje na kontenerach</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Wymaga przeglądu - pełna walidacja taksonomii</span>
        </div>
        <span>0 z 11 (0%) / 0 z 11 (0%)</span>
        <span>11 luk w możliwościach</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Konfiguracja kontenera</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Wymaga przeglądu - pełna walidacja taksonomii</span>
        </div>
        <span>0 z 6 (0%) / 0 z 6 (0%)</span>
        <span>6 luk w możliwościach</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Wydanie i walidacja obrazu</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">Częściowo sprawdzone - pełna walidacja taksonomii</span>
        </div>
  ...
  <Accordion title="Środowisko uruchomieniowe Gateway - 13 obszarów">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Interfejsy API RPC Gateway i zdarzenia</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">Częściowo przejrzane - pełna walidacja taksonomii</span>
        </div>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Stan, diagnostyka i naprawa</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Wymaga przeglądu - pełna walidacja taksonomii</span>
        </div>
        <span>0 z 7 (0%) / 0 z 7 (0%)</span>
        <span>7 luk w możliwościach</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Hostowana powierzchnia webowa</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Wymaga przeglądu - pełna walidacja taksonomii</span>
        </div>
        <span>0 z 4 (0%) / 0 z 4 (0%)</span>
        <span>4 luki w możliwościach</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Dostęp do sieci i wykrywanie</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Wymaga przeglądu - pełna walidacja taksonomii</span>
        </div>
        <span>0 z 6 (0%) / 0 z 6 (0%)</span>
        <span>6 luk w możliwościach</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Węzły i zdalne możliwości</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Wymaga przeglądu - pełna walidacja taksonomii</span>
        </div>
  ...
  <Accordion title="Google Chat - 5 obszarów">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Natywne kontrolki i zatwierdzenia</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Wymaga przeglądu - pełna walidacja taksonomii</span>
        </div>
        <span>0 z 16 (0%) / 0 z 16 (0%)</span>
        <span>16 luk w możliwościach</span>
  ...
  <Accordion title="Narzędzia do generowania obrazów, wideo i muzyki - 5 obszarów">
    <p className="maturity-readiness-summary">5 wymaga przeglądu</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>Obszar</span><span>Funkcje / identyfikatory pokrycia</span><span>Dalsze działania</span></div>
      <div className="maturity-readiness-row">
  ...
  <Accordion title="iMessage i BlueBubbles - 5 obszarów">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Routing rozmów i dostarczanie</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Wymaga przeglądu - pełna walidacja taksonomii</span>
        </div>
        <span>0 z 4 (0%) / 0 z 4 (0%)</span>
        <span>4 luki w możliwościach</span>
  ...
  <Accordion title="Aplikacja iOS - 8 obszarów">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Canvas i ekran</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Wymaga przeglądu - pełna walidacja taksonomii</span>
        </div>
        <span>0 z 1 (0%) / 0 z 1 (0%)</span>
        <span>1 luka w możliwościach</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Konfiguracja Gateway i diagnostyka</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Wymaga przeglądu - pełna walidacja taksonomii</span>
        </div>
        <span>0 z 7 (0%) / 0 z 7 (0%)</span>
        <span>7 luk w możliwościach</span>
  ...
  <Accordion title="Aplikacja towarzysząca na Linuxa - 5 obszarów">
    <p className="maturity-readiness-summary">5 wymaga przeglądu</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>Obszar</span><span>Funkcje / identyfikatory pokrycia</span><span>Dalsze działania</span></div>
      <div className="maturity-readiness-row">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Możliwości pulpitu</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Wymaga przeglądu - pełna walidacja taksonomii</span>
        </div>
        <span>0 z 9 (0%) / 0 z 9 (0%)</span>
        <span>9 luk w możliwościach</span>
  ...
  <Accordion title="Host Gateway na Linuxie - 5 obszarów">
    <p className="maturity-readiness-summary">5 wymaga przeglądu</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>Obszar</span><span>Funkcje / identyfikatory pokrycia</span><span>Dalsze działania</span></div>
      <div className="maturity-readiness-row">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Środowisko uruchomieniowe Gateway i kontrola usług</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Wymaga przeglądu - pełna walidacja taksonomii</span>
        </div>
        <span>0 z 6 (0%) / 0 z 6 (0%)</span>
        <span>6 luk w możliwościach</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Zdalny dostęp i bezpieczeństwo</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Wymaga przeglądu - pełna walidacja taksonomii</span>
        </div>
        <span>0 z 6 (0%) / 0 z 6 (0%)</span>
        <span>6 luk w możliwościach</span>
  ...
  <Accordion title="Lokalni dostawcy modeli: Ollama, vLLM, SGLang, LM Studio - 5 obszarów">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Natywne Plugin dostawców</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Wymaga przeglądu - pełna walidacja taksonomii</span>
        </div>
        <span>0 z 10 (0%) / 0 z 10 (0%)</span>
        <span>10 luk w możliwościach</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Bezpieczeństwo sieci i kontrola promptów</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Wymaga przeglądu - pełna walidacja taksonomii</span>
        </div>
        <span>0 z 2 (0%) / 0 z 2 (0%)</span>
        <span>2 luki w możliwościach</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Konfiguracja dostawcy, cykl życia i diagnostyka</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Wymaga przeglądu - pełna walidacja taksonomii</span>
        </div>
        <span>0 z 12 (0%) / 0 z 12 (0%)</span>
        <span>12 luk w możliwościach</span>
  ...
  <Accordion title="Hostowani dostawcy z długiego ogona - 3 obszary">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Hostowani dostawcy mediów</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Wymaga przeglądu - pełna walidacja taksonomii</span>
        </div>
        <span>0 z 8 (0%) / 0 z 8 (0%)</span>
        <span>8 luk w możliwościach</span>
  ...
  <Accordion title="aplikacja towarzysząca macOS - 8 obszarów">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Kanwa</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Wymaga przeglądu - Pełna walidacja taksonomii</span>
        </div>
        <span>0 z 4 (0%) / 0 z 4 (0%)</span>
        <span>4 luki w możliwościach</span>
  ...
  <Accordion title="host Gateway macOS - 7 obszarów">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Lokalna integracja Gateway</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Wymaga przeglądu - Pełna walidacja taksonomii</span>
        </div>
        <span>0 z 9 (0%) / 0 z 9 (0%)</span>
        <span>9 luk w możliwościach</span>
  ...
  <Accordion title="Rozumienie mediów i generowanie mediów - 6 obszarów">
    <p className="maturity-readiness-summary">4 wymagają przeglądu / 2 częściowo sprawdzone</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>Obszar</span><span>Funkcje / identyfikatory pokrycia</span><span>Dalsze działania</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Obsługa mediów w kanale</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Wymaga przeglądu - pełna walidacja taksonomii</span>
        </div>
        <span>0 z 5 (0%) / 0 z 5 (0%)</span>
        <span>5 luk w możliwościach</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Konfiguracja mediów</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Wymaga przeglądu - pełna walidacja taksonomii</span>
        </div>
        <span>0 z 1 (0%) / 0 z 1 (0%)</span>
        <span>1 luka w możliwościach</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Generowanie mediów</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">Częściowo sprawdzone - pełna walidacja taksonomii</span>
        </div>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Przyjmowanie mediów i dostęp</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Wymaga przeglądu - pełna walidacja taksonomii</span>
        </div>
        <span>0 z 8 (0%) / 0 z 8 (0%)</span>
        <span>8 luk w możliwościach</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Rozumienie mediów</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">Częściowo sprawdzone - pełna walidacja taksonomii</span>
        </div>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Dostarczanie Text-to-Speech</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Wymaga przeglądu - pełna walidacja taksonomii</span>
        </div>
        <span>0 z 2 (0%) / 0 z 2 (0%)</span>
        <span>2 luki w możliwościach</span>
  ...
  <Accordion title="Natywny Windows - 4 obszary">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Sieć</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Wymaga przeglądu - pełna walidacja taksonomii</span>
        </div>
        <span>0 z 4 (0%) / 0 z 4 (0%)</span>
        <span>4 luki w możliwościach</span>
  ...
  <Accordion title="Ścieżka dostawcy OpenAI i Codex - 5 obszarów">
    <p className="maturity-readiness-summary">2 wymagają przeglądu / 3 częściowo zweryfikowane</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>Obszar</span><span>Funkcje / identyfikatory pokrycia</span><span>Dalsze działania</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Obrazy i dane multimodalne</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Wymaga przeglądu - pełna walidacja taksonomii</span>
        </div>
        <span>0 z 2 (0%) / 0 z 2 (0%)</span>
        <span>2 luki w możliwościach</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          ...
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">Częściowo zweryfikowano - pełna walidacja taksonomii</span>
        </div>
  ...
  <Accordion title="OpenClaw App SDK - 6 obszarów">
    <p className="maturity-readiness-summary">5 wymaga przeglądu / 1 częściowo zweryfikowany</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>Obszar</span><span>Funkcje / identyfikatory pokrycia</span><span>Dalsze działania</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
  ...
  <Accordion title="Plugin - 9 obszarów">
    <p className="maturity-readiness-summary">6 wymaga przeglądu / 3 częściowo sprawdzone</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>Obszar</span><span>Funkcje / identyfikatory pokrycia</span><span>Dalsze działania</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Tworzenie i pakowanie Plugin</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Wymaga przeglądu - pełna walidacja taksonomii</span>
        </div>
        <span>0 z 8 (0%) / 0 z 8 (0%)</span>
        <span>8 luk w możliwościach</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Dołączone Plugin</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Wymaga przeglądu - pełna walidacja taksonomii</span>
        </div>
        <span>0 z 5 (0%) / 0 z 5 (0%)</span>
        <span>5 luk w możliwościach</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Plugin kanałów</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Wymaga przeglądu - pełna walidacja taksonomii</span>
        </div>
        <span>0 z 5 (0%) / 0 z 5 (0%)</span>
        <span>5 luk w możliwościach</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Instalowanie i uruchamianie Plugin</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">Częściowo sprawdzone - pełna walidacja taksonomii</span>
        </div>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Zatwierdzenia Plugin</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Wymaga przeglądu - pełna walidacja taksonomii</span>
        </div>
        <span>0 z 6 (0%) / 0 z 6 (0%)</span>
        <span>6 luk w możliwościach</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Plugin dostawców i narzędzi</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">Częściowo sprawdzone - pełna walidacja taksonomii</span>
        </div>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Publikowanie Plugin</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Wymaga przeglądu - pełna walidacja taksonomii</span>
        </div>
        <span>0 z 6 (0%) / 0 z 6 (0%)</span>
        <span>6 luk w możliwościach</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Testowanie Plugin</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">Częściowo sprawdzone - pełna walidacja taksonomii</span>
        </div>
  ...
  <Accordion title="Bezpieczeństwo, uwierzytelnianie, parowanie i sekrety - 6 obszarów">
    <p className="maturity-readiness-summary">2 częściowo sprawdzone / 4 wymagają przeglądu</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>Obszar</span><span>Funkcje / identyfikatory pokrycia</span><span>Dalsze działania</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Zaufanie do Plugin</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Wymaga przeglądu - pełna walidacja taksonomii</span>
        </div>
        <span>0 z 2 (0%) / 0 z 2 (0%)</span>
        <span>2 luki w możliwościach</span>
  ...
  <Accordion title="Sesja, pamięć i mechanizm kontekstu - 9 obszarów">
    <p className="maturity-readiness-summary">2 wymagają przeglądu / 7 częściowo sprawdzonych</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>Obszar</span><span>Funkcje / identyfikatory pokrycia</span><span>Dalsze działania</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Zarządzanie sesjami i transkrypcjami CLI</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Wymaga przeglądu - pełna walidacja taksonomii</span>
        </div>
        <span>0 z 2 (0%) / 0 z 2 (0%)</span>
        <span>2 luki w możliwościach</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Mechanizm kontekstu</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">Częściowo sprawdzone - pełna walidacja taksonomii</span>
        </div>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Diagnostyka, utrzymanie i odzyskiwanie</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">Częściowo sprawdzone - pełna walidacja taksonomii</span>
        </div>
  ...
  <Accordion title="Obserwowalność - 5 obszarów">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Logowanie</span>
  ...
  <Accordion title="TUI - 5 obszarów">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Wykonywanie lokalnej powłoki</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Wymaga sprawdzenia - pełna walidacja taksonomii</span>
        </div>
        <span>0 z 4 (0%) / 0 z 4 (0%)</span>
        <span>4 luki w możliwościach</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Tryby uruchomieniowe</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Wymaga sprawdzenia - pełna walidacja taksonomii</span>
        </div>
        <span>0 z 14 (0%) / 0 z 14 (0%)</span>
        <span>14 luk w możliwościach</span>
  ...
  <Accordion title="Głos i rozmowa w czasie rzeczywistym - 6 obszarów">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Wybudzanie głosem i routing</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Wymaga sprawdzenia - pełna walidacja taksonomii</span>
        </div>
        <span>0 z 4 (0%) / 0 z 4 (0%)</span>
        <span>4 luki w możliwościach</span>
  ...
  <Accordion title="Kanał rozmów głosowych - 5 obszarów">
    <p className="maturity-readiness-summary">5 wymaga sprawdzenia</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>Obszar</span><span>Funkcje / identyfikatory pokrycia</span><span>Dalsze działania</span></div>
      <div className="maturity-readiness-row">
  ...
  <Accordion title="Powierzchnie aplikacji towarzyszącej watchOS - 5 obszarów">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Zatwierdzenia kadry kierowniczej</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Wymaga przeglądu - Pełna walidacja taksonomii</span>
        </div>
        <span>0 z 3 (0%) / 0 z 3 (0%)</span>
        <span>3 luki w możliwościach</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Interfejs użytkownika aplikacji na zegarek</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Wymaga przeglądu - Pełna walidacja taksonomii</span>
        </div>
        <span>0 z 3 (0%) / 0 z 3 (0%)</span>
        <span>3 luki w możliwościach</span>
  ...
  <Accordion title="Narzędzia wyszukiwania w sieci - 4 obszary">
    <p className="maturity-readiness-summary">2 wymagają przeglądu / 2 częściowo przejrzano</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>Obszar</span><span>Funkcje / identyfikatory pokrycia</span><span>Dalsze działania</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
  ...
  <Accordion title="Windows przez WSL2 - 6 obszarów">
    <p className="maturity-readiness-summary">5 wymaga przeglądu / 1 częściowo przejrzano</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>Obszar</span><span>Funkcje / identyfikatory pokrycia</span><span>Dalsze działania</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Przeglądarka i interfejs użytkownika sterowania</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Wymaga przeglądu - Pełna walidacja taksonomii</span>
        </div>
        <span>0 z 6 (0%) / 0 z 6 (0%)</span>
        <span>6 luk w możliwościach</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Dostęp do Gateway i ekspozycja</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Wymaga przeglądu - Pełna walidacja taksonomii</span>
        </div>
        <span>0 z 11 (0%) / 0 z 11 (0%)</span>
        <span>11 luk w możliwościach</span>
