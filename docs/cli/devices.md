...
- Rotation and revocation also invalidate the matching device and role's Dashboard read permissions retained by an admitted turn, including after a disconnect. Disconnecting alone does not revoke those permissions.
