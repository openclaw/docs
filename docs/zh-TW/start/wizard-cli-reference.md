---
read_when:
    - 你需要特定 `openclaw onboard` 步驟的詳細行為
    - 你正在偵錯 onboarding 結果或整合 onboarding 用戶端
sidebarTitle: CLI reference
summary: openclaw onboard 的逐步行為：每個步驟的作用、寫入的設定，以及內部機制
title: 命令列介面設定參考
x-i18n:
    generated_at: "2026-07-05T11:48:09Z"
    model: gpt-5.5
