...
<Note>
如果你剛開始使用 OpenClaw，請從[開始使用](/zh-TW/start/getting-started)開始。
</Note>

使用這些中心來探索每個頁面，包括左側導覽列中未顯示的深入說明與參考文件。
...
- [入門導引（CLI）](/zh-TW/start/wizard)
- [設定](/zh-TW/start/setup)
- [Dashboard（本機 Gateway）](http://127.0.0.1:18789/)
- [說明](/zh-TW/help)
...
- [Plugin 概觀](/zh-TW/tools/plugin)
- [建置 Plugin](/zh-TW/plugins/building-plugins)
- [Plugin Hook](/zh-TW/plugins/hooks)
- [Plugin 資訊清單](/zh-TW/plugins/manifest)
- [Agent 工具](/zh-TW/plugins/building-plugins#registering-agent-tools)
- [Plugin 套件組合](/zh-TW/plugins/bundles)
