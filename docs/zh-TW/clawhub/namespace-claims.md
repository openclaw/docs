...
summary: 如何針對 org、brand、owner-handle、package-scope、skill-slug 或 namespace 所有權爭議申請 ClawHub 審查。
title: 組織與命名空間宣告
x-i18n:
    generated_at: "2026-07-04T17:48:17Z"
    model: gpt-5.5
...
ClawHub 使用擁有者控制代碼、組織控制代碼、skill slug、外掛套件名稱和
套件 scope 作為公開命名空間。如果某個命名空間看起來屬於
現實世界的專案、品牌、套件生態系或組織，但在 ClawHub 上已被
申請、保留、造成誤導或有爭議，請要求工作人員透過
...
- 像 `@example-org/*` 這樣只應由相符 ClawHub 擁有者發布的
  套件 scope
...
- 指向有爭議的 ClawHub 擁有者、skill、外掛、套件或問題的連結

請說明每個連結證明了什麼。工作人員應能在不需要私人憑證或秘密的情況下理解其
關係。
