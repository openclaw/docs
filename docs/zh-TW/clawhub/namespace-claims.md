...
ClawHub 使用擁有者帳號代稱、組織帳號代稱、技能代稱、外掛套件名稱和
...
此路徑用於公開、非敏感的所有權審查。請勿使用產品內
回報或帳號申訴表單來處理命名空間聲明。

## 何時提出聲明

當你認為 ClawHub 工作人員應審查某個命名空間是否因現實世界所有權而
需要被保留、移轉、重新命名、隱藏、隔離、加上別名，
或以其他方式變更時，請提出命名空間聲明。

範例包括：

- 與你的 GitHub 組織、專案、公司或社群相符的組織帳號代稱
- 例如 `@example-org/*` 的套件作用域，該作用域應只由
  相符的 ClawHub 擁有者發布
...
重新命名、移轉、隱藏或刪除受影響資源來修正命名空間。當你無法管理目前的擁有者，或工作人員需要解決
爭議時，請使用聲明。
...
- 指名該命名空間的官方專案文件
- 網域或官方電子郵件網域證明
- npm、PyPI、crates.io 或其他套件登錄檔的作用域控制
...
請勿在公開 GitHub 問題中放入秘密或私人證明。請勿包含：
