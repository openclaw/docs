...
x-i18n:
    generated_at: "2026-07-02T13:57:22Z"
    model: gpt-5.5
...
已刪除、遭封鎖或停用的帳戶無法完成一般 ClawHub 登入。如果登入後又回到登出狀態，你的帳戶可能狀態不良好。如果你的帳戶遭封鎖或停用，且你認為這是錯誤，請使用 [ClawHub 申訴表單](https://appeals.openclaw.ai/)。
