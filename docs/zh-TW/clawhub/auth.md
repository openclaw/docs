...
x-i18n:
    generated_at: "2026-07-03T23:25:49Z"
    model: gpt-5.5
...
ClawHub 使用 GitHub 進行網頁登入。命令列介面使用透過該登入帳號建立的 ClawHub API 權杖。

## 網頁登入

使用 GitHub 在 [clawhub.ai](https://clawhub.ai) 登入。

已刪除、遭封鎖或停用的帳號無法完成一般 ClawHub 登入。如果登入後又回到登出狀態，你的帳號狀態可能不正常。如果你的帳號遭封鎖或停用，且你認為這是錯誤，請使用 [ClawHub 申訴表單](https://appeals.openclaw.ai/)。
...
如果你的瀏覽器因為防火牆、VPN 或代理規則而無法連線到本機回呼，請使用無瀏覽器權杖流程。
