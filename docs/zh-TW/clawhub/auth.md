...
已刪除、遭封鎖或停用的帳號無法完成一般 ClawHub 登入。如果登入後又回到登出狀態，你的帳號可能不是良好狀態。如果你的帳號遭封鎖或停用，且你認為這是錯誤，請使用 [ClawHub 申訴表單](https://appeals.openclaw.ai/)。
...
在 ClawHub 網頁使用者介面建立權杖，然後將它傳給命令列介面：
