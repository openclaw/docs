...
x-i18n:
    generated_at: "2026-07-14T13:31:41Z"
    model: gpt-5.6
...
已刪除、遭封鎖或停用的帳號無法完成正常的 ClawHub 登入。如果登入後又回到登出狀態，你的帳號狀態可能不良。如果你的帳號遭封鎖或停用，而你認為這是錯誤，請使用 [ClawHub 申訴表單](https://appeals.openclaw.ai/)。
...
如果因防火牆、VPN 或 Proxy 規則導致瀏覽器無法連線至本機回呼位址，請使用無介面權杖流程。
...
已刪除、遭封鎖或停用的帳號無法繼續使用現有的 API 權杖。如果你的帳號遭封鎖或停用，而你認為這是錯誤，請使用 [ClawHub 申訴表單](https://appeals.openclaw.ai/)。
