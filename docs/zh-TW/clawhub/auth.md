...
ClawHub 使用 GitHub 進行網頁登入。命令列介面使用透過該登入帳戶建立的 ClawHub API 權杖。

## 網頁登入

使用 GitHub 在 [clawhub.ai](https://clawhub.ai) 登入。

已刪除、遭封鎖或停用的帳戶無法完成一般 ClawHub 登入。如果登入後又回到登出狀態，你的帳戶狀態可能不正常。如果你的帳戶遭封鎖或停用，且你認為這是錯誤，請使用 [ClawHub 申訴表單](https://appeals.openclaw.ai/)。
