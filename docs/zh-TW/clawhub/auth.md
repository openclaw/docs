...
已刪除、遭封鎖或停用的帳號無法完成正常的 ClawHub 登入。如果登入後又回到登出狀態，你的帳號可能狀態不良。如果你的帳號遭封鎖或停用，且你認為這是錯誤，請使用 [ClawHub 申訴表單](https://appeals.openclaw.ai/)。
...
如果因防火牆、VPN 或 Proxy 規則導致你的瀏覽器無法連到本機回呼，請使用無頭權杖流程。
...
已刪除、遭封鎖或停用的帳號無法繼續使用既有 API 權杖。如果你的帳號遭封鎖或停用，且你認為這是錯誤，請使用 [ClawHub 申訴表單](https://appeals.openclaw.ai/)。
