...
已刪除、遭封禁或停用的帳號無法完成一般的 ClawHub 登入。如果登入後又回到登出狀態，你的帳號可能狀態不良好。如果你的帳號遭封禁或停用，且你認為這是錯誤，請使用 [ClawHub 申訴表單](https://appeals.openclaw.ai/)。
...
如果你的瀏覽器因防火牆、VPN 或 Proxy 規則而無法連到本機回呼，請使用無介面權杖流程。
...
已刪除、遭封禁或停用的帳號無法繼續使用現有 API 權杖。如果你的帳號遭封禁或停用，且你認為這是錯誤，請使用 [ClawHub 申訴表單](https://appeals.openclaw.ai/)。
