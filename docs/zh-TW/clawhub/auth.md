...
已刪除、遭停權或遭停用的帳戶無法完成一般 ClawHub 登入。如果登入後又回到登出狀態，你的帳戶狀態可能不良好。如果你的帳戶遭停權或停用，且你認為這是錯誤，請使用 [ClawHub 申訴表單](https://appeals.openclaw.ai/)。
