...
x-i18n:
    generated_at: "2026-07-16T11:28:25Z"
    model: gpt-5.6
...
已刪除、遭封鎖或停用的帳戶無法完成一般 ClawHub 登入。
如果登入後又回到登出狀態，你的帳戶可能不是正常狀態。如果你的帳戶遭封鎖或停用，且你認為這是誤判，請使用
...
在 ClawHub 網頁介面中建立權杖，然後將它傳遞給命令列介面：
