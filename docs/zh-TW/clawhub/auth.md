...
已刪除、遭封鎖或停用的帳戶無法完成一般 ClawHub 登入。如果登入後又回到登出狀態，你的帳戶可能未處於良好狀態。如果你的帳戶遭封鎖或停用，且你認為這是錯誤，請使用 [ClawHub 申訴表單](https://appeals.openclaw.ai/)。
...
如果因為防火牆、VPN 或代理規則，導致你的瀏覽器無法連線到本機回呼，請使用無頭權杖流程。
