...
已刪除、遭停權或遭停用的帳號無法完成一般 ClawHub 登入。如果登入後又回到登出狀態，你的帳號可能狀態不佳。如果你的帳號遭停權或停用，且你認為這是錯誤，請使用 [ClawHub 申訴表單](https://appeals.openclaw.ai/)。
...
已刪除、遭停權或遭停用的帳號無法繼續使用現有 API 權杖。如果你的帳號遭停權或停用，且你認為這是錯誤，請使用 [ClawHub 申訴表單](https://appeals.openclaw.ai/)。
