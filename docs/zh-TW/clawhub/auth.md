...
已刪除、遭封鎖或停用的帳戶無法完成一般的 ClawHub 登入。如果登入後又回到登出狀態，你的帳戶可能並非處於良好狀態。如果你的帳戶遭封鎖或停用，而你認為這是誤判，請使用 [ClawHub 申訴表單](https://appeals.openclaw.ai/)。
...
已刪除、遭封鎖或停用的帳戶無法繼續使用現有 API 權杖。如果你的帳戶遭封鎖或停用，而你認為這是誤判，請使用 [ClawHub 申訴表單](https://appeals.openclaw.ai/)。
