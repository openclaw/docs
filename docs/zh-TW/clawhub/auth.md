...
x-i18n:
    generated_at: "2026-07-04T17:47:49Z"
    model: gpt-5.5
...
已刪除、遭停權或停用的帳戶無法完成一般 ClawHub 登入。如果登入後又回到登出狀態，你的帳戶可能並非處於良好狀態。如果你的帳戶遭停權或停用，且你認為這是錯誤，請使用 [ClawHub 申訴表單](https://appeals.openclaw.ai/)。
...
如果你的瀏覽器因為防火牆、VPN 或代理規則而無法連到本機回呼，請使用無頭權杖流程。
...
已刪除、遭停權或停用的帳戶無法繼續使用現有 API 權杖。如果你的帳戶遭停權或停用，且你認為這是錯誤，請使用 [ClawHub 申訴表單](https://appeals.openclaw.ai/)。
