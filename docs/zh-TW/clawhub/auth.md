...
已刪除、遭封鎖或停用的帳戶無法完成一般的 ClawHub 登入。如果登入後又回到登出狀態，你的帳戶可能狀態不佳。如果你的帳戶遭封鎖或停用，而你認為這是錯誤，請使用 [ClawHub appeal form](https://appeals.openclaw.ai/)。
...
如果因防火牆、VPN 或代理規則導致瀏覽器無法連到本機回呼，請使用無頭權杖流程。
...
已刪除、遭封鎖或停用的帳戶無法繼續使用既有 API 權杖。如果你的帳戶遭封鎖或停用，而你認為這是錯誤，請使用 [ClawHub appeal form](https://appeals.openclaw.ai/)。
