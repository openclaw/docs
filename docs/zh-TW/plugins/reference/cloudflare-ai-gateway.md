---
read_when:
    - 你正在安裝、設定或稽核 cloudflare-ai-gateway 外掛
summary: 新增 Cloudflare AI Gateway 模型提供者支援至 OpenClaw。
title: Cloudflare AI 閘道外掛
x-i18n:
    generated_at: "2026-06-27T19:41:39Z"
    model: gpt-5.5
...
- 安裝路徑：npm；ClawHub：`clawhub:@openclaw/cloudflare-ai-gateway-provider`
