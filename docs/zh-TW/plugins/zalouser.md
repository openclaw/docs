---
read_when:
    - 你想要 OpenClaw 支援 Zalo Personal（非官方）
...
<Warning>
非官方自動化可能導致帳號停權或封鎖。請自行承擔風險使用。
</Warning>

## 命名

頻道 id 為 `zalouser`，以明確表示這會自動化 **個人 Zalo 使用者帳號**（非官方）。我們保留 `zalo` 供未來可能的官方 Zalo API 整合使用。

## 執行位置

此 Plugin 會在 **Gateway 程序內部** 執行。
