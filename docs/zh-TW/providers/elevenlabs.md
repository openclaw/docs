...
read_when:
    ...
    - 你想要針對音訊附件使用 ElevenLabs Scribe 語音轉文字
...
v2 進行批次語音轉文字，以及透過 Scribe v2 Realtime 進行串流 STT。
...
<Note>
Voice Call 會以 8 kHz G.711 u-law 接收 Twilio 媒體。ElevenLabs 即時提供者預設為 `ulaw_8000`，因此電話語音影格可以不經轉碼直接轉送。
</Note>
