...
title: Vitrina
x-i18n:
    generated_at: "2026-04-15T05:11:41Z"
    model: gpt-5.4
    provider: openai
...
<div className="showcase-hero">
  ...
  <p className="showcase-lead">
    Los proyectos de OpenClaw no son demos de juguete. La gente está lanzando bucles de revisión de PR, aplicaciones móviles, automatización del hogar,
    sistemas de voz, devtools y flujos de trabajo con mucha memoria desde los canales que ya usan.
  </p>
...
<div className="showcase-jump-links">
  ...
  <a href="#fresh-from-discord">Recién salido de Discord</a>
...
<p className="showcase-section-intro">
  Empieza aquí si quieres el camino más corto de “¿qué es esto?” a “vale, ya lo entiendo”.
</p>
...
<div className="showcase-video-grid">
  <div className="showcase-video-card">
    ...
    <p>VelvetShark, 28 minutos. Instala, configura y obtén tu primer asistente funcional de principio a fin.</p>
  ...
  <div className="showcase-video-card">
    ...
    <h3>Video recopilatorio de la comunidad</h3>
    <p>Un recorrido más rápido por proyectos, superficies y flujos de trabajo reales creados alrededor de OpenClaw.</p>
  ...
  <div className="showcase-video-card">
    ...
    <p>Ejemplos de la comunidad, desde bucles de programación nativos de chat hasta hardware y automatización personal.</p>
    <a href="https://www.youtube.com/watch?v=5kkIJNUGFho">Ver en YouTube</a>
  </div>
</div>

<h2 id="fresh-from-discord">Recién salido de Discord</h2>
...
OpenCode termina el cambio → abre un PR → OpenClaw revisa el diff y responde en Telegram con “sugerencias menores” además de un veredicto claro de merge (incluyendo correcciones críticas que aplicar primero).

  <img src="/assets/showcase/pr-review-telegram.jpg" alt="Feedback de revisión de PR de OpenClaw entregado en Telegram" />
</Card>

<Card title="Skill de cava de vinos en minutos" icon="wine-glass" href="https://x.com/i/status/2010916352454791216">
  **@prades_maxime** • `skills` `local` `csv`

Le pidió a “Robby” (@openclaw) un Skill local para una cava de vinos. Solicita un CSV de ejemplo exportado + dónde almacenarlo, y luego crea/prueba el Skill rápidamente (962 botellas en el ejemplo).

  <img src="/assets/showcase/wine-cellar-skill.jpg" alt="OpenClaw creando un Skill local de cava de vinos a partir de CSV" />
</Card>
...
Plan semanal de comidas → habituales → reservar franja de entrega → confirmar pedido. Sin APIs, solo control del navegador.
  ...
  <img src="/assets/showcase/tesco-shop.jpg" alt="Automatización de compra en Tesco por chat" />
</Card>
...
Aplicación de escritorio para gestionar skills/comandos entre Agents, Claude, Codex y OpenClaw.
...
Asistente instalado con Homebrew para listar/inspeccionar/monitorizar sesiones locales de OpenAI Codex (CLI + VS Code).
...
<Card title="Comidas escolares con ParentPay" icon="utensils">
  **@George5562** • `automation` `browser` `parenting`

Automatización de reservas de comidas escolares en el Reino Unido mediante ParentPay. Usa coordenadas del ratón para hacer clic de forma fiable en celdas de tabla.
</Card>

<Card title="Carga a R2 (Envíame mis archivos)" icon="cloud-arrow-up" href="https://clawhub.ai/skills/r2-upload">
  **@julianengel** • `files` `r2` `presigned-urls`

Sube a Cloudflare R2/S3 y genera enlaces seguros de descarga presignados. Perfecto para instancias remotas de OpenClaw.
</Card>

<Card title="App de iOS a través de Telegram" icon="mobile">
...
<Card title="El equipo de ensueño de Kev (14+ Agents)" icon="robot" href="https://github.com/adam91holt/orchestrated-ai-articles">
  **@adam91holt** • `multi-agent` `orchestration` `architecture` `manifesto`

Más de 14 agents bajo un solo gateway con un orquestador Opus 4.5 que delega en workers de Codex. [Documento técnico](https://github.com/adam91holt/orchestrated-ai-articles) completo que cubre la plantilla del Dream Team, selección de modelos, sandboxing, webhooks, Heartbeat y flujos de delegación. [Clawdspace](https://github.com/adam91holt/clawdspace) para sandboxing de agents. [Entrada de blog](https://adams-ai-journey.ghost.io/2026-the-year-of-the-orchestrator/).
</Card>

<Card title="Linear CLI" icon="terminal" href="https://github.com/Finesssee/linear-cli">
  **@NessZerra** • `devtools` `linear` `cli` `issues`

CLI para Linear que se integra con flujos de trabajo agénticos (Claude Code, OpenClaw). Gestiona issues, proyectos y flujos de trabajo desde la terminal. ¡Primer PR externo fusionado!
</Card>

<Card title="Beeper CLI" icon="message" href="https://github.com/blqke/beepcli">
  **@jules** • `messaging` `beeper` `cli` `automation`

Lee, envía y archiva mensajes mediante Beeper Desktop. Usa la API MCP local de Beeper para que los agents puedan gestionar todos tus chats (iMessage, WhatsApp, etc.) en un solo lugar.
</Card>

</CardGroup>

<h2 id="automation-workflows">Automatización y flujos de trabajo</h2>

<p className="showcase-section-intro">
  Programación, control del navegador, bucles de soporte y el lado del producto de “simplemente hazme la tarea”.
</p>
...
Claude Code descubrió y confirmó los controles del purificador, luego OpenClaw toma el control para gestionar la calidad del aire de la habitación.
...
Activado por una cámara en el tejado: pedirle a OpenClaw que tome una foto del cielo cuando se vea bonito — diseñó un Skill y tomó la foto.
...
Un prompt programado genera cada mañana una sola imagen de “escena” (clima, tareas, fecha, publicación/cita favorita) mediante una persona de OpenClaw.
</Card>

<Card title="Reserva de pista de pádel" icon="calendar-check" href="https://github.com/joshp123/padel-cli">
  **@joshp123** • `automation` `booking` `cli`
  
  Verificador de disponibilidad de Playtomic + CLI de reserva. No vuelvas a perderte una pista libre.
  
  <img src="/assets/showcase/padel-screenshot.jpg" alt="captura de pantalla de padel-cli" />
</Card>

<Card title="Captura de información contable" icon="file-invoice-dollar">
...
Reconstruyó todo su sitio personal a través de Telegram mientras veía Netflix — Notion → Astro, 18 publicaciones migradas, DNS a Cloudflare. Nunca abrió un portátil.
</Card>

<Card title="Agent de búsqueda de empleo" icon="briefcase">
  **@attol8** • `automation` `api` `skill`

Busca ofertas de trabajo, las compara con palabras clave del CV y devuelve oportunidades relevantes con enlaces. Creado en 30 minutos usando la API de JSearch.
</Card>
...
<Card title="Skill de Todoist a través de Telegram" icon="list-check" href="https://x.com/iamsubhrajyoti/status/2009949389884920153">
...
Supervisa el canal de Slack de la empresa, responde de forma útil y reenvía notificaciones a Telegram. Corrigió de manera autónoma un error de producción en una aplicación desplegada sin que nadie se lo pidiera.
</Card>

</CardGroup>

<h2 id="knowledge-memory">Conocimiento y memoria</h2>
...
<h2 id="voice-phone">Voz y teléfono</h2>
...
<Card title="Puente telefónico Clawdia" icon="phone" href="https://github.com/alejandroOPI/clawdia-bridge">
  **@alejandroOPI** • `voice` `vapi` `bridge`
  ...
  Asistente de voz Vapi ↔ puente HTTP de OpenClaw. Llamadas telefónicas casi en tiempo real con tu agent.
</Card>
...
<h2 id="infrastructure-deployment">Infraestructura y despliegue</h2>
...
<Card title="Empaquetado Nix" icon="snowflake" href="https://github.com/openclaw/nix-openclaw">
  **@openclaw** • `nix` `packaging` `deployment`
  ...
  Configuración de OpenClaw con Nix incluida para despliegues reproducibles.
</Card>

<Card title="Calendario CalDAV" icon="calendar" href="https://clawhub.ai/skills/caldav-calendar">
  **ClawHub** • `calendar` `caldav` `skill`
  
  Skill de calendario usando khal/vdirsyncer. Integración de calendario autoalojada.
</Card>

</CardGroup>

<h2 id="home-hardware">Hogar y hardware</h2>
...
<Card title="Automatización GoHome" icon="house-signal" href="https://github.com/joshp123/gohome">
  **@joshp123** • `home` `nix` `grafana`
  ...
  Automatización del hogar nativa de Nix con OpenClaw como interfaz, además de hermosos paneles de Grafana.
...
<p className="showcase-section-intro">
  Cosas que crecieron más allá de un solo flujo de trabajo y se convirtieron en productos o ecosistemas más amplios.
</p>
...
<Card title="Marketplace StarSwap" icon="star" href="https://star-swap.com/">
  **Comunidad** • `marketplace` `astronomy` `webapp`
  ...
  Marketplace completo de equipo de astronomía. Creado con/alrededor del ecosistema de OpenClaw.
</Card>
...
<p className="showcase-section-intro">
  Si estás creando algo interesante con OpenClaw, envíalo. Las capturas de pantalla sólidas y los resultados concretos ayudan.
</p>

¿Tienes algo para compartir? ¡Nos encantaría destacarlo!
...
<Steps>
  ...
  <Step title="Incluye detalles">
    Cuéntanos qué hace, enlaza al repositorio/demo y comparte una captura de pantalla si tienes una
  </Step>
  <Step title="Aparece destacado">
