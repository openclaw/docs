...
x-i18n:
    generated_at: "2026-07-05T11:46:31Z"
    model: gpt-5.5
...
The [threat model](/es/security/THREAT-MODEL-ATLAS) is a living document. Contributions are welcome from anyone; you do not need security or MITRE ATLAS background.
...
- [Threat model](/es/security/THREAT-MODEL-ATLAS)
- [Incident response](/es/security/incident-response)
- [Formal verification](/es/security/formal-verification)
