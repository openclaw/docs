...
x-i18n:
    generated_at: "2026-07-14T13:35:12Z"
    model: gpt-5.6
...
- Encabezados:
  - H1: Eliminación de BlueBubbles y la ruta de iMessage mediante imsg
  - H2: Qué cambió
  - H2: Qué hacer
...
- Encabezados:
  ...
  - H2: Rutas de autenticación basadas únicamente en la configuración
...
- Encabezados:
  ...
  - H3: El día del mes y el día de la semana usan lógica O
...
- Encabezados:
  ...
  - H3: Modo reflejado
  - H2: Estados de los flujos
  - H2: Estado persistente y seguimiento de revisiones
  - H2: Comportamiento de la cancelación
...
- Encabezados:
  ...
  - H2: Relación de las tareas con otros sistemas
  - H2: Temas relacionados
...
- Encabezados:
  ...
  - H2: Configurar los valores predeterminados compartidos
...
- Encabezados:
  ...
  - H2: Voz
  - H3: Canales de voz
  - H3: Seguir a usuarios en los canales de voz
  - H3: Mensajes de voz
  - H2: Solución de problemas
...
- Encabezados:
  ...
  - H2: Obtener identificadores de grupos y usuarios
  - H3: Identificadores de grupo (chatid, formato: ocxxx)
  - H3: Identificadores de usuario (openid, formato: ouxxx)
...
- Encabezados:
  ...
  - H3: Opción C: túnel de Cloudflare
  - H2: Cómo funciona
  - H2: Destinos
...
- Encabezados:
  ...
  - H2: Claves de sesión
  - H2: Patrón: mensajes directos personales y grupos públicos (un solo agente)
  ...
  - H2: Restricciones de herramientas por grupo o canal (opcional)
...
- Encabezados:
  ...
  - H2: Paso a paso
  - H2: Equivalencia de acciones de un vistazo
...
- Encabezados:
  ...
  - H2: Contenido multimedia, división en fragmentos y destinos de entrega
  - H2: Acciones de la API privada
  - H2: Escrituras de configuración
  - H2: Combinación de mensajes directos enviados por separado (comando y URL en una sola composición)
  - H3: Situaciones y lo que ve el agente
  - H2: Recuperación de mensajes entrantes tras reiniciar un puente o el Gateway
  - H3: Señal visible para el operador
  - H3: Migración
  - H2: Solución de problemas
  - H2: Referencias a la configuración
  - H2: Contenido relacionado
...
- Encabezados:
  ...
  - H2: Si se desea comenzar desde cero para los mensajes futuros
  - H2: Contenido relacionado
...
- Encabezados:
  ...
  - H3: Normalización del identificador de cuenta
  - H3: Credenciales almacenadas en caché
  - H3: Variables de entorno
  - H2: Ejemplo de configuración
  - H2: Vistas previas en tiempo real
  - H2: Mensajes de voz
  - H2: Metadatos de aprobación
  - H3: Reglas de notificaciones autohospedadas para vistas previas finalizadas silenciosas
  - H2: Salas entre bots
  ...
  - H2: Vinculaciones de conversaciones ACP
  - H3: Configuración de vinculaciones de hilos
  - H2: Reacciones
...
- Encabezados:
  ...
  - H2: Canales (grupos)
  - H2: Destinos de entrega saliente
  - H2: Reintento del canal de mensajes directos
  - H2: Vista previa en tiempo real
...
- Encabezados:
  ...
  - H2: Objetivos
  - H2: Escrituras de configuración
  - H2: Control de acceso (mensajes directos + grupos)
  - H3: Cómo funciona
  ...
  - H3: Recuperación de archivos de canales/grupos (graphMediaFallback)
  - H2: Limitaciones conocidas
  - H3: Tiempos de espera de Webhook
  - H3: Compatibilidad con la nube de Teams y las URL de servicio
  - H3: Formato
  - H2: Configuración
  ...
  - H2: Identificadores de equipo y canal (error frecuente)
  - H2: Canales privados
  - H2: Solución de problemas
...
- Encabezados:
  ...
  - H2: Contenido multimedia + límites
  - H2: Indicadores de escritura + confirmaciones de lectura
  - H2: Reacciones al estado del ciclo de vida
  - H2: Reacciones (herramienta de mensajes)
...
- Encabezados:
  ...
  - H3: Modo de relé
  - H3: Instalaciones de Enterprise Grid en toda la organización
  - H4: Socket Mode
  ...
  - H3: Envíos de cuadros de diálogo propiedad del Plugin
...
- Encabezados:
  ...
  - H3: Destino de salida predeterminado
  - H2: Control de acceso
  - H2: Envío de SMS
...
- Encabezados:
  ...
  - H3: Identidad del bot en grupos
...
- Encabezados:
  ...
  - H2: Enlaces del Plugin y privacidad
  - H2: Control de acceso y activación
  - H2: Vinculaciones de ACP configuradas
  - H2: Comportamiento del número personal y del chat con uno mismo
  - H2: Normalización de mensajes y contexto
  - H2: Entrega, fragmentación y contenido multimedia
  - H2: Citas en respuestas
...
- Encabezados:
  ...
  - H3: Inserción de indicaciones de Markdown
...
- Encabezados:
  - H2: Compatibilidad
  - H2: Requisitos previos
  - H2: Instalación mediante la incorporación (recomendado)
...
- Ruta: /ci
- Encabezados:
  - H2: Descripción general del flujo de trabajo
  - H2: Orden de interrupción rápida
  - H2: Contexto y pruebas de la solicitud de incorporación
  ...
  - H3: Solicitudes de incorporación duplicadas después de la fusión
  - H2: Controles locales y enrutamiento de cambios
...
- Encabezados:
  - H1: CLI de ClawHub
  - H2: Descubrimiento e instalación
  - H3: Confianza en la versión
  - H2: Publicación y mantenimiento
  - H2: Contenido relacionado
...
- Encabezados:
  ...
  - H2: Prueba básica del protocolo
  - H2: Cómo usarlo
...
- Encabezados:
  ...
  - H3: Formato de --bind
  - H3: Comportamiento del ámbito de vinculación
  - H2: Archivos de identidad
  - H2: Establecimiento de la identidad
  - H2: Contenido relacionado
...
- Encabezados:
  ...
  - H2: Comandos habituales
  - H2: Sustitución de aprobaciones desde un archivo
...
- Encabezados:
  ...
  - H3: Verificación y restauración
  - H2: Qué se incluye en la copia de seguridad
  - H2: Comportamiento ante una configuración no válida
...
- Encabezados:
  ...
  - H2: Adición / eliminación de cuentas
  - H2: Inicio y cierre de sesión (interactivo)
  - H2: Solución de problemas
  - H2: Comprobación de capacidades
  - H2: Resolución de nombres en identificadores
  - H2: Contenido relacionado
...
- Encabezados:
  ...
  - H3: Modelo de confianza del arnés de la CLI
...
- Encabezados:
  - H1: openclaw cron
  - H2: Creación rápida de trabajos
  - H2: Sesiones
  - H2: Entrega
  - H3: Propiedad de la entrega
  - H3: Entrega de errores
  - H2: Programación
  ...
  - H2: Modificaciones habituales
  - H2: Comandos de administración habituales
  - H2: Temas relacionados
...
- Encabezados:
  ...
  - H2: Salida legible por máquinas
  - H2: Temas relacionados
...
- Encabezados:
  ...
  - H2: Notas
  - H2: Lista de comprobación para recuperarse de la desviación de tokens
...
- Encabezados:
  ...
  - H2: Compactación de SQLite del estado compartido
  - H2: Migración de sesiones a SQLite
  - H3: Regresión de versión tras migrar las sesiones a SQLite
  - H2: Notas
  - H2: macOS: sustituciones de entorno de launchctl
  - H2: Temas relacionados
...
- Encabezados:
  ...
  - H3: Límites de disco
  - H3: Política de tráfico saliente
  - H2: fleet list
  - H2: fleet status
  - H2: fleet logs
  ...
  - H2: fleet doctor
  - H2: fleet rm
  - H2: Almacenamiento y disposición de los contenedores
...
- Ruta: /cli/gateway
- Encabezados:
  - H2: Ejecución del Gateway
  - H3: Opciones
  - H2: Reinicio del Gateway
  - H3: Análisis de rendimiento del Gateway
  - H2: Consulta de un Gateway en ejecución
  - H3: gateway health
  ...
  - H2: Gestión del servicio Gateway
  - H3: Instalación con un contenedor
  - H2: Detección de gateways (Bonjour)
  - H3: gateway discover
  - H2: Temas relacionados
...
- Encabezados:
  - H1: openclaw hooks
  - H2: Enumeración de hooks
  - H2: Obtención de información de un hook
  - H2: Comprobación de elegibilidad
  - H2: Activación de un hook
  - H2: Desactivación de un hook
  - H2: Instalación y actualización de paquetes de hooks
  - H2: Hooks incluidos
...
- Ruta: /cli/infer
- Encabezados:
  - H2: Conversión de infer en una habilidad
  - H2: Árbol de comandos
...
- Encabezados:
  ...
  - H2: Ejemplos
  - H2: Comportamiento de recuperación y alternativa
  - H2: Temas relacionados
...
- Ruta: /cli/mcp
- Encabezados:
  - H2: Elección de la ruta MCP adecuada
  - H2: OpenClaw como servidor MCP
  - H3: Cuándo utilizar serve
  - H3: Cómo funciona
  - H3: Elección de un modo de cliente
  - H3: Qué expone serve
  - H3: Uso
  ...
  - H3: Recetas habituales de servidores
  - H3: Estructuras de salida JSON
  - H3: Transporte Stdio
  - H3: Transporte SSE/HTTP
  - H3: Flujo de trabajo de OAuth
  - H3: Transporte HTTP por secuencias
...
- Encabezados:
  ...
  - H2: Dreaming
  - H2: Dependencia del Gateway de SecretRef
  - H2: Temas relacionados
...
- Encabezados:
  ...
  - H3: Estado del archivo y de revisión manual
  - H2: Proveedor Codex
...
- Encabezados:
  ...
  - H2: Autenticación del Gateway para el host Node
...
- Encabezados:
  ...
  - H2: Emparejamiento
  - H2: Invocación
  - H2: Notificaciones, envío, ubicación y pantalla
  - H2: Contenido relacionado
...
- Encabezados:
  ...
  - H4: Red
  - H4: Acceso de entrada y de canales
  - H4: Gateway
  ...
  - H2: Ejecución de comprobaciones
  - H2: Configuración de políticas
  - H2: Aceptación del estado de las políticas
  - H2: Hallazgos
  - H2: Reparación
  - H2: Códigos de salida
  - H2: Contenido relacionado
...
- Encabezados:
  ...
  - H2: Descubrimiento pasivo en la lista de modelos
...
- Encabezados:
  ...
  - H2: Por qué es necesario volver a crear
...
- Encabezados:
  - H1: openclaw secrets
  - H2: Recarga de la instantánea del entorno de ejecución
  - H2: Auditoría
  - H2: Configuración (asistente interactivo)
  - H3: Seguridad del proveedor de ejecución
  - H2: Aplicación de un plan guardado
...
- Encabezados:
  ...
  - H2: Seguimiento del progreso de una trayectoria
  - H2: Exportación de un paquete de trayectoria
  - H2: Mantenimiento de limpieza
  - H2: Compaction de una sesión
...
- Ruta: /cli/status
- Encabezados:
  - H2: Resolución de sesiones y modelos
  - H2: Uso y cuota
...
- Encabezados:
  ...
  - H2: Vínculos con la configuración
  - H2: Contenido relacionado
...
- Encabezados:
  ...
  - H2: move
  - H2: dispatch
  - H2: Equivalencia con el comando de barra
  - H2: Permisos
  - H2: Solución de problemas
...
- Encabezados:
  ...
  - H3: Tipos de sesión
  - H2: Activación por sesión
  - H2: Cómo visualizarlo
  - H2: Modos de consulta
  - H2: Estilos de indicaciones
  - H2: Política de modelo alternativo
...
- Encabezados:
  ...
  - H2: Composición de las indicaciones
  - H2: Enlaces
  - H3: Enlaces internos (enlaces del Gateway)
  - H3: Enlaces de Plugin
  - H2: Transmisión
...
- Encabezados:
  ...
  - H2: Qué NO se encuentra en el espacio de trabajo
  - H2: Copia de seguridad con Git (recomendada y privada)
  - H2: No confirmar secretos
  - H2: Traslado del espacio de trabajo a un equipo nuevo
  - H2: Notas avanzadas
  - H2: Contenido relacionado
...
- Encabezados:
  ...
  - H2: Vinculación y confianza local
...
- Encabezados:
  - H2: Activación de compromisos
  - H2: Cómo funciona
  - H2: Ámbito
  - H2: Compromisos frente a recordatorios
  - H2: Gestión de compromisos
...
- Encabezados:
  ...
  - H3: Adición a la indicación del sistema
...
- Encabezados:
  ...
  - H2: Por qué utilizar delegados
  - H2: Niveles de capacidad
  - H3: Nivel 1: solo lectura y borradores
  - H3: Nivel 2: envío en representación
  ...
  - H3: Aislamiento del entorno restringido
  - H3: Registro de auditoría
  - H2: Configuración de un delegado
  - H3: 1. Crear el agente delegado
  - H3: 2. Configurar la delegación del proveedor de identidades
  - H4: Microsoft 365
  - H4: Google Workspace
  - H3: 3. Vincular el delegado a los canales
...
- Encabezados:
  ...
  - H3: Cobertura del informe de la prueba paralela de control de calidad
  - H2: Programación
  - H2: Inicio rápido
  - H2: Comando de barra
...
- Encabezados:
  ...
  - H2: Modo ligero para modelos locales
  - H3: Por qué utilizar estas herramientas
  - H3: Cuándo activarlo
...
- Encabezados:
  ...
  - H2: Interpretación de los tiempos
...
- Encabezados:
  - H2: Qué añade respecto a la memoria integrada
  - H2: Primeros pasos
...
- Encabezados:
  - H2: Motivo de esta refactorización
  - H2: Qué se publicó
...
- Encabezados:
  - H2: Desduplicación de mensajes entrantes
  - H2: Supresión de rebotes de mensajes entrantes
  - H2: Sesiones y dispositivos
  - H2: Cuerpos de las instrucciones y contexto del historial
  - H2: Metadatos de resultados de herramientas
  - H2: Puesta en cola y seguimientos
  - H2: Propiedad de la ejecución del canal
...
- Encabezados:
  ...
  - H2: Política de la fuente de selección
  - H2: Caché para omitir fallos de autenticación
  - H2: Avisos de respaldo visibles para el usuario
  - H2: Almacenamiento de autenticación (claves + OAuth)
  - H2: Identificadores de perfil
  - H2: Orden de rotación
  - H3: Persistencia de la sesión (favorable para la caché)
...
- Encabezados:
  - H2: Reglas rápidas
  - H2: Configuración de proveedores en la interfaz de control
  - H2: Comportamiento del proveedor gestionado por el Plugin
  - H2: Rotación de claves de API
  - H2: Plugins oficiales de proveedores
  - H3: OpenAI
  - H3: Anthropic
  - H3: OAuth de OpenAI ChatGPT/Codex
  - H3: Otras opciones alojadas basadas en suscripción
  - H3: OpenCode
...
- Encabezados:
  ...
  - H2: Fuente de selección y rigurosidad del respaldo
...
- Encabezados:
  - H2: Qué constituye un agente
  - H2: Rutas
  - H3: Modo de agente único (predeterminado)
  - H2: Asistente de agentes
  - H2: Inicio rápido
  - H2: Varios agentes, varias personalidades
  - H2: Almacenes de la wiki de memoria por agente
...
- Encabezados:
  ...
  - H3: 1) Opción preferida: agentes separados
...
- Encabezados:
  ...
  - H3: Fase 1: contratos de carril y trabajo intensivo en segundo plano
...
- Encabezados:
  ...
  - H2: Reglas de combinación y deduplicación (por qué importa instanceId)
  - H2: TTL y tamaño limitado
  - H2: Consideración sobre conexiones remotas/túneles (IP de bucle local)
  - H2: Consumidores
...
- Encabezados:
  ...
  - H3: Modo detallado
  - H3: Texto de comandos/ejecución
  - H3: Canal de comentarios
...
- Encabezados:
  - H2: Superficie de comandos
  - H3: Ejecución de QA respaldada por un perfil
  - H2: Flujo del operador
  - H3: Pruebas de humo de observabilidad
  - H3: Carriles de pruebas de humo de Matrix
  ...
  - H2: Cobertura de transportes en vivo
  ...
  - H2: Carriles simulados de proveedores
  - H2: Adaptadores de transporte
  - H3: Añadir un canal
  - H3: Nombres de los asistentes de escenarios
  - H2: Informes
  - H2: Documentación relacionada
...
- Encabezados:
  ...
  - H2: Cambios de estado de sesión
...
- Encabezados:
  ...
  - H3: Mattermost
  - H3: Matrix
  - H2: Actualizaciones de la vista previa del progreso de herramientas
  - H2: Renderizado del borrador de progreso
  - H3: Canal de comentarios de progreso
  - H2: Contenido relacionado
...
- Encabezados:
  ...
  - H2: Activar mediante la configuración
  - H2: Anulación mediante variable de entorno (puntual)
  - H2: Indicadores del perfilador
...
- Encabezados:
  ...
  - H2: Configuración de la cuenta de servicio para Gateways sin interfaz
...
- Encabezados:
  ...
  - H3: Clasificación por tipo de conversación
  - H2: Modelo de privacidad
...
- Encabezados:
  ...
  - H2: Control de la credencial utilizada
...
- Encabezados:
  ...
  - H3: Seguridad del proceso de escucha del Gateway
  - H2: Qué se anuncia
  ...
  - H2: Nombres de instancia con secuencias de escape (\032)
...
- Encabezados:
  ...
  - H2: Uso histórico de la red final
...
- Encabezados:
  ...
  - H3: Instalación de canales
  - H2: Despacho de una sesión
  - H2: Modelo de seguridad
  - H2: Solución de problemas
  - H2: Contenido relacionado
...
- Encabezados:
  ...
  - H3: Política de tiempo de ejecución
  ...
  - H3: Campos de coincidencia de vinculación
...
- Encabezados:
  ...
  - H3: Anulaciones de modelos de canal
...
- Encabezados:
  ...
  - H3: Herramientas MCP y de Plugin en la política de herramientas del entorno aislado
  - H3: tools.codeMode
...
- Encabezados:
  ...
  - H3: Repositorio hermano de Skills mediante enlace simbólico
  - H2: Patrones habituales
  - H3: Base compartida de Skills con una anulación
  - H3: Configuración multiplataforma
  - H3: Aprobación automática de redes de nodos de confianza
...
- Encabezados:
  ...
  - H2: Skills
  - H2: Plugins
  - H3: Configuración del Plugin del entorno de Codex
  - H2: Compromisos
  - H2: Navegador
  - H2: Interfaz de usuario
  - H2: Gateway
  - H3: Puntos de conexión compatibles con OpenAI
...
- Encabezados:
  - H2: Inicio rápido
  - H3: Modos sin interfaz gráfica y de automatización
  - H2: Modo de análisis estático de solo lectura
  - H2: Qué hace (resumen)
  - H2: Relleno de datos y restablecimiento de la interfaz de Dreams
...
- Encabezados:
  ...
  - H3: Configuración híbrida: servicio alojado principal y respaldo local
...
- Encabezados:
  ...
  - H2: Formato de la consola (registro de subsistemas)
  - H2: Temas relacionados
...
- Encabezados:
  ...
  - H2: Lista de comprobación del aislamiento
...
- Encabezados:
  ...
  - H3: Estructura de la respuesta de herramientas sin transmisión
  - H3: Estructura de la respuesta de herramientas con transmisión
...
- Encabezados:
  ...
  - H2: Herramientas (herramientas de funciones del lado del cliente)
...
- Encabezados:
  ...
  - H3: Conversación
  - H3: Colas y sesiones
  - H3: Telemetría de disponibilidad de la sesión
  - H3: Ciclo de vida del entorno de ejecución
  - H3: Ejecución de herramientas y detección de bucles
  - H3: Ejecución
  - H3: Funcionamiento interno de los diagnósticos (memoria, cargas útiles y estado del exportador)
...
- Encabezados:
  ...
  - H2: Aprobaciones de emparejamiento de Nodes
...
- Encabezados:
  ...
  - H2: Límites de confianza de los eventos de Node (2026.3.31+)
...
- Encabezados:
  ...
  - H3: Rol del trabajador y protocolo cerrado
  ...
  - H2: Delimitación del ámbito de los eventos de difusión
  ...
  - H2: Aprobaciones de ejecución
  - H2: Alternativa de entrega del agente
  - H2: Control de versiones
...
- Encabezados:
  - H2: Qué sobrevive a un reinicio
  ...
  - H2: Salvaguardas y observabilidad
...
- Encabezados:
  ...
  - H2: Política de herramientas: qué herramientas existen o pueden invocarse
  - H3: Grupos de herramientas (formas abreviadas)
  - H2: Privilegios elevados: «ejecutar en el host» solo para exec
  - H2: Soluciones comunes para el «confinamiento del entorno aislado»
  - H3: «La herramienta X está bloqueada por la política de herramientas del entorno aislado»
  - H3: «Creía que este era el agente principal, ¿por qué está aislado?»
  - H2: Temas relacionados
...
- Encabezados:
  ...
  - H2: Política de herramientas y mecanismos de escape
  - H2: Anulaciones para varios agentes
...
- Encabezados:
  ...
  - H2: Comportamiento según el tipo de destino
...
- Encabezados:
  - H2: Modelo de ejecución
  - H2: Inyección durante la salida (centinelas)
  ...
  - H2: Notas de compatibilidad de la autenticación heredada
...
- Encabezados:
  ...
  - H2: Comportamientos que no son vulnerabilidades por diseño
  - H2: Confianza en el Gateway y los nodos
  - H2: Modelo de amenazas
  - H2: Acceso a mensajes directos: emparejamiento, lista de permitidos, abierto, desactivado
  ...
  - H2: Plugins
  - H2: Aislamiento
  - H3: Salvaguarda para la delegación a subagentes
  ...
  - H3: Enlace, puerto y cortafuegos
  - H3: Publicación de puertos de Docker con UFW
  - H3: Descubrimiento mediante mDNS/Bonjour
  ...
  - H2: Confianza en la implementación y el host
  ...
  - H3: Contención
  - H3: Rotación (suponer que existe una vulneración si se filtraron secretos)
  - H3: Auditoría
  - H3: Recopilación para un informe
...
- Encabezados:
  - H2: Valor predeterminado: sin auxiliar de Python
...
- Encabezados:
  ...
  - H3: Solo Tailnet (enlace a la IP de Tailnet)
...
- Encabezados:
  ...
  - H2: Política y comportamiento de enrutamiento
  - H2: Respuestas
  - H2: Ejemplo
  - H2: Temas relacionados
...
- Encabezados:
  ...
  - H2: Incompatibilidad de protocolo después de revertir una versión
  - H2: Enlace simbólico de Skills omitido por escapar de la ruta
  ...
  - H2: Bucle del supervisor launchd de macOS con LaunchAgents de Gateway/node duplicados
  ...
  - H2: Node emparejado, pero la herramienta falla
  - H2: La herramienta del navegador falla
  - H2: Si algo dejó de funcionar de repente después de actualizar
  - H2: Contenido relacionado
...
- Encabezados:
  ...
  - H3: Orientación para el despliegue
...
- Encabezados:
  ...
  - H2: Creación de perfiles del inicio y los comandos de la CLI
  - H2: Modo de vigilancia del Gateway
...
- Encabezados:
  ...
  - H2: Variables de entorno de la interfaz de usuario
...
- Encabezados:
  ...
  - H2: Ayudante de lectura de GitHub
...
- Encabezados:
  ...
  - H2: En vivo: comprobación de capacidades del Node de Android
  - H2: En vivo: prueba de humo de modelos (claves de perfil)
  - H3: Capa 1: finalización directa del modelo (sin Gateway)
  - H3: Capa 2: Gateway y prueba de humo del agente de desarrollo (lo que realmente hace "@openclaw")
  - H2: En vivo: prueba de humo del backend de la CLI (Claude, Gemini u otras CLI locales)
  - H2: En vivo: accesibilidad del proxy HTTP/2 de APNs
  - H2: En vivo: prueba de humo de vinculación de ACP (/acp spawn ... --bind here)
  - H2: En vivo: prueba de humo del arnés del servidor de aplicaciones Codex
  - H3: Recetas recomendadas para pruebas en vivo
  - H2: En vivo: matriz de modelos (qué cubrimos)
  - H3: Agregadores y Gateways alternativos
  - H2: Credenciales (no confirmar nunca en el repositorio)
...
- Encabezados:
  ...
  - H2: Flujos de trabajo en vivo y con Docker/Parallels
  ...
  - H3: E2E: prueba de humo del backend de OpenShell
  - H3: En vivo (proveedores y modelos reales)
  - H2: ¿Qué conjunto de pruebas se debe ejecutar?
...
- Encabezados:
  ...
  - H2: Error 429 de Anthropic con contextos largos
  ...
  - H2: La política de instalación bloquea las instalaciones o actualizaciones de plugins
...
- Encabezados:
  - H2: Incluir los binarios necesarios en la imagen
  - H2: Compilación e inicio
  - H2: Qué se conserva y dónde
  - H2: Actualizaciones
  - H2: Temas relacionados
...
- Encabezados:
  ...
  - H3: Variables de entorno
  - H3: Imágenes compiladas desde el código fuente con los plugins seleccionados
  - H3: Observabilidad
  - H3: Comprobaciones de estado
  - H3: LAN frente a bucle local
  - H3: Proveedores locales del host
  - H3: Backend de la CLI de Claude en Docker
  - H3: Bonjour / mDNS
  - H3: Almacenamiento y persistencia
  - H3: Utilidades de shell (opcionales)
...
- Encabezados:
  ...
  - H2: Instalación manual
  - H2: Configuración remota de canales
  - H2: Acceso remoto
  - H2: Actualización
  - H2: Temas relacionados
...
- Encabezados:
  ...
  - H3: Instalación desde el checkout de la rama main de GitHub
...
- Encabezados:
  - H2: Opción predeterminada recomendada (para la mayoría de usuarios)
  - H2: Opciones de VM de macOS
  - H3: VM local en un Mac con Apple Silicon (Lume)
  ...
  - H2: 5) Conectarse a la VM mediante SSH
  - H2: 6) Instalar OpenClaw
  - H2: 7) Configurar los canales
...
- Encabezados:
  ...
  - H3: Errores frecuentes
  - H3: Lista de comprobación para la verificación
  - H2: Actualización de un plugin en el mismo lugar
  - H2: Temas relacionados
...
- Encabezados:
  - H2: Requisitos previos
  - H2: Configuración
  - H2: Verificación de la configuración de seguridad
  - H2: Notas sobre ARM
  - H2: Persistencia y copias de seguridad
...
- Encabezados:
  - H2: Compatibilidad del hardware
  - H2: Requisitos previos
  - H2: Configuración
...
- Encabezados:
  ...
  - H2: Implementación
  - H2: El Blueprint
  - H2: Elección de un plan
  - H2: Después de la implementación
  - H3: Acceso a la interfaz de control
  - H3: Registros
  - H3: Acceso al shell
  - H3: Variables de entorno
  ...
  - H3: Fallos en las comprobaciones de estado
  - H2: Próximos pasos
...
- Encabezados:
  ...
  - H2: Alternativa: usar npm, pnpm o bun manualmente
  - H3: Temas avanzados sobre la instalación con npm
...
- Encabezados:
  ...
  - H2: Ejemplos de configuración
  - H3: Proveedor con alternativa mediante CLI (OpenAI y CLI de Whisper)
  ...
  - H2: Aspectos que deben tenerse en cuenta
  - H2: Contenido relacionado
...
- Encabezados:
  ...
  - H3: Comandos de iOS (mediante node.invoke del Gateway)
  ...
  - H3: Comandos de Android (mediante node.invoke del Gateway)
  - H2: Aplicación para macOS
  - H3: Ajuste de usuario de macOS
  - H3: Utilidad de la CLI (invocación de Node)
  - H2: Host de Node para Linux
...
- Encabezados:
  ...
  - H2: El comando computer.act de Node
...
- Encabezados:
  ...
  - H2: Canalización de respuestas automáticas
  - H2: Conversión de contenido multimedia entrante en comandos
...
- Encabezados:
  ...
  - H2: Diferencias entre versiones y orden de actualización
  - H2: Host remoto de Node (system.run)
  - H3: Iniciar un host de Node (en primer plano)
  - H3: Gateway remoto mediante un túnel SSH (vinculación a la interfaz de bucle invertido)
  - H3: Iniciar un host de Node (servicio)
  - H3: Emparejar y asignar un nombre
  - H3: Servidores MCP alojados en Node
  - H3: Skills alojadas en Node
  ...
  - H3: A2UI (lienzo)
  - H2: Fotos y vídeos (cámara de Node)
  ...
  - H2: Vinculación del Node de exec
  - H2: Mapa de permisos
...
- Encabezados:
  - H2: Resumen
  - H2: Por qué se usa un selector (y no solo un interruptor)
...
- Encabezados:
  ...
  - H3: Credenciales de proveedores
  - H2: Reglas y comportamiento
  - H3: Detección automática (predeterminada)
  - H3: Compatibilidad con proxy (llamadas a proveedores de audio y vídeo)
  - H2: Capacidades
...
- Encabezados:
  ...
  - H2: Cómo se dirigen las alertas de conexión
  - H2: Solución de problemas
  - H2: Contenido relacionado
...
- Encabezados:
  ...
  - H2: Códigos de error habituales de Node
...
- Encabezados:
  ...
  - H2: Problema
  - H2: Objetivos
  - H2: Elementos fuera del alcance (v1)
  - H2: Trabajos anteriores (qué copiamos y qué invertimos)
  - H2: Decisión de arquitectura: bucle en el trabajador, inferencia mediante el Gateway
  - H2: Componentes
  ...
  - H3: 4. Protocolo del trabajador (dedicado; no es el protocolo de Node)
  - H3: 5. RPC del backend de sesiones
  - H3: 6. Sincronización del espacio de trabajo
  - H3: 7. Máquina de estados de asignación, sesiones e interfaz
...
- Encabezados:
  ...
  - H3: 5. Verificar que el Node esté conectado
  - H3: 6. Chat e historial
  - H3: 7. Canvas y cámara
...
- Encabezados:
  ...
  - H2: Requisitos
  - H2: Activar el acceso
  - H3: 1. Autorizar el comando del Gateway
  - H3: 2. Activar el uso compartido en el iPhone
  - H2: Solicitar el resumen de hoy
  - H2: Comportamiento de privacidad
  - H2: Solución de problemas
  - H3: El comando no está declarado por el Node
  - H3: El comando requiere aceptación explícita
...
- Encabezados:
  ...
  - H2: Revisar las aprobaciones de comandos
  - H2: Node directo opcional para Apple Watch
  - H2: Notificaciones push respaldadas por un relé para compilaciones oficiales
...
- Encabezados:
  ...
  - H2: Solución de problemas
  - H3: Error de compilación: incompatibilidad de la cadena de herramientas o del SDK
...
- Encabezados:
  ...
  - H2: Activar para OpenClaw (ai.openclaw)
  - H2: Desactivar después de la depuración
  - H2: Contenido relacionado
...
- Encabezados:
  ...
  - H2: Concesiones de accesibilidad para entornos de ejecución de Node y CLI
...
- Encabezados:
  ...
  - H2: Requisitos
  - H2: Modos
  - H2: Comportamiento del entorno de ejecución (palabra de activación)
...
- Encabezados:
  ...
  - H2: Objetivos
  - H2: Cómo funciona
  - H3: Transporte del Gateway y el Node
  - H3: Servicio del Node e IPC de la aplicación
...
- Encabezados:
  ...
  - H2: Responsabilidades de la aplicación
  - H2: Páginas de información detallada de macOS
  - H2: Contenido relacionado
...
- Encabezados:
  - H2: Recomendado: centro de Windows
  - H3: Qué incluye el centro de Windows
  - H3: Primer inicio
  ...
  - H3: El chat web no puede conectarse a un Gateway remoto
  - H3: Los comandos screen.snapshot, de cámara o de audio fallan
...
- Encabezados:
  ...
  - H2: Puntos de integración del proveedor y el entorno de ejecución
  - H2: Lista de comprobación de archivos
  - H2: Ejemplo práctico: generación de imágenes
  - H2: Proveedores de representaciones vectoriales
  - H2: Lista de comprobación para la revisión
  - H2: Contenido relacionado
...
- Encabezados:
  ...
  - H2: Enlaces de ejecución del proveedor
  - H3: Orden y uso de los enlaces
  - H3: Ejemplo de proveedor
  - H3: Ejemplos integrados
  - H2: Funciones auxiliares de ejecución
  - H3: api.runtime.imageGeneration
  - H2: Rutas HTTP del Gateway
  - H2: Rutas de importación del SDK de plugins
  - H2: Esquemas de herramientas de mensajería
  - H2: Resolución de destinos de canales
  ...
  - H2: Añadir una capacidad nueva
  - H3: Lista de comprobación de capacidades
  - H3: Plantilla de capacidades
  - H2: Contenido relacionado
...
- Encabezados:
  ...
  - H3: Plugins de canales y herramienta de mensajería compartida
  - H2: Modelo de propiedad de capacidades
  - H3: Organización de capacidades por capas
  ...
  - H2: Detalles internos y referencia
  - H2: Contenido relacionado
...
- Encabezados:
  ...
  - H2: Dependencias de ejecución y limpieza
  - H2: Seguridad
  - H2: Solución de problemas
  - H2: Contenido relacionado
...
- Encabezados:
  - H2: Responsabilidades del plugin
  - H2: Plugin de backend mínimo
  - H2: Forma de la configuración
  - H2: Enlaces avanzados del backend
  - H3: ownsNativeCompaction: excluirse de la Compaction de OpenClaw
...
- Encabezados:
  ...
  - H2: Configuración rápida
  - H2: Comandos
  - H2: Opciones del catálogo
  - H2: Catálogo incluido de macOS
...
- Encabezados:
  ...
  - H2: Envío de comentarios sobre Codex
...
- Encabezados:
  - H2: Requisitos
  - H2: Inicio rápido
  - H2: Compartir hilos con Codex Desktop y la CLI
  - H2: Supervisar sesiones de Codex
  - H2: Configuración
  - H3: Compaction
  - H2: Verificar el entorno de ejecución de Codex
  ...
  - H3: Inspeccionar localmente los hilos de Codex
...
- Encabezados:
  ...
  - H2: Inventario y propiedad de las aplicaciones
  - H2: Aplicaciones de cuentas conectadas
  - H2: Configuración de aplicaciones de hilos
...
- Encabezados:
  ...
  - H2: Gateway local + Chrome en Parallels
  ...
  - H3: Verificar OAuth mediante el diagnóstico
  - H3: Resolver, realizar la comprobación previa y leer artefactos
  - H3: Prueba rápida en vivo
  - H3: Ejemplos de creación
  - H2: Configuración
...
- Encabezados:
  ...
  - H2: Depurar hooks del entorno de ejecución
...
- Encabezados:
  ...
  - H2: Diagnósticos del entorno de ejecución
  - H2: Solución de problemas
...
- Encabezados:
  ...
  - H3: Las capturas se realizan correctamente, pero no aparece ninguna tarjeta
  - H2: Contenido relacionado
...
- Encabezados:
  ...
  - H2: Afirmaciones estructuradas y evidencias
  - H2: Metadatos de entidades orientados al agente
...
- Encabezados:
  ...
  - H3: Visibilidad del valor de reserva de los botones
...
- Encabezados:
  ...
  - H2: Modelo de seguridad
  - H2: Antes de comenzar
  - H2: Configurar secretos registrados
  - H2: Usar la herramienta del agente
  - H2: Niveles de políticas y aprobaciones
  - H2: Inspeccionar el estado y el historial de auditoría
...
- Encabezados:
  ...
  - H2: Solo para el checkout del código fuente
...
- Encabezados:
  - H1: Plugin de núcleo de memoria
  - H2: Distribución
  - H2: Superficie
...
- Encabezados:
  ...
  - H2: Lo que aún administra el núcleo
  - H3: Inicialización de autenticación administrada por el arnés
  ...
  - H2: Rigor del entorno de ejecución
...
- Encabezados:
  - H2: Resolutor del entorno de ejecución
  - H2: Resultado
  - H2: Grupos de acceso
  - H2: Modos de eventos
...
- Encabezados:
  ...
  - H3: Indicadores de escritura
  - H3: Parámetros de origen multimedia
...
- Encabezados:
  ...
  - H2: Elementos obsoletos activos
  - H2: Migración de voz conversacional y en tiempo real
...
- Encabezados:
  ...
  - H3: Infraestructura
  - H4: Conexiones MCP por solicitante
  - H3: Enlaces del host para plugins de flujo de trabajo
  - H3: Registro de detección del Gateway
...
- Encabezados:
  ...
  - H3: Importaciones específicas de auxiliares de configuración
  - H3: Promoción de cuenta única controlada por el canal
...
- Encabezados:
  ...
  - H3: Auxiliares obsoletos de compatibilidad y pruebas
  - H3: Subrutas auxiliares reservadas para plugins incluidos
  - H2: Contenido relacionado
...
- Encabezados:
  ...
  - H2: Patrones de pruebas
  - H3: Pruebas de contratos de registro
  - H3: Pruebas del acceso a la configuración del entorno de ejecución
  ...
  - H3: Ejecución de pruebas delimitadas
...
- Encabezados:
  - H2: Requisitos
  - H2: Inicio rápido
  - H2: Creación de una herramienta
...
- Encabezados:
  ...
  - H2: Antes de comenzar
  - H2: Almacenamiento de una clave de proveedor en Vault
  - H2: Visibilidad de Vault para el Gateway
  - H2: Generación y aplicación de un plan de SecretRef
  - H2: Configuración de más claves de proveedores
...
- Encabezados:
  ...
  - H3: Fallan las conexiones de Google Meet a Twilio
...
- Encabezados:
  - H2: Configuración de rutas
  - H2: Modelo de seguridad
  - H2: Formato de la solicitud
  - H2: Acciones compatibles
  - H3: createflow
  - H3: runtask
  - H2: Forma de la respuesta
  - H2: Contenido relacionado
...
- Encabezados:
  - H2: Primeros pasos
  - H2: Detección automática de modelos
  - H2: Configuración rápida (mediante AWS)
  - H2: Configuración avanzada
  - H2: Contenido relacionado
...
- Encabezados:
  ...
  - H2: Representaciones vectoriales para la búsqueda en memoria
  - H3: Configuración
  - H3: Cómo funciona
  - H2: Contenido relacionado
...
- Encabezados:
  ...
  - H2: Páginas de información general compartida
...
- Encabezados:
  ...
  - H3: Host de la LAN o la red de Tailscale
  - H2: Solución de problemas
...
- Encabezados:
  ...
  - H3: Los nombres de los modelos son nombres de implementaciones
...
- Encabezados:
  ...
  - H3: Fase 2: Limpieza basada primero en arrendamientos
  - H3: Eliminación al inicio basada primero en arrendamientos
  - H3: Fase 4: Filas de propiedad de sesiones
...
- Encabezados:
  - H1: Refactorización del estado con la base de datos primero
  - H2: Decisión
  ...
  - H2: Estructura del esquema objetivo
  ...
  - H3: Fase 5: Copia de seguridad, restauración, limpieza y verificación
...
- Encabezados:
  ...
  - H2: Objetivos
  - H2: Objetivos excluidos
  - H2: Línea base previa al despliegue y mapa de evidencias
  - H2: Trabajo previo
  - H2: Arquitectura y propiedad
  - H2: Registro persistente
  - H2: Máquina de estados y comparación y asignación
  - H2: API del Gateway
  - H2: Eventos y acciones portables
  - H2: Interfaz de control
  - H2: Autorización y privacidad
  - H2: Proyección de audiencia
  - H2: Convergencia de superficies de entrega
  ...
  - H3: PR 6: comportamiento de cierre seguro
...
- Encabezados:
  ...
  - H2: Skills principales (habilítelas en Settings → Skills)
  - H2: Notas de uso
  - H2: Contenido relacionado
...
- Encabezados:
  ...
  - H2: Cierre estable de main
  - H2: Comprobaciones previas al lanzamiento
  ...
  - H2: Secuencia regular de lanzamientos beta y estables más recientes
...
- Encabezados:
  - H2: Dónde se generan los costes
  - H2: Cómo se detectan las claves
  - H2: Funciones que pueden consumir claves
  ...
  - H3: Análisis y sondeo de modelos
  - H3: Conversación (voz)
...
- Encabezados:
  ...
  - H2: Ciclo de vida de la ejecución y las instantáneas
...
- Encabezados:
  ...
  - H2: Bloques de la ruta de lanzamiento de Docker
  ...
  - H2: Archivos del flujo de trabajo
...
- Encabezados:
  ...
  - H3: Tiempo de espera de las incrustaciones en línea
  ...
  - H2: Búsqueda en la memoria de sesiones (experimental)
...
- Encabezados:
  ...
  - H2: Comprobación aislada de la CLI compilada
  - H2: Comprobación previa
  - H2: Escenario controlado por agentes
...
- Encabezados:
  ...
  - H3: Proveedores mediante arnés de CLI (Claude Code, Gemini CLI)
  ...
  - H3: Configuración básica centrada en el coste
  - H2: Pruebas de regresión en vivo
  - H3: Resultados esperados de Anthropic en vivo
  - H3: Resultados esperados de OpenAI en vivo
...
- Encabezados:
  ...
  - H2: [embed ...]
  - H2: Estructura de renderizado almacenada
  - H2: Contenido relacionado
...
- Encabezados:
  ...
  - H3: Reversión a una versión anterior tras el cambio a SQLite
  ...
  - H2: Cuándo se produce la Compaction automática
  ...
  - H2: Volcado de memoria previo a la Compaction
...
- Encabezados:
  - H1: TOOLS.md: notas sobre las herramientas del usuario (editables)
  - H2: Ejemplos
  - H3: imsg
  - H3: sag
  - H2: Contenido relacionado
...
- Encabezados:
  - H1: USER.md: información sobre la persona
  - H2: Contexto
  - H2: Contenido relacionado
...
- Encabezados:
  ...
  - H3: Ejemplo: mantener activa una caché de 1h mediante Heartbeat
...
- Encabezados:
  ...
  - H2: Regla global: turnos incompletos de solo razonamiento
...
- Encabezados:
  ...
  - H3: Añadir un agente (modo no interactivo)
...
- Encabezados:
  ...
  - H2: Aspectos destacados
  - H3: Fiabilidad de entrega de los canales
  ...
  - H3: Recuperación del reinicio y del estado de preparación
...
- Encabezados:
  ...
  - H4: GPT-5.6 y Codex
  - H4: Tencent Hy3
  - H4: Meta Model API y Muse Spark 1.1
  - H4: Modelos Claude
  ...
  - H3: Los bucles de fallos ahora se detienen para permitir la reparación
  ...
  - H3: Recuperación, chats largos y continuidad de las sesiones
  - H2: Agentes, trabajo en segundo plano y conexiones
  - H3: Mantener el trabajo en marcha y entregar las respuestas
  ...
  - H3: Documentación y guías operativas
...
- Encabezados:
  ...
  - H4: T-RECON-001: Detección de endpoints de agentes
  ...
  - H4: T-PERSIST-002: Manipulación maliciosa de actualizaciones de Skills
...
- Encabezados:
  ...
  - H3: Canal de ejecución del Node (capacidad de mayor riesgo)
  - H3: Almacén de emparejamientos (control de acceso a mensajes directos)
  - H3: Control de acceso de entrada (menciones y omisión mediante comandos de control)
...
- Encabezados:
  ...
  - H2: Límite de los nodos emparejados
  - H2: Permisos
  - H2: Compatibilidad
  - H2: Trabajo futuro
...
- Encabezados:
  ...
  - H3: La saga de la generación del icono (27 de enero de 2026)
  - H2: El futuro
  - H2: Contenido relacionado
...
- Encabezados:
  - H2: Resumen
  - H2: Requisitos previos (del código fuente)
...
- Encabezados:
  ...
  - H2: Voz y teléfono
  - H2: Infraestructura e implementación
  - H2: Hogar y hardware
...
- Encabezados:
  - H2: Configuración regional
  - H2: Valor predeterminado guiado
...
- Encabezados:
  - H2: Compatibilidad actual con el entorno acpx
  - H2: Configuración obligatoria
  - H2: Configuración del Plugin para el backend acpx
  - H3: Sondeo de inicio del entorno de ejecución acpx
  - H3: Descarga automática del adaptador
  - H3: Puente MCP para herramientas del Plugin
...
- Encabezados:
  ...
  - H3: Modelo mental
  - H3: Vinculaciones con la conversación actual
  ...
  - H2: Modos de vinculación y subproceso al crear sesiones
  ...
  - H2: Entorno acpx, configuración del Plugin y permisos
  - H2: Solución de problemas
  - H2: Contenido relacionado
...
- Encabezados:
  ...
  - H3: Solución 2: usar Chromium de snap en modo de solo conexión
...
- Encabezados:
  ...
  - H2: Errores engañosos habituales
  - H2: Lista de comprobación para un diagnóstico rápido
  - H2: Contenido relacionado
...
- Encabezados:
  ...
  - H2: Proveedores de CDP directo mediante WebSocket
  - H3: Browserbase
  - H3: Notte
  - H2: Seguridad
...
- Encabezados:
  ...
  - H2: Cómo funciona
  - H2: Instalar y vincular
  - H2: Utilización
  - H2: Uso remoto o entre equipos
  - H2: Diagnóstico
  - H2: Modelo de seguridad
...
- Encabezados:
  ...
  - H2: Comandos de intérpretes y entornos de ejecución
  ...
  - H3: Flujo de IPC de macOS
  - H2: Preguntas frecuentes
  - H3: ¿Cuándo se usarían accountId y threadId en un destino de aprobación?
  - H3: Cuando las aprobaciones se envían a una sesión, ¿puede aprobarlas cualquier participante de esa sesión?
  - H2: Contenido relacionado
...
- Encabezados:
  ...
  - H2: Permitir automáticamente las CLI de Skills
  - H2: Binarios seguros y reenvío de aprobaciones
  - H2: Edición de la interfaz de control
...
- Encabezados:
  ...
  - H3: firecrawlsearch
  - H3: firecrawlscrape
  - H2: Evasión sigilosa de bots
  - H2: Cómo utiliza webfetch a Firecrawl
  - H2: Contenido relacionado
...
- Encabezados:
  ...
  - H2: Parámetros de la herramienta
  - H2: Salida
  - H2: Ejemplo: paso de un flujo de trabajo de Lobster
...
- Encabezados:
  ...
  - H3: run
  - H3: resume
  - H3: Modo de flujo de tareas gestionado
  - H2: Envolvente de salida
  - H2: Aprobaciones
  - H2: OpenProse
  - H2: Seguridad
  - H2: Solución de problemas
...
- Encabezados:
  ...
  - H2: Configuración recomendada
  - H2: Protección posterior a la Compaction
...
- Encabezados:
  ...
  - H2: Asignaciones de proveedores (cómo se distribuyen los proveedores entre las superficies)
  - H2: Contenido relacionado
...
- Encabezados:
  ...
  - H2: Inicio rápido
  - H2: Configuración
  - H3: Elegir un origen de instalación
  - H3: Política de instalación del operador
  - H3: Configurar la política de plugins
...
- Encabezados:
  ...
  - H2: Límites
  - H2: Solución de problemas
  - H3: Diagnóstico de la política de herramientas
  - H2: Contenido relacionado
...
- Encabezados:
  ...
  - H2: Skills en entornos aislados y variables de entorno
...
- Encabezados:
  - H2: Sesión actual
  - H2: Dirección frente a puesta en cola
  - H2: Subagentes
  - H2: Sesiones ACP
  - H2: Contenido relacionado
...
- Encabezados:
  ...
  - H3: Nombres de tareas y asignación de destino
...
- Encabezados:
  ...
  - H2: Directivas de rastreo de plugins (/trace)
  - H2: Visibilidad del razonamiento (/reasoning)
  - H2: Contenido relacionado
  - H2: Heartbeats
  - H2: Interfaz web de chat
...
- Encabezados:
  ...
  - H2: Por qué existe
  - H2: API
  - H2: Límite del tiempo de ejecución
  - H2: Configuración
...
- Encabezados:
  ...
  - H2: Personas
  - H3: Persona mínima
  - H3: Persona completa (solicitud independiente del proveedor)
  - H3: Resolución de personas
  - H3: Cómo utilizan los proveedores las solicitudes de persona
  - H3: Política de respaldo
  - H2: Directivas controladas por el modelo
  - H2: Comandos de barra diagonal
...
- Encabezados:
  ...
  - H2: Agente compartido de la empresa en un VPS
  - H2: Usar Nodes con un VPS
  - H2: Ajustes de inicio para máquinas virtuales pequeñas y hosts ARM
  - H3: Lista de comprobación de ajustes de systemd (opcional)
  - H2: Contenido relacionado
...
- Encabezados:
  ...
  - H2: Desactivar (o volver a activar) las visitas
  - H2: El Lobsterdex
  - H2: Notas de campo
  - H2: Privacidad
...
- Ruta: /web/workspaces
- Encabezados:
  - H2: Habilitar los espacios de trabajo
  - H2: El espacio de trabajo predeterminado
