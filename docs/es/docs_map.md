...
x-i18n:
    generated_at: "2026-07-04T06:21:41Z"
    model: gpt-5.5
...
- Encabezados:
  - H1: Eliminación de BlueBubbles y la ruta de imsg iMessage
  - H2: Qué cambió
  - H2: Qué hacer
...
- Encabezados:
  ...
  - H2: Descubrimiento de credenciales de CLI externas
  - H2: Guardia de política OAuth SecretRef
...
- Encabezados:
  ...
  - H3: Ejemplo 3: supervisión y alertas (continua)
...
- Encabezados:
  ...
  - H2: Rutas de canales de mensajes admitidas
...
- Encabezados:
  ...
  - H2: Aspectos específicos de iMessage
  - H2: Prompts del sistema de WhatsApp
  - H2: Aspectos específicos de WhatsApp
  - H2: Relacionado
...
- Encabezados:
  ...
  - H2: Riesgo oculto del registro de grupos
  - H2: Paso a paso
...
- Encabezados:
  ...
  - H2: Combinación de envíos divididos de DM (comando + URL en una sola composición)
  - H3: Escenarios y lo que ve el agente
  - H2: Recuperación entrante después de reiniciar un bridge o Gateway
...
- Encabezados:
  ...
  - H2: Qué no puede hacer automáticamente la migración
  ...
  - H2: Si el historial cifrado todavía no vuelve
...
- Encabezados:
  ...
  - H2: Medios e historial habilitados por Graph (obligatorio para canales)
...
- Encabezados:
  ...
  - H3: Aprobación automática opcional de nodos por CIDR de confianza
...
- Encabezados:
  ...
  - H2: Renovación de token (opcional)
...
- Encabezados:
  ...
  - H2: Varias cuentas
  - H2: Variables de entorno
  - H2: Escritura, reacciones y acuses de recibo de entrega
  - H2: Solución de problemas
  - H2: Relacionado
...
- Encabezados:
  ...
  - H2: Contexto y evidencia del PR
  ...
  - H2: Validación completa de versión
...
- Encabezados:
  ...
  - H2: Helpers de lista de permitidos
  - H2: Opciones comunes
  - H2: Notas
  - H2: Relacionado
...
- Encabezados:
  ...
  - H2: Modelos
  - H3: Precedencia del modelo de cron aislado
  - H3: Modo rápido
...
- Encabezados:
  ...
  - H2: Primera aprobación de Paperclip / openclawgateway
...
- Encabezados:
  ...
  - H3: gateway status
  - H3: gateway probe
  - H4: Remoto por SSH (paridad de app para Mac)
...
- Encabezados:
  - H1: openclaw logs
  - H2: Opciones
  - H2: Opciones RPC del Gateway compartidas
  - H2: Ejemplos
  - H2: Notas
  - H2: Relacionado
...
- Encabezados:
  ...
  - H3: Opciones de endpoint de Z.AI no interactivas
...
- Encabezados:
  ...
  - H3: Instalar
  - H4: Abreviatura del marketplace
  - H3: Listar
...
- Encabezados:
  ...
  - H3: wiki obsidian ...
  - H2: Orientación de uso práctico
...
- Encabezados:
  ...
  - H2: Política de fallback de modelos
...
- Encabezados:
  ...
  - H2: Puesta en cola + concurrencia
...
- Encabezados:
  ...
  - H2: Copia de seguridad con Git (recomendado, privada)
...
- Encabezados:
  ...
  - H2: Sesiones
  - H2: Dirigir mientras se transmite
...
- Encabezados:
  ...
  - H3: Nivel 2: Enviar en nombre de otro
...
- Encabezados:
  ...
  - H2: Cobertura de informes de ensayo sombra de QA
  - H2: Programación
  - H2: Inicio rápido
  - H2: Comando de barra
...
- Encabezados:
  ...
  - H3: Fase 2: Núcleo de envío durable
  ...
  - H3: Fase 8: Eliminar compatibilidad con nombres de Turn
  - H2: Plan de pruebas
  - H2: Preguntas abiertas
...
- Encabezados:
  ...
  - H3: Comportamiento de omisión por enfriamiento frente a sondeo
...
- Encabezados:
  ...
  - H3: Ediciones seguras de lista permitida
...
- Encabezados:
  ...
  - H2: Migración de la CLI de Anthropic Claude
...
- Encabezados:
  ...
  - H4: Por qué no aparecen los comandos CLI puntuales
  - H3: 3) Balizas system-event
  - H3: 4) Node se conecta (rol: node)
  - H2: Reglas de fusión + eliminación de duplicados (por qué importa instanceId)
...
- Encabezados:
  ...
  - H2: Semillas respaldadas por el repo
...
- Encabezados:
  ...
  - H2: Coalescencia (fusionar bloques transmitidos por streaming)
  - H2: Ritmo similar al humano entre bloques
  - H2: "Transmitir fragmentos por streaming o todo"
...
- Encabezados:
  ...
  - H2: Inyección de arranque del workspace
  - H2: Manejo de hora
  - H2: Skills
  - H2: Documentación
  - H2: Relacionado
...
- Ruta: /date-time
- Encabezados:
  - H2: Envoltorios de mensaje (local de forma predeterminada)
  - H3: Ejemplos
...
- Encabezados:
  ...
  - H2: Reproducción mínima en el repo
...
- Encabezados:
  ...
  - H2: Anthropic: compatibilidad con CLI de Claude y tokens
...
- Encabezados:
  - H2: herramienta exec
  - H2: Puente con procesos secundarios
...
- Encabezados:
  ...
  - H2: Problemas típicos de Docker
  - H2: Solucionar problemas de Bonjour desactivado
...
- Encabezados:
  ...
  - H4: Límites del historial de DM
...
- Encabezados:
  ...
  - H2: Patrones comunes
  - H3: Línea base de Skills compartida con un override
  - H3: Configuración multiplataforma
  - H3: Aprobación automática de red de nodos de confianza
  - H3: Modo DM seguro (bandeja compartida / DM multiusuario)
  - H3: Clave de API de Anthropic + fallback de MiniMax
...
- Encabezados:
  ...
  - H2: Includes de configuración ($include)
  - H2: Relacionado
...
- Encabezados:
  ...
  - H3: Modos de recarga
  - H3: Qué se aplica en caliente frente a qué necesita un reinicio
...
- Encabezados:
  ...
  - H2: Qué hace (resumen)
  - H2: Relleno y restablecimiento de la UI de Dreams
...
- Encabezados:
  ...
  - H3: Configuración híbrida: primario alojado, fallback local
...
- Encabezados:
  ...
  - H2: Redacción
  - H2: Logs WebSocket del Gateway
  - H3: Estilo de logs WS
...
- Encabezados:
  ...
  - H2: Ítems (entrada)
  - H3: message
  - H3: functioncalloutput (herramientas por turno)
...
- Encabezados:
  ...
  - H2: Aprobación automática por upgrade de metadatos
...
- Encabezados:
  ...
  - H2: Presencia
  - H3: Evento de nodo vivo en segundo plano
  - H2: Alcance de eventos broadcast
  - H2: Familias comunes de métodos RPC
  - H3: Familias comunes de eventos
  - H3: Métodos helper de nodo
  - H3: RPCs del registro de tareas
  - H3: Métodos helper de operador
  ...
  - H2: Auth
  - H2: Identidad del dispositivo + emparejamiento
  - H3: Diagnóstico de migración de auth de dispositivos
  - H2: TLS + pinning
  - H2: Alcance
  - H2: Relacionado
...
- Encabezados:
  ...
  - H2: Iniciar automáticamente el túnel al iniciar sesión
...
- Encabezados:
  ...
  - H2: Elevado: solo exec "ejecutar en el host"
  - H2: Correcciones comunes de "confinamiento de sandbox"
...
- Encabezados:
  ...
  - H2: Montajes de enlace personalizados
...
- Encabezados:
  ...
  - H2: Claves API respaldadas por archivos
...
- Encabezados:
  ...
  - H3: Implementación y confianza del host
  - H3: Operaciones de archivo seguras
  - H3: Espacio de trabajo Slack compartido: riesgo real
  ...
  - H2: Regla rápida de bandeja de entrada compartida
  ...
  - H3: Control del navegador mediante host de Node (recomendado)
...
- Encabezados:
  ...
  - H3: Solo tailnet (bind a la IP de tailnet)
...
- Encabezados:
  - H2: Escalera de comandos
  - H2: Después de una actualización
  - H2: Instalaciones divididas y guarda de configuración más nueva
  - H2: Incompatibilidad de protocolo tras una reversión
  ...
  - H2: El backend local compatible con OpenAI pasa pruebas directas, pero las ejecuciones del agente fallan
  - H2: Sin respuestas
  ...
  - H2: El Gateway se cierra durante uso alto de memoria
  - H2: El Gateway rechazó configuración no válida
...
- Ruta: /help/debugging
- Encabezados:
  - H2: Anulaciones de depuración del runtime
...
- Encabezados:
  ...
  - H2: Bloque de entorno de configuración
  - H2: Importación del entorno de shell
  - H2: Instantáneas de shell exec
  - H2: Variables de entorno inyectadas por el runtime
...
- Encabezados:
  ...
  - H2: Comandos de chat, abortar tareas y "no se detiene"
  - H2: Miscelánea
  - H2: Relacionado
...
- Encabezados:
  ...
  - H2: En vivo: barrido de capacidades de nodos Android
  - H2: En vivo: prueba de humo de modelos (claves de perfil)
  - H3: Capa 1: finalización directa de modelo (sin Gateway)
  - H3: Capa 2: Gateway + prueba de humo de agente de desarrollo (lo que "@openclaw" hace realmente)
  - H2: En vivo: prueba de humo del backend de CLI (Claude, Gemini u otras CLI locales)
  - H2: En vivo: accesibilidad del proxy HTTP/2 de APNs
  - H2: En vivo: prueba de humo de enlace ACP (/acp spawn ... --bind here)
  - H2: En vivo: prueba de humo del arnés de servidor de aplicación de Codex
  - H3: Recetas en vivo recomendadas
  - H2: En vivo: matriz de modelos (lo que cubrimos)
  - H3: Conjunto moderno de pruebas de humo (llamada a herramientas + imagen)
  - H3: Línea base: llamada a herramientas (Read + Exec opcional)
...
- Encabezados:
  ...
  - H3: E2E (prueba de humo de gateway)
...
- Encabezados:
  ...
  - H2: 4) Configurar nginx para hacer proxy de OpenClaw al puerto 8000
...
- Encabezados:
  ...
  - H3: Configuración
  - H3: Acceso a un despliegue privado
...
- Encabezados:
  ...
  - H3: Proveedores de Mac alojado (nube)
...
- Encabezados:
  ...
  - H2: Lo que obtienes
  - H2: Configuración obligatoria de Railway
  - H3: Redes públicas
...
- Encabezados:
  ...
  - H3: Acceder a la Control UI
  - H2: Funciones del Render Dashboard
  - H3: Registros
  - H3: Acceso a shell
  - H3: Variables de entorno
  ...
  - H2: Solución de problemas
  - H3: El servicio no arranca
  - H3: Arranques en frío lentos (nivel gratuito)
  - H3: Pérdida de datos tras volver a desplegar
...
- Encabezados:
  ...
  - H3: Temas avanzados de instalación npm
...
- Encabezados:
  ...
  - H2: Ejemplos de configuración
  - H3: Proveedor + respaldo de CLI (OpenAI + Whisper CLI)
  ...
  - H3: Repetir la transcripción en el chat (opt-in)
  - H2: Notas y límites
...
- Encabezados:
  ...
  - H3: Helper de CLI (node invoke)
  - H2: Seguridad + límites prácticos
  - H2: Video de pantalla de macOS (a nivel de SO)
  - H2: Relacionado
...
- Encabezados:
  ...
  - H3: Gateway remoto mediante túnel SSH (vinculación loopback)
...
- Encabezados:
  ...
  - H3: Detección automática de comprensión de medios (predeterminado)
...
- Encabezados:
  ...
  - H3: El servidor de app de Codex sigue siendo canónico para el estado nativo de hilos
  ...
  - H3: 1. Exportar o reubicar helpers reutilizables de intentos del motor de contexto
  - H3: 2. Añadir un helper de proyección de contexto de Codex
  ...
  - H3: 5. Preservar el formato estable para caché de prompts
  - H3: 6. Conectar post-turn después del espejado de transcripción
  - H3: 7. Normalizar uso y contexto de runtime de caché de prompts
...
- Encabezados:
  - H1: Registro (macOS)
  - H2: Registro de archivo de diagnósticos rotativo (panel Debug)
...
- Encabezados:
  ...
  - H2: Exponer servicios de WSL en la LAN
  - H2: Solución de problemas
...
- Encabezados:
  ...
  - H2: Probar contra versiones beta
  - H2: Próximos pasos
  - H2: Relacionado
...
- Encabezados:
  ...
  - H3: Despliegue de proveedores mixtos
  - H3: Despliegue Codex con cierre ante fallos
...
- Encabezados:
  ...
  - H2: Inventario de aplicaciones y propiedad
...
- Encabezados:
  ...
  - H3: Chrome
  - H3: Twilio
  - H2: OAuth y comprobación preliminar
  ...
  - H3: Falla la creación de la reunión
...
- Encabezados:
  ...
  - H2: Límites de recuerdo y captura
  - H2: Comandos
  - H2: Almacenamiento
  ...
  - H3: El Plugin carga pero no aparece ningún recuerdo
  - H2: Relacionado
...
- Encabezados:
  ...
  - H2: Contrato de renderizador
  - H2: Flujo de renderizado central
  - H2: Reglas de degradación
  - H3: Visibilidad de fallback del valor del botón
  - H2: Mapeo de proveedores
  - H2: Presentation frente a InteractiveReply
  - H2: Pin de entrega
...
- Encabezados:
  ...
  - H3: Efectos secundarios al final del agente
...
- Encabezados:
  ...
  - H3: Importaciones estrechas de ayudantes de configuración
...
- Encabezados:
  ...
  - H3: Ejecutar pruebas con alcance definido
...
- Encabezados:
  ...
  - H2: Publicar
  - H2: Solución de problemas
  - H3: no se encontró la entrada de Plugin: ./dist/index.js
...
- Encabezados:
  ...
  - H2: Ejecuciones y tareas de tarjetas
...
- Encabezados:
  - H2: Primeros pasos
  - H2: Descubrimiento de modelos
  - H2: Protocolos y plugins de proveedor
  - H2: Cuotas y uso
  - H2: Solución de problemas
...
- Encabezados:
  ...
  - H2: Superficies de OpenClaw compatibles
...
- Encabezados:
  ...
  - H2: Primeros pasos
  - H2: Autenticación del servidor de app nativo de Codex
  - H2: Generación de imágenes
  - H2: Generación de video
...
- Encabezados:
  ...
  - H2: Descubrimiento de modelos
  - H2: Streaming y compatibilidad con herramientas
  - H2: Precios
...
- Encabezados:
  ...
  - H3: Fase 2: Limpieza con prioridad de concesiones
  - H3: Fase 3: Recolección de inicio con prioridad de concesiones
...
- Encabezados:
  ...
  - H3: Fase 6: Runtime de workers
  - H3: Fase 7: Eliminar el mundo anterior
...
- Encabezados:
  ...
  - H2: Verificación previa al lanzamiento
...
- Encabezados:
  ...
  - H2: Fase 3: Ajuste de arquitectura frontend
...
- Encabezados:
  ...
  - H2: Interacción con Tool Search
  ...
  - H2: Telemetría
  - H2: Depuración
  - H2: Distribución de la implementación
...
- Encabezados:
  ...
  - H3: cacheRetention (predeterminado global, modelo y por agente)
  ...
  - H3: Tráfico mixto (predeterminado recomendado)
  - H3: Referencia priorizando costos
...
- Encabezados:
  ...
  - H2: Cuándo ocurre la autocompactación (runtime de OpenClaw)
  - H2: Configuración de Compaction (reserveTokens, keepRecentTokens)
  - H2: Proveedores de Compaction extensibles
...
- Encabezados:
  ...
  - H2: La conversación
  - H2: Después de que sepas quién eres
...
- Ruta: /reference/test
- Encabezados:
  - H2: Puerta de PR local
  - H2: Banco de latencia de modelo (claves locales)
...
- Encabezados:
  ...
  - H2: Regla global: llamadas de herramientas con formato incorrecto
...
- Encabezados:
  ...
  - H2: Aspectos destacados
  - H3: Confiabilidad de entrega de canales
  ...
  - H3: Confiabilidad de configuración y comandos
...
- Encabezados:
  ...
  - H4: T-EXEC-004: Omisión de aprobación de ejecución
  ...
  - H4: T-IMPACT-003: Daño a la reputación
...
- Encabezados:
  ...
  - H3: La juerga de compras robóticas (3 de dic. de 2025)
  - H2: Textos sagrados
...
- Encabezados:
  ...
  - H2: Requisitos previos
  - H2: La configuración con dos teléfonos (recomendado)
  ...
  - H2: Medios entrantes y salientes
...
- Encabezados:
  - H2: TL;DR
  - H2: Requisitos previos (desde código fuente)
  - H2: Estrategia de personalización (para que las actualizaciones no molesten)
  ...
  - H3: 0) (Opcional) Ejecutar también la app de macOS desde código fuente
...
- Encabezados:
  - H2: Ejemplo no interactivo de referencia
...
- Encabezados:
  ...
  - H3: Configuración del comando acpx y la versión
  ...
  - H3: Configuración del tiempo de espera de operación en runtime
...
- Encabezados:
  ...
  - H2: Controles ACP
  - H3: Asignación de opciones de runtime
...
- Encabezados:
  ...
  - H3: Opción 2: Chrome MCP local al host
  - H2: Arquitectura funcional
  - H2: Por qué esta configuración es confusa
  - H2: Regla crítica para la UI de control
  ...
  - H3: Capa 4: Verificar por separado la capa de la UI de control
...
- Encabezados:
  ...
  - H2: Perfiles: openclaw vs usuario
  - H2: Configuración
...
- Encabezados:
  ...
  - H3: Configuración persistente de "no volver a preguntar" en host de Gateway
  - H3: Atajo local
  - H3: Host Node
  ...
  - H2: Edición en la UI de control
...
- Encabezados:
  ...
  - H2: Configurar búsqueda con Firecrawl
  - H2: Configurar fallback de webfetch con Firecrawl
...
- Encabezados:
  ...
  - H2: Solucionar problemas con herramientas faltantes
  - H2: Relacionado
...
- Encabezados:
  ...
  - H3: Limitación importante: Lobster integrado vs openclaw.invoke
...
- Encabezados:
  ...
  - H2: Configuración recomendada
  - H2: Guardia posterior a Compaction
...
- Encabezados:
  ...
  - H2: Asignaciones de proveedores (cómo los vendedores se dividen entre superficies)
  - H2: Relacionado
...
- Encabezados:
  - H2: Obtener una credencial de plan de tokens
  - H2: Configuración
...
- Encabezados:
  ...
  - H3: Modo de respaldo por extracción
  - H2: Configuración
