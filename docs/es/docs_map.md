...
x-i18n:
    generated_at: "2026-07-04T17:49:31Z"
    model: gpt-5.5
...
- Encabezados:
  ...
  - H2: Protección de política de OAuth SecretRef
...
- Encabezados:
  ...
  - H2: Tipos de eventos
  - H2: Escribir ganchos
  - H3: Estructura de gancho
  - H3: Formato de HOOK.md
  - H3: Implementación de manejador
  - H3: Aspectos destacados del contexto de evento
  - H2: Detección de ganchos
  - H3: Paquetes de ganchos
  ...
  - H2: Ganchos de Plugin
  - H2: Configuración
  - H2: Referencia de CLI
  - H2: Prácticas recomendadas
  - H2: Solución de problemas
  - H3: Gancho no detectado
  - H3: Gancho no elegible
  - H3: Gancho no se ejecuta
  - H2: Relacionado
...
- Encabezados:
  ...
  - H3: Ejemplo 3: supervisión y alertas (continuo)
...
- Encabezados:
  ...
  - H2: Fijación de ruta principal de DM
...
- Encabezados:
  ...
  - H3: Permitir todos los grupos, seguir requiriendo @mención
...
- Encabezados:
  ...
  - H2: Claves de sesión
  - H2: Patrón: DMs personales + grupos públicos (un solo agente)
  - H2: Etiquetas de visualización
  - H2: Política de grupo
  - H2: Control por mención (predeterminado)
  ...
  - H2: Detalles específicos de iMessage
  - H2: Prompts de sistema de WhatsApp
  - H2: Detalles específicos de WhatsApp
  - H2: Relacionado
...
- Encabezados:
  ...
  - H2: Fusión de DMs de envío dividido (comando + URL en una sola composición)
...
- Encabezados:
  ...
  - H2: Control de acceso
  - H3: Problema común: allowFrom es para DMs, no para canales
  ...
  - H3: Herramientas distintas por remitente (el propietario tiene más poder)
  - H2: NickServ
...
- Encabezados:
  ...
  - H2: Desarrollo local (tunneling)
  - H2: Probar el bot
  - H2: Variables de entorno
  - H2: Acción de información de miembros
  - H2: Contexto del historial
  - H2: Permisos actuales de Teams RSC (manifiesto)
  ...
  - H3: Solo con Teams RSC (aplicación instalada, sin permisos de Graph API)
...
- Encabezados:
  - H2: 1) Emparejamiento por DM (acceso al chat entrante)
...
- Ruta: /channels/slack
- Encabezados:
  - H2: Elegir Socket Mode o URL de solicitud HTTP
  - H3: Modo de relé
  - H2: Instalar
  - H2: Configuración rápida
  - H2: Ajuste del transporte Socket Mode
  - H2: Lista de verificación del manifiesto y los ámbitos
  ...
  - H2: Referencia de configuración
  - H2: Solución de problemas
  - H2: Referencia de visión de archivos adjuntos
  - H3: Tipos de medios compatibles
  - H3: Canalización de entrada
  - H3: Herencia de archivos adjuntos de la raíz del hilo
  - H3: Manejo de varios archivos adjuntos
  - H3: Tamaño, descarga y límites del modelo
...
- Encabezados:
  ...
  - H2: Controles de respuesta a errores
  - H2: Solución de problemas
  - H2: Referencia de configuración
  - H2: Relacionado
...
- Encabezados:
  ...
  - H2: WhatsApp
  - H3: Firmas de fallos de WhatsApp
  - H2: Telegram
  - H3: Firmas de fallos de Telegram
  - H2: Discord
  - H3: Firmas de fallos de Discord
  - H2: Slack
  - H3: Firmas de fallos de Slack
  - H2: iMessage
  - H3: Firmas de fallos de iMessage
  - H2: Signal
  - H3: Firmas de fallos de Signal
  - H2: QQ Bot
  - H3: Firmas de fallos de QQ Bot
  - H2: Matrix
  - H3: Firmas de fallos de Matrix
  - H2: Relacionado
...
- Encabezados:
  ...
  - H2: Soporte para múltiples cuentas
  - H2: Control de acceso
  - H2: Solución de problemas
  - H2: Configuración
...
- Encabezados:
  ...
  - H2: Reacciones de estado del ciclo de vida
  - H2: Múltiples cuentas y credenciales
...
- Encabezados:
  ...
  - H3: Restringir los DM a usuarios específicos
  - H3: Desactivar el requisito de @mention en grupos
  ...
  - H3: El bot no responde en chats de grupo
  - H3: El bot no recibe mensajes
  - H3: El bot envía respuestas vacías o de fallback
  - H3: App Secret filtrado
  - H2: Configuración avanzada
  - H3: Múltiples cuentas
  - H3: Límites de mensajes
  - H3: Streaming
  - H3: Contexto del historial de chat de grupo
  - H3: Modo de respuesta
  - H3: Inyección de sugerencia Markdown
...
- Encabezados:
  ...
  - H3: PR duplicados después del merge
  - H2: Puertas de comprobación local y enrutamiento de cambios
...
- Encabezados:
  ...
  - H2: config patch
  - H2: Flags del constructor de proveedor
  - H2: Dry run
...
- Encabezados:
  ...
  - H3: Supresión de reconocimientos obsoletos
  - H3: Supresión de tokens silenciosos
  - H3: Denegaciones estructuradas
  - H2: Retención
  - H2: Migración de jobs antiguos
  - H2: Ediciones comunes
  - H2: Comandos comunes de administración
  - H2: Relacionado
...
- Encabezados:
  ...
  - H2: Opciones comunes
  - H2: Notas
  - H2: Checklist de recuperación de desviación de tokens
  - H2: Relacionado
...
- Encabezados:
  ...
  - H2: macOS: sobrescrituras de env de launchctl
  - H2: Relacionado
...
- Encabezados:
  ...
  - H3: gateway status
  - H3: gateway probe
  - H4: Remoto sobre SSH (paridad con app Mac)
...
- Encabezados:
  ...
  - H3: Estado Codex de revisión manual
  - H2: Proveedor Hermes
...
- Encabezados:
  ...
  - H2: Autenticación de Gateway para host de nodo
...
- Encabezados:
  ...
  - H2: Casos de uso
  - H3: Después de actualizar una imagen Docker
...
- Encabezados:
  ...
  - H2: Auditar
  - H2: Configurar (ayudante interactivo)
  - H2: Aplicar un plan guardado
  - H2: Por qué no hay copias de seguridad para rollback
  - H2: Ejemplo
  - H2: Relacionado
...
- Encabezados:
  ...
  - H2: Ensamblaje de prompt + prompt del sistema
  ...
  - H2: Formato de respuesta + supresión
  - H2: Compaction + reintentos
  - H2: Flujos de eventos (hoy)
  - H2: Manejo de canal de chat
...
- Encabezados:
  ...
  - H2: Runtime de agente GitHub Copilot
...
- Encabezados:
  ...
  - H2: No hagas commit de secretos
...
- Encabezados:
  ...
  - H2: Sesiones
  - H2: Dirigir durante el streaming
...
- Encabezados:
  ...
  - H3: Gateway (daemon)
  - H3: Clientes (app de Mac / CLI / administrador web)
  ...
  - H2: Tipado de protocolo y codegen
  - H2: Acceso remoto
...
- Encabezados:
  - H2: Inicio rápido
  - H2: Cómo funciona
  - H3: Ciclo de vida de subagentes (opcional)
...
- Encabezados:
  ...
  - H2: Cobertura de informes de pruebas sombra de QA
  - H2: Programación
  - H2: Inicio rápido
  - H2: Comando slash
...
- Encabezados:
  - H2: Qué añade sobre lo integrado
  - H2: Primeros pasos
...
- Encabezados:
  ...
  - H2: Dreaming
  - H2: Backfill fundamentado y promoción en vivo
  - H2: CLI
  - H2: Lecturas adicionales
  - H2: Relacionado
...
- Encabezados:
  ...
  - H2: Guardarraíles de compatibilidad
  ...
  - H3: Fase 4: Puente de dispatcher preparado
...
- Encabezados:
  ...
  - H2: Desduplicación de entradas
  - H2: Debouncing de entradas
...
- Encabezados:
  ...
  - H3: Persistencia de sesión (amigable con caché)
  - H3: Suscripción OpenAI Codex más respaldo con clave de API
  - H2: Cooldowns
  ...
  - H3: Omisión por cooldown frente a comportamiento de sondeo
  - H2: Sobrescrituras de sesión y cambio de modelo en vivo
  - H2: Observabilidad y resúmenes de fallo
...
- Encabezados:
  - H2: Reglas rápidas
  - H2: Comportamiento de proveedores propiedad del Plugin
...
- Encabezados:
  ...
  - H3: Ediciones seguras de allowlist
  - H2: "Model is not allowed" (y por qué se detienen las respuestas)
...
- Encabezados:
  ...
  - H2: Migración de la CLI Claude de Anthropic
...
- Encabezados:
  ...
  - H4: Por qué los comandos únicos de la CLI no aparecen
  ...
  - H2: Advertencia sobre remoto/túnel (IP de local loopback)
  - H2: Consumidores
...
- Encabezados:
  ...
  - H2: Elige un modo
  - H2: Configura etiquetas
  - H2: Controla las líneas de progreso
...
- Encabezados:
  ...
  - H3: Flags compartidos de la CLI
  - H3: QA de Telegram
  - H3: QA de Discord
  - H3: QA de Slack
  ...
  - H2: Carriles de simulación de proveedor
...
- Encabezados:
  ...
  - H3: Comportamiento en runtime
  - H3: Actualizaciones de vista previa del progreso de herramientas
...
- Encabezados:
  ...
  - H2: Ejemplo completo: añadir un método de extremo a extremo
...
- Encabezados:
  ...
  - H3: Config
  - H2: Pie completo /usage personalizado
  - H3: Forma
...
- Encabezados:
  ...
  - H2: Sobrescritura de entorno (única)
...
- Encabezados:
  ...
  - H2: Anthropic: compatibilidad con CLI Claude y tokens
  ...
  - H2: Eliminar la autenticación de proveedor mientras el Gateway está en ejecución
  ...
  - H3: Token a punto de caducar/caducado
  - H2: Relacionado
...
- Encabezados:
  ...
  - H2: Depuración en registros de Gateway
...
- Encabezados:
  - H2: Inicio rápido apto para principiantes
  ...
  - H2: Superposiciones de MCP del bundle
...
- Encabezados:
  ...
  - H3: Sobrescrituras de perfil de arranque por agente
...
- Encabezados:
  ...
  - H3: Control de menciones en chat de grupo
  - H4: Límites de historial de MD
...
- Encabezados:
  ...
  - H3: Herramientas de MCP y Plugin dentro de la política de herramientas de sandbox
  - H3: tools.codeMode
...
- Encabezados:
  ...
  - H3: Repositorio de Skills hermano enlazado con symlink
  - H2: Patrones comunes
  - H3: Línea base de Skills compartida con una sustitución
  - H3: Configuración multiplataforma
  - H3: Aprobación automática de red de nodos de confianza
  - H3: Modo de MD seguro (bandeja compartida / MD multiusuario)
...
- Encabezados:
  - H2: Canales
  - H2: Valores predeterminados de agente, multiagente, sesiones y mensajes
  ...
  - H3: gateway.reload
  - H2: Hooks
  - H3: Integración de Gmail
  - H2: Host de Plugin de Canvas
  - H2: Descubrimiento
  - H3: mDNS (Bonjour)
  - H3: Área amplia (DNS-SD)
  - H2: Entorno
  - H3: env (variables de entorno inline)
  ...
  - H2: Variables de plantilla de modelos multimedia
...
- Encabezados:
  - H2: Configuración mínima
  - H2: Edición de configuración
  - H2: Validación estricta
  - H2: Tareas comunes
  - H2: Recarga en caliente de configuración
  - H3: Modos de recarga
...
- Encabezados:
  ...
  - H2: Qué hace (resumen)
  - H2: Relleno y restablecimiento de la IU de sueños
  - H2: Comportamiento detallado y fundamento
  - H2: Relacionado
...
- Encabezados:
  ...
  - H2: Diagnóstico profundo
  - H2: Configuración del monitor de salud
  - H2: Monitorización de tiempo activo
  - H3: Ejemplos de configuración de servicios de monitorización
...
- Encabezados:
  ...
  - H3: Precedencia de puerto y bind
  - H3: Modos de recarga en caliente
  - H2: Conjunto de comandos de operador
...
- Encabezados:
  ...
  - H3: Configuración híbrida: primario hospedado, respaldo local
...
- Encabezados:
  ...
  - H2: Notas de navegador/CDP (problema común)
...
- Encabezados:
  ...
  - H2: Por qué esta superficie importa
...
- Encabezados:
  ...
  - H2: Comportamiento de sesión
  - H2: Forma de la solicitud (admitida)
...
- Encabezados:
  ...
  - H3: Conversación
  - H3: Colas y sesiones
  - H3: Telemetría de liveness de sesión
...
- Encabezados:
  ...
  - H2: El alcance de método es solo la primera puerta
...
- Encabezados:
  ...
  - H2: Aprobación automática de dispositivos con CIDR de confianza
  - H2: Aprobación automática de actualización de metadatos
...
- Encabezados:
  ...
  - H2: Elegir entre exportación de Prometheus y OpenTelemetry
  - H2: Solución de problemas
  - H2: Relacionado
...
- Encabezados:
  ...
  - H3: El equipo de escritorio de casa ejecuta el Gateway
...
- Encabezados:
  ...
  - H2: Política de herramientas: qué herramientas existen/se pueden llamar
  - H3: Grupos de herramientas (atajos)
  - H2: Elevated: “ejecutar en el host” solo para exec
...
- Encabezados:
  ...
  - H2: Notas de alcance de tiempo de ejecución y auditoría
...
- Encabezados:
  - H2: Objetivos y modelo de tiempo de ejecución
...
- Encabezados:
  ...
  - H2: Regla rápida para bandeja compartida
  ...
  - H3: Fortaleza del modelo (nota de seguridad)
  ...
  - H3: DM: emparejamiento predeterminado
  ...
  - H3: Barrera de seguridad para delegación a subagentes
...
- Encabezados:
  - H2: Valor predeterminado: sin helper de Python
...
- Encabezados:
  ...
  - H3: Solo tailnet (enlazar a la IP de tailnet)
...
- Encabezados:
  - H2: Escalera de comandos
  - H2: Después de una actualización
  - H2: Instalaciones split brain y protección de configuración más reciente
  - H2: Desajuste de protocolo tras una reversión
  ...
  - H2: El backend local compatible con OpenAI supera pruebas directas, pero fallan las ejecuciones del agente
  - H2: Sin respuestas
  ...
  - H2: Gateway sale durante uso alto de memoria
...
- Ruta: /help/debugging
- Encabezados:
  - H2: Sobrescrituras de depuración en tiempo de ejecución
  - H2: Salida de trazas de sesión
  - H2: Traza del ciclo de vida de Plugin
  - H2: Perfilado de inicio y comandos de la CLI
  - H2: Modo watch del Gateway
  - H2: Perfil de desarrollo + gateway de desarrollo (--dev)
  - H2: Registro de stream sin procesar (OpenClaw)
...
- Encabezados:
  ...
  - H2: Referencias de secretos vs cadenas ${ENV}
...
- Encabezados:
  - H2: Inicio rápido y configuración inicial
  - H2: Relacionado
...
- Encabezados:
  - H2: En vivo: comandos de smoke locales
  ...
  - H3: Capa 2: Gateway + smoke de agente de desarrollo (lo que realmente hace "@openclaw")
  - H2: En vivo: smoke de backend CLI (Claude, Gemini u otras CLI locales)
  - H2: En vivo: alcanzabilidad del proxy APNs HTTP/2
  - H2: En vivo: smoke de enlace ACP (/acp spawn ... --bind here)
  - H2: En vivo: smoke del arnés de servidor de aplicación de Codex
  - H3: Recetas en vivo recomendadas
  - H2: En vivo: matriz de modelos (lo que cubrimos)
  - H3: Conjunto moderno de smoke (llamada de herramientas + imagen)
  - H3: Línea base: llamada de herramientas (Read + Exec opcional)
  - H3: Visión: envío de imagen (adjunto → mensaje multimodal)
  - H3: Agregadores / gateways alternativos
  - H2: Credenciales (nunca confirmar)
  - H2: En vivo de Deepgram (transcripción de audio)
  - H2: En vivo de plan de codificación BytePlus
  - H2: En vivo de medios de flujo de trabajo ComfyUI
  - H2: En vivo de generación de imágenes
  - H2: En vivo de generación de música
  - H2: En vivo de generación de video
  - H2: Arnés en vivo de medios
  - H2: Relacionado
...
- Encabezados:
  ...
  - H2: Ejecutores Docker (comprobaciones opcionales de "funciona en Linux")
  ...
  - H3: Contratos de estado del proveedor
  - H3: Contratos del proveedor
  - H3: Cuándo ejecutar
...
- Encabezados:
  ...
  - H2: El asistente se siente limitado o sin herramientas
...
- Encabezados:
  - H2: Incorporar los binarios requeridos en la imagen
  - H2: Compilar y lanzar
...
- Encabezados:
  ...
  - H3: Variables de entorno
  - H3: Observabilidad
  - H3: Comprobaciones de salud
  - H3: LAN frente a loopback
  - H3: Proveedores locales del host
  - H3: Backend CLI de Claude en Docker
  - H3: Bonjour / mDNS
...
- Encabezados:
  ...
  - H2: 4) Configurar nginx para proxyar OpenClaw al puerto 8000
...
- Ruta: /install/gcp
- Encabezados:
  - H2: Qué estamos haciendo (en términos sencillos)?
  - H2: Ruta rápida (operadores con experiencia)
  - H2: Qué necesitas
  - H2: Solución de problemas
...
- Encabezados:
  - H2: Requisitos previos
  - H2: Opción A: OpenClaw en 1 clic
...
- Encabezados:
  ...
  - H3: Proveedores Mac alojados (nube)
  ...
  - H2: Extra: integración de iMessage
...
- Encabezados:
  - H1: Railway
  - H2: Lista de comprobación rápida (usuarios nuevos)
  - H2: Despliegue en un clic
  - H2: Qué obtienes
  ...
  - H3: Variables
  - H2: Conectar un canal
  - H2: Copias de seguridad &amp; migración
  - H2: Próximos pasos
...
- Encabezados:
  - H1: Render
  - H2: Requisitos previos
  - H2: Desplegar con un Render Blueprint
...
- Encabezados:
  - H2: Requisitos previos
  - H2: Crear un Box
  - H2: Conectarse con un túnel SSH
  - H2: Instalar OpenClaw
...
- Encabezados:
  ...
  - H3: Diagnósticos dirigidos de transporte de modelos
...
- Encabezados:
  ...
  - H2: Ejemplos de configuración
  - H3: Proveedor + respaldo CLI (OpenAI + Whisper CLI)
  - H3: Solo proveedor con restricción por alcance
  - H3: Solo proveedor (Deepgram)
  - H3: Solo proveedor (Mistral Voxtral)
  - H3: Solo proveedor (SenseAudio)
  - H3: Enviar transcripción al chat (opcional)
  - H2: Notas y límites
...
- Encabezados:
  ...
  - H2: Dispositivo Android + comandos de datos personales
...
- Encabezados:
  ...
  - H3: La estabilidad de prompt-cache importa
  ...
  - H3: 3. Conectar el arranque antes del inicio de hilos de Codex
  - H3: 4. Conectar assemble antes de thread/start / thread/resume y turn/start
  - H3: 5. Conservar el formato estable de prompt-cache
  - H3: 6. Conectar post-turn después del reflejo de la transcripción
  - H3: 7. Normalizar el uso y el contexto de runtime de prompt-cache
  ...
  - H3: 9. Comportamiento de restablecimiento y enlace de sesión
...
- Encabezados:
  ...
  - H4: Descubrimiento Tailnet (Viena ⇄ Londres) mediante DNS-SD unicast
  - H3: 3) Conectar desde Android
  - H3: Señales de presencia viva
  - H3: 4) Aprobar emparejamiento (CLI)
  - H3: 5) Verificar que el nodo está conectado
  - H3: 6) Chat + historial
  - H3: 7) Canvas + cámara
  - H4: Host Canvas del Gateway (recomendado para contenido web)
...
- Encabezados:
  - H1: Registro (macOS)
  - H2: Registro de archivo de diagnósticos rotativo (panel Depuración)
...
- Encabezados:
  ...
  - H2: Relación con el uso de computadora
...
- Encabezados:
  ...
  - H2: Concesiones de accesibilidad para tiempos de ejecución Node y CLI
...
- Encabezados:
  ...
  - H2: Configuración de la app para macOS
  - H2: Chat web
  - H2: Permisos
  - H2: Notas de seguridad
...
- Encabezados:
  - H1: firma en mac (compilaciones de depuración)
  - H2: Uso
...
- Encabezados:
  ...
  - H2: Gateway WSL2
  - H2: Inicio automático del Gateway antes del inicio de sesión de Windows
  - H2: Exponer servicios WSL en LAN
  - H2: Solución de problemas
...
- Encabezados:
  ...
  - H2: Ganchos de tiempo de ejecución de proveedor
  - H3: Orden y uso de ganchos
  - H3: Ejemplo de proveedor
  - H3: Ejemplos integrados
  - H2: Helpers de tiempo de ejecución
  - H3: api.runtime.imageGeneration
  - H2: Rutas HTTP de Gateway
  - H2: Rutas de importación del SDK de Plugin
  - H2: Esquemas de herramientas de mensaje
...
- Encabezados:
  ...
  - H3: Formas de Plugin
  - H3: Ganchos heredados
  - H3: Señales de compatibilidad
  - H2: Visión general de la arquitectura
  ...
  - H3: Ejemplo de Plugin de empresa con múltiples capacidades
...
- Encabezados:
  ...
  - H2: Lista de comprobación antes del envío
...
- Encabezados:
  ...
  - H4: Paquetes de ganchos
  - H4: MCP para OpenClaw incrustado
  - H4: Configuración de OpenClaw incrustado
  - H4: LSP de OpenClaw incrustado
...
- Encabezados:
  ...
  - H2: Ganchos avanzados de backend
...
- Encabezados:
  ...
  - H2: Archivos de arranque de workspace
...
- Encabezados:
  ...
  - H2: Cómo funciona la configuración nativa de Plugin
  - H2: Límite de soporte V1
  - H2: Inventario de apps y propiedad
  - H2: Configuración de app de hilo
...
- Encabezados:
  ...
  - H2: Lista de comprobación de pruebas en vivo
  - H2: Solución de problemas
...
- Encabezados:
  ...
  - H3: El Plugin se carga, pero no aparecen recuerdos
  - H2: Relacionado
...
- Encabezados:
  ...
  - H3: Visibilidad del valor de reserva del botón
...
- Encabezados:
  ...
  - H2: Lo que el núcleo aún controla
...
- Encabezados:
  ...
  - H2: Resolutor en tiempo de ejecución
  - H2: Resultado
  - H2: Grupos de acceso
  - H2: Modos de evento
...
- Encabezados:
  ...
  - H3: Adaptadores obsoletos de embedding de memoria
...
- Encabezados:
  ...
  - H3: Importaciones reducidas de helpers de configuración
  - H3: Promoción de cuenta única gestionada por el canal
...
- Encabezados:
  ...
  - H3: Tipos
  - H2: Prueba de resolución de destino
  - H2: Patrones de prueba
  - H3: Probar contratos de registro
  - H3: Probar el acceso a la configuración en tiempo de ejecución
...
- Encabezados:
  ...
  - H3: la entrada de plugin no expone metadatos de defineToolPlugin
  - H3: los metadatos generados de openclaw.plugin.json están desactualizados
...
- Encabezados:
  ...
  - H3: Las credenciales del proveedor fallan
  - H3: Las llamadas empiezan, pero los webhooks del proveedor no llegan
  - H3: La verificación de firma falla
  - H3: Las uniones de Google Meet con Twilio fallan
...
- Encabezados:
  ...
  - H2: Flujo de trabajo del dashboard
  - H2: Permisos
  - H2: Configuración
  - H2: Solución de problemas
...
- Encabezados:
  ...
  - H2: Fallback por negativa de seguridad (Claude Fable 5)
...
- Encabezados:
  - H2: Primeros pasos
  - H2: Descubrimiento de modelos
  - H2: Protocolo y plugins de proveedores
  - H2: Cuotas y uso
  - H2: Solución de problemas
...
- Encabezados:
  ...
  - H2: Voz y habla
  - H2: Puntos de conexión de Azure OpenAI
  - H3: Configuración
  - H3: Versión de API
  - H3: Los nombres de modelos son nombres de implementaciones
...
- Encabezados:
  - H2: Instalar Plugin
  - H2: Primeros pasos
  - H2: Tipos de plan y puntos de conexión
  - H2: Catálogo integrado
...
- Encabezados:
  - H2: Instalar Plugin
  - H2: Resumen de regiones y puntos de conexión
  - H2: Catálogo integrado
  - H2: Primeros pasos
  - H2: Configuración avanzada
  - H2: Relacionado
...
- Encabezados:
  - H1: Refactorización de estado Database-First
  - H2: Decisión
  ...
  - H2: Supuestos tras leer el código
  - H2: Hallazgos tras leer el código
  ...
  - H3: Fase 3: Reemplazar las APIs del almacén de sesiones
...
- Encabezados:
  ...
  - H2: Publicación mensual solo en npm de versión estable extendida
...
- Encabezados:
  ...
  - H2: Fase 4: Rendimiento y confiabilidad
...
- Encabezados:
  ...
  - H2: Nombres y colisiones de herramientas
  ...
  - H2: Telemetría
  - H2: Depuración
  - H2: Disposición de implementación
...
- Encabezados:
  ...
  - H2: Configuración de backend QMD
...
- Encabezados:
  ...
  - H2: Cuándo ocurre la autocompaction (runtime de OpenClaw)
  ...
  - H2: "Vaciado de memoria" previo a Compaction (implementado)
...
- Encabezados:
  - H1: AGENTS.md - Espacio de trabajo OpenClaw
  - H2: Primera ejecución (una sola vez)
  - H2: Consejo de copia de seguridad (recomendado)
  - H2: Valores predeterminados de seguridad
  - H2: Preflight de soluciones existentes
...
- Encabezados:
  ...
  - H3: Correcciones de interfaz, ajustes e incorporación
...
- Encabezados:
  ...
  - H3: 3.7 Recopilación &amp; exfiltración (AML.TA0009, AML.TA0010)
  ...
  - H2: 7. Apéndices
  - H3: 7.1 Asignación de técnicas ATLAS
...
- Encabezados:
  ...
  - H3: Exposición de Gateway y configuración errónea de Gateway abierto
  - H3: Canalización exec de Node (capacidad de mayor riesgo)
  - H3: Almacén de emparejamiento (control de DM)
  - H3: Control de entrada (menciones + omisión de comandos de control)
...
- Encabezados:
  ...
  - H2: Cómo enruta OpenClaw el tráfico
...
- Encabezados:
  - H1: Supervisor de Claw
  - H2: Objetivo
  - H2: Modelo de producto
  - H2: Arquitectura
  - H2: Contrato de servidor de aplicación de Codex
...
- Encabezados:
  - H2: Qué hace el arranque inicial
  - H2: Omitir el arranque inicial
  - H2: Dónde se ejecuta
  - H2: Documentación relacionada
...
- Encabezados:
  ...
  - H3: La compra compulsiva del robot (3 de diciembre de 2025)
  - H2: Textos sagrados
...
- Encabezados:
  ...
  - H2: Incorporación de CLI
  - H2: Incorporación de la aplicación macOS
...
- Encabezados:
  ...
  - H2: Estrategia de adaptación (para que las actualizaciones no hagan daño)
  ...
  - H3: 0) (Opcional) Ejecuta también la aplicación macOS desde el código fuente
  - H3: 1) Inicia el Gateway de desarrollo
  - H3: 2) Apunta la aplicación macOS a tu Gateway en ejecución
  - H3: 3) Verifica
  - H3: Errores habituales
  - H2: Mapa de almacenamiento de credenciales
  - H2: Actualización (sin arruinar tu configuración)
...
- Encabezados:
  ...
  - H2: Ejemplos específicos por proveedor
...
- Encabezados:
  - H2: Compatibilidad del arnés acpx (actual)
...
- Encabezados:
  ...
  - H2: Modos de vinculación de generación y de hilo
  - H2: Modelo de entrega
  - H2: Compatibilidad de sandbox
  - H2: Resolución del objetivo de sesión
  - H2: Controles de ACP
...
- Encabezados:
  ...
  - H3: Solución 2: Usar Snap Chromium con modo solo adjuntar
...
- Encabezados:
  ...
  - H3: Opción 2: MCP de Chrome local del host
  ...
  - H2: Lista de comprobación de triaje rápido
...
- Encabezados:
  ...
  - H2: Proveedores directos de WebSocket CDP
  - H3: Browserbase
  - H3: Notte
  - H2: Seguridad
...
- Encabezados:
  ...
  - H3: Validación de argv e indicadores denegados
  ...
  - H2: Preguntas frecuentes
  - H3: ¿Cuándo se usarían accountId y threadId en un objetivo de aprobación?
  - H3: Cuando se envían aprobaciones a una sesión, ¿cualquiera en esa sesión puede aprobarlas?
  - H2: Relacionado
...
- Encabezados:
  ...
  - H3: Configuración persistente de "nunca preguntar" para host de Gateway
  - H3: Atajo local
  - H3: Host de Node
...
- Encabezados:
  ...
  - H3: Limitación importante: Lobster incrustado frente a openclaw.invoke
  - H2: Archivos de flujo de trabajo (.lobster)
  - H2: Instalar Lobster
  - H2: Habilitar la herramienta
  - H2: Ejemplo: Triaje de correo electrónico
  - H2: Parámetros de la herramienta
  - H3: run
  - H3: resume
...
- Encabezados:
  - H2: Capacidades
  - H2: Matriz de capacidades del proveedor
...
- Encabezados:
  ...
  - H3: Modo de reserva por extracción
  - H2: Configuración
...
- Encabezados:
  ...
  - H2: Entradas por Skills (skills.entries)
...
- Encabezados:
  ...
  - H2: /trace — salida de traza de plugins
...
- Encabezados:
  ...
  - H3: Sustitución mediante configuración
  - H2: Concurrencia
...
- Encabezados:
  ...
  - H2: Directivas de traza de plugins (/trace)
...
- Encabezados:
  ...
  - H2: Primero reforzar el acceso administrativo
  - H2: Agente de empresa compartido en un VPS
  - H2: Uso de nodos con un VPS
  - H2: Ajuste de inicio para máquinas virtuales pequeñas y hosts ARM
...
- Encabezados:
  ...
  - H2: Acceso Tailscale
  - H3: Servicio integrado (recomendado)
  - H3: Vinculación tailnet + token
