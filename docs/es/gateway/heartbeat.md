---
read_when:
    - Ajuste de la cadencia de Heartbeat o de la mensajería
...
title: Heartbeat
x-i18n:
    generated_at: "2026-05-12T23:30:12Z"
    model: gpt-5.5
    provider: openai
...
<Warning>
No pongas secretos (claves API, números de teléfono, tokens privados) en `HEARTBEAT.md`: pasa a formar parte del contexto del prompt.
</Warning>
