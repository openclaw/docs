...
title: Seguridad
x-i18n:
    generated_at: "2026-07-02T07:55:39Z"
    model: gpt-5.5
...
informes de asesoría de ClawHub incluyen errores en:
...
Para informes del marketplace, retenciones de moderación, fichas ocultas, vetos y estado de la cuenta, consulta [Moderación y seguridad de la cuenta](/clawhub/moderation).
