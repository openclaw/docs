---
read_when:
    - Reportar un problema de seguridad de ClawHub
...
title: Seguridad
x-i18n:
    generated_at: "2026-07-03T02:42:34Z"
    model: gpt-5.5
...
o secretos de usuarios, contenido malicioso que llega a los usuarios por un fallo de la plataforma,
...
paquetes de la CLI de ClawHub, binarios, bibliotecas u otros artefactos de publicación que los usuarios
...
Para informes del marketplace, bloqueos de moderación, fichas ocultas, prohibiciones y estado de la cuenta,
