...
No uses los advisories de ClawHub para vulnerabilidades en el código fuente propio de una skill de terceros o
de un plugin. Infórmalas directamente al editor o al repositorio de origen
