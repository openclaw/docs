...
title: Seguridad
x-i18n:
    generated_at: "2026-07-01T10:57:05Z"
    model: gpt-5.5
...
reportes de asesoría de ClawHub incluyen errores en:
...
- análisis, moderación o gestión de reportes

No uses las asesorías de ClawHub para vulnerabilidades en el código fuente propio de una skill o
...
Para reportes del marketplace, retenciones de moderación, listados ocultos, prohibiciones y estado de la cuenta,
