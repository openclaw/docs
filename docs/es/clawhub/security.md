...
title: Seguridad
x-i18n:
    generated_at: "2026-07-03T17:13:22Z"
    model: gpt-5.5
...
No uses los avisos de ClawHub para vulnerabilidades en el código fuente propio de una habilidad o
...
Para informes del marketplace, retenciones de moderación, fichas ocultas, prohibiciones y estado de la cuenta, consulta [Moderación y seguridad de la cuenta](/clawhub/moderation).
