...
title: Seguridad
x-i18n:
    generated_at: "2026-07-03T13:15:56Z"
    model: gpt-5.5
...
Usa GitHub Security Advisories para vulnerabilidades en ClawHub propiamente dicho. Los buenos
...
- el escaneo, la moderación o el manejo de reportes
...
Para reportes del marketplace, retenciones de moderación, fichas ocultas, vetos y estado de la cuenta, consulta [Moderación y seguridad de la cuenta](/clawhub/moderation).
