...
title: Seguridad
x-i18n:
    generated_at: "2026-07-05T05:12:07Z"
    model: gpt-5.5
...
Usa GitHub Security Advisories para vulnerabilidades en ClawHub mismo. Los
buenos informes de avisos de ClawHub incluyen errores en:
...
o secretos de usuarios, contenido malicioso que llega a usuarios por una falla de la plataforma,
...
Para informes del marketplace, retenciones de moderación, fichas ocultas, prohibiciones y estado de cuenta,
