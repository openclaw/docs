...
title: Seguridad
x-i18n:
    generated_at: "2026-06-27T17:09:40Z"
    model: gpt-5.5
...
Usa los avisos de seguridad de GitHub para vulnerabilidades en ClawHub mismo. Los buenos
...
evidencia de impacto real en los usuarios o cuando los usuarios deben tomar medidas.

Los ejemplos de impacto real en los usuarios incluyen explotación confirmada, exposición de datos
...
Para informes del marketplace, retenciones por moderación, fichas ocultas, bloqueos y estado de la cuenta,
