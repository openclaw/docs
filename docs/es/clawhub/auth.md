...
x-i18n:
    generated_at: "2026-07-12T14:22:53Z"
    model: gpt-5.6
...
Si, tras iniciar sesión, vuelve a un estado sin sesión iniciada, es posible que su cuenta no esté en
buen estado. Si su cuenta fue bloqueada o deshabilitada, use el
...
Si el navegador no puede acceder a la devolución de llamada local debido a reglas de firewall, VPN o
proxy, use el flujo de tokens sin interfaz gráfica.
...
Para anular la ruta predeterminada, use:
