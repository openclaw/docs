...
Si al iniciar sesión vuelves a un estado de sesión cerrada, es posible que tu cuenta no esté en buen
...
Para shells remotas en las que puedes abrir un navegador en otro lugar, ejecuta:
