...
x-i18n:
    generated_at: "2026-07-05T05:11:48Z"
    model: gpt-5.5
...
El flujo de inicio de sesión predeterminado de la CLI abre tu navegador:
...
Si tu navegador no puede alcanzar la devolución de llamada local debido a reglas de firewall, VPN o
