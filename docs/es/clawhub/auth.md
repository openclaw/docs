...
summary: Inicio de sesión en ClawHub, tokens de API, inicio de sesión en CLI, almacenamiento de tokens y revocación.
x-i18n:
...
Si tu navegador no puede llegar a la devolución de llamada local debido a reglas de firewall, VPN o
proxy, usa el flujo de token sin interfaz gráfica.

## Inicio de sesión sin interfaz gráfica

Crea un token en la interfaz de usuario web de ClawHub y luego pásalo a la CLI:
...
Puedes revocar tokens de API en la interfaz de usuario web de ClawHub.
