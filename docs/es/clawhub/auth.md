...
x-i18n:
    generated_at: "2026-07-14T13:30:54Z"
    model: gpt-5.6
...
Si, tras iniciar sesión, vuelve a un estado sin sesión iniciada, es posible que su cuenta no esté en regla.
...
Cree un token en la interfaz web de ClawHub y páselo a la CLI:
