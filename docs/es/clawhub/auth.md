...
Las cuentas eliminadas, vetadas o deshabilitadas no pueden completar el inicio de sesión normal en ClawHub.
...
El flujo predeterminado de inicio de sesión en CLI abre tu navegador:
