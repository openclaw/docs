...
summary: Inicio de sesión de ClawHub, tokens de API, inicio de sesión de la CLI, almacenamiento de tokens y revocación.
x-i18n:
...
Las cuentas eliminadas, prohibidas o deshabilitadas no pueden completar el inicio de sesión normal en ClawHub.
Si el inicio de sesión te devuelve a un estado de sesión cerrada, es posible que tu cuenta no esté en regla.
Si tu cuenta fue prohibida o deshabilitada, usa el
...
Para shells remotas donde puedas abrir un navegador en otro lugar, ejecuta:
...
Las cuentas eliminadas, prohibidas o deshabilitadas no pueden seguir usando tokens de API existentes.
Si tu cuenta fue prohibida o deshabilitada, usa el
[formulario de apelación de ClawHub](https://appeals.openclaw.ai/) si crees que se trata de un
error.
