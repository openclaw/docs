...
x-i18n:
    generated_at: "2026-07-03T02:42:18Z"
    model: gpt-5.5
...
contiene códigos de mantenimiento del escáner sin orientación de corrección para el autor, esos
son para mantenedores de OpenClaw y no para autores de Plugin.
...
| `package-openclaw-entry-missing`        | [Declarar puntos de entrada de paquete de OpenClaw](/es/clawhub/plugin-validation-fixes#package-openclaw-entry-missing)                         |
...
| `package-plugin-api-compat-missing`     | [Declarar la compatibilidad de la API de Plugin](/es/clawhub/plugin-validation-fixes#package-plugin-api-compat-missing)                          |
...
| `package-openclaw-unsupported-metadata` | [Eliminar metadatos de paquete de OpenClaw no admitidos](/es/clawhub/plugin-validation-fixes#package-openclaw-unsupported-metadata)          |
...
| `sdk-load-session-store`                | [Reemplazar acceso al almacén completo de sesión](/es/clawhub/plugin-validation-fixes#sdk-load-session-store)                                   |
| `sdk-session-store-write`               | [Reemplazar escrituras en el almacén completo de sesión](/es/clawhub/plugin-validation-fixes#sdk-session-store-write)                                  |
...
- Usa la versión de la API de Plugin de OpenClaw o el límite inferior semver contra el que compilaste
  y probaste.
...
- Si `openclaw.plugin.json` también tiene `version`, actualízala para que coincida o elimina
  metadatos obsoletos de versión del manifiesto cuando los metadatos del paquete sean la autoridad.
...
- Mantén `providerAuthEnvVars` solo como metadatos de compatibilidad mientras tu rango de
  OpenClaw admitido aún lo necesite.
