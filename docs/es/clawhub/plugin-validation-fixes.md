...
summary: Corregir los hallazgos de validación del paquete de Plugin de ClawHub antes de publicarlo
title: Correcciones de validación de Plugin
x-i18n:
    generated_at: "2026-07-04T17:48:10Z"
    model: gpt-5.5
...
análisis automatizados de paquetes. Esta página cubre los hallazgos orientados a autores, lo que significa
...
contiene códigos de mantenimiento del escáner sin orientación de corrección para autores, esos
...
| `manifest-name-missing`                 | [Añade un nombre visible del manifiesto](/es/clawhub/plugin-validation-fixes#manifest-name-missing)                                           |
...
| `sdk-session-store-write`               | [Reemplaza escrituras en todo el almacén de sesión](/es/clawhub/plugin-validation-fixes#sdk-session-store-write)                                  |
...
El paquete tiene `package.json`, pero no declara metadatos del paquete de OpenClaw.
...
- Usa la versión de la API de Plugin de OpenClaw o el límite inferior semver con el que compilaste y probaste.
...
- Mantén `providerAuthEnvVars` solo como metadatos de compatibilidad mientras tu rango admitido de
...
El manifiesto usa metadatos de variables de entorno de canal heredados o antiguos sin los metadatos actuales
...
- Refleja el setup de canal impulsado por variables de entorno en los metadatos actuales de setup, configuración de canal o
  canal de paquete usados por la forma de tu Plugin.
