...
| `sdk-session-transcript-file-target`    | [Reemplaza destinos heredados de archivos de transcripción](/es/clawhub/plugin-validation-fixes#sdk-session-transcript-file-target)                   |
...
- Corrige metadatos de paquete no válidos, scripts de ciclo de vida rotos o entradas de archivos que
  hagan que falle el empaquetado.
