...
x-i18n:
    generated_at: "2026-07-04T06:21:37Z"
    model: gpt-5.5
...
ClawHub valida paquetes de plugins antes de publicarlos y también puede mostrar hallazgos de
...
| `package-plugin-api-compat-missing`     | [Declara compatibilidad con la API de plugins](/es/clawhub/plugin-validation-fixes#package-plugin-api-compat-missing)                          |
...
| `legacy-root-sdk-import`                | [Reemplaza importaciones del SDK raíz](/es/clawhub/plugin-validation-fixes#legacy-root-sdk-import)                                             |
...
El Plugin importa una ruta de SDK reservada para Plugins incluidos o compatibilidad
interna.
...
- Usa `appendSessionTranscriptMessageByIdentity(...)` para agregar a la transcripción.
