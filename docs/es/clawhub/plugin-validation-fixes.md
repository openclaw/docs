...
x-i18n:
    generated_at: "2026-07-03T09:22:01Z"
    model: gpt-5.5
...
contiene códigos de mantenimiento del analizador sin guía de remediación para autores, esos
son para los mantenedores de OpenClaw, no para autores de plugins.
...
| `package-openclaw-unsupported-metadata` | [Elimina los metadatos de paquete de OpenClaw no admitidos](/es/clawhub/plugin-validation-fixes#package-openclaw-unsupported-metadata)          |
...
| `manifest-unknown-fields`               | [Elimina los campos de manifiesto no admitidos](/es/clawhub/plugin-validation-fixes#manifest-unknown-fields)                                  |
| `manifest-unknown-contracts`            | [Elimina las claves de contrato no admitidas](/es/clawhub/plugin-validation-fixes#manifest-unknown-contracts)                                 |
...
| `reserved-sdk-import`                   | [Elimina las importaciones reservadas del SDK](/es/clawhub/plugin-validation-fixes#reserved-sdk-import)                                             |
...
| `sdk-session-store-write`               | [Sustituye las escrituras en el almacén de sesión completo](/es/clawhub/plugin-validation-fixes#sdk-session-store-write)                                  |
| `sdk-session-file-helper`               | [Sustituye los helpers de rutas de archivo de sesión](/es/clawhub/plugin-validation-fixes#sdk-session-file-helper)                                   |
...
| `security-manifest-schema-unavailable`  | [Elimina las referencias a esquemas de manifiesto de seguridad no disponibles](/es/clawhub/plugin-validation-fixes#security-manifest-schema-unavailable) |
| `unrecognized-security-manifest`        | [Elimina los archivos de manifiesto de seguridad no admitidos](/es/clawhub/plugin-validation-fixes#unrecognized-security-manifest)                   |
...
- Configura `openclaw.install.defaultChoice` cuando haya más de un origen de instalación
  disponible.
...
- Usa la versión de la API de plugins de OpenClaw o el mínimo semver con el que creaste y probaste
  el paquete.
...
- Asegúrate de que `openclaw.plugin.json` se incluya cuando el paquete sea un plugin nativo
  de OpenClaw.
...
- Mantén `name` legible para humanos y mantén `id` como el id estable legible por máquina.
- Consulta [Manifiesto de Plugin](/es/plugins/manifest).
- Vuelve a ejecutar `clawhub package validate <path-to-plugin>`.
...
- Usa `openclaw/plugin-sdk/channel-core` para los helpers de punto de entrada de canales.
...
El plugin aún usa el helper obsoleto de almacén completo de sesiones
`loadSessionStore`.
...
El plugin aún usa un helper obsoleto de escritura del almacén completo de sesiones, como
...
El plugin aún usa helpers obsoletos de bajo nivel de transcripción, como
...
- Mantén los helpers de bajo nivel de transcripción solo mientras tu rango de compatibilidad declarado
  aún admita versiones anteriores de OpenClaw que los requieran.
- Consulta [API de tiempo de ejecución](/es/plugins/sdk-runtime#agent-session-state) y
  [Subrutas del SDK de Plugin](/es/plugins/sdk-subpaths).
- Vuelve a ejecutar `clawhub package validate <path-to-plugin>`.
...
- Refleja el setup de canal controlado por variables de entorno en los metadatos actuales de setup, configuración de canal o
