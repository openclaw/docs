...
x-i18n:
    generated_at: "2026-07-04T03:35:14Z"
    model: gpt-5.5
...
análisis automatizados de paquetes. Esta página cubre hallazgos orientados al autor, es decir,
...
| `package-plugin-api-compat-missing`     | [Declarar la compatibilidad de la API de plugins](/es/clawhub/plugin-validation-fixes#package-plugin-api-compat-missing)                          |
...
| `package-npm-pack-unavailable`          | [Hacer que el artefacto npm sea empaquetable](/es/clawhub/plugin-validation-fixes#package-npm-pack-unavailable)                                 |
...
| `sdk-session-store-write`               | [Reemplazar las escrituras del almacén de sesión completo](/es/clawhub/plugin-validation-fixes#sdk-session-store-write)                                  |
| `sdk-session-file-helper`               | [Reemplazar helpers de rutas de archivo de sesión](/es/clawhub/plugin-validation-fixes#sdk-session-file-helper)                                   |
...
| `sdk-session-transcript-low-level`      | [Reemplazar helpers de transcripción de bajo nivel](/es/clawhub/plugin-validation-fixes#sdk-session-transcript-low-level)                       |
...
- Consulta [Puntos de entrada de plugins](/es/plugins/sdk-entrypoints) y
...
- Usa la versión de la API de plugins de OpenClaw o el piso semver contra el que compilaste
  y probaste.
...
- Mantén `name` legible para personas y conserva `id` como el identificador estable para máquinas.
- Consulta [Manifiesto del Plugin](/es/plugins/manifest).
- Vuelve a ejecutar `clawhub package validate <path-to-plugin>`.
...
- Usa `appendSessionTranscriptMessageByIdentity(...)` para anexar a la transcripción.
