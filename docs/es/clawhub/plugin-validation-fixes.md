...
- Si `openclaw.plugin.json` también tiene `version`, actualízala para que coincida o elimina
  metadatos de versión del manifiesto obsoletos cuando los metadatos del paquete sean la fuente autoritativa.
...
El plugin todavía usa el ayudante obsoleto de almacén completo de sesiones
`loadSessionStore`.
...
El plugin todavía usa un ayudante obsoleto de escritura de almacén completo de sesiones, como
...
- Evita leer o construir directamente destinos heredados de archivo de transcripción.
- Mantén el ayudante heredado solo mientras tu rango de compatibilidad declarado siga
...
El plugin todavía usa ayudantes obsoletos de transcripción de bajo nivel como
...
- Mantén documentado el comportamiento sensible a la seguridad en la documentación pública de tu paquete o
