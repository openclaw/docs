---
read_when:
    - Cómo informar sobre una skill, Plugin o paquete
...
el escaneo, la moderación o los límites de confianza de descarga/instalación. No uses los avisos
...
por sí mismo en una acción de cuenta.

## Reclamaciones de org y espacios de nombres

Las disputas sobre propiedad de org, marca, alcance de paquete, identificador de propietario o espacio de nombres deben
usar el proceso de [Reclamaciones de org y espacios de nombres](/clawhub/namespace-claims), no el
...
documentos personales de identidad, tokens de API ni tokens de desafío DNS en un
issue público.
...
público, o las futuras publicaciones pueden empezar ocultas hasta que se revise el problema.
