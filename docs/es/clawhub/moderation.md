---
read_when:
    - Informar de una skill, un plugin o un paquete
    - Recuperarse de una lista retenida, oculta o bloqueada
...
[Uso aceptable](/es/clawhub/acceptable-usage). Para problemas de derechos de autor u otros
...
Las disputas de propiedad sobre organizaciones, marcas, ámbitos de paquete, identificadores de propietario o espacios de nombres deben
...
espacio de nombres debe reservarse, transferirse, renombrarse, ocultarse, ponerse en cuarentena, asignarse a un alias
...
Las retenciones de moderación tienen como objetivo proteger a los usuarios mientras ClawHub resuelve casos
...
Las señales de presión por abuso de publicadores se revisan diariamente. Las señales que alcancen
