---
read_when:
    - Notificar un Skill, Plugin o paquete
...
title: Seguridad de la moderación y de la cuenta
x-i18n:
...
Los buenos reportes son específicos y accionables. El abuso del sistema de reportes puede, por sí mismo, derivar en
acciones sobre la cuenta.

## Reclamos de organización y namespace

Las disputas sobre propiedad de organizaciones, marcas, ámbitos de paquete, identificadores de propietario o namespaces deben
usar el proceso de [Reclamos de organización y namespace](/clawhub/namespace-claims), no el
...
Las señales de revisión de menor confianza y acotadas temporalmente quedan fuera de la
