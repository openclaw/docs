...
x-i18n:
    generated_at: "2026-07-04T17:48:08Z"
    model: gpt-5.5
...
necesitan protecciones. Los reportes, las retenciones de moderación, los listados ocultos y las acciones sobre cuentas
...
[Uso aceptable](/clawhub/acceptable-usage). Para problemas de copyright u otros derechos
sobre contenido, usa [Solicitudes de derechos de contenido](/clawhub/content-rights).
...
Las señales de presión de abuso de editores se revisan diariamente. Las señales que alcanzan
el umbral de posible bloqueo de ClawHub pueden activar una advertencia automática. Si el siguiente
escaneo elegible después de la fecha límite de advertencia todavía coloca al editor en el
...
Para reducir los falsos positivos y mejorar la confianza del usuario:
