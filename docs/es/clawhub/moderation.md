---
read_when:
    - Informar sobre un Skills, Plugin o paquete
...
summary: Cómo funcionan las denuncias de ClawHub, las retenciones de moderación, los listados ocultos, las prohibiciones y el estado de la cuenta.
title: Moderación y seguridad de la cuenta
x-i18n:
    generated_at: "2026-07-01T15:18:56Z"
    model: gpt-5.5
...
necesitan controles de protección. Los reportes, las retenciones de moderación, los listados ocultos y las acciones de cuenta
...
público o las publicaciones futuras pueden comenzar ocultas hasta que el problema sea revisado.
...
escaneo elegible después de la fecha límite de advertencia aún coloca al publicador en el
