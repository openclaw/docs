...
[Uso aceptable](/clawhub/acceptable-usage). Para inquietudes sobre copyright u otros derechos
de contenido, usa [Solicitudes sobre derechos de contenido](/clawhub/content-rights).
...
ClawHub mismo. Algunos ejemplos incluyen errores en el sitio web, API, CLI, registro, auth,
...
en acciones sobre la cuenta.

## Reclamaciones de org y namespace

Las disputas sobre propiedad de org, marca, alcance de paquete, identificador de propietario o namespace deben
...
namespace debe reservarse, transferirse, renombrarse, ocultarse, ponerse en cuarentena, asociarse con un alias
...
Las señales de presión por abuso del publicador se comprueban a diario. Las señales que alcanzan
el umbral de bloqueo potencial de ClawHub pueden activar una advertencia automática. Si el siguiente
escaneo elegible después de la fecha límite de la advertencia todavía coloca al publicador en el
umbral de bloqueo potencial, ClawHub puede aplicar la acción sobre la cuenta automáticamente.
...
estado de la cuenta. Si el inicio de sesión o el acceso normal por CLI está bloqueado por un bloqueo o una cuenta deshabilitada,
