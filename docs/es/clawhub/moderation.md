...
necesitan protecciones. Los informes, las retenciones de moderación, los listados ocultos y las acciones
...
Los buenos informes son específicos y accionables. El abuso del sistema de informes puede llevar por sí mismo a
acciones sobre la cuenta.

## Reclamaciones de organizaciones y espacios de nombres

Las disputas de propiedad de organizaciones, marcas, ámbitos de paquetes, identificadores de propietario o espacios de nombres deberían
...
dar lugar al bloqueo de cuentas, la revocación de tokens, contenido oculto o listados eliminados.
