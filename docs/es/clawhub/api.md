...
x-i18n:
    generated_at: "2026-07-01T15:18:47Z"
    model: gpt-5.5
...
- Usa endpoints públicos de lectura como `GET /api/v1/skills`, `GET /api/v1/search` y `GET /api/v1/skills/{slug}` para los listados de catálogo.
...
- No reflejes contenido oculto, privado o bloqueado por moderación omitiendo filtros de API públicos o límites de autenticación.
...
- `GET /api/v1/skills?limit=&cursor=&sort=`
  ...
  - `cursor` se aplica a ordenamientos que no son `trending`
