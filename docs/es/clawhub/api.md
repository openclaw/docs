...
- Enlaza de vuelta a la URL canónica de la Skill de ClawHub al mostrar listados para que los usuarios puedan inspeccionar el registro de origen del registro.
...
- No reflejes contenido oculto, privado o bloqueado por moderación omitiendo los filtros de la API pública o los límites de autenticación.
...
Aplicación según autenticación:
...
- `GET /api/v1/skills?limit=&cursor=&sort=`
  ...
  - `recommended` usa señales de participación y actualidad.
