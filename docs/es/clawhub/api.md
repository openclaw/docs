...
Puedes crear un catálogo, directorio o superficie de búsqueda de terceros sobre las API públicas de lectura de ClawHub. Los metadatos públicos de skill y los archivos de skill se publican bajo las reglas de licencia de skills de ClawHub, mientras que la API en sí tiene límites de tasa y debe consumirse de forma responsable.
...
- Almacena en caché las respuestas y respeta `429`, `Retry-After` y los encabezados de límites de tasa en lugar de hacer sondeos agresivos.
- Enlaza de vuelta a la URL canónica de skill de ClawHub al mostrar listados para que los usuarios puedan inspeccionar el registro de origen del registro.
...
- `GET /api/v1/skills?limit=&cursor=&sort=`
  ...
  - `cursor` se aplica a ordenaciones distintas de `trending`
