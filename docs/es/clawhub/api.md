...
- Enlaza a la URL canónica de la Skill de ClawHub al mostrar listados para que los usuarios puedan inspeccionar el registro de origen.
...
- El token ausente/no válido recurre a la aplicación por IP.
