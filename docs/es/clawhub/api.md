...
- Almacena respuestas en caché y respeta `429`, `Retry-After` y los encabezados de límites de tasa en lugar de sondear agresivamente.
...
- Un token ausente o no válido recae en la aplicación por IP.
