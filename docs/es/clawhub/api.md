...
- Almacena en caché las respuestas y respeta los encabezados `429`, `Retry-After` y de límite de tasa en lugar de hacer sondeos agresivos.
...
- No repliques contenido oculto, privado o bloqueado por moderación omitiendo filtros de API pública o límites de autenticación.
...
- `X-RateLimit-Remaining` / `RateLimit-Remaining`: presupuesto restante exacto cuando
  está presente; las solicitudes exitosas con particionamiento lo omiten en lugar de devolver un valor
  global aproximado
