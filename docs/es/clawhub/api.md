...
x-i18n:
    generated_at: "2026-07-03T23:25:38Z"
    model: gpt-5.5
...
- Enlaza a la URL canónica de Skills de ClawHub al mostrar listados para que los usuarios puedan inspeccionar el registro de origen.
- Usa URL de página canónicas con el formato `https://clawhub.ai/<owner>/skills/<slug>`.
- No impliques que ClawHub respalda, verifica u opera el sitio de terceros.
...
- `X-RateLimit-Reset`: segundos de época Unix (tiempo absoluto de reinicio)
