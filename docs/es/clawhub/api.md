...
x-i18n:
    generated_at: "2026-07-03T09:21:31Z"
    model: gpt-5.5
...
- Enlaza a la URL canónica del Skill en ClawHub al mostrar listados para que los usuarios puedan inspeccionar el registro de origen del registro.
...
- No reflejes contenido oculto, privado o bloqueado por moderación eludiendo filtros de API públicas o límites de autenticación.
...
- Solicitudes autenticadas (token Bearer válido): por contenedor de usuario.
