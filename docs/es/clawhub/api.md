...
- Almacena respuestas en caché y respeta `429`, `Retry-After` y los encabezados de límite de tasa en lugar de sondear de forma agresiva.
- Enlaza de vuelta a la URL canónica de habilidad de ClawHub al mostrar listados para que los usuarios puedan inspeccionar el registro de origen del registro.
