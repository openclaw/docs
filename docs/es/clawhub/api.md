...
x-i18n:
    generated_at: "2026-07-01T07:50:31Z"
    model: gpt-5.5
...
- Enlaza a la URL canónica de Skill de ClawHub al mostrar listados para que los usuarios puedan inspeccionar el registro fuente del registro.
...
- `X-RateLimit-Remaining` / `RateLimit-Remaining`: presupuesto restante exacto cuando
  ...
  global aproximado
- `Retry-After`: segundos de retraso que esperar en `429`
...
- `POST /api/v1/users/reserve` reserva slugs raíz y marcadores de posición de paquetes privados sin versiones para un identificador de propietario.
