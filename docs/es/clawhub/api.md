...
- Almacena respuestas en caché y respeta `429`, `Retry-After` y las cabeceras de límite de tasa en lugar de sondear agresivamente.
...
- Solicitudes autenticadas (token Bearer válido): por bloque de usuario.
