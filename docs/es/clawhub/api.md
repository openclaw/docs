...
Aplicación que tiene en cuenta la autenticación:
...
- `X-RateLimit-Remaining` / `RateLimit-Remaining`: presupuesto restante exacto cuando está
  presente; las solicitudes exitosas fragmentadas lo omiten en lugar de devolver un valor
  global aproximado
...
- Agrega fluctuación aleatoria a los reintentos.
