...
- Enlaza a la URL canónica de Skills de ClawHub al mostrar listados para que los usuarios puedan inspeccionar el registro de origen del registro.
- Usa URL de página canónicas con el formato `https://clawhub.ai/<owner>/skills/<slug>`.
- No sugieras que ClawHub respalda, verifica u opera el sitio de terceros.
- No dupliques contenido oculto, privado o bloqueado por moderación eludiendo filtros de la API pública o límites de autenticación.
