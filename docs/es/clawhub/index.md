...
`npm:<package>` permanece solo para npm cuando el origen debe ser explícito.
...
Usa `--dry-run` para construir el plan exacto de publicación sin subir nada, y `--json`
...
ClawHub pueda calcular recuentos de instalaciones. Desactiva esto con:
