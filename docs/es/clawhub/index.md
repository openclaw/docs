...
- Usa la CLI separada `clawhub` para la autenticación en el registro, la publicación y los flujos de eliminación/restauración.
...
artefacto ClawPack, OpenClaw prefiere el `.tgz` exacto subido por npm-pack, verifica
...
Cuando ejecutas `clawhub install` con la sesión iniciada, la CLI puede enviar un evento de instalación
