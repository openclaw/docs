...
metadatos de origen para que los comandos de actualización posteriores puedan seguir en ClawHub.
...
Usa `--dry-run` para construir el plan de publicación exacto sin subir, y `--json`
...
ClawHub ejecuta comprobaciones automatizadas en Skills y versiones de plugins publicadas. Las versiones retenidas por análisis
