...
title: ClawHub
x-i18n:
    generated_at: "2026-07-04T03:34:55Z"
    model: gpt-5.5
...
- Usa la CLI `clawhub` separada para flujos de trabajo de autenticación del registro, publicación y eliminación/restauración.
...
Instala la CLI de ClawHub cuando quieras flujos de trabajo autenticados con el registro, como
...
o bloqueadas pueden desaparecer del catálogo público y de las superficies de instalación, aunque
...
[Uso aceptable](/es/clawhub/acceptable-usage) para conocer los detalles de políticas y aplicación.
