...
title: ClawHub
x-i18n:
    generated_at: "2026-07-02T07:55:00Z"
    model: gpt-5.5
...
para que los usuarios puedan inspeccionar una skill o plugin antes de instalarlo.
...
Las especificaciones de plugins simples compatibles con npm pueden resolverse a través de npm durante los cambios de lanzamiento, y
...
- `--tags <tags>`: etiquetas separadas por comas, con el valor predeterminado `latest`.
...
con suficiente antigüedad para pasar la puerta de subida. Las páginas públicas de detalle resumen el
...
[Uso aceptable](/es/clawhub/acceptable-usage) para ver detalles de políticas y aplicación.
