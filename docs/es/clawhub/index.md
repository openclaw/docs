...
- Usa la CLI `clawhub` independiente para flujos de autenticación en el registro, publicación y eliminación/restauración.
...
Usa `--dry-run` para generar el plan de publicación exacto sin subir nada, y `--json`
