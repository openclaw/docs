...
title: ClawHub
x-i18n:
    generated_at: "2026-07-06T21:46:49Z"
    model: gpt-5.5
...
Las especificaciones de plugins compatibles con npm y sin prefijo pueden resolverse mediante npm durante las transiciones de lanzamiento, y
`npm:<package>` permanece solo en npm cuando el origen debe ser explícito.
...
[Uso aceptable](/clawhub/acceptable-usage) para ver detalles de políticas y aplicación.
