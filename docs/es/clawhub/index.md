...
Las especificaciones de plugins simples compatibles con npm pueden resolverse mediante npm durante las transiciones de lanzamiento, y
...
con la antigüedad suficiente para pasar la puerta de subida. Las páginas públicas de detalles resumen el
