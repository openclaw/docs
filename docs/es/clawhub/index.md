...
summary: Descripción general pública de ClawHub para descubrir, instalar, publicar, seguridad y la CLI de clawhub.
title: ClawHub
x-i18n:
...
- Usa la CLI separada `clawhub` para flujos de trabajo de autenticación del registro, publicación y eliminación/restauración.
...
Instala la CLI de ClawHub cuando quieras flujos de trabajo autenticados por el registro, como
...
Las especificaciones de plugins sin prefijo y seguras para npm pueden resolverse a través de npm durante las transiciones de lanzamiento, y
...
La CLI de ClawHub es para trabajo autenticado por el registro:
...
Usa `--dry-run` para crear el plan exacto de publicación sin cargar, y `--json`
...
ClawHub está abierto de forma predeterminada: cualquiera puede cargar, pero publicar requiere una cuenta de GitHub
