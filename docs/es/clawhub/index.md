...
title: ClawHub
x-i18n:
    generated_at: "2026-06-28T05:15:36Z"
    model: gpt-5.5
...
Las especificaciones de plugins sin prefijo compatibles con npm pueden resolverse a través de npm durante transiciones de lanzamiento, y
...
permanecen visibles para su propietario en `/dashboard`.
