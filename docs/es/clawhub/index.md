...
read_when:
    ...
    - Elegir entre los flujos CLI de openclaw y clawhub
...
Las especificaciones de plugin simples compatibles con npm pueden resolverse a través de npm durante las transiciones de lanzamiento, y
...
ClawHub ejecuta comprobaciones automatizadas sobre Skills publicadas y versiones de plugins. Las versiones retenidas por escaneo
...
Cuando ejecutas `clawhub install` con la sesión iniciada, la CLI puede enviar un evento de instalación de mejor esfuerzo
