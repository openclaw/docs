...
- Usa la CLI separada `clawhub` para flujos de autenticación, publicación y eliminación/restauración del registro.
...
Las especificaciones de plugin simples y seguras para npm pueden resolverse a través de npm durante cambios de lanzamiento, y
...
Usa `--dry-run` para crear el plan de publicación exacto sin cargarlo, y `--json`
