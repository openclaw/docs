...
los metadatos de origen para que los comandos de actualización posteriores puedan seguir en ClawHub.
...
Usa `--dry-run` para crear el plan exacto de publicación sin subir nada, y `--json`
para una salida apta para CI.
...
`openclaw.build.openclawVersion`. Consulta [CLI](/es/clawhub/cli) para ver la referencia completa de comandos
...
[Uso aceptable](/clawhub/acceptable-usage) para obtener detalles de política y aplicación.
