...
title: ClawHub
x-i18n:
    generated_at: "2026-07-01T20:10:53Z"
    model: gpt-5.5
...
Usa `--dry-run` para compilar el plan exacto de publicación sin subir nada, y `--json`
para una salida compatible con CI.
...
| Variable                      | Efecto                                            |
| ----------------------------- | ------------------------------------------------- |
| `CLAWHUB_SITE`                | Sustituye la URL del sitio usada para el inicio de sesión en el navegador.     |
| `CLAWHUB_REGISTRY`            | Sustituye la URL de la API del registro.                    |
| `CLAWHUB_CONFIG_PATH`         | Sustituye dónde almacena la CLI el estado de token/configuración. |
