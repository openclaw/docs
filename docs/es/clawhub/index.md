...
- Usa la CLI independiente `clawhub` para flujos de trabajo de autenticación del registro, publicación, eliminación/restauración y sincronización.
...
Las especificaciones de plugins aptas para npm sin prefijo pueden resolverse a través de npm durante las transiciones de lanzamiento, y
...
con la antigüedad suficiente para superar la puerta de subida. Las páginas públicas de detalle resumen el
...
[Seguridad y moderación](/es/clawhub/security) para conocer los detalles de políticas y aplicación.

## Telemetría y entorno

Cuando ejecutas `clawhub sync` con la sesión iniciada, la CLI envía una instantánea mínima para que
ClawHub pueda calcular los recuentos de instalación. Desactívalo con:
