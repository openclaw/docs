...
Las especificaciones de plugins sin prefijo aptas para npm pueden resolverse mediante npm durante las transiciones de lanzamiento, y
...
ClawHub está abierto de forma predeterminada: cualquiera puede cargar contenido, pero la publicación requiere una cuenta de GitHub
