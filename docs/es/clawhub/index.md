...
La CLI de ClawHub sirve para trabajo autenticado con el registro:
...
con antigüedad suficiente para superar la barrera de subida. Las páginas públicas de detalle resumen el
estado del análisis más reciente antes de instalar o descargar.

ClawHub ejecuta comprobaciones automatizadas en las Skills y versiones de plugins publicadas. Las versiones retenidas por análisis
