...
title: ClawHub
x-i18n:
    generated_at: "2026-07-01T07:50:40Z"
    model: gpt-5.5
...
- Usa la CLI separada `clawhub` para flujos de autenticación en el registro, publicación y eliminación/restauración.
...
Los comandos nativos de OpenClaw instalan en el espacio de trabajo activo de OpenClaw y persisten
...
Las especificaciones de plugins bare compatibles con npm pueden resolverse a través de npm durante transiciones de lanzamiento, y
...
artefacto ClawPack, OpenClaw prefiere el `.tgz` exacto subido con npm-pack, verifica
...
y [Formato de Skills](/clawhub/skill-format) para los metadatos de skills.
...
| `CLAWHUB_CONFIG_PATH`         | Anula dónde la CLI almacena el estado de token/configuración. |
