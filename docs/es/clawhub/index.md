...
title: ClawHub
x-i18n:
    generated_at: "2026-06-27T10:52:55Z"
    model: gpt-5.5
...
ClawHub realiza seguimiento de versiones semver, etiquetas como `latest`, registros de cambios, archivos,
...
Las especificaciones de plugin sin prefijo y seguras para npm pueden resolverse a través de npm durante transiciones de lanzamiento, y
...
ClawHub ejecuta comprobaciones automatizadas sobre Skills y versiones de plugins publicados. Las versiones retenidas por escaneo
