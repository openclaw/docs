...
ClawHub ejecuta comprobaciones automatizadas en Skills y versiones de plugins publicados. Las versiones retenidas por análisis
...
Los usuarios que hayan iniciado sesión pueden reportar Skills y paquetes. Los moderadores pueden revisar reportes,
ocultar o restaurar contenido, y vetar cuentas abusivas. Consulta
[Uso aceptable](/es/clawhub/acceptable-usage) y
[Seguridad + moderación](/es/clawhub/security) para ver detalles de políticas y aplicación.

## Telemetría y entorno

Cuando ejecutas `clawhub sync` con la sesión iniciada, la CLI envía una instantánea mínima para que
ClawHub pueda calcular conteos de instalaciones. Desactívalo con:
