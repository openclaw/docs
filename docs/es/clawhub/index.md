...
title: ClawHub
x-i18n:
    generated_at: "2026-07-02T17:30:25Z"
    model: gpt-5.5
...
- Usa la CLI `clawhub` separada para la autenticación del registro, la publicación y los flujos de eliminación/restauración.
...
ClawHub hace seguimiento de versiones semver, etiquetas como `latest`, registros de cambios, archivos,
...
Las especificaciones de plugins simples compatibles con npm pueden resolverse a través de npm durante transiciones de lanzamiento, y
...
ClawHub es abierto de forma predeterminada: cualquiera puede subir contenido, pero la publicación requiere una cuenta de GitHub
con antigüedad suficiente para pasar la barrera de subida. Las páginas públicas de detalle resumen el
...
[Uso aceptable](/clawhub/acceptable-usage) para obtener detalles sobre políticas y aplicación.
