...
title: ClawHub
x-i18n:
    generated_at: "2026-07-04T06:21:32Z"
    model: gpt-5.5
...
y [Formato de Skill](/clawhub/skill-format) para los metadatos de Skill.
...
de mejor esfuerzo para que ClawHub pueda calcular conteos agregados de instalaciones. Desactívalo con:
