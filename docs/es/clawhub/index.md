...
title: ClawHub
x-i18n:
    generated_at: "2026-07-02T00:42:54Z"
    model: gpt-5.5
...
- Usa la CLI `clawhub` independiente para la autenticación del registro, la publicación y los flujos de eliminación/restauración.
...
Instala la CLI de ClawHub cuando quieras flujos autenticados por el registro, como
