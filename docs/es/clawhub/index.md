...
title: ClawHub
x-i18n:
    generated_at: "2026-07-05T01:54:08Z"
    model: gpt-5.5
...
- Usa la CLI independiente `clawhub` para los flujos de autenticación del registro, publicación y eliminación/restauración.
...
con la antigüedad suficiente para pasar la puerta de subida. Las páginas públicas de detalle resumen el
estado del análisis más reciente antes de instalar o descargar.

ClawHub ejecuta comprobaciones automatizadas sobre Skills publicadas y versiones de plugins. Las versiones retenidas por análisis
