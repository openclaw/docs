...
ClawHub rastrea versiones semver, etiquetas como `latest`, changelogs, archivos,
...
Las especificaciones de plugins sin prefijo compatibles con npm pueden resolverse mediante npm durante transiciones de lanzamiento, y
...
[Uso aceptable](/es/clawhub/acceptable-usage) para ver detalles de políticas y cumplimiento.
