...
ClawHub usa **telemetría mínima** para calcular los **recuentos de instalaciones** (lo que realmente está en uso) y para ofrecer una mejor ordenación y filtrado.
...
- `skillId` (resuelta por slug; solo se rastrean las skills que existen en el registro).
...
- Ningún rastreo de skills que no estén subidas al registro (los slugs desconocidos se ignoran).
