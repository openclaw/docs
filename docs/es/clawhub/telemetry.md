...
- `installsAllTime`: usuarios únicos que han informado al menos una instalación de la habilidad desde la CLI.
...
Con esto establecido, la CLI no enviará telemetría de instalación.
