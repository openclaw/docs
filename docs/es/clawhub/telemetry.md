...
x-i18n:
    generated_at: "2026-06-27T10:55:25Z"
    model: gpt-5.5
...
- `installsAllTime`: usuarios únicos que han informado al menos una instalación desde la CLI para el skill.
...
Todas las personas solo ven **contadores agregados de instalaciones**.
