...
x-i18n:
    generated_at: "2026-06-28T05:17:53Z"
    model: gpt-5.5
...
En cada `clawhub install` informado, la CLI envía un único evento de instalación de mejor esfuerzo.
...
- `installsAllTime`: usuarios únicos que han informado al menos una instalación de CLI para la skill.
