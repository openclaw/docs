...
- `installsAllTime`: usuarios únicos que han informado al menos una instalación de la habilidad mediante la CLI.
...
Con esto establecido, la CLI no enviará telemetría de instalaciones.
