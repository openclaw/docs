...
x-i18n:
    generated_at: "2026-07-03T13:16:32Z"
    model: gpt-5.5
...
- `slug`: el slug de la Skills instalada.
...
ClawHub mantiene contadores agregados por Skills:

- `installsAllTime`: usuarios únicos que han informado al menos una instalación de la CLI para la Skills.
...
Todas las personas solo ven **contadores de instalaciones agregados**.
