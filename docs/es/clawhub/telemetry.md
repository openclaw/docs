...
summary: Instala la telemetría recopilada por la CLI de ClawHub y cómo excluirse.
x-i18n:
    generated_at: "2026-07-02T07:55:40Z"
    model: gpt-5.5
...
- La telemetría **no está desactivada** (consulta “Cómo desactivarla” a continuación).
...
- `installsAllTime`: usuarios únicos que han informado al menos una instalación desde la CLI para la Skill.
...
Todos ven solo **contadores agregados de instalaciones**.
...
Con esta configuración, la CLI no enviará telemetría de instalación.
