...
summary: Instalar la telemetría recopilada por la CLI de ClawHub y cómo optar por no participar.
x-i18n:
    generated_at: "2026-06-28T00:12:07Z"
    model: gpt-5.5
...
ClawHub usa una telemetría mínima de la CLI para calcular recuentos agregados de instalaciones.
...
- No se recopilan rutas de carpetas ni identificadores derivados de carpetas.
- No se recopilan contenidos de archivos.
- No se recopilan registros por ejecución, prompts ni otra salida de la CLI.
