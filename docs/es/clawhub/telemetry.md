...
ClawHub usa **telemetría mínima** para calcular los **recuentos de instalaciones** (lo que realmente está en uso) y ofrecer mejor ordenación/filtrado.
...
- `installsAllTime` nunca disminuye a menos que elimines la telemetría (consulta abajo).
