---
read_when:
    - Revisar cargas por abuso o infracciones de políticas
...
title: Uso aceptable
x-i18n:
    generated_at: "2026-07-02T13:57:30Z"
    model: gpt-5.5
...
| Seguridad defensiva, moderación y revisión de abusos | La herramienta está planteada para revisión autorizada, preserva evidencias y mantiene claros los límites de aprobación humana.                          |
...
| Catálogos mantenidos                              | Cada listado es distinto, útil, descrito con precisión y mantenido de forma razonable.                                                |
...
| Abuso de plataforma y evasión de bloqueos                              | Cuentas encubiertas después de bloqueos, calentamiento o cultivo de cuentas, interacción falsa, automatización de múltiples cuentas, publicaciones masivas, bots de spam o automatización creada para evitar la detección.                                                                                                                                          |
...
| Contenido sexual explícito o generación adulta con seguridad desactivada | Generación de imágenes, video o contenido NSFW; wrappers de contenido adulto alrededor de APIs de terceros; o listados cuyo propósito principal sea contenido sexual explícito.                                                                                                                                                       |
...
- ocultar, retener, eliminar, eliminar de forma reversible o, cuando el tipo de recurso lo admita,
  eliminar de forma definitiva listados que infrinjan las reglas
