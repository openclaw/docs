...
Estas reglas se aplican a lo que hace una ficha, lo que pide a los usuarios que
ejecuten, cómo se presenta y cómo los publicadores usan las superficies de
descubrimiento, instalación y confianza de ClawHub. Para estados de moderación y
situación de la cuenta, consulta
[Moderación y seguridad de la cuenta](/clawhub/moderation). Para reclamaciones
de copyright u otros derechos, consulta [Solicitudes de derechos de contenido](/clawhub/content-rights).
...
El contexto importa. El mismo tema puede ser aceptable en un entorno defensivo o
basado en consentimiento, y no aceptable cuando se empaqueta como un flujo de trabajo de abuso.
...
| Abuso de plataformas y evasión de vetos                              | Cuentas encubiertas tras vetos, preparación o cultivo de cuentas, interacción falsa, automatización de múltiples cuentas, publicaciones masivas, bots de spam o automatización creada para evitar la detección.                                                                                                                                          |
...
| Enriquecimiento o vigilancia invasivos para la privacidad                 | Extracción de contactos para spam, doxxing, acoso, extracción de clientes potenciales combinada con contacto no solicitado, monitoreo encubierto, coincidencia biométrica no consentida o uso de datos filtrados o volcados de brechas.                                                                                                                  |
...
## Comportamiento de mercado no permitido

ClawHub también revisa cómo los publicadores usan el mercado. No uses ClawHub para
manipular el descubrimiento, las métricas, las señales de confianza, los sistemas
de moderación o la atención de los usuarios.

El comportamiento de mercado no permitido incluye:

- publicar en bloque grandes cantidades de fichas de bajo esfuerzo, duplicadas,
  de marcador de posición o generadas por máquina que no parecen tener valor real
  para los usuarios
- inundar las superficies de búsqueda o categoría con Skills o plugins casi idénticos
- publicar cientos de fichas con poco o ningún uso, mantenimiento, claridad de
...
- crear o rotar cuentas para evadir la moderación, los vetos, los límites de publicador o
...
[Solicitudes de derechos de contenido](/clawhub/content-rights). No uses los reportes normales del mercado
...
- vetar a infractores reincidentes o graves

No garantizamos un cumplimiento con advertencia previa para abusos evidentes. Consulta
[Moderación y seguridad de la cuenta](/clawhub/moderation) para reportes, retenciones de moderación,
fichas ocultas, vetos y situación de la cuenta.
