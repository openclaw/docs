...
read_when:
    ...
    - Decidir si una skill debe ocultarse o un usuario debe ser bloqueado
...
confianza de ClawHub. Para estados de moderación y reputación de la cuenta, consulta
...
| Seguridad defensiva, moderación y revisión de abuso | La herramienta se presenta para revisión autorizada, preserva la evidencia y mantiene claros los límites de aprobación humana.       |
...
| Abuso de plataforma y evasión de prohibiciones              | Cuentas encubiertas después de prohibiciones, calentamiento o cultivo de cuentas, interacción falsa, automatización multi-cuenta, publicación masiva, bots de spam o automatización creada para evitar la detección.                                                                                       |
...
| Enriquecimiento invasivo de la privacidad o vigilancia      | Extracción de contactos para spam, doxxing, acoso, extracción de leads combinada con contacto no solicitado, monitoreo encubierto, coincidencia biométrica no consensuada o uso de datos filtrados o volcados de brechas.                                                                                  |
...
| Contenido sexual explícito o generación para adultos con seguridad deshabilitada | Generación de imágenes, videos o contenido NSFW; envoltorios de contenido adulto alrededor de API de terceros; o listados cuyo propósito principal sea contenido sexual explícito.                                                                                                                          |
| Requisitos de ejecución ocultos, inseguros o engañosos      | Comandos de instalación ofuscados, instaladores pipe-to-shell como contenido descargado ejecutado con `sh` o `bash` sin revisión clara, requisitos de secretos o claves privadas no declarados, ejecución remota de `npx @latest` sin revisión clara, o metadatos que ocultan lo que el listado realmente necesita para ejecutarse. |
...
listados ocultos, prohibiciones y reputación de la cuenta.
