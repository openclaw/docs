...
- saturar superficies de búsqueda o categorías con Skills o plugins casi idénticos
...
[Solicitudes de derechos de contenido](/clawhub/content-rights). No uses reportes normales de marketplace
para reclamos de derechos de autor o derechos salvo que la ficha también sea insegura,
...
- ocultar, retener, eliminar, eliminar de forma reversible o, cuando sea compatible con el tipo de recurso,
  eliminar de forma irreversible fichas infractoras
...
No garantizamos una aplicación con advertencia previa para abuso evidente. Consulta
