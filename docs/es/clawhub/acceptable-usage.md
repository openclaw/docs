...
summary: 'Política del marketplace: lo que permite ClawHub y lo que no alojará.'
title: Uso aceptable
x-i18n:
    generated_at: "2026-07-01T05:27:43Z"
    model: gpt-5.5
...
| ------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------- |
| Productividad del desarrollador                  | La ficha ayuda a los usuarios a crear, probar, migrar, depurar, documentar u operar software.                                    |
...
| Contenido sexual explícito o generación adulta con seguridad deshabilitada | Generación de imágenes, videos o contenido NSFW; envoltorios de contenido adulto alrededor de APIs de terceros; o fichas cuyo propósito principal sea contenido sexual explícito.                                                                                                                           |
