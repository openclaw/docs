...
title: Uso aceptable
x-i18n:
    generated_at: "2026-07-05T05:07:50Z"
    model: gpt-5.5
...
[Moderación y seguridad de la cuenta](/clawhub/moderation). Para reclamos de derechos de autor u otros derechos,
...
| Enriquecimiento o vigilancia invasivos de la privacidad                 | Extracción de contactos para spam, doxxing, acoso, extracción de clientes potenciales combinada con contacto no solicitado, monitoreo encubierto, coincidencia biométrica no consentida o uso de datos filtrados o volcados de brechas.                                                                                                                  |
| Suplantación o manipulación de identidad no consentida       | Intercambio de rostros, gemelos digitales, influencers clonados, personas falsas u otras herramientas usadas para suplantar o engañar.                                                                                                                                                                                                 |
| Contenido sexual explícito o generación adulta con seguridad deshabilitada | Generación de imágenes, videos o contenido NSFW; envoltorios de contenido adulto alrededor de API de terceros; o fichas cuyo propósito principal es contenido sexual explícito.                                                                                                                                                       |
...
| Material que infringe derechos de autor o vulnera derechos           | Republicar la Skill, el Plugin, la documentación, los activos de marca o el código propietario de otra persona sin permiso; violar términos de licencia; o suplantar al autor o publicador original.                                                                                                                            |
...
para reclamos de derechos de autor o de derechos, salvo que la ficha también sea insegura,
...
No garantizamos aplicar primero una advertencia ante abusos evidentes. Consulta
