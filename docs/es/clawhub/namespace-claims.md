...
summary: Cómo solicitar una revisión de ClawHub para disputas sobre la propiedad de organización, marca, identificador de propietario, alcance de paquete, slug de skill o espacio de nombres.
title: Reclamaciones de organización y espacio de nombres
x-i18n:
    generated_at: "2026-06-27T10:53:50Z"
    model: gpt-5.5
...
o cambiarse de otro modo debido a titularidad en el mundo real.
...
- un slug de Skill o nombre de paquete de Plugin que parezca suplantar a un proyecto
- una marca, marca comercial, cambio de nombre de proyecto o disputa de historial de paquetes
...
- historial de organización, repositorio, versión o mantenedor de GitHub
...
- evidencia de titularidad de marca comercial, marca o proyecto que sea seguro discutir
  públicamente
