...
summary: Cómo solicitar una revisión de ClawHub para disputas de propiedad de organización, marca, identificador del propietario, ámbito de paquete, slug de Skill o espacio de nombres.
...
espacio de nombres debe reservarse, transferirse, renombrarse, ocultarse, ponerse en cuarentena, aliasarse
o cambiarse de otro modo debido a una propiedad del mundo real.
...
- una disputa sobre una marca, marca registrada, renombrado de proyecto o historial de paquetes
...
es para revisiones de propiedad, no para divulgación urgente de vulnerabilidades.
...
- evidencia de marca registrada, marca o propiedad del proyecto que sea seguro discutir
  públicamente
- historial del repositorio fuente, historial del paquete o avisos públicos de renombrado
