...
x-i18n:
    generated_at: "2026-06-28T05:07:29Z"
    model: gpt-5.5
...
Usa esta vía para la revisión pública y no sensible de la propiedad. No uses informes
...
o cambiarse de otro modo por motivos de propiedad en el mundo real.
...
Usa pruebas públicas y no sensibles. Entre las pruebas útiles se incluyen:
...
- pruebas de marca registrada, marca o propiedad del proyecto que sean seguras para tratarse
  públicamente
- historial del repositorio fuente, historial del paquete o avisos públicos de cambio de nombre
- enlaces al propietario, Skill, Plugin, paquete o incidencia de ClawHub disputados
