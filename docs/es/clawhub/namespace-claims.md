...
x-i18n:
    generated_at: "2026-07-03T13:15:48Z"
    model: gpt-5.5
...
o cambiarse de algún otro modo debido a la propiedad en el mundo real.
...
- historial de organización, repositorio, release o mantenedor en GitHub
...
- evidencia de marca registrada, marca o propiedad del proyecto que sea seguro comentar
  públicamente
