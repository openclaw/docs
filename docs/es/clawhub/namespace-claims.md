...
summary: Cómo solicitar una revisión de ClawHub para disputas de titularidad de organización, marca, identificador del propietario, alcance de paquete, slug de skill o espacio de nombres.
...
espacio de nombres debe reservarse, transferirse, renombrarse, ocultarse, ponerse en cuarentena, tener un alias
o modificarse de otra manera debido a la propiedad en el mundo real.
...
- un slug de Skills o un nombre de paquete de Plugin que parece suplantar a un proyecto
...
sigue también las directrices de moderación o seguridad correspondientes. El formulario de reclamación de espacio de nombres
...
- historial de organización, repositorio, lanzamiento o mantenedores de GitHub
...
- pruebas de propiedad de marca registrada, marca o proyecto que sea seguro debatir
  públicamente
