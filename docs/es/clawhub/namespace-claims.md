...
# Reclamaciones de organización y espacios de nombres
...
Usa esta vía para revisiones públicas y no sensibles de propiedad. No uses los informes
dentro del producto ni el formulario de apelación de cuentas para reclamaciones de espacios de nombres.
...
o modificarse de otra forma por motivos de propiedad en el mundo real.
...
sigue también las directrices de moderación o seguridad correspondientes. El formulario de reclamación de
espacio de nombres es para revisión de propiedad, no para la divulgación urgente de vulnerabilidades.
...
Usa pruebas públicas y no sensibles. Algunas pruebas útiles son:

- historial de organización, repositorio, versión o mantenedores de GitHub
- documentación oficial del proyecto que mencione el espacio de nombres
- pruebas de dominio o de dominio de correo electrónico oficial
- control de ámbito en npm, PyPI, crates.io u otro registro de paquetes
- pruebas de marca registrada, marca o propiedad del proyecto que sea seguro comentar
  públicamente
...
El formulario de reclamación pregunta si las pruebas sensibles necesitan un canal privado con el personal.
...
El personal sopesa las pruebas públicas, el uso existente, el riesgo de seguridad y el impacto en los usuarios.
