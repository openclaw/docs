...
informes dentro del producto ni el formulario de apelación de cuenta para reclamos de espacios de nombres.

## Cuándo abrir un reclamo

Abre un reclamo de espacio de nombres cuando creas que el personal de ClawHub debe revisar si un
...
- una disputa de marca, marca comercial, cambio de nombre de proyecto o historial de paquetes
...
sigue también la guía de moderación o seguridad pertinente. El formulario de reclamo de espacio de nombres
...
renombrando, transfiriendo, ocultando o eliminando el recurso afectado. Usa un reclamo
...
- evidencia de propiedad de marca comercial, marca o proyecto que sea seguro discutir
  públicamente
...
El formulario de reclamo pregunta si la evidencia sensible necesita un canal privado con el personal.
