...
summary: Cómo solicitar una revisión de ClawHub para disputas de titularidad sobre organización, marca, identificador del propietario, ámbito de paquete, slug de habilidad o espacio de nombres.
title: Reclamaciones de organización y espacio de nombres
x-i18n:
    generated_at: "2026-06-30T13:46:31Z"
    model: gpt-5.5
...
reclamado, reservado, es engañoso o está en disputa en ClawHub, solicita al personal que lo revise
con el
...
- historial de organización de GitHub, repositorio, lanzamiento o mantenedores
...
- evidencia de marca registrada, marca o propiedad del proyecto que sea seguro tratar
  públicamente
...
La revisión del espacio de nombres no garantiza que todos los nombres coincidentes se transfieran.
