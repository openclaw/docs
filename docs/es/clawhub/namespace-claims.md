...
summary: Cómo solicitar la revisión de ClawHub para disputas de propiedad de organización, marca, identificador de propietario, ámbito de paquete, slug de habilidad o espacio de nombres.
title: Reivindicaciones de organización y espacio de nombres
x-i18n:
    generated_at: "2026-06-28T05:16:08Z"
    model: gpt-5.5
...
Usa esta vía para revisiones públicas y no sensibles de titularidad. No uses informes dentro del producto
...
o modificarse de otra manera debido a una titularidad del mundo real.
...
- una marca, marca comercial, cambio de nombre de proyecto o disputa sobre el historial de un paquete
...
- historial de organización de GitHub, repositorio, versión o mantenedores
...
- evidencia de titularidad de marca comercial, marca o proyecto que sea seguro comentar
  públicamente
