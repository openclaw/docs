...
summary: Cómo solicitar una revisión de ClawHub para disputas sobre propiedad de organización, marca, identificador del propietario, ámbito de paquete, slug de Skills o espacio de nombres.
title: Reclamaciones de organización y espacio de nombres
x-i18n:
    generated_at: "2026-07-06T10:47:42Z"
    model: gpt-5.5
...
- una disputa sobre marca, marca registrada, renombre de proyecto o historial de paquetes
...
- evidencia de propiedad de marca registrada, marca o proyecto que sea segura de discutir
  públicamente
- historial del repositorio fuente, historial de paquetes o avisos públicos de renombre
