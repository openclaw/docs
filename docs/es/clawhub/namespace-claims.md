...
x-i18n:
    generated_at: "2026-06-30T22:05:42Z"
    model: gpt-5.5
...
Usa esta vía para revisiones públicas y no sensibles de titularidad. No uses los
...
o modificarse de otro modo por motivos de titularidad en el mundo real.
...
sigue también la guía de moderación o seguridad correspondiente. El formulario de reclamación de
espacio de nombres es para revisiones de titularidad, no para divulgación urgente de vulnerabilidades.
...
- historial de organización, repositorio, versiones o mantenedores en GitHub
...
- pruebas de titularidad de marca registrada, marca o proyecto que sea seguro debatir
  públicamente
...
La revisión de espacios de nombres no garantiza que se transfiera cada nombre coincidente.
El personal pondera las pruebas públicas, el uso existente, el riesgo de seguridad y el impacto en los usuarios.
