...
x-i18n:
    generated_at: "2026-07-04T10:26:47Z"
    model: gpt-5.5
...
ClawHub usa identificadores de propietario, identificadores de organización, slugs de skill, nombres de paquetes de Plugin y
...
Usa esta vía para revisiones de propiedad públicas y no sensibles. No uses los informes
