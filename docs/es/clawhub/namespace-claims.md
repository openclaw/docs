...
x-i18n:
    generated_at: "2026-07-01T20:11:08Z"
    model: gpt-5.5
...
proyecto real, una marca, un ecosistema de paquetes o una organización, pero ya está
...
Usa esta vía para revisiones de propiedad públicas y no confidenciales. No uses los informes
...
- una marca, marca registrada, cambio de nombre de proyecto o disputa de historial de paquetes
...
Si puedes gestionar el propietario actual, corrige directamente el espacio de nombres publicando,
...
- organización, repositorio, versión o historial de mantenimiento en GitHub
...
- evidencia de propiedad de marca registrada, marca o proyecto que sea segura para debatir
  públicamente
