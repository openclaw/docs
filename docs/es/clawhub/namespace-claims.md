...
o modificarse de otro modo debido a una titularidad del mundo real.
...
- evidencia de titularidad de marca registrada, marca o proyecto que sea segura para discutir
  públicamente
...
transferir la titularidad, renombrar un recurso, ocultar o poner en cuarentena una publicación existente,
