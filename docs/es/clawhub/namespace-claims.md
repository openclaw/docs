...
summary: Cómo solicitar la revisión de ClawHub para disputas de propiedad de organización, marca, identificador del propietario, ámbito de paquete, slug de Skill o espacio de nombres.
title: Reclamaciones de organización y espacio de nombres
x-i18n:
    generated_at: "2026-07-02T07:55:17Z"
    model: gpt-5.5
...
- una disputa sobre una marca, marca comercial, cambio de nombre de proyecto o historial de paquetes
...
- evidencia de marca comercial, marca o propiedad de proyecto que sea segura de discutir
  públicamente
