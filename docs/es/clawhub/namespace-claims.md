...
x-i18n:
    generated_at: "2026-07-04T17:48:13Z"
    model: gpt-5.5
...
ClawHub utiliza identificadores de propietario, identificadores de organización, slugs de Skills, nombres de paquetes de Plugin y
...
con el
[formulario de incidencia Reclamación de organización / espacio de nombres](https://github.com/openclaw/clawhub/issues/new?template=org-namespace-claim.yml).
...
o modificarse de otro modo debido a una propiedad del mundo real.
...
- una disputa sobre marca, marca comercial, cambio de nombre de proyecto o historial de paquete
...
sigue también las pautas de moderación o seguridad correspondientes. El formulario de reclamación de espacio de nombres
es para revisiones de propiedad, no para divulgaciones urgentes de vulnerabilidades.
...
- evidencia de marca comercial, marca o propiedad del proyecto que sea segura para discutir
  públicamente
