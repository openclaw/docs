---
read_when:
    - ClawHub CLI o los comandos del registro de OpenClaw fallan
...
- Asegúrate de haber iniciado sesión con la cuenta de GitHub que posee o puede publicar
  el paquete.
- Verifica que la URL de origen sea pública o accesible para ClawHub.
...
Si una publicación falla porque el identificador del propietario, el espacio de nombres de la organización, el ámbito del paquete, el slug del Skill
...
[Reclamaciones de organizaciones y espacios de nombres](/es/clawhub/namespace-claims) para obtener orientación sobre las pruebas y qué
