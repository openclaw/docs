...
Si muchos usuarios comparten una IP de salida, pueden alcanzarse los límites de IP anónima incluso cuando cada
...
Los diagnósticos visibles para el propietario pueden explicar el estado de análisis, bloqueo de subida o moderación.
