...
Para plugins, revisa los metadatos de compatibilidad de `package.json`. Las publicaciones de Plugin de código
...
[Reclamaciones de organización y espacio de nombres](/clawhub/namespace-claims) para obtener orientación sobre pruebas y qué
