...
- Revisa el firewall local, la VPN y las reglas de proxy si el callback nunca llega.
...
Para plugins, revisa los metadatos de compatibilidad en `package.json`. Las publicaciones de
...
slug de la Skill o el nombre del paquete ya está reclamado o reservado, primero confirma que estás
