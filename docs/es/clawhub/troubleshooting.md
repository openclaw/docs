...
x-i18n:
    generated_at: "2026-07-02T07:55:24Z"
    model: gpt-5.5
...
ClawHub usa la identidad de GitHub y la atribución del origen para conectar los paquetes con sus
publicadores.
...
- Mantén las ediciones locales y omite la actualización.
...
- Envía a los usuarios de vuelta al listado canónico de ClawHub.
