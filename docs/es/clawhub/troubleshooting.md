...
x-i18n:
    generated_at: "2026-07-01T18:07:03Z"
    model: gpt-5.5
...
Si una publicación falla porque el identificador del propietario, el namespace de la organización, el alcance del paquete, el slug de la Skill
o el nombre del paquete ya está reclamado o reservado, confirma primero que estás
