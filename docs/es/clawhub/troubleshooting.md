...
Para plugins, revisa los metadatos de compatibilidad en `package.json`. Las publicaciones de code-plugin
...
slug de la habilidad o el nombre del paquete ya está reclamado o reservado, primero confirma que estés
...
[Reclamaciones de organizaciones y espacios de nombres](/clawhub/namespace-claims) para obtener orientación sobre evidencias y sobre qué
