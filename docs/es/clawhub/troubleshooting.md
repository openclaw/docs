...
x-i18n:
    generated_at: "2026-06-28T05:08:06Z"
    model: gpt-5.5
...
Los diagnósticos visibles para el propietario pueden explicar el estado de análisis, puerta de subida o moderación.
...
no puedes gestionar el propietario actual de ClawHub, abre una
...
[Reclamaciones de organizaciones y espacios de nombres](/es/clawhub/namespace-claims) para obtener orientación sobre pruebas y qué
