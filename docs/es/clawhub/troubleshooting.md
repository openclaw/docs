...
Si una publicación falla porque el identificador del propietario, el namespace de la organización, el alcance del paquete, el slug del skill
...
[Reclamaciones de organización y namespace](/clawhub/namespace-claims) para obtener orientación sobre las pruebas y qué
