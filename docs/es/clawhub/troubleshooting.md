...
x-i18n:
    generated_at: "2026-07-05T01:55:01Z"
    model: gpt-5.5
...
La CLI inicia un servidor de callback local de corta duración durante el inicio de sesión en el navegador.
...
Si muchos usuarios comparten una sola IP de salida, se pueden alcanzar los límites de IP anónima incluso cuando cada
...
herramientas requeridas deben declararse para que los usuarios y escáneres puedan entender el paquete.

Para Plugins, revisa los metadatos de compatibilidad en `package.json`. Las publicaciones de Plugins de código
...
Si una publicación falla porque el handle del propietario, el namespace de la organización, el alcance del paquete, el slug del Skill
...
[Reclamaciones de organización y namespace](/clawhub/namespace-claims) para obtener orientación sobre pruebas y qué
...
Previsualiza primero si no tienes certeza de qué se publicará:
