---
read_when:
    - Fallan los comandos de CLI de ClawHub o del registro de OpenClaw
...
Si una publicación falla porque el identificador de propietario, el namespace de la organización, el ámbito del paquete, el slug de la Skill
...
[Reclamaciones de organización y namespace](/clawhub/namespace-claims) para obtener orientación sobre la evidencia y qué
...
- Remite a los usuarios de vuelta al listado canónico de ClawHub.
