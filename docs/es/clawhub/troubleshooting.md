---
read_when:
    - Fallan los comandos de ClawHub CLI o del registro de OpenClaw
...
- Revisa las reglas locales de firewall, VPN y proxy si el callback nunca llega.
...
Si muchos usuarios comparten una IP de salida, los límites de IP anónima pueden alcanzarse incluso cuando cada
...
Para habilidades, revisa el frontmatter de `SKILL.md`. Las variables de entorno y
...
Previsualiza primero el payload de publicación:
...
Si una publicación falla porque el identificador de propietario, el espacio de nombres de la organización, el ámbito del paquete, el
slug de habilidad o el nombre del paquete ya está reclamado o reservado, primero confirma que estás
...
[Reclamaciones de organizaciones y espacios de nombres](/clawhub/namespace-claims) para obtener orientación sobre evidencias y qué
