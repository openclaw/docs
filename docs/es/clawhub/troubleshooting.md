...
x-i18n:
    generated_at: "2026-07-04T06:22:02Z"
    model: gpt-5.5
...
- `RateLimit-Reset` o `X-RateLimit-Reset`: hora de restablecimiento.
...
[Reclamaciones de organizaciones y espacios de nombres](/clawhub/namespace-claims) para ver orientación sobre pruebas y qué
