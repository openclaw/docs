...
x-i18n:
    generated_at: "2026-07-03T13:16:06Z"
    model: gpt-5.5
...
- `Retry-After`: segundos que esperar antes de reintentar.
...
o el nombre del paquete ya están reclamados o reservados, primero confirma que estás
...
- Revisa la página de detalles del paquete para conocer el estado de escaneo y los metadatos de compatibilidad.
