...
x-i18n:
    generated_at: "2026-07-12T21:22:38Z"
    model: gpt-5.6
...
cuando inicie sesión, publique, administre sus propios listados o utilice
...
En los repositorios que contienen varias Skills, el flujo de trabajo reutilizable de GitHub ejecuta
...
Use primero `--dry-run` para previsualizar los metadatos resueltos del paquete, los campos de
...
los metadatos, los enlaces al código fuente, las versiones, los registros de cambios y el estado del análisis:
...
moderación pueden permanecer ocultas en las superficies de búsqueda e instalación hasta que se resuelva la situación.
