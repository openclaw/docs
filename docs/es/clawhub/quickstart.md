...
x-i18n:
    generated_at: "2026-07-05T17:40:31Z"
    model: gpt-5.5
...
los campos de compatibilidad, la atribución de la fuente y el plan de carga sin publicar.
...
Los listados públicos muestran el estado más reciente del análisis. Las versiones que estén retenidas o bloqueadas por
