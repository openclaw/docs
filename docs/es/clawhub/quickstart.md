...
Usa primero `--dry-run` para previsualizar los metadatos del paquete resuelto, los campos de compatibilidad,
...
`sync` analiza las carpetas de Skills y publica Skills nuevas o modificadas que aún no están
sincronizadas.
