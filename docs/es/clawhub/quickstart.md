...
`sync` analiza las carpetas de Skills y publica Skills nuevas o modificadas que no están
ya sincronizadas.
...
Cuando hayas iniciado sesión, `sync` también puede enviar una instantánea mínima de instalación para
