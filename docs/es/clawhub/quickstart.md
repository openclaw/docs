...
x-i18n:
    generated_at: "2026-07-16T11:30:01Z"
    model: gpt-5.6
...
Antes de publicar, revise los metadatos de `SKILL.md`. Declare las
...
Para los repositorios que contienen varias Skills, el flujo de trabajo reutilizable de GitHub invoca
...
moderación pueden permanecer ocultas en las interfaces de búsqueda e instalación hasta que se resuelvan.
