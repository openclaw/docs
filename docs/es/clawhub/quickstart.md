...
x-i18n:
    generated_at: "2026-07-03T17:13:17Z"
    model: gpt-5.5
...
Usa primero `--dry-run` para previsualizar los metadatos resueltos del paquete, los campos de
...
Los listados públicos muestran el estado más reciente del escaneo. Las versiones retenidas o bloqueadas por
