...
Usa primero `--dry-run` para previsualizar los metadatos resueltos del paquete, los campos de compatibilidad, la atribución de origen y el plan de carga sin publicar.
