...
x-i18n:
    generated_at: "2026-07-05T04:49:07Z"
    model: gpt-5.5
...
Usa OpenClaw cuando estés instalando elementos en OpenClaw. Usa la CLI `clawhub`
cuando estés iniciando sesión, publicando, administrando tus propios listados o usando
...
entorno, las herramientas y los permisos necesarios para que los usuarios puedan entender qué
...
Usa `--dry-run` primero para previsualizar los metadatos del paquete resueltos, los campos de
