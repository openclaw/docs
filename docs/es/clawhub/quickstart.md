...
`sync` escanea carpetas de Skills y publica Skills nuevas o modificadas que aún no están
sincronizadas.
...
conteos agregados de instalaciones. Consulta [Telemetría](/es/clawhub/telemetry) para ver qué se informa
y cómo excluirte.
