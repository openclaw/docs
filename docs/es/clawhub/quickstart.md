...
x-i18n:
    generated_at: "2026-07-03T23:26:00Z"
    model: gpt-5.5
...
Actualizar las skills instaladas:
...
El comando omite el contenido sin cambios. Las nuevas skills comienzan en `1.0.0`; los cambios posteriores
...
entorno, herramientas y permisos requeridos para que los usuarios puedan entender qué necesita la
...
Usa primero `--dry-run` para previsualizar los metadatos del paquete resueltos, los campos de compatibilidad, la atribución de origen y el plan de carga sin publicar.
