...
Usa el prefijo `clawhub:` cuando quieras que OpenClaw resuelva el paquete mediante
...
Antes de publicar, comprueba los metadatos en `SKILL.md`. Declara las
variables de entorno, herramientas y permisos requeridos para que los usuarios
puedan entender qué necesita la skill antes de instalarla. Consulta [Formato de skill](/es/clawhub/skill-format).
