...
x-i18n:
    generated_at: "2026-06-28T00:11:42Z"
    model: gpt-5.5
...
OpenClaw registra de dónde procede la skill para que las actualizaciones
...
entorno, herramientas y permisos necesarios para que los usuarios puedan entender
...
Usa primero `--dry-run` para previsualizar los metadatos del paquete resueltos,
...
retenidas o bloqueadas por moderación pueden estar ocultas de las superficies de
