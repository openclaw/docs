...
qué necesita el skill antes de instalarlo. Consulta [Formato de skill](/es/clawhub/skill-format).
...
## Sincronizar los skills que mantienes

`sync` examina las carpetas de skills y publica skills nuevos o modificados que
aún no estén sincronizados.
...
CLI para inspeccionar metadatos, enlaces de origen, versiones, registros de cambios
