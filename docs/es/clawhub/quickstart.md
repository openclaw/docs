...
read_when:
    ...
    - Instalación de una Skill o un Plugin desde el registro
    - Publicar en ClawHub
...
Una skill es una carpeta con un archivo obligatorio `SKILL.md` y archivos de apoyo
opcionales.
...
`sync` escanea carpetas de Skills y publica Skills nuevas o modificadas que no estén
ya sincronizadas.
