...
Usa `--dry-run` para obtener una vista previa o `--version` para elegir una
versión explícita.
...
Usa primero `--dry-run` para obtener una vista previa de los metadatos del paquete resuelto, los
