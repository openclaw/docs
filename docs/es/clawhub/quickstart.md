...
x-i18n:
    generated_at: "2026-07-04T15:07:32Z"
    model: gpt-5.5
...
Antes de publicar, comprueba los metadatos en `SKILL.md`. Declara las variables de entorno,
...
`skill publish` para cada carpeta inmediata de skills bajo `skills/`:
