...
x-i18n:
    generated_at: "2026-07-02T17:30:35Z"
    model: gpt-5.5
...
OpenClaw registra de dónde vino el skill para que las actualizaciones posteriores puedan seguir
...
herramientas y permisos requeridos para que los usuarios puedan entender qué necesita el
