...
La página del listado es el lugar canónico donde los usuarios pueden inspeccionar qué afirma hacer una skill o
...
información de compatibilidad, enlaces de fuente, artefactos y registros de versión.
...
versión mínima del Gateway, objetivos de host, requisitos de entorno y resúmenes de artefactos.
...
descargas. Los catálogos de terceros pueden usar estas API cuando enlazan al listado canónico
de ClawHub, respetan los límites de frecuencia y evitan insinuar respaldo.
