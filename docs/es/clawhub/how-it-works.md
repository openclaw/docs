...
x-i18n:
    generated_at: "2026-05-12T23:28:43Z"
    model: gpt-5.5
    provider: openai
...
descargas. Los catálogos de terceros pueden usar estas API cuando enlazan al listado canónico de ClawHub,
respetan los límites de tasa y evitan dar a entender respaldo.
