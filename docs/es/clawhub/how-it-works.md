...
summary: Cómo funcionan las fichas, versiones, instalaciones, publicación, análisis y actualizaciones de ClawHub.
x-i18n:
...
ClawHub es la capa de registro para Skills y plugins de OpenClaw. Proporciona a los usuarios un
...
- changelog e información de etiquetas como `latest`
...
importan porque ayudan a los usuarios a decidir si instalan la skill y
...
Usa ejecuciones de prueba para previsualizar la carga útil resuelta antes de la subida. Las páginas públicas luego
...
ClawHub está abierto a la publicación, pero las versiones siguen estando sujetas a puertas de subida,
