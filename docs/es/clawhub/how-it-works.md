...
summary: Cómo funcionan los listados, versiones, instalaciones, publicación, análisis y actualizaciones de ClawHub.
x-i18n:
    generated_at: "2026-06-30T22:04:40Z"
    model: gpt-5.5
...
lugar para descubrir paquetes, a los editores un lugar para publicar versiones, y
...
ClawHub está abierto a la publicación, pero las versiones siguen sujetas a puertas de subida,
...
descargas. Los catálogos de terceros pueden usar estas API cuando enlazan al listado
canónico de ClawHub, respetan los límites de tasa y evitan insinuar respaldo.
