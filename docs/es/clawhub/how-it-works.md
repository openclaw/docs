...
summary: Cómo funcionan los listados, versiones, instalaciones, publicaciones, análisis y actualizaciones de ClawHub.
x-i18n:
...
ClawHub es la capa de registro para las habilidades y los plugins de OpenClaw. Ofrece a los usuarios un
...
La página del listado es el lugar canónico para que los usuarios inspeccionen lo que una habilidad o
...
la descripción, los requisitos, las variables de entorno y los metadatos de la habilidad. Los metadatos precisos
son importantes porque ayudan a los usuarios a decidir si instalar la habilidad y
...
Usa ejecuciones en seco para previsualizar la carga útil resuelta antes de subirla. Después, las páginas públicas
...
actualización de habilidades para usuarios que quieran carpetas de habilidades gestionadas por el registro fuera de un
...
o bloqueado puede desaparecer de los flujos públicos de búsqueda e instalación mientras permanece
...
listado canónico de ClawHub, respetan los límites de tasa y evitan dar a entender respaldo.
