...
x-i18n:
    generated_at: "2026-07-03T23:25:34Z"
    model: gpt-5.5
...
actualización directa de Skills para usuarios que quieren carpetas de Skills gestionadas por el registro fuera de un
espacio de trabajo completo de OpenClaw.

## Estado de seguridad

ClawHub está abierto a publicaciones, pero los lanzamientos siguen sujetos a barreras de subida,
