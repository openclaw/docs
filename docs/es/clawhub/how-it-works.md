...
ClawHub lee el frontmatter de `SKILL.md` para comprender el nombre de la habilidad,
...
Las páginas públicas muestran resúmenes de análisis cuando están disponibles. El contenido que esté retenido, oculto
...
listado canónico de ClawHub, respeten los límites de frecuencia y eviten sugerir respaldo.
