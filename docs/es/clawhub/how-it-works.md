...
lugar para descubrir paquetes, a los publicadores un lugar para lanzar versiones, y a
OpenClaw los metadatos suficientes para instalar y actualizar esos paquetes de forma segura.
...
versión mínima de Gateway, objetivos de host, requisitos de entorno y resúmenes de artefactos.
...
Usa ejecuciones en seco para previsualizar la carga resuelta antes de subirla. Luego, las páginas públicas
...
ClawHub está abierto a publicaciones, pero los lanzamientos siguen sujetos a compuertas de subida,
