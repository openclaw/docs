...
- señales de descarga, instalación, estrellas y comentarios
- estado de escaneo de seguridad y moderación

La página del listado es el lugar canónico donde los usuarios pueden inspeccionar lo que una Skill o
...
la descripción, los requisitos, las variables de entorno y los metadatos. Los metadatos
precisos importan porque ayudan a los usuarios a decidir si instalar la Skill y
...
Usa ejecuciones de prueba para previsualizar la carga útil resuelta antes de subirla. Después, las páginas públicas
...
descargas. Los catálogos de terceros pueden usar estas API cuando enlacen al listado canónico
de ClawHub, respeten los límites de frecuencia y eviten insinuar respaldo.
