...
x-i18n:
    generated_at: "2026-07-03T09:21:32Z"
    model: gpt-5.5
...
ClawHub está abierto a publicaciones, pero las versiones siguen sujetas a controles de subida,
...
o bloqueado puede desaparecer de los flujos de búsqueda e instalación públicos mientras permanece
...
descargas. Los catálogos de terceros pueden usar estas APIs cuando enlazan al listado
canónico de ClawHub, respetan los límites de frecuencia y evitan insinuar respaldo.
