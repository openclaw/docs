...
x-i18n:
    generated_at: "2026-07-02T13:57:18Z"
    model: gpt-5.5
...
La página de la ficha es el lugar canónico para que los usuarios inspeccionen qué afirma hacer una skill o
...
OpenClaw registra metadatos del origen de instalación para que las actualizaciones puedan resolver el mismo
...
descargas. Los catálogos de terceros pueden usar estas API cuando enlazan a la
ficha canónica de ClawHub, respetan los límites de frecuencia y evitan insinuar respaldo.
