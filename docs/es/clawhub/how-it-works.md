...
x-i18n:
    generated_at: "2026-07-05T05:11:43Z"
    model: gpt-5.5
...
Consulta [Formato de Skill](/clawhub/skill-format).
...
paquete del registro más adelante. La CLI de ClawHub también admite flujos de trabajo de instalación y
actualización directas de skills para usuarios que quieren carpetas de skills gestionadas por el registro fuera de un
...
Consulta [Seguridad](/es/clawhub/security), [Auditorías de seguridad](/clawhub/security-audits),
