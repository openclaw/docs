...
x-i18n:
    generated_at: "2026-07-05T11:07:51Z"
    model: gpt-5.5
...
Los plugins son extensiones de OpenClaw empaquetadas. ClawHub almacena metadatos de paquete,
...
versión mínima del Gateway, destinos de host, requisitos de entorno y resúmenes criptográficos de artefactos.
...
ClawHub está abierto a la publicación, pero las versiones siguen sujetas a compuertas de subida,
