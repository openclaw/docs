...
summary: Cómo funcionan los listados, versiones, instalaciones, publicación, escaneos y actualizaciones de ClawHub.
x-i18n:
    generated_at: "2026-05-13T02:50:55Z"
    model: gpt-5.5
    provider: openai
...
Usa ejecuciones de prueba para previsualizar la carga útil resuelta antes de la carga. Las páginas públicas luego
...
o bloqueado puede desaparecer de la búsqueda pública y los flujos de instalación, mientras sigue siendo
visible para el propietario para diagnóstico.
...
descargas. Los catálogos de terceros pueden usar estas API cuando enlazan al listado canónico de
ClawHub, respetan los límites de frecuencia y evitan insinuar respaldo.
