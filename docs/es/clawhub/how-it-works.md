...
x-i18n:
    generated_at: "2026-07-04T20:23:31Z"
    model: gpt-5.5
...
lugar para descubrir paquetes, a los editores un lugar para publicar versiones y a
OpenClaw metadatos suficientes para instalar y actualizar esos paquetes de forma segura.
...
La página del listado es el lugar canónico para que los usuarios inspeccionen lo que un Skill o
...
ClawHub lee el frontmatter de `SKILL.md` para comprender el nombre del Skill,
la descripción, los requisitos, las variables de entorno y los metadatos. Los
metadatos precisos importan porque ayudan a los usuarios a decidir si instalar el Skill y
ayudan a los escaneos automatizados a detectar discrepancias entre el comportamiento declarado y observado.
...
La publicación crea un nuevo registro de versión inmutable. Los editores usan la CLI `clawhub`
...
Usa ejecuciones de prueba para previsualizar la carga útil resuelta antes de subirla. Las páginas públicas después
muestran los metadatos publicados, archivos, atribución de origen y estado de escaneo.
...
paquete del registro más tarde. La CLI de ClawHub también admite flujos de trabajo directos de instalación y
...
ClawHub está abierto a la publicación, pero las versiones siguen sujetas a barreras de subida,
