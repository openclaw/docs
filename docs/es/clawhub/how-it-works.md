...
x-i18n:
    generated_at: "2026-07-04T17:47:45Z"
    model: gpt-5.5
...
Consulta [Formato de skills](/es/clawhub/skill-format).
...
Usa simulaciones para previsualizar la carga útil resuelta antes de subirla. Luego, las páginas públicas
...
Las páginas públicas muestran resúmenes de escaneos cuando están disponibles. El contenido retenido, oculto
o bloqueado puede desaparecer de los flujos de búsqueda pública e instalación mientras sigue siendo
