...
x-i18n:
    generated_at: "2026-05-11T22:19:14Z"
    model: gpt-5.5
    provider: openai
...
La página de la ficha es el lugar canónico para que los usuarios inspeccionen lo que una skill o
...
Los plugins son extensiones de OpenClaw empaquetadas. ClawHub almacena metadatos de paquetes,
...
descargas. Los catálogos de terceros pueden usar estas API cuando enlazan a la ficha canónica de
ClawHub, respetan los límites de tasa y evitan sugerir respaldo.
