...
read_when:
    ...
    - Decidir si instalar una skill o Plugin
...
x-i18n:
    generated_at: "2026-07-02T17:31:03Z"
    model: gpt-5.5
...
si algo merece atención adicional antes de poder acceder a archivos, cuentas,
...
| `Error`     | La auditoría no pudo completarse.                                         |
...
Un comportamiento poderoso no es automáticamente malo. Muchas herramientas útiles necesitan credenciales,
...
estándar de confianza del sector para reputación de archivos y análisis de malware, y nuestra
