...
summary: Cómo entender los resultados de auditoría de seguridad de ClawHub antes de instalar una skill o Plugin.
title: Auditorías de seguridad
x-i18n:
    generated_at: "2026-07-02T07:55:35Z"
    model: gpt-5.5
...
Las auditorías son señales de seguridad fuertes, pero no garantizan que una versión esté
...
Las páginas de artefacto enlazan a la auditoría completa en:
