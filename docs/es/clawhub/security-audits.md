...
summary: Cómo entender los resultados de la auditoría de seguridad de ClawHub antes de instalar un skill o Plugin.
...
El nivel de riesgo describe el radio de impacto: cuánta capacidad parece tener la versión si
la usas según lo previsto.

| Nivel de riesgo | Significado                                                                       |
| ---------- | ----------------------------------------------------------------------------- |
| `Low`      | Se encontró poca autoridad sensible o poco impacto para el usuario.                          |
| `Medium`   | La versión tiene autoridad significativa, como acceso a cuentas o cambios en datos. |
...
- El nivel de riesgo pregunta: "¿Cuánta capacidad hay aquí?"
...
comandos locales, API de proveedores o instalaciones de paquetes. La auditoría comprueba si esa
capacidad es esperada, divulgada y proporcional.
...
estándar de confianza de la industria para la reputación de archivos y el análisis de malware, y nuestra
...
El análisis de riesgos se ejecuta internamente con ClawScan, el sistema propio de auditoría de seguridad
