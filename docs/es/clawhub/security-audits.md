...
x-i18n:
    generated_at: "2026-07-02T22:22:03Z"
    model: gpt-5.5
...
Los hallazgos pueden etiquetarse como `Info`, `Low`, `Medium`, `High` o `Critical`. Los hallazgos de
mayor gravedad contribuyen con más fuerza al nivel de riesgo y al estado de la auditoría.
...
estándar de confianza en la industria para la reputación de archivos y el análisis de malware, y nuestra
...
señales de reputación que complementan la revisión de ClawHub consciente de los agentes. Cuando hay
...
VirusTotal sigue siendo telemetría. No sustituye el propio análisis de riesgo de ClawHub
