...
read_when:
    ...
    - Explicación del estado de auditoría, nivel de riesgo o hallazgos de ClawHub
...
Las auditorías de seguridad de ClawHub te ayudan a decidir si una Skill o Plugin es lo bastante seguro
...
señales de reputación que complementan la revisión de ClawHub consciente de agentes. Cuando están
disponibles los recuentos de motores de proveedores, la auditoría los resume en lenguaje claro, como:
...
la ejecución no segura, el envenenamiento de memoria o contexto y la autonomía excesiva.
