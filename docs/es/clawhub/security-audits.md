...
summary: Cómo entender los resultados de la auditoría de seguridad de ClawHub antes de instalar una skill o Plugin.
title: Auditorías de seguridad
x-i18n:
    generated_at: "2026-06-28T20:42:30Z"
    model: gpt-5.5
...
para instalarse. Muestran qué hace una versión, qué autoridad solicita y
...
poder es esperado, está comunicado y es proporcional.
...
estándar de confianza en la industria para la reputación de archivos y el escaneo de malware, y nuestra
...
señales de reputación que complementan la revisión de ClawHub con conocimiento de agentes. Cuando hay recuentos
de motores de proveedores disponibles, la auditoría los resume en lenguaje claro, como:
...
con conocimiento de artefactos.

## Análisis de riesgos

El análisis de riesgos funciona internamente con ClawScan, el sistema propio de auditoría de seguridad
de ClawHub. Revisa cada versión como un artefacto orientado a agentes: instrucciones,
metadatos, permisos declarados, archivos, señales de capacidad, señales de escaneo estático,
...
como lente para riesgos como la inyección de prompts, el uso indebido de herramientas, la exposición de credenciales,
la ejecución insegura, el envenenamiento de memoria o contexto y la agencia excesiva.

ClawScan no trata una capacidad de apariencia alarmante como automáticamente maliciosa.
Pregunta si la capacidad está comunicada, alineada con el propósito y respaldada por
