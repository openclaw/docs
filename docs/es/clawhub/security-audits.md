...
x-i18n:
    generated_at: "2026-07-04T15:07:39Z"
    model: gpt-5.5
...
Instala solo contenido que comprendas y en el que confíes.
...
| `Review`    | Lee los hallazgos antes de instalar. La versión puede seguir siendo legítima. |
...
El nivel de riesgo y el estado de auditoría responden a preguntas diferentes:
...
autoridad solicitada y el contenido real coinciden con lo que los usuarios esperarían razonablemente?
...
señales de reputación que complementan la revisión consciente de agentes de ClawHub. Cuando los recuentos de
...
El análisis de riesgo funciona internamente con ClawScan, el sistema propio de auditoría de seguridad de
...
sección de auditoría pública independiente ni un veredicto que bloquee la instalación.
