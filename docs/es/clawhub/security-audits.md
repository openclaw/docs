---
read_when:
    - Cómo entender los resultados de la auditoría de seguridad de ClawHub
...
| `Warn`      | Usa especial cautela. ClawHub encontró una preocupación de alto impacto o una señal de advertencia. |
...
| ---------- | ----------------------------------------------------------------------------- |
| `Low`      | Se encontró poca autoridad sensible o impacto en el usuario.                          |
...
estándar de confianza en la industria para reputación de archivos y escaneo de malware, y nuestra
