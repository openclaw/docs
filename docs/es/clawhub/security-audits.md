...
Las auditorías de seguridad de ClawHub te ayudan a decidir si una habilidad o un plugin es lo bastante seguro
para instalarlo. Muestran qué hace una versión, qué autoridad solicita y
si hay algo que merece atención adicional antes de que pueda acceder a archivos, cuentas,
...
| `Warn`      | Usa precaución adicional. ClawHub encontró una inquietud de alto impacto o una señal de advertencia. |
...
- qué significa
- por qué se marcó
- el contenido relevante de la habilidad o el plugin
- una recomendación
...
estándar de confianza del sector para reputación de archivos y escaneo de malware, y nuestra
asociación permite que ClawHub añada inteligencia de seguridad más amplia a la revisión de habilidades y plugins.

VirusTotal es especialmente útil para artefactos maliciosos conocidos, detecciones de motores y
señales de reputación que complementan la revisión de ClawHub con conocimiento de agentes. Cuando hay
recuentos de motores de proveedores disponibles, la auditoría los resume en lenguaje claro, por ejemplo:
...
sección pública de auditoría independiente ni un veredicto que bloquee la instalación.
...
ejecución insegura, envenenamiento de memoria o contexto y exceso de agencia.
