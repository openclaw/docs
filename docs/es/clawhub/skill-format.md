...
summary: Formato de la carpeta de Skill, archivos obligatorios, tipos de archivo permitidos, límites.
x-i18n:
...
- `.clawhubignore` (patrones de ignorado para publicación, heredado `.clawdhubignore`)
...
- El texto para incrustación incluye `SKILL.md` + hasta aproximadamente 40 archivos que no sean `.md` (límite de mejor esfuerzo).
