...
- `.clawhubignore` (patrones de omisión para publicar/sincronizar, heredado `.clawdhubignore`)
...
- No agregues términos de licencia en conflicto en `SKILL.md`; ClawHub no admite anulaciones de licencia por skill.
