...
- `SKILL.md` (o `skill.md`; el heredado `skills.md` también se acepta)
...
| `emoji`            | `string`   | Emoji que se muestra para el skill.                                                                                                          |
| `homepage`         | `string`   | URL de la página de inicio o documentación del skill.                                                                                        |
