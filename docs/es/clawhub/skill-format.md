...
- `.clawhubignore` (patrones de ignorar para publicación, heredado `.clawdhubignore`)
...
la cuenta de GitHub que inició sesión. No importa repositorios privados, forks,
