...
- `.clawhubignore` (patrones de ignorados para publicación, `.clawdhubignore` heredado)
...
archivos `SKILL.md` o `skills.md` heredados en repositorios públicos que no sean bifurcaciones y que pertenezcan a
...
- Los tipos de contenido que comienzan con `text/` se tratan como texto; además de una pequeña lista de permitidos (JSON/YAML/TOML/JS/TS/Markdown/SVG).
