---
read_when:
    - Informar sobre problemas de derechos de autor u otros derechos relacionados con contenido de ClawHub
...
x-i18n:
    generated_at: "2026-07-05T04:48:39Z"
    model: gpt-5.5
...
el publicador para obtener más información. Según las circunstancias, el contenido afectado
puede ocultarse, restaurarse o dejarse sin cambios.

Para contenido no seguro del marketplace que no sea un problema de derechos sobre contenido, usa el
