...
read_when:
    - Publicando almas
    - Depuración de fallos de soul publish
summary: Formato del paquete Soul, archivos obligatorios, límites.
x-i18n:
    generated_at: "2026-05-12T00:57:40Z"
    model: gpt-5.5
    provider: openai
...
- `description` se usa como resumen del soul en la interfaz/búsqueda.

## Límites

- Tamaño total del paquete: 50 MB.
- El texto de embeddings incluye solo `SOUL.md`.
