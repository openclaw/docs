...
<Steps>
  ...
  <Step title="Verifikasi model tersedia">
    ...
    Untuk memeriksa katalog statis Plugin tanpa memerlukan Gateway yang sedang berjalan,
    gunakan:
...
| ---------------------------- | ----------------- | ----- | --------- | ----------- | -------------------------------------------- |
| `deepseek/deepseek-v4-flash` | DeepSeek V4 Flash | teks  | 1,000,000 | 384,000     | Model default; permukaan V4 yang mendukung pemikiran |
| `deepseek/deepseek-v4-pro`   | DeepSeek V4 Pro   | teks  | 1,000,000 | 384,000     | Permukaan V4 yang mendukung pemikiran        |
| `deepseek/deepseek-chat`     | DeepSeek Chat     | teks  | 131,072   | 8,192       | Permukaan DeepSeek V3.2 tanpa pemikiran      |
| `deepseek/deepseek-reasoner` | DeepSeek Reasoner | teks  | 131,072   | 65,536      | Permukaan V3.2 dengan penalaran aktif        |

<Tip>
Model V4 mendukung kontrol `thinking` DeepSeek. OpenClaw juga memutar ulang
`reasoning_content` DeepSeek pada giliran lanjutan agar sesi pemikiran dengan
...
Sesi pemikiran DeepSeek V4 memiliki kontrak pemutaran ulang yang lebih ketat daripada sebagian besar
penyedia yang kompatibel dengan OpenAI: setelah giliran dengan pemikiran aktif menggunakan alat, DeepSeek
...
Jika Anda mengalihkan sesi yang sudah ada dari penyedia lain yang kompatibel dengan OpenAI ke
model DeepSeek V4, giliran panggilan alat asisten lama mungkin tidak memiliki
`reasoning_content` asli DeepSeek. OpenClaw mengisi kolom yang hilang itu pada pesan
asisten yang diputar ulang untuk permintaan pemikiran DeepSeek V4 sehingga penyedia dapat menerima
riwayat tanpa memerlukan `/new`.

Saat pemikiran dinonaktifkan di OpenClaw (termasuk pilihan UI **Tidak ada**),
...
dengan pemikiran nonaktif tetap berada di jalur DeepSeek tanpa pemikiran.
...
Suite model live langsung menyertakan DeepSeek V4 dalam set model modern. Untuk
...
Pemeriksaan live tersebut memverifikasi bahwa kedua model V4 dapat menyelesaikan tugas dan bahwa giliran lanjutan pemikiran/alat
mempertahankan payload pemutaran ulang yang diwajibkan DeepSeek.
