...
[Together AI](https://together.ai) menyediakan akses ke berbagai model sumber terbuka
terkemuka, termasuk Llama, DeepSeek, Kimi, dan lainnya melalui API terpadu.
...
<Note>
Orientasi awal menetapkan `together/meta-llama/Llama-3.3-70B-Instruct-Turbo`
sebagai model bawaan.
</Note>
...
| -------------------------------------------------- | ---------------------------- | ----------- | ------- | -------------- | -------------------- | -------------------------- |
| `together/meta-llama/Llama-3.3-70B-Instruct-Turbo` | Llama 3.3 70B Instruct Turbo | teks        | 131,072 | 8,192          | 0.88 / 0.88          | Model bawaan               |
...
Plugin `together` yang disertakan juga mendaftarkan pembuatan video melalui
alat `video_generate` bersama.

| Properti                 | Nilai                                                                                                  |
| ------------------------ | ------------------------------------------------------------------------------------------------------ |
| Model video bawaan       | `Wan-AI/Wan2.2-T2V-A14B`                                                                               |
| Model lainnya            | `Wan-AI/Wan2.2-I2V-A14B`, `minimax/Hailuo-02`, `Kwai/Kling-2.1-Master`                                 |
...
Untuk menggunakan Together sebagai penyedia video bawaan:
...
<AccordionGroup>
  <Accordion title="Catatan lingkungan">
    ...
    atau `env.shellEnv` agar selalu tersedia.
    </Warning>
