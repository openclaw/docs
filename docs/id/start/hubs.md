...
summary: Hub yang menautkan ke setiap dokumentasi OpenClaw
...
<Note>
Jika Anda baru mengenal OpenClaw, mulailah dengan [Memulai](/id/start/getting-started).
</Note>

Gunakan pusat-pusat ini untuk menemukan setiap halaman, termasuk pembahasan mendalam dan dokumentasi referensi yang tidak muncul di navigasi kiri.
...
- [Galeri](/id/start/showcase)
- [Kisah latar](/id/start/lore)

## Instalasi + pembaruan

- [Docker](/id/install/docker)
- [Nix](/id/install/nix)
- [Pembaruan / pengembalian versi](/id/install/updating)
...
- [Streaming + pemenggalan](/id/concepts/streaming)
...
- [Kehadiran](/id/concepts/presence)
- [Penemuan + transportasi](/id/gateway/discovery)
...
- [Pusat kanal obrolan](/id/channels)
- [Pusat penyedia model](/id/providers/models)
...
- [Diagnostik](/id/gateway/doctor)
- [Pencatatan log](/id/gateway/logging)
- [Sandboxing](/id/gateway/sandboxing)
- [Dasbor](/id/web/dashboard)
- [Antarmuka kontrol](/id/web/control-ui)
...
- [Mode dengan hak akses tinggi](/id/tools/elevated)
- [Tugas Cron](/id/automation/cron-jobs)
- [Otomatisasi](/id/automation)
- [Penalaran + keluaran terperinci](/id/tools/thinking)
- [Model](/id/concepts/models)
- [Subagen](/id/tools/subagents)
- [CLI pengiriman agen](/id/tools/agent-send)
- [Antarmuka pengguna terminal](/id/web/tui)
- [Kontrol peramban](/id/tools/browser)
- [Peramban (pemecahan masalah Linux)](/id/tools/browser-linux-troubleshooting)
- [Jajak pendapat](/id/cli/message)
...
- [Aktivasi suara macOS](/id/platforms/mac/voicewake)
- [Hamparan suara macOS](/id/platforms/mac/voice-overlay)
- [WebChat macOS](/id/platforms/mac/webchat)
- [Kanvas macOS](/id/platforms/mac/canvas)
- [Proses anak macOS](/id/platforms/mac/child-process)
- [Kesehatan macOS](/id/platforms/mac/health)
- [Ikon macOS](/id/platforms/mac/icon)
- [Pencatatan log macOS](/id/platforms/mac/logging)
- [Izin macOS](/id/platforms/mac/permissions)
- [Akses jarak jauh macOS](/id/platforms/mac/remote)
...
- [ClawHub](/clawhub)
- [Panduan praktis kapabilitas](/id/plugins/adding-capabilities)
...
- [AGENTS bawaan](/id/reference/AGENTS.default)
