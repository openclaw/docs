...
nama bercakupan seperti `@example-org/example-plugin` harus dipublikasikan sebagai pemilik
...
Berkas lokal tidak cocok dengan versi mana pun yang diketahui ClawHub. Pilih salah satu:
