...
read_when:
    ...
    - Sebuah paket tidak dapat diinstal, dipublikasikan, atau diperbarui
summary: Pemecahan masalah masuk, instalasi, penerbitan, pembaruan, dan masalah API ClawHub.
x-i18n:
    generated_at: "2026-07-05T08:35:36Z"
    model: gpt-5.5
...
- Jika Anda menggunakan path konfigurasi kustom, pastikan `CLAWHUB_CONFIG_PATH` mengarah ke
...
- `RateLimit-Remaining`: sisa kuota Anda yang tepat saat header ini ada. Pada `429`, nilainya `0`.
...
alat wajib harus dideklarasikan agar pengguna dan pemindai dapat memahami paket.
...
## Publikasi gagal karena error pemilik atau sumber GitHub
...
## Publikasi gagal karena namespace sudah diklaim atau dicadangkan
...
harus dikecualikan dari masalah publik.
...
- Pastikan versi OpenClaw Anda memenuhi rentang kompatibilitas yang
  diiklankan paket.
- Jika paket disembunyikan, ditahan, atau diblokir, paket tersebut mungkin tidak dapat diinstal sampai
...
- Jangan cerminkan konten tersembunyi, privat, ditahan, atau diblokir moderasi di luar
