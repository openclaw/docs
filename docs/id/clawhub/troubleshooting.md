...
x-i18n:
    generated_at: "2026-06-28T00:12:19Z"
    model: gpt-5.5
...
## Pencarian atau instalasi gagal di belakang proksi
...
menerbitkan dengan pemilik yang sesuai dengan namespace. Untuk paket Plugin,
...
[Klaim Org dan Namespace](/id/clawhub/namespace-claims) untuk panduan bukti dan hal yang
...
- Pastikan versi OpenClaw Anda memenuhi rentang kompatibilitas yang diiklankan
  paket tersebut.
- Jika paket tersembunyi, ditahan, atau diblokir, paket mungkin tidak dapat diinstal hingga
