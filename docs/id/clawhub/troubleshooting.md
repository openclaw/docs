...
summary: Pemecahan masalah untuk masalah masuk, instalasi, publikasi, pembaruan, dan API ClawHub.
x-i18n:
    generated_at: "2026-07-03T17:43:10Z"
    model: gpt-5.5
...
atau nama paket sudah diklaim atau dicadangkan, pastikan terlebih dahulu bahwa Anda
memublikasikan dengan pemilik yang cocok dengan namespace tersebut. Untuk paket plugin,
...
[Klaim Organisasi dan Namespace](/clawhub/namespace-claims) untuk panduan bukti dan hal yang
...
- Publikasikan salinan yang telah Anda edit sebagai slug baru atau fork.
...
- Pastikan versi OpenClaw Anda memenuhi rentang kompatibilitas yang diiklankan
  paket tersebut.
- Jika paket disembunyikan, tertahan, atau diblokir, paket mungkin tidak dapat diinstal sampai
