...
summary: Memecahkan masalah masuk, pemasangan, penerbitan, pembaruan, dan masalah API ClawHub.
x-i18n:
    generated_at: "2026-07-02T14:11:58Z"
    model: gpt-5.5
...
CLI menjalankan server callback lokal berumur singkat selama login browser.
...
## Pencarian atau instalasi gagal di belakang proxy
