...
summary: Memecahkan masalah masuk, instal, publikasi, pembaruan, dan API ClawHub.
x-i18n:
    generated_at: "2026-07-05T05:36:22Z"
    model: gpt-5.5
...
- Jika Anda pemilik skill tersebut, masuk dan periksa:
...
- Pastikan Anda masuk dengan akun GitHub yang memiliki atau dapat menerbitkan
  paket tersebut.
- Periksa apakah URL sumber bersifat publik atau dapat diakses oleh ClawHub.
...
yang perlu dihindari dari isu publik.
