...
summary: Pemecahan masalah masuk, instalasi, publikasi, pembaruan, dan isu API ClawHub.
x-i18n:
    generated_at: "2026-07-04T15:35:50Z"
    model: gpt-5.5
...
CLI memulai server callback lokal berumur singkat selama login browser.
...
Jika publikasi gagal karena handle pemilik, namespace organisasi, cakupan paket, slug keterampilan,
...
[Klaim Organisasi dan Namespace](/clawhub/namespace-claims) untuk panduan bukti dan apa yang
harus dijauhkan dari isu publik.

## `sync` mengatakan tidak ada keterampilan yang ditemukan
...
- Pastikan versi OpenClaw Anda memenuhi rentang kompatibilitas yang diiklankan
  paket tersebut.
- Jika paket tersembunyi, ditahan, atau diblokir, paket tersebut mungkin tidak dapat diinstal sampai
