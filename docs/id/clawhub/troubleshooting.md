---
read_when:
    - Perintah CLI ClawHub atau registry OpenClaw gagal
    - Paket tidak dapat diinstal, dipublikasikan, atau diperbarui
summary: Memecahkan masalah masuk, pemasangan, penerbitan, pembaruan, dan API ClawHub.
x-i18n:
    generated_at: "2026-07-03T09:59:56Z"
    model: gpt-5.5
...
- Di lingkungan tanpa head, buat token API di UI web ClawHub lalu jalankan:
...
- Jika Anda menggunakan path konfigurasi khusus, pastikan `CLAWHUB_CONFIG_PATH` menunjuk ke
...
alat yang wajib sebaiknya dideklarasikan agar pengguna dan pemindai dapat memahami paket.
...
[issue Klaim Org / Namespace](https://github.com/openclaw/clawhub/issues/new?template=org-namespace-claim.yml)
...
harus dijauhkan dari issue publik.
