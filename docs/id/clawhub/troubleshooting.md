...
x-i18n:
    generated_at: "2026-07-02T17:47:00Z"
    model: gpt-5.5
...
- Jika Anda menggunakan jalur konfigurasi khusus, pastikan `CLAWHUB_CONFIG_PATH` menunjuk ke
...
- `RateLimit-Remaining`: anggaran tersisa persis Anda ketika header tersedia. Pada `429`, nilainya `0`.
...
## Publikasi gagal dengan kesalahan pemilik atau sumber GitHub
...
atau nama paket sudah diklaim atau dicadangkan, pertama pastikan Anda
...
- Terbitkan salinan yang Anda edit sebagai slug baru atau fork.
