...
x-i18n:
    generated_at: "2026-06-30T22:35:26Z"
    model: gpt-5.5
...
- Jika Anda menggunakan jalur konfigurasi kustom, pastikan `CLAWHUB_CONFIG_PATH` menunjuk ke
...
CLI mengikuti variabel proksi standar:
...
Jika Anda yakin org, proyek, atau merek Anda adalah pemilik namespace yang berhak tetapi
