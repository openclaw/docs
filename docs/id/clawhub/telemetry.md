...
summary: Telemetri instalasi yang dikumpulkan oleh CLI ClawHub dan cara untuk berhenti ikut serta.
x-i18n:
    generated_at: "2026-07-01T08:30:56Z"
    model: gpt-5.5
...
Pada setiap `clawhub install` yang dilaporkan, CLI mengirimkan satu peristiwa pemasangan dengan upaya terbaik.
...
ClawHub memelihara penghitung agregat per skill:
...
Dengan ini diatur, CLI tidak akan mengirim telemetri pemasangan.
