---
read_when:
    - Mengerjakan telemetri / kontrol privasi
    - Pertanyaan tentang data apa yang dikumpulkan
summary: Pasang telemetri yang dikumpulkan oleh CLI ClawHub dan cara memilih keluar.
x-i18n:
    generated_at: "2026-06-30T22:36:10Z"
    model: gpt-5.5
...
Pada setiap `clawhub install` yang dilaporkan, CLI mengirim satu peristiwa pemasangan dengan upaya terbaik.
...
- Tidak ada jalur folder atau pengidentifikasi yang diturunkan dari folder.
- Tidak ada isi file.
