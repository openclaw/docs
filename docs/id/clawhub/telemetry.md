...
summary: Telemetri pemasangan yang dikumpulkan oleh CLI ClawHub dan cara memilih untuk tidak ikut.
x-i18n:
    generated_at: "2026-07-03T17:42:40Z"
    model: gpt-5.5
...
Pada setiap `clawhub install` yang dilaporkan, CLI mengirimkan satu peristiwa instalasi best-effort.
