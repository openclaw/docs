...
summary: Instal telemetri yang dikumpulkan oleh CLI ClawHub dan cara untuk tidak ikut serta.
x-i18n:
    generated_at: "2026-07-01T15:31:37Z"
    model: gpt-5.5
...
Pada setiap `clawhub install` yang dilaporkan, CLI mengirim satu peristiwa instalasi sebisa mungkin.
...
Dengan ini diatur, CLI tidak akan mengirim telemetri instalasi.
