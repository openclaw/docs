...
summary: Telemetri instalasi yang dikumpulkan oleh CLI ClawHub dan cara berhenti berpartisipasi.
x-i18n:
    generated_at: "2026-07-04T04:06:32Z"
    model: gpt-5.5
...
- Tidak ada isi file.
- Tidak ada log, prompt, atau keluaran CLI lain per eksekusi.
