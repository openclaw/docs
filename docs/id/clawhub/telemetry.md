...
summary: Telemetri instalasi dikumpulkan melalui `clawhub sync` + opsi untuk tidak ikut.
x-i18n:
...
- `label`: label yang mudah dibaca manusia yang berasal dari dua segmen path terakhir (path home ditampilkan dengan `~`).
