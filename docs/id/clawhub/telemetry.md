...
x-i18n:
    generated_at: "2026-07-19T04:52:10Z"
    model: gpt-5.6
...
Pada setiap `clawhub install` yang dilaporkan, CLI mengirimkan satu peristiwa instalasi berdasarkan upaya terbaik.
...
ClawHub menyimpan penghitung agregat per Skills:
...
Jika variabel ini ditetapkan, CLI tidak akan mengirimkan telemetri instalasi.
