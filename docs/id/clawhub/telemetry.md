...
summary: Telemetri pemasangan yang dikumpulkan oleh ClawHub CLI dan cara menonaktifkannya.
x-i18n:
    generated_at: "2026-07-01T13:22:50Z"
    model: gpt-5.5
...
- `installsCurrent`: pengguna unik yang telah melaporkan instalasi dan belum menghapus telemetri
  mereka.
