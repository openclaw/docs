...
title: ClawHub
x-i18n:
    generated_at: "2026-07-05T08:34:16Z"
    model: gpt-5.5
...
| Plugin bundle  | Bundle Plugin terkemas untuk distribusi OpenClaw           | `clawhub package publish <source>`           |
...
Override environment yang berguna:
...
Lihat [Telemetri](/id/clawhub/telemetry), [API HTTP](/clawhub/http-api), dan
