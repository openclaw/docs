...
title: ClawHub
x-i18n:
    generated_at: "2026-07-03T23:42:37Z"
    model: gpt-5.5
...
- Gunakan CLI `clawhub` terpisah untuk alur kerja autentikasi registri, penerbitan, serta hapus/batal hapus.
...
Spek plugin bare yang aman untuk npm dapat di-resolve melalui npm selama cutover peluncuran, dan
...
ClawPack, OpenClaw lebih memilih `.tgz` npm-pack unggahan yang persis, memverifikasi
