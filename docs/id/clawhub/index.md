...
summary: Ikhtisar ClawHub publik untuk penemuan, penginstalan, penerbitan, keamanan, dan CLI clawhub.
title: ClawHub
x-i18n:
...
- Gunakan CLI `clawhub` terpisah untuk alur kerja auth registry, publikasi, hapus/pulihkan penghapusan, dan sinkronisasi.
...
publikasi, sinkronisasi, atau hapus/pulihkan penghapusan:
...
artefak ClawPack, OpenClaw lebih memilih `.tgz` npm-pack unggahan persisnya, memverifikasi
...
ClawHub bersifat terbuka secara default: siapa pun dapat mengunggah, tetapi publikasi memerlukan akun GitHub
...
ditahan oleh pemindaian atau diblokir dapat menghilang dari katalog publik dan permukaan instalasi, sembari
