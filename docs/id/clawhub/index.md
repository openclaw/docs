...
- Gunakan CLI `clawhub` terpisah untuk alur kerja autentikasi registri, publikasi, hapus/batal hapus, dan sinkronisasi.
...
| -------------- | ---------------------------------------------------------- | ------------------------------------------- |
| Skills         | Bundel teks berversi dengan `SKILL.md` serta file pendukung | `openclaw skills install <slug>`            |
...
metadata sumber agar perintah pembaruan berikutnya tetap dapat berada di ClawHub.

Gunakan `clawhub:<package>` saat instalasi plugin harus di-resolve melalui ClawHub.
Spesifikasi plugin yang aman untuk npm tanpa prefix dapat di-resolve melalui npm selama cutover peluncuran, dan
...
CLI juga memiliki perintah instal/pembaruan Skills untuk alur kerja registri langsung:
...
Pengguna yang sudah masuk dapat melaporkan Skills dan paket. Moderator dapat meninjau laporan,
