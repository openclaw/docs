...
title: ClawHub
x-i18n:
    generated_at: "2026-06-30T14:24:15Z"
    model: gpt-5.5
...
- Gunakan CLI `clawhub` terpisah untuk alur kerja autentikasi registri, penerbitan, serta hapus/pulihkan penghapusan.
...
penerbitan atau hapus/pulihkan penghapusan:
...
| Plugin bundel  | Bundel Plugin terkemas untuk distribusi OpenClaw           | `clawhub package publish <source>`          |
...
Perintah OpenClaw native menginstal ke workspace OpenClaw aktif dan menyimpan
...
Spesifikasi Plugin npm-safe tanpa prefiks dapat di-resolve melalui npm selama cutover peluncuran, dan
...
ClawPack, OpenClaw lebih memilih `.tgz` npm-pack yang diunggah secara tepat, memverifikasi
...
atau diblokir dapat menghilang dari katalog publik dan permukaan instalasi, tetapi
