...
title: ClawHub
x-i18n:
    generated_at: "2026-05-12T08:44:22Z"
    model: gpt-5.5
    provider: openai
...
- Gunakan CLI `clawhub` terpisah untuk alur kerja autentikasi registri, penerbitan, hapus/pulihkan, dan sinkronisasi.
...
Instal CLI ClawHub saat Anda menginginkan alur kerja yang terautentikasi registri seperti
...
status registri saat ini agar pengguna dapat memeriksa skill atau plugin sebelum menginstalnya.
...
GitHub yang cukup lama untuk lolos gerbang unggah. Halaman detail publik merangkum
