...
summary: Gambaran umum publik ClawHub untuk penemuan, instalasi, publikasi, keamanan, dan CLI clawhub.
title: ClawHub
x-i18n:
...
- Gunakan CLI `clawhub` terpisah untuk auth registri, publikasi, hapus/pulihkan hapus, dan alur kerja sinkronisasi.
...
publikasi, sinkronisasi, atau hapus/pulihkan hapus:
