...
title: ClawHub
x-i18n:
    generated_at: "2026-07-04T11:03:08Z"
    model: gpt-5.5
...
Spesifikasi plugin bare yang aman untuk npm dapat diselesaikan melalui npm selama transisi peluncuran, dan
...
CLI juga memiliki perintah instal/pembaruan skill untuk alur kerja registri langsung:
...
pemindaian atau diblokir dapat menghilang dari katalog publik dan permukaan instalasi sambil
...
Ketika Anda menjalankan `clawhub install` saat sudah masuk, CLI dapat mengirim event
