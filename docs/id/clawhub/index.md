...
- Gunakan CLI `clawhub` terpisah untuk autentikasi registri, publikasi, serta alur kerja hapus/batalkan hapus.
...
ClawPack, OpenClaw memilih `.tgz` npm-pack yang diunggah secara tepat, memverifikasi
...
perintah lengkap dan [Format Skills](/id/clawhub/skill-format) untuk metadata Skills.

## Keamanan dan moderasi

ClawHub terbuka secara default: siapa pun dapat mengunggah, tetapi publikasi memerlukan akun GitHub
yang cukup lama untuk melewati gerbang unggah. Halaman detail publik merangkum status
pemindaian terbaru sebelum instalasi atau unduhan.

ClawHub menjalankan pemeriksaan otomatis pada Skills dan rilis Plugin yang dipublikasikan. Rilis yang ditahan pemindaian
atau diblokir dapat hilang dari katalog publik dan permukaan instalasi sambil
