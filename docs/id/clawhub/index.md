...
title: ClawHub
x-i18n:
    generated_at: "2026-07-02T08:48:30Z"
    model: gpt-5.5
...
- Gunakan CLI `clawhub` terpisah untuk autentikasi registry, penerbitan, serta alur kerja hapus/batalkan hapus.
...
Instal CLI ClawHub saat Anda membutuhkan alur kerja yang diautentikasi registry seperti
menerbitkan atau menghapus/batalkan hapus:
...
| -------------- | ---------------------------------------------------------- | -------------------------------------------- |
| Skills         | Bundle teks berversi dengan `SKILL.md` serta file pendukung | `openclaw skills install @openclaw/demo`     |
...
terkini sehingga pengguna dapat memeriksa Skills atau Plugin sebelum menginstalnya.
...
Spesifikasi Plugin tanpa awalan yang aman untuk npm dapat di-resolve melalui npm selama cutover peluncuran, dan
...
artefak ClawPack, OpenClaw memilih `.tgz` npm-pack unggahan yang persis, memverifikasi
...
perintah lengkap dan [Format Skills](/clawhub/skill-format) untuk metadata Skills.

## Keamanan dan moderasi

ClawHub terbuka secara default: siapa pun dapat mengunggah, tetapi penerbitan memerlukan akun
GitHub yang cukup lama untuk melewati gerbang unggah. Halaman detail publik merangkum
...
ditahan oleh pemindaian atau diblokir dapat menghilang dari katalog publik dan permukaan instalasi sambil
...
menyembunyikan atau memulihkan konten, dan melarang akun yang menyalahgunakan layanan. Lihat
...
Saat Anda menjalankan `clawhub install` dalam keadaan masuk, CLI dapat mengirim event
