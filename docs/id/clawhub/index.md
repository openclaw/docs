...
title: ClawHub
x-i18n:
    generated_at: "2026-07-02T14:11:09Z"
    model: gpt-5.5
...
Spesifikasi plugin polos yang aman untuk npm dapat diselesaikan melalui npm selama peralihan peluncuran, dan
...
artefak ClawPack, OpenClaw memilih `.tgz` npm-pack unggahan persisnya, memverifikasi
...
dan merekam versi yang terinstal di `.clawhub/lock.json`.
...
Saat Anda menjalankan `clawhub install` ketika sedang masuk, CLI dapat mengirim peristiwa
instal best-effort agar ClawHub dapat menghitung jumlah instalasi agregat. Nonaktifkan ini dengan:
