...
title: ClawHub
x-i18n:
    generated_at: "2026-07-01T13:20:45Z"
    model: gpt-5.5
...
- Gunakan CLI `clawhub` terpisah untuk alur kerja autentikasi registry, penerbitan, dan hapus/batal hapus.
...
menerbitkan atau menghapus/batal menghapus:
...
ClawHub terbuka secara default: siapa pun dapat mengunggah, tetapi penerbitan membutuhkan akun
