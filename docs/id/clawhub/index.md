...
title: ClawHub
x-i18n:
    generated_at: "2026-07-01T15:31:17Z"
    model: gpt-5.5
...
- Gunakan CLI `clawhub` terpisah untuk autentikasi registri, publikasi, dan alur kerja hapus/pulihkan.
...
saat ini agar pengguna dapat memeriksa sebuah Skills atau Plugin sebelum menginstalnya.
...
Spesifikasi Plugin polos yang aman untuk npm dapat di-resolve melalui npm selama peralihan peluncuran, dan
...
CLI ini juga memiliki perintah instal/perbarui Skills untuk alur kerja registri langsung:
...
- `--tags <tags>`: tag yang dipisahkan koma, defaultnya `latest`.
...
yang cukup lama untuk lolos gerbang unggah. Halaman detail publik merangkum status
pemindaian terbaru sebelum instalasi atau pengunduhan.
