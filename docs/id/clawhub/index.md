...
summary: Ringkasan publik ClawHub untuk penemuan, instalasi, publikasi, keamanan, dan CLI clawhub.
title: ClawHub
x-i18n:
    generated_at: "2026-07-04T18:19:32Z"
    model: gpt-5.5
...
- Gunakan CLI `clawhub` terpisah untuk autentikasi registri, penerbitan, dan alur kerja hapus/pulihkan hapus.
...
penerbitan atau hapus/pulihkan hapus:
...
unduhan, bintang, dan ringkasan pemindaian keamanan. Halaman publik menampilkan
status registri saat ini sehingga pengguna dapat memeriksa Skill atau Plugin sebelum menginstalnya.
...
lengkap dan [Format Skills](/clawhub/skill-format) untuk metadata Skill.
