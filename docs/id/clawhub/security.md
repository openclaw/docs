...
title: Keamanan
x-i18n:
    generated_at: "2026-07-04T18:20:04Z"
    model: gpt-5.5
...
advisory ClawHub yang baik mencakup bug pada:

- situs web, API, atau CLI ClawHub
- penerbitan registry, unduhan, pemasangan, atau integritas artefak
- autentikasi, otorisasi, atau token API
- pemindaian, moderasi, atau penanganan laporan

Jangan gunakan advisory ClawHub untuk kerentanan pada kode sumber milik skill atau
...
secara publik ketika ada bukti dampak nyata pada pengguna atau ketika pengguna
perlu mengambil tindakan.

Contoh dampak nyata pada pengguna mencakup eksploitasi yang terkonfirmasi,
paparan data atau rahasia pengguna, konten berbahaya yang mencapai pengguna
...
Kerentanan pada perangkat lunak yang dipasang pengguna diungkapkan secara
publik, seperti paket CLI ClawHub, biner, pustaka, atau artefak rilis lain yang
perlu diperbarui pengguna secara lokal.

## Halaman terkait

Untuk label audit saat pemasangan, tingkat risiko, temuan, dan interpretasi,
lihat [Audit Keamanan](/clawhub/security-audits).
