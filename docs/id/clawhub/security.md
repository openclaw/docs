...
title: Keamanan
x-i18n:
    generated_at: "2026-07-02T08:49:06Z"
    model: gpt-5.5
...
Kerentanan dalam perangkat lunak yang dipasang pengguna diungkapkan kepada publik,
seperti paket CLI ClawHub, biner, pustaka, atau artefak rilis lain yang perlu
diperbarui pengguna secara lokal.

## Halaman terkait

Untuk label audit saat pemasangan, tingkat risiko, temuan, dan interpretasi, lihat
[Audit Keamanan](/clawhub/security-audits).

Untuk laporan marketplace, penahanan moderasi, listing tersembunyi, larangan, dan
