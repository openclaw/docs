...
tidak diungkapkan secara publik secara default. Kerentanan diungkapkan secara
publik ketika ada bukti dampak nyata terhadap pengguna atau ketika pengguna perlu
mengambil tindakan.
...
dan reputasi akun, lihat [Moderasi dan Keamanan Akun](/id/clawhub/moderation).
