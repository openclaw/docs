...
title: Keamanan
x-i18n:
    generated_at: "2026-07-03T09:59:42Z"
    model: gpt-5.5
...
advisori ClawHub yang baik mencakup bug di:
...
Karena ClawHub adalah aplikasi cloud terhosting, kerentanan layanan ClawHub
tidak diungkapkan secara publik secara default. Kerentanan diungkapkan secara publik ketika ada
bukti dampak nyata terhadap pengguna atau ketika pengguna perlu mengambil tindakan.

Contoh dampak nyata terhadap pengguna mencakup eksploitasi yang terkonfirmasi, tereksposnya data
atau rahasia pengguna, konten berbahaya yang menjangkau pengguna karena kegagalan platform,
...
Kerentanan dalam perangkat lunak yang diinstal pengguna diungkapkan secara publik, seperti
paket CLI ClawHub, biner, pustaka, atau artefak rilis lain yang perlu
...
Untuk laporan marketplace, penahanan moderasi, listing tersembunyi, pemblokiran, dan status
