...
x-i18n:
    generated_at: "2026-07-02T08:49:16Z"
    model: gpt-5.5
...
- informasi log perubahan dan tag seperti `latest`
- sinyal unduhan, pemasangan, dan bintang
- status pemindaian keamanan dan moderasi

Halaman daftar adalah tempat kanonis bagi pengguna untuk memeriksa apa yang diklaim dapat dilakukan oleh sebuah skill atau
...
ClawHub membaca metadata awal `SKILL.md` untuk memahami nama skill,
...
Gunakan uji coba untuk meninjau payload yang diselesaikan sebelum unggahan. Halaman publik kemudian
...
atau diblokir dapat menghilang dari alur pencarian dan pemasangan publik sambil tetap
