---
read_when:
    - Memahami cantuman, versi, pemasangan, publikasi, dan moderasi
summary: Cara kerja listing, versi, instalasi, publikasi, pemindaian, dan pembaruan ClawHub.
x-i18n:
    generated_at: "2026-07-04T04:06:17Z"
    model: gpt-5.5
...
Gunakan dry run untuk mempratinjau payload yang telah di-resolve sebelum diunggah. Halaman publik kemudian
...
unduhan. Katalog pihak ketiga dapat menggunakan API ini saat menautkan kembali ke listing ClawHub
kanonis, menghormati batas laju, dan menghindari kesan dukungan resmi.
