...
dapat dilakukan oleh sebuah Skills atau plugin sebelum menginstalnya.

## Skills

Skills adalah bundel teks berversi yang berpusat pada `SKILL.md`. Skills dapat menyertakan
...
yang diumumkan sebelum menginstal. Catatan paket dapat mencakup kompatibilitas API,
...
menampilkan metadata, file, atribusi sumber, dan status pemindaian yang dipublikasikan.
...
pembaruan Skills langsung bagi pengguna yang menginginkan folder Skills yang dikelola registry di luar
...
atau diblokir dapat menghilang dari alur pencarian dan instalasi publik, sambil tetap
...
listing ClawHub kanonis, menghormati batas laju, dan menghindari kesan adanya endorsement.
