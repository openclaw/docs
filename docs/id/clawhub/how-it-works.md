...
Halaman listing adalah tempat kanonis bagi pengguna untuk memeriksa klaim yang dibuat sebuah skill atau
...
Gunakan sumber instal ClawHub yang eksplisit ketika Anda ingin registry menjadi
sumber kebenaran:
...
Gunakan dry run untuk meninjau payload yang diselesaikan sebelum pengunggahan. Halaman publik kemudian
menampilkan metadata yang dipublikasikan, file, atribusi sumber, dan status pemindaian.

## Instalasi dan pembaruan

Perintah instal OpenClaw menggunakan ClawHub sebagai sumber paket:
...
OpenClaw mencatat metadata sumber instal sehingga pembaruan dapat menyelesaikan paket
...
atau diblokir dapat hilang dari pencarian publik dan alur instalasi sementara tetap
