...
summary: Cara kerja daftar ClawHub, versi, instalasi, penerbitan, pemindaian, dan pembaruan.
x-i18n:
    generated_at: "2026-07-04T18:19:56Z"
    model: gpt-5.5
...
dapat dilakukan oleh skill atau plugin sebelum memasangnya.
...
kompatibilitas yang diiklankan sebelum memasang. Catatan paket dapat mencakup kompatibilitas API,
