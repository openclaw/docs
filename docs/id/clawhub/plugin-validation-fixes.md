...
x-i18n:
    generated_at: "2026-07-04T15:35:40Z"
    model: gpt-5.5
...
| `channel-env-vars`                      | [Cerminkan variabel env channel dalam metadata saat ini](/id/clawhub/plugin-validation-fixes#channel-env-vars)                                |
...
Paket mendeklarasikan entrypoint OpenClaw, tetapi file yang direferensikan hilang
...
Plugin mengimpor dari root SDK barrel yang sudah tidak digunakan:
`openclaw/plugin-sdk`.
...
- Tetap dokumentasikan perilaku sensitif keamanan di dokumen paket publik atau
