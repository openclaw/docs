...
- Gunakan versi API Plugin OpenClaw atau batas minimum semver yang Anda gunakan untuk membangun dan menguji.
...
- Gunakan identitas transkrip atau helper target saat kode menyiapkan operasi transkrip.
...
Manifes menggunakan metadata env-var channel lama atau lebih tua tanpa metadata setup
