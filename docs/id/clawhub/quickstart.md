...
x-i18n:
    generated_at: "2026-07-04T06:50:43Z"
    model: gpt-5.5
...
Gunakan OpenClaw saat Anda memasang hal-hal ke dalam OpenClaw. Gunakan CLI `clawhub`
...
Perintah ini melewati konten yang tidak berubah. Keterampilan baru dimulai dari `1.0.0`; perubahan berikutnya
...
dibutuhkan keterampilan sebelum mereka menginstalnya. Lihat [Format keterampilan](/id/clawhub/skill-format).

Untuk repositori yang berisi beberapa keterampilan, workflow GitHub yang dapat digunakan kembali memanggil
`skill publish` untuk setiap folder keterampilan langsung di bawah `skills/`:
...
Publikasikan plugin dari folder lokal, repo GitHub, ref GitHub, atau
...
moderasi dapat disembunyikan dari permukaan pencarian dan instalasi hingga diselesaikan.
