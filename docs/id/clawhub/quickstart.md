...
x-i18n:
    generated_at: "2026-07-04T20:43:44Z"
    model: gpt-5.5
...
Pasang Plugin yang di-hosting ClawHub dengan sumber ClawHub eksplisit:
...
Perintah melewati konten yang tidak berubah. Skill baru dimulai dari `1.0.0`; perubahan berikutnya
...
Gunakan `--dry-run` terlebih dahulu untuk meninjau metadata paket yang di-resolve, kolom kompatibilitas,
