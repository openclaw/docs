...
x-i18n:
    generated_at: "2026-07-04T18:20:32Z"
    model: gpt-5.5
...
otomatis menerbitkan versi patch berikutnya. Gunakan `--dry-run` untuk melihat pratinjau atau
...
Gunakan `--dry-run` terlebih dahulu untuk melihat pratinjau metadata paket yang diselesaikan, kolom
