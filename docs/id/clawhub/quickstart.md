...
x-i18n:
    generated_at: "2026-06-30T14:26:21Z"
    model: gpt-5.5
...
perubahan berikutnya otomatis menerbitkan versi patch berikutnya. Gunakan `--dry-run`
untuk pratinjau atau `--version` untuk memilih versi eksplisit.
...
di-resolve, bidang kompatibilitas, atribusi sumber, dan rencana unggah tanpa
menerbitkan.
...
pemasangan sampai terselesaikan.
