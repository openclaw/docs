...
x-i18n:
    generated_at: "2026-07-05T05:35:55Z"
    model: gpt-5.5
...
saat Anda masuk, menerbitkan, mengelola daftar milik sendiri, atau menggunakan
...
secara otomatis menerbitkan versi patch berikutnya. Gunakan `--dry-run` untuk meninjau atau
...
Gunakan `--dry-run` terlebih dahulu untuk meninjau metadata paket yang diselesaikan, bidang kompatibilitas,
