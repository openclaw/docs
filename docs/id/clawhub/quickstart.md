...
summary: 'Mulai menggunakan ClawHub: temukan, instal, perbarui, dan publikasikan skill atau plugin.'
x-i18n:
    generated_at: "2026-07-02T14:11:33Z"
    model: gpt-5.5
...
Instal Plugin yang di-hosting ClawHub dengan sumber ClawHub eksplisit:
...
Gunakan `--dry-run` terlebih dahulu untuk melihat pratinjau metadata paket yang di-resolve, kolom
...
moderasi mungkin disembunyikan dari permukaan pencarian dan instalasi hingga diselesaikan.
