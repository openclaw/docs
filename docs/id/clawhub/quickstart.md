...
Untuk repositori yang berisi beberapa skill, workflow GitHub yang dapat digunakan ulang memanggil
...
Gunakan `--dry-run` terlebih dahulu untuk mempratinjau metadata paket yang di-resolve, kolom
