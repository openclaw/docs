...
x-i18n:
    generated_at: "2026-05-12T23:29:27Z"
    model: gpt-5.5
    provider: openai
...
Gunakan `--dry-run` terlebih dahulu untuk meninjau metadata paket yang diselesaikan,
...
jumlah pemasangan agregat. Lihat [Telemetri](/id/clawhub/telemetry) untuk mengetahui
apa yang dilaporkan dan cara memilih keluar.
...
diblokir oleh moderasi mungkin disembunyikan dari permukaan pencarian dan pemasangan
