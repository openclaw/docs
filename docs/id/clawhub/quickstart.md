...
x-i18n:
    generated_at: "2026-07-05T08:29:07Z"
    model: gpt-5.5
...
ClawHub alih-alih npm atau sumber lain.
...
Skill adalah folder dengan berkas `SKILL.md` wajib dan berkas pendukung opsional.
...
Sebelum menerbitkan, periksa metadata di `SKILL.md`. Nyatakan variabel
...
Gunakan `--dry-run` terlebih dahulu untuk melihat pratinjau metadata paket yang diselesaikan, bidang kompatibilitas,
