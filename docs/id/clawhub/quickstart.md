...
read_when:
    ...
    - Memasang skill atau plugin dari registri
...
secara otomatis menerbitkan versi patch berikutnya. Gunakan `--dry-run` untuk meninjau pratinjau atau
...
Gunakan `--dry-run` terlebih dahulu untuk meninjau pratinjau metadata paket yang diresolusikan, bidang
...
moderasi dapat disembunyikan dari permukaan pencarian dan instalasi sampai diselesaikan.
