...
summary: Format folder Skill, file yang wajib, jenis file yang diizinkan, batasan.
x-i18n:
    generated_at: "2026-06-30T14:26:48Z"
    model: gpt-5.5
...
- `SKILL.md` (atau `skill.md`; `skills.md` warisan juga diterima)

Opsional:

- berkas pendukung _berbasis teks_ apa pun (lihat “Berkas yang diizinkan”)
- `.clawhubignore` (pola pengabaian untuk publikasi, `.clawdhubignore` warisan)
- `.gitignore` (juga dihormati)

## Impor GitHub

Pengimpor GitHub web lebih ketat daripada publish/sync lokal. Pengimpor ini hanya menemukan
berkas `SKILL.md` atau `skills.md` warisan di repositori publik, non-fork, yang dimiliki oleh
...
Hanya berkas “berbasis teks” yang diterima oleh publish.
...
- Teks embedding mencakup `SKILL.md` + hingga sekitar 40 berkas non-`.md` (batas upaya terbaik).
