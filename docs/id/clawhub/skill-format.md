...
x-i18n:
    generated_at: "2026-07-04T15:36:40Z"
    model: gpt-5.5
...
Importer GitHub web lebih ketat daripada publish/sync lokal. Ia hanya menemukan
...
Analisis keamanan ClawHub memeriksa bahwa deklarasi skill Anda cocok dengan apa yang sebenarnya dilakukannya. Jika kode Anda mereferensikan `TODOIST_API_KEY` tetapi frontmatter Anda tidak mendeklarasikannya di bawah `requires.env`, `primaryEnv`, atau `envVars`, analisis akan menandai ketidakcocokan metadata. Menjaga deklarasi tetap akurat membantu skill Anda lolos peninjauan dan membantu pengguna memahami apa yang mereka instal.
