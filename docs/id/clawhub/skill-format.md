...
- `.clawhubignore` (pola pengabaian untuk publish/sync, warisan `.clawdhubignore`)
...
- Tipe konten yang diawali dengan `text/` diperlakukan sebagai teks; ditambah daftar kecil yang diizinkan (JSON/YAML/TOML/JS/TS/Markdown/SVG).
