...
x-i18n:
    generated_at: "2026-07-04T20:43:55Z"
    model: gpt-5.5
...
Pengimpor GitHub web lebih ketat daripada publish/sync lokal. Pengimpor ini hanya menemukan file
`SKILL.md` atau `skills.md` lama di repositori publik non-fork yang dimiliki oleh
