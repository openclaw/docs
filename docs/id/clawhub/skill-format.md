...
x-i18n:
    generated_at: "2026-07-02T14:11:39Z"
    model: gpt-5.5
...
- `.clawhubignore` (pola abaian untuk publikasi, legacy `.clawdhubignore`)
...
Status instal direktori kerja (ditulis oleh CLI):
...
Jika skill Anda memerlukan dependensi terinstal, deklarasikan dependensi tersebut di array `install`:
