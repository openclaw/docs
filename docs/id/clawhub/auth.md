...
x-i18n:
    generated_at: "2026-07-04T18:21:48Z"
    model: gpt-5.5
...
Jika proses masuk mengembalikan Anda ke status keluar, akun Anda mungkin tidak memiliki
...
Gunakan alur ini untuk server, pekerjaan CI, atau lingkungan yang hanya terminal.
