...
x-i18n:
    generated_at: "2026-07-05T08:34:52Z"
    model: gpt-5.5
...
Jika proses masuk mengembalikan Anda ke status keluar, akun Anda mungkin tidak dalam reputasi baik.
...
Gunakan alur ini untuk server, tugas CI, atau lingkungan yang hanya memakai terminal.

Untuk shell jarak jauh yang memungkinkan Anda membuka browser di tempat lain, jalankan:
...
Cetak token tersimpan untuk penyiapan CI dengan:
