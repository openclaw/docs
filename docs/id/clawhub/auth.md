...
4. Browser mengalihkan kembali ke panggilan balik lokal.
5. CLI menyimpan token di file konfigurasi ClawHub Anda.

Jika browser Anda tidak dapat menjangkau panggilan balik lokal karena aturan tembok api, VPN, atau
proksi, gunakan alur token tanpa browser.
