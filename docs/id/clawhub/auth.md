...
x-i18n:
    generated_at: "2026-07-04T04:05:59Z"
    model: gpt-5.5
...
ClawHub menggunakan GitHub untuk masuk ke web. CLI menggunakan token API ClawHub yang dibuat
...
status baik. Jika akun Anda diblokir atau dinonaktifkan, gunakan
[formulir banding ClawHub](https://appeals.openclaw.ai/) jika Anda yakin ini adalah
kesalahan.

## Login CLI

Alur login CLI default membuka peramban Anda:
...
proxy, gunakan alur token tanpa peramban.

## Login tanpa peramban
...
CLI mencetak kode satu kali dan menunggu saat Anda mengotorisasinya di
