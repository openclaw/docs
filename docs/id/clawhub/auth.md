...
Jika proses masuk mengembalikan Anda ke status keluar, akun Anda mungkin tidak berada dalam status
baik.

## Login CLI

Alur login CLI bawaan membuka browser Anda:
...
4. Browser dialihkan kembali ke panggilan balik lokal.
5. CLI menyimpan token di file konfigurasi ClawHub Anda.

Jika browser Anda tidak dapat menjangkau panggilan balik lokal karena firewall, VPN, atau
