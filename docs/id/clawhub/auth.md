...
reputasi baik. Jika akun Anda diblokir atau dinonaktifkan, gunakan
...
4. Browser mengarahkan kembali ke callback lokal.
...
Gunakan alur ini untuk server, job CI, atau lingkungan yang hanya memiliki terminal.

Untuk shell jarak jauh ketika Anda dapat membuka browser di tempat lain, jalankan:
...
Token yang dicabut, tidak valid, atau hilang mengembalikan `401` Tidak Terotorisasi. Masuk lagi
