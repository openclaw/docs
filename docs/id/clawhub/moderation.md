...
x-i18n:
    generated_at: "2026-07-02T08:49:51Z"
    model: gpt-5.5
...
penahanan moderasi. Ketika ini terjadi, konten yang terdampak mungkin disembunyikan dari penemuan
publik atau publikasi berikutnya mungkin mulai dalam keadaan tersembunyi sampai masalah tersebut ditinjau.
...
Sinyal peninjauan temporal terbatas dan dengan keyakinan lebih rendah tetap berada di luar
penegakan otomatis.
