...
x-i18n:
    generated_at: "2026-07-01T20:34:46Z"
    model: gpt-5.5
...
memerlukan guardrail. Laporan, penahanan moderasi, listing tersembunyi, dan tindakan akun
...
Gunakan tombol **Laporkan Skills** pada halaman Skills, atau perintah/API pelaporan paket
untuk paket.

Jangan gunakan laporan ClawHub untuk kerentanan dalam kode sumber milik Skills atau
...
kode Skills atau Plugin pihak ketiga.
...
penahanan moderasi. Ketika ini terjadi, konten yang terdampak mungkin disembunyikan dari
penemuan publik atau publikasi berikutnya mungkin mulai dalam keadaan tersembunyi hingga masalahnya ditinjau.
...
ambang potensi pemblokiran ClawHub dapat memicu peringatan otomatis. Jika pemindaian berikutnya
...
Sinyal tinjauan temporal yang berkeyakinan lebih rendah dan terbatas tidak masuk dalam
penegakan otomatis.
...
Jika email yang dipicu pemindai menyebut versi Skills atau Plugin sebagai berbahaya,
unduh hasil pemindaian yang tersimpan untuk versi yang diajukan dan diblokir:
