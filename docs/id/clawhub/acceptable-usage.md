...
ClawHub menampung Skills, Plugin, paket, dan metadata lokapasar untuk OpenClaw.
Gunakan halaman ini untuk menentukan apakah konten atau perilaku penerbitan pantas berada di
ClawHub.

Aturan ini berlaku pada apa yang dilakukan sebuah listing, apa yang diminta untuk dijalankan oleh pengguna, bagaimana listing itu
...
| Alur kerja UI, data, dan otomatisasi               | Cakupannya jelas, kredensial yang diperlukan dinyatakan secara eksplisit, dan tindakan berisiko menyertakan jalur peninjauan, uji coba kering, pratinjau, atau konfirmasi. |
...
ClawHub tidak menampung konten yang tujuan utamanya adalah penyalahgunaan, penipuan, eksekusi yang tidak aman,
atau pelanggaran hak.

| Kategori                                                    | Tidak diizinkan                                                                                                                                                                                                                                                                                                   |
| ----------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Akses tidak sah atau pengelakan keamanan                      | Pengelakan autentikasi, pengambilalihan akun, penyalahgunaan batas laju, pengambilalihan panggilan langsung atau agen, pencurian sesi yang dapat digunakan kembali, atau alur pemasangan yang disetujui otomatis untuk pengguna yang tidak disetujui.                                                                                                                                                   |
| Penyalahgunaan platform dan pengelakan pemblokiran                              | Akun tersembunyi setelah pemblokiran, pemanasan atau pembiakan akun, keterlibatan palsu, otomatisasi multi-akun, posting massal, bot spam, atau otomatisasi yang dibuat untuk menghindari deteksi.                                                                                                                                          |
...
| Peniruan atau manipulasi identitas tanpa persetujuan       | Tukar wajah, kembaran digital, influencer tiruan, persona palsu, atau alat lain yang digunakan untuk meniru atau menyesatkan.                                                                                                                                                                                                 |
...
| Persyaratan eksekusi tersembunyi, tidak aman, atau menyesatkan        | Perintah instalasi yang dikaburkan, installer pipe-to-shell seperti konten unduhan yang dijalankan dengan `sh` atau `bash` tanpa kemampuan tinjau yang jelas, persyaratan rahasia atau kunci privat yang tidak dinyatakan, eksekusi `npx @latest` jarak jauh tanpa kemampuan tinjau yang jelas, atau metadata yang menyembunyikan apa yang benar-benar diperlukan listing untuk berjalan. |
...
- menggembungkan instalasi, unduhan, bintang, atau metrik keterlibatan lain secara artifisial
  melalui otomatisasi, putaran instalasi mandiri, akun palsu, aktivitas terkoordinasi,
...
Kami tidak menjamin penegakan yang selalu didahului peringatan untuk penyalahgunaan yang jelas. Lihat
