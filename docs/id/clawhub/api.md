...
x-i18n:
    generated_at: "2026-07-04T06:50:18Z"
    model: gpt-5.5
...
Anda dapat membangun katalog pihak ketiga, direktori, atau permukaan pencarian di atas API baca publik ClawHub. Metadata skill publik dan file skill diterbitkan berdasarkan aturan lisensi skill ClawHub, sementara API itu sendiri dibatasi lajunya dan harus digunakan secara bertanggung jawab.
...
- Error v1 berupa teks polos (`text/plain; charset=utf-8`), termasuk `400`,
