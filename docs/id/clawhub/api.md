...
Anda dapat membangun katalog, direktori, atau permukaan pencarian pihak ketiga di atas API baca publik ClawHub. Metadata skill publik dan file skill dipublikasikan berdasarkan aturan lisensi skill ClawHub, sedangkan API itu sendiri dibatasi lajunya dan harus digunakan secara bertanggung jawab.
...
- `RateLimit-Reset`: detik penundaan sampai reset
- `X-RateLimit-Remaining` / `RateLimit-Remaining`: sisa anggaran persis saat
  ada; permintaan sukses yang di-shard menghilangkannya alih-alih mengembalikan
