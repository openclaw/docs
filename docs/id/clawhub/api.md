...
x-i18n:
    generated_at: "2026-07-03T23:42:57Z"
    model: gpt-5.5
...
Anda dapat membangun katalog, direktori, atau permukaan pencarian pihak ketiga di atas API baca publik ClawHub. Metadata skill publik dan file skill diterbitkan berdasarkan aturan lisensi skill ClawHub, sementara API itu sendiri memiliki pembatasan laju dan harus digunakan secara bertanggung jawab.

Panduan:

- Gunakan endpoint baca publik seperti `GET /api/v1/skills`, `GET /api/v1/search`, dan `GET /api/v1/skills/{slug}` untuk daftar katalog.
- Cache respons dan patuhi header `429`, `Retry-After`, dan pembatasan laju alih-alih melakukan polling secara agresif.
...
- Token yang hilang/tidak valid beralih ke penegakan IP.
...
- Galat v1 berupa teks biasa (`text/plain; charset=utf-8`), termasuk respons `400`,
...
- `GET /api/v1/skills?limit=&cursor=&sort=`
  ...
  - `recommended` menggunakan sinyal keterlibatan dan keterbaruan.
...
- `GET /api/v1/skills/export?startDate=&endDate=&limit=&cursor=`
  - Skills yang di-host diekspor sebagai file yang disimpan.
