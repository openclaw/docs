...
- Baca publik: token tidak diperlukan.
...
- Prioritaskan `Retry-After` saat tersedia.
...
- `POST /api/v1/users/reserve` mencadangkan slug root dan placeholder package privat tanpa rilis untuk handle pemilik.
