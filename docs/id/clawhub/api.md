...
summary: Gambaran umum dan konvensi Public REST API (v1).
x-i18n:
    generated_at: "2026-07-05T08:33:23Z"
    model: gpt-5.5
...
- Simpan respons dalam cache dan patuhi header `429`, `Retry-After`, dan batas laju alih-alih melakukan polling secara agresif.
...
- Kesalahan v1 adalah teks biasa (`text/plain; charset=utf-8`), termasuk `400`,
