...
Penegakan berbasis autentikasi:
...
- `GET /api/v1/skills?limit=&cursor=&sort=`
  ...
  - Alias legacy: `nonSuspicious=true`
  - Dengan `nonSuspiciousOnly=true`, halaman berbasis kursor mungkin berisi item lebih sedikit dari `limit`; gunakan `nextCursor` untuk melanjutkan.
