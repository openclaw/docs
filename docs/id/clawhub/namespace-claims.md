...
x-i18n:
    generated_at: "2026-07-04T04:06:03Z"
    model: gpt-5.5
...
scope paket sebagai namespace publik. Jika sebuah namespace tampak milik
...
- kontrol scope registry paket npm, PyPI, crates.io, atau registry paket lainnya
...
Jangan menaruh rahasia atau bukti privat dalam isu GitHub publik. Jangan sertakan:
...
Staf mempertimbangkan bukti publik, penggunaan yang sudah ada, risiko keamanan, dan dampak pengguna.
