...
summary: Cara meminta peninjauan ClawHub untuk sengketa kepemilikan organisasi, merek, nama pengguna pemilik, cakupan paket, slug skill, atau ruang nama.
title: Klaim Organisasi dan Namespace
x-i18n:
    generated_at: "2026-07-02T14:11:32Z"
    model: gpt-5.5
...
cakupan paket sebagai namespace publik. Jika sebuah namespace tampak dimiliki
oleh proyek dunia nyata, merek, ekosistem paket, atau organisasi tetapi sudah
...
Pertama konfirmasikan bahwa Anda menerbitkan dengan pemilik yang cocok dengan namespace.
...
- dokumen proyek resmi yang menyebutkan namespace
