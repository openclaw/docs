...
x-i18n:
    generated_at: "2026-07-04T06:51:02Z"
    model: gpt-5.5
...
Buka klaim namespace ketika Anda meyakini staf ClawHub perlu meninjau apakah sebuah
namespace harus dicadangkan, dialihkan, diganti namanya, disembunyikan, dikarantina, diberi alias,
atau diubah dengan cara lain karena kepemilikan nyata.
...
Pertama, pastikan Anda memublikasikan dengan pemilik yang cocok dengan namespace.
...
- kendali scope registri paket npm, PyPI, crates.io, atau lainnya
- bukti kepemilikan merek dagang, merek, atau proyek yang aman dibahas
  secara publik
