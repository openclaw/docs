...
summary: Cara meminta tinjauan ClawHub untuk sengketa kepemilikan organisasi, merek, handle pemilik, cakupan paket, slug keterampilan, atau ruang nama.
title: Klaim Organisasi dan Namespace
x-i18n:
    generated_at: "2026-07-04T11:02:35Z"
    model: gpt-5.5
...
scope paket sebagai namespace publik. Jika suatu namespace tampak menjadi milik
...
[formulir masalah Klaim Org / Namespace](https://github.com/openclaw/clawhub/issues/new?template=org-namespace-claim.yml).
...
- scope paket seperti `@example-org/*` yang seharusnya hanya menerbitkan di bawah
...
- pemilik yang dihapus, tidak aktif, atau tidak dapat dihubungi yang memblokir pemilik namespace
  yang sah
...
- kontrol scope registry paket npm, PyPI, crates.io, atau lainnya
...
Jangan menaruh rahasia atau bukti pribadi dalam masalah GitHub publik. Jangan sertakan:
