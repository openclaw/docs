...
x-i18n:
    generated_at: "2026-07-04T04:06:36Z"
    model: gpt-5.5
...
| `Review`    | Baca temuan sebelum menginstal. Rilis mungkin tetap sah.                  |
...
`Pass` memberi rasa aman, tetapi tidak menggantikan pertimbangan Anda sendiri. Ini paling penting
...
tidak berarti keterampilan tersebut berbahaya. Artinya keterampilan tersebut tampak selaras dengan tujuan, tetapi dapat
...
sinyal reputasi yang melengkapi peninjauan ClawHub yang memahami agen. Saat jumlah mesin vendor
...
sendiri. Sistem ini meninjau setiap rilis sebagai artefak yang dihadapkan ke agen: instruksi,
metadata, izin yang dideklarasikan, file, sinyal kemampuan, sinyal pemindaian statis,
...
ClawScan tidak menganggap kemampuan yang tampak menakutkan sebagai otomatis berbahaya.
ClawScan menanyakan apakah kemampuan tersebut diungkapkan, selaras dengan tujuan, dan didukung oleh
