...
x-i18n:
    generated_at: "2026-06-30T14:27:01Z"
    model: gpt-5.5
...
bebas risiko. Selalu gunakan pertimbangan Anda sebelum memberikan akses sensitif.
...
`Pass` memang meyakinkan, tetapi tidak menggantikan pertimbangan Anda sendiri. Ini paling penting
...
sinyal reputasi yang melengkapi peninjauan sadar-agen ClawHub. Saat jumlah engine vendor
...
Saat ClawHub tidak memiliki telemetri jumlah vendor untuk dirangkum, audit mengatakan:

```text
No VirusTotal findings
```

VirusTotal tetap berupa telemetri. Ini tidak menggantikan analisis risiko sadar-artefak
milik ClawHub sendiri.

## Analisis risiko

Analisis risiko secara internal didukung oleh ClawScan, sistem audit keamanan milik ClawHub
...
bagian audit publik mandiri atau putusan pemblokiran instalasi.
...
kasus penggunaan yang dinyatakan rilis.
