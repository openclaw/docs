...
x-i18n:
    generated_at: "2026-07-04T18:22:44Z"
    model: gpt-5.5
...
`Pass` memberi keyakinan, tetapi tidak menggantikan penilaian Anda sendiri. Ini paling penting
...
Misalnya, sebuah skill penerbitan dapat menampilkan `Review` dengan risiko `Medium`. Itu
...
Temuan dengan tingkat keyakinan rendah disembunyikan dari ringkasan audit publik sehingga halaman
...
dan konten sebenarnya selaras dengan apa yang secara wajar diharapkan pengguna?
...
VirusTotal sangat berguna untuk artefak berbahaya yang dikenal, hit mesin, dan
sinyal reputasi yang melengkapi peninjauan ClawHub yang sadar agen. Ketika jumlah mesin
vendor tersedia, audit merangkumnya dalam bahasa yang jelas, seperti:
...
VirusTotal tetap berupa telemetri. Itu tidak menggantikan analisis risiko ClawHub sendiri
yang sadar artefak.

## Analisis risiko

Analisis risiko didukung secara internal oleh ClawScan, sistem audit keamanan ClawHub sendiri.
