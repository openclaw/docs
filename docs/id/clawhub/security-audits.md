...
Audit keamanan ClawHub membantu Anda memutuskan apakah keterampilan atau Plugin cukup aman untuk
diinstal. Audit ini menunjukkan apa yang dilakukan sebuah rilis, kewenangan apa yang dimintanya, dan
apakah ada hal yang perlu mendapat perhatian tambahan sebelum dapat mengakses file, akun,
...
## Apa yang harus diperiksa sebelum menginstal
...
| Tingkat risiko | Arti                                                                       |
| ---------- | ----------------------------------------------------------------------------- |
| `Low`      | Hanya sedikit kewenangan sensitif atau dampak pengguna yang ditemukan.         |
| `Medium`   | Rilis memiliki kewenangan berarti, seperti akses akun atau perubahan data.     |
