...
x-i18n:
    generated_at: "2026-07-01T20:35:45Z"
    model: gpt-5.5
...
Tingkat risiko menggambarkan cakupan dampak: seberapa besar kuasa yang tampaknya dimiliki rilis tersebut jika
...
perintah lokal, API penyedia, atau instalasi paket. Audit memeriksa apakah
...
Sistem ini meninjau setiap rilis sebagai artefak yang dihadapkan ke agen: instruksi,
