...
x-i18n:
    generated_at: "2026-07-02T22:48:40Z"
    model: gpt-5.5
...
untuk dipasang. Audit ini menunjukkan apa yang dilakukan sebuah rilis, kewenangan apa yang dimintanya, dan
...
| `Review`    | Baca temuannya sebelum memasang. Rilis tersebut mungkin tetap sah.        |
...
`Pass` memang meyakinkan, tetapi tidak menggantikan penilaian Anda sendiri. Ini paling penting
untuk alat yang dapat menerbitkan konten, mengedit data, menjalankan perintah, membaca file, atau
mengakses sistem produksi.

## Tingkat risiko

Tingkat risiko menggambarkan blast radius: seberapa besar kuasa yang tampaknya dimiliki rilis tersebut jika
Anda menggunakannya sebagaimana dimaksud.

| Tingkat risiko | Arti                                                                    |
| --------------- | ----------------------------------------------------------------------- |
| `Low`           | Sedikit kewenangan sensitif atau dampak pengguna yang ditemukan.        |
| `Medium`        | Rilis memiliki kewenangan bermakna, seperti akses akun atau perubahan data. |
| `High`          | Rilis memiliki kewenangan berdampak tinggi, temuan berat, atau sinyal berbahaya. |
...
tidak berarti skill tersebut berbahaya. Artinya skill tersebut tampaknya selaras dengan tujuan, tetapi dapat
...
dan konten aktual selaras dengan apa yang secara wajar akan diharapkan pengguna?
...
Sistem ini meninjau setiap rilis sebagai artefak yang berhadapan dengan agen: instruksi,
...
eksekusi tidak aman, peracunan memori atau konteks, dan keagenan berlebihan.

ClawScan tidak menganggap kapabilitas yang terlihat menakutkan sebagai otomatis berbahaya.
