...
summary: Cara memahami hasil audit keamanan ClawHub sebelum memasang keterampilan atau Plugin.
...
Tingkat risiko menjelaskan radius dampak: seberapa besar kekuasaan yang tampaknya dimiliki rilis jika
...
- Tingkat risiko bertanya: "Seberapa besar kekuasaan di sini?"
...
Pertanyaan utamanya adalah koherensi: apakah nama, ringkasan, metadata, otoritas
yang diminta, dan konten aktual selaras dengan hal yang secara wajar diharapkan
pengguna?
...
VirusTotal sangat berguna untuk artefak berbahaya yang sudah dikenal, temuan engine, dan
sinyal reputasi yang melengkapi tinjauan ClawHub yang sadar agen. Ketika jumlah
engine vendor tersedia, audit merangkumnya dalam bahasa sederhana, seperti:
...
VirusTotal tetap merupakan telemetri. Ini tidak menggantikan analisis risiko
ClawHub sendiri yang sadar artefak.

## Analisis risiko

Analisis risiko didukung secara internal oleh ClawScan, sistem audit keamanan
milik ClawHub. Sistem ini meninjau setiap rilis sebagai artefak yang dihadapkan ke agen:
instruksi, metadata, izin yang dideklarasikan, file, sinyal kapabilitas, sinyal pemindaian statis,
...
bagian audit publik tersendiri atau putusan yang memblokir pemasangan.
...
ClawScan tidak memperlakukan kapabilitas yang tampak menakutkan sebagai sesuatu yang otomatis berbahaya.
