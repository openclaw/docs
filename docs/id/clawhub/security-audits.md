...
read_when:
    ...
    - Memutuskan apakah akan menginstal Skills atau Plugin
...
untuk diinstal. Audit ini menunjukkan apa yang dilakukan sebuah rilis, wewenang apa yang dimintanya, dan
...
| Tingkat risiko | Arti                                                                      |
| ---------- | ----------------------------------------------------------------------------- |
| `Low`      | Sedikit wewenang sensitif atau dampak pengguna yang ditemukan.                 |
...
sinyal reputasi yang melengkapi peninjauan ClawHub yang mempertimbangkan agen. Ketika jumlah
