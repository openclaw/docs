...
read_when:
    ...
    - Menentukan apakah akan memasang skill atau plugin
...
x-i18n:
    generated_at: "2026-07-03T09:59:29Z"
    model: gpt-5.5
...
`Pass` memberi rasa aman, tetapi tidak menggantikan pertimbangan Anda sendiri. Ini penting
terutama untuk alat yang dapat menerbitkan konten, mengedit data, menjalankan perintah, membaca file, atau
...
Misalnya, keterampilan publikasi dapat menampilkan `Review` dengan risiko `Medium`. Itu
...
kemitraan kami memungkinkan ClawHub menambahkan kecerdasan keamanan yang lebih luas ke peninjauan
keterampilan dan plugin.

VirusTotal sangat berguna untuk artefak berbahaya yang sudah dikenal, deteksi mesin, dan
sinyal reputasi yang melengkapi peninjauan ClawHub yang sadar agen. Ketika jumlah
...
ClawHub sendiri. Sistem ini meninjau setiap rilis sebagai artefak yang menghadap agen: instruksi,
...
eksekusi yang tidak aman, peracunan memori atau konteks, dan agensi yang berlebihan.
