...
summary: Cara memahami hasil audit keamanan ClawHub sebelum memasang Skills atau Plugin.
title: Audit Keamanan
x-i18n:
    generated_at: "2026-07-01T08:30:16Z"
    model: gpt-5.5
...
untuk diinstal. Audit ini menunjukkan apa yang dilakukan sebuah rilis, kewenangan apa yang dimintanya, dan
...
Audit adalah sinyal keamanan yang kuat, tetapi bukan jaminan bahwa suatu rilis
...
| `Review`    | Baca temuan sebelum menginstal. Rilis ini mungkin masih sah.              |
| `Warn`      | Gunakan kewaspadaan ekstra. ClawHub menemukan masalah berdampak tinggi atau sinyal peringatan. |
| `Malicious` | Jangan instal.                                                            |
| `Pending`   | Audit belum selesai.                                                      |
| `Error`     | Audit tidak dapat diselesaikan.                                           |

`Pass` memberi rasa aman, tetapi tidak menggantikan penilaian Anda sendiri. Ini paling penting
...
| Tingkat risiko | Arti                                                                      |
| --------------- | ------------------------------------------------------------------------- |
| `Low`           | Ditemukan sedikit kewenangan sensitif atau dampak pengguna.               |
| `Medium`        | Rilis memiliki kewenangan bermakna, seperti akses akun atau perubahan data. |
...
bertindak dengan kewenangan akun yang bermakna.
...
dan konten sebenarnya sejalan dengan apa yang wajar diharapkan pengguna?

Perilaku yang kuat tidak otomatis buruk. Banyak alat berguna memerlukan kredensial,
perintah lokal, API penyedia, atau instalasi paket. Audit memeriksa apakah kekuasaan tersebut
...
sinyal reputasi yang melengkapi peninjauan ClawHub yang sadar agen. Ketika jumlah mesin vendor
...
Analisis risiko ditenagai secara internal oleh ClawScan, sistem audit keamanan milik ClawHub sendiri.
Sistem ini meninjau setiap rilis sebagai artefak yang ditujukan untuk agen: instruksi,
...
ClawScan tidak menganggap kapabilitas yang tampak menakutkan sebagai otomatis berbahaya.
Sistem ini menanyakan apakah kapabilitas tersebut diungkapkan, selaras dengan tujuan, dan didukung oleh
