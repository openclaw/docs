...
x-i18n:
    generated_at: "2026-07-02T01:15:43Z"
    model: gpt-5.5
...
| `Warn`      | Gunakan kewaspadaan ekstra. ClawHub menemukan kekhawatiran berdampak tinggi atau sinyal peringatan. |
...
untuk alat yang dapat memublikasikan konten, mengedit data, menjalankan perintah, membaca berkas, atau
...
| Tingkat risiko | Arti                                                                          |
| -------------- | ----------------------------------------------------------------------------- |
| `Low`          | Hanya sedikit otoritas sensitif atau dampak pengguna yang ditemukan.          |
...
tidak berarti skill tersebut berbahaya. Itu berarti skill tampaknya selaras dengan tujuan, tetapi dapat
...
ClawHub menggunakan VirusTotal sebagai telemetri malware dalam stack audit. VirusTotal adalah
...
VirusTotal sangat berguna untuk artefak berbahaya yang sudah dikenal, hasil deteksi mesin, dan
