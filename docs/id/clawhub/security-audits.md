...
x-i18n:
    generated_at: "2026-07-04T15:35:16Z"
    model: gpt-5.5
...
| `Review`    | Baca temuan sebelum menginstal. Rilis tersebut mungkin masih sah.         |
...
Tingkat risiko menjelaskan blast radius: seberapa besar kuasa yang tampaknya dimiliki rilis jika
