...
untuk diinstal. Audit ini menunjukkan apa yang dilakukan suatu rilis, otoritas apa yang dimintanya, dan
...
Tingkat risiko menjelaskan radius dampak: seberapa besar kuasa yang tampaknya dimiliki rilis
jika Anda menggunakannya sebagaimana dimaksudkan.

| Tingkat risiko | Arti                                                                         |
| --------------- | ----------------------------------------------------------------------------- |
| `Low`           | Hanya sedikit otoritas sensitif atau dampak pengguna yang ditemukan.          |
| `Medium`        | Rilis memiliki otoritas berarti, seperti akses akun atau perubahan data.      |
...
VirusTotal sangat berguna untuk artefak berbahaya yang diketahui, temuan mesin, dan
...
sendiri. Sistem ini meninjau setiap rilis sebagai artefak yang menghadap agen: instruksi,
...
bagian audit publik mandiri atau vonis pemblokir instalasi.
