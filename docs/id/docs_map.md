...
title: Peta dokumen
x-i18n:
    generated_at: "2026-07-02T01:15:59Z"
    model: gpt-5.5
...
File ini dibuat dari heading `docs/**/*.md` dan `docs/**/*.mdx` untuk membantu agen menavigasi pohon dokumentasi.
...
- Heading:
  ...
  - H3: Penyiapan wizard (disarankan)
...
- Heading:
  - H2: Kapan menggunakan Alur Tugas
...
- Heading:
  ...
  - H2: Grup referensi dari daftar izin
...
- Heading:
  - H2: Penyiapan cepat
  - H2: Disarankan: Siapkan workspace guild
  - H2: Model runtime
  - H2: Kanal forum
...
- Heading:
  ...
  - H3: Opsi A: Tailscale Funnel (Disarankan)
...
- Heading:
  ...
  - H2: Balasan terlihat
  - H2: Visibilitas konteks dan daftar izin
  - H2: Kunci sesi
  - H2: Pola: DM pribadi + grup publik (satu agen)
  - H2: Label tampilan
  - H2: Kebijakan grup
  - H2: Gerbang mention (default)
  - H2: Pola mention yang dikonfigurasi cakupan
...
- Heading:
  ...
  - H2: Pemasangan, sesi, dan pengikatan ACP
...
- Heading:
  ...
  - H2: Catatan keamanan (disarankan untuk kanal publik)
...
- Judul:
  ...
  - H3: Bootstrap atau perbaiki penandatanganan silang
  ...
  - H3: Pengutasan balasan (threadReplies)
  - H3: Pewarisan utas dan perintah garis miring
  - H2: Pengikatan percakapan ACP
  ...
  - H2: Memproksikan lalu lintas Matrix
  - H2: Resolusi target
  - H2: Referensi konfigurasi
  - H3: Akun dan koneksi
  - H3: Enkripsi
  ...
  - H3: Perkakas dan override per ruang
...
- Judul:
  - H2: Instal
  - H2: Penyiapan cepat
  - H2: Perintah garis miring native
  - H2: Variabel lingkungan (akun default)
  - H2: Mode chat
  - H2: Pengutasan dan sesi
  - H2: Kontrol akses (DM)
  - H2: Saluran (grup)
...
- Judul:
  ...
  - H2: Contoh manifest Teams (diredaksi)
  ...
  - H3: RSC vs Graph API
  - H2: Media + riwayat yang diaktifkan Graph (wajib untuk saluran)
  ...
  - H2: Format target
  - H2: Pesan proaktif
  - H2: ID Tim dan Saluran (Kesalahan Umum)
  - H2: Saluran privat
  - H2: Pemecahan masalah
  - H3: Masalah umum
...
- Judul:
  - H2: 1) Pemasangan DM (akses chat masuk)
  - H3: Setujui pengirim
  - H3: Grup pengirim yang dapat digunakan ulang
  - H3: Tempat status disimpan
  - H2: 2) Pemasangan perangkat Node (node iOS/Android/macOS/headless)
  - H3: Pasangkan melalui Telegram (direkomendasikan untuk iOS)
  - H3: Setujui perangkat node
  - H3: Persetujuan otomatis node trusted-CIDR opsional
  - H3: Penyimpanan status pemasangan Node
  - H3: Catatan
  - H2: Dokumen terkait
...
- Judul:
  ...
  - H2: Kontrol akses dan perutean
  - H2: Pengutasan, sesi, dan tag balasan
  - H2: Reaksi ack
  ...
  - H2: Perintah dan perilaku garis miring
...
- Judul:
  ...
  - H3: Tidak ada permintaan pemasangan yang muncul
...
- Judul:
  ...
  - H2: Alat, tindakan, dan penulisan konfig
  - H2: Pemecahan masalah
  - H2: Prompt sistem
  - H2: Penunjuk referensi konfigurasi
  - H2: Terkait
...
- Judul:
  ...
  - H3: 2) Konfigurasikan token (env atau konfig)
  - H2: Cara kerjanya (perilaku)
  - H2: Batas
  - H2: Kontrol akses (DM)
  - H3: Akses DM
...
- Judul:
  ...
  - H2: Instalasi manual
  - H3: 1. Instal Plugin
  - H3: 2. Aktifkan Plugin di konfig
...
- Judul:
  ...
  - H2: Gerbang pemeriksaan lokal dan perutean perubahan
  - H2: Validasi Testbox
  - H2: Terkait
...
- Judul:
  - H1: openclaw backup
  - H2: Catatan
  - H2: Apa saja yang dicadangkan
  - H2: Perilaku konfig tidak valid
...
- Judul:
  ...
  - H2: Opsi umum
  - H2: Catatan
  - H2: Checklist pemulihan drift token
  - H2: Terkait
...
- Rute: /cli/infer
- Judul:
  - H2: Jadikan infer sebagai skill
...
- Judul:
  ...
  - H3: Alur kerja OAuth
  - H3: Transport HTTP yang dapat distream
  - H2: UI Kontrol
  - H2: Batas saat ini
  - H2: Terkait
...
- Judul:
  ...
  - H2: Mengapa tidak ada backup rollback
  - H2: Contoh
  - H2: Terkait
...
- Judul:
  ...
  - H2: Backup Git (direkomendasikan, privat)
  - H2: Jangan commit secret
...
- Judul:
  ...
  - H3: Flush memori
  - H2: Penyedia Compaction yang dapat di-plugin
...
- Judul:
  ...
  - H2: Sesi, Compaction, dan pruning (yang dipertahankan)
...
- Judul:
  ...
  - H2: Hal umum yang perlu diwaspadai
  - H2: Terkait
...
- Judul:
  - H2: Yang ditambahkannya dibanding builtin
  - H2: Memulai
  - H3: Prasyarat
  - H3: Aktifkan
...
- Judul:
  ...
  - H3: Fase 3: Jembatan Inbound Channel
  - H3: Fase 4: Jembatan Dispatcher yang Disiapkan
...
- Judul:
  ...
  - H2: Override sesi dan peralihan model live
...
- Judul:
  ...
  - H3: Opsi hosted gaya langganan lainnya
  - H3: OpenCode
...
- Judul:
  ...
  - H2: Beralih model dalam chat (/model)
  - H2: Perintah CLI
  - H3: models list
  - H3: models status
...
- Rute: /concepts/oauth
- Judul:
  - H2: Sink token (alasan keberadaannya)
...
- Judul:
  ...
  - H2: Template kontrak jalur minimal
  - H2: Terkait
...
- Judul:
  - H2: Bidang presence (yang ditampilkan)
  - H2: Penghasil (asal presence)
  - H3: 1) Entri mandiri Gateway
  - H3: 2) Koneksi WebSocket
  - H4: Mengapa perintah CLI sekali jalan tidak ditampilkan
  - H3: 3) Beacon system-event
  - H3: 4) Node terhubung (peran: node)
  - H2: Aturan penggabungan + dedupe (mengapa instanceId penting)
...
- Judul:
  ...
  - H2: Jeda mirip manusia antarblok
...
- Judul:
  - H2: Tiga permukaan timezone
  - H2: Mengatur timezone pengguna
...
- Judul:
  ...
  - H2: Cara schema digunakan saat runtime
  - H2: Contoh frame
  ...
  - H2: Pola dan konvensi schema
  - H2: JSON schema live
  - H2: Saat Anda mengubah schema
  - H2: Terkait
...
- Judul:
  ...
  - H3: Perilaku toggle
  - H3: Konfigurasi
  - H2: Footer /usage lengkap kustom
  - H3: Bentuk
  - H3: Jalur kontrak
  - H3: Verba
  - H3: Bentuk bagian
...
- Judul:
  ...
  - H3: Konfigurasikan timezone pengguna + format
  - H2: Deteksi format waktu (otomatis)
  - H2: Payload tool + konektor (waktu provider mentah + bidang ternormalisasi)
  - H2: Dokumen terkait
...
- Judul:
  - H2: Setup yang direkomendasikan (API key, provider apa pun)
  - H2: Anthropic: kompatibilitas CLI Claude dan token
  ...
  - H3: OpenAI dan id legacy openai-codex
  - H3: Saat login (CLI)
...
- Judul:
  ...
  - H3: Setup server DNS satu kali (host gateway)
...
- Judul:
  ...
  - H3: Peta kepemilikan budget konteks
...
- Judul:
  ...
  - H2: Sertaan konfigurasi ($include)
  - H2: Terkait
...
- Judul:
  ...
  - H3: Mode reload
  - H3: Yang diterapkan panas vs yang perlu restart
...
- Judul:
  ...
  - H3: Konfigurasi hibrida: utama terhosting, fallback lokal
  - H3: Utamakan lokal dengan jaring pengaman terhosting
  - H3: Hosting regional / perutean data
  - H2: Proksi lokal kompatibel OpenAI lainnya
...
- Judul:
  ...
  - H2: Presence
  - H3: Peristiwa hidup latar belakang Node
...
- Judul:
  ...
  - H3: Langkah 3: Konfigurasikan Auth Gateway Jarak Jauh
...
- Judul:
  ...
  - H3: Mount bind (pemeriksaan cepat keamanan)
  ...
  - H3: "Saya kira ini main, mengapa di-sandbox?"
  - H2: Terkait
...
- Judul:
  ...
  - H2: Plugin
  - H2: Model akses DM: pairing, allowlist, open, disabled
  - H2: Isolasi sesi DM (mode multi-pengguna)
  - H3: Mode DM aman (direkomendasikan)
  - H2: Daftar izin untuk DM dan grup
  ...
  - H3: Backend LLM yang dihosting sendiri
  ...
  - H2: Respons insiden
  - H3: Batasi
  - H3: Rotasi (anggap kompromi jika secrets bocor)
  - H3: Audit
...
- Judul:
  - H2: Tangga perintah
  - H2: Setelah pembaruan
  - H2: Instalasi split brain dan guard konfigurasi lebih baru
  - H2: Ketidakcocokan protokol setelah rollback
  - H2: Symlink Skill dilewati sebagai path escape
  - H2: Anthropic 429 penggunaan ekstra diperlukan untuk konteks panjang
  ...
  - H2: Gateway macOS diam-diam berhenti merespons, lalu lanjut saat Anda menyentuh dashboard
...
- Judul:
  - H2: Model: default, pemilihan, alias, berpindah
...
- Judul:
  ...
  - H2: Lokasi hal-hal berada di disk
...
- Judul:
  - H2: Langsung: perintah uji smoke lokal
  - H2: Langsung: pemeriksaan menyeluruh kemampuan node Android
  - H2: Langsung: uji smoke model (kunci profil)
  - H3: Lapisan 1: Penyelesaian model langsung (tanpa gateway)
  - H3: Lapisan 2: Gateway + uji smoke agen pengembang (apa yang sebenarnya dilakukan "@openclaw")
  - H2: Langsung: uji smoke backend CLI (Claude, Gemini, atau CLI lokal lainnya)
  - H2: Langsung: keterjangkauan proksi HTTP/2 APNs
  - H2: Langsung: uji smoke pengikatan ACP (/acp spawn ... --bind here)
  - H2: Langsung: uji smoke harness server aplikasi Codex
  - H3: Resep langsung yang direkomendasikan
  - H2: Langsung: matriks model (cakupan kami)
  - H3: Set uji smoke modern (pemanggilan alat + gambar)
  - H3: Dasar: pemanggilan alat (Baca + Exec opsional)
  - H3: Visi: pengiriman gambar (lampiran → pesan multimodal)
  - H3: Agregator / gateway alternatif
  - H2: Kredensial (jangan pernah commit)
  - H2: Deepgram langsung (transkripsi audio)
  - H2: Rencana pengodean BytePlus langsung
  - H2: Media alur kerja ComfyUI langsung
  - H2: Pembuatan gambar langsung
  - H2: Pembuatan musik langsung
  - H2: Pembuatan video langsung
  - H2: Harness media langsung
  - H2: Terkait
...
- Judul:
  ...
  - H3: E2E (agregat repo)
  - H3: E2E (uji smoke gateway)
  - H3: E2E (peramban Control UI tiruan)
  - H3: E2E: uji smoke backend OpenShell
...
- Judul:
  ...
  - H2: Backend lokal kompatibel OpenAI berfungsi langsung tetapi gagal di OpenClaw
...
- Judul:
  - H2: Sertakan biner yang diperlukan ke dalam image
...
- Judul:
  ...
  - H2: 4) Siapkan nginx untuk memproksikan OpenClaw ke port 8000
...
- Judul:
  ...
  - H3: Kontainer dan pengelola paket
...
- Judul:
  ...
  - H2: Pemecahan masalah
  - H3: Layanan tidak akan berjalan
...
- Judul:
  ...
  - H3: Khusus penyedia dengan gating cakupan
  - H3: Khusus penyedia (Deepgram)
  - H3: Khusus penyedia (Mistral Voxtral)
  - H3: Khusus penyedia (SenseAudio)
...
- Judul:
  ...
  - H2: Batasan desain
  - H3: Codex app-server tetap menjadi kanonis untuk state thread native
  - H3: Assembly context engine harus diproyeksikan ke input Codex
  - H3: Stabilitas prompt-cache penting
  - H3: Semantik pemilihan runtime tidak berubah
  - H2: Rencana implementasi
  - H3: 1. Ekspor atau relokasi helper attempt context-engine yang dapat digunakan ulang
  ...
  - H3: 6. Hubungkan post-turn setelah mirroring transkrip
  - H3: 7. Normalisasi usage dan konteks runtime prompt-cache
...
- Tajuk:
  ...
  - H2: Mode kegagalan overlay lekat (sebelumnya)
...
- Tajuk:
  ...
  - H2: Checklist file
  - H2: Contoh kerja: generasi gambar
...
- Tajuk:
  ...
  - H2: Konvensi impor
  - H2: Checklist sebelum pengajuan
...
- Tajuk:
  ...
  - H2: Izin native dan elicitations MCP
...
- Judul:
  ...
  - H3: Tidak ada Node terhubung yang mendukung Google Meet
...
- Judul:
  ...
  - H2: Contoh minimal
  - H2: Contoh lengkap
  - H2: Referensi bidang tingkat atas
...
- Judul:
  ...
  - H2: Pin pengiriman
  - H2: Daftar periksa pembuat Plugin
  - H2: Dokumentasi terkait
...
- Judul:
  ...
  - H2: Persetujuan dan kapabilitas channel
  - H2: Kebijakan mention inbound
...
- Judul:
  ...
  - H2: API registrasi
  - H3: Registrasi kapabilitas
  - H3: Tool dan perintah
  - H3: Infrastruktur
  - H3: Hook host untuk plugin alur kerja
  - H3: Registrasi penemuan Gateway
  - H3: Metadata registrasi CLI
  - H3: Registrasi backend CLI
  - H3: Slot eksklusif
  - H3: Adapter embedding memori yang sudah tidak digunakan
...
- Judul:
  ...
  - H2: Field api level teratas lainnya
  - H2: Terkait
...
- Judul:
  ...
  - H2: Entri setup
  - H3: Impor helper setup sempit
  - H3: Promosi akun tunggal milik channel
  - H2: Skema config
  - H3: Membangun skema config channel
  - H2: Wizard setup
  - H2: Menerbitkan dan menginstal
  - H2: Terkait
...
- Judul:
  - H2: Entri Plugin
  - H3: Helper kompatibilitas dan pengujian yang sudah tidak digunakan
...
- Judul:
  ...
  - H3: Tool tidak muncul setelah instal
  - H2: Lihat juga
...
- Judul:
  ...
  - H3: Prompt dan siklus hidup worker
...
- Judul:
  ...
  - H2: Konfigurasi
  - H2: Suara
  - H3: Pengesampingan suara per pesan
  - H2: Output
...
- Judul:
  ...
  - H2: Embedding memori
  - H2: Memulai
  - H2: Autentikasi app-server Codex native
  - H2: Pembuatan gambar
  - H2: Pembuatan video
...
- Judul:
  ...
  - H3: Fase 3: Reaping Startup yang Mengutamakan Lease
...
- Judul:
  - H1: Refactor State yang Mengutamakan Database
  - H2: Keputusan
  - H2: Kontrak Keras
...
- Judul:
  - H2: Menjalankan pertama kali (direkomendasikan)
  ...
  - H2: Alat dan Skills
  - H2: Kiat pencadangan (direkomendasikan)
...
- Judul:
  - H2: Penamaan versi
  - H2: Irama rilis
  - H2: Checklist operator rilis
  - H2: Closeout main stabil
  - H2: Preflight rilis
...
- Judul:
  ...
  - H2: Fitur yang dapat memakai kunci berbayar
  ...
  - H3: 5) Alat fetch web (Firecrawl)
  - H3: 6) Snapshot penggunaan penyedia (status/kesehatan)
  - H3: 7) Perangkuman safeguard Compaction
...
- Judul:
  ...
  - H2: Slice pertama yang direkomendasikan
...
- Judul:
  ...
  - H3: Aturan serialisasi scope
  - H3: Prompt
  - H3: Pembersihan
  - H3: Checklist pengujian
  - H2: API output
  - H2: Katalog alat
...
- Judul:
  - H1: Konvensi placeholder secret
...
- Judul:
  ...
  - H2: Kapan Compaction otomatis terjadi (runtime OpenClaw)
  - H2: Pengaturan Compaction (reserveTokens, keepRecentTokens)
  - H2: Penyedia Compaction pluggable
  - H2: Surface yang terlihat pengguna
  - H2: Housekeeping senyap (NOREPLY)
  - H2: "Memory flush" pra-Compaction (diimplementasikan)
  - H2: Checklist pemecahan masalah
  - H2: Terkait
...
- Judul:
  ...
  - H2: Menjalankan pertama kali (sekali saja)
  - H2: Kiat pencadangan (direkomendasikan)
  - H2: Default keselamatan
  - H2: Preflight solusi yang ada
...
- Judul:
  ...
  - H3: Contoh: pertahankan cache 1 jam tetap hangat dengan Heartbeat
  - H3: Contoh: lalu lintas campuran dengan strategi cache per agen
  - H3: Konteks Anthropic 1M
  - H2: Kiat untuk mengurangi tekanan token
  - H2: Terkait
...
- Judul:
  ...
  - H3: Isolasi routing/session-key
...
- Judul:
  - H1: Kisah OpenClaw 🦞📖
  - H2: Kisah Asal
  - H2: Pergantian Cangkang Pertama (27 Januari 2026)
  - H2: Nama
  - H2: Dalek vs Lobster
  - H2: Tokoh Utama
  - H3: Molty 🦞
  ...
  - H3: Pergantian Cangkang Besar (27 Jan 2026)
...
- Judul:
  ...
  - H2: Beri agen sebuah workspace (AGENTS)
...
- Judul:
  ...
  - H2: Alur kerja stabil (aplikasi macOS dahulu)
  - H2: Alur kerja paling mutakhir (Gateway di terminal)
...
- Judul:
  ...
  - H3: Opsi 2: MCP Chrome lokal host
  - H2: Arsitektur kerja
...
- Judul:
  ...
  - H2: Konfigurasi
  - H3: Visi screenshot (dukungan model teks saja)
  ...
  - H2: Browserless (CDP remote terhost)
...
- Judul:
  ...
  - H2: Apa yang tidak dilakukannya
...
- Judul:
  ...
  - H3: Saat persetujuan dikirim ke sesi, apakah siapa pun dalam sesi tersebut dapat menyetujuinya?
  - H2: Terkait
...
- Judul:
  - H2: Mendapatkan kredensial Token Plan
  - H2: Konfigurasi
...
- Judul:
  ...
  - H2: Mulai cepat
  - H2: Konfigurasi
  - H3: Memilih sumber pemasangan
  - H3: Kebijakan pemasangan operator
  - H3: Mengonfigurasi kebijakan plugin
...
- Judul:
  ...
  - H2: Identitas personal (lokal-browser)
