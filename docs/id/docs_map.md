...
x-i18n:
    generated_at: "2026-07-01T08:31:49Z"
    model: gpt-5.5
...
- Judul:
  ...
  - H2: Detail fitur
  - H2: Alat dan gate tindakan
  - H2: UI Components v2
  - H2: Suara
  - H3: Kanal suara
  - H3: Mengikuti pengguna di suara
  - H3: Pesan suara
  - H2: Pemecahan masalah
...
- Judul:
  ...
  - H3: Izinkan semua grup, tidak memerlukan @mention
...
- Judul:
  ...
  - H2: Default keamanan
  - H2: Kontrol akses
  - H3: Kesalahan umum: allowFrom adalah untuk DM, bukan kanal
...
- Judul:
  ...
  - H2: Jika Anda ingin memulai ulang untuk pesan mendatang
  - H2: Terkait
...
- Judul:
  ...
  - H3: Gabung otomatis
  - H3: Format target daftar izinkan
...
- Judul:
  ...
  - H3: Langkah 3: Konfigurasikan Endpoint Perpesanan
  - H3: Langkah 4: Aktifkan Saluran Teams
  - H3: Langkah 5: Bangun Manifes Aplikasi Teams
  ...
  - H2: Contoh manifes Teams (disunting)
  - H3: Catatan manifes (bidang wajib)
  - H3: Memperbarui aplikasi yang ada
  - H2: Kemampuan: hanya RSC vs Graph
  - H3: Dengan hanya Teams RSC (aplikasi terinstal, tanpa izin Graph API)
  - H3: Dengan izin Teams RSC + Microsoft Graph Application
  - H3: RSC vs Graph API
  - H2: Media + riwayat yang diaktifkan Graph (diperlukan untuk saluran)
  ...
  - H2: Mengirim file dalam obrolan grup
  - H3: Mengapa obrolan grup memerlukan SharePoint
  - H3: Penyiapan
  - H3: Perilaku berbagi
  - H3: Perilaku cadangan
  - H3: Lokasi file yang disimpan
...
- Judul:
  - H2: 1) Pemasangan DM (akses obrolan masuk)
  - H3: Setujui pengirim
...
- Rute: /channels/slack
- Judul:
  - H2: Memilih Socket Mode atau HTTP Request URLs
  - H3: Mode relay
  - H2: Instal
  - H2: Penyiapan cepat
...
- Judul:
  ...
  - H3: Nomor privat khusus daftar izinkan
...
- Judul:
  ...
  - H3: Pembatasan akses grup dengan mention
  - H2: Multi-akun
  - H2: Variabel lingkungan
...
- Judul:
  ...
  - H2: Smoke instalasi
  - H2: E2E Docker lokal
  - H3: Parameter yang dapat disetel
  ...
  - H2: Gate pemeriksaan lokal dan routing perubahan
  - H2: Validasi Testbox
  - H2: Terkait
...
- Judul:
  ...
  - H3: Emoji
  - H3: Stiker
  - H3: Peran / Saluran / Anggota / Suara
  - H3: Peristiwa
  - H3: Moderasi (Discord)
  - H3: Siaran
  - H2: Contoh
...
- Judul:
  ...
  - H2: Perintah umum
  - H2: peristiwa sistem
  - H2: Heartbeat sistem last|enable|disable
  - H2: kehadiran sistem
  - H2: Catatan
  - H2: Terkait
...
- Judul:
  ...
  - H2: Perintah, direktif, dan "pintasan sebaris"
  - H2: Sesi, Compaction, dan pemangkasan (yang dipertahankan)
...
- Judul:
  - H2: Apa yang ditambahkannya dibanding bawaan
  - H2: Memulai
  - H3: Prasyarat
  - H3: Aktifkan
  - H2: Cara kerja sidecar
  - H2: Performa pencarian dan kompatibilitas
  - H2: Penggantian model
...
- Judul:
  ...
  - H3: Fase 2: Inti Kirim yang Tahan Lama
...
- Judul:
  ...
  - H3: Lewati cooldown vs perilaku probe
  - H2: Penggantian sesi dan pengalihan model live
...
- Judul:
  ...
  - H4: Kekhasan yang perlu diketahui
...
- Judul:
  ...
  - H2: Ritme mirip manusia antar blok
...
- Judul:
  ...
  - H2: Payload tool + connector (waktu provider mentah + bidang ternormalisasi)
  - H2: Dokumen terkait
...
- Judul:
  - H2: Penyiapan yang direkomendasikan (kunci API, provider apa pun)
  ...
  - H2: Menghapus auth provider saat gateway sedang berjalan
  - H2: Mengontrol kredensial mana yang digunakan
  - H3: OpenAI dan id openai-codex legacy
  - H3: Saat login (CLI)
  - H3: Per sesi (perintah chat)
  - H3: Per agent (override CLI)
  - H2: Pemecahan masalah
  - H3: "Tidak ada kredensial ditemukan"
  - H3: Token kedaluwarsa/sudah kedaluwarsa
  - H2: Terkait
...
- Judul:
  ...
  - H2: Variabel template model media
...
- Judul:
  ...
  - H2: Tanggung jawab berdasarkan komponen
  - H2: Terkait
...
- Judul:
  ...
  - H3: Apa yang dilakukan setiap flag
...
- Judul:
  ...
  - H2: Mengapa ini berhasil
  - H2: Apa yang Diubah oleh --profile rescue onboard
...
- Judul:
  ...
  - H3: Peran
  - H3: Cakupan (operator)
  - H3: Kapasitas/perintah/izin (node)
  - H2: Presence
...
- Judul:
  ...
  - H2: Ditingkatkan: "jalankan di host" khusus exec
  - H2: Perbaikan umum "penjara sandbox"
  - H3: "Alat X diblokir oleh kebijakan alat sandbox"
  - H3: "Saya kira ini utama, mengapa disandbox?"
  - H2: Terkait
...
- Judul:
  ...
  - H2: Penalaran dan keluaran verbose dalam grup
  ...
  - H3: Grup: wajibkan mention di mana saja
...
- Judul:
  ...
  - H2: Gateway macOS diam-diam berhenti merespons, lalu kembali saat Anda menyentuh dashboard
...
- Judul:
  ...
  - H2: Variabel env yang diinjeksikan runtime
  - H2: Variabel env UI
...
- Judul:
  - H2: Model: default, pemilihan, alias, pengalihan
...
- Judul:
  ...
  - H2: Live: smoke backend CLI (Claude, Gemini, atau CLI lokal lainnya)
  - H2: Live: keterjangkauan proxy APNs HTTP/2
  ...
  - H3: Aggregator / gateway alternatif
...
- Judul:
  ...
  - H3: E2E (browser Control UI tiruan)
...
- Judul:
  - H1: Render
  - H2: Prasyarat
  - H2: Terapkan dengan Render Blueprint
  - H2: Memahami Blueprint
  - H2: Memilih paket
  - H2: Setelah penerapan
  - H3: Akses Control UI
  ...
  - H3: Kehilangan data setelah deploy ulang
...
- Judul:
  ...
  - H2: Contoh konfigurasi
  - H3: Penyedia + fallback CLI (OpenAI + Whisper CLI)
...
- Judul:
  ...
  - H3: Persyaratan latar depan
  - H3: Pembantu CLI
  - H2: Node Android
  - H3: Pengaturan pengguna Android (default aktif)
  - H3: Izin
  - H3: Persyaratan latar depan Android
...
- Judul:
  ...
  - H3: Mulai host Node (latar depan)
...
- Judul:
  ...
  - H3: 1. Ekspor atau relokasi helper percobaan mesin konteks yang dapat digunakan ulang
  ...
  - H4: Peristiwa contextCompaction native Codex di dalam turn
...
- Judul:
  - H2: Persyaratan untuk izin stabil
...
- Judul:
  ...
  - H2: Checklist file
  - H2: Contoh dikerjakan: pembuatan gambar
  - H2: Provider embedding
  - H2: Checklist peninjauan
  - H2: Terkait
...
- Judul:
  ...
  - H2: Balasan terlihat dan heartbeats
  - H2: Batas hook
...
- Judul:
  ...
  - H2: Pasangan penyedia plus harness
...
- Judul:
  - H2: Cara kerja Plugin saluran
  - H2: Persetujuan dan kapabilitas saluran
...
- Judul:
  ...
  - H3: Slot eksklusif
  - H3: Adapter embedding memori yang usang
...
- Judul:
  ...
  - H3: openclaw.channel
  - H3: openclaw.install
  - H3: Pemuatan penuh tertunda
  - H2: Manifest Plugin
  - H2: Publikasi ClawHub
  - H2: Entri setup
  - H3: Impor helper setup yang sempit
  - H3: Promosi akun tunggal milik saluran
  - H2: Skema config
  - H3: Membuat skema config saluran
  - H2: Wizard setup
  - H2: Mempublikasikan dan menginstal
  - H2: Terkait
...
- Judul:
  - H2: Entri Plugin
  - H3: Helper kompatibilitas dan pengujian yang usang
...
- Judul:
  ...
  - H3: Menguji unit Plugin saluran
...
- Judul:
  ...
  - H3: Alat tidak muncul setelah instal
  - H2: Lihat juga
...
- Judul:
  ...
  - H2: Penemuan model
  - H2: Streaming dan dukungan alat
  - H2: Harga
...
- Judul:
  ...
  - H3: Fase 2: Pembersihan Berbasis Sewa
  - H3: Fase 3: Pembersihan Startup Berbasis Sewa
...
- Judul:
  - H1: Refactor Status Database-First
  - H2: Keputusan
  - H2: Kontrak Ketat
...
- Judul:
  ...
  - H3: 7) Perangkuman perlindungan Compaction
...
- Judul:
  ...
  - H3: Dasar yang mengutamakan biaya
  - H2: Diagnostik cache
...
- Judul:
  ...
  - H2: Housekeeping diam-diam (NOREPLY)
  - H2: "Flush memori" sebelum Compaction (diimplementasikan)
...
- Judul:
  ...
  - H2: Apa yang tidak akan saya lakukan
  - H2: Aturan Emas
  - H2: Terkait
...
- Judul:
  ...
  - H3: Contoh: menjaga cache 1j tetap hangat dengan Heartbeat
...
- Judul:
  ...
  - H2: Aturan global: panggilan alat cacat format
...
- Judul:
  ...
  - H4: T-RECON-002: Penjajakan Integrasi Kanal
...
- Judul:
  ...
  - H2: v1++: model berbatas tambahan (konkurensi, percobaan ulang, ketepatan trace)
...
- Judul:
  ...
  - H2: Konfig yang mengubahnya menjadi "asisten"
  - H2: Sesi dan memori
...
- Judul:
  ...
  - H3: Rangkaian shell, wrapper, dan multiplexer
  ...
  - H3: Saat persetujuan dikirim ke suatu sesi, apakah siapa pun dalam sesi itu dapat menyetujuinya?
  - H2: Terkait
...
- Judul:
  ...
  - H2: Kebijakan Instal Operator (security.installPolicy)
  - H2: Daftar izin skill bawaan
  - H2: Entri per skill (skills.entries)
  - H2: Daftar izin agen (agents)
  - H2: Workshop (skills.workshop)
  - H2: Root skill bersymlink
  - H2: Skill bersandbox dan variabel lingkungan
...
- Judul:
  ...
  - H2: Visibilitas reasoning (/reasoning)
  - H2: Terkait
  - H2: Heartbeat
  - H2: UI chat web
  - H2: Profil penyedia
...
- Judul:
  - H2: Aktifkan Plugin
  - H2: Perubahan yang dibuat tokenjuice
...
- Judul:
  ...
  - H2: Format keluaran menurut channel
  - H2: Referensi bidang
  - H2: Alat agen
  - H2: RPC Gateway
  - H2: Tautan layanan
