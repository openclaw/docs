---
read_when:
    - Anda sedang menginstal, mengonfigurasi, atau mengaudit Plugin deepinfra
summary: Menambahkan dukungan penyedia model DeepInfra ke OpenClaw.
title: Plugin DeepInfra
x-i18n:
    generated_at: "2026-06-27T17:52:52Z"
    model: gpt-5.5
...
Menambahkan dukungan penyedia model DeepInfra ke OpenClaw.

## Distribusi

- Paket: `@openclaw/deepinfra-provider`
- Rute instalasi: npm; ClawHub: `clawhub:@openclaw/deepinfra-provider`
