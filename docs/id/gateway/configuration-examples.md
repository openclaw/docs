...
```json5
{
  ...
  session: {
    scope: "per-sender",
    dmScope: "per-channel-peer", // disarankan untuk kotak masuk multi-pengguna
    reset: {
      mode: "daily",
      atHour: 4,
      idleMinutes: 60,
  ...
  agents: {
    defaults: {
      ...
      heartbeat: {
        ...
        target: "last",
        directPolicy: "allow", // allow (bawaan) | block
        to: "+15555550123",
        prompt: "HEARTBEAT",
        ackMaxChars: 300,
      },
      ...
      sandbox: {
        mode: "non-main",
        scope: "session", // lebih disarankan daripada perSession: true yang lama
