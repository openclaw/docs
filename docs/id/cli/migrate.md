...
<Note>
Impor onboarding memerlukan penyiapan OpenClaw yang baru. Reset konfigurasi, kredensial, sesi, dan ruang kerja terlebih dahulu jika Anda sudah memiliki status lokal. Impor cadangan-plus-timpa atau gabungan dibatasi fitur untuk penyiapan yang sudah ada.
</Note>
