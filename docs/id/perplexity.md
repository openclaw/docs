...
summary: Alihkan ke /tools/perplexity-search
title: Pencarian Perplexity
x-i18n:
    generated_at: "2026-05-06T09:18:57Z"
    model: gpt-5.5
    provider: openai
...
Halaman ini telah dipindahkan ke [pencarian Perplexity](/id/tools/perplexity-search).
