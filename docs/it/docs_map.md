...
summary: Mappa dei titoli generata per le pagine della documentazione di OpenClaw
title: Mappa della documentazione
x-i18n:
    generated_at: "2026-06-30T22:21:17Z"
    model: gpt-5.5
...
# Mappa dei documenti OpenClaw

Questo file è generato dalle intestazioni `docs/**/*.md` e `docs/**/*.mdx` per aiutare gli agenti a navigare nell'albero della documentazione.
...
- Headings:
  ...
  - H2: Route di autenticazione solo tramite configurazione
...
- Headings:
  ...
  - H3: Punti salienti del contesto dell'evento
...
- Headings:
  ...
  - H2: Integrazione dello stato (pressione attività)
...
- Headings:
  ...
  - H2: Percorsi supportati dei canali di messaggistica
...
- Headings:
  ...
  - H3: Consentire tutti i gruppi, nessuna @mention richiesta
  - H3: Consentire tutti i gruppi, richiedere comunque @mention
...
- Headings:
  ...
  - H2: Coalescenza dei DM split-send (comando + URL in un'unica composizione)
...
- Headings:
  ...
  - H2: Attivazione della risposta (menzioni)
...
- Intestazioni:
  ...
  - H3: Formati di destinazione allowlist
  ...
  - H2: Riparazione della stanza diretta
...
- Intestazioni:
  ...
  - H2: Esempio di manifesto Teams (oscurato)
...
- Intestazioni:
  ...
  - H3: Approvazione automatica opzionale del Node tramite CIDR attendibile
...
- Intestazioni:
  ...
  - H3: Regolare la strategia di unione del testo
  - H2: Comandi comuni
  - H2: Risoluzione dei problemi
  - H3: Il bot non risponde nelle chat di gruppo
  - H3: Il bot non riceve messaggi
...
- Intestazioni:
  - H1: openclaw backup
  - H2: Note
  - H2: Elementi sottoposti a backup
...
- Intestazioni:
  ...
  - H3: Soppressione di riconoscimenti obsoleti
...
- Intestazioni:
  ...
  - H2: Opzioni comuni
  - H2: Note
  - H2: Checklist di recupero della deriva dei token
  - H2: Correlati
...
- Intestazioni:
  ...
  - H2: Opzioni
  - H2: Modalità lint
  - H2: Controlli strutturati dello stato
...
- Intestazioni:
  - H1: openclaw logs
  - H2: Opzioni
  - H2: Opzioni RPC del Gateway condiviso
  - H2: Esempi
  - H2: Note
  - H2: Correlati
...
- Intestazioni:
  ...
  - H2: Proxy del browser (zero-config)
...
- Intestazioni:
  ...
  - H2: Esempi
  - H2: Locale
  - H3: Scelte di endpoint Z.AI non interattive
  - H2: Note sul flusso
...
- Intestazioni:
  ...
  - H3: Installa
  - H4: Forma abbreviata marketplace
  - H3: Elenco
...
- Intestazioni:
  ...
  - H2: Configura i criteri
  - H2: Accetta lo stato dei criteri
  - H2: Risultati
  - H2: Riparazione
  - H2: Codici di uscita
  - H2: Correlati
...
- Intestazioni:
  ...
  - H3: Dopo la modifica della sorgente, dei criteri o della modalità OpenShell
...
- Intestazioni:
  ...
  - H2: Sessioni
  - H2: Direzionamento durante lo streaming
...
- Intestazioni:
  ...
  - H2: Compaction rispetto a pruning
  - H2: Risoluzione dei problemi
  - H2: Correlati
...
- Intestazioni:
  ...
  - H2: Skills: iniettate rispetto a caricate su richiesta
...
- Intestazioni:
  ...
  - H2: Come funziona
  - H2: Honcho rispetto alla memoria integrata
  - H2: Comandi CLI
...
- Intestazioni:
  ...
  - H3: Fase 1: dominio Message interno
...
- Intestazioni:
  - H2: Flusso del runtime
  - H2: Criteri della sorgente di selezione
  ...
  - H3: Salto per cooldown rispetto al comportamento di probe
...
- Intestazioni:
  ...
  - H4: Peculiarità da conoscere
  - H2: Provider tramite models.providers (URL custom/base)
  - H3: Moonshot AI (Kimi)
  - H3: Kimi coding
...
- Intestazioni:
  ...
  - H2: Criteri rapidi per i modelli
...
- Intestazioni:
  ...
  - H2: Compatibilità con i token legacy Anthropic
...
- Intestazioni:
  ...
  - H2: Template minimale di contratto di lane
  - H2: Correlati
...
- Intestazioni:
  - H2: Campi di presenza (ciò che viene mostrato)
  ...
  - H2: Avvertenza remote/tunnel (IP local loopback)
  - H2: Consumatori
  - H3: Scheda Istanze macOS
  - H2: Suggerimenti per il debugging
  - H2: Correlati
...
- Intestazioni:
  ...
  - H3: Consegna dei media con lo streaming a blocchi
...
- Intestazioni:
  - H2: Strumento exec
  - H2: Bridging dei processi child
...
- Intestazioni:
  ...
  - H2: Debugging su macOS
  - H2: Debugging nei log del Gateway
  - H2: Debugging su Node iOS
...
- Intestazioni:
  ...
  - H3: Override del profilo bootstrap per agent
  ...
  - H3: Campi di corrispondenza binding
...
- Intestazioni:
  ...
  - H3: Repository di Skills sibling con symlink
  - H2: Pattern comuni
  - H3: Baseline di skill condivisa con una sovrascrittura
...
- Intestazioni:
  ...
  - H2: Backfill e ripristino dell'UI Dreams
...
- Intestazioni:
  ...
  - H2: Consegna del reasoning (facoltativa)
...
- Intestazioni:
  ...
  - H2: Mapping delle porte (derivato)
...
- Intestazioni:
  ...
  - H2: Gate dei comandi dei nodi (2026.3.31+)
  ...
  - H2: Approvazione automatica con upgrade dei metadati
...
- Intestazioni:
  ...
  - H2: Approvazioni Exec
  - H2: Fallback di consegna degli agenti
  - H2: Versioning
  - H3: Costanti client
  - H2: Auth
  - H2: Identità del dispositivo + pairing
  - H3: Diagnostica di migrazione dell'auth dei dispositivi
  - H2: TLS + pinning
  - H2: Ambito
  - H2: Correlati
...
- Intestazioni:
  ...
  - H3: Desktop di casa esegue il Gateway
  - H3: Laptop esegue il Gateway
...
- Intestazioni:
  ...
  - H2: setupCommand (configurazione container una tantum)
...
- Intestazioni:
  ...
  - H2: Note su ambito runtime e audit
...
- Intestazioni:
  ...
  - H2: Confine di accesso dell'agent
  ...
  - H2: Materiale di autenticazione SSH sandbox
...
- Intestazioni:
  ...
  - H3: Agent condiviso in azienda: modello accettabile
  - H2: Concetto di fiducia del Gateway e del nodo
  ...
  - H2: Interfaccia di controllo via HTTP
  ...
  - H2: Flag di bypass per contenuto esterno non sicuro
...
- Intestazioni:
  ...
  - H2: Symlink della skill saltato come fuga dal percorso
  - H2: Anthropic 429: uso extra richiesto per contesto lungo
  - H2: Risposte upstream 403 bloccate
  - H2: Backend locale compatibile con OpenAI supera i probe diretti ma le esecuzioni dell'agent falliscono
  - H2: Nessuna risposta
  - H2: Connettività dell'interfaccia di controllo della dashboard
  - H3: Mappa rapida dei codici dettaglio auth
  ...
  - H2: Il Gateway esce durante l'uso elevato di memoria
...
- Intestazioni:
  ...
  - H2: Avvio CLI e profiling dei comandi
...
- Intestazioni:
  ...
  - H2: Live: smoke test dei modelli (chiavi dei profili)
  - H3: Livello 1: completamento diretto del modello (senza Gateway)
  - H3: Livello 2: Gateway + smoke test dell'agente dev (ciò che "@openclaw" fa davvero)
  ...
  - H3: Set di smoke test moderno (chiamata agli strumenti + immagine)
  - H3: Baseline: chiamata agli strumenti (Read + Exec facoltativo)
  - H3: Visione: invio immagine (allegato → messaggio multimodale)
  - H3: Aggregatori / Gateway alternativi
  - H2: Credenziali (non eseguire mai il commit)
...
- Intestazioni:
  ...
  - H2: Runner Docker (controlli facoltativi "funziona in Linux")
  - H2: Controllo di coerenza della documentazione
  - H2: Regressione offline (sicura per la CI)
...
- Intestazioni:
  ...
  - H2: Dry run
  - H2: Plugin e canali
  - H2: Controllare lo stato corrente
...
- Intestazioni:
  ...
  - H2: 4) Configurare nginx per eseguire il proxy di OpenClaw sulla porta 8000
...
- Intestazioni:
  ...
  - H3: Config non letta
  - H3: Scrittura della config tramite SSH
...
- Intestazioni:
  ...
  - H2: Cosa resta solo in archivio
...
- Intestazioni:
  ...
  - H3: L'app-server Codex rimane canonico per lo stato nativo del thread
  ...
  - H3: 1. Esportare o ricollocare gli helper riutilizzabili per i tentativi del motore di contesto
  ...
  - H3: 7. Normalizzare l'uso e il contesto runtime della cache dei prompt
...
- Intestazioni:
  ...
  - H2: Pressione sulla memoria e kill OOM
  - H2: Correlati
...
- Intestazioni:
  ...
  - H2: 2. Compila e crea il pacchetto dell'app
  ...
  - H3: Gateway "Avvio..." a tempo indeterminato
  - H2: Correlati
...
- Intestazioni:
  - H1: Logging (macOS)
  - H2: Log diagnostico su file con rotazione (riquadro Debug)
...
- Intestazioni:
  ...
  - H2: Schemi degli strumenti messaggio
...
- Intestazioni:
  ...
  - H3: Plugin di canale e strumento messaggio condiviso
...
- Intestazioni:
  - H2: Panoramica
  - H2: Associazioni dei thread e cambi di modello
...
- Intestazioni:
  ...
  - H3: Alias piatti per callback inbound WhatsApp
  - H3: Campi di ammissione inbound WhatsApp
  - H2: Note di release
...
- Intestazioni:
  - H2: Separazione delle responsabilità
...
- Intestazioni:
  ...
  - H3: Estensioni di sessione e inserimenti nel turno successivo
...
- Intestazioni:
  ...
  - H3: Campi package.json che influiscono sulla discovery
  - H2: Precedenza della discovery (ID Plugin duplicati)
...
- Intestazioni:
  ...
  - H2: Ciò che il core continua a gestire
...
- Intestazioni:
  ...
  - H3: Slot esclusivi
  - H3: Adattatori di embedding memoria deprecati
...
- Intestazioni:
  ...
  - H3: Promozione di account singolo gestita dal canale
...
- Intestazioni:
  ...
  - H2: Applicazione lint (Plugin nel repository)
...
- Intestazioni:
  ...
  - H3: la voce Plugin non espone i metadati defineToolPlugin
...
- Intestazioni:
  ...
  - H3: Le connessioni Twilio a Google Meet non riescono
...
- Intestazioni:
  ...
  - H2: Dove viene eseguito
  - H2: Installazione
  - H3: Opzione A: installazione da npm
  - H3: Opzione B: installazione da una cartella locale (dev)
  - H2: Configurazione
  - H2: CLI
  - H2: Strumento agente
  - H2: Correlati
...
- Intestazioni:
  ...
  - H2: Dettagli del flusso di lavoro
  - H2: Correlati
...
- Intestazioni:
  ...
  - H2: Supporto streaming e strumenti
  - H2: Prezzi
  - H3: Venice (anonimizzato) rispetto ad API diretta
  - H2: Esempi d'uso
  - H2: Risoluzione dei problemi
  - H2: Configurazione avanzata
  - H2: Correlati
...
- Titoli:
  ...
  - H3: Fase 3: recupero all'avvio basato prima sui lease
...
- Titoli:
  - H2: Prima esecuzione (consigliato)
...
- Titoli:
  ...
  - H2: Fase 2: pulizia del prodotto e della UX
  - H2: Fase 3: irrigidimento dell'architettura frontend
  - H2: Fase 4: performance e affidabilità
...
- Titoli:
  ...
  - H2: Impostazioni di sicurezza predefinite
  - H2: Preflight delle soluzioni esistenti
  - H2: Memoria giornaliera (consigliato)
...
- Intestazioni:
  ...
  - H2: Impatto di TTL cache e potatura
...
- Intestazioni:
  - H1: Note di rilascio
  - H2: Prossimamente
  - H2: Cronologia grezza delle release
...
- Intestazioni:
  ...
  - H4: T-PERSIST-001: Installazione di Skills dannose
  - H4: T-PERSIST-002: Avvelenamento degli aggiornamenti delle Skills
...
- Intestazioni:
  - H2: Inizia qui
  - H2: Provider ed esperienza utente
  - H2: App companion
...
- Intestazioni:
  ...
  - H3: 0) (Opzionale) Esegui anche l'app macOS dal sorgente
  - H3: 1) Avvia il Gateway di sviluppo
  - H3: 2) Punta l'app macOS al Gateway in esecuzione
  - H3: 3) Verifica
  - H3: Errori comuni
  - H2: Mappa dell'archiviazione delle credenziali
  - H2: Aggiornamento (senza distruggere la configurazione)
...
- Intestazioni:
  - H2: Esempio non interattivo di riferimento
...
- Intestazioni:
  ...
  - H3: Bridge MCP per gli strumenti del Plugin
  - H3: Bridge MCP per gli strumenti OpenClaw
...
- Intestazioni:
  ...
  - H2: Binding persistenti dei canali
  - H3: Modello di binding
  ...
  - H2: Compatibilità della sandbox
  - H2: Risoluzione del target della sessione
  - H2: Controlli ACP
  - H3: Mappatura delle opzioni di runtime
  - H2: Harness acpx, configurazione dei Plugin e autorizzazioni
  - H2: Risoluzione dei problemi
  - H2: Correlati
...
- Intestazioni:
  ...
  - H2: Regola critica per la UI di controllo
  - H2: Validare a livelli
  ...
  - H3: Livello 4: verificare separatamente il livello della UI di controllo
  - H3: Livello 5: verificare il controllo del browser end-to-end
...
- Intestazioni:
  ...
  - H2: Valori predefiniti dei Plugin
...
- Intestazioni:
  ...
  - H3: Inoltro approvazioni dei Plugin
...
- Intestazioni:
  ...
  - H2: Modifica nella UI di controllo
  - H2: Flusso di approvazione
  - H2: Eventi di sistema
  - H2: Comportamento delle approvazioni negate
  - H2: Implicazioni
  - H2: Correlati
...
- Intestazioni:
  ...
  - H2: Mappatura di Codex Guardian
...
- Intestazioni:
  ...
  - H2: Parametri dello strumento
  - H3: Regole dei filtri di dominio
  - H2: Note
  - H2: Correlati
...
- Intestazioni:
  ...
  - H2: Riferimento della configurazione Plugin
  - H2: Note
  - H2: Correlati
...
- Intestazioni:
  ...
  - H2: Elenco consentito delle skill in bundle
  - H2: Voci per skill (skills.entries)
  - H2: Elenchi consentiti degli agenti (agents)
  - H2: Workshop (skills.workshop)
  - H2: Radici skill collegate tramite symlink
...
- Intestazioni:
  ...
  - H2: Elenchi consentiti degli agenti
  - H2: Plugin e Skills
  - H2: Skill Workshop
...
- Intestazioni:
  ...
  - H2: /debug — override solo a runtime
...
- Intestazioni:
  - H2: Per iniziare
  - H2: Riferimento degli strumenti
  - H3: tavilysearch
  - H3: tavilyextract
...
- Intestazioni:
  ...
  - H2: Autenticazione della rotta avatar
  - H2: Autenticazione della rotta media assistente
...
- Intestazioni:
  ...
  - H2: Nozioni di base sull'autenticazione (locale vs remota)
