...
x-i18n:
    generated_at: "2026-07-01T08:07:37Z"
    model: gpt-5.5
...
- Intestazioni:
  ...
  - H2: Protezione policy OAuth SecretRef
...
- Intestazioni:
  ...
  - H2: Come funziona
  - H2: Target
  - H2: Aspetti principali della configurazione
  - H2: Risoluzione dei problemi
...
- Intestazioni:
  ...
  - H2: Media, suddivisione in parti e target di consegna
  - H2: Azioni dell'API privata
  - H2: Scritture di configurazione
  - H2: Coalescenza dei DM con invio suddiviso (comando + URL in una composizione)
...
- Intestazioni:
  ...
  - H3: Strumenti diversi per mittente (il proprietario ottiene più poteri)
  - H2: NickServ
...
- Intestazioni:
  ...
  - H2: Messaggi comuni e relativo significato
  ...
  - H2: Se la cronologia crittografata non ricompare ancora
...
- Intestazioni:
  ...
  - H3: Segnali di stato e fiducia
  - H3: Verificare questo dispositivo con una chiave di ripristino
  - H3: Eseguire il bootstrap o riparare la firma incrociata
...
- Intestazioni:
  ...
  - H3: Passaggio 5: compilare il manifesto dell'app Teams
  ...
  - H3: RSC vs Graph API
  - H2: Contenuti multimediali + cronologia abilitati da Graph (obbligatori per i canali)
  - H2: Limitazioni note
  - H3: Timeout Webhook
  ...
  - H2: ID di Team e Channel (errore comune)
  - H2: Canali privati
  - H2: Risoluzione dei problemi
  - H3: Problemi comuni
...
- Intestazioni:
  ...
  - H2: Checklist del manifesto e degli scope
  ...
  - H3: Dimensione, download e limiti del modello
  - H3: Limiti noti
...
- Intestazioni:
  ...
  - H3: 2) Configura il token (env o config)
  - H2: Come funziona (comportamento)
  - H2: Limiti
  - H2: Controllo degli accessi (DM)
  - H3: Accesso DM
...
- Intestazioni:
  ...
  - H3: 3. Genera il codice QR ed effettua l'accesso
...
- Intestazioni:
  ...
  - H3: Gate per menzioni di gruppo
  - H2: Più account
  - H2: Variabili di ambiente
...
- Intestazioni:
  ...
  - H2: Convalida completa del rilascio
  ...
  - H3: Chunk del percorso di rilascio
...
- Intestazioni:
  ...
  - H2: Comandi comuni
  - H2: Sostituisci approvazioni da un file
...
- Intestazioni:
  ...
  - H3: Trasporto HTTP con streaming
...
- Intestazioni:
  ...
  - H2: Come visualizzarlo
  - H2: Toggle della sessione
...
- Intestazioni:
  ...
  - H3: Livello 2: invio per conto di altri
...
- Intestazioni:
  ...
  - H2: Modello a fasi
  - H2: Acquisizione della trascrizione di sessione
  - H2: Diario dei sogni
  - H2: Segnali di ranking approfonditi
  - H2: Copertura dei report delle prove shadow QA
  - H2: Pianificazione
  - H2: Avvio rapido
  - H2: Comando slash
...
- Intestazioni:
  ...
  - H2: Proprietà delle esecuzioni del canale
...
- Intestazioni:
  ...
  - H2: Template minimo di contratto di corsia
  - H2: Correlati
...
- Intestazioni:
  ...
  - H2: Contratto del trasporto live
  - H2: Correlati
...
- Intestazioni:
  ...
  - H3: Recapito dei media con streaming a blocchi
  - H2: Algoritmo di suddivisione in chunk (limiti bassi/alti)
  - H2: Coalescing (unire i blocchi in streaming)
...
- Intestazioni:
  ...
  - H2: Payload degli strumenti + connector (ora grezza del provider + campi normalizzati)
  - H2: Documentazione correlata
...
- Intestazioni:
  ...
  - H2: Limite di cronologia per reseed
  - H2: Limitazioni
  - H2: Risoluzione dei problemi
  - H2: Correlati
...
- Intestazioni:
  ...
  - H3: Override per profilo bootstrap per agente
...
- Intestazioni:
  ...
  - H3: Strumenti MCP e Plugin all'interno della policy degli strumenti della sandbox
  - H3: tools.codeMode
...
- Intestazioni:
  ...
  - H3: Repository Skill sibling collegato tramite symlink
  - H2: Pattern comuni
  - H3: Baseline Skill condivisa con una sola sovrascrittura
...
- Intestazioni:
  - H2: Canali
  - H2: Valori predefiniti dell'agente, multi-agente, sessioni e messaggi
...
- Intestazioni:
  ...
  - H3: Cosa viene applicato a caldo e cosa richiede un riavvio
...
- Intestazioni:
  ...
  - H2: Elementi (input)
  - H3: message
  - H3: functioncalloutput (strumenti basati sul turno)
...
- Intestazioni:
  ...
  - H3: Talk
  - H3: Code e sessioni
  - H3: Telemetria liveness della sessione
...
- Intestazioni:
  ...
  - H3: Diagnostica della migrazione auth dispositivo
  - H2: TLS + pinning
  - H2: Ambito
  - H2: Correlati
...
- Intestazioni:
  ...
  - H2: Policy degli strumenti: quali strumenti esistono/sono chiamabili
  - H3: Gruppi di strumenti (scorciatoie)
  - H2: Elevato: "esegui sull'host" solo per exec
  - H2: Correzioni comuni per "jail sandbox"
...
- Intestazioni:
  ...
  - H2: Concetto di fiducia del Gateway e del Node
  ...
  - H2: Isolamento delle sessioni DM (modalità multi-utente)
  ...
  - H3: Protezione per la delega a sotto-agenti
...
- Intestazioni:
  ...
  - H2: Anthropic 429 richiede uso aggiuntivo per contesto lungo
  ...
  - H2: Nessuna risposta
  - H2: Connettività dell'interfaccia di controllo del dashboard
  - H3: Mappa rapida dei codici di dettaglio autenticazione
  - H2: Servizio Gateway non in esecuzione
  - H2: Il gateway macOS smette silenziosamente di rispondere, poi riprende quando tocchi il dashboard
  - H2: Il Gateway termina durante un uso elevato di memoria
...
- Intestazioni:
  ...
  - H2: Dal vivo: analisi delle capacità del nodo Android
  - H2: Dal vivo: verifica rapida dei modelli (chiavi profilo)
  - H3: Livello 1: completamento diretto del modello (senza Gateway)
  - H3: Livello 2: Gateway + verifica rapida dell'agente di sviluppo (cosa fa davvero "@openclaw")
  - H2: Dal vivo: verifica rapida del backend CLI (Claude, Gemini o altre CLI locali)
  - H2: Dal vivo: raggiungibilità del proxy APNs HTTP/2
  - H2: Dal vivo: verifica rapida del bind ACP (/acp spawn ... --bind here)
  - H2: Dal vivo: verifica rapida dell'harness app-server di Codex
  - H3: Ricette live consigliate
  - H2: Dal vivo: matrice dei modelli (cosa copriamo)
  - H3: Set moderno di verifiche rapide (chiamata di strumenti + immagine)
  ...
  - H2: Media dei workflow ComfyUI live
...
- Intestazioni:
  ...
  - H3: E2E (verifica rapida del Gateway)
  - H3: E2E (browser mockato della Control UI)
  - H3: E2E: verifica rapida del backend OpenShell
  ...
  - H3: Quando eseguire
  - H2: Aggiungere regressioni (indicazioni)
  - H2: Correlati
...
- Intestazioni:
  ...
  - H3: Interfaccia web e associazione
  - H3: Configurazione e manutenzione
  - H3: Utilità
  - H2: Flusso del primo utilizzo
...
- Intestazioni:
  - H2: Cambiare canale
  - H2: Puntare a una versione o a un tag una tantum
  - H2: Esecuzione di prova
  - H2: Plugin e canali
  - H2: Verificare lo stato attuale
...
- Intestazioni:
  ...
  - H3: Rilevamento PATH del servizio
  - H2: Correlati
...
- Intestazioni:
  ...
  - H2: Alternativa: npm, pnpm o bun manuali
  - H3: Argomenti avanzati di installazione npm
...
- Intestazioni:
  ...
  - H2: Indicazioni per la selezione del modello
...
- Intestazioni:
  ...
  - H3: La semantica di selezione runtime non cambia
  - H2: Piano di implementazione
  - H3: 1. Esportare o ricollocare gli helper riutilizzabili dei tentativi del motore di contesto
...
- Intestazioni:
  ...
  - H2: 2. Crea e pacchettizza l'app
  - H2: 3. Installa la CLI
  - H2: Risoluzione dei problemi
  - H3: Build non riuscita: mancata corrispondenza di toolchain o SDK
...
- Intestazioni:
  - H1: Logging (macOS)
  - H2: Log diagnostico a rotazione su file (pannello Debug)
...
- Intestazioni:
  ...
  - H2: Testa rispetto alle release beta
  - H2: Prossimi passi
  - H2: Correlati
...
- Intestazioni:
  ...
  - H3: Creare le credenziali Google
  - H3: Generare il refresh token
...
- Intestazioni:
  ...
  - H3: Il Plugin viene caricato ma non compaiono ricordi
  - H2: Correlati
...
- Intestazioni:
  ...
  - H2: Pin di consegna
  - H2: Checklist per gli autori di Plugin
  - H2: Documenti correlati
...
- Intestazioni:
  ...
  - H2: Ciò che il core gestisce ancora
...
- Intestazioni:
  ...
  - H2: Come eseguire la migrazione
  - H2: Riferimento ai percorsi di importazione
...
- Intestazioni:
  ...
  - H2: Riferimento ai sottopercorsi
...
- Intestazioni:
  ...
  - H2: Struttura dei file
  - H2: Riferimento all'ordine del catalogo
  - H2: Passaggi successivi
  - H2: Correlati
...
- Intestazioni:
  ...
  - H3: Tipi
  - H2: Test della risoluzione della destinazione
  - H2: Pattern di test
...
- Intestazioni:
  ...
  - H2: RPC Gateway
  - H2: Risoluzione dei problemi
  - H3: La configurazione non riesce nell'esposizione Webhook
  ...
  - H3: I join Twilio a Google Meet non riescono
...
- Intestazioni:
  ...
  - H2: Per iniziare
  - H2: Autenticazione app-server nativa di Codex
  - H2: Generazione di immagini
  - H2: Generazione di video
...
- Intestazioni:
  ...
  - H2: Catalogo integrato
  - H2: Copertura delle funzionalità OpenClaw
  - H3: Mappature in modalità veloce
...
- Intestazioni:
  ...
  - H2: Fase 5: Rafforzamento di tipi, contratto e test
...
- Intestazioni:
  - H1: Convenzioni dei placeholder segreti
  - H2: Stile consigliato
  - H2: Evita questi pattern nei documenti
  - H2: Esempio
...
- Intestazioni:
  ...
  - H2: Provider di Compaction pluggabili
...
- Intestazioni:
  - H2: Gate PR locale
  - H2: Benchmark di latenza dei modelli (chiavi locali)
...
- Intestazioni:
  ...
  - H3: Esempio: mantenere calda la cache per 1 ora con Heartbeat
...
- Intestazioni:
  ...
  - H2: Regola globale: turni incompleti di solo reasoning
...
- Intestazioni:
  ...
  - H2: Punti salienti
  - H3: Affidabilità della consegna sui canali
...
- Intestazioni:
  ...
  - H4: T-RECON-002: Sondaggio delle integrazioni di canale
...
- Intestazioni:
  ...
  - H3: Gating dell'ingress (menzioni + bypass dei comandi di controllo)
  ...
  - H3: Correlazione / idempotenza della traccia di ingress
...
- Intestazioni:
  ...
  - H3: La spesa robotica sfrenata (3 dic 2025)
  - H2: Testi sacri
  - H2: Il credo dell'astice
...
- Intestazioni:
  ...
  - H3: 3) Verificare
  - H3: Problemi comuni
  - H2: Mappa dello storage delle credenziali
...
- Intestazioni:
  ...
  - H3: Configurazione dell'agente di probe di integrità
...
- Intestazioni:
  ...
  - H2: Modalità di bind dello spawn e thread
...
- Intestazioni:
  ...
  - H3: Consegna approvazione nativa
  - H3: Flusso IPC macOS
  - H2: FAQ
...
- Intestazioni:
  ...
  - H2: Risolvere problemi con strumenti mancanti
  - H2: Correlati
...
- Intestazioni:
  ...
  - H2: Risoluzione dei problemi
  - H3: Proprietà bloccata del percorso Plugin
...
- Intestazioni:
  ...
  - H2: /tools — cosa può usare l'agente ora
...
- Intestazioni:
  ...
  - H3: Canali con supporto dei thread
  - H3: Flusso rapido
...
- Intestazioni:
  ...
  - H3: Come i provider usano i prompt delle persone
