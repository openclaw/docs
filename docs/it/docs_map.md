...
x-i18n:
    generated_at: "2026-07-02T22:35:06Z"
    model: gpt-5.5
...
- Headings:
  ...
  - H2: Risoluzione del target del probe
...
- Headings:
  ...
  - H3: Punti principali del contesto dell’evento
...
- Headings:
  - H2: Configurazione rapida
  - H2: Consigliato: configura un workspace guild
  - H2: Modello runtime
  - H2: Canali forum
...
- Headings:
  ...
  - H2: Ottieni ID di gruppo/utente
...
- Headings:
  ...
  - H3: Opzione C: Tunnel Cloudflare
  - H2: Come funziona
  - H2: Target
...
- Headings:
  ...
  - H2: Pattern: DM personali + gruppi pubblici (singolo agente)
  - H2: Etichette visualizzate
  - H2: Policy di gruppo
  - H2: Gate delle menzioni (predefinito)
  - H2: Limita l’ambito dei pattern di menzione configurati
...
- Headings:
  ...
  - H2: Insidia del registro dei gruppi
  - H2: Passo dopo passo
...
- Headings:
  ...
  - H2: Coalescenza di DM con invio suddiviso (comando + URL in una composizione)
...
- Headings:
  ...
  - H2: Controllo degli accessi
  - H3: Insidia comune: allowFrom è per i DM, non per i canali
...
- Intestazioni:
  ...
  - H3: Messaggi di ripristino dello stato crittografato
...
- Intestazioni:
  ...
  - H3: Abilitare la crittografia
  - H3: Segnali di stato e attendibilità
  - H3: Verificare questo dispositivo con una chiave di ripristino
  - H3: Avviare o riparare la firma incrociata
  ...
  - H2: Risoluzione delle destinazioni
  - H2: Riferimento di configurazione
...
- Intestazioni:
  ...
  - H2: Contenuti multimediali + cronologia abilitati da Graph (necessari per i canali)
  - H2: Limitazioni note
  ...
  - H3: Perché le chat di gruppo hanno bisogno di SharePoint
...
- Intestazioni:
  - H2: Plugin in bundle
  - H3: Installazioni più vecchie/personalizzate
...
- Intestazioni:
  ...
  - H3: Associare tramite Telegram (consigliato per iOS)
  - H3: Approvare un dispositivo Node
  - H3: Approvazione automatica opzionale dei Node con CIDR attendibile
  - H3: Archiviazione dello stato di associazione dei Node
  - H3: Note
...
- Intestazioni:
  - H2: Scelta tra Socket Mode o URL di richiesta HTTP
  - H3: Modalità relay
  - H2: Installazione
  - H2: Configurazione rapida
  ...
  - H2: Contenuti multimediali, suddivisione in blocchi e consegna
...
- Intestazioni:
  ...
  - H3: Mittente del servizio di messaggistica
...
- Intestazioni:
  ...
  - H2: Configurazione rapida
  - H2: Variabili d'ambiente
  - H2: Criterio DM e controllo accessi
...
- Intestazioni:
  ...
  - H3: Disabilitare il requisito di @menzione nei gruppi
  ...
  - H3: Modalità di debug
  - H3: Routing multi-agent
  - H2: Riferimento di configurazione
  - H2: Tipi di messaggio supportati
  - H3: Ricevere
  - H3: Inviare
...
- Intestazioni:
  - H2: Compatibilità
  - H2: Prerequisiti
  - H2: Installazione con onboard (consigliato)
...
- Intestazioni:
  ...
  - H2: Ambito e routing
  - H2: Inoltro delle attività ClawSweeper
  - H2: Dispatch manuali
  - H2: Runner
  ...
  - H3: Esempi
  - H2: Smoke test dell'installazione
...
- Intestazioni:
  ...
  - H3: formato --bind
  - H3: Comportamento dello scope del binding
...
- Intestazioni:
  - H1: openclaw backup
  - H2: Note
  - H2: Di cosa viene eseguito il backup
...
- Intestazioni:
  ...
  - H2: Modalità di recupero dei messaggi
  - H2: Correlati
...
- Intestazioni:
  ...
  - H2: Output delle esecuzioni e rifiuti
  - H3: Soppressione delle conferme obsolete
  - H3: Soppressione silenziosa dei token
  - H3: Rifiuti strutturati
  - H2: Conservazione
  - H2: Migrazione di job più vecchi
  - H2: Modifiche comuni
...
- Intestazioni:
  ...
  - H2: Prima approvazione Paperclip / openclawgateway
...
- Intestazioni:
  ...
  - H2: Flag comuni
  - H2: Note
  - H2: Utilizzo dei risultati con l'invio di messaggi
...
- Intestazioni:
  ...
  - H2: Individuare Gateway (Bonjour)
  - H3: gateway discover
  - H2: Correlati
...
- Intestazioni:
  ...
  - H3: Trasporto HTTP trasmissibile in streaming
...
- Intestazioni:
  ...
  - H2: Proxy del browser (zero configurazione)
...
- Intestazioni:
  ...
  - H3: Installa
  - H4: Forma abbreviata del marketplace
  - H3: Elenco
  - H3: Indice Plugin
  - H3: Disinstalla
  - H3: Aggiorna
...
- Intestazioni:
  - H1: openclaw policy
  - H2: Avvio rapido
  - H3: Riferimento delle regole dei criteri
...
- Intestazioni:
  ...
  - H3: Dopo la modifica della configurazione della sandbox
  - H3: Dopo la modifica della destinazione SSH o del materiale di autenticazione SSH
  - H3: Dopo la modifica di sorgente, criterio o modalità di OpenShell
...
- Intestazioni:
  ...
  - H2: Perché nessun backup di rollback
  - H2: Esempio
  - H2: Correlati
...
- Intestazioni:
  ...
  - H2: Utilizzo
  - H2: Opzioni
  - H2: stato aggiornamento
  - H2: riparazione aggiornamento
...
- Intestazioni:
  ...
  - H3: wiki obsidian ...
  - H2: Indicazioni pratiche per l'utilizzo
...
- Intestazioni:
  ...
  - H2: Gestione dei canali di chat
  - H2: Timeout
...
- Intestazioni:
  ...
  - H2: Non commettere segreti
  - H2: Spostamento del workspace su una nuova macchina
  - H2: Note avanzate
  - H2: Correlati
...
- Intestazioni:
  ...
  - H2: Associazione + attendibilità locale
...
- Intestazioni:
  - H2: Avvio rapido
  - H2: Come funziona
  - H3: Ciclo di vita del subagente (facoltativo)
...
- Intestazioni:
  ...
  - H3: /context detail
  - H3: /context map
  - H2: Cosa conta ai fini della finestra di contesto
...
- Intestazioni:
  ...
  - H2: Indicizzazione di percorsi extra
...
- Intestazioni:
  ...
  - H3: Fase 2: Core di invio duraturo
...
- Intestazioni:
  ...
  - H3: Comportamento di skip del cooldown rispetto al probe
...
- Titoli:
  ...
  - H2: Produttori (da dove arriva la presenza)
  ...
  - H3: 4) Connessioni Node (role: node)
  - H2: Regole di unione + deduplicazione (perché instanceId conta)
...
- Titoli:
  ...
  - H2: Coalescenza (unire blocchi in streaming)
  ...
  - H3: Aggiornamenti dell'anteprima dello stato degli strumenti
  - H3: Corsia di avanzamento del commento
  - H2: Correlati
...
- Titoli:
  ...
  - H2: Iniezione di bootstrap del workspace
  - H2: Gestione dell'orario
  - H2: Skills
  - H2: Documentazione
  - H2: Correlati
...
- Titoli:
  ...
  - H2: Payload degli strumenti + connettori (ora raw del provider + campi normalizzati)
  - H2: Documenti correlati
...
- Titoli:
  ...
  - H2: Controllare lo stato dell'autenticazione del modello
...
- Titoli:
  ...
  - H2: Usarlo come ripiego
  - H2: Panoramica della configurazione
  - H3: Configurazione di esempio
  - H2: Come funziona
  - H2: Sessioni
  - H2: Preludio di ripiego dalle sessioni claude-cli
...
- Titoli:
  ...
  - H3: Override del profilo di bootstrap per agente
...
- Titoli:
  ...
  - H3: Gate sulle menzioni nella chat di gruppo
...
- Intestazioni:
  ...
  - H3: Repository skill fratello collegato con symlink
  - H2: Pattern comuni
  - H3: Baseline di skill condivisa con una sola override
...
- Intestazioni:
  ...
  - H2: Segreti
  - H3: SecretRef
  - H3: Superficie di credenziali supportata
...
- Intestazioni:
  ...
  - H3: Pianificazione della ricaricamento
...
- Intestazioni:
  ...
  - H2: Codice dell'app vs codice del plugin
  - H2: Correlati
...
- Intestazioni:
  ...
  - H3: Vitalità
  - H3: Prontezza
  - H3: Ripristino dei gap
  - H2: Firme comuni di errore
...
- Intestazioni:
  ...
  - H3: Locale prima di tutto con rete di sicurezza hosted
...
- Intestazioni:
  ...
  - H3: Campi della richiesta supportati
...
- Intestazioni:
  ...
  - H2: File (inputfile)
  - H2: Limiti di file + immagini (configurazione)
  - H2: Streaming (SSE)
  - H2: Utilizzo
  - H2: Errori
  - H2: Esempi
...
- Intestazioni:
  ...
  - H3: Talk
  - H3: Code e sessioni
  - H3: Telemetria di vitalità della sessione
...
- Intestazioni:
  ...
  - H2: Approvazioni del pairing dei dispositivi
  - H2: Approvazioni del pairing dei nodi
...
- Intestazioni:
  ...
  - H2: Workflow CLI (compatibile con headless)
  - H2: Superficie API (protocollo gateway)
  - H2: Gating dei comandi dei nodi (2026.3.31+)
  - H2: Confini di attendibilità degli eventi dei nodi (2026.3.31+)
  - H2: Approvazione automatica (app macOS)
  - H2: Approvazione automatica dei dispositivi Trusted-CIDR
  - H2: Approvazione automatica degli upgrade dei metadati
...
- Intestazioni:
  ...
  - H2: Ricette PromQL
  - H2: Scegliere tra export Prometheus e OpenTelemetry
  - H2: Risoluzione dei problemi
  - H2: Correlati
...
- Intestazioni:
  ...
  - H3: Ruoli
  - H3: Ambiti (operatore)
  - H3: Cap/commands/permissions (nodo)
  - H2: Presenza
...
- Intestazioni:
  ...
  - H2: Impostazioni remote predefinite della CLI
...
- Intestazioni:
  ...
  - H2: Limite di accesso dell'agente
...
- Intestazioni:
  ...
  - H2: Matrice dei limiti di attendibilità
  ...
  - H2: Concetto fondamentale: controllo degli accessi prima dell'intelligenza
  ...
  - H3: Esempio: strumenti di sola lettura + area di lavoro di sola lettura
  - H3: Esempio: nessun accesso a filesystem/shell (messaggistica del provider consentita)
  - H2: Risposta agli incidenti
  - H3: Contieni
  - H3: Ruota (presumi la compromissione se i segreti sono trapelati)
  - H3: Audit
  - H3: Raccogli per una segnalazione
...
- Intestazioni:
  ...
  - H3: Solo tailnet (bind all'IP della tailnet)
...
- Intestazioni:
  - H2: Autenticazione
  - H2: Limite di sicurezza (importante)
  - H2: Corpo della richiesta
  - H2: Criterio + comportamento di instradamento
  - H2: Risposte
  - H2: Esempio
  - H2: Correlati
...
- Intestazioni:
  ...
  - H2: Symlink di Skill ignorato come escape del percorso
  - H2: Anthropic 429: utilizzo extra richiesto per contesti lunghi
  - H2: Risposte upstream 403 bloccate
  - H2: Il backend locale compatibile con OpenAI supera le sonde dirette, ma le esecuzioni degli agenti falliscono
  - H2: Nessuna risposta
  ...
  - H2: Il Gateway si chiude durante un uso elevato della memoria
  ...
  - H2: Strumento del browser non riuscito
  - H2: Se hai eseguito l'aggiornamento e qualcosa si è rotto improvvisamente
  - H2: Correlati
...
- Intestazioni:
  ...
  - H2: Come funziona
  - H2: Comportamento di abbinamento dell'interfaccia di controllo
  - H2: Configurazione
  ...
  - H2: Risoluzione dei problemi
  - H2: Migrazione dall'autenticazione a token
  - H2: Correlati
...
- Intestazioni:
  ...
  - H2: Output di tracciamento della sessione
  - H2: Tracciamento del ciclo di vita dei Plugin
  - H2: Avvio della CLI e profilazione dei comandi
  - H2: Modalità watch del Gateway
  - H2: Profilo dev + gateway dev (--dev)
  - H2: Logging del flusso raw (OpenClaw)
...
- Intestazioni:
  ...
  - H2: Failover del modello e "Tutti i modelli non sono riusciti"
...
- Intestazioni:
  ...
  - H2: Dove risiedono gli elementi su disco
  - H2: Nozioni di base sulla configurazione
  - H2: Gateway e nodi remoti
  - H2: Variabili env e caricamento di .env
...
- Intestazioni:
  ...
  - H2: Live: sweep delle capability del nodo Android
  - H2: Live: smoke dei modelli (chiavi dei profili)
  - H3: Livello 1: completamento diretto del modello (senza gateway)
  - H3: Livello 2: Gateway + smoke dell'agente dev (cosa fa davvero "@openclaw")
...
- Intestazioni:
  ...
  - H3: Unit / integration (predefinito)
  ...
  - H2: Controllo di sanità della documentazione
...
- Intestazioni:
  - H2: Primi 60 secondi
  - H2: L'assistente sembra limitato o gli mancano strumenti
...
- Intestazioni:
  - H2: Integrare nell'immagine i binari richiesti
  - H2: Creare e avviare
...
- Intestazioni:
  ...
  - H3: Problemi di blocco del Gateway
  ...
  - H3: Configurazione
  - H3: Accedere a una distribuzione privata
...
- Intestazioni:
  ...
  - H2: 5) Connettersi via SSH alla VM
...
- Intestazioni:
  ...
  - H2: Configurazione modello consigliata
...
- Intestazioni:
  ...
  - H3: Perdita di dati dopo una ridistribuzione
...
- Intestazioni:
  ...
  - H2: Installazione normale rispetto al checkout del sorgente
...
- Intestazioni:
  ...
  - H3: Livelli di log
  - H3: Diagnostica mirata del trasporto modello
  - H3: Correlazione delle trace
...
- Intestazioni:
  ...
  - H3: Abbinare + assegnare un nome
  - H3: Consentire i comandi
...
- Intestazioni:
  ...
  - H2: Abbinamento rispetto alle approvazioni
...
- Intestazioni:
  ...
  - H4: Eventi contextCompaction nativi Codex in-turn
  - H3: 9. Ripristino sessione e comportamento di binding
...
- Intestazioni:
  ...
  - H3: 4) Approvare l'abbinamento (CLI)
...
- Intestazioni:
  ...
  - H2: Attivazione delle esecuzioni agente da Canvas
  - H2: Note di sicurezza
  - H2: Correlati
...
- Intestazioni:
  ...
  - H2: 2. Compila e impacchetta l'app
  ...
  - H3: Gateway "Starting..." a tempo indeterminato
  - H2: Correlati
...
- Intestazioni:
  - H1: Logging (macOS)
  - H2: Log diagnostico su file a rotazione (pannello Debug)
...
- Intestazioni:
  ...
  - H2: Flusso di login WhatsApp (remoto)
  - H2: Risoluzione dei problemi
...
- Intestazioni:
  ...
  - H2: Requisiti
  - H2: Modalità
  - H2: Comportamento a runtime (parola di attivazione)
...
- Intestazioni:
  - H1: Architettura IPC di OpenClaw per macOS
  - H2: Obiettivi
  - H2: Come funziona
...
- Intestazioni:
  ...
  - H2: Gateway WSL2
  - H2: Avvio automatico del Gateway prima del login di Windows
...
- Intestazioni:
  - H2: Quando creare una capacità
  - H2: La sequenza standard
  - H2: Cosa va dove
  - H2: Sezioni di integrazione di provider e harness
...
- Intestazioni:
  ...
  - H2: Aggiunta di una nuova capacità
  - H3: Checklist delle capacità
  - H3: Template della capacità
  - H2: Correlati
...
- Intestazioni:
  - H2: Modello pubblico delle capacità
  ...
  - H2: Modello di ownership delle capacità
  - H3: Stratificazione delle capacità
  - H3: Esempio di Plugin aziendale multi-capacità
  - H3: Esempio di capacità: comprensione video
...
- Intestazioni:
  ...
  - H2: Testare rispetto alle versioni beta
  - H2: Passaggi successivi
  - H2: Correlati
...
- Intestazioni:
  ...
  - H2: Riferimento alla configurazione
...
- Intestazioni:
  ...
  - H2: Autenticazione e isolamento dell'ambiente
...
- Intestazioni:
  - H2: Panoramica
  - H2: Binding dei thread e modifiche di modello
...
- Intestazioni:
  ...
  - H2: Inventario e ownership dell'app
...
- Intestazioni:
  ...
  - H3: I controlli della configurazione di Twilio non riescono
...
- Intestazioni:
  ...
  - H2: Policy per le chiamate agli strumenti
...
- Intestazioni:
  ...
  - H3: Effetti collaterali di fine agente
...
- Intestazioni:
  ...
  - H3: Slot esclusivi
  - H3: Adapter deprecati per embedding di memoria
...
- Intestazioni:
  ...
  - H2: Voce di setup
  - H3: Import stretti degli helper di setup
  - H3: Promozione di un account singolo posseduta dal canale
...
- Intestazioni:
  ...
  - H3: Grace period di disconnessione dello stream Twilio
...
- Intestazioni:
  ...
  - H3: Dispatch non avvia un worker
  - H2: Correlati
...
- Intestazioni:
  - H2: Per iniziare
  - H2: Valori predefiniti di thinking (Claude Fable 5, 4.8 e 4.6)
...
- Intestazioni:
  ...
  - H3: Host LM Studio su LAN o tailnet
  - H2: Correlati
...
- Intestazioni:
  ...
  - H2: Nemotron 3 Ultra
  - H2: Catalogo fallback in bundle
  - H2: Configurazione avanzata
  - H2: Correlati
...
- Intestazioni:
  - H2: Primi passi
  - H2: Catalogo con pagamento a consumo
  - H2: Catalogo Piano Token
  - H2: Sintesi vocale
  - H2: Esempio di configurazione
  - H2: Correlati
...
- Intestazioni:
  - H1: Refactor dello stato con priorità al database
  - H2: Decisione
  - H2: Contratto rigido
  ...
  - H3: Fase 3: sostituire le API dello store sessioni
...
- Intestazioni:
  ...
  - H2: Funzionalità che possono usare le chiavi a pagamento
...
- Intestazioni:
  - H2: Obiettivo
  - H2: Principi
  - H2: Fase 1: audit della baseline
...
- Intestazioni:
  ...
  - H2: Confini dei blocchi di Compaction e abbinamento degli strumenti
...
- Intestazioni:
  ...
  - H2: Benchmark dell'avvio della CLI
  - H2: Benchmark dell'avvio del Gateway
  - H2: Benchmark del riavvio del Gateway
...
- Intestazioni:
  ...
  - H2: Impatto di Cache TTL e pruning
  - H3: Esempio: mantenere calda la cache di 1 ora con Heartbeat
  - H3: Esempio: traffico misto con strategia cache per agente
...
- Intestazioni:
  ...
  - H2: RPC della procedura guidata Gateway
...
- Intestazioni:
  ...
  - H3: Ripristino dopo riavvio e prontezza
  - H3: Consegna di risultati remoti e contenuti multimediali
...
- Intestazioni:
  ...
  - H4: T-EXEC-001: Iniezione diretta del prompt
  - H4: T-EXEC-002: Iniezione indiretta del prompt
  ...
  - H4: T-EVADE-001: Bypass del pattern di moderazione
...
- Intestazioni:
  ...
  - H3: Store di associazione (gating dei DM)
  ...
  - H3: Concorrenza / idempotenza dello store di associazione
  - H3: Correlazione della traccia in ingresso / idempotenza
...
- Intestazioni:
  ...
  - H2: Workflow all'avanguardia (Gateway in un terminale)
...
- Intestazioni:
  ...
  - H3: Configurazione dell'agente di verifica dello stato
...
- Intestazioni:
  ...
  - H2: Funziona senza configurazione?
  ...
  - H3: Impostazioni predefinite runtime per agente
  - H3: Esempio
  - H3: Comportamento
  ...
  - H2: Harness acpx, configurazione Plugin e autorizzazioni
  - H2: Risoluzione dei problemi
  - H2: Correlati
...
- Intestazioni:
  ...
  - H3: Causa principale
  - H3: Soluzione 1: installare Google Chrome (consigliata)
...
- Intestazioni:
  ...
  - H2: Avvio rapido
  - H2: Controllo Plugin
  - H2: Guida per gli agenti
  - H2: Comando o strumento browser mancante
  - H2: Profili: openclaw rispetto a utente
  - H2: Configurazione
  ...
  - H2: Sessione esistente tramite MCP Chrome DevTools
...
- Intestazioni:
  ...
  - H3: Directory dei binari attendibili
...
- Intestazioni:
  - H2: Funzionalità
  - H2: Matrice delle funzionalità dei fornitori
  - H2: Asincrono rispetto a sincrono
  - H2: Speech-to-text e Voice Call
  - H2: Mappature dei fornitori (come i vendor si suddividono tra le superfici)
  - H2: Correlati
...
- Intestazioni:
  ...
  - H2: Configurazione
  - H3: Selezione del modello
  - H3: Ordine di selezione dei fornitori
  - H2: Note sui fornitori
  - H2: Scegliere il percorso corretto
  - H2: Modalità delle funzionalità dei fornitori
  - H2: Test live
  - H2: Correlati
...
- Intestazioni:
  - H2: Installare il Plugin
  - H2: Chiave API (fornitore a pagamento)
  - H2: Configurazione
  - H2: Sostituzione dell'URL di base
  - H2: Parametri dello strumento
  - H2: Note
  - H2: Correlati
...
- Intestazioni:
  ...
  - H2: Riferimento alla configurazione del Plugin
  - H2: Note
  - H2: Correlati
...
- Intestazioni:
  ...
  - H2: Allowlist delle Skills in bundle
  - H2: Voci per singola skill (skills.entries)
  - H2: Allowlist degli agenti (agents)
  - H2: Workshop (skills.workshop)
  - H2: Radici delle skill collegate simbolicamente
...
- Intestazioni:
  ...
  - H2: Skills per agente rispetto a condivise
  ...
  - H2: Sostituzioni della configurazione
...
- Intestazioni:
  ...
  - H2: Orientare rispetto a mettere in coda
  - H2: Sotto-agenti
  - H2: Sessioni ACP
  - H2: Correlati
...
- Intestazioni:
  ...
  - H3: Sostituzione tramite configurazione
  - H2: Concorrenza
  - H2: Operatività e ripristino
  - H2: Arresto
  - H2: Limitazioni
  - H2: Correlati
...
- Intestazioni:
  ...
  - H3: tavilysearch
  - H3: tavilyextract
  - H2: Scegliere lo strumento corretto
  - H2: Configurazione avanzata
  - H2: Correlati
...
- Intestazioni:
  ...
  - H2: Fornitori supportati
  - H2: Configurazione
  - H3: Sostituzioni della voce per agente
  - H2: Persona
  - H3: Persona minima
  - H3: Persona completa (prompt indipendente dal fornitore)
  - H3: Risoluzione della persona
  - H3: Come i fornitori usano i prompt persona
...
- Intestazioni:
  - H2: Avvio rapido
  - H2: Scegliere un fornitore
  - H3: Confronto tra fornitori
...
- Intestazioni:
  ...
  - H2: Utilizzare nodi con una VPS
  - H2: Regolazione dell'avvio per VM piccole e host ARM
  - H3: Checklist di regolazione systemd (facoltativa)
  - H2: Correlati
...
- Intestazioni:
  ...
  - H2: Nozioni di base sull'autenticazione (locale rispetto a remota)
