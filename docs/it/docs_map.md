...
x-i18n:
    generated_at: "2026-06-30T14:08:39Z"
    model: gpt-5.5
...
- Intestazioni:
  - H1: Rimozione di BlueBubbles e percorso imsg iMessage
  - H2: Che cosa è cambiato
  - H2: Che cosa fare
  - H2: Note sulla migrazione
  - H2: Vedi anche
...
- Intestazioni:
  ...
  - H2: Guardia della policy SecretRef OAuth
...
- Intestazioni:
  ...
  - H2: Ordini permanenti più cron job
  - H2: Esempi
...
- Intestazioni:
  ...
  - H2: Pattern affidabile di workflow pianificato
  ...
  - H2: Comandi CLI
  - H2: Come i flussi sono correlati alle attività
  - H2: Correlati
...
- Intestazioni:
  ...
  - H2: Come le attività sono correlate ad altri sistemi
  - H2: Correlati
...
- Intestazioni:
  ...
  - H2: Predefiniti
  - H2: Configura i predefiniti condivisi
...
- Intestazioni:
  ...
  - H3: Sessioni ACP
  - H4: Associazione ACP persistente
...
- Intestazioni:
  ...
  - H2: Definisci l'ambito dei pattern di menzione configurati
  ...
  - H2: Specifiche iMessage
  - H2: Prompt di sistema WhatsApp
  - H2: Specifiche WhatsApp
  - H2: Correlati
...
- Intestazioni:
  ...
  - H2: Footgun del registro dei gruppi
  - H2: Passo dopo passo
  - H2: Parità delle azioni in sintesi
  - H2: Associazione, sessioni e binding ACP
...
- Intestazioni:
  ...
  - H2: Associazioni di conversazioni ACP
...
- Intestazioni:
  ...
  - H2: 2) Associazione di dispositivi Node (nodi iOS/Android/macOS/headless)
  - H3: Associazione tramite Telegram (consigliata per iOS)
...
- Intestazioni:
  ...
  - H2: Percorso di configurazione A: collegare un account Signal esistente (QR)
...
- Intestazioni:
  ...
  - H3: Invii modali gestiti dal Plugin
...
- Intestazioni:
  ...
  - H3: Numero privato solo elenco consentiti
...
- Intestazioni:
  ...
  - H2: Recapito, suddivisione in blocchi e contenuti multimediali
...
- Intestazioni:
  ...
  - H3: Gate sulle menzioni nei gruppi
  - H2: Multi-account
  - H2: Variabili d'ambiente
...
- Intestazioni:
  ...
  - H2: Gate di controllo locali e routing modificato
...
- Intestazioni:
  - H1: openclaw backup
  - H2: Note
  - H2: Elementi di cui viene eseguito il backup
...
- Intestazioni:
  ...
  - H3: Soppressione dei riconoscimenti obsoleti
...
- Intestazioni:
  ...
  - H2: Autenticazione del Gateway per host Node
...
- Intestazioni:
  - H1: openclaw policy
  - H2: Avvio rapido
  - H3: Riferimento delle regole delle policy
...
- Intestazioni:
  ...
  - H3: Dopo aver modificato sorgente, policy o modalità di OpenShell
...
- Intestazioni:
  - H1: openclaw setup
  - H2: Opzioni
  - H3: Attivazione automatica della procedura guidata
  - H2: Esempi
  - H2: Note
  - H2: Correlati
...
- Intestazioni:
  ...
  - H2: Modellazione risposta + soppressione
...
- Intestazioni:
  ...
  - H2: Abbinamento + attendibilità locale
...
- Intestazioni:
  - H2: Avvio rapido
  - H2: Come funziona
  - H3: Ciclo di vita del subagent (opzionale)
...
- Intestazioni:
  ...
  - H2: Cosa segnala davvero /context
  - H2: Correlati
...
- Intestazioni:
  ...
  - H2: Cache di skip per errore di autenticazione
  ...
  - H3: Quali errori avanzano il fallback
  - H3: Skip per cooldown vs comportamento di probe
...
- Intestazioni:
  - H2: Regole rapide
  - H2: Comportamento del provider di proprietà del Plugin
...
- Intestazioni:
  ...
  - H2: Ricerca nella memoria QMD cross-agent
  - H2: Un numero WhatsApp, più persone (divisione DM)
  - H2: Regole di instradamento (come i messaggi scelgono un agente)
...
- Intestazioni:
  ...
  - H2: Migrazione CLI Anthropic Claude
  - H2: Scambio OAuth (come funziona il login)
  - H3: setup-token Anthropic
  - H3: OpenAI Codex (ChatGPT OAuth)
  - H2: Refresh + scadenza
  - H2: Più account (profili) + instradamento
...
- Intestazioni:
  ...
  - H2: Invio di messaggi tra sessioni
  - H2: Helper di stato e orchestrazione
  - H2: Generazione di sub-agenti
  - H2: Visibilità
  - H2: Letture aggiuntive
  - H2: Correlati
...
- Intestazioni:
  ...
  - H2: Coalescenza (unione dei blocchi trasmessi in streaming)
  - H2: Ritmo simile a quello umano tra i blocchi
  - H2: "Trasmettere i chunk in streaming o tutto"
...
- Intestazioni:
  ...
  - H2: Iniezione del bootstrap del workspace
...
- Intestazioni:
  ...
  - H2: Impostazione del fuso orario dell'utente
...
- Intestazioni:
  ...
  - H2: Quando si modificano gli schemi
  - H2: Correlati
...
- Intestazioni:
  ...
  - H2: Modalità predefinita del piè di pagina sull'utilizzo
  - H3: Tre stati di sessione distinti
  - H3: Precedenza
  - H3: Reimpostazione rispetto a disattivazione
...
- Intestazioni:
  ...
  - H2: Verifica della versione Node
  - H2: Note / ipotesi
...
- Intestazioni:
  ...
  - H2: Verifica dello stato di autenticazione del modello
  - H2: Comportamento di rotazione delle chiavi API (gateway)
  - H2: Rimozione dell'autenticazione del provider mentre il gateway è in esecuzione
  - H2: Controllo di quale credenziale viene usata
  - H3: ID OpenAI e openai-codex legacy
...
- Intestazioni:
  - H2: Canali
  - H3: Accesso DM e di gruppo
  - H3: Override del modello del canale
  - H3: Valori predefiniti e Heartbeat del canale
  - H3: WhatsApp
  - H3: Telegram
  - H3: Discord
  - H3: Google Chat
  ...
  - H3: Gate sulle menzioni nelle chat di gruppo
...
- Intestazioni:
  ...
  - H3: Repository Skills sibling collegato con symlink
  - H2: Pattern comuni
...
- Intestazioni:
  ...
  - H3: Wide-area (DNS-SD)
  - H2: Ambiente
  - H3: env (variabili di ambiente inline)
  - H3: Sostituzione delle variabili di ambiente
  - H2: Segreti
  - H3: SecretRef
  - H3: Superficie delle credenziali supportata
  - H3: Configurazione dei provider di segreti
  - H2: Archiviazione dell'autenticazione
  - H3: auth.cooldowns
  - H2: Logging
  - H2: Diagnostica
  - H2: Aggiornamento
...
- Intestazioni:
  ...
  - H2: Abbinamento + autenticazione (trasporto diretto)
...
- Intestazioni:
  - H2: Avvio rapido
  - H3: Modalità headless e di automazione
...
- Intestazioni:
  ...
  - H2: Riferimento della configurazione
  - H2: Esempi
...
- Intestazioni:
  ...
  - H3: Exec
  - H3: Interni diagnostici (memoria e loop degli strumenti)
  - H2: Span esportati
...
- Intestazioni:
  ...
  - H2: Approvazioni di abbinamento dei dispositivi
  - H2: Approvazioni di abbinamento dei Node
  - H2: Autenticazione con segreto condiviso
...
- Intestazioni:
  ...
  - H2: Workflow CLI (adatto all'headless)
  ...
  - H2: Helper per l'abbinamento QR
...
- Intestazioni:
  ...
  - H3: RPC del ledger delle attività
  - H3: Metodi helper dell'operatore
  - H3: viste models.list
  - H2: Approvazioni Exec
  - H2: Fallback della consegna agli agenti
  - H2: Versionamento
  - H3: Costanti del client
  - H2: Autenticazione
  - H2: Identità del dispositivo + abbinamento
  - H3: Diagnostica della migrazione dell'autenticazione dispositivo
  - H2: TLS + pinning
  - H2: Ambito
  - H2: Correlati
...
- Intestazioni:
  ...
  - H2: Risoluzione dei percorsi dei comandi
...
- Intestazioni:
  - H2: Scegli il pattern di esposizione
...
- Intestazioni:
  ...
  - H2: Plugin
  - H2: Modello di accesso DM: associazione, allowlist, aperto, disabilitato
  ...
  - H3: DM: associazione predefinita
  ...
  - H3: Guardrail per la delega a sotto-agenti
...
- Intestazioni:
  ...
  - H2: Anthropic 429: uso extra richiesto per contesti lunghi
...
- Intestazioni:
  ...
  - H2: Quando NON usare
  - H2: Come funziona
  - H2: Comportamento di associazione della Control UI
  - H2: Configurazione
...
- Intestazioni:
  ...
  - H2: Trace del ciclo di vita dei Plugin
...
- Intestazioni:
  - H2: Avvio rapido e configurazione della prima esecuzione
  - H2: Correlati
...
- Intestazioni:
  - H2: Live: comandi di smoke locali
  - H2: Live: sweep delle capacità del nodo Android
  - H2: Live: smoke del modello (chiavi profilo)
  - H3: Livello 1: completamento diretto del modello (senza gateway)
  - H3: Livello 2: Gateway + smoke dell’agente dev (cosa fa effettivamente "@openclaw")
  ...
  - H3: Set di smoke moderno (chiamata di strumenti + immagine)
  ...
  - H2: Credenziali (non fare mai commit)
...
- Intestazioni:
  ...
  - H3: Aggiungere un canale alla QA
  ...
  - H2: Valutazioni affidabilità agenti (skills)
...
- Intestazioni:
  ...
  - H2: Backend locale compatibile con OpenAI funziona direttamente ma non in OpenClaw
  - H2: Installazione Plugin non riuscita per estensioni openclaw mancanti
...
- Intestazioni:
  ...
  - H2: Eseguire il deployment delle risorse Azure
...
- Intestazioni:
  ...
  - H2: 4) Configurare nginx come proxy da OpenClaw alla porta 8000
...
- Intestazioni:
  ...
  - H3: Scrittura della configurazione via SSH
...
- Intestazioni:
  ...
  - H2: 3) Completare l’assistente di configurazione
...
- Intestazioni:
  ...
  - H2: Installazione normale rispetto a checkout dei sorgenti
  - H3: Installazione normale (install.sh / npm / pnpm / bun)
  - H3: Checkout dei sorgenti (git clone)
  - H2: Correlati
...
- Intestazioni:
  ...
  - H2: Host Node remoto (system.run)
  - H3: Cosa viene eseguito dove
  - H3: Avvia un host Node (in primo piano)
  - H3: Gateway remoto tramite tunnel SSH (binding loopback)
  - H3: Avvia un host Node (servizio)
  - H3: Associa + assegna nome
  - H3: Inserisci i comandi nell'elenco consentiti
  - H3: Punta exec al Node
  ...
  - H3: Controlli Canvas
  - H3: A2UI (Canvas)
  - H2: Foto + video (fotocamera Node)
  - H2: Registrazioni dello schermo (Node)
  - H2: Posizione (Node)
  - H2: SMS (Node Android)
  - H2: Comandi dati dispositivo Android + personali
  - H2: Comandi di sistema (host Node / Node Mac)
  - H2: Binding del Node exec
  - H2: Mappa delle autorizzazioni
  - H2: Host Node headless (multipiattaforma)
  - H2: Modalità Node Mac
...
- Intestazioni:
  ...
  - H2: Codici di errore comuni dei Node
...
- Intestazioni:
  ...
  - H2: Esecuzione dei test dell'Agent Runtime
  - H2: Test manuali
...
- Intestazioni:
  ...
  - H3: Il server app Codex resta canonico per lo stato nativo dei thread
  ...
  - H3: 1. Esporta o ricolloca helper riutilizzabili per i tentativi del motore di contesto
  - H3: 2. Aggiungi un helper di proiezione del contesto Codex
  - H3: 3. Collega il bootstrap prima dell'avvio del thread Codex
  - H3: 4. Collega l'assemblaggio prima di thread/start / thread/resume e turn/start
  - H3: 5. Preserva la formattazione stabile della prompt-cache
  - H3: 6. Collega il post-turn dopo il mirroring della trascrizione
  - H3: 7. Normalizza l'utilizzo e il contesto runtime della prompt-cache
  - H3: 8. Criterio di Compaction
  - H4: /compact e Compaction OpenClaw esplicita
  - H4: Eventi Codex nativi contextCompaction durante il turno
...
- Intestazioni:
  ...
  - H3: 2) Verifica il rilevamento (opzionale)
  ...
  - H3: 5) Verifica che il Node sia connesso
...
- Intestazioni:
  ...
  - H2: Push con relay per build ufficiali
  - H2: Beacon attivi in background
...
- Intestazioni:
  - H2: Installa la CLI (obbligatoria per la modalità locale)
...
- Intestazioni:
  ...
  - H2: 2. Creare la build e pacchettizzare l'app
  - H2: 3. Installare la CLI
  - H2: Risoluzione dei problemi
...
- Intestazioni:
  ...
  - H2: Checklist di recupero quando i prompt scompaiono
...
- Intestazioni:
  ...
  - H2: Cosa va dove
  - H2: Punti di giunzione di provider e harness
...
- Intestazioni:
  ...
  - H2: Quickstart
  - H2: Registrare strumenti
  - H2: Convenzioni di importazione
  - H2: Checklist pre-invio
  - H2: Testare rispetto alle release beta
  - H2: Passaggi successivi
  - H2: Correlati
...
- Intestazioni:
  ...
  - H2: Dipendenze runtime e cleanup
  - H2: Sicurezza
  - H2: Risoluzione dei problemi
  - H2: Correlati
...
- Intestazioni:
  - H2: Panoramica
  - H2: Associazioni dei thread e modifiche di modello
  ...
  - H2: Compaction e mirror del transcript
  - H2: Media e consegna
  - H2: Correlati
...
- Intestazioni:
  ...
  - H2: Policy per azioni distruttive
  - H2: Risoluzione dei problemi
  - H2: Correlati
...
- Intestazioni:
  ...
  - H3: Alias flat dei callback in ingresso WhatsApp
...
- Intestazioni:
  ...
  - H3: Chrome
  - H3: Twilio
  - H2: OAuth e verifica preliminare
  - H3: Creare credenziali Google
  - H3: Generare il token di aggiornamento
  - H3: Verificare OAuth con doctor
  - H2: Configurazione
  - H2: Strumento
...
- Intestazioni:
  - H2: Avvio rapido
  - H2: Catalogo hook
  - H2: Eseguire il debug degli hook di runtime
  - H2: Policy delle chiamate agli strumenti
...
- Intestazioni:
  ...
  - H2: Richiedere approvazione prima di una chiamata a uno strumento
...
- Intestazioni:
  - H2: Quando usare una struttura di esecuzione
  - H2: Ciò che il core continua a possedere
  - H2: Registrare una struttura di esecuzione
  - H2: Criterio di selezione
  - H2: Abbinamento tra provider e struttura di esecuzione
  - H3: Middleware dei risultati degli strumenti
  - H3: Classificazione dell'esito terminale
  - H3: Effetti collaterali lato termine dell'agente
  - H3: Input utente e superfici degli strumenti
  - H3: Modalità struttura di esecuzione Codex nativa
...
- Intestazioni:
  - H2: Cosa sta cambiando
  - H2: Perché è cambiato
  - H2: Piano di migrazione per voce in tempo reale e conversazione
...
- Intestazioni:
  ...
  - H3: Infrastruttura
  - H3: Hook host per Plugin di flusso di lavoro
...
- Intestazioni:
  ...
  - H3: Promozione di un singolo account di proprietà del canale
  - H2: Schema di configurazione
  - H3: Creazione degli schemi di configurazione del canale
  - H2: Procedure guidate di configurazione
...
- Intestazioni:
  ...
  - H2: Pulizia delle chiamate obsolete
  ...
  - H3: La chiamata in tempo reale non ha voce
  - H2: Correlati
...
- Intestazioni:
  ...
  - H3: L'invio non avvia un worker
  - H2: Correlati
...
- Intestazioni:
  ...
  - H2: Generazione di immagini
  - H2: Generazione di video
  - H2: Contributo ai prompt di GPT-5
  - H2: Voce e parlato
...
- Intestazioni:
  ...
  - H3: Fase 3: Bonifica all'avvio basata prima sui lease
...
- Intestazioni:
  ...
  - H2: Cosa fa OpenClaw
  - H2: Skills di base (abilita in Impostazioni → Skills)
  - H2: Note d'uso
  - H2: Correlati
...
- Intestazioni:
  ...
  - H3: QA Lab
  - H3: Pacchetto
  - H2: Automazione di pubblicazione del rilascio
...
- Intestazioni:
  ...
  - H2: Come vengono scoperte le chiavi
...
- Intestazioni:
  ...
  - H3: Baseline con priorità al costo
...
- Intestazioni:
  - H2: Gate PR locale
  - H2: Benchmark latenza modello (chiavi locali)
  - H2: Benchmark avvio CLI
  - H2: Benchmark avvio Gateway
  - H2: Benchmark riavvio Gateway
  - H2: Onboarding E2E (Docker)
  - H2: Smoke test importazione QR (Docker)
  - H2: Correlati
...
- Intestazioni:
  ...
  - H2: Impatto di TTL della cache e pruning
...
- Intestazioni:
  ...
  - H3: Contribuire a questo modello di minacce
  - H2: 1. Introduzione
  - H3: 1.1 Scopo
  - H3: 1.2 Ambito
  - H3: 1.3 Fuori ambito
  ...
  - H4: T-RECON-001: Rilevamento endpoint dell'agente
  ...
  - H4: T-EXEC-004: Bypass approvazione exec
  - H3: 3.4 Persistenza (AML.TA0006)
  - H4: T-PERSIST-001: Installazione di Skill dannosa
  - H4: T-PERSIST-002: Avvelenamento dell'aggiornamento delle Skill
...
- Intestazioni:
  ...
  - H3: Archivio di abbinamento (gate dei DM)
  - H3: Gate di ingresso (menzioni + bypass dei comandi di controllo)
  - H3: Isolamento di routing/session-key
  - H2: v1++: modelli delimitati aggiuntivi (concorrenza, tentativi, correttezza della traccia)
...
- Intestazioni:
  ...
  - H2: Validazione
  - H2: Attendibilità della CA del proxy
  - H2: Limiti
...
- Intestazioni:
  ...
  - H3: La spesa folle del robot (3 dic 2025)
  - H2: Testi sacri
...
- Intestazioni:
  ...
  - H3: 0) (Opzionale) Esegui anche l'app macOS da sorgente
...
- Intestazioni:
  - H2: Supporto harness acpx (corrente)
  - H2: Configurazione richiesta
  ...
  - H3: Configurazione agente probe di salute
...
- Intestazioni:
  ...
  - H2: Modalità spawn bind e thread
...
- Intestazioni:
  ...
  - H3: Inoltro approvazioni Plugin
  - H3: Approvazioni nella stessa chat su qualsiasi canale
  - H3: Consegna approvazioni native
  - H3: Flusso IPC macOS
  - H2: FAQ
...
- Intestazioni:
  ...
  - H2: Mappature dei provider (come i vendor si distribuiscono tra le superfici)
  - H2: Correlati
...
- Intestazioni:
  ...
  - H2: Esempi di restrizione degli strumenti
...
- Intestazioni:
  ...
  - H2: Modalità delle capacità del provider
  - H2: Test live
  - H2: Correlati
...
- Intestazioni:
  ...
  - H2: Compatibilità con OpenRouter
  - H2: Esempi di configurazione
...
- Intestazioni:
  ...
  - H2: Skill per agente e condivise
...
- Intestazioni:
  ...
  - H2: /tools — ciò che l'agente può usare ora
...
- Intestazioni:
  ...
  - H3: Canali di supporto del thread
  - H3: Flusso rapido
...
- Intestazioni:
  ...
  - H3: Come i provider usano i prompt di persona
...
- Intestazioni:
  ...
  - H2: Ricerca web nativa di OpenAI
  - H2: Ricerca web nativa di Codex
  ...
  - H2: Parametri dello strumento
  - H2: xsearch
  - H3: Configurazione di xsearch
  - H3: Parametri di xsearch
  - H3: Esempio di xsearch
  - H2: Esempi
  - H2: Profili dello strumento
  - H2: Correlati
...
- Intestazioni:
  ...
  - H2: HTTP non sicuro
  - H2: Policy di sicurezza dei contenuti
  ...
  - H2: Debug/testing: server di sviluppo + Gateway remoto
  - H2: Correlati
...
- Intestazioni:
  ...
  - H2: Nozioni di base sull'autenticazione (locale vs remoto)
...
- Intestazioni:
  ...
  - H2: Configurazione (abilitata per impostazione predefinita)
...
- Intestazioni:
  ...
  - H2: Ripara configurazioni dalla TUI locale
...
- Intestazioni:
  ...
  - H2: Uso remoto
  - H2: Riferimento alla configurazione (WebChat)
  - H2: Correlati
