...
x-i18n:
    generated_at: "2026-04-05T14:07:15Z"
    model: gpt-5.4
    provider: openai
...
`~/.openclaw/.env` (o nell'ambiente del tuo servizio). Vedi [Variabili env](/it/help/faq#env-vars-and-env-loading).
...
- `count` è lì solo per compatibilità; la risposta resta comunque una singola
  risposta sintetizzata con citazioni anziché un elenco di N risultati
- I filtri solo API di ricerca come `country`, `language`, `date_after`,
...
- [Documentazione API di ricerca Perplexity](https://docs.perplexity.ai/docs/search/quickstart) -- documentazione ufficiale di Perplexity
