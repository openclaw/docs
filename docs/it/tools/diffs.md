...
read_when:
    ...
    - Sono necessari artefatti di diff controllati e temporanei con impostazioni predefinite sicure
sidebarTitle: Diffs
...
<Note>
Motore di rendering dei diff powered by [Diffs](https://diffs.com).
</Note>
