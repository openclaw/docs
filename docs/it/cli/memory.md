...
read_when:
    ...
    - Stai diagnosticando la disponibilità della memoria o l'indicizzazione
...
Fornito dal Plugin Active Memory attivo (predefinito: `memory-core`; imposta `plugins.slots.memory = "none"` per disabilitarlo).
