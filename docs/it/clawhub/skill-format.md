...
I metadati della skill sono dichiarati nel frontmatter YAML all’inizio del tuo `SKILL.md`. Questo comunica al registro (e all’analisi di sicurezza) cosa serve alla skill per funzionare.
...
- Gli scope dei pacchetti devono corrispondere esattamente all’handle del publisher ClawHub. Gli handle dei publisher possono usare lettere minuscole, numeri, trattini, punti e underscore; devono iniziare e finire con una lettera minuscola o un numero.
