...
- `.clawhubignore` (pattern da ignorare per pubblicazione/sincronizzazione, `.clawdhubignore` legacy)
...
- I tipi di contenuto che iniziano con `text/` sono trattati come testo; in più, una piccola allowlist (JSON/YAML/TOML/JS/TS/Markdown/SVG).
