...
x-i18n:
    generated_at: "2026-07-04T10:43:45Z"
    model: gpt-5.5
...
L'importatore GitHub web è più rigido rispetto alla pubblicazione/sincronizzazione locale. Rileva solo
...
| `emoji`            | `string`   | Emoji di visualizzazione per la skill.                                                                                                                 |
...
- Il testo di embedding include `SKILL.md` + fino a ~40 file non `.md` (limite best-effort).
