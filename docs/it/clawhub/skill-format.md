...
- `description` è usato come riepilogo della skill nella UI/ricerca.
...
- Chiunque può usare, modificare e redistribuire le skill pubblicate, anche a fini commerciali.
