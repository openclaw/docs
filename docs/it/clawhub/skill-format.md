...
x-i18n:
    generated_at: "2026-07-02T22:37:11Z"
    model: gpt-5.5
...
L'importatore web GitHub è più rigoroso rispetto alla pubblicazione/sincronizzazione locale. Rileva solo
...
- I tipi di contenuto che iniziano con `text/` vengono trattati come testo; più una piccola allowlist (JSON/YAML/TOML/JS/TS/Markdown/SVG).
