...
x-i18n:
    generated_at: "2026-07-03T13:32:46Z"
    model: gpt-5.5
...
| `os`               | `string[]` | Restrizioni del sistema operativo (per es. `["macos"]`, `["linux"]`).                                                                             |
...
- Gli scope dei pacchetti devono corrispondere esattamente all'handle del publisher ClawHub. Gli handle del publisher possono usare lettere minuscole, numeri, trattini, punti e underscore; devono iniziare e finire con una lettera minuscola o un numero.
