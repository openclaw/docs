...
x-i18n:
    generated_at: "2026-07-05T05:12:00Z"
    model: gpt-5.5
...
L'importatore web da GitHub è più rigoroso della pubblicazione/sincronizzazione locale. Rileva solo
...
Usa `requires.env` per le variabili di ambiente che devono essere presenti prima che la skill possa essere eseguita. Usa `envVars` quando hai bisogno di metadati per variabile, incluse variabili facoltative con `required: false`.

### Riferimento completo dei campi

| Campo              | Tipo       | Descrizione                                                                                                                                  |
| ------------------ | ---------- | -------------------------------------------------------------------------------------------------------------------------------------------- |
| `requires.env`     | `string[]` | Variabili di ambiente obbligatorie che la tua skill si aspetta.                                                                              |
...
| `primaryEnv`       | `string`   | La variabile di ambiente principale per le credenziali della tua skill.                                                                      |
