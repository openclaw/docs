...
| ------------------ | ---------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `requires.env`     | `string[]` | Variabili d'ambiente obbligatorie che la tua skill si aspetta.                                                                                                  |
| `requires.bins`    | `string[]` | Binari CLI che devono essere tutti installati.                                                                                                                  |
| `requires.anyBins` | `string[]` | Binari CLI per cui deve esisterne almeno uno.                                                                                                                   |
...
| `always`           | `boolean`  | Se `true`, la skill è sempre attiva (non è necessaria alcuna installazione esplicita).                                                                          |
