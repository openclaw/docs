...
x-i18n:
    generated_at: "2026-07-02T08:21:25Z"
    model: gpt-5.5
...
Queste regole si applicano a ciò che fa un'inserzione, a ciò che chiede agli utenti di eseguire, a come si
...
| ----------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Accesso non autorizzato o aggiramento della sicurezza                      | Aggiramento dell'autenticazione, acquisizione di account, abuso dei limiti di frequenza, acquisizione di chiamate live o agenti, furto di sessioni riutilizzabili o flussi di associazione approvati automaticamente per utenti non approvati.                                                                                                                                                   |
...
| Frodi, truffe e flussi di lavoro finanziari ingannevoli             | Certificati o fatture falsi, flussi di pagamento ingannevoli, contatti per truffe, prove sociali false, flussi di lavoro con identità sintetiche per frode o strumenti di spesa/addebito senza chiara approvazione umana.                                                                                                                    |
| Arricchimento invasivo della privacy o sorveglianza                 | Scraping di contatti per spam, doxxing, stalking, estrazione di lead abbinata a contatti non sollecitati, monitoraggio occulto, corrispondenza biometrica non consensuale o uso di dati trapelati o dump di violazioni.                                                                                                                  |
| Impersonificazione non consensuale o manipolazione dell'identità       | Face swap, gemelli digitali, influencer clonati, identità false o altri strumenti usati per impersonare o trarre in inganno.                                                                                                                                                                                                 |
| Contenuto sessuale esplicito o generazione per adulti con sicurezze disabilitate | Generazione di immagini, video o contenuti NSFW; wrapper per contenuti per adulti attorno ad API di terze parti; o inserzioni il cui scopo principale è contenuto sessuale esplicito.                                                                                                                                                       |
...
- pubblicazione in blocco di grandi numeri di inserzioni a basso impegno, duplicative, segnaposto o
  generate da macchine che non sembrano avere un reale valore per gli utenti
...
- gonfiare artificialmente installazioni, download, stelle o altre metriche di
  ...
  coordinata, coinvolgimento pagato o altri comportamenti non organici
...
per rivendicazioni di copyright o diritti, a meno che l'inserzione non sia anche non sicura,
...
non prova un abuso da solo; aiuta ClawHub a decidere cosa richiede revisione.
