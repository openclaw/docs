...
x-i18n:
    generated_at: "2026-07-02T17:37:58Z"
    model: gpt-5.5
...
fiducia di ClawHub. Per gli stati di moderazione e lo stato dell'account, consulta
[Moderazione e sicurezza dell'account](/clawhub/moderation). Per copyright o altre rivendicazioni
di diritti, consulta [Richieste sui diritti dei contenuti](/clawhub/content-rights).
...
| Flussi di lavoro per UI, dati e automazione               | L'ambito è chiaro, le credenziali richieste sono esplicite e le azioni rischiose includono percorsi di revisione, simulazione, anteprima o conferma. |
| Sicurezza difensiva, moderazione e revisione degli abusi | Lo strumento è presentato per revisione autorizzata, conserva le prove e mantiene chiari i confini dell'approvazione umana.                          |
...
| ----------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Accesso non autorizzato o aggiramento della sicurezza                      | Aggiramento dell'autenticazione, acquisizione di account, abuso dei limiti di frequenza, acquisizione di chiamate live o agenti, furto di sessioni riutilizzabili o approvazione automatica dei flussi di abbinamento per utenti non approvati.                                                                                                                                                   |
| Abuso della piattaforma ed elusione dei ban                              | Account stealth dopo i ban, riscaldamento o farming di account, interazioni false, automazione multi-account, pubblicazione di massa, bot di spam o automazione costruita per evitare il rilevamento.                                                                                                                                          |
...
| Contenuti sessuali espliciti o generazione per adulti senza protezioni di sicurezza | Generazione di immagini, video o contenuti NSFW; wrapper per contenuti per adulti intorno ad API di terze parti; o schede il cui scopo principale è contenuto sessuale esplicito.                                                                                                                                                       |
...
| Materiale che viola copyright o altri diritti           | Ripubblicare lo skill, il Plugin, la documentazione, le risorse di brand o il codice proprietario di qualcun altro senza autorizzazione; violare i termini di licenza; o impersonare l'autore o l'editore originale.                                                                                                                            |
...
- pubblicazione in blocco di grandi quantità di schede a basso impegno, duplicative, segnaposto o
...
- gonfiare artificialmente installazioni, download, stelle o altre metriche di interazione
  tramite automazione, cicli di autoinstallazione, account falsi, attività coordinata,
  interazioni a pagamento o altro comportamento non organico
- creare o ruotare account per eludere moderazione, ban, limiti dell'editore o
...
- nascondere, trattenere, rimuovere, eliminare in modo reversibile o, quando supportato dal tipo di risorsa,
...
schede nascoste, ban e stato dell'account.
