...
x-i18n:
    generated_at: "2026-06-30T14:06:09Z"
    model: gpt-5.5
...
| ----------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Accesso non autorizzato o aggiramento della sicurezza                      | Aggiramento dell'autenticazione, takeover di account, abuso dei limiti di frequenza, takeover di chiamate live o agenti, furto di sessioni riutilizzabili o approvazione automatica di flussi di abbinamento per utenti non approvati.                                                                                                                                                   |
| Abuso della piattaforma ed elusione dei ban                              | Account stealth dopo ban, riscaldamento o coltivazione di account, engagement falso, automazione multi-account, pubblicazione massiva, bot di spam o automazione costruita per evitare il rilevamento.                                                                                                                                          |
| Frodi, truffe e flussi finanziari ingannevoli             | Certificati o fatture falsi, flussi di pagamento ingannevoli, outreach fraudolento, falsa prova sociale, flussi di lavoro con identità sintetiche per frodi o strumenti di spesa/addebito senza chiara approvazione umana.                                                                                                                    |
...
| Impersonificazione non consensuale o manipolazione dell'identità       | Face swap, gemelli digitali, influencer clonati, persone false o altri strumenti usati per impersonare o trarre in inganno.                                                                                                                                                                                                 |
...
| Materiale che viola copyright o diritti           | Ripubblicare Skills, plugin, documentazione, asset di brand o codice proprietario di qualcun altro senza autorizzazione; violare i termini di licenza; o impersonare l'autore o il publisher originale.                                                                                                                            |
...
- pubblicare in massa grandi numeri di schede a basso impegno, duplicative, segnaposto o
  generate automaticamente che non sembrano avere valore reale per gli utenti
- invadere superfici di ricerca o categoria con Skills o plugin quasi identici
...
- creare o ruotare account per eludere moderazione, ban, limiti per publisher o
