...
x-i18n:
    generated_at: "2026-07-03T15:31:41Z"
    model: gpt-5.5
...
[Moderazione e sicurezza dell'account](/it/clawhub/moderation). Per rivendicazioni di copyright o altri diritti,
...
| Sicurezza difensiva, moderazione e revisione degli abusi | Lo strumento è presentato per una revisione autorizzata, conserva le prove e mantiene chiari i confini di approvazione umana.                          |
...
| ----------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Accesso non autorizzato o aggiramento della sicurezza                      | Aggiramento dell'autenticazione, takeover di account, abuso dei limiti di frequenza, takeover di chiamate live o agenti, furto riutilizzabile di sessioni o flussi di abbinamento approvati automaticamente per utenti non approvati.                                                                                                                                                   |
| Abuso della piattaforma ed elusione dei ban                              | Account stealth dopo ban, riscaldamento o farming di account, interazioni false, automazione multi-account, pubblicazione di massa, bot spam o automazione costruita per evitare il rilevamento.                                                                                                                                          |
...
| Arricchimento o sorveglianza invasivi della privacy                 | Scraping di contatti per spam, doxxing, stalking, estrazione di lead associata a contatti non richiesti, monitoraggio occulto, corrispondenza biometrica non consensuale o uso di dati trapelati o dump di violazioni.                                                                                                                  |
| Impersonificazione non consensuale o manipolazione dell'identità       | Face swap, gemelli digitali, influencer clonati, persone false o altri strumenti usati per impersonare o ingannare.                                                                                                                                                                                                 |
...
- pubblicare in blocco grandi numeri di schede a basso impegno, duplicative, placeholder o
...
revisioni dello staff per identificare contenuti non sicuri o comportamenti di pubblicazione abusivi. Un segnale
...
- bannare i recidivi o i trasgressori gravi

Non garantiamo l'applicazione con avviso preventivo per abusi evidenti. Consulta
[Moderazione e sicurezza dell'account](/it/clawhub/moderation) per segnalazioni, sospensioni di moderazione,
