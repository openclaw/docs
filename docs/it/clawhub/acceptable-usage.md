...
x-i18n:
    generated_at: "2026-07-01T15:25:06Z"
    model: gpt-5.5
...
| ----------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Accesso non autorizzato o aggiramento della sicurezza       | Aggiramento dell'autenticazione, presa di controllo dell'account, abuso dei limiti di frequenza, presa di controllo di chiamate live o agenti, furto di sessioni riutilizzabili o approvazione automatica di flussi di pairing per utenti non approvati.                                                      |
| Abuso della piattaforma ed elusione dei ban                 | Account nascosti dopo ban, riscaldamento o farming di account, engagement falso, automazione multi-account, pubblicazione di massa, spam bot o automazione creata per evitare il rilevamento.                                                                                                               |
| Frodi, truffe e flussi finanziari ingannevoli               | Certificati o fatture falsi, flussi di pagamento ingannevoli, attività di contatto truffaldine, falsa riprova sociale, flussi di lavoro con identità sintetiche per frode o strumenti di spesa/addebito senza chiara approvazione umana.                                                                      |
| Arricchimento o sorveglianza invasivi della privacy         | Scraping di contatti per spam, doxxing, stalking, estrazione di lead abbinata a contatti non sollecitati, monitoraggio occulto, corrispondenza biometrica non consensuale o uso di dati trapelati o dump di violazioni.                                                                                      |
...
| Requisiti di esecuzione nascosti, non sicuri o fuorvianti   | Comandi di installazione offuscati, installer pipe-to-shell come contenuti scaricati eseguiti con `sh` o `bash` senza chiara possibilità di revisione, requisiti di segreti o chiavi private non dichiarati, esecuzione remota `npx @latest` senza chiara possibilità di revisione o metadati che nascondono ciò di cui la scheda ha realmente bisogno per funzionare. |
| Materiale che viola copyright o altri diritti               | Ripubblicazione senza autorizzazione di Skill, Plugin, documentazione, asset di brand o codice proprietario di qualcun altro; violazione dei termini di licenza; o impersonificazione dell'autore o editore originale.                                                                                         |
...
- gonfiare artificialmente installazioni, download, stelle o altre metriche di engagement
  tramite automazione, loop di auto-installazione, account falsi, attività coordinate,
...
il volume è associato a schede superficiali, duplicate, fuorvianti, non mantenute o
...
per copyright o rivendicazioni di diritti, a meno che la scheda non sia anche non sicura,
...
- nascondere, mettere in sospeso, rimuovere, eliminare reversibilmente o, quando supportato per il tipo di risorsa,
  eliminare definitivamente le schede in violazione
- bloccare download o installazioni per release non sicure
- revocare token API
- eliminare reversibilmente i contenuti associati
