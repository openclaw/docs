...
x-i18n:
    generated_at: "2026-07-03T02:49:45Z"
    model: gpt-5.5
...
| `Review`    | Leggi i rilievi prima dell'installazione. La release può comunque essere legittima. |
...
I rilievi possono essere etichettati come `Info`, `Low`, `Medium`, `High` o `Critical`. I rilievi di gravità
più alta contribuiscono in modo più forte al livello di rischio e allo stato dell'audit.
...
ClawHub sottopone ad audit gli artefatti di release inviati, tra cui:
...
e contenuto effettivo sono allineati a ciò che gli utenti si aspetterebbero ragionevolmente?
...
disponibili i conteggi dei motori dei fornitori, l'audit li riepiloga in linguaggio semplice, ad
esempio:
...
VirusTotal rimane telemetria. Non sostituisce l'analisi del rischio di ClawHub, consapevole
degli artefatti.
