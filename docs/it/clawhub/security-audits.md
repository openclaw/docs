...
x-i18n:
    generated_at: "2026-07-01T05:46:44Z"
    model: gpt-5.5
...
| Stato       | Significato                                                              |
| ----------- | ------------------------------------------------------------------------ |
| `Pass`      | Non è stato trovato alcun problema visibile sopra il basso rischio.      |
| `Review`    | Leggi i risultati prima dell'installazione. La release potrebbe comunque essere legittima. |
| `Warn`      | Usa particolare cautela. ClawHub ha trovato una criticità ad alto impatto o un segnale di avviso. |
...
resta concentrata su evidenze utili.

## Cosa controlla ClawHub

ClawHub verifica gli artefatti di release inviati, inclusi:
...
partnership permette a ClawHub di aggiungere una più ampia intelligence di sicurezza alla revisione di skill e plugin.
...
metadati, autorizzazioni dichiarate, file, segnali di capability, segnali di scansione statica,
...
ClawScan non considera automaticamente malevola una capability dall'aspetto preoccupante.
Chiede se la capability è dichiarata, allineata allo scopo e supportata
