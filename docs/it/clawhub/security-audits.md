...
x-i18n:
    generated_at: "2026-07-01T15:25:36Z"
    model: gpt-5.5
...
| `Review`    | Leggi i risultati prima dell'installazione. La release potrebbe essere comunque legittima. |
| `Warn`      | Usa particolare cautela. ClawHub ha rilevato un problema ad alto impatto o un segnale di avvertimento. |
...
Ad esempio, uno skill di pubblicazione può mostrare `Review` con rischio `Medium`. Questo
...
I risultati a bassa attendibilità sono nascosti dal riepilogo pubblico dell'audit, così la pagina
...
segnali di reputazione che integrano la revisione di ClawHub consapevole degli agenti. Quando
sono disponibili i conteggi dei motori dei fornitori, l'audit li riassume in linguaggio semplice, ad
esempio:
