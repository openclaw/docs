...
read_when:
    ...
    - Spiegare lo stato di audit di ClawHub, il livello di rischio o i rilievi
...
x-i18n:
    generated_at: "2026-07-03T23:33:59Z"
    model: gpt-5.5
...
| `Review`    | Leggi i risultati prima dell'installazione. La release può essere ancora legittima. |
...
I risultati possono essere etichettati come `Info`, `Low`, `Medium`, `High` o `Critical`. I risultati di gravità
più alta contribuiscono in modo più forte al livello di rischio e allo stato dell'audit.

I risultati a bassa confidenza sono nascosti dal riepilogo pubblico dell'audit così che la pagina
rimanga concentrata su evidenze utili.
...
partnership consente a ClawHub di aggiungere una più ampia intelligence di sicurezza alla revisione di skill e plugin.

VirusTotal è particolarmente utile per artefatti malevoli noti, rilevamenti dei motori e
segnali di reputazione che completano la revisione di ClawHub consapevole degli agenti. Quando i conteggi
dei motori dei vendor sono disponibili, l'audit li riassume in linguaggio semplice, ad esempio:
