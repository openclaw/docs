...
x-i18n:
    generated_at: "2026-06-30T14:07:51Z"
    model: gpt-5.5
...
| `High`             | La release ha un'autorità ad alto impatto, rilievi gravi o segnali malevoli. |
...
rilievi di SkillSpector, telemetria VirusTotal e contesto fornito dal publisher.
