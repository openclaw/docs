...
read_when:
    ...
    - Spiegare lo stato dell’audit ClawHub, il livello di rischio o i risultati
...
x-i18n:
    generated_at: "2026-07-04T03:49:57Z"
    model: gpt-5.5
...
- credenziali, permessi o variabili di ambiente richiesti
...
| Stato       | Significato                                                               |
| ----------- | ------------------------------------------------------------------------- |
| `Pass`      | Non è stato trovato alcun problema visibile oltre il basso rischio.       |
...
- variabili di ambiente e permessi dichiarati
...
di ClawHub. Esamina ogni release come artefatto destinato ad agenti: istruzioni,
metadati, permessi dichiarati, file, segnali di capacità, segnali di scansione statica,
risultati di SkillSpector, telemetria VirusTotal e contesto fornito dal publisher.
...
Chiede se la capacità è dichiarata, allineata allo scopo e supportata dal
caso d'uso dichiarato della release.
