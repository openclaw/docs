...
x-i18n:
    generated_at: "2026-06-30T22:20:44Z"
    model: gpt-5.5
...
I rilievi possono essere etichettati come `Info`, `Low`, `Medium`, `High` o `Critical`. I rilievi di
...
resti focalizzata su prove utili.
