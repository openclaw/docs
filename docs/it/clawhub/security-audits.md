...
x-i18n:
    generated_at: "2026-07-05T05:09:33Z"
    model: gpt-5.5
...
- proprietario, sorgente, versione, changelog, download, stelle e altri segnali di fiducia
...
Il livello di rischio descrive il raggio d'impatto: quanta potenza sembra avere la release se
...
| `High`             | La release ha autorità ad alto impatto, rilievi gravi o segnali malevoli.    |

Livello di rischio e stato dell'audit rispondono a domande diverse:

- Il livello di rischio chiede: "Quanta potenza c'è qui?"
...
I rilievi possono essere etichettati come `Info`, `Low`, `Medium`, `High` o `Critical`. I rilievi con gravità più alta
contribuiscono più fortemente al livello di rischio e allo stato dell'audit.

I rilievi a bassa confidenza sono nascosti dal riepilogo pubblico dell'audit affinché la pagina
resti concentrata su prove utili.
...
potenza è prevista, dichiarata e proporzionata.
...
segnali di reputazione che completano la revisione agent-aware di ClawHub. Quando i conteggi dei
motori dei fornitori sono disponibili, l'audit li riassume in linguaggio semplice, ad
esempio:
...
rilievi di SkillSpector, telemetria di VirusTotal e contesto fornito dal publisher.
...
ClawScan non tratta una capacità dall'aspetto allarmante come automaticamente malevola.
