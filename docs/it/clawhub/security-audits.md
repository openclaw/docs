...
read_when:
    ...
    - Spiegare lo stato dell’audit di ClawHub, il livello di rischio o i risultati
sidebarTitle: Security Audits
summary: Come interpretare i risultati della verifica di sicurezza di ClawHub prima di installare un'abilità o un plugin.
title: Audit di sicurezza
x-i18n:
    generated_at: "2026-06-27T17:17:24Z"
    model: gpt-5.5
...
agire con significativa autorità sull'account.
