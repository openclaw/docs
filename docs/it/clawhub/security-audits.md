---
read_when:
    - Comprendere i risultati degli audit di sicurezza di ClawHub
    - Decidere se installare una skill o un plugin
    - Spiegazione dello stato di audit di ClawHub, del livello di rischio o dei rilievi
...
x-i18n:
    generated_at: "2026-07-04T06:36:10Z"
    model: gpt-5.5
...
I risultati spiegano perché è stato mostrato un certo esito dell'audit. Ogni risultato di solito include:
