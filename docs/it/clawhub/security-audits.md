...
x-i18n:
    generated_at: "2026-07-01T13:04:47Z"
    model: gpt-5.5
...
| `Review`    | Leggi i risultati prima di installare. La release potrebbe comunque essere legittima. |
...
| `Medium`   | La release ha autorità significativa, come accesso all'account o modifiche ai dati. |
...
I risultati possono essere etichettati come `Info`, `Low`, `Medium`, `High` o `Critical`. I risultati con severità
...
segnali di reputazione che integrano la revisione consapevole degli agenti di ClawHub. Quando
sono disponibili i conteggi dei motori dei vendor, l'audit li riassume in linguaggio semplice, ad
esempio:
...
proprio di ClawHub. Esamina ogni release come artefatto rivolto agli agenti: istruzioni,
