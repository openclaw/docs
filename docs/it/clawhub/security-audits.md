...
summary: Come interpretare i risultati del controllo di sicurezza di ClawHub prima di installare una skill o un plugin.
title: Audit di sicurezza
x-i18n:
    generated_at: "2026-07-03T09:41:08Z"
    model: gpt-5.5
...
da installare. Mostrano cosa fa un rilascio, quali autorizzazioni richiede e
...
| `Review`    | Leggi i risultati prima di installare. Il rilascio può comunque essere legittimo. |
...
| `Medium`   | Il rilascio ha autorità significativa, come accesso ad account o modifiche ai dati. |
...
Le pagine degli artefatti rimandano all'audit completo a:
...
VirusTotal è particolarmente utile per artefatti dannosi noti, riscontri dei motori e
segnali di reputazione che completano la revisione di ClawHub consapevole degli agenti. Quando i conteggi dei
motori dei fornitori sono disponibili, l'audit li riassume in linguaggio semplice, ad esempio:
...
di ClawHub. Esamina ogni rilascio come artefatto destinato agli agenti: istruzioni,
