...
read_when:
    ...
    - Ripristino da una voce trattenuta, nascosta o bloccata
...
ClawHub è aperto alla pubblicazione, ma le superfici di scoperta e installazione pubbliche hanno comunque
bisogno di controlli di sicurezza. Segnalazioni, blocchi di moderazione, inserzioni nascoste e azioni sugli account
...
Usa il pulsante **Segnala skill** nella pagina di una skill, oppure il comando/API
di segnalazione dei pacchetti per i pacchetti.
...
nella scansione, nella moderazione o nei confini di fiducia di download/installazione. Non usare gli advisory di ClawHub
per vulnerabilità in skill o plugin di terze parti.

Le buone segnalazioni sono specifiche e utilizzabili. L'abuso delle segnalazioni può a sua volta portare
a un'azione sull'account.

## Rivendicazioni di organizzazioni e namespace

Le dispute sulla proprietà di organizzazioni, brand, ambiti di pacchetto, handle proprietario o namespace devono
...
Alcuni riscontri gravi o problemi di policy possono mettere un publisher o un'inserzione sotto
un blocco di moderazione. Quando accade, i contenuti interessati possono essere nascosti dalla scoperta
...
I segnali di revisione temporale a confidenza più bassa e delimitati restano fuori
...
inizia a non riuscire dopo un'azione sull'account, accedi all'interfaccia web per riesaminare lo
