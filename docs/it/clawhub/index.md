...
title: ClawHub
x-i18n:
    generated_at: "2026-07-01T20:23:24Z"
    model: gpt-5.5
...
| Ambito         | Cosa archivia                                                | Comando tipico                              |
| -------------- | ------------------------------------------------------------ | ------------------------------------------ |
...
stato attuale del registro così gli utenti possono ispezionare una Skill o un plugin prima di installarlo.
...
Le specifiche di plugin non qualificate compatibili con npm possono essere risolte tramite npm durante le transizioni di lancio, e
...
La CLI ClawHub è per il lavoro autenticato dal registro:
...
La CLI include anche comandi di installazione/aggiornamento delle Skill per flussi diretti sul registro:
...
ClawHub esegue controlli automatizzati su Skills pubblicate e release dei plugin. Le release trattenute dalla scansione
