...
Installa la CLI di ClawHub quando vuoi flussi autenticati sul registro, come
...
| -------------- | ----------------------------------------------------------- | ------------------------------------------- |
| Skills         | Pacchetti di testo versionati con `SKILL.md` e file di supporto | `openclaw skills install @openclaw/demo`     |
...
Le specifiche di plugin bare compatibili con npm possono risolversi tramite npm durante i cutover di lancio, e
...
prima che venga eseguita l'installazione dell'archivio. Quando una versione di pacchetto pubblica un artefatto
...
La CLI ClawHub serve per lavoro autenticato sul registro:
...
nascondere o ripristinare contenuti e bandire account abusivi. Consulta
