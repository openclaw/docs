...
summary: Panoramica pubblica di ClawHub per scoperta, installazione, pubblicazione, sicurezza e CLI di clawhub.
title: ClawHub
x-i18n:
    generated_at: "2026-07-01T15:25:08Z"
    model: gpt-5.5
...
I comandi nativi di OpenClaw installano nello spazio di lavoro OpenClaw attivo e mantengono
...
prima dell'esecuzione dell'installazione dell'archivio. Quando una versione del pacchetto pubblica un
...
La CLI ClawHub è per il lavoro autenticato sul registro:
...
La CLI ha anche comandi di installazione/aggiornamento Skills per flussi di lavoro diretti con il registro:
...
e [Formato Skills](/clawhub/skill-format) per i metadati delle Skill.
...
[Utilizzo accettabile](/it/clawhub/acceptable-usage) per dettagli su policy e applicazione.
