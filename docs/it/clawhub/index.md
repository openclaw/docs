...
title: ClawHub
x-i18n:
    generated_at: "2026-07-02T08:21:17Z"
    model: gpt-5.5
...
I comandi nativi OpenClaw installano nello workspace OpenClaw attivo e persistono
...
Questi comandi installano gli Skill in `./skills` nella directory di lavoro corrente
...
ClawHub esegue controlli automatici sugli Skill pubblicati e sulle release dei plugin. Le release trattenute dalla scansione
o bloccate possono sparire dal catalogo pubblico e dalle superfici di installazione, pur
...
best-effort così ClawHub può calcolare conteggi di installazione aggregati. Disabilitalo con:
