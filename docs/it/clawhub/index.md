...
title: ClawHub
x-i18n:
    generated_at: "2026-06-28T06:01:08Z"
    model: gpt-5.5
...
La CLI include anche comandi di installazione/aggiornamento delle skill per flussi di lavoro diretti sul registro:
...
abbastanza vecchio da superare il controllo di caricamento. Le pagine di dettaglio pubbliche riepilogano
...
Quando esegui `clawhub install` mentre sei autenticato, la CLI può inviare un evento di installazione best-effort
