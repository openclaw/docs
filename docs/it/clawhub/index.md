...
title: ClawHub
x-i18n:
    generated_at: "2026-07-04T20:32:51Z"
    model: gpt-5.5
...
| Bundle Plugin  | Bundle Plugin pacchettizzati per la distribuzione OpenClaw  | `clawhub package publish <source>`         |
...
La CLI dispone anche di comandi di installazione/aggiornamento delle skill per flussi diretti del registro:
...
ClawHub esegue controlli automatici sulle Skills pubblicate e sulle release dei Plugin. Le release trattenute dalla scansione
...
| `CLAWHUB_CONFIG_PATH`         | Sostituisce il percorso in cui la CLI archivia stato token/configurazione. |
