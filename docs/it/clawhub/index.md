...
- Usa la CLI `clawhub` separata per autenticazione al registro, pubblicazione, eliminazione/ripristino eliminazione e flussi di sincronizzazione.
...
pubblicazione, sincronizzazione o eliminazione/ripristino eliminazione:
...
Le specifiche di plugin nude compatibili con npm possono risolversi tramite npm durante i cambi di lancio, e
...
La CLI ClawHub è per lavoro autenticato dal registro:
...
Quei comandi installano Skills in `./skills` sotto la directory di lavoro corrente
...
ClawHub esegue controlli automatici su Skills pubblicate e rilasci di plugin. I rilasci
