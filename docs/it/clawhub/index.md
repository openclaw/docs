...
title: ClawHub
x-i18n:
    generated_at: "2026-06-30T14:04:06Z"
    model: gpt-5.5
...
Le specifiche di plugin compatibili con npm senza prefisso possono essere risolte tramite npm durante le transizioni di lancio, e
...
La CLI ClawHub serve per lavoro autenticato con il registro:
...
ClawHub esegue controlli automatizzati sulle Skills pubblicate e sulle release dei plugin. Le release trattenute dalla scansione
...
Gli utenti con accesso effettuato possono segnalare Skills e pacchetti. I moderatori possono esaminare le segnalazioni,
...
[Utilizzo accettabile](/clawhub/acceptable-usage) per i dettagli su policy e applicazione.

## Telemetria e ambiente

Quando esegui `clawhub install` mentre hai effettuato l'accesso, la CLI può inviare un evento
di installazione al meglio delle possibilità, così ClawHub può calcolare conteggi aggregati delle installazioni. Disabilitalo con:
