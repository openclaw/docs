...
| -------------- | ------------------------------------------------------------ | -------------------------------------------- |
| Skills         | Bundle di testo con versioni con `SKILL.md` e file di supporto | `openclaw skills install <slug>`             |
...
Le specifiche Plugin nude sicure per npm possono risolversi tramite npm durante i passaggi di lancio, e
