...
summary: Panoramica pubblica di ClawHub per discovery, installazione, pubblicazione, sicurezza e la CLI clawhub.
title: ClawHub
x-i18n:
    generated_at: "2026-07-04T15:21:49Z"
    model: gpt-5.5
...
Installa la CLI di ClawHub quando vuoi usare flussi autenticati dal registro come
...
[Utilizzo accettabile](/it/clawhub/acceptable-usage) per i dettagli sulle policy e sull'applicazione.
...
così ClawHub può calcolare i conteggi aggregati delle installazioni. Disabilitalo con:
...
| `CLAWHUB_CONFIG_PATH`         | Sostituisce dove la CLI archivia lo stato token/config. |
