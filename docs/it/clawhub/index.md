...
Usa `--dry-run` per costruire il piano di pubblicazione esatto senza caricare nulla, e `--json`
...
ClawHub esegue controlli automatizzati sulle skill pubblicate e sui rilasci dei plugin. I rilasci trattenuti dalla scansione
o bloccati possono scomparire dal catalogo pubblico e dalle superfici di installazione, pur
