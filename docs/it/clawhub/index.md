...
title: ClawHub
x-i18n:
    generated_at: "2026-07-03T09:39:50Z"
    model: gpt-5.5
...
- Usa la CLI separata `clawhub` per autenticazione al registro, pubblicazione e flussi di eliminazione/ripristino.
...
Installa la CLI di ClawHub quando vuoi usare flussi autenticati al registro, come
...
Specifiche Plugin semplici e sicure per npm possono risolversi tramite npm durante i passaggi di lancio, e
