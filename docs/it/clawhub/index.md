...
title: ClawHub
x-i18n:
    generated_at: "2026-07-04T10:43:39Z"
    model: gpt-5.5
...
La CLI ClawHub serve per lavoro autenticato nel registro:
...
La CLI ha anche comandi di installazione/aggiornamento delle Skill per flussi di lavoro diretti sul registro:
...
ClawHub esegue controlli automatizzati su Skills pubblicate e release dei plugin. Le release
