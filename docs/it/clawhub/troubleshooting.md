---
read_when:
    - I comandi ClawHub CLI o del registro OpenClaw non riescono
...
x-i18n:
    generated_at: "2026-06-30T14:05:01Z"
    model: gpt-5.5
...
## La pubblicazione non riesce con un errore del proprietario GitHub o della fonte
...
Se una pubblicazione non riesce perché handle del proprietario, namespace dell'organizzazione, ambito del pacchetto, slug della skill
o nome del pacchetto è già rivendicato o riservato, conferma prima di
...
[issue Rivendicazione organizzazione / namespace](https://github.com/openclaw/clawhub/issues/new?template=org-namespace-claim.yml)
...
- Non creare mirror di contenuti nascosti, privati, trattenuti o bloccati dalla moderazione al di fuori della
