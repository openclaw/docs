...
Leggi le informazioni di ritentativo nella risposta:
...
- Per origini GitHub, usa `owner/repo`, `owner/repo@ref` o un URL GitHub completo.
...
## `update` si rifiuta a causa di modifiche locali
...
- Rispetta le intestazioni di ritentativo `429` e memorizza nella cache le risposte pubbliche di elenco/ricerca.
