...
Se molti utenti condividono un solo IP di uscita, i limiti per IP anonimo possono essere raggiunti anche quando ogni
...
Indicalo alle root che vuoi analizzare:
...
- Rispetta gli header di nuovo tentativo `429` e memorizza nella cache le risposte di elenchi/ricerche pubbliche.
