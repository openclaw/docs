...
x-i18n:
    generated_at: "2026-07-01T18:13:53Z"
    model: gpt-5.5
...
slug dello skill o il nome del pacchetto è già rivendicato o riservato, conferma prima di
...
- Rispetta gli header di retry `429` e metti in cache le risposte pubbliche di elenco/ricerca.
