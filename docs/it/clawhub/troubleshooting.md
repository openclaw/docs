...
x-i18n:
    generated_at: "2026-07-05T06:51:30Z"
    model: gpt-5.5
...
## La pubblicazione non riesce perché un namespace è già rivendicato o riservato
...
non puoi gestire il proprietario ClawHub corrente, apri una
...
I file locali non corrispondono a nessuna versione nota a ClawHub. Scegline una:
...
- Rispetta gli header di ripetizione `429` e memorizza nella cache le risposte pubbliche di elenco/ricerca.
