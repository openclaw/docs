---
read_when:
    - I comandi della CLI di ClawHub o del registro di OpenClaw falliscono
...
x-i18n:
    generated_at: "2026-05-11T22:20:26Z"
    model: gpt-5.5
    provider: openai
...
- Se usi un percorso di configurazione personalizzato, conferma che `CLAWHUB_CONFIG_PATH` punti al
  file che contiene il token attuale.
...
- Se possiedi la skill, accedi ed esaminala:
