...
persona invia solo poche richieste. Accedi ove possibile e riprova dopo il
ritardo indicato.
...
## La pubblicazione non riesce con un errore di proprietario o sorgente GitHub
...
Consulta [API HTTP](/it/clawhub/http-api) per i dettagli degli endpoint.
