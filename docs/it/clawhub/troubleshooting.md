...
x-i18n:
    generated_at: "2026-07-04T03:50:53Z"
    model: gpt-5.5
...
gli strumenti richiesti dovrebbero essere dichiarati in modo che utenti e scanner possano comprendere il pacchetto.
...
## La pubblicazione non riesce con un errore del proprietario GitHub o della sorgente
...
[segnalazione di rivendicazione org / namespace](https://github.com/openclaw/clawhub/issues/new?template=org-namespace-claim.yml)
