---
read_when:
    - I comandi di ClawHub CLI o del registro OpenClaw falliscono
    - Un pacchetto non può essere installato, pubblicato o aggiornato
summary: Risoluzione dei problemi di ClawHub relativi ad accesso, installazione, pubblicazione, sincronizzazione, aggiornamento e API.
x-i18n:
...
Leggi le informazioni per riprovare nella risposta:
...
## La pubblicazione non riesce con un errore sul proprietario GitHub o sulla sorgente
