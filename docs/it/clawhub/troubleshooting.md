...
La CLI avvia un server di callback locale di breve durata durante il login tramite browser.
...
- `RateLimit-Remaining`: il tuo budget residuo esatto quando l'header è presente. Con `429`, è `0`.
- `RateLimit-Reset` o `X-RateLimit-Reset`: tempistica del reset.
...
- Conferma che la release sia pubblica e non trattenuta dalla scansione o dalla moderazione.
