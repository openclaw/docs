...
x-i18n:
    generated_at: "2026-07-04T06:37:52Z"
    model: gpt-5.5
...
Per i plugin, controlla i metadati di compatibilità in `package.json`. Le pubblicazioni
code-plugin richiedono campi di compatibilità OpenClaw come `openclaw.compat.pluginApi` e
