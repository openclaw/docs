...
x-i18n:
    generated_at: "2026-07-02T22:36:24Z"
    model: gpt-5.5
...
- Verifica che il rilascio sia pubblico e non bloccato da scansione o moderazione.
...
Le diagnostiche visibili al proprietario possono spiegare lo stato di scansione, gate di caricamento o moderazione.
...
- Controlla la pagina di dettaglio del pacchetto per lo stato di scansione e i metadati di compatibilità.
...
- Non eseguire il mirror di contenuti nascosti, privati, trattenuti o bloccati dalla moderazione al di fuori della
