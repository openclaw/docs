...
- Negli ambienti senza interfaccia grafica, crea un token API nell'interfaccia web di ClawHub ed esegui:
...
slug della skill o il nome del pacchetto è già rivendicato o riservato, verifica prima di
