...
x-i18n:
    generated_at: "2026-07-03T02:49:59Z"
    model: gpt-5.5
...
- `RateLimit-Reset` o `X-RateLimit-Reset`: tempo di reimpostazione.
...
- Assicurati di aver effettuato l'accesso con l'account GitHub che possiede o può pubblicare
  il pacchetto.
- Verifica che l'URL della sorgente sia pubblico o accessibile a ClawHub.
