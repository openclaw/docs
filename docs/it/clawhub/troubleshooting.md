...
x-i18n:
    generated_at: "2026-07-03T00:58:22Z"
    model: gpt-5.5
...
La diagnostica visibile al proprietario può spiegare lo stato di scansione, del gate di caricamento o di moderazione.
...
Per i plugins, controlla i metadati di compatibilità in `package.json`. Le pubblicazioni di code-plugin
...
pubblicare con il proprietario che corrisponde allo spazio dei nomi. Per i pacchetti plugin,
...
[issue di rivendicazione organizzazione / spazio dei nomi](https://github.com/openclaw/clawhub/issues/new?template=org-namespace-claim.yml)
...
Indicalo alle radici che vuoi scansionare:
...
- Rispetta le intestazioni di ripetizione `429` e memorizza nella cache le risposte pubbliche di elenco/ricerca.
