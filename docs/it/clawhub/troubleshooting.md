---
read_when:
    - Comandi CLI di ClawHub o del registro OpenClaw non riusciti
...
La CLI avvia un server di callback locale temporaneo durante l'accesso tramite browser.
...
- `RateLimit-Remaining`: il budget esatto rimanente quando l'intestazione è presente. Su `429`, è `0`.
...
- Verifica che la tua versione di OpenClaw soddisfi l'intervallo di
