...
d'ambiente, gli strumenti e le autorizzazioni necessari, così gli utenti possono
...
CLI per ispezionare metadati, link alla sorgente, versioni, changelog e stato
della scansione:
...
Le schede pubbliche mostrano lo stato più recente della scansione. Le release
trattenute o bloccate dalla moderazione possono essere nascoste dalle superfici
di ricerca e installazione finché non vengono risolte.
