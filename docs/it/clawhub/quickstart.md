...
x-i18n:
    generated_at: "2026-07-04T20:33:13Z"
    model: gpt-5.5
...
quando accedi, pubblichi, gestisci le tue inserzioni o usi flussi di lavoro
...
Il comando ignora i contenuti invariati. Le nuove skill partono da `1.0.0`; le modifiche successive
...
Usa prima `--dry-run` per visualizzare in anteprima i metadati del pacchetto risolti, i campi di compatibilità, l'attribuzione della fonte e il piano di caricamento senza pubblicare.
