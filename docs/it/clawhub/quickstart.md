...
Pubblica un plugin da una cartella locale, un repo GitHub, un ref GitHub o un
archivio esistente:
...
I code plugin devono includere metadati di compatibilità con OpenClaw in `package.json`,
