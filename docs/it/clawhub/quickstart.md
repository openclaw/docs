...
ha bisogno la skill prima di installarla. Consulta [Formato delle skill](/it/clawhub/skill-format).
...
Usa prima `--dry-run` per visualizzare in anteprima i metadati del pacchetto risolti, i campi di
...
conteggi aggregati delle installazioni. Consulta [Telemetria](/it/clawhub/telemetry) per sapere cosa viene segnalato
e come disattivarla.
