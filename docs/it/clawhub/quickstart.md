...
x-i18n:
    generated_at: "2026-06-30T14:06:43Z"
    model: gpt-5.5
...
Il comando salta i contenuti invariati. Le nuove skill partono da `1.0.0`; le
modifiche successive pubblicano automaticamente la versione patch successiva.
Usa `--dry-run` per visualizzare un'anteprima o `--version` per scegliere una
versione esplicita.
...
capire di cosa ha bisogno la skill prima di installarla. Vedi [Formato delle skill](/it/clawhub/skill-format).
