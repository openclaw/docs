...
x-i18n:
    generated_at: "2026-07-05T06:50:16Z"
    model: gpt-5.5
...
- Collega all'URL canonico della skill ClawHub quando visualizzi gli elenchi, così gli utenti possono ispezionare il record del registro di origine.
...
- `POST /api/v1/users/reserve` riserva slug root e segnaposto di pacchetti privati senza release per un handle proprietario.
