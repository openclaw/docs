...
x-i18n:
    generated_at: "2026-05-11T20:22:22Z"
    model: gpt-5.5
    provider: openai
...
- Inserisci un collegamento all'URL canonico della Skill ClawHub quando mostri gli elenchi, così gli utenti possono consultare il record del registro di origine.
...
- `X-RateLimit-Reset`: secondi dall'epoca Unix (ora assoluta di ripristino)
- `RateLimit-Reset`: secondi di ritardo fino al ripristino
