...
x-i18n:
    generated_at: "2026-07-03T02:48:52Z"
    model: gpt-5.5
...
Puoi creare un catalogo, una directory o una superficie di ricerca di terze parti sopra le API di lettura pubbliche di ClawHub. I metadati pubblici delle skill e i file delle skill sono pubblicati secondo le regole della licenza delle skill di ClawHub, mentre l'API stessa è soggetta a limiti di frequenza e deve essere consumata in modo responsabile.
...
- Inserisci un link all'URL canonico della skill su ClawHub quando visualizzi gli elenchi, così gli utenti possono ispezionare il record del registro di origine.
