...
x-i18n:
    generated_at: "2026-06-30T22:20:14Z"
    model: gpt-5.5
...
- Aggiungi un link all'URL canonico dello skill su ClawHub quando mostri gli elenchi, in modo che gli utenti possano ispezionare il record del registro di origine.
...
- `X-RateLimit-Reset`: secondi dell'epoca Unix (ora di reset assoluta)
...
- `GET /api/v1/download?slug=&version=&tag=`
  ...
  - Gli skill correnti basati su GitHub con una scansione `clean` o `suspicious` restituiscono un
...
- `GET /api/v1/skills/export?startDate=&endDate=&limit=&cursor=`
  ...
  - Gli skill correnti basati su GitHub con una scansione `clean` o `suspicious` vengono esportati
