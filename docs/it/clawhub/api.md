...
- Collega l'URL canonico della skill ClawHub quando mostri gli elenchi, così gli utenti possono ispezionare il record del registro di origine.
...
- Gli errori v1 sono testo semplice (`text/plain; charset=utf-8`), incluse le risposte
  `400`, `401`, `403`, `404`, `429` e di download bloccato.
