...
- Altrimenti usa `RateLimit-Reset` oppure deriva il ritardo da `X-RateLimit-Reset`.
...
- `POST /api/v1/users/reserve` riserva slug root e segnaposto privati di pacchetti senza rilascio per un handle proprietario.
