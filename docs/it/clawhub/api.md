...
- I parametri di query sconosciuti sono ignorati per compatibilità.
...
- `GET /api/v1/download?slug=&version=&tag=`
  ...
  - Le Skills attuali basate su GitHub con una scansione `clean` o `suspicious` restituiscono un
...
- `GET /api/v1/skills/export?startDate=&endDate=&limit=&cursor=`
  ...
  - Le Skills attuali basate su GitHub con una scansione `clean` o `suspicious` sono esportate
