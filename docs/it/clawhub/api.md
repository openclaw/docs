...
Puoi creare un catalogo, una directory o una superficie di ricerca di terze parti sopra le API pubbliche di lettura di ClawHub. I metadati pubblici delle skill e i file delle skill sono pubblicati secondo le regole della licenza per le skill di ClawHub, mentre l'API stessa ha limiti di frequenza e deve essere usata responsabilmente.
...
- Rimanda all'URL canonico della skill ClawHub quando mostri gli elenchi, così gli utenti possono esaminare il record del registro di origine.
