...
x-i18n:
    generated_at: "2026-07-01T20:22:46Z"
    model: gpt-5.5
...
Puoi creare un catalogo, una directory o un'interfaccia di ricerca di terze parti sopra le API pubbliche di lettura di ClawHub. I metadati pubblici delle skill e i file delle skill sono pubblicati secondo le regole di licenza delle skill di ClawHub, mentre l'API stessa è soggetta a limiti di frequenza e deve essere usata in modo responsabile.
...
- Non eseguire il mirroring di contenuti nascosti, privati o bloccati dalla moderazione aggirando i filtri dell'API pubblica o i confini di autenticazione.
...
- `GET /api/v1/skills?limit=&cursor=&sort=`
  ...
  - `recommended` usa segnali di engagement e attualità.
