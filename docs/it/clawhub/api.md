...
x-i18n:
    generated_at: "2026-07-02T22:36:35Z"
    model: gpt-5.5
...
- Usa endpoint pubblici di sola lettura come `GET /api/v1/skills`, `GET /api/v1/search` e `GET /api/v1/skills/{slug}` per gli elenchi del catalogo.
