...
- Quando mostri gli elenchi, collega all'URL canonico dello skill su ClawHub, così gli utenti possono esaminare il record del registro sorgente.
...
- `X-RateLimit-Remaining` / `RateLimit-Remaining`: budget rimanente esatto quando
  presente; le richieste riuscite su shard la omettono invece di restituire un valore
