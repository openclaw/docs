...
- Memorizza nella cache le risposte e rispetta gli header `429`, `Retry-After` e di limite di frequenza invece di eseguire polling aggressivo.
...
- Usa URL canonici delle pagine nel formato `https://clawhub.ai/<owner>/<slug>`.
...
- `X-RateLimit-Reset`: secondi dall'epoca Unix (tempo assoluto di reset)
