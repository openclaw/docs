...
Puoi creare un catalogo, una directory o una superficie di ricerca di terze parti basata sulle API pubbliche di lettura di ClawHub. I metadati pubblici delle skill e i file delle skill sono pubblicati secondo le regole di licenza delle skill di ClawHub, mentre l'API stessa è soggetta a limiti di frequenza e deve essere usata responsabilmente.
...
- Collega all'URL canonico della skill ClawHub quando mostri gli elenchi, così gli utenti possono esaminare il record del registro di origine.
- Usa URL canonici delle pagine nella forma `https://clawhub.ai/<owner>/skills/<slug>`.
