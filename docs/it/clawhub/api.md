...
x-i18n:
    generated_at: "2026-07-04T06:34:17Z"
    model: gpt-5.5
...
- Memorizza nella cache le risposte e rispetta `429`, `Retry-After` e gli header di limite di frequenza invece di eseguire polling aggressivo.
- Aggiungi un link all'URL canonico della Skills ClawHub quando mostri gli elenchi, così gli utenti possono ispezionare il record del registro di origine.
...
- `X-RateLimit-Reset`: secondi dall'epoch Unix (ora assoluta di reset)
