...
- La telemetria **non è disabilitata** (vedi “Come disabilitarla” più sotto).
...
- `installsAllTime`: utenti unici che hanno segnalato almeno un'installazione tramite CLI per la skill.
