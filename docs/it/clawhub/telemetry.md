...
- `installsAllTime`: utenti unici che hanno segnalato almeno una installazione CLI per la skill.
...
Tutti vedono solo **contatori di installazione aggregati**.
...
Con questa impostazione, la CLI non invierà telemetria di installazione.
