...
x-i18n:
    generated_at: "2026-07-03T09:41:33Z"
    model: gpt-5.5
...
ClawHub usa una telemetria CLI minima per calcolare conteggi aggregati delle installazioni.
...
- `version`: la versione installata, se nota.
...
- `installsCurrent`: utenti univoci che hanno segnalato un'installazione e non hanno eliminato la loro
  telemetria.
