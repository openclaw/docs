...
x-i18n:
    generated_at: "2026-07-02T22:34:52Z"
    model: gpt-5.5
...
- Nessun percorso di cartelle o identificatore derivato dalle cartelle.
...
- `installsAllTime`: utenti unici che hanno segnalato almeno un'installazione CLI della skill.
...
L'eliminazione del tuo account elimina anche i dati di telemetria.
