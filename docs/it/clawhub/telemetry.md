...
- La telemetria **non è disattivata** (vedi “Come disattivarla” di seguito).

Se non hai effettuato l'accesso, non viene segnalato nulla.

## Cosa raccogliamo

A ogni `clawhub install` segnalato, la CLI invia un singolo evento di installazione al meglio possibile.
