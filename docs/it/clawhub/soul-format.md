...
summary: Formato del bundle Soul, file obbligatori, limiti.
x-i18n:
...
- `description` viene usato come riepilogo dell'anima nell'interfaccia utente/ricerca.
...
- Deve essere in minuscolo e sicuro per gli URL: `^[a-z0-9][a-z0-9-]*$`.
