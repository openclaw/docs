---
read_when:
    - Rivendicazione di un'organizzazione, un marchio, un ambito di pacchetto, un identificativo del proprietario, uno slug della competenza o uno spazio dei nomi del pacchetto
...
x-i18n:
    generated_at: "2026-07-03T02:49:19Z"
    model: gpt-5.5
...
progetto reale, marchio, ecosistema di pacchetti o organizzazione, ma è già
...
segnalazioni nel prodotto o il modulo di ricorso dell'account per rivendicazioni di namespace.
...
- una disputa su marchio, trademark, rinomina di progetto o cronologia di pacchetto
- un proprietario eliminato, inattivo o irraggiungibile che blocca il legittimo proprietario del
  namespace

Se la scheda è pericolosa, dannosa o fuorviante oltre la disputa sulla proprietà,
segui anche le linee guida pertinenti di moderazione o sicurezza. Il modulo di rivendicazione di namespace
è destinato alla revisione della proprietà, non alla divulgazione di emergenza di vulnerabilità.
...
- prove di proprietà di trademark, marchio o progetto che siano sicure da discutere
  pubblicamente
...
La revisione del namespace non garantisce che ogni nome corrispondente sarà trasferito.
