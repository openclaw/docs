...
read_when:
    ...
    - Decidere se utilizzare una segnalazione, un ricorso o una rivendicazione di namespace
...
title: Reclami su organizzazione e namespace
x-i18n:
    generated_at: "2026-06-30T14:07:27Z"
    model: gpt-5.5
...
Usa questo percorso per una revisione pubblica e non sensibile della proprietà. Non usare i report nel prodotto
o il modulo di appello dell'account per le rivendicazioni di namespace.
...
segui anche le indicazioni pertinenti su moderazione o sicurezza. Il modulo di rivendicazione del namespace
