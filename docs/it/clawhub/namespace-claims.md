...
summary: Come richiedere una revisione ClawHub per controversie sulla proprietà di organizzazione, marchio, handle del proprietario, ambito del pacchetto, skill-slug o namespace.
title: Rivendicazioni di organizzazione e spazio dei nomi
x-i18n:
    generated_at: "2026-07-04T06:35:33Z"
    model: gpt-5.5
...
Usa questo percorso per revisioni pubbliche e non sensibili sulla proprietà. Non usare le segnalazioni
...
o modificato in altro modo per motivi di proprietà nel mondo reale.
...
- una disputa su brand, marchio, ridenominazione di progetto o cronologia di pacchetto
...
segui anche le indicazioni pertinenti di moderazione o sicurezza. Il modulo di rivendicazione del namespace
