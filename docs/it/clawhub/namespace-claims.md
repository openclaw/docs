...
summary: Come richiedere la revisione di ClawHub per controversie sulla proprietà di organizzazione, brand, handle del proprietario, ambito del pacchetto, slug della skill o namespace.
title: Richieste di organizzazione e namespace
x-i18n:
    generated_at: "2026-07-03T09:40:34Z"
    model: gpt-5.5
...
con il
[modulo di issue Rivendicazione org / namespace](https://github.com/openclaw/clawhub/issues/new?template=org-namespace-claim.yml).
...
Se il listing è non sicuro, dannoso o fuorviante oltre alla controversia sulla proprietà,
...
trasferire la proprietà, rinominare una risorsa, nascondere o mettere in quarantena un listing esistente,
