...
x-i18n:
    generated_at: "2026-07-04T15:21:09Z"
    model: gpt-5.5
...
Usa questo percorso per la revisione pubblica e non sensibile della proprietà. Non usare le
...
Spiega cosa dimostra ogni link. Lo staff dovrebbe essere in grado di comprendere la
