...
summary: Come richiedere la revisione di ClawHub per controversie sulla proprietà di organizzazioni, brand, handle del proprietario, ambiti di pacchetti, slug di skill o namespace.
...
Usa questo percorso per revisioni pubbliche e non sensibili della proprietà. Non usare i report
nel prodotto o il modulo di ricorso per l'account per rivendicazioni di namespace.
...
Se la scheda è pericolosa, dannosa o fuorviante oltre alla disputa sulla proprietà,
...
- prove del dominio o del dominio email ufficiale
