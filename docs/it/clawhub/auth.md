...
Se l'accesso ti riporta a uno stato disconnesso, il tuo account potrebbe non essere in buono
stato.
...
Gli account eliminati, sospesi o disabilitati non possono continuare a usare token API esistenti.
