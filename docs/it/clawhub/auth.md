...
x-i18n:
    generated_at: "2026-07-03T13:31:55Z"
    model: gpt-5.5
...
[modulo di ricorso di ClawHub](https://appeals.openclaw.ai/) se ritieni che si tratti di un
errore.
...
con `clawhub login` o fornisci un nuovo token con `clawhub login --token`.
