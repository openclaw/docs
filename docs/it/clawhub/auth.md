...
Gli account eliminati, banditi o disabilitati non possono completare il normale accesso a ClawHub.
...
proxy, usa il flusso di token senza interfaccia grafica.
...
Gli account eliminati, banditi o disabilitati non possono continuare a usare token API esistenti.
