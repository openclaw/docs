...
summary: Accesso a ClawHub, token API, login dalla CLI, archiviazione dei token e revoca.
x-i18n:
    generated_at: "2026-07-01T08:07:54Z"
    model: gpt-5.5
...
tramite l'account con cui hai effettuato l'accesso.
...
Se il browser non riesce a raggiungere il callback locale a causa di regole di firewall, VPN o
...
La CLI stampa un codice monouso e resta in attesa mentre lo autorizzi su
