...
title: Sicurezza
x-i18n:
    generated_at: "2026-07-03T09:40:07Z"
    model: gpt-5.5
...
del suo plugin. Segnalale direttamente all'editore o al repository sorgente
...
Per le etichette di audit in fase di installazione, i livelli di rischio, i risultati e l'interpretazione, consulta
[Audit di sicurezza](/clawhub/security-audits).

Per segnalazioni del marketplace, blocchi di moderazione, inserzioni nascoste, ban e stato
