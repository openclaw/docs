...
title: Sicurezza
x-i18n:
    generated_at: "2026-07-04T06:37:56Z"
    model: gpt-5.5
...
Non usare gli advisory ClawHub per vulnerabilità nel codice sorgente proprio di una Skills o
di un Plugin di terze parti. Segnalale direttamente all'editore o al repository
sorgente collegato dalla scheda ClawHub.
...
pacchetti CLI ClawHub, binari, librerie o altri artefatti di rilascio che gli utenti
