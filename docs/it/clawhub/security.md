...
read_when:
    ...
    - Distinguere i problemi della piattaforma ClawHub dai problemi relativi a Skills o Plugin di terze parti
sidebarTitle: Security
summary: Come segnalare problemi di sicurezza di ClawHub e quando le vulnerabilità vengono divulgate pubblicamente.
title: Sicurezza
x-i18n:
    generated_at: "2026-07-01T20:23:59Z"
    model: gpt-5.5
...
segnalazioni advisory per ClawHub includono bug in:
...
Non usare gli advisory di ClawHub per vulnerabilità nel codice sorgente di una skill o di un
...
prove di un impatto reale sugli utenti o quando gli utenti devono intraprendere azioni.
...
intraprendere altre azioni di protezione.
