...
title: Sicurezza
x-i18n:
    generated_at: "2026-07-04T18:02:32Z"
    model: gpt-5.5
...
Non usare gli advisory di ClawHub per vulnerabilità nel codice sorgente di una skill di terze parti o di un
plugin. Segnalale direttamente al publisher o al repository sorgente
...
o segreti degli utenti, contenuti dannosi che raggiungono gli utenti a causa di un guasto della piattaforma,
...
Per le etichette di audit al momento dell'installazione, i livelli di rischio, i risultati e l'interpretazione, consulta
[Audit di sicurezza](/clawhub/security-audits).

Per segnalazioni del marketplace, sospensioni per moderazione, schede nascoste, ban e stato
