...
title: Sicurezza
x-i18n:
    generated_at: "2026-07-04T03:50:57Z"
    model: gpt-5.5
...
- pubblicazione nel registry, download, installazioni o integrità degli artefatti
...
di un plugin. Segnalale direttamente al publisher o al repository sorgente
...
non vengono rese pubbliche per impostazione predefinita. Vengono rese pubbliche quando ci sono
prove di un impatto reale sugli utenti o quando gli utenti devono intraprendere un'azione.

Esempi di impatto reale sugli utenti includono sfruttamento confermato, esposizione di dati utente
o segreti, contenuti dannosi che raggiungono gli utenti a causa di un errore della piattaforma,
...
Le vulnerabilità nel software installato dagli utenti vengono rese pubbliche, come
...
Per segnalazioni del marketplace, sospensioni di moderazione, schede nascoste, ban e stato dell'account,
consulta [Moderazione e sicurezza dell'account](/clawhub/moderation).
