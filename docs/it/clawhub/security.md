...
summary: Come segnalare i problemi di sicurezza di ClawHub e quando le vulnerabilità vengono divulgate pubblicamente.
title: Sicurezza
x-i18n:
    generated_at: "2026-07-02T22:36:12Z"
    model: gpt-5.5
...
Non usare gli advisory ClawHub per vulnerabilità nel codice sorgente di una skill o di un
...
non vengono divulgate pubblicamente per impostazione predefinita. Vengono divulgate pubblicamente quando ci sono
...
Per etichette di audit durante l'installazione, livelli di rischio, risultati e interpretazione, vedi
