...
x-i18n:
    generated_at: "2026-07-05T05:11:03Z"
    model: gpt-5.5
...
luogo in cui scoprire i pacchetti, agli autori un luogo in cui rilasciare versioni e
...
Una skill è un bundle di testo con versionamento centrato su `SKILL.md`. Può includere
...
aggiornamento diretti delle skill per utenti che vogliono cartelle di skill gestite dal registro al di fuori di
