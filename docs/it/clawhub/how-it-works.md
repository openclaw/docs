...
luogo per scoprire pacchetti, ai publisher un luogo per rilasciare versioni e a
...
pubblicizzati prima dell'installazione. I record del pacchetto possono includere compatibilità API,
versione minima del Gateway, destinazioni host, requisiti di ambiente e digest
degli artefatti.
...
per i workflow autenticati del registro:
...
I comandi di installazione di OpenClaw usano ClawHub come fonte pacchetti:
...
aggiornamento delle skill per gli utenti che vogliono cartelle di skill gestite dal registro fuori da un
...
scheda canonica di ClawHub, rispettano i limiti di frequenza ed evitano di implicare approvazione.
