...
x-i18n:
    generated_at: "2026-06-28T20:40:50Z"
    model: gpt-5.5
...
La pagina della scheda è il luogo canonico in cui gli utenti possono verificare cosa dichiara di fare una skill o un
plugin prima di installarlo.
...
per i workflow del registro autenticati:
