...
x-i18n:
    generated_at: "2026-07-03T02:48:49Z"
    model: gpt-5.5
...
La pagina dell'inserzione è il luogo canonico in cui gli utenti possono verificare cosa una skill o un
...
informazioni di compatibilità, link al sorgente, artefatti e record di versione.
...
Usa le prove a secco per vedere in anteprima il payload risolto prima del caricamento. Le pagine pubbliche poi
...
verifiche automatiche, segnalazioni degli utenti e interventi dei moderatori.
