...
summary: Come funzionano schede ClawHub, versioni, installazioni, pubblicazione, scansioni e aggiornamenti.
x-i18n:
    generated_at: "2026-07-04T06:34:14Z"
    model: gpt-5.5
...
per i flussi di lavoro del registro autenticati:
...
pacchetto del registro. La CLI ClawHub supporta anche flussi di installazione e
aggiornamento diretti delle skill per gli utenti che vogliono cartelle di skill gestite dal registro al di fuori di
