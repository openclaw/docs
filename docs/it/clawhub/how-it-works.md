...
x-i18n:
    generated_at: "2026-07-04T20:32:44Z"
    model: gpt-5.5
...
La pagina dell'inserzione è il luogo canonico in cui gli utenti possono verificare cosa
...
le informazioni di compatibilità, i link alle sorgenti, gli artefatti e i record di versione.
...
Le pagine pubbliche mostrano quindi i metadati pubblicati, i file, l'attribuzione della sorgente e lo stato della scansione.
...
pacchetto del registro. La CLI di ClawHub supporta anche workflow diretti di installazione e
aggiornamento delle skill per gli utenti che desiderano cartelle skill gestite dal registro al di fuori di un
...
ClawHub espone API pubbliche di sola lettura per scoperta, ricerca, dettagli dei pacchetti e
