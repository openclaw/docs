...
summary: Hub che collegano a ogni documento di OpenClaw
title: Hub della documentazione
x-i18n:
    generated_at: "2026-06-27T18:16:30Z"
    model: gpt-5.5
...
<Note>
Se non conosci OpenClaw, inizia con [Guida introduttiva](/it/start/getting-started).
</Note>
...
- [Pannello di controllo (Gateway locale)](http://127.0.0.1:18789/)
- [Aiuto](/it/help)
...
- [Hub Windows](/it/platforms/windows)
- [Linux](/it/platforms/linux)
- [Superfici web](/it/web)

## App complementare macOS (avanzata)
...
- [ClawHub](/it/clawhub)
- [Ricettario delle capacità](/it/plugins/adding-capabilities)
...
- [Politica di rilascio](/it/reference/RELEASING)
- [Modelli di dispositivi](/it/reference/device-models)
