...
title: Plugin Groq
x-i18n:
    generated_at: "2026-06-27T17:56:36Z"
    model: gpt-5.5
...
Aggiunge a OpenClaw il supporto per il provider di modelli Groq.

## Distribuzione

- Pacchetto: `@openclaw/groq-provider`
- Percorso di installazione: npm; ClawHub: `clawhub:@openclaw/groq-provider`
