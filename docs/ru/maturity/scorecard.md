---
summary: Оценки готовности к выпуску OpenClaw для областей продукта, интеграций и поддерживаемых рабочих процессов.
title: Оценочная таблица зрелости
x-i18n:
    generated_at: "2026-07-13T18:20:58Z"
    model: gpt-5.6
...
# Карта оценки зрелости

<div className="maturity-hero">
  <p className="maturity-kicker">готовность к выпуску — сформировано на основе таксономии и данных QA</p>
  <p className="maturity-hero-title">Практический обзор того, что готово, что подтверждено и что ещё требует доработки.</p>
  <p>50 поверхностей — 281 область возможностей — детерминированное покрытие, а также качество и полнота, проверенные специалистами.</p>
...
Эта страница отвечает на один вопрос: какие поверхности OpenClaw можно обоснованно выбрать для выпуска и какие данные подтверждают эту оценку? Покрытие определяется на основе детерминированных данных QA; качество и полнота поддерживаются в виде проверенных оценок зрелости.
...
Покрытие намеренно основывается на данных: область не становится «готовой» лишь потому, что её реализация существует. Покрытие не учитывается при расчёте оценки зрелости, однако OpenClaw стремится со временем поддерживать сквозное покрытие зрелых функций уровня «Стабильный» или выше на отметке более 90%.
...
Поверхности упорядочены по уровню зрелости, полноте и качеству. Поддержка LTS указана в каждой строке, чтобы варианты, готовые к выпуску, было легко сравнивать.
  ...
  <Tab title="Все поверхности">
    <div className="maturity-surface-table">
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/ru/maturity/taxonomy#channel-framework"><span className="maturity-surface-title">Платформа каналов</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>Бета</span></span><span>8 областей</span></span></a>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/ru/maturity/taxonomy#docker-and-podman-hosting"><span className="maturity-surface-title">Хостинг с Docker и Podman</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>Бета</span></span><span>4 области</span></span></a>
        ...
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Завершённость</span><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Бета</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">Нет</span></div>
      </div>
      <div className="maturity-surface-row">
      ...
      <div className="maturity-surface-row">
        ...
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Покрытие</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Экспериментальный</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Качество</span><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Бета</span><span>71%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "71%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Завершённость</span><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Бета</span><span>78%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "78%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">Нет</span></div>
      </div>
      <div className="maturity-surface-row">
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/ru/maturity/taxonomy#voice-and-realtime-talk"><span className="maturity-surface-title">Голосовая связь и разговор в реальном времени</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>Альфа</span></span><span>6 областей</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Покрытие</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Экспериментальный</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Качество</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Альфа</span><span>61%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "61%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Полнота</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Альфа</span><span>68%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "68%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">Нет</span></div>
  ...
  <Tab title="Платформа">
    <div className="maturity-surface-table">
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/ru/maturity/taxonomy#docker-and-podman-hosting"><span className="maturity-surface-title">Размещение в Docker и Podman</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>Бета</span></span><span>4 области</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Покрытие</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Экспериментальный</span><span>7%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "7%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Качество</span><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Бета</span><span>71%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "71%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Полнота</span><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Бета</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">Нет</span></div>
      ...
      <div className="maturity-surface-row">
        ...
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Качество</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Альфа</span><span>58%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "58%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Полнота</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Альфа</span><span>66%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "66%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-partial">Частичная — 1</span></div>
      </div>
      <div className="maturity-surface-row">
  ...
  <Tab title="Канал">
    <div className="maturity-surface-table">
      <div className="maturity-surface-row maturity-surface-row-header"><span>Интерфейс</span><span>Покрытие</span><span>Качество</span><span>Полнота</span><span>Поддержка</span></div>
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/ru/maturity/taxonomy#discord"><span className="maturity-surface-title">Discord</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-stable"><span className="maturity-level-code">M4</span><span>Стабильный</span></span><span>6 областей</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Покрытие</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Экспериментальный</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Качество</span><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Бета</span><span>73%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "73%" }} /></span></span></div>
  ...
  <Tab title="Провайдер и инструмент">
    <div className="maturity-surface-table">
      <div className="maturity-surface-row maturity-surface-row-header"><span>Компонент</span><span>Покрытие</span><span>Качество</span><span>Полнота</span><span>Поддержка</span></div>
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/ru/maturity/taxonomy#browser-automation-exec-and-sandbox-tools"><span className="maturity-surface-title">Автоматизация браузера, инструменты exec и песочницы</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>Бета</span></span><span>3 области</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Покрытие</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Экспериментальный</span><span>21%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "21%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Качество</span><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Бета</span><span>75%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "75%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Полнота</span><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Бета</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
...
## Сводка результатов QA

Приведённые ниже проверки показывают, какие области оценочной карты были проверены на основании данных профиля QA.
...
### Готовность по областям
  ...
  Откройте раздел, чтобы проверить состояние подтверждающих материалов для каждой категории. Список остаётся свёрнутым, чтобы страницу было удобно просматривать с первого взгляда.
  ...
  <Accordion title="Среда выполнения агента — 9 областей">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Выполнение у размещённых провайдеров</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">Частично проверено — полная проверка таксономии</span>
        </div>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Локальные провайдеры и провайдеры с самостоятельным размещением</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Аутентификация у провайдера</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">Частично проверено — полная проверка таксономии</span>
        </div>
  ...
  <Accordion title="Приложение Android — 7 областей">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Среда выполнения на устройстве</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Требуется проверка — полная валидация таксономии</span>
        </div>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Захват мультимедиа</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Требуется проверка — полная валидация таксономии</span>
        </div>
        <span>0 из 1 (0%) / 0 из 1 (0%)</span>
        <span>1 пробел в возможностях</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Голосовое взаимодействие</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Требуется проверка — полная валидация таксономии</span>
        </div>
        <span>0 из 1 (0%) / 0 из 1 (0%)</span>
        <span>1 пробел в возможностях</span>
  ...
  <Accordion title="Путь провайдера Anthropic — 5 областей">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Входные мультимедийные данные</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Требуется проверка — полная валидация таксономии</span>
        </div>
  ...
  <Accordion title="Автоматизация браузера, выполнение и инструменты песочницы — 3 области">
  ...
  <Accordion title="Платформа каналов — 8 областей">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Команды действий канала и подтверждения</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Требуется проверка — полная валидация таксономии</span>
        </div>
        <span>0 из 5 (0%) / 0 из 5 (0%)</span>
        <span>5 пробелов в возможностях</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Медиавложения и расширенные данные каналов</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Требуется проверка — полная валидация таксономии</span>
        </div>
        <span>0 из 4 (0%) / 0 из 4 (0%)</span>
        <span>4 пробела в возможностях</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Состояние работоспособности и управление оператором</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Требуется проверка — полная валидация таксономии</span>
        </div>
  ...
  <Accordion title="ClawHub — 4 области">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Жизненный цикл и работоспособность плагинов</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Требует проверки — полная валидация таксономии</span>
        </div>
  ...
  <Accordion title="CLI — 7 областей">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Первоначальная настройка и настройка аутентификации</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Требует проверки — полная валидация таксономии</span>
        </div>
        <span>0 из 5 (0%) / 0 из 5 (0%)</span>
        <span>5 пробелов в возможностях</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Настройка плагинов и каналов</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Требует проверки — полная валидация таксономии</span>
        </div>
        <span>0 из 5 (0%) / 0 из 5 (0%)</span>
        <span>5 пробелов в возможностях</span>
  ...
  <Accordion title="Хостинг с Docker и Podman — 4 области">
  ...
  <Accordion title="Feishu, QQ Bot, WeChat, Yuanbao, Zalo, Zalo Personal, региональные каналы — 4 области">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Медиа и форматированное содержимое</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Требует проверки — полная валидация таксономии</span>
        </div>
        <span>0 из 1 (0%) / 0 из 1 (0%)</span>
        <span>1 пробел в возможностях</span>
  ...
  <Accordion title="Среда выполнения Gateway — 13 областей">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Работоспособность, диагностика и восстановление</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Требует проверки — полная валидация таксономии</span>
        </div>
        <span>0 из 7 (0%) / 0 из 7 (0%)</span>
        <span>7 пробелов в возможностях</span>
  ...
  <Accordion title="Путь провайдера Google — 5 областей">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Настройка провайдера и учётные данные</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Требуется проверка — полная валидация таксономии</span>
        </div>
        <span>0 из 10 (0%) / 0 из 10 (0%)</span>
        <span>10 пробелов в возможностях</span>
  ...
  <Accordion title="Инструменты генерации изображений, видео и музыки — 5 областей">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Маршрутизация и обнаружение медиаресурсов</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Требуется проверка — полная валидация таксономии</span>
        </div>
        <span>0 из 4 (0%) / 0 из 4 (0%)</span>
        <span>4 пробела в возможностях</span>
  ...
  <Accordion title="Размещение в Kubernetes — 4 области">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Доступ и внешний доступ</span>
  ...
  <Accordion title="Хост Gateway на Linux — 5 областей">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Целевые среды развертывания</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Требуется проверка — полная проверка таксономии</span>
        </div>
        <span>0 из 3 (0%) / 0 из 3 (0%)</span>
        <span>3 пробела в возможностях</span>
  ...
  <Accordion title="Провайдеры локальных моделей: Ollama, vLLM, SGLang, LM Studio — 5 областей">
    <p className="maturity-readiness-summary">5 требуют проверки</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>Область</span><span>Функции / идентификаторы покрытия</span><span>Дальнейшие действия</span></div>
      <div className="maturity-readiness-row">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Нативные плагины провайдеров</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Требуется проверка — полная проверка таксономии</span>
        </div>
        <span>0 из 10 (0%) / 0 из 10 (0%)</span>
        <span>10 пробелов в возможностях</span>
  ...
  <Accordion title="Редко используемые облачные провайдеры — 3 области">
    <p className="maturity-readiness-summary">3 требуют проверки</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>Область</span><span>Функции / идентификаторы покрытия</span><span>Дальнейшие действия</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Облачные провайдеры LLM</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Требуется проверка — полная проверка таксономии</span>
        </div>
        <span>0 из 12 (0%) / 0 из 12 (0%)</span>
        <span>12 пробелов в возможностях</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Облачные провайдеры мультимедиа</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Требуется проверка — полная проверка таксономии</span>
        </div>
        <span>0 из 8 (0%) / 0 из 8 (0%)</span>
        <span>8 пробелов в возможностях</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Эксплуатация провайдеров</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Требуется проверка — полная проверка таксономии</span>
        </div>
        <span>0 из 12 (0%) / 0 из 12 (0%)</span>
        <span>12 пробелов в возможностях</span>
  ...
  <Accordion title="Хост Gateway для macOS — 7 областей">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Локальная интеграция Gateway</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Требуется проверка — полная валидация таксономии</span>
        </div>
        <span>0 из 9 (0%) / 0 из 9 (0%)</span>
        <span>9 пробелов в возможностях</span>
  ...
  <Accordion title="Понимание и генерация медиаконтента — 6 областей">
    <p className="maturity-readiness-summary">4 требуют проверки / 2 частично проверены</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>Область</span><span>Функции / идентификаторы покрытия</span><span>Дальнейшие действия</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Обработка медиаконтента в каналах</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Требует проверки — полная проверка таксономии</span>
        </div>
        <span>0 из 5 (0%) / 0 из 5 (0%)</span>
        <span>5 пробелов в возможностях</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Настройка медиаконтента</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Требует проверки — полная проверка таксономии</span>
        </div>
        <span>0 из 1 (0%) / 0 из 1 (0%)</span>
        <span>1 пробел в возможностях</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Генерация медиаконтента</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">Частично проверено — полная проверка таксономии</span>
        </div>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Приём медиаконтента и доступ к нему</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Требует проверки — полная проверка таксономии</span>
        </div>
        <span>0 из 8 (0%) / 0 из 8 (0%)</span>
        <span>8 пробелов в возможностях</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Понимание медиаконтента</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">Частично проверено — полная проверка таксономии</span>
        </div>
  ...
  <Accordion title="Нативное приложение-компаньон для Windows — 5 областей">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Состояние и восстановление</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Требуется проверка — полная проверка таксономии</span>
        </div>
        <span>0 из 5 (0%) / 0 из 5 (0%)</span>
        <span>5 пробелов в возможностях</span>
  ...
  <Accordion title="Путь установки Nix — 5 областей">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Жизненный цикл плагина</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Требуется проверка — полная проверка таксономии</span>
        </div>
        <span>0 из 4 (0%) / 0 из 4 (0%)</span>
        <span>4 пробела в возможностях</span>
  ...
  <Accordion title="Путь провайдеров OpenAI и Codex — 5 областей">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Нативная среда запуска Codex</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">Частично проверено — полная проверка таксономии</span>
        </div>
  ...
  <Accordion title="Плагины — 9 областей">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Одобрение плагинов</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Требует проверки — полная проверка таксономии</span>
        </div>
        <span>0 из 6 (0%) / 0 из 6 (0%)</span>
        <span>6 пробелов в возможностях</span>
  ...
  <Accordion title="Raspberry Pi и малогабаритные устройства Linux — 4 области">
    <p className="maturity-readiness-summary">4 требуют проверки</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>Область</span><span>Функции / идентификаторы покрытия</span><span>Дальнейшие действия</span></div>
      <div className="maturity-readiness-row">
  ...
  <Accordion title="Безопасность, аутентификация, сопряжение и секреты — 6 областей">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Политика одобрения и меры защиты инструментов</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">Частично проверено — полная проверка таксономии</span>
        </div>
  ...
  <Accordion title="Сеансы, память и механизм контекста — 9 областей">
    <p className="maturity-readiness-summary">2 требуют проверки / 7 частично проверены</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>Область</span><span>Функции / идентификаторы покрытия</span><span>Дальнейшие действия</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Управление сеансами и журналами CLI</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Требует проверки — полная проверка таксономии</span>
        </div>
        <span>0 из 2 (0%) / 0 из 2 (0%)</span>
        <span>2 пробела в возможностях</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Механизм контекста</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">Частично проверено — полная проверка таксономии</span>
        </div>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Единообразие истории и сеансов между клиентами</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">Частично проверено — полная проверка таксономии</span>
        </div>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Сохранение журналов</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Требует проверки — полная проверка таксономии</span>
        </div>
        <span>0 из 2 (0%) / 0 из 2 (0%)</span>
        <span>2 пробела в возможностях</span>
  ...
  <Accordion title="Голосовое общение в реальном времени — 6 областей">
    <p className="maturity-readiness-summary">6 требуют проверки</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>Область</span><span>Функции / идентификаторы покрытия</span><span>Дальнейшие действия</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Голосовое общение в нативном приложении</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Требует проверки — полная валидация таксономии</span>
        </div>
        <span>0 из 4 (0%) / 0 из 4 (0%)</span>
        <span>4 пробела в возможностях</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Сеансы голосового общения в реальном времени</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Требует проверки — полная валидация таксономии</span>
        </div>
        <span>0 из 11 (0%) / 0 из 11 (0%)</span>
        <span>11 пробелов в возможностях</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Наблюдаемость голосового общения</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Требует проверки — полная валидация таксономии</span>
        </div>
        <span>0 из 5 (0%) / 0 из 5 (0%)</span>
        <span>5 пробелов в возможностях</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Провайдеры голосового общения</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Требует проверки — полная валидация таксономии</span>
        </div>
        <span>0 из 7 (0%) / 0 из 7 (0%)</span>
        <span>7 пробелов в возможностях</span>
  ...
  <Accordion title="Сопутствующие интерфейсы watchOS — 5 областей">
    <p className="maturity-readiness-summary">5 требуют проверки</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>Область</span><span>Функции / идентификаторы покрытия</span><span>Дальнейшие действия</span></div>
      <div className="maturity-readiness-row">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Подтверждения выполнения команд</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Требуется проверка — полная валидация таксономии</span>
        </div>
        <span>0 из 3 (0%) / 0 из 3 (0%)</span>
        <span>3 пробела в возможностях</span>
  ...
  <Accordion title="Инструменты веб-поиска — 4 области">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Безопасность сети</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Требуется проверка — полная валидация таксономии</span>
        </div>
        <span>0 из 4 (0%) / 0 из 4 (0%)</span>
        <span>4 пробела в возможностях</span>
  ...
  <Accordion title="WhatsApp — 5 областей">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Мультимедиа и форматированный контент</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">Требуется проверка — полная валидация таксономии</span>
        </div>
        <span>0 из 2 (0%) / 0 из 2 (0%)</span>
        <span>2 пробела в возможностях</span>
