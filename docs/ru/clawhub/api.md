...
x-i18n:
    generated_at: "2026-07-02T08:37:46Z"
    model: gpt-5.5
...
Вы можете построить сторонний каталог, директорию или поисковую поверхность поверх публичных API ClawHub для чтения. Публичные метаданные Skills и файлы Skills публикуются по лицензионным правилам Skills ClawHub, а сам API имеет ограничения частоты запросов и должен использоваться ответственно.
...
- Давайте ссылку на канонический URL Skills ClawHub при отображении списков, чтобы пользователи могли проверить исходную запись реестра.
...
- `GET /api/v1/skills?limit=&cursor=&sort=`
  ...
  - Устаревший псевдоним: `nonSuspicious=true`
  - При `nonSuspiciousOnly=true` страницы на основе курсора могут содержать меньше элементов, чем `limit`; используйте `nextCursor` для продолжения.
