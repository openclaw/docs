...
x-i18n:
    generated_at: "2026-07-04T10:52:15Z"
    model: gpt-5.5
...
файлы `SKILL.md` или устаревшие `skills.md` в публичных репозиториях без форка,
принадлежащих вошедшему в систему аккаунту GitHub. Он не импортирует приватные репозитории, форки,
...
Метаданные навыка объявляются в YAML frontmatter в начале вашего `SKILL.md`. Они сообщают реестру (и анализу безопасности), что требуется навыку для запуска.
...
- Не добавляйте метаданные цены в `SKILL.md`; это не часть формата навыка и не сделает опубликованный навык платным.
