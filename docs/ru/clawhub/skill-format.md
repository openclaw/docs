...
x-i18n:
    generated_at: "2026-07-05T07:37:13Z"
    model: gpt-5.5
...
Объявите требования среды выполнения вашего Skill в `metadata.openclaw` (псевдонимы: `metadata.clawdbot`, `metadata.clawdis`).
...
- Не добавляйте конфликтующие условия лицензии в `SKILL.md`; ClawHub не поддерживает переопределения лицензии для отдельных Skills.

## Платные Skills

- ClawHub не поддерживает платные Skills, цены для отдельных Skills, платный доступ или распределение доходов.
