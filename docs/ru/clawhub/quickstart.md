...
x-i18n:
    generated_at: "2026-07-03T09:50:06Z"
    model: gpt-5.5
...
когда входите в систему, публикуете, управляете собственными listing или используете
...
Сначала используйте `--dry-run`, чтобы предварительно посмотреть разрешенные метаданные пакета, поля совместимости,
...
метаданные, ссылки на источники, версии, changelog и статус сканирования:
...
Публичные listing показывают последнее состояние сканирования. Релизы, задержанные или заблокированные
