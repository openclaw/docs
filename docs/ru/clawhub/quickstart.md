...
x-i18n:
    generated_at: "2026-06-28T22:40:36Z"
    model: gpt-5.5
...
Команда пропускает неизмененный контент. Новые навыки начинаются с версии `1.0.0`;
...
нужно навыку, до его установки. См. [Формат навыка](/ru/clawhub/skill-format).
...
Перед установкой используйте веб-страницу ClawHub или команды подробностей CLI, чтобы проверить
метаданные, ссылки на источник, версии, списки изменений и статус сканирования:
...
Публичные листинги показывают последнее состояние сканирования. Релизы, которые удерживаются или заблокированы
