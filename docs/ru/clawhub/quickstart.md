...
x-i18n:
    generated_at: "2026-07-04T18:12:14Z"
    model: gpt-5.5
...
когда выполняете вход, публикацию, управляете своими списками или используете
...
по-прежнему разрешаться через ClawHub.
...
Команда пропускает неизмененное содержимое. Новые навыки начинают с версии `1.0.0`; последующие изменения
...
переменные среды, инструменты и разрешения, чтобы пользователи понимали, что нужно
...
Опубликуйте плагин из локальной папки, репозитория GitHub, GitHub ref или
...
Публичные списки показывают актуальное состояние последнего сканирования. Релизы, удерживаемые или заблокированные
модерацией, могут быть скрыты из интерфейсов поиска и установки до разрешения ситуации.
