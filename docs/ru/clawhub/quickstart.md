...
OpenClaw записывает, откуда был получен Skills, чтобы последующие обновления могли продолжать
...
Skills перед установкой. См. [Формат Skills](/ru/clawhub/skill-format).
...
Перед установкой используйте веб-страницу ClawHub или команды CLI для подробного просмотра, чтобы проверить
метаданные, ссылки на источник, версии, журналы изменений и состояние сканирования:
...
модерацией, могут быть скрыты из поиска и поверхностей установки до устранения проблемы.
