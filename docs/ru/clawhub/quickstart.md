...
OpenClaw сохраняет, откуда был получен навык, чтобы последующие обновления могли продолжать
...
Команда пропускает неизмененное содержимое. Новые навыки начинаются с `1.0.0`; последующие изменения
...
Перед публикацией проверьте метаданные в `SKILL.md`. Объявите обязательные
