...
x-i18n:
    generated_at: "2026-06-30T22:26:32Z"
    model: gpt-5.5
...
по-прежнему выполняться через ClawHub.
...
модерацией, могут быть скрыты из поиска и интерфейсов установки до разрешения ситуации.
