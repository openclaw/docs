---
read_when:
    - Первый раз используете ClawHub
...
x-i18n:
    generated_at: "2026-07-02T22:42:42Z"
    model: gpt-5.5
...
OpenClaw записывает, откуда взят skill, чтобы последующие обновления могли продолжать
...
Перед установкой используйте веб-страницу ClawHub или команды CLI для просмотра деталей, чтобы проверить
метаданные, ссылки на исходный код, версии, списки изменений и статус проверки:
...
Публичные карточки показывают последнее состояние проверки. Релизы, удержанные или заблокированные
