...
x-i18n:
    generated_at: "2026-07-04T03:59:00Z"
    model: gpt-5.5
...
Установить плагин, размещенный на ClawHub, с явным источником ClawHub:
...
навыку, прежде чем устанавливать его. См. [Формат навыка](/ru/clawhub/skill-format).
...
метаданные, ссылки на источник, версии, журналы изменений и статус сканирования:
