...
x-i18n:
    generated_at: "2026-07-04T06:42:37Z"
    model: gpt-5.5
...
переменные окружения, инструменты и разрешения, чтобы пользователи понимали, что
требуется навыку, до его установки. См. [формат навыка](/ru/clawhub/skill-format).

Для репозиториев с несколькими навыками переиспользуемый workflow GitHub вызывает
