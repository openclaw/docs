...
x-i18n:
    generated_at: "2026-07-05T05:25:55Z"
    model: gpt-5.5
...
когда входите в систему, публикуете, управляете собственными карточками или используете
...
OpenClaw записывает, откуда поступил skill, чтобы последующие обновления могли по-прежнему
...
Публичные карточки показывают последнее состояние сканирования. Выпуски, удержанные или заблокированные
