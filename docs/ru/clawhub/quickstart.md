...
x-i18n:
    generated_at: "2026-07-02T01:06:53Z"
    model: gpt-5.5
...
когда выполняете вход, публикацию, управление собственными листингами или используете
...
метаданные, ссылки на исходный код, версии, changelogs и статус сканирования:
