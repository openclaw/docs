...
title: ClawHub
x-i18n:
    generated_at: "2026-07-04T06:43:25Z"
    model: gpt-5.5
...
- Используйте нативные команды `openclaw` для поиска, установки и обновления Skills, а также для установки Plugin из ClawHub.
...
например публикация или удаление/отмена удаления:
...
| Область        | Что хранит                                                   | Типичная команда                            |
| -------------- | ------------------------------------------------------------ | ------------------------------------------- |
...
В CLI также есть команды установки/обновления Skill для прямых рабочих процессов с реестром:
...
событие установки, чтобы ClawHub мог вычислять агрегированные счетчики установок. Отключите это так:
