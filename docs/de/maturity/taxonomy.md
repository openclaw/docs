...
x-i18n:
    generated_at: "2026-07-24T05:02:57Z"
    model: gpt-5.6
...
<div className="maturity-hero maturity-hero-compact">
  ...
  <p>50 Oberflächen, gruppiert in 4 Familien, wobei jede Kategorie mit der kanonischen Dokumentation und den IDs der QA-Abdeckung verknüpft ist.</p>
...
<div className="maturity-level-list">
  <div className="maturity-level-row"><span className="maturity-level-title"><span className="maturity-level-pill maturity-level-experimental"><span className="maturity-level-code">M0</span><span>Geplant</span></span></span><span>Die Richtung ist bekannt, aber es gibt noch keinen unterstützten Benutzerpfad.</span><span className="maturity-level-promotion">Aufstieg: Design-Issue, zuständige Person und Zieloberfläche sind vorhanden.</span></div>
  <div className="maturity-level-row"><span className="maturity-level-title"><span className="maturity-level-pill maturity-level-experimental"><span className="maturity-level-code">M1</span><span>Experimentell</span></span></span><span>Mit Einschränkungen, Flags, Quellcode-Builds oder ausschließlich für Maintainer vorgesehenen Abläufen implementiert.</span><span className="maturity-level-promotion">Aufstieg: Maintainer können das Szenario vom aktuellen Stand des Hauptzweigs ausführen.</span></div>
  <div className="maturity-level-row"><span className="maturity-level-title"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>Alpha</span></span></span><span>Echte Benutzer können es ausprobieren, müssen jedoch mit inkompatiblen Änderungen und einer unvollständigen Benutzerführung rechnen.</span><span className="maturity-level-promotion">Aufstieg: Dokumentierte Einrichtung, grundlegende Tests, bekannte Einschränkungen und mindestens ein Nachweis in einer realen Umgebung.</span></div>
  <div className="maturity-level-row"><span className="maturity-level-title"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>Beta</span></span></span><span>Ein öffentlicher Pfad ist vorhanden, und der Hauptarbeitsablauf ist mit begrenzten Einschränkungen nutzbar.</span><span className="maturity-level-promotion">Aufstieg: Dokumentation für Installation und Aktualisierung, Regressionstests, Support-Runbook und erfolgreicher Szenarionachweis in der erwarteten Umgebung.</span></div>
  ...
  <div className="maturity-level-row"><span className="maturity-level-title"><span className="maturity-level-pill maturity-level-clawesome"><span className="maturity-level-code">M5</span><span>Clawesome</span></span></span><span>Ausgereift, angenehm, umfassend instrumentiert und konkurrenzfähig mit dem besten vergleichbaren Arbeitsablauf.</span><span className="maturity-level-promotion">Aufstieg: Stabil sowie bestandene Benutzer-Bewertungstabelle für repräsentative Benutzer.</span></div>
</div>
...
<Tabs>
  <Tab title="Kern">
    ...
    <a className="maturity-surface-link" href="#cli">
      ...
      <span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-stable"><span className="maturity-level-code">M4</span><span>Stabil</span></span><span>7 Bereiche – zu 90 % vollständig</span></span>
    </a>

    <a className="maturity-surface-link" href="#gateway-runtime">
      <span className="maturity-surface-title">Gateway-Laufzeit</span>
      <span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-stable"><span className="maturity-level-code">M4</span><span>Stabil</span></span><span>13 Bereiche – zu 89 % vollständig</span></span>
    </a>

    <a className="maturity-surface-link" href="#agent-runtime">
      <span className="maturity-surface-title">Agentenlaufzeit</span>
      <span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>Beta</span></span><span>9 Bereiche – zu 79 % vollständig</span></span>
    </a>
    ...
    <a className="maturity-surface-link" href="#channel-framework">
      ...
      <span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>Beta</span></span><span>8 Bereiche – zu 79 % vollständig</span></span>
    </a>
    ...
    <a className="maturity-surface-link" href="#security-auth-pairing-and-secrets">
      <span className="maturity-surface-title">Sicherheit, Authentifizierung, Kopplung und Secrets</span>
      <span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>Beta</span></span><span>6 Bereiche – zu 79 % abgeschlossen</span></span>
    </a>
  ...
  <Tab title="Plattform">
    ...
    <a className="maturity-surface-link" href="#macos-companion-app">
      ...
      <span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>Beta</span></span><span>8 Bereiche – 78 % vollständig</span></span>
    </a>


    <a className="maturity-surface-link" href="#native-windows">
      <span className="maturity-surface-title">Natives Windows</span>
      <span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>Alpha</span></span><span>4 Bereiche – 66 % vollständig</span></span>
    </a>

    <a className="maturity-surface-link" href="#kubernetes-hosting">
      <span className="maturity-surface-title">Kubernetes-Hosting</span>
      <span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>Alpha</span></span><span>4 Bereiche – 61 % vollständig</span></span>
    </a>


    <a className="maturity-surface-link" href="#nix-install-path">
      <span className="maturity-surface-title">Nix-Installationspfad</span>
      <span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-experimental"><span className="maturity-level-code">M1</span><span>Experimentell</span></span><span>5 Bereiche – 44 % vollständig</span></span>
    </a>
    ...
    <a className="maturity-surface-link" href="#linux-companion-app">
      ...
      <span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-experimental"><span className="maturity-level-code">M0</span><span>Geplant</span></span><span>5 Bereiche – 21 % vollständig</span></span>
    </a>
  ...
  <Tab title="Kanal">
    ...
    <a className="maturity-surface-link" href="#discord">
      ...
      <span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-stable"><span className="maturity-level-code">M4</span><span>Stabil</span></span><span>6 Bereiche – 87 % vollständig</span></span>
    </a>

    <a className="maturity-surface-link" href="#telegram">
      <span className="maturity-surface-title">Telegram</span>
      <span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>Beta</span></span><span>5 Bereiche – 78 % vollständig</span></span>
    </a>
    ...
    <a className="maturity-surface-link" href="#matrix">
      ...
      <span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>Alpha</span></span><span>6 Bereiche – 67 % vollständig</span></span>
    </a>

    <a className="maturity-surface-link" href="#google-chat">
      <span className="maturity-surface-title">Google Chat</span>
      <span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>Alpha</span></span><span>5 Bereiche – 66 % vollständig</span></span>
    </a>
    ...
    <a className="maturity-surface-link" href="#feishu-qq-bot-wechat-yuanbao-zalo-zalo-personal-regional-channels">
      ...
      <span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>Alpha</span></span><span>4 Bereiche – 58 % vollständig</span></span>
    </a>
    ...
    <a className="maturity-surface-link" href="#mattermost-line-irc-nextcloud-talk-nostr-twitch-tlon-synology-chat">
      ...
      <span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>Alpha</span></span><span>4 Bereiche – 54 % vollständig</span></span>
    </a>
  ...
  <Tab title="Provider und Tool">
    ...
    <a className="maturity-surface-link" href="#browser-automation-exec-and-sandbox-tools">
      <span className="maturity-surface-title">Browserautomatisierungs-, Ausführungs- und Sandbox-Tools</span>
      <span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>Beta</span></span><span>3 Bereiche – 79 % vollständig</span></span>
    </a>

    <a className="maturity-surface-link" href="#openai-and-codex-provider-path">
      <span className="maturity-surface-title">OpenAI- und Codex-Providerpfad</span>
    ...
    <a className="maturity-surface-link" href="#web-search-tools">
      <span className="maturity-surface-title">Websuchtools</span>
      <span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>Beta</span></span><span>4 Bereiche – 79 % vollständig</span></span>
    </a>

    <a className="maturity-surface-link" href="#anthropic-provider-path">
      <span className="maturity-surface-title">Anthropic-Providerpfad</span>
      <span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>Beta</span></span><span>5 Bereiche – 78 % vollständig</span></span>
    </a>

    <a className="maturity-surface-link" href="#google-provider-path">
      <span className="maturity-surface-title">Google-Providerpfad</span>
      <span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>Beta</span></span><span>5 Bereiche – 78 % vollständig</span></span>
    </a>

    <a className="maturity-surface-link" href="#openrouter-provider-path">
      <span className="maturity-surface-title">OpenRouter-Providerpfad</span>
      <span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>Beta</span></span><span>4 Bereiche – 78 % vollständig</span></span>
    </a>
    ...
    <a className="maturity-surface-link" href="#image-video-and-music-generation-tools">
      ...
      <span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>Alpha</span></span><span>5 Bereiche – 68 % vollständig</span></span>
    </a>
    ...
    <a className="maturity-surface-link" href="#long-tail-hosted-providers">
      ...
      <span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>Alpha</span></span><span>3 Bereiche – 68 % vollständig</span></span>
    </a>
...
<AccordionGroup>
  <Accordion title="CLI – M4 Stabil – 7 Bereiche">
    ...
    Die regulären Einrichtungs- und Reparaturpfade sind in der Installations-, CLI- und Gateway-Dokumentation beschrieben. Plattformspezifische Windows-Pfade werden in den Zeilen „Windows über WSL2“ und „Natives Windows“ nachverfolgt.
    ...
    [Übersicht](/de/install/index), [Installationsprogramm](/de/install/installer), [Node](/de/install/node), [Aktualisierung](/de/install/updating)
    ...
    [Onboarding](/de/cli/onboard), [Konfigurieren](/de/cli/configure), [Onboarding-Übersicht](/de/start/onboarding-overview)
    ...
    [Status](/de/cli/status), [Systemzustand](/de/cli/health), [Protokolle](/de/cli/logs), [Diagnose](/de/gateway/diagnostics)
    ...
    [Aktualisieren](/de/install/updating), [Aktualisierung](/de/cli/update), [Fehlerbehebung](/de/gateway/troubleshooting)
  ...
  <Accordion title="Gateway-Laufzeit – M4 Stabil – 13 Bereiche">
    ...
    [Protokoll](/de/gateway/protocol), [Übersicht](/de/gateway/security/index)
    ...
    [Index](/de/gateway/index), [OpenAI-HTTP-API](/de/gateway/openai-http-api), [OpenResponses-HTTP-API](/de/gateway/openresponses-http-api), [HTTP-API zum Aufrufen von Tools](/de/gateway/tools-invoke-http-api), [Hooks](/de/automation/hooks), [Index](/de/web/index)
    ...
    [Index](/de/gateway/index), [Architektur](/de/concepts/architecture), [Steuerungsoberfläche](/de/web/control-ui), [Webchat](/de/web/webchat), [Canvas](/de/refactor/canvas)
    ...
    [Protokoll](/de/gateway/protocol), [Index](/de/gateway/index), [Architektur](/de/concepts/architecture)

    </div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">Geräteauthentifizierung und Kopplung</span>
          <span>10 Funktionen / LTS-unterstützt</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Experimentell</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>75%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "75%" }} /></span></span></div>
    ...
    [Protokoll](/de/gateway/protocol), [Kopplung](/de/gateway/pairing), [Index](/de/gateway/security/index)

    </div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">Netzwerkzugriff und Erkennung</span>
          <span>6 Funktionen / LTS-unterstützt</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Experimentell</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>75%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "75%" }} /></span></span></div>
    ...
    [Index](/de/gateway/index), [Erkennung](/de/gateway/discovery), [Protokoll](/de/gateway/protocol)
    ...
    [Protokoll](/de/gateway/protocol), [Architektur](/de/concepts/architecture), [Index](/de/nodes/index)
    ...
    [Index](/de/gateway/index), [Diagnose](/de/gateway/diagnostics), [Doctor](/de/gateway/doctor)
    ...
    [Übersicht](/de/gateway/index), [Architektur](/de/concepts/architecture)
    ...
    [Übersicht](/de/gateway/security/index), [Protokoll](/de/gateway/protocol), [Erkennung](/de/gateway/discovery)
  ...
  <Accordion title="Agent-Runtime – M3 Beta – 9 Bereiche">
    ...
    Hauptschleife, Modelle, Provider-Routing und Tool-Streaming sind erstklassig, doch das Verhalten der Provider ändert sich wöchentlich und erfordert für jedes Release einen Szenarionachweis.
    ...
    [Agent-Schleife](/de/concepts/agent-loop), [Agent](/de/cli/agent), [Agent-Runtimes](/de/concepts/agent-runtimes)
    ...
    [Modelle](/de/concepts/models), [Modelle](/de/cli/models), [OpenAI](/de/providers/openai), [Agent-Laufzeiten](/de/concepts/agent-runtimes)
    ...
    [Streaming](/de/concepts/streaming), [Agentenschleife](/de/concepts/agent-loop)
    ...
    [Agentenschleife](/de/concepts/agent-loop), [Ollama](/de/providers/ollama)
    ...
    [Sandbox vs. Tool-Richtlinie vs. erhöhte Berechtigungen](/de/gateway/sandbox-vs-tool-policy-vs-elevated), [Agentenschleife](/de/concepts/agent-loop), [Subagenten](/de/tools/subagents)
  ...
  <Accordion title="Sitzungs-, Speicher- und Kontext-Engine – M3 Beta – 9 Bereiche">
    <a id="session-memory-and-context-engine" />

    Umfassende Dokumentation und aktive Implementierung. Der Reifegrad hängt von der Beständigkeit der Transkripte, der Qualität der Compaction und der Gleichwertigkeit zwischen Clients ab.
    ...
    [Sitzung](/de/concepts/session), [Compaction der Sitzungsverwaltung](/de/reference/session-management-compaction), [Sitzungen](/de/cli/sessions)
    ...
    [Compaction](/de/concepts/compaction), [Kontext](/de/concepts/context), [Compaction der Sitzungsverwaltung](/de/reference/session-management-compaction)
    ...
    [Kontext](/de/concepts/context), [Kontext-Engine](/de/concepts/context-engine)
    ...
    [Diagnose](/de/gateway/diagnostics), [Sitzungsverwaltung und Compaction](/de/reference/session-management-compaction), [Flags](/de/diagnostics/flags)
    ...
    [Kontext](/de/concepts/context), [Transkriptbereinigung](/de/reference/transcript-hygiene), [Discord](/de/channels/discord)
    ...
    [Speicherkonfiguration](/de/reference/memory-config), [Speicher-Qmd](/de/concepts/memory-qmd), [Speicher](/de/concepts/memory), [Discord](/de/channels/discord)
    ...
    [Compaction der Sitzungsverwaltung](/de/reference/session-management-compaction), [Transkripthygiene](/de/reference/transcript-hygiene)
  ...
  <Accordion title="Channel-Framework – M3 Beta – 8 Bereiche">
    ...
    Viele Channels verwenden dieselben Gateway-Verträge für Zustellung und Routing, das Channel-Verhalten variiert jedoch aufgrund der vorgelagerten API und der Einschränkungen durch Kontorichtlinien.
    ...
    <div className="maturity-category-list">
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">Channel-Aktionen, Befehle und Genehmigungen</span>
          <span>5 Funktionen</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Experimentell</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
    ...
    [Gruppen](/de/channels/groups), [Discord](/de/channels/discord), [Google Chat](/de/channels/googlechat), [Signal](/de/channels/signal), [Matrix](/de/channels/matrix)
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">Channel-Einrichtung</span>
          <span>5 Funktionen / LTS-unterstützt</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Experimentell</span><span>14%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "14%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
    ...
    [Übersicht](/de/channels/index), [Kopplung](/de/channels/pairing), [Fehlerbehebung](/de/channels/troubleshooting), [SDK-Channel-Plugins](/de/plugins/sdk-channel-plugins)

    </div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">Verhalten von Gruppen-Threads und Hintergrundräumen</span>
          <span>5 Funktionen</span>
        </div>
    ...
    [Gruppen](/de/channels/groups), [Gruppennachrichten](/de/channels/group-messages), [Hintergrundraum-Ereignisse](/de/channels/ambient-room-events), [Broadcast-Gruppen](/de/channels/broadcast-groups), [Discord](/de/channels/discord)

    </div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">Zugriffskontrollen und Identitätsprüfungen für eingehende Nachrichten</span>
          <span>5 Funktionen / LTS-unterstützt</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Experimentell</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>68%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "68%" }} /></span></span></div>
    ...
    [Gruppen](/de/channels/groups), [Hintergrundraum-Ereignisse](/de/channels/ambient-room-events), [Discord](/de/channels/discord), [Matrix](/de/channels/matrix), [Kanalkonfiguration](/de/gateway/config-channels)
    ...
    [Kanalrouting](/de/channels/channel-routing), [Gruppen](/de/channels/groups), [Discord](/de/channels/discord), [Matrix](/de/channels/matrix), [Fehlerbehebung](/de/channels/troubleshooting), [Konfigurationsreferenz](/de/gateway/configuration-reference)
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">Statusintegrität und Bedienelemente für Betreiber</span>
          <span>4 Funktionen / LTS-unterstützt</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Experimentell</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
    ...
    [Systemzustand](/de/gateway/health), [Konfigurationsreferenz](/de/gateway/configuration-reference), [Fehlerbehebung](/de/channels/troubleshooting), [Discord](/de/channels/discord)
  ...
  <Accordion title="Beobachtbarkeit – M3 Beta – 5 Bereiche">
    ...
    Dokumentation zu OTel, Prometheus, Protokollierung und Diagnose ist vorhanden. Es ist eine Überarbeitung des Reifegrads für eine öffentliche Darstellung dazu erforderlich, „worauf Betreiber zuerst achten sollten“.
    ...
    [Systemzustand](/de/gateway/health), [Telegram](/de/channels/telegram), [Doctor](/de/cli/doctor), [Doctor](/de/gateway/doctor), [SDK-Unterpfade](/de/plugins/sdk-subpaths), [Systemzustand](/de/cli/health), [Protokoll](/de/gateway/protocol)
    ...
    [Diagnose](/de/gateway/diagnostics), [Systemzustand](/de/gateway/health), [Codex-Testumgebung](/de/plugins/codex-harness), [Protokoll](/de/gateway/protocol)
    ...
    [Hooks](/de/plugins/hooks), [OpenTelemetry](/de/gateway/opentelemetry), [Protokollierung](/de/logging), [SDK-Unterpfade](/de/plugins/sdk-subpaths), [OpenTelemetry-Diagnose](/de/plugins/reference/diagnostics-otel), [Prometheus](/de/gateway/prometheus), [Prometheus-Diagnose](/de/plugins/reference/diagnostics-prometheus)
    ...
    [OpenTelemetry](/de/gateway/opentelemetry), [Prometheus](/de/gateway/prometheus), [Diagnose](/de/gateway/diagnostics), [Protokoll](/de/gateway/protocol)
  ...
  <Accordion title="Gateway-Web-App – M3 Beta – 6 Bereiche">
    ...
    Die Web-Benutzeroberfläche ist mit Abläufen für Kopplung, Chat, PWA, Talk, Push-Benachrichtigungen und Remote-Gateway dokumentiert. Die Hochstufung erfolgt nach Abschluss der Scorecards für verschiedene Browser und mobile PWAs.
    ...
    [Steuerungsoberfläche](/de/web/control-ui), [Protokoll](/de/gateway/protocol), [Gespräch](/de/nodes/talk)
    ...
    [Steuerungsoberfläche](/de/web/control-ui), [Dashboard](/de/web/dashboard), [Tailscale](/de/gateway/tailscale), [Fernzugriff](/de/gateway/remote)
    ...
    [Steuerungsoberfläche](/de/web/control-ui), [Konfiguration](/de/gateway/configuration)
    ...
    [Steuerungsoberfläche](/de/web/control-ui), [Übersicht](/de/web/index), [Dashboard](/de/web/dashboard), [Protokoll](/de/gateway/protocol)
    ...
    [Steuerungsoberfläche](/de/web/control-ui), [Webchat](/de/web/webchat), [Erste Schritte](/de/start/getting-started), [Kanalrouting](/de/channels/channel-routing), [Sichere Dateioperationen](/de/gateway/security/secure-file-operations)
    ...
    [Steuerungsoberfläche](/de/web/control-ui), [Systemzustand](/de/gateway/health), [Protokoll](/de/gateway/protocol), [Dashboard](/de/web/dashboard)
  ...
  <Accordion title="Plugins – M3 Beta – 9 Bereiche">
    ...
    Umfassende Dokumentation und aussagekräftige interne Laufzeitnachweise sind für Manifeste, Erkennung, Laden, die Provider-/Tool-Architektur und Genehmigungsgrenzen vorhanden. Die Einstufung sollte bei Beta bleiben, bis stärkere Nachweise für die öffentliche SDK-API und deren Unterpfade sowie für die externe Distribution vorliegen.
    ...
    [Plugin-Inventar](/de/plugins/plugin-inventory), [Plugins](/de/cli/plugins), [Architektur-Interna](/de/plugins/architecture-internals)
    ...
    [SDK-Kanal-Plugins](/de/plugins/sdk-channel-plugins), [Eingehende SDK-Kanäle](/de/plugins/sdk-channel-inbound), [Ausgehende SDK-Kanäle](/de/plugins/sdk-channel-outbound)
    ...
    [SDK-Provider-Plugins](/de/plugins/sdk-provider-plugins), [Werkzeug-Plugins](/de/plugins/tool-plugins), [Funktionen hinzufügen](/de/plugins/adding-capabilities)
    ...
    [Plugin-Berechtigungsanfragen](/de/plugins/plugin-permission-requests), [Ausführungsgenehmigungen](/de/tools/exec-approvals), [SDK-Kanal-Plugins](/de/plugins/sdk-channel-plugins)
    ...
    [Plugins](/de/cli/plugins), [Kompatibilität](/de/plugins/compatibility), [Veröffentlichung](/de/clawhub/publishing)
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">Testen von Plugins</span>
    ...
    [SDK-Tests](/de/plugins/sdk-testing), [SDK-Einrichtung](/de/plugins/sdk-setup), [Codex-Testumgebung](/de/plugins/codex-harness)
  ...
  <Accordion title="Sicherheit, Authentifizierung, Kopplung und Geheimnisse – M3 Beta – 6 Bereiche">
    ...
    Gute Dokumentation und Härtungsmechanismen sind vorhanden. Hochstufen, nachdem regelmäßige Upgrade- und Sicherheitsszenarien nachgewiesen haben, dass keine Einrichtungsregressionen auftreten.
    ...
    [Ausführungsgenehmigungen](/de/tools/exec-approvals), [Genehmigungen](/de/cli/approvals), [Plugin-Berechtigungsanfragen](/de/plugins/plugin-permission-requests), [Auditprüfungen](/de/gateway/security/audit-checks)

    </div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">Gateway-Authentifizierung und Fernzugriff</span>
    ...
    [Übersicht](/de/gateway/security/index), [Leitfaden zur Exposition](/de/gateway/security/exposure-runbook), [Authentifizierung über vertrauenswürdige Proxys](/de/gateway/trusted-proxy-auth), [Tailscale](/de/gateway/tailscale), [Fernzugriff](/de/gateway/remote), [Konfigurationsreferenz](/de/gateway/configuration-reference), [Gateway](/de/cli/gateway), [Diagnose](/de/cli/doctor), [Steuerungsoberfläche](/de/web/control-ui), [Browsersteuerung](/de/tools/browser-control), [Auditprüfungen](/de/gateway/security/audit-checks)
    ...
    [Kopplung](/de/channels/pairing), [Telegram](/de/channels/telegram), [Zugriffsgruppen](/de/channels/access-groups), [Auditprüfungen](/de/gateway/security/audit-checks)
    ...
    [Protokoll](/de/gateway/protocol), [Geräte](/de/cli/devices), [Kopplung](/de/channels/pairing), [Kopplung](/de/gateway/pairing), [Operator-Bereiche](/de/gateway/operator-scopes), [Steuerungsoberfläche](/de/web/control-ui), [Webchat](/de/web/webchat), [Genehmigungen](/de/cli/approvals)

    </div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">Vertrauen in Plugins</span>
    ...
    [Manifest](/de/plugins/manifest), [Plugin-Berechtigungsanfragen](/de/plugins/plugin-permission-requests), [Plugins verwalten](/de/plugins/manage-plugins), [Auditprüfungen](/de/gateway/security/audit-checks)

    </div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">Hygiene bei Anmeldedaten und Geheimnissen</span>
          <span>5 Funktionen / LTS-unterstützt</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Experimentell</span><span>46%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "46%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
    ...
    [Authentifizierung](/de/gateway/authentication), [Modelle](/de/cli/models), [OpenAI](/de/providers/openai), [OAuth](/de/concepts/oauth), [Geheimnisse](/de/gateway/secrets), [Geheimnisse](/de/cli/secrets), [Secretref-Anmeldedatenoberfläche](/de/reference/secretref-credential-surface), [Auditprüfungen](/de/gateway/security/audit-checks)
  ...
  <Accordion title="Automatisierung: Cron, Hooks, Aufgaben, Polling – M3 Beta – 6 Bereiche">
    ...
    Dokumentiert und nutzbar, aber die Szenarienachweise sollten die unbeaufsichtigte Zustellung, Wiederholungsversuche und die Sichtbarkeit von Fehlern abdecken.
    ...
    [Cron-Aufträge](/de/automation/cron-jobs), [Cron](/de/cli/cron), [Protokoll](/de/gateway/protocol), [Aufgaben](/de/automation/tasks), [Discord](/de/channels/discord)
    ...
    [Aufgaben](/de/automation/tasks), [Übersicht](/de/automation/index), [Aufgaben](/de/cli/tasks), [TaskFlow](/de/automation/taskflow), [SDK-Laufzeit](/de/plugins/sdk-runtime)
    ...
    [Übersicht](/de/automation/index), [Heartbeat](/de/gateway/heartbeat), [Zusagen](/de/concepts/commitments)
    ...
    [Umfrage](/de/cli/message), [Nachricht](/de/cli/message), [Telegram](/de/channels/telegram), [Microsoft Teams](/de/channels/msteams), [Hintergrundprozess](/de/gateway/background-process)
  ...
  <Accordion title="Medienverständnis und Mediengenerierung – M2 Alpha – 6 Bereiche">
    ...
    Es steht ein breites Funktionsspektrum zur Verfügung, doch Unterschiede zwischen Providern, Dateibeschränkungen und die Parität zwischen Node und App verhindern derzeit noch einen stabilen Status.
    ...
    [Medienübersicht](/de/tools/media-overview), [Medienverständnis](/de/nodes/media-understanding), [Sichere Dateioperationen](/de/gateway/security/secure-file-operations), [PDF](/de/tools/pdf), [Bilderzeugung](/de/tools/image-generation), [QR](/de/cli/qr), [LINE](/de/channels/line), [WhatsApp](/de/channels/whatsapp)
    ...
    [Medienübersicht](/de/tools/media-overview), [Bilderzeugung](/de/tools/image-generation), [Manifest](/de/plugins/manifest), [Codex-Testumgebung](/de/plugins/codex-harness)

    </div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">Text-zu-Sprache-Ausgabe</span>
          <span>2 Funktionen</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Experimentell</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>61%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "61%" }} /></span></span></div>
    ...
    [Text-zu-Sprache](/de/tools/tts), [Medienübersicht](/de/tools/media-overview), [Discord](/de/channels/discord)
    ...
    [Audio](/de/nodes/audio), [Medienverständnis](/de/nodes/media-understanding), [Medienübersicht](/de/tools/media-overview), [WhatsApp](/de/channels/whatsapp), [Bilder](/de/nodes/images), [Inferenz](/de/cli/infer), [PDF](/de/tools/pdf)
    ...
    [Bilderzeugung](/de/tools/image-generation), [Medienübersicht](/de/tools/media-overview), [Skills](/de/tools/skills), [Musikerzeugung](/de/tools/music-generation), [Videoerzeugung](/de/tools/video-generation)
  ...
  <Accordion title="Sprache und Echtzeitgespräche – M2 Alpha – 6 Bereiche">
    ...
    In Control UI, Apps und bei Providern gibt es mehrere Implementierungen. Vor der Beta sind Bewertungen für Latenz, Fehlermodi und Einrichtung erforderlich.
    ...
    <div className="maturity-category-list">
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">Gesprächs-Provider</span>
    ...
    [OpenAI](/de/providers/openai), [Google](/de/providers/google), [SDK-Provider-Plugins](/de/plugins/sdk-provider-plugins), [Gespräche](/de/nodes/talk), [Control UI](/de/web/control-ui)

    </div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">Echtzeit-Sprachsitzungen</span>
          <span>11 Funktionen</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Experimentell</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>61%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "61%" }} /></span></span></div>
    ...
    [Sprachfunktion](/de/nodes/talk), [Steuerungsoberfläche](/de/web/control-ui)
    ...
    [Sprachfunktion](/de/nodes/talk), [OpenAI](/de/providers/openai), [Google](/de/providers/google)

    </div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">Sprachfunktion der nativen App</span>
          <span>4 Funktionen</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Experimentell</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>61%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "61%" }} /></span></span></div>
    ...
    [Sprachfunktion](/de/nodes/talk), [Sprachaktivierung](/de/platforms/mac/voicewake)
    ...
    [Sprachaktivierung](/de/nodes/voicewake), [Sprachaktivierung](/de/platforms/mac/voicewake), [Sprach-Overlay](/de/platforms/mac/voice-overlay)

    </div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">Beobachtbarkeit der Sprachfunktion</span>
          <span>5 Funktionen</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Experimentell</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>61%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "61%" }} /></span></span></div>
    ...
    [Steuerungsoberfläche](/de/web/control-ui), [Sprach-Overlay](/de/platforms/mac/voice-overlay), [Sprachfunktion](/de/nodes/talk)
  ...
  <Accordion title="TUI - M2 Alpha - 5 Bereiche">
    ...
    In Dokumentation und Quellcode vorhanden, aber als primärer Benutzerablauf weniger sichtbar. Erfordert eine explizite Szenariodefinition.
    ...
    [TUI](/de/cli/tui), [TUI](/de/web/tui), [Übersicht](/de/cli/index)
    ...
    [TUI](/de/web/tui), [TUI](/de/cli/tui)
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">Sicherheit bei Darstellung und Ausgabe</span>
          <span>4 Funktionen</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Experimentell</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>59%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "59%" }} /></span></span></div>
  ...
  <Accordion title="ClawHub – M2 Alpha – 4 Bereiche">
    ...
    Öffentliche Dokumentation und ein Ökosystemkonzept sind vorhanden. Benötigt Bewertungsübersichten für Installation, Vertrauenswürdigkeit, Aktualisierung, Rollback und Kompatibilität.
    ...
    [Veröffentlichung](/de/clawhub/publishing), [Skills erstellen](/de/tools/creating-skills), [Community](/de/plugins/community)

    </div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">Katalogsuche</span>
          <span>5 Funktionen</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Experimentell</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>61%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "61%" }} /></span></span></div>
    ...
    [Plugin](/de/tools/plugin), [Plugins](/de/cli/plugins), [Skills](/de/cli/skills), [Skills](/de/tools/skills), [Community](/de/plugins/community)

    </div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">Kompatibilität und Vertrauenswürdigkeit</span>
          <span>12 Funktionen</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Experimentell</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>55%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "55%" }} /></span></span></div>
    ...
    [Plugin](/de/tools/plugin), [Plugins](/de/cli/plugins), [Skills](/de/cli/skills), [Skills](/de/tools/skills), [Protokoll](/de/gateway/protocol), [Pakete](/de/plugins/bundles), [Abhängigkeitsauflösung](/de/plugins/dependency-resolution)
  ...
  <Accordion title="OpenClaw App SDK – M2 Alpha – 6 Bereiche">
    ...
    Das OpenClaw App SDK ist ein eigenständiger Vertrag für externe Apps, der von der Gateway-Laufzeit und dem Plugin SDK getrennt ist. Die aktuelle Bewertung zeigt einen realen `@openclaw/sdk`-Pfad mit Lücken bei öffentlicher Paketierung, automatischer Erkennung, Genehmigungen, Hilfsfunktionen und Kompatibilität.
    ...
    [OpenClaw SDK](/de/gateway/external-apps), [OpenClaw-SDK-API-Design](/de/gateway/external-apps), [Protokoll](/de/gateway/protocol), [Übersicht](/de/gateway/security/index)
...
<AccordionGroup>
  <Accordion title="Linux-Gateway-Host – M4 Stabil – 5 Bereiche">
    ...
    Die Node-Laufzeit wird empfohlen, der systemd-Benutzerdienst ist dokumentiert und die Anleitung für VPS/Container ist umfassend.
    ...
    [Übersicht](/de/install/index), [Aktualisierung](/de/install/updating), [Linux](/de/platforms/linux), [Übersicht](/de/platforms/index)
    ...
    [Übersicht](/de/gateway/index), [Gateway](/de/cli/gateway), [Linux](/de/platforms/linux), [VPS](/de/vps)
    ...
    [Fernzugriff](/de/gateway/remote), [Tailscale](/de/gateway/tailscale), [Runbook zur Exposition](/de/gateway/security/exposure-runbook), [Authentifizierung](/de/gateway/authentication), [Geheimnisse](/de/gateway/secrets)
    ...
    [Status](/de/cli/status), [Protokolle](/de/cli/logs), [Doctor](/de/cli/doctor), [Diagnose](/de/gateway/diagnostics), [Index](/de/gateway/index)
  ...
  <Accordion title="macOS-Gateway-Host – M4 Stabil – 7 Bereiche">
    ...
    [macOS](/de/platforms/macos), [Gebündelter Gateway](/de/platforms/mac/bundled-gateway), [Installationsprogramm](/de/install/installer), [Node](/de/install/node)
    ...
    [macOS](/de/platforms/macos), [Gebündelter Gateway](/de/platforms/mac/bundled-gateway), [Remote](/de/platforms/mac/remote), [Übersicht](/de/gateway/index), [Gateway](/de/cli/gateway), [Bonjour](/de/gateway/bonjour)
    ...
    [macOS](/de/platforms/macos), [Gebündelter Gateway](/de/platforms/mac/bundled-gateway), [Gateway](/de/cli/gateway), [Übersicht](/de/gateway/index), [Aktualisierung](/de/cli/update), [Aktualisieren](/de/install/updating), [Deinstallieren](/de/install/uninstall), [Fehlerbehebung](/de/gateway/troubleshooting)
    ...
    [Gebündelter Gateway](/de/platforms/mac/bundled-gateway), [macOS](/de/platforms/macos), [Gateway](/de/cli/gateway), [Diagnose](/de/gateway/doctor), [Fehlerbehebung](/de/gateway/troubleshooting)
    ...
    [macOS](/de/platforms/macos), [Remote](/de/platforms/mac/remote)
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">Profile und Isolierung</span>
          <span>5 Funktionen</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Experimentell</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>74%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "74%" }} /></span></span></div>
    ...
    [Mehrere Gateways](/de/gateway/multiple-gateways), [Übersicht](/de/gateway/index), [Gateway](/de/cli/gateway)
  ...
  <Accordion title="Android-App – M4 Stabil – 7 Bereiche">
    ...
    Eine offizielle Distribution über Google Play ist verfügbar, die Dokumentation zum Erstellen und Ausführen aus dem Quellcode wird gepflegt, und die Android-App ist für Benutzer als regulärer begleitender Node dokumentiert.
  ...
  <Accordion title="iOS-App – M4 Stabil – 8 Bereiche">
    ...
    Eine offizielle App-Store-Distribution ist verfügbar, Relay-gestützte Push-Benachrichtigungen sind dokumentiert und die iOS-App wird als regulärer begleitender Node für Benutzer dokumentiert.
    ...
    [iOS](/de/platforms/ios), [Sprechen](/de/nodes/talk)
  ...
  <Accordion title="Hosting mit Docker und Podman – M3 Beta – 4 Bereiche">
    ...
    Installationsdokumentation ist vorhanden, und diese Optionen sind verbreitete Bereitstellungsmethoden. Hochstufen, sobald wiederkehrende Smoke-Tests für Releases das Upgrade- und Volume-Verhalten erfassen.
    ...
    [Podman](/de/install/podman), [Docker-VM-Laufzeit](/de/install/docker-vm-runtime), [Docker](/de/install/docker), [Hetzner](/de/install/hetzner), [Hostinger](/de/install/hostinger)
    ...
    [Docker](/de/install/docker), [Docker-VM-Laufzeit](/de/install/docker-vm-runtime), [Vollständige Release-Validierung](/de/reference/full-release-validation)
    ...
    [Docker](/de/install/docker), [Docker-VM-Laufzeit](/de/install/docker-vm-runtime)
  ...
  <Accordion title="Windows über WSL2 - M3 Beta - 6 Bereiche">
    ...
    Empfohlener Windows-Pfad mit Anleitungen zu systemd/Benutzerdiensten und Dokumentation zur Boot-Kette. Nach wiederholten Bewertungsübersichten für Installation und Aktualisierung hochstufen.
    ...
    [Windows](/de/platforms/windows), [Erste Schritte](/de/start/getting-started), [Aktualisierung](/de/install/updating), [Einrichtung](/de/cli/onboard), [Diagnose](/de/cli/doctor), [Status](/de/cli/status), [Protokolle](/de/cli/logs)
    ...
    [Windows](/de/platforms/windows), [Übersicht](/de/gateway/index), [Diagnose](/de/gateway/doctor)
    ...
    [Authentifizierung](/de/gateway/authentication), [Geheimnisse](/de/gateway/secrets), [Fernzugriff](/de/gateway/remote), [Runbook zur Exposition](/de/gateway/security/exposure-runbook), [Windows](/de/platforms/windows)
    ...
    [Fehlerbehebung für Remote-CDP unter Browser WSL2 Windows](/de/tools/browser-wsl2-windows-remote-cdp-troubleshooting), [Browser](/de/tools/browser), [Control UI](/de/web/control-ui)
  ...
  <Accordion title="Raspberry Pi und kleine Linux-Geräte – M3 Beta – 4 Bereiche">
    ...
    Plattformdokumentation ist vorhanden, und der Gateway-Pfad basiert auf Linux. Für eine höhere Einstufung ist hardwarespezifischer Smoke-Test-Nachweis für Releases erforderlich.
    ...
    [Raspberry Pi](/de/install/raspberry-pi), [Übersicht](/de/install/index), [FAQ zum ersten Start](/de/help/faq-first-run), [FAQ](/de/help/faq), [Linux](/de/platforms/linux), [Installationsprogramm](/de/install/installer)
    ...
    [Raspberry Pi](/de/install/raspberry-pi), [Authentifizierung](/de/gateway/authentication), [Geheimnisse](/de/gateway/secrets), [Kopplung](/de/gateway/pairing), [Geräte](/de/cli/devices), [Fernzugriff](/de/gateway/remote), [Tailscale](/de/gateway/tailscale)
    ...
    [Übersicht](/de/gateway/index), [Gateway](/de/cli/gateway), [Raspberry Pi](/de/install/raspberry-pi), [Linux](/de/platforms/linux), [VPS](/de/vps)
    ...
    [Raspberry Pi](/de/install/raspberry-pi), [Linux](/de/platforms/linux), [Systemzustand](/de/gateway/health), [Diagnose](/de/gateway/diagnostics)
  ...
  <Accordion title="macOS-Begleit-App – M3 Beta – 8 Bereiche">
    ...
    Eine umfangreiche Menüleisten-App, Berechtigungen, Node-Modus, Canvas, Sprachaktivierung, WebChat und Remote-Modus sind vorhanden. Die Entwicklung schreitet jedoch noch zu schnell voran, um die Einstufung „Stabil“ zu rechtfertigen.
    ...
    [Gebündelter Gateway](/de/platforms/mac/bundled-gateway), [macOS](/de/platforms/macos), [Unterprozess](/de/platforms/mac/child-process), [Entwicklungsumgebung](/de/platforms/mac/dev-setup)
    ...
    [Menüleiste](/de/platforms/mac/menu-bar), [Symbol](/de/platforms/mac/icon), [macOS](/de/platforms/macos), [Systemzustand](/de/platforms/mac/health), [Protokollierung](/de/platforms/mac/logging), [Remotezugriff](/de/platforms/mac/remote)
    ...
    [Remotezugriff](/de/platforms/mac/remote), [macOS](/de/platforms/macos), [Remotezugriff](/de/gateway/remote)

    </div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">Sprache und Unterhaltung</span>
          <span>3 Funktionen</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Experimentell</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>66%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "66%" }} /></span></span></div>
    ...
    [Sprachaktivierung](/de/platforms/mac/voicewake), [Sprach-Overlay](/de/platforms/mac/voice-overlay), [Unterhaltung](/de/nodes/talk), [macOS](/de/platforms/macos)
    ...
    [Webchat](/de/platforms/mac/webchat), [Remote-Zugriff](/de/gateway/remote), [Remote-Zugriff](/de/platforms/mac/remote)
  ...
  <Accordion title="Natives Windows – M2 Alpha – 4 Bereiche">
    ...
    Die grundlegenden CLI-/Gateway-Abläufe funktionieren, die Dokumentation empfiehlt jedoch weiterhin WSL2 für den vollständigen Funktionsumfang und führt Einschränkungen der nativen Nutzung auf.
    ...
    [Übersicht](/de/install/index), [Installationsprogramm](/de/install/installer), [Windows](/de/platforms/windows), [Erste Schritte](/de/start/getting-started), [Einrichtung](/de/cli/onboard)
    ...
    [Windows](/de/platforms/windows), [Übersicht](/de/gateway/index), [Gateway](/de/cli/gateway), [Doctor](/de/cli/doctor)
    ...
    [Windows](/de/platforms/windows), [Übersicht](/de/gateway/index), [Gateway](/de/cli/gateway)
  ...
  <Accordion title="Kubernetes-Hosting – M2 Alpha – 4 Bereiche">
    ...
    <div className="maturity-category-list">
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">Einrichtung der Bereitstellung</span>
          <span>5 Funktionen</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Experimentell</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>55%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "55%" }} /></span></span></div>
    ...
    [Kubernetes](/de/install/kubernetes), [Übersicht](/de/install/index)
    ...
    [Kubernetes](/de/install/kubernetes), [Secrets](/de/gateway/secrets), [Umgebung](/de/help/environment)
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">Zugriff und Veröffentlichung</span>
          <span>5 Funktionen</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Experimentell</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>55%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "55%" }} /></span></span></div>
    ...
    [Kubernetes](/de/install/kubernetes), [Authentifizierung](/de/gateway/authentication), [Fernzugriff](/de/gateway/remote), [Runbook zur Veröffentlichung](/de/gateway/security/exposure-runbook)
    ...
    [Kubernetes](/de/install/kubernetes), [Übersicht](/de/gateway/index)
  ...
  <Accordion title="Nix-Installationspfad – M1 Experimentell – 5 Bereiche">
    ...
    [Nix](/de/install/nix), [Index](/de/install/index), [Dokumentationsverzeichnis](/de/start/docs-directory)
    ...
    [Nix](/de/install/nix), [Einrichtung](/de/cli/setup), [Diagnose](/de/cli/doctor), [Aktualisierung](/de/cli/update)
  ...
  <Accordion title="watchOS-Begleitoberflächen – M1 Experimentell – 5 Bereiche">
    ...
    Der Quellcode enthält Oberflächen für die Watch-App/-Erweiterung; die öffentliche Dokumentation stellt dies noch nicht als Benutzerfunktion dar.
    ...
    [Ausführungsgenehmigungen](/de/tools/exec-approvals), [iOS](/de/platforms/ios)
  ...
  <Accordion title="Linux-Begleit-App – M0 geplant – 5 Bereiche">
    ...
    Laut Dokumentation sind native Linux-Begleit-Apps geplant; derzeit ist der Gateway der unterstützte Weg unter Linux.
    ...
    [Linux](/de/platforms/linux), [Übersicht](/de/platforms/index), [Übersicht](/de/install/index)
    ...
    [Linux](/de/platforms/linux), [Übersicht](/de/gateway/index), [Kopplung](/de/gateway/pairing), [Fernzugriff](/de/gateway/remote)
    ...
    [Linux](/de/platforms/linux), [Ausführungsgenehmigungen](/de/tools/exec-approvals), [Geheimnisse](/de/gateway/secrets), [Übersicht](/de/nodes/index), [Ausführung](/de/tools/exec), [Sprachausgabe](/de/nodes/talk), [Kamera](/de/nodes/camera)
  ...
  <Accordion title="Native Windows-Begleit-App – M0 geplant – 5 Bereiche">
    ...
    <div className="maturity-category-list">
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">Installation und Aktualisierungen</span>
          <span>4 Funktionen</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Experimentell</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Experimentell</span><span>19%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "19%" }} /></span></span></div>
    ...
    [Windows](/de/platforms/windows), [Übersicht](/de/install/index)
    ...
    [Windows](/de/platforms/windows), [Übersicht](/de/gateway/index), [Kopplung](/de/gateway/pairing), [Fernzugriff](/de/gateway/remote)
    ...
    [Windows](/de/platforms/windows), [Diagnose](/de/gateway/doctor), [Übersicht](/de/gateway/index)

    </div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">Desktop-Werkzeuge und Berechtigungen</span>
          <span>10 Funktionen</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Experimentell</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Experimentell</span><span>19%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "19%" }} /></span></span></div>
    ...
    [Windows](/de/platforms/windows), [Übersicht](/de/nodes/index), [Ausführung](/de/tools/exec), [Ausführungsgenehmigungen](/de/tools/exec-approvals), [Übersicht](/de/gateway/security/index)
...
<AccordionGroup>
  <Accordion title="Discord - M4 Stabil - 6 Bereiche">
    ...
    Ausführliche Dokumentation und breite Funktionsabdeckung. Pfade für Sprache/Delegation sollten weiterhin separat als Beta/Alpha bewertet werden.
    ...
    [Discord](/de/channels/discord), [Discord](/de/plugins/reference/discord), [Fly](/de/install/fly), [Slash-Befehle](/de/tools/slash-commands), [Systemzustand](/de/gateway/health), [Kanäle](/de/cli/channels), [Kanalkonfiguration](/de/gateway/config-channels)
    ...
    [Discord](/de/channels/discord), [Kanal-Routing](/de/channels/channel-routing), [Gruppen](/de/channels/groups), [Zugriffsgruppen](/de/channels/access-groups), [ACP-Agenten](/de/tools/acp-agents), [Subagenten](/de/tools/subagents)
    ...
    [Discord](/de/channels/discord), [OpenAI](/de/providers/openai), [Elevenlabs](/de/providers/elevenlabs), [QA-E2E-Automatisierung](/de/concepts/qa-e2e-automation), [Kanalkonfiguration](/de/gateway/config-channels)
  ...
  <Accordion title="Telegram – M3 Beta – 5 Bereiche">
    ...
    Der Kernkanal ist ausgereift genug für den regulären Einsatz, doch UX-Fälle mit hoher Varianz und Medien-Randfälle erfordern wiederkehrende Szenarionachweise.
    ...
    [Telegram](/de/channels/telegram), [Kanalkonfiguration](/de/gateway/config-channels), [Kanäle](/de/cli/channels)
    ...
    [Telegram](/de/channels/telegram), [Ausführungsgenehmigungen](/de/tools/exec-approvals), [Reaktionen](/de/tools/reactions)
  ...
  <Accordion title="Slack – M3 Beta – 5 Bereiche">
    ...
    Erstklassige Kanaldokumentation und Routing-Oberfläche. Benötigt Scorecards für Szenarien zur Workspace-Installation und -Administration.
    ...
    [Slack](/de/channels/slack), [Slack](/de/plugins/reference/slack), [Geheimnisse](/de/gateway/secrets), [QA-E2E-Automatisierung](/de/concepts/qa-e2e-automation), [Fehlerbehebung](/de/channels/troubleshooting)
    ...
    [Slack](/de/channels/slack), [Schutz vor Bot-Schleifen](/de/channels/bot-loop-protection), [Kopplung](/de/channels/pairing)
  ...
  <Accordion title="iMessage und BlueBubbles - M3 Beta - 5 Bereiche">
    ...
    Unterstütztes iMessage wird über imsg auf einem angemeldeten macOS-Messages-Host ausgeführt; ältere BlueBubbles-Konfigurationen müssen migriert werden. Weisen Sie weiterhin deutlich auf macOS-Berechtigungen, den SSH-Wrapper, SIP/private APIs und Migrationshinweise hin.
    ...
    [BlueBubbles iMessage](/de/announcements/bluebubbles-imessage), [iMessage von BlueBubbles](/de/channels/imessage-from-bluebubbles), [Kanalkonfiguration](/de/gateway/config-channels), [iMessage](/de/channels/imessage)
    ...
    [iMessage](/de/channels/imessage), [iMessage von BlueBubbles](/de/channels/imessage-from-bluebubbles), [Kanalkonfiguration](/de/gateway/config-channels)
    ...
    [iMessage](/de/channels/imessage), [iMessage über BlueBubbles](/de/channels/imessage-from-bluebubbles), [Kanäle konfigurieren](/de/gateway/config-channels)
  ...
  <Accordion title="WhatsApp – M3 Beta – 5 Bereiche">
    ...
    Der Kernpfad ist wichtig und dokumentiert; die Volatilität von Baileys und Sitzungen im Upstream verhindert jedoch die Einstufung als „Stabil“.
    ...
    [WhatsApp](/de/channels/whatsapp), [Kanäle konfigurieren](/de/gateway/config-channels), [WhatsApp](/de/plugins/reference/whatsapp), [QA-E2E-Automatisierung](/de/concepts/qa-e2e-automation), [Doctor](/de/gateway/doctor)
    ...
    [WhatsApp](/de/channels/whatsapp), [Kanäle konfigurieren](/de/gateway/config-channels), [QA-E2E-Automatisierung](/de/concepts/qa-e2e-automation), [Kopplung](/de/channels/pairing)
  ...
  <Accordion title="Matrix – M2 Alpha – 6 Bereiche">
    ...
    Unterstützung über das gebündelte Plugin. Benötigt Scorecards für Bridge, Authentifizierung und Raumlebenszyklus.
    ...
    [Matrix](/de/channels/matrix), [Gruppen](/de/channels/groups), [Schutz vor Bot-Schleifen](/de/channels/bot-loop-protection)
  ...
  <Accordion title="Google Chat – M2 Alpha – 5 Bereiche">
    ...
    Dokumentierter Kanal, aber die Einrichtung für Unternehmen und Administratoren erhöht das Reiferisiko.
    ...
    [Google Chat](/de/channels/googlechat), [Google Chat](/de/plugins/reference/googlechat), [Kanalkonfiguration](/de/gateway/config-channels), [Referenz zum Einrichtungsassistenten der CLI](/de/start/wizard-cli-reference), [Geheimnisse](/de/gateway/secrets), [Secretref-Anmeldedatenoberfläche](/de/reference/secretref-credential-surface), [Integritätsstatus](/de/gateway/health), [Plugin-Inventar](/de/plugins/plugin-inventory), [Übersicht](/de/channels/index)
    ...
    [Google Chat](/de/channels/googlechat), [Kopplung](/de/channels/pairing), [Zugriffsgruppen](/de/channels/access-groups), [Kanalkonfiguration](/de/gateway/config-channels), [Schutz vor Bot-Schleifen](/de/channels/bot-loop-protection), [Kanal-Routing](/de/channels/channel-routing)
    ...
    [Google Chat](/de/channels/googlechat), [Schutz vor Bot-Schleifen](/de/channels/bot-loop-protection), [Zugriffsgruppen](/de/channels/access-groups), [Kanalrouting](/de/channels/channel-routing)
  ...
  <Accordion title="Microsoft Teams – M2 Alpha – 5 Bereiche">
    ...
    Authentifizierungs- und Administratorabläufe für Unternehmen benötigen explizite Szenarionachweise.
    ...
    [Microsoft Teams](/de/channels/msteams), [Microsoft Teams](/de/plugins/reference/msteams), [Kanalkonfiguration](/de/gateway/config-channels), [Integritätsstatus](/de/gateway/health)
    ...
    [Microsoft Teams](/de/channels/msteams), [Kopplung](/de/channels/pairing), [Zugriffsgruppen](/de/channels/access-groups)
    ...
    [Microsoft Teams](/de/channels/msteams), [Gruppen](/de/channels/groups), [Kanalrouting](/de/channels/channel-routing)
    ...
    [Microsoft Teams](/de/channels/msteams), [Erweiterte Ausführungsgenehmigungen](/de/tools/exec-approvals-advanced)
  ...
  <Accordion title="Feishu, QQ Bot, WeChat, Yuanbao, Zalo, Zalo Personal, regionale Kanäle – M2 Alpha – 4 Bereiche">
    ...
    Wichtige regionale Abdeckung, die öffentliche Unterstützungsstufe sollte jedoch je nach Kontotyp, vorgelagerter Genehmigung und Nachweis durch die Maintainer abgestimmt werden.
    ...
    [Übersicht](/de/channels/index), [Kopplung](/de/channels/pairing), [Feishu](/de/plugins/reference/feishu), [Architektur-Interna](/de/plugins/architecture-internals)
  ...
  <Accordion title="Mattermost, LINE, IRC, Nextcloud Talk, Nostr, Twitch, Tlon, Synology Chat – M2 Alpha – 4 Bereiche">
    ...
    Unterstützte Oberflächen sind vorhanden, der Reifegrad variiert jedoch wahrscheinlich je nach Upstream-Unterstützung und Abdeckung durch Maintainer. Später einzeln bewerten.
  ...
  <Accordion title="Sprachanrufkanal – M1 Experimentell – 5 Bereiche">
    ...
    [Sprachanruf](/de/plugins/voice-call), [Plugin-Bestand](/de/plugins/plugin-inventory)

    </div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">Echtzeit-Sprachkommunikation und Anrufe</span>
          <span>2 Funktionen</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Experimentell</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Experimentell</span><span>41%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "41%" }} /></span></span></div>
...
<AccordionGroup>
  <Accordion title="Browserautomatisierung, Ausführung und Sandbox-Tools – M3 Beta – 3 Bereiche">
    ...
    Die Kern-Tools sind dokumentiert, aber die Host-Sicherheit und die Benutzerführung für Berechtigungen sollten weiterhin aktiv anhand der Scorecard überprüft werden.
    ...
    [Browsersteuerung](/de/tools/browser-control), [Tests](/de/help/testing), [Browser](/de/tools/browser), [Index](/de/gateway/security/index), [Auditprüfungen](/de/gateway/security/audit-checks)
    ...
    [Exec](/de/tools/exec), [Hintergrundprozess](/de/gateway/background-process), [Tools-Aufruf-HTTP-API](/de/gateway/tools-invoke-http-api), [Operator-Bereiche](/de/gateway/operator-scopes), [Protokoll](/de/gateway/protocol), [Exec-Genehmigungen](/de/tools/exec-approvals), [Erweiterte Exec-Genehmigungen](/de/tools/exec-approvals-advanced), [Erhöhte Berechtigungen](/de/tools/elevated)
    ...
    [Sandboxing](/de/gateway/sandboxing), [Sandbox vs. Tool-Richtlinie vs. erhöhte Berechtigungen](/de/gateway/sandbox-vs-tool-policy-vs-elevated), [Multi-Agent-Sandbox-Tools](/de/tools/multi-agent-sandbox-tools), [Codex-Harness-Referenz](/de/plugins/codex-harness-reference), [Konfigurations-Tools](/de/gateway/config-tools)
  ...
  <Accordion title="OpenAI- und Codex-Provider-Pfad – M3 Beta – 5 Bereiche">
    ...
    Ausführliche Dokumentation, OAuth-/Abonnementpfad, Echtzeitsprachübertragung, Bildfunktionen und Kompatibilitätsverhalten. Häufige Änderungen am Provider verhindern ohne Nachweis durch die Release-Scorecard die Einstufung als stabil.
    ...
    [OpenAI](/de/providers/openai), [Codex Harness](/de/plugins/codex-harness), [Modelle](/de/concepts/models), [OAuth](/de/concepts/oauth), [Codex-Harness-Referenz](/de/plugins/codex-harness-reference), [Authentifizierungsüberwachung](/de/gateway/authentication)
  ...
  <Accordion title="Websuchwerkzeuge – M3 Beta – 4 Bereiche">
    <a id="web-search-tools" />

    Es sind mehrere Provider und Dokumentationen vorhanden. Für jede Provider-Familie sind Nachweise für Kontingente, Fehler und SSRF erforderlich.
    ...
    [Web](/de/tools/web), [Web-Abruf](/de/tools/web-fetch), [Häufig gestellte Fragen](/de/help/faq), [API-Nutzungskosten](/de/reference/api-usage-costs), [Brave-Suche](/de/tools/brave-search), [Perplexity-Suche](/de/tools/perplexity-search), [Tavily](/de/tools/tavily), [Firecrawl](/de/tools/firecrawl)
    ...
    [Web](/de/tools/web), [Web-Abruf](/de/tools/web-fetch), [Firecrawl](/de/tools/firecrawl), [Searxng-Suche](/de/tools/searxng-search)

    </div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">Werkzeugverfügbarkeit und Abruf</span>
    ...
    [Konfigurationswerkzeuge](/de/gateway/config-tools), [Web-Abruf](/de/tools/web-fetch), [Web](/de/tools/web), [Häufig gestellte Fragen](/de/help/faq)
  ...
  <Accordion title="Anthropic-Provider-Pfad – M3 Beta – 5 Bereiche">
    ...
    Vollwertiger Modell-Provider. Erfordert wiederkehrende Szenariennachweise für Authentifizierung, Katalog und Werkzeugaufrufe.
    ...
    [Anthropic](/de/providers/anthropic), [Agenten konfigurieren](/de/gateway/config-agents), [Modelle](/de/concepts/models), [CLI-Backends](/de/gateway/cli-backends)
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">Anfragetransport und Semantik von Durchläufen</span>
          <span>10 Funktionen</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Experimentell</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>77%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "77%" }} /></span></span></div>
  ...
  <Accordion title="Google-Provider-Pfad – M3 Beta – 5 Bereiche">
    ...
    Vollwertiger Provider mit Modell- und Echtzeitoberflächen. Erfordert separate Bewertungen für Live/Talk.
    ...
    [Google](/de/providers/google), [Modell-Provider](/de/concepts/model-providers), [Google](/de/plugins/reference/google), [Gemini-Suche](/de/tools/gemini-search)
    ...
    [Google](/de/providers/google), [Modell-Provider](/de/concepts/model-providers), [Häufig gestellte Fragen zu Modellen](/de/help/faq-models), [Live-Tests](/de/help/testing-live)
  ...
  <Accordion title="OpenRouter-Provider-Pfad – M3 Beta – 4 Bereiche">
    ...
    Der einheitliche Provider-Pfad ist dokumentiert und wertvoll, das modellspezifische Verhalten variiert jedoch.
  ...
  <Accordion title="Werkzeuge zur Bild-, Video- und Musikgenerierung – M2 Alpha – 5 Bereiche">
    <a id="image-video-and-music-generation-tools" />

    Die Funktion ist bei mehreren Providern vorhanden, doch Qualität, Latenz und Parameterkompatibilität variieren zu stark, um ohne Nachweis für jeden einzelnen Provider den Beta-Status zu erreichen.
    ...
    [Medienübersicht](/de/tools/media-overview), [Bilderzeugung](/de/tools/image-generation), [Videoerzeugung](/de/tools/video-generation), [Musikerzeugung](/de/tools/music-generation)

    </div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">Bilderzeugung</span>
          <span>9 Funktionen</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Experimentell</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>61%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "61%" }} /></span></span></div>
    ...
    [Bilderzeugung](/de/tools/image-generation), [Inferenz](/de/cli/infer), [Medienübersicht](/de/tools/media-overview)

    </div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">Videoerzeugung</span>
          <span>11 Funktionen</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Experimentell</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>61%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "61%" }} /></span></span></div>
    ...
    [Videoerzeugung](/de/tools/video-generation), [Runway](/de/providers/runway), [Pixverse](/de/providers/pixverse), [Fal](/de/providers/fal), [Openrouter](/de/providers/openrouter)

    </div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">Musikerzeugung</span>
          <span>6 Funktionen</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Experimentell</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>61%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "61%" }} /></span></span></div>
  ...
  <Accordion title="Lokale Modell-Provider: Ollama, vLLM, SGLang, LM Studio – M2 Alpha – 5 Bereiche">
    ...
    Nützlich und dokumentiert, jedoch bestehen große Unterschiede zwischen den Umgebungen.
    ...
    [Lokale Modelle](/de/gateway/local-models), [Lmstudio](/de/providers/lmstudio), [Ollama](/de/providers/ollama), [Vllm](/de/providers/vllm), [Lokale Modelldienste](/de/gateway/local-model-services), [Agenten konfigurieren](/de/gateway/config-agents), [Fehlerbehebung](/de/gateway/troubleshooting), [Doctor](/de/gateway/doctor)
    ...
    [Übersicht](/de/gateway/security/index), [Konfigurationswerkzeuge](/de/gateway/config-tools), [Lokale Modelle](/de/gateway/local-models)
  ...
  <Accordion title="Weniger verbreitete gehostete Provider – M2 Alpha – 3 Bereiche">
    ...
    [Übersicht](/de/providers/index), [Modell-Provider](/de/concepts/model-providers), [Live-Tests](/de/help/testing-live), [Einrichtung](/de/cli/onboard)
    ...
    [Manifest](/de/plugins/manifest), [Live-Tests](/de/help/testing-live), [Übersicht](/de/providers/index)
    ...
    [Übersicht](/de/providers/index), [Modell-Provider](/de/concepts/model-providers), [Manifest](/de/plugins/manifest), [Live-Tests](/de/help/testing-live), [Modelle](/de/cli/models)
