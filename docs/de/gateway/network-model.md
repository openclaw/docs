---
read_when:
    - Sie möchten eine kompakte Übersicht über das Gateway-Netzwerkmodell
redirect: /network#core-model
summary: Weiterleitung zu /network#core-model
title: Netzwerkmodell
x-i18n:
    generated_at: "2026-05-06T06:48:40Z"
    model: gpt-5.5
    provider: openai
...
Dieser Inhalt wurde in [Netzwerk — Kernmodell](/de/network#core-model) integriert.
