...
summary: Meta-Einrichtung (Authentifizierung + Modellauswahl für muse-spark-1.1)
title: Meta
x-i18n:
...
- Zustandslose, verschlüsselte Wiedergabe des Reasonings (`store: false`, `include: ["reasoning.encrypted_content"]`)
