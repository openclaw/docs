...
title: Cohere
x-i18n:
    generated_at: "2026-07-12T15:47:17Z"
    model: gpt-5.6
...
[Cohere](https://cohere.com) bietet über seine Compatibility API eine OpenAI-kompatible Inferenz. OpenClaw bündelt den Cohere-Provider während der Umstellung auf die Externalisierung und veröffentlicht ihn außerdem als offizielles externes Plugin.

| Eigenschaft                  | Wert                                                        |
| ---------------------------- | ----------------------------------------------------------- |
| Provider-ID                  | `cohere`                                                    |
| Plugin                       | während der Umstellung gebündelt; offizielles externes Paket |
| Umgebungsvariable für Auth   | `COHERE_API_KEY`                                            |
...
| ------------------------------------ | ----------- | ------- | ---------------- | ----------------------------------------------------------- |
| `cohere/command-a-plus-05-2026`      | Text, Bild  | 128,000 | 64,000           | Standardmodell; führendes agentisches Reasoning-Modell       |
...
| `cohere/command-a-vision-07-2025`    | Text, Bild  | 128,000 | 8,000            | Bild- und Dokumentenanalyse; keine Werkzeugnutzung           |
...
4. Vergewissern Sie sich, dass der Katalog verfügbar ist:
