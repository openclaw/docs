...
OpenClaw = CLAW + TARDIS: Jeder Weltraumhummer braucht eine Zeit- und Raummaschine.
...
- **Vincent Koc** ([@vincentkoc](https://github.com/vincentkoc), [@vincent_koc](https://x.com/vincent_koc)) – Agenten, Telemetrie, Hooks, Sicherheit
...
- [Veröffentlichungsrichtlinie](/de/reference/RELEASING)
