...
title: CLI-Referenz
x-i18n:
    generated_at: "2026-05-11T20:26:34Z"
    model: gpt-5.5
    provider: openai
...
eigene Referenzseite oder ist bei dem Befehl dokumentiert, für den er ein Alias ist; dieser
...
`openclaw status --usage` und die Control-UI zeigen Provider-Nutzung und Kontingente an, wenn
OAuth-/API-Zugangsdaten verfügbar sind. Die Daten stammen direkt aus den Provider-Nutzungsendpunkten
und werden auf `X% left` normalisiert. Provider mit aktuellen Nutzungsfenstern:
