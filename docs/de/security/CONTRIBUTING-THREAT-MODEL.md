---
read_when:
    - Sie möchten Sicherheitslücken oder Bedrohungsszenarien beitragen
...
x-i18n:
    generated_at: "2026-07-12T16:00:41Z"
    model: gpt-5.6
...
Das [Bedrohungsmodell](/de/security/THREAT-MODEL-ATLAS) ist ein fortlaufend aktualisiertes Dokument. Beiträge von allen sind willkommen; Sie benötigen keine Vorkenntnisse im Bereich Sicherheit oder MITRE ATLAS.

<Note>
Dies gilt für Ergänzungen des Bedrohungsmodells, nicht für die Meldung aktueller Sicherheitslücken. Wenn Sie eine ausnutzbare Sicherheitslücke gefunden haben, befolgen Sie stattdessen die Anweisungen zur verantwortungsvollen Offenlegung auf der [Trust-Seite](https://trust.openclaw.ai).
</Note>
...
- Links zu relevanten Forschungsarbeiten, CVEs oder realen Beispielen.

Die Maintainer ordnen während der Überprüfung die ATLAS-Zuordnung, die Bedrohungs-ID und die Risikostufe zu.

**Eine Gegenmaßnahme vorschlagen.** Erstellen Sie ein Issue oder einen PR mit Verweis auf die Bedrohung. Formulieren Sie den Vorschlag konkret und umsetzbar: „Ratenbegrenzung pro Absender auf 10 Nachrichten/Minute am Gateway“ ist hilfreicher als „Ratenbegrenzung implementieren“.

**Eine Angriffskette vorschlagen.** Angriffsketten zeigen, wie mehrere Bedrohungen zu einem realistischen Szenario kombiniert werden. Beschreiben Sie die Schritte und wie ein Angreifer sie verketten würde; eine kurze Darstellung ist besser als eine formale Vorlage.
...
Bedrohungen werden [MITRE ATLAS](https://atlas.mitre.org/) (Adversarial Threat Landscape for AI Systems) zugeordnet, einem Framework für KI-/ML-spezifische Bedrohungen wie Prompt-Injection, Werkzeugmissbrauch und die Ausnutzung von Agenten. Sie müssen ATLAS nicht kennen, um Beiträge einzureichen; die Maintainer ordnen Einreichungen während der Überprüfung zu.
...
- **Sicherheitslücken:** Anweisungen zur Meldung finden Sie auf der [Trust-Seite](https://trust.openclaw.ai) oder unter `security@openclaw.ai`.
...
Mitwirkende am Bedrohungsmodell werden in den Danksagungen des Bedrohungsmodells, den Versionshinweisen und bei bedeutenden Beiträgen in der OpenClaw Security Hall of Fame gewürdigt.
