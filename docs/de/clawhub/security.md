...
read_when:
    ...
    - ClawHub-Plattformprobleme von Problemen mit Skills oder Drittanbieter-Plugins unterscheiden
...
-Plugins. Melden Sie diese direkt dem Publisher oder dem Quell-Repository,
