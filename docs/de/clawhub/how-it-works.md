...
x-i18n:
    generated_at: "2026-07-01T15:22:23Z"
    model: gpt-5.5
...
Plugin zu leisten behauptet, bevor sie ihn bzw. es installieren.
...
Wenn OpenClaw ein Plugin aus ClawHub installiert, prüft es die angekündigten Kompatibilitätsmetadaten
...
Verwenden Sie Probeläufe, um die aufgelöste Payload vor dem Upload in der Vorschau zu prüfen. Öffentliche Seiten
...
OpenClaw zeichnet Metadaten zur Installationsquelle auf, damit Updates dasselbe
Registry-Paket später wieder auflösen können. Die ClawHub CLI unterstützt außerdem direkte Skill-Installations- und
...
kanonische ClawHub-Listing zurückverlinken, Ratenlimits respektieren und vermeiden, eine Empfehlung zu suggerieren.
