...
Wenn OpenClaw ein Plugin aus ClawHub installiert, prüft es die angekündigten Kompatibilitäts-
metadaten vor der Installation. Paketeinträge können API-Kompatibilität,
Mindestversion des Gateway, Host-Zielplattformen, Umgebungsanforderungen und Artefakt-
Digests enthalten.
...
kanonische ClawHub-Listing zurückverlinken, Rate Limits respektieren und keine Unterstützung suggerieren.
