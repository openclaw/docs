...
x-i18n:
    generated_at: "2026-07-03T00:54:49Z"
    model: gpt-5.5
...
Ort zum Entdecken von Paketen, Herausgebern einen Ort zum Veröffentlichen von Versionen und
...
- Metadaten, Zusammenfassung, Dateien und Herkunftsnachweis
...
Metadaten sind wichtig, weil sie Benutzern bei der Entscheidung helfen, ob sie den Skill
installieren sollen, und automatisierten Scans helfen, Abweichungen zwischen deklariertem und beobachtetem Verhalten zu erkennen.
...
Das Veröffentlichen erstellt einen neuen unveränderlichen Versionseintrag. Herausgeber verwenden die `clawhub`-
...
zeigen anschließend die veröffentlichten Metadaten, Dateien, Herkunftsnachweise und den Scan-Status.
...
kanonischen ClawHub-Eintrag zurückverlinken, Rate-Limits einhalten und vermeiden, eine Empfehlung zu implizieren.
