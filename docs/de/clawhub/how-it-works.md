...
x-i18n:
    generated_at: "2026-07-05T05:46:27Z"
    model: gpt-5.5
...
Metadaten sind wichtig, weil sie Benutzern bei der Entscheidung helfen, ob sie den Skill installieren sollten, und
automatisierten Scans dabei helfen, Abweichungen zwischen deklariertem und beobachtetem Verhalten zu erkennen.
...
eine minimale Gateway-Version, Host-Ziele, Umgebungsanforderungen und Artefakt-Digests enthalten.
...
Verwenden Sie Probeläufe, um die aufgelöste Payload vor dem Upload zu prüfen. Öffentliche Seiten zeigen anschließend
...
oder blockiert werden, können aus der öffentlichen Suche und den Installationsabläufen verschwinden, bleiben
für den Owner jedoch zu Diagnosezwecken sichtbar.

Siehe [Sicherheit](/de/clawhub/security), [Sicherheitsaudits](/clawhub/security-audits),
...
kanonische ClawHub-Listing zurückverlinken, Ratenbegrenzungen einhalten und keine Billigung suggerieren.
