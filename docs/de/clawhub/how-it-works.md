...
x-i18n:
    generated_at: "2026-07-01T05:37:30Z"
    model: gpt-5.5
...
Ein Skill ist ein versioniertes Textpaket mit `SKILL.md` als Mittelpunkt. Es kann
...
Wenn OpenClaw ein Plugin aus ClawHub installiert, prüft es vor der Installation die beworbenen Kompatibilitätsmetadaten.
...
Verwenden Sie Testläufe, um die aufgelöste Nutzlast vor dem Hochladen zu prüfen. Öffentliche Seiten zeigen anschließend
