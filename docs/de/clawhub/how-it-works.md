...
x-i18n:
    generated_at: "2026-07-04T03:41:56Z"
    model: gpt-5.5
...
einen Ort, um Pakete zu entdecken, Herausgebern einen Ort, um Versionen zu veröffentlichen, und
...
Metadaten sind wichtig, weil sie Benutzern bei der Entscheidung helfen, ob sie den Skill installieren, und
...
Wenn OpenClaw ein Plugin aus ClawHub installiert, prüft es vor der Installation die angezeigten Kompatibilitätsmetadaten. Paketeinträge können API-Kompatibilität,
...
Die Veröffentlichung erstellt einen neuen unveränderlichen Versionseintrag. Herausgeber verwenden die `clawhub`
...
zeigen anschließend die veröffentlichten Metadaten, Dateien, Quellenzuordnung und den Scanstatus an.
...
Downloads bereit. Drittanbieter-Kataloge dürfen diese APIs verwenden, wenn sie auf die
kanonische ClawHub-Auflistung zurückverlinken, Ratenlimits respektieren und keine Empfehlung implizieren.
