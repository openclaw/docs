---
read_when:
    - Auflistungen, Versionen, Installationen, Veröffentlichung und Moderation verstehen
summary: Wie ClawHub-Einträge, Versionen, Installationen, Veröffentlichung, Scans und Updates funktionieren.
x-i18n:
    generated_at: "2026-06-28T00:10:26Z"
    model: gpt-5.5
...
Jeder öffentliche Listeneintrag ist ein Registry-Eintrag mit:
...
Wenn OpenClaw ein Plugin aus ClawHub installiert, prüft es die angezeigten Kompatibilitätsmetadaten
vor der Installation. Paketdatensätze können API-Kompatibilität,
...
Verwenden Sie Probeläufe, um die aufgelöste Nutzlast vor dem Hochladen zu prüfen. Öffentliche Seiten
...
ClawHub ist für Veröffentlichungen geöffnet, Releases unterliegen jedoch weiterhin Upload-Sperren,
...
kanonischen ClawHub-Eintrag zurückverlinken, Rate-Limits einhalten und keine Empfehlung implizieren.
