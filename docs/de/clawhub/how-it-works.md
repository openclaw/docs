...
x-i18n:
    generated_at: "2026-07-01T18:09:55Z"
    model: gpt-5.5
...
Ein Skill ist ein versioniertes Text-Bundle mit `SKILL.md` im Mittelpunkt. Er kann
...
Durch das Veröffentlichen wird ein neuer unveränderlicher Versionsdatensatz erstellt. Publisher verwenden die `clawhub`
...
oder blockiert werden, können aus der öffentlichen Suche und aus Installationsabläufen verschwinden, bleiben dem
Owner aber für Diagnosen sichtbar.
...
kanonischen ClawHub-Eintrag zurückverlinken, Ratenbegrenzungen einhalten und keine Empfehlung suggerieren.
