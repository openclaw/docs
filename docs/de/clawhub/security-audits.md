...
read_when:
    ...
    - Entscheiden, ob Sie eine Skill oder ein Plugin installieren sollen
...
x-i18n:
    generated_at: "2026-06-30T13:57:46Z"
    model: gpt-5.5
...
| `Warn`      | Seien Sie besonders vorsichtig. ClawHub hat ein schwerwiegendes Problem oder ein Warnsignal gefunden. |
...
Die Risikostufe beschreibt den Auswirkungsradius: wie viel Macht das Release zu haben scheint, wenn
Sie es wie vorgesehen verwenden.

| Risikostufe | Bedeutung                                                                     |
| ----------- | ----------------------------------------------------------------------------- |
| `Low`       | Es wurden nur geringe sensible Berechtigungen oder Auswirkungen auf Benutzer gefunden. |
| `Medium`    | Das Release hat relevante Berechtigungen, etwa Kontozugriff oder Datenänderungen. |
| `High`      | Das Release hat schwerwiegende Berechtigungen, schwere Befunde oder bösartige Signale. |
...
Beispielsweise kann ein Publishing-Skill `Review` mit `Medium`-Risiko anzeigen. Das bedeutet
...
Befunde mit geringer Zuverlässigkeit werden aus der öffentlichen Auditzusammenfassung ausgeblendet, damit die Seite
...
Partnerschaft ermöglicht ClawHub, die Prüfung von Skills und Plugins um umfassendere Sicherheitsinformationen
zu erweitern.

VirusTotal ist besonders nützlich für bekannte bösartige Artefakte, Treffer von Engines und
Reputationssignale, die die agentenbewusste Prüfung von ClawHub ergänzen. Wenn Zählungen von Anbieter-Engines
...
System. Es prüft jedes Release als agentengerichtetes Artefakt: Anweisungen,
...
als Perspektive auf Risiken wie Prompt-Injection, Tool-Missbrauch, Offenlegung von Zugangsdaten,
...
Es fragt, ob die Fähigkeit offengelegt, zweckgerecht und durch
