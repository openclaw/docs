...
x-i18n:
    generated_at: "2026-07-01T12:57:44Z"
    model: gpt-5.5
...
Der Audit-Status zeigt Ihnen, wie Sie auf das Audit-Ergebnis reagieren sollten:
...
| ----------- | ------------------------------------------------------------------------------- |
| `Low`       | Es wurde wenig sensible Befugnis oder Auswirkung auf Benutzer gefunden.          |
| `Medium`    | Das Release hat relevante Befugnisse, etwa Kontozugriff oder Datenänderungen.   |
| `High`      | Das Release hat weitreichende Befugnisse, schwerwiegende Befunde oder bösartige Signale. |
...
Befunde erklären, warum ein Audit-Ergebnis angezeigt wurde. Jeder Befund enthält normalerweise:
...
Befugnisse und tatsächlicher Inhalt zu dem, was Benutzer vernünftigerweise erwarten würden?
...
Hersteller-Engines verfügbar sind, fasst das Audit sie in einfacher Sprache zusammen, zum Beispiel:
...
Wenn ClawHub keine Herstellerzählungs-Telemetrie zum Zusammenfassen hat, lautet das Audit:
...
System. Sie prüft jedes Release als agentenbezogenes Artefakt: Anweisungen,
...
eigenständiger öffentlicher Audit-Abschnitt und kein installierungsblockierendes Urteil.
...
unsichere Ausführung, Vergiftung von Speicher oder Kontext sowie übermäßige Handlungsautonomie.
