...
read_when:
    ...
    - Erläuterung des ClawHub-Auditstatus, des Risikoniveaus oder der Befunde
...
x-i18n:
    generated_at: "2026-07-02T22:26:17Z"
    model: gpt-5.5
...
Befunde mit niedriger Zuverlässigkeit werden aus der öffentlichen Audit-Zusammenfassung ausgeblendet, damit die Seite
auf nützliche Evidenz fokussiert bleibt.
...
System. Sie prüft jedes Release als agentengerichtetes Artefakt: Anweisungen,
...
als Betrachtungsrahmen für Risiken wie Prompt Injection, Tool-Missbrauch, Offenlegung von Anmeldedaten,
...
Es prüft, ob die Fähigkeit offengelegt, zweckkonform und durch den angegebenen Anwendungsfall
