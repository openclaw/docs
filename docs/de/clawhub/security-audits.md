...
x-i18n:
    generated_at: "2026-07-03T00:54:37Z"
    model: gpt-5.5
...
Ein veröffentlichender Skill kann beispielsweise `Review` mit `Medium`-Risiko anzeigen. Das bedeutet
...
Befunde mit geringer Vertrauenswürdigkeit werden aus der öffentlichen Audit-Zusammenfassung ausgeblendet, damit die Seite
...
Partnerschaft ermöglicht es ClawHub, breitere Sicherheitsinformationen in die Prüfung von Skills und Plugins
einzubeziehen.
...
verfügbar sind, fasst das Audit sie in einfacher Sprache zusammen, etwa:
...
Die Risikoanalyse wird intern von ClawScan unterstützt, ClawHubs eigenem System für Sicherheitsaudits.
Sie prüft jedes Release als agentenorientiertes Artefakt: Anweisungen,
...
eigenständiger öffentlicher Audit-Abschnitt und kein installblockierendes Urteil.
