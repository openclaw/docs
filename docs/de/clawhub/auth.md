...
read_when:
    ...
    - 401-Fehler debuggen
summary: Anmeldung bei ClawHub, API-Token, CLI-Anmeldung, Token-Speicherung und Widerruf.
x-i18n:
    generated_at: "2026-06-27T17:14:31Z"
    model: gpt-5.5
...
gutem Zustand. Wenn Ihr Konto gesperrt oder deaktiviert wurde, verwenden Sie das
