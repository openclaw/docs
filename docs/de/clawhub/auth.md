...
x-i18n:
    generated_at: "2026-07-02T00:50:06Z"
    model: gpt-5.5
...
Wenn die Anmeldung Sie in einen abgemeldeten Zustand zurückversetzt, ist Ihr Konto möglicherweise nicht in gutem
...
Verwenden Sie diesen Ablauf für Server, CI-Jobs oder Umgebungen, die nur ein Terminal haben.
