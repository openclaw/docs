...
x-i18n:
    generated_at: "2026-07-04T06:26:23Z"
    model: gpt-5.5
...
Melden Sie sich mit GitHub bei [clawhub.ai](https://clawhub.ai) an.

Gelöschte, gesperrte oder deaktivierte Konten können die normale ClawHub-Anmeldung nicht abschließen. Wenn Sie nach der Anmeldung wieder abgemeldet sind, ist Ihr Konto möglicherweise nicht in gutem Zustand. Wenn Ihr Konto gesperrt oder deaktiviert wurde, verwenden Sie das [ClawHub-Einspruchsformular](https://appeals.openclaw.ai/), falls Sie glauben, dass dies ein Fehler ist.
...
Wenn Ihr Browser den lokalen Callback aufgrund von Firewall-, VPN- oder Proxy-Regeln nicht erreichen kann, verwenden Sie den Headless-Token-Fluss.
