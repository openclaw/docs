...
x-i18n:
    generated_at: "2026-05-10T19:25:07Z"
    model: gpt-5.5
    provider: openai
...
Wenn die Anmeldung Sie wieder in einen abgemeldeten Zustand zurückführt, befindet sich Ihr Konto möglicherweise nicht in gutem
Status.
...
Gelöschte, gesperrte oder deaktivierte Konten können bestehende API-Token nicht weiterverwenden.
