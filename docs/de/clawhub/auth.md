...
read_when:
    ...
    - 401-Fehler debuggen
summary: ClawHub-Anmeldung, API-Token, CLI-Login, Tokenspeicherung und Widerruf.
x-i18n:
    generated_at: "2026-07-04T17:56:27Z"
    model: gpt-5.5
...
Wenn Sie nach der Anmeldung wieder in einem abgemeldeten Zustand landen, ist Ihr Konto möglicherweise
nicht in einwandfreiem Zustand. Wenn Ihr Konto gesperrt oder deaktiviert wurde, verwenden Sie das
[ClawHub-Einspruchsformular](https://appeals.openclaw.ai/), falls Sie glauben, dass dies ein Fehler ist.
...
Wenn Ihr Browser den lokalen Callback wegen Firewall-, VPN- oder Proxy-Regeln nicht erreichen kann,
verwenden Sie den Headless-Token-Ablauf.
