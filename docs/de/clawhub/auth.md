...
x-i18n:
    generated_at: "2026-07-04T10:32:57Z"
    model: gpt-5.5
...
ClawHub verwendet GitHub für die Webanmeldung. Die CLI verwendet ClawHub-API-Tokens, die
...
Wenn die Anmeldung Sie in einen abgemeldeten Zustand zurückführt, ist Ihr Konto möglicherweise nicht in gutem
...
Sie können API-Tokens in der ClawHub-Weboberfläche widerrufen.
...
Gelöschte, gesperrte oder deaktivierte Konten können bestehende API-Tokens nicht weiterverwenden.
