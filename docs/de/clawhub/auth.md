...
x-i18n:
    generated_at: "2026-07-05T05:46:32Z"
    model: gpt-5.5
...
Widerrufene, ungültige oder fehlende Token geben `401 Unauthorized` zurück. Melden Sie sich erneut an
mit `clawhub login` oder stellen Sie ein neues Token mit `clawhub login --token` bereit.
