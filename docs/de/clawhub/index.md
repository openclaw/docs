...
- Verwenden Sie die separate `clawhub` CLI für Registry-Authentifizierung, Veröffentlichung, Löschen/Wiederherstellen und Synchronisierungsworkflows.
...
Nackte npm-sichere Plugin-Spezifikationen können während Launch-Cutovers über npm aufgelöst werden, und
...
| Variable                      | Wirkung                                                   |
| ----------------------------- | --------------------------------------------------------- |
| `CLAWHUB_SITE`                | Überschreibt die für den Browser-Login verwendete Site-URL. |
