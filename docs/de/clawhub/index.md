...
- Verwenden Sie die separate `clawhub`-CLI für Registry-Authentifizierung, Veröffentlichung, Löschen/Wiederherstellen und Sync-Workflows.
...
für ihren Besitzer in `/dashboard` jedoch sichtbar.
