...
Status, sodass Benutzer einen Skill oder ein Plugin prüfen können, bevor sie es installieren.
...
ClawHub ist standardmäßig offen: Jeder kann hochladen, aber zum Veröffentlichen ist ein GitHub-
Konto erforderlich, das alt genug ist, um die Upload-Sperre zu passieren. Öffentliche Detailseiten fassen den
...
Wenn Sie `clawhub install` ausführen, während Sie angemeldet sind, kann die CLI nach bestem Ermessen
