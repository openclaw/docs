...
- Verwenden Sie die separate `clawhub`-CLI für Registry-Authentifizierung, Veröffentlichung sowie Lösch- und Wiederherstellungsworkflows.
...
| Code-Plugins   | OpenClaw-Pluginpakete mit Kompatibilitätsmetadaten                | `openclaw plugins install clawhub:<package>` |
...
Quellmetadaten dauerhaft, damit spätere Aktualisierungsbefehle bei ClawHub bleiben können.
