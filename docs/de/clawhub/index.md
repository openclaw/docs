...
read_when:
    ...
    - Nach Skills oder Plugins suchen, sie installieren oder aktualisieren
...
title: ClawHub
x-i18n:
    generated_at: "2026-07-02T22:25:57Z"
    model: gpt-5.5
...
Die CLI bietet außerdem Befehle zum Installieren/Aktualisieren von Skills für direkte Registry-Workflows:
...
oder blockierte Releases können aus öffentlichen Katalog- und Installationsoberflächen verschwinden, während sie
...
Wenn Sie `clawhub install` ausführen, während Sie angemeldet sind, kann die CLI nach bestem Aufwand
...
| `CLAWHUB_CONFIG_PATH`         | Überschreibt, wo die CLI den Token-/Konfigurationsstatus speichert. |
