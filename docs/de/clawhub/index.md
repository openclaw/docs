...
Quellmetadaten, damit spätere Update-Befehle bei ClawHub bleiben können.

Verwenden Sie `clawhub:<package>`, wenn eine Plugin-Installation über ClawHub aufgelöst werden soll.
Bloße npm-sichere Plugin-Spezifikationen können während Umstellungsphasen beim Start über npm aufgelöst werden, und
...
Die CLI verfügt außerdem über Skill-Installations-/Update-Befehle für direkte Registry-Workflows:
...
ClawHub ist standardmäßig offen: Jede Person kann hochladen, aber das Veröffentlichen erfordert ein GitHub-
...
für ihre Eigentümer jedoch in `/dashboard` sichtbar.
...
[Akzeptable Nutzung](/clawhub/acceptable-usage) für Details zu Richtlinien und Durchsetzung.
...
Siehe [Telemetrie](/de/clawhub/telemetry), [HTTP-API](/clawhub/http-api) und
[Fehlerbehebung](/clawhub/troubleshooting) für ausführlicheres Referenzmaterial.
