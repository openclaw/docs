...
summary: Öffentliche ClawHub-Übersicht zum Entdecken, Installieren, Veröffentlichen, zur Sicherheit und zur clawhub-CLI.
title: ClawHub
x-i18n:
    generated_at: "2026-07-05T04:59:13Z"
    model: gpt-5.5
...
`npm:<package>` bleibt nur npm, wenn eine Quelle explizit sein muss.
...
Die CLI bietet außerdem Skill-Installations- und Update-Befehle für direkte Registry-Workflows:
...
ClawHub führt automatisierte Prüfungen für veröffentlichte Skills und Plugin-Releases aus. Scan-angehaltene
