...
read_when:
    ...
    - Nach Skills oder Plugins suchen, diese installieren oder aktualisieren
    - Skills oder Plugins in der Registry veröffentlichen
    - Zwischen openclaw- und clawhub-CLI-Abläufen wählen
sidebarTitle: ClawHub
summary: Öffentliche ClawHub-Übersicht zu Entdeckung, Installation, Veröffentlichung, Sicherheit und der clawhub CLI.
title: ClawHub
x-i18n:
    generated_at: "2026-05-11T20:24:31Z"
    model: gpt-5.5
    provider: openai
...
- Verwenden Sie die separate `clawhub`-CLI für Registry-Authentifizierung, Veröffentlichung, Löschen/Wiederherstellen, erneute Scans und Synchronisierungs-Workflows.
...
Veröffentlichen, Synchronisieren, Löschen/Wiederherstellen oder vom Owner angeforderte erneute Scans verwenden möchten:
...
| -------------- | ------------------------------------------------------------ | -------------------------------------------- |
| Skills         | Versionierte Text-Bundles mit `SKILL.md` plus unterstützenden Dateien | `openclaw skills install <slug>`             |
...
`npm:<package>` bleibt rein npm-basiert, wenn eine Quelle explizit sein muss.
...
Die CLI hat außerdem Skill-Installations- und Aktualisierungsbefehle für direkte Registry-Workflows:
...
Konto, das alt genug ist, um die Upload-Schranke zu bestehen. Öffentliche Detailseiten fassen den
...
oder blockierte Releases können aus dem öffentlichen Katalog und den Installationsoberflächen verschwinden, bleiben
aber für ihren Owner in `/dashboard` sichtbar.

Owner können begrenzte erneute Scans zur Wiederherstellung nach falsch positiven Ergebnissen anfordern. Plattform-
Moderatoren und Administratoren können beim Bearbeiten von Support-Meldungen
erneute Scans für jeden Skill oder jedes Paket anfordern:
...
Inhalte ausblenden oder wiederherstellen, Einsprüche bearbeiten und missbräuchliche Konten sperren. Siehe
