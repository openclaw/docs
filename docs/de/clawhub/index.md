...
Native OpenClaw-Befehle installieren in den aktiven OpenClaw-Arbeitsbereich und persistieren
Quellmetadaten, damit spätere Update-Befehle auf ClawHub bleiben können.
...
Die CLI verfügt außerdem über Skill-Installations- und Update-Befehle für direkte Registry-Workflows:
...
ClawHub ist standardmäßig offen: Jede Person kann hochladen, aber die Veröffentlichung erfordert ein GitHub-
...
für ihren Besitzer jedoch in `/dashboard` sichtbar.
