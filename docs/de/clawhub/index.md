...
title: ClawHub
x-i18n:
    generated_at: "2026-07-01T20:18:21Z"
    model: gpt-5.5
...
| -------------- | ---------------------------------------------------------- | ------------------------------------------ |
| Skills         | Versionierte Text-Bundles mit `SKILL.md` plus Hilfsdateien | `openclaw skills install @openclaw/demo`   |
...
Plugin-Installationen prüfen die beworbene Kompatibilität von `pluginApi` und `minGatewayVersion`,
