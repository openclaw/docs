...
summary: Öffentliche ClawHub-Übersicht zum Entdecken, Installieren, Veröffentlichen, zu Sicherheit und zur clawhub CLI.
title: ClawHub
x-i18n:
    generated_at: "2026-07-01T05:36:36Z"
    model: gpt-5.5
...
- Verwenden Sie die separate `clawhub`-CLI für Registry-Authentifizierung, Veröffentlichung und Löschen-/Wiederherstellen-Workflows.
