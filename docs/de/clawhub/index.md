...
- Verwenden Sie die separate `clawhub`-CLI für Registry-Authentifizierung, Veröffentlichung sowie Löschen/Wiederherstellen-Workflows.
...
oder blockierte Releases können aus öffentlichem Katalog und Installationsoberflächen verschwinden, während sie
