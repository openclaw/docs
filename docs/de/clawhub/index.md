...
summary: Öffentliche ClawHub-Übersicht für Erkennung, Installation, Veröffentlichung, Sicherheit und die clawhub CLI.
title: ClawHub
x-i18n:
    generated_at: "2026-07-03T02:46:18Z"
    model: gpt-5.5
...
`npm:<package>` bleibt nur npm, wenn eine Quelle ausdrücklich sein muss.
