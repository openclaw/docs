...
read_when:
    ...
    - Suchen nach, Installieren oder Aktualisieren von Skills oder Plugins
...
title: ClawHub
x-i18n:
    generated_at: "2026-07-02T08:09:55Z"
    model: gpt-5.5
...
- Verwenden Sie die separate `clawhub`-CLI für Registry-Authentifizierung, Veröffentlichung sowie Lösch-/Wiederherstellungs-Workflows.
