...
summary: Öffentlicher ClawHub-Überblick für Discovery, Installation, Veröffentlichung, Sicherheit und die clawhub CLI.
title: ClawHub
x-i18n:
    generated_at: "2026-07-04T20:28:21Z"
    model: gpt-5.5
...
Bare npm-sichere Plugin-Spezifikationen können während Launch-Umstellungen über npm aufgelöst werden, und
...
bevor die Archivinstallation läuft. Wenn eine Paketversion ein ClawPack-Artefakt veröffentlicht,
bevorzugt OpenClaw das exakt hochgeladene npm-pack-`.tgz`, verifiziert den
ClawHub-Digest-Header und die heruntergeladenen Bytes und zeichnet Artefaktmetadaten für
...
Konto, das alt genug ist, um die Upload-Sperre zu bestehen. Öffentliche Detailseiten fassen den
neuesten Scan-Status vor der Installation oder dem Download zusammen.

ClawHub führt automatisierte Prüfungen an veröffentlichten Skills und Plugin-Releases aus. Zurückgehaltene
oder blockierte Releases können aus dem öffentlichen Katalog und Installationsoberflächen verschwinden,
bleiben aber für ihren Besitzer in `/dashboard` sichtbar.
...
[Akzeptable Nutzung](/de/clawhub/acceptable-usage) für Richtlinien und Durchsetzungsdetails.
