...
title: ClawHub
x-i18n:
    generated_at: "2026-07-02T14:01:57Z"
    model: gpt-5.5
...
Bare npm-sichere Plugin-Spezifikationen können während Launch-Übergängen über npm aufgelöst werden, und
...
ClawHub führt automatisierte Prüfungen für veröffentlichte Skills und Plugin-Releases aus. Zurückgehaltene
oder blockierte Releases können aus öffentlichen Katalog- und Installationsoberflächen verschwinden, bleiben
aber für ihre Besitzer unter `/dashboard` sichtbar.
...
| Variable                      | Wirkung                                           |
| ----------------------------- | ------------------------------------------------- |
| `CLAWHUB_SITE`                | Überschreibt die für die Browser-Anmeldung verwendete Site-URL. |
