...
Die CLI verfügt auch über Befehle zum Installieren/Aktualisieren von Skills für direkte Registry-Workflows:
...
sie für ihre Eigentümer in `/dashboard` sichtbar bleiben.
...
Wenn Sie `clawhub install` ausführen, während Sie angemeldet sind, sendet die CLI möglicherweise nach bestem Bemühen
ein Installationsereignis, damit ClawHub aggregierte Installationszahlen berechnen kann. Deaktivieren Sie dies mit:
