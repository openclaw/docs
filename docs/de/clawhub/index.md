...
title: ClawHub
x-i18n:
    generated_at: "2026-06-28T05:29:50Z"
    model: gpt-5.5
...
Reine npm-sichere Plugin-Spezifikationen können während Launch-Cutovers über npm aufgelöst werden, und
...
Die ClawHub-CLI ist für Registry-authentifizierte Arbeiten gedacht:
...
Konto, das alt genug ist, um die Upload-Grenze zu passieren. Öffentliche Detailseiten fassen den
neuesten Scan-Zustand vor Installation oder Download zusammen.
...
| Variable                      | Wirkung                                                       |
| ----------------------------- | ------------------------------------------------------------- |
| `CLAWHUB_SITE`                | Überschreibt die Website-URL, die für den Browser-Login verwendet wird. |
