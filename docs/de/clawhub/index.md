...
title: ClawHub
x-i18n:
    generated_at: "2026-07-02T17:34:24Z"
    model: gpt-5.5
...
- Verwenden Sie die separate `clawhub`-CLI für Registry-Authentifizierung, Veröffentlichung sowie Workflows zum Löschen und Wiederherstellen.
...
- `--slug <slug>`: veröffentlichter URL-Name des Skills.
...
für ihren Owner in `/dashboard` sichtbar bleiben.
