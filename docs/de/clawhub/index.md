...
Quellmetadaten, sodass spätere Aktualisierungsbefehle bei ClawHub bleiben können.

Verwenden Sie `clawhub:<package>`, wenn eine Plugin-Installation über ClawHub aufgelöst werden soll.
Einfache npm-sichere Plugin-Spezifikationen können während Umstellungsphasen des Starts über npm aufgelöst werden, und
