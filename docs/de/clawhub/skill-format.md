...
x-i18n:
    generated_at: "2026-07-04T03:42:26Z"
    model: gpt-5.5
...
Installationsstatus des Workdir (von der CLI geschrieben):
...
---
name: my-skill
description: Kurze Zusammenfassung dessen, was dieser Skill tut.
version: 1.0.0
---
```
  ...
  openclaw:
    ...
    envVars:
      - name: TODOIST_API_KEY
        required: true
        description: Todoist API-Token, der für authentifizierte Anfragen verwendet wird.
      - name: TODOIST_PROJECT_ID
        required: false
        description: Optionale Standard-Projekt-ID, wenn der Benutzer keine angibt.
```
