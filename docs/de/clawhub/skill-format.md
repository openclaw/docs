...
read_when:
    ...
    - Fehlersuche bei Fehlern beim Veröffentlichen/Synchronisieren
...
- `.clawhubignore` (Ignoriermuster für Veröffentlichen/Synchronisieren, Legacy `.clawdhubignore`)
...
| `primaryEnv`       | `string`   | Die zentrale Zugangsdaten-Umgebungsvariable für Ihren Skill.                                                                                                 |
