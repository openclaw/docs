...
Metadaten für lokale Installation (von der CLI geschrieben):
...
### Laufzeit-Metadaten (`metadata.openclaw`)
  ...
  openclaw:
    ...
    envVars:
      - name: TODOIST_API_KEY
        required: true
        description: Todoist API-Token, das für authentifizierte Anfragen verwendet wird.
...
- ClawHub unterstützt keine kostenpflichtigen Skills, keine Preise pro Skill, keine Bezahlschranken und keine Umsatzbeteiligung.
