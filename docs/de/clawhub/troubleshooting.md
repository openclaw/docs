...
x-i18n:
    generated_at: "2026-07-01T18:10:42Z"
    model: gpt-5.5
...
- Wenn Sie Eigentümer des Skills sind, melden Sie sich an und prüfen Sie ihn:
...
mit öffentlichen, nicht sensiblen Nachweisen. Weitere Hinweise zu Nachweisen und dazu, was
nicht in öffentliche Issues gehört, finden Sie unter
[Org- und Namespace-Claims](/clawhub/namespace-claims).
