...
x-i18n:
    generated_at: "2026-07-02T00:49:24Z"
    model: gpt-5.5
...
- `Retry-After`: Sekunden, die vor einem erneuten Versuch zu warten sind.
...
müssen gescoped Namen wie `@example-org/example-plugin` als passender
