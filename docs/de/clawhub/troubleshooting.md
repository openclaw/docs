...
x-i18n:
    generated_at: "2026-07-02T08:10:30Z"
    model: gpt-5.5
...
Wenn viele Benutzer eine Egress-IP teilen, können anonyme IP-Limits erreicht werden, selbst wenn jede
...
Prüfen Sie bei Skills das `SKILL.md`-Frontmatter. Erforderliche Umgebungsvariablen und
...
Wenn eine Veröffentlichung fehlschlägt, weil das Owner-Handle, der Org-Namespace, der Paket-Scope, der Skill-
...
nicht in öffentlichen Issues stehen sollte.
