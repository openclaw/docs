...
summary: Fehlerbehebung bei ClawHub-Anmelde-, Installations-, Veröffentlichungs-, Aktualisierungs- und API-Problemen.
x-i18n:
    generated_at: "2026-07-04T10:36:27Z"
    model: gpt-5.5
...
- Wenn Sie ein API-Token verwenden, prüfen Sie, ob es in der Weboberfläche nicht widerrufen wurde.
...
- Prüfen Sie den exakten Slug oder die Owner-Seite, wenn Sie ihn kennen.
...
## Veröffentlichen schlägt wegen eines GitHub-Owners oder Quellenfehlers fehl
...
Slug oder Paketname bereits beansprucht oder reserviert ist, prüfen Sie zuerst, ob Sie
