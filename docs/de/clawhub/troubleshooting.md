...
x-i18n:
    generated_at: "2026-06-30T22:12:45Z"
    model: gpt-5.5
...
Wenn Sie der Meinung sind, dass Ihre Organisation, Ihr Projekt oder Ihre Marke der rechtmäßige Namespace-Owner ist, Sie
...
- Beachten Sie die `429`-Retry-Header und cachen Sie öffentliche Listen-/Suchantworten.
