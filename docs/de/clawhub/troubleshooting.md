...
x-i18n:
    generated_at: "2026-06-28T07:42:30Z"
    model: gpt-5.5
...
- Vergewissern Sie sich, dass die Veröffentlichung öffentlich ist und nicht durch Scan oder Moderation zurückgehalten wird.
...
[Problem zur Organisations-/Namespace-Beanspruchung](https://github.com/openclaw/clawhub/issues/new?template=org-namespace-claim.yml)
mit öffentlichen, nicht vertraulichen Nachweisen. Siehe
[Organisations- und Namespace-Beanspruchungen](/de/clawhub/namespace-claims) für Hinweise zu Nachweisen und dazu, was
