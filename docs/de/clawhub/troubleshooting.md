...
x-i18n:
    generated_at: "2026-07-02T17:35:01Z"
    model: gpt-5.5
...
- `Retry-After`: Sekunden, die Sie vor einem erneuten Versuch warten sollten.
...
Sehen Sie sich zuerst eine Vorschau der Veröffentlichungsnutzlast an:
