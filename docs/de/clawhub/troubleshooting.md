...
summary: Fehlerbehebung bei Problemen mit der ClawHub-Anmeldung, Installation, Veröffentlichung, Synchronisierung, Aktualisierung und API.
x-i18n:
...
- Prüfen Sie den genauen Slug oder die Besitzerseite, falls Sie diese kennen.
- Stellen Sie sicher, dass die Veröffentlichung öffentlich ist und nicht durch Scan oder Moderation zurückgehalten wird.
...
Weitere Endpunktdetails finden Sie unter [HTTP-API](/de/clawhub/http-api).
