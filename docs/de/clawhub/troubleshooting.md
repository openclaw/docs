...
x-i18n:
    generated_at: "2026-07-01T05:37:31Z"
    model: gpt-5.5
...
- `Retry-After`: Sekunden, die vor dem erneuten Versuch gewartet werden soll.
...
Wenn viele Benutzer dieselbe ausgehende IP-Adresse teilen, können anonyme IP-Limits erreicht werden, auch wenn jede
...
- Prüfen Sie den genauen Slug oder die Owner-Seite, falls Sie ihn bzw. sie kennen.
- Prüfen Sie, ob das Release öffentlich ist und nicht durch Scan oder Moderation zurückgehalten wird.
...
Zeigen Sie zuerst eine Vorschau des Veröffentlichungspayloads an:

```bash
clawhub package publish <source> --family code-plugin --dry-run
```

## Veröffentlichung schlägt mit einem GitHub-Owner- oder Quellenfehler fehl

ClawHub verwendet GitHub-Identität und Quellenzuordnung, um Pakete mit ihren
Publishern zu verknüpfen.

- Stellen Sie sicher, dass Sie mit dem GitHub-Konto angemeldet sind, das das Paket besitzt oder veröffentlichen kann.
...
- Behalten Sie lokale Bearbeitungen und überspringen Sie das Update.
...
- Prüfen Sie, ob Ihre OpenClaw-Version den beworbenen
