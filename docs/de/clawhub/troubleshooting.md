...
x-i18n:
    generated_at: "2026-07-01T07:57:24Z"
    model: gpt-5.5
...
- Bestätigen Sie, dass das Release öffentlich ist und nicht durch Prüfung oder Moderation zurückgehalten wird.
...
Für Owner sichtbare Diagnosen können den Prüf-, Upload-Gate- oder Moderationsstatus erklären.
...
Wenn eine Veröffentlichung fehlschlägt, weil das Owner-Handle, der Org-Namensraum, der Paket-Scope, der Skill-
Slug oder der Paketname bereits beansprucht oder reserviert ist, bestätigen Sie zuerst, dass Sie
mit dem Owner veröffentlichen, der zum Namensraum passt. Für Plugin-Pakete
...
- Lokale Bearbeitungen behalten und das Update überspringen.
...
- Prüfen Sie die Paketdetailseite auf Prüfstatus und Kompatibilitätsmetadaten.
