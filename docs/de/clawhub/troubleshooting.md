...
- Prüfen Sie den exakten Slug oder die Owner-Seite, falls Sie diese kennen.
...
## Veröffentlichen schlägt wegen eines GitHub-Owners oder Quellfehlers fehl
...
Wenn eine Veröffentlichung fehlschlägt, weil der Owner-Handle, Org-Namespace, Paket-Scope, Skill-
...
Scoped-Namen wie `@example-org/example-plugin` als passender `example-org`-Owner veröffentlicht werden.
...
Die lokalen Dateien stimmen mit keiner Version überein, die ClawHub bekannt ist. Wählen Sie eine Option:
...
- Prüfen Sie die Paketdetailseite auf Scanstatus und Kompatibilitätsmetadaten.
