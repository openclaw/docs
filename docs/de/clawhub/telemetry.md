...
summary: Installationstelemetrie, erfasst über `clawhub sync` + Abmeldung.
x-i18n:
...
- Sie in der CLI **angemeldet** sind (für Sync-/Publish-Flows verlangen wir ohnehin Authentifizierung).
...
- Keine Dateiinhalte.
- Keine Logs einzelner Läufe, Prompts oder sonstige CLI-Ausgaben.
