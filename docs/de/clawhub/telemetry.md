...
summary: Installations-Telemetrie, die von der ClawHub CLI erfasst wird, und wie Sie die Erfassung deaktivieren können.
x-i18n:
    generated_at: "2026-07-01T20:17:03Z"
    model: gpt-5.5
...
- `slug`: den Slug des installierten Skill.
