---
read_when:
    - Arbeite an Telemetrie-/Datenschutzsteuerungen
    - Fragen dazu, welche Daten erfasst werden
summary: Von der ClawHub-CLI erfasste Installationstelemetrie und wie Sie diese deaktivieren können.
x-i18n:
    generated_at: "2026-07-03T23:30:04Z"
    model: gpt-5.5
...
- Keine Dateiinhalte.
- Keine laufbezogenen Logs, Prompts oder andere CLI-Ausgaben.
