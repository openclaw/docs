...
summary: Installations-Telemetrie, die von der ClawHub CLI erfasst wird, und wie Sie sie deaktivieren können.
x-i18n:
    generated_at: "2026-07-02T00:49:33Z"
    model: gpt-5.5
...
- Keine Dateiinhalte.
- Keine Logs, Prompts oder sonstigen CLI-Ausgaben pro Lauf.
