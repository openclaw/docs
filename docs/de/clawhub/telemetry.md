...
summary: Vom ClawHub-CLI erfasste Installations-Telemetrie und wie Sie sie deaktivieren.
x-i18n:
    generated_at: "2026-07-02T17:35:36Z"
    model: gpt-5.5
...
- Telemetrie **nicht deaktiviert** ist (siehe unten „So deaktivieren Sie sie“).
...
Wenn diese Variable gesetzt ist, sendet die CLI keine Installations-Telemetrie.
