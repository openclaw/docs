...
summary: Installations-Telemetrie, die über `clawhub sync` + Abmeldung erfasst wird.
x-i18n:
...
- `skillId` (per Slug aufgelöst; nur Skills, die in der Registry vorhanden sind, werden erfasst).
...
- Keine Dateiinhalte.
- Keine Laufprotokolle, Prompts oder andere CLI-Ausgaben.
