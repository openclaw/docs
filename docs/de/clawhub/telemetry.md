...
summary: Installations-Telemetrie, die von der ClawHub-CLI erfasst wird, und wie Sie sich davon abmelden.
x-i18n:
    generated_at: "2026-07-02T14:02:06Z"
    model: gpt-5.5
...
- Keine Dateiinhalte.
- Keine Protokolle pro Ausführung, Prompts oder sonstige CLI-Ausgaben.
...
## Transparenz und Benutzersteuerung
