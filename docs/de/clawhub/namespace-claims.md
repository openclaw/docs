...
summary: So fordern Sie eine ClawHub-Prüfung bei Streitfällen zur Inhaberschaft von Organisation, Marke, Owner-Handle, Paket-Scope, Skill-Slug oder Namespace an.
title: Organisations- und Namespace-Ansprüche
x-i18n:
    generated_at: "2026-06-30T13:57:41Z"
    model: gpt-5.5
...
Verwenden Sie diesen Weg für öffentliche, nicht vertrauliche Eigentumsprüfungen. Verwenden Sie keine produktinternen
...
- ein Marken-, Warenzeichen-, Projektumbenennungs- oder Pakethistorienstreit
...
befolgen Sie auch die entsprechende Moderations- oder Sicherheitsanleitung. Das Formular für Namespace-Ansprüche
...
das Eigentum übertragen, eine Ressource umbenennen, einen bestehenden Eintrag ausblenden oder unter Quarantäne stellen,
