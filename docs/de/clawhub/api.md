...
- Cachen Sie Antworten und respektieren Sie `429`, `Retry-After` und Rate-Limit-Header, anstatt aggressiv zu pollen.
- Verlinken Sie bei der Anzeige von Einträgen auf die kanonische ClawHub-Skill-URL, damit Benutzer den ursprünglichen Registry-Eintrag prüfen können.
