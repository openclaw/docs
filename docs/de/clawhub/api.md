...
x-i18n:
    generated_at: "2026-07-05T05:00:17Z"
    model: gpt-5.5
...
- `X-RateLimit-Remaining` / `RateLimit-Remaining`: exakt verbleibendes Budget, wenn
  vorhanden; erfolgreich geshardete Anfragen lassen es weg, statt einen ungefähren
...
- Andernfalls verwenden Sie `RateLimit-Reset` oder leiten die Verzögerung aus `X-RateLimit-Reset` ab.
