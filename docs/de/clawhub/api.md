...
- Speichern Sie Antworten zwischen und beachten Sie `429`, `Retry-After` und Rate-Limit-Header, statt aggressiv abzufragen.
...
- `X-RateLimit-Reset`: Unix-Epochenzeit in Sekunden (absolute Reset-Zeit)
