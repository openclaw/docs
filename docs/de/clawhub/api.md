...
x-i18n:
    generated_at: "2026-07-01T18:09:58Z"
    model: gpt-5.5
...
- Erwecken Sie nicht den Eindruck, dass ClawHub die Drittanbieter-Website befürwortet, verifiziert oder betreibt.
...
- Andernfalls verwenden Sie `RateLimit-Reset` oder leiten Sie die Verzögerung aus `X-RateLimit-Reset` ab.
- Fügen Sie Wiederholungsversuchen Jitter hinzu.

## Fehler

- v1-Fehler sind Plain Text (`text/plain; charset=utf-8`), einschließlich `400`,
...
- `GET /api/v1/download?slug=&version=&tag=`
  ...
  - Aktuelle GitHub-gestützte Skills mit einem `clean`- oder `suspicious`-Scan geben
    statt ClawHub-Bytes einen JSON-`public-github`-Handoff-Deskriptor zurück.
...
- `POST /api/v1/users/reserve` reserviert Root-Slugs und private Paket-Platzhalter ohne Release für ein Owner-Handle.
