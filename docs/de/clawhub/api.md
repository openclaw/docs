...
summary: 'Öffentliche REST-API (v1): Übersicht und Konventionen.'
x-i18n:
...
- Cachen Sie Antworten und beachten Sie `429`, `Retry-After` und Ratenlimit-Header, anstatt aggressiv abzufragen.
- Verlinken Sie beim Anzeigen von Einträgen auf die kanonische ClawHub-Skill-URL, damit Benutzer den ursprünglichen Registry-Eintrag prüfen können.
