...
- Verlinken Sie beim Anzeigen von Einträgen auf die kanonische ClawHub-Skill-URL, damit Benutzer den Quelleintrag im Registry prüfen können.
...
- Spiegeln Sie keine verborgenen, privaten oder durch Moderation gesperrten Inhalte, indem Sie öffentliche API-Filter oder Authentifizierungsgrenzen umgehen.
