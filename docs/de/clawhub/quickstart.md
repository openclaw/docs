...
zum Anmelden, Veröffentlichen, Verwalten Ihrer eigenen Einträge oder für
Registry-spezifische Workflows.
...
Prüfen Sie vor der Veröffentlichung die Metadaten in `SKILL.md`. Geben Sie erforderliche
Umgebungsvariablen, Tools und Berechtigungen an, damit Benutzer verstehen können, was der
...
Moderation zurückgehalten oder blockiert werden, können aus Such- und Installationsoberflächen ausgeblendet bleiben, bis das Problem behoben ist.
