...
x-i18n:
    generated_at: "2026-07-02T00:50:32Z"
    model: gpt-5.5
...
OpenClaw zeichnet auf, woher der Skill stammt, damit spätere Aktualisierungen weiterhin über ClawHub
...
Moderation zurückgehalten oder blockiert werden, können aus Such- und Installationsoberflächen ausgeblendet werden, bis sie geklärt sind.
