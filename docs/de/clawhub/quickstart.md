...
Ein von ClawHub gehostetes Plugin mit expliziter ClawHub-Quelle installieren:
...
Quellenangaben und des Upload-Plans zu erhalten, ohne zu veröffentlichen.
...
Moderation zurückgehalten oder blockiert werden, können aus Such- und Installationsoberflächen ausgeblendet sein, bis dies geklärt ist.
