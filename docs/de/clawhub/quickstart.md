...
x-i18n:
    generated_at: "2026-05-12T23:29:26Z"
    model: gpt-5.5
    provider: openai
...
Moderation zurückgehalten oder blockiert werden, können von Such- und Installationsoberflächen ausgeblendet sein, bis das Problem behoben ist.
