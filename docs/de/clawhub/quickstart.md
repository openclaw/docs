...
x-i18n:
    generated_at: "2026-07-01T05:38:00Z"
    model: gpt-5.5
...
Quellenangaben und den Upload-Plan vorab anzuzeigen, ohne zu veröffentlichen.
...
Metadaten, Quelllinks, Versionen, Changelogs und den Scanstatus zu prüfen:
