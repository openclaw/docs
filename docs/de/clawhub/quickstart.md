...
x-i18n:
    generated_at: "2026-07-02T22:27:20Z"
    model: gpt-5.5
...
Quellzuordnung und des Upload-Plans anzuzeigen, ohne zu veröffentlichen.
...
Öffentliche Einträge zeigen den neuesten Scan-Status. Releases, die durch Moderation zurückgehalten oder blockiert
werden, können in Such- und Installationsoberflächen ausgeblendet sein, bis dies behoben ist.
