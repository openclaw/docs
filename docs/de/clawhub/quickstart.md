...
summary: 'Beginnen Sie mit ClawHub: Finden, installieren, aktualisieren und veröffentlichen Sie Skills oder Plugins.'
x-i18n:
...
Quellenzuordnung und den Upload-Plan vorab zu prüfen, ohne zu veröffentlichen.
...
aggregierte Installationszahlen senden. Siehe [Telemetry](/de/clawhub/telemetry), um zu erfahren, was gemeldet wird
und wie Sie sich abmelden können.

## Vor der Installation prüfen

Verwenden Sie vor der Installation die ClawHub-Webseite oder Detailbefehle der CLI, um
...
Öffentliche Einträge zeigen den neuesten Scanstatus. Releases, die durch
Moderation zurückgehalten oder blockiert werden, können in Such- und Installationsoberflächen ausgeblendet sein, bis das Problem behoben ist.
