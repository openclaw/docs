...
x-i18n:
    generated_at: "2026-07-02T08:10:23Z"
    model: gpt-5.5
...
OpenClaw zeichnet auf, woher der Skill stammt, damit spätere Updates weiterhin über
...
Quellzuordnung und den Upload-Plan vorab anzuzeigen, ohne zu veröffentlichen.
...
Öffentliche Einträge zeigen den neuesten Scan-Zustand. Releases, die durch
Moderation zurückgehalten oder blockiert werden, können in Such- und Installationsoberflächen ausgeblendet sein, bis dies geklärt ist.
