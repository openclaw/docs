...
x-i18n:
    generated_at: "2026-07-03T17:18:30Z"
    model: gpt-5.5
...
Veröffentlichen Sie ein Plugin aus einem lokalen Ordner, einem GitHub-Repo, einer GitHub-Referenz oder einem
vorhandenen Archiv:
...
Öffentliche Einträge zeigen den neuesten Scanstatus. Releases, die von
Moderation zurückgehalten oder blockiert werden, können bis zur Klärung in Such- und Installationsoberflächen verborgen sein.
