...
x-i18n:
    generated_at: "2026-07-03T13:21:57Z"
    model: gpt-5.5
...
Der Befehl überspringt unveränderte Inhalte. Neue Skills starten bei `1.0.0`; spätere Änderungen
...
Umgebungsvariablen, Tools und Berechtigungen, damit Nutzer verstehen können, was der
...
Moderation zurückgehalten oder blockiert werden, können bis zur Klärung aus Such- und Installationsoberflächen ausgeblendet sein.
