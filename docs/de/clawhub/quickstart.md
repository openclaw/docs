...
summary: 'Beginnen Sie mit der Nutzung von ClawHub: Suchen, installieren, aktualisieren und veröffentlichen Sie Skills oder Plugins.'
x-i18n:
    generated_at: "2026-07-04T15:14:21Z"
    model: gpt-5.5
...
OpenClaw zeichnet auf, woher der Skill stammt, sodass spätere Aktualisierungen weiterhin
...
Bei Repositorys, die mehrere Skills enthalten, ruft der wiederverwendbare GitHub-Workflow
...
Quellenangaben und den Upload-Plan vor der Veröffentlichung in der Vorschau zu prüfen.
...
Verwenden Sie vor der Installation die ClawHub-Webseite oder die CLI-Detailbefehle, um
...
Moderation zurückgehalten oder blockiert werden, können in Such- und Installationsoberflächen verborgen bleiben, bis sie geklärt sind.
