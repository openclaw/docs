...
read_when:
    ...
    - Installieren einer Skill oder eines Plugins aus der Registry
...
x-i18n:
    generated_at: "2026-07-04T03:42:24Z"
    model: gpt-5.5
...
Verwenden Sie zuerst `--dry-run`, um eine Vorschau auf die aufgelösten Paketmetadaten, Kompatibilitätsfelder,
Quellenzuordnung und den Upload-Plan zu erhalten, ohne zu veröffentlichen.
...
Moderation zurückgehalten oder blockiert werden, können in Such- und Installationsoberflächen ausgeblendet sein, bis dies behoben ist.
