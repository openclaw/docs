...
summary: 'Beginnen Sie mit der Nutzung von ClawHub: Skills oder Plugins finden, installieren, aktualisieren und veröffentlichen.'
x-i18n:
    generated_at: "2026-07-04T17:53:24Z"
    model: gpt-5.5
...
Für Repositorys, die mehrere Skills enthalten, ruft der wiederverwendbare GitHub-Workflow
...
Veröffentlichen Sie ein Plugin aus einem lokalen Ordner, einem GitHub-Repo, einem GitHub-Ref oder einem
vorhandenen Archiv:
...
Metadaten, Quelllinks, Versionen, Changelogs und den Scan-Status zu prüfen:
...
Öffentliche Einträge zeigen den neuesten Scan-Status. Releases, die von
der Moderation zurückgehalten oder blockiert werden, können bis zur Klärung in Such- und Installationsoberflächen ausgeblendet sein.
