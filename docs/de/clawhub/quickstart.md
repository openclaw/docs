...
read_when:
    ...
    - Skill oder Plugin aus der Registry installieren
...
x-i18n:
    generated_at: "2026-07-04T06:26:43Z"
    model: gpt-5.5
...
Quellenzuordnung und den Upload-Plan als Vorschau anzuzeigen, ohne zu veröffentlichen.
...
Moderation zurückgehalten oder blockiert werden, können in Such- und Installationsoberflächen ausgeblendet sein, bis sie geklärt sind.
