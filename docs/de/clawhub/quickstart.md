---
read_when:
    - OpenClaw zum ersten Mal verwenden
...
Metadaten, Quelllinks, Versionen, Änderungsprotokolle und Scanstatus zu prüfen:
...
Moderation zurückgehalten oder blockiert werden, können aus Such- und Installationsoberflächen ausgeblendet sein, bis dies behoben ist.
