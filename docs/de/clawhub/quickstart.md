...
x-i18n:
    generated_at: "2026-07-12T21:34:33Z"
    model: gpt-5.6
...
`skill publish` für jeden direkt unter `skills/` liegenden Skill-Ordner auf:
...
Quellenangabe und des Upload-Plans anzuzeigen, ohne zu veröffentlichen.
...
Öffentliche Einträge zeigen den neuesten Scanstatus. Releases, die durch die
Moderation zurückgehalten oder blockiert werden, können bis zur Klärung aus den Such- und Installationsoberflächen ausgeblendet sein.
