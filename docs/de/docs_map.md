...
x-i18n:
    generated_at: "2026-07-03T09:28:39Z"
    model: gpt-5.5
...
- Route: /automation
- Überschriften:
  - H2: Schneller Entscheidungsleitfaden
...
- Überschriften:
  ...
  - H3: Alle Gruppen erlauben, @Erwähnung weiterhin erforderlich
...
- Überschriften:
  ...
  - H3: Unterschiedliche Tools pro Absender (Besitzer erhält mehr Macht)
  - H2: NickServ
...
- Überschriften:
  ...
  - H2: Beispiel-Teams-Manifest (redigiert)
  ...
  - H3: Speicherort gespeicherter Dateien
...
- Überschriften:
  ...
  - H3: Nachrichtenlimits
  - H3: Streaming
  - H3: Verlaufskontext von Gruppenchats
  - H3: Reply-to-Modus
...
- Überschriften:
  ...
  - H3: 2) Token konfigurieren (Env oder Konfiguration)
...
- Überschriften:
  ...
  - H2: Mehrere Konten
  - H2: Umgebungsvariablen
  - H2: Eingabeanzeige, Reaktionen und Zustellbestätigungen
  - H2: Fehlerbehebung
  - H2: Verwandt
...
- Überschriften:
  ...
  - H2: Beispiel für „Never prompt“ / YOLO
  - H2: Allowlist-Helfer
  - H2: Häufige Optionen
  - H2: Hinweise
  - H2: Verwandt
...
- Überschriften:
  ...
  - H2: Paperclip-/openclawgateway-Erststart-Genehmigung
...
- Überschriften:
  ...
  - H3: Archiv- und Manuell-prüfen-Status
  - H2: Codex-Provider
  - H3: Was Codex importiert
  - H3: Manuell-prüfen-Codex-Status
  - H2: Hermes-Provider
...
- Überschriften:
  ...
  - H3: 2. Delegation des Identity Providers konfigurieren
  - H4: Microsoft 365
  - H4: Google Workspace
...
- Überschriften:
  ...
  - H3: Phase 3: Eingehende Kanalbrücke
  - H3: Phase 4: Vorbereitete Dispatcher-Brücke
  - H3: Phase 5: Einheitlicher Live-Lifecycle
...
- Überschriften:
  ...
  - H2: Kanalzuständigkeit für Runs
...
- Überschriften:
  ...
  - H2: DM-Isolation
  - H3: Verknüpfte Dock-Kanäle
  - H2: Sitzungslebenszyklus
  - H2: Wo der Zustand gespeichert ist
  - H2: Sitzungswartung
  - H2: Sitzungen prüfen
  - H2: Weiterführende Informationen
  - H2: Verwandt
...
- Überschriften:
  ...
  - H2: Standardmodus für Nutzungsfußzeile
...
- Überschriften:
  ...
  - H2: Tool-Payloads + Connectors (Rohzeit des Providers + normalisierte Felder)
  - H2: Verwandte Dokumentation
...
- Überschriften:
  ...
  - H2: Obergrenze für History-Reseed
  - H2: Einschränkungen
  - H2: Fehlerbehebung
  - H2: Verwandt
...
- Überschriften:
  ...
  - H3: Mention-Gating im Gruppenchat
...
- Überschriften:
  ...
  - H2: Secrets
  - H3: SecretRef
  - H3: Unterstützte Anmeldeinformations-Oberfläche
...
- Überschriften:
  ...
  - H3: Reload-Modi
  - H3: Was per Hot Apply übernommen wird und was einen Neustart erfordert
  - H3: Reload-Planung
  - H2: Konfigurations-RPC (programmgesteuerte Updates)
  - H2: Umgebungsvariablen
...
- Überschriften:
  ...
  - H3: Hybrid-Konfiguration: gehosteter Primärdienst, lokaler Fallback
...
- Überschriften:
  - H2: Am besten empfohlenes Setup
...
- Überschriften:
  ...
  - H2: Elemente (Eingabe)
  - H3: message
  - H3: functioncalloutput (turnbasierte Tools)
...
- Überschriften:
  ...
  - H2: Automatische Genehmigung für Geräte aus vertrauenswürdigen CIDR-Bereichen
...
- Überschriften:
  ...
  - H2: Präsenz
  - H3: Node-Hintergrundereignis „alive“
  ...
  - H3: Diagnose der Geräte-Auth-Migration
  - H2: TLS + Pinning
  - H2: Scope
  - H2: Verwandte Themen
...
- Überschriften:
  ...
  - H3: Abhängigkeitssperre des veröffentlichten Pakets
  ...
  - H2: Schnellregel für gemeinsamen Posteingang
  ...
  - H3: Gruppen: Erwähnung überall verlangen
  ...
  - H3: Schutzschiene für Sub-Agent-Delegation
  - H2: Risiken der Browsersteuerung
  - H3: Browser-SSRF-Richtlinie (standardmäßig streng)
  ...
  - H3: Eindämmen
  - H3: Rotieren (Kompromittierung annehmen, wenn Secrets geleakt sind)
  - H3: Audit
...
- Überschriften:
  - H2: Befehlsleiter
  - H2: Nach einem Update
  - H2: Split-Brain-Installationen und Schutz bei neuerer Konfiguration
  ...
  - H2: macOS-Gateway reagiert still nicht mehr und nimmt wieder auf, wenn Sie das Dashboard berühren
...
- Überschriften:
  ...
  - H2: Live: Model-Smoke (Profilschlüssel)
  ...
  - H2: Live: Smoke für Codex-App-Server-Harness
  - H3: Empfohlene Live-Rezepte
  - H2: Live: Modellmatrix (was wir abdecken)
  - H3: Modernes Smoke-Set (Tool-Aufruf + Bild)
...
- Überschriften:
  ...
  - H2: Vertragstests (Plugin- und Kanalstruktur)
  - H3: Befehle
  - H3: Kanalverträge
...
- Überschriften:
  - H2: Kanäle wechseln
  - H2: Einmaliges Ziel für Version oder Tag
  - H2: Testlauf
...
- Überschriften:
  ...
  - H2: Einrichtung des Remote-Kanals
  - H2: Remote-Zugriff
  - H2: Aktualisieren
  - H2: Verwandte Themen
...
- Überschriften:
  ...
  - H3: Log-Level
  - H3: Gezielte Diagnose für Modelltransport
...
- Überschriften:
  - H2: Kopplung + Status
  - H2: Remote-Knotenhost (system.run)
  - H3: Was wo ausgeführt wird
  - H3: Knotenhost starten (Vordergrund)
  - H3: Remote-Gateway über SSH-Tunnel (Loopback-Bindung)
  - H3: Knotenhost starten (Dienst)
  - H3: Koppeln + benennen
  - H3: Befehle auf die Allowlist setzen
  - H3: Exec auf den Knoten ausrichten
  ...
  - H3: A2UI (Canvas)
  - H2: Fotos + Videos (Knotenkamera)
  - H2: Bildschirmaufzeichnungen (Knoten)
  - H2: Standort (Knoten)
  - H2: SMS (Android-Knoten)
  - H2: Android-Geräte- + personenbezogene Datenbefehle
  - H2: Systembefehle (Knotenhost / Mac-Knoten)
  - H2: Exec-Knotenbindung
  - H2: Berechtigungszuordnung
  - H2: Headless-Knotenhost (plattformübergreifend)
  - H2: Mac-Knotenmodus
...
- Überschriften:
  ...
  - H2: Support-Matrix der Provider (OpenClaw-Integrationen)
...
- Überschriften:
  ...
  - H2: Kopplung gegenüber Genehmigungen
  - H2: Häufige Knotenfehlercodes
...
- Überschriften:
  ...
  - H2: Manuelle Tests
  - H2: Zurücksetzen auf sauberen Zustand
  - H2: Referenzen
  - H2: Verwandt
...
- Überschriften:
  ...
  - H2: Testplan
  - H3: Unit-Tests
  - H3: Vorhandene Tests zum Aktualisieren
...
- Überschriften:
  ...
  - H3: 5) Prüfen, ob der Knoten verbunden ist
  - H3: 6) Chat + Verlauf
  - H3: 7) Canvas + Kamera
...
- Überschriften:
  ...
  - H3: Gateway zeigt dauerhaft „Wird gestartet ...“
  - H2: Verwandte Themen
...
- Überschriften:
  ...
  - H2: Wiederherstellungscheckliste, wenn Aufforderungen verschwinden
  - H2: Berechtigungen für Dateien und Ordner (Schreibtisch/Dokumente/Downloads)
  - H2: Verwandte Themen
...
- Überschriften:
  - H1: Sprachaktivierung und Push-to-Talk
  - H2: Anforderungen
  - H2: Modi
  - H2: Laufzeitverhalten (Wake-Word)
  - H2: Lebenszyklus-Invarianten
  - H2: Fehlermodus bei hängenbleibendem Overlay (vorher)
  - H2: Besonderheiten von Push-to-Talk
  - H2: Benutzersichtbare Einstellungen
...
- Überschriften:
  ...
  - H2: Dateicheckliste
  - H2: Durchgearbeitetes Beispiel: Bildgenerierung
...
- Überschriften:
  ...
  - H2: Modell zur Capability-Zuständigkeit
...
- Überschriften:
  ...
  - H2: Authentifizierung und Umgebungsisolation
  - H2: Dynamische Tools
...
- Überschriften:
  ...
  - H3: Deployment mit gemischten Providern
...
- Überschriften:
  ...
  - H3: Flache Aliase für WhatsApp-Inbound-Callbacks
...
- Überschriften:
  ...
  - H3: Besprechungserstellung schlägt fehl
  - H3: Agent tritt bei, spricht aber nicht
  - H3: Twilio-Einrichtungsprüfungen schlagen fehl
  - H3: Twilio-Anruf startet, tritt der Besprechung aber nie bei
  - H2: Hinweise
  - H2: Verwandte Themen
...
- Überschriften:
  ...
  - H3: Sitzungserweiterungen und Einfügungen für den nächsten Turn
  - H2: Nachrichten-Hooks
  - H2: Hooks installieren
  - H2: Gateway-Lebenszyklus
  - H2: Anstehende Einstellungen
  - H2: Verwandte Themen
...
- Überschriften:
  - H2: Was es hinzufügt
  - H2: Wie es mit Memory zusammenspielt
  ...
  - H2: Strukturierte Claims und Nachweise
...
- Überschriften:
  ...
  - H3: Seiteneffekte am Agentenende
...
- Überschriften:
  - H2: Was sich ändert
  - H2: Warum sich das geändert hat
...
- Überschriften:
  ...
  - H2: Vertragstests (In-Repo-Plugins)
...
- Überschriften:
  ...
  - H2: Konfiguration
  - H2: Fehlerbehebung
  - H3: Der Tab sagt, Workboard ist nicht verfügbar
...
- Überschriften:
  - H2: Einrichtung
  - H2: Standardeinstellungen
  - H2: Wodurch sich dies von Qwen unterscheidet
...
- Überschriften:
  ...
  - H3: Regeln zur Umfangsserialisierung
  - H3: Prompts
  - H3: Bereinigung
  - H3: Test-Checkliste
  - H2: Ausgabe-API
...
- Überschriften:
  ...
  - H2: Muster B: stdio-Child-Prozess (imsg)
...
- Überschriften:
  ...
  - H3: Kontinuität von Sitzung, Memory und Vertrauen
...
- Überschriften:
  ...
  - H4: T-RECON-002: Prüfung der Channel-Integration
  ...
  - H4: T-EXFIL-003: Erbeuten von Anmeldedaten
...
- Überschriften:
  ...
  - H2: CLI-Onboarding
  - H2: Onboarding in der macOS-App
...
- Überschriften:
  ...
  - H2: Voraussetzungen
  - H2: Einrichtung mit zwei Smartphones (empfohlen)
...
- Überschriften:
  ...
  - H2: Das Gateway aus diesem Repo ausführen
  ...
  - H3: 2) Die macOS-App auf Ihr laufendes Gateway verweisen lassen
  - H3: 3) Überprüfen
  - H3: Häufige Stolperfallen
  - H2: Zuordnung der Speicherung von Anmeldedaten
...
- Überschriften:
  ...
  - H3: Schicht 5: Browsersteuerung durchgängig prüfen
...
- Überschriften:
  ...
  - H2: Node-Browser-Proxy (Standard ohne Konfiguration)
...
- Überschriften:
  ...
  - H3: Dauerhafte Gateway-Host-Einrichtung mit "never prompt"
  - H3: Lokale Abkürzung
  - H3: Node-Host
...
- Überschriften:
  ...
  - H2: Beispiele für Tool-Beschränkungen
...
- Überschriften:
  ...
  - H3: Fallback-Modus für Extraktion
  - H2: Konfiguration
  - H2: Ausgabedetails
  - H2: Fehlerverhalten
  - H2: Beispiele
...
- Überschriften:
  - H2: Ladereihenfolge
  - H2: Agent-spezifische vs. gemeinsam genutzte Skills
...
- Überschriften:
  ...
  - H2: Tool-Richtlinie
  - H3: Überschreiben über Konfiguration
  - H2: Nebenläufigkeit
...
- Überschriften:
  ...
  - H2: Administratorzugriff zuerst härten
  ...
  - H3: systemd-Abstimmungsliste (optional)
  - H2: Verwandt
...
- Überschriften:
  ...
  - H2: Medienrouten-Authentifizierung für den Assistant
  - H2: UI erstellen
  - H2: Leere Control-UI-Seite
  - H2: Debugging/Tests: Entwicklungsserver + Remote-Gateway
  - H2: Verwandt
...
- Überschriften:
  - H2: Webhooks
  - H2: Admin-HTTP-RPC
  - H2: Konfiguration (standardmäßig aktiv)
