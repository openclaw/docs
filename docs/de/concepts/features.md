...
summary: OpenClaw-Funktionen für Kanäle, Routing, Medien und Benutzererlebnis.
title: Funktionen
x-i18n:
    generated_at: "2026-07-12T01:32:10Z"
    model: gpt-5.6
...
<Columns>
  ...
  <Card title="Mobile Nodes" icon="smartphone" href="/de/nodes">
    iOS- und Android-Nodes mit Kopplung, Sprach- und Chatfunktionen sowie umfangreichen Gerätebefehlen.
  </Card>
</Columns>
...
- Externe Plugin-Kanäle, die außerhalb des OpenClaw-Repositorys gepflegt werden: WeChat, Yuanbao und Zalo ClawBot
- Unterstützung für Gruppenchats mit erwähnungsbasierter Aktivierung
- Sicherheit für Direktnachrichten durch Positivlisten und Kopplung
...
- Unterstützung für benutzerdefinierte und selbst gehostete Provider (vLLM, SGLang, Ollama, llama.cpp, LM Studio und
  beliebige OpenAI- oder Anthropic-kompatible Endpunkte)
...
- iOS-Node mit Kopplung, Canvas, Kamera, Bildschirmaufnahme, Standort und Sprachfunktionen
- Android-Node mit Kopplung, Chat, Sprachfunktionen, Canvas, Kamera und Gerätebefehlen
...
<CardGroup cols={2}>
  <Card title="Experimentelle Funktionen" href="/de/concepts/experimental-features" icon="flask">
    Optional aktivierbare Funktionen, die noch nicht standardmäßig verfügbar sind.
  </Card>
  <Card title="Agent-Laufzeit" href="/de/concepts/agent" icon="robot">
    Laufzeitmodell des Agenten und Verteilung der Ausführungen.
  </Card>
