...
Von der Community entwickelte OpenClaw-Projekte: PR-Review-Schleifen, mobile Apps, Heimautomatisierung, Sprachsysteme, Entwicklerwerkzeuge und Memory-Workflows, chat-nativ für Telegram, WhatsApp, Discord und Terminals entwickelt.
...
Aktuelle Highlights aus den Bereichen Programmierung, Entwicklerwerkzeuge, mobile Anwendungen und chat-native Produktentwicklung.
...
Sagen Sie Ihrem Agenten „Stelle dieses HTML bereit“, und Sie erhalten nach etwa einer Sekunde eine öffentliche URL. Seiten laufen nach einer Stunde automatisch ab – kein Server, keine Konfiguration, keine Registrierung.
</Card>
...
Fügen Sie eine beliebige URL ein und erhalten Sie eine Bewertung. Mehr als 2,5 Mio. Betrugsdomains aus 38 Feeds (PhishTank, OpenPhish, CERT.PL und weitere) werden lokal abgeglichen, sodass der Browserverlauf den Rechner nie verlässt.
</Card>

<Card title="Skills für Überlegungen zum Produktdesign" icon="pen-ruler" href="https://clawhub.ai/monikazapisekstudio/skills/socratic-dialog">
  **@monikazapisekstudio** • `product` `reasoning` `skills`

Ein Trio für die Produktarbeit: [Sokratischer Dialog](https://clawhub.ai/monikazapisekstudio/skills/socratic-dialog) hinterfragt eine Frage vor der Beantwortung kritisch, [Kano-Modell-Stratege](https://clawhub.ai/monikazapisekstudio/skills/kano-model-strategist) ordnet Funktionen danach, welche ihren Platz verdienen, und [Verständliche Agentenausgabe](https://clawhub.ai/monikazapisekstudio/skills/legible-agent-output) formuliert Agentenausgaben in verständliche Sprache um.
</Card>

<Card title="Postfach-Broker für Unteragenten" icon="inbox" href="https://clawhub.ai/albzhu/skills/miab-broker">
  **@albzhu** • `multi-agent` `async` `skill`

Verhindert, dass Orchestratoren untätig warten, während Unteragenten arbeiten: ein asynchroner Callback-Mechanismus, bei dem Ergebnisse in einem Postfach landen, statt den übergeordneten Agenten zu blockieren.
</Card>
...
Token-Kostenverfolgung von einem NVIDIA-Ingenieur mit erstklassiger OpenClaw-Unterstützung: Sehen Sie für jedes Modell und jede Sitzung genau, wofür die Ausgaben Ihres Agenten anfallen.
</Card>
...
Ließ OpenClaw sein eigenes Abfragewerkzeug für Google Analytics erstellen, verpackte es anschließend und veröffentlichte es auf ClawHub.
</Card>

<Card title="ClawEval-Modellrangliste" icon="ranking-star" href="https://github.com/AIgenteur/ClawEval">
  **@AIgenteur** • `evals` `models` `devtools`

Vergleicht Modelle anhand von 59 Agentenrollen, um die Frage „Welches LLM eignet sich für meine GPU?“ zu beantworten. Ein Favorit der Community für die Auswahl lokaler Modelle.
</Card>

<Card title="Music Craft" icon="music" href="https://clawhub.ai/luischarro/music-craft">
  **@luischarro** • `music` `generation` `skill`

Provider-unabhängige Songgenerierung: Planen Sie den Titel, strukturieren Sie den Liedtext und überarbeiten Sie dürftige Ergebnisse, statt sich auf einen einzigen Prompt zu verlassen. Enthält eine [MiniMax-Variante](https://clawhub.ai/luischarro/music-craft-minimax) mit Steuerung von BPM, Tonart, Struktur und Mashups.
</Card>
...
OpenCode schließt die Änderung ab und öffnet einen PR. OpenClaw prüft den Diff und antwortet in Telegram mit Vorschlägen sowie einer eindeutigen Merge-Empfehlung.
...
Bat „Robby“ (@openclaw) um einen lokalen Weinkeller-Skill. Dieser fordert einen beispielhaften CSV-Export und einen Speicherpfad an und erstellt und testet anschließend den Skill (im Beispiel mit 962 Flaschen).
...
Wählen Sie per Tastenkürzel einen Bildschirmbereich aus, lassen Sie ihn von Gemini Vision verarbeiten und erhalten Sie sofort Markdown in Ihrer Zwischenablage.
  ...
  <img src="/assets/showcase/snag.png" alt="SNAG-Werkzeug zur Umwandlung von Screenshots in Markdown" />
</Card>
...
Umschließt die TTS-Funktion von papla.media und sendet die Ergebnisse als Telegram-Sprachnachrichten (ohne störende automatische Wiedergabe).
...
<Card title="Wiener Verkehrsmittel (Wiener Linien)" icon="train" href="https://clawhub.ai/hjanuschka/skills/wienerlinien">
  **@hjanuschka** • `travel` `transport` `skill`

Abfahrten in Echtzeit, Störungen, Aufzugstatus und Routenplanung für den öffentlichen Nahverkehr in Wien.
...
Erstellte vollständig über einen Telegram-Chat eine komplette iOS-App mit Karten und Sprachaufzeichnung und bereitete sie für die Veröffentlichung im App Store vor.
</Card>

<Card title="Gesundheitsassistent für den Oura Ring" icon="heart-pulse">
  **@AS** • `health` `oura` `calendar`

Persönlicher KI-Gesundheitsassistent, der Daten des Oura Ring mit Kalender, Terminen und Trainingsplan integriert.
...
14+ Agenten unter einem Gateway, wobei ein Opus-4.5-Orchestrator Aufgaben an Codex-Arbeiter delegiert. Informationen zum Agenten-Sandboxing finden Sie in der [technischen Beschreibung](https://github.com/adam91holt/orchestrated-ai-articles) und in [Clawdspace](https://github.com/adam91holt/clawdspace).
</Card>

<Card title="Linear CLI" icon="terminal" href="https://github.com/Finesssee/linear-cli">
  **@NessZerra** • `devtools` `linear` `cli`

CLI für Linear, die sich in agentenbasierte Workflows integriert (Claude Code, OpenClaw). Verwalten Sie Issues, Projekte und Workflows über das Terminal.
</Card>

<Card title="Beeper CLI" icon="message" href="https://github.com/blqke/beepcli">
  **@jules** • `messaging` `beeper` `cli`

Lesen, senden und archivieren Sie Nachrichten über Beeper Desktop. Verwendet die lokale MCP-API von Beeper, damit Agenten alle Ihre Chats (iMessage, WhatsApp und weitere) zentral verwalten können.
</Card>
...
Zeitplanung, Browsersteuerung, Support-Schleifen und die Seite des Produkts, die Aufgaben einfach für Sie erledigt.
...
Claude Code ermittelte und bestätigte die Steuerungsfunktionen des Luftreinigers. Anschließend übernimmt OpenClaw die Regelung der Raumluftqualität.

  <img src="/assets/showcase/winix-air-purifier.jpg" alt="Steuerung eines Winix-Luftreinigers über OpenClaw" />
</Card>

<Card title="Schöne Aufnahmen des Himmels" icon="camera" href="https://x.com/signalgaining/status/2010523120604746151">
  **@signalgaining** • `automation` `camera` `skill`

Ausgelöst durch eine Dachkamera: Bitten Sie OpenClaw, immer dann ein Foto des Himmels aufzunehmen, wenn dieser schön aussieht. OpenClaw entwarf einen Skill und nahm das Foto auf.

  <img src="/assets/showcase/roof-camera-sky.jpg" alt="Von OpenClaw aufgenommener Schnappschuss des Himmels mit einer Dachkamera" />
</Card>
...
<Card title="Erfassung von Buchhaltungsunterlagen" icon="file-invoice-dollar">
  **Community** • `automation` `email` `pdf`

Sammelt PDF-Dateien aus E-Mails und bereitet Dokumente für eine Steuerberatung vor. Monatliche Buchhaltung auf Autopilot.
</Card>

<Card title="Entwicklungsmodus für Stubenhocker" icon="couch" href="https://davekiss.com">
  **@davekiss** • `telegram` `migration` `astro`

Erstellte beim Ansehen von Netflix eine komplette persönliche Website über Telegram neu – von Notion zu Astro, 18 Beiträge migriert, DNS zu Cloudflare verschoben. Öffnete dabei nie einen Laptop.
</Card>

<Card title="Agent für die Stellensuche" icon="briefcase">
  **@attol8** • `automation` `api` `skill`

Durchsucht Stellenangebote, gleicht sie mit Schlüsselwörtern aus dem Lebenslauf ab und liefert passende Möglichkeiten mit Links zurück. In 30 Minuten mithilfe der JSearch-API erstellt.
</Card>

<Card title="Jira-Skill-Builder" icon="diagram-project" href="https://x.com/jdrhyne/status/2008336434827002232">
  **@jdrhyne** • `jira` `skill` `devtools`

OpenClaw stellte eine Verbindung zu Jira her und generierte anschließend spontan einen neuen Skill (bevor dieser auf ClawHub verfügbar war).
</Card>
...
Ließ OpenClaw auf Autohändler los: Es übernahm die gesamte Verhandlung und drückte den Preis um 4.200 $.
</Card>
...
<Card title="Einreichen eines Versicherungsanspruchs" icon="file-signature" href="https://x.com/avi_press/status/2013066316467560521">
...
Überwacht einen Slack-Kanal des Unternehmens, antwortet hilfreich und leitet Benachrichtigungen an Telegram weiter. Behebbte selbstständig und ohne Aufforderung einen Produktionsfehler in einer bereitgestellten App.
</Card>
...
Systeme, die persönliches oder teaminternes Wissen indizieren, durchsuchen, speichern und auswerten.

<CardGroup cols={2}>

<Card title="Chinesisch lernen mit xuezh" icon="language" href="https://github.com/joshp123/xuezh">
...
Rief 4 Millionen Beiträge von 100 führenden X-Konten ab und wandelte sie in eine abfragbare Analyse-Pipeline um.
</Card>
...
Organisierte die Laborergebnisse jahrelanger Blutuntersuchungen in einer strukturierten Notion-Datenbank.
</Card>
...
Assistent für den täglichen Einsatz auf WhatsApp, dessen gesamtes Gedächtnis als Markdown in einem versionsverwalteten Obsidian-Vault gespeichert ist: Erfassung von Kalorien und Training, Aufgabenlisten und Verwaltung des Alltags.
</Card>
...
Ist in einem Telegram-Gruppenchat der Familie aktiv, dokumentiert Geschichten von mehr als 50 Verwandten und stellt fundierte Rückfragen – für Muttersprachler auf Nepali.
</Card>
...
Erweitert Karakeep-Lesezeichen um eine Vektorsuche mit Qdrant sowie Embeddings von OpenAI oder Ollama.
</Card>
...
<Card title="Sprachsteuerung mit einem Fingertipp auf den Pebble Ring" icon="ring" href="https://x.com/thekitze/status/2014765279650189578">
  **@thekitze** • `voice` `wearable` `hardware`

Ein Fingertipp auf einen Pebble Ring startet eine Sprachunterhaltung mit OpenClaw – Agentenzugriff über ein Wearable.
</Card>
...
<Card title="Action Button als Walkie-Talkie" icon="walkie-talkie" href="https://x.com/i/status/2072766510053888497">
  **@buddyhadry** • `voice` `ios` `mobile`

Der iPhone Action Button ist mit OpenClaw verbunden: drücken, sprechen und der Agent antwortet wie über ein Walkie-Talkie.
</Card>
...
<Card title="macOS-Menüleistenmanager" icon="desktop" href="https://x.com/MagiMetal/status/2009424267801485362">
  **@MagiMetal** • `macos` `swift` `ui`

Native Swift-App für die Menüleiste, die den Agentenstatus mit Schnellsteuerungen anzeigt.
</Card>

<Card title="Nix-Paketierung" icon="snowflake" href="https://github.com/openclaw/nix-openclaw">
  **@openclaw** • `nix` `packaging` `deployment`

Vollständig ausgestattete, nixifizierte OpenClaw-Konfiguration für reproduzierbare Bereitstellungen.
</Card>
...
<Card title="Selbst entwickelter HomePod-Skill" icon="volume-high" href="https://x.com/localghost/status/2014763987683225685">
  **@localghost** • `homepod` `discovery` `skill`

OpenClaw fand die HomePods im lokalen Netzwerk und schrieb sich selbst einen Skill zu deren Steuerung.
</Card>

<Card title="35-$-Hologrammwürfel als Benutzeroberfläche" icon="cube" href="https://x.com/andrewjiang/status/2013140793649734032">
...
Nix-native Heimautomatisierung mit OpenClaw als Benutzeroberfläche und zusätzlichen Grafana-Dashboards.
...
Projekte, die über einen einzelnen Arbeitsablauf hinaus zu umfassenderen Produkten oder Ökosystemen gewachsen sind.
...
<Steps>
  <Step title="Teilen">
    Veröffentlichen Sie es in [#self-promotion auf Discord](https://discord.gg/clawd) oder [twittern Sie an @openclaw](https://x.com/openclaw).
  </Step>
  <Step title="Details angeben">
    Beschreiben Sie, was es tut, verlinken Sie das Repository oder die Demo und teilen Sie einen Screenshot, falls Sie einen haben.
  </Step>
