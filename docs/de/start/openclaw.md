...
read_when:
    ...
    - Auswirkungen auf Sicherheit und Berechtigungen prüfen
summary: End-to-End-Anleitung zum Betrieb von OpenClaw als persönliche Assistenz mit Sicherheitshinweisen
title: Einrichtung des persönlichen Assistenten
x-i18n:
    generated_at: "2026-05-06T07:03:42Z"
    model: gpt-5.5
    provider: openai
...
- OpenClaw installiert und eingerichtet – siehe [Erste Schritte](/de/start/getting-started), falls Sie dies noch nicht getan haben
...
<Tip>
Behandeln Sie diesen Ordner wie den Speicher von OpenClaw und machen Sie daraus ein Git-Repository (idealerweise privat), damit Ihre `AGENTS.md` und Speicherdateien gesichert sind. Wenn Git installiert ist, werden ganz neue Workspaces automatisch initialisiert.
</Tip>
