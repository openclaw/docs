...
read_when:
    ...
    - Вам потрібні спільна збірка бінарного файлу, збереження стану та процес оновлення
summary: Спільні кроки середовища виконання віртуальної машини Docker для довготривалих хостів OpenClaw Gateway
...
<Note>
Наведені вище URL є прикладами. Для віртуальних машин на ARM вибирайте ресурси `arm64`. Для відтворюваних збірок закріплюйте URL версійних релізів.
</Note>
