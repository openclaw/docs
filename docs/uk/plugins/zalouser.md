---
read_when:
    - Ви хочете мати підтримку Zalo Personal (неофіційну) в OpenClaw
...
x-i18n:
    generated_at: "2026-05-06T16:11:43Z"
    model: gpt-5.5
    provider: openai
...
<Warning>
Неофіційна автоматизація може призвести до призупинення облікового запису або блокування. Використовуйте на власний ризик.
</Warning>
...
Використовуйте пакет без додаткових уточнень, щоб стежити за поточним офіційним тегом випуску. Закріплюйте точну
