...
| Код плагінів   | Пакети плагінів OpenClaw з метаданими сумісності             | `openclaw plugins install clawhub:<package>` |
| Пакети плагінів | Запаковані пакети плагінів для дистрибуції OpenClaw          | `clawhub package publish <source>`           |
| Souls          | Пакети `SOUL.md`, що відображаються на onlycrabs.ai          | Робочі процеси публікації через Web та API  |
...
ClawHub відкритий за замовчуванням: будь-хто може завантажувати, але публікація потребує облікового запису GitHub,
...
ClawHub запускає автоматизовані перевірки опублікованих Skills і релізів плагінів. Релізи, утримані скануванням
або заблоковані, можуть зникнути з публічного каталогу та поверхонь встановлення, але
...
| `CLAWHUB_CONFIG_PATH`         | Перевизначає, де CLI зберігає стан токена/конфігурації. |
