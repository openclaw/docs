...
read_when:
    ...
    - Публікація Skills або плагінів до реєстру
...
title: ClawHub
x-i18n:
    generated_at: "2026-07-03T01:03:10Z"
    model: gpt-5.5
...
Встановіть ClawHub CLI, коли вам потрібні процеси з автентифікацією в реєстрі, як-от
...
| Пакети плагінів | Упаковані набори плагінів для дистрибуції OpenClaw           | `clawhub package publish <source>`           |
...
Прості npm-сумісні специфікації плагінів можуть розв’язуватися через npm під час перехідних запусків, а
...
- `--tags <tags>`: теги, розділені комами; типове значення — `latest`.
...
обліковий запис, достатньо старий, щоб пройти шлюз завантаження. Публічні сторінки деталей узагальнюють
останній стан сканування перед встановленням або завантаженням.

ClawHub виконує автоматизовані перевірки опублікованих Skills і випусків плагінів. Випуски, утримані скануванням
