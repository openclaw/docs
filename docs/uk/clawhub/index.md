...
read_when:
    ...
    - Пошук, встановлення або оновлення Skills або Plugin
...
title: ClawHub
x-i18n:
    generated_at: "2026-07-02T08:44:12Z"
    model: gpt-5.5
...
CLI також має команди встановлення й оновлення Skills для прямих робочих процесів із реєстром:
...
затримані скануванням або заблоковані, можуть зникнути з публічного каталогу й поверхонь установлення, але
