...
read_when:
    ...
    - Публікація Skills або Plugin у реєстр
...
title: ClawHub
x-i18n:
    generated_at: "2026-07-02T22:46:25Z"
    model: gpt-5.5
...
- Використовуйте нативні команди `openclaw` для пошуку, встановлення й оновлення Skills, а також для встановлення Plugin із ClawHub.
...
Шукайте та встановлюйте Plugin за допомогою OpenClaw:
...
| Кодові Plugin  | Пакети Plugin OpenClaw із метаданими сумісності              | `openclaw plugins install clawhub:<package>` |
| Пакетні Plugin | Запаковані пакети Plugin для дистрибуції OpenClaw            | `clawhub package publish <source>`           |
...
Використовуйте `clawhub:<package>`, коли встановлення Plugin має вирішуватися через ClawHub.
...
Кодові Plugin мають містити обов’язкові метадані сумісності OpenClaw у
...
і [Формат Skill](/clawhub/skill-format) для метаданих Skill.
...
ClawHub виконує автоматизовані перевірки опублікованих Skills і релізів Plugin. Релізи, утримані скануванням
...
подію встановлення, щоб ClawHub міг обчислювати сукупні лічильники встановлень. Вимкніть це так:
