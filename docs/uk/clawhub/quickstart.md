...
Установіть Plugin, розміщений у ClawHub, з явно вказаним джерелом ClawHub:
...
агрегованих лічильників установлень. Див. [Телеметрія](/uk/clawhub/telemetry), щоб дізнатися, що повідомляється
і як відмовитися.
