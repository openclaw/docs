...
x-i18n:
    generated_at: "2026-07-04T06:48:32Z"
    model: gpt-5.5
...
Встановіть Plugin, розміщений у ClawHub, з явним джерелом ClawHub:
...
змінні середовища, інструменти та дозволи, щоб користувачі розуміли, що потрібно
Skill, перш ніж встановлювати його. Див. [Формат Skill](/uk/clawhub/skill-format).
...
Перед встановленням використайте вебсторінку ClawHub або команди CLI для перегляду деталей, щоб перевірити
