...
x-i18n:
    generated_at: "2026-07-05T08:21:25Z"
    model: gpt-5.5
...
OpenClaw записує, звідки походить skill, щоб пізніші оновлення могли й надалі
...
потрібно skill перед установленням. Див. [Формат skill](/uk/clawhub/skill-format).
...
Опублікувати plugin з локальної папки, репозиторію GitHub, GitHub ref або
наявного архіву:
...
Перед установленням використовуйте вебсторінку ClawHub або команди деталізації CLI, щоб перевірити
