...
read_when:
    ...
    - Установлення skill або plugin з реєстру
...
skill, перш ніж його встановити. Див. [Формат skill](/uk/clawhub/skill-format).
...
Спочатку використайте `--dry-run`, щоб попередньо переглянути вирішені метадані пакета, поля сумісності,
...
Перед установленням скористайтеся вебсторінкою ClawHub або командами подробиць CLI, щоб перевірити
