...
summary: 'Почніть використовувати ClawHub: знаходьте, встановлюйте, оновлюйте й публікуйте Skills або Plugin.'
x-i18n:
...
сумісності, зазначення джерела та план завантаження без публікації.
