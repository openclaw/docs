...
summary: 'Почніть використовувати ClawHub: знаходьте, встановлюйте, оновлюйте та публікуйте Skills або plugins.'
x-i18n:
    generated_at: "2026-07-03T02:55:17Z"
    model: gpt-5.5
...
Спочатку використайте `--dry-run`, щоб попередньо переглянути визначені метадані пакета, поля
