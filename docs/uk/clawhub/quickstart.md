...
summary: 'Почніть користуватися ClawHub: знаходьте, установлюйте, оновлюйте й публікуйте навички або плагіни.'
x-i18n:
...
Перед установленням використовуйте вебсторінку ClawHub або команди CLI для перегляду деталей, щоб перевірити
...
модерацією, можуть бути приховані з інтерфейсів пошуку та встановлення, доки проблему не буде розв’язано.
