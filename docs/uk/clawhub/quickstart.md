...
x-i18n:
    generated_at: "2026-07-02T22:47:34Z"
    model: gpt-5.5
...
Спершу використайте `--dry-run`, щоб попередньо переглянути розв’язані метадані пакета, поля
...
Перед встановленням використовуйте вебсторінку ClawHub або команди CLI для перегляду деталей, щоб перевірити
