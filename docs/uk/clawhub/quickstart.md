...
x-i18n:
    generated_at: "2026-07-04T15:34:24Z"
    model: gpt-5.5
...
Середовища без інтерфейсу можуть використовувати API-токен із вебінтерфейсу ClawHub:
...
навичці, перш ніж вони її встановлять. Див. [Формат навички](/uk/clawhub/skill-format).
