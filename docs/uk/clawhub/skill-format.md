...
x-i18n:
    generated_at: "2026-07-04T04:06:18Z"
    model: gpt-5.5
...
- Типи вмісту, що починаються з `text/`, розглядаються як текст; також діє невеликий список дозволених типів (JSON/YAML/TOML/JS/TS/Markdown/SVG).

Обмеження (на боці сервера):

- Загальний розмір пакета: 50 МБ.
- Текст для embedding включає `SKILL.md` + до приблизно 40 файлів, що не є `.md` (обмеження за принципом найкращих зусиль).
