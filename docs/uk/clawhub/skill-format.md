...
x-i18n:
    generated_at: "2026-07-03T23:42:13Z"
    model: gpt-5.5
...
Вебімпортер GitHub суворіший, ніж локальна публікація/синхронізація. Він виявляє лише
...
- Текст для вбудовування включає `SKILL.md` + до приблизно 40 файлів не `.md` (обмеження за принципом найкращого зусилля).

## Slugs

- За замовчуванням утворюються з назви папки.
- Області видимості пакетів мають точно відповідати ідентифікатору видавця ClawHub. Ідентифікатори видавців можуть містити малі літери, цифри, дефіси, крапки та підкреслення; вони мають починатися й закінчуватися малою літерою або цифрою.
...
- ClawHub не підтримує платні навички, ціни для окремих навичок, платний доступ або розподіл доходів.
