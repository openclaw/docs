...
- Типи вмісту, що починаються з `text/`, обробляються як текст; також є невеликий список дозволених форматів (JSON/YAML/TOML/JS/TS/Markdown/SVG).
...
- Не додавайте конфліктні умови ліцензії в `SKILL.md`; ClawHub не підтримує перевизначення ліцензій для окремих навичок.
