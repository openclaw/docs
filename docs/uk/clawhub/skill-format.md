...
x-i18n:
    generated_at: "2026-07-04T15:34:17Z"
    model: gpt-5.5
...
файли `SKILL.md` або застарілі `skills.md` у публічних репозиторіях, що не є форками, належать
...
- Текст для embedding містить `SKILL.md` + до приблизно 40 файлів не-`.md` (обмеження застосовується за можливості).

## Slugs

- За замовчуванням утворюються з назви папки.
- Scopes пакета мають точно збігатися з handle видавця ClawHub. Handles видавців можуть використовувати малі літери, цифри, дефіси, крапки та підкреслення; вони мають починатися й закінчуватися малою літерою або цифрою.
...
- Будь-хто може використовувати, змінювати та поширювати опубліковані навички, зокрема комерційно.
- Зазначення авторства не потрібне.
- Не додавайте суперечливі умови ліцензії в `SKILL.md`; ClawHub не підтримує перевизначення ліцензії для окремої навички.

## Платні навички

- ClawHub не підтримує платні навички, ціноутворення для окремих навичок, paywalls або розподіл доходу.
- Не додавайте метадані ціни до `SKILL.md`; це не частина формату навички й не зробить опубліковану навичку платною.
