...
- Текст для embedding включає `SKILL.md` + до приблизно 40 файлів не `.md` (обмеження застосовується за можливості).
...
- ClawHub не підтримує платні навички, ціни для окремих навичок, paywall або розподіл доходу.
