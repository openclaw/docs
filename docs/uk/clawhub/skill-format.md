...
summary: Формат теки Skills, обов’язкові файли, дозволені типи файлів, обмеження.
x-i18n:
...
Вебімпортер GitHub суворіший за локальну публікацію/синхронізацію. Він знаходить лише файли
...
Оголошуйте вимоги середовища виконання вашої навички в `metadata.openclaw` (аліаси: `metadata.clawdbot`, `metadata.clawdis`).
...
- Текст для вбудовування містить `SKILL.md` + до приблизно 40 файлів не `.md` (обмеження в межах найкращої спроби).

## Slugs

- За замовчуванням виводяться з назви папки.
- Області видимості пакета мають точно збігатися з handle видавця ClawHub. Handles видавців можуть містити малі літери, цифри, дефіси, крапки та підкреслення; вони мають починатися й закінчуватися малою літерою або цифрою.
