...
x-i18n:
    generated_at: "2026-05-12T23:29:33Z"
    model: gpt-5.5
    provider: openai
...
Використовуйте `requires.env` для змінних середовища, які мають бути наявні до запуску навички. Використовуйте `envVars`, коли потрібні метадані для окремих змінних, зокрема необов’язкові змінні з `required: false`.
...
- Не додавайте цінові метадані до `SKILL.md`; це не частина формату навички й не зробить опубліковану навичку платною.
