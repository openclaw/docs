...
- Типи вмісту, що починаються з `text/`, вважаються текстовими; плюс невеликий список дозволених типів (JSON/YAML/TOML/JS/TS/Markdown/SVG).

Обмеження (на стороні сервера):

- Загальний розмір пакета: 50MB.
- Текст для вбудовування включає `SKILL.md` + до приблизно 40 файлів не `.md` (обмеження з максимально можливим охопленням).
