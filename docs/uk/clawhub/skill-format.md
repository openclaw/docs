...
x-i18n:
    generated_at: "2026-05-12T00:57:47Z"
    model: gpt-5.5
    provider: openai
...
Метадані навички оголошуються в YAML frontmatter на початку вашого `SKILL.md`. Це повідомляє реєстру (і засобам аналізу безпеки), що потрібно вашій навичці для запуску.
...
- Текст для вбудовування включає `SKILL.md` + до приблизно 40 файлів не `.md` (обмеження застосовується за найкращих зусиль).
...
- ClawHub не підтримує платні навички, ціноутворення для окремих навичок, paywall або розподіл доходів.
