...
summary: Огляд і угоди публічного REST API (v1).
x-i18n:
    generated_at: "2026-06-30T22:33:41Z"
    model: gpt-5.5
...
Ви можете створити сторонній каталог, довідник або поверхню пошуку на основі публічних API читання ClawHub. Публічні метадані skill і файли skill публікуються відповідно до правил ліцензії skill ClawHub, тоді як сам API має обмеження частоти запитів і його слід використовувати відповідально.
...
- Додавайте посилання на канонічну URL-адресу skill у ClawHub під час відображення списків, щоб користувачі могли переглянути вихідний запис реєстру.
...
- Не дзеркалюйте прихований, приватний або заблокований модерацією вміст, обходячи фільтри публічного API або межі автентифікації.
...
- `X-RateLimit-Remaining` / `RateLimit-Remaining`: точний залишковий бюджет, коли
  присутній; шардовані успішні запити опускають його, а не повертають приблизне
  глобальне значення
