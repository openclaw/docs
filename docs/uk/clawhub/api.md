...
x-i18n:
    generated_at: "2026-07-01T08:27:55Z"
    model: gpt-5.5
...
Ви можете створити сторонній каталог, директорію або пошукову поверхню на основі публічних API читання ClawHub. Публічні метадані навичок і файли навичок публікуються за правилами ліцензії навичок ClawHub, тоді як сам API має обмеження частоти запитів і його слід використовувати відповідально.
...
- Не дублюйте прихований, приватний або заблокований модерацією вміст, обходячи публічні фільтри API чи межі автентифікації.
...
- `GET /api/v1/download?slug=&version=&tag=`
  - Hosted skills повертають детерміновані байти ZIP.
...
- `GET /api/v1/skills/export?startDate=&endDate=&limit=&cursor=`
  - Hosted skills експортуються як збережені файли.
