...
Ви можете створити сторонній каталог, довідник або пошукову поверхню на основі публічних API читання ClawHub. Публічні метадані Skills і файли Skills публікуються за правилами ліцензування Skills у ClawHub, тоді як сам API має обмеження частоти запитів і його слід використовувати відповідально.
...
- Під час показу списків посилайтеся назад на канонічну URL-адресу Skill у ClawHub, щоб користувачі могли переглянути вихідний запис реєстру.
...
- `X-RateLimit-Remaining` / `RateLimit-Remaining`: точний залишковий бюджет, коли
  наявний; шардовані успішні запити не включають його, замість того щоб повертати приблизне
  глобальне значення
...
- `GET /api/v1/skills?limit=&cursor=&sort=`
  ...
  - `recommended` використовує сигнали взаємодії та новизни.
