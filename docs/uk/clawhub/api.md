...
Ви можете створити сторонній каталог, директорію або пошуковий інтерфейс поверх публічних API читання ClawHub. Публічні метадані Skills і файли Skills публікуються відповідно до правил ліцензії Skills ClawHub, тоді як сам API має обмеження частоти запитів і його слід використовувати відповідально.
...
- `X-RateLimit-Remaining` / `RateLimit-Remaining`: точний залишок бюджету, коли
  присутній; шардовані успішні запити не включають його, замість того щоб повертати приблизне
  глобальне значення
