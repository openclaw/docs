...
x-i18n:
    generated_at: "2026-07-01T18:19:37Z"
    model: gpt-5.5
...
Ви можете створити сторонній каталог, директорію або пошукову поверхню на основі публічних API читання ClawHub. Публічні метадані навичок і файли навичок публікуються за правилами ліцензування навичок ClawHub, тоді як сам API має обмеження частоти запитів і повинен використовуватися відповідально.
...
- Під час показу списків посилайтеся назад на канонічний URL навички ClawHub, щоб користувачі могли переглянути вихідний запис реєстру.
- Використовуйте канонічні URL сторінок у форматі `https://clawhub.ai/<owner>/skills/<slug>`.
...
- Віддавайте перевагу `Retry-After`, коли він присутній.
...
- `GET /api/v1/skills?limit=&cursor=&sort=`
  ...
  - `recommended` використовує сигнали залучення й новизни.
...
- `GET /api/v1/download?slug=&version=&tag=`
  ...
  - Поточні навички, підтримувані GitHub, зі скануванням `clean` або `suspicious` повертають
...
- `GET /api/v1/skills/export?startDate=&endDate=&limit=&cursor=`
  ...
  - Поточні навички, підтримувані GitHub, зі скануванням `clean` або `suspicious` експортуються
...
- `POST /api/v1/users/reserve` резервує кореневі слаги та приватні заповнювачі пакетів без релізів для дескриптора власника.
