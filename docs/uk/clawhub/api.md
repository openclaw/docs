...
x-i18n:
    generated_at: "2026-07-03T02:54:47Z"
    model: gpt-5.5
...
Ви можете побудувати сторонній каталог, директорію або пошукову поверхню поверх публічних API читання ClawHub. Публічні метадані Skills і файли Skills публікуються за правилами ліцензії Skills у ClawHub, тоді як сам API має обмеження швидкості, і його слід використовувати відповідально.
...
- Кешуйте відповіді та враховуйте `429`, `Retry-After` і заголовки обмеження швидкості замість агресивного опитування.
- Під час показу списків посилайтеся назад на канонічний URL Skills у ClawHub, щоб користувачі могли переглянути вихідний запис реєстру.
