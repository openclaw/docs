...
summary: Огляд публічного REST API (v1) та його конвенцій.
x-i18n:
...
Ви можете створити сторонній каталог, директорію або поверхню пошуку на основі публічних API читання ClawHub. Публічні метадані Skills і файли Skills публікуються відповідно до правил ліцензії Skills ClawHub, тоді як сам API має обмеження частоти запитів і повинен використовуватися відповідально.
...
- Кешуйте відповіді та дотримуйтеся `429`, `Retry-After` і заголовків обмеження частоти запитів замість агресивного опитування.
- Посилайтеся на канонічну URL-адресу ClawHub Skills під час показу списків, щоб користувачі могли переглянути вихідний запис реєстру.
...
- Не дзеркальте прихований, приватний або заблокований модерацією вміст шляхом обходу публічних фільтрів API або меж автентифікації.
