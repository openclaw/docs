...
x-i18n:
    generated_at: "2026-07-03T01:03:45Z"
    model: gpt-5.5
...
Ви можете створити сторонній каталог, директорію або поверхню пошуку на основі публічних API читання ClawHub. Публічні метадані Skills і файли Skills публікуються відповідно до правил ліцензування Skills у ClawHub, а сам API має обмеження частоти запитів і його слід використовувати відповідально.
...
- Під час відображення списків додавайте посилання на канонічний URL Skills у ClawHub, щоб користувачі могли переглянути вихідний запис реєстру.
...
- Відсутній/недійсний токен використовує обмеження за IP.
...
- `Retry-After`: затримка в секундах для очікування після `429`
