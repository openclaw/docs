...
Ви можете побудувати сторонній каталог, директорію або пошукову поверхню на основі публічних API читання ClawHub. Публічні метадані Skills і файли Skills публікуються за правилами ліцензії Skills ClawHub, тоді як сам API має обмеження частоти й повинен використовуватися відповідально.
...
- Додавайте посилання на канонічну URL-адресу Skills ClawHub під час показу списків, щоб користувачі могли перевірити вихідний запис реєстру.
