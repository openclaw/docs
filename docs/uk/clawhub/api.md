...
Ви можете створити сторонній каталог, довідник або пошукову поверхню на основі публічних API ClawHub для читання. Публічні метадані Skills і файли Skills публікуються відповідно до правил ліцензування Skills у ClawHub, тоді як сам API має обмеження частоти запитів і його слід використовувати відповідально.
...
- Додавайте посилання на канонічну URL-адресу Skills у ClawHub під час показу списків, щоб користувачі могли переглянути вихідний запис реєстру.
...
- Помилки v1 є звичайним текстом (`text/plain; charset=utf-8`), включно з `400`,
  `401`, `403`, `404`, `429` і відповідями для заблокованих завантажень.
