...
Ви можете створити сторонній каталог, директорію або пошуковий інтерфейс поверх публічних API читання ClawHub. Публічні метадані навичок і файли навичок публікуються за правилами ліцензії навичок ClawHub, тоді як сам API має обмеження частоти запитів і має використовуватися відповідально.
