...
x-i18n:
    generated_at: "2026-07-03T09:56:27Z"
    model: gpt-5.5
...
Ви можете створити сторонній каталог, директорію або пошукову поверхню на основі публічних API читання ClawHub. Публічні метадані Skills і файли Skills публікуються згідно з ліцензійними правилами Skills ClawHub, тоді як сам API має обмеження частоти запитів і його слід використовувати відповідально.
...
- `X-RateLimit-Remaining` / `RateLimit-Remaining`: точний залишковий бюджет, коли
  присутній; шардовані успішні запити не повертають його, замість того щоб повертати приблизне
  глобальне значення
...
- `GET /api/v1/skills?limit=&cursor=&sort=`
  ...
  - `cursor` застосовується до сортувань не `trending`
  ...
  - `recommended` використовує сигнали залучення та свіжості.
