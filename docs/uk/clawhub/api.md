...
summary: Огляд і умовності публічного REST API (v1).
x-i18n:
    generated_at: "2026-05-13T02:51:08Z"
    model: gpt-5.5
    provider: openai
...
Ви можете створити сторонній каталог, директорію або поверхню пошуку на основі публічних API читання ClawHub. Публічні метадані навичок і файли навичок публікуються відповідно до ліцензійних правил ClawHub для навичок, тоді як сам API має обмеження частоти запитів і має використовуватися відповідально.
...
Заголовки: `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset`, `RateLimit-Limit`, `RateLimit-Remaining`, `RateLimit-Reset`, `Retry-After` (при 429).
