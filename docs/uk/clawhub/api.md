...
x-i18n:
    generated_at: "2026-07-01T15:30:43Z"
    model: gpt-5.5
...
Ви можете створити сторонній каталог, директорію або пошукову поверхню на основі публічних API читання ClawHub. Публічні метадані навичок і файли навичок публікуються за правилами ліцензування навичок ClawHub, тоді як сам API має обмеження частоти запитів і його слід використовувати відповідально.
...
- Додавайте посилання на канонічний URL навички ClawHub під час показу списків, щоб користувачі могли переглянути вихідний запис реєстру.
...
`X-RateLimit-Remaining`, `RateLimit-Remaining` і `Retry-After` включаються у відповідь `429`.
...
- `GET /api/v1/skills?limit=&cursor=&sort=`
  ...
  - `recommended` використовує сигнали залучення й нещодавності.
...
- `GET /api/v1/download?slug=&version=&tag=`
  - Хостовані навички повертають детерміновані ZIP-байти.
...
- `GET /api/v1/skills/export?startDate=&endDate=&limit=&cursor=`
  - Хостовані навички експортуються як збережені файли.
