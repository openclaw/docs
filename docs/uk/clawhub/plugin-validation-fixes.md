...
summary: Виправити результати перевірки валідації пакета Plugin ClawHub перед публікацією
...
містить коди обслуговування сканера без інструкцій для виправлення автором, вони
...
| `package-npm-pack-entrypoint-missing`   | [Додайте точки входу до вихідних даних npm pack](/uk/clawhub/plugin-validation-fixes#package-npm-pack-entrypoint-missing)        |
| `package-npm-pack-metadata-missing`     | [Додайте метадані до вихідних даних npm pack](/uk/clawhub/plugin-validation-fixes#package-npm-pack-metadata-missing)             |
...
- Віддавайте перевагу `package.json#version` як версії релізу пакета.
...
- Оновіть `files`, `.npmignore` або вихідні дані збірки, щоб оголошені точки входу були
  включені.
- Див. [Точки входу Plugin](/uk/plugins/sdk-entrypoints).
- Повторно запустіть `clawhub package validate <path-to-plugin>`.
...
- Замініть імпорти з кореневого бареля на цільові імпорти з публічних підшляхів.
...
- Скористайтеся [угодами щодо імпорту](/uk/plugins/building-plugins#import-conventions) і
...
- Залишайте застарілий допоміжний засіб лише поки ваш оголошений діапазон сумісності все ще
...
- Залишайте низькорівневі допоміжні засоби транскриптів лише поки ваш оголошений діапазон сумісності
  все ще підтримує старіші версії OpenClaw, яким вони потрібні.
- Див. [Runtime API](/uk/plugins/sdk-runtime#agent-session-state) і
  [підшляхи Plugin SDK](/uk/plugins/sdk-subpaths).
- Повторно запустіть `clawhub package validate <path-to-plugin>`.
...
- Залишайте `before_agent_start` лише поки ваш оголошений діапазон сумісності все ще
  підтримує старіші версії OpenClaw, яким він потрібен.
...
- Віддзеркальте налаштування каналу, кероване env, у поточні setup, конфігурацію каналу або
...
- Видаліть `openclaw.security.json`, доки OpenClaw не задокументує версійну схему маніфесту безпеки
