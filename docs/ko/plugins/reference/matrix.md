---
read_when:
    - matrix Plugin을 설치, 구성 또는 감사하고 있습니다
summary: OpenClaw Matrix 채널 Plugin은 방과 다이렉트 메시지를 지원합니다.
title: Matrix Plugin
x-i18n:
...
룸과 다이렉트 메시지를 위한 OpenClaw Matrix 채널 Plugin입니다.

## 배포

- 패키지: `@openclaw/matrix`
- 설치 경로: ClawHub: `clawhub:@openclaw/matrix`; npm
