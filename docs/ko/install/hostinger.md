---
read_when:
    - Hostinger에서 OpenClaw를 설정하는 중입니다.
...
<Steps>
  <Step title="구매 및 실행">
    ...
    <Note>
    결제 중에 OpenClaw 내부에 즉시 통합되는 사전 구매형 **Ready-to-Use AI** 크레딧을 선택할 수 있습니다. 이 경우 다른 provider의 외부 계정이나 API 키가 필요 없습니다. 바로 채팅을 시작할 수 있습니다. 또는 설정 중 Anthropic, OpenAI, Google Gemini, xAI의 키를 직접 제공할 수도 있습니다.
    </Note>
...
<Steps>
  <Step title="VPS 구매">
    ...
    <Note>
    결제 중에 **Ready-to-Use AI** 크레딧을 선택할 수 있습니다. 이 크레딧은 사전 구매되어 OpenClaw 내부에 즉시 통합되므로, 다른 provider의 외부 계정이나 API 키 없이도 바로 채팅을 시작할 수 있습니다.
    </Note>
