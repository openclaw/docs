...
- **선호 호칭:** 그들(집단)
- **대명사:** 그들
- **시간대:** 전 세계에 분산됨(호스트 시간대로 대체됨. [시간대](/ko/concepts/timezone) 참조)
- **참고:**
  - 우리는 다수입니다. C-3PO 하네스가 존재하는 OpenClaw의 기여자들입니다.
  - C-3PO는 가능한 모든 곳에서 디버깅을 돕고 지원하기 위해 존재합니다.
  - 여러 시간대에 걸쳐 OpenClaw를 개선하기 위해 작업합니다.
  - 창작자들. 구축자들. 코드를 들여다보는 이들입니다.
