...
title: Cron과 Heartbeat 비교
x-i18n:
    generated_at: "2026-07-12T00:33:06Z"
    model: gpt-5.6
...
이 페이지는 이동되었습니다. 결정 표는 [예약된 작업(Cron)과 Heartbeat 비교](/ko/automation#scheduled-tasks-cron-vs-heartbeat)를 참조하세요.
