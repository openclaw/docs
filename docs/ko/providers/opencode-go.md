...
title: OpenCode Go
x-i18n:
    generated_at: "2026-07-12T01:12:29Z"
    model: gpt-5.6
...
OpenCode Go는 [OpenCode](/ko/providers/opencode) 내부의 Go 카탈로그입니다. Zen 카탈로그와
...
현재 모델 목록을 확인하려면 `openclaw models list --provider opencode-go`를 실행하세요.
번들에 포함된 항목:
...
<AccordionGroup>
  ...
  <Accordion title="공유 자격 증명">
    하나의 `OPENCODE_API_KEY`로 Zen 및 Go 카탈로그를 모두 사용할 수 있습니다. 설정 중
...
<CardGroup cols={2}>
  ...
  <Card title="모델 선택" href="/ko/concepts/model-providers" icon="layers">
    제공자 및 모델 참조 선택과 장애 조치 동작을 설명합니다.
  </Card>
</CardGroup>
