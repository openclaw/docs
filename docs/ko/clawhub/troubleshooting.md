...
x-i18n:
    generated_at: "2026-07-03T23:29:36Z"
    model: gpt-5.5
...
많은 사용자가 하나의 송신 IP를 공유하면 각 사람이 몇 번만 요청하더라도 익명 IP 한도에
도달할 수 있습니다. 가능하면 로그인하고 보고된 지연 시간 이후 다시 시도하세요.
...
ClawHub는 GitHub 신원과 소스 출처 표시를 사용하여 패키지를 게시자와 연결합니다.
