...
x-i18n:
    generated_at: "2026-07-02T08:04:28Z"
    model: gpt-5.5
...
많은 사용자가 하나의 송신 IP를 공유하면 각 사람이 몇 번의 요청만 보내더라도 익명 IP 한도에 도달할 수 있습니다. 가능하면 로그인하고 보고된 지연 시간 후 다시 시도하세요.
