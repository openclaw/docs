...
많은 사용자가 하나의 송신 IP를 공유하는 경우 각 사람이 몇 개의 요청만 보내더라도
익명 IP 제한에 도달할 수 있습니다. 가능한 경우 로그인하고 보고된 지연 시간 후에
다시 시도하세요.
...
Skills의 경우 `SKILL.md` 프런트매터를 확인하세요. 사용자가 패키지를 이해하고
