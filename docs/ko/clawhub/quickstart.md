...
x-i18n:
    generated_at: "2026-07-03T09:27:33Z"
    model: gpt-5.5
...
이 명령은 변경되지 않은 콘텐츠를 건너뜁니다. 새 Skills는 `1.0.0`에서 시작하며, 이후 변경 사항은 다음 패치 버전으로 자동 게시됩니다. 미리 보려면 `--dry-run`을 사용하거나 명시적 버전을 선택하려면 `--version`을 사용하세요.
