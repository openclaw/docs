...
로그인한 상태에서는 `sync`가 집계 설치 수를 위해 최소 설치 스냅샷을 보낼 수도 있습니다. 보고되는 내용과 옵트아웃 방법은 [Telemetry](/ko/clawhub/telemetry)를 참조하세요.
...
공개 목록에는 최신 스캔 상태가 표시됩니다. 검토에서 보류되거나 차단된 릴리스는 해결될 때까지 검색 및 설치 화면에서 숨겨질 수 있습니다.
