...
여러 Skills가 포함된 저장소의 경우, 재사용 가능한 GitHub 워크플로는 `skills/` 아래의 각 직접 Skills 폴더에 대해 `skill publish`를 호출합니다.
...
설치하기 전에 ClawHub 웹 페이지나 CLI 상세 명령을 사용해 메타데이터, 소스 링크, 버전, 변경 로그, 스캔 상태를 검사하세요.
