...
OpenClaw는 해당 Skill의 출처를 기록하므로 이후 업데이트도 ClawHub를 통해 계속 확인할 수 있습니다.
...
게시하기 전에 `SKILL.md`의 메타데이터를 확인하세요. 사용자가 설치하기 전에 해당 Skill에 필요한 내용을 이해할 수 있도록 필수 환경 변수, 도구, 권한을 선언하세요. [Skill 형식](/ko/clawhub/skill-format)을 참조하세요.
...
로그인한 경우 `sync`는 집계 설치 수를 위해 최소 설치 스냅샷도 보낼 수 있습니다. 보고되는 내용과 옵트아웃 방법은 [Telemetry](/ko/clawhub/telemetry)를 참조하세요.
