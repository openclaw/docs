...
`sync`는 Skill 폴더를 스캔하고 아직 동기화되지 않은 새 Skills 또는 변경된 Skills를 게시합니다.
...
로그인한 상태에서는 `sync`가 집계 설치 수를 위해 최소 설치 스냅샷도 보낼 수 있습니다. 보고되는 내용과 옵트아웃 방법은 [Telemetry](/ko/clawhub/telemetry)를 참조하세요.
