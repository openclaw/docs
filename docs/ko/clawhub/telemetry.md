...
read_when:
    ...
    - 수집되는 데이터에 대한 질문
summary: ClawHub CLI가 수집하는 설치 텔레메트리와 수집 거부 방법.
x-i18n:
    generated_at: "2026-07-02T17:35:31Z"
    model: gpt-5.5
...
- `installsAllTime`: 해당 skill에 대해 하나 이상의 CLI 설치를 보고한 고유 사용자.
...
이 설정을 사용하면 CLI는 설치 텔레메트리를 전송하지 않습니다.
