...
삭제, 차단 또는 비활성화된 계정은 일반적인 ClawHub 로그인을 완료할 수 없습니다. 로그인 후 다시 로그아웃된 상태로 돌아온다면 계정 상태가 양호하지 않을 수 있습니다.
...
방화벽, VPN 또는 프록시 규칙 때문에 브라우저가 로컬 콜백에 연결할 수 없으면 헤드리스 토큰 흐름을 사용하세요.
