...
x-i18n:
    generated_at: "2026-07-02T08:05:54Z"
    model: gpt-5.5
...
패키지를 발견할 수 있는 곳을 제공하고, 게시자가 버전을 릴리스할 수 있는 곳을 제공하며,
...
레지스트리를 신뢰할 수 있는 원본으로 삼고 싶다면 명시적인 ClawHub 설치 소스를 사용하세요.
...
업로드 전에 해석된 페이로드를 미리 보려면 dry run을 사용하세요. 그런 다음 공개 페이지에
...
메타데이터를 기록합니다. ClawHub CLI는 전체 OpenClaw 작업 공간 밖에서
...
소유자에게 진단 목적으로 계속 표시되더라도 공개 검색 및 설치 흐름에서 사라질 수 있습니다.
...
타사 카탈로그는 표준 ClawHub 목록으로 다시 연결하고, 속도 제한을 존중하며,
