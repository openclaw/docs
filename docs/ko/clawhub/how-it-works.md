...
내용을 검토할 수 있는 표준 위치입니다.

## Skills

Skills는 `SKILL.md`를 중심으로 하는 버전 관리 텍스트 번들입니다. 지원 파일,
...
외부에서 레지스트리 관리 Skills 폴더를 원하는 사용자를 위해 직접 Skills
...
[모더레이션 및 계정 안전](/ko/clawhub/moderation),
