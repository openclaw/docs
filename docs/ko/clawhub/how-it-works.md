...
x-i18n:
    generated_at: "2026-07-01T18:09:28Z"
    model: gpt-5.5
...
목록 페이지는 사용자가 Skills 또는 Plugin이 무엇을 한다고 주장하는지 설치 전에
확인할 수 있는 표준 위치입니다.
...
설치할지 결정하는 데 도움이 되고, 자동 검사에서 선언된 동작과 관찰된 동작 간의
...
레지스트리를 신뢰할 수 있는 단일 출처로 사용하려면 명시적인 ClawHub 설치
소스를 사용하세요.
...
업로드 전에 확인된 페이로드를 미리 보려면 드라이 런을 사용하세요. 그런 다음
공개 페이지에는 게시된 메타데이터, 파일, 소스 귀속 정보, 검사 상태가 표시됩니다.
...
레지스트리 패키지를 확인할 수 있습니다. ClawHub CLI는 전체 OpenClaw
작업 공간 외부에서 레지스트리가 관리하는 Skills 폴더를 원하는 사용자를 위해
...
[검토 및 계정 안전](/ko/clawhub/moderation),
