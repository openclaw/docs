---
read_when:
    - Bạn cần gọi các hàm trợ giúp lõi từ một Plugin (TTS, STT, tạo ảnh, tìm kiếm web, tác tử con, nút)
...
summary: api.runtime -- các trợ giúp thời gian chạy được tiêm sẵn cho các Plugin
...
<AccordionGroup>
  ...
  <Accordion title="api.runtime.llm">
    ...
    sao chép phần chuẩn bị mô hình/xác thực/base URL của OpenClaw.
    ...
    Helper này dùng cùng đường dẫn chuẩn bị hoàn tất đơn giản như thời gian chạy
    tích hợp sẵn của OpenClaw và snapshot cấu hình thời gian chạy do máy chủ sở hữu. Các engine ngữ cảnh
    nhận capability `llm.complete` gắn với phiên, vì vậy các lệnh gọi mô hình dùng
