...
x-i18n:
    generated_at: "2026-04-29T22:44:46Z"
    model: gpt-5.5
    provider: openai
...
See [Security](/vi/gateway/security) and [Remote access](/vi/gateway/remote).
...
- [Configuration reference](/vi/gateway/configuration-reference)
