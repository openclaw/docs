...
read_when:
    ...
    - Quyết định nên dùng báo cáo, kháng nghị hay yêu cầu quyền sở hữu namespace
sidebarTitle: Org and Namespace Claims
summary: Cách yêu cầu ClawHub xem xét các tranh chấp về quyền sở hữu tổ chức, thương hiệu, tên định danh chủ sở hữu, phạm vi gói, slug Skills hoặc namespace.
title: Yêu cầu xác nhận tổ chức và không gian tên
x-i18n:
    generated_at: "2026-07-02T14:05:53Z"
    model: gpt-5.5
...
khiếu nại, giữ chỗ, gây hiểu nhầm hoặc đang bị tranh chấp trên ClawHub, hãy yêu cầu nhân viên xem xét
bằng
...
trong sản phẩm hoặc biểu mẫu kháng nghị tài khoản cho các khiếu nại không gian tên.
...
cũng hãy làm theo hướng dẫn kiểm duyệt hoặc bảo mật liên quan. Biểu mẫu khiếu nại không gian tên
...
xuất bản với chủ sở hữu `example-org` tương ứng.

Nếu bạn có thể quản lý chủ sở hữu hiện tại, hãy tự sửa không gian tên bằng cách xuất bản,
...
- lịch sử tổ chức, repo, bản phát hành hoặc người bảo trì trên GitHub
...
- bằng chứng quyền sở hữu nhãn hiệu, thương hiệu hoặc dự án an toàn để thảo luận
  công khai
...
Tùy vào bằng chứng và rủi ro, nhân viên ClawHub có thể giữ chỗ một không gian tên,
