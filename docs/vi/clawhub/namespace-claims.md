---
read_when:
    - Xác nhận quyền sở hữu một tổ chức, thương hiệu, phạm vi gói, handle chủ sở hữu, slug kỹ năng hoặc không gian tên gói
    - Giải quyết một namespace đã được khai báo hoặc được bảo lưu
    - Quyết định nên dùng báo cáo, kháng nghị hay yêu cầu namespace
sidebarTitle: Org and Namespace Claims
summary: Cách yêu cầu ClawHub xem xét các tranh chấp về quyền sở hữu tổ chức, thương hiệu, tên chủ sở hữu, phạm vi gói, slug kỹ năng hoặc không gian tên.
title: Xác nhận quyền sở hữu tổ chức và không gian tên
x-i18n:
    generated_at: "2026-06-28T06:20:41Z"
    model: gpt-5.5
...
ClawHub dùng handle chủ sở hữu, handle tổ chức, slug skill, tên gói Plugin và
...
được xác nhận quyền, giữ trước, gây hiểu nhầm hoặc đang bị tranh chấp trên ClawHub, hãy yêu cầu nhân viên xem xét
bằng
...
hoặc biểu mẫu khiếu nại tài khoản cho các yêu cầu xác nhận quyền đối với không gian tên.

## Khi nào nên mở yêu cầu xác nhận quyền

Mở yêu cầu xác nhận quyền đối với không gian tên khi bạn tin rằng nhân viên ClawHub nên xem xét liệu một
...
cũng hãy làm theo hướng dẫn kiểm duyệt hoặc bảo mật liên quan. Biểu mẫu yêu cầu xác nhận quyền đối với không gian tên
dành cho việc xem xét quyền sở hữu, không phải tiết lộ lỗ hổng khẩn cấp.

## Trước khi bạn gửi

Trước tiên hãy xác nhận rằng bạn đang phát hành với chủ sở hữu khớp với không gian tên.
...
đổi tên, chuyển giao, ẩn hoặc xóa tài nguyên bị ảnh hưởng. Dùng yêu cầu xác nhận quyền
...
Biểu mẫu yêu cầu xác nhận quyền hỏi liệu bằng chứng nhạy cảm có cần kênh nhân viên riêng tư hay không.
Hãy dùng tùy chọn đó thay vì đăng tài liệu nhạy cảm công khai.

## Kết quả có thể xảy ra

Tùy thuộc vào bằng chứng và rủi ro, nhân viên ClawHub có thể giữ trước một không gian tên,
