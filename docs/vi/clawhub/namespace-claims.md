---
read_when:
    - Xác nhận quyền sở hữu một tổ chức, thương hiệu, phạm vi gói, handle chủ sở hữu, slug Skills hoặc không gian tên gói
...
x-i18n:
    generated_at: "2026-07-01T08:09:59Z"
    model: gpt-5.5
...
Mở khiếu nại về không gian tên khi bạn tin rằng nhân viên ClawHub nên xem xét liệu một
...
hãy làm theo cả hướng dẫn kiểm duyệt hoặc bảo mật liên quan. Biểu mẫu khiếu nại không gian tên
...
phát hành dưới dạng chủ sở hữu `example-org` tương ứng.
...
- quyền kiểm soát phạm vi npm, PyPI, crates.io hoặc registry gói khác
...
Giải thích từng liên kết chứng minh điều gì. Nhân viên phải có thể hiểu
mối quan hệ mà không cần thông tin đăng nhập riêng tư hoặc bí mật.

## Không nên Bao gồm Điều gì
...
Biểu mẫu khiếu nại hỏi liệu bằng chứng nhạy cảm có cần một kênh nhân viên riêng tư hay không.
