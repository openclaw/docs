...
read_when:
    ...
    - Quyết định nên dùng báo cáo, kháng nghị hay yêu cầu xác nhận quyền đối với không gian tên
sidebarTitle: Org and Namespace Claims
summary: Cách yêu cầu ClawHub xem xét đối với tranh chấp quyền sở hữu tổ chức, thương hiệu, tên người sở hữu, phạm vi gói, slug Skills hoặc namespace.
title: Xác nhận quyền sở hữu tổ chức và không gian tên
x-i18n:
    generated_at: "2026-06-28T07:41:52Z"
    model: gpt-5.5
...
được xác nhận, đặt trước, gây hiểu nhầm hoặc đang bị tranh chấp trên ClawHub, hãy yêu cầu nhân viên xem xét bằng
...
đổi tên, chuyển giao, ẩn hoặc xóa tài nguyên bị ảnh hưởng. Sử dụng yêu cầu xác nhận
...
Biểu mẫu yêu cầu xác nhận sẽ hỏi liệu bằng chứng nhạy cảm có cần một kênh riêng với nhân viên hay không.
