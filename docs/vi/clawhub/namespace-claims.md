---
read_when:
    - Yêu cầu quyền sở hữu một tổ chức, thương hiệu, phạm vi gói, handle chủ sở hữu, slug skill hoặc không gian tên gói
...
summary: Cách yêu cầu ClawHub xem xét các tranh chấp về quyền sở hữu tổ chức, thương hiệu, định danh chủ sở hữu, phạm vi gói, slug Skills hoặc không gian tên.
title: Tuyên bố quyền sở hữu tổ chức và không gian tên
x-i18n:
    generated_at: "2026-07-04T15:22:57Z"
    model: gpt-5.5
...
không gian tên dành cho việc xem xét quyền sở hữu, không phải tiết lộ lỗ hổng khẩn cấp.
...
Không đặt bí mật hoặc bằng chứng riêng tư trong một vấn đề GitHub công khai. Không bao gồm:
