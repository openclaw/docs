---
read_when:
    - Xác nhận quyền sở hữu đối với tổ chức, thương hiệu, phạm vi gói, tên định danh chủ sở hữu, slug kỹ năng hoặc không gian tên gói
    - Giải quyết một namespace đã được xác nhận quyền sở hữu hoặc được dành riêng
...
x-i18n:
    generated_at: "2026-07-02T22:36:39Z"
    model: gpt-5.5
...
hoặc biểu mẫu kháng nghị tài khoản cho khiếu nại về không gian tên.
...
đổi tên, chuyển nhượng, ẩn hoặc xóa tài nguyên bị ảnh hưởng. Sử dụng khiếu nại
...
Biểu mẫu khiếu nại hỏi liệu bằng chứng nhạy cảm có cần một kênh riêng với nhân viên hay không.
