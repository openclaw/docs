---
read_when:
    - Xác nhận quyền sở hữu đối với một tổ chức, thương hiệu, phạm vi gói, định danh chủ sở hữu, slug kỹ năng hoặc không gian tên gói
...
summary: Cách yêu cầu ClawHub đánh giá các tranh chấp quyền sở hữu về tổ chức, thương hiệu, owner-handle, package-scope, skill-slug hoặc không gian tên.
...
xác nhận, đặt trước, gây hiểu lầm hoặc đang bị tranh chấp trên ClawHub, hãy yêu cầu nhân viên xem xét
bằng
...
không gian tên có nên được đặt trước, chuyển nhượng, đổi tên, ẩn, cách ly, đặt bí danh
hoặc thay đổi theo cách khác do quyền sở hữu ngoài đời thực hay không.
...
hãy cũng làm theo hướng dẫn kiểm duyệt hoặc bảo mật có liên quan. Biểu mẫu yêu cầu xác nhận
...
- tài liệu chính thức của dự án nêu tên không gian tên
...
chuyển nhượng quyền sở hữu, đổi tên tài nguyên, ẩn hoặc cách ly một mục niêm yết hiện có,
...
Nhân viên cân nhắc bằng chứng công khai, cách sử dụng hiện có, rủi ro bảo mật và tác động tới người dùng.
