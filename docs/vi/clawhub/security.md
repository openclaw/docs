...
read_when:
    ...
    - Tìm hiểu việc tiết lộ lỗ hổng ClawHub
...
title: Bảo mật
x-i18n:
    generated_at: "2026-07-02T17:40:15Z"
    model: gpt-5.5
...
Không sử dụng cố vấn ClawHub cho các lỗ hổng trong mã nguồn riêng của kỹ năng hoặc
...
bằng chứng về tác động thực sự đến người dùng hoặc khi người dùng cần thực hiện
hành động.

Ví dụ về tác động thực sự đến người dùng bao gồm khai thác đã được xác nhận,
...
Để biết báo cáo marketplace, giữ lại để kiểm duyệt, mục niêm yết bị ẩn, lệnh cấm và
