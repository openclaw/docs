...
title: Bảo mật
x-i18n:
    generated_at: "2026-06-30T22:22:13Z"
    model: gpt-5.5
...
các gói, tệp nhị phân, thư viện hoặc artifact phát hành khác của ClawHub CLI mà người dùng
cần cập nhật cục bộ.

## Trang liên quan

Để biết về nhãn kiểm tra trong lúc cài đặt, mức độ rủi ro, phát hiện và cách diễn giải, hãy xem
[Kiểm tra bảo mật](/clawhub/security-audits).

Để biết về báo cáo trên thị trường, trạng thái giữ để kiểm duyệt, mục niêm yết bị ẩn, lệnh cấm và
tình trạng tài khoản, hãy xem [Kiểm duyệt và an toàn tài khoản](/clawhub/moderation).
