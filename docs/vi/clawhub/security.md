---
read_when:
    - Báo cáo vấn đề bảo mật của ClawHub
    - Tìm hiểu việc công bố lỗ hổng ClawHub
...
title: Bảo mật
x-i18n:
    generated_at: "2026-07-04T06:39:13Z"
    model: gpt-5.5
...
Không sử dụng advisories của ClawHub cho các lỗ hổng trong mã nguồn riêng của Skills hoặc
...
Ví dụ về tác động thực sự đến người dùng bao gồm khai thác đã được xác nhận, lộ
