...
read_when:
    ...
    - Phân biệt sự cố nền tảng ClawHub với sự cố về kỹ năng hoặc Plugin của bên thứ ba
sidebarTitle: Security
summary: Cách báo cáo các vấn đề bảo mật của ClawHub và thời điểm các lỗ hổng được công bố công khai.
title: Bảo mật
x-i18n:
    generated_at: "2026-07-04T18:05:57Z"
    model: gpt-5.5
...
Không sử dụng cảnh báo ClawHub cho các lỗ hổng trong mã nguồn riêng của skill hoặc
...
Các lỗ hổng trong phần mềm do người dùng cài đặt sẽ được tiết lộ công khai, chẳng hạn như
...
Để biết báo cáo marketplace, tạm giữ kiểm duyệt, mục niêm yết bị ẩn, lệnh cấm và trạng thái
