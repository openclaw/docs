---
read_when:
    - Báo cáo một vấn đề bảo mật của ClawHub
...
title: Bảo mật
x-i18n:
    generated_at: "2026-07-01T15:26:34Z"
    model: gpt-5.5
...
Để biết về nhãn kiểm tra khi cài đặt, mức độ rủi ro, phát hiện và cách diễn giải, hãy xem
