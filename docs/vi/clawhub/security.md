...
title: Bảo mật
x-i18n:
    generated_at: "2026-07-03T13:38:41Z"
    model: gpt-5.5
...
Dùng GitHub Security Advisories cho các lỗ hổng trong chính ClawHub. Báo cáo
khuyến cáo ClawHub tốt bao gồm các lỗi trong:

- trang web, API, hoặc CLI của ClawHub
- xuất bản sổ đăng ký, tải xuống, cài đặt, hoặc tính toàn vẹn của hiện vật
- xác thực, phân quyền, hoặc mã thông báo API
- quét, kiểm duyệt, hoặc xử lý báo cáo

Không dùng khuyến cáo ClawHub cho các lỗ hổng trong mã nguồn riêng của một skill hoặc
...
Ví dụ về tác động thực tế đến người dùng bao gồm việc khai thác đã được xác nhận, lộ
dữ liệu hoặc bí mật của người dùng, nội dung độc hại đến được với người dùng do lỗi nền tảng,
...
các gói CLI, tệp nhị phân, thư viện của ClawHub, hoặc các hiện vật phát hành khác mà người dùng
cần cập nhật cục bộ.

## Trang liên quan

Đối với nhãn kiểm tra khi cài đặt, mức độ rủi ro, phát hiện, và cách diễn giải, xem
[Kiểm tra bảo mật](/clawhub/security-audits).

Đối với báo cáo trên chợ, tạm giữ kiểm duyệt, mục niêm yết bị ẩn, lệnh cấm, và trạng thái
