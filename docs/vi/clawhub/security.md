...
title: Bảo mật
x-i18n:
    generated_at: "2026-07-03T17:26:35Z"
    model: gpt-5.5
...
Để biết nhãn kiểm tra tại thời điểm cài đặt, mức rủi ro, phát hiện và cách diễn giải, hãy xem
[Kiểm tra bảo mật](/clawhub/security-audits).

Để biết báo cáo marketplace, tạm giữ kiểm duyệt, danh sách bị ẩn, lệnh cấm và
