...
title: Bảo mật
x-i18n:
    generated_at: "2026-07-04T10:46:49Z"
    model: gpt-5.5
...
được liên kết từ danh sách ClawHub.
...
như các gói CLI ClawHub, binary, thư viện hoặc các artifact phát hành khác mà
người dùng cần cập nhật cục bộ.

## Trang liên quan

Để biết nhãn kiểm tra tại thời điểm cài đặt, mức độ rủi ro, phát hiện và cách
diễn giải, hãy xem [Kiểm tra bảo mật](/clawhub/security-audits).

Đối với báo cáo marketplace, giữ lại để kiểm duyệt, danh sách bị ẩn, lệnh cấm và
