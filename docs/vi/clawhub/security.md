...
title: Bảo mật
x-i18n:
    generated_at: "2026-07-01T18:14:15Z"
    model: gpt-5.5
...
Các lỗ hổng trong phần mềm do người dùng cài đặt được tiết lộ công khai, chẳng hạn
như các gói CLI, tệp nhị phân, thư viện hoặc artifact phát hành khác của ClawHub
...
Để biết báo cáo marketplace, trạng thái tạm giữ kiểm duyệt, mục bị ẩn, lệnh cấm và
