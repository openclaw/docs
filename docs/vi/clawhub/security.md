...
summary: Cách báo cáo vấn đề bảo mật của ClawHub và thời điểm các lỗ hổng được công khai.
title: Bảo mật
x-i18n:
...
Không dùng cố vấn ClawHub cho các lỗ hổng trong mã nguồn riêng của kỹ năng hoặc
...
Để biết nhãn kiểm toán khi cài đặt, mức rủi ro, phát hiện và cách diễn giải, hãy xem
[Kiểm toán bảo mật](/vi/clawhub/security-audits).

Để biết báo cáo marketplace, tạm giữ kiểm duyệt, mục niêm yết bị ẩn, lệnh cấm và
