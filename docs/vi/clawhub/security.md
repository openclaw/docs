...
Ví dụ về tác động thực tế đến người dùng bao gồm khai thác đã được xác nhận, lộ dữ
liệu hoặc bí mật của người dùng, nội dung độc hại đến được người dùng do lỗi nền tảng,
hoặc bất kỳ vấn đề nào yêu cầu người dùng xoay vòng thông tin xác thực, cập nhật phần
mềm cục bộ, hoặc thực hiện hành động bảo vệ khác.
...
Để biết báo cáo marketplace, giữ để kiểm duyệt, mục niêm yết bị ẩn, lệnh cấm và trạng thái
