...
read_when:
    ...
    - Hiểu về việc tiết lộ lỗ hổng bảo mật ClawHub
...
Ví dụ về tác động thực sự đến người dùng bao gồm khai thác đã được xác nhận, lộ dữ liệu
...
Để biết nhãn kiểm toán tại thời điểm cài đặt, mức rủi ro, phát hiện và cách diễn giải, hãy xem
