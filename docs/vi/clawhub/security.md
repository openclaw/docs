...
title: Bảo mật
x-i18n:
    generated_at: "2026-07-03T23:36:24Z"
    model: gpt-5.5
...
Dùng GitHub Security Advisories cho các lỗ hổng trong chính ClawHub. Các báo cáo
advisory ClawHub tốt bao gồm lỗi trong:
...
Không dùng advisory của ClawHub cho các lỗ hổng trong mã nguồn riêng của kỹ năng hoặc
...
tác động thực tế đến người dùng hoặc khi người dùng cần thực hiện hành động.
...
các gói CLI, binary, thư viện hoặc artifact phát hành khác của ClawHub mà người dùng
cần cập nhật cục bộ.

## Trang liên quan

Để xem các nhãn kiểm tra tại thời điểm cài đặt, mức độ rủi ro, phát hiện và cách diễn giải, hãy xem
[Kiểm tra bảo mật](/clawhub/security-audits).

Để xem báo cáo marketplace, tạm giữ kiểm duyệt, mục niêm yết bị ẩn, lệnh cấm và
