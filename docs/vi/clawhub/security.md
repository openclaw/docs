...
title: Bảo mật
x-i18n:
    generated_at: "2026-07-03T02:50:34Z"
    model: gpt-5.5
...
tư vấn ClawHub tốt bao gồm các lỗi trong:

- trang web, API hoặc CLI của ClawHub
- việc xuất bản, tải xuống, cài đặt registry hoặc tính toàn vẹn của artifact
...
Các lỗ hổng trong phần mềm do người dùng cài đặt được công bố công khai, chẳng hạn
như các gói CLI ClawHub, tệp nhị phân, thư viện hoặc các artifact phát hành khác
mà người dùng cần cập nhật cục bộ.

## Trang liên quan

Để biết các nhãn kiểm tra tại thời điểm cài đặt, mức độ rủi ro, phát hiện và cách
diễn giải, xem [Kiểm tra bảo mật](/clawhub/security-audits).

Để biết báo cáo marketplace, giữ kiểm duyệt, mục niêm yết bị ẩn, lệnh cấm và
trạng thái tài khoản, xem [Kiểm duyệt và An toàn tài khoản](/clawhub/moderation).
