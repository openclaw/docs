...
read_when:
    ...
    - Tìm hiểu về công bố lỗ hổng ClawHub
    - Phân biệt sự cố nền tảng ClawHub với sự cố về Skills hoặc Plugin của bên thứ ba
sidebarTitle: Security
summary: Cách báo cáo các vấn đề bảo mật của ClawHub và thời điểm các lỗ hổng được công bố công khai.
title: Bảo mật
x-i18n:
    generated_at: "2026-07-04T20:33:49Z"
    model: gpt-5.5
...
Sử dụng GitHub Security Advisories cho các lỗ hổng trong chính ClawHub. Các
báo cáo khuyến cáo ClawHub tốt bao gồm lỗi trong:
...
Không sử dụng khuyến cáo ClawHub cho các lỗ hổng trong mã nguồn riêng của skill hoặc
Plugin bên thứ ba. Hãy báo cáo trực tiếp cho nhà xuất bản hoặc repository nguồn
...
Ví dụ về tác động thực tế đến người dùng bao gồm khai thác đã được xác nhận, lộ dữ liệu
hoặc bí mật của người dùng, nội dung độc hại tiếp cận người dùng do lỗi nền tảng,
...
các gói ClawHub CLI, binary, thư viện hoặc artifact phát hành khác mà người dùng
cần cập nhật cục bộ.

## Trang liên quan

Để biết nhãn kiểm tra khi cài đặt, mức độ rủi ro, phát hiện và cách diễn giải, xem
[Kiểm tra bảo mật](/clawhub/security-audits).

Để biết báo cáo marketplace, giữ kiểm duyệt, mục niêm yết bị ẩn, lệnh cấm và trạng thái
