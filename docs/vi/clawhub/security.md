...
read_when:
    ...
    - Hiểu về công bố lỗ hổng bảo mật ClawHub
...
title: Bảo mật
x-i18n:
    generated_at: "2026-07-04T15:23:33Z"
    model: gpt-5.5
...
dữ liệu hoặc bí mật của người dùng, nội dung độc hại tiếp cận người dùng do lỗi
...
Để biết nhãn kiểm toán khi cài đặt, mức rủi ro, phát hiện và diễn giải, xem
