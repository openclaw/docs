...
read_when:
    ...
    - Hiểu về công bố lỗ hổng bảo mật của ClawHub
...
tư vấn ClawHub tốt bao gồm lỗi trong:
...
Không sử dụng tư vấn ClawHub cho các lỗ hổng trong mã nguồn riêng của skill hoặc
plugin bên thứ ba. Hãy báo cáo trực tiếp cho nhà phát hành hoặc repository nguồn
được liên kết từ mục niêm yết trên ClawHub.

## Tiết lộ lỗ hổng

Vì ClawHub là một ứng dụng đám mây được lưu trữ, các lỗ hổng dịch vụ ClawHub
không được tiết lộ công khai theo mặc định. Chúng được tiết lộ công khai khi có
bằng chứng về tác động thực sự đến người dùng hoặc khi người dùng cần hành động.

Ví dụ về tác động thực sự đến người dùng bao gồm việc khai thác đã được xác nhận,
lộ dữ liệu hoặc bí mật của người dùng, nội dung độc hại đến được với người dùng
do lỗi nền tảng, hoặc bất kỳ vấn đề nào yêu cầu người dùng xoay vòng thông tin xác thực,
...
các gói CLI, binary, thư viện của ClawHub hoặc các artifact phát hành khác mà người dùng
cần cập nhật cục bộ.

## Trang liên quan

Để biết về nhãn kiểm tra tại thời điểm cài đặt, mức rủi ro, phát hiện và cách diễn giải, hãy xem
[Kiểm tra bảo mật](/clawhub/security-audits).

Để biết về báo cáo marketplace, tạm giữ kiểm duyệt, mục niêm yết bị ẩn, lệnh cấm và
trạng thái tài khoản, hãy xem [Kiểm duyệt và An toàn tài khoản](/clawhub/moderation).
