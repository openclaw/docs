...
read_when:
    ...
    - Quyết định có cài đặt skill hoặc plugin hay không
...
x-i18n:
    generated_at: "2026-07-04T18:06:35Z"
    model: gpt-5.5
...
liệu có điều gì cần chú ý thêm trước khi có thể truy cập tệp, tài khoản,
thông tin xác thực, mã hoặc dịch vụ bên ngoài hay không.

Kiểm tra là tín hiệu an toàn mạnh, nhưng không bảo đảm rằng một bản phát hành
...
| `Warn`      | Cần hết sức thận trọng. ClawHub đã tìm thấy mối quan ngại có tác động cao hoặc tín hiệu cảnh báo. |
| `Malicious` | Không cài đặt.                                                            |
| `Pending`   | Kiểm tra chưa hoàn tất.                                                   |
| `Error`     | Không thể hoàn tất kiểm tra.                                              |

`Pass` là tín hiệu đáng yên tâm, nhưng không thay thế đánh giá của chính bạn. Điều này quan trọng
nhất với các công cụ có thể đăng nội dung, chỉnh sửa dữ liệu, chạy lệnh, đọc tệp hoặc
truy cập hệ thống production.

## Mức rủi ro

Mức rủi ro mô tả phạm vi ảnh hưởng: bản phát hành dường như có bao nhiêu quyền lực nếu
bạn sử dụng đúng mục đích.
...
| `High`     | Bản phát hành có quyền hạn có tác động cao, phát hiện nghiêm trọng hoặc tín hiệu độc hại. |
...
không có nghĩa là nó độc hại. Điều đó có nghĩa là kỹ năng này có vẻ phù hợp với mục đích, nhưng có thể
...
và nội dung thực tế có khớp với những gì người dùng có thể kỳ vọng hợp lý hay không?

Hành vi mạnh không tự động là xấu. Nhiều công cụ hữu ích cần thông tin xác thực,
lệnh cục bộ, API nhà cung cấp hoặc cài đặt gói. Kiểm tra sẽ xem quyền lực đó
...
ClawHub sử dụng VirusTotal làm dữ liệu đo từ xa về phần mềm độc hại trong ngăn xếp kiểm tra. VirusTotal là
tiêu chuẩn ngành đáng tin cậy về uy tín tệp và quét phần mềm độc hại, và quan hệ
đối tác của chúng tôi cho phép ClawHub bổ sung thông tin tình báo bảo mật rộng hơn vào quá trình đánh giá kỹ năng và plugin.

VirusTotal đặc biệt hữu ích cho các hiện vật độc hại đã biết, lượt phát hiện của công cụ và
tín hiệu uy tín bổ sung cho đánh giá nhận biết tác nhân của ClawHub. Khi có số lượng
công cụ nhà cung cấp, kiểm tra sẽ tóm tắt chúng bằng ngôn ngữ đơn giản, chẳng hạn như:
...
VirusTotal vẫn là dữ liệu đo từ xa. Nó không thay thế phân tích rủi ro nhận biết hiện vật
của riêng ClawHub.

## Phân tích rủi ro

Phân tích rủi ro được vận hành nội bộ bởi ClawScan, hệ thống kiểm tra bảo mật riêng
của ClawHub. Hệ thống này đánh giá mỗi bản phát hành như một hiện vật hướng đến tác nhân: hướng dẫn,
...
một mục kiểm tra công khai độc lập hoặc phán quyết chặn cài đặt.

Phân tích rủi ro sử dụng
[OWASP Agentic Skills Top 10](https://owasp.org/www-project-agentic-skills-top-10/)
làm lăng kính cho các rủi ro như chèn prompt, lạm dụng công cụ, lộ thông tin xác thực,
