...
read_when:
    ...
    - Quyết định có nên cài đặt một skill hay plugin không
...
x-i18n:
    generated_at: "2026-07-02T22:37:01Z"
    model: gpt-5.5
...
Kiểm tra bảo mật của ClawHub giúp bạn quyết định liệu một kỹ năng hoặc plugin có đủ an toàn
...
Các kiểm tra là tín hiệu an toàn mạnh, nhưng không bảo đảm rằng một bản phát hành
...
| `Warn`      | Hãy thận trọng hơn. ClawHub phát hiện một mối lo ngại có tác động cao hoặc tín hiệu cảnh báo. |
...
Mức rủi ro mô tả phạm vi tác động: bản phát hành dường như có bao nhiêu quyền lực nếu
...
không có nghĩa là nó độc hại. Nó có nghĩa là kỹ năng này dường như phù hợp với mục đích, nhưng có thể
...
Các phát hiện có độ tin cậy thấp bị ẩn khỏi bản tổng hợp kiểm tra công khai để trang
...
- các tệp kèm theo và bản kê khai tệp
...
lệnh cục bộ, API nhà cung cấp, hoặc cài đặt gói. Kiểm tra đánh giá liệu quyền lực đó
...
ClawHub dùng VirusTotal làm dữ liệu đo lường phần mềm độc hại trong bộ kiểm tra. VirusTotal là một
chuẩn ngành đáng tin cậy cho uy tín tệp và quét phần mềm độc hại, và quan hệ đối tác của chúng tôi
cho phép ClawHub bổ sung thông tin tình báo bảo mật rộng hơn vào quá trình đánh giá kỹ năng và plugin.

VirusTotal đặc biệt hữu ích cho các tạo phẩm độc hại đã biết, lượt phát hiện từ engine, và
tín hiệu uy tín bổ sung cho đánh giá có nhận biết tác tử của ClawHub. Khi có số lượng engine
của nhà cung cấp, kiểm tra sẽ tóm tắt chúng bằng ngôn ngữ rõ ràng, chẳng hạn như:
...
Khi ClawHub không có dữ liệu đo lường số lượng nhà cung cấp để tóm tắt, kiểm tra sẽ ghi:
...
Phân tích rủi ro được vận hành nội bộ bởi ClawScan, hệ thống kiểm tra bảo mật riêng của ClawHub.
Nó xem xét từng bản phát hành như một tạo phẩm hướng đến tác tử: hướng dẫn,
...
phần kiểm tra công khai độc lập hay một kết luận chặn cài đặt.
...
thực thi không an toàn, đầu độc bộ nhớ hoặc ngữ cảnh, và trao quyền tự chủ quá mức.
