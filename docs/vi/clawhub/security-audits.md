...
x-i18n:
    generated_at: "2026-06-30T22:22:33Z"
    model: gpt-5.5
...
| `Warn`      | Thận trọng hơn. ClawHub tìm thấy mối lo ngại tác động cao hoặc tín hiệu cảnh báo. |
| `Malicious` | Không cài đặt.                                                            |
| `Pending`   | Kiểm toán chưa hoàn tất.                                                  |
| `Error`     | Không thể hoàn tất kiểm toán.                                             |

`Pass` đem lại sự yên tâm, nhưng không thay thế phán đoán của chính bạn. Điều này quan trọng
...
không có nghĩa là nó độc hại. Điều đó nghĩa là kỹ năng này có vẻ phù hợp với mục đích, nhưng có thể
...
VirusTotal đặc biệt hữu ích với các tạo tác độc hại đã biết, lượt phát hiện của engine, và
...
Khi ClawHub không có dữ liệu đo từ xa về số lượng nhà cung cấp để tóm tắt, kiểm toán ghi:

```text
No VirusTotal findings
```

VirusTotal vẫn là dữ liệu đo từ xa. Nó không thay thế phân tích rủi ro có nhận thức về
tạo tác của riêng ClawHub.

## Phân tích rủi ro

Phân tích rủi ro được vận hành nội bộ bởi ClawScan, hệ thống kiểm toán bảo mật riêng của ClawHub.
Hệ thống này xem xét từng bản phát hành như một tạo tác hướng tới tác tử: hướng dẫn,
