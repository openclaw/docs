...
read_when:
    ...
    - Quyết định có nên cài đặt một kỹ năng hay Plugin
...
x-i18n:
    generated_at: "2026-07-04T15:23:17Z"
    model: gpt-5.5
...
| `Warn`      | Hãy thận trọng hơn. ClawHub tìm thấy mối quan ngại tác động cao hoặc tín hiệu cảnh báo. |
...
ClawHub kiểm toán các tạo tác phát hành đã gửi, bao gồm:
...
ClawHub dùng VirusTotal làm tín hiệu đo lường phần mềm độc hại trong bộ kiểm toán. VirusTotal là một
...
công cụ nhà cung cấp, bản kiểm toán tóm tắt chúng bằng ngôn ngữ rõ ràng, chẳng hạn như:
...
Khi ClawHub không có dữ liệu đo lường số lượng nhà cung cấp để tóm tắt, bản kiểm toán sẽ ghi:
...
Nó xem xét từng bản phát hành như một tạo tác dành cho tác nhân: hướng dẫn,
...
mục kiểm toán công khai độc lập hoặc kết luận chặn cài đặt.

Phân tích rủi ro sử dụng
[OWASP Agentic Skills Top 10](https://owasp.org/www-project-agentic-skills-top-10/)
như một lăng kính cho các rủi ro như tiêm prompt, sử dụng sai công cụ, lộ thông tin xác thực,
