...
Các kiểm toán bảo mật của ClawHub giúp bạn quyết định một kỹ năng hoặc Plugin có đủ an toàn
để cài đặt hay không. Chúng cho biết một bản phát hành làm gì, yêu cầu quyền hạn nào, và
liệu có điều gì cần chú ý thêm trước khi bản đó có thể truy cập tệp, tài khoản,
thông tin xác thực, mã, hoặc dịch vụ bên ngoài hay không.

Kiểm toán là tín hiệu an toàn mạnh, nhưng không đảm bảo rằng một bản phát hành là
không có rủi ro. Luôn dùng phán đoán của bạn trước khi cấp quyền truy cập nhạy cảm.

Xem thêm [Bảo mật](/vi/clawhub/security), [Mức sử dụng chấp nhận được](/vi/clawhub/acceptable-usage),
...
| `Warn`      | Cần thận trọng hơn. ClawHub tìm thấy mối quan ngại tác động cao hoặc tín hiệu cảnh báo. |
...
mức độ nghiêm trọng cao hơn đóng góp mạnh hơn vào mức rủi ro và trạng thái kiểm toán.
...
ClawHub kiểm toán các tạo phẩm bản phát hành đã gửi, bao gồm:
...
Các trang tạo phẩm liên kết đến kiểm toán đầy đủ tại:
...
ClawHub sử dụng VirusTotal làm telemetry phần mềm độc hại trong ngăn xếp kiểm toán. VirusTotal là một
tiêu chuẩn ngành đáng tin cậy về uy tín tệp và quét phần mềm độc hại, và
quan hệ đối tác của chúng tôi cho phép ClawHub bổ sung thông tin tình báo bảo mật rộng hơn vào quá trình đánh giá kỹ năng và Plugin.

VirusTotal đặc biệt hữu ích đối với các tạo phẩm độc hại đã biết, lần phát hiện của engine, và
tín hiệu uy tín bổ sung cho đánh giá có nhận thức về tác tử của ClawHub. Khi có
số lượng engine của nhà cung cấp, kiểm toán tóm tắt chúng bằng ngôn ngữ dễ hiểu, chẳng
hạn như:
...
Khi ClawHub không có telemetry số lượng nhà cung cấp để tóm tắt, kiểm toán ghi:

```text
No VirusTotal findings
```

VirusTotal vẫn là telemetry. Nó không thay thế phân tích rủi ro có nhận thức về tạo phẩm
riêng của ClawHub.

## Phân tích rủi ro

Phân tích rủi ro được vận hành nội bộ bởi ClawScan, hệ thống kiểm toán bảo mật riêng
của ClawHub. Nó xem xét từng bản phát hành như một tạo phẩm hướng tới tác tử: hướng dẫn,
siêu dữ liệu, quyền đã khai báo, tệp, tín hiệu năng lực, tín hiệu quét tĩnh,
phát hiện SkillSpector, telemetry VirusTotal, và ngữ cảnh do nhà xuất bản cung cấp.
Tín hiệu quét tĩnh là ngữ cảnh nội bộ cho quá trình đánh giá này; chúng không phải là
