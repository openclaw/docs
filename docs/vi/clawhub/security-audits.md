...
read_when:
    ...
    - Giải thích trạng thái kiểm toán, mức độ rủi ro hoặc phát hiện của ClawHub
...
Kiểm toán là tín hiệu an toàn mạnh, nhưng không bảo đảm rằng một bản phát hành là
...
| `Warn`      | Cần đặc biệt thận trọng. ClawHub đã tìm thấy mối quan ngại có tác động cao hoặc tín hiệu cảnh báo. |
...
và nội dung thực tế có khớp với điều người dùng có thể kỳ vọng hợp lý không?
...
ClawHub dùng VirusTotal làm tín hiệu đo từ xa về phần mềm độc hại trong ngăn xếp kiểm toán. VirusTotal là một
tiêu chuẩn ngành đáng tin cậy về danh tiếng tệp và quét phần mềm độc hại, và quan hệ
đối tác của chúng tôi cho phép ClawHub bổ sung thông tin bảo mật rộng hơn vào quá trình đánh giá kỹ năng và Plugin.

VirusTotal đặc biệt hữu ích với các tạo phẩm độc hại đã biết, các lần phát hiện của công cụ quét, và
tín hiệu danh tiếng bổ sung cho đánh giá có nhận biết tác tử của ClawHub. Khi có
số lượng công cụ của nhà cung cấp, kiểm toán sẽ tóm tắt chúng bằng ngôn ngữ dễ hiểu, chẳng
hạn như:
...
VirusTotal vẫn là dữ liệu đo từ xa. Nó không thay thế phân tích rủi ro có nhận biết
tạo phẩm của riêng ClawHub.

## Phân tích rủi ro

Phân tích rủi ro được vận hành nội bộ bởi ClawScan, hệ thống kiểm toán bảo mật riêng của ClawHub.
Nó xem xét từng bản phát hành như một tạo phẩm hướng tới tác tử: hướng dẫn,
siêu dữ liệu, quyền đã khai báo, tệp, tín hiệu năng lực, tín hiệu quét tĩnh,
phát hiện SkillSpector, dữ liệu đo từ xa VirusTotal, và ngữ cảnh do nhà phát hành cung cấp.
