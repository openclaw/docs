---
read_when:
    - Tìm hiểu kết quả kiểm toán bảo mật của ClawHub
...
summary: Cách diễn giải kết quả kiểm toán bảo mật ClawHub trước khi cài đặt một kỹ năng hoặc Plugin.
title: Kiểm tra bảo mật
x-i18n:
    generated_at: "2026-07-05T05:13:18Z"
    model: gpt-5.5
...
Các kiểm toán bảo mật của ClawHub giúp bạn quyết định liệu một kỹ năng hoặc Plugin có đủ an toàn
để cài đặt hay không. Chúng cho biết một bản phát hành làm gì, yêu cầu quyền hạn nào, và
liệu có điểm nào cần chú ý thêm trước khi nó có thể truy cập tệp, tài khoản,
...
| `Warn`      | Thận trọng hơn. ClawHub đã tìm thấy một mối quan ngại có tác động cao hoặc tín hiệu cảnh báo. |
...
Mức độ rủi ro mô tả phạm vi tác động: bản phát hành có vẻ có bao nhiêu quyền lực nếu
...
ClawHub sử dụng VirusTotal làm dữ liệu đo lường phần mềm độc hại trong ngăn xếp kiểm toán. VirusTotal là một
tiêu chuẩn ngành đáng tin cậy về uy tín tệp và quét phần mềm độc hại, và
quan hệ đối tác của chúng tôi cho phép ClawHub bổ sung thông tin bảo mật rộng hơn vào việc đánh giá kỹ năng và Plugin.

VirusTotal đặc biệt hữu ích cho các tạo phẩm độc hại đã biết, lượt phát hiện của công cụ, và
...
VirusTotal vẫn là dữ liệu đo lường. Nó không thay thế phân tích rủi ro có nhận thức về tạo phẩm
riêng của ClawHub.

## Phân tích rủi ro

Phân tích rủi ro được vận hành nội bộ bởi ClawScan, hệ thống kiểm toán bảo mật riêng của ClawHub.
Nó xem xét từng bản phát hành như một tạo phẩm hướng tới tác nhân: hướng dẫn,
...
một phần kiểm toán công khai độc lập hoặc phán quyết chặn cài đặt.
