...
title: ClawHub
x-i18n:
    generated_at: "2026-07-05T05:15:47Z"
    model: gpt-5.5
...
Cài đặt ClawHub CLI khi bạn muốn các quy trình được xác thực với registry như
...
Các đặc tả plugin trần an toàn với npm có thể phân giải qua npm trong các giai đoạn chuyển đổi khi ra mắt, và
...
được khai báo trước khi quá trình cài đặt archive chạy. Khi một phiên bản gói phát hành một
...
ClawHub CLI dùng cho công việc cần xác thực registry:
