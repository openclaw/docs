...
Các spec Plugin an toàn cho npm dạng trần có thể được phân giải qua npm trong các giai đoạn chuyển đổi ra mắt, và
...
được khai báo trước khi chạy cài đặt archive. Khi một phiên bản gói phát hành artifact
...
`openclaw.build.openclawVersion`. Xem [CLI](/vi/clawhub/cli) để tham khảo đầy đủ lệnh
