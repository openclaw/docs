...
title: ClawHub
x-i18n:
    generated_at: "2026-07-05T07:02:04Z"
    model: gpt-5.5
...
Cài đặt ClawHub CLI khi bạn muốn dùng các quy trình có xác thực registry như
...
Các đặc tả plugin an toàn cho npm dạng trần có thể phân giải qua npm trong các giai đoạn chuyển đổi khi ra mắt, và
...
được quảng bá trước khi quá trình cài đặt archive chạy. Khi một phiên bản gói phát hành artifact
...
Những lệnh đó cài đặt Skills vào `./skills` dưới thư mục làm việc hiện tại
...
[Sử dụng chấp nhận được](/clawhub/acceptable-usage) để biết chi tiết chính sách và thực thi.
...
Xem [Telemetry](/vi/clawhub/telemetry), [HTTP API](/clawhub/http-api), và
[Khắc phục sự cố](/clawhub/troubleshooting) để biết tài liệu tham chiếu chuyên sâu hơn.
