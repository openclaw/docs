...
| Souls          | Các gói `SOUL.md` hiển thị trên onlycrabs.ai                | Quy trình xuất bản qua Web và API            |
...
Dùng `clawhub:<package>` khi một lần cài đặt plugin cần phân giải qua ClawHub.
...
được quảng bá trước khi chạy cài đặt archive. Khi một phiên bản gói xuất bản
...
Xuất bản plugins từ thư mục cục bộ, `owner/repo`, `owner/repo@ref` hoặc URL GitHub:
...
ClawHub chạy kiểm tra tự động trên skills và bản phát hành plugin đã xuất bản. Các bản phát hành
