...
title: ClawHub
x-i18n:
    generated_at: "2026-05-13T04:18:17Z"
    model: gpt-5.5
    provider: openai
...
Cài đặt CLI ClawHub khi bạn muốn dùng các quy trình đã xác thực registry như
...
| Souls          | Các bundle `SOUL.md` hiển thị trên onlycrabs.ai                      | Quy trình phát hành qua web và API                    |
...
Các spec plugin thuần tương thích npm có thể phân giải qua npm trong các giai đoạn chuyển đổi khi ra mắt, và
...
CLI ClawHub dành cho công việc đã xác thực registry:
