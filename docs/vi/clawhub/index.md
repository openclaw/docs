...
summary: Tổng quan công khai về ClawHub để khám phá, cài đặt, phát hành, bảo mật và CLI clawhub.
title: ClawHub
x-i18n:
    generated_at: "2026-07-01T20:26:19Z"
    model: gpt-5.5
...
| -------------- | ------------------------------------------------------------ | -------------------------------------------- |
| Skills         | Các gói văn bản có phiên bản, gồm `SKILL.md` cùng các tệp hỗ trợ | `openclaw skills install @openclaw/demo`     |
| Plugin mã   | Các gói Plugin OpenClaw kèm metadata tương thích         | `openclaw plugins install clawhub:<package>` |
| Plugin dạng bundle | Các bundle Plugin đóng gói cho bản phân phối OpenClaw            | `clawhub package publish <source>`           |

ClawHub theo dõi các phiên bản semver, tag như `latest`, nhật ký thay đổi, tệp,
...
Các đặc tả Plugin trần an toàn cho npm có thể được phân giải qua npm trong các giai đoạn chuyển đổi khi ra mắt, và
...
Xuất bản Plugin từ một thư mục cục bộ, `owner/repo`, `owner/repo@ref`, hoặc một URL
GitHub:
...
ClawHub chạy các kiểm tra tự động trên Skills và các bản phát hành Plugin đã xuất bản. Các bản phát hành
bị giữ lại do quét hoặc bị chặn có thể biến mất khỏi catalog công khai và các bề mặt cài đặt trong khi
...
cài đặt theo khả năng tốt nhất để ClawHub có thể tính tổng số lượt cài đặt. Tắt tính năng này bằng:
