...
title: ClawHub
x-i18n:
    generated_at: "2026-07-03T17:28:09Z"
    model: gpt-5.5
...
Các đặc tả plugin thuần tương thích npm có thể được phân giải qua npm trong giai đoạn chuyển đổi khi ra mắt, và
...
bị giữ lại do quét hoặc bị chặn có thể biến mất khỏi danh mục công khai và các bề mặt cài đặt trong khi
...
Xem [Đo từ xa](/vi/clawhub/telemetry), [API HTTP](/vi/clawhub/http-api), và
