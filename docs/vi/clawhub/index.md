...
title: ClawHub
x-i18n:
    generated_at: "2026-07-04T03:52:41Z"
    model: gpt-5.5
...
Cài đặt CLI ClawHub khi bạn muốn dùng các quy trình có xác thực registry như
...
Các thông số plugin trần an toàn cho npm có thể được phân giải qua npm trong các giai đoạn chuyển đổi khi ra mắt, và
...
được công bố trước khi chạy cài đặt archive. Khi một phiên bản gói xuất bản một
artifact ClawPack, OpenClaw ưu tiên đúng tệp `.tgz` npm-pack đã tải lên, xác minh
...
CLI cũng có các lệnh cài đặt/cập nhật skill cho những quy trình registry trực tiếp:
...
Các lệnh đó cài đặt Skills vào `./skills` bên dưới thư mục làm việc hiện tại
...
ClawHub chạy kiểm tra tự động trên Skills đã xuất bản và các bản phát hành plugin. Các bản phát hành
...
Khi bạn chạy `clawhub install` trong khi đã đăng nhập, CLI có thể gửi một sự kiện
