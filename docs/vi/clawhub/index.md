...
title: ClawHub
x-i18n:
    generated_at: "2026-07-03T23:35:49Z"
    model: gpt-5.5
...
Các đặc tả plugin an toàn cho npm ở dạng trần có thể phân giải qua npm trong các giai đoạn chuyển đổi khi ra mắt, và
...
được khai báo trước khi chạy cài đặt từ archive. Khi một phiên bản gói xuất bản một
...
Xuất bản Skills từ một thư mục cục bộ có chứa `SKILL.md`:
...
- `--slug <slug>`: tên URL của Skills đã xuất bản.
...
Theo mặc định, ClawHub là mở: bất kỳ ai cũng có thể tải lên, nhưng việc xuất bản yêu cầu một tài khoản GitHub
...
cài đặt theo cơ chế nỗ lực tối đa để ClawHub có thể tính số lượt cài đặt tổng hợp. Tắt tính năng này bằng:
...
Xem [Đo từ xa](/clawhub/telemetry), [HTTP API](/clawhub/http-api), và
