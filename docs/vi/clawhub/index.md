...
title: ClawHub
x-i18n:
    generated_at: "2026-07-01T15:26:01Z"
    model: gpt-5.5
...
Cài đặt CLI ClawHub khi bạn cần các quy trình có xác thực registry như phát hành hoặc xóa/khôi phục xóa:
...
Các đặc tả Plugin npm-safe dạng trần có thể được phân giải qua npm trong các giai đoạn chuyển đổi khi ra mắt, và
`npm:<package>` vẫn chỉ dùng npm khi nguồn cần được nêu rõ.

Quy trình cài đặt Plugin xác thực tính tương thích của `pluginApi` và `minGatewayVersion`
...
cài đặt theo nỗ lực tốt nhất để ClawHub có thể tính tổng số lượt cài đặt. Tắt tính năng này bằng:
