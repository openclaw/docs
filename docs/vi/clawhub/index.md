...
title: ClawHub
x-i18n:
    generated_at: "2026-06-28T06:20:16Z"
    model: gpt-5.5
...
Các thông số plugin thuần tương thích npm có thể được phân giải qua npm trong các giai đoạn chuyển đổi khi ra mắt, và
`npm:<package>` vẫn chỉ dùng npm khi cần chỉ rõ nguồn.

Lượt cài đặt plugin xác thực tính tương thích `pluginApi` và `minGatewayVersion`
được khai báo trước khi cài đặt archive chạy. Khi một phiên bản gói phát hành
...
ClawHub chạy các kiểm tra tự động trên Skills đã phát hành và các bản phát hành plugin. Những bản phát hành
