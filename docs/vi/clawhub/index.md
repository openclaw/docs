...
title: ClawHub
x-i18n:
    generated_at: "2026-07-01T08:12:28Z"
    model: gpt-5.5
...
Cài đặt ClawHub CLI khi bạn cần các quy trình có xác thực với registry, chẳng hạn như
...
Các đặc tả plugin trần an toàn với npm có thể được phân giải qua npm trong giai đoạn chuyển đổi phát hành, và
...
ClawHub CLI dùng cho công việc có xác thực với registry:
