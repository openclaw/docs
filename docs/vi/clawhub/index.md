...
title: ClawHub
x-i18n:
    generated_at: "2026-07-04T18:05:19Z"
    model: gpt-5.5
...
| -------------- | ------------------------------------------------------------ | -------------------------------------------- |
| Skills         | Các gói văn bản có phiên bản với `SKILL.md` và các tệp hỗ trợ | `openclaw skills install @openclaw/demo`     |
...
Lượt cài đặt Plugin xác thực tính tương thích của `pluginApi` và `minGatewayVersion`
được khai báo trước khi quá trình cài đặt archive chạy. Khi một phiên bản gói phát hành
...
[Mức sử dụng chấp nhận được](/vi/clawhub/acceptable-usage) để biết chi tiết về chính sách và thực thi.

## Telemetry và môi trường

Khi bạn chạy `clawhub install` trong lúc đã đăng nhập, CLI có thể gửi một sự kiện cài đặt theo mức nỗ lực tốt nhất
