...
summary: Tổng quan ClawHub công khai cho khám phá, cài đặt, xuất bản, bảo mật và CLI clawhub.
title: ClawHub
x-i18n:
    generated_at: "2026-07-03T00:58:07Z"
    model: gpt-5.5
...
| Bundle plugins | Các gói Plugin đã đóng gói cho bản phân phối OpenClaw       | `clawhub package publish <source>`           |
...
Các đặc tả Plugin không xung đột với npm có thể phân giải qua npm trong giai đoạn chuyển đổi phát hành, và
...
được công bố trước khi chạy cài đặt archive. Khi một phiên bản gói phát hành một
...
ClawHub mở theo mặc định: bất kỳ ai cũng có thể tải lên, nhưng việc phát hành yêu cầu tài khoản GitHub
...
ClawHub chạy kiểm tra tự động trên Skills và các bản phát hành Plugin đã công bố. Các bản phát hành
...
Khi bạn chạy `clawhub install` trong lúc đã đăng nhập, CLI có thể gửi một sự kiện cài đặt theo nỗ lực tối đa
