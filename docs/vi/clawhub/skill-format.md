...
x-i18n:
    generated_at: "2026-07-01T08:13:40Z"
    model: gpt-5.5
...
Chỉ các tệp “dạng văn bản” mới được chấp nhận khi xuất bản.
...
- Bất kỳ ai cũng có thể dùng, sửa đổi, và phân phối lại kỹ năng đã xuất bản, bao gồm cả mục đích thương mại.
...
- Nếu kỹ năng của bạn tích hợp với dịch vụ bên thứ ba có phí, hãy ghi rõ chi phí bên ngoài và tài khoản bắt buộc trong hướng dẫn kỹ năng và khai báo môi trường (`requires.env` cho biến bắt buộc, hoặc `envVars` với `required: false` cho biến tùy chọn).
