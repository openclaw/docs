...
read_when:
    - Xuất bản Skills
    - Gỡ lỗi các sự cố xuất bản/đồng bộ
...
- Không thêm siêu dữ liệu giá vào `SKILL.md`; nó không phải là một phần của định dạng kỹ năng và sẽ không khiến kỹ năng đã publish trở thành kỹ năng trả phí.
