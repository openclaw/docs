...
x-i18n:
    generated_at: "2026-07-04T18:06:18Z"
    model: gpt-5.5
...
các tệp `SKILL.md` hoặc `skills.md` cũ trong kho công khai, không phải fork, thuộc sở hữu của
...
- Phạm vi package phải khớp chính xác với định danh nhà xuất bản ClawHub. Định danh nhà xuất bản có thể dùng chữ thường, số, dấu gạch nối, dấu chấm, và dấu gạch dưới; chúng phải bắt đầu và kết thúc bằng chữ thường hoặc số.
...
- Không thêm siêu dữ liệu giá vào `SKILL.md`; nó không phải là một phần của định dạng kỹ năng và sẽ không khiến kỹ năng đã xuất bản trở thành trả phí.
