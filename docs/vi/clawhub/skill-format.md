...
x-i18n:
    generated_at: "2026-07-01T15:26:52Z"
    model: gpt-5.5
...
- Nếu kỹ năng của bạn tích hợp với một dịch vụ bên thứ ba có tính phí, hãy ghi rõ chi phí bên ngoài và tài khoản bắt buộc trong hướng dẫn kỹ năng và khai báo môi trường (`requires.env` cho biến bắt buộc, hoặc `envVars` với `required: false` cho biến tùy chọn).
