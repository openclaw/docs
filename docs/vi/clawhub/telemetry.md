...
summary: Cài đặt đo từ xa do ClawHub CLI thu thập và cách chọn không tham gia.
x-i18n:
    generated_at: "2026-07-03T15:33:28Z"
    model: gpt-5.5
...
Trên mỗi lệnh `clawhub install` được báo cáo, CLI gửi một sự kiện cài đặt theo nỗ lực tốt nhất.
