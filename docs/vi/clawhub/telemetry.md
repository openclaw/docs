...
summary: Cài đặt tính năng đo từ xa được CLI ClawHub thu thập và cách chọn không tham gia.
x-i18n:
    generated_at: "2026-07-01T18:14:12Z"
    model: gpt-5.5
...
- Không có đường dẫn thư mục hoặc mã định danh có nguồn gốc từ thư mục.
