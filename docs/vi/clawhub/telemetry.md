...
summary: Cài đặt phép đo từ xa do ClawHub CLI thu thập và cách chọn không tham gia.
x-i18n:
    generated_at: "2026-07-03T09:45:05Z"
    model: gpt-5.5
...
Với mỗi `clawhub install` được báo cáo, CLI gửi một sự kiện cài đặt theo cơ chế cố gắng tối đa.
