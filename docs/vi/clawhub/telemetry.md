...
summary: Dữ liệu đo từ xa về quá trình cài đặt do ClawHub CLI thu thập và cách chọn không tham gia.
x-i18n:
    generated_at: "2026-07-02T22:37:05Z"
    model: gpt-5.5
...
ClawHub duy trì bộ đếm tổng hợp cho mỗi skill:
