...
summary: Cài đặt dữ liệu đo từ xa do ClawHub CLI thu thập và cách chọn không tham gia.
x-i18n:
    generated_at: "2026-07-02T08:29:14Z"
    model: gpt-5.5
...
Với mỗi lệnh `clawhub install` được báo cáo, CLI gửi một sự kiện cài đặt theo cơ chế cố gắng tối đa.
...
- Không có nhật ký theo từng lượt chạy, lời nhắc hoặc đầu ra CLI khác.
