---
read_when:
    - Đang làm việc trên các điều khiển đo lường từ xa / quyền riêng tư
    - Câu hỏi về dữ liệu nào được thu thập
summary: Dữ liệu telemetry cài đặt được CLI ClawHub thu thập và cách chọn không tham gia.
x-i18n:
...
Với mỗi lần `clawhub install` được báo cáo, CLI gửi một sự kiện cài đặt theo nguyên tắc nỗ lực tối đa.
...
- Không có đường dẫn thư mục hoặc mã định danh phát sinh từ thư mục.
