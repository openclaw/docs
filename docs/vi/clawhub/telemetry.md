...
summary: Dữ liệu đo từ xa khi cài đặt do ClawHub CLI thu thập và cách chọn không tham gia.
x-i18n:
    generated_at: "2026-07-05T05:13:56Z"
    model: gpt-5.5
...
ClawHub dùng dữ liệu đo từ xa CLI ở mức tối thiểu để tính tổng số lượt cài đặt. 
...
Trong mỗi lần `clawhub install` được báo cáo, CLI gửi một sự kiện cài đặt theo nguyên tắc nỗ lực tối đa.
...
- `installsAllTime`: số người dùng duy nhất đã báo cáo ít nhất một lần cài đặt kỹ năng qua CLI.
- `installsCurrent`: số người dùng duy nhất đã báo cáo một lần cài đặt và chưa xóa dữ liệu
  đo từ xa của họ.

## Tính minh bạch + quyền kiểm soát của người dùng

Mọi người chỉ thấy **bộ đếm lượt cài đặt đã tổng hợp**.
