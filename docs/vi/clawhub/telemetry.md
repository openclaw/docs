...
summary: Dữ liệu đo từ xa khi cài đặt do ClawHub CLI thu thập và cách từ chối tham gia.
x-i18n:
    generated_at: "2026-06-30T14:09:47Z"
    model: gpt-5.5
...
Với mỗi lần `clawhub install` được báo cáo, CLI gửi một sự kiện cài đặt theo cơ chế nỗ lực tối đa.
