...
ClawHub sử dụng đo từ xa CLI ở mức tối thiểu để tính số lượt cài đặt tổng hợp.
...
Với mỗi lệnh `clawhub install` được báo cáo, CLI gửi một sự kiện cài đặt theo nỗ lực tối đa.
