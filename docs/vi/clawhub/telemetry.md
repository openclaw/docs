---
read_when:
    - Đang phát triển các điều khiển về đo lường từ xa / quyền riêng tư
    - Câu hỏi về dữ liệu được thu thập
summary: Dữ liệu đo lường khi cài đặt do ClawHub CLI thu thập và cách chọn không tham gia.
x-i18n:
    generated_at: "2026-07-01T13:09:54Z"
    model: gpt-5.5
...
- `installsAllTime`: số người dùng duy nhất đã báo cáo ít nhất một lần cài đặt CLI cho kỹ năng.
- `installsCurrent`: số người dùng duy nhất đã báo cáo một lần cài đặt và chưa xóa
  telemetry của họ.
