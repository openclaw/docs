---
read_when:
    - Đang xử lý các kiểm soát telemetry / quyền riêng tư
...
x-i18n:
    generated_at: "2026-07-03T02:51:32Z"
    model: gpt-5.5
...
Với mỗi lần `clawhub install` được báo cáo, CLI gửi một sự kiện cài đặt theo nỗ lực tối đa.
...
- `installsCurrent`: người dùng duy nhất đã báo cáo một lần cài đặt và chưa xóa dữ liệu đo từ xa
  của họ.
