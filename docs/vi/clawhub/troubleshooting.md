---
read_when:
    - Các lệnh ClawHub CLI hoặc sổ đăng ký OpenClaw không thành công
...
- Trong môi trường không có giao diện, hãy tạo token API trong giao diện web của ClawHub rồi chạy:
...
Đối với plugins, hãy kiểm tra siêu dữ liệu tương thích trong `package.json`. Việc xuất bản code-plugin
...
## Xuất bản thất bại vì namespace đã được xác nhận hoặc được dành riêng

Nếu việc xuất bản thất bại vì handle chủ sở hữu, namespace tổ chức, phạm vi gói, slug skill
hoặc tên gói đã được xác nhận hoặc được dành riêng, trước tiên hãy xác nhận rằng bạn đang
xuất bản bằng chủ sở hữu khớp với namespace. Đối với gói plugin,
...
[Xác nhận tổ chức và Namespace](/vi/clawhub/namespace-claims) để biết hướng dẫn về bằng chứng và những gì
...
- Liên kết người dùng trở lại mục niêm yết ClawHub chuẩn.
- Không phản chiếu nội dung bị ẩn, riêng tư, bị giữ hoặc bị chặn bởi kiểm duyệt ra ngoài
