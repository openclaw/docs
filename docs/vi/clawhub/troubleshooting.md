...
- `RateLimit-Remaining`: ngân sách chính xác còn lại của bạn khi header này có mặt. Với `429`, giá trị này là `0`.
...
## Xuất bản thất bại vì một namespace đã được nhận hoặc dành riêng

Nếu việc xuất bản thất bại vì handle chủ sở hữu, namespace tổ chức, phạm vi gói, slug skill
hoặc tên gói đã được nhận hoặc dành riêng, trước tiên hãy xác nhận rằng bạn đang
...
Các tệp cục bộ không khớp với bất kỳ phiên bản nào ClawHub biết đến. Chọn một cách:
...
- Liên kết người dùng về danh sách ClawHub chính thức.
