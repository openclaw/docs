...
x-i18n:
    generated_at: "2026-07-01T15:26:33Z"
    model: gpt-5.5
...
- Trong môi trường không có giao diện đồ họa, hãy tạo API token trong giao diện web ClawHub rồi chạy:
...
- `RateLimit-Remaining`: ngân sách chính xác còn lại của bạn khi header hiện diện. Khi gặp `429`, giá trị này là `0`.
...
Nếu xuất bản thất bại vì handle chủ sở hữu, namespace tổ chức, phạm vi gói, slug Skill
...
Xem trước trước nếu bạn chưa chắc nội dung nào sẽ được xuất bản:
...
- Xác nhận phiên bản OpenClaw của bạn đáp ứng khoảng tương thích
  mà gói công bố.
...
- Tôn trọng các header thử lại `429` và lưu bộ nhớ đệm các phản hồi danh sách/tìm kiếm công khai.
