---
read_when:
    - ClawHub CLI hoặc các lệnh kho đăng ký của OpenClaw bị lỗi
...
Đối với plugin, hãy kiểm tra siêu dữ liệu tương thích trong `package.json`. Các lần publish code-plugin
