...
x-i18n:
    generated_at: "2026-07-01T20:26:51Z"
    model: gpt-5.5
...
CLI tôn trọng các biến proxy chuẩn:
...
Đối với plugins, hãy kiểm tra metadata tương thích trong `package.json`. Các lần xuất bản code-plugin
...
- Xác nhận phiên bản OpenClaw của bạn thỏa mãn phạm vi tương thích
  mà gói công bố.
