...
summary: Khắc phục sự cố đăng nhập, cài đặt, phát hành, đồng bộ hóa, cập nhật và API của ClawHub.
x-i18n:
    generated_at: "2026-05-12T04:10:29Z"
    model: gpt-5.5
    provider: openai
...
ClawHub dùng danh tính GitHub và quy nguồn để kết nối các gói với
...
Các tệp cục bộ không khớp với bất kỳ phiên bản nào ClawHub biết. Hãy chọn một:
...
- Không phản chiếu nội dung bị ẩn, riêng tư, bị giữ lại hoặc bị chặn kiểm duyệt ra ngoài
