...
- Kiểm tra quy tắc tường lửa cục bộ, VPN và proxy nếu callback không bao giờ đến.
...
## Tìm kiếm hoặc cài đặt thất bại khi ở sau proxy
...
Nếu xuất bản thất bại vì handle chủ sở hữu, namespace tổ chức, scope gói, slug Skills
hoặc tên gói đã được nhận hoặc được giữ riêng, trước tiên hãy xác nhận bạn đang
...
[Khiếu nại tổ chức và Namespace](/clawhub/namespace-claims) để biết hướng dẫn bằng chứng và những gì
cần tránh đưa vào vấn đề công khai.

## `sync` nói không tìm thấy Skills nào
...
Xem trước nếu bạn chưa chắc nội dung nào sẽ được xuất bản:
