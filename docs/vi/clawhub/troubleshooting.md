...
- Trong môi trường không có giao diện, hãy tạo một API token trong giao diện web ClawHub rồi chạy:
...
- `RateLimit-Remaining`: ngân sách chính xác còn lại của bạn khi header này có mặt. Với `429`, giá trị là `0`.
...
người chỉ gửi một vài yêu cầu. Hãy đăng nhập khi có thể và thử lại sau khoảng trễ
được báo cáo.
...
Đối với kỹ năng, hãy kiểm tra frontmatter trong `SKILL.md`. Các biến môi trường và
...
xuất bản bằng chủ sở hữu khớp với namespace đó. Đối với các gói plugin,
...
[Yêu cầu tổ chức và Namespace](/vi/clawhub/namespace-claims) để biết hướng dẫn về bằng chứng và những gì
...
Trỏ lệnh tới các gốc bạn muốn quét:
