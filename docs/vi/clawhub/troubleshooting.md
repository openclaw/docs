...
- Trong môi trường không có giao diện đồ họa, tạo một token API trong giao diện web ClawHub rồi chạy:
...
Đối với Plugin, kiểm tra siêu dữ liệu tương thích trong `package.json`. Việc xuất bản code-plugin
...
- Liên kết người dùng về mục ClawHub chính tắc.
