...
x-i18n:
    generated_at: "2026-07-03T17:28:42Z"
    model: gpt-5.5
...
CLI tuân thủ các biến proxy tiêu chuẩn:
...
## Đăng tải thất bại vì thiếu metadata bắt buộc
...
Đối với plugins, hãy kiểm tra metadata tương thích trong `package.json`. Việc đăng tải
...
- Hãy đảm bảo bạn đã đăng nhập bằng tài khoản GitHub sở hữu hoặc có quyền đăng tải
  gói.
...
## Đăng tải thất bại vì namespace đã được xác nhận hoặc đặt trước

Nếu đăng tải thất bại vì handle chủ sở hữu, namespace tổ chức, phạm vi gói, slug skill
hoặc tên gói đã được xác nhận hoặc đặt trước, trước tiên hãy xác nhận bạn đang
đăng tải với chủ sở hữu khớp với namespace đó. Đối với gói plugin,
các tên có phạm vi như `@example-org/example-plugin` phải được đăng tải dưới chủ sở hữu
`example-org` tương ứng.

Nếu bạn tin rằng tổ chức, dự án hoặc thương hiệu của mình là chủ sở hữu namespace hợp pháp nhưng
không thể quản lý chủ sở hữu ClawHub hiện tại, hãy mở
...
[Yêu cầu tổ chức và namespace](/vi/clawhub/namespace-claims) để biết hướng dẫn bằng chứng và những gì
...
Xem trước trước nếu bạn không chắc nội dung nào sẽ được đăng tải:
...
- Đăng tải bản sao đã chỉnh sửa của bạn dưới dạng slug hoặc fork mới.
...
- Xác nhận phiên bản OpenClaw của bạn thỏa mãn dải tương thích được gói
  quảng bá.
