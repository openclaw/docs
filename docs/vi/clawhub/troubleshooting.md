---
read_when:
    - CLI ClawHub hoặc các lệnh sổ đăng ký OpenClaw thất bại
    - Không thể cài đặt, phát hành hoặc cập nhật gói
summary: Khắc phục các sự cố đăng nhập, cài đặt, phát hành, đồng bộ hóa, cập nhật và API của ClawHub.
x-i18n:
    generated_at: "2026-05-11T22:20:23Z"
    model: gpt-5.5
    provider: openai
