...
x-i18n:
    generated_at: "2026-06-30T14:07:20Z"
    model: gpt-5.5
...
Các tài khoản đã bị xóa, bị cấm hoặc bị vô hiệu hóa không thể hoàn tất quy trình đăng nhập ClawHub bình thường.
Nếu sau khi đăng nhập bạn bị đưa trở lại trạng thái chưa đăng nhập, tài khoản của bạn có thể không ở trạng thái
tốt. Nếu tài khoản của bạn đã bị cấm hoặc bị vô hiệu hóa, hãy dùng
...
quy tắc proxy, hãy dùng luồng token không cần giao diện.

## Đăng nhập không cần giao diện
...
Các tài khoản đã bị xóa, bị cấm hoặc bị vô hiệu hóa không thể tiếp tục dùng các token API hiện có.
