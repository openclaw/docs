...
ClawHub sử dụng GitHub để đăng nhập web. CLI sử dụng các mã thông báo API ClawHub được tạo
...
quy tắc proxy, hãy dùng luồng mã thông báo không cần trình duyệt.
