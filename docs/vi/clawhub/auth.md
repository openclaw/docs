...
x-i18n:
    generated_at: "2026-07-03T13:35:10Z"
    model: gpt-5.5
...
Nếu việc đăng nhập đưa bạn trở lại trạng thái đã đăng xuất, tài khoản của bạn có thể không ở trạng thái
tốt. Nếu tài khoản của bạn bị cấm hoặc bị vô hiệu hóa, hãy sử dụng
...
quy tắc proxy, hãy sử dụng luồng mã thông báo không giao diện.

## Đăng nhập không giao diện

Tạo mã thông báo trong giao diện web ClawHub, sau đó truyền mã đó cho CLI:
