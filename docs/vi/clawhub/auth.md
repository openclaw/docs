...
x-i18n:
    generated_at: "2026-07-02T17:41:02Z"
    model: gpt-5.5
...
Nếu sau khi đăng nhập bạn quay lại trạng thái đã đăng xuất, tài khoản của bạn có thể không ở trạng thái
hợp lệ. Nếu tài khoản của bạn bị cấm hoặc bị vô hiệu hóa, hãy sử dụng
