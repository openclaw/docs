...
Nếu quá trình đăng nhập đưa bạn trở lại trạng thái đã đăng xuất, tài khoản của bạn có thể không ở trạng thái
tốt.
...
quy tắc proxy, hãy sử dụng luồng mã thông báo không cần trình duyệt.

## Đăng nhập không cần trình duyệt

Tạo một mã thông báo trong giao diện web ClawHub, rồi truyền nó cho CLI:
...
Các tài khoản đã bị xóa, bị cấm hoặc bị vô hiệu hóa không thể tiếp tục sử dụng các mã thông báo API hiện có.
