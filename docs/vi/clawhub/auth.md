...
Nếu đăng nhập đưa bạn trở lại trạng thái đã đăng xuất, tài khoản của bạn có thể không còn ở
trạng thái hợp lệ. Nếu tài khoản của bạn bị cấm hoặc bị vô hiệu hóa, hãy sử dụng
...
quy tắc proxy, hãy sử dụng luồng token không cần giao diện.
...
Token bị thu hồi, không hợp lệ hoặc bị thiếu sẽ trả về `401 Unauthorized`. Đăng nhập lại
...
Nếu tài khoản của bạn bị cấm hoặc bị vô hiệu hóa, hãy sử dụng
[biểu mẫu kháng nghị ClawHub](https://appeals.openclaw.ai/) nếu bạn cho rằng đây là
nhầm lẫn.
