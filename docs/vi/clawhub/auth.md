...
x-i18n:
    generated_at: "2026-07-04T20:33:06Z"
    model: gpt-5.5
...
proxy, hãy sử dụng luồng mã thông báo headless.

## Đăng nhập headless

Tạo một mã thông báo trong giao diện web ClawHub, sau đó truyền nó cho CLI:
...
CLI in ra một mã dùng một lần và chờ trong khi bạn ủy quyền cho mã đó tại
