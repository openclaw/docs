...
Tài khoản đã bị xóa, bị cấm hoặc bị vô hiệu hóa không thể hoàn tất đăng nhập ClawHub
thông thường. Nếu đăng nhập đưa bạn trở lại trạng thái đã đăng xuất, tài khoản
của bạn có thể không ở trạng thái tốt. Nếu tài khoản của bạn đã bị cấm hoặc bị
vô hiệu hóa, hãy dùng
...
Nếu trình duyệt của bạn không thể truy cập callback cục bộ vì quy tắc tường lửa,
VPN hoặc proxy, hãy dùng luồng token headless.
...
CLI in ra mã dùng một lần và chờ trong khi bạn cấp quyền tại
...
Tài khoản đã bị xóa, bị cấm hoặc bị vô hiệu hóa không thể tiếp tục dùng các token API
hiện có. Nếu tài khoản của bạn đã bị cấm hoặc bị vô hiệu hóa, hãy dùng
[biểu mẫu kháng nghị ClawHub](https://appeals.openclaw.ai/) nếu bạn cho rằng đây là
một nhầm lẫn.
