...
x-i18n:
    generated_at: "2026-07-02T22:36:38Z"
    model: gpt-5.5
...
ClawHub dùng GitHub để đăng nhập trên web. CLI dùng token API ClawHub được tạo
...
Tài khoản đã bị xóa, bị cấm hoặc bị vô hiệu hóa không thể hoàn tất quy trình đăng nhập ClawHub thông thường.
Nếu đăng nhập đưa bạn trở lại trạng thái chưa đăng nhập, tài khoản của bạn có thể không còn ở trạng thái hợp lệ.
Nếu tài khoản của bạn bị cấm hoặc bị vô hiệu hóa, hãy dùng
...
Nếu trình duyệt của bạn không thể truy cập callback cục bộ do quy tắc tường lửa, VPN hoặc
proxy, hãy dùng luồng token không giao diện.
...
Tài khoản đã bị xóa, bị cấm hoặc bị vô hiệu hóa không thể tiếp tục dùng các token API hiện có.
Nếu tài khoản của bạn bị cấm hoặc bị vô hiệu hóa, hãy dùng
[biểu mẫu khiếu nại ClawHub](https://appeals.openclaw.ai/) nếu bạn cho rằng đây là
nhầm lẫn.
