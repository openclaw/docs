...
Nếu đăng nhập đưa bạn trở lại trạng thái đã đăng xuất, tài khoản của bạn có thể không ở trạng thái hợp lệ.
...
proxy, hãy dùng luồng token headless.

## Đăng nhập headless

Tạo token trong giao diện web ClawHub, sau đó truyền token đó cho CLI:
...
Với shell từ xa nơi bạn có thể mở trình duyệt ở nơi khác, chạy:
