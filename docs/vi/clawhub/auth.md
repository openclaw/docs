...
x-i18n:
    generated_at: "2026-07-03T23:34:58Z"
    model: gpt-5.5
...
Nếu đăng nhập đưa bạn trở lại trạng thái đã đăng xuất, tài khoản của bạn có thể không ở
trạng thái hợp lệ. Nếu tài khoản của bạn bị cấm hoặc bị vô hiệu hóa, hãy dùng
...
quy tắc proxy, hãy dùng luồng token không giao diện.
...
Các tài khoản đã bị xóa, bị cấm hoặc bị vô hiệu hóa không thể tiếp tục dùng token API hiện có.
