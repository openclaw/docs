...
ClawHub sử dụng GitHub để đăng nhập trên web. CLI sử dụng các mã thông báo API ClawHub được tạo
...
Nếu sau khi đăng nhập bạn bị đưa trở lại trạng thái đã đăng xuất, tài khoản của bạn có thể không ở trạng thái
tốt. Nếu tài khoản của bạn bị cấm hoặc vô hiệu hóa, hãy dùng
...
Tạo mã thông báo trong giao diện web ClawHub, rồi truyền mã đó cho CLI:
...
Mã thông báo đã bị thu hồi, không hợp lệ hoặc bị thiếu sẽ trả về `401 Unauthorized`. Hãy đăng nhập lại
...
Nếu tài khoản của bạn bị cấm hoặc vô hiệu hóa, hãy dùng
[biểu mẫu khiếu nại ClawHub](https://appeals.openclaw.ai/) nếu bạn cho rằng đây là
nhầm lẫn.
