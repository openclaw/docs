...
khi bạn đăng nhập, xuất bản, quản lý listing của riêng mình, hoặc dùng
...
Trước khi xuất bản, kiểm tra siêu dữ liệu trong `SKILL.md`. Khai báo các
...
Dùng `--dry-run` trước để xem trước siêu dữ liệu gói đã được phân giải, các
...
## Đồng bộ các kỹ năng bạn bảo trì
...
tổng hợp số lượt cài đặt. Xem [Telemetry](/vi/clawhub/telemetry) để biết thông tin
nào được báo cáo và cách chọn không tham gia.

## Kiểm tra trước khi cài đặt

Trước khi cài đặt, dùng trang web ClawHub hoặc các lệnh chi tiết của CLI để
