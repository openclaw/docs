...
ClawHub là một registry cho các kỹ năng và plugin OpenClaw.

Dùng OpenClaw khi bạn đang cài đặt mọi thứ vào OpenClaw. Dùng CLI `clawhub`
khi bạn đang đăng nhập, xuất bản, quản lý listing của riêng mình, hoặc dùng
...
Khi bạn đã đăng nhập, `sync` cũng có thể gửi một bản chụp cài đặt tối thiểu cho
...
giữ lại hoặc bị moderation chặn có thể bị ẩn khỏi bề mặt tìm kiếm và cài đặt
