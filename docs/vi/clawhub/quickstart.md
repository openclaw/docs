...
read_when:
    ...
    - Cài đặt một Skill hoặc Plugin từ kho đăng ký
    - Đăng lên ClawHub
...
khi bạn đăng nhập, xuất bản, quản lý listing của riêng mình, hoặc sử dụng
...
trước khi họ cài đặt nó. Xem [Định dạng skill](/vi/clawhub/skill-format).

Đối với các repository chứa nhiều skill, workflow GitHub tái sử dụng sẽ gọi
...
Xuất bản một plugin từ thư mục cục bộ, GitHub repo, GitHub ref, hoặc một
archive hiện có:
