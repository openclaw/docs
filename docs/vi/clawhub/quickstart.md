...
x-i18n:
    generated_at: "2026-07-03T17:28:47Z"
    model: gpt-5.5
...
Đối với các kho chứa nhiều kỹ năng, workflow GitHub có thể tái sử dụng gọi
`skill publish` cho từng thư mục kỹ năng trực tiếp dưới `skills/`:
