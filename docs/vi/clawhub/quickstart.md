...
x-i18n:
    generated_at: "2026-07-03T13:35:36Z"
    model: gpt-5.5
...
các quy trình làm việc riêng cho kho đăng ký.
...
Một skill là một thư mục có tệp bắt buộc `SKILL.md` và các tệp hỗ trợ tùy chọn.
...
Đối với các kho chứa nhiều skill, quy trình làm việc GitHub tái sử dụng sẽ gọi
