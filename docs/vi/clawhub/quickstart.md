...
x-i18n:
    generated_at: "2026-07-01T08:13:35Z"
    model: gpt-5.5
...
khi bạn đang đăng nhập, phát hành, quản lý các listing của riêng mình, hoặc dùng
...
tự động phát hành phiên bản patch tiếp theo. Dùng `--dry-run` để xem trước hoặc
...
ghi nhận nguồn và kế hoạch tải lên mà không phát hành.
