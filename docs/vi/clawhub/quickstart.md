...
x-i18n:
    generated_at: "2026-07-01T13:06:22Z"
    model: gpt-5.5
...
OpenClaw ghi lại skill đó đến từ đâu để các bản cập nhật sau này có thể tiếp tục
...
tương thích, ghi nguồn và kế hoạch tải lên mà không xuất bản.
...
Trước khi cài đặt, dùng trang web ClawHub hoặc các lệnh chi tiết CLI để kiểm tra
