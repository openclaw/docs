...
x-i18n:
    generated_at: "2026-07-01T18:14:21Z"
    model: gpt-5.5
...
Đối với các kho chứa nhiều kỹ năng, workflow GitHub dùng lại được sẽ gọi
...
Phát hành plugin từ một thư mục cục bộ, kho GitHub, ref GitHub hoặc một
bản lưu trữ hiện có:
