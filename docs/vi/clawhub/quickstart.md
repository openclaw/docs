...
x-i18n:
    generated_at: "2026-07-03T23:36:09Z"
    model: gpt-5.5
...
biến môi trường, công cụ và quyền cần thiết để người dùng có thể hiểu skill cần gì
trước khi cài đặt. Xem [Định dạng skill](/vi/clawhub/skill-format).

Với các repository chứa nhiều skill, workflow GitHub có thể tái sử dụng sẽ gọi
...
Phát hành một plugin từ thư mục cục bộ, GitHub repo, GitHub ref, hoặc một
archive hiện có:
