...
Gốc: `https://clawhub.ai`

OpenAPI: `/api/v1/openapi.json`

## Tái sử dụng danh mục công khai

Bạn có thể xây dựng danh mục, thư mục hoặc bề mặt tìm kiếm của bên thứ ba dựa trên các API đọc công khai của ClawHub. Siêu dữ liệu kỹ năng công khai và tệp kỹ năng được phát hành theo các quy tắc giấy phép kỹ năng của ClawHub, trong khi chính API có giới hạn tốc độ và nên được sử dụng một cách có trách nhiệm.
...
- Lưu phản hồi vào bộ nhớ đệm và tuân thủ `429`, `Retry-After` cũng như các header giới hạn tốc độ thay vì thăm dò quá dày đặc.
...
- Không sao chép nội dung ẩn, riêng tư hoặc bị chặn kiểm duyệt bằng cách vượt qua các bộ lọc API công khai hoặc ranh giới xác thực.
...
- Token thiếu/không hợp lệ sẽ quay lại thực thi theo IP.
