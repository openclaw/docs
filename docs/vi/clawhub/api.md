...
read_when:
    ...
    - Thêm các điểm cuối hoặc lược đồ
...
- Dùng URL trang chuẩn theo dạng `https://clawhub.ai/<owner>/<slug>`.
- Không ngụ ý rằng ClawHub chứng thực, xác minh hoặc vận hành trang web bên thứ ba.
...
- `POST /api/v1/users/reserve` giữ trước root slug và các phần giữ chỗ gói riêng tư không có bản phát hành cho một handle chủ sở hữu.
