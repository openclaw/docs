...
summary: Cách các mục đăng, phiên bản, lượt cài đặt, quy trình phát hành, quét và cập nhật của ClawHub hoạt động.
x-i18n:
    generated_at: "2026-07-03T23:35:35Z"
    model: gpt-5.5
...
ClawHub mở cho việc phát hành, nhưng các bản phát hành vẫn phải tuân theo các cổng tải lên,
...
tải xuống. Các catalog bên thứ ba có thể dùng các API này khi chúng liên kết lại đến
