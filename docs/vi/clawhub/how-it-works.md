...
summary: Cách các mục niêm yết, phiên bản, lượt cài đặt, quy trình xuất bản, quét và cập nhật của ClawHub hoạt động.
x-i18n:
...
Việc phát hành tạo ra một bản ghi phiên bản bất biến mới. Nhà phát hành dùng CLI `clawhub`
...
tải xuống. Các danh mục bên thứ ba có thể dùng các API này khi chúng liên kết lại đến
