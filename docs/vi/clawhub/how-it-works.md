...
x-i18n:
    generated_at: "2026-07-04T15:23:02Z"
    model: gpt-5.5
...
ClawHub là lớp registry cho các kỹ năng và plugin của OpenClaw. Nó cung cấp cho người dùng
...
Trang mục là nơi chuẩn để người dùng kiểm tra một kỹ năng hoặc
...
ClawHub cho phép xuất bản mở, nhưng các bản phát hành vẫn chịu sự chi phối của cổng tải lên,
...
tải xuống. Các danh mục của bên thứ ba có thể dùng các API này khi chúng liên kết về
mục ClawHub chuẩn, tôn trọng giới hạn tốc độ và tránh ngụ ý được xác nhận.
