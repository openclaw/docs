...
summary: Cách hoạt động của danh sách hiển thị, phiên bản, lượt cài đặt, quy trình xuất bản, quét và cập nhật trên ClawHub.
x-i18n:
...
ClawHub là lớp sổ đăng ký cho Skills và plugins của OpenClaw. Nó cung cấp cho người dùng một
...
Mỗi mục niêm yết công khai là một bản ghi sổ đăng ký có:

- chủ sở hữu và slug hoặc tên gói
- một hoặc nhiều phiên bản đã phát hành
- siêu dữ liệu, tóm tắt, tệp và thông tin quy nguồn
...
giúp các lượt quét tự động phát hiện sự không khớp giữa hành vi được khai báo và hành vi quan sát được.

Xem [Định dạng skill](/vi/clawhub/skill-format).

## Plugins

Plugins là các phần mở rộng OpenClaw được đóng gói. ClawHub lưu trữ siêu dữ liệu gói,
...
Sử dụng nguồn cài đặt ClawHub rõ ràng khi bạn muốn sổ đăng ký là
nguồn sự thật:
...
Việc xuất bản tạo một bản ghi phiên bản bất biến mới. Nhà phát hành sử dụng CLI `clawhub`
...
hiển thị siêu dữ liệu đã xuất bản, tệp, thông tin quy nguồn và trạng thái quét.
...
gói sổ đăng ký sau này. CLI ClawHub cũng hỗ trợ các quy trình cài đặt và
...
ClawHub mở cho việc xuất bản, nhưng các bản phát hành vẫn phải tuân theo cổng tải lên,
...
[Việc sử dụng được chấp nhận](/vi/clawhub/acceptable-usage).

## Truy cập API

ClawHub cung cấp các API đọc công khai để khám phá, tìm kiếm, xem chi tiết gói và
tải xuống. Các danh mục bên thứ ba có thể sử dụng các API này khi chúng liên kết lại đến
