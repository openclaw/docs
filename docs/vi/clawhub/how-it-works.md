...
summary: Cách hoạt động của danh sách, phiên bản, lượt cài đặt, xuất bản, quét và cập nhật trên ClawHub.
x-i18n:
    generated_at: "2026-06-30T22:20:35Z"
    model: gpt-5.5
...
Mỗi mục công khai là một bản ghi registry với:
...
Trang mục là nơi chuẩn để người dùng kiểm tra một skill hoặc
...
giúp các lượt quét tự động phát hiện sai khác giữa hành vi được khai báo và hành vi quan sát được.
...
ClawHub mở cho việc xuất bản, nhưng các bản phát hành vẫn chịu sự chi phối của các cổng tải lên,
...
mục ClawHub chuẩn, tôn trọng giới hạn tốc độ và tránh ngụ ý sự chứng thực.
