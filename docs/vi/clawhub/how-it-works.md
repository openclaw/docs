...
summary: Cách hoạt động của các mục niêm yết, phiên bản, lượt cài đặt, quy trình xuất bản, quét và cập nhật của ClawHub.
x-i18n:
...
ClawHub là lớp sổ đăng ký cho skills và plugin của OpenClaw. Nó cung cấp cho người dùng
...
- siêu dữ liệu, tóm tắt, tệp và ghi nguồn
...
ClawHub đọc phần đầu của `SKILL.md` để hiểu tên skill,
...
Dùng chạy thử để xem trước tải trọng đã phân giải trước khi tải lên. Sau đó, các trang công khai
hiển thị siêu dữ liệu đã xuất bản, tệp, ghi nguồn và trạng thái quét.
...
Các trang công khai hiển thị tóm tắt quét khi có. Nội dung bị giữ lại, bị ẩn,
hoặc bị chặn có thể biến mất khỏi tìm kiếm công khai và luồng cài đặt trong khi vẫn
...
tải xuống. Các catalog bên thứ ba có thể dùng những API này khi chúng liên kết lại đến
mục niêm yết ClawHub chính thức, tôn trọng giới hạn tần suất và tránh ngụ ý được chứng thực.
