...
x-i18n:
    generated_at: "2026-07-01T15:26:21Z"
    model: gpt-5.5
...
Mỗi danh sách công khai là một bản ghi registry có:
...
gói registry về sau. CLI ClawHub cũng hỗ trợ trực tiếp các quy trình cài đặt và
cập nhật skill cho người dùng muốn có các thư mục skill do registry quản lý bên ngoài một
...
tải xuống. Các catalog bên thứ ba có thể sử dụng những API này khi chúng liên kết trở lại
