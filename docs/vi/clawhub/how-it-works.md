...
x-i18n:
    generated_at: "2026-07-01T08:12:48Z"
    model: gpt-5.5
...
phiên bản Gateway tối thiểu, mục tiêu host, yêu cầu môi trường, và mã băm artifact.
...
tải xuống. Các catalog của bên thứ ba có thể dùng những API này khi chúng liên kết lại đến
