...
summary: Cách hoạt động của danh sách, phiên bản, lượt cài đặt, việc xuất bản, quét và cập nhật trên ClawHub.
x-i18n:
...
gói sổ đăng ký đó về sau. CLI ClawHub cũng hỗ trợ các quy trình cài đặt và
cập nhật skill trực tiếp cho người dùng muốn các thư mục skill do sổ đăng ký quản lý bên ngoài
...
tải xuống. Các danh mục bên thứ ba có thể sử dụng các API này khi chúng liên kết trở lại
danh sách ClawHub chính thức, tôn trọng giới hạn tốc độ và tránh ngụ ý được chứng thực.
