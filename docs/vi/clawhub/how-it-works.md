...
x-i18n:
    generated_at: "2026-07-04T10:45:13Z"
    model: gpt-5.5
...
Trang mục niêm yết là nơi chính thức để người dùng kiểm tra kỹ năng hoặc
...
Plugin là các tiện ích mở rộng OpenClaw đã được đóng gói. ClawHub lưu trữ siêu dữ liệu gói,
...
phiên bản gateway tối thiểu, mục tiêu máy chủ, yêu cầu môi trường và bản tóm lược
artifact.
...
cập nhật kỹ năng trực tiếp cho người dùng muốn có các thư mục kỹ năng do registry quản lý bên ngoài
một workspace OpenClaw đầy đủ.

## Trạng thái bảo mật

ClawHub cho phép phát hành mở, nhưng các bản phát hành vẫn chịu các cổng tải lên,
