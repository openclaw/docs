...
summary: Cách hoạt động của danh sách, phiên bản, lượt cài đặt, quy trình xuất bản, quét và cập nhật trên ClawHub.
x-i18n:
    generated_at: "2026-07-03T09:40:15Z"
    model: gpt-5.5
...
Sử dụng nguồn cài đặt ClawHub tường minh khi bạn muốn registry là
nguồn sự thật:
...
Việc xuất bản tạo một bản ghi phiên bản bất biến mới. Nhà xuất bản sử dụng CLI `clawhub`
...
gói registry đó sau này. CLI ClawHub cũng hỗ trợ các workflow cài đặt và
cập nhật skill trực tiếp cho người dùng muốn có thư mục skill do registry quản lý bên ngoài
...
tải xuống. Các catalog bên thứ ba có thể sử dụng các API này khi họ liên kết lại đến
