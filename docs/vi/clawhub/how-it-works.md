...
ClawHub là lớp kho đăng ký cho Skills và Plugin của OpenClaw. Nó cung cấp cho người dùng một
...
Mỗi mục công khai là một bản ghi kho đăng ký với:
...
Sử dụng nguồn cài đặt ClawHub rõ ràng khi bạn muốn kho đăng ký là
nguồn sự thật:
...
Việc xuất bản tạo ra một bản ghi phiên bản bất biến mới. Nhà xuất bản dùng CLI `clawhub`
cho các quy trình kho đăng ký đã xác thực:
...
gói trong kho đăng ký sau này. CLI ClawHub cũng hỗ trợ các quy trình cài đặt và
cập nhật skill trực tiếp cho người dùng muốn các thư mục skill do kho đăng ký quản lý bên ngoài một
workspace OpenClaw đầy đủ.

## Trạng thái bảo mật

ClawHub mở cho việc xuất bản, nhưng các bản phát hành vẫn phải chịu các cổng tải lên,
...
tải xuống. Các catalog bên thứ ba có thể dùng những API này khi chúng liên kết lại về
mục ClawHub chính thức, tôn trọng giới hạn tốc độ, và tránh ngụ ý được chứng thực.
