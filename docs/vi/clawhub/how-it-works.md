...
summary: Cách hoạt động của các mục niêm yết, phiên bản, cài đặt, phát hành, quét và cập nhật trên ClawHub.
x-i18n:
    generated_at: "2026-07-05T05:16:53Z"
    model: gpt-5.5
...
phiên bản Gateway tối thiểu, mục tiêu máy chủ, yêu cầu môi trường, và digest của artifact.
...
Xuất bản tạo một bản ghi phiên bản bất biến mới. Nhà xuất bản sử dụng CLI `clawhub`
...
tải xuống. Các catalog bên thứ ba có thể sử dụng những API này khi chúng liên kết về
