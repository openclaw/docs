...
x-i18n:
    generated_at: "2026-07-02T17:40:54Z"
    model: gpt-5.5
...
giúp các lượt quét tự động phát hiện khác biệt giữa hành vi đã khai báo và hành vi quan sát được.

Xem [Định dạng skill](/vi/clawhub/skill-format).

## Plugins

Plugins là các tiện ích mở rộng OpenClaw được đóng gói. ClawHub lưu trữ siêu dữ liệu gói,
...
tải xuống. Các catalog bên thứ ba có thể dùng các API này khi họ liên kết ngược về
danh sách ClawHub chính thức, tuân thủ giới hạn tốc độ, và tránh ngụ ý sự chứng thực.
