...
summary: Cách hoạt động của các mục đăng, phiên bản, lượt cài đặt, việc phát hành, quá trình quét và cập nhật trên ClawHub.
x-i18n:
    generated_at: "2026-07-05T07:02:09Z"
    model: gpt-5.5
...
Xem [Định dạng kỹ năng](/clawhub/skill-format).
...
gói sổ đăng ký đó về sau. CLI ClawHub cũng hỗ trợ các quy trình làm việc cài đặt và
cập nhật kỹ năng trực tiếp cho người dùng muốn có thư mục kỹ năng do sổ đăng ký quản lý bên ngoài một
...
Xem [Bảo mật](/vi/clawhub/security), [Kiểm toán bảo mật](/clawhub/security-audits),
...
tải xuống. Danh mục của bên thứ ba có thể dùng các API này khi chúng liên kết lại tới
