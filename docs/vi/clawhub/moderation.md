...
read_when:
    ...
    - Khôi phục từ mục niêm yết bị giữ, bị ẩn hoặc bị chặn
    - Tìm hiểu về kiểm duyệt ClawHub, lệnh cấm hoặc trạng thái tài khoản
sidebarTitle: Moderation and Account Safety
summary: Cách hoạt động của báo cáo ClawHub, tạm giữ kiểm duyệt, danh sách bị ẩn, lệnh cấm và trạng thái uy tín tài khoản.
title: Kiểm duyệt và An toàn tài khoản
x-i18n:
    generated_at: "2026-07-01T08:13:20Z"
    model: gpt-5.5
...
cần có rào chắn bảo vệ. Báo cáo, giữ kiểm duyệt, danh sách bị ẩn và hành động tài khoản
...
khác, dùng [Yêu cầu quyền nội dung](/clawhub/content-rights).
...
được liên kết từ danh sách. ClawHub không bảo trì hoặc vá mã
skill hoặc Plugin bên thứ ba.

GitHub Security Advisories cho `openclaw/clawhub` dành cho các lỗ hổng trong
chính ClawHub. Ví dụ gồm lỗi trong website, API, CLI, registry, auth,
...
Báo cáo tốt phải cụ thể và có thể hành động. Lạm dụng việc báo cáo tự nó cũng có thể dẫn đến
hành động tài khoản.

## Khiếu nại tổ chức và namespace

Tranh chấp về quyền sở hữu tổ chức, thương hiệu, phạm vi gói, owner-handle hoặc namespace nên
...
rủi ro cao. Chúng cũng có thể được gỡ bỏ khi xác nhận đó là false positive.
...
Chủ sở hữu vẫn có thể thấy chẩn đoán cho các danh sách của chính họ bị giữ hoặc bị ẩn. Các
...
Tín hiệu áp lực lạm dụng của nhà xuất bản được kiểm tra hằng ngày. Các tín hiệu đạt
...
Các tín hiệu đánh giá theo thời gian có độ tin cậy thấp hơn và có giới hạn không được đưa vào
thực thi tự động.

Tài khoản đã xóa, bị cấm hoặc bị vô hiệu hóa không thể dùng API token của ClawHub. Nếu CLI auth
bắt đầu lỗi sau hành động tài khoản, hãy đăng nhập vào web UI để xem lại trạng thái
tài khoản. Nếu việc đăng nhập hoặc truy cập CLI bình thường bị chặn bởi lệnh cấm hoặc tài khoản bị vô hiệu hóa,
dùng [biểu mẫu kháng nghị ClawHub](https://appeals.openclaw.ai/) để yêu cầu xem xét khôi phục.
...
Để giảm false positive và cải thiện niềm tin của người dùng:
...
- dùng dry run trước khi xuất bản Plugin
