...
cần có cơ chế bảo vệ. Báo cáo, giữ kiểm duyệt, danh sách bị ẩn và hành động với
...
Trang này bao quát kiểm duyệt và trạng thái tài khoản. Với các nhãn kiểm toán như
...
[Quy định sử dụng chấp nhận được](/vi/clawhub/acceptable-usage). Với các vấn đề về
bản quyền hoặc quyền nội dung khác, hãy dùng [Yêu cầu quyền nội dung](/vi/clawhub/content-rights).
...
chính ClawHub. Ví dụ gồm lỗi trong website, API, CLI, registry, auth, quét,
kiểm duyệt hoặc ranh giới tin cậy khi tải xuống/cài đặt. Không dùng advisory của
...
Các tranh chấp về quyền sở hữu tổ chức, thương hiệu, phạm vi gói, owner-handle
...
rằng một namespace nên được giữ riêng, chuyển giao, đổi tên, ẩn, cách ly, đặt
bí danh hoặc xem xét theo cách khác. Không đưa bí mật, tài liệu riêng tư, hồ sơ
...
gì trước khi danh sách có thể trở lại các bề mặt công khai.

## Lệnh cấm và trạng thái tài khoản

Tài khoản vi phạm chính sách ClawHub có thể mất quyền xuất bản. Lạm dụng nghiêm
trọng có thể dẫn đến cấm tài khoản, thu hồi token, ẩn nội dung hoặc gỡ danh sách.
Các tín hiệu áp lực lạm dụng của nhà xuất bản được kiểm tra hằng ngày. Những tín
hiệu đạt ngưỡng có khả năng bị cấm của ClawHub có thể kích hoạt cảnh báo tự động.
Nếu lần quét đủ điều kiện tiếp theo sau hạn chót cảnh báo vẫn đặt nhà xuất bản
trong ngưỡng có khả năng bị cấm, ClawHub có thể tự động áp dụng hành động với tài
khoản. Các tín hiệu đánh giá có độ tin cậy thấp hơn và bị giới hạn theo thời gian
không được đưa vào thực thi tự động.

Tài khoản đã xóa, bị cấm hoặc bị vô hiệu hóa không thể dùng token API ClawHub.
Nếu xác thực CLI bắt đầu lỗi sau hành động với tài khoản, hãy đăng nhập vào giao
diện web để xem trạng thái tài khoản. Nếu đăng nhập hoặc quyền truy cập CLI thông
thường bị chặn bởi lệnh cấm hoặc tài khoản bị vô hiệu hóa, hãy dùng
