...
read_when:
    ...
    - Khôi phục sau khi mục niêm yết bị giữ, bị ẩn hoặc bị chặn
...
x-i18n:
    generated_at: "2026-07-04T10:45:27Z"
    model: gpt-5.5
...
cần có rào chắn bảo vệ. Báo cáo, giữ lại để kiểm duyệt, danh sách bị ẩn và hành động
tài khoản giúp bảo vệ người dùng khi một bản phát hành hoặc tài khoản có vẻ không an toàn, gây hiểu lầm hoặc không tuân thủ
chính sách.
...
[Cách sử dụng được chấp nhận](/clawhub/acceptable-usage). Đối với các vấn đề về bản quyền hoặc quyền nội dung
...
chính ClawHub. Ví dụ gồm lỗi trong trang web, API, CLI, registry, xác thực,
...
Một số phát hiện nghiêm trọng hoặc vấn đề chính sách có thể khiến một nhà xuất bản hoặc danh sách bị
giữ lại để kiểm duyệt. Khi điều này xảy ra, nội dung bị ảnh hưởng có thể bị ẩn khỏi
khám phá công khai hoặc các lần xuất bản trong tương lai có thể bắt đầu ở trạng thái ẩn cho đến khi vấn đề được xem xét.

Việc giữ lại để kiểm duyệt nhằm bảo vệ người dùng trong khi ClawHub xử lý các trường hợp
...
giải quyết vấn đề hoặc bên kiểm duyệt khôi phục nó.
...
Các tài khoản vi phạm chính sách ClawHub có thể mất quyền xuất bản. Hành vi lạm dụng nghiêm trọng có thể
...
Các tín hiệu xem xét theo thời gian có độ tin cậy thấp hơn và có giới hạn sẽ không nằm trong
thực thi tự động.
