...
summary: Cách hoạt động của báo cáo ClawHub, lệnh giữ để kiểm duyệt, danh sách bị ẩn, lệnh cấm và trạng thái tài khoản.
title: Kiểm duyệt và an toàn tài khoản
x-i18n:
    generated_at: "2026-07-03T23:35:38Z"
    model: gpt-5.5
...
cần có rào chắn bảo vệ. Báo cáo, trạng thái giữ kiểm duyệt, mục niêm yết bị ẩn và hành động với tài khoản
...
[Quy định sử dụng được chấp nhận](/clawhub/acceptable-usage). Với các lo ngại về bản quyền hoặc quyền nội dung
...
- mạo danh
- đăng ký có chủ ý xấu hoặc lạm dụng nhãn hiệu
- nội dung vi phạm [Quy định sử dụng được chấp nhận](/clawhub/acceptable-usage)
...
mã skill hay plugin bên thứ ba.
...
Báo cáo tốt cần cụ thể và có thể hành động. Việc lạm dụng báo cáo tự nó có thể dẫn đến
hành động với tài khoản.

## Khiếu nại về tổ chức và không gian tên

Tranh chấp về quyền sở hữu tổ chức, thương hiệu, phạm vi gói, handle chủ sở hữu hoặc không gian tên nên
dùng quy trình [Khiếu nại về tổ chức và không gian tên](/clawhub/namespace-claims), thay vì
...
không gian tên nên được bảo lưu, chuyển giao, đổi tên, ẩn, cách ly, đặt bí danh
hoặc được xem xét theo cách khác. Không đưa bí mật, tài liệu riêng tư, hồ sơ pháp lý riêng tư,
giấy tờ định danh cá nhân, API token hoặc DNS challenge token vào
một issue công khai.
...
Trạng thái giữ kiểm duyệt nhằm bảo vệ người dùng trong khi ClawHub xử lý các trường hợp
...
Chủ sở hữu vẫn có thể thấy chẩn đoán cho các mục niêm yết của chính họ đang bị giữ hoặc bị ẩn. Những
...
ngưỡng có khả năng bị cấm của ClawHub có thể kích hoạt cảnh báo tự động. Nếu lần quét đủ điều kiện tiếp theo
sau hạn cảnh báo vẫn đặt nhà xuất bản trong
ngưỡng có khả năng bị cấm, ClawHub có thể tự động áp dụng hành động với tài khoản.
...
bắt đầu thất bại sau hành động với tài khoản, hãy đăng nhập vào web UI để xem lại trạng thái
tài khoản. Nếu việc đăng nhập hoặc truy cập CLI bình thường bị chặn do tài khoản bị cấm hoặc bị vô hiệu hóa,
