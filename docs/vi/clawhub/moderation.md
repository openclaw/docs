...
x-i18n:
    generated_at: "2026-07-04T20:34:42Z"
    model: gpt-5.5
...
ClawHub cho phép xuất bản công khai, nhưng các bề mặt khám phá và cài đặt công khai vẫn
...
[Sử dụng được chấp nhận](/clawhub/acceptable-usage). Đối với các vấn đề về bản quyền hoặc
...
mã kỹ năng hoặc plugin bên thứ ba.
...
Chủ sở hữu vẫn có thể thấy chẩn đoán cho các danh sách của họ đang bị tạm giữ hoặc bị ẩn. Các
...
Các tín hiệu đánh giá có độ tin cậy thấp hơn và giới hạn theo thời gian không được đưa vào
thực thi tự động.
