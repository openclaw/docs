...
read_when:
    ...
    - Khôi phục từ một listing bị giữ, bị ẩn hoặc bị chặn
...
cần có rào chắn bảo vệ. Báo cáo, tạm giữ kiểm duyệt, danh sách bị ẩn và hành động tài khoản
...
[Cách sử dụng chấp nhận được](/clawhub/acceptable-usage). Đối với các mối quan ngại về bản quyền hoặc quyền nội dung
...
được liên kết từ danh sách. ClawHub không bảo trì hoặc vá mã của skill hay plugin
bên thứ ba.
...
dùng quy trình [Khiếu nại tổ chức và namespace](/clawhub/namespace-claims), không phải
luồng báo cáo trong sản phẩm hay biểu mẫu kháng nghị tài khoản.

Dùng quy trình đó khi bạn cần nhân viên ClawHub xem xét bằng chứng không nhạy cảm rằng một
namespace nên được bảo lưu, chuyển giao, đổi tên, ẩn, cách ly, đặt bí danh,
hoặc được xem xét theo cách khác. Không đưa bí mật, tài liệu riêng tư, hồ sơ pháp lý riêng tư,
giấy tờ định danh cá nhân, API tokens hoặc DNS challenge tokens vào
issue công khai.
...
Tạm giữ kiểm duyệt nhằm bảo vệ người dùng trong khi ClawHub giải quyết các trường hợp rủi ro cao.
...
Chủ sở hữu vẫn có thể thấy chẩn đoán cho danh sách bị tạm giữ hoặc bị ẩn của chính họ. Những
...
ngưỡng có thể bị cấm của ClawHub có thể kích hoạt cảnh báo tự động. Nếu lần quét đủ điều kiện tiếp theo
sau thời hạn cảnh báo vẫn đặt nhà xuất bản vào ngưỡng
có thể bị cấm, ClawHub có thể tự động áp dụng hành động tài khoản.
Các tín hiệu đánh giá có độ tin cậy thấp hơn và có giới hạn thời gian không thuộc phạm vi
thực thi tự động.

Tài khoản đã xóa, bị cấm hoặc bị vô hiệu hóa không thể dùng ClawHub API tokens. Nếu xác thực CLI
bắt đầu thất bại sau hành động tài khoản, hãy đăng nhập vào UI web để xem lại trạng thái tài khoản.
