---
read_when:
    - Bạn cần giải thích không gian làm việc của tác nhân hoặc cấu trúc tệp của không gian đó
...
<Warning>
Không gian làm việc là **cwd mặc định**, không phải sandbox cứng. Công cụ phân giải đường dẫn tương đối theo không gian làm việc, nhưng đường dẫn tuyệt đối vẫn có thể truy cập nơi khác trên host trừ khi đã bật sandbox. Nếu bạn cần cô lập, hãy dùng [`agents.defaults.sandbox`](/vi/gateway/sandboxing) (và/hoặc cấu hình sandbox cho từng agent).

Khi sandbox được bật và `workspaceAccess` không phải `"rw"`, công cụ hoạt động bên trong một không gian làm việc sandbox dưới `~/.openclaw/sandboxes`, không phải không gian làm việc host của bạn.
</Warning>
...
<Note>
Bản sao gieo sandbox chỉ chấp nhận các tệp thông thường nằm trong không gian làm việc; các bí danh symlink/hardlink phân giải ra ngoài không gian làm việc nguồn sẽ bị bỏ qua.
</Note>
...
<Note>
**Khuyến nghị:** giữ một không gian làm việc đang hoạt động duy nhất. Nếu bạn không còn dùng các thư mục bổ sung, hãy lưu trữ hoặc chuyển chúng vào Thùng rác (ví dụ `trash ~/openclaw`). Nếu bạn cố ý giữ nhiều không gian làm việc, hãy đảm bảo `agents.defaults.workspace` trỏ đến không gian đang hoạt động.
