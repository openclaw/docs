...
read_when:
    - Tìm ví dụ sử dụng OpenClaw thực tế
...
Đa ngôn ngữ hóa bản chép lời âm thanh qua OpenRouter (Gemini và nhiều dịch vụ khác). Có trên ClawHub.
</Card>
...
Cấu hình OpenClaw đã được nix hóa, đầy đủ sẵn dùng, cho các triển khai có thể tái lập.
</Card>

<Card title="Lịch CalDAV" icon="calendar" href="https://clawhub.ai/skills/caldav-calendar">
...
Tự động hóa nhà ở thuần Nix với OpenClaw làm giao diện, cùng với bảng điều khiển Grafana.
