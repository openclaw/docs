---
read_when:
    - Đánh giá tình trạng bảo mật hoặc các kịch bản mối đe dọa
    - Làm việc với các tính năng bảo mật hoặc phản hồi kiểm toán
summary: Mô hình mối đe dọa của OpenClaw được ánh xạ vào khung MITRE ATLAS
...
**Khung:** [MITRE ATLAS](https://atlas.mitre.org/) (Bối cảnh mối đe dọa đối nghịch cho hệ thống AI)
...
| SKILL.md bắt buộc    | Tệp đọc bắt buộc            | Giá trị bảo mật thấp - Chỉ mang tính thông tin              |
