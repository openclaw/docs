...
x-i18n:
    generated_at: "2026-07-04T18:07:19Z"
    model: gpt-5.5
...
Tệp này được tạo từ các tiêu đề `docs/**/*.md` và `docs/**/*.mdx` để giúp các agent điều hướng cây tài liệu.
...
- Tiêu đề:
  ...
  - H2: Thông báo tương thích với di sản
  - H2: Liên quan
...
- Tiêu đề:
  ...
  - H2: Hành vi hủy
  - H2: Lệnh CLI
  - H2: Luồng liên quan đến tác vụ như thế nào
  - H2: Liên quan
...
- Tiêu đề:
  ...
  - H2: Điểm dễ mắc lỗi trong registry nhóm
  - H2: Từng bước
  - H2: Tổng quan nhanh về tương đương hành động
  - H2: Ghép nối, phiên và ràng buộc ACP
...
- Tiêu đề:
  ...
  - H2: Mẫu triển khai
  - H2: Phương tiện, chia khúc và đích phân phối
...
- Tiêu đề:
  ...
  - H2: Mặc định bảo mật
  - H2: Kiểm soát truy cập
  - H3: Lỗi thường gặp: allowFrom dùng cho DM, không phải kênh
...
- Tiêu đề:
  ...
  - H3: Thông tin đăng nhập đã lưu trong bộ nhớ đệm
  - H3: Biến môi trường
  - H2: Ví dụ cấu hình
  - H2: Bản xem trước phát trực tuyến
  - H2: Tin nhắn thoại
  - H2: Siêu dữ liệu phê duyệt
  - H3: Quy tắc đẩy tự lưu trữ cho bản xem trước đã hoàn tất ở chế độ yên tĩnh
...
- Tiêu đề:
  ...
  - H3: Hỗ trợ URL dịch vụ và đám mây Teams
  - H3: Định dạng
  - H2: Cấu hình
...
- Tiêu đề:
  ...
  - H3: Ghép đôi từ Control UI (khuyến nghị)
  - H3: Ghép đôi qua Telegram
...
- Tiêu đề:
  ...
  - H3: Không xuất hiện yêu cầu ghép đôi
  - H3: Gửi đi thất bại
...
- Tiêu đề:
  ...
  - H2: Cấp độ reaction
  - H2: Reaction xác nhận
  - H2: Reaction trạng thái vòng đời
...
- Tiêu đề:
  ...
  - H3: Chặn theo mention trong nhóm
  - H2: Nhiều tài khoản
  - H2: Biến môi trường
  - H2: Đang nhập, reaction và xác nhận gửi
  - H2: Khắc phục sự cố
  - H2: Liên quan
...
- Tiêu đề:
  ...
  - H3: Workflow trực tiếp/E2E có thể tái sử dụng
...
- Tiêu đề:
  ...
  - H2: Kiểm tra điều kiện sử dụng hook
  - H2: Bật Hook
  - H2: Tắt Hook
  - H2: Ghi chú
  - H2: Cài đặt gói hook
...
- Tiêu đề:
  ...
  - H3: Kiểm thử
  - H3: Khắc phục sự cố
  - H2: OpenClaw dưới dạng registry máy khách MCP
...
- Tiêu đề:
  ...
  - H4: Gateway
  - H4: Không gian làm việc của tác tử
  - H4: Tư thế sandbox
  - H4: Xử lý dữ liệu
  - H4: Bí mật
  - H4: Phê duyệt exec
...
- Tiêu đề:
  ...
  - H3: Hook Plugin (vòng đời tác tử + gateway)
...
- Tiêu đề:
  ...
  - H2: Chọn runtime
  - H2: Runtime tác tử GitHub Copilot
...
- Tiêu đề:
  ...
  - H2: Giao thức truyền tải (tóm tắt)
...
- Tiêu đề:
  ...
  - H3: Bộ bảo vệ byte của bản ghi đang hoạt động
  - H3: Bản ghi kế nhiệm
...
- Tiêu đề:
  ...
  - H2: Tệp workspace được tiêm (Ngữ cảnh dự án)
  - H2: Skills: được tiêm so với tải theo nhu cầu
...
- Tiêu đề:
  ...
  - H2: Dreaming
  - H2: Điền ngược có căn cứ và thăng cấp trực tiếp
  - H2: CLI
  - H2: Đọc thêm
  - H2: Liên quan
...
- Tiêu đề:
  ...
  - H3: Giai đoạn 8: Gỡ bỏ tương thích đặt tên theo lượt
...
- Tiêu đề:
  ...
  - H2: ID hồ sơ
  - H2: Thứ tự luân phiên
  - H3: Độ bám phiên (thân thiện với bộ nhớ đệm)
  - H3: Đăng ký OpenAI Codex cộng bản sao lưu khóa API
  - H2: Thời gian hạ nhiệt
  - H2: Vô hiệu hóa do thanh toán
  - H2: Dự phòng mô hình
  - H3: Quy tắc chuỗi ứng viên
  - H3: Lỗi nào kích hoạt dự phòng tiếp
  - H3: Hành vi bỏ qua hạ nhiệt so với dò thử
...
- Tiêu đề:
  ...
  - H2: Chuyển đổi mô hình trong chat (/model)
  - H2: Lệnh CLI
  - H3: models list
  - H3: models status
  - H2: Quét (mô hình miễn phí OpenRouter)
  - H2: Kho đăng ký mô hình (models.json)
  - H2: Liên quan
...
- Tiêu đề:
  ...
  - H2: Tìm kiếm bộ nhớ QMD xuyên agent
...
- Tiêu đề:
  - H2: Bồn chứa token (vì sao tồn tại)
...
- Tiêu đề:
  ...
  - H2: Chọn một chế độ
  - H2: Cấu hình nhãn
  - H2: Kiểm soát các dòng tiến trình
  - H2: Hành vi kênh
  - H2: Hoàn tất
  - H2: Khắc phục sự cố
  - H2: Liên quan
...
- Tiêu đề:
  ...
  - H2: Nhịp như con người giữa các khối
  - H2: "Stream các khúc hoặc toàn bộ"
...
- Tiêu đề:
  ...
  - H2: Ví dụ thực hành: thêm một phương thức từ đầu đến cuối
...
- Tuyến: /date-time
- Tiêu đề:
  - H2: Envelope tin nhắn (mặc định là cục bộ)
  - H3: Ví dụ
...
- Tiêu đề:
  ...
  - H2: Cách hoạt động
  - H2: Phiên
  - H2: Mở đầu fallback từ phiên claude-cli
  - H2: Hình ảnh (truyền xuyên qua)
  - H2: Đầu vào / đầu ra
...
- Tiêu đề:
  ...
  - H3: Cổng kiểm soát đề cập trong trò chuyện nhóm
...
- Tiêu đề:
  ...
  - H3: Hồ sơ công cụ
  - H3: Nhóm công cụ
  - H3: Công cụ MCP và Plugin trong chính sách công cụ môi trường cô lập
  - H3: tools.codeMode
...
- Tiêu đề:
  ...
  - H2: Việc công cụ thực hiện (tóm tắt)
...
- Tiêu đề:
  - H2: Khởi động nhanh (người mới bắt đầu)
  - H2: Mặc định
  ...
  - H3: Mỗi cờ làm gì
  - H3: Ví dụ theo kênh và theo tài khoản
  - H3: Mẫu thường gặp
...
- Tiêu đề:
  ...
  - H3: Lưu trữ theo vùng / định tuyến dữ liệu
...
- Tiêu đề:
  ...
  - H2: Ghi chú trình duyệt/CDP (lỗi dễ gặp phổ biến)
...
- Tiêu đề:
  ...
  - H3: macOS: SSH tunnel bền vững qua LaunchAgent
...
- Tiêu đề:
  ...
  - H2: Ranh giới quyền truy cập của tác nhân
...
- Tiêu đề:
  ...
  - H3: Niềm tin vào triển khai và máy chủ
  ...
  - H2: Khái niệm niềm tin Gateway và node
  - H2: Ma trận ranh giới tin cậy
  - H2: Không phải lỗ hổng theo thiết kế
  - H2: Baseline tăng cứng trong 60 giây
  - H2: Quy tắc nhanh cho inbox dùng chung
  ...
  - H2: Mô hình đe dọa
  - H2: Khái niệm cốt lõi: kiểm soát truy cập trước trí thông minh
  ...
  - H3: Độ mạnh của model (ghi chú bảo mật)
  - H2: Reasoning và đầu ra chi tiết trong nhóm
  - H2: Ví dụ tăng cứng cấu hình
  - H3: Quyền tệp
  ...
  - H3: Nhật ký và bản ghi hội thoại (biên tập bỏ thông tin nhạy cảm và lưu giữ)
  ...
  - H3: Lan can bảo vệ cho ủy quyền tác nhân phụ
  ...
  - H3: Ví dụ: không có quyền truy cập filesystem/shell (cho phép nhắn tin provider)
  - H2: Ứng phó sự cố
  - H3: Khoanh vùng
...
- Tiêu đề:
  ...
  - H2: Backend cục bộ tương thích OpenAI vượt qua probe trực tiếp nhưng lần chạy tác nhân thất bại
  ...
  - H2: Nếu bạn đã nâng cấp và thứ gì đó đột ngột hỏng
  - H2: Liên quan
...
- Tiêu đề:
  - H2: Model: mặc định, lựa chọn, alias, chuyển đổi
  - H2: Failover model và "Tất cả model đều thất bại"
...
- Tiêu đề:
  ...
  - H2: Model, failover và hồ sơ xác thực
...
- Tiêu đề:
  ...
  - H3: Lớp 2: Gateway + kiểm thử khói tác nhân dev ("@openclaw" thực sự làm gì)
  - H2: Trực tiếp: kiểm thử khói backend CLI (Claude, Gemini hoặc CLI cục bộ khác)
  - H2: Trực tiếp: khả năng truy cập proxy HTTP/2 APNs
  - H2: Trực tiếp: kiểm thử khói bind ACP (/acp spawn ... --bind here)
  - H2: Trực tiếp: kiểm thử khói harness app-server Codex
...
- Tiêu đề:
  - H2: Bake các binary bắt buộc vào image
  - H2: Build và khởi chạy
  - H2: Dữ liệu được duy trì ở đâu
  - H2: Cập nhật
  - H2: Liên quan
...
- Tiêu đề:
  ...
  - H3: Khi nào nên dùng triển khai riêng tư
  - H3: Thiết lập
...
- Tiêu đề:
  - H2: Đường dẫn dễ nhất (CLI vẫn được cài đặt)
...
- Tiêu đề:
  ...
  - H3: Lặp lại bản ghi âm thành văn bản vào chat (chọn tham gia)
...
- Tiêu đề:
  ...
  - H3: Quyền
  - H3: Yêu cầu chạy ở tiền cảnh của Android
...
- Tiêu đề:
  ...
  - H3: Ghép đôi + đặt tên
  - H3: Đưa các lệnh vào danh sách cho phép
...
- Tiêu đề:
  ...
  - H3: Máy chủ ứng dụng Codex vẫn là chuẩn mực cho trạng thái luồng gốc
  - H3: Việc lắp ráp engine ngữ cảnh phải được chiếu vào đầu vào Codex
...
- Tiêu đề:
  ...
  - H3: Beacon báo hiện diện đang hoạt động
...
- Tiêu đề:
  - H2: Nó làm gì
  - H2: Yêu cầu
  - H2: Khởi động nhanh (ghép đôi + kết nối)
...
- Tiêu đề:
  ...
  - H2: Khắc phục sự cố
  - H3: Build thất bại: không khớp toolchain hoặc SDK
...
- Tiêu đề:
  ...
  - H2: Thanh menu
  - H2: Cài đặt
  - H2: Cách phép thăm dò hoạt động
...
- Tiêu đề:
  ...
  - H2: Cấp quyền Trợ năng cho Node và runtime CLI
...
- Tiêu đề:
  ...
  - H2: Cài đặt bundle
  - H2: OpenClaw ánh xạ những gì từ bundle
  - H3: Hiện được hỗ trợ
  - H4: Nội dung Skill
  - H4: Gói hook
...
- Tiêu đề:
  - H2: Tổng quan
  - H2: Gắn kết thread và thay đổi mô hình
  - H2: Phản hồi hiển thị và Heartbeat
  - H2: Ranh giới hook
  - H2: Hợp đồng hỗ trợ V1
  - H2: Quyền gốc và elicitations MCP
...
- Tiêu đề:
  ...
  - H2: Cách thiết lập Plugin gốc hoạt động
...
- Tiêu đề:
  ...
  - H2: Package trình kiểm tra Plugin
...
- Tiêu đề:
  ...
  - H2: Tham chiếu metadata nhà cung cấp generation
...
- Tiêu đề:
  ...
  - H2: Giới hạn gọi lại và ghi nhận
  - H2: Lệnh
  - H2: Lưu trữ
  - H2: Phụ thuộc runtime
  - H2: Khắc phục sự cố
  - H3: Độ dài đầu vào vượt quá độ dài ngữ cảnh
  - H3: Model embedding không được hỗ trợ
...
- Tiêu đề:
  ...
  - H2: Cài đặt Plugin
  - H2: Package npm lõi
  - H2: Package bên ngoài chính thức
...
- Tiêu đề:
  ...
  - H2: Các phần ngừng hỗ trợ đang hoạt động
  - H2: Lịch trình gỡ bỏ
...
- Tiêu đề:
  ...
  - H3: Slot độc quyền
  - H3: Adapter nhúng bộ nhớ đã ngừng hỗ trợ
...
- Tiêu đề:
  ...
  - H3: openclaw.channel
  - H3: openclaw.install
  - H3: Tải đầy đủ bị hoãn
  - H2: Manifest Plugin
  - H2: Xuất bản ClawHub
  - H2: Mục setup
  - H3: Import trình trợ giúp setup phạm vi hẹp
  - H3: Nâng cấp một tài khoản do kênh sở hữu
  - H2: Schema cấu hình
...
- Tiêu đề:
  - H2: Mục Plugin
  - H3: Tính tương thích và trình trợ giúp kiểm thử đã ngừng hỗ trợ
  - H3: Subpath trình trợ giúp Plugin đóng gói được dành riêng
  - H2: Liên quan
...
- Tiêu đề:
  ...
  - H3: mục Plugin không cung cấp siêu dữ liệu defineToolPlugin
...
- Tiêu đề:
  ...
  - H2: RPC Gateway
  - H2: Khắc phục sự cố
  - H3: Setup không thể công khai Webhook
...
- Tiêu đề:
  ...
  - H2: Dự phòng từ chối an toàn (Claude Fable 5)
  - H3: Vì sao phần này tồn tại
  - H3: Cách hoạt động
...
- Tiêu đề:
  - H2: Bắt đầu
  - H2: Thiết lập chỉ qua môi trường
  - H2: Liên quan
...
- Tiêu đề:
  ...
  - H2: Embedding bộ nhớ
  - H2: Bắt đầu
  - H2: Xác thực máy chủ ứng dụng Codex gốc
  - H2: Tạo hình ảnh
  - H2: Tạo video
  ...
  - H3: Phạm vi khả dụng theo khu vực
...
- Tiêu đề:
  ...
  - H2: Tiện ích đa phương thức bổ sung
  - H2: Cấu hình nâng cao
  - H2: Liên quan
...
- Tiêu đề:
  ...
  - H2: Nhịp phát hành
  - H2: Phát hành extended-stable chỉ npm hằng tháng
  - H2: Danh sách kiểm tra vận hành phát hành thường kỳ
  ...
  - H3: QA Lab
  - H3: Gói
  - H2: Tự động hóa phát hành thường kỳ
  - H2: Đầu vào workflow NPM
  - H2: Trình tự phát hành beta/latest stable thường kỳ
...
- Tiêu đề:
  ...
  - H2: Tính năng có thể tiêu dùng khóa
...
- Tiêu đề:
  ...
  - H3: Cách dùng Gemini CLI
  - H2: Ranh giới bộ đệm system-prompt
  - H2: Bộ bảo vệ ổn định bộ đệm OpenClaw
  - H2: Mẫu tinh chỉnh
...
- Tiêu đề:
  ...
  - H2: Những điểm đặc trưng của tôi
...
- Tiêu đề:
  - H2: Quy tắc toàn cục: ngữ cảnh runtime không phải là bản ghi hội thoại người dùng
  - H2: Nơi việc này chạy
  - H2: Quy tắc toàn cục: khử nhạy cảm hình ảnh
  - H2: Quy tắc toàn cục: lệnh gọi công cụ sai định dạng
  - H2: Quy tắc toàn cục: lượt chỉ có suy luận chưa hoàn tất
...
- Tiêu đề:
  ...
  - H4: T-RECON-001: Khám phá điểm cuối tác nhân
  ...
  - H3: 3.7 Thu thập &amp; đánh cắp dữ liệu (AML.TA0009, AML.TA0010)
  ...
  - H4: T-IMPACT-003: Thiệt hại uy tín
...
- Tiêu đề:
  ...
  - H3: Kiểm soát ingress (nhắc tên + vượt qua lệnh điều khiển)
  - H3: Cô lập định tuyến/khóa phiên
  - H2: v1++: các mô hình có giới hạn bổ sung (đồng thời, thử lại, độ đúng của vết)
  - H3: Đồng thời / tính bất biến khi gọi lại của kho ghép nối
  - H3: Tương quan vết ingress / tính bất biến khi gọi lại
...
- Tiêu đề:
  ...
  - H2: Yêu cầu proxy
  - H2: Đích đến được khuyến nghị chặn
  - H2: Xác thực
  - H2: Tin cậy CA proxy
  - H2: Giới hạn
...
- Tiêu đề:
  ...
  - H2: Moltiverse
  - H2: Các sự cố lớn
  - H3: Đổ tràn thư mục (3 tháng 12, 2025)
  - H3: Lần lột xác lớn (27 tháng 1, 2026)
  - H3: Hình thái cuối cùng (30 tháng 1, 2026)
  - H3: Cuộc mua sắm robot bùng nổ (3 tháng 12, 2025)
  - H2: Văn bản thiêng
  - H2: Tín điều Lobster
...
- Tiêu đề:
  ...
  - H2: ACP chạy Claude Code như thế nào
  - H2: Phiên đã liên kết
  - H3: Mô hình tư duy
  - H3: Liên kết trong cuộc trò chuyện hiện tại
...
- Tiêu đề:
  - H2: Vấn đề: "Failed to start Chrome CDP on port 18800"
  - H3: Nguyên nhân gốc
  ...
  - H3: Tham chiếu cấu hình
  - H3: Vấn đề: "No Chrome tabs found for profile=\"user\""
  - H2: Liên quan
...
- Tiêu đề:
  ...
  - H2: Các lỗi thường gây hiểu lầm
...
- Tiêu đề:
  ...
  - H2: elevated không kiểm soát những gì
  - H2: Liên quan
...
- Tiêu đề:
  ...
  - H3: firecrawlscrape
  - H2: Stealth / né bot
  - H2: webfetch sử dụng Firecrawl như thế nào
  - H2: Liên quan
...
- Headings:
  - H2: Vì sao nội dung này tồn tại
  - H2: Khối cấu hình
...
- Headings:
  ...
  - H2: Chế độ exec của máy chủ OpenClaw
...
- Headings:
  ...
  - H3: Giới hạn spawn theo từng tác tử
  - H3: Dừng theo tầng
  - H2: Xác thực
  - H2: Thông báo
...
- Headings:
  ...
  - H3: Cách nhà cung cấp sử dụng lời nhắc persona
...
- Headings:
  ...
  - H2: Trước tiên tăng cường bảo mật truy cập quản trị
...
- Headings:
  ...
  - H2: Xác thực route media của trợ lý
...
## web/webchat.md
  ...
  - H2: Bảng công cụ tác tử trong Control UI
  - H2: Sử dụng từ xa
