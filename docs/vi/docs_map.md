...
- Tiêu đề:
  - H2: Bắt đầu nhanh
  - H2: Cron hoạt động như thế nào
  - H2: Loại lịch
  - H3: Ngày trong tháng và ngày trong tuần dùng logic OR
  - H2: Kiểu thực thi
  - H3: Payload lệnh
  - H3: Tùy chọn payload cho công việc cô lập
...
- Tiêu đề:
  ...
  - H2: Lệnh thường trực cộng với công việc Cron
  - H2: Ví dụ
  - H3: Ví dụ 1: nội dung và mạng xã hội (chu kỳ hằng tuần)
  - H3: Ví dụ 2: vận hành tài chính (được kích hoạt bởi sự kiện)
...
- Tiêu đề:
  ...
  - H2: Hành vi hủy
  - H2: Lệnh CLI
  - H2: Flow liên quan đến tác vụ như thế nào
  - H2: Liên quan
...
- Tiêu đề:
  ...
  - H3: Tác vụ nằm ở đâu
  - H3: Bảo trì tự động
  - H2: Tác vụ liên quan đến các hệ thống khác như thế nào
  - H2: Liên quan
...
- Tiêu đề:
  ...
  - H2: Thuật ngữ chính
  - H2: Tiền tố mục tiêu gửi ra ngoài
  - H2: Hình dạng khóa phiên (ví dụ)
  - H2: Ghim tuyến DM chính
  - H2: Ghi nhận gửi đến có bảo vệ
  - H2: Quy tắc định tuyến (cách chọn một agent)
...
- Tiêu đề:
  - H2: Thiết lập nhanh
  - H2: Khuyến nghị: thiết lập một workspace guild
  - H2: Mô hình runtime
  - H2: Kênh diễn đàn
...
- Tiêu đề:
  ...
  - H2: Bẫy thường gặp trong registry nhóm
  - H2: Từng bước
  - H2: Tổng quan nhanh về độ tương đương hành động
...
- Tiêu đề:
  ...
  - H2: Khôi phục gửi đến sau khi bridge hoặc Gateway khởi động lại
...
- Tiêu đề:
  ...
  - H3: Công cụ khác nhau cho từng người gửi (chủ sở hữu có nhiều quyền hơn)
  - H2: NickServ
  - H2: Biến môi trường
  - H2: Khắc phục sự cố
  - H2: Liên quan
...
- Tiêu đề:
  ...
  - H3: Tự động tham gia
  - H3: Định dạng mục tiêu allowlist
  - H3: Chuẩn hóa ID tài khoản
  - H3: Thông tin đăng nhập được lưu vào bộ nhớ đệm
  - H3: Biến môi trường
  - H2: Ví dụ cấu hình
  - H2: Bản xem trước phát trực tuyến
  - H2: Tin nhắn thoại
  - H2: Siêu dữ liệu phê duyệt
  - H3: Quy tắc đẩy tự lưu trữ để giữ yên lặng cho bản xem trước đã hoàn tất
  - H2: Phòng bot-với-bot
  - H2: Mã hóa và xác minh
  - H3: Bật mã hóa
  - H3: Tín hiệu trạng thái và độ tin cậy
  ...
  - H2: Ủy quyền lưu lượng Matrix qua proxy
...
- Tiêu đề:
  ...
  - H3: Bước 2: Lấy thông tin đăng nhập
  ...
  - H3: Lưu ý về manifest (các trường bắt buộc)
...
- Tiêu đề:
  - H2: Plugin đi kèm
  - H3: Bản cài đặt cũ hơn/tùy chỉnh
...
- Tiêu đề:
  ...
  - H3: Nhóm người gửi tái sử dụng
  - H3: Trạng thái nằm ở đâu
  - H2: 2) Ghép nối thiết bị Node (nút iOS/Android/macOS/headless)
  - H3: Ghép nối qua Telegram (khuyến nghị cho iOS)
  - H3: Phê duyệt thiết bị nút
  - H3: Tự động phê duyệt nút trusted-CIDR tùy chọn
...
- Tiêu đề:
  ...
  - H2: Phương tiện, chia khối và gửi
...
- Tiêu đề:
  ...
  - H3: Bot gửi phản hồi trống hoặc dự phòng
...
- Tiêu đề:
  ...
  - H3: Cổng kiểm soát nhắc đến nhóm
  - H2: Nhiều tài khoản
  - H2: Biến môi trường
...
- Tiêu đề:
  ...
  - H2: Chọn agent
  - H2: Sử dụng từ acpx (Codex, Claude, ACP client khác)
...
- Tiêu đề:
  ...
  - H2: Lệnh phổ biến
  - H2: Trạng thái / khả năng / phân giải / log
...
- Tiêu đề:
  ...
  - H2: Trình lập kế hoạch hỗ trợ bởi mô hình
...
- Tiêu đề:
  ...
  - H2: Kiểm tra điều kiện đủ của hook
  - H2: Bật Hook
  - H2: Tắt Hook
  - H2: Ghi chú
  - H2: Cài đặt gói hook
...
- Tiêu đề:
  ...
  - H4: Gateway
  - H4: Không gian làm việc của agent
  - H4: Tư thế sandbox
  - H4: Xử lý dữ liệu
  - H4: Bí mật
  - H4: Phê duyệt exec
...
- Tiêu đề:
  ...
  - H2: Định dạng phản hồi + chặn hiển thị
...
- Tiêu đề:
  ...
  - H2: Bản đồ tệp không gian làm việc
...
- Tiêu đề:
  ...
  - H2: Phiên
  - H2: Điều khiển khi đang streaming
...
- Tiêu đề:
  ...
  - H3: Nút (macOS / iOS / Android / headless)
  - H3: WebChat
  - H2: Vòng đời kết nối (một máy khách)
  - H2: Giao thức đường truyền (tóm tắt)
...
- Tiêu đề:
  ...
  - H3: Chốt bảo vệ byte bản ghi phiên đang hoạt động
...
- Tiêu đề:
  ...
  - H3: Phần bổ sung vào system prompt
  - H2: Engine cũ
  - H2: Engine Plugin
...
- Tiêu đề:
  ...
  - H2: Tệp workspace được chèn (Ngữ cảnh dự án)
  - H2: Skills: được chèn so với được tải theo nhu cầu
...
- Tiêu đề:
  ...
  - H2: Phạm vi báo cáo thử nghiệm shadow QA
  - H2: Lập lịch
  - H2: Bắt đầu nhanh
  - H2: Lệnh slash
  - H2: Quy trình CLI
...
- Tiêu đề:
  ...
  - H3: Giai đoạn 3: Cầu nối inbound của kênh
  ...
  - H3: Giai đoạn 8: Xóa khả năng tương thích được đặt tên theo turn
...
- Tiêu đề:
  ...
  - H2: Thông báo dự phòng hiển thị cho người dùng
  - H2: Lưu trữ xác thực (khóa + OAuth)
  - H2: ID hồ sơ
  - H2: Thứ tự xoay vòng
  - H3: Độ bám phiên (thân thiện với cache)
  - H3: Gói đăng ký OpenAI Codex cộng với bản sao lưu API-key
  - H2: Cooldown
  - H2: Tắt do thanh toán
  - H2: Dự phòng mô hình
  - H3: Quy tắc chuỗi ứng viên
  - H3: Lỗi nào làm chuyển sang dự phòng
...
- Tiêu đề:
  ...
  - H2: Nhà cung cấp qua models.providers (custom/base URL)
  - H3: Moonshot AI (Kimi)
  - H3: Kimi coding
...
- Tiêu đề:
  ...
  - H2: Nguồn lựa chọn và hành vi dự phòng
...
- Tiêu đề:
  - H2: Bể nhận token (vì sao tồn tại)
  - H2: Lưu trữ (token nằm ở đâu)
  - H2: Khả năng tương thích token cũ của Anthropic
...
- Tiêu đề:
  ...
  - H2: Bên tạo (nguồn của trạng thái hiện diện)
  - H3: 1) Mục tự thân Gateway
  ...
  - H2: Lưu ý remote/tunnel (IP local loopback)
  - H2: Bên tiêu thụ
...
- Tiêu đề:
  ...
  - H2: Tài liệu tham chiếu QA cho Telegram, Discord, Slack và WhatsApp
  ...
  - H3: QA WhatsApp
  - H3: Nhóm thông tin đăng nhập Convex
...
- Tiêu đề:
  ...
  - H2: Gửi tin nhắn giữa các phiên
  - H2: Helper trạng thái và điều phối
  - H2: Khởi tạo sub-agent
...
- Tiêu đề:
  ...
  - H2: Prompt Molty
  - H2: Tiêu chuẩn tốt trông như thế nào
  - H2: Một cảnh báo
  - H2: Liên quan
...
- Tiêu đề:
  - H2: Streaming theo block (tin nhắn kênh)
  - H3: Phân phối media với streaming theo block
  - H2: Thuật toán chia chunk (giới hạn thấp/cao)
  - H2: Gộp (hợp nhất block đã stream)
  - H2: Nhịp giống con người giữa các block
  - H2: "Stream chunk hoặc mọi thứ"
...
- Tiêu đề:
  ...
  - H2: Cách schema được dùng ở runtime
  - H2: Frame ví dụ
  - H2: Client tối thiểu (Node.js)
  - H2: Ví dụ đầy đủ: thêm một method từ đầu đến cuối
...
- Tiêu đề:
  ...
  - H3: Dạng mảnh
  - H3: Ví dụ
  - H2: Provider + thông tin đăng nhập
  - H2: Liên quan
...
- Tiêu đề:
  ...
  - H3: Bản đồ quyền sở hữu ngân sách context
...
- Tiêu đề:
  ...
  - H3: Kho kỹ năng đồng cấp được liên kết tượng trưng
  - H2: Mẫu phổ biến
...
- Tiêu đề:
  ...
  - H3: Chế độ tải lại
  - H3: Nội dung áp dụng nóng và nội dung cần khởi động lại
  - H3: Lập kế hoạch tải lại
  - H2: RPC cấu hình (cập nhật theo lập trình)
  - H2: Biến môi trường
...
- Tiêu đề:
  ...
  - H2: Thu thập console
  - H2: Biên tập ẩn thông tin
  - H2: Log WebSocket Gateway
  - H3: Kiểu log WS
  - H2: Định dạng console (ghi log hệ con)
  - H2: Liên quan
...
- Tiêu đề:
  ...
  - H2: Ghi chú Browser/CDP (lỗi dễ mắc phổ biến)
...
- Tiêu đề:
  ...
  - H3: Dạng phản hồi công cụ không streaming
  - H3: Dạng phản hồi công cụ streaming
...
- Tiêu đề:
  ...
  - H3: OpenShell theo từng agent với gateway tùy chỉnh
  - H2: Quản lý vòng đời
...
- Tiêu đề:
  ...
  - H2: Lấy mẫu và xả bộ đệm
  - H2: Metric được xuất
  - H3: Mức sử dụng mô hình
  - H3: Luồng tin nhắn
  - H3: Talk
  - H3: Hàng đợi và phiên
  - H3: Telemetry tính sống của phiên
  - H3: Vòng đời harness
  - H3: Thực thi công cụ
  - H3: Exec
...
- Tiêu đề:
  ...
  - H2: Phạm vi hóa sự kiện phát rộng
...
- Tiêu đề:
  ...
  - H3: macOS: đường hầm SSH liên tục qua LaunchAgent
...
- Tiêu đề:
  ...
  - H2: Cách sửa lỗi "nhốt trong sandbox" phổ biến
...
- Tiêu đề:
  ...
  - H3: Triển khai và độ tin cậy máy chủ
  ...
  - H2: Plugins
  - H2: Mô hình truy cập DM: ghép cặp, allowlist, mở, tắt
  ...
  - H3: Quyền tệp
  - H3: Phơi bày mạng (bind, cổng, tường lửa)
  ...
  - H3: Ví dụ: không truy cập hệ thống tệp/shell (cho phép nhắn tin qua nhà cung cấp)
  - H2: Ứng phó sự cố
  - H3: Cô lập
  - H3: Xoay vòng (giả định bị xâm phạm nếu bí mật bị lộ)
  - H3: Kiểm toán
...
- Tiêu đề:
  ...
  - H2: Backend cục bộ tương thích OpenAI vượt qua probe trực tiếp nhưng lần chạy agent thất bại
  ...
  - H2: Node đã ghép cặp, công cụ thất bại
...
- Tiêu đề:
  ...
  - H2: Cách hoạt động
  - H2: Hành vi ghép cặp Control UI
  - H2: Cấu hình
...
- Tiêu đề:
  ...
  - H2: Khởi động CLI và lập hồ sơ lệnh
  - H2: Chế độ watch của Gateway
  - H2: Hồ sơ dev + dev gateway (--dev)
...
- Tuyến: /help/faq
- Tiêu đề:
  - H2: 60 giây đầu tiên nếu có gì đó bị hỏng
  - H2: Khởi động nhanh và thiết lập lần chạy đầu tiên
  - H2: OpenClaw là gì?
...
- Tiêu đề:
  ...
  - H3: Lớp 1: Hoàn thành mô hình trực tiếp (không qua Gateway)
  - H3: Lớp 2: Gateway + kiểm thử khói tác nhân phát triển (điều "@openclaw" thực sự làm)
  - H2: Trực tiếp: kiểm thử khói phần phụ trợ CLI (Claude, Gemini, hoặc CLI cục bộ khác)
  - H2: Trực tiếp: khả năng kết nối proxy APNs HTTP/2
  - H2: Trực tiếp: kiểm thử khói liên kết ACP (/acp spawn ... --bind here)
  - H2: Trực tiếp: kiểm thử khói harness máy chủ ứng dụng Codex
  ...
  - H2: Trực tiếp phương tiện quy trình ComfyUI
...
- Tiêu đề:
  ...
  - H3: E2E: kiểm thử khói phần phụ trợ OpenShell
  - H3: Trực tiếp (nhà cung cấp thật + mô hình thật)
  - H2: Tôi nên chạy bộ kiểm thử nào?
...
- Tiêu đề:
  ...
  - H2: Phần phụ trợ tương thích OpenAI cục bộ hoạt động trực tiếp nhưng lỗi trong OpenClaw
...
- Tiêu đề:
  ...
  - H2: Những gì được lưu bền ở đâu
  - H2: Cập nhật
  - H2: Liên quan
...
- Tiêu đề:
  ...
  - H3: Phần phụ trợ Claude CLI trong Docker
  - H3: Bonjour / mDNS
  - H3: Lưu trữ và lưu bền
...
- Tiêu đề:
  ...
  - H3: Trạng thái không được lưu bền
  - H2: Cập nhật
...
- Tiêu đề:
  ...
  - H3: VM cục bộ trên máy Mac Apple Silicon của bạn (Lume)
...
- Tiêu đề:
  ...
  - H2: Thay thế: chạy lại trình cài đặt
  - H2: Thay thế: npm, pnpm hoặc bun thủ công
...
- Tiêu đề:
  ...
  - H3: Chỉ nhà cung cấp với chặn theo phạm vi
  ...
  - H2: Phát hiện đề cập trong nhóm
...
- Tiêu đề:
  ...
  - H3: Yêu cầu chạy tiền cảnh
  - H3: Trình hỗ trợ CLI
  - H2: Node Android
  - H3: Cài đặt người dùng Android (bật mặc định)
  - H3: Quyền
  - H3: Yêu cầu chạy tiền cảnh trên Android
...
- Tiêu đề:
  ...
  - H3: Tự động phát hiện hiểu media (mặc định)
...
- Tiêu đề:
  ...
  - H2: Giao thức
  - H3: Phương thức
  - H3: Phương thức định tuyến (kích hoạt → đích)
  - H3: Sự kiện
...
- Tiêu đề:
  ...
  - H3: Quá trình lắp ráp công cụ ngữ cảnh phải được chiếu vào đầu vào Codex
  - H3: Độ ổn định của prompt-cache là quan trọng
...
- Tiêu đề:
  ...
  - H3: 6) Chat + lịch sử
  - H3: 7) Canvas + camera
  - H4: Máy chủ Canvas Gateway (khuyến nghị cho nội dung web)
...
- Tiêu đề:
  ...
  - H2: Áp lực bộ nhớ và tiến trình bị OOM kill
  - H2: Liên quan
...
- Tiêu đề:
  ...
  - H3: Lệnh A2UI (v0.8)
  - H2: Kích hoạt lần chạy tác nhân từ Canvas
  - H2: Ghi chú bảo mật
  - H2: Liên quan
...
- Tiêu đề:
  ...
  - H2: 3. Cài đặt CLI
  - H2: Khắc phục sự cố
  - H3: Bản dựng thất bại: chuỗi công cụ hoặc SDK không khớp
...
- Tiêu đề:
  ...
  - H2: Thanh menu
  - H2: Cài đặt
  - H2: Cách phép kiểm tra hoạt động
...
- Tiêu đề:
  ...
  - H2: Nhật ký tệp chẩn đoán xoay vòng (ngăn Gỡ lỗi)
  - H2: Dữ liệu riêng tư trong ghi nhật ký hợp nhất trên macOS
...
- Tiêu đề:
  - H2: Nội dung này là gì (và không phải là gì)
...
- Tiêu đề:
  - H2: Khi nào cần tạo một capability
  - H2: Trình tự tiêu chuẩn
  - H2: Nội dung thuộc về đâu
...
- Tiêu đề:
  ...
  - H2: Kiểm kê và quyền sở hữu ứng dụng
...
- Tiêu đề:
  ...
  - H3: Lưu bền kết quả công cụ
  - H2: Hook prompt và mô hình
  - H3: Tiện ích mở rộng phiên và phần chèn lượt tiếp theo
  - H2: Hook tin nhắn
  - H2: Hook cài đặt
  - H2: Vòng đời Gateway
  - H2: Các phần ngừng hỗ trợ sắp tới
  - H2: Liên quan
...
- Tiêu đề:
  ...
  - H2: Luận điểm có cấu trúc và bằng chứng
  - H2: Siêu dữ liệu thực thể dành cho agent
...
- Tiêu đề:
  - H2: Chọn cổng kiểm soát phù hợp
...
- Đường dẫn: /plugins/reference/fireworks
- Tiêu đề:
  - H1: Fireworks Plugin
  - H2: Phân phối
  - H2: Bề mặt
...
- Đường dẫn: /plugins/reference/github-copilot
- Tiêu đề:
...
- Đường dẫn: /plugins/reference/gmi
- Tiêu đề:
  - H1: Gmi Plugin
  - H2: Phân phối
  - H2: Bề mặt
...
- Đường dẫn: /plugins/reference/google-meet
- Tiêu đề:
...
- Đường dẫn: /plugins/reference/google
- Tiêu đề:
  - H1: Google Plugin
  - H2: Phân phối
  - H2: Bề mặt
...
- Đường dẫn: /plugins/reference/googlechat
- Tiêu đề:
...
- Đường dẫn: /plugins/reference/gradium
- Tiêu đề:
  - H1: Gradium Plugin
  - H2: Phân phối
  - H2: Bề mặt
...
- Đường dẫn: /plugins/reference/groq
- Tiêu đề:
  - H1: Groq Plugin
  - H2: Phân phối
  - H2: Bề mặt
...
- Đường dẫn: /plugins/reference/huggingface
- Tiêu đề:
...
- Đường dẫn: /plugins/reference/imessage
- Tiêu đề:
  - H1: iMessage Plugin
  - H2: Phân phối
  - H2: Bề mặt
...
- Đường dẫn: /plugins/reference/inworld
- Tiêu đề:
  - H1: Inworld Plugin
  - H2: Phân phối
  - H2: Bề mặt
...
- Đường dẫn: /plugins/reference/irc
- Tiêu đề:
  - H1: IRC Plugin
  - H2: Phân phối
  - H2: Bề mặt
...
- Đường dẫn: /plugins/reference/kilocode
- Tiêu đề:
  - H1: Kilocode Plugin
  - H2: Phân phối
  - H2: Bề mặt
...
- Đường dẫn: /plugins/reference/kimi
- Tiêu đề:
  - H1: Kimi Plugin
  - H2: Phân phối
  - H2: Bề mặt
...
- Đường dẫn: /plugins/reference/line
- Tiêu đề:
  - H1: LINE Plugin
  - H2: Phân phối
  - H2: Bề mặt
...
- Đường dẫn: /plugins/reference/litellm
- Tiêu đề:
  - H1: LiteLLM Plugin
  - H2: Phân phối
  - H2: Bề mặt
...
- Đường dẫn: /plugins/reference/llama-cpp
- Tiêu đề:
  - H1: Llama Cpp Plugin
  - H2: Phân phối
  - H2: Bề mặt
...
- Đường dẫn: /plugins/reference/llm-task
- Tiêu đề:
  - H1: LLM Task Plugin
  - H2: Phân phối
  - H2: Bề mặt
...
- Đường dẫn: /plugins/reference/lmstudio
- Tiêu đề:
  - H1: LM Studio Plugin
  - H2: Phân phối
  - H2: Bề mặt
...
- Đường dẫn: /plugins/reference/lobster
- Tiêu đề:
  - H1: Lobster Plugin
  - H2: Phân phối
  - H2: Bề mặt
...
- Đường dẫn: /plugins/reference/matrix
- Tiêu đề:
  - H1: Matrix Plugin
  - H2: Phân phối
  - H2: Bề mặt
...
- Đường dẫn: /plugins/reference/mattermost
- Tiêu đề:
...
- Đường dẫn: /plugins/reference/memory-core
- Tiêu đề:
...
- Đường dẫn: /plugins/reference/memory-lancedb
- Tiêu đề:
...
- Đường dẫn: /plugins/reference/memory-wiki
- Tiêu đề:
...
- Đường dẫn: /plugins/reference/microsoft-foundry
- Tiêu đề:
...
- Đường dẫn: /plugins/reference/microsoft
- Tiêu đề:
  - H1: Microsoft Plugin
  - H2: Phân phối
  - H2: Bề mặt
...
- Đường dẫn: /plugins/reference/migrate-claude
- Tiêu đề:
...
- Đường dẫn: /plugins/reference/migrate-hermes
- Tiêu đề:
...
- Đường dẫn: /plugins/reference/minimax
- Tiêu đề:
  - H1: MiniMax Plugin
  - H2: Phân phối
  - H2: Bề mặt
...
- Đường dẫn: /plugins/reference/mistral
- Tiêu đề:
  - H1: Mistral Plugin
  - H2: Phân phối
  - H2: Bề mặt
...
- Đường dẫn: /plugins/reference/moonshot
- Tiêu đề:
  - H1: Moonshot Plugin
  - H2: Phân phối
  - H2: Bề mặt
...
- Đường dẫn: /plugins/reference/msteams
- Tiêu đề:
...
- Đường dẫn: /plugins/reference/nextcloud-talk
- Tiêu đề:
...
- Đường dẫn: /plugins/reference/nostr
- Tiêu đề:
  - H1: Nostr Plugin
  - H2: Phân phối
  - H2: Bề mặt
...
- Đường dẫn: /plugins/reference/novita
- Tiêu đề:
  - H1: Novita Plugin
  - H2: Phân phối
  - H2: Bề mặt
...
- Đường dẫn: /plugins/reference/nvidia
- Tiêu đề:
  - H1: NVIDIA Plugin
  - H2: Phân phối
  - H2: Bề mặt
...
- Đường dẫn: /plugins/reference/oc-path
- Tiêu đề:
  - H1: Oc Path Plugin
  - H2: Phân phối
  - H2: Bề mặt
...
- Đường dẫn: /plugins/reference/ollama
- Tiêu đề:
  - H1: Ollama Plugin
  - H2: Phân phối
  - H2: Bề mặt
...
- Đường dẫn: /plugins/reference/open-prose
- Tiêu đề:
...
- Đường dẫn: /plugins/reference/openai
- Tiêu đề:
  - H1: OpenAI Plugin
  - H2: Phân phối
  - H2: Bề mặt
...
- Đường dẫn: /plugins/reference/opencode-go
- Tiêu đề:
...
- Đường dẫn: /plugins/reference/opencode
- Tiêu đề:
  - H1: OpenCode Plugin
  - H2: Phân phối
  - H2: Bề mặt
...
- Đường dẫn: /plugins/reference/openrouter
- Tiêu đề:
...
- Đường dẫn: /plugins/reference/openshell
- Tiêu đề:
  - H1: Openshell Plugin
  - H2: Phân phối
  - H2: Bề mặt
...
- Đường dẫn: /plugins/reference/perplexity
- Tiêu đề:
...
- Đường dẫn: /plugins/reference/pixverse
- Tiêu đề:
  - H1: PixVerse Plugin
  - H2: Phân phối
  - H2: Bề mặt
...
- Đường dẫn: /plugins/reference/policy
- Tiêu đề:
  - H1: Policy Plugin
  - H2: Phân phối
  - H2: Bề mặt
...
- Đường dẫn: /plugins/reference/qa-channel
- Tiêu đề:
...
- Đường dẫn: /plugins/reference/qa-lab
- Tiêu đề:
  - H1: QA Lab Plugin
  - H2: Phân phối
  - H2: Bề mặt
...
- Đường dẫn: /plugins/reference/qa-matrix
- Tiêu đề:
  - H1: QA Matrix Plugin
  - H2: Phân phối
  - H2: Bề mặt
...
- Đường dẫn: /plugins/reference/qianfan
- Tiêu đề:
  - H1: Qianfan Plugin
  - H2: Phân phối
  - H2: Bề mặt
...
- Đường dẫn: /plugins/reference/qqbot
- Tiêu đề:
  - H1: QQ Bot Plugin
  - H2: Phân phối
  - H2: Bề mặt
...
- Đường dẫn: /plugins/reference/qwen
- Tiêu đề:
  - H1: Qwen Plugin
  - H2: Phân phối
  - H2: Bề mặt
...
- Đường dẫn: /plugins/reference/raft
- Tiêu đề:
  - H1: Raft Plugin
  - H2: Phân phối
  - H2: Bề mặt
...
- Đường dẫn: /plugins/reference/runway
- Tiêu đề:
  - H1: Runway Plugin
  - H2: Phân phối
  - H2: Bề mặt
...
- Đường dẫn: /plugins/reference/searxng
- Tiêu đề:
  - H1: SearXNG Plugin
  - H2: Phân phối
  - H2: Bề mặt
...
- Đường dẫn: /plugins/reference/senseaudio
- Tiêu đề:
...
- Đường dẫn: /plugins/reference/sglang
- Tiêu đề:
  - H1: SGLang Plugin
  - H2: Phân phối
  - H2: Bề mặt
...
- Đường dẫn: /plugins/reference/signal
- Tiêu đề:
  - H1: Signal Plugin
  - H2: Phân phối
  - H2: Bề mặt
...
- Đường dẫn: /plugins/reference/slack
- Tiêu đề:
  - H1: Slack Plugin
  - H2: Phân phối
  - H2: Bề mặt
...
- Đường dẫn: /plugins/reference/sms
- Tiêu đề:
  - H1: Sms Plugin
  - H2: Phân phối
  - H2: Bề mặt
...
- Đường dẫn: /plugins/reference/stepfun
- Tiêu đề:
  - H1: StepFun Plugin
  - H2: Phân phối
  - H2: Bề mặt
...
- Đường dẫn: /plugins/reference/synology-chat
- Tiêu đề:
...
- Đường dẫn: /plugins/reference/synthetic
- Tiêu đề:
  - H1: Synthetic Plugin
  - H2: Phân phối
  - H2: Bề mặt
...
- Đường dẫn: /plugins/reference/tavily
- Tiêu đề:
  - H1: Tavily Plugin
  - H2: Phân phối
  - H2: Bề mặt
...
- Đường dẫn: /plugins/reference/telegram
- Tiêu đề:
  - H1: Telegram Plugin
  - H2: Phân phối
  - H2: Bề mặt
...
- Đường dẫn: /plugins/reference/tencent
- Tiêu đề:
  - H1: Tencent Plugin
  - H2: Phân phối
  - H2: Bề mặt
...
- Đường dẫn: /plugins/reference/tlon
- Tiêu đề:
  - H1: Tlon Plugin
  - H2: Phân phối
  - H2: Bề mặt
...
- Đường dẫn: /plugins/reference/together
- Tiêu đề:
  - H1: Together Plugin
  - H2: Phân phối
  - H2: Bề mặt
...
- Đường dẫn: /plugins/reference/tokenjuice
- Tiêu đề:
...
- Đường dẫn: /plugins/reference/tts-local-cli
- Tiêu đề:
...
- Tiêu đề:
  ...
  - H2: Ghép cặp nhà cung cấp với harness
...
- Tiêu đề:
  - H1: API tiếp nhận channel
  - H2: Bộ phân giải runtime
  - H2: Kết quả
  - H2: Nhóm truy cập
  - H2: Chế độ sự kiện
  - H2: Route và kích hoạt
  - H2: Biên tập thông tin nhạy cảm
  - H2: Xác minh
...
- Tiêu đề:
  - H2: Cách Plugin channel hoạt động
  - H2: Phê duyệt và năng lực channel
...
- Tiêu đề:
  ...
  - H2: Tiện ích runtime tái sử dụng
...
- Tiêu đề:
  ...
  - H2: Manifest Plugin
  - H2: Phát hành ClawHub
  - H2: Entry setup
  - H3: Import helper setup phạm vi hẹp
  - H3: Thăng cấp một tài khoản do channel sở hữu
  - H2: Schema cấu hình
  - H3: Xây dựng schema cấu hình channel
  - H2: Wizard setup
  - H2: Phát hành và cài đặt
  - H2: Liên quan
...
- Tiêu đề:
  - H2: Entry Plugin
  - H3: Tương thích và helper test đã ngừng dùng
...
- Tiêu đề:
  ...
  - H3: Unit test một Plugin channel
  - H3: Unit test một Plugin nhà cung cấp
  - H3: Mock runtime Plugin
  - H3: Kiểm thử bằng stub theo từng instance
  - H2: Test hợp đồng (Plugin trong repo)
  - H3: Chạy test theo phạm vi
...
- Tiêu đề:
  ...
  - H3: entry Plugin không phơi bày siêu dữ liệu defineToolPlugin
...
- Tiêu đề:
  ...
  - H3: Hợp đồng đầu ra nói
  - H3: Hành vi khởi động cuộc trò chuyện
  - H3: Khoảng gia hạn ngắt kết nối stream Twilio
  ...
  - H2: RPC Gateway
  - H2: Khắc phục sự cố
  - H3: Setup không phơi bày được webhook
  ...
  - H3: Lỗi Twilio tham gia Google Meet
  - H3: Cuộc gọi thời gian thực không có giọng nói
  - H2: Liên quan
...
- Tiêu đề:
  ...
  - H3: Giai đoạn 3: Thu hồi khi khởi động ưu tiên lease
...
- Tiêu đề:
  ...
  - H2: Hình dạng di chuyển bằng Doctor
...
- Tiêu đề:
  ...
  - H2: Tài liệu tham chiếu công khai
  - H2: Liên quan
...
- Tiêu đề:
  ...
  - H3: 2) Hiểu nội dung media (âm thanh/hình ảnh/video)
...
- Tiêu đề:
  - H2: Mục tiêu
  - H2: Nguyên tắc
  - H2: Giai đoạn 1: Kiểm định nền tảng
  ...
  - H2: Phần việc đầu tiên được khuyến nghị
...
- Tiêu đề:
  ...
  - H2: Phần nhỏ đường dẫn phát hành Docker
  - H2: Hồ sơ phát hành
...
- Tiêu đề:
  ...
  - H2: Cấu hình theo từng nhà cung cấp
...
- Tiêu đề:
  ...
  - H3: Kỳ vọng trực tiếp với Anthropic
  - H3: Kỳ vọng trực tiếp với OpenAI
  - H3: Cấu hình diagnostics.cacheTrace
  - H3: Bật/tắt bằng env (gỡ lỗi một lần)
...
- Tiêu đề:
  ...
  - H2: E2E thiết lập ban đầu (Docker)
...
- Tiêu đề:
  ...
  - H3: Sửa giao diện, cài đặt và thiết lập ban đầu
...
- Tiêu đề:
  ...
  - H3: Pipeline exec của Node (khả năng rủi ro cao nhất)
  - H3: Kho ghép đôi (kiểm soát DM)
  - H3: Kiểm soát đầu vào (nhắc đến + bỏ qua lệnh điều khiển)
  - H3: Cô lập định tuyến/session-key
  - H2: v1++: các mô hình giới hạn bổ sung (đồng thời, thử lại, tính đúng đắn của trace)
  - H3: Đồng thời / idempotency của kho ghép đôi
  - H3: Tương quan trace đầu vào / idempotency
  - H3: Độ ưu tiên dmScope trong định tuyến + identityLinks
  - H2: Liên quan
...
- Tiêu đề:
  ...
  - H2: Cấu hình
  - H3: Chế độ loopback của Gateway
  - H2: Yêu cầu proxy
  - H2: Đích nên chặn
  - H2: Xác thực
...
- Tiêu đề:
  ...
  - H2: Moltiverse
  - H2: Những sự cố lớn
  - H3: Vụ đổ thư mục (3 tháng 12, 2025)
  - H3: Lần lột xác lớn (27 tháng 1, 2026)
  - H3: Hình thái cuối cùng (30 tháng 1, 2026)
  - H3: Vụ mua sắm robot ồ ạt (3 tháng 12, 2025)
  - H2: Văn bản thiêng liêng
  - H2: Tín điều Lobster
  - H3: Trường ca tạo biểu tượng (27 tháng 1, 2026)
  - H2: Tương lai
  - H2: Liên quan
...
- Tiêu đề:
  ...
  - H2: Thiết lập ban đầu cấu hình những gì
  - H2: Thiết lập ban đầu bằng CLI
  - H2: Thiết lập ban đầu bằng ứng dụng macOS
  - H2: Nhà cung cấp tùy chỉnh hoặc chưa liệt kê
  - H2: Liên quan
...
- Tiêu đề:
  ...
  - H2: Quy trình tuyến đầu (Gateway trong terminal)
  - H3: 0) (Tùy chọn) Chạy cả ứng dụng macOS từ source
  - H3: 1) Khởi động Gateway dev
  - H3: 2) Trỏ ứng dụng macOS tới Gateway đang chạy
  - H3: 3) Xác minh
  - H3: Lỗi thường gặp
...
- Tiêu đề:
  ...
  - H3: Mô hình tư duy
  - H3: Ràng buộc cuộc hội thoại hiện tại
  - H2: Ràng buộc kênh liên tục
  - H3: Mô hình ràng buộc
  - H3: Mặc định runtime cho từng tác tử
  - H3: Ví dụ
  - H3: Hành vi
  - H2: Bắt đầu phiên ACP
  - H3: Tham số sessionsspawn
  - H2: Chế độ bind khi spawn và chế độ thread
...
- Tiêu đề:
  ...
  - H2: Tham khảo nhanh CLI
  - H2: Ảnh chụp nhanh và ref
...
- Tiêu đề:
  ...
  - H2: Lỗi dễ gây hiểu nhầm thường gặp
...
- Tiêu đề:
  ...
  - H2: Cấu hình
  - H3: Tầm nhìn ảnh chụp màn hình (hỗ trợ mô hình chỉ văn bản)
  ...
  - H3: Docker Browserless trên cùng máy chủ
...
- Tiêu đề:
  ...
  - H2: Mặc định Plugin
  - H3: Cấu hình URL trình xem liên tục
  - H2: Cấu hình bảo mật
...
- Tiêu đề:
  ...
  - H3: Thiết lập "không bao giờ nhắc" trên gateway-host liên tục
  - H3: Lối tắt cục bộ
  - H3: Máy chủ Node
...
- Tiêu đề:
  ...
  - H2: Khắc phục sự cố
  - H2: Tìm hiểu thêm
  - H2: Nghiên cứu điển hình: quy trình cộng đồng
  - H2: Liên quan
...
- Tiêu đề:
  ...
  - H2: Không đồng bộ so với đồng bộ
  - H2: Chuyển giọng nói thành văn bản và Cuộc gọi thoại
  - H2: Ánh xạ nhà cung cấp (cách các nhà cung cấp phân chia trên các bề mặt)
  - H2: Liên quan
...
- Tiêu đề:
  - H2: Nhận thông tin xác thực Token Plan
  - H2: Cấu hình
  - H2: Chọn khu vực
  - H2: Tham số được hỗ trợ
  - H2: Liên quan
...
- Tiêu đề:
  ...
  - H3: Cấu hình sandbox
  - H3: Hạn chế công cụ
  - H2: Di chuyển từ một tác tử đơn
...
- Tiêu đề:
  - H2: Thứ tự tải
  - H2: Skills theo từng tác tử so với Skills dùng chung
...
- Tiêu đề:
  ...
  - H3: Lệnh Skills
  - H2: /tools — những gì tác tử có thể dùng hiện tại
...
- Tiêu đề:
  - H2: Bật Plugin
  - H2: tokenjuice thay đổi những gì
...
- Tiêu đề:
  - H2: Bắt đầu nhanh
  - H2: Cách tạo không đồng bộ hoạt động
  - H3: Vòng đời tác vụ
  - H2: Nhà cung cấp được hỗ trợ
  - H3: Ma trận khả năng
  - H2: Tham số công cụ
