...
x-i18n:
    generated_at: "2026-07-02T22:21:22Z"
    model: gpt-5.5
...
OpenClaw が ClawHub からプラグインをインストールするときは、インストール前に公表された互換性
...
またはブロックされたコンテンツは、診断のため所有者には表示されたまま、
