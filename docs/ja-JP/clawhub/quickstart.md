...
read_when:
    ...
    - ClawHub への公開
summary: 'ClawHub を使い始める: Skills やプラグインを検索、インストール、更新、公開する。'
x-i18n:
    generated_at: "2026-07-04T15:07:34Z"
    model: gpt-5.5
...
OpenClaw は Skills の取得元を記録するため、以後の更新でも ClawHub 経由で解決を続けられます。
...
公開前に、`SKILL.md` のメタデータを確認します。必要な環境変数、ツール、権限を宣言して、ユーザーがインストール前に Skills に必要なものを理解できるようにします。[Skills 形式](/ja-JP/clawhub/skill-format) を参照してください。
