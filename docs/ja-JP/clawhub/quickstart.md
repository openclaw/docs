...
公開する前に、`SKILL.md` のメタデータを確認してください。必須の環境変数、ツール、権限を宣言し、インストール前にユーザーがそのスキルに何が必要かを理解できるようにします。[スキル形式](/ja-JP/clawhub/skill-format)を参照してください。
...
ローカルフォルダー、GitHub repo、GitHub ref、または既存のアーカイブからプラグインを公開します。
