...
title: Plugin 検証の修正
x-i18n:
    generated_at: "2026-06-27T10:49:39Z"
    model: gpt-5.5
...
- 最小パッケージの例については [Plugin の構築](/ja-JP/plugins/building-plugins) を、パッケージとマニフェストの分離については [Plugin マニフェスト](/ja-JP/plugins/manifest#manifest-versus-packagejson) を使用します。
