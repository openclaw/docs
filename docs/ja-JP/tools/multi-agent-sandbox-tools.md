...
<CardGroup cols={3}>
  ...
  <Card title="サンドボックスとツールポリシーと昇格の違い" href="/ja-JP/gateway/sandbox-vs-tool-policy-vs-elevated">
...
<AccordionGroup>
  ...
  <Accordion title="例 2b: グローバルなコーディングプロファイル + メッセージング専用エージェント">
    ```json
    {
...
<AccordionGroup>
  ...
  <Accordion title="deny list にもかかわらずツールがまだ利用可能">
