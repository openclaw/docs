---
read_when:
    - oc-path Pluginをインストール、設定、または監査しています
summary: oc:// ワークスペースファイルのアドレス指定用に openclaw path CLI を追加します。
...
oc:// ワークスペースファイルアドレス指定用の openclaw path CLI を追加します。

## 配布

- パッケージ: `@openclaw/oc-path`
