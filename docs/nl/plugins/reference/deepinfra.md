...
Voegt ondersteuning voor de DeepInfra-modelprovider toe aan OpenClaw.

## Distributie

- Pakket: `@openclaw/deepinfra-provider`
- Installatieroute: npm; ClawHub: `clawhub:@openclaw/deepinfra-provider`
