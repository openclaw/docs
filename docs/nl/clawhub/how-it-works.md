...
Gebruik dry-runs om de opgeloste payload te bekijken voordat je uploadt. Openbare pagina's
...
OpenClaw legt installatiebronmetadata vast zodat updates later hetzelfde
...
voor de eigenaar zichtbaar blijft voor diagnose.
