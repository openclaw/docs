...
x-i18n:
    generated_at: "2026-07-01T13:08:47Z"
    model: gpt-5.5
...
- download-, installatie- en sterren-signalen
...
metadata is belangrijk omdat gebruikers zo beter kunnen beslissen of ze de Skill installeren en
geautomatiseerde scans afwijkingen tussen gedeclareerd en waargenomen gedrag kunnen detecteren.
...
compatibiliteitsinformatie, bronlinks, artefacten en versie-records.
...
Gebruik dry runs om de opgeloste payload vóór het uploaden te bekijken. Openbare pagina's tonen vervolgens
...
volledige OpenClaw-workspace willen gebruiken.
...
canonieke ClawHub-vermelding, rate limits respecteren en vermijden dat ze goedkeuring suggereren.
