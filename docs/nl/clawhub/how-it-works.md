...
plugin beweert te doen voordat zij deze installeren.
...
metadata is belangrijk omdat die gebruikers helpt beslissen of zij de skill willen installeren en
geautomatiseerde scans helpt afwijkingen te detecteren tussen opgegeven en waargenomen gedrag.
...
downloads. Catalogi van derden mogen deze API's gebruiken wanneer zij teruglinken naar de
canonieke ClawHub-vermelding, rate limits respecteren en niet de indruk wekken van goedkeuring.
