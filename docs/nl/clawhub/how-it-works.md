...
x-i18n:
    generated_at: "2026-07-05T07:18:14Z"
    model: gpt-5.5
...
Zie [Skillindeling](/clawhub/skill-format).

## Plugins

Plugins zijn verpakte OpenClaw-uitbreidingen. ClawHub slaat pakketmetadata,
compatibiliteitsinformatie, bronlinks, artefacten en versiegegevens op.
...
updateworkflows voor skills voor gebruikers die registerbeheerde skillmappen willen buiten een
...
Zie [Beveiliging](/nl/clawhub/security), [Beveiligingsaudits](/clawhub/security-audits),
