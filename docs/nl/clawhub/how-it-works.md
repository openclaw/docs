...
x-i18n:
    generated_at: "2026-06-28T22:31:51Z"
    model: gpt-5.5
...
voordat de installatie begint. Pakketrecords kunnen API-compatibiliteit,
...
registerpakket kunnen vinden. De ClawHub CLI ondersteunt ook directe workflows voor skillinstallatie en
-updates voor gebruikers die door het register beheerde skillmappen buiten een
