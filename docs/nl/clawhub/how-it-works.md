...
x-i18n:
    generated_at: "2026-06-30T22:22:18Z"
    model: gpt-5.5
...
Gebruik dry runs om de opgeloste payload te bekijken vóór upload. Openbare pagina’s tonen vervolgens
...
registerpakket kunnen vinden. De ClawHub CLI ondersteunt ook directe installatie- en
updateworkflows voor skills voor gebruikers die door het register beheerde skillmappen willen buiten een
volledige OpenClaw-workspace.
