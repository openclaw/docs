...
x-i18n:
    generated_at: "2026-07-03T13:37:46Z"
    model: gpt-5.5
...
ClawHub leest de frontmatter van `SKILL.md` om de Skill-naam,
...
updateworkflows voor Skills voor gebruikers die door het register beheerde Skill-mappen willen buiten een
