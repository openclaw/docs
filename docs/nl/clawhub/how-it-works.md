...
x-i18n:
    generated_at: "2026-07-03T17:28:03Z"
    model: gpt-5.5
...
Een skill is een versiegebundelde tekstbundel rond `SKILL.md`. Deze kan
...
Gebruik dry runs om de opgeloste payload te bekijken vóór het uploaden. Openbare pagina's tonen daarna
