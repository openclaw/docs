...
summary: 'Ga aan de slag met ClawHub: Skills of plugins zoeken, installeren, bijwerken en publiceren.'
x-i18n:
    generated_at: "2026-07-05T07:19:13Z"
    model: gpt-5.5
...
Een skill is een map met een vereist bestand `SKILL.md` en optionele ondersteunende
bestanden.
...
Code-plugins moeten OpenClaw-compatibiliteitsmetadata in `package.json` opnemen,
