...
ClawHub kunnen blijven resolven.
...
Wanneer je bent ingelogd, kan `sync` ook een minimale installatiesnapshot verzenden
voor geaggregeerde installatietellingen. Zie [Telemetrie](/nl/clawhub/telemetry) voor wat wordt gerapporteerd
