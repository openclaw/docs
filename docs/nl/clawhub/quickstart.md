...
summary: 'Aan de slag met ClawHub: vind, installeer, werk Skills of plugins bij en publiceer ze.'
x-i18n:
    generated_at: "2026-07-05T05:19:53Z"
    model: gpt-5.5
...
OpenClaw legt vast waar de skill vandaan kwam, zodat latere updates via ClawHub
kunnen blijven worden opgelost.
...
moderatie worden vastgehouden of geblokkeerd, kunnen verborgen zijn voor zoek- en installatieoppervlakken totdat ze zijn opgelost.
