...
OpenClaw legt vast waar de skill vandaan kwam, zodat latere updates kunnen blijven
...
Gebruik eerst `--dry-run` om een voorbeeld te bekijken van de opgeloste package-metadata, compatibiliteitsvelden, brontoeschrijving en het uploadplan zonder te publiceren.
...
moderatie zijn vastgehouden of geblokkeerd, kunnen verborgen zijn voor zoek- en installatieoppervlakken totdat dit is opgelost.
