...
x-i18n:
    generated_at: "2026-06-30T22:22:45Z"
    model: gpt-5.5
...
ClawHub kunnen blijven worden omgezet.
...
ClawHub omzet in plaats van via npm of een andere bron.
...
brontoeschrijving en uploadplanning zonder te publiceren.
...
moderatie zijn vastgehouden of geblokkeerd, kunnen verborgen zijn in zoek- en installatie-oppervlakken totdat ze zijn opgelost.
