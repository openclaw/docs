...
summary: 'Begin ClawHub te gebruiken: vind, installeer, werk bij en publiceer Skills of plugins.'
x-i18n:
    generated_at: "2026-07-03T17:29:35Z"
    model: gpt-5.5
...
Skill nodig heeft voordat ze die installeren. Zie [Skill-indeling](/clawhub/skill-format).

Voor repositories die meerdere Skills bevatten, roept de herbruikbare GitHub-workflow
...
brontoeschrijving en het uploadplan te bekijken zonder te publiceren.
...
moderatie worden vastgehouden of geblokkeerd, kunnen verborgen zijn in zoek- en installatie-oppervlakken totdat dit is opgelost.
