...
x-i18n:
    generated_at: "2026-07-03T09:44:45Z"
    model: gpt-5.5
...
`--dry-run` om vooraf te bekijken of `--version` om een expliciete versie te kiezen.
...
worden vastgehouden of geblokkeerd, kunnen verborgen zijn voor zoek- en
