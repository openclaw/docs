...
x-i18n:
    generated_at: "2026-07-01T08:15:18Z"
    model: gpt-5.5
...
ClawHub resolveert in plaats van via npm of een andere bron.
...
brontoewijzing en het uploadplan vooraf te bekijken zonder te publiceren.
...
moderatie kunnen verborgen zijn in zoek- en installatieoppervlakken totdat dit is opgelost.
