...
summary: 'Aan de slag met ClawHub: vind en installeer Skills of Plugins, werk ze bij en publiceer ze.'
x-i18n:
    generated_at: "2026-07-02T01:04:15Z"
    model: gpt-5.5
...
`--dry-run` om vooraf te bekijken of `--version` om een expliciete versie te
kiezen.
...
Voor repositories die meerdere Skills bevatten, roept de herbruikbare
GitHub-workflow `skill publish` aan voor elke directe skillmap onder `skills/`:
...
Gebruik eerst `--dry-run` om de opgeloste pakketmetadata,
compatibiliteitsvelden, bronvermelding en het uploadplan te bekijken zonder te
publiceren.
...
worden vastgehouden of geblokkeerd, kunnen verborgen blijven voor zoek- en
