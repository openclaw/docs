...
Installeer de ClawHub CLI wanneer u register-geauthenticeerde workflows wilt, zoals
...
Plugininstallaties valideren geadverteerde compatibiliteit met `pluginApi` en
`minGatewayVersion` voordat archiefinstallatie wordt uitgevoerd. Wanneer een pakketversie een
...
Wanneer u `clawhub install` uitvoert terwijl u bent ingelogd, kan de CLI naar beste vermogen een
