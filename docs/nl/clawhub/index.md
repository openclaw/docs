...
title: ClawHub
x-i18n:
    generated_at: "2026-07-01T20:27:02Z"
    model: gpt-5.5
...
- Gebruik de aparte `clawhub` CLI voor registerauthenticatie, publiceren en workflows voor verwijderen/herstellen.
...
| Surface        | Wat het opslaat                                             | Typische opdracht                            |
| -------------- | ----------------------------------------------------------- | -------------------------------------------- |
...
Kale npm-veilige pluginspecificaties kunnen tijdens lanceringsomschakelingen via npm worden opgelost, en
...
het de ClawHub-digestheader en gedownloade bytes, en legt het artefactmetadata vast voor
latere updates.
...
door scans worden vastgehouden of geblokkeerd, kunnen uit de openbare catalogus en installatieoppervlakken verdwijnen,
