...
title: ClawHub
x-i18n:
    generated_at: "2026-07-01T15:27:34Z"
    model: gpt-5.5
...
| Bundle-plugins | Verpakte pluginbundels voor OpenClaw-distributie            | `clawhub package publish <source>`           |
...
opgelost. Kale npm-veilige pluginspecificaties kunnen tijdens lanceringsoverschakelingen
...
gedownloade bytes, en registreert het artefactmetadata voor latere updates.
...
registreren geïnstalleerde versies in `.clawhub/lock.json`.
...
- `--tags <tags>`: door komma's gescheiden tags, standaard ingesteld op `latest`.
...
opdrachtreferentie en [Skill-indeling](/clawhub/skill-format) voor Skill-metadata.
...
verbannen. Zie [Beveiliging](/nl/clawhub/security),
