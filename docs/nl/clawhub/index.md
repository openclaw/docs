...
read_when:
    ...
    - Skills of plugins naar de registry publiceren
...
title: ClawHub
x-i18n:
    generated_at: "2026-07-03T09:45:08Z"
    model: gpt-5.5
...
De CLI heeft ook skillinstallatie- en updateopdrachten voor directe registerworkflows:
...
Veelvoorkomende publicatieopties:
...
inhoud verbergen of herstellen, en misbruikaccounts verbannen. Zie
