...
Installeer de ClawHub CLI wanneer je register-geauthenticeerde workflows wilt, zoals
...
opdrachtreferentie en [Skill-indeling](/nl/clawhub/skill-format) voor Skill-metadata.

## Beveiliging en moderatie

ClawHub is standaard open: iedereen kan uploaden, maar publiceren vereist een GitHub-
account dat oud genoeg is om de uploadcontrole te passeren. Openbare detailpagina's vatten de
...
of geblokkeerd, kunnen verdwijnen uit de openbare catalogus en installatieschermen terwijl ze
