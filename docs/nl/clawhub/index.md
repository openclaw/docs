...
title: ClawHub
x-i18n:
    generated_at: "2026-07-05T07:19:21Z"
    model: gpt-5.5
...
downloads, sterren en samenvattingen van beveiligingsscans bij. Openbare pagina's tonen de huidige registerstatus, zodat gebruikers een skill of plugin kunnen bekijken voordat ze die installeren.
...
opgelost. Kale npm-veilige pluginspecificaties kunnen tijdens introductie-overgangen via npm worden opgelost, en
`npm:<package>` blijft alleen npm wanneer een bron expliciet moet zijn.

Plugininstallaties valideren geadverteerde compatibiliteit voor `pluginApi` en
...
De CLI heeft ook opdrachten voor skill-installatie en -updates voor directe registerworkflows:
...
Veelgebruikte publicatie-opties:

- `--slug <slug>`: gepubliceerde URL-naam van de skill.
...
opdrachtnaslag en [Skill-indeling](/clawhub/skill-format) voor skillmetadata.
...
of geblokkeerd, kunnen verdwijnen uit openbare catalogus- en installatieoppervlakken terwijl
...
[Probleemoplossing](/clawhub/troubleshooting) voor dieper naslagmateriaal.
