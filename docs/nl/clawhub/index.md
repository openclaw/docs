...
Installeer de ClawHub CLI wanneer je registry-geauthenticeerde workflows wilt gebruiken, zoals
...
| Bundel-Plugins | Verpakte Pluginbundels voor OpenClaw-distributie                 | `clawhub package publish <source>`           |
...
zodat gebruikers een Skill of Plugin kunnen bekijken voordat ze die installeren.
...
ClawPack-artefact publiceert, geeft OpenClaw de voorkeur aan het exact geüploade npm-pack `.tgz`, verifieert
de ClawHub-digestheader en gedownloade bytes, en registreert artefactmetadata voor
latere updates.

## ClawHub CLI

De ClawHub CLI is voor registry-geauthenticeerd werk:
...
De CLI heeft ook opdrachten voor Skill-installatie/-update voor directe registry-workflows:
...
referentie en [Skill-indeling](/clawhub/skill-format) voor Skill-metadata.
