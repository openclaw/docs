...
title: ClawHub
x-i18n:
    generated_at: "2026-07-04T15:24:30Z"
    model: gpt-5.5
...
Gebruik `clawhub:<package>` wanneer een plugininstallatie via ClawHub moet worden resolved.
Kale npm-veilige pluginspecificaties kunnen tijdens overgangsmomenten rond lanceringen via npm worden resolved, en
...
ClawPack-artefact publiceert, geeft OpenClaw de voorkeur aan het exacte geüploade npm-pack `.tgz`, verifieert
het de ClawHub-digestheader en gedownloade bytes, en registreert het artefactmetadata voor
latere updates.
...
door scans worden vastgehouden of geblokkeerd, kunnen verdwijnen uit openbare catalogus- en installatieoppervlakken terwijl
