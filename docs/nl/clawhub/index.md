...
title: ClawHub
x-i18n:
    generated_at: "2026-06-30T22:23:35Z"
    model: gpt-5.5
...
- Gebruik de afzonderlijke `clawhub` CLI voor registerauthenticatie, publiceren en werkstromen voor verwijderen/herstellen.
...
Installeer de ClawHub CLI wanneer je registergeauthenticeerde werkstromen wilt, zoals
...
Plugininstallaties valideren de geadverteerde compatibiliteit voor `pluginApi` en `minGatewayVersion`
...
De CLI heeft ook opdrachten voor het installeren/bijwerken van Skills voor directe registerwerkstromen:
