...
title: ClawHub
x-i18n:
    generated_at: "2026-07-02T14:06:45Z"
    model: gpt-5.5
...
- Gebruik de afzonderlijke `clawhub` CLI voor registerauthenticatie, publiceren en workflows voor verwijderen/ongedaan maken van verwijderen.
...
Kale npm-veilige pluginspecificaties kunnen tijdens startovergangen via npm worden opgelost, en
