...
title: ClawHub
x-i18n:
    generated_at: "2026-07-04T10:50:17Z"
    model: gpt-5.5
...
Kale npm-veilige pluginspecificaties kunnen via npm worden opgelost tijdens launch-cutovers, en
...
`openclaw.build.openclawVersion`. Zie [CLI](/nl/clawhub/cli) voor de volledige opdrachtenreferentie
...
of geblokkeerd, kunnen uit de openbare catalogus en installatieschermen verdwijnen terwijl
...
een installatie-event verzenden zodat ClawHub geaggregeerde installatietellingen kan berekenen. Schakel dit uit met:
