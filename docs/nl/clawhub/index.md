...
title: ClawHub
x-i18n:
    generated_at: "2026-07-01T08:14:37Z"
    model: gpt-5.5
...
Plugininstallaties valideren de geadverteerde compatibiliteit met `pluginApi` en
...
content verbergen of herstellen, en misbruikende accounts bannen. Zie
...
Wanneer je `clawhub install` uitvoert terwijl je bent ingelogd, kan de CLI op best-effort-basis
