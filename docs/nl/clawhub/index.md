...
title: ClawHub
x-i18n:
    generated_at: "2026-07-02T08:28:46Z"
    model: gpt-5.5
...
- Gebruik native `openclaw`-opdrachten om Skills te zoeken, installeren en bij te werken, en om plugins van ClawHub te installeren.
- Gebruik de afzonderlijke `clawhub` CLI voor registry-authenticatie, publiceren en workflows voor verwijderen/herstellen.
...
Kale npm-veilige pluginspecificaties kunnen tijdens overgangsperiodes bij de lancering via npm worden opgelost, en
...
De CLI heeft ook opdrachten voor het installeren/bijwerken van Skills voor directe registry-workflows:
...
Gebruikelijke publicatieopties:
