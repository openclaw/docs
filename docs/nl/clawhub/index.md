...
title: ClawHub
x-i18n:
    generated_at: "2026-07-05T05:19:36Z"
    model: gpt-5.5
...
Kale npm-veilige pluginspecificaties kunnen tijdens overgangsfases bij de lancering via npm worden opgelost, en
...
`openclaw.build.openclawVersion`. Zie [CLI](/nl/clawhub/cli) voor de volledige opdrachtnaslag
...
of geblokkeerd, kunnen verdwijnen uit de openbare catalogus en installatieschermen terwijl
...
[Acceptabel gebruik](/nl/clawhub/acceptable-usage) voor beleid en handhavingsdetails.
...
[Probleemoplossing](/nl/clawhub/troubleshooting) voor uitgebreider naslagmateriaal.
