...
summary: Los de validatiebevindingen voor het ClawHub-Plugin-pakket op voordat je publiceert
title: Plugin-validatiefixes
x-i18n:
    generated_at: "2026-07-01T18:16:43Z"
    model: gpt-5.5
...
geautomatiseerde pakketscans. Deze pagina behandelt auteurgerichte bevindingen, dat wil zeggen
...
- Bouw het pakket als het entrypoint wordt gegenereerd naar `dist`.
...
- Los ongeldige pakketmetadata, kapotte levenscyclusscripts of files-vermeldingen op die
...
- Spiegel env-gestuurde channel-setup naar de huidige setup, channelconfig of
  pakketchannelmetadata die door je pluginvorm wordt gebruikt.
