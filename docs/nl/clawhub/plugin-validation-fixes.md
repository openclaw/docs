...
summary: Los bevindingen in de validatie van ClawHub-Plugin-pakketten op vóór publicatie
title: Plugin-validatiefixes
x-i18n:
    generated_at: "2026-07-01T15:27:47Z"
    model: gpt-5.5
...
imports of gepubliceerde artefact.
...
- Houd pakketentrypoints, compatibiliteit, installatie, setup en catalogmetadata
...
- Verplaats runtimegedrag naar pluginregistratiecode en beperk `contracts`
  tot statische metagegevens over capability-eigenaarschap.
- Voer `clawhub package validate <path-to-plugin>` opnieuw uit.
...
Het manifest gebruikt nog steeds verouderde `providerAuthEnvVars`-provider-authmetagegevens.
...
Het manifest gebruikt verouderde of oudere channel-env-varmetagegevens zonder de huidige
