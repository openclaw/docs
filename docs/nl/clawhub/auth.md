...
x-i18n:
    generated_at: "2026-07-02T14:06:32Z"
    model: gpt-5.5
...
Verwijderde, verbannen of uitgeschakelde accounts kunnen normaal aanmelden bij ClawHub niet voltooien.
Als aanmelden je terugbrengt naar een afgemelde status, is je account mogelijk niet in goede
staat. Als je account is verbannen of uitgeschakeld, gebruik dan het
