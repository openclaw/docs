...
Verwijderde, geblokkeerde of uitgeschakelde accounts kunnen de normale ClawHub-aanmelding niet voltooien. Als aanmelden je terugbrengt naar een afgemelde status, heeft je account mogelijk geen goede status.
...
Maak een token in de ClawHub-webinterface en geef het daarna door aan de CLI:
