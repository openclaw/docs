...
via dat aangemelde account worden aangemaakt.
...
Als je na het aanmelden terugkeert naar een afgemelde toestand, heeft je account mogelijk geen goede
...
De standaard aanmeldstroom van de CLI opent je browser:
...
Maak een token aan in de ClawHub-web-UI en geef het vervolgens door aan de CLI:
