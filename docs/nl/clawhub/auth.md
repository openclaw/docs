...
x-i18n:
    generated_at: "2026-07-02T01:03:48Z"
    model: gpt-5.5
...
Verwijderde, geblokkeerde of uitgeschakelde accounts kunnen het normale aanmelden bij ClawHub niet voltooien.
Als je na het aanmelden terugkeert naar een afgemelde status, heeft je account mogelijk geen goede
