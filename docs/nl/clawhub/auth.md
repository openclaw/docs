...
Verwijderde, geblokkeerde of uitgeschakelde accounts kunnen de normale ClawHub-inlog niet voltooien.
Als inloggen je terugbrengt naar een uitgelogde status, heeft je account mogelijk geen goede
status.

## CLI-inlog

De standaard CLI-inlogflow opent je browser:
...
2. Je browser opent de ClawHub-inlogpagina.
