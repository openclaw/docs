...
x-i18n:
    generated_at: "2026-07-03T09:44:15Z"
    model: gpt-5.5
...
Als aanmelden u terugbrengt naar een afgemelde staat, heeft uw account mogelijk geen goede
status. Als uw account is geblokkeerd of uitgeschakeld, gebruik dan het
[ClawHub-bezwaarformulier](https://appeals.openclaw.ai/) als u denkt dat dit een
vergissing is.

## CLI-aanmelding

De standaard CLI-aanmeldingsflow opent uw browser:
...
2. Uw browser opent de aanmeldpagina van ClawHub.
...
Toon het opgeslagen token voor CI-installatie met:
...
Ingetrokken, ongeldige of ontbrekende tokens retourneren `401 Unauthorized`. Meld u opnieuw aan
...
Als uw account is geblokkeerd of uitgeschakeld, gebruik dan het
[ClawHub-bezwaarformulier](https://appeals.openclaw.ai/) als u denkt dat dit een
vergissing is.
