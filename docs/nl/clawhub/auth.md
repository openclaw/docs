...
x-i18n:
    generated_at: "2026-07-03T00:59:38Z"
    model: gpt-5.5
...
[ClawHub-bezwaarbeformulier](https://appeals.openclaw.ai/) als je denkt dat dit een
vergissing is.

## CLI-aanmelding

De standaard CLI-aanmeldflow opent je browser:
