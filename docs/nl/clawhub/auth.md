...
Als aanmelding je terugbrengt naar een afgemelde toestand, heeft je account mogelijk geen goede
status. Als je account is geblokkeerd of uitgeschakeld, gebruik dan het
[ClawHub-bezwaarschrift](https://appeals.openclaw.ai/) als je denkt dat dit een
vergissing is.
