...
Verwijderde, gebande of uitgeschakelde accounts kunnen de normale ClawHub-inlogprocedure niet voltooien. Als inloggen je terugbrengt naar een uitgelogde status, heeft je account mogelijk geen goede status. Als je account is geband of uitgeschakeld, gebruik dan het [ClawHub-bezwaarformulier](https://appeals.openclaw.ai/) als je denkt dat dit een vergissing is.
