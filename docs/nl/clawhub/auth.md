...
read_when:
    ...
    - 401-fouten debuggen
summary: Inloggen bij ClawHub, API-tokens, CLI-login, tokenopslag en intrekking.
x-i18n:
    generated_at: "2026-07-04T03:54:05Z"
    model: gpt-5.5
...
ClawHub gebruikt GitHub voor aanmelden op het web. De CLI gebruikt ClawHub API-tokens die
...
Verwijderde, gebande of uitgeschakelde accounts kunnen de normale aanmelding bij ClawHub niet voltooien.
Als je na het aanmelden terugkeert naar een afgemelde staat, heeft je account mogelijk geen goede
status. Als je account is geband of uitgeschakeld, gebruik dan het
[ClawHub-bezwaarfomulier](https://appeals.openclaw.ai/) als je denkt dat dit een
fout is.
