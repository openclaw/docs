---
read_when:
    - Bezig met telemetrie-/privacyinstellingen
    - Vragen over welke gegevens worden verzameld
summary: Installatietelemetrie verzameld door de ClawHub CLI en hoe je je kunt afmelden.
x-i18n:
    generated_at: "2026-07-04T10:51:22Z"
    model: gpt-5.5
...
Bij elke gerapporteerde `clawhub install` verzendt de CLI één installgebeurtenis op best-effortbasis.
