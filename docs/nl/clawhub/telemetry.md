---
read_when:
    - Bezig met telemetrie-/privacy-instellingen
    - Vragen over welke gegevens worden verzameld
summary: Installeer telemetrie die door de ClawHub-CLI wordt verzameld en hoe u zich kunt afmelden.
x-i18n:
...
Bij elke gerapporteerde `clawhub install` verzendt de CLI één install event op best-effortbasis.

Het event bevat:

- `slug`: de slug van de geïnstalleerde vaardigheid.
