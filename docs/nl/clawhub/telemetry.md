...
x-i18n:
    generated_at: "2026-07-03T23:36:32Z"
    model: gpt-5.5
...
Bij elke gerapporteerde `clawhub install` verzendt de CLI één best-effort installatie-event.

Het event bevat:

- `slug`: de geïnstalleerde Skills-slug.
...
ClawHub houdt geaggregeerde tellers bij per Skills:

- `installsAllTime`: unieke gebruikers die ten minste één CLI-installatie voor de Skills hebben gerapporteerd.
