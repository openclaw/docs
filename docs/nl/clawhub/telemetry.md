...
Bij elke gerapporteerde `clawhub install` verzendt de CLI één installatiegebeurtenis voor zover mogelijk.
...
- Geen maplocaties of uit mappen afgeleide identificatiegegevens.
- Geen bestandsinhoud.
...
## Transparantie + gebruikersbeheer
