...
read_when:
    ...
    - Inzicht in openbaarmaking van kwetsbaarheden in ClawHub
...
title: Beveiliging
x-i18n:
    generated_at: "2026-07-02T14:07:14Z"
    model: gpt-5.5
...
- publiceren naar het register, downloads, installaties of artifact-integriteit
...
ClawHub CLI-pakketten, binaire bestanden, bibliotheken of andere release-artifacts die gebruikers
...
Zie voor marktplaatsmeldingen, moderatieblokkeringen, verborgen vermeldingen, bans en accountstatus
