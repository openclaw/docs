...
Plugin van derden. Meld die rechtstreeks bij de uitgever of bronrepository die in de ClawHub-vermelding is gelinkt.
...
standaard niet openbaar gemaakt. Ze worden openbaar gemaakt wanneer er bewijs is van echte impact op gebruikers
of wanneer gebruikers actie moeten ondernemen.
...
ClawHub CLI-pakketten, binaire bestanden, bibliotheken of andere release-artefacten die gebruikers
...
Voor marktplaatsmeldingen, moderatieblokkades, verborgen vermeldingen, bans en accountstatus,
zie [Moderation and Account Safety](/nl/clawhub/moderation).
