...
read_when:
    ...
    - ClawHub-platformproblemen onderscheiden van Skill- of Plugin-problemen van derden
sidebarTitle: Security
summary: Hoe u beveiligingsproblemen in ClawHub meldt en wanneer kwetsbaarheden openbaar worden gemaakt.
title: Beveiliging
x-i18n:
    generated_at: "2026-07-05T07:19:00Z"
    model: gpt-5.5
...
ClawHub-beveiligingsmeldingen bevatten bugs in:
...
Gebruik ClawHub-meldingen niet voor kwetsbaarheden in de eigen broncode van een vaardigheid van derden of
Plugin. Meld die rechtstreeks bij de uitgever of bronrepository
...
Zie voor marktplaatsrapporten, moderatiewachtingen, verborgen vermeldingen, bans en accountstatus
