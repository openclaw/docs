...
x-i18n:
    generated_at: "2026-06-30T14:10:03Z"
    model: gpt-5.5
...
vangrails nodig. Meldingen, moderatieblokkeringen, verborgen vermeldingen en accountmaatregelen
...
Gebruik de knop **Skill melden** op een skillpagina, of de rapportageopdracht/API
voor pakketten.

Gebruik ClawHub-meldingen niet voor kwetsbaarheden in de eigen broncode van een externe skill of
plugin. Meld die rechtstreeks aan de uitgever of de bronrepository die vanuit de vermelding is
...
Geschillen over eigendom van organisaties, merken, pakket-scopes, owner-handles of namespaces moeten
het proces [Claims op organisaties en namespaces](/clawhub/namespace-claims) gebruiken, niet de
...
of anderszins beoordeeld moet worden. Neem geen geheimen, privédocumenten, juridische privébestanden,
persoonlijke identiteitsdocumenten, API-tokens of DNS-challengetokens op in een
openbaar issue.

## Moderatieblokkeringen

Sommige ernstige bevindingen of beleidskwesties kunnen ertoe leiden dat een uitgever of vermelding onder een
moderatieblokkering wordt geplaatst. Wanneer dit gebeurt, kan betrokken content verborgen worden voor openbare
...
gevallen oplost. Ze kunnen ook worden opgeheven wanneer een fout-positieve melding wordt bevestigd.
...
Signalen voor misbruikdruk door uitgevers worden dagelijks gecontroleerd. Signalen die de
...
begint te falen na een accountmaatregel, log dan in bij de web-UI om de accountstatus te
...
Als een door een scanner getriggerde e-mail een versie van een skill of plugin als kwaadaardig noemt,
...
Om fout-positieve meldingen te verminderen en gebruikersvertrouwen te verbeteren:
...
- reageer duidelijk als gebruikers of moderators naar releasegedrag vragen
