...
x-i18n:
    generated_at: "2026-07-04T15:24:41Z"
    model: gpt-5.5
...
helpen gebruikers te beschermen wanneer een release of account onveilig, misleidend of
in strijd met beleid lijkt.
...
Gebruik de knop **Skill melden** op een Skill-pagina, of de pakketmeldingsopdracht/API
voor pakketten.
...
Skill- of Plugin-code van derden.
...
Geschillen over eigendom van orgs, merken, pakketscopes, owner-handles of namespaces moeten
...
moderatieblokkade plaatsen. Wanneer dit gebeurt, kan getroffen inhoud worden verborgen voor openbare
ontdekking of kunnen toekomstige publicaties verborgen starten totdat het probleem is beoordeeld.

Moderatieblokkades zijn bedoeld om gebruikers te beschermen terwijl ClawHub hoogrisicogevallen
...
leiden tot accountbans, tokenintrekking, verborgen inhoud of verwijderde vermeldingen.
...
begint te mislukken na een accountactie, log dan in op de web-UI om de accountstatus
te bekijken. Als inloggen of normale CLI-toegang wordt geblokkeerd door een ban of uitgeschakeld account,
