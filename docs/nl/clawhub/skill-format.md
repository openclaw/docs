...
x-i18n:
    generated_at: "2026-07-03T09:44:51Z"
    model: gpt-5.5
...
Declareer de runtime-vereisten van je skill onder `metadata.openclaw` (aliassen: `metadata.clawdbot`, `metadata.clawdis`).
...
- Ingesloten tekst omvat `SKILL.md` + tot ongeveer 40 niet-`.md`-bestanden (best-effort-limiet).
...
- Package-slugs moeten in kleine letters staan en npm-veilig zijn, bijvoorbeeld `@example.tools/demo-plugin` of `demo-plugin`.
...
- Iedereen mag gepubliceerde skills gebruiken, aanpassen en herdistribueren, ook commercieel.
