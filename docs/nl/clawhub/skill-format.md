...
summary: Skills-mapindeling, vereiste bestanden, toegestane bestandstypen, limieten.
x-i18n:
...
- Als je skill integreert met een betaalde externe service, documenteer dan duidelijk de externe kosten en het vereiste account in de instructies van de skill en de env-declaraties (`requires.env` voor vereiste variabelen, of `envVars` met `required: false` voor optionele variabelen).
