...
x-i18n:
    generated_at: "2026-07-04T10:50:01Z"
    model: gpt-5.5
...
De webgebaseerde GitHub-importer is strikter dan lokaal publiceren/synchroniseren. Deze ontdekt alleen
...
- Tekst voor embeddings omvat `SKILL.md` + maximaal ongeveer 40 niet-`.md`-bestanden (best-effort-limiet).
...
- Alle skills die op ClawHub worden gepubliceerd, zijn gelicentieerd onder `MIT-0`.
