...
x-i18n:
    generated_at: "2026-07-03T02:50:15Z"
    model: gpt-5.5
...
`SKILL.md`- of verouderde `skills.md`-bestanden in openbare, niet-fork-repositories die eigendom zijn van
...
- Package-scopes moeten exact overeenkomen met de ClawHub-publisherhandle. Publisherhandles kunnen kleine letters, cijfers, koppeltekens, punten en underscores gebruiken; ze moeten beginnen en eindigen met een kleine letter of cijfer.
...
- Als je skill integreert met een betaalde service van derden, documenteer dan duidelijk de externe kosten en het vereiste account in de skillinstructies en omgevingsdeclaraties (`requires.env` voor vereiste variabelen, of `envVars` met `required: false` voor optionele variabelen).
