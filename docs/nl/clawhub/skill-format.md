...
x-i18n:
    generated_at: "2026-07-03T23:37:18Z"
    model: gpt-5.5
...
het ingelogde GitHub-account. Deze importeert geen privérepo's, forks,
...
Als je skill afhankelijkheden geïnstalleerd moet hebben, declareer je die in de `install`-array:
...
- Package-slugs moeten uit kleine letters bestaan en npm-veilig zijn, bijvoorbeeld `@example.tools/demo-plugin` of `demo-plugin`.
