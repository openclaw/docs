...
x-i18n:
    generated_at: "2026-05-12T12:49:30Z"
    model: gpt-5.5
    provider: openai
...
- Inbeddingstekst omvat `SKILL.md` + maximaal ongeveer 40 niet-`.md`-bestanden (best-effort limiet).

## Slugs

- Standaard afgeleid van de mapnaam.
- Moeten lowercase en URL-veilig zijn: `^[a-z0-9][a-z0-9-]*$`.
