...
x-i18n:
    generated_at: "2026-07-03T01:00:45Z"
    model: gpt-5.5
...
De GitHub-importer op het web is strikter dan lokaal publiceren/synchroniseren. Hij ontdekt alleen
`SKILL.md`- of legacy `skills.md`-bestanden in openbare, niet-fork repositories die eigendom zijn van
het aangemelde GitHub-account. Hij importeert geen private repositories, forks,
...
- Insluitingstekst omvat `SKILL.md` + maximaal ongeveer 40 niet-`.md`-bestanden (best-effortlimiet).
