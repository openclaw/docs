...
x-i18n:
    generated_at: "2026-07-03T13:38:54Z"
    model: gpt-5.5
...
De webgebaseerde GitHub-importer is strikter dan lokaal publiceren/synchroniseren. Hij ontdekt alleen
`SKILL.md`- of legacy `skills.md`-bestanden in openbare, niet-geforkte repositories die eigendom zijn van
het ingelogde GitHub-account. Hij importeert geen privérepo's, forks,
...
- Pakket-scopes moeten exact overeenkomen met de ClawHub-publisherhandle. Publisherhandles kunnen kleine letters, cijfers, koppeltekens, punten en underscores gebruiken; ze moeten beginnen en eindigen met een kleine letter of cijfer.
