...
x-i18n:
    generated_at: "2026-07-01T15:27:24Z"
    model: gpt-5.5
...
Je kunt een catalogus, directory of zoekinterface van derden bouwen boven op de openbare lees-API's van ClawHub. Openbare Skills-metadata en Skills-bestanden worden gepubliceerd onder de licentieregels voor Skills van ClawHub, terwijl de API zelf is voorzien van ratelimieten en verantwoord moet worden gebruikt.
...
- Cache responses en respecteer `429`-, `Retry-After`- en ratelimit-headers in plaats van agressief te pollen.
