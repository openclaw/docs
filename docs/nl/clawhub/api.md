...
x-i18n:
    generated_at: "2026-07-02T08:30:18Z"
    model: gpt-5.5
...
Je kunt een catalogus, directory of zoekoppervlak van derden bouwen boven op de openbare lees-API's van ClawHub. Openbare metadata van Skills en skillbestanden worden gepubliceerd onder de licentieregels voor Skills van ClawHub, terwijl de API zelf rate-limited is en verantwoord moet worden gebruikt.
