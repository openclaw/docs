...
Je kunt een catalogus, directory of zoekoppervlak van derden bouwen boven op de openbare read-API's van ClawHub. Openbare Skill-metadata en Skill-bestanden worden gepubliceerd onder de Skill-licentieregels van ClawHub, terwijl de API zelf rate-limited is en verantwoordelijk moet worden gebruikt.
...
- `POST /api/v1/users/reserve` reserveert rootslugs en private no-release package-placeholders voor een owner-handle.
