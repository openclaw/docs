...
Je kunt een catalogus, directory of zoekinterface van derden bouwen boven op de openbare lees-API's van ClawHub. Openbare skillmetadata en skillbestanden worden gepubliceerd onder de licentieregels voor skills van ClawHub, terwijl de API zelf rate-limited is en verantwoord moet worden gebruikt.
...
- Spiegel geen verborgen, private of door moderatie geblokkeerde inhoud door openbare API-filters of auth-grenzen te omzeilen.
...
- `POST /api/v1/users/reserve` reserveert rootslugs en private no-release-pakketplaceholders voor een eigenaarshandle.
