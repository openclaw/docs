...
x-i18n:
    generated_at: "2026-05-11T20:22:44Z"
    model: gpt-5.5
    provider: openai
...
Je kunt een catalogus, directory of zoekoppervlak van een derde partij bouwen boven op de openbare lees-API's van ClawHub. Openbare metadata van Skills en skillbestanden worden gepubliceerd onder de licentieregels voor Skills van ClawHub, terwijl de API zelf rate-limited is en verantwoord moet worden gebruikt.
...
- `POST /api/v1/users/reserve` reserveert root-slugs en privé-no-release-pakketplaceholders voor een owner-handle.
