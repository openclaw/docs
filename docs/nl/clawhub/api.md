...
Je kunt een catalogus, directory of zoekoppervlak van derden bouwen boven op de openbare lees-API's van ClawHub. Openbare Skills-metadata en Skills-bestanden worden gepubliceerd onder de licentieregels voor Skills van ClawHub, terwijl de API zelf tariefbeperkt is en verantwoord moet worden gebruikt.
...
- Link terug naar de canonieke ClawHub-Skills-URL bij het weergeven van vermeldingen, zodat gebruikers de bronregistratierecord kunnen bekijken.
...
- `POST /api/v1/users/reserve` reserveert root-slugs en privé-placeholderpakketten zonder release voor een owner-handle.
