...
x-i18n:
    generated_at: "2026-07-16T15:18:00Z"
    model: gpt-5.6
...
- Link bij het weergeven van vermeldingen terug naar de canonieke URL van de Skill op ClawHub, zodat gebruikers de bronvermelding in het register kunnen bekijken.
...
- `X-RateLimit-Reset`: seconden sinds het Unix-tijdperk (absoluut hersteltijdstip)
- `RateLimit-Reset`: aantal seconden vertraging tot herstel
- `X-RateLimit-Remaining` / `RateLimit-Remaining`: exact resterend quotum wanneer
  aanwezig; bij succesvolle gesharde verzoeken wordt dit weggelaten in plaats van een globale
  benaderingswaarde te retourneren
- `Retry-After`: aantal seconden vertraging om te wachten bij `429`
