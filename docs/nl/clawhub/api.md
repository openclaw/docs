...
x-i18n:
    generated_at: "2026-05-12T08:43:55Z"
    model: gpt-5.5
    provider: openai
...
Je kunt een catalogus, directory of zoekoppervlak van derden bouwen boven op de openbare lees-API's van ClawHub. Openbare skillmetadata en skillbestanden worden gepubliceerd onder de licentieregels voor skills van ClawHub, terwijl de API zelf rate-limited is en verantwoordelijk moet worden gebruikt.
...
- Link terug naar de canonieke ClawHub-skill-URL bij het weergeven van vermeldingen, zodat gebruikers de bronvermelding in het register kunnen inspecteren.
