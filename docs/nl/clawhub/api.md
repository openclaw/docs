...
x-i18n:
    generated_at: "2026-07-02T14:05:30Z"
    model: gpt-5.5
...
Je kunt een catalogus, directory of zoekoppervlak van derden bouwen boven op de publieke lees-API's van ClawHub. Publieke metagegevens van Skills en skillbestanden worden gepubliceerd onder de licentieregels voor Skills van ClawHub, terwijl de API zelf rate-limited is en verantwoordelijk moet worden gebruikt.
...
- Spiegel geen verborgen, privé- of door moderatie geblokkeerde content door publieke API-filters of authenticatiegrenzen te omzeilen.
...
- Voeg jitter toe aan herhalingen.
...
- `POST /api/v1/users/reserve` reserveert root-slugs en privé-no-release pakketplaatsaanduidingen voor een owner-handle.
