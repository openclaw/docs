...
x-i18n:
    generated_at: "2026-07-03T01:00:07Z"
    model: gpt-5.5
...
gefocust blijft op nuttig bewijs.
...
bevoegdheid en feitelijke content overeen met wat gebruikers redelijkerwijs zouden verwachten?
...
van ClawHub. Het beoordeelt elke release als een agent-gericht artefact: instructies,
metadata, gedeclareerde machtigingen, bestanden, capaciteitssignalen, statische scansignalen,
SkillSpector-bevindingen, VirusTotal-telemetrie en context die door de publisher is aangeleverd.
