...
x-i18n:
    generated_at: "2026-06-30T14:13:10Z"
    model: gpt-5.5
...
ClawHub-beveiligingsaudits helpen je beslissen of een skill of Plugin veilig genoeg is
...
belangrijk voor tools die content kunnen publiceren, gegevens kunnen bewerken, opdrachten kunnen uitvoeren, bestanden kunnen lezen of
...
| `High`       | De release heeft bevoegdheid met grote impact, ernstige bevindingen of schadelijke signalen. |
...
niet dat deze schadelijk is. Het betekent dat de skill bij het doel lijkt te passen, maar
...
ClawHub auditeert ingediende release-artifacts, waaronder:
...
Artifact-pagina's linken naar de volledige audit op:
...
samenwerking laat ClawHub bredere beveiligingsinformatie toevoegen aan beoordeling van skills en plugins.

VirusTotal is vooral nuttig voor bekende schadelijke artifacts, engine-hits en
reputatiesignalen die ClawHub's agentbewuste beoordeling aanvullen. Wanneer aantallen van vendor-engines
...
VirusTotal blijft telemetrie. Het vervangt ClawHub's eigen artifactbewuste
risicoanalyse niet.

## Risicoanalyse

Risicoanalyse wordt intern aangedreven door ClawScan, ClawHub's eigen beveiligingsauditsysteem.
Het beoordeelt elke release als een agentgericht artifact: instructies,
...
onveilige uitvoering, geheugen- of contextvergiftiging en buitensporige agency.

ClawScan behandelt een angstaanjagend ogende capaciteit niet als automatisch schadelijk.
