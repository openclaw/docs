...
read_when:
    ...
    - Uitleg over auditstatus, risiconiveau of bevindingen van ClawHub
sidebarTitle: Security Audits
summary: Hoe u de resultaten van een ClawHub-beveiligingsaudit begrijpt voordat u een skill of plugin installeert.
title: Beveiligingsaudits
x-i18n:
    generated_at: "2026-07-03T09:46:14Z"
    model: gpt-5.5
...
| `Warn`      | Wees extra voorzichtig. ClawHub vond een zorgpunt met hoge impact of een waarschuwingssignaal. |
...
Bevindingen met lage betrouwbaarheid worden verborgen uit het openbare auditoverzicht, zodat de pagina
...
reputatiesignalen die ClawHubs agentbewuste beoordeling aanvullen. Wanneer aantallen
...
onveilige uitvoering, vergiftiging van geheugen of context en overmatige handelingsruimte.
...
de vermelde use case van de release.
