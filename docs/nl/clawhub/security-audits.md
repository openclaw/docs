...
x-i18n:
    generated_at: "2026-07-03T17:28:39Z"
    model: gpt-5.5
...
om te installeren. Ze laten zien wat een release doet, welke autoriteit deze vraagt en
...
| `Warn`      | Wees extra voorzichtig. ClawHub heeft een punt van zorg met grote impact of een waarschuwingssignaal gevonden. |
...
Risiconiveau beschrijft de impactradius: hoeveel macht de release lijkt te hebben als
je deze gebruikt zoals bedoeld.

| Risiconiveau | Betekenis                                                                   |
| ------------ | --------------------------------------------------------------------------- |
| `Low`        | Er is weinig gevoelige autoriteit of gebruikersimpact gevonden.              |
| `Medium`     | De release heeft betekenisvolle autoriteit, zoals accounttoegang of gegevenswijzigingen. |
| `High`       | De release heeft autoriteit met grote impact, ernstige bevindingen of kwaadaardige signalen. |
...
Een publicerende Skill kan bijvoorbeeld `Review` tonen met `Medium` risico. Dat betekent
niet dat deze kwaadaardig is. Het betekent dat de Skill doelgericht lijkt, maar
kan handelen met betekenisvolle accountautoriteit.
...
autoriteit en daadwerkelijke inhoud overeen met wat gebruikers redelijkerwijs mogen verwachten?
...
de opgegeven gebruikssituatie van de release.
