...
x-i18n:
    generated_at: "2026-07-01T15:27:22Z"
    model: gpt-5.5
...
| `Warn`      | Wees extra voorzichtig. ClawHub heeft een zorg met grote impact of waarschuwingssignaal gevonden. |
...
Bevindingen kunnen het label `Info`, `Low`, `Medium`, `High` of `Critical` krijgen. Bevindingen met hogere
...
reputatiesignalen die ClawHubs agentbewuste review aanvullen. Wanneer aantallen van vendor-
engines beschikbaar zijn, vat de audit ze samen in duidelijke taal, zoals:
...
ClawScan behandelt een angstaanjagend ogende capability niet automatisch als kwaadaardig.
Het vraagt of de capability is bekendgemaakt, doelgericht is en wordt ondersteund door
