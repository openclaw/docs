...
summary: ClawHub-beveiligingsauditresultaten begrijpen voordat u een vaardigheid of plugin installeert.
title: Beveiligingsaudits
x-i18n:
    generated_at: "2026-07-02T17:42:34Z"
    model: gpt-5.5
...
om te installeren. Ze laten zien wat een release doet, om welke bevoegdheid deze vraagt, en
...
- de relevante content van de skill of plugin
- een aanbeveling
...
ClawHub audit ingediende release-artifacts, waaronder:
...
samenwerking laat ClawHub bredere beveiligingsintelligentie toevoegen aan beoordeling van skills en plugins.

VirusTotal is vooral nuttig voor bekende kwaadaardige artifacts, engine-hits en
reputatiesignalen die de agent-bewuste beoordeling van ClawHub aanvullen. Wanneer tellingen van leveranciersengines
...
VirusTotal blijft telemetrie. Het vervangt de eigen artifact-bewuste
risicoanalyse van ClawHub niet.

## Risicoanalyse

Risicoanalyse wordt intern aangedreven door ClawScan, het eigen beveiligingsauditsysteem
van ClawHub. Het beoordeelt elke release als een agentgericht artifact: instructies,
...
ClawScan behandelt een beangstigend ogende capaciteit niet automatisch als kwaadaardig.
