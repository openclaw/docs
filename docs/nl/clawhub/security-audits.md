...
reputatiesignalen die ClawHubs agentbewuste beoordeling aanvullen. Wanneer aantallen van vendor-engines
beschikbaar zijn, vat de audit deze samen in duidelijke taal, zoals:
...
ClawScan behandelt een eng ogende capability niet automatisch als kwaadaardig.
