...
read_when:
    ...
    - Beslissen of je een skill of Plugin moet installeren
...
x-i18n:
    generated_at: "2026-07-04T15:24:12Z"
    model: gpt-5.5
...
Het risiconiveau beschrijft het impactbereik: hoeveel macht de release lijkt te hebben als
...
niet dat deze schadelijk is. Het betekent dat de skill op het doel afgestemd lijkt, maar
...
met hogere ernst dragen sterker bij aan het risiconiveau en de auditstatus.
...
vertrouwde industrienorm voor bestandsreputatie en malwarescans, en onze
samenwerking laat ClawHub bredere beveiligingsinformatie toevoegen aan reviews van skills en Plugins.

VirusTotal is vooral nuttig voor bekende schadelijke artefacten, detecties door engines en
reputatiesignalen die de agentbewuste review van ClawHub aanvullen. Wanneer aantallen
...
VirusTotal blijft telemetrie. Het vervangt niet de eigen artefactbewuste
risicoanalyse van ClawHub.
...
Statische-scansignalen zijn interne context voor deze review; ze zijn geen
...
Het vraagt of de capaciteit bekendgemaakt is, afgestemd is op het doel en wordt ondersteund door
de vermelde gebruikssituatie van de release.
