...
x-i18n:
    generated_at: "2026-07-02T08:33:25Z"
    model: gpt-5.5
...
ClawHub-beveiligingsaudits helpen je bepalen of een skill of Plugin veilig genoeg is om
te installeren. Ze tonen wat een release doet, welke bevoegdheid deze vraagt en
...
Het risiconiveau beschrijft de impactradius: hoeveel macht de release lijkt te hebben als
...
niet dat deze kwaadaardig is. Het betekent dat de skill op het beoogde doel lijkt afgestemd, maar
...
partnerschap laat ClawHub bredere beveiligingsintelligentie toevoegen aan de beoordeling van skills en Plugins.

VirusTotal is vooral nuttig voor bekende kwaadaardige artefacten, engine-hits en
reputatiesignalen die de agentbewuste beoordeling van ClawHub aanvullen. Wanneer tellingen van leveranciersengines
beschikbaar zijn, vat de audit ze samen in duidelijke taal, zoals:
...
Wanneer ClawHub geen leveranciers-teltelemetrie heeft om samen te vatten, zegt de audit:
...
onveilige uitvoering, vergiftiging van geheugen of context en te veel handelingsvrijheid.

ClawScan behandelt een zorgwekkend ogende capaciteit niet automatisch als kwaadaardig.
Het vraagt of de capaciteit is bekendgemaakt, op het doel is afgestemd en wordt ondersteund door
de verklaarde gebruikssituatie van de release.
