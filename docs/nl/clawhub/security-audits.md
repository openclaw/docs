...
read_when:
    ...
    - Bepalen of je een vaardigheid of Plugin moet installeren
...
| `Medium`     | De release heeft betekenisvolle bevoegdheden, zoals accounttoegang of dat wijzigingen. |
...
bevoegdheden en feitelijke content aan bij wat gebruikers redelijkerwijs zouden verwachten?
...
reputatiesignalen die de agentbewuste review van ClawHub aanvullen. Wanneer tellingen van
...
onveilige uitvoering, vergiftiging van geheugen of context en buitensporige handelingsruimte.

ClawScan behandelt een eng ogende capaciteit niet automatisch als kwaadaardig.
Het vraagt of de capaciteit bekendgemaakt, doelgericht en ondersteund wordt door
