---
read_when:
    - Begrijpen van ClawHub-beveiligingsauditresultaten
...
x-i18n:
    generated_at: "2026-07-04T03:54:30Z"
    model: gpt-5.5
...
niet dat deze kwaadaardig is. Het betekent dat de skill lijkt aan te sluiten op het doel,
maar kan handelen met betekenisvolle accountbevoegdheden.
...
reputatiesignalen die de agentbewuste beoordeling van ClawHub aanvullen. Wanneer tellingen
van leveranciersengines beschikbaar zijn, vat de audit ze samen in gewone taal, zoals:
...
Wanneer ClawHub geen telemetrie met leverancierstellingen heeft om samen te vatten, zegt de audit:
...
van ClawHub. Het beoordeelt elke release als een artefact gericht op agents: instructies,
...
Het vraagt of de capaciteit bekendgemaakt is, aansluit op het doel en wordt ondersteund door
