...
summary: Problemen oplossen met inloggen bij ClawHub, installeren, publiceren, synchroniseren, bijwerken en API-problemen.
x-i18n:
...
- Controleer of je OpenClaw-versie voldoet aan het opgegeven
  compatibiliteitsbereik van het pakket.
- Als het pakket verborgen, vastgehouden of geblokkeerd is, is het mogelijk pas installeerbaar nadat
