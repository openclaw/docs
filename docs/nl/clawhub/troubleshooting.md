...
summary: Problemen oplossen met aanmelden, installeren, publiceren, bijwerken en API-problemen in ClawHub.
x-i18n:
    generated_at: "2026-07-02T01:03:36Z"
    model: gpt-5.5
...
De CLI start tijdens browseraanmelding een kortstondige lokale callbackserver.
