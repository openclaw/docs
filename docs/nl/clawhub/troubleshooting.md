...
summary: Probleemoplossing voor aanmelden, installeren, publiceren, bijwerken en API-problemen met ClawHub.
x-i18n:
    generated_at: "2026-07-04T06:40:35Z"
    model: gpt-5.5
...
- Als jij eigenaar bent van de skill, meld je aan en inspecteer deze:
...
- Als het pakket verborgen is, wordt vastgehouden of geblokkeerd is, is het mogelijk pas installeerbaar nadat
