...
x-i18n:
    generated_at: "2026-07-03T17:28:38Z"
    model: gpt-5.5
...
- Maak in headless omgevingen een API-token in de ClawHub-webinterface en voer uit:
...
[Org- en namespaceclaims](/nl/clawhub/namespace-claims) voor richtlijnen voor bewijs en wat je
