---
read_when:
    - ClawHub CLI- of OpenClaw-registercommando's mislukken
    - Een pakket kan niet worden geïnstalleerd, gepubliceerd of bijgewerkt
summary: Problemen oplossen met aanmelding bij ClawHub, installatie, publicatie, synchronisatie, updates en API-problemen.
x-i18n:
    generated_at: "2026-05-12T00:58:08Z"
    model: gpt-5.5
    provider: openai
...
persoon maar een paar verzoeken verzendt. Meld je aan waar mogelijk en probeer het opnieuw na de
...
Voor eigenaren zichtbare diagnostiek kan scan-, upload-gate- of moderatiestatus verklaren.
