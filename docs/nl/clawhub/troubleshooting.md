...
x-i18n:
    generated_at: "2026-07-02T22:39:31Z"
    model: gpt-5.5
...
Controleer voor plugins de compatibiliteitsmetadata in `package.json`. Publicaties van code-plugin hebben
OpenClaw-compatibiliteitsvelden nodig, zoals `openclaw.compat.pluginApi` en
...
- Zorg dat je bent aangemeld met het GitHub-account dat eigenaar is van het
  pakket of het kan publiceren.
...
[issue voor organisatie- / namespaceclaim](https://github.com/openclaw/clawhub/issues/new?template=org-namespace-claim.yml)
...
- Respecteer `429` retry-headers en cache openbare lijst-/zoekreacties.
- Link gebruikers terug naar de canonieke ClawHub-vermelding.
- Mirror geen verborgen, private, vastgehouden of door moderatie geblokkeerde content buiten het
