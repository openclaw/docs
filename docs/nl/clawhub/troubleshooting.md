...
summary: Probleemoplossing voor aanmelding, installatie, publicatie, updates en API-problemen met ClawHub.
x-i18n:
    generated_at: "2026-07-04T03:55:09Z"
    model: gpt-5.5
...
De CLI start tijdens browserlogin een lokale callbackserver met korte levensduur.
...
[Org- en namespaceclaims](/clawhub/namespace-claims) voor bewijsrichtlijnen en wat je
...
- Als het pakket verborgen is, wordt vastgehouden of is geblokkeerd, is het mogelijk niet installeerbaar totdat
...
- Spiegel geen verborgen, private, vastgehouden of door moderatie geblokkeerde content buiten het
