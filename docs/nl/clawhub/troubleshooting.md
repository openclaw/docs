...
summary: Problemen met aanmelden bij, installeren, publiceren, bijwerken en API-kwesties van ClawHub oplossen.
x-i18n:
    generated_at: "2026-07-01T13:09:10Z"
    model: gpt-5.5
...
publiceert met de eigenaar die bij de namespace past. Voor pluginpakketten
...
[Org and Namespace Claims](/clawhub/namespace-claims) voor richtlijnen voor bewijs en wat
...
Verwijs het naar de roots die je wilt scannen:
...
- Als het pakket verborgen is, wordt vastgehouden of geblokkeerd is, kan het mogelijk pas worden geïnstalleerd nadat
