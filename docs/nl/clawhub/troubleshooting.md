...
summary: Problemen oplossen met aanmelding, installatie, publicatie, updates en API-problemen in ClawHub.
x-i18n:
    generated_at: "2026-07-03T23:36:57Z"
    model: gpt-5.5
...
Diagnostiek die voor eigenaren zichtbaar is, kan de scan-, upload-gate- of moderatiestatus verklaren.
...
Als publiceren mislukt omdat de eigenaar-handle, org-namespace, pakketscope, skill-
