...
- Als je de eigenaar bent van de skill, meld je dan aan en inspecteer deze:

```bash
clawhub inspect <skill-slug>
```

Diagnostiek die zichtbaar is voor de eigenaar kan de status van scan, uploadgate of moderatie uitleggen.
