...
summary: Probleemoplossing voor ClawHub-aanmeldings-, installatie-, publicatie-, update- en API-problemen.
x-i18n:
    generated_at: "2026-07-02T08:29:27Z"
    model: gpt-5.5
...
- Als jij de skill bezit, meld je dan aan en inspecteer deze:

```bash
clawhub inspect @openclaw/demo
```

Diagnostiek die zichtbaar is voor de eigenaar kan de scan-, uploadgate- of moderatiestatus uitleggen.
...
- Respecteer `429`-retryheaders en cache openbare lijst-/zoekantwoorden.
