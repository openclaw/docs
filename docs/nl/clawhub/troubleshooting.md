...
summary: Problemen oplossen met aanmelden bij ClawHub, installatie, publiceren, updates en API-problemen.
x-i18n:
    generated_at: "2026-06-30T14:10:50Z"
    model: gpt-5.5
...
- Maak in omgevingen zonder grafische interface een API-token aan in de ClawHub-web-UI en voer uit:
...
- Als je een API-token gebruikt, bevestig dan dat het niet is ingetrokken in de web-UI.
...
- Bevestig dat de release openbaar is en niet wordt vastgehouden door scan of moderatie.
...
Diagnostiek die zichtbaar is voor eigenaren kan de scan-, uploadgate- of moderatiestatus verklaren.
...
- Controleer of de bron-URL openbaar is of toegankelijk voor ClawHub.
...
Als publiceren mislukt omdat de eigenaarshandle, org-namespace, pakketscope, Skill-
