...
summary: Problemen met aanmelden, installeren, publiceren, bijwerken en API-problemen in ClawHub oplossen.
x-i18n:
    generated_at: "2026-07-01T08:15:38Z"
    model: gpt-5.5
...
ClawHub gebruikt GitHub-identiteit en bronattributie om pakketten te koppelen aan hun
uitgevers.
...
Als een publicatie mislukt omdat de eigenaarshandle, organisatienamespace, pakketscope, skill-
...
[Organisatie- / namespaceclaim-issue](https://github.com/openclaw/clawhub/issues/new?template=org-namespace-claim.yml)
met openbaar, niet-gevoelig bewijs. Zie
[Organisatie- en namespaceclaims](/clawhub/namespace-claims) voor richtlijnen voor bewijs en wat
...
- Als het pakket verborgen is, wordt tegengehouden of is geblokkeerd, kan het mogelijk niet worden geïnstalleerd totdat
