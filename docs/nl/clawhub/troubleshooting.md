...
- Als je een aangepast configuratiepad gebruikt, controleer dan of `CLAWHUB_CONFIG_PATH` naar het
  bestand verwijst dat je huidige token bevat.
...
publiceert met de eigenaar die overeenkomt met de namespace. Voor Plugin-pakketten moeten
...
[Org- en Namespace-claims](/clawhub/namespace-claims) voor richtlijnen voor bewijs en wat je
...
- Als het pakket verborgen, vastgehouden of geblokkeerd is, is het mogelijk pas installeerbaar
  nadat de eigenaar het probleem heeft opgelost.
