---
read_when:
    - ClawHub CLI- of OpenClaw-registryopdrachten mislukken
    - Een pakket kan niet worden geïnstalleerd, gepubliceerd of bijgewerkt
summary: Problemen met aanmelden, installeren, publiceren, bijwerken en API-kwesties in ClawHub oplossen.
x-i18n:
    generated_at: "2026-07-01T18:16:50Z"
    model: gpt-5.5
...
persoon slechts een paar aanvragen verstuurt. Meld je waar mogelijk aan en probeer het opnieuw na de
gemelde vertraging.
...
Diagnostiek die zichtbaar is voor de eigenaar kan de scan-, uploadgate- of moderatiestatus verklaren.

## Publiceren mislukt omdat verplichte metadata ontbreekt
...
Als publiceren mislukt omdat de eigenaar-handle, org-namespace, package-scope, skill-
...
[Org- en namespaceclaims](/clawhub/namespace-claims) voor richtlijnen voor bewijs en wat
...
- Lokale bewerkingen behouden en de update overslaan.
- Overschrijven met de gepubliceerde versie:

```bash
clawhub update @openclaw/demo --force
```

- Je bewerkte kopie publiceren als een nieuwe slug of fork.
...
- Als het pakket verborgen is, wordt vastgehouden of geblokkeerd, is het mogelijk niet installeerbaar totdat
...
- Mirror geen verborgen, privé-, vastgehouden of door moderatie geblokkeerde content buiten het
