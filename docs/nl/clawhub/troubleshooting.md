...
summary: Probleemoplossing voor aanmelden bij ClawHub, installeren, publiceren, bijwerken en API-problemen.
x-i18n:
...
## Een vaardigheid verschijnt niet in zoekresultaten
...
- Als jij de eigenaar van de vaardigheid bent, meld je dan aan en inspecteer deze:
...
Controleer voor vaardigheden de frontmatter van `SKILL.md`. Vereiste omgevingsvariabelen en
...
Als een publicatie mislukt omdat de eigenaarshandle, org-namespace, pakketscope, vaardigheidsslug
of pakketnaam al is geclaimd of gereserveerd, controleer dan eerst of je publiceert
met de eigenaar die overeenkomt met de namespace. Voor pluginpakketten moeten
...
[Org and Namespace Claims](/clawhub/namespace-claims) voor bewijsrichtlijnen en wat
je buiten openbare issues moet houden.

## `sync` zegt dat er geen vaardigheden zijn gevonden
