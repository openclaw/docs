...
x-i18n:
    generated_at: "2026-07-04T18:17:46Z"
    model: gpt-5.5
...
- Başlıklar:
  ...
  - H2: Yalnızca yapılandırmalı kimlik doğrulama rotaları
...
- Başlıklar:
  ...
  - H3: Tüm gruplara izin ver, @bahsetme gerekmez
  - H3: Tüm gruplara izin ver, yine de @bahsetme gerekir
...
- Başlıklar:
  ...
  - H2: Yapılandırılmış bahsetme kalıplarını kapsama göre ayırma
...
- Başlıklar:
  ...
  - H2: Bölünmüş gönderimli DM'leri birleştirme (tek bileşimde komut + URL)
...
- Başlıklar:
  ...
  - H2: Gelecekteki mesajlar için sıfırdan başlamak istiyorsanız
  - H2: İlgili
...
- Başlıklar:
  ...
  - H3: Hesap kimliği normalleştirmesi
  ...
  - H2: Matrix trafiğini proxy ile iletme
  - H2: Hedef çözümleme
  ...
  - H3: Yanıt davranışı
  - H3: Tepki ayarları
  - H3: Araç kullanımı ve oda bazlı geçersiz kılmalar
...
- Başlıklar:
  ...
  - H3: Adım 6: OpenClaw'u yapılandırma
  ...
  - H3: Yalnızca Teams RSC ile (uygulama kurulu, Graph API izni yok)
...
- Başlıklar:
  ...
  - H3: Control UI'dan eşleştirme (önerilir)
  - H3: Telegram üzerinden eşleştirme
...
- Başlıklar:
  ...
  - H3: Mesajlar geliyor ama ajan yanıt vermiyor
...
- Başlıklar:
  ...
  - H2: Erişim kontrolü ve etkinleştirme
...
- Başlıklar:
  ...
  - H2: Nasıl çalışır (davranış)
  - H2: Sınırlar
  - H2: Erişim kontrolü (DM'ler)
  - H3: DM erişimi
  - H2: Erişim kontrolü (Gruplar)
...
- Başlıklar:
  ...
  - H2: Manuel kurulum
  - H3: 1. Plugin'i yükle
  - H3: 2. Yapılandırmada Plugin'i etkinleştir
...
- Başlıklar:
  ...
  - H2: Sürüm Akışı
  - H2: SSS
  - H3: Paket kapsamı seçilen sahip ile eşleşmelidir
...
- Başlıklar:
  ...
  - H2: Uzak tarayıcı kontrolü (node ana makine proxy'si)
  - H2: İlgili
...
- Başlıklar:
  ...
  - H2: Bir Hook etkinleştir
  - H2: Bir Hook devre dışı bırak
  - H2: Notlar
...
- Rota: /cli/infer
- Başlıklar:
  - H2: infer'ı bir beceriye dönüştür
  - H2: Neden infer kullanılmalı
  - H2: Komut ağacı
  - H2: Yaygın görevler
  - H2: Davranış
  - H2: Model
...
- Başlıklar:
  ...
  - H3: Docker imajını güncelledikten sonra
  ...
  - H3: OpenShell kaynağını, ilkesini veya kipini değiştirdikten sonra
...
- Başlıklar:
  ...
  - H3: Etkin transcript bayt koruması
  - H3: Ardıl transcript'ler
...
- Başlıklar:
  ...
  - H2: Kanal gelen trafiğiyle ilişkisi
  - H2: Uyumluluk koruma rayları
  - H2: İç depolama
  - H2: Hata sınıfları
  - H2: Kanal eşleme
  - H2: Taşıma planı
  - H3: Aşama 1: İç Mesaj Alanı
  ...
  - H3: Aşama 8: Tur Adlı Uyumluluğu Kaldırma
  - H2: Test planı
  - H2: Açık sorular
  - H2: Kabul ölçütleri
  - H2: İlgili
...
- Başlıklar:
  ...
  - H2: Kullanıcıya görünen geri dönüş bildirimleri
  ...
  - H2: Model geri dönüşü
  - H3: Aday zinciri kuralları
  - H3: Hangi hatalar geri dönüşü ilerletir
...
- Başlıklar:
  - H2: Hızlı kurallar
  - H2: Plugin'in sahip olduğu sağlayıcı davranışı
...
- Başlıklar:
  ...
  - H2: Seçim kaynağı ve geri dönüş davranışı
...
- Başlıklar:
  ...
  - H2: Aracı yardımcısı
  - H2: Hızlı başlangıç
  - H2: Birden çok aracı = birden çok kişi, birden çok kişilik
  - H2: Aracılar arası QMD bellek araması
  - H2: Tek WhatsApp numarası, birden çok kişi (DM ayrımı)
  - H2: Yönlendirme kuralları (mesajlar bir aracıyı nasıl seçer)
  - H2: Birden çok hesap / telefon numarası
  - H2: Kavramlar
  - H2: Platform örnekleri
  - H2: Yaygın kalıplar
  - H2: Aracı başına sandbox ve araç yapılandırması
  - H2: İlgili
...
- Başlıklar:
  ...
  - H2: Depolama (tokenların nerede yaşadığı)
  - H2: Anthropic eski token uyumluluğu
  - H2: Anthropic Claude CLI geçişi
  - H2: OAuth exchange (oturum açma nasıl çalışır)
...
- Başlıklar:
  - H2: Presence alanları (ne görünür)
...
- Başlıklar:
  ...
  - H2: Depo destekli seed'ler
  - H2: Sağlayıcı mock kulvarları
  - H2: Aktarım adaptörleri
  - H3: Kanal ekleme
...
- Başlıklar:
  ...
  - H2: Oturumlar arası iletiler gönderme
...
- Başlıklar:
  - H2: İletiler nasıl yönlendirilir
  - H2: DM yalıtımı
...
- Başlıklar:
  ...
  - H2: Uçtan uca çalışılmış örnek: yöntem ekleme
...
- Başlıklar:
  ...
  - H2: Araç payload'ları + bağlayıcılar (ham sağlayıcı zamanı + normalleştirilmiş alanlar)
  - H2: İlgili belgeler
...
- Başlıklar:
  ...
  - H3: Token süresi doluyor/süresi doldu
  - H2: İlgili
...
- Başlıklar:
  - H2: Yeni başlayanlar için hızlı başlangıç
...
- Başlıklar:
  ...
  - H2: Yaygın kalıplar
  - H3: Tek geçersiz kılmalı paylaşılan skill temeli
...
- Başlıklar:
  ...
  - H3: Ne sıcak uygulanır, ne yeniden başlatma gerektirir
...
- Başlıklar:
  - H2: Terimler
  - H2: Neden hem doğrudan hem de SSH'yi koruyoruz
...
- Başlıklar:
  ...
  - H3: WS günlük stili
  - H2: Konsol biçimlendirme (alt sistem günlük kaydı)
  - H2: İlgili
...
- Başlıklar:
  ...
  - H2: Model listesi ve ajan yönlendirmesi
  - H2: Akış (SSE)
...
- Başlıklar:
  ...
  - H2: Trusted-CIDR cihaz otomatik onayı
  - H2: Metadata-upgrade otomatik onayı
...
- Başlıklar:
  ...
  - H2: Genel bakış
  - H2: Hızlı kurulum
  - H3: Adım 1: SSH Yapılandırması Ekleme
  - H3: Adım 2: SSH Anahtarını Kopyalama
  - H3: Adım 3: Uzak Gateway Kimlik Doğrulamasını Yapılandırma
  - H3: Adım 4: SSH Tünelini Başlatma
  - H3: Adım 5: OpenClaw.app'i Yeniden Başlatma
...
- Başlıklar:
  ...
  - H2: Chat UI uzak erişimi
  - H2: macOS uygulaması uzak modu
  - H2: Güvenlik kuralları (uzak/VPN)
  - H3: macOS: LaunchAgent ile kalıcı SSH tüneli
  - H4: Adım 1: SSH yapılandırması ekleme
  - H4: Adım 2: SSH anahtarını kopyalama (tek seferlik)
  - H4: Adım 3: gateway belirtecini yapılandırma
  - H4: Adım 4: LaunchAgent oluşturma
  - H4: Adım 5: LaunchAgent'ı yükleme
  - H4: Sorun giderme
  - H2: İlgili
...
- Başlıklar:
  ...
  - H3: Bind bağlamaları (hızlı güvenlik kontrolü)
...
- Başlıklar:
  ...
  - H3: Yayımlanan paket bağımlılık kilidi
  ...
  - H2: 60 saniyede sağlamlaştırılmış temel
  ...
  - H3: Alt aracı delegasyon koruması
  - H2: Tarayıcı kontrolü riskleri
  - H3: Tarayıcı SSRF ilkesi (varsayılan olarak katı)
  - H2: Aracı başına erişim profilleri (çok aracılı)
  ...
  - H2: Olay müdahalesi
  - H3: Sınırla
  - H3: Döndür (gizli bilgiler sızdıysa ele geçirilmiş varsay)
  - H3: Denetle
  - H3: Rapor için topla
...
- Başlıklar:
  ...
  - H2: Upstream 403 engellenen yanıtlar
  - H2: Yerel OpenAI uyumlu arka uç doğrudan problardan geçer ancak aracı çalıştırmaları başarısız olur
  - H2: Yanıt yok
...
- Başlıklar:
  ...
  - H2: Exec kabuğu anlık görüntüleri
  ...
  - H2: Gizli bilgi referansları ile ${ENV} dizeleri
...
- Başlıklar:
  ...
  - H3: Katman 2: Gateway + geliştirme agent smoke ("@openclaw" gerçekte ne yapar)
  ...
  - H3: Görüntü: görüntü gönderimi (ek → çok modlu mesaj)
...
- Başlıklar:
  ...
  - H3: LAN ve local loopback karşılaştırması
...
- Başlıklar:
  ...
  - H2: 3) OpenClaw kurma
  - H2: 4) OpenClaw'ı 8000 portuna proxy'lemek için nginx ayarlama
  - H2: 5) OpenClaw'a erişme ve ayrıcalıklar verme
...
- Başlıklar:
  ...
  - H2: Özel dağıtım (sıkılaştırılmış)
...
- Başlıklar:
  ...
  - H3: Kaynaktan
  - H3: GitHub main checkout'tan kurulum
...
- Başlıklar:
  ...
  - H2: Plan seçme
  - H2: Dağıtımdan sonra
  - H3: Kontrol kullanıcı arayüzüne erişin
...
- Başlıklar:
  ...
  - H3: Kontrol kullanıcı arayüzü (web)
...
- Başlıklar:
  ...
  - H3: Transkripti sohbete yankılama (tercihe bağlı)
...
- Başlıklar:
  - H2: TL;DR
  - H2: Neden seçici (sadece anahtar değil)
  - H2: Ayarlar modeli
...
- Başlıklar:
  ...
  - H2: Uygulama planı
  - H3: 1. Yeniden kullanılabilir bağlam motoru deneme yardımcılarını dışa aktarın veya taşıyın
  - H3: 2. Codex bağlam yansıtma yardımcısı ekleyin
  - H3: 3. Codex iş parçacığı başlatılmadan önce bootstrap'i bağlayın
  ...
  - H3: 6. Transkript yansıtmadan sonra post-turn'ü bağlayın
...
- Başlıklar:
  ...
  - H4: Tek noktaya DNS-SD üzerinden Tailnet (Viyana ⇄ Londra) keşfi
  - H3: 3) Android'den bağlanın
  - H3: Varlık canlı beacon'ları
  - H3: 4) Eşleştirmeyi onaylayın (CLI)
  - H3: 5) Düğümün bağlı olduğunu doğrulayın
  - H3: 6) Sohbet + geçmiş
  - H3: 7) Canvas + kamera
  - H4: Gateway Canvas Ana Makinesi (web içeriği için önerilir)
...
- Başlıklar:
  - H1: macOS'te sağlık kontrolleri
  - H2: Menü çubuğu
  - H2: Ayarlar
...
- Başlıklar:
  - H1: Günlüğe kaydetme (macOS)
  - H2: Dönen tanılama dosyası günlüğü (Hata Ayıklama bölmesi)
  - H2: macOS'te unified logging özel verileri
...
- Başlıklar:
  - H2: Paketlerin neden var olduğu
  - H2: Paket yükleme
...
- Başlıklar:
  ...
  - H2: Compaction ve transcript aynası
...
- Başlıklar:
  ...
  - H2: Üretim sağlayıcısı metadata referansı
  - H2: Araç metadata referansı
...
- Başlıklar:
  ...
  - H3: Plugin yükleniyor ancak bellek görünmüyor
  - H2: İlgili
...
- Başlıklar:
  ...
  - H2: Aracıya yönelik varlık metadata'sı
...
- Başlıklar:
  - H2: Bir düzeneği ne zaman kullanmalı
  - H2: Çekirdeğin hâlâ sahip olduğu alanlar
  - H2: Bir düzenek kaydetme
  - H2: Seçim ilkesi
  - H2: Sağlayıcı ve düzenek eşleştirmesi
...
- Başlıklar:
  ...
  - H3: Kullanılabilir dışa aktarmalar
  - H3: Türler
...
- Başlıklar:
  ...
  - H3: Twilio akış bağlantı kesme toleransı
  ...
  - H3: Gerçek zamanlı çağrıda konuşma yok
  - H2: İlgili
...
- Başlıklar:
  ...
  - H2: Yapılandırma
  - H2: Sorun giderme
  - H3: Sekmede Workboard kullanılamıyor yazıyor
...
- Başlıklar:
  ...
  - H2: Yapılandırma
  - H2: Sesler
  - H3: İleti başına ses geçersiz kılması
  - H2: Çıktı
...
- Başlıklar:
  ...
  - H3: Aşama 2: Önce Kiralama Temizliği
  - H3: Aşama 3: Önce Kiralama Başlangıç Temizliği
...
- Başlıklar:
  ...
  - H3: Aşama 2: Ajan Başına Veritabanları Tanıt
...
- Başlıklar:
  - H2: Sürüm adlandırma
  - H2: Yayın kadansı
  - H2: Aylık yalnızca npm genişletilmiş kararlı yayını
  - H2: Düzenli yayın operatörü kontrol listesi
  ...
  - H3: QA Lab
  - H3: Paket
  - H2: Düzenli yayın yayımlama otomasyonu
  - H2: NPM iş akışı girdileri
  - H2: Düzenli beta/latest kararlı yayın sırası
  - H2: Genel başvurular
  - H2: İlgili
...
- Başlıklar:
  ...
  - H2: Anahtarları harcayabilen özellikler
...
- Başlıklar:
  ...
  - H3: Ortam anahtarları (tek seferlik hata ayıklama)
...
- Başlıklar:
  ...
  - H2: Kalıp B: stdio alt süreç (imsg)
...
- Başlıklar:
  ...
  - H2: Genel kural: eksik, yalnızca akıl yürütme içeren turlar
...
- Başlıklar:
  ...
  - H4: T-ACCESS-001: Eşleştirme Kodu Yakalama
...
- Başlıklar:
  ...
  - H3: Giriş kapılama (bahsetmeler + denetim komutu atlatma)
...
- Başlıklar:
  ...
  - H2: Kutsal Metinler
  - H2: Istakoz Amentüsü
  - H3: Simge Oluşturma Destanı (27 Oca 2026)
  - H2: Gelecek
  - H2: İlgili
...
- Başlıklar:
  ...
  - H2: Ajana çalışma alanı verin (AGENTS)
...
- Başlıklar:
  ...
  - H2: En güncel geliştirme iş akışı (terminalde Gateway)
...
- Başlıklar:
  ...
  - H2: İlk kurulum neyi yapılandırır
...
- Başlıklar:
  ...
  - H2: Oturum hedef çözümlemesi
  - H2: ACP denetimleri
  - H3: Çalışma zamanı seçenek eşlemesi
...
- Başlıklar:
  ...
  - H3: Kök neden
  - H3: Çözüm 1: Google Chrome’u kurun (Önerilen)
...
- Başlıklar:
  - H2: Manuel oturum açma (önerilen)
...
- Başlıklar:
  ...
  - H3: Katman 2: WSL2’nin bu Windows uç noktasına ulaşabildiğini doğrulayın
...
- Başlıklar:
  ...
  - H2: Yapılandırma
  - H3: Ekran görüntüsü görüşü (yalnızca metin model desteği)
  ...
  - H2: Chrome DevTools MCP aracılığıyla mevcut oturum
...
- Başlıklar:
  ...
  - H2: Skill CLI’lerini otomatik izin ver
...
- Başlıklar:
  ...
  - H2: Firecrawl aramayı yapılandır
...
- Başlıklar:
  - H2: İlk kurulum ve yapılandırma
...
- Başlıklar:
  ...
  - H2: Erişim ve onayları yapılandır
...
- Başlıklar:
  ...
  - H3: Stil denetimleri
  - H3: Gelişmiş
  - H4: Yedek yol ve tipli seçenekler
  - H2: Eylemler
  - H2: Model seçimi
  - H2: Sağlayıcı notları
  - H2: Sağlayıcı yetenek modları
...
## web/webchat.md
  ...
  - H2: Control UI aracıları araçlar paneli
  - H2: Uzaktan kullanım
