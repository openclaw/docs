...
read_when:
    ...
    - Skill veya Plugin kurup kurmamaya karar verme
    - ClawHub denetim durumunu, risk düzeyini veya bulgularını açıklama
sidebarTitle: Security Audits
summary: Bir beceri veya plugin kurmadan önce ClawHub güvenlik denetimi sonuçlarını nasıl anlayacağınız.
title: Güvenlik Denetimleri
x-i18n:
    generated_at: "2026-07-02T14:10:26Z"
    model: gpt-5.5
...
Ayrıca [Güvenlik](/clawhub/security), [Kabul edilebilir kullanım](/clawhub/acceptable-usage)
ve [Moderasyon ve Hesap Güvenliği](/clawhub/moderation) bölümlerine bakın.
...
`Pass` güven vericidir, ancak kendi değerlendirmenizin yerini tutmaz. Bu en çok
...
onun kötü amaçlı olduğu anlamına gelmez. Beceri amaca uygun görünüyor, ancak
anlamlı hesap yetkisiyle hareket edebiliyor demektir.
...
Daha yüksek önem düzeyindeki bulgular, risk düzeyine ve denetim durumuna daha
...
- uyumluluk ve kabiliyet meta verileri
...
VirusTotal özellikle bilinen kötü amaçlı artefaktlar, motor isabetleri ve
...
ClawHub'ın özetleyecek tedarikçi sayısı telemetrisi olmadığında denetim şöyle der:
...
ClawScan tarafından desteklenir. Her sürümü ajanlara yönelik bir artefakt olarak
inceler: talimatlar, meta veriler, bildirilen izinler, dosyalar, kabiliyet
sinyalleri, statik tarama sinyalleri, SkillSpector bulguları, VirusTotal
telemetrisi ve yayımcı tarafından sağlanan bağlam. Statik tarama sinyalleri bu
inceleme için dahili bağlamdır; bağımsız bir herkese açık denetim bölümü veya
kurulumu engelleyen hüküm değildir.

Risk analizi, istem enjeksiyonu, araç kötüye kullanımı, kimlik bilgisi açığa
çıkması, güvenli olmayan yürütme, bellek veya bağlam zehirlenmesi ve aşırı
özerklik gibi riskler için
[OWASP Agentic Skills Top 10](https://owasp.org/www-project-agentic-skills-top-10/)
listesini bir mercek olarak kullanır.

ClawScan, korkutucu görünen bir kabiliyeti otomatik olarak kötü amaçlı saymaz.
Kabiliyetin açıklanmış, amaca uygun ve sürümün belirtilen kullanım amacıyla
