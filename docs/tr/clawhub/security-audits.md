...
summary: Skills veya Plugin yüklemeden önce ClawHub güvenlik denetimi sonuçlarını anlama.
title: Güvenlik Denetimleri
x-i18n:
    generated_at: "2026-07-01T13:17:58Z"
    model: gpt-5.5
...
- sahip, kaynak, sürüm, changelog, indirmeler, yıldızlar ve diğer güven sinyalleri
...
| `Pending`   | Denetimler henüz bitmedi.                                                 |
...
Risk seviyesi etki alanını açıklar: sürümün amaçlandığı gibi kullanıldığında ne kadar güce sahip göründüğünü.
...
Örneğin, yayımlama becerisi `Medium` riskle `Review` gösterebilir. Bu, onun kötü amaçlı olduğu anlamına gelmez. Becerinin amaca uygun göründüğü, ancak anlamlı hesap yetkisiyle hareket edebileceği anlamına gelir.
...
VirusTotal özellikle bilinen kötü amaçlı yapıtlar, motor isabetleri ve ClawHub'ın ajan farkındalıklı incelemesini tamamlayan itibar sinyalleri için yararlıdır. Tedarikçi motor sayıları kullanılabilir olduğunda denetim bunları düz dille özetler, örneğin:
...
Risk analizi, dahili olarak ClawHub'ın kendi güvenlik denetim sistemi olan ClawScan tarafından desteklenir. Her sürümü ajanlara yönelik bir yapıt olarak inceler: yönergeler, meta veriler, bildirilen izinler, dosyalar, yetenek sinyalleri, statik tarama sinyalleri, SkillSpector bulguları, VirusTotal telemetrisi ve yayımcı tarafından sağlanan bağlam. Statik tarama sinyalleri bu inceleme için dahili bağlamdır; bağımsız bir genel denetim bölümü veya yüklemeyi engelleyen karar değildir.

Risk analizi; istem enjeksiyonu, araç kötüye kullanımı, kimlik bilgisi açığa çıkması, güvenli olmayan yürütme, bellek veya bağlam zehirlenmesi ve aşırı yetki kullanımı gibi riskleri değerlendirmek için [OWASP Agentic Skills Top 10](https://owasp.org/www-project-agentic-skills-top-10/) listesini bir mercek olarak kullanır.

ClawScan, korkutucu görünen bir yeteneği otomatik olarak kötü amaçlı saymaz. Yeteneğin açıklanıp açıklanmadığını, amaca uygun olup olmadığını ve sürümün belirtilen kullanım amacı tarafından desteklenip desteklenmediğini sorar.
