...
summary: ClawHub güvenlik denetimi sonuçlarını bir beceri veya Plugin yüklemeden önce nasıl anlayacağınız.
title: Güvenlik Denetimleri
x-i18n:
    generated_at: "2026-07-04T06:47:45Z"
    model: gpt-5.5
...
kötü amaçlı olduğu anlamına gelmez. Beceri amacına uygun görünüyor, ancak anlamlı
hesap yetkisiyle işlem yapabiliyor demektir.
...
yüksek önem derecesine sahip bulgular, risk seviyesine ve denetim durumuna daha
güçlü şekilde katkıda bulunur.

Düşük güven düzeyine sahip bulgular, sayfanın yararlı kanıtlara odaklı kalması için
...
kullanıcıların makul olarak bekleyeceği şeylerle uyumlu mu?
...
ClawHub, denetim yığınında kötü amaçlı yazılım telemetrisi olarak VirusTotal'ı kullanır.
...
VirusTotal özellikle bilinen kötü amaçlı artefaktlar, motor eşleşmeleri ve ClawHub'ın
ajan farkındalıklı incelemesini tamamlayan itibar sinyalleri için yararlıdır. Tedarikçi
...
dahili olarak desteklenir. Her sürümü ajan odaklı bir artefakt olarak inceler:
...
sağladığı bağlam. Statik tarama sinyalleri bu inceleme için dahili bağlamdır; ayrı
bir genel denetim bölümü veya yüklemeyi engelleyen hüküm değildir.

Risk analizi, prompt injection, araç kötüye kullanımı, kimlik bilgisi açığa çıkması,
güvensiz yürütme, bellek veya bağlam zehirlenmesi ve aşırı yetki kullanımı gibi
risklere bakmak için
