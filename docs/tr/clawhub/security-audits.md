...
read_when:
    ...
    - Bir skill veya Plugin yükleyip yüklemeyeceğinize karar verme
...
x-i18n:
    generated_at: "2026-06-30T22:31:13Z"
    model: gpt-5.5
...
harici hizmetlere erişebilmeden önce ekstra dikkat gerektiren bir şey olup
olmadığını gösterir.
...
Risk seviyesi etki alanını tanımlar: sürüm amaçlandığı şekilde kullanıldığında
...
| `High`        | Sürüm yüksek etkili yetkiye, ciddi bulgulara veya kötü amaçlı sinyallere sahip. |

Risk seviyesi ve denetim durumu farklı sorulara yanıt verir:
...
Düşük güvenli bulgular herkese açık denetim özetinden gizlenir; böylece sayfa
yararlı kanıtlara odaklı kalır.
...
Güçlü davranış otomatik olarak kötü değildir. Birçok yararlı aracın kimlik
bilgilerine, yerel komutlara, sağlayıcı API'lerine veya paket yüklemelerine
ihtiyacı vardır. Denetim, bu gücün beklenen, açıklanmış ve orantılı olup
...
VirusTotal özellikle bilinen kötü amaçlı yapıtlar, motor tespitleri ve ClawHub'ın
ajan farkındalıklı incelemesini tamamlayan itibar sinyalleri için yararlıdır.
Satıcı motor sayıları mevcut olduğunda denetim bunları düz bir dille özetler;
örneğin:
...
ClawHub'ın özetleyebileceği satıcı sayısı telemetrisi olmadığında denetim şunu söyler:
...
ClawScan tarafından desteklenir. Her sürümü ajanlara yönelik bir yapıt olarak
inceler: talimatlar, meta veriler, bildirilen izinler, dosyalar, yetenek sinyalleri,
statik tarama sinyalleri, SkillSpector bulguları, VirusTotal telemetrisi ve
yayıncı tarafından sağlanan bağlam. Statik tarama sinyalleri bu inceleme için
dahili bağlamdır; bağımsız bir herkese açık denetim bölümü veya yüklemeyi
engelleyen hüküm değildir.

Risk analizi, prompt injection, araçların kötüye kullanımı, kimlik bilgisi
ifşası, güvensiz yürütme, bellek veya bağlam zehirlenmesi ve aşırı aracılık gibi
riskler için
[OWASP Agentic Skills Top 10](https://owasp.org/www-project-agentic-skills-top-10/)
kaynağını bir bakış açısı olarak kullanır.

ClawScan korkutucu görünen bir yeteneği otomatik olarak kötü amaçlı saymaz.
Yeteneğin açıklanmış, amaca uygun ve sürümün belirtilen kullanım amacıyla
