...
read_when:
    ...
    - Bir Skills veya Plugin kurup kurmamaya karar verme
...
x-i18n:
    generated_at: "2026-07-05T08:02:36Z"
    model: gpt-5.5
...
veya harici servislere erişmeden önce fazladan dikkat gerektiren bir şey olup
olmadığını gösterir.
...
yayımlayabilen, verileri düzenleyebilen, komut çalıştırabilen, dosyaları
...
Düşük güvenli bulgular, sayfanın yararlı kanıtlara odaklanması için genel
denetim özetinde gizlenir.
...
kullanıcıların makul biçimde bekleyeceği şeylerle uyumlu mu?
...
ClawHub'ın aracı farkında incelemesini tamamlayan itibar sinyalleri için
yararlıdır. Tedarikçi motor sayıları mevcut olduğunda denetim bunları sade bir
...
VirusTotal telemetri olarak kalır. ClawHub'ın kendi yapıt farkında risk analizinin yerini almaz.
...
güvensiz yürütme, bellek veya bağlam zehirlenmesi ve aşırı yetkilendirme gibi
...
belirtilen kullanım amacı tarafından desteklenip desteklenmediğini sorar.
