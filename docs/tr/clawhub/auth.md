...
x-i18n:
    generated_at: "2026-07-04T20:39:09Z"
    model: gpt-5.5
...
açma işlemini tamamlayamaz. Oturum açma sizi oturum kapalı duruma döndürüyorsa,
hesabınızın durumu uygun olmayabilir. Hesabınız yasaklandıysa veya devre dışı
...
çağırmaya erişemiyorsa, headless belirteç akışını kullanın.
