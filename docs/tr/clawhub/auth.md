...
summary: ClawHub'da oturum açma, API belirteçleri, CLI ile oturum açma, belirteç depolama ve iptal etme.
x-i18n:
    generated_at: "2026-06-30T22:28:42Z"
    model: gpt-5.5
...
ClawHub, web üzerinden oturum açma için GitHub kullanır. CLI, oturum açılmış
hesap üzerinden oluşturulan ClawHub API tokenlarını kullanır.
...
3. GitHub ile oturum açtıktan sonra ClawHub bir API tokenı oluşturur.
...
çağrıya ulaşamıyorsa başsız token akışını kullanın.
