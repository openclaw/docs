...
summary: ClawHub oturum açma, API tokenleri, CLI girişi, token depolama ve iptal etme.
x-i18n:
    generated_at: "2026-07-01T15:28:55Z"
    model: gpt-5.5
...
ClawHub, web oturum açma için GitHub kullanır. CLI, oturum açılmış hesap
...
çağırmaya erişemiyorsa başsız belirteç akışını kullanın.
