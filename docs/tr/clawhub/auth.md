...
x-i18n:
    generated_at: "2026-06-30T14:19:37Z"
    model: gpt-5.5
...
Silinmiş, yasaklanmış veya devre dışı bırakılmış hesaplar normal ClawHub oturumu açma işlemini tamamlayamaz.
Oturum açma sizi oturum kapalı durumuna döndürüyorsa hesabınızın itibarı iyi
...
4. Tarayıcı yerel geri çağırmaya geri yönlendirir.
...
ClawHub web kullanıcı arayüzünde bir token oluşturun, ardından bunu CLI'ye geçirin:
...
Silinmiş, yasaklanmış veya devre dışı bırakılmış hesaplar mevcut API tokenlarını kullanmaya devam edemez.
Hesabınız yasaklandıysa veya devre dışı bırakıldıysa, bunun bir hata olduğunu
düşünüyorsanız [ClawHub itiraz formunu](https://appeals.openclaw.ai/) kullanın.
