...
ClawHub, web oturum açma için GitHub kullanır. CLI, oturum açılmış
...
Oturum açma sizi oturum kapalı durumuna döndürüyorsa, hesabınızın durumu iyi
olmayabilir.
...
ulaşamıyorsa, tarayıcısız belirteç akışını kullanın.
