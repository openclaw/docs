...
bu hesap üzerinden oluşturulan ClawHub API belirteçlerini kullanır.
...
işlemini tamamlayamaz. Oturum açma sizi oturum kapalı durumuna geri döndürüyorsa,
hesabınız iyi durumda olmayabilir.
...
3. GitHub ile oturum açtıktan sonra ClawHub bir API belirteci oluşturur.
...
erişemiyorsa, tarayıcısız belirteç akışını kullanın.
...
Bu akışı sunucular, CI işleri veya yalnızca terminal olan ortamlar için kullanın.
