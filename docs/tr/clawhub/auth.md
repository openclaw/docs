...
summary: ClawHub oturumu açma, API belirteçleri, CLI ile oturum açma, belirteç depolama ve iptal.
x-i18n:
    generated_at: "2026-07-05T08:03:21Z"
    model: gpt-5.5
...
ClawHub web kullanıcı arayüzünde bir belirteç oluşturun, ardından bunu CLI'a
iletin:
