...
x-i18n:
    generated_at: "2026-07-04T06:46:34Z"
    model: gpt-5.5
...
çağrıya ulaşamıyorsa tarayıcısız belirteç akışını kullanın.
...
`clawhub login` ile yeniden oturum açın veya `clawhub login --token` ile yeni bir
belirteç sağlayın.
