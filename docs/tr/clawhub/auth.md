...
ClawHub, web oturum açma için GitHub kullanır. CLI, oturum açmış hesap
...
döndürürse hesabınız iyi durumda olmayabilir.
...
`clawhub login` ile tekrar oturum açın veya `clawhub login --token` ile yeni
