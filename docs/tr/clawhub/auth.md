...
summary: ClawHub oturum açma, API belirteçleri, CLI ile oturum açma, belirteç depolama ve iptal etme.
x-i18n:
    generated_at: "2026-07-03T23:39:56Z"
    model: gpt-5.5
...
açma işlemini tamamlayamaz. Oturum açma sizi oturum kapalı durumuna döndürüyorsa,
hesabınızın durumu iyi olmayabilir. Hesabınız yasaklandıysa veya devre dışı
