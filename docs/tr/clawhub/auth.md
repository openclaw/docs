...
summary: ClawHub oturum açma, API belirteçleri, CLI oturum açma, belirteç depolama ve iptal etme.
x-i18n:
    generated_at: "2026-07-02T01:10:24Z"
    model: gpt-5.5
...
3. GitHub oturumu açıldıktan sonra ClawHub bir API token'ı oluşturur.
...
CLI tek kullanımlık bir kod yazdırır ve siz bunu `https://clawhub.ai/cli/device`
