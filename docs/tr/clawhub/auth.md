...
x-i18n:
    generated_at: "2026-07-04T04:01:33Z"
    model: gpt-5.5
...
açma işlemini tamamlayamaz. Oturum açma sizi oturumu kapatılmış bir duruma geri
döndürüyorsa, hesabınızın durumu iyi olmayabilir. Hesabınız yasaklandıysa veya
...
ulaşamıyorsa, headless token akışını kullanın.
