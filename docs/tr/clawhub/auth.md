...
summary: ClawHub oturum açma, API token’ları, CLI oturumu açma, token depolama ve iptal etme.
x-i18n:
    generated_at: "2026-07-05T05:27:38Z"
    model: gpt-5.5
...
3. GitHub oturum açma işleminden sonra ClawHub bir API belirteci oluşturır.
4. Tarayıcı yerel geri çağırmaya geri yönlendirir.
5. CLI, belirteci ClawHub yapılandırma dosyanızda depolar.
...
Başka bir yerde tarayıcı açabileceğiniz uzak kabuklarda şunu çalıştırın:
...
CI kurulumu için depolanan belirteci şu komutla yazdırın:
