...
x-i18n:
    generated_at: "2026-07-02T08:42:52Z"
    model: gpt-5.5
...
açma işlemini tamamlayamaz. Oturum açma sizi oturum kapalı durumuna döndürürse,
...
ClawHub web kullanıcı arayüzünde bir belirteç oluşturun, ardından CLI'ye iletin:
