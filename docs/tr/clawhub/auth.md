...
summary: ClawHub oturum açma, API tokenleri, CLI ile giriş, token depolama ve iptal.
x-i18n:
    generated_at: "2026-07-03T17:35:08Z"
    model: gpt-5.5
...
açma işlemini tamamlayamaz. Oturum açma sizi oturumun kapalı olduğu bir duruma
geri döndürürse, hesabınızın durumu iyi olmayabilir. Hesabınız yasaklandıysa
veya devre dışı bırakıldıysa, bunun bir hata olduğunu düşünüyorsanız
...
ClawHub web arayüzünde API token'larını iptal edebilirsiniz.

İptal edilmiş, geçersiz veya eksik token'lar `401 Unauthorized` döndürür. Tekrar
