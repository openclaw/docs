...
x-i18n:
    generated_at: "2026-07-05T05:30:20Z"
    model: gpt-5.5
...
ClawHub, paketleri yayıncılarıyla ilişkilendirmek için GitHub kimliği ve kaynak atfı kullanır.
...
## Bir ad alanı alınmış veya ayrılmış olduğu için yayınlama başarısız oluyor

Sahip tanıtıcısı, kuruluş ad alanı, paket kapsamı, skill
slug'ı veya paket adı zaten alınmış ya da ayrılmış olduğu için yayınlama başarısız olursa, önce
ad alanıyla eşleşen sahip üzerinden yayınladığınızı doğrulayın. Plugin paketleri için
`@example-org/example-plugin` gibi kapsamlı adlar, eşleşen `example-org` sahibi olarak yayınlanmalıdır.

Kuruluşunuzun, projenizin veya markanızın ad alanının hak sahibi olduğuna inanıyorsanız ancak
...
açın. Kanıt rehberi ve herkese açık sorunların dışında tutulması gerekenler için
[Kuruluş ve Ad Alanı Talepleri](/clawhub/namespace-claims) bölümüne bakın.

## `sync` hiç skill bulunmadığını söylüyor
