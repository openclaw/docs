...
summary: ClawHub oturum açma, kurulum, yayınlama, senkronizasyon, güncelleme ve API sorunlarını giderme.
x-i18n:
...
Sahibe görünür tanı bilgileri tarama, yükleme geçidi veya moderasyon durumunu açıklayabilir.
...
- Gizli, özel, bekletilen veya moderasyon tarafından engellenmiş içeriği herkese açık API yüzeyi dışında
  yansıtmayın.

Uç nokta ayrıntıları için [HTTP API](/tr/clawhub/http-api) sayfasına bakın.
