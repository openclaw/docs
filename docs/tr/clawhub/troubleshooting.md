...
x-i18n:
    generated_at: "2026-06-30T22:30:58Z"
    model: gpt-5.5
...
- Biliyorsanız tam slug'ı veya sahip sayfasını denetleyin.
...
Beceriler için `SKILL.md` frontmatter bölümünü denetleyin. Gerekli ortam değişkenleri ve
araçlar, kullanıcıların ve tarayıcıların paketi anlayabilmesi için bildirilmelidir.

Plugin'ler için `package.json` uyumluluk meta verilerini denetleyin. Kod Plugin'i yayınları
...
- Kaynak URL'nin herkese açık olduğunu veya ClawHub tarafından erişilebilir olduğunu denetleyin.
...
zaten talep edildiği ya da rezerve edildiği için bir yayın başarısız olursa,
...
Kuruluşunuzun, projenizin veya markanızın haklı ad alanı sahibi olduğuna inanıyor ancak
mevcut ClawHub sahibini yönetemiyorsanız, herkese açık ve hassas olmayan kanıtla bir
[Kuruluş / Ad Alanı Talebi sorunu](https://github.com/openclaw/clawhub/issues/new?template=org-namespace-claim.yml)
açın. Kanıt kılavuzu ve herkese açık sorunların dışında tutulması gerekenler için
