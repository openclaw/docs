...
x-i18n:
    generated_at: "2026-07-01T08:26:06Z"
    model: gpt-5.5
...
bir yer ve OpenClaw'a bu paketleri güvenli şekilde kurup güncellemesi için
...
ettiğini kurmadan önce inceleyebilecekleri kanonik yerdir.
...
metadata bilgilerini anlamak için `SKILL.md` frontmatter bölümünü okur. Doğru
metadata önemlidir; çünkü kullanıcıların skilli kurup kurmamaya karar vermesine
yardımcı olur ve otomatik taramaların bildirilen davranış ile gözlenen davranış
...
sürümü, host hedefleri, ortam gereksinimleri ve artifact özet değerlerini
içerebilir.

Kaydın doğruluk kaynağı olmasını istediğinizde açık bir ClawHub kurulum kaynağı
kullanın:
...
Yüklemeden önce çözümlenmiş payload önizlemesi için dry run kullanın. Ardından
herkese açık sayfalar yayımlanmış metadatayı, dosyaları, kaynak atfını ve tarama
durumunu gösterir.
...
kurulum kaynağı metadatasını kaydeder. ClawHub CLI ayrıca, tam bir OpenClaw
