...
x-i18n:
    generated_at: "2026-07-05T08:03:14Z"
    model: gpt-5.5
...
Her herkese açık listeleme şu bilgileri içeren bir kayıt kaydıdır:
...
veri önemlidir, çünkü kullanıcıların beceriyi kurup kurmamaya karar vermesine
...
Bkz. [Beceri biçimi](/clawhub/skill-format).
...
sürümü, ana makine hedefleri, ortam gereksinimleri ve yapıt özetlerini
içerebilir.
...
Yayımlama, değiştirilemez yeni bir sürüm kaydı oluşturur. Yayıncılar, kimliği
...
Yüklemeden önce çözümlenmiş yükü önizlemek için deneme çalıştırmalarını
kullanın. Ardından herkese açık sayfalar yayımlanan meta verileri, dosyaları,
...
çalışma alanı dışında kayıt tarafından yönetilen beceri klasörleri isteyen
kullanıcılar için doğrudan beceri kurulum ve güncelleme iş akışlarını destekler.
...
gizlenen veya engellenen içerik, tanılama için sahibi tarafından görülebilir
kalmaya devam ederken herkese açık arama ve kurulum akışlarından kaybolabilir.

Bkz. [Güvenlik](/tr/clawhub/security), [Güvenlik Denetimleri](/clawhub/security-audits),
...
verdikleri, hız sınırlarına uydukları ve onay ima etmekten kaçındıkları sürece bu
