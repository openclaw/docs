...
ClawHub'ın herkese açık okuma API'lerinin üzerinde üçüncü taraf bir katalog, dizin veya arama yüzeyi oluşturabilirsiniz. Herkese açık Skills meta verileri ve Skills dosyaları ClawHub'ın Skills lisans kuralları kapsamında yayımlanırken, API'nin kendisi hız sınırına tabidir ve sorumlu biçimde tüketilmelidir.
...
- Kullanıcıların kaynak kayıt kaydını inceleyebilmesi için listelemeleri gösterirken kanonik ClawHub Skills URL'sine geri bağlantı verin.
...
- `GET /api/v1/download?slug=&version=&tag=`
  ...
  - `clean` veya `suspicious` taramasına sahip mevcut GitHub destekli Skills,
    ClawHub baytları yerine JSON `public-github` aktarım tanımlayıcısı döndürür.
