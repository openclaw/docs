...
x-i18n:
    generated_at: "2026-07-04T18:17:10Z"
    model: gpt-5.5
...
ClawHub'ın herkese açık okuma API'leri üzerinde üçüncü taraf bir katalog, dizin veya arama yüzeyi oluşturabilirsiniz. Herkese açık skill meta verileri ve skill dosyaları ClawHub'ın skill lisansı kuralları kapsamında yayımlanırken, API'nin kendisi hız sınırlıdır ve sorumlu şekilde tüketilmelidir.
...
- Listeleri gösterirken kullanıcıların kaynak kayıt defteri kaydını inceleyebilmesi için kanonik ClawHub skill URL'sine geri bağlantı verin.
...
- `Retry-After`: `429` üzerinde beklenmesi gereken gecikme saniyesi
...
- v1 hataları düz metindir (`text/plain; charset=utf-8`); buna `400`,
  `401`, `403`, `404`, `429` ve engellenmiş indirme yanıtları dahildir.
...
- `GET /api/v1/download?slug=&version=&tag=`
  ...
  - `clean` veya `suspicious` taraması olan güncel GitHub destekli skills, ClawHub baytları yerine
