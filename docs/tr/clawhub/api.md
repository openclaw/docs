...
- Listelemeleri görüntülerken kullanıcıların kaynak kayıt defteri kaydını inceleyebilmesi için kanonik ClawHub Skills URL'sine bağlantı verin.
...
- `POST /api/v1/users/reserve`, bir owner handle için kök slug'ları ve özel no-release paket yer tutucularını ayırır.
