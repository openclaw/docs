...
x-i18n:
    generated_at: "2026-07-02T01:09:52Z"
    model: gpt-5.5
...
- Kimliği doğrulanmış istekler (geçerli Bearer token): kullanıcı havuzu başına.
...
- `X-RateLimit-Remaining` / `RateLimit-Remaining`: mevcut olduğunda tam kalan bütçe;
  parçalanmış başarılı istekler yaklaşık bir global değer döndürmek yerine bunu
  atlar
