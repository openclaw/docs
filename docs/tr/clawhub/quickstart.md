...
x-i18n:
    generated_at: "2026-06-28T20:42:14Z"
    model: gpt-5.5
...
Başsız ortamlar, ClawHub web UI'ından bir API belirteci kullanabilir:
...
Beceri, zorunlu bir `SKILL.md` dosyası ve isteğe bağlı destek dosyaları içeren
bir klasördür.
...
değişiklikler bir sonraki yama sürümünü otomatik olarak yayınlar. Önizlemek için
