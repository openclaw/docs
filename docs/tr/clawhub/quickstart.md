...
x-i18n:
    generated_at: "2026-07-04T04:02:59Z"
    model: gpt-5.5
...
Yayınlamadan önce `SKILL.md` içindeki meta verileri kontrol edin. Gerekli
ortam değişkenlerini, araçları ve izinleri bildirin; böylece kullanıcılar
Skills'i kurmadan önce neye ihtiyaç duyduğunu anlayabilir. Bkz.
[Skills biçimi](/tr/clawhub/skill-format).

Birden fazla Skills içeren depolar için yeniden kullanılabilir GitHub iş akışı,
`skills/` altındaki her bir doğrudan Skills klasörü için `skill publish`
çağırır:
