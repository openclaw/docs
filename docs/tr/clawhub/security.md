...
read_when:
    ...
    - ClawHub güvenlik açığı bildirimi anlayışı
...
title: Güvenlik
x-i18n:
    generated_at: "2026-07-02T14:10:21Z"
    model: gpt-5.5
...
Üçüncü taraf bir skill veya plugin'in kendi kaynak kodundaki güvenlik açıkları için ClawHub danışmanlıklarını kullanmayın. Bunları doğrudan ClawHub listesinden bağlantı verilen yayımcıya veya kaynak deposuna bildirin.
