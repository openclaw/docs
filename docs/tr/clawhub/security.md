...
summary: ClawHub güvenlik sorunlarının nasıl bildirileceği ve güvenlik açıklarının ne zaman kamuya açık olarak duyurulduğu.
title: Güvenlik
x-i18n:
    generated_at: "2026-07-04T06:47:37Z"
    model: gpt-5.5
...
- kayıt defteri yayımlama, indirmeler, kurulumlar veya artefakt bütünlüğü
- kimlik doğrulama, yetkilendirme veya API tokenları
- tarama, moderasyon veya rapor işleme

Üçüncü taraf bir skill veya plugin'in kendi kaynak kodundaki güvenlik açıkları için ClawHub güvenlik danışmanlıklarını kullanmayın. Bunları doğrudan yayıncıya veya ClawHub listelemesinden bağlantı verilen kaynak deposuna bildirin.
...
Kullanıcıların yerelde güncellemesi gereken ClawHub CLI paketleri, ikili dosyalar, kitaplıklar veya diğer yayın artefaktları gibi kullanıcı tarafından kurulan yazılımlardaki güvenlik açıkları herkese açık şekilde açıklanır.
...
Pazar yeri raporları, moderasyon askıları, gizli listelemeler, yasaklar ve hesap durumu için bkz. [Moderasyon ve Hesap Güvenliği](/clawhub/moderation).
