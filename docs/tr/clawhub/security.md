...
title: Güvenlik
x-i18n:
    generated_at: "2026-07-04T15:31:05Z"
    model: gpt-5.5
...
ClawHub güvenlik sorunları, `openclaw/clawhub` için GitHub Güvenlik Danışmanları üzerinden bildirilebilir.

ClawHub'ın kendisindeki güvenlik açıkları için GitHub Güvenlik Danışmanları'nı kullanın. İyi ClawHub danışmanlık raporları şunlardaki hataları içerir:
...
Üçüncü taraf bir Skill veya Plugin'in kendi kaynak kodundaki güvenlik açıkları için ClawHub danışmanlıklarını kullanmayın. Bunları doğrudan ClawHub listesinden bağlantısı verilen yayıncıya veya kaynak deposuna bildirin.
