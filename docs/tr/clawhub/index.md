...
title: ClawHub
x-i18n:
    generated_at: "2026-07-03T23:40:16Z"
    model: gpt-5.5
...
Yayımlama veya silme/silmeyi geri alma gibi kayıt defteri kimliği doğrulanmış iş akışları istediğinizde ClawHub CLI'ını kurun:
...
bir Skill veya Plugin'i kurmadan önce inceleyebilmesi için geçerli kayıt defteri
durumunu gösterir.
...
Bir Plugin kurulumunun ClawHub üzerinden çözülmesi gerektiğinde `clawhub:<package>` kullanın.
Çıplak npm-güvenli Plugin belirtimleri, lansman geçişleri sırasında npm üzerinden çözülebilir ve
...
CLI ayrıca doğrudan kayıt defteri iş akışları için Skill kurma/güncelleme komutlarına sahiptir:
...
için [Skill biçimi](/clawhub/skill-format) sayfasına bakın.

## Güvenlik ve moderasyon

ClawHub varsayılan olarak açıktır: herkes yükleyebilir, ancak yayımlama için yükleme
geçidini geçecek kadar eski bir GitHub hesabı gerekir. Genel ayrıntı sayfaları, kurulum
...
bekletilen veya engellenen sürümler, sahiplerine `/dashboard` içinde görünür kalırken genel katalog
ve kurulum yüzeylerinden kaybolabilir.

Oturum açmış kullanıcılar Skills ve paketleri bildirebilir. Moderatörler bildirimleri inceleyebilir,
içeriği gizleyebilir veya geri yükleyebilir ve kötüye kullanan hesapları yasaklayabilir. Politika ve
...
sayılarını hesaplayabilmesi için en iyi çaba kurulum olayı gönderebilir. Bunu şununla devre dışı bırakın:
