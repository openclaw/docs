...
read_when:
    ...
    - Skills veya pluginleri kayıt defterinde yayımlama
...
title: ClawHub
x-i18n:
    generated_at: "2026-07-04T18:12:58Z"
    model: gpt-5.5
...
| -------------- | ------------------------------------------------------------- | ------------------------------------------- |
| Skills         | `SKILL.md` ve destek dosyalarıyla sürümlü metin paketleri     | `openclaw skills install @openclaw/demo`    |
...
Herkese açık sayfalar güncel kayıt deposu durumunu gösterir; böylece kullanıcılar
bir Skill veya Plugin'i yüklemeden önce inceleyebilir.
...
`clawhub:<package>` kullanın. Çıkarma geçişleri sırasında yalın npm uyumlu
Plugin tanımları npm üzerinden çözümlenebilir ve bir kaynağın açıkça belirtilmesi
...
Skill meta verileri için [Skill biçimi](/clawhub/skill-format) sayfasına bakın.
...
ClawHub, yayımlanan Skills ve Plugin sürümlerinde otomatik denetimler çalıştırır.
Tarama nedeniyle bekletilen veya engellenen sürümler, sahipleri için `/dashboard`
içinde görünür kalırken herkese açık katalog ve yükleme yüzeylerinden kaybolabilir.
