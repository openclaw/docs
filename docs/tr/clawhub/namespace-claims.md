---
read_when:
    - Bir kuruluşu, markayı, paket kapsamını, sahip kullanıcı adını, beceri slug'ını veya paket ad alanını sahiplenme
...
title: Kuruluş ve Ad Alanı Hak Talepleri
x-i18n:
...
ayrılması, devredilmesi, yeniden adlandırılması, gizlenmesi, karantinaya alınması, başka adla eşlenmesi
...
- API belirteçleri, imzalama anahtarları veya kimlik bilgileri
- DNS doğrulama belirteçleri
...
bir takma ad ya da yönlendirme ekleyebilir, daha fazla kanıt isteyebilir ya da isteği reddedebilir.
