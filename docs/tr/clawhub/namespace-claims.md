---
read_when:
    - Kuruluş, marka, paket kapsamı, sahip kullanıcı adı, beceri slug’ı veya paket ad alanı üzerinde hak talep etme
...
x-i18n:
    generated_at: "2026-06-28T08:16:54Z"
    model: gpt-5.5
...
bir projeye, markaya, paket ekosistemine veya kuruluşa ait gibi görünüyor ancak ClawHub üzerinde
...
Geçerli sahibi yönetemediğinizde veya personelin bir ihtilafı çözmesi gerektiğinde talep kullanın.
...
Talep formu, hassas kanıt için özel bir personel kanalına ihtiyaç olup olmadığını sorar.
...
sahipliği devredebilir, bir kaynağı yeniden adlandırabilir, mevcut bir listelemeyi gizleyebilir
veya karantinaya alabilir, bir takma ad ya da yönlendirme ekleyebilir, daha fazla kanıt isteyebilir
