---
read_when:
    - Bir kuruluş, marka, paket kapsamı, sahip kullanıcı adı, beceri kısa adı veya paket ad alanı üzerinde hak talep etme
    - Zaten sahiplenilmiş veya ayrılmış bir ad alanını çözümleme
    - Bir rapor, itiraz veya ad alanı talebi kullanıp kullanmamaya karar verme
sidebarTitle: Org and Namespace Claims
summary: Kuruluş, marka, sahip tanıtıcısı, paket kapsamı, skill-slug veya namespace sahipliği uyuşmazlıkları için ClawHub incelemesi nasıl istenir.
title: Kuruluş ve Ad Alanı Talepleri
x-i18n:
    generated_at: "2026-07-04T04:01:41Z"
    model: gpt-5.5
...
bir projeye, markaya, paket ekosistemine veya kuruluşa ait gibi görünüyorsa ancak ClawHub üzerinde zaten
...
ClawHub personelinin bir ad alanının gerçek dünya sahipliği nedeniyle
...
ilgili moderasyon veya güvenlik rehberliğini de izleyin. Ad alanı talep
...
- kaynak deposu geçmişi, paket geçmişi veya herkese açık yeniden adlandırma bildirimleri
...
Talep formu, hassas kanıtların özel bir personel kanalına ihtiyaç duyup duymadığını sorar.
...
takma ad veya yönlendirme ekleyebilir, daha fazla kanıt isteyebilir ya da isteği reddedebilir.

Ad alanı incelemesi, her eşleşen adın devredileceğini garanti etmez.
