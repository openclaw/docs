...
x-i18n:
    generated_at: "2026-07-01T18:17:57Z"
    model: gpt-5.5
...
Raporlanan her `clawhub install` için CLI, en iyi çaba esaslı bir kurulum olayı gönderir.

Olay şunları içerir:

- `slug`: kurulan beceri slug’ı.
...
Herkes yalnızca **toplam kurulum sayaçlarını** görür.
