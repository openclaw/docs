...
x-i18n:
    generated_at: "2026-07-02T14:11:08Z"
    model: gpt-5.5
...
Raporlanan her `clawhub install` işleminde CLI, elinden geldiğince bir yükleme olayı gönderir.

Olay şunları içerir:

- `slug`: yüklenen becerinin slug'ı.
- `version`: bilindiğinde yüklenen sürüm.
...
- `installsAllTime`: beceri için en az bir CLI yüklemesi raporlamış benzersiz kullanıcılar.
