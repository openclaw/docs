...
x-i18n:
    generated_at: "2026-06-30T22:31:31Z"
    model: gpt-5.5
...
ClawHub, toplu kurulum sayılarını hesaplamak için minimal CLI telemetrisi kullanır.
...
- Çalıştırma başına günlükler, promptlar veya başka CLI çıktıları yok.
