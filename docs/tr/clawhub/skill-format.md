...
x-i18n:
    generated_at: "2026-05-12T15:42:52Z"
    model: gpt-5.5
    provider: openai
...
- destekleyici _metin tabanlı_ dosyalar (bkz. “İzin verilen dosyalar”)
...
- Beceriniz ücretli bir üçüncü taraf hizmetle entegre oluyorsa, dış maliyeti ve gerekli hesabı beceri talimatlarında ve ortam bildirimlerinde açıkça belgeleyin (gerekli değişkenler için `requires.env` veya isteğe bağlı değişkenler için `required: false` ile `envVars`).
