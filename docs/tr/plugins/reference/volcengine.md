---
read_when:
    - volcengine Plugin'ini kuruyor, yapılandırıyor veya denetliyorsunuz
...
OpenClaw'a Volcengine, Volcengine Plan model sağlayıcısı desteği ekler.
...
sağlayıcılar: volcengine, volcengine-plan; sözleşmeler: speechProviders

## İlgili dokümanlar

- [volcengine](/tr/providers/volcengine)
