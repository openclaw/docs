---
read_when:
    - comfy Plugin'ı yüklüyor, yapılandırıyor veya denetliyorsunuz
summary: OpenClaw'a ComfyUI model sağlayıcı desteği ekler.
title: ComfyUI Plugin
x-i18n:
    generated_at: "2026-05-02T20:51:30Z"
    model: gpt-5.5
    provider: openai
