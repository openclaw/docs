...
summary: Yuanbao botuna genel bakış, özellikleri ve yapılandırması
title: Yuanbao
x-i18n:
    generated_at: "2026-05-06T09:04:28Z"
    model: gpt-5.5
    provider: openai
...
Yuanbao botlarını WebSocket üzerinden OpenClaw'a bağlar; böylece doğrudan mesajlar
ve grup sohbetleri üzerinden kullanıcılarla etkileşime geçebilirler.
