...
- `translate-all.yml` reconciles missing or changed translations weekly or by manual dispatch. Matching-page retranslation requires explicit `force_retranslate` recovery.
