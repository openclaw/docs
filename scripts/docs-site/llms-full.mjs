...
if (!pages.length) throw new Error(`no English docs pages found in ${path.relative(root, docsDir) || docsDir}`);
...
console.log(`llms-full ok: ${pages.length} pages, ${content.length} chars, ${path.relative(root, outputDir)}`);
